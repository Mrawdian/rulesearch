...
| connect | 4 | 3 | 18247 | 9121 | 1186 | 636 | 1812 | 1446 | 1981 | 1836 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 17853 | 4202 | 7532 | 12 | 2441 | 917 | 7 | 2742 | 15.4% |
...
- candidats AVEC connectivite : 1963, dont T2 : 100%
- candidats SANS connectivite : 3052, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2255 systemes avec CONNECTED sur 17402 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*725 candidats sur 5015 portent les champs bruts (14%).*
...
- `e3baecf8377b` — 461 candidats
  - AVEC connectivite (180) : resistance **42.8%**
...
- `e3baecf8377b` — 461 candidats
  - AVEC connectivite (180) : T0=13.02 T1=0.00 T2=3.13 — pondere **6.26**
  - SANS connectivite (281) : T0=16.13 T1=0.00 T2=2.67 — pondere **5.33**
...
- TROP-CHER : 2272 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2255 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14901 systemes
  - sans CONNECTED : 0.0% sur 3346 systemes
