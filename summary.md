...
genere 2026-08-26 13:56 UTC — 47782 systemes evalues
...
- moteur actif `0caa9267db60` (4040 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21051 | 10509 | 1394 | 723 | 2089 | 1673 | 2248 | 2152 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20616 | 4814 | 8703 | 13 | 2858 | 1065 | 7 | 3156 | 15.3% |
...
- candidats AVEC connectivite : 2279, dont T2 : 100%
- candidats SANS connectivite : 3466, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2522 systemes avec CONNECTED sur 19695 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1455 candidats sur 5745 portent les champs bruts (25%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 340 candidats
  - AVEC connectivite (141) : resistance **40.1%**
  - SANS connectivite (199) : resistance **20.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 340 candidats
  - AVEC connectivite (141) : T0=13.43 T1=0.00 T2=2.94 — pondere **5.89**
  - SANS connectivite (199) : T0=16.15 T1=0.00 T2=2.70 — pondere **5.40**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17194 systemes
  - sans CONNECTED : 0.0% sur 3857 systemes
