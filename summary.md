...
genere 2026-08-27 01:07 UTC — 73131 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 9167 systemes
- `ab89a63b01ef` : 8224 systemes
...
- moteur actif `0caa9267db60` (29389 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 33149 | 7647 | 14077 | 20 | 4604 | 1732 | 17 | 5052 | 15.2% |
...
- candidats SANS connectivite : 5362, dont T2 : 100%
...
*4659 candidats sur 8949 portent les champs bruts (52%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 982 candidats
  - AVEC connectivite (407) : resistance **40.9%**
  - SANS connectivite (575) : resistance **21.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 982 candidats
  ...
  - SANS connectivite (575) : T0=15.91 T1=0.00 T2=2.64 — pondere **5.29**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
...
- TROP-CHER : 3912 systemes abandonnes (5.3% des systemes), 96% du temps total
