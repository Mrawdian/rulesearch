...
genere 2026-08-26 03:37 UTC — 21373 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 12399 systemes
...
| connect | 4 | 3 | 10745 | 5405 | 706 | 372 | 1030 | 855 | 1160 | 1079 | 10.0% |
...
- candidats AVEC connectivite : 1082, dont T2 : 100%
...
- **1160 systemes avec CONNECTED sur 8868 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1529 candidats
  - AVEC connectivite (603) : T0=13.37 T1=0.00 T2=2.87 — pondere **5.73**
...
- TROP-CHER : 1164 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 1160 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 8811 systemes
  - sans CONNECTED : 0.0% sur 1934 systemes
