...
genere 2026-08-27 07:08 UTC — 86478 systemes evalues
...
- moteur actif `0caa9267db60` (42736 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 40597 | 20212 | 2775 | 1384 | 4061 | 3196 | 4281 | 4162 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 39766 | 9160 | 16910 | 22 | 5518 | 2077 | 21 | 6058 | 15.2% |
...
- candidats AVEC connectivite : 4289, dont T2 : 100%
- candidats SANS connectivite : 6368, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4555 systemes avec CONNECTED sur 35673 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6367 candidats sur 10657 portent les champs bruts (60%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 402 candidats
  - AVEC connectivite (161) : resistance **42.0%**
  - SANS connectivite (241) : resistance **21.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 402 candidats
  - AVEC connectivite (161) : T0=13.15 T1=0.00 T2=3.06 — pondere **6.12**
  - SANS connectivite (241) : T0=15.81 T1=0.00 T2=2.69 — pondere **5.38**
...
- TROP-CHER : 4586 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4555 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 33172 systemes
  - sans CONNECTED : 0.0% sur 7425 systemes
