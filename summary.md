...
genere 2026-08-27 23:09 UTC — 118222 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 34878 systemes
...
- moteur actif `0caa9267db60` (74480 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 56621 | 28204 | 3915 | 1921 | 5616 | 4479 | 5979 | 5780 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 55486 | 12805 | 23541 | 26 | 7713 | 2868 | 25 | 8506 | 15.3% |
...
- candidats AVEC connectivite : 5907, dont T2 : 100%
- candidats SANS connectivite : 8816, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6253 systemes avec CONNECTED sur 48751 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10433 candidats sur 14723 portent les champs bruts (71%).*

- `5c556c16ea8b` — 4468 candidats
  - AVEC connectivite (1779) : resistance **42.0%**
  - SANS connectivite (2689) : resistance **22.4%**
...
- `5c556c16ea8b` — 4468 candidats
  - AVEC connectivite (1779) : T0=12.96 T1=0.00 T2=3.06 — pondere **6.11**
  - SANS connectivite (2689) : T0=15.78 T1=0.00 T2=2.71 — pondere **5.42**
...
- TROP-CHER : 6288 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6253 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 46250 systemes
  - sans CONNECTED : 0.0% sur 10371 systemes
