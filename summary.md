...
genere 2026-08-26 06:52 UTC — 29363 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 20389 systemes
...
| connect | 4 | 3 | 13998 | 7003 | 916 | 481 | 1368 | 1108 | 1529 | 1411 | 10.1% |
...
- candidats AVEC connectivite : 1438, dont T2 : 100%
- candidats SANS connectivite : 2187, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1604 systemes avec CONNECTED sur 12146 (13.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2460 candidats
  - AVEC connectivite (959) : T0=13.20 T1=0.00 T2=2.87 — pondere **5.75**
...
## cout
- temps total 9.3 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 1613 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1604 avec CONNECTED, 9 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 11466 systemes
  - sans CONNECTED : 0.0% sur 2532 systemes
