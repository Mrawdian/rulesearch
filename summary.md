...
genere 2026-09-08 05:30 UTC — 451141 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 367797 systemes
...
- moteur actif `0caa9267db60` (407399 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 224743 | 111593 | 15311 | 7498 | 22745 | 17618 | 23952 | 23158 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 220283 | 51317 | 92860 | 87 | 30692 | 11377 | 79 | 33853 | 15.4% |
...
- candidats AVEC connectivite : 23285, dont T2 : 100%
- candidats SANS connectivite : 34163, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **24226 systemes avec CONNECTED sur 186017 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*53158 candidats sur 57448 portent les champs bruts (93%).*

- `5c556c16ea8b` — 47193 candidats
  - AVEC connectivite (19157) : resistance **41.2%**
  - SANS connectivite (28036) : resistance **21.3%**
...
- `5c556c16ea8b` — 47193 candidats
  - AVEC connectivite (19157) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (28036) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 183516 systemes
  - sans CONNECTED : 0.0% sur 41227 systemes
