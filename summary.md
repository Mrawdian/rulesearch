...
genere 2026-09-02 03:17 UTC — 300297 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 216953 systemes
...
- moteur actif `0caa9267db60` (256555 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 148571 | 73807 | 10110 | 4979 | 15073 | 11690 | 15737 | 15271 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 145611 | 33859 | 61624 | 62 | 20160 | 7525 | 63 | 22306 | 15.3% |
...
- candidats AVEC connectivite : 15398, dont T2 : 100%
- candidats SANS connectivite : 22616, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16011 systemes avec CONNECTED sur 123792 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*33724 candidats sur 38014 portent les champs bruts (89%).*

- `5c556c16ea8b` — 27759 candidats
  - AVEC connectivite (11270) : resistance **41.0%**
  - SANS connectivite (16489) : resistance **21.3%**
...
- `5c556c16ea8b` — 27759 candidats
  - AVEC connectivite (11270) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (16489) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 16084 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16011 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 121291 systemes
  - sans CONNECTED : 0.0% sur 27280 systemes
