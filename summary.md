...
genere 2026-09-01 23:24 UTC — 295823 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 212479 systemes
...
- moteur actif `0caa9267db60` (252081 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 146320 | 72672 | 9953 | 4907 | 14859 | 11537 | 15466 | 15041 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 143388 | 33358 | 60647 | 61 | 19856 | 7407 | 63 | 21985 | 15.3% |
...
- candidats AVEC connectivite : 15168, dont T2 : 100%
- candidats SANS connectivite : 22295, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15740 systemes avec CONNECTED sur 121919 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*33173 candidats sur 37463 portent les champs bruts (89%).*

- `5c556c16ea8b` — 27208 candidats
  - AVEC connectivite (11040) : resistance **41.0%**
  - SANS connectivite (16168) : resistance **21.3%**
...
- `5c556c16ea8b` — 27208 candidats
  - AVEC connectivite (11040) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (16168) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 119418 systemes
  - sans CONNECTED : 0.0% sur 26902 systemes
