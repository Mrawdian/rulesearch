...
genere 2026-08-31 03:36 UTC — 239566 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 156222 systemes
...
- moteur actif `0caa9267db60` (195824 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 117926 | 58661 | 8012 | 3954 | 11850 | 9294 | 12495 | 12119 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 115525 | 26958 | 48838 | 53 | 15936 | 5966 | 52 | 17712 | 15.3% |
...
- candidats AVEC connectivite : 12246, dont T2 : 100%
- candidats SANS connectivite : 18022, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12769 systemes avec CONNECTED sur 98800 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*25978 candidats sur 30268 portent les champs bruts (86%).*

- `5c556c16ea8b` — 20013 candidats
  - AVEC connectivite (8118) : resistance **41.0%**
  - SANS connectivite (11895) : resistance **21.4%**
...
- `5c556c16ea8b` — 20013 candidats
  - AVEC connectivite (8118) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.97**
  - SANS connectivite (11895) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 12831 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 12769 avec CONNECTED, 62 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 96299 systemes
  - sans CONNECTED : 0.0% sur 21627 systemes
