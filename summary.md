...
genere 2026-08-30 23:12 UTC — 233605 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 150261 systemes
...
- moteur actif `0caa9267db60` (189863 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 114924 | 57142 | 7804 | 3861 | 11540 | 9082 | 12161 | 11825 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 112566 | 26257 | 47568 | 53 | 15535 | 5816 | 49 | 17278 | 15.3% |
...
- candidats AVEC connectivite : 11952, dont T2 : 100%
- candidats SANS connectivite : 17588, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12435 systemes avec CONNECTED sur 96352 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*25250 candidats sur 29540 portent les champs bruts (85%).*

- `5c556c16ea8b` — 19285 candidats
  - AVEC connectivite (7824) : resistance **41.0%**
  - SANS connectivite (11461) : resistance **21.4%**
...
- `5c556c16ea8b` — 19285 candidats
  - AVEC connectivite (7824) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (11461) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 12494 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 12435 avec CONNECTED, 59 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 93851 systemes
  - sans CONNECTED : 0.0% sur 21073 systemes
