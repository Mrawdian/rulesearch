...
genere 2026-08-26 20:55 UTC — 63959 systemes evalues
...
- moteur actif `0caa9267db60` (20217 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 29231 | 14542 | 1993 | 976 | 2913 | 2317 | 3112 | 3004 | 10.3% |
...
- candidats AVEC connectivite : 3131, dont T2 : 100%
- candidats SANS connectivite : 4711, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3386 systemes avec CONNECTED sur 26409 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3552 candidats sur 7842 portent les champs bruts (45%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 683 candidats
  - AVEC connectivite (287) : resistance **40.2%**
...
- `62448a55927e` — 683 candidats
  - AVEC connectivite (287) : T0=12.81 T1=0.00 T2=2.86 — pondere **5.71**
...
- TROP-CHER : 3408 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3386 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23908 systemes
  - sans CONNECTED : 0.0% sur 5323 systemes
