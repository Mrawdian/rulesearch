...
genere 2026-08-27 01:51 UTC — 74848 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 9941 systemes
...
- moteur actif `0caa9267db60` (31106 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 34733 | 17284 | 2392 | 1176 | 3444 | 2762 | 3692 | 3539 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 34000 | 7837 | 14451 | 20 | 4720 | 1769 | 18 | 5185 | 15.2% |
...
- candidats AVEC connectivite : 3666, dont T2 : 100%
- candidats SANS connectivite : 5495, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3966 systemes avec CONNECTED sur 30914 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4871 candidats sur 9161 portent les champs bruts (53%).*
...
- `ab89a63b01ef` — 1194 candidats
  - AVEC connectivite (486) : resistance **41.2%**
...
- `ab89a63b01ef` — 1194 candidats
  - AVEC connectivite (486) : T0=13.02 T1=0.00 T2=3.03 — pondere **6.07**
...
- TROP-CHER : 3994 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3966 avec CONNECTED, 28 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 28413 systemes
  - sans CONNECTED : 0.0% sur 6320 systemes
