...
genere 2026-08-31 19:53 UTC — 261657 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 178313 systemes
...
- moteur actif `0caa9267db60` (217915 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 129085 | 64174 | 8728 | 4327 | 13076 | 10202 | 13600 | 13294 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 126457 | 29473 | 53398 | 56 | 17535 | 6533 | 56 | 19396 | 15.3% |
...
- candidats AVEC connectivite : 13421, dont T2 : 100%
- candidats SANS connectivite : 19706, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13874 systemes avec CONNECTED sur 107815 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*28837 candidats sur 33127 portent les champs bruts (87%).*

- `5c556c16ea8b` — 22872 candidats
  - AVEC connectivite (9293) : resistance **41.1%**
  - SANS connectivite (13579) : resistance **21.4%**
...
- `5c556c16ea8b` — 22872 candidats
  - AVEC connectivite (9293) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (13579) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.32**
...
## cout
- temps total 80.8 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 13940 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13874 avec CONNECTED, 66 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 105314 systemes
  - sans CONNECTED : 0.0% sur 23771 systemes
