...
genere 2026-08-26 04:31 UTC — 23559 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 14585 systemes
...
| connect | 4 | 3 | 11850 | 5933 | 775 | 410 | 1140 | 957 | 1285 | 1201 | 10.1% |
| ref | 4 | 3 | 11585 | 2755 | 4873 | 7 | 1571 | 592 | 4 | 1783 | 15.4% |
...
- candidats AVEC connectivite : 1204, dont T2 : 100%
...
- **1285 systemes avec CONNECTED sur 9760 (13.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1826 candidats
  - AVEC connectivite (725) : T0=13.35 T1=0.00 T2=2.85 — pondere **5.69**
...
- TROP-CHER : 1289 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1285 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 9703 systemes
  - sans CONNECTED : 0.0% sur 2147 systemes
