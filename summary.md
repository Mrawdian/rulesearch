...
genere 2026-09-07 05:30 UTC — 429194 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 345850 systemes
...
- moteur actif `0caa9267db60` (385452 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 213656 | 106084 | 14553 | 7121 | 21658 | 16788 | 22717 | 22014 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 209423 | 48752 | 88293 | 81 | 29194 | 10815 | 75 | 32195 | 15.4% |
...
- candidats AVEC connectivite : 22141, dont T2 : 100%
- candidats SANS connectivite : 32505, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **22991 systemes avec CONNECTED sur 176873 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*50356 candidats sur 54646 portent les champs bruts (92%).*

- `5c556c16ea8b` — 44391 candidats
  - AVEC connectivite (18013) : resistance **41.1%**
  - SANS connectivite (26378) : resistance **21.3%**
...
- `5c556c16ea8b` — 44391 candidats
  - AVEC connectivite (18013) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (26378) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
## cout
- temps total 133.6 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 23076 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 22991 avec CONNECTED, 85 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 174372 systemes
  - sans CONNECTED : 0.0% sur 39284 systemes
