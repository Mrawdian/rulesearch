...
genere 2026-09-07 06:06 UTC — 429771 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 346427 systemes
...
- moteur actif `0caa9267db60` (386029 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 213954 | 106249 | 14566 | 7132 | 21685 | 16808 | 22745 | 22043 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 209702 | 48816 | 88416 | 81 | 29236 | 10824 | 75 | 32236 | 15.4% |
...
- candidats SANS connectivite : 32546, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23019 systemes avec CONNECTED sur 177130 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*50426 candidats sur 54716 portent les champs bruts (92%).*

- `5c556c16ea8b` — 44461 candidats
  - AVEC connectivite (18042) : resistance **41.1%**
  - SANS connectivite (26419) : resistance **21.3%**
...
- `5c556c16ea8b` — 44461 candidats
  ...
  - SANS connectivite (26419) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 23104 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23019 avec CONNECTED, 85 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 174629 systemes
  - sans CONNECTED : 0.0% sur 39325 systemes
