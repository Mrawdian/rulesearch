...
genere 2026-08-26 22:09 UTC — 66684 systemes evalues
...
- moteur actif `0caa9267db60` (22942 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 30608 | 15209 | 2094 | 1029 | 3056 | 2435 | 3260 | 3139 | 10.3% |
...
- candidats AVEC connectivite : 3266, dont T2 : 100%
- candidats SANS connectivite : 4917, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3534 systemes avec CONNECTED sur 27523 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3893 candidats sur 8183 portent les champs bruts (48%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 216 candidats
  - AVEC connectivite (86) : resistance **43.4%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 216 candidats
  - AVEC connectivite (86) : T0=13.20 T1=0.00 T2=3.07 — pondere **6.14**
  - SANS connectivite (130) : T0=16.07 T1=0.00 T2=2.71 — pondere **5.42**
  - test de permutation : **p = 0.0960** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- TROP-CHER : 3557 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3534 avec CONNECTED, 23 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 25022 systemes
  - sans CONNECTED : 0.0% sur 5586 systemes
