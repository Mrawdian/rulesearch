...
genere 2026-08-26 07:24 UTC — 30832 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 21858 systemes
...
| connect | 4 | 3 | 14372 | 7181 | 940 | 497 | 1408 | 1142 | 1568 | 1450 | 10.1% |
| d4 | 4 | 4 | 2259 | 1042 | 573 | 13 | 165 | 152 | 110 | 148 | 6.6% |
| ref | 4 | 3 | 14077 | 3338 | 5911 | 9 | 1936 | 717 | 6 | 2160 | 15.3% |
...
- candidats AVEC connectivite : 1486, dont T2 : 100%
- candidats SANS connectivite : 2279, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1675 systemes avec CONNECTED sur 12753 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2600 candidats
  - AVEC connectivite (1007) : T0=13.19 T1=0.00 T2=2.88 — pondere **5.76**
  - SANS connectivite (1593) : T0=15.89 T1=0.01 T2=2.63 — pondere **5.27**
...
## cout
- temps total 9.8 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 1684 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1675 avec CONNECTED, 9 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 11763 systemes
  - sans CONNECTED : 0.0% sur 2609 systemes
