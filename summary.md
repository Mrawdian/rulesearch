...
genere 2026-08-26 23:13 UTC — 68912 systemes evalues
...
- moteur actif `0caa9267db60` (25170 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 31054 | 7153 | 13202 | 18 | 4299 | 1614 | 14 | 4754 | 15.3% |
...
- candidats SANS connectivite : 5064, dont T2 : 100%
...
*4148 candidats sur 8438 portent les champs bruts (49%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 471 candidats
  - AVEC connectivite (194) : resistance **41.7%**
  - SANS connectivite (277) : resistance **22.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 471 candidats
  ...
  - SANS connectivite (277) : T0=16.02 T1=0.00 T2=2.65 — pondere **5.31**
...
**6 serie(s) reproductible(s) sur 13 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `ab89a63b01ef` (p=0.0130), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
