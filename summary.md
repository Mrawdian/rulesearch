...
genere 2026-08-26 22:30 UTC — 67364 systemes evalues
...
- moteur actif `0caa9267db60` (23622 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 30949 | 15367 | 2118 | 1038 | 3083 | 2466 | 3303 | 3180 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 30300 | 6979 | 12866 | 18 | 4196 | 1574 | 14 | 4653 | 15.4% |
...
- candidats AVEC connectivite : 3307, dont T2 : 100%
- candidats SANS connectivite : 4963, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3577 systemes avec CONNECTED sur 27801 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3980 candidats sur 8270 portent les champs bruts (48%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 303 candidats
  - AVEC connectivite (127) : resistance **43.1%**
  - SANS connectivite (176) : resistance **22.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 303 candidats
  - AVEC connectivite (127) : T0=12.83 T1=0.00 T2=3.09 — pondere **6.17**
  - SANS connectivite (176) : T0=16.15 T1=0.00 T2=2.81 — pondere **5.62**
  - test de permutation : **p = 0.1194** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 25300 systemes
  - sans CONNECTED : 0.0% sur 5649 systemes
