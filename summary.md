...
genere 2026-08-26 20:27 UTC — 62982 systemes evalues
...
- moteur actif `0caa9267db60` (19240 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 28737 | 14309 | 1969 | 963 | 2850 | 2277 | 3054 | 2954 | 10.3% |
...
- candidats AVEC connectivite : 3081, dont T2 : 100%
- candidats SANS connectivite : 4634, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3328 systemes avec CONNECTED sur 26011 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3425 candidats sur 7715 portent les champs bruts (44%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 556 candidats
  - AVEC connectivite (237) : resistance **39.6%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 556 candidats
  - AVEC connectivite (237) : T0=12.84 T1=0.00 T2=2.83 — pondere **5.66**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23510 systemes
  - sans CONNECTED : 0.0% sur 5227 systemes
