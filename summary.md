...
genere 2026-09-06 18:28 UTC — 418690 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 335346 systemes
...
- moteur actif `0caa9267db60` (374948 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 208353 | 103442 | 14191 | 6939 | 21117 | 16395 | 22151 | 21473 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 204222 | 47491 | 86158 | 80 | 28478 | 10538 | 73 | 31387 | 15.4% |
...
- candidats AVEC connectivite : 21600, dont T2 : 100%
- candidats SANS connectivite : 31697, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **22425 systemes avec CONNECTED sur 172523 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*49007 candidats sur 53297 portent les champs bruts (92%).*

- `5c556c16ea8b` — 43042 candidats
  - AVEC connectivite (17472) : resistance **41.1%**
  - SANS connectivite (25570) : resistance **21.3%**
...
- `5c556c16ea8b` — 43042 candidats
  - AVEC connectivite (17472) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (25570) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 170022 systemes
  - sans CONNECTED : 0.0% sur 38331 systemes
