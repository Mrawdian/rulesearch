...
genere 2026-08-30 10:15 UTC — 215093 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 131749 systemes
...
- moteur actif `0caa9267db60` (171351 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 105565 | 52402 | 7194 | 3518 | 10644 | 8397 | 11187 | 10846 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 103413 | 24125 | 43672 | 48 | 14281 | 5335 | 41 | 15903 | 15.4% |
...
- candidats AVEC connectivite : 10973, dont T2 : 100%
- candidats SANS connectivite : 16213, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11461 systemes avec CONNECTED sur 88613 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*22896 candidats sur 27186 portent les champs bruts (84%).*

- `5c556c16ea8b` — 16931 candidats
  - AVEC connectivite (6845) : resistance **41.1%**
  - SANS connectivite (10086) : resistance **21.5%**
...
- `5c556c16ea8b` — 16931 candidats
  - AVEC connectivite (6845) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (10086) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 11512 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 11461 avec CONNECTED, 51 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 86112 systemes
  - sans CONNECTED : 0.0% sur 19453 systemes
