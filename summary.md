...
genere 2026-08-27 04:14 UTC — 80020 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 15113 systemes
...
- moteur actif `0caa9267db60` (36278 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 36554 | 8406 | 15576 | 21 | 5052 | 1908 | 20 | 5571 | 15.2% |
...
- candidats SANS connectivite : 5881, dont T2 : 100%
...
*5557 candidats sur 9847 portent les champs bruts (56%).*
...
- `ab89a63b01ef` — 1880 candidats
  - AVEC connectivite (786) : resistance **41.4%**
  - SANS connectivite (1094) : resistance **21.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1880 candidats
  ...
  - SANS connectivite (1094) : T0=15.91 T1=0.00 T2=2.69 — pondere **5.37**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
