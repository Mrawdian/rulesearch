...
genere 2026-08-27 15:54 UTC — 104250 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 20906 systemes
...
- moteur actif `0caa9267db60` (60508 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 49572 | 24681 | 3430 | 1698 | 4925 | 3927 | 5231 | 5041 | 10.2% |
...
- candidats AVEC connectivite : 5168, dont T2 : 100%
- candidats SANS connectivite : 7718, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5505 systemes avec CONNECTED sur 42996 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*8596 candidats sur 12886 portent les champs bruts (67%).*
...
- `5c556c16ea8b` — 2631 candidats
  - AVEC connectivite (1040) : resistance **41.7%**
...
- `5c556c16ea8b` — 2631 candidats
  - AVEC connectivite (1040) : T0=13.02 T1=0.00 T2=3.03 — pondere **6.06**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 40495 systemes
  - sans CONNECTED : 0.0% sur 9077 systemes
