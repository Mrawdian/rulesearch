...
| connect | 4 | 3 | 17410 | 8712 | 1125 | 601 | 1724 | 1386 | 1891 | 1751 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 17049 | 4013 | 7210 | 12 | 2334 | 861 | 7 | 2612 | 15.3% |
...
- candidats AVEC connectivite : 1878, dont T2 : 100%
- candidats SANS connectivite : 2922, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2165 systemes avec CONNECTED sur 16724 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*510 candidats sur 4800 portent les champs bruts (11%).*
...
- `e3baecf8377b` — 246 candidats
  - AVEC connectivite (95) : resistance **43.3%**
  - SANS connectivite (151) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 246 candidats
  - AVEC connectivite (95) : T0=13.03 T1=0.00 T2=3.15 — pondere **6.29**
  - SANS connectivite (151) : T0=16.13 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14223 systemes
  - sans CONNECTED : 0.0% sur 3187 systemes
