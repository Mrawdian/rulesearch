...
**7466 enregistrements (58%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 6501 | 3269 | 420 | 235 | 623 | 526 | 677 | 676 | 10.4% |
| ref | 4 | 3 | 6340 | 1538 | 2626 | 1 | 851 | 314 | 2 | 1008 | 15.9% |
...
- candidats AVEC connectivite : 679, dont T2 : 100%
- candidats SANS connectivite : 1012, dont T2 : 100%
...
- **677 systemes avec CONNECTED sur 5383 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 526 candidats
  - AVEC connectivite (200) : T0=13.23 T1=0.00 T2=2.92 — pondere **5.83**
  - SANS connectivite (326) : T0=15.82 T1=0.00 T2=2.64 — pondere **5.28**
...
## cout
- temps total 3.9 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 679 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 677 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 5326 systemes
  - sans CONNECTED : 0.0% sur 1175 systemes
