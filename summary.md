...
| connect | 4 | 3 | 17530 | 8775 | 1131 | 603 | 1739 | 1392 | 1903 | 1766 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 17166 | 4044 | 7260 | 12 | 2347 | 868 | 7 | 2628 | 15.3% |
...
- candidats AVEC connectivite : 1893, dont T2 : 100%
- candidats SANS connectivite : 2938, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2177 systemes avec CONNECTED sur 16819 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*541 candidats sur 4831 portent les champs bruts (11%).*
...
- `e3baecf8377b` — 277 candidats
  - AVEC connectivite (110) : resistance **44.2%**
  - SANS connectivite (167) : resistance **21.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 277 candidats
  - AVEC connectivite (110) : T0=12.97 T1=0.00 T2=3.19 — pondere **6.38**
  - SANS connectivite (167) : T0=16.10 T1=0.00 T2=2.66 — pondere **5.32**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14318 systemes
  - sans CONNECTED : 0.0% sur 3212 systemes
