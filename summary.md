...
genere 2026-08-27 16:06 UTC — 104697 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 21353 systemes
...
- moteur actif `0caa9267db60` (60955 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 49797 | 24803 | 3440 | 1705 | 4945 | 3945 | 5250 | 5066 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 48785 | 11274 | 20718 | 25 | 6744 | 2549 | 23 | 7450 | 15.3% |
...
- candidats AVEC connectivite : 5193, dont T2 : 100%
- candidats SANS connectivite : 7760, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5524 systemes avec CONNECTED sur 43182 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*8663 candidats sur 12953 portent les champs bruts (67%).*
...
- `5c556c16ea8b` — 2698 candidats
  - AVEC connectivite (1065) : resistance **41.6%**
  - SANS connectivite (1633) : resistance **22.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 2698 candidats
  - AVEC connectivite (1065) : T0=13.04 T1=0.00 T2=3.03 — pondere **6.06**
  - SANS connectivite (1633) : T0=15.77 T1=0.00 T2=2.68 — pondere **5.36**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 2280 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 40681 systemes
  - sans CONNECTED : 0.0% sur 9116 systemes
