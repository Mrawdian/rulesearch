...
genere 2026-08-28 01:33 UTC — 123100 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 39756 systemes
...
- moteur actif `0caa9267db60` (79358 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 59096 | 29426 | 4083 | 1998 | 5877 | 4685 | 6207 | 6060 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 57889 | 13367 | 24565 | 28 | 8040 | 2996 | 26 | 8865 | 15.3% |
...
- candidats SANS connectivite : 9175, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6481 systemes avec CONNECTED sur 50742 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11072 candidats sur 15362 portent les champs bruts (72%).*

- `5c556c16ea8b` — 5107 candidats
  - AVEC connectivite (2059) : resistance **41.9%**
  - SANS connectivite (3048) : resistance **22.3%**
...
- `5c556c16ea8b` — 5107 candidats
  ...
  - SANS connectivite (3048) : T0=15.84 T1=0.00 T2=2.71 — pondere **5.42**
...
- TROP-CHER : 6517 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6481 avec CONNECTED, 36 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 48241 systemes
  - sans CONNECTED : 0.0% sur 10855 systemes
