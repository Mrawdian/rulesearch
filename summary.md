...
genere 2026-08-29 22:13 UTC — 197575 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 114231 systemes
...
- moteur actif `0caa9267db60` (153833 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 96712 | 48015 | 6579 | 3253 | 9757 | 7698 | 10203 | 9968 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 94748 | 22099 | 40024 | 43 | 13117 | 4867 | 37 | 14555 | 15.4% |
...
- candidats AVEC connectivite : 10095, dont T2 : 100%
- candidats SANS connectivite : 14865, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10477 systemes avec CONNECTED sur 81382 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*20670 candidats sur 24960 portent les champs bruts (83%).*

- `5c556c16ea8b` — 14705 candidats
  - AVEC connectivite (5967) : resistance **41.2%**
  - SANS connectivite (8738) : resistance **21.5%**
...
- `5c556c16ea8b` — 14705 candidats
  - AVEC connectivite (5967) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (8738) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.32**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 78881 systemes
  - sans CONNECTED : 0.0% sur 17831 systemes
