...
genere 2026-08-28 07:10 UTC — 133317 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 49973 systemes
...
- moteur actif `0caa9267db60` (89575 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 64257 | 31930 | 4413 | 2180 | 6441 | 5113 | 6752 | 6601 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 62945 | 14563 | 26648 | 29 | 8763 | 3252 | 28 | 9660 | 15.3% |
...
- candidats AVEC connectivite : 6728, dont T2 : 100%
- candidats SANS connectivite : 9970, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7026 systemes avec CONNECTED sur 54912 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12408 candidats sur 16698 portent les champs bruts (74%).*

- `5c556c16ea8b` — 6443 candidats
  - AVEC connectivite (2600) : resistance **41.5%**
  - SANS connectivite (3843) : resistance **21.9%**
...
- `5c556c16ea8b` — 6443 candidats
  - AVEC connectivite (2600) : T0=12.98 T1=0.00 T2=3.02 — pondere **6.04**
  - SANS connectivite (3843) : T0=15.86 T1=0.00 T2=2.68 — pondere **5.36**
...
## cout
- temps total 41.0 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 7064 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7026 avec CONNECTED, 38 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 52411 systemes
  - sans CONNECTED : 0.0% sur 11846 systemes
