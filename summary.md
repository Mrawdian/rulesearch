...
genere 2026-09-01 05:59 UTC — 274428 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 191084 systemes
...
- moteur actif `0caa9267db60` (230686 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 135514 | 67345 | 9159 | 4540 | 13746 | 10720 | 14309 | 13938 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 132799 | 30937 | 56141 | 58 | 18408 | 6867 | 59 | 20319 | 15.3% |
...
- candidats AVEC connectivite : 14065, dont T2 : 100%
- candidats SANS connectivite : 20629, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14583 systemes avec CONNECTED sur 113066 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*30404 candidats sur 34694 portent les champs bruts (88%).*

- `5c556c16ea8b` — 24439 candidats
  - AVEC connectivite (9937) : resistance **41.0%**
  - SANS connectivite (14502) : resistance **21.3%**
...
- `5c556c16ea8b` — 24439 candidats
  - AVEC connectivite (9937) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (14502) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 14652 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14583 avec CONNECTED, 69 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 110565 systemes
  - sans CONNECTED : 0.0% sur 24949 systemes
