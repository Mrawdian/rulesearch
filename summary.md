...
genere 2026-09-09 13:58 UTC — 480101 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 396757 systemes
...
- moteur actif `0caa9267db60` (436359 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 239384 | 118822 | 16328 | 8019 | 24233 | 18778 | 25492 | 24671 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 234602 | 54666 | 98846 | 92 | 32686 | 12123 | 84 | 36086 | 15.4% |
...
- candidats SANS connectivite : 36396, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25766 systemes avec CONNECTED sur 197921 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*56904 candidats sur 61194 portent les champs bruts (93%).*

- `5c556c16ea8b` — 50939 candidats
  - AVEC connectivite (20670) : resistance **41.2%**
  - SANS connectivite (30269) : resistance **21.3%**
...
- `5c556c16ea8b` — 50939 candidats
  ...
  - SANS connectivite (30269) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 195420 systemes
  - sans CONNECTED : 0.0% sur 43964 systemes
