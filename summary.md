...
genere 2026-08-27 23:54 UTC — 119637 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 36293 systemes
...
- moteur actif `0caa9267db60` (75895 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 57335 | 28563 | 3963 | 1940 | 5684 | 4536 | 6055 | 5860 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 56187 | 12960 | 23845 | 26 | 7816 | 2901 | 25 | 8612 | 15.3% |
...
- candidats AVEC connectivite : 5987, dont T2 : 100%
- candidats SANS connectivite : 8922, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6329 systemes avec CONNECTED sur 49342 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10619 candidats sur 14909 portent les champs bruts (71%).*

- `5c556c16ea8b` — 4654 candidats
  - AVEC connectivite (1859) : resistance **42.0%**
  - SANS connectivite (2795) : resistance **22.5%**
...
- `5c556c16ea8b` — 4654 candidats
  - AVEC connectivite (1859) : T0=12.98 T1=0.00 T2=3.05 — pondere **6.11**
  - SANS connectivite (2795) : T0=15.78 T1=0.00 T2=2.72 — pondere **5.44**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 46841 systemes
