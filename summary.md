...
genere 2026-08-26 19:35 UTC — 61057 systemes evalues
...
- moteur actif `0caa9267db60` (17315 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27765 | 13840 | 1897 | 933 | 2746 | 2203 | 2949 | 2848 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 27177 | 6291 | 11492 | 15 | 3783 | 1400 | 11 | 4185 | 15.4% |
...
- candidats AVEC connectivite : 2975, dont T2 : 100%
- candidats SANS connectivite : 4495, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3223 systemes avec CONNECTED sur 25218 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3180 candidats sur 7470 portent les champs bruts (43%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 311 candidats
  - AVEC connectivite (131) : resistance **39.6%**
  - SANS connectivite (180) : resistance **19.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 311 candidats
  - AVEC connectivite (131) : T0=13.08 T1=0.00 T2=2.91 — pondere **5.82**
  - SANS connectivite (180) : T0=16.05 T1=0.00 T2=2.62 — pondere **5.23**
  - test de permutation : **p = 0.0950** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- TROP-CHER : 3244 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3223 avec CONNECTED, 21 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22717 systemes
  - sans CONNECTED : 0.0% sur 5048 systemes
