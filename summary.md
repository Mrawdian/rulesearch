...
genere 2026-09-01 08:47 UTC — 277849 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 194505 systemes
...
- moteur actif `0caa9267db60` (234107 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 137245 | 68212 | 9290 | 4585 | 13918 | 10835 | 14507 | 14119 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 134489 | 31355 | 56825 | 58 | 18637 | 6964 | 60 | 20580 | 15.3% |
...
- candidats AVEC connectivite : 14246, dont T2 : 100%
- candidats SANS connectivite : 20890, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14781 systemes avec CONNECTED sur 114494 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*30846 candidats sur 35136 portent les champs bruts (88%).*

- `5c556c16ea8b` — 24881 candidats
  - AVEC connectivite (10118) : resistance **41.0%**
  - SANS connectivite (14763) : resistance **21.3%**
...
- `5c556c16ea8b` — 24881 candidats
  - AVEC connectivite (10118) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (14763) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
## cout
- temps total 86.0 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 14851 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14781 avec CONNECTED, 70 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 111993 systemes
  - sans CONNECTED : 0.0% sur 25252 systemes
