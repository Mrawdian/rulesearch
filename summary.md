...
genere 2026-08-27 15:05 UTC — 102582 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 19238 systemes
...
- moteur actif `0caa9267db60` (58840 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 48723 | 24262 | 3357 | 1670 | 4842 | 3856 | 5147 | 4957 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 47744 | 11043 | 20258 | 25 | 6612 | 2500 | 23 | 7282 | 15.3% |
...
- candidats AVEC connectivite : 5084, dont T2 : 100%
- candidats SANS connectivite : 7592, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5421 systemes avec CONNECTED sur 42311 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*8386 candidats sur 12676 portent les champs bruts (66%).*
...
- `5c556c16ea8b` — 2421 candidats
  - AVEC connectivite (956) : resistance **41.7%**
  - SANS connectivite (1465) : resistance **22.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 2421 candidats
  - AVEC connectivite (956) : T0=13.03 T1=0.00 T2=3.04 — pondere **6.07**
  - SANS connectivite (1465) : T0=15.77 T1=0.00 T2=2.68 — pondere **5.35**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 2280 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 39810 systemes
  - sans CONNECTED : 0.0% sur 8913 systemes
