...
| connect | 4 | 3 | 6426 | 3237 | 418 | 232 | 616 | 512 | 670 | 666 | 10.4% |
...
- candidats AVEC connectivite : 669, dont T2 : 100%
...
- **670 systemes avec CONNECTED sur 5327 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 505 candidats
  - AVEC connectivite (190) : T0=13.23 T1=0.00 T2=2.89 — pondere **5.79**
  - SANS connectivite (315) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.31**
  - test de permutation : **p = 0.0915** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 672 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 670 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 5270 systemes
  - sans CONNECTED : 0.0% sur 1156 systemes
