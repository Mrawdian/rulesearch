...
**7466 enregistrements (54%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 6902 | 3469 | 451 | 242 | 658 | 561 | 722 | 720 | 10.4% |
| ref | 4 | 3 | 6737 | 1623 | 2799 | 1 | 908 | 336 | 2 | 1068 | 15.9% |
...
- candidats AVEC connectivite : 723, dont T2 : 100%
- candidats SANS connectivite : 1072, dont T2 : 100%
...
- **722 systemes avec CONNECTED sur 5713 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 630 candidats
  - AVEC connectivite (244) : T0=13.22 T1=0.00 T2=2.95 — pondere **5.89**
  - SANS connectivite (386) : T0=15.78 T1=0.00 T2=2.64 — pondere **5.28**
...
## cout
- temps total 4.2 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 724 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 722 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 5656 systemes
  - sans CONNECTED : 0.0% sur 1246 systemes
