...
genere 2026-08-26 20:21 UTC — 62803 systemes evalues
...
- moteur actif `0caa9267db60` (19061 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 28647 | 14272 | 1960 | 959 | 2843 | 2273 | 3042 | 2939 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 28041 | 6484 | 11880 | 15 | 3895 | 1442 | 12 | 4313 | 15.4% |
...
- candidats AVEC connectivite : 3066, dont T2 : 100%
- candidats SANS connectivite : 4623, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3316 systemes avec CONNECTED sur 25934 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3399 candidats sur 7689 portent les champs bruts (44%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 530 candidats
  - AVEC connectivite (222) : resistance **39.7%**
  - SANS connectivite (308) : resistance **20.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 530 candidats
  - AVEC connectivite (222) : T0=12.88 T1=0.00 T2=2.86 — pondere **5.71**
  - SANS connectivite (308) : T0=16.18 T1=0.00 T2=2.67 — pondere **5.33**
  - test de permutation : **p = 0.1489** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- TROP-CHER : 3338 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3316 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23433 systemes
  - sans CONNECTED : 0.0% sur 5214 systemes
