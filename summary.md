...
genere 2026-08-26 14:13 UTC — 48405 systemes evalues
...
- moteur actif `0caa9267db60` (4663 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21366 | 10660 | 1420 | 737 | 2112 | 1698 | 2285 | 2184 | 10.2% |
...
- candidats AVEC connectivite : 2311, dont T2 : 100%
- candidats SANS connectivite : 3523, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2559 systemes avec CONNECTED sur 19962 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1544 candidats sur 5834 portent les champs bruts (26%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 429 candidats
  - AVEC connectivite (173) : resistance **40.0%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 429 candidats
  - AVEC connectivite (173) : T0=13.45 T1=0.00 T2=2.97 — pondere **5.94**
...
- TROP-CHER : 2576 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2559 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17461 systemes
