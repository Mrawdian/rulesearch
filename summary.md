...
genere 2026-08-26 22:04 UTC — 66506 systemes evalues
...
- moteur actif `0caa9267db60` (22764 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 29873 | 6887 | 12697 | 17 | 4125 | 1543 | 13 | 4591 | 15.4% |
...
- candidats SANS connectivite : 4901, dont T2 : 100%
...
*3871 candidats sur 8161 portent les champs bruts (47%).*
...
- `23303c299f39` — 225 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 194 candidats
  - AVEC connectivite (80) : resistance **43.2%**
  - SANS connectivite (114) : resistance **22.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 194 candidats
  ...
  - SANS connectivite (114) : T0=15.83 T1=0.00 T2=2.75 — pondere **5.49**
  - test de permutation : **p = 0.2184** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
