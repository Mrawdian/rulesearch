...
genere 2026-08-27 02:31 UTC — 76240 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 11333 systemes
...
- moteur actif `0caa9267db60` (32498 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 35438 | 17634 | 2436 | 1201 | 3513 | 2810 | 3771 | 3616 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 34687 | 7989 | 14755 | 20 | 4804 | 1815 | 19 | 5285 | 15.2% |
...
- candidats AVEC connectivite : 3743, dont T2 : 100%
- candidats SANS connectivite : 5595, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4045 systemes avec CONNECTED sur 31502 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5048 candidats sur 9338 portent les champs bruts (54%).*
...
- `ab89a63b01ef` — 1371 candidats
  - AVEC connectivite (563) : resistance **41.0%**
  - SANS connectivite (808) : resistance **22.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1371 candidats
  - AVEC connectivite (563) : T0=13.02 T1=0.00 T2=3.03 — pondere **6.05**
  - SANS connectivite (808) : T0=15.91 T1=0.00 T2=2.69 — pondere **5.38**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- TROP-CHER : 4074 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4045 avec CONNECTED, 29 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 29001 systemes
  - sans CONNECTED : 0.0% sur 6437 systemes
