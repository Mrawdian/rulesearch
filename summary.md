...
genere 2026-08-26 13:04 UTC — 45509 systemes evalues
...
- moteur actif `0caa9267db60` (1767 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 19905 | 9945 | 1297 | 686 | 1998 | 1569 | 2140 | 2024 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 19489 | 4572 | 8233 | 13 | 2684 | 1006 | 7 | 2974 | 15.3% |
...
- candidats AVEC connectivite : 2151, dont T2 : 100%
- candidats SANS connectivite : 3284, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2414 systemes avec CONNECTED sur 18755 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1145 candidats sur 5435 portent les champs bruts (21%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 30 candidats
  - AVEC connectivite (13) : resistance **37.5%**
  - SANS connectivite (17) : resistance **18.7%**
...
- `06fe04a859f1` — 30 candidats
  - AVEC connectivite (13) : T0=13.92 T1=0.00 T2=2.38 — pondere **4.77**
  - SANS connectivite (17) : T0=16.24 T1=0.00 T2=2.41 — pondere **4.82**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 16254 systemes
  - sans CONNECTED : 0.0% sur 3651 systemes
