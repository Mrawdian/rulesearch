...
genere 2026-09-01 10:10 UTC — 279605 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 196261 systemes
...
- moteur actif `0caa9267db60` (235863 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 138124 | 68656 | 9342 | 4610 | 14013 | 10894 | 14597 | 14226 | 10.3% |
...
- candidats AVEC connectivite : 14353, dont T2 : 100%
...
- **14871 systemes avec CONNECTED sur 115208 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*31082 candidats sur 35372 portent les champs bruts (88%).*

- `5c556c16ea8b` — 25117 candidats
  - AVEC connectivite (10225) : resistance **41.0%**
...
- `5c556c16ea8b` — 25117 candidats
  - AVEC connectivite (10225) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 14941 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14871 avec CONNECTED, 70 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 112707 systemes
  - sans CONNECTED : 0.0% sur 25417 systemes
