...
genere 2026-08-27 00:17 UTC — 71351 systemes evalues
...
- moteur actif `0caa9267db60` (27609 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 32970 | 16377 | 2267 | 1116 | 3278 | 2624 | 3515 | 3370 | 10.2% |
...
- candidats AVEC connectivite : 3497, dont T2 : 100%
- candidats SANS connectivite : 5246, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3789 systemes avec CONNECTED sur 29455 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4453 candidats sur 8743 portent les champs bruts (51%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 776 candidats
  - AVEC connectivite (317) : resistance **41.4%**
...
- `ab89a63b01ef` — 776 candidats
  - AVEC connectivite (317) : T0=13.17 T1=0.00 T2=3.08 — pondere **6.15**
...
- TROP-CHER : 3814 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3789 avec CONNECTED, 25 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 26954 systemes
  - sans CONNECTED : 0.0% sur 6016 systemes
