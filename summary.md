...
genere 2026-08-30 10:51 UTC — 216008 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 132664 systemes
...
- moteur actif `0caa9267db60` (172266 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 106028 | 52639 | 7234 | 3538 | 10676 | 8429 | 11232 | 10898 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 103865 | 24227 | 43879 | 49 | 14335 | 5359 | 41 | 15967 | 15.4% |
...
- candidats SANS connectivite : 16277, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11506 systemes avec CONNECTED sur 89003 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*23012 candidats sur 27302 portent les champs bruts (84%).*

- `5c556c16ea8b` — 17047 candidats
  - AVEC connectivite (6897) : resistance **41.1%**
  - SANS connectivite (10150) : resistance **21.5%**
...
- `5c556c16ea8b` — 17047 candidats
  ...
  - SANS connectivite (10150) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 11557 systemes abandonnes (5.4% des systemes), 96% du temps total
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 86502 systemes
  - sans CONNECTED : 0.0% sur 19526 systemes
