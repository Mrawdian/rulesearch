...
genere 2026-08-30 05:04 UTC — 208023 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 124679 systemes
...
- moteur actif `0caa9267db60` (164281 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 101989 | 50649 | 6942 | 3411 | 10292 | 8136 | 10745 | 10483 | 10.3% |
...
- candidats AVEC connectivite : 10610, dont T2 : 100%
...
- **11019 systemes avec CONNECTED sur 85678 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*22012 candidats sur 26302 portent les champs bruts (84%).*

- `5c556c16ea8b` — 16047 candidats
  - AVEC connectivite (6482) : resistance **41.1%**
...
- `5c556c16ea8b` — 16047 candidats
  - AVEC connectivite (6482) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
...
- TROP-CHER : 11067 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11019 avec CONNECTED, 48 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 83177 systemes
  - sans CONNECTED : 0.0% sur 18812 systemes
