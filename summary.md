...
genere 2026-08-26 19:41 UTC — 61219 systemes evalues
...
- moteur actif `0caa9267db60` (17477 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27854 | 13885 | 1905 | 935 | 2755 | 2209 | 2962 | 2853 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 27250 | 6305 | 11529 | 15 | 3791 | 1404 | 11 | 4195 | 15.4% |
...
- candidats AVEC connectivite : 2980, dont T2 : 100%
- candidats SANS connectivite : 4505, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3236 systemes avec CONNECTED sur 25292 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3195 candidats sur 7485 portent les champs bruts (43%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 326 candidats
  - AVEC connectivite (136) : resistance **39.3%**
  - SANS connectivite (190) : resistance **19.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 326 candidats
  - AVEC connectivite (136) : T0=13.08 T1=0.00 T2=2.87 — pondere **5.74**
  - SANS connectivite (190) : T0=16.12 T1=0.00 T2=2.64 — pondere **5.28**
...
- TROP-CHER : 3257 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3236 avec CONNECTED, 21 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22791 systemes
  - sans CONNECTED : 0.0% sur 5063 systemes
