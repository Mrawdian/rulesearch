...
genere 2026-09-01 03:24 UTC — 271126 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 187782 systemes
...
- moteur actif `0caa9267db60` (227384 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 133857 | 66509 | 9051 | 4492 | 13575 | 10598 | 14140 | 13755 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 131154 | 30566 | 55420 | 57 | 18179 | 6773 | 57 | 20092 | 15.3% |
...
- candidats AVEC connectivite : 13882, dont T2 : 100%
- candidats SANS connectivite : 20402, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14414 systemes avec CONNECTED sur 111704 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*29994 candidats sur 34284 portent les champs bruts (87%).*

- `5c556c16ea8b` — 24029 candidats
  - AVEC connectivite (9754) : resistance **41.0%**
  - SANS connectivite (14275) : resistance **21.3%**
...
- `5c556c16ea8b` — 24029 candidats
  - AVEC connectivite (9754) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (14275) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 14481 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14414 avec CONNECTED, 67 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 109203 systemes
  - sans CONNECTED : 0.0% sur 24654 systemes
