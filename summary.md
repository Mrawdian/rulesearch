...
genere 2026-08-26 16:01 UTC — 52643 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 7460 systemes
...
- moteur actif `0caa9267db60` (8901 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23519 | 11720 | 1591 | 804 | 2346 | 1866 | 2512 | 2384 | 10.1% |
...
- candidats AVEC connectivite : 2511, dont T2 : 100%
- candidats SANS connectivite : 3857, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2786 systemes avec CONNECTED sur 21696 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2078 candidats sur 6368 portent les champs bruts (33%).*
...
- `06fe04a859f1` — 963 candidats
  - AVEC connectivite (373) : resistance **41.4%**
...
- `06fe04a859f1` — 963 candidats
  - AVEC connectivite (373) : T0=13.21 T1=0.00 T2=3.05 — pondere **6.10**
...
- TROP-CHER : 2806 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2786 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19195 systemes
  - sans CONNECTED : 0.0% sur 4324 systemes
