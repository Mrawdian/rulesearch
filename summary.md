...
genere 2026-09-06 04:48 UTC — 405549 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 322205 systemes
...
- moteur actif `0caa9267db60` (361807 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 201710 | 100145 | 13756 | 6715 | 20469 | 15868 | 21418 | 20775 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 197724 | 45979 | 83432 | 78 | 27544 | 10217 | 73 | 30384 | 15.4% |
...
- candidats AVEC connectivite : 20902, dont T2 : 100%
- candidats SANS connectivite : 30694, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21692 systemes avec CONNECTED sur 167077 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*47306 candidats sur 51596 portent les champs bruts (92%).*

- `5c556c16ea8b` — 41341 candidats
  - AVEC connectivite (16774) : resistance **41.1%**
  - SANS connectivite (24567) : resistance **21.3%**
...
- `5c556c16ea8b` — 41341 candidats
  - AVEC connectivite (16774) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (24567) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 21775 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21692 avec CONNECTED, 83 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 164576 systemes
  - sans CONNECTED : 0.0% sur 37134 systemes
