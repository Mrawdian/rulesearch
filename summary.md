...
genere 2026-09-08 10:21 UTC — 455504 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 372160 systemes
...
- moteur actif `0caa9267db60` (411762 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 226954 | 112717 | 15438 | 7585 | 22960 | 17792 | 24195 | 23378 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 222435 | 51802 | 93752 | 88 | 30983 | 11507 | 81 | 34204 | 15.4% |
...
- candidats AVEC connectivite : 23505, dont T2 : 100%
...
- **24469 systemes avec CONNECTED sur 187825 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*53729 candidats sur 58019 portent les champs bruts (93%).*

- `5c556c16ea8b` — 47764 candidats
  - AVEC connectivite (19377) : resistance **41.1%**
...
- `5c556c16ea8b` — 47764 candidats
  - AVEC connectivite (19377) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 24560 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 24469 avec CONNECTED, 91 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 185324 systemes
  - sans CONNECTED : 0.0% sur 41630 systemes
