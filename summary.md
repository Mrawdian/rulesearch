...
genere 2026-08-26 23:47 UTC — 70236 systemes evalues
...
- moteur actif `0caa9267db60` (26494 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 32415 | 16125 | 2218 | 1093 | 3227 | 2579 | 3455 | 3304 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 31706 | 7318 | 13460 | 18 | 4388 | 1656 | 14 | 4852 | 15.3% |
...
- candidats AVEC connectivite : 3431, dont T2 : 100%
- candidats SANS connectivite : 5162, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3729 systemes avec CONNECTED sur 29005 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4303 candidats sur 8593 portent les champs bruts (50%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 626 candidats
  - AVEC connectivite (251) : resistance **42.2%**
  - SANS connectivite (375) : resistance **22.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 626 candidats
  - AVEC connectivite (251) : T0=13.06 T1=0.00 T2=3.14 — pondere **6.27**
  - SANS connectivite (375) : T0=15.94 T1=0.00 T2=2.65 — pondere **5.29**
...
## cout
- temps total 21.8 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 3753 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3729 avec CONNECTED, 24 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 26504 systemes
  - sans CONNECTED : 0.0% sur 5911 systemes
