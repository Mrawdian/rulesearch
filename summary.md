...
genere 2026-09-02 15:05 UTC — 313960 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 230616 systemes
...
- moteur actif `0caa9267db60` (270218 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 155469 | 77237 | 10571 | 5194 | 15804 | 12241 | 16480 | 15947 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 152376 | 35496 | 64446 | 64 | 21049 | 7886 | 63 | 23360 | 15.3% |
...
- candidats AVEC connectivite : 16074, dont T2 : 100%
- candidats SANS connectivite : 23670, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16754 systemes avec CONNECTED sur 129400 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*35454 candidats sur 39744 portent les champs bruts (89%).*

- `5c556c16ea8b` — 29489 candidats
  - AVEC connectivite (11946) : resistance **41.1%**
  - SANS connectivite (17543) : resistance **21.3%**
...
- `5c556c16ea8b` — 29489 candidats
  - AVEC connectivite (11946) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (17543) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
## cout
- temps total 97.5 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 16827 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16754 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 126899 systemes
  - sans CONNECTED : 0.0% sur 28570 systemes
