...
| connect | 4 | 3 | 17604 | 8810 | 1134 | 608 | 1749 | 1401 | 1913 | 1768 | 10.0% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 17238 | 4053 | 7292 | 12 | 2358 | 873 | 7 | 2643 | 15.3% |
...
- candidats AVEC connectivite : 1895, dont T2 : 100%
- candidats SANS connectivite : 2953, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2187 systemes avec CONNECTED sur 16877 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*558 candidats sur 4848 portent les champs bruts (12%).*
...
- `e3baecf8377b` — 294 candidats
  - AVEC connectivite (112) : resistance **44.3%**
  - SANS connectivite (182) : resistance **21.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 294 candidats
  - AVEC connectivite (112) : T0=12.94 T1=0.00 T2=3.19 — pondere **6.38**
  - SANS connectivite (182) : T0=16.10 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 2204 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2187 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14376 systemes
  - sans CONNECTED : 0.0% sur 3228 systemes
