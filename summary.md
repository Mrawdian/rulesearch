...
genere 2026-08-26 23:17 UTC — 69060 systemes evalues
...
- moteur actif `0caa9267db60` (25318 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 31817 | 15804 | 2186 | 1072 | 3165 | 2535 | 3398 | 3252 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 31128 | 7172 | 13231 | 18 | 4309 | 1616 | 14 | 4768 | 15.3% |
...
- candidats AVEC connectivite : 3379, dont T2 : 100%
- candidats SANS connectivite : 5078, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3672 systemes avec CONNECTED sur 28517 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4167 candidats sur 8457 portent les champs bruts (49%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 490 candidats
  - AVEC connectivite (199) : resistance **42.0%**
  - SANS connectivite (291) : resistance **22.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 490 candidats
  - AVEC connectivite (199) : T0=12.98 T1=0.00 T2=3.08 — pondere **6.15**
  - SANS connectivite (291) : T0=16.05 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 3696 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 3672 avec CONNECTED, 24 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 26016 systemes
  - sans CONNECTED : 0.0% sur 5801 systemes
