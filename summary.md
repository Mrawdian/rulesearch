...
genere 2026-09-01 21:42 UTC — 293668 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 210324 systemes
...
- moteur actif `0caa9267db60` (249926 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 145234 | 72122 | 9875 | 4866 | 14751 | 11443 | 15363 | 14939 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 142319 | 33093 | 60194 | 61 | 19731 | 7356 | 63 | 21810 | 15.3% |
...
- candidats AVEC connectivite : 15066, dont T2 : 100%
- candidats SANS connectivite : 22120, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15637 systemes avec CONNECTED sur 121023 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*32896 candidats sur 37186 portent les champs bruts (88%).*

- `5c556c16ea8b` — 26931 candidats
  - AVEC connectivite (10938) : resistance **41.0%**
  - SANS connectivite (15993) : resistance **21.3%**
...
- `5c556c16ea8b` — 26931 candidats
  - AVEC connectivite (10938) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (15993) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 15710 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15637 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 118522 systemes
  - sans CONNECTED : 0.0% sur 26712 systemes
