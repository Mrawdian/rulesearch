...
genere 2026-08-27 10:08 UTC — 92834 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 18378 systemes
- `5c556c16ea8b` : 9490 systemes
...
- moteur actif `0caa9267db60` (49092 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 43813 | 21842 | 3007 | 1484 | 4371 | 3450 | 4606 | 4485 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 42906 | 9894 | 18210 | 25 | 5969 | 2240 | 22 | 6545 | 15.3% |
...
- candidats AVEC connectivite : 4612, dont T2 : 100%
- candidats SANS connectivite : 6855, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4880 systemes avec CONNECTED sur 38307 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*7177 candidats sur 11467 portent les champs bruts (63%).*
...
- `ab89a63b01ef` — 2280 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 1212 candidats
  - AVEC connectivite (484) : resistance **41.3%**
  - SANS connectivite (728) : resistance **21.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 2280 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 1212 candidats
  - AVEC connectivite (484) : T0=12.97 T1=0.00 T2=3.01 — pondere **6.01**
  - SANS connectivite (728) : T0=15.78 T1=0.00 T2=2.64 — pondere **5.29**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- TROP-CHER : 4912 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4880 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 35806 systemes
  - sans CONNECTED : 0.0% sur 8007 systemes
