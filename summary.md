...
genere 2026-09-08 22:43 UTC — 466705 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 383361 systemes
...
- moteur actif `0caa9267db60` (422963 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 232604 | 115546 | 15837 | 7791 | 23531 | 18217 | 24777 | 23954 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 227986 | 53104 | 96064 | 91 | 31760 | 11781 | 81 | 35086 | 15.4% |
...
- candidats AVEC connectivite : 24081, dont T2 : 100%
- candidats SANS connectivite : 35396, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25051 systemes avec CONNECTED sur 192442 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55187 candidats sur 59477 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49222 candidats
  - AVEC connectivite (19953) : resistance **41.2%**
  - SANS connectivite (29269) : resistance **21.3%**
...
- `5c556c16ea8b` — 49222 candidats
  - AVEC connectivite (19953) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (29269) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 25142 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25051 avec CONNECTED, 91 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 189941 systemes
  - sans CONNECTED : 0.0% sur 42663 systemes
