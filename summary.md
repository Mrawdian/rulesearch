...
**7466 enregistrements (19%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 17245 | 8622 | 1114 | 595 | 1711 | 1374 | 1876 | 1737 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 16880 | 3977 | 7147 | 11 | 2304 | 854 | 7 | 2580 | 15.3% |
...
- candidats AVEC connectivite : 1864, dont T2 : 100%
- candidats SANS connectivite : 2890, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2150 systemes avec CONNECTED sur 16586 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*464 candidats sur 4754 portent les champs bruts (10%).*
...
- `e3baecf8377b` — 200 candidats
  - AVEC connectivite (81) : resistance **42.7%**
  - SANS connectivite (119) : resistance **20.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 200 candidats
  - AVEC connectivite (81) : T0=13.26 T1=0.00 T2=3.15 — pondere **6.30**
  - SANS connectivite (119) : T0=15.92 T1=0.00 T2=2.60 — pondere **5.19**
...
## cout
- temps total 12.6 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2167 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2150 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14085 systemes
  - sans CONNECTED : 0.0% sur 3160 systemes
