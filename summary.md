...
genere 2026-08-28 19:16 UTC — 154314 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 70970 systemes
...
- moteur actif `0caa9267db60` (110572 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 74848 | 37200 | 5099 | 2555 | 7509 | 5962 | 7892 | 7682 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 73351 | 17067 | 31022 | 35 | 10108 | 3765 | 31 | 11320 | 15.4% |
...
- candidats AVEC connectivite : 7809, dont T2 : 100%
- candidats SANS connectivite : 11630, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8166 systemes avec CONNECTED sur 63559 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*15149 candidats sur 19439 portent les champs bruts (78%).*

- `5c556c16ea8b` — 9184 candidats
  - AVEC connectivite (3681) : resistance **41.1%**
  - SANS connectivite (5503) : resistance **21.7%**
...
- `5c556c16ea8b` — 9184 candidats
  - AVEC connectivite (3681) : T0=13.02 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (5503) : T0=15.89 T1=0.00 T2=2.68 — pondere **5.35**
...
- TROP-CHER : 8207 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8166 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 61058 systemes
  - sans CONNECTED : 0.0% sur 13790 systemes
