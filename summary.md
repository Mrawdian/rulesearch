...
| connect | 4 | 3 | 7592 | 3825 | 498 | 265 | 725 | 607 | 801 | 787 | 10.4% |
| ref | 4 | 3 | 7408 | 1794 | 3089 | 1 | 993 | 364 | 2 | 1165 | 15.7% |
...
- candidats AVEC connectivite : 790, dont T2 : 100%
- candidats SANS connectivite : 1169, dont T2 : 100%
...
- **801 systemes avec CONNECTED sur 6287 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 794 candidats
  - AVEC connectivite (311) : T0=13.35 T1=0.00 T2=2.90 — pondere **5.79**
  - SANS connectivite (483) : T0=15.78 T1=0.00 T2=2.66 — pondere **5.31**
  - test de permutation : **p = 0.0325** — ecart significatif au seuil 0.05
...
- TROP-CHER : 803 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 801 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 6230 systemes
  - sans CONNECTED : 0.0% sur 1362 systemes
