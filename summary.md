...
genere 2026-08-28 03:26 UTC — 126688 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 43344 systemes
...
- moteur actif `0caa9267db60` (82946 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 60902 | 30293 | 4213 | 2057 | 6068 | 4839 | 6385 | 6262 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 59671 | 13813 | 25267 | 28 | 8311 | 3086 | 26 | 9138 | 15.3% |
...
- candidats AVEC connectivite : 6389, dont T2 : 100%
- candidats SANS connectivite : 9448, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6659 systemes avec CONNECTED sur 52198 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11547 candidats sur 15837 portent les champs bruts (73%).*

- `5c556c16ea8b` — 5582 candidats
  - AVEC connectivite (2261) : resistance **41.9%**
  - SANS connectivite (3321) : resistance **22.1%**
...
- `5c556c16ea8b` — 5582 candidats
  - AVEC connectivite (2261) : T0=12.99 T1=0.00 T2=3.05 — pondere **6.09**
  - SANS connectivite (3321) : T0=15.86 T1=0.00 T2=2.70 — pondere **5.40**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 49697 systemes
  - sans CONNECTED : 0.0% sur 11205 systemes
