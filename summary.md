...
genere 2026-08-29 23:26 UTC — 199478 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 116134 systemes
...
- moteur actif `0caa9267db60` (155736 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 97668 | 48508 | 6644 | 3280 | 9848 | 7770 | 10297 | 10066 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 95695 | 22335 | 40398 | 44 | 13229 | 4923 | 37 | 14723 | 15.4% |
...
- candidats SANS connectivite : 15033, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10571 systemes avec CONNECTED sur 82165 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*20936 candidats sur 25226 portent les champs bruts (83%).*

- `5c556c16ea8b` — 14971 candidats
  - AVEC connectivite (6065) : resistance **41.1%**
  - SANS connectivite (8906) : resistance **21.5%**
...
- `5c556c16ea8b` — 14971 candidats
  ...
  - SANS connectivite (8906) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 79664 systemes
