...
genere 2026-08-26 17:02 UTC — 55060 systemes evalues
...
- moteur actif `0caa9267db60` (11318 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
| connect | 4 | 3 | 24729 | 12348 | 1680 | 838 | 2450 | 1948 | 2639 | 2517 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 24216 | 5603 | 10239 | 14 | 3390 | 1229 | 10 | 3731 | 15.4% |
...
- candidats AVEC connectivite : 2644, dont T2 : 100%
- candidats SANS connectivite : 4041, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2913 systemes avec CONNECTED sur 22716 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2395 candidats sur 6685 portent les champs bruts (36%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 85 candidats
  - AVEC connectivite (30) : resistance **39.5%**
  - SANS connectivite (55) : resistance **22.6%**
...
- `23303c299f39` — 85 candidats
  - AVEC connectivite (30) : T0=12.93 T1=0.00 T2=2.83 — pondere **5.67**
  - SANS connectivite (55) : T0=16.95 T1=0.00 T2=2.87 — pondere **5.75**
  - test de permutation : **p = 0.9440** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 20215 systemes
  - sans CONNECTED : 0.0% sur 4514 systemes
