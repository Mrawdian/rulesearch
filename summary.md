...
genere 2026-09-09 00:32 UTC — 468310 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 384966 systemes
...
- moteur actif `0caa9267db60` (424568 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 233425 | 115928 | 15907 | 7813 | 23629 | 18285 | 24865 | 24039 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 228770 | 53284 | 96390 | 92 | 31879 | 11815 | 82 | 35209 | 15.4% |
...
- candidats AVEC connectivite : 24166, dont T2 : 100%
- candidats SANS connectivite : 35519, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25139 systemes avec CONNECTED sur 193091 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55395 candidats sur 59685 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49430 candidats
  - AVEC connectivite (20038) : resistance **41.2%**
  - SANS connectivite (29392) : resistance **21.3%**
...
- `5c556c16ea8b` — 49430 candidats
  - AVEC connectivite (20038) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.97**
  - SANS connectivite (29392) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 190590 systemes
  - sans CONNECTED : 0.0% sur 42835 systemes
