...
genere 2026-09-09 08:53 UTC — 475690 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 392346 systemes
...
- moteur actif `0caa9267db60` (431948 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 237146 | 117753 | 16176 | 7943 | 23982 | 18581 | 25260 | 24440 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 232429 | 54171 | 97904 | 92 | 32375 | 12003 | 84 | 35781 | 15.4% |
...
- candidats AVEC connectivite : 24567, dont T2 : 100%
- candidats SANS connectivite : 36091, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25534 systemes avec CONNECTED sur 196139 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*56368 candidats sur 60658 portent les champs bruts (93%).*

- `5c556c16ea8b` — 50403 candidats
  - AVEC connectivite (20439) : resistance **41.2%**
  - SANS connectivite (29964) : resistance **21.3%**
...
- `5c556c16ea8b` — 50403 candidats
  - AVEC connectivite (20439) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (29964) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 193638 systemes
  - sans CONNECTED : 0.0% sur 43508 systemes
