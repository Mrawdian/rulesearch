...
genere 2026-08-26 10:13 UTC — 38222 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29248 systemes
...
| connect | 4 | 3 | 16227 | 8101 | 1052 | 556 | 1616 | 1292 | 1773 | 1632 | 10.1% |
| d4 | 4 | 4 | 5976 | 2745 | 1515 | 30 | 420 | 403 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 15895 | 3738 | 6721 | 11 | 2175 | 805 | 7 | 2438 | 15.3% |
...
- candidats AVEC connectivite : 1759, dont T2 : 100%
- candidats SANS connectivite : 2748, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2047 systemes avec CONNECTED sur 15762 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*217 candidats sur 4507 portent les champs bruts (5%).*

- `89c65c03c4ad` — 217 candidats
  - AVEC connectivite (82) : resistance **47.6%**
  - SANS connectivite (135) : resistance **21.2%**
...
- `89c65c03c4ad` — 3342 candidats
  - AVEC connectivite (1280) : T0=13.04 T1=0.00 T2=2.97 — pondere **5.93**
  - SANS connectivite (2062) : T0=15.85 T1=0.02 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 2064 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2047 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.4% sur 13261 systemes
  - sans CONNECTED : 0.0% sur 2966 systemes
