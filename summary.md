...
genere 2026-08-31 12:29 UTC — 251770 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 168426 systemes
...
- moteur actif `0caa9267db60` (208028 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 124081 | 61714 | 8415 | 4155 | 12502 | 9792 | 13103 | 12776 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 121574 | 28360 | 51324 | 54 | 16826 | 6290 | 56 | 18654 | 15.3% |
...
- candidats AVEC connectivite : 12903, dont T2 : 100%
- candidats SANS connectivite : 18964, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13377 systemes avec CONNECTED sur 103775 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*27577 candidats sur 31867 portent les champs bruts (87%).*

- `5c556c16ea8b` — 21612 candidats
  - AVEC connectivite (8775) : resistance **40.9%**
  - SANS connectivite (12837) : resistance **21.3%**
...
- `5c556c16ea8b` — 21612 candidats
  - AVEC connectivite (8775) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (12837) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 13443 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13377 avec CONNECTED, 66 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 101274 systemes
  - sans CONNECTED : 0.0% sur 22807 systemes
