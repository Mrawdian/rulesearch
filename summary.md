...
genere 2026-08-27 01:50 UTC — 74803 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 9896 systemes
...
- moteur actif `0caa9267db60` (31061 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 34718 | 17278 | 2390 | 1176 | 3442 | 2761 | 3692 | 3535 | 10.2% |
...
- candidats AVEC connectivite : 3662, dont T2 : 100%
- candidats SANS connectivite : 5491, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3966 systemes avec CONNECTED sur 30901 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4863 candidats sur 9153 portent les champs bruts (53%).*
...
- `ab89a63b01ef` — 1186 candidats
  - AVEC connectivite (482) : T0=13.00 T1=0.00 T2=3.04 — pondere **6.08**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 28400 systemes
  - sans CONNECTED : 0.0% sur 6318 systemes
