...
genere 2026-09-02 20:04 UTC — 319632 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 236288 systemes
...
- moteur actif `0caa9267db60` (275890 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 158337 | 78672 | 10783 | 5287 | 16095 | 12454 | 16794 | 16228 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 155180 | 36163 | 65636 | 64 | 21433 | 8015 | 63 | 23794 | 15.3% |
...
- candidats SANS connectivite : 24104, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **17068 systemes avec CONNECTED sur 131757 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*36169 candidats sur 40459 portent les champs bruts (89%).*

- `5c556c16ea8b` — 30204 candidats
  - AVEC connectivite (12227) : resistance **41.1%**
  - SANS connectivite (17977) : resistance **21.2%**
...
- `5c556c16ea8b` — 30204 candidats
  ...
  - SANS connectivite (17977) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.29**
...
- TROP-CHER : 17141 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 17068 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 129256 systemes
  - sans CONNECTED : 0.0% sur 29081 systemes
