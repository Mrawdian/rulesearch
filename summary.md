...
genere 2026-09-01 22:21 UTC — 294449 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 211105 systemes
...
- moteur actif `0caa9267db60` (250707 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 145621 | 72313 | 9902 | 4883 | 14798 | 11479 | 15407 | 14962 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 142713 | 33196 | 60362 | 61 | 19778 | 7368 | 63 | 21874 | 15.3% |
...
- candidats AVEC connectivite : 15089, dont T2 : 100%
- candidats SANS connectivite : 22184, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15681 systemes avec CONNECTED sur 121339 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*32983 candidats sur 37273 portent les champs bruts (88%).*

- `5c556c16ea8b` — 27018 candidats
  - AVEC connectivite (10961) : resistance **41.0%**
  - SANS connectivite (16057) : resistance **21.3%**
...
- `5c556c16ea8b` — 27018 candidats
  - AVEC connectivite (10961) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (16057) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 15754 systemes abandonnes (5.4% des systemes), 96% du temps total
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 118838 systemes
  - sans CONNECTED : 0.0% sur 26783 systemes
