...
genere 2026-08-27 19:46 UTC — 111823 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 28479 systemes
...
- moteur actif `0caa9267db60` (68081 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 53392 | 26584 | 3700 | 1821 | 5285 | 4226 | 5630 | 5450 | 10.2% |
...
- candidats AVEC connectivite : 5577, dont T2 : 100%
- candidats SANS connectivite : 8313, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5904 systemes avec CONNECTED sur 46118 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*9600 candidats sur 13890 portent les champs bruts (69%).*
...
- `5c556c16ea8b` — 3635 candidats
  - AVEC connectivite (1449) : resistance **42.2%**
...
- `5c556c16ea8b` — 3635 candidats
  - AVEC connectivite (1449) : T0=12.94 T1=0.00 T2=3.07 — pondere **6.14**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 43617 systemes
  - sans CONNECTED : 0.0% sur 9775 systemes
