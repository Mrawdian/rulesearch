...
genere 2026-08-26 04:27 UTC — 23412 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 14438 systemes
...
| connect | 4 | 3 | 11775 | 5896 | 772 | 408 | 1131 | 947 | 1277 | 1196 | 10.2% |
...
- candidats AVEC connectivite : 1199, dont T2 : 100%
...
- **1277 systemes avec CONNECTED sur 9703 (13.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1807 candidats
  - AVEC connectivite (720) : T0=13.34 T1=0.00 T2=2.85 — pondere **5.69**
...
- TROP-CHER : 1281 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1277 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 9646 systemes
  - sans CONNECTED : 0.0% sur 2129 systemes
