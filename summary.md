...
genere 2026-08-30 19:54 UTC — 229050 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 145706 systemes
...
- moteur actif `0caa9267db60` (185308 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 112620 | 56000 | 7651 | 3769 | 11315 | 8911 | 11914 | 11592 | 10.3% |
...
- candidats AVEC connectivite : 11719, dont T2 : 100%
...
- **12188 systemes avec CONNECTED sur 94425 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*24697 candidats sur 28987 portent les champs bruts (85%).*

- `5c556c16ea8b` — 18732 candidats
  - AVEC connectivite (7591) : resistance **41.1%**
...
- `5c556c16ea8b` — 18732 candidats
  - AVEC connectivite (7591) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.98**
...
- TROP-CHER : 12243 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 12188 avec CONNECTED, 55 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 91924 systemes
  - sans CONNECTED : 0.0% sur 20696 systemes
