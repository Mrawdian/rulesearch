...
genere 2026-09-02 07:24 UTC — 305196 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 221852 systemes
...
- moteur actif `0caa9267db60` (261454 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 151037 | 75051 | 10269 | 5059 | 15330 | 11887 | 15997 | 15514 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 148044 | 34475 | 62628 | 62 | 20480 | 7637 | 63 | 22687 | 15.3% |
...
- candidats SANS connectivite : 22997, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16271 systemes avec CONNECTED sur 125799 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*34348 candidats sur 38638 portent les champs bruts (89%).*

- `5c556c16ea8b` — 28383 candidats
  - AVEC connectivite (11513) : resistance **41.1%**
  - SANS connectivite (16870) : resistance **21.3%**
...
- `5c556c16ea8b` — 28383 candidats
  ...
  - SANS connectivite (16870) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 123298 systemes
  - sans CONNECTED : 0.0% sur 27739 systemes
