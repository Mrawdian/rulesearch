...
| connect | 4 | 3 | 7967 | 4018 | 517 | 272 | 761 | 633 | 840 | 833 | 10.5% |
| ref | 4 | 3 | 7787 | 1879 | 3264 | 1 | 1044 | 380 | 3 | 1216 | 15.6% |
...
- candidats AVEC connectivite : 836, dont T2 : 100%
- candidats SANS connectivite : 1220, dont T2 : 100%
...
- **840 systemes avec CONNECTED sur 6599 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 891 candidats
  - AVEC connectivite (357) : T0=13.39 T1=0.00 T2=2.84 — pondere **5.69**
  - SANS connectivite (534) : T0=15.84 T1=0.00 T2=2.65 — pondere **5.29**
...
- TROP-CHER : 843 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 840 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 6542 systemes
  - sans CONNECTED : 0.0% sur 1425 systemes
