...
genere 2026-09-04 14:06 UTC — 366279 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 282935 systemes
...
- moteur actif `0caa9267db60` (322537 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 181881 | 90399 | 12371 | 6073 | 18509 | 14330 | 19262 | 18608 | 10.2% |
...
- candidats AVEC connectivite : 18735, dont T2 : 100%
...
- **19536 systemes avec CONNECTED sur 150868 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*42119 candidats sur 46409 portent les champs bruts (91%).*

- `5c556c16ea8b` — 36154 candidats
  - AVEC connectivite (14607) : resistance **41.0%**
...
- `5c556c16ea8b` — 36154 candidats
  - AVEC connectivite (14607) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.95**
...
- TROP-CHER : 19616 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19536 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 148367 systemes
  - sans CONNECTED : 0.0% sur 33514 systemes
