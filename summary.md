...
genere 2026-08-26 01:52 UTC — 17007 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 8033 systemes
...
| connect | 4 | 3 | 8535 | 4300 | 555 | 287 | 812 | 684 | 913 | 880 | 10.3% |
...
- candidats AVEC connectivite : 883, dont T2 : 100%
...
- **913 systemes avec CONNECTED sur 7069 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1019 candidats
  - AVEC connectivite (404) : T0=13.40 T1=0.00 T2=2.85 — pondere **5.70**
...
- TROP-CHER : 916 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 913 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 7012 systemes
  - sans CONNECTED : 0.0% sur 1523 systemes
