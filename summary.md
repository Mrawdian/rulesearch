...
genere 2026-08-27 11:38 UTC — 95852 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 18378 systemes
- `5c556c16ea8b` : 12508 systemes
...
- moteur actif `0caa9267db60` (52110 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 45334 | 22610 | 3104 | 1539 | 4518 | 3580 | 4770 | 4627 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 44403 | 10247 | 18840 | 25 | 6163 | 2310 | 22 | 6795 | 15.3% |
...
- candidats SANS connectivite : 7105, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5044 systemes avec CONNECTED sur 39540 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*7569 candidats sur 11859 portent les champs bruts (64%).*
...
- `ab89a63b01ef` — 2280 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 1604 candidats
  - AVEC connectivite (626) : resistance **41.5%**
  - SANS connectivite (978) : resistance **22.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 1604 candidats
  ...
  - SANS connectivite (978) : T0=15.78 T1=0.00 T2=2.66 — pondere **5.32**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- TROP-CHER : 5076 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 5044 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 37039 systemes
  - sans CONNECTED : 0.0% sur 8295 systemes
