...
genere 2026-08-26 14:45 UTC — 49664 systemes evalues
...
- moteur actif `0caa9267db60` (5922 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22011 | 10983 | 1474 | 753 | 2183 | 1741 | 2354 | 2245 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 21538 | 5009 | 9090 | 13 | 2994 | 1109 | 9 | 3314 | 15.4% |
...
- candidats AVEC connectivite : 2372, dont T2 : 100%
- candidats SANS connectivite : 3624, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2628 systemes avec CONNECTED sur 20487 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1706 candidats sur 5996 portent les champs bruts (28%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 591 candidats
  - AVEC connectivite (234) : resistance **41.1%**
  - SANS connectivite (357) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 591 candidats
  - AVEC connectivite (234) : T0=13.36 T1=0.00 T2=3.04 — pondere **6.09**
  - SANS connectivite (357) : T0=16.03 T1=0.00 T2=2.64 — pondere **5.29**
...
- TROP-CHER : 2647 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2628 avec CONNECTED, 19 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17986 systemes
  - sans CONNECTED : 0.0% sur 4025 systemes
