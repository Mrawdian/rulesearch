...
genere 2026-09-01 20:11 UTC — 291848 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 208504 systemes
...
- moteur actif `0caa9267db60` (248106 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 144306 | 71680 | 9802 | 4831 | 14650 | 11371 | 15264 | 14844 | 10.3% |
...
- candidats AVEC connectivite : 14971, dont T2 : 100%
...
- **15538 systemes avec CONNECTED sur 120264 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*32674 candidats sur 36964 portent les champs bruts (88%).*

- `5c556c16ea8b` — 26709 candidats
  - AVEC connectivite (10843) : resistance **41.0%**
...
- `5c556c16ea8b` — 26709 candidats
  - AVEC connectivite (10843) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 15611 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15538 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 117763 systemes
  - sans CONNECTED : 0.0% sur 26543 systemes
