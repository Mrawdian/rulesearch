...
genere 2026-08-27 21:37 UTC — 115202 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 31858 systemes
...
- moteur actif `0caa9267db60` (71460 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 55097 | 27437 | 3816 | 1872 | 5449 | 4359 | 5826 | 5624 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 53990 | 12454 | 22923 | 26 | 7492 | 2802 | 25 | 8266 | 15.3% |
...
- candidats AVEC connectivite : 5751, dont T2 : 100%
- candidats SANS connectivite : 8576, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6100 systemes avec CONNECTED sur 47516 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10037 candidats sur 14327 portent les champs bruts (70%).*

- `5c556c16ea8b` — 4072 candidats
  - AVEC connectivite (1623) : resistance **42.0%**
  - SANS connectivite (2449) : resistance **22.5%**
...
- `5c556c16ea8b` — 4072 candidats
  - AVEC connectivite (1623) : T0=12.94 T1=0.00 T2=3.06 — pondere **6.11**
  - SANS connectivite (2449) : T0=15.78 T1=0.00 T2=2.71 — pondere **5.42**
...
- TROP-CHER : 6135 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6100 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 45015 systemes
  - sans CONNECTED : 0.0% sur 10082 systemes
