...
genere 2026-08-28 00:47 UTC — 121501 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 38157 systemes
...
- moteur actif `0caa9267db60` (77759 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 58272 | 29029 | 4031 | 1966 | 5787 | 4610 | 6135 | 5965 | 10.2% |
...
- candidats AVEC connectivite : 6092, dont T2 : 100%
- candidats SANS connectivite : 9054, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6409 systemes avec CONNECTED sur 50089 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10856 candidats sur 15146 portent les champs bruts (72%).*

- `5c556c16ea8b` — 4891 candidats
  - AVEC connectivite (1964) : resistance **42.1%**
...
- `5c556c16ea8b` — 4891 candidats
  - AVEC connectivite (1964) : T0=12.99 T1=0.00 T2=3.06 — pondere **6.11**
...
- TROP-CHER : 6445 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6409 avec CONNECTED, 36 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 47588 systemes
  - sans CONNECTED : 0.0% sur 10684 systemes
