...
genere 2026-08-29 04:13 UTC — 169614 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 86270 systemes
...
- moteur actif `0caa9267db60` (125872 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 82586 | 41106 | 5611 | 2790 | 8295 | 6554 | 8666 | 8511 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 80913 | 18836 | 34235 | 38 | 11205 | 4109 | 34 | 12451 | 15.4% |
...
- candidats AVEC connectivite : 8638, dont T2 : 100%
- candidats SANS connectivite : 12761, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8940 systemes avec CONNECTED sur 69889 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*17109 candidats sur 21399 portent les champs bruts (80%).*

- `5c556c16ea8b` — 11144 candidats
  - AVEC connectivite (4510) : resistance **41.2%**
  - SANS connectivite (6634) : resistance **21.7%**
...
- `5c556c16ea8b` — 11144 candidats
  - AVEC connectivite (4510) : T0=13.02 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (6634) : T0=15.90 T1=0.00 T2=2.67 — pondere **5.34**
...
- TROP-CHER : 8984 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8940 avec CONNECTED, 44 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 67388 systemes
  - sans CONNECTED : 0.0% sur 15198 systemes
