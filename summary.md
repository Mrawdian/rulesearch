...
genere 2026-08-28 17:53 UTC — 151826 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 68482 systemes
...
- moteur actif `0caa9267db60` (108084 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 73592 | 36549 | 5013 | 2518 | 7387 | 5864 | 7773 | 7550 | 10.3% |
...
- candidats AVEC connectivite : 7677, dont T2 : 100%
...
- **8047 systemes avec CONNECTED sur 62535 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*14825 candidats sur 19115 portent les champs bruts (78%).*

- `5c556c16ea8b` — 8860 candidats
  - AVEC connectivite (3549) : resistance **41.1%**
...
- `5c556c16ea8b` — 8860 candidats
  - AVEC connectivite (3549) : T0=13.03 T1=0.00 T2=2.99 — pondere **5.99**
...
- TROP-CHER : 8088 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8047 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 60034 systemes
  - sans CONNECTED : 0.0% sur 13558 systemes
