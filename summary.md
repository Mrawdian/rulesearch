...
genere 2026-08-26 22:37 UTC — 67646 systemes evalues
...
- moteur actif `0caa9267db60` (23904 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 31099 | 15444 | 2127 | 1043 | 3100 | 2478 | 3319 | 3193 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 30432 | 7006 | 12927 | 18 | 4221 | 1580 | 14 | 4666 | 15.3% |
...
- candidats AVEC connectivite : 3320, dont T2 : 100%
- candidats SANS connectivite : 4976, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3593 systemes avec CONNECTED sur 27922 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4006 candidats sur 8296 portent les champs bruts (48%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 329 candidats
  - AVEC connectivite (140) : resistance **42.8%**
  - SANS connectivite (189) : resistance **22.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 329 candidats
  - AVEC connectivite (140) : T0=12.79 T1=0.00 T2=3.09 — pondere **6.17**
  - SANS connectivite (189) : T0=16.16 T1=0.00 T2=2.79 — pondere **5.59**
...
- TROP-CHER : 3617 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3593 avec CONNECTED, 24 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 25421 systemes
  - sans CONNECTED : 0.0% sur 5678 systemes
