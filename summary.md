...
genere 2026-09-01 10:05 UTC — 279504 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 196160 systemes
...
- moteur actif `0caa9267db60` (235762 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 138080 | 68633 | 9337 | 4609 | 14011 | 10892 | 14592 | 14220 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 135309 | 31534 | 57180 | 58 | 18756 | 7008 | 60 | 20702 | 15.3% |
...
- candidats AVEC connectivite : 14347, dont T2 : 100%
- candidats SANS connectivite : 21012, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14866 systemes avec CONNECTED sur 115169 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*31069 candidats sur 35359 portent les champs bruts (88%).*

- `5c556c16ea8b` — 25104 candidats
  - AVEC connectivite (10219) : resistance **41.0%**
  - SANS connectivite (14885) : resistance **21.4%**
...
- `5c556c16ea8b` — 25104 candidats
  - AVEC connectivite (10219) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (14885) : T0=15.93 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 14936 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14866 avec CONNECTED, 70 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 112668 systemes
  - sans CONNECTED : 0.0% sur 25412 systemes
