...
genere 2026-09-06 20:03 UTC — 420310 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 336966 systemes
...
- moteur actif `0caa9267db60` (376568 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 209161 | 103869 | 14246 | 6959 | 21207 | 16447 | 22221 | 21550 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 205034 | 47673 | 86499 | 80 | 28586 | 10583 | 73 | 31523 | 15.4% |
...
- candidats AVEC connectivite : 21677, dont T2 : 100%
- candidats SANS connectivite : 31833, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **22495 systemes avec CONNECTED sur 173188 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*49220 candidats sur 53510 portent les champs bruts (92%).*

- `5c556c16ea8b` — 43255 candidats
  - AVEC connectivite (17549) : resistance **41.1%**
  - SANS connectivite (25706) : resistance **21.3%**
...
- `5c556c16ea8b` — 43255 candidats
  - AVEC connectivite (17549) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (25706) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 170687 systemes
  - sans CONNECTED : 0.0% sur 38474 systemes
