...
genere 2026-08-28 06:42 UTC — 132491 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 49147 systemes
...
- moteur actif `0caa9267db60` (88749 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 63837 | 31727 | 4386 | 2169 | 6389 | 5078 | 6706 | 6561 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 62539 | 14459 | 26492 | 29 | 8706 | 3231 | 28 | 9592 | 15.3% |
...
- candidats AVEC connectivite : 6688, dont T2 : 100%
- candidats SANS connectivite : 9902, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6980 systemes avec CONNECTED sur 54580 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12300 candidats sur 16590 portent les champs bruts (74%).*

- `5c556c16ea8b` — 6335 candidats
  - AVEC connectivite (2560) : resistance **41.5%**
  - SANS connectivite (3775) : resistance **22.0%**
...
- `5c556c16ea8b` — 6335 candidats
  - AVEC connectivite (2560) : T0=12.97 T1=0.00 T2=3.01 — pondere **6.03**
  - SANS connectivite (3775) : T0=15.86 T1=0.00 T2=2.68 — pondere **5.37**
...
## cout
- temps total 40.7 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 7018 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6980 avec CONNECTED, 38 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 52079 systemes
  - sans CONNECTED : 0.0% sur 11758 systemes
