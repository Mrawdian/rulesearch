...
genere 2026-08-26 22:02 UTC — 66401 systemes evalues
...
- moteur actif `0caa9267db60` (22659 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 29813 | 6874 | 12670 | 17 | 4118 | 1539 | 13 | 4582 | 15.4% |
...
- candidats SANS connectivite : 4892, dont T2 : 100%
...
*3856 candidats sur 8146 portent les champs bruts (47%).*
...
- `23303c299f39` — 225 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 179 candidats
  - AVEC connectivite (74) : resistance **44.0%**
  - SANS connectivite (105) : resistance **22.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 179 candidats
  ...
  - SANS connectivite (105) : T0=15.94 T1=0.00 T2=2.83 — pondere **5.66**
  - test de permutation : **p = 0.2814** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
