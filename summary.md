...
genere 2026-09-06 18:03 UTC — 418294 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 334950 systemes
...
- moteur actif `0caa9267db60` (374552 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 208144 | 103332 | 14179 | 6928 | 21097 | 16389 | 22129 | 21447 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 204035 | 47451 | 86074 | 80 | 28457 | 10524 | 73 | 31359 | 15.4% |
...
- candidats AVEC connectivite : 21574, dont T2 : 100%
- candidats SANS connectivite : 31669, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **22403 systemes avec CONNECTED sur 172342 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*48953 candidats sur 53243 portent les champs bruts (92%).*

- `5c556c16ea8b` — 42988 candidats
  - AVEC connectivite (17446) : resistance **41.1%**
  - SANS connectivite (25542) : resistance **21.3%**
...
- `5c556c16ea8b` — 42988 candidats
  - AVEC connectivite (17446) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (25542) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 169841 systemes
  - sans CONNECTED : 0.0% sur 38303 systemes
