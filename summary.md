...
genere 2026-09-07 18:21 UTC — 441126 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 357782 systemes
...
- moteur actif `0caa9267db60` (397384 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 219690 | 109133 | 14982 | 7317 | 22237 | 17209 | 23372 | 22644 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 215321 | 50139 | 90759 | 85 | 30003 | 11132 | 77 | 33108 | 15.4% |
...
- candidats AVEC connectivite : 22771, dont T2 : 100%
- candidats SANS connectivite : 33418, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23646 systemes avec CONNECTED sur 181879 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*51899 candidats sur 56189 portent les champs bruts (92%).*

- `5c556c16ea8b` — 45934 candidats
  - AVEC connectivite (18643) : resistance **41.1%**
  - SANS connectivite (27291) : resistance **21.3%**
...
- `5c556c16ea8b` — 45934 candidats
  - AVEC connectivite (18643) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (27291) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 179378 systemes
  - sans CONNECTED : 0.0% sur 40312 systemes
