...
genere 2026-08-28 06:51 UTC — 132801 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 49457 systemes
...
- moteur actif `0caa9267db60` (89059 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 63987 | 31804 | 4395 | 2172 | 6409 | 5089 | 6721 | 6576 | 10.3% |
...
- candidats AVEC connectivite : 6703, dont T2 : 100%
- candidats SANS connectivite : 9925, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6995 systemes avec CONNECTED sur 54698 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12338 candidats sur 16628 portent les champs bruts (74%).*

- `5c556c16ea8b` — 6373 candidats
  - AVEC connectivite (2575) : resistance **41.5%**
...
- `5c556c16ea8b` — 6373 candidats
  - AVEC connectivite (2575) : T0=12.98 T1=0.00 T2=3.02 — pondere **6.03**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 52197 systemes
  - sans CONNECTED : 0.0% sur 11790 systemes
