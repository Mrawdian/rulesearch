...
| connect | 4 | 3 | 18022 | 9011 | 1172 | 626 | 1786 | 1429 | 1961 | 1811 | 10.0% |
...
- candidats AVEC connectivite : 1938, dont T2 : 100%
- candidats SANS connectivite : 3024, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2235 systemes avec CONNECTED sur 17221 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*672 candidats sur 4962 portent les champs bruts (14%).*
...
- `e3baecf8377b` — 408 candidats
  - AVEC connectivite (155) : resistance **44.3%**
...
- `e3baecf8377b` — 408 candidats
  - AVEC connectivite (155) : T0=12.96 T1=0.00 T2=3.23 — pondere **6.46**
...
- TROP-CHER : 2252 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2235 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14720 systemes
  - sans CONNECTED : 0.0% sur 3302 systemes
