...
genere 2026-08-31 00:36 UTC — 235475 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 152131 systemes
...
- moteur actif `0caa9267db60` (191733 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 115861 | 57596 | 7866 | 3894 | 11642 | 9146 | 12271 | 11929 | 10.3% |
...
- candidats AVEC connectivite : 12056, dont T2 : 100%
...
- **12545 systemes avec CONNECTED sur 97124 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*25499 candidats sur 29789 portent les champs bruts (86%).*

- `5c556c16ea8b` — 19534 candidats
  - AVEC connectivite (7928) : resistance **41.0%**
...
- `5c556c16ea8b` — 19534 candidats
  - AVEC connectivite (7928) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.97**
...
- TROP-CHER : 12605 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 12545 avec CONNECTED, 60 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 94623 systemes
  - sans CONNECTED : 0.0% sur 21238 systemes
