...
genere 2026-09-04 02:21 UTC — 353602 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 270258 systemes
...
- moteur actif `0caa9267db60` (309860 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 175486 | 87224 | 11933 | 5864 | 17867 | 13805 | 18600 | 17960 | 10.2% |
...
- candidats AVEC connectivite : 18087, dont T2 : 100%
...
- **18874 systemes avec CONNECTED sur 145699 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*40530 candidats sur 44820 portent les champs bruts (90%).*

- `5c556c16ea8b` — 34565 candidats
  - AVEC connectivite (13959) : resistance **41.0%**
...
- `5c556c16ea8b` — 34565 candidats
  - AVEC connectivite (13959) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 18952 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18874 avec CONNECTED, 78 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 143198 systemes
