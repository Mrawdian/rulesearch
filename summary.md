...
genere 2026-08-27 14:09 UTC — 100717 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 18378 systemes
- `5c556c16ea8b` : 17373 systemes
...
- moteur actif `0caa9267db60` (56975 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 47783 | 23821 | 3278 | 1637 | 4736 | 3778 | 5049 | 4867 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 46819 | 10839 | 19866 | 25 | 6485 | 2441 | 22 | 7140 | 15.3% |
...
- candidats AVEC connectivite : 4994, dont T2 : 100%
- candidats SANS connectivite : 7450, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5323 systemes avec CONNECTED sur 41557 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*8154 candidats sur 12444 portent les champs bruts (66%).*
...
- `ab89a63b01ef` — 2280 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 2189 candidats
  - AVEC connectivite (866) : resistance **41.8%**
  - SANS connectivite (1323) : resistance **22.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 2280 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 2189 candidats
  - AVEC connectivite (866) : T0=13.01 T1=0.00 T2=3.04 — pondere **6.09**
  - SANS connectivite (1323) : T0=15.76 T1=0.00 T2=2.68 — pondere **5.37**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- TROP-CHER : 5355 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 5323 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 39056 systemes
