...
- moteur actif `0caa9267db60` (8140 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23132 | 11526 | 1563 | 786 | 2305 | 1840 | 2472 | 2349 | 10.2% |
...
- candidats AVEC connectivite : 2476, dont T2 : 100%
- candidats SANS connectivite : 3802, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2746 systemes avec CONNECTED sur 21381 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1988 candidats sur 6278 portent les champs bruts (32%).*
...
- `06fe04a859f1` — 873 candidats
  - AVEC connectivite (338) : resistance **41.0%**
...
- `06fe04a859f1` — 873 candidats
  - AVEC connectivite (338) : T0=13.25 T1=0.00 T2=3.01 — pondere **6.03**
...
- TROP-CHER : 2766 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2746 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18880 systemes
  - sans CONNECTED : 0.0% sur 4252 systemes
