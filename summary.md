...
genere 2026-08-31 11:22 UTC — 250244 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 166900 systemes
...
- moteur actif `0caa9267db60` (206502 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 123318 | 61342 | 8361 | 4137 | 12409 | 9731 | 13029 | 12698 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 120811 | 28210 | 50995 | 53 | 16695 | 6251 | 55 | 18542 | 15.3% |
...
- candidats SANS connectivite : 18852, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13303 systemes avec CONNECTED sur 103166 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*27387 candidats sur 31677 portent les champs bruts (86%).*

- `5c556c16ea8b` — 21422 candidats
  - AVEC connectivite (8697) : resistance **40.9%**
  - SANS connectivite (12725) : resistance **21.3%**
...
- `5c556c16ea8b` — 21422 candidats
  ...
  - SANS connectivite (12725) : T0=15.90 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 13368 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13303 avec CONNECTED, 65 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 100665 systemes
  - sans CONNECTED : 0.0% sur 22653 systemes
