...
genere 2026-08-26 19:17 UTC — 60381 systemes evalues
...
- moteur actif `0caa9267db60` (16639 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27420 | 13675 | 1869 | 926 | 2710 | 2173 | 2914 | 2810 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 26846 | 6205 | 11358 | 15 | 3740 | 1381 | 10 | 4137 | 15.4% |
...
- candidats AVEC connectivite : 2937, dont T2 : 100%
- candidats SANS connectivite : 4447, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3188 systemes avec CONNECTED sur 24937 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3094 candidats sur 7384 portent les champs bruts (42%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 225 candidats
  - AVEC connectivite (93) : resistance **39.7%**
  - SANS connectivite (132) : resistance **18.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 225 candidats
  - AVEC connectivite (93) : T0=13.13 T1=0.00 T2=2.92 — pondere **5.85**
  - SANS connectivite (132) : T0=16.20 T1=0.00 T2=2.58 — pondere **5.17**
...
- TROP-CHER : 3208 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3188 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22436 systemes
  - sans CONNECTED : 0.0% sur 4984 systemes
