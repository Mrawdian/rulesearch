...
genere 2026-08-29 20:38 UTC — 195077 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 111733 systemes
...
- moteur actif `0caa9267db60` (151335 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 95442 | 47393 | 6490 | 3218 | 9620 | 7607 | 10080 | 9816 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 93520 | 21799 | 39491 | 43 | 12949 | 4811 | 37 | 14384 | 15.4% |
...
- candidats AVEC connectivite : 9943, dont T2 : 100%
- candidats SANS connectivite : 14694, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10354 systemes avec CONNECTED sur 80343 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*20347 candidats sur 24637 portent les champs bruts (83%).*

- `5c556c16ea8b` — 14382 candidats
  - AVEC connectivite (5815) : resistance **41.2%**
  - SANS connectivite (8567) : resistance **21.5%**
...
- `5c556c16ea8b` — 14382 candidats
  - AVEC connectivite (5815) : T0=13.00 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (8567) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.33**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 77842 systemes
  - sans CONNECTED : 0.0% sur 17600 systemes
