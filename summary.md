...
genere 2026-08-26 17:44 UTC — 56608 systemes evalues
...
- moteur actif `0caa9267db60` (12866 systemes) : `06fe04a859f1`, `23303c299f39`, `b71bb0907fb5`, `e40600351a72`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 25520 | 12734 | 1734 | 860 | 2528 | 2013 | 2729 | 2608 | 10.2% |
...
- candidats AVEC connectivite : 2735, dont T2 : 100%
- candidats SANS connectivite : 4159, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3003 systemes avec CONNECTED sur 23368 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2604 candidats sur 6894 portent les champs bruts (38%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `b71bb0907fb5` — 41 candidats
  - AVEC connectivite (19) : resistance **39.9%**
...
- `b71bb0907fb5` — 41 candidats
  - AVEC connectivite (19) : T0=12.58 T1=0.00 T2=3.00 — pondere **6.00**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 20867 systemes
  - sans CONNECTED : 0.0% sur 4653 systemes
