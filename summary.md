...
genere 2026-08-26 16:00 UTC — 52629 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 7446 systemes
...
- moteur actif `0caa9267db60` (8887 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23505 | 11714 | 1590 | 804 | 2344 | 1865 | 2509 | 2383 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 23009 | 5329 | 9721 | 14 | 3215 | 1173 | 10 | 3547 | 15.4% |
...
- candidats AVEC connectivite : 2510, dont T2 : 100%
- candidats SANS connectivite : 3857, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2783 systemes avec CONNECTED sur 21685 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2077 candidats sur 6367 portent les champs bruts (33%).*
...
- `06fe04a859f1` — 962 candidats
  - AVEC connectivite (372) : resistance **41.4%**
  - SANS connectivite (590) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 962 candidats
  - AVEC connectivite (372) : T0=13.21 T1=0.00 T2=3.04 — pondere **6.09**
  - SANS connectivite (590) : T0=16.04 T1=0.00 T2=2.64 — pondere **5.28**
...
- TROP-CHER : 2803 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2783 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19184 systemes
  - sans CONNECTED : 0.0% sur 4321 systemes
