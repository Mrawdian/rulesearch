...
genere 2026-08-28 08:24 UTC — 135591 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 52247 systemes
...
- moteur actif `0caa9267db60` (91849 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 65410 | 32483 | 4496 | 2225 | 6544 | 5227 | 6869 | 6719 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 64066 | 14826 | 27109 | 30 | 8910 | 3308 | 28 | 9853 | 15.4% |
...
- candidats AVEC connectivite : 6846, dont T2 : 100%
- candidats SANS connectivite : 10163, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7143 systemes avec CONNECTED sur 55860 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12719 candidats sur 17009 portent les champs bruts (75%).*

- `5c556c16ea8b` — 6754 candidats
  - AVEC connectivite (2718) : resistance **41.4%**
  - SANS connectivite (4036) : resistance **21.8%**
...
- `5c556c16ea8b` — 6754 candidats
  - AVEC connectivite (2718) : T0=12.99 T1=0.00 T2=3.02 — pondere **6.03**
  - SANS connectivite (4036) : T0=15.85 T1=0.00 T2=2.68 — pondere **5.35**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 53359 systemes
  - sans CONNECTED : 0.0% sur 12051 systemes
