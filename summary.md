...
| connect | 4 | 3 | 18082 | 9039 | 1175 | 630 | 1794 | 1436 | 1964 | 1818 | 10.1% |
...
- candidats AVEC connectivite : 1945, dont T2 : 100%
- candidats SANS connectivite : 3028, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2238 systemes avec CONNECTED sur 17267 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*683 candidats sur 4973 portent les champs bruts (14%).*
...
- `e3baecf8377b` — 419 candidats
  - AVEC connectivite (162) : resistance **44.2%**
...
- `e3baecf8377b` — 419 candidats
  - AVEC connectivite (162) : T0=12.93 T1=0.00 T2=3.23 — pondere **6.46**
...
- TROP-CHER : 2255 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2238 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14766 systemes
  - sans CONNECTED : 0.0% sur 3316 systemes
