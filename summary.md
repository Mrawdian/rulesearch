...
genere 2026-08-27 03:14 UTC — 77892 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 12985 systemes
...
- moteur actif `0caa9267db60` (34150 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 36275 | 18043 | 2498 | 1228 | 3598 | 2869 | 3850 | 3715 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 35502 | 8193 | 15097 | 20 | 4906 | 1851 | 19 | 5416 | 15.3% |
...
- candidats AVEC connectivite : 3842, dont T2 : 100%
- candidats SANS connectivite : 5726, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4124 systemes avec CONNECTED sur 32192 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5278 candidats sur 9568 portent les champs bruts (55%).*
...
- `ab89a63b01ef` — 1601 candidats
  - AVEC connectivite (662) : resistance **41.2%**
  - SANS connectivite (939) : resistance **22.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1601 candidats
  - AVEC connectivite (662) : T0=13.02 T1=0.00 T2=3.05 — pondere **6.09**
  - SANS connectivite (939) : T0=15.92 T1=0.00 T2=2.71 — pondere **5.43**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- TROP-CHER : 4153 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4124 avec CONNECTED, 29 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 29691 systemes
  - sans CONNECTED : 0.0% sur 6584 systemes
