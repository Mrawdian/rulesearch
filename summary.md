...
| connect | 4 | 3 | 17649 | 8827 | 1138 | 611 | 1755 | 1403 | 1918 | 1776 | 10.1% |
...
- candidats AVEC connectivite : 1903, dont T2 : 100%
- candidats SANS connectivite : 2958, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2192 systemes avec CONNECTED sur 16915 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*571 candidats sur 4861 portent les champs bruts (12%).*
...
- `e3baecf8377b` — 307 candidats
  - AVEC connectivite (120) : resistance **43.7%**
...
- `e3baecf8377b` — 307 candidats
  - AVEC connectivite (120) : T0=12.97 T1=0.00 T2=3.14 — pondere **6.28**
...
**2 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0135).
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14414 systemes
  - sans CONNECTED : 0.0% sur 3235 systemes
