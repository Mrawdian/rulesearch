...
genere 2026-08-27 08:39 UTC — 89663 systemes evalues
...
- moteur actif `0caa9267db60` (45921 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 42212 | 21019 | 2904 | 1428 | 4212 | 3315 | 4446 | 4342 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 41336 | 9529 | 17573 | 23 | 5720 | 2152 | 22 | 6317 | 15.3% |
...
- candidats AVEC connectivite : 4469, dont T2 : 100%
- candidats SANS connectivite : 6627, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4720 systemes avec CONNECTED sur 37003 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6806 candidats sur 11096 portent les champs bruts (61%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 841 candidats
  - AVEC connectivite (341) : resistance **41.0%**
  - SANS connectivite (500) : resistance **21.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 841 candidats
  - AVEC connectivite (341) : T0=13.11 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (500) : T0=15.96 T1=0.00 T2=2.64 — pondere **5.29**
...
- TROP-CHER : 4752 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4720 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 34502 systemes
  - sans CONNECTED : 0.0% sur 7710 systemes
