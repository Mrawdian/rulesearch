...
genere 2026-09-09 03:54 UTC — 471363 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 388019 systemes
...
- moteur actif `0caa9267db60` (427621 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 234963 | 116697 | 16020 | 7866 | 23782 | 18397 | 25015 | 24204 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 230285 | 53650 | 97021 | 92 | 32085 | 11900 | 82 | 35436 | 15.4% |
...
- candidats SANS connectivite : 35746, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25289 systemes avec CONNECTED sur 194344 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55787 candidats sur 60077 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49822 candidats
  - AVEC connectivite (20203) : resistance **41.2%**
  - SANS connectivite (29619) : resistance **21.3%**
...
- `5c556c16ea8b` — 49822 candidats
  ...
  - SANS connectivite (29619) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 25381 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25289 avec CONNECTED, 92 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 191843 systemes
  - sans CONNECTED : 0.0% sur 43120 systemes
