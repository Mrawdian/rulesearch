...
genere 2026-08-27 08:24 UTC — 89203 systemes evalues
...
- moteur actif `0caa9267db60` (45461 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 41973 | 20905 | 2885 | 1419 | 4187 | 3301 | 4419 | 4312 | 10.3% |
...
- candidats AVEC connectivite : 4439, dont T2 : 100%
- candidats SANS connectivite : 6588, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4693 systemes avec CONNECTED sur 36803 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6737 candidats sur 11027 portent les champs bruts (61%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 772 candidats
  - AVEC connectivite (311) : resistance **41.3%**
...
- `5c556c16ea8b` — 772 candidats
  - AVEC connectivite (311) : T0=13.08 T1=0.00 T2=3.02 — pondere **6.03**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 34302 systemes
  - sans CONNECTED : 0.0% sur 7671 systemes
