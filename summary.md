...
genere 2026-08-27 15:07 UTC — 102669 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 19325 systemes
...
- moteur actif `0caa9267db60` (58927 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 48768 | 24287 | 3360 | 1671 | 4848 | 3860 | 5149 | 4961 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 47786 | 11054 | 20277 | 25 | 6616 | 2501 | 23 | 7289 | 15.3% |
...
- candidats AVEC connectivite : 5088, dont T2 : 100%
- candidats SANS connectivite : 7599, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5423 systemes avec CONNECTED sur 42347 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*8397 candidats sur 12687 portent les champs bruts (66%).*
...
- `5c556c16ea8b` — 2432 candidats
  - AVEC connectivite (960) : resistance **41.7%**
...
- `5c556c16ea8b` — 2432 candidats
  - AVEC connectivite (960) : T0=13.02 T1=0.00 T2=3.04 — pondere **6.07**
...
- TROP-CHER : 5456 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 5423 avec CONNECTED, 33 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 39846 systemes
  - sans CONNECTED : 0.0% sur 8922 systemes
