...
genere 2026-08-28 22:38 UTC — 160086 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 76742 systemes
...
- moteur actif `0caa9267db60` (116344 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 77766 | 38619 | 5304 | 2650 | 7786 | 6221 | 8191 | 8003 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 76205 | 17714 | 32267 | 35 | 10498 | 3901 | 31 | 11755 | 15.4% |
...
- candidats AVEC connectivite : 8130, dont T2 : 100%
- candidats SANS connectivite : 12065, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8465 systemes avec CONNECTED sur 65921 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*15905 candidats sur 20195 portent les champs bruts (79%).*

- `5c556c16ea8b` — 9940 candidats
  - AVEC connectivite (4002) : resistance **41.2%**
  - SANS connectivite (5938) : resistance **21.8%**
...
- `5c556c16ea8b` — 9940 candidats
  - AVEC connectivite (4002) : T0=13.00 T1=0.00 T2=3.00 — pondere **6.01**
  - SANS connectivite (5938) : T0=15.88 T1=0.00 T2=2.69 — pondere **5.37**
...
- TROP-CHER : 8506 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8465 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 63420 systemes
  - sans CONNECTED : 0.0% sur 14346 systemes
