...
genere 2026-09-05 11:02 UTC — 387848 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 304504 systemes
...
- moteur actif `0caa9267db60` (344106 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 192782 | 95738 | 13124 | 6420 | 19606 | 15171 | 20449 | 19808 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 188951 | 43987 | 79745 | 77 | 26289 | 9779 | 70 | 28990 | 15.3% |
...
- candidats AVEC connectivite : 19935, dont T2 : 100%
...
- **20723 systemes avec CONNECTED sur 159769 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*44945 candidats sur 49235 portent les champs bruts (91%).*

- `5c556c16ea8b` — 38980 candidats
  - AVEC connectivite (15807) : resistance **41.1%**
...
- `5c556c16ea8b` — 38980 candidats
  - AVEC connectivite (15807) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
...
- TROP-CHER : 20803 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 20723 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 157268 systemes
  - sans CONNECTED : 0.0% sur 35514 systemes
