...
genere 2026-09-10 04:16 UTC — 492229 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 408885 systemes
...
- moteur actif `0caa9267db60` (448487 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 245492 | 121897 | 16713 | 8235 | 24835 | 19263 | 26171 | 25259 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 240622 | 56092 | 101374 | 96 | 33502 | 12429 | 87 | 37021 | 15.4% |
...
- candidats AVEC connectivite : 25386, dont T2 : 100%
- candidats SANS connectivite : 37331, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **26445 systemes avec CONNECTED sur 202945 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*58427 candidats sur 62717 portent les champs bruts (93%).*

- `5c556c16ea8b` — 52462 candidats
  - AVEC connectivite (21258) : resistance **41.2%**
  - SANS connectivite (31204) : resistance **21.3%**
...
- `5c556c16ea8b` — 52462 candidats
  - AVEC connectivite (21258) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (31204) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
## cout
- temps total 153.6 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 26542 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 26445 avec CONNECTED, 97 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 200444 systemes
  - sans CONNECTED : 0.0% sur 45048 systemes
