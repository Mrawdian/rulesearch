...
genere 2026-08-26 23:30 UTC — 69589 systemes evalues
...
- moteur actif `0caa9267db60` (25847 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 32087 | 15946 | 2204 | 1079 | 3200 | 2556 | 3423 | 3273 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 31387 | 7236 | 13331 | 18 | 4343 | 1640 | 14 | 4805 | 15.3% |
...
- candidats AVEC connectivite : 3400, dont T2 : 100%
- candidats SANS connectivite : 5115, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3697 systemes avec CONNECTED sur 28727 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4225 candidats sur 8515 portent les champs bruts (50%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 548 candidats
  - AVEC connectivite (220) : resistance **42.2%**
  - SANS connectivite (328) : resistance **22.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 548 candidats
  - AVEC connectivite (220) : T0=13.00 T1=0.00 T2=3.10 — pondere **6.19**
  - SANS connectivite (328) : T0=16.01 T1=0.00 T2=2.68 — pondere **5.37**
...
- TROP-CHER : 3721 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3697 avec CONNECTED, 24 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 26226 systemes
  - sans CONNECTED : 0.0% sur 5861 systemes
