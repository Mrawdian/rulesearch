...
- moteur actif `0caa9267db60` (8214 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23162 | 11540 | 1568 | 787 | 2308 | 1842 | 2476 | 2350 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 22679 | 5248 | 9571 | 14 | 3182 | 1157 | 10 | 3497 | 15.4% |
...
- candidats AVEC connectivite : 2477, dont T2 : 100%
- candidats SANS connectivite : 3807, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2750 systemes avec CONNECTED sur 21406 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1994 candidats sur 6284 portent les champs bruts (32%).*
...
- `06fe04a859f1` — 879 candidats
  - AVEC connectivite (339) : resistance **41.1%**
  - SANS connectivite (540) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 879 candidats
  - AVEC connectivite (339) : T0=13.24 T1=0.00 T2=3.02 — pondere **6.05**
  - SANS connectivite (540) : T0=16.03 T1=0.00 T2=2.64 — pondere **5.28**
...
## cout
- temps total 16.1 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2770 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2750 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18905 systemes
  - sans CONNECTED : 0.0% sur 4257 systemes
