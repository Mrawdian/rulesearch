...
genere 2026-08-25 22:46 UTC — 9046 systemes evalues
...
- `89c65c03c4ad` : 72 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)

Les lignes de dsl_hash differents ne sont pas comparables entre elles.

**7538 enregistrements (83%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| ref | 4 | 3 | 4410 | 1069 | 1855 | 1 | 584 | 209 | 2 | 690 | 15.6% |
...
- candidats SANS connectivite : 694, dont T2 : 100%
