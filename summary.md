...
genere 2026-09-04 16:14 UTC — 368632 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 285288 systemes
...
- moteur actif `0caa9267db60` (324890 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 183061 | 90993 | 12447 | 6115 | 18635 | 14414 | 19373 | 18733 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 179456 | 41715 | 75814 | 74 | 24930 | 9298 | 70 | 27541 | 15.3% |
...
- candidats AVEC connectivite : 18860, dont T2 : 100%
...
- **19647 systemes avec CONNECTED sur 151832 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*42421 candidats sur 46711 portent les champs bruts (91%).*

- `5c556c16ea8b` — 36456 candidats
  - AVEC connectivite (14732) : resistance **41.0%**
...
- `5c556c16ea8b` — 36456 candidats
  - AVEC connectivite (14732) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.95**
...
- TROP-CHER : 19727 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19647 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 149331 systemes
  - sans CONNECTED : 0.0% sur 33730 systemes
