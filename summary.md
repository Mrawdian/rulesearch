...
| connect | 4 | 3 | 18815 | 9391 | 1227 | 652 | 1873 | 1496 | 2039 | 1904 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 18411 | 4326 | 7756 | 13 | 2531 | 952 | 7 | 2826 | 15.3% |
...
- candidats AVEC connectivite : 2031, dont T2 : 100%
- candidats SANS connectivite : 3136, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2313 systemes avec CONNECTED sur 17859 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*877 candidats sur 5167 portent les champs bruts (17%).*
...
- `e3baecf8377b` — 613 candidats
  - AVEC connectivite (248) : resistance **42.0%**
  - SANS connectivite (365) : resistance **21.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 613 candidats
  - AVEC connectivite (248) : T0=13.11 T1=0.00 T2=3.09 — pondere **6.18**
  - SANS connectivite (365) : T0=15.94 T1=0.00 T2=2.62 — pondere **5.25**
...
- TROP-CHER : 2330 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2313 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 15358 systemes
  - sans CONNECTED : 0.0% sur 3457 systemes
