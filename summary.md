...
**7466 enregistrements (50%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 7547 | 3803 | 496 | 263 | 719 | 606 | 795 | 782 | 10.4% |
| ref | 4 | 3 | 7378 | 1786 | 3079 | 1 | 988 | 364 | 2 | 1158 | 15.7% |
...
- candidats AVEC connectivite : 785, dont T2 : 100%
- candidats SANS connectivite : 1162, dont T2 : 100%
...
- **795 systemes avec CONNECTED sur 6247 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 782 candidats
  - AVEC connectivite (306) : T0=13.33 T1=0.00 T2=2.92 — pondere **5.83**
  - SANS connectivite (476) : T0=15.80 T1=0.00 T2=2.66 — pondere **5.31**
  - test de permutation : **p = 0.0295** — ecart significatif au seuil 0.05
...
## cout
- temps total 4.6 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 797 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 795 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 6190 systemes
  - sans CONNECTED : 0.0% sur 1357 systemes
