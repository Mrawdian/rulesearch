...
genere 2026-09-04 22:48 UTC — 375314 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 291970 systemes
...
- moteur actif `0caa9267db60` (331572 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 186436 | 92594 | 12680 | 6236 | 18960 | 14689 | 19765 | 19120 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 182763 | 42511 | 77208 | 76 | 25382 | 9467 | 70 | 28035 | 15.3% |
...
- candidats SANS connectivite : 28345, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20039 systemes avec CONNECTED sur 154591 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*43302 candidats sur 47592 portent les champs bruts (91%).*

- `5c556c16ea8b` — 37337 candidats
  - AVEC connectivite (15119) : resistance **41.1%**
  - SANS connectivite (22218) : resistance **21.2%**
...
- `5c556c16ea8b` — 37337 candidats
  ...
  - SANS connectivite (22218) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 152090 systemes
  - sans CONNECTED : 0.0% sur 34346 systemes
