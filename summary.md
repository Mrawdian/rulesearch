...
genere 2026-09-04 10:43 UTC — 362629 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 279285 systemes
...
- moteur actif `0caa9267db60` (318887 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 180043 | 89476 | 12232 | 6021 | 18317 | 14192 | 19075 | 18431 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 176471 | 40975 | 74575 | 72 | 24517 | 9142 | 70 | 27106 | 15.4% |
...
- candidats AVEC connectivite : 18558, dont T2 : 100%
...
- **19349 systemes avec CONNECTED sur 149382 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*41684 candidats sur 45974 portent les champs bruts (91%).*

- `5c556c16ea8b` — 35719 candidats
  - AVEC connectivite (14430) : resistance **41.0%**
...
- `5c556c16ea8b` — 35719 candidats
  - AVEC connectivite (14430) : T0=13.03 T1=0.00 T2=2.97 — pondere **5.95**
...
- TROP-CHER : 19429 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19349 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 146881 systemes
  - sans CONNECTED : 0.0% sur 33162 systemes
