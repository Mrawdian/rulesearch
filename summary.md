...
genere 2026-08-28 14:17 UTC — 145554 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 62210 systemes
...
- moteur actif `0caa9267db60` (101812 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 70426 | 34990 | 4808 | 2390 | 7065 | 5616 | 7443 | 7213 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 69013 | 16021 | 29155 | 32 | 9556 | 3554 | 30 | 10662 | 15.4% |
...
- candidats SANS connectivite : 10972, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7717 systemes avec CONNECTED sur 59948 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*14022 candidats sur 18312 portent les champs bruts (77%).*

- `5c556c16ea8b` — 8057 candidats
  - AVEC connectivite (3212) : resistance **41.2%**
  - SANS connectivite (4845) : resistance **21.8%**
...
- `5c556c16ea8b` — 8057 candidats
  ...
  - SANS connectivite (4845) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.35**
...
- TROP-CHER : 7757 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7717 avec CONNECTED, 40 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 57447 systemes
  - sans CONNECTED : 0.0% sur 12979 systemes
