...
| connect | 4 | 3 | 6932 | 3483 | 451 | 244 | 659 | 564 | 725 | 727 | 10.5% |
| ref | 4 | 3 | 6765 | 1628 | 2811 | 1 | 911 | 338 | 2 | 1074 | 15.9% |
...
- candidats AVEC connectivite : 730, dont T2 : 100%
- candidats SANS connectivite : 1078, dont T2 : 100%
...
- **725 systemes avec CONNECTED sur 5739 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 643 candidats
  - AVEC connectivite (251) : T0=13.26 T1=0.00 T2=2.93 — pondere **5.86**
  - SANS connectivite (392) : T0=15.79 T1=0.00 T2=2.65 — pondere **5.29**
...
- TROP-CHER : 727 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 725 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 5682 systemes
  - sans CONNECTED : 0.0% sur 1250 systemes
