...
genere 2026-08-26 03:29 UTC — 20975 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 12001 systemes
...
**7466 enregistrements (36%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 10536 | 5306 | 692 | 365 | 1006 | 836 | 1141 | 1056 | 10.0% |
| ref | 4 | 3 | 10315 | 2470 | 4350 | 5 | 1378 | 523 | 4 | 1585 | 15.4% |
...
- candidats AVEC connectivite : 1059, dont T2 : 100%
- candidats SANS connectivite : 1589, dont T2 : 100%
...
- **1141 systemes avec CONNECTED sur 8705 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1483 candidats
  - AVEC connectivite (580) : T0=13.33 T1=0.00 T2=2.87 — pondere **5.73**
  - SANS connectivite (903) : T0=15.80 T1=0.00 T2=2.66 — pondere **5.31**
...
## cout
- temps total 6.6 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 1145 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1141 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 8648 systemes
  - sans CONNECTED : 0.0% sur 1888 systemes
