...
genere 2026-09-03 16:05 UTC — 342340 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 258996 systemes
...
- moteur actif `0caa9267db60` (298598 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 169800 | 84391 | 11522 | 5684 | 17268 | 13414 | 17999 | 17358 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 166425 | 38712 | 70335 | 67 | 23098 | 8604 | 66 | 25531 | 15.3% |
...
- candidats AVEC connectivite : 17485, dont T2 : 100%
...
- **18273 systemes avec CONNECTED sur 141036 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39036 candidats sur 43326 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33071 candidats
  - AVEC connectivite (13357) : resistance **41.0%**
...
- `5c556c16ea8b` — 33071 candidats
  - AVEC connectivite (13357) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 18349 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18273 avec CONNECTED, 76 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 138535 systemes
  - sans CONNECTED : 0.0% sur 31265 systemes
