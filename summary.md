...
| connect | 4 | 3 | 6740 | 3390 | 438 | 240 | 643 | 545 | 707 | 699 | 10.4% |
| ref | 4 | 3 | 6575 | 1591 | 2728 | 1 | 882 | 326 | 2 | 1045 | 15.9% |
...
- candidats AVEC connectivite : 702, dont T2 : 100%
- candidats SANS connectivite : 1049, dont T2 : 100%
...
- **707 systemes avec CONNECTED sur 5585 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 586 candidats
  - AVEC connectivite (223) : T0=13.23 T1=0.00 T2=2.96 — pondere **5.93**
  - SANS connectivite (363) : T0=15.77 T1=0.00 T2=2.62 — pondere **5.23**
...
- TROP-CHER : 709 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 707 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 5528 systemes
  - sans CONNECTED : 0.0% sur 1212 systemes
