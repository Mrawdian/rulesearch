...
genere 2026-08-28 22:41 UTC — 160191 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 76847 systemes
...
- moteur actif `0caa9267db60` (116449 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 77826 | 38658 | 5305 | 2650 | 7791 | 6224 | 8195 | 8011 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 76250 | 17725 | 32286 | 35 | 10505 | 3903 | 31 | 11761 | 15.4% |
...
- candidats AVEC connectivite : 8138, dont T2 : 100%
- candidats SANS connectivite : 12071, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8469 systemes avec CONNECTED sur 65972 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*15919 candidats sur 20209 portent les champs bruts (79%).*

- `5c556c16ea8b` — 9954 candidats
  - AVEC connectivite (4010) : resistance **41.2%**
  - SANS connectivite (5944) : resistance **21.8%**
...
- `5c556c16ea8b` — 9954 candidats
  - AVEC connectivite (4010) : T0=13.00 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (5944) : T0=15.89 T1=0.00 T2=2.69 — pondere **5.37**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 63471 systemes
  - sans CONNECTED : 0.0% sur 14355 systemes
