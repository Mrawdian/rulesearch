...
genere 2026-09-04 10:48 UTC — 362718 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 279374 systemes
...
- moteur actif `0caa9267db60` (318976 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 180088 | 89493 | 12235 | 6024 | 18324 | 14195 | 19081 | 18437 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 176515 | 40981 | 74598 | 72 | 24521 | 9142 | 70 | 27117 | 15.4% |
...
- candidats AVEC connectivite : 18564, dont T2 : 100%
- candidats SANS connectivite : 27427, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19355 systemes avec CONNECTED sur 149417 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*41701 candidats sur 45991 portent les champs bruts (91%).*

- `5c556c16ea8b` — 35736 candidats
  - AVEC connectivite (14436) : resistance **41.0%**
  - SANS connectivite (21300) : resistance **21.2%**
...
- `5c556c16ea8b` — 35736 candidats
  - AVEC connectivite (14436) : T0=13.03 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (21300) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 19435 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19355 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 146916 systemes
  - sans CONNECTED : 0.0% sur 33172 systemes
