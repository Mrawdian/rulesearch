...
genere 2026-09-02 01:32 UTC — 298279 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 214935 systemes
...
- moteur actif `0caa9267db60` (254537 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 147558 | 73296 | 10045 | 4947 | 14974 | 11614 | 15617 | 15167 | 10.3% |
...
- candidats AVEC connectivite : 15294, dont T2 : 100%
...
- **15891 systemes avec CONNECTED sur 122960 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*33468 candidats sur 37758 portent les champs bruts (89%).*

- `5c556c16ea8b` — 27503 candidats
  - AVEC connectivite (11166) : resistance **41.0%**
...
- `5c556c16ea8b` — 27503 candidats
  - AVEC connectivite (11166) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 15964 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 15891 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 120459 systemes
  - sans CONNECTED : 0.0% sur 27099 systemes
