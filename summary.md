...
genere 2026-08-29 07:07 UTC — 174286 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 90942 systemes
...
- moteur actif `0caa9267db60` (130544 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 84947 | 42275 | 5774 | 2868 | 8527 | 6739 | 8918 | 8770 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 83224 | 19431 | 35192 | 39 | 11481 | 4239 | 34 | 12803 | 15.4% |
...
- candidats AVEC connectivite : 8897, dont T2 : 100%
- candidats SANS connectivite : 13113, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9192 systemes avec CONNECTED sur 71840 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*17720 candidats sur 22010 portent les champs bruts (81%).*

- `5c556c16ea8b` — 11755 candidats
  - AVEC connectivite (4769) : resistance **41.2%**
  - SANS connectivite (6986) : resistance **21.7%**
...
- `5c556c16ea8b` — 11755 candidats
  - AVEC connectivite (4769) : T0=13.01 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (6986) : T0=15.88 T1=0.00 T2=2.67 — pondere **5.33**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 69339 systemes
  - sans CONNECTED : 0.0% sur 15608 systemes
