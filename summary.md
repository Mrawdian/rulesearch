...
genere 2026-09-10 10:37 UTC — 497357 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 414013 systemes
...
- moteur actif `0caa9267db60` (453615 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 248089 | 123150 | 16899 | 8342 | 25099 | 19459 | 26464 | 25532 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 243153 | 56726 | 102421 | 97 | 33831 | 12534 | 87 | 37436 | 15.4% |
...
- candidats SANS connectivite : 37746, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **26738 systemes avec CONNECTED sur 205074 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*59115 candidats sur 63405 portent les champs bruts (93%).*

- `5c556c16ea8b` — 53150 candidats
  - AVEC connectivite (21531) : resistance **41.2%**
  - SANS connectivite (31619) : resistance **21.3%**
...
- `5c556c16ea8b` — 53150 candidats
  ...
  - SANS connectivite (31619) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 202573 systemes
  - sans CONNECTED : 0.0% sur 45516 systemes
