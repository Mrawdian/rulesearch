...
genere 2026-08-26 12:46 UTC — 44814 systemes evalues
...
| connect | 4 | 3 | 19561 | 9756 | 1275 | 682 | 1955 | 1553 | 2101 | 1995 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 19138 | 4491 | 8073 | 13 | 2639 | 989 | 7 | 2926 | 15.3% |
...
- candidats AVEC connectivite : 2122, dont T2 : 100%
- candidats SANS connectivite : 3236, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2375 systemes avec CONNECTED sur 18472 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1068 candidats sur 5358 portent les champs bruts (20%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `e40600351a72` — 147 candidats
  - AVEC connectivite (71) : resistance **40.7%**
  - SANS connectivite (76) : resistance **19.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e40600351a72` — 147 candidats
  - AVEC connectivite (71) : T0=12.93 T1=0.00 T2=3.01 — pondere **6.03**
  - SANS connectivite (76) : T0=16.89 T1=0.00 T2=2.64 — pondere **5.29**
...
## cout
- temps total 13.9 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2392 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2375 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 15971 systemes
  - sans CONNECTED : 0.0% sur 3590 systemes
