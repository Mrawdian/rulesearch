...
genere 2026-08-26 02:14 UTC — 17837 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 8863 systemes
...
| connect | 4 | 3 | 8954 | 4508 | 580 | 299 | 861 | 709 | 967 | 920 | 10.3% |
| ref | 4 | 3 | 8759 | 2110 | 3676 | 2 | 1170 | 431 | 3 | 1367 | 15.6% |
...
- candidats AVEC connectivite : 923, dont T2 : 100%
- candidats SANS connectivite : 1371, dont T2 : 100%
...
- **967 systemes avec CONNECTED sur 7419 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1129 candidats
  - AVEC connectivite (444) : T0=13.35 T1=0.00 T2=2.89 — pondere **5.78**
  - SANS connectivite (685) : T0=15.88 T1=0.00 T2=2.67 — pondere **5.34**
  - test de permutation : **p = 0.0255** — ecart significatif au seuil 0.05
...
- TROP-CHER : 970 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 967 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 7362 systemes
  - sans CONNECTED : 0.0% sur 1592 systemes
