...
genere 2026-08-31 00:27 UTC — 235281 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 151937 systemes
...
- moteur actif `0caa9267db60` (191539 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 115756 | 57541 | 7861 | 3887 | 11629 | 9139 | 12260 | 11922 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 113410 | 26463 | 47932 | 53 | 15635 | 5861 | 50 | 17406 | 15.3% |
...
- candidats AVEC connectivite : 12049, dont T2 : 100%
- candidats SANS connectivite : 17716, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12534 systemes avec CONNECTED sur 97035 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*25475 candidats sur 29765 portent les champs bruts (86%).*

- `5c556c16ea8b` — 19510 candidats
  - AVEC connectivite (7921) : resistance **41.0%**
  - SANS connectivite (11589) : resistance **21.4%**
...
- `5c556c16ea8b` — 19510 candidats
  - AVEC connectivite (7921) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.97**
  - SANS connectivite (11589) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 12594 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 12534 avec CONNECTED, 60 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 94534 systemes
  - sans CONNECTED : 0.0% sur 21222 systemes
