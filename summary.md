...
genere 2026-09-07 10:12 UTC — 433594 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 350250 systemes
...
- moteur actif `0caa9267db60` (389852 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 215883 | 107235 | 14695 | 7193 | 21871 | 16934 | 22955 | 22253 | 10.3% |
...
- candidats AVEC connectivite : 22380, dont T2 : 100%
...
- **23229 systemes avec CONNECTED sur 178738 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*50929 candidats sur 55219 portent les champs bruts (92%).*

- `5c556c16ea8b` — 44964 candidats
  - AVEC connectivite (18252) : resistance **41.1%**
...
- `5c556c16ea8b` — 44964 candidats
  - AVEC connectivite (18252) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 23315 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23229 avec CONNECTED, 86 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 176237 systemes
  - sans CONNECTED : 0.0% sur 39646 systemes
