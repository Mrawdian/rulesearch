...
genere 2026-08-27 08:47 UTC — 89944 systemes evalues
...
- moteur actif `0caa9267db60` (46202 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 42347 | 21091 | 2909 | 1430 | 4228 | 3322 | 4463 | 4358 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 41482 | 9558 | 17634 | 24 | 5741 | 2160 | 22 | 6343 | 15.3% |
...
- candidats AVEC connectivite : 4485, dont T2 : 100%
- candidats SANS connectivite : 6653, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4737 systemes avec CONNECTED sur 37115 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6848 candidats sur 11138 portent les champs bruts (61%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 883 candidats
  - AVEC connectivite (357) : resistance **41.0%**
  - SANS connectivite (526) : resistance **21.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 883 candidats
  - AVEC connectivite (357) : T0=13.11 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (526) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.29**
...
## cout
- temps total 27.7 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 4769 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4737 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 34614 systemes
  - sans CONNECTED : 0.0% sur 7733 systemes
