...
genere 2026-08-26 05:48 UTC — 26770 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 17796 systemes
...
| connect | 4 | 3 | 13356 | 6682 | 877 | 466 | 1305 | 1062 | 1450 | 1346 | 10.1% |
| d4 | 4 | 4 | 210 | 103 | 50 | 0 | 12 | 13 | 11 | 15 | 7.1% |
| ref | 4 | 3 | 13080 | 3130 | 5492 | 9 | 1780 | 657 | 5 | 2007 | 15.3% |
...
- candidats AVEC connectivite : 1352, dont T2 : 100%
- candidats SANS connectivite : 2023, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1461 systemes avec CONNECTED sur 11081 (13.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2210 candidats
  - AVEC connectivite (873) : T0=13.24 T1=0.00 T2=2.86 — pondere **5.73**
  - SANS connectivite (1337) : T0=15.89 T1=0.00 T2=2.64 — pondere **5.28**
...
## cout
- temps total 8.5 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 1466 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1461 avec CONNECTED, 5 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 10941 systemes
  - sans CONNECTED : 0.0% sur 2415 systemes
