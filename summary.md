...
genere 2026-08-29 00:46 UTC — 163831 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 80487 systemes
...
- moteur actif `0caa9267db60` (120089 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 79667 | 39634 | 5424 | 2702 | 7961 | 6345 | 8370 | 8219 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 78049 | 18145 | 33023 | 36 | 10780 | 3979 | 32 | 12049 | 15.4% |
...
- candidats AVEC connectivite : 8346, dont T2 : 100%
- candidats SANS connectivite : 12359, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8644 systemes avec CONNECTED sur 67494 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*16415 candidats sur 20705 portent les champs bruts (79%).*

- `5c556c16ea8b` — 10450 candidats
  - AVEC connectivite (4218) : resistance **41.1%**
  - SANS connectivite (6232) : resistance **21.7%**
...
- `5c556c16ea8b` — 10450 candidats
  - AVEC connectivite (4218) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (6232) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.35**
...
## cout
- temps total 50.4 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 8686 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8644 avec CONNECTED, 42 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 64993 systemes
  - sans CONNECTED : 0.0% sur 14674 systemes
