...
| connect | 4 | 3 | 18621 | 9290 | 1208 | 644 | 1864 | 1487 | 2015 | 1883 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 18221 | 4285 | 7676 | 13 | 2499 | 942 | 7 | 2799 | 15.4% |
...
- candidats AVEC connectivite : 2010, dont T2 : 100%
- candidats SANS connectivite : 3109, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2289 systemes avec CONNECTED sur 17690 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*829 candidats sur 5119 portent les champs bruts (16%).*
...
- `e3baecf8377b` — 565 candidats
  - AVEC connectivite (227) : resistance **42.0%**
  - SANS connectivite (338) : resistance **21.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 565 candidats
  - AVEC connectivite (227) : T0=13.16 T1=0.00 T2=3.09 — pondere **6.18**
  - SANS connectivite (338) : T0=16.01 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 2306 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 2289 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 15189 systemes
  - sans CONNECTED : 0.0% sur 3432 systemes
