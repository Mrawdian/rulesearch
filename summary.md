...
| connect | 4 | 3 | 6396 | 3221 | 418 | 231 | 611 | 511 | 667 | 663 | 10.4% |
...
- candidats AVEC connectivite : 666, dont T2 : 100%
...
- **667 systemes avec CONNECTED sur 5303 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 493 candidats
  - AVEC connectivite (187) : T0=13.24 T1=0.00 T2=2.90 — pondere **5.80**
...
- TROP-CHER : 669 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 667 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 5246 systemes
  - sans CONNECTED : 0.0% sur 1150 systemes
