...
genere 2026-08-29 23:20 UTC — 199329 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 115985 systemes
...
- moteur actif `0caa9267db60` (155587 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 97593 | 48467 | 6639 | 3278 | 9843 | 7764 | 10288 | 10062 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 95621 | 22316 | 40371 | 44 | 13217 | 4920 | 37 | 14710 | 15.4% |
...
- candidats SANS connectivite : 15020, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10562 systemes avec CONNECTED sur 82101 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*20919 candidats sur 25209 portent les champs bruts (83%).*

- `5c556c16ea8b` — 14954 candidats
  - AVEC connectivite (6061) : resistance **41.1%**
  - SANS connectivite (8893) : resistance **21.5%**
...
- `5c556c16ea8b` — 14954 candidats
  ...
  - SANS connectivite (8893) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 79600 systemes
  - sans CONNECTED : 0.0% sur 17993 systemes
