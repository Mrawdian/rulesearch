...
genere 2026-08-26 16:31 UTC — 53860 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 8677 systemes
...
- moteur actif `0caa9267db60` (10118 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 24134 | 12044 | 1645 | 818 | 2390 | 1909 | 2574 | 2452 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 23611 | 5469 | 9975 | 14 | 3303 | 1203 | 10 | 3637 | 15.4% |
...
- candidats AVEC connectivite : 2579, dont T2 : 100%
- candidats SANS connectivite : 3947, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2848 systemes avec CONNECTED sur 22220 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2236 candidats sur 6526 portent les champs bruts (34%).*
...
- `06fe04a859f1` — 1121 candidats
  - AVEC connectivite (441) : resistance **40.7%**
  - SANS connectivite (680) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1121 candidats
  - AVEC connectivite (441) : T0=13.12 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (680) : T0=15.96 T1=0.00 T2=2.64 — pondere **5.29**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19719 systemes
  - sans CONNECTED : 0.0% sur 4415 systemes
