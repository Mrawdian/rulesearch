...
genere 2026-08-26 16:20 UTC — 53385 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 8202 systemes
...
- moteur actif `0caa9267db60` (9643 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23894 | 11922 | 1626 | 813 | 2372 | 1884 | 2553 | 2425 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 23376 | 5414 | 9871 | 14 | 3271 | 1193 | 10 | 3603 | 15.4% |
...
- candidats AVEC connectivite : 2552, dont T2 : 100%
- candidats SANS connectivite : 3913, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2827 systemes avec CONNECTED sur 22020 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2175 candidats sur 6465 portent les champs bruts (34%).*
...
- `06fe04a859f1` — 1060 candidats
  - AVEC connectivite (414) : resistance **40.9%**
  - SANS connectivite (646) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1060 candidats
  - AVEC connectivite (414) : T0=13.19 T1=0.00 T2=3.03 — pondere **6.06**
  - SANS connectivite (646) : T0=15.99 T1=0.00 T2=2.64 — pondere **5.28**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
...
- TROP-CHER : 2847 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2827 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19519 systemes
  - sans CONNECTED : 0.0% sur 4375 systemes
