...
genere 2026-08-26 10:30 UTC — 38934 systemes evalues
...
- `e3baecf8377b` : 341 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
**7807 enregistrements (20%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 16587 | 8281 | 1070 | 570 | 1645 | 1324 | 1810 | 1677 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 16232 | 3815 | 6878 | 11 | 2217 | 817 | 7 | 2487 | 15.3% |
...
- candidats AVEC connectivite : 1804, dont T2 : 100%
- candidats SANS connectivite : 2797, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2084 systemes avec CONNECTED sur 16061 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*311 candidats sur 4601 portent les champs bruts (7%).*
...
- `e3baecf8377b` — 47 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (21) : resistance **37.0%**
  - SANS connectivite (26) : resistance **16.8%**
  - p = 0.0010 — **A NE PAS RETENIR** : serie non reproductible.
...
- `e3baecf8377b` — 47 candidats
  - AVEC connectivite (21) : T0=13.86 T1=0.00 T2=2.90 — pondere **5.81**
  - SANS connectivite (26) : T0=15.92 T1=0.00 T2=2.19 — pondere **4.38**
...
- `T2` indices=0.12 — PAIRDIFF(>=1)@adj + PAIRDIFF(>=1)@knight + CONNECTED(v2) + COUNT(v2,1-4)@grid

## cout
- temps total 12.2 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2101 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2084 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 13560 systemes
  - sans CONNECTED : 0.0% sur 3027 systemes
