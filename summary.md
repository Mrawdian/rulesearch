...
- moteur actif `0caa9267db60` (47826 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 43169 | 21515 | 2962 | 1457 | 4311 | 3396 | 4546 | 4420 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 42284 | 9754 | 17944 | 25 | 5863 | 2208 | 22 | 6467 | 15.3% |
...
- candidats AVEC connectivite : 4547, dont T2 : 100%
- candidats SANS connectivite : 6777, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4820 systemes avec CONNECTED sur 37770 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*7034 candidats sur 11324 portent les champs bruts (62%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 1069 candidats
  - AVEC connectivite (419) : resistance **41.2%**
  - SANS connectivite (650) : resistance **21.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 1069 candidats
  - AVEC connectivite (419) : T0=13.03 T1=0.00 T2=3.01 — pondere **6.01**
  - SANS connectivite (650) : T0=15.81 T1=0.00 T2=2.63 — pondere **5.27**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
...
- TROP-CHER : 4852 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4820 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 35269 systemes
  - sans CONNECTED : 0.0% sur 7900 systemes
