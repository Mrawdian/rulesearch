...
genere 2026-08-26 02:24 UTC — 18192 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 9218 systemes
...
| connect | 4 | 3 | 9134 | 4599 | 594 | 305 | 877 | 725 | 991 | 932 | 10.2% |
| ref | 4 | 3 | 8934 | 2148 | 3760 | 2 | 1189 | 444 | 3 | 1388 | 15.5% |
...
- candidats AVEC connectivite : 935, dont T2 : 100%
- candidats SANS connectivite : 1392, dont T2 : 100%
...
- **991 systemes avec CONNECTED sur 7565 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1162 candidats
  - AVEC connectivite (456) : T0=13.37 T1=0.00 T2=2.89 — pondere **5.78**
  - SANS connectivite (706) : T0=15.82 T1=0.00 T2=2.66 — pondere **5.32**
  - test de permutation : **p = 0.0170** — ecart significatif au seuil 0.05
...
- TROP-CHER : 994 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 991 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 7508 systemes
  - sans CONNECTED : 0.0% sur 1626 systemes
