...
genere 2026-09-01 13:20 UTC — 283618 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 200274 systemes
...
- moteur actif `0caa9267db60` (239876 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 140156 | 69675 | 9479 | 4688 | 14237 | 11053 | 14800 | 14412 | 10.3% |
...
- candidats AVEC connectivite : 14539, dont T2 : 100%
...
- **15074 systemes avec CONNECTED sur 116861 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*31577 candidats sur 35867 portent les champs bruts (88%).*

- `5c556c16ea8b` — 25612 candidats
  - AVEC connectivite (10411) : resistance **41.0%**
...
- `5c556c16ea8b` — 25612 candidats
  - AVEC connectivite (10411) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 15145 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15074 avec CONNECTED, 71 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 114360 systemes
  - sans CONNECTED : 0.0% sur 25796 systemes
