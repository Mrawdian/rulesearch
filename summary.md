...
genere 2026-09-09 12:57 UTC — 479288 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 395944 systemes
...
- moteur actif `0caa9267db60` (435546 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 238965 | 118632 | 16294 | 8007 | 24195 | 18745 | 25435 | 24624 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 234208 | 54578 | 98678 | 92 | 32631 | 12101 | 84 | 36025 | 15.4% |
...
- candidats AVEC connectivite : 24751, dont T2 : 100%
- candidats SANS connectivite : 36335, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25709 systemes avec CONNECTED sur 197577 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*56796 candidats sur 61086 portent les champs bruts (93%).*

- `5c556c16ea8b` — 50831 candidats
  - AVEC connectivite (20623) : resistance **41.2%**
  - SANS connectivite (30208) : resistance **21.3%**
...
- `5c556c16ea8b` — 50831 candidats
  - AVEC connectivite (20623) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (30208) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
## cout
- temps total 149.4 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 25803 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25709 avec CONNECTED, 94 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 195076 systemes
  - sans CONNECTED : 0.0% sur 43889 systemes
