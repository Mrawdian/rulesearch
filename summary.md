...
| connect | 4 | 3 | 5950 | 3001 | 383 | 214 | 571 | 478 | 618 | 615 | 10.3% |
...
- candidats AVEC connectivite : 618, dont T2 : 100%
...
- **618 systemes avec CONNECTED sur 4935 (12.5%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 377 candidats
  - AVEC connectivite (139) : T0=13.08 T1=0.00 T2=2.92 — pondere **5.84**
...
- TROP-CHER : 620 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 618 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 4878 systemes
  - sans CONNECTED : 0.0% sur 1072 systemes
