...
genere 2026-08-26 13:05 UTC — 45627 systemes evalues
...
- moteur actif `0caa9267db60` (1885 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 19964 | 9979 | 1302 | 687 | 2005 | 1572 | 2142 | 2031 | 10.2% |
...
- candidats AVEC connectivite : 2158, dont T2 : 100%
- candidats SANS connectivite : 3290, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2416 systemes avec CONNECTED sur 18799 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1158 candidats sur 5448 portent les champs bruts (21%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 43 candidats
  - AVEC connectivite (20) : resistance **38.4%**
  - SANS connectivite (23) : resistance **20.8%**
  - test de permutation : **p = 0.0025** — significatif.
...
- `06fe04a859f1` — 43 candidats
  - AVEC connectivite (20) : T0=13.85 T1=0.00 T2=2.50 — pondere **5.00**
  - SANS connectivite (23) : T0=16.74 T1=0.00 T2=2.65 — pondere **5.30**
  - test de permutation : **p = 0.7486** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 2433 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2416 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16298 systemes
  - sans CONNECTED : 0.0% sur 3666 systemes
