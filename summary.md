...
genere 2026-08-26 20:04 UTC — 62062 systemes evalues
...
- moteur actif `0caa9267db60` (18320 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 28273 | 14076 | 1936 | 951 | 2805 | 2239 | 3010 | 2901 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 27674 | 6391 | 11730 | 15 | 3846 | 1423 | 12 | 4257 | 15.4% |
...
- candidats AVEC connectivite : 3028, dont T2 : 100%
- candidats SANS connectivite : 4567, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3284 systemes avec CONNECTED sur 25632 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3305 candidats sur 7595 portent les champs bruts (44%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 436 candidats
  - AVEC connectivite (184) : resistance **39.3%**
  - SANS connectivite (252) : resistance **19.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 436 candidats
  - AVEC connectivite (184) : T0=12.82 T1=0.00 T2=2.83 — pondere **5.65**
  - SANS connectivite (252) : T0=16.10 T1=0.00 T2=2.60 — pondere **5.20**
...
- TROP-CHER : 3306 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3284 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23131 systemes
  - sans CONNECTED : 0.0% sur 5142 systemes
