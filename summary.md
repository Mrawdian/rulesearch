...
genere 2026-09-04 16:41 UTC — 369078 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 285734 systemes
...
- moteur actif `0caa9267db60` (325336 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 183286 | 91100 | 12458 | 6123 | 18658 | 14430 | 19403 | 18762 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 179677 | 41771 | 75907 | 74 | 24961 | 9307 | 70 | 27573 | 15.3% |
...
- candidats AVEC connectivite : 18889, dont T2 : 100%
- candidats SANS connectivite : 27883, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19677 systemes avec CONNECTED sur 152018 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*42482 candidats sur 46772 portent les champs bruts (91%).*

- `5c556c16ea8b` — 36517 candidats
  - AVEC connectivite (14761) : resistance **41.0%**
  - SANS connectivite (21756) : resistance **21.2%**
...
- `5c556c16ea8b` — 36517 candidats
  - AVEC connectivite (14761) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.94**
  - SANS connectivite (21756) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 19757 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19677 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 149517 systemes
  - sans CONNECTED : 0.0% sur 33769 systemes
