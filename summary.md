...
genere 2026-08-27 01:47 UTC — 74629 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 9722 systemes
...
- moteur actif `0caa9267db60` (30887 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 34629 | 17230 | 2382 | 1173 | 3436 | 2753 | 3686 | 3526 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 33885 | 7810 | 14405 | 20 | 4704 | 1762 | 18 | 5166 | 15.2% |
...
- candidats SANS connectivite : 5476, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3960 systemes avec CONNECTED sur 30831 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4839 candidats sur 9129 portent les champs bruts (53%).*
...
- `ab89a63b01ef` — 1162 candidats
  - AVEC connectivite (473) : resistance **41.3%**
  - SANS connectivite (689) : resistance **21.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1162 candidats
  ...
  - SANS connectivite (689) : T0=15.90 T1=0.00 T2=2.67 — pondere **5.35**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- TROP-CHER : 3988 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3960 avec CONNECTED, 28 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 28330 systemes
  - sans CONNECTED : 0.0% sur 6299 systemes
