...
genere 2026-08-26 20:02 UTC — 61987 systemes evalues
...
- moteur actif `0caa9267db60` (18245 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 28243 | 14063 | 1932 | 950 | 2803 | 2236 | 3005 | 2900 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 27629 | 6378 | 11713 | 15 | 3837 | 1422 | 12 | 4252 | 15.4% |
...
- candidats AVEC connectivite : 3027, dont T2 : 100%
- candidats SANS connectivite : 4562, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3279 systemes avec CONNECTED sur 25609 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3299 candidats sur 7589 portent les champs bruts (43%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 430 candidats
  - AVEC connectivite (183) : resistance **39.2%**
  - SANS connectivite (247) : resistance **19.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 430 candidats
  - AVEC connectivite (183) : T0=12.81 T1=0.00 T2=2.82 — pondere **5.64**
  - SANS connectivite (247) : T0=16.09 T1=0.00 T2=2.60 — pondere **5.19**
...
## cout
- temps total 19.2 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 3301 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3279 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23108 systemes
  - sans CONNECTED : 0.0% sur 5135 systemes
