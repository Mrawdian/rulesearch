...
genere 2026-08-26 02:53 UTC — 19437 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 10463 systemes
...
| connect | 4 | 3 | 9761 | 4909 | 635 | 337 | 930 | 774 | 1057 | 998 | 10.2% |
| ref | 4 | 3 | 9552 | 2283 | 4029 | 2 | 1273 | 488 | 4 | 1473 | 15.4% |
...
- candidats AVEC connectivite : 1001, dont T2 : 100%
- candidats SANS connectivite : 1477, dont T2 : 100%
...
- **1057 systemes avec CONNECTED sur 8076 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1313 candidats
  - AVEC connectivite (522) : T0=13.34 T1=0.00 T2=2.88 — pondere **5.76**
  - SANS connectivite (791) : T0=15.83 T1=0.00 T2=2.67 — pondere **5.33**
...
- TROP-CHER : 1061 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1057 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 8019 systemes
  - sans CONNECTED : 0.0% sur 1742 systemes
