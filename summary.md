...
genere 2026-08-26 20:58 UTC — 64034 systemes evalues
...
- moteur actif `0caa9267db60` (20292 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 29276 | 14568 | 1994 | 977 | 2916 | 2321 | 3119 | 3007 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 28643 | 6607 | 12151 | 16 | 3979 | 1475 | 12 | 4403 | 15.4% |
...
- candidats AVEC connectivite : 3134, dont T2 : 100%
- candidats SANS connectivite : 4713, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3393 systemes avec CONNECTED sur 26446 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3557 candidats sur 7847 portent les champs bruts (45%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 688 candidats
  - AVEC connectivite (290) : resistance **40.0%**
...
- `62448a55927e` — 688 candidats
  - AVEC connectivite (290) : T0=12.82 T1=0.00 T2=2.84 — pondere **5.69**
  - SANS connectivite (398) : T0=16.12 T1=0.00 T2=2.68 — pondere **5.36**
  - test de permutation : **p = 0.1614** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e3baecf8377b` — 657 candidats
...
- TROP-CHER : 3415 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3393 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23945 systemes
  - sans CONNECTED : 0.0% sur 5331 systemes
