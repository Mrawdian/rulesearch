...
genere 2026-08-26 17:18 UTC — 55637 systemes evalues
...
- moteur actif `0caa9267db60` (11895 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
| connect | 4 | 3 | 25028 | 12493 | 1703 | 844 | 2477 | 1976 | 2675 | 2549 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 24494 | 5662 | 10362 | 14 | 3423 | 1245 | 10 | 3778 | 15.4% |
...
- candidats AVEC connectivite : 2676, dont T2 : 100%
- candidats SANS connectivite : 4088, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2949 systemes avec CONNECTED sur 22962 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2474 candidats sur 6764 portent les champs bruts (37%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 164 candidats
  - AVEC connectivite (62) : resistance **41.6%**
  - SANS connectivite (102) : resistance **20.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `23303c299f39` — 164 candidats
  - AVEC connectivite (62) : T0=12.79 T1=0.00 T2=3.05 — pondere **6.10**
  - SANS connectivite (102) : T0=16.06 T1=0.00 T2=2.60 — pondere **5.20**
...
- TROP-CHER : 2969 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2949 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 20461 systemes
  - sans CONNECTED : 0.0% sur 4567 systemes
