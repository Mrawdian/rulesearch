...
genere 2026-08-26 21:40 UTC — 65676 systemes evalues
...
- moteur actif `0caa9267db60` (21934 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 30098 | 14954 | 2059 | 1012 | 3015 | 2384 | 3203 | 3091 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 29463 | 6793 | 12518 | 16 | 4083 | 1519 | 12 | 4522 | 15.3% |
...
- candidats AVEC connectivite : 3218, dont T2 : 100%
- candidats SANS connectivite : 4832, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3477 systemes avec CONNECTED sur 27103 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3760 candidats sur 8050 portent les champs bruts (47%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 83 candidats
  - AVEC connectivite (38) : resistance **44.2%**
...
- `ab89a63b01ef` — 83 candidats
  - AVEC connectivite (38) : T0=14.37 T1=0.00 T2=3.16 — pondere **6.32**
  - SANS connectivite (45) : T0=16.29 T1=0.00 T2=3.04 — pondere **6.09**
  - test de permutation : **p = 0.7901** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e80bc1b2b437` — 75 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24602 systemes
