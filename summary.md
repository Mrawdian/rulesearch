...
| connect | 4 | 3 | 5094 | 2552 | 320 | 183 | 495 | 417 | 534 | 535 | 10.5% |
| ref | 4 | 3 | 4986 | 1212 | 2090 | 1 | 655 | 239 | 2 | 787 | 15.8% |
...
- candidats AVEC connectivite : 538, dont T2 : 100%
- candidats SANS connectivite : 791, dont T2 : 100%
...
- **534 systemes avec CONNECTED sur 4221 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 164 candidats
  - AVEC connectivite (59) : T0=13.12 T1=0.00 T2=2.92 — pondere **5.83**
  - SANS connectivite (105) : T0=16.09 T1=0.00 T2=2.74 — pondere **5.49**
...
- TROP-CHER : 536 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 534 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 4164 systemes
  - sans CONNECTED : 0.0% sur 930 systemes
