...
genere 2026-09-06 22:11 UTC — 422388 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 339044 systemes
...
- moteur actif `0caa9267db60` (378646 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 210221 | 104380 | 14322 | 7000 | 21322 | 16532 | 22324 | 21668 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 206052 | 47912 | 86924 | 80 | 28727 | 10645 | 73 | 31674 | 15.4% |
...
- candidats AVEC connectivite : 21795, dont T2 : 100%
- candidats SANS connectivite : 31984, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **22598 systemes avec CONNECTED sur 174051 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*49489 candidats sur 53779 portent les champs bruts (92%).*

- `5c556c16ea8b` — 43524 candidats
  - AVEC connectivite (17667) : resistance **41.1%**
  - SANS connectivite (25857) : resistance **21.3%**
...
- `5c556c16ea8b` — 43524 candidats
  - AVEC connectivite (17667) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (25857) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 22681 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 22598 avec CONNECTED, 83 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 171550 systemes
  - sans CONNECTED : 0.0% sur 38671 systemes
