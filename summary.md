...
genere 2026-08-30 03:39 UTC — 205943 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 122599 systemes
...
- moteur actif `0caa9267db60` (162201 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 100941 | 50124 | 6872 | 3382 | 10182 | 8057 | 10627 | 10382 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 98887 | 23042 | 41767 | 45 | 13669 | 5113 | 38 | 15206 | 15.4% |
...
- candidats AVEC connectivite : 10509, dont T2 : 100%
...
- **10901 systemes avec CONNECTED sur 84812 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*21735 candidats sur 26025 portent les champs bruts (84%).*

- `5c556c16ea8b` — 15770 candidats
  - AVEC connectivite (6381) : resistance **41.1%**
...
- `5c556c16ea8b` — 15770 candidats
  - AVEC connectivite (6381) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.99**
...
- TROP-CHER : 10949 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10901 avec CONNECTED, 48 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 82311 systemes
  - sans CONNECTED : 0.0% sur 18630 systemes
