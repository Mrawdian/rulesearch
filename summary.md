...
genere 2026-09-05 10:53 UTC — 387715 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 304371 systemes
...
- moteur actif `0caa9267db60` (343973 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 192708 | 95706 | 13121 | 6416 | 19602 | 15163 | 20440 | 19797 | 10.3% |
...
- candidats AVEC connectivite : 19924, dont T2 : 100%
...
- **20714 systemes avec CONNECTED sur 159709 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*44927 candidats sur 49217 portent les champs bruts (91%).*

- `5c556c16ea8b` — 38962 candidats
  - AVEC connectivite (15796) : resistance **41.1%**
...
- `5c556c16ea8b` — 38962 candidats
  - AVEC connectivite (15796) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
...
- TROP-CHER : 20794 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 20714 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 157208 systemes
  - sans CONNECTED : 0.0% sur 35500 systemes
