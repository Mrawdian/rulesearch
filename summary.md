...
genere 2026-09-04 02:22 UTC — 353632 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 270288 systemes
...
- moteur actif `0caa9267db60` (309890 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 175501 | 87231 | 11934 | 5864 | 17870 | 13809 | 18600 | 17960 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 172016 | 39973 | 72655 | 70 | 23904 | 8906 | 68 | 26426 | 15.4% |
...
- candidats SANS connectivite : 26736, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18874 systemes avec CONNECTED sur 145707 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*40533 candidats sur 44823 portent les champs bruts (90%).*

- `5c556c16ea8b` — 34568 candidats
  - AVEC connectivite (13959) : resistance **41.0%**
  - SANS connectivite (20609) : resistance **21.2%**
...
- `5c556c16ea8b` — 34568 candidats
  ...
  - SANS connectivite (20609) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 143206 systemes
  - sans CONNECTED : 0.0% sur 32295 systemes
