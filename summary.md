...
genere 2026-08-26 21:39 UTC — 65602 systemes evalues
...
- `ab89a63b01ef` : 695 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (21860 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
**8221 enregistrements (13%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 30068 | 14938 | 2057 | 1012 | 3013 | 2379 | 3202 | 3087 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 29419 | 6783 | 12499 | 16 | 4074 | 1517 | 12 | 4518 | 15.4% |
...
- candidats AVEC connectivite : 3214, dont T2 : 100%
- candidats SANS connectivite : 4828, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3476 systemes avec CONNECTED sur 27079 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3752 candidats sur 8042 portent les champs bruts (47%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 75 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (34) : resistance **43.0%**
  - SANS connectivite (41) : resistance **21.0%**
...
- `ab89a63b01ef` — 75 candidats
  - AVEC connectivite (34) : T0=14.53 T1=0.00 T2=3.06 — pondere **6.12**
  - SANS connectivite (41) : T0=16.46 T1=0.00 T2=2.93 — pondere **5.85**
  - test de permutation : **p = 0.7691** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e80bc1b2b437` — 75 candidats
...
- TROP-CHER : 3498 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3476 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24578 systemes
  - sans CONNECTED : 0.0% sur 5490 systemes
