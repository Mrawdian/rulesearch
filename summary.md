...
| connect | 4 | 3 | 17619 | 8817 | 1135 | 609 | 1750 | 1402 | 1915 | 1770 | 10.0% |
...
- candidats AVEC connectivite : 1897, dont T2 : 100%
- candidats SANS connectivite : 2953, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2189 systemes avec CONNECTED sur 16891 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*560 candidats sur 4850 portent les champs bruts (12%).*
...
- `e3baecf8377b` — 296 candidats
  - AVEC connectivite (114) : resistance **44.2%**
...
- `e3baecf8377b` — 296 candidats
  - AVEC connectivite (114) : T0=12.93 T1=0.00 T2=3.18 — pondere **6.35**
...
**2 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0055).
...
- TROP-CHER : 2206 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2189 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14390 systemes
  - sans CONNECTED : 0.0% sur 3229 systemes
