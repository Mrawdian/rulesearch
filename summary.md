...
genere 2026-08-27 23:37 UTC — 119089 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 35745 systemes
...
- moteur actif `0caa9267db60` (75347 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 57068 | 28436 | 3944 | 1934 | 5656 | 4515 | 6027 | 5824 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 55906 | 12896 | 23722 | 26 | 7774 | 2890 | 25 | 8571 | 15.3% |
...
- candidats AVEC connectivite : 5951, dont T2 : 100%
- candidats SANS connectivite : 8881, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6301 systemes avec CONNECTED sur 49120 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10542 candidats sur 14832 portent les champs bruts (71%).*

- `5c556c16ea8b` — 4577 candidats
  - AVEC connectivite (1823) : resistance **42.1%**
  - SANS connectivite (2754) : resistance **22.4%**
...
- `5c556c16ea8b` — 4577 candidats
  - AVEC connectivite (1823) : T0=12.96 T1=0.00 T2=3.06 — pondere **6.12**
  - SANS connectivite (2754) : T0=15.77 T1=0.00 T2=2.71 — pondere **5.42**
...
- TROP-CHER : 6336 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6301 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 46619 systemes
  - sans CONNECTED : 0.0% sur 10449 systemes
