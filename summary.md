...
genere 2026-08-26 16:20 UTC — 53430 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 8247 systemes
...
- moteur actif `0caa9267db60` (9688 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23909 | 11927 | 1628 | 813 | 2373 | 1888 | 2553 | 2428 | 10.2% |
...
- candidats AVEC connectivite : 2555, dont T2 : 100%
- candidats SANS connectivite : 3918, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2827 systemes avec CONNECTED sur 22030 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2183 candidats sur 6473 portent les champs bruts (34%).*
...
- `06fe04a859f1` — 1068 candidats
  - AVEC connectivite (417) : resistance **40.9%**
...
- `06fe04a859f1` — 1068 candidats
  - AVEC connectivite (417) : T0=13.17 T1=0.00 T2=3.03 — pondere **6.06**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19529 systemes
  - sans CONNECTED : 0.0% sur 4380 systemes
