...
| connect | 4 | 3 | 5845 | 2941 | 375 | 212 | 561 | 473 | 608 | 605 | 10.4% |
| ref | 4 | 3 | 5700 | 1383 | 2376 | 1 | 757 | 277 | 2 | 904 | 15.9% |
...
- candidats AVEC connectivite : 608, dont T2 : 100%
- candidats SANS connectivite : 908, dont T2 : 100%
...
- **608 systemes avec CONNECTED sur 4847 (12.5%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 351 candidats
  - AVEC connectivite (129) : T0=13.10 T1=0.00 T2=2.88 — pondere **5.75**
  - SANS connectivite (222) : T0=15.97 T1=0.00 T2=2.64 — pondere **5.28**
  - test de permutation : **p = 0.1799** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 610 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 608 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 4790 systemes
  - sans CONNECTED : 0.0% sur 1055 systemes
