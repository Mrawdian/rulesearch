...
genere 2026-08-27 03:30 UTC — 78514 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 13607 systemes
...
- moteur actif `0caa9267db60` (34772 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 35812 | 8257 | 15237 | 20 | 4954 | 1868 | 19 | 5457 | 15.2% |
...
- candidats SANS connectivite : 5767, dont T2 : 100%
...
*5354 candidats sur 9644 portent les champs bruts (56%).*
...
- `ab89a63b01ef` — 1677 candidats
  - AVEC connectivite (697) : resistance **41.2%**
  - SANS connectivite (980) : resistance **22.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1677 candidats
  ...
  - SANS connectivite (980) : T0=15.93 T1=0.00 T2=2.70 — pondere **5.41**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
