...
genere 2026-09-03 09:12 UTC — 334668 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 251324 systemes
...
- moteur actif `0caa9267db60` (290926 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 165927 | 82446 | 11273 | 5551 | 16894 | 13087 | 17584 | 16967 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 162626 | 37872 | 68744 | 66 | 22552 | 8406 | 66 | 24908 | 15.3% |
...
- candidats AVEC connectivite : 17094, dont T2 : 100%
- candidats SANS connectivite : 25218, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **17858 systemes avec CONNECTED sur 137872 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*38022 candidats sur 42312 portent les champs bruts (90%).*

- `5c556c16ea8b` — 32057 candidats
  - AVEC connectivite (12966) : resistance **41.1%**
  - SANS connectivite (19091) : resistance **21.2%**
...
- `5c556c16ea8b` — 32057 candidats
  - AVEC connectivite (12966) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (19091) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.29**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 135371 systemes
  - sans CONNECTED : 0.0% sur 30556 systemes
