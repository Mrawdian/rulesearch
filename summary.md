...
| connect | 4 | 3 | 5242 | 2628 | 331 | 188 | 508 | 431 | 552 | 545 | 10.4% |
| ref | 4 | 3 | 5118 | 1240 | 2143 | 1 | 673 | 246 | 2 | 813 | 15.9% |
...
- candidats AVEC connectivite : 548, dont T2 : 100%
- candidats SANS connectivite : 817, dont T2 : 100%
...
- **552 systemes avec CONNECTED sur 4337 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 200 candidats
  - AVEC connectivite (69) : T0=13.28 T1=0.00 T2=2.86 — pondere **5.71**
  - SANS connectivite (131) : T0=15.89 T1=0.00 T2=2.69 — pondere **5.37**
...
- TROP-CHER : 554 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 552 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 4280 systemes
