...
genere 2026-09-02 22:59 UTC — 323062 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 239718 systemes
...
- moteur actif `0caa9267db60` (279320 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 160072 | 79508 | 10882 | 5352 | 16308 | 12615 | 16963 | 16396 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 156875 | 36572 | 66303 | 64 | 21697 | 8097 | 65 | 24065 | 15.3% |
...
- candidats AVEC connectivite : 16523, dont T2 : 100%
- candidats SANS connectivite : 24375, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **17237 systemes avec CONNECTED sur 133097 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*36608 candidats sur 40898 portent les champs bruts (90%).*

- `5c556c16ea8b` — 30643 candidats
  - AVEC connectivite (12395) : resistance **41.1%**
  - SANS connectivite (18248) : resistance **21.2%**
...
- `5c556c16ea8b` — 30643 candidats
  - AVEC connectivite (12395) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (18248) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 17312 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 17237 avec CONNECTED, 75 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 130596 systemes
