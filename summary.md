...
genere 2026-08-27 00:32 UTC — 71871 systemes evalues
...
- moteur actif `0caa9267db60` (28129 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 33239 | 16514 | 2285 | 1125 | 3304 | 2642 | 3545 | 3399 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 32517 | 7497 | 13806 | 18 | 4508 | 1704 | 16 | 4968 | 15.3% |
...
- candidats AVEC connectivite : 3526, dont T2 : 100%
- candidats SANS connectivite : 5278, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3819 systemes avec CONNECTED sur 29685 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4514 candidats sur 8804 portent les champs bruts (51%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 837 candidats
  - AVEC connectivite (346) : resistance **41.1%**
  - SANS connectivite (491) : resistance **21.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 837 candidats
  - AVEC connectivite (346) : T0=13.11 T1=0.00 T2=3.05 — pondere **6.10**
  - SANS connectivite (491) : T0=15.95 T1=0.00 T2=2.60 — pondere **5.20**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 798 candidats
...
- TROP-CHER : 3845 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3819 avec CONNECTED, 26 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 27184 systemes
  - sans CONNECTED : 0.0% sur 6055 systemes
