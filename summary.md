...
genere 2026-08-26 09:48 UTC — 37119 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 28145 systemes
...
| d4 | 4 | 4 | 5422 | 2491 | 1378 | 28 | 386 | 365 | 257 | 381 | 7.0% |
| ref | 4 | 3 | 15615 | 3670 | 6584 | 11 | 2145 | 793 | 7 | 2405 | 15.4% |
...
- candidats SANS connectivite : 2681, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1990 systemes avec CONNECTED sur 15311 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*110 candidats sur 4400 portent les champs bruts (2%).*

- `89c65c03c4ad` — 110 candidats
  - AVEC connectivite (42) : resistance **47.8%**
  - SANS connectivite (68) : resistance **21.1%**
...
- `89c65c03c4ad` — 3235 candidats
  - AVEC connectivite (1240) : T0=13.07 T1=0.00 T2=2.95 — pondere **5.90**
  - SANS connectivite (1995) : T0=15.85 T1=0.02 T2=2.65 — pondere **5.32**
