...
genere 2026-09-01 19:34 UTC — 291160 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 207816 systemes
...
- moteur actif `0caa9267db60` (247418 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 143961 | 71510 | 9779 | 4819 | 14619 | 11349 | 15217 | 14807 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 141084 | 32798 | 59679 | 59 | 19559 | 7288 | 63 | 21627 | 15.3% |
...
- candidats AVEC connectivite : 14934, dont T2 : 100%
- candidats SANS connectivite : 21937, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15491 systemes avec CONNECTED sur 119977 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*32581 candidats sur 36871 portent les champs bruts (88%).*

- `5c556c16ea8b` — 26616 candidats
  - AVEC connectivite (10806) : resistance **41.0%**
  - SANS connectivite (15810) : resistance **21.4%**
...
- `5c556c16ea8b` — 26616 candidats
  - AVEC connectivite (10806) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (15810) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
## cout
- temps total 90.2 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 15564 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15491 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 117476 systemes
  - sans CONNECTED : 0.0% sur 26485 systemes
