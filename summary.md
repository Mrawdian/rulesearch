...
genere 2026-09-06 16:49 UTC — 417123 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 333779 systemes
...
- moteur actif `0caa9267db60` (373381 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 207561 | 103049 | 14142 | 6907 | 21036 | 16336 | 22063 | 21390 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 203447 | 47307 | 85823 | 79 | 28376 | 10504 | 73 | 31268 | 15.4% |
...
- candidats AVEC connectivite : 21517, dont T2 : 100%
- candidats SANS connectivite : 31578, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **22337 systemes avec CONNECTED sur 171873 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*48805 candidats sur 53095 portent les champs bruts (92%).*

- `5c556c16ea8b` — 42840 candidats
  - AVEC connectivite (17389) : resistance **41.1%**
  - SANS connectivite (25451) : resistance **21.3%**
...
- `5c556c16ea8b` — 42840 candidats
  - AVEC connectivite (17389) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (25451) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
## cout
- temps total 129.8 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 22420 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 22337 avec CONNECTED, 83 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 169372 systemes
  - sans CONNECTED : 0.0% sur 38189 systemes
