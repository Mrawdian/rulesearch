...
genere 2026-09-03 18:00 UTC — 344455 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 261111 systemes
...
- moteur actif `0caa9267db60` (300713 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 170860 | 84950 | 11594 | 5725 | 17376 | 13478 | 18111 | 17451 | 10.2% |
...
- candidats AVEC connectivite : 17578, dont T2 : 100%
...
- **18385 systemes avec CONNECTED sur 141915 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39302 candidats sur 43592 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33337 candidats
  - AVEC connectivite (13450) : resistance **41.0%**
...
- `5c556c16ea8b` — 33337 candidats
  - AVEC connectivite (13450) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 18461 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18385 avec CONNECTED, 76 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 139414 systemes
  - sans CONNECTED : 0.0% sur 31446 systemes
