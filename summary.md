...
genere 2026-09-01 07:18 UTC — 275965 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 192621 systemes
...
- moteur actif `0caa9267db60` (232223 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 136291 | 67713 | 9223 | 4558 | 13829 | 10773 | 14408 | 14016 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 133559 | 31126 | 56438 | 58 | 18523 | 6907 | 60 | 20437 | 15.3% |
...
- candidats AVEC connectivite : 14143, dont T2 : 100%
- candidats SANS connectivite : 20747, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14682 systemes avec CONNECTED sur 113703 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*30600 candidats sur 34890 portent les champs bruts (88%).*

- `5c556c16ea8b` — 24635 candidats
  - AVEC connectivite (10015) : resistance **41.0%**
  - SANS connectivite (14620) : resistance **21.3%**
...
- `5c556c16ea8b` — 24635 candidats
  - AVEC connectivite (10015) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (14620) : T0=15.93 T1=0.00 T2=2.66 — pondere **5.31**
...
## cout
- temps total 85.5 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 14752 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14682 avec CONNECTED, 70 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 111202 systemes
  - sans CONNECTED : 0.0% sur 25089 systemes
