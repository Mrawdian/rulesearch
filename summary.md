...
| connect | 4 | 3 | 18681 | 9320 | 1217 | 646 | 1866 | 1489 | 2024 | 1888 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 18280 | 4299 | 7700 | 13 | 2511 | 944 | 7 | 2806 | 15.4% |
...
- candidats AVEC connectivite : 2015, dont T2 : 100%
- candidats SANS connectivite : 3116, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2298 systemes avec CONNECTED sur 17742 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*841 candidats sur 5131 portent les champs bruts (16%).*
...
- `e3baecf8377b` — 577 candidats
  - AVEC connectivite (232) : resistance **41.9%**
  - SANS connectivite (345) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 577 candidats
  - AVEC connectivite (232) : T0=13.12 T1=0.00 T2=3.07 — pondere **6.15**
  - SANS connectivite (345) : T0=16.01 T1=0.00 T2=2.64 — pondere **5.28**
...
- TROP-CHER : 2315 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 2298 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 15241 systemes
