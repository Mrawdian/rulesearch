...
| connect | 4 | 3 | 7787 | 3925 | 512 | 269 | 743 | 618 | 815 | 816 | 10.5% |
| ref | 4 | 3 | 7613 | 1844 | 3185 | 1 | 1020 | 373 | 3 | 1187 | 15.6% |
...
- candidats AVEC connectivite : 819, dont T2 : 100%
- candidats SANS connectivite : 1191, dont T2 : 100%
...
- **815 systemes avec CONNECTED sur 6449 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 845 candidats
  - AVEC connectivite (340) : T0=13.41 T1=0.00 T2=2.86 — pondere **5.71**
  - SANS connectivite (505) : T0=15.79 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 818 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 815 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 6392 systemes
  - sans CONNECTED : 0.0% sur 1395 systemes
