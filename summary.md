...
genere 2026-08-27 20:56 UTC — 113813 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 30469 systemes
...
- moteur actif `0caa9267db60` (70071 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 54392 | 27088 | 3761 | 1843 | 5369 | 4304 | 5760 | 5559 | 10.2% |
...
- candidats AVEC connectivite : 5686, dont T2 : 100%
- candidats SANS connectivite : 8463, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6034 systemes avec CONNECTED sur 46953 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*9859 candidats sur 14149 portent les champs bruts (70%).*

- `5c556c16ea8b` — 3894 candidats
  - AVEC connectivite (1558) : resistance **42.0%**
...
- `5c556c16ea8b` — 3894 candidats
  - AVEC connectivite (1558) : T0=12.93 T1=0.00 T2=3.06 — pondere **6.11**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 44452 systemes
  - sans CONNECTED : 0.0% sur 9940 systemes
