...
genere 2026-08-28 04:34 UTC — 128665 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 45321 systemes
...
- moteur actif `0caa9267db60` (84923 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 61901 | 30798 | 4266 | 2095 | 6174 | 4914 | 6500 | 6357 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 60649 | 14042 | 25672 | 28 | 8439 | 3141 | 27 | 9298 | 15.3% |
...
- candidats AVEC connectivite : 6484, dont T2 : 100%
- candidats SANS connectivite : 9608, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6774 systemes avec CONNECTED sur 53013 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11802 candidats sur 16092 portent les champs bruts (73%).*

- `5c556c16ea8b` — 5837 candidats
  - AVEC connectivite (2356) : resistance **41.8%**
  - SANS connectivite (3481) : resistance **22.1%**
...
- `5c556c16ea8b` — 5837 candidats
  - AVEC connectivite (2356) : T0=12.99 T1=0.00 T2=3.04 — pondere **6.07**
  - SANS connectivite (3481) : T0=15.85 T1=0.00 T2=2.70 — pondere **5.39**
...
- TROP-CHER : 6811 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6774 avec CONNECTED, 37 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 50512 systemes
