...
genere 2026-08-25 22:03 UTC — 7348 systemes evalues

## versions du DSL presentes
- `615abe43d6bc` : 6371 systemes
...
| connect | 4 | 3 | 3658 | 1848 | 236 | 122 | 357 | 294 | 371 | 387 | 10.6% |
...
- candidats AVEC connectivite : 390, dont T2 : 100%
- candidats SANS connectivite : 561, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **371 systemes avec CONNECTED sur 3045 (12.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- TROP-CHER : 373 systemes abandonnes (5.1% des systemes), 96% du temps total
  dont 371 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.4% sur 2988 systemes
  - sans CONNECTED : 0.0% sur 670 systemes
