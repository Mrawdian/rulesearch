...
genere 2026-08-28 00:00 UTC — 119875 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 36531 systemes
...
- moteur actif `0caa9267db60` (76133 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 57454 | 28613 | 3971 | 1943 | 5700 | 4547 | 6064 | 5880 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 56306 | 12991 | 23896 | 27 | 7832 | 2907 | 25 | 8626 | 15.3% |
...
- candidats SANS connectivite : 8936, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6338 systemes avec CONNECTED sur 49433 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10653 candidats sur 14943 portent les champs bruts (71%).*

- `5c556c16ea8b` — 4688 candidats
  - AVEC connectivite (1879) : resistance **41.9%**
  - SANS connectivite (2809) : resistance **22.5%**
...
- `5c556c16ea8b` — 4688 candidats
  ...
  - SANS connectivite (2809) : T0=15.78 T1=0.00 T2=2.72 — pondere **5.44**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 46932 systemes
