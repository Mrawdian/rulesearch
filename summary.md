...
genere 2026-08-26 13:34 UTC — 46941 systemes evalues
...
- moteur actif `0caa9267db60` (3199 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20633 | 10290 | 1362 | 717 | 2055 | 1641 | 2202 | 2111 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20193 | 4723 | 8532 | 13 | 2801 | 1043 | 7 | 3074 | 15.2% |
...
- candidats AVEC connectivite : 2238, dont T2 : 100%
- candidats SANS connectivite : 3384, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2476 systemes avec CONNECTED sur 19345 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1332 candidats sur 5622 portent les champs bruts (24%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 217 candidats
  - AVEC connectivite (100) : resistance **38.6%**
  - SANS connectivite (117) : resistance **21.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 217 candidats
  - AVEC connectivite (100) : T0=13.53 T1=0.00 T2=2.78 — pondere **5.56**
  - SANS connectivite (117) : T0=16.14 T1=0.00 T2=2.85 — pondere **5.71**
  - test de permutation : **p = 0.7171** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
- TROP-CHER : 2493 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2476 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16844 systemes
  - sans CONNECTED : 0.0% sur 3789 systemes
