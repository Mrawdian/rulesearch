...
genere 2026-09-07 10:59 UTC — 434287 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 350943 systemes
...
- moteur actif `0caa9267db60` (390545 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 216242 | 107423 | 14721 | 7198 | 21899 | 16954 | 23001 | 22294 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 211930 | 49341 | 89359 | 83 | 29525 | 10952 | 76 | 32576 | 15.4% |
...
- candidats SANS connectivite : 32886, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23275 systemes avec CONNECTED sur 179047 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*51017 candidats sur 55307 portent les champs bruts (92%).*

- `5c556c16ea8b` — 45052 candidats
  - AVEC connectivite (18293) : resistance **41.1%**
  - SANS connectivite (26759) : resistance **21.3%**
...
- `5c556c16ea8b` — 45052 candidats
  ...
  - SANS connectivite (26759) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 176546 systemes
  - sans CONNECTED : 0.0% sur 39696 systemes
