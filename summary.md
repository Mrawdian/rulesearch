...
genere 2026-08-26 18:29 UTC — 58459 systemes evalues
...
- moteur actif `0caa9267db60` (14717 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 26448 | 13182 | 1803 | 895 | 2621 | 2090 | 2818 | 2713 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 25896 | 5952 | 10986 | 15 | 3612 | 1329 | 10 | 3992 | 15.4% |
...
- candidats AVEC connectivite : 2840, dont T2 : 100%
- candidats SANS connectivite : 4302, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3092 systemes avec CONNECTED sur 24133 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2852 candidats sur 7142 portent les champs bruts (40%).*
...
- `b71bb0907fb5` — 53 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `8f22f0d2d442` — 48 candidats
  - AVEC connectivite (17) : resistance **40.4%**
  - SANS connectivite (31) : resistance **18.2%**
...
- `8f22f0d2d442` — 48 candidats
  - AVEC connectivite (17) : T0=13.29 T1=0.00 T2=2.71 — pondere **5.41**
  - SANS connectivite (31) : T0=16.00 T1=0.00 T2=2.48 — pondere **4.97**
...
- TROP-CHER : 3112 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3092 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 21632 systemes
  - sans CONNECTED : 0.0% sur 4816 systemes
