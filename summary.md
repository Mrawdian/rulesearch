...
genere 2026-08-28 05:52 UTC — 130974 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 47630 systemes
...
- moteur actif `0caa9267db60` (87232 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 63065 | 31350 | 4327 | 2138 | 6306 | 5024 | 6628 | 6479 | 10.3% |
...
- candidats AVEC connectivite : 6606, dont T2 : 100%
- candidats SANS connectivite : 9788, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6902 systemes avec CONNECTED sur 53950 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12104 candidats sur 16394 portent les champs bruts (74%).*

- `5c556c16ea8b` — 6139 candidats
  - AVEC connectivite (2478) : resistance **41.5%**
...
- `5c556c16ea8b` — 6139 candidats
  - AVEC connectivite (2478) : T0=12.98 T1=0.00 T2=3.02 — pondere **6.03**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 51449 systemes
  - sans CONNECTED : 0.0% sur 11616 systemes
