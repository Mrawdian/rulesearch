...
genere 2026-08-26 17:05 UTC — 55177 systemes evalues
...
- moteur actif `0caa9267db60` (11435 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
| connect | 4 | 3 | 24789 | 12380 | 1684 | 840 | 2454 | 1951 | 2645 | 2525 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 24273 | 5618 | 10263 | 14 | 3398 | 1231 | 10 | 3739 | 15.4% |
...
- candidats AVEC connectivite : 2652, dont T2 : 100%
- candidats SANS connectivite : 4049, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2919 systemes avec CONNECTED sur 22769 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2411 candidats sur 6701 portent les champs bruts (36%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 101 candidats
  - AVEC connectivite (38) : resistance **39.2%**
  - SANS connectivite (63) : resistance **22.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `23303c299f39` — 101 candidats
  - AVEC connectivite (38) : T0=12.71 T1=0.00 T2=2.89 — pondere **5.79**
  - SANS connectivite (63) : T0=16.70 T1=0.00 T2=2.78 — pondere **5.56**
  - test de permutation : **p = 0.7676** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 2939 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2919 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 20268 systemes
  - sans CONNECTED : 0.0% sur 4521 systemes
