...
genere 2026-08-28 09:59 UTC — 138226 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 54882 systemes
...
- moteur actif `0caa9267db60` (94484 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 66741 | 33164 | 4575 | 2268 | 6676 | 5326 | 7028 | 6848 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 65370 | 15117 | 27633 | 30 | 9110 | 3378 | 28 | 10071 | 15.4% |
...
- candidats SANS connectivite : 10381, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7302 systemes avec CONNECTED sur 56952 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*13066 candidats sur 17356 portent les champs bruts (75%).*

- `5c556c16ea8b` — 7101 candidats
  - AVEC connectivite (2847) : resistance **41.4%**
  - SANS connectivite (4254) : resistance **21.8%**
...
- `5c556c16ea8b` — 7101 candidats
  ...
  - SANS connectivite (4254) : T0=15.86 T1=0.00 T2=2.67 — pondere **5.35**
...
- TROP-CHER : 7340 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7302 avec CONNECTED, 38 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 54451 systemes
  - sans CONNECTED : 0.0% sur 12290 systemes
