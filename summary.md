...
| connect | 4 | 3 | 5471 | 2750 | 352 | 200 | 528 | 450 | 569 | 561 | 10.3% |
...
- candidats AVEC connectivite : 564, dont T2 : 100%
...
- **569 systemes avec CONNECTED sur 4528 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 250 candidats
  - AVEC connectivite (85) : T0=13.27 T1=0.00 T2=2.73 — pondere **5.46**
  - SANS connectivite (165) : T0=15.95 T1=0.00 T2=2.65 — pondere **5.30**
  - test de permutation : **p = 0.6742** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 571 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 569 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 4471 systemes
  - sans CONNECTED : 0.0% sur 1000 systemes
