...
genere 2026-09-01 06:54 UTC — 275491 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 192147 systemes
...
- moteur actif `0caa9267db60` (231749 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 136052 | 67603 | 9204 | 4550 | 13808 | 10758 | 14378 | 13987 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 133324 | 31068 | 56342 | 58 | 18491 | 6892 | 60 | 20403 | 15.3% |
...
- candidats AVEC connectivite : 14114, dont T2 : 100%
- candidats SANS connectivite : 20713, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14652 systemes avec CONNECTED sur 113509 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*30537 candidats sur 34827 portent les champs bruts (88%).*

- `5c556c16ea8b` — 24572 candidats
  - AVEC connectivite (9986) : resistance **41.0%**
  - SANS connectivite (14586) : resistance **21.3%**
...
- `5c556c16ea8b` — 24572 candidats
  - AVEC connectivite (9986) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (14586) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
## cout
- temps total 85.3 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 14722 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14652 avec CONNECTED, 70 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 111008 systemes
  - sans CONNECTED : 0.0% sur 25044 systemes
