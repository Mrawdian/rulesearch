...
genere 2026-09-08 22:39 UTC — 466645 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 383301 systemes
...
- moteur actif `0caa9267db60` (422903 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 232574 | 115531 | 15832 | 7789 | 23528 | 18217 | 24775 | 23952 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 227956 | 53098 | 96056 | 91 | 31748 | 11780 | 81 | 35083 | 15.4% |
...
- candidats AVEC connectivite : 24079, dont T2 : 100%
- candidats SANS connectivite : 35393, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25049 systemes avec CONNECTED sur 192417 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55182 candidats sur 59472 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49217 candidats
  - AVEC connectivite (19951) : resistance **41.2%**
  - SANS connectivite (29266) : resistance **21.3%**
...
- `5c556c16ea8b` — 49217 candidats
  - AVEC connectivite (19951) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (29266) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 25140 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25049 avec CONNECTED, 91 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 189916 systemes
  - sans CONNECTED : 0.0% sur 42658 systemes
