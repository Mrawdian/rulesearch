...
genere 2026-08-27 13:22 UTC — 99101 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 18378 systemes
- `5c556c16ea8b` : 15757 systemes
...
- moteur actif `0caa9267db60` (55359 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 46975 | 23408 | 3232 | 1604 | 4661 | 3701 | 4965 | 4800 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 46011 | 10647 | 19512 | 25 | 6362 | 2402 | 22 | 7040 | 15.3% |
...
- candidats AVEC connectivite : 4927, dont T2 : 100%
- candidats SANS connectivite : 7350, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5239 systemes avec CONNECTED sur 40907 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*7987 candidats sur 12277 portent les champs bruts (65%).*
...
- `ab89a63b01ef` — 2280 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 2022 candidats
  - AVEC connectivite (799) : resistance **42.0%**
  - SANS connectivite (1223) : resistance **22.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 2280 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 2022 candidats
  - AVEC connectivite (799) : T0=13.02 T1=0.00 T2=3.06 — pondere **6.13**
  - SANS connectivite (1223) : T0=15.76 T1=0.00 T2=2.66 — pondere **5.33**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 38406 systemes
  - sans CONNECTED : 0.0% sur 8569 systemes
