...
genere 2026-08-31 15:00 UTC — 255190 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 171846 systemes
...
- moteur actif `0caa9267db60` (211448 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 125814 | 62546 | 8515 | 4218 | 12710 | 9952 | 13272 | 12951 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 123261 | 28747 | 52029 | 55 | 17069 | 6373 | 56 | 18922 | 15.4% |
...
- candidats AVEC connectivite : 13078, dont T2 : 100%
- candidats SANS connectivite : 19232, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13546 systemes avec CONNECTED sur 105156 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*28020 candidats sur 32310 portent les champs bruts (87%).*

- `5c556c16ea8b` — 22055 candidats
  - AVEC connectivite (8950) : resistance **41.0%**
  - SANS connectivite (13105) : resistance **21.4%**
...
- `5c556c16ea8b` — 22055 candidats
  - AVEC connectivite (8950) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.97**
  - SANS connectivite (13105) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 102655 systemes
  - sans CONNECTED : 0.0% sur 23159 systemes
