...
genere 2026-08-28 16:59 UTC — 150194 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 66850 systemes
...
- moteur actif `0caa9267db60` (106452 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 72772 | 36139 | 4973 | 2487 | 7297 | 5797 | 7694 | 7456 | 10.2% |
...
- candidats AVEC connectivite : 7583, dont T2 : 100%
...
- **7968 systemes avec CONNECTED sur 61872 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*14609 candidats sur 18899 portent les champs bruts (77%).*

- `5c556c16ea8b` — 8644 candidats
  - AVEC connectivite (3455) : resistance **41.2%**
...
- `5c556c16ea8b` — 8644 candidats
  - AVEC connectivite (3455) : T0=13.01 T1=0.00 T2=3.00 — pondere **6.00**
...
- TROP-CHER : 8009 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7968 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 59371 systemes
  - sans CONNECTED : 0.0% sur 13401 systemes
