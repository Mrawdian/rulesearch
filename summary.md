...
genere 2026-08-26 09:32 UTC — 36391 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 27417 systemes
...
**7466 enregistrements (21%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 15763 | 7857 | 1030 | 540 | 1561 | 1258 | 1723 | 1594 | 10.1% |
| d4 | 4 | 4 | 5062 | 2323 | 1292 | 26 | 361 | 336 | 244 | 355 | 7.0% |
| ref | 4 | 3 | 15442 | 3623 | 6516 | 11 | 2120 | 782 | 6 | 2384 | 15.4% |
...
- candidats AVEC connectivite : 1695, dont T2 : 100%
- candidats SANS connectivite : 2645, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1958 systemes avec CONNECTED sur 15011 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*50 candidats sur 4340 portent les champs bruts (1%).*

- `89c65c03c4ad` — 50 candidats
  - AVEC connectivite (18) : resistance **56.7%**
  - SANS connectivite (32) : resistance **24.6%**
...
- `89c65c03c4ad` — 3175 candidats
  - AVEC connectivite (1216) : T0=13.10 T1=0.00 T2=2.95 — pondere **5.90**
  - SANS connectivite (1959) : T0=15.86 T1=0.02 T2=2.66 — pondere **5.34**
...
## cout
- temps total 11.5 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 1973 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 1958 avec CONNECTED, 15 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.4% sur 12887 systemes
  - sans CONNECTED : 0.0% sur 2876 systemes
