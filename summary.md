...
**7466 enregistrements (63%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 5980 | 3017 | 385 | 214 | 574 | 480 | 621 | 619 | 10.4% |
| ref | 4 | 3 | 5831 | 1418 | 2425 | 1 | 779 | 286 | 2 | 920 | 15.8% |
...
- candidats AVEC connectivite : 622, dont T2 : 100%
- candidats SANS connectivite : 924, dont T2 : 100%
...
- **621 systemes avec CONNECTED sur 4959 (12.5%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 381 candidats
  - AVEC connectivite (143) : T0=13.11 T1=0.00 T2=2.95 — pondere **5.90**
  - SANS connectivite (238) : T0=15.96 T1=0.00 T2=2.66 — pondere **5.31**
...
## cout
- temps total 3.6 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 623 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 621 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 4902 systemes
  - sans CONNECTED : 0.0% sur 1078 systemes
