...
genere 2026-08-30 12:46 UTC — 218908 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 135564 systemes
...
- moteur actif `0caa9267db60` (175166 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 107490 | 53400 | 7312 | 3592 | 10827 | 8545 | 11372 | 11040 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 105303 | 24554 | 44478 | 49 | 14540 | 5444 | 41 | 16188 | 15.4% |
...
- candidats AVEC connectivite : 11167, dont T2 : 100%
- candidats SANS connectivite : 16498, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11646 systemes avec CONNECTED sur 90186 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*23375 candidats sur 27665 portent les champs bruts (84%).*

- `5c556c16ea8b` — 17410 candidats
  - AVEC connectivite (7039) : resistance **41.1%**
  - SANS connectivite (10371) : resistance **21.5%**
...
- `5c556c16ea8b` — 17410 candidats
  - AVEC connectivite (7039) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (10371) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 11697 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11646 avec CONNECTED, 51 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 87685 systemes
  - sans CONNECTED : 0.0% sur 19805 systemes
