...
genere 2026-09-09 01:15 UTC — 468990 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 385646 systemes
...
- moteur actif `0caa9267db60` (425248 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 233770 | 116096 | 15935 | 7824 | 23662 | 18315 | 24892 | 24082 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 229105 | 53353 | 96533 | 92 | 31932 | 11836 | 82 | 35258 | 15.4% |
...
- candidats SANS connectivite : 35568, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25166 systemes avec CONNECTED sur 193366 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55487 candidats sur 59777 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49522 candidats
  - AVEC connectivite (20081) : resistance **41.2%**
  - SANS connectivite (29441) : resistance **21.3%**
...
- `5c556c16ea8b` — 49522 candidats
  ...
  - SANS connectivite (29441) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 25258 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25166 avec CONNECTED, 92 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 190865 systemes
  - sans CONNECTED : 0.0% sur 42905 systemes
