...
genere 2026-09-04 12:54 UTC — 364915 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 281571 systemes
...
- moteur actif `0caa9267db60` (321173 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 181196 | 90040 | 12320 | 6054 | 18433 | 14277 | 19205 | 18551 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 177604 | 41259 | 75053 | 72 | 24668 | 9197 | 70 | 27271 | 15.4% |
...
- candidats AVEC connectivite : 18678, dont T2 : 100%
- candidats SANS connectivite : 27581, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19479 systemes avec CONNECTED sur 150316 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*41969 candidats sur 46259 portent les champs bruts (91%).*

- `5c556c16ea8b` — 36004 candidats
  - AVEC connectivite (14550) : resistance **41.0%**
  - SANS connectivite (21454) : resistance **21.2%**
...
- `5c556c16ea8b` — 36004 candidats
  - AVEC connectivite (14550) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (21454) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 147815 systemes
  - sans CONNECTED : 0.0% sur 33381 systemes
