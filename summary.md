...
genere 2026-08-27 08:21 UTC — 89027 systemes evalues
...
- moteur actif `0caa9267db60` (45285 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 41884 | 20859 | 2879 | 1418 | 4176 | 3292 | 4417 | 4299 | 10.3% |
...
- candidats AVEC connectivite : 4426, dont T2 : 100%
- candidats SANS connectivite : 6577, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4691 systemes avec CONNECTED sur 36737 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6713 candidats sur 11003 portent les champs bruts (61%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 748 candidats
  - AVEC connectivite (298) : resistance **41.4%**
...
- `5c556c16ea8b` — 748 candidats
  - AVEC connectivite (298) : T0=13.04 T1=0.00 T2=3.02 — pondere **6.04**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 34236 systemes
  - sans CONNECTED : 0.0% sur 7648 systemes
