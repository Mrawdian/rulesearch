...
genere 2026-09-10 02:14 UTC — 490486 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 407142 systemes
...
- moteur actif `0caa9267db60` (446744 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 244612 | 121451 | 16652 | 8196 | 24753 | 19190 | 26079 | 25186 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 239759 | 55891 | 100977 | 95 | 33399 | 12391 | 87 | 36898 | 15.4% |
...
- candidats AVEC connectivite : 25313, dont T2 : 100%
...
- **26353 systemes avec CONNECTED sur 202212 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*58231 candidats sur 62521 portent les champs bruts (93%).*

- `5c556c16ea8b` — 52266 candidats
  - AVEC connectivite (21185) : resistance **41.2%**
...
- `5c556c16ea8b` — 52266 candidats
  - AVEC connectivite (21185) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 26450 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 26353 avec CONNECTED, 97 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 199711 systemes
  - sans CONNECTED : 0.0% sur 44901 systemes
