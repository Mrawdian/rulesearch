...
genere 2026-09-04 00:51 UTC — 352057 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 268713 systemes
...
- moteur actif `0caa9267db60` (308315 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 174711 | 86849 | 11877 | 5842 | 17791 | 13749 | 18503 | 17874 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 171231 | 39793 | 72342 | 70 | 23778 | 8858 | 67 | 26309 | 15.4% |
...
- candidats AVEC connectivite : 18001, dont T2 : 100%
- candidats SANS connectivite : 26619, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18777 systemes avec CONNECTED sur 145057 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*40330 candidats sur 44620 portent les champs bruts (90%).*

- `5c556c16ea8b` — 34365 candidats
  - AVEC connectivite (13873) : resistance **41.0%**
  - SANS connectivite (20492) : resistance **21.3%**
...
- `5c556c16ea8b` — 34365 candidats
  - AVEC connectivite (13873) : T0=13.03 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (20492) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 18854 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18777 avec CONNECTED, 77 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 142556 systemes
  - sans CONNECTED : 0.0% sur 32155 systemes
