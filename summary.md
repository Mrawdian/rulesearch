...
genere 2026-08-29 23:09 UTC — 199050 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 115706 systemes
...
- moteur actif `0caa9267db60` (155308 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 97458 | 48404 | 6630 | 3275 | 9830 | 7747 | 10274 | 10047 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 95477 | 22284 | 40314 | 44 | 13201 | 4912 | 37 | 14679 | 15.4% |
...
- candidats SANS connectivite : 14989, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10548 systemes avec CONNECTED sur 81997 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*20873 candidats sur 25163 portent les champs bruts (83%).*

- `5c556c16ea8b` — 14908 candidats
  - AVEC connectivite (6046) : resistance **41.1%**
  - SANS connectivite (8862) : resistance **21.5%**
...
- `5c556c16ea8b` — 14908 candidats
  ...
  - SANS connectivite (8862) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 10595 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10548 avec CONNECTED, 47 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 79496 systemes
