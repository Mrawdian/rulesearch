...
genere 2026-08-27 06:33 UTC — 85119 systemes evalues
...
- moteur actif `0caa9267db60` (41377 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 39913 | 19884 | 2732 | 1357 | 3974 | 3137 | 4219 | 4094 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 39091 | 9002 | 16632 | 22 | 5417 | 2041 | 21 | 5956 | 15.2% |
...
- candidats SANS connectivite : 6266, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4493 systemes avec CONNECTED sur 35143 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6197 candidats sur 10487 portent les champs bruts (59%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 232 candidats
  - AVEC connectivite (93) : resistance **43.2%**
  - SANS connectivite (139) : resistance **22.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 232 candidats
  ...
  - SANS connectivite (139) : T0=15.91 T1=0.00 T2=2.73 — pondere **5.45**
...
- TROP-CHER : 4524 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4493 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 32642 systemes
  - sans CONNECTED : 0.0% sur 7271 systemes
