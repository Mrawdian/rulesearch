...
genere 2026-08-26 13:45 UTC — 47455 systemes evalues
...
- moteur actif `0caa9267db60` (3713 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20886 | 10432 | 1385 | 721 | 2073 | 1658 | 2223 | 2136 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20454 | 4786 | 8636 | 13 | 2831 | 1057 | 7 | 3124 | 15.3% |
...
- candidats AVEC connectivite : 2263, dont T2 : 100%
- candidats SANS connectivite : 3434, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2497 systemes avec CONNECTED sur 19561 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1407 candidats sur 5697 portent les champs bruts (25%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 292 candidats
  - AVEC connectivite (125) : resistance **39.6%**
  - SANS connectivite (167) : resistance **21.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 292 candidats
  - AVEC connectivite (125) : T0=13.26 T1=0.00 T2=2.86 — pondere **5.71**
  - SANS connectivite (167) : T0=16.19 T1=0.00 T2=2.75 — pondere **5.50**
  - test de permutation : **p = 0.5742** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
## cout
- temps total 14.6 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2514 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2497 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 17060 systemes
  - sans CONNECTED : 0.0% sur 3826 systemes
