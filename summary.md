...
genere 2026-08-26 10:36 UTC — 39156 systemes evalues
...
- `e3baecf8377b` : 563 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
**8029 enregistrements (21%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
*337 candidats sur 4627 portent les champs bruts (7%).*
...
- `e3baecf8377b` — 73 candidats (**NON REPRODUCTIBLE**)
...
- `e3baecf8377b` — 73 candidats
  - AVEC connectivite (29) : T0=13.69 T1=0.00 T2=2.83 — pondere **5.66**
  - SANS connectivite (44) : T0=15.98 T1=0.00 T2=2.32 — pondere **4.64**
  - test de permutation : **p = 0.1834** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
