...
| connect | 4 | 3 | 18890 | 9430 | 1234 | 653 | 1883 | 1505 | 2044 | 1908 | 10.1% |
...
- candidats AVEC connectivite : 2035, dont T2 : 100%
- candidats SANS connectivite : 3149, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2318 systemes avec CONNECTED sur 17918 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*894 candidats sur 5184 portent les champs bruts (17%).*
...
- `e3baecf8377b` — 630 candidats
  - AVEC connectivite (252) : resistance **42.2%**
...
- `e3baecf8377b` — 630 candidats
  - AVEC connectivite (252) : T0=13.08 T1=0.00 T2=3.10 — pondere **6.21**
...
- TROP-CHER : 2335 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2318 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 15417 systemes
  - sans CONNECTED : 0.0% sur 3473 systemes
