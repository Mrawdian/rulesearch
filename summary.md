...
genere 2026-09-01 20:00 UTC — 291608 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 208264 systemes
...
- moteur actif `0caa9267db60` (247866 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 144186 | 71627 | 9791 | 4828 | 14634 | 11365 | 15252 | 14826 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 141307 | 32849 | 59768 | 59 | 19586 | 7307 | 63 | 21664 | 15.3% |
...
- candidats SANS connectivite : 21974, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15526 systemes avec CONNECTED sur 120171 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*32637 candidats sur 36927 portent les champs bruts (88%).*

- `5c556c16ea8b` — 26672 candidats
  - AVEC connectivite (10825) : resistance **41.0%**
  - SANS connectivite (15847) : resistance **21.4%**
...
- `5c556c16ea8b` — 26672 candidats
  ...
  - SANS connectivite (15847) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 117670 systemes
  - sans CONNECTED : 0.0% sur 26516 systemes
