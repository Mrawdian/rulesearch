...
| connect | 4 | 3 | 5138 | 2574 | 324 | 185 | 503 | 419 | 538 | 537 | 10.5% |
...
- candidats AVEC connectivite : 540, dont T2 : 100%
...
- **538 systemes avec CONNECTED sur 4251 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 171 candidats
  - AVEC connectivite (61) : T0=13.16 T1=0.00 T2=2.85 — pondere **5.70**
...
- TROP-CHER : 540 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 538 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 4194 systemes
  - sans CONNECTED : 0.0% sur 944 systemes
