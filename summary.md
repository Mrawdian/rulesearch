...
genere 2026-08-26 01:43 UTC — 16652 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 7678 systemes
...
| connect | 4 | 3 | 8356 | 4206 | 545 | 284 | 794 | 671 | 890 | 865 | 10.4% |
...
- candidats AVEC connectivite : 868, dont T2 : 100%
...
- **890 systemes avec CONNECTED sur 6917 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 978 candidats
  - AVEC connectivite (389) : T0=13.37 T1=0.00 T2=2.85 — pondere **5.71**
...
- TROP-CHER : 893 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 890 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 6860 systemes
  - sans CONNECTED : 0.0% sur 1496 systemes
