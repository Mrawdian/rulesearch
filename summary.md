...
genere 2026-08-26 12:27 UTC — 43901 systemes evalues
...
- `e40600351a72` : 159 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
- `6680f7b47e6f` : 124 systemes

Les lignes de dsl_hash differents ne sont pas comparables entre elles.

**7625 enregistrements (17%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| ref | 4 | 3 | 18687 | 4384 | 7877 | 13 | 2572 | 972 | 7 | 2862 | 15.3% |
...
- candidats SANS connectivite : 3172, dont T2 : 100%
...
*943 candidats sur 5233 portent les champs bruts (18%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `e40600351a72` — 22 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (10) : resistance **38.8%**
  - SANS connectivite (12) : resistance **18.5%**
...
- `e40600351a72` — 22 candidats
  - AVEC connectivite (10) : T0=14.90 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (12) : T0=16.25 T1=0.00 T2=2.17 — pondere **4.33**
  - *groupes trop petits (< 20) — aucun test, aucune conclusion*
