...
genere 2026-08-30 09:06 UTC — 213543 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 130199 systemes
...
- moteur actif `0caa9267db60` (169801 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 104778 | 52021 | 7129 | 3492 | 10563 | 8342 | 11090 | 10778 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 102650 | 23946 | 43342 | 48 | 14178 | 5297 | 41 | 15790 | 15.4% |
...
- candidats AVEC connectivite : 10905, dont T2 : 100%
- candidats SANS connectivite : 16100, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11364 systemes avec CONNECTED sur 87965 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*22715 candidats sur 27005 portent les champs bruts (84%).*

- `5c556c16ea8b` — 16750 candidats
  - AVEC connectivite (6777) : resistance **41.2%**
  - SANS connectivite (9973) : resistance **21.5%**
...
- `5c556c16ea8b` — 16750 candidats
  - AVEC connectivite (6777) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (9973) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
## cout
- temps total 66.2 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 11415 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11364 avec CONNECTED, 51 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 85464 systemes
  - sans CONNECTED : 0.0% sur 19314 systemes
