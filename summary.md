...
genere 2026-08-30 23:41 UTC — 234262 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 150918 systemes
...
- moteur actif `0caa9267db60` (190520 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 115253 | 57302 | 7828 | 3873 | 11572 | 9110 | 12199 | 11855 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 112894 | 26335 | 47707 | 53 | 15574 | 5833 | 50 | 17332 | 15.4% |
...
- candidats AVEC connectivite : 11982, dont T2 : 100%
...
- **12473 systemes avec CONNECTED sur 96621 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*25334 candidats sur 29624 portent les champs bruts (86%).*

- `5c556c16ea8b` — 19369 candidats
  - AVEC connectivite (7854) : resistance **41.0%**
...
- `5c556c16ea8b` — 19369 candidats
  - AVEC connectivite (7854) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.98**
...
- TROP-CHER : 12533 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 12473 avec CONNECTED, 60 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 94120 systemes
  - sans CONNECTED : 0.0% sur 21133 systemes
