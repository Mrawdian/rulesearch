...
genere 2026-08-29 22:35 UTC — 198181 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 114837 systemes
...
- moteur actif `0caa9267db60` (154439 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 97011 | 48176 | 6594 | 3262 | 9785 | 7720 | 10229 | 9999 | 10.3% |
...
- candidats AVEC connectivite : 10126, dont T2 : 100%
...
- **10503 systemes avec CONNECTED sur 81626 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*20753 candidats sur 25043 portent les champs bruts (83%).*

- `5c556c16ea8b` — 14788 candidats
  - AVEC connectivite (5998) : resistance **41.2%**
...
- `5c556c16ea8b` — 14788 candidats
  - AVEC connectivite (5998) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
...
- TROP-CHER : 10550 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10503 avec CONNECTED, 47 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 79125 systemes
  - sans CONNECTED : 0.0% sur 17886 systemes
