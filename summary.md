...
genere 2026-08-26 19:59 UTC — 61869 systemes evalues
...
- moteur actif `0caa9267db60` (18127 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 28183 | 14038 | 1927 | 948 | 2793 | 2231 | 2998 | 2894 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 27571 | 6366 | 11683 | 15 | 3829 | 1421 | 12 | 4245 | 15.4% |
...
- candidats AVEC connectivite : 3021, dont T2 : 100%
- candidats SANS connectivite : 4555, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3272 systemes avec CONNECTED sur 25563 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3286 candidats sur 7576 portent les champs bruts (43%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 417 candidats
  - AVEC connectivite (177) : resistance **39.1%**
  - SANS connectivite (240) : resistance **19.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 417 candidats
  - AVEC connectivite (177) : T0=12.85 T1=0.00 T2=2.81 — pondere **5.63**
  - SANS connectivite (240) : T0=16.11 T1=0.00 T2=2.60 — pondere **5.19**
  - test de permutation : **p = 0.1519** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- TROP-CHER : 3294 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3272 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23062 systemes
  - sans CONNECTED : 0.0% sur 5121 systemes
