...
genere 2026-08-29 15:16 UTC — 187041 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 103697 systemes
...
- moteur actif `0caa9267db60` (143299 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 91386 | 45439 | 6212 | 3075 | 9199 | 7279 | 9618 | 9401 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 89540 | 20919 | 37779 | 43 | 12387 | 4594 | 36 | 13776 | 15.4% |
...
- candidats AVEC connectivite : 9528, dont T2 : 100%
- candidats SANS connectivite : 14086, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9892 systemes avec CONNECTED sur 77046 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*19324 candidats sur 23614 portent les champs bruts (82%).*

- `5c556c16ea8b` — 13359 candidats
  - AVEC connectivite (5400) : resistance **41.2%**
  - SANS connectivite (7959) : resistance **21.6%**
...
- `5c556c16ea8b` — 13359 candidats
  - AVEC connectivite (5400) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (7959) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.33**
...
## cout
- temps total 57.6 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 9938 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 9892 avec CONNECTED, 46 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 74545 systemes
  - sans CONNECTED : 0.0% sur 16841 systemes
