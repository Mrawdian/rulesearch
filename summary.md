...
genere 2026-08-31 11:07 UTC — 249964 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 166620 systemes
...
- moteur actif `0caa9267db60` (206222 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 123169 | 61263 | 8356 | 4132 | 12399 | 9718 | 13009 | 12687 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 120680 | 28176 | 50947 | 53 | 16672 | 6245 | 55 | 18522 | 15.3% |
...
- candidats AVEC connectivite : 12814, dont T2 : 100%
- candidats SANS connectivite : 18832, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13283 systemes avec CONNECTED sur 103039 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*27356 candidats sur 31646 portent les champs bruts (86%).*

- `5c556c16ea8b` — 21391 candidats
  - AVEC connectivite (8686) : resistance **41.0%**
  - SANS connectivite (12705) : resistance **21.3%**
...
- `5c556c16ea8b` — 21391 candidats
  - AVEC connectivite (8686) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (12705) : T0=15.90 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 13348 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13283 avec CONNECTED, 65 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 100538 systemes
  - sans CONNECTED : 0.0% sur 22631 systemes
