...
genere 2026-08-30 00:41 UTC — 201392 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 118048 systemes
...
- moteur actif `0caa9267db60` (157650 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 98641 | 48965 | 6712 | 3310 | 9951 | 7858 | 10397 | 10173 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 96636 | 22547 | 40792 | 45 | 13355 | 4985 | 37 | 14868 | 15.4% |
...
- candidats SANS connectivite : 15178, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10671 systemes avec CONNECTED sur 82945 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*21188 candidats sur 25478 portent les champs bruts (83%).*

- `5c556c16ea8b` — 15223 candidats
  - AVEC connectivite (6172) : resistance **41.2%**
  - SANS connectivite (9051) : resistance **21.5%**
...
- `5c556c16ea8b` — 15223 candidats
  ...
  - SANS connectivite (9051) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 10718 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10671 avec CONNECTED, 47 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 80444 systemes
  - sans CONNECTED : 0.0% sur 18197 systemes
