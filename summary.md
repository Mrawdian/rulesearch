...
genere 2026-08-29 03:29 UTC — 168321 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 84977 systemes
...
- moteur actif `0caa9267db60` (124579 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 81927 | 40786 | 5569 | 2777 | 8226 | 6500 | 8604 | 8421 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 80279 | 18681 | 33972 | 37 | 11119 | 4081 | 34 | 12350 | 15.4% |
...
- candidats AVEC connectivite : 8548, dont T2 : 100%
- candidats SANS connectivite : 12660, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8878 systemes avec CONNECTED sur 69347 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*16918 candidats sur 21208 portent les champs bruts (80%).*

- `5c556c16ea8b` — 10953 candidats
  - AVEC connectivite (4420) : resistance **41.2%**
  - SANS connectivite (6533) : resistance **21.7%**
...
- `5c556c16ea8b` — 10953 candidats
  - AVEC connectivite (4420) : T0=13.01 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (6533) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.34**
...
- TROP-CHER : 8922 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8878 avec CONNECTED, 44 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 66846 systemes
  - sans CONNECTED : 0.0% sur 15081 systemes
