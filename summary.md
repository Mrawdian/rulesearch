...
genere 2026-08-26 02:35 UTC — 18669 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 9695 systemes
...
| connect | 4 | 3 | 9372 | 4713 | 614 | 315 | 898 | 742 | 1016 | 960 | 10.2% |
| ref | 4 | 3 | 9173 | 2203 | 3864 | 2 | 1218 | 454 | 4 | 1428 | 15.6% |
...
- candidats AVEC connectivite : 963, dont T2 : 100%
- candidats SANS connectivite : 1432, dont T2 : 100%
...
- **1016 systemes avec CONNECTED sur 7759 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1230 candidats
  - AVEC connectivite (484) : T0=13.33 T1=0.00 T2=2.90 — pondere **5.81**
  - SANS connectivite (746) : T0=15.86 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 1020 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1016 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 7702 systemes
  - sans CONNECTED : 0.0% sur 1670 systemes
