...
genere 2026-09-02 06:47 UTC — 304493 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 221149 systemes
...
- moteur actif `0caa9267db60` (260751 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 150680 | 74861 | 10248 | 5049 | 15290 | 11863 | 15958 | 15486 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 147698 | 34391 | 62482 | 62 | 20441 | 7616 | 63 | 22631 | 15.3% |
...
- candidats AVEC connectivite : 15613, dont T2 : 100%
- candidats SANS connectivite : 22941, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16232 systemes avec CONNECTED sur 125505 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*34264 candidats sur 38554 portent les champs bruts (89%).*

- `5c556c16ea8b` — 28299 candidats
  - AVEC connectivite (11485) : resistance **41.1%**
  - SANS connectivite (16814) : resistance **21.3%**
...
- `5c556c16ea8b` — 28299 candidats
  - AVEC connectivite (11485) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (16814) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 123004 systemes
  - sans CONNECTED : 0.0% sur 27676 systemes
