...
genere 2026-09-09 16:57 UTC — 482613 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 399269 systemes
...
- moteur actif `0caa9267db60` (438871 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 240651 | 119459 | 16406 | 8068 | 24359 | 18880 | 25633 | 24794 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 235847 | 54949 | 99386 | 94 | 32864 | 12175 | 86 | 36272 | 15.4% |
...
- candidats AVEC connectivite : 24921, dont T2 : 100%
- candidats SANS connectivite : 36582, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25907 systemes avec CONNECTED sur 198964 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*57213 candidats sur 61503 portent les champs bruts (93%).*

- `5c556c16ea8b` — 51248 candidats
  - AVEC connectivite (20793) : resistance **41.2%**
  - SANS connectivite (30455) : resistance **21.3%**
...
- `5c556c16ea8b` — 51248 candidats
  - AVEC connectivite (20793) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (30455) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 26003 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25907 avec CONNECTED, 96 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 196463 systemes
  - sans CONNECTED : 0.0% sur 44188 systemes
