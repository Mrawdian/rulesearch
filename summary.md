...
genere 2026-08-27 06:39 UTC — 85444 systemes evalues
...
- moteur actif `0caa9267db60` (41702 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 40077 | 19962 | 2743 | 1363 | 3993 | 3150 | 4228 | 4121 | 10.3% |
...
- candidats AVEC connectivite : 4248, dont T2 : 100%
- candidats SANS connectivite : 6291, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4502 systemes avec CONNECTED sur 35276 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6249 candidats sur 10539 portent les champs bruts (59%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 284 candidats
  - AVEC connectivite (120) : resistance **41.4%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 284 candidats
  - AVEC connectivite (120) : T0=13.04 T1=0.00 T2=3.03 — pondere **6.07**
  - SANS connectivite (164) : T0=15.86 T1=0.00 T2=2.72 — pondere **5.44**
  - test de permutation : **p = 0.0920** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 32775 systemes
  - sans CONNECTED : 0.0% sur 7302 systemes
