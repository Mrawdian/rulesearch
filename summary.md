...
genere 2026-09-01 18:18 UTC — 289651 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 206307 systemes
...
- moteur actif `0caa9267db60` (245909 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 143200 | 71147 | 9716 | 4789 | 14546 | 11300 | 15129 | 14724 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 140336 | 32634 | 59364 | 59 | 19450 | 7255 | 63 | 21500 | 15.3% |
...
- candidats AVEC connectivite : 14851, dont T2 : 100%
- candidats SANS connectivite : 21810, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15403 systemes avec CONNECTED sur 119346 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*32371 candidats sur 36661 portent les champs bruts (88%).*

- `5c556c16ea8b` — 26406 candidats
  - AVEC connectivite (10723) : resistance **41.0%**
  - SANS connectivite (15683) : resistance **21.3%**
...
- `5c556c16ea8b` — 26406 candidats
  - AVEC connectivite (10723) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (15683) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 116845 systemes
  - sans CONNECTED : 0.0% sur 26355 systemes
