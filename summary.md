...
genere 2026-08-30 05:55 UTC — 209205 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 125861 systemes
...
- moteur actif `0caa9267db60` (165463 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 102587 | 50928 | 6983 | 3435 | 10366 | 8181 | 10818 | 10540 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 100503 | 23404 | 42461 | 45 | 13883 | 5188 | 39 | 15475 | 15.4% |
...
- candidats AVEC connectivite : 10667, dont T2 : 100%
- candidats SANS connectivite : 15785, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11092 systemes avec CONNECTED sur 86161 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*22162 candidats sur 26452 portent les champs bruts (84%).*

- `5c556c16ea8b` — 16197 candidats
  - AVEC connectivite (6539) : resistance **41.1%**
  - SANS connectivite (9658) : resistance **21.5%**
...
- `5c556c16ea8b` — 16197 candidats
  - AVEC connectivite (6539) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (9658) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 11141 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11092 avec CONNECTED, 49 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 83660 systemes
  - sans CONNECTED : 0.0% sur 18927 systemes
