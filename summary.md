...
genere 2026-09-07 13:47 UTC — 436932 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 353588 systemes
...
- moteur actif `0caa9267db60` (393190 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 217571 | 108092 | 14831 | 7240 | 22028 | 17064 | 23137 | 22417 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 213246 | 49670 | 89879 | 83 | 29718 | 11014 | 77 | 32787 | 15.4% |
...
- candidats AVEC connectivite : 22544, dont T2 : 100%
- candidats SANS connectivite : 33097, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23411 systemes avec CONNECTED sur 180119 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*51351 candidats sur 55641 portent les champs bruts (92%).*

- `5c556c16ea8b` — 45386 candidats
  - AVEC connectivite (18416) : resistance **41.1%**
  - SANS connectivite (26970) : resistance **21.3%**
...
- `5c556c16ea8b` — 45386 candidats
  - AVEC connectivite (18416) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (26970) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 177618 systemes
  - sans CONNECTED : 0.0% sur 39953 systemes
