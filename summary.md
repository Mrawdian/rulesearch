...
- moteur actif `0caa9267db60` (8344 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23237 | 11576 | 1576 | 790 | 2318 | 1845 | 2485 | 2356 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 22734 | 5257 | 9597 | 14 | 3189 | 1157 | 10 | 3510 | 15.4% |
...
- candidats AVEC connectivite : 2483, dont T2 : 100%
- candidats SANS connectivite : 3820, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2759 systemes avec CONNECTED sur 21468 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2013 candidats sur 6303 portent les champs bruts (32%).*
...
- `06fe04a859f1` — 898 candidats
  - AVEC connectivite (345) : resistance **41.3%**
  - SANS connectivite (553) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 898 candidats
  - AVEC connectivite (345) : T0=13.21 T1=0.00 T2=3.03 — pondere **6.07**
  - SANS connectivite (553) : T0=16.03 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18967 systemes
  - sans CONNECTED : 0.0% sur 4270 systemes
