...
genere 2026-09-06 23:05 UTC — 423225 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 339881 systemes
...
- moteur actif `0caa9267db60` (379483 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 210639 | 104599 | 14350 | 7009 | 21368 | 16551 | 22374 | 21712 | 10.3% |
...
- candidats AVEC connectivite : 21839, dont T2 : 100%
...
- **22648 systemes avec CONNECTED sur 174399 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*49614 candidats sur 53904 portent les champs bruts (92%).*

- `5c556c16ea8b` — 43649 candidats
  - AVEC connectivite (17711) : resistance **41.1%**
...
- `5c556c16ea8b` — 43649 candidats
  - AVEC connectivite (17711) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 22731 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 22648 avec CONNECTED, 83 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 171898 systemes
  - sans CONNECTED : 0.0% sur 38741 systemes
