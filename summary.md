...
genere 2026-09-03 23:53 UTC — 351007 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 267663 systemes
...
- moteur actif `0caa9267db60` (307265 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 174173 | 86588 | 11834 | 5828 | 17737 | 13711 | 18445 | 17813 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 170719 | 39682 | 72134 | 70 | 23716 | 8830 | 67 | 26206 | 15.4% |
...
- candidats AVEC connectivite : 17940, dont T2 : 100%
- candidats SANS connectivite : 26516, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18719 systemes avec CONNECTED sur 144617 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*40166 candidats sur 44456 portent les champs bruts (90%).*

- `5c556c16ea8b` — 34201 candidats
  - AVEC connectivite (13812) : resistance **41.0%**
  - SANS connectivite (20389) : resistance **21.2%**
...
- `5c556c16ea8b` — 34201 candidats
  - AVEC connectivite (13812) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (20389) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 18796 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18719 avec CONNECTED, 77 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 142116 systemes
