...
genere 2026-08-25 22:41 UTC — 8856 systemes evalues

## versions du DSL presentes
- `615abe43d6bc` : 7172 systemes
- `0327bdc4c76a` : 853 systemes
- `12564867381b` : 413 systemes
...
| connect | 4 | 3 | 4423 | 2227 | 280 | 153 | 432 | 345 | 465 | 469 | 10.6% |
| ref | 4 | 3 | 4309 | 1048 | 1818 | 1 | 571 | 204 | 2 | 665 | 15.4% |
...
- candidats AVEC connectivite : 472, dont T2 : 100%
- candidats SANS connectivite : 669, dont T2 : 100%
...
- **465 systemes avec CONNECTED sur 3688 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- TROP-CHER : 467 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 465 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 3631 systemes
  - sans CONNECTED : 0.0% sur 792 systemes
