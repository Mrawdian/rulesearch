...
- moteur actif `0caa9267db60` (7062 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22579 | 11251 | 1518 | 770 | 2255 | 1787 | 2419 | 2298 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 22110 | 5124 | 9326 | 13 | 3090 | 1136 | 10 | 3411 | 15.4% |
...
- candidats AVEC connectivite : 2425, dont T2 : 100%
- candidats SANS connectivite : 3721, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2693 systemes avec CONNECTED sur 20930 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1856 candidats sur 6146 portent les champs bruts (30%).*
...
- `06fe04a859f1` — 741 candidats
  - AVEC connectivite (287) : resistance **41.2%**
  - SANS connectivite (454) : resistance **20.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 741 candidats
  - AVEC connectivite (287) : T0=13.36 T1=0.00 T2=3.03 — pondere **6.06**
  - SANS connectivite (454) : T0=16.02 T1=0.00 T2=2.62 — pondere **5.24**
...
- TROP-CHER : 2713 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2693 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18429 systemes
  - sans CONNECTED : 0.0% sur 4150 systemes
