...
**7466 enregistrements (47%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 7997 | 4032 | 519 | 272 | 764 | 637 | 842 | 838 | 10.5% |
| ref | 4 | 3 | 7816 | 1887 | 3276 | 1 | 1047 | 382 | 3 | 1220 | 15.6% |
...
- candidats AVEC connectivite : 841, dont T2 : 100%
- candidats SANS connectivite : 1224, dont T2 : 100%
...
- **842 systemes avec CONNECTED sur 6623 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 900 candidats
  - AVEC connectivite (362) : T0=13.40 T1=0.00 T2=2.84 — pondere **5.67**
  - SANS connectivite (538) : T0=15.86 T1=0.00 T2=2.65 — pondere **5.31**
  - test de permutation : **p = 0.0905** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- `T2` indices=0.15 — PAIRDIFF(>=1)@knight + PAIRSTEP(1)@adj + CONNECTED(v2) + COUNT(v2,1-4)@grid

## cout
- temps total 4.9 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 845 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 842 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 6566 systemes
  - sans CONNECTED : 0.0% sur 1431 systemes
