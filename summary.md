...
| connect | 4 | 3 | 18531 | 9249 | 1202 | 643 | 1851 | 1476 | 2011 | 1869 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 18147 | 4272 | 7648 | 13 | 2485 | 938 | 7 | 2784 | 15.3% |
...
- candidats AVEC connectivite : 1996, dont T2 : 100%
- candidats SANS connectivite : 3094, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2285 systemes avec CONNECTED sur 17625 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*800 candidats sur 5090 portent les champs bruts (16%).*
...
- `e3baecf8377b` — 536 candidats
  - AVEC connectivite (213) : resistance **42.2%**
  - SANS connectivite (323) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 536 candidats
  - AVEC connectivite (213) : T0=13.06 T1=0.00 T2=3.08 — pondere **6.17**
  - SANS connectivite (323) : T0=16.07 T1=0.00 T2=2.66 — pondere **5.32**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 15124 systemes
  - sans CONNECTED : 0.0% sur 3407 systemes
