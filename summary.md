...
genere 2026-09-04 15:35 UTC — 367935 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 284591 systemes
...
- moteur actif `0caa9267db60` (324193 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 182717 | 90818 | 12423 | 6104 | 18606 | 14392 | 19337 | 18696 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 179103 | 41630 | 75677 | 74 | 24883 | 9273 | 70 | 27482 | 15.3% |
...
- candidats AVEC connectivite : 18823, dont T2 : 100%
- candidats SANS connectivite : 27792, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19611 systemes avec CONNECTED sur 151541 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*42325 candidats sur 46615 portent les champs bruts (91%).*

- `5c556c16ea8b` — 36360 candidats
  - AVEC connectivite (14695) : resistance **41.0%**
  - SANS connectivite (21665) : resistance **21.2%**
...
- `5c556c16ea8b` — 36360 candidats
  - AVEC connectivite (14695) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (21665) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
## cout
- temps total 114.0 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 19691 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19611 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 149040 systemes
  - sans CONNECTED : 0.0% sur 33677 systemes
