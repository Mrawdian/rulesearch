...
genere 2026-08-26 18:44 UTC — 59113 systemes evalues
...
- moteur actif `0caa9267db60` (15371 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 26777 | 13362 | 1824 | 904 | 2655 | 2115 | 2848 | 2737 | 10.2% |
...
- candidats AVEC connectivite : 2864, dont T2 : 100%
- candidats SANS connectivite : 4358, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3122 systemes avec CONNECTED sur 24407 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2932 candidats sur 7222 portent les champs bruts (41%).*
...
- `8f22f0d2d442` — 65 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 63 candidats
  - AVEC connectivite (20) : resistance **46.2%**
...
- `62448a55927e` — 63 candidats
  - AVEC connectivite (20) : T0=13.65 T1=0.00 T2=3.35 — pondere **6.70**
...
- TROP-CHER : 3142 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3122 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 21906 systemes
  - sans CONNECTED : 0.0% sur 4871 systemes
