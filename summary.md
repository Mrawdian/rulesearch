...
genere 2026-09-07 03:05 UTC — 426958 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 343614 systemes
...
- moteur actif `0caa9267db60` (383216 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 212523 | 105517 | 14475 | 7073 | 21565 | 16708 | 22587 | 21897 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 208320 | 48480 | 87847 | 81 | 29038 | 10758 | 74 | 32024 | 15.4% |
...
- candidats AVEC connectivite : 22024, dont T2 : 100%
- candidats SANS connectivite : 32334, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **22861 systemes avec CONNECTED sur 175927 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*50068 candidats sur 54358 portent les champs bruts (92%).*

- `5c556c16ea8b` — 44103 candidats
  - AVEC connectivite (17896) : resistance **41.1%**
  - SANS connectivite (26207) : resistance **21.3%**
...
- `5c556c16ea8b` — 44103 candidats
  - AVEC connectivite (17896) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (26207) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
## cout
- temps total 132.8 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 22945 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 22861 avec CONNECTED, 84 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 173426 systemes
  - sans CONNECTED : 0.0% sur 39097 systemes
