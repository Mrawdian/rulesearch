...
genere 2026-08-26 20:07 UTC — 62196 systemes evalues
...
- moteur actif `0caa9267db60` (18454 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 28348 | 14115 | 1941 | 953 | 2811 | 2246 | 3015 | 2910 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 27733 | 6409 | 11748 | 15 | 3854 | 1424 | 12 | 4271 | 15.4% |
...
- candidats AVEC connectivite : 3037, dont T2 : 100%
- candidats SANS connectivite : 4581, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3289 systemes avec CONNECTED sur 25694 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3328 candidats sur 7618 portent les champs bruts (44%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 459 candidats
  - AVEC connectivite (193) : resistance **39.6%**
  - SANS connectivite (266) : resistance **20.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 459 candidats
  - AVEC connectivite (193) : T0=12.81 T1=0.00 T2=2.85 — pondere **5.70**
  - SANS connectivite (266) : T0=16.16 T1=0.00 T2=2.61 — pondere **5.21**
...
- TROP-CHER : 3311 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3289 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23193 systemes
  - sans CONNECTED : 0.0% sur 5155 systemes
