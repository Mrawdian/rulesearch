...
genere 2026-09-04 08:01 UTC — 359764 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 276420 systemes
...
- moteur actif `0caa9267db60` (316022 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 178595 | 88765 | 12133 | 5973 | 18170 | 14071 | 18922 | 18288 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 175054 | 40674 | 73947 | 71 | 24302 | 9075 | 70 | 26901 | 15.4% |
...
- candidats AVEC connectivite : 18415, dont T2 : 100%
- candidats SANS connectivite : 27211, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19196 systemes avec CONNECTED sur 148222 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*41336 candidats sur 45626 portent les champs bruts (91%).*

- `5c556c16ea8b` — 35371 candidats
  - AVEC connectivite (14287) : resistance **41.1%**
  - SANS connectivite (21084) : resistance **21.3%**
...
- `5c556c16ea8b` — 35371 candidats
  - AVEC connectivite (14287) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (21084) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
## cout
- temps total 111.6 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 19276 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19196 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 145721 systemes
  - sans CONNECTED : 0.0% sur 32874 systemes
