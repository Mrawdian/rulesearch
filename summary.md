...
genere 2026-08-26 10:04 UTC — 37835 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 28861 systemes
...
- candidats AVEC connectivite : 1743, dont T2 : 100%
- candidats SANS connectivite : 2723, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2025 systemes avec CONNECTED sur 15601 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*176 candidats sur 4466 portent les champs bruts (4%).*

- `89c65c03c4ad` — 176 candidats
  - AVEC connectivite (66) : resistance **47.5%**
...
- `89c65c03c4ad` — 3301 candidats
  - AVEC connectivite (1264) : T0=13.05 T1=0.00 T2=2.96 — pondere **5.92**
...
- TROP-CHER : 2042 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2025 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.4% sur 13186 systemes
