...
genere 2026-08-26 13:10 UTC — 45816 systemes evalues
...
- moteur actif `0caa9267db60` (2074 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20067 | 10023 | 1311 | 690 | 2010 | 1592 | 2152 | 2041 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 19634 | 4603 | 8297 | 13 | 2701 | 1015 | 7 | 2998 | 15.3% |
...
- candidats AVEC connectivite : 2168, dont T2 : 100%
- candidats SANS connectivite : 3308, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2426 systemes avec CONNECTED sur 18875 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1186 candidats sur 5476 portent les champs bruts (22%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 71 candidats
  - AVEC connectivite (30) : resistance **37.8%**
  - SANS connectivite (41) : resistance **19.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 71 candidats
  - AVEC connectivite (30) : T0=13.57 T1=0.00 T2=2.63 — pondere **5.27**
  - SANS connectivite (41) : T0=16.61 T1=0.00 T2=2.63 — pondere **5.27**
...
- TROP-CHER : 2443 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2426 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16374 systemes
  - sans CONNECTED : 0.0% sur 3693 systemes
