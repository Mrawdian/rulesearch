...
genere 2026-08-26 02:27 UTC — 18282 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 9308 systemes
...
| connect | 4 | 3 | 9179 | 4620 | 598 | 306 | 881 | 727 | 998 | 938 | 10.2% |
...
- candidats AVEC connectivite : 941, dont T2 : 100%
...
- **998 systemes avec CONNECTED sur 7602 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1177 candidats
  - AVEC connectivite (462) : T0=13.36 T1=0.00 T2=2.89 — pondere **5.78**
...
- TROP-CHER : 1002 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 998 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 7545 systemes
  - sans CONNECTED : 0.0% sur 1634 systemes
