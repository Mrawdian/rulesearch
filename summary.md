...
genere 2026-08-31 13:28 UTC — 253072 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 169728 systemes
...
- moteur actif `0caa9267db60` (209330 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 124739 | 62030 | 8451 | 4177 | 12593 | 9845 | 13172 | 12837 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 122218 | 28518 | 51589 | 54 | 16919 | 6317 | 56 | 18755 | 15.3% |
...
- candidats AVEC connectivite : 12964, dont T2 : 100%
- candidats SANS connectivite : 19065, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13446 systemes avec CONNECTED sur 104295 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*27739 candidats sur 32029 portent les champs bruts (87%).*

- `5c556c16ea8b` — 21774 candidats
  - AVEC connectivite (8836) : resistance **41.0%**
  - SANS connectivite (12938) : resistance **21.4%**
...
- `5c556c16ea8b` — 21774 candidats
  - AVEC connectivite (8836) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (12938) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 13512 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13446 avec CONNECTED, 66 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 101794 systemes
  - sans CONNECTED : 0.0% sur 22945 systemes
