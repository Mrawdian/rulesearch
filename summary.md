...
genere 2026-08-27 06:07 UTC — 84266 systemes evalues
...
- moteur actif `0caa9267db60` (40524 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 39481 | 19657 | 2710 | 1348 | 3931 | 3109 | 4170 | 4044 | 10.2% |
...
- candidats AVEC connectivite : 4171, dont T2 : 100%
- candidats SANS connectivite : 6193, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4444 systemes avec CONNECTED sur 34788 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6074 candidats sur 10364 portent les champs bruts (59%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 109 candidats
  - AVEC connectivite (43) : resistance **45.3%**
...
- `5c556c16ea8b` — 109 candidats
  - AVEC connectivite (43) : T0=12.72 T1=0.00 T2=3.28 — pondere **6.56**
...
**7 serie(s) reproductible(s) sur 14 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `ab89a63b01ef` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0060), `5c556c16ea8b` (p=0.0195), `b71bb0907fb5` (p=0.0110).
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 32287 systemes
  - sans CONNECTED : 0.0% sur 7194 systemes
