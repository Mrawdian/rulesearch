...
- moteur actif `0caa9267db60` (7669 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22893 | 11410 | 1545 | 777 | 2280 | 1816 | 2451 | 2326 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 22403 | 5188 | 9451 | 14 | 3135 | 1144 | 10 | 3461 | 15.4% |
...
- candidats SANS connectivite : 3771, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2725 systemes avec CONNECTED sur 21189 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1934 candidats sur 6224 portent les champs bruts (31%).*
...
- `06fe04a859f1` — 819 candidats
  - AVEC connectivite (315) : resistance **41.0%**
  - SANS connectivite (504) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 819 candidats
  ...
  - SANS connectivite (504) : T0=16.00 T1=0.00 T2=2.63 — pondere **5.26**
...
- TROP-CHER : 2745 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2725 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18688 systemes
  - sans CONNECTED : 0.0% sur 4205 systemes
