...
genere 2026-09-06 07:16 UTC — 407899 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 324555 systemes
...
- moteur actif `0caa9267db60` (364157 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 202905 | 100745 | 13847 | 6749 | 20579 | 15943 | 21558 | 20901 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 198879 | 46230 | 83937 | 78 | 27704 | 10277 | 73 | 30563 | 15.4% |
...
- candidats SANS connectivite : 30873, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21832 systemes avec CONNECTED sur 168070 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*47611 candidats sur 51901 portent les champs bruts (92%).*

- `5c556c16ea8b` — 41646 candidats
  - AVEC connectivite (16900) : resistance **41.1%**
  - SANS connectivite (24746) : resistance **21.3%**
...
- `5c556c16ea8b` — 41646 candidats
  ...
  - SANS connectivite (24746) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 21915 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21832 avec CONNECTED, 83 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 165569 systemes
  - sans CONNECTED : 0.0% sur 37336 systemes
