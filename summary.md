...
genere 2026-09-04 03:45 UTC — 355071 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 271727 systemes
...
- moteur actif `0caa9267db60` (311329 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 176218 | 87569 | 11984 | 5889 | 17944 | 13869 | 18689 | 18031 | 10.2% |
...
- candidats AVEC connectivite : 18158, dont T2 : 100%
...
- **18963 systemes avec CONNECTED sur 146285 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*40729 candidats sur 45019 portent les champs bruts (90%).*

- `5c556c16ea8b` — 34764 candidats
  - AVEC connectivite (14030) : resistance **41.0%**
...
- `5c556c16ea8b` — 34764 candidats
  - AVEC connectivite (14030) : T0=13.03 T1=0.00 T2=2.97 — pondere **5.95**
...
- TROP-CHER : 19041 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18963 avec CONNECTED, 78 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 143784 systemes
  - sans CONNECTED : 0.0% sur 32434 systemes
