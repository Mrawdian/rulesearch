...
| connect | 4 | 3 | 7352 | 3704 | 485 | 255 | 693 | 598 | 768 | 768 | 10.4% |
...
- **768 systemes avec CONNECTED sur 6087 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- TROP-CHER : 770 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 768 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 6030 systemes
  - sans CONNECTED : 0.0% sur 1322 systemes
