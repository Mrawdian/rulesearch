...
genere 2026-08-28 11:53 UTC — 141509 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 58165 systemes
...
- moteur actif `0caa9267db60` (97767 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 68398 | 33986 | 4694 | 2328 | 6851 | 5452 | 7212 | 7000 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 66996 | 15514 | 28329 | 30 | 9299 | 3461 | 30 | 10330 | 15.4% |
...
- candidats AVEC connectivite : 7127, dont T2 : 100%
- candidats SANS connectivite : 10640, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7486 systemes avec CONNECTED sur 58287 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*13477 candidats sur 17767 portent les champs bruts (76%).*

- `5c556c16ea8b` — 7512 candidats
  - AVEC connectivite (2999) : resistance **41.3%**
  - SANS connectivite (4513) : resistance **21.8%**
...
- `5c556c16ea8b` — 7512 candidats
  - AVEC connectivite (2999) : T0=13.01 T1=0.00 T2=3.01 — pondere **6.01**
  - SANS connectivite (4513) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.36**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 55786 systemes
  - sans CONNECTED : 0.0% sur 12612 systemes
