...
genere 2026-08-27 17:43 UTC — 107862 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 24518 systemes
...
- moteur actif `0caa9267db60` (64120 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 50352 | 11671 | 21353 | 26 | 6951 | 2628 | 23 | 7698 | 15.3% |
...
- candidats SANS connectivite : 8008, dont T2 : 100%
...
*9071 candidats sur 13361 portent les champs bruts (68%).*
...
- `5c556c16ea8b` — 3106 candidats
  - AVEC connectivite (1225) : resistance **42.0%**
  - SANS connectivite (1881) : resistance **22.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 3106 candidats
  ...
  - SANS connectivite (1881) : T0=15.78 T1=0.00 T2=2.70 — pondere **5.40**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 2280 candidats
