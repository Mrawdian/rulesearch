...
genere 2026-08-26 14:40 UTC — 49487 systemes evalues
...
- moteur actif `0caa9267db60` (5745 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21921 | 10933 | 1469 | 753 | 2172 | 1736 | 2342 | 2239 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 21451 | 4986 | 9059 | 13 | 2978 | 1104 | 9 | 3302 | 15.4% |
...
- candidats AVEC connectivite : 2366, dont T2 : 100%
- candidats SANS connectivite : 3612, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2616 systemes avec CONNECTED sur 20413 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1688 candidats sur 5978 portent les champs bruts (28%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 573 candidats
  - AVEC connectivite (228) : resistance **40.5%**
  - SANS connectivite (345) : resistance **20.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 573 candidats
  - AVEC connectivite (228) : T0=13.43 T1=0.00 T2=3.02 — pondere **6.04**
  - SANS connectivite (345) : T0=16.07 T1=0.00 T2=2.64 — pondere **5.28**
...
- TROP-CHER : 2635 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2616 avec CONNECTED, 19 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17912 systemes
  - sans CONNECTED : 0.0% sur 4009 systemes
