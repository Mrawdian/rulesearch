...
genere 2026-08-26 13:29 UTC — 46718 systemes evalues
...
- moteur actif `0caa9267db60` (2976 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20514 | 10232 | 1351 | 710 | 2050 | 1632 | 2192 | 2093 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20089 | 4703 | 8481 | 13 | 2785 | 1039 | 7 | 3061 | 15.2% |
...
- candidats AVEC connectivite : 2220, dont T2 : 100%
- candidats SANS connectivite : 3371, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2466 systemes avec CONNECTED sur 19242 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1301 candidats sur 5591 portent les champs bruts (23%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 186 candidats
  - AVEC connectivite (82) : resistance **38.3%**
  - SANS connectivite (104) : resistance **22.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 186 candidats
  - AVEC connectivite (82) : T0=13.55 T1=0.00 T2=2.76 — pondere **5.51**
  - SANS connectivite (104) : T0=16.25 T1=0.00 T2=2.94 — pondere **5.88**
  - test de permutation : **p = 0.4053** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
- TROP-CHER : 2483 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2466 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16741 systemes
  - sans CONNECTED : 0.0% sur 3773 systemes
