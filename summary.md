...
genere 2026-08-26 19:28 UTC — 60748 systemes evalues
...
- moteur actif `0caa9267db60` (17006 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27615 | 13775 | 1880 | 932 | 2727 | 2189 | 2936 | 2830 | 10.2% |
...
- candidats AVEC connectivite : 2957, dont T2 : 100%
- candidats SANS connectivite : 4469, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3210 systemes avec CONNECTED sur 25101 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3136 candidats sur 7426 portent les champs bruts (42%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 267 candidats
  - AVEC connectivite (113) : resistance **39.4%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 267 candidats
  - AVEC connectivite (113) : T0=13.03 T1=0.00 T2=2.90 — pondere **5.81**
...
- TROP-CHER : 3231 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3210 avec CONNECTED, 21 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22600 systemes
  - sans CONNECTED : 0.0% sur 5015 systemes
