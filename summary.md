...
| connect | 4 | 3 | 7892 | 3983 | 514 | 272 | 753 | 626 | 828 | 824 | 10.4% |
...
- candidats AVEC connectivite : 827, dont T2 : 100%
...
- **828 systemes avec CONNECTED sur 6537 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 871 candidats
  - AVEC connectivite (348) : T0=13.41 T1=0.00 T2=2.85 — pondere **5.70**
  - SANS connectivite (523) : T0=15.81 T1=0.00 T2=2.64 — pondere **5.29**
  - test de permutation : **p = 0.0665** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 831 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 828 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 6480 systemes
  - sans CONNECTED : 0.0% sur 1412 systemes
