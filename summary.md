...
genere 2026-08-29 09:24 UTC — 178021 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 94677 systemes
...
- moteur actif `0caa9267db60` (134279 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 86829 | 43178 | 5907 | 2948 | 8722 | 6904 | 9109 | 8956 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 85077 | 19872 | 35954 | 39 | 11743 | 4334 | 35 | 13094 | 15.4% |
...
- candidats SANS connectivite : 13404, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9383 systemes avec CONNECTED sur 73355 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*18197 candidats sur 22487 portent les champs bruts (81%).*

- `5c556c16ea8b` — 12232 candidats
  - AVEC connectivite (4955) : resistance **41.1%**
  - SANS connectivite (7277) : resistance **21.6%**
...
- `5c556c16ea8b` — 12232 candidats
  ...
  - SANS connectivite (7277) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 9428 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 9383 avec CONNECTED, 45 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 70854 systemes
  - sans CONNECTED : 0.0% sur 15975 systemes
