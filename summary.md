...
genere 2026-09-03 17:12 UTC — 343557 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 260213 systemes
...
- moteur actif `0caa9267db60` (299815 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 170415 | 84707 | 11563 | 5708 | 17330 | 13451 | 18065 | 17420 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 167027 | 38858 | 70591 | 67 | 23166 | 8637 | 66 | 25630 | 15.3% |
...
- candidats SANS connectivite : 25940, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18339 systemes avec CONNECTED sur 141541 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39197 candidats sur 43487 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33232 candidats
  - AVEC connectivite (13419) : resistance **41.0%**
  - SANS connectivite (19813) : resistance **21.2%**
...
- `5c556c16ea8b` — 33232 candidats
  ...
  - SANS connectivite (19813) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 139040 systemes
  - sans CONNECTED : 0.0% sur 31375 systemes
