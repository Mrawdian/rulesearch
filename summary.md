...
genere 2026-09-05 17:25 UTC — 394289 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 310945 systemes
...
- moteur actif `0caa9267db60` (350547 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 196022 | 97343 | 13342 | 6535 | 19930 | 15418 | 20799 | 20162 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 192152 | 44723 | 81075 | 78 | 26754 | 9932 | 71 | 29505 | 15.4% |
...
- candidats AVEC connectivite : 20289, dont T2 : 100%
...
- **21073 systemes avec CONNECTED sur 162423 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*45814 candidats sur 50104 portent les champs bruts (91%).*

- `5c556c16ea8b` — 39849 candidats
  - AVEC connectivite (16161) : resistance **41.1%**
...
- `5c556c16ea8b` — 39849 candidats
  - AVEC connectivite (16161) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
...
- TROP-CHER : 21154 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21073 avec CONNECTED, 81 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 159922 systemes
  - sans CONNECTED : 0.0% sur 36100 systemes
