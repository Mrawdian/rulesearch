...
genere 2026-08-26 14:33 UTC — 49219 systemes evalues
...
- moteur actif `0caa9267db60` (5477 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21786 | 10873 | 1455 | 748 | 2157 | 1725 | 2326 | 2225 | 10.2% |
...
- candidats AVEC connectivite : 2352, dont T2 : 100%
- candidats SANS connectivite : 3599, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2600 systemes avec CONNECTED sur 20311 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1661 candidats sur 5951 portent les champs bruts (28%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 546 candidats
  - AVEC connectivite (214) : resistance **40.3%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 546 candidats
  - AVEC connectivite (214) : T0=13.46 T1=0.00 T2=3.01 — pondere **6.03**
...
- TROP-CHER : 2618 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2600 avec CONNECTED, 18 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17810 systemes
  - sans CONNECTED : 0.0% sur 3976 systemes
