...
genere 2026-08-26 22:04 UTC — 66536 systemes evalues
...
- moteur actif `0caa9267db60` (22794 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 30533 | 15168 | 2089 | 1026 | 3051 | 2428 | 3251 | 3135 | 10.3% |
...
- candidats AVEC connectivite : 3262, dont T2 : 100%
- candidats SANS connectivite : 4907, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3525 systemes avec CONNECTED sur 27459 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3879 candidats sur 8169 portent les champs bruts (47%).*
...
- `23303c299f39` — 225 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 202 candidats
  - AVEC connectivite (82) : resistance **43.5%**
...
- `ab89a63b01ef` — 202 candidats
  - AVEC connectivite (82) : T0=13.27 T1=0.00 T2=3.06 — pondere **6.12**
  - SANS connectivite (120) : T0=15.94 T1=0.00 T2=2.74 — pondere **5.48**
  - test de permutation : **p = 0.1484** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24958 systemes
  - sans CONNECTED : 0.0% sur 5575 systemes
