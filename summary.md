...
genere 2026-08-31 03:46 UTC — 239835 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 156491 systemes
...
- moteur actif `0caa9267db60` (196093 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 118061 | 58731 | 8022 | 3958 | 11857 | 9301 | 12506 | 12144 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 115659 | 26986 | 48893 | 53 | 15960 | 5970 | 52 | 17735 | 15.3% |
...
- candidats AVEC connectivite : 12271, dont T2 : 100%
- candidats SANS connectivite : 18045, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12780 systemes avec CONNECTED sur 98919 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*26026 candidats sur 30316 portent les champs bruts (86%).*

- `5c556c16ea8b` — 20061 candidats
  - AVEC connectivite (8143) : resistance **41.0%**
  - SANS connectivite (11918) : resistance **21.4%**
...
- `5c556c16ea8b` — 20061 candidats
  - AVEC connectivite (8143) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.97**
  - SANS connectivite (11918) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 12842 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 12780 avec CONNECTED, 62 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 96418 systemes
  - sans CONNECTED : 0.0% sur 21643 systemes
