...
- moteur actif `0caa9267db60` (6913 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22504 | 11213 | 1513 | 768 | 2249 | 1781 | 2409 | 2290 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 22036 | 5111 | 9295 | 13 | 3080 | 1129 | 10 | 3398 | 15.4% |
...
- candidats AVEC connectivite : 2417, dont T2 : 100%
- candidats SANS connectivite : 3708, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2683 systemes avec CONNECTED sur 20868 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1835 candidats sur 6125 portent les champs bruts (30%).*
...
- `06fe04a859f1` — 720 candidats
  - AVEC connectivite (279) : resistance **41.2%**
  - SANS connectivite (441) : resistance **20.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 720 candidats
  - AVEC connectivite (279) : T0=13.33 T1=0.00 T2=3.03 — pondere **6.05**
  - SANS connectivite (441) : T0=16.01 T1=0.00 T2=2.61 — pondere **5.23**
...
- TROP-CHER : 2703 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2683 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18367 systemes
  - sans CONNECTED : 0.0% sur 4137 systemes
