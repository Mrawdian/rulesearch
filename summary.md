...
genere 2026-08-27 23:07 UTC — 118163 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 34819 systemes
...
- moteur actif `0caa9267db60` (74421 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 56591 | 28188 | 3912 | 1921 | 5614 | 4479 | 5977 | 5774 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 55457 | 12797 | 23532 | 26 | 7707 | 2868 | 25 | 8500 | 15.3% |
...
- candidats AVEC connectivite : 5901, dont T2 : 100%
- candidats SANS connectivite : 8810, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6251 systemes avec CONNECTED sur 48724 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10421 candidats sur 14711 portent les champs bruts (71%).*

- `5c556c16ea8b` — 4456 candidats
  - AVEC connectivite (1773) : resistance **42.0%**
  - SANS connectivite (2683) : resistance **22.4%**
...
- `5c556c16ea8b` — 4456 candidats
  - AVEC connectivite (1773) : T0=12.96 T1=0.00 T2=3.06 — pondere **6.11**
  - SANS connectivite (2683) : T0=15.78 T1=0.00 T2=2.71 — pondere **5.42**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 46223 systemes
  - sans CONNECTED : 0.0% sur 10368 systemes
