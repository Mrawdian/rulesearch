...
genere 2026-08-27 19:35 UTC — 111441 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 28097 systemes
...
- moteur actif `0caa9267db60` (67699 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 53198 | 26483 | 3685 | 1818 | 5272 | 4206 | 5612 | 5430 | 10.2% |
...
- candidats AVEC connectivite : 5557, dont T2 : 100%
- candidats SANS connectivite : 8278, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5886 systemes avec CONNECTED sur 45959 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*9545 candidats sur 13835 portent les champs bruts (69%).*
...
- `5c556c16ea8b` — 3580 candidats
  - AVEC connectivite (1429) : resistance **42.1%**
...
- `5c556c16ea8b` — 3580 candidats
  - AVEC connectivite (1429) : T0=12.94 T1=0.00 T2=3.07 — pondere **6.13**
...
- TROP-CHER : 5921 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 5886 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 43458 systemes
  - sans CONNECTED : 0.0% sur 9740 systemes
