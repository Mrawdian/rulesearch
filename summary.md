...
| connect | 4 | 3 | 17170 | 8585 | 1109 | 593 | 1704 | 1365 | 1869 | 1729 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 16822 | 3960 | 7128 | 11 | 2298 | 852 | 7 | 2566 | 15.3% |
...
- candidats AVEC connectivite : 1856, dont T2 : 100%
- candidats SANS connectivite : 2876, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2143 systemes avec CONNECTED sur 16526 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*442 candidats sur 4732 portent les champs bruts (9%).*
...
- `e3baecf8377b` — 178 candidats
  - AVEC connectivite (73) : resistance **42.5%**
  - SANS connectivite (105) : resistance **20.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 178 candidats
  - AVEC connectivite (73) : T0=13.18 T1=0.00 T2=3.16 — pondere **6.33**
  - SANS connectivite (105) : T0=15.99 T1=0.00 T2=2.62 — pondere **5.24**
...
- TROP-CHER : 2160 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2143 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14025 systemes
  - sans CONNECTED : 0.0% sur 3145 systemes
