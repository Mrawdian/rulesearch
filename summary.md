...
genere 2026-09-03 02:29 UTC — 327064 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 243720 systemes
...
- moteur actif `0caa9267db60` (283322 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 162087 | 80512 | 11014 | 5415 | 16516 | 12775 | 17178 | 16604 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 158862 | 37027 | 67134 | 64 | 21996 | 8205 | 65 | 24359 | 15.3% |
...
- candidats AVEC connectivite : 16731, dont T2 : 100%
- candidats SANS connectivite : 24669, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **17452 systemes avec CONNECTED sur 134729 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*37110 candidats sur 41400 portent les champs bruts (90%).*

- `5c556c16ea8b` — 31145 candidats
  - AVEC connectivite (12603) : resistance **41.1%**
  - SANS connectivite (18542) : resistance **21.2%**
...
- `5c556c16ea8b` — 31145 candidats
  - AVEC connectivite (12603) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (18542) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 17527 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 17452 avec CONNECTED, 75 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 132228 systemes
  - sans CONNECTED : 0.0% sur 29859 systemes
