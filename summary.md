...
genere 2026-08-26 16:28 UTC — 53727 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 8544 systemes
...
- moteur actif `0caa9267db60` (9985 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 24059 | 12001 | 1640 | 814 | 2384 | 1904 | 2569 | 2445 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 23553 | 5453 | 9955 | 14 | 3294 | 1200 | 10 | 3627 | 15.4% |
...
- candidats AVEC connectivite : 2572, dont T2 : 100%
- candidats SANS connectivite : 3937, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2843 systemes avec CONNECTED sur 22153 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2219 candidats sur 6509 portent les champs bruts (34%).*
...
- `06fe04a859f1` — 1104 candidats
  - AVEC connectivite (434) : resistance **40.7%**
  - SANS connectivite (670) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1104 candidats
  - AVEC connectivite (434) : T0=13.13 T1=0.00 T2=3.00 — pondere **6.01**
  - SANS connectivite (670) : T0=15.95 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 2863 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2843 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19652 systemes
  - sans CONNECTED : 0.0% sur 4407 systemes
