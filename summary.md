...
genere 2026-08-29 08:48 UTC — 177054 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 93710 systemes
...
- moteur actif `0caa9267db60` (133312 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 86336 | 42957 | 5875 | 2921 | 8672 | 6857 | 9059 | 8897 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 84603 | 19760 | 35760 | 39 | 11669 | 4315 | 35 | 13019 | 15.4% |
...
- candidats AVEC connectivite : 9024, dont T2 : 100%
- candidats SANS connectivite : 13329, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9333 systemes avec CONNECTED sur 72962 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*18063 candidats sur 22353 portent les champs bruts (81%).*

- `5c556c16ea8b` — 12098 candidats
  - AVEC connectivite (4896) : resistance **41.1%**
  - SANS connectivite (7202) : resistance **21.6%**
...
- `5c556c16ea8b` — 12098 candidats
  - AVEC connectivite (4896) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (7202) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 70461 systemes
  - sans CONNECTED : 0.0% sur 15875 systemes
