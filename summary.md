...
genere 2026-08-26 22:25 UTC — 67201 systemes evalues
...
- moteur actif `0caa9267db60` (23459 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 30875 | 15330 | 2115 | 1037 | 3076 | 2460 | 3295 | 3169 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 30211 | 6958 | 12833 | 18 | 4181 | 1570 | 14 | 4637 | 15.3% |
...
- candidats AVEC connectivite : 3296, dont T2 : 100%
- candidats SANS connectivite : 4947, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3569 systemes avec CONNECTED sur 27741 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3953 candidats sur 8243 portent les champs bruts (48%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 276 candidats
  - AVEC connectivite (116) : resistance **43.6%**
  - SANS connectivite (160) : resistance **22.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 276 candidats
  - AVEC connectivite (116) : T0=12.76 T1=0.00 T2=3.12 — pondere **6.24**
  - SANS connectivite (160) : T0=16.04 T1=0.00 T2=2.80 — pondere **5.60**
  - test de permutation : **p = 0.1029** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- TROP-CHER : 3593 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3569 avec CONNECTED, 24 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 25240 systemes
  - sans CONNECTED : 0.0% sur 5635 systemes
