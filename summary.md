...
genere 2026-09-08 10:55 UTC — 456049 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 372705 systemes
...
- moteur actif `0caa9267db60` (412307 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 227224 | 112864 | 15454 | 7597 | 22982 | 17810 | 24217 | 23406 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 222710 | 51860 | 93869 | 88 | 31031 | 11513 | 81 | 34250 | 15.4% |
...
- candidats AVEC connectivite : 23533, dont T2 : 100%
- candidats SANS connectivite : 34560, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **24491 systemes avec CONNECTED sur 188054 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*53803 candidats sur 58093 portent les champs bruts (93%).*

- `5c556c16ea8b` — 47838 candidats
  - AVEC connectivite (19405) : resistance **41.2%**
  - SANS connectivite (28433) : resistance **21.3%**
...
- `5c556c16ea8b` — 47838 candidats
  - AVEC connectivite (19405) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (28433) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 185553 systemes
  - sans CONNECTED : 0.0% sur 41671 systemes
