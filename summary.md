...
genere 2026-08-28 11:03 UTC — 140056 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 56712 systemes
...
- moteur actif `0caa9267db60` (96314 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 67667 | 33610 | 4649 | 2304 | 6784 | 5392 | 7131 | 6930 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 66274 | 15327 | 28015 | 30 | 9225 | 3425 | 30 | 10219 | 15.4% |
...
- candidats AVEC connectivite : 7057, dont T2 : 100%
- candidats SANS connectivite : 10529, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7405 systemes avec CONNECTED sur 57690 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*13296 candidats sur 17586 portent les champs bruts (76%).*

- `5c556c16ea8b` — 7331 candidats
  - AVEC connectivite (2929) : resistance **41.4%**
  - SANS connectivite (4402) : resistance **21.7%**
...
- `5c556c16ea8b` — 7331 candidats
  - AVEC connectivite (2929) : T0=13.00 T1=0.00 T2=3.01 — pondere **6.03**
  - SANS connectivite (4402) : T0=15.88 T1=0.00 T2=2.67 — pondere **5.35**
...
- TROP-CHER : 7445 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7405 avec CONNECTED, 40 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 55189 systemes
  - sans CONNECTED : 0.0% sur 12478 systemes
