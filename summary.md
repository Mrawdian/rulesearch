...
genere 2026-08-27 19:41 UTC — 111617 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 28273 systemes
...
- moteur actif `0caa9267db60` (67875 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 52215 | 12068 | 22171 | 26 | 7220 | 2717 | 25 | 7986 | 15.3% |
...
- candidats SANS connectivite : 8296, dont T2 : 100%
...
*9572 candidats sur 13862 portent les champs bruts (69%).*
...
- `5c556c16ea8b` — 3607 candidats
  - AVEC connectivite (1438) : resistance **42.2%**
  - SANS connectivite (2169) : resistance **22.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 3607 candidats
  ...
  - SANS connectivite (2169) : T0=15.77 T1=0.00 T2=2.71 — pondere **5.42**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 2280 candidats
