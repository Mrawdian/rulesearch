...
genere 2026-08-27 23:59 UTC — 119830 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 36486 systemes
...
- moteur actif `0caa9267db60` (76088 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 57439 | 28608 | 3969 | 1943 | 5698 | 4546 | 6062 | 5877 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 56276 | 12985 | 23885 | 27 | 7827 | 2903 | 25 | 8622 | 15.3% |
...
- candidats AVEC connectivite : 6004, dont T2 : 100%
- candidats SANS connectivite : 8932, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6336 systemes avec CONNECTED sur 49421 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10646 candidats sur 14936 portent les champs bruts (71%).*

- `5c556c16ea8b` — 4681 candidats
  - AVEC connectivite (1876) : resistance **41.9%**
  - SANS connectivite (2805) : resistance **22.5%**
...
- `5c556c16ea8b` — 4681 candidats
  - AVEC connectivite (1876) : T0=12.98 T1=0.00 T2=3.05 — pondere **6.10**
  - SANS connectivite (2805) : T0=15.78 T1=0.00 T2=2.72 — pondere **5.44**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 46920 systemes
  - sans CONNECTED : 0.0% sur 10519 systemes
