...
- moteur actif `0caa9267db60` (7595 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22848 | 11387 | 1543 | 775 | 2278 | 1813 | 2448 | 2317 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 22374 | 5184 | 9435 | 14 | 3130 | 1143 | 10 | 3458 | 15.5% |
...
- candidats AVEC connectivite : 2444, dont T2 : 100%
- candidats SANS connectivite : 3768, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2722 systemes avec CONNECTED sur 21148 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1922 candidats sur 6212 portent les champs bruts (31%).*
...
- `06fe04a859f1` — 807 candidats
  - AVEC connectivite (306) : resistance **41.0%**
  - SANS connectivite (501) : resistance **20.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 807 candidats
  - AVEC connectivite (306) : T0=13.35 T1=0.00 T2=3.02 — pondere **6.05**
  - SANS connectivite (501) : T0=16.00 T1=0.00 T2=2.61 — pondere **5.23**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18647 systemes
  - sans CONNECTED : 0.0% sur 4201 systemes
