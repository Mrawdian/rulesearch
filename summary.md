...
genere 2026-09-01 06:21 UTC — 274856 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 191512 systemes
...
- moteur actif `0caa9267db60` (231114 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 135739 | 67449 | 9180 | 4547 | 13771 | 10734 | 14338 | 13960 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 133002 | 30977 | 56224 | 58 | 18445 | 6875 | 59 | 20354 | 15.3% |
...
- candidats AVEC connectivite : 14087, dont T2 : 100%
- candidats SANS connectivite : 20664, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14612 systemes avec CONNECTED sur 113252 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*30461 candidats sur 34751 portent les champs bruts (88%).*

- `5c556c16ea8b` — 24496 candidats
  - AVEC connectivite (9959) : resistance **41.0%**
  - SANS connectivite (14537) : resistance **21.3%**
...
- `5c556c16ea8b` — 24496 candidats
  - AVEC connectivite (9959) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (14537) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 110751 systemes
  - sans CONNECTED : 0.0% sur 24988 systemes
