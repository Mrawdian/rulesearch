...
genere 2026-09-07 04:33 UTC — 428320 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 344976 systemes
...
- moteur actif `0caa9267db60` (384578 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 213210 | 105868 | 14521 | 7095 | 21623 | 16758 | 22665 | 21968 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 208995 | 48651 | 88124 | 81 | 29128 | 10793 | 75 | 32125 | 15.4% |
...
- candidats AVEC connectivite : 22095, dont T2 : 100%
- candidats SANS connectivite : 32435, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **22939 systemes avec CONNECTED sur 176501 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*50240 candidats sur 54530 portent les champs bruts (92%).*

- `5c556c16ea8b` — 44275 candidats
  - AVEC connectivite (17967) : resistance **41.1%**
  - SANS connectivite (26308) : resistance **21.3%**
...
- `5c556c16ea8b` — 44275 candidats
  - AVEC connectivite (17967) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (26308) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 174000 systemes
  - sans CONNECTED : 0.0% sur 39210 systemes
