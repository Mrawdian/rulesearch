...
genere 2026-08-26 09:53 UTC — 37357 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 28383 systemes
...
| d4 | 4 | 4 | 5541 | 2550 | 1406 | 28 | 392 | 370 | 261 | 392 | 7.1% |
...
- candidats AVEC connectivite : 1725, dont T2 : 100%
- candidats SANS connectivite : 2698, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2001 systemes avec CONNECTED sur 15410 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*133 candidats sur 4423 portent les champs bruts (3%).*

- `89c65c03c4ad` — 133 candidats
  - AVEC connectivite (48) : resistance **48.4%**
  - SANS connectivite (85) : resistance **21.1%**
...
- `89c65c03c4ad` — 3258 candidats
  - AVEC connectivite (1246) : T0=13.06 T1=0.00 T2=2.95 — pondere **5.90**
  - SANS connectivite (2012) : T0=15.84 T1=0.02 T2=2.65 — pondere **5.33**
...
- TROP-CHER : 2018 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2001 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
