...
genere 2026-08-26 06:24 UTC — 28377 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 19403 systemes
...
| d4 | 4 | 4 | 1016 | 478 | 251 | 4 | 77 | 71 | 43 | 64 | 6.3% |
...
- candidats AVEC connectivite : 1400, dont T2 : 100%
- candidats SANS connectivite : 2120, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1538 systemes avec CONNECTED sur 11736 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2355 candidats
  - AVEC connectivite (921) : T0=13.21 T1=0.00 T2=2.88 — pondere **5.75**
...
- TROP-CHER : 1544 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 1538 avec CONNECTED, 6 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
