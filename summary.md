...
genere 2026-08-29 08:03 UTC — 175840 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 92496 systemes
...
- moteur actif `0caa9267db60` (132098 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 85723 | 42665 | 5833 | 2897 | 8598 | 6801 | 8996 | 8844 | 10.3% |
...
- candidats AVEC connectivite : 8971, dont T2 : 100%
...
- **9270 systemes avec CONNECTED sur 72480 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*17923 candidats sur 22213 portent les champs bruts (81%).*

- `5c556c16ea8b` — 11958 candidats
  - AVEC connectivite (4843) : resistance **41.1%**
...
- `5c556c16ea8b` — 11958 candidats
  - AVEC connectivite (4843) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.98**
...
- TROP-CHER : 9315 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 9270 avec CONNECTED, 45 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 69979 systemes
  - sans CONNECTED : 0.0% sur 15744 systemes
