...
genere 2026-09-07 23:31 UTC — 445722 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 362378 systemes
...
- moteur actif `0caa9267db60` (401980 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 222011 | 110261 | 15135 | 7416 | 22462 | 17385 | 23649 | 22875 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 217596 | 50689 | 91699 | 85 | 30341 | 11259 | 78 | 33427 | 15.4% |
...
- candidats AVEC connectivite : 23002, dont T2 : 100%
...
- **23923 systemes avec CONNECTED sur 183804 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*52449 candidats sur 56739 portent les champs bruts (92%).*

- `5c556c16ea8b` — 46484 candidats
  - AVEC connectivite (18874) : resistance **41.2%**
...
- `5c556c16ea8b` — 46484 candidats
  - AVEC connectivite (18874) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 24011 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23923 avec CONNECTED, 88 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 181303 systemes
  - sans CONNECTED : 0.0% sur 40708 systemes
