...
genere 2026-09-02 20:42 UTC — 320432 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 237088 systemes
...
- moteur actif `0caa9267db60` (276690 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 158739 | 78868 | 10802 | 5303 | 16141 | 12495 | 16826 | 16276 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 155578 | 36260 | 65800 | 64 | 21491 | 8033 | 63 | 23855 | 15.3% |
...
- candidats AVEC connectivite : 16403, dont T2 : 100%
- candidats SANS connectivite : 24165, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **17100 systemes avec CONNECTED sur 132064 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*36278 candidats sur 40568 portent les champs bruts (89%).*

- `5c556c16ea8b` — 30313 candidats
  - AVEC connectivite (12275) : resistance **41.1%**
  - SANS connectivite (18038) : resistance **21.2%**
...
- `5c556c16ea8b` — 30313 candidats
  - AVEC connectivite (12275) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (18038) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.29**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 129563 systemes
  - sans CONNECTED : 0.0% sur 29176 systemes
