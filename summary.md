...
genere 2026-09-02 22:03 UTC — 322113 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 238769 systemes
...
- moteur actif `0caa9267db60` (278371 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 159594 | 79295 | 10851 | 5336 | 16245 | 12566 | 16894 | 16362 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 156404 | 36459 | 66119 | 64 | 21622 | 8075 | 64 | 23989 | 15.3% |
...
- candidats AVEC connectivite : 16489, dont T2 : 100%
- candidats SANS connectivite : 24299, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **17168 systemes avec CONNECTED sur 132739 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*36498 candidats sur 40788 portent les champs bruts (89%).*

- `5c556c16ea8b` — 30533 candidats
  - AVEC connectivite (12361) : resistance **41.1%**
  - SANS connectivite (18172) : resistance **21.2%**
...
- `5c556c16ea8b` — 30533 candidats
  - AVEC connectivite (12361) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (18172) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.29**
...
## cout
- temps total 99.9 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 17242 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 17168 avec CONNECTED, 74 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 130238 systemes
  - sans CONNECTED : 0.0% sur 29356 systemes
