...
genere 2026-08-31 01:26 UTC — 236588 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 153244 systemes
...
- moteur actif `0caa9267db60` (192846 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 116415 | 57877 | 7908 | 3913 | 11697 | 9184 | 12336 | 11978 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 114058 | 26601 | 48214 | 53 | 15725 | 5903 | 51 | 17501 | 15.3% |
...
- candidats AVEC connectivite : 12105, dont T2 : 100%
- candidats SANS connectivite : 17811, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12610 systemes avec CONNECTED sur 97571 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*25626 candidats sur 29916 portent les champs bruts (86%).*

- `5c556c16ea8b` — 19661 candidats
  - AVEC connectivite (7977) : resistance **41.0%**
  - SANS connectivite (11684) : resistance **21.4%**
...
- `5c556c16ea8b` — 19661 candidats
  - AVEC connectivite (7977) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.97**
  - SANS connectivite (11684) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.31**
...
## cout
- temps total 73.4 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 12671 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 12610 avec CONNECTED, 61 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 95070 systemes
  - sans CONNECTED : 0.0% sur 21345 systemes
