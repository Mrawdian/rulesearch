...
genere 2026-09-01 13:18 UTC — 283603 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 200259 systemes
...
- moteur actif `0caa9267db60` (239861 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 140141 | 69667 | 9478 | 4687 | 14236 | 11053 | 14797 | 14411 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 137347 | 31967 | 58058 | 59 | 19063 | 7110 | 61 | 21018 | 15.3% |
...
- candidats AVEC connectivite : 14538, dont T2 : 100%
- candidats SANS connectivite : 21328, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15071 systemes avec CONNECTED sur 116848 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*31576 candidats sur 35866 portent les champs bruts (88%).*

- `5c556c16ea8b` — 25611 candidats
  - AVEC connectivite (10410) : resistance **41.0%**
  - SANS connectivite (15201) : resistance **21.4%**
...
- `5c556c16ea8b` — 25611 candidats
  - AVEC connectivite (10410) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (15201) : T0=15.93 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 15142 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15071 avec CONNECTED, 71 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 114347 systemes
  - sans CONNECTED : 0.0% sur 25794 systemes
