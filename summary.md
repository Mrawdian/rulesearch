...
genere 2026-08-26 20:19 UTC — 62744 systemes evalues
...
- moteur actif `0caa9267db60` (19002 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 28617 | 14257 | 1958 | 959 | 2839 | 2273 | 3037 | 2935 | 10.3% |
...
- candidats AVEC connectivite : 3062, dont T2 : 100%
- candidats SANS connectivite : 4620, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3311 systemes avec CONNECTED sur 25907 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3392 candidats sur 7682 portent les champs bruts (44%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 523 candidats
  - AVEC connectivite (218) : resistance **39.7%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 523 candidats
  - AVEC connectivite (218) : T0=12.88 T1=0.00 T2=2.87 — pondere **5.74**
  - SANS connectivite (305) : T0=16.17 T1=0.00 T2=2.65 — pondere **5.30**
  - test de permutation : **p = 0.1139** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23406 systemes
  - sans CONNECTED : 0.0% sur 5211 systemes
