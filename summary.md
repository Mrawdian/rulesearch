...
genere 2026-09-07 11:22 UTC — 434683 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 351339 systemes
...
- moteur actif `0caa9267db60` (390941 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 216436 | 107522 | 14738 | 7205 | 21917 | 16971 | 23015 | 22315 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 212132 | 49394 | 89440 | 83 | 29552 | 10960 | 76 | 32609 | 15.4% |
...
- candidats AVEC connectivite : 22442, dont T2 : 100%
- candidats SANS connectivite : 32919, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23289 systemes avec CONNECTED sur 179202 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*51071 candidats sur 55361 portent les champs bruts (92%).*

- `5c556c16ea8b` — 45106 candidats
  - AVEC connectivite (18314) : resistance **41.1%**
  - SANS connectivite (26792) : resistance **21.3%**
...
- `5c556c16ea8b` — 45106 candidats
  - AVEC connectivite (18314) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (26792) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 23375 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23289 avec CONNECTED, 86 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 176701 systemes
  - sans CONNECTED : 0.0% sur 39735 systemes
