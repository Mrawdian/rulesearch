...
genere 2026-09-05 22:56 UTC — 399768 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 316424 systemes
...
- moteur actif `0caa9267db60` (356026 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 198800 | 98702 | 13544 | 6624 | 20188 | 15662 | 21102 | 20450 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 194853 | 45348 | 82206 | 78 | 27128 | 10061 | 72 | 29943 | 15.4% |
...
- candidats AVEC connectivite : 20577, dont T2 : 100%
- candidats SANS connectivite : 30253, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21376 systemes avec CONNECTED sur 164687 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*46540 candidats sur 50830 portent les champs bruts (92%).*

- `5c556c16ea8b` — 40575 candidats
  - AVEC connectivite (16449) : resistance **41.0%**
  - SANS connectivite (24126) : resistance **21.3%**
...
- `5c556c16ea8b` — 40575 candidats
  - AVEC connectivite (16449) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.94**
  - SANS connectivite (24126) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 21458 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21376 avec CONNECTED, 82 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 162186 systemes
  - sans CONNECTED : 0.0% sur 36614 systemes
