...
genere 2026-08-27 17:40 UTC — 107715 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 24371 systemes
...
- moteur actif `0caa9267db60` (63973 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 51320 | 25566 | 3547 | 1757 | 5086 | 4064 | 5414 | 5221 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 50280 | 11654 | 21322 | 26 | 6942 | 2624 | 23 | 7687 | 15.3% |
...
- candidats AVEC connectivite : 5348, dont T2 : 100%
- candidats SANS connectivite : 7997, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5688 systemes avec CONNECTED sur 44422 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*9055 candidats sur 13345 portent les champs bruts (68%).*
...
- `5c556c16ea8b` — 3090 candidats
  - AVEC connectivite (1220) : resistance **42.1%**
  - SANS connectivite (1870) : resistance **22.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 3090 candidats
  - AVEC connectivite (1220) : T0=12.98 T1=0.00 T2=3.07 — pondere **6.13**
  - SANS connectivite (1870) : T0=15.78 T1=0.00 T2=2.70 — pondere **5.39**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 2280 candidats
...
## cout
- temps total 33.2 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 5721 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 5688 avec CONNECTED, 33 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 41921 systemes
  - sans CONNECTED : 0.0% sur 9399 systemes
