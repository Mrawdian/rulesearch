...
genere 2026-08-31 22:30 UTC — 264930 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 181586 systemes
...
- moteur actif `0caa9267db60` (221188 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 130727 | 64978 | 8825 | 4395 | 13251 | 10332 | 13792 | 13451 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 128088 | 29871 | 54095 | 56 | 17748 | 6628 | 57 | 19623 | 15.3% |
...
- candidats AVEC connectivite : 13578, dont T2 : 100%
...
- **14066 systemes avec CONNECTED sur 109166 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*29221 candidats sur 33511 portent les champs bruts (87%).*

- `5c556c16ea8b` — 23256 candidats
  - AVEC connectivite (9450) : resistance **41.0%**
...
- `5c556c16ea8b` — 23256 candidats
  - AVEC connectivite (9450) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.97**
...
- TROP-CHER : 14133 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14066 avec CONNECTED, 67 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 106665 systemes
  - sans CONNECTED : 0.0% sur 24062 systemes
