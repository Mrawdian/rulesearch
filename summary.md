...
genere 2026-08-26 18:11 UTC — 57674 systemes evalues
...
- `e80bc1b2b437` : 250 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (13932 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `84fba70921e0`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
**7716 enregistrements (13%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 26058 | 12979 | 1777 | 881 | 2581 | 2061 | 2783 | 2673 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 25501 | 5877 | 10803 | 15 | 3560 | 1301 | 10 | 3935 | 15.4% |
...
- candidats AVEC connectivite : 2800, dont T2 : 100%
- candidats SANS connectivite : 4245, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3057 systemes avec CONNECTED sur 23805 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2755 candidats sur 7045 portent les champs bruts (39%).*
...
- `b71bb0907fb5` — 53 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `e80bc1b2b437` — 26 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (15) : resistance **37.5%**
  - SANS connectivite (11) : resistance **25.0%**
...
- `e80bc1b2b437` — 26 candidats
  - AVEC connectivite (15) : T0=12.47 T1=0.00 T2=2.33 — pondere **4.67**
  - SANS connectivite (11) : T0=14.82 T1=0.00 T2=3.18 — pondere **6.36**
  - *groupes trop petits (< 20) — aucun test, aucune conclusion*
- `e8a1f930f7b9` — 28 candidats
...
- TROP-CHER : 3077 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3057 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 21304 systemes
  - sans CONNECTED : 0.0% sur 4754 systemes
