...
genere 2026-08-28 21:15 UTC — 157696 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 74352 systemes
...
- moteur actif `0caa9267db60` (113954 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 76555 | 38045 | 5215 | 2598 | 7669 | 6107 | 8071 | 7874 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 75026 | 17441 | 31774 | 35 | 10333 | 3842 | 31 | 11567 | 15.4% |
...
- candidats SANS connectivite : 11877, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8345 systemes avec CONNECTED sur 64961 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*15588 candidats sur 19878 portent les champs bruts (78%).*

- `5c556c16ea8b` — 9623 candidats
  - AVEC connectivite (3873) : resistance **41.2%**
  - SANS connectivite (5750) : resistance **21.7%**
...
- `5c556c16ea8b` — 9623 candidats
  ...
  - SANS connectivite (5750) : T0=15.89 T1=0.00 T2=2.68 — pondere **5.36**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 62460 systemes
