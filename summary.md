...
genere 2026-08-29 13:58 UTC — 185112 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 101768 systemes
...
- moteur actif `0caa9267db60` (141370 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 90401 | 44964 | 6142 | 3046 | 9092 | 7200 | 9504 | 9306 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 88596 | 20705 | 37385 | 43 | 12237 | 4543 | 35 | 13642 | 15.4% |
...
- candidats AVEC connectivite : 9433, dont T2 : 100%
- candidats SANS connectivite : 13952, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9778 systemes avec CONNECTED sur 76251 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*19095 candidats sur 23385 portent les champs bruts (82%).*

- `5c556c16ea8b` — 13130 candidats
  - AVEC connectivite (5305) : resistance **41.2%**
  - SANS connectivite (7825) : resistance **21.5%**
...
- `5c556c16ea8b` — 13130 candidats
  - AVEC connectivite (5305) : T0=12.99 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (7825) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.33**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 73750 systemes
  - sans CONNECTED : 0.0% sur 16651 systemes
