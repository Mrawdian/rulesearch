...
genere 2026-08-26 18:34 UTC — 58652 systemes evalues
...
- `62448a55927e` : 44 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (14910 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
**7510 enregistrements (13%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 26552 | 13233 | 1812 | 897 | 2635 | 2099 | 2830 | 2719 | 10.2% |
...
- candidats AVEC connectivite : 2846, dont T2 : 100%
- candidats SANS connectivite : 4320, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3104 systemes avec CONNECTED sur 24215 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2876 candidats sur 7166 portent les champs bruts (40%).*
...
- TROP-CHER : 3124 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3104 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 21714 systemes
  - sans CONNECTED : 0.0% sur 4838 systemes
