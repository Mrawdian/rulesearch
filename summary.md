...
genere 2026-08-27 04:57 UTC — 81829 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 16922 systemes
...
- moteur actif `0caa9267db60` (38087 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 38259 | 19044 | 2632 | 1308 | 3805 | 3003 | 4036 | 3933 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 37455 | 8639 | 15924 | 21 | 5192 | 1948 | 20 | 5711 | 15.2% |
...
- candidats AVEC connectivite : 4060, dont T2 : 100%
- candidats SANS connectivite : 6021, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4310 systemes avec CONNECTED sur 33807 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5791 candidats sur 10081 portent les champs bruts (57%).*
...
- `ab89a63b01ef` — 2114 candidats
  - AVEC connectivite (880) : resistance **41.6%**
  - SANS connectivite (1234) : resistance **21.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 2114 candidats
  - AVEC connectivite (880) : T0=13.03 T1=0.00 T2=3.05 — pondere **6.09**
  - SANS connectivite (1234) : T0=15.95 T1=0.00 T2=2.67 — pondere **5.35**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- TROP-CHER : 4340 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4310 avec CONNECTED, 30 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 31306 systemes
  - sans CONNECTED : 0.0% sur 6953 systemes
