...
genere 2026-08-27 06:50 UTC — 85784 systemes evalues
...
- moteur actif `0caa9267db60` (42042 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 39414 | 9082 | 16764 | 22 | 5465 | 2054 | 21 | 6006 | 15.2% |
...
- candidats SANS connectivite : 6316, dont T2 : 100%
...
*6289 candidats sur 10579 portent les champs bruts (59%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 324 candidats
  - AVEC connectivite (135) : resistance **41.7%**
  - SANS connectivite (189) : resistance **21.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 324 candidats
  ...
  - SANS connectivite (189) : T0=15.95 T1=0.00 T2=2.65 — pondere **5.29**
  - test de permutation : **p = 0.0235** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `23303c299f39` — 225 candidats
...
**7 serie(s) reproductible(s) sur 14 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `ab89a63b01ef` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `5c556c16ea8b` (p=0.0235), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
