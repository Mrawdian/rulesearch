...
genere 2026-09-02 09:36 UTC — 307805 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 224461 systemes
...
- moteur actif `0caa9267db60` (264063 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 152365 | 75693 | 10368 | 5103 | 15484 | 11991 | 16134 | 15646 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 149325 | 34791 | 63144 | 63 | 20652 | 7709 | 63 | 22891 | 15.3% |
...
- candidats AVEC connectivite : 15773, dont T2 : 100%
...
- **16408 systemes avec CONNECTED sur 126874 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*34684 candidats sur 38974 portent les champs bruts (89%).*

- `5c556c16ea8b` — 28719 candidats
  - AVEC connectivite (11645) : resistance **41.1%**
...
- `5c556c16ea8b` — 28719 candidats
  - AVEC connectivite (11645) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 16481 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16408 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 124373 systemes
