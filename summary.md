...
genere 2026-08-26 20:00 UTC — 61899 systemes evalues
...
- moteur actif `0caa9267db60` (18157 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 28198 | 14044 | 1928 | 949 | 2795 | 2233 | 3000 | 2895 | 10.3% |
...
- candidats AVEC connectivite : 3022, dont T2 : 100%
- candidats SANS connectivite : 4557, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3274 systemes avec CONNECTED sur 25574 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3289 candidats sur 7579 portent les champs bruts (43%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 420 candidats
  - AVEC connectivite (178) : resistance **39.1%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 420 candidats
  - AVEC connectivite (178) : T0=12.85 T1=0.00 T2=2.81 — pondere **5.63**
...
- TROP-CHER : 3296 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3274 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23073 systemes
  - sans CONNECTED : 0.0% sur 5125 systemes
