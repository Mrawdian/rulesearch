...
| connect | 4 | 3 | 5695 | 2866 | 364 | 205 | 547 | 465 | 594 | 587 | 10.3% |
...
- candidats AVEC connectivite : 590, dont T2 : 100%
...
- **594 systemes avec CONNECTED sur 4718 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 303 candidats
  - AVEC connectivite (111) : T0=13.14 T1=0.00 T2=2.74 — pondere **5.48**
  - SANS connectivite (192) : T0=15.99 T1=0.00 T2=2.62 — pondere **5.24**
  - test de permutation : **p = 0.5167** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 596 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 594 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 4661 systemes
  - sans CONNECTED : 0.0% sur 1034 systemes
