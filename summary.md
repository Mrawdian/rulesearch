...
- `89c65c03c4ad` — 337 candidats
  - AVEC connectivite (122) : T0=13.12 T1=0.00 T2=2.78 — pondere **5.56**
  - SANS connectivite (215) : T0=16.02 T1=0.00 T2=2.67 — pondere **5.33**
  - test de permutation : **p = 0.5247** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
