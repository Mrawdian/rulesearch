...
genere 2026-08-26 03:16 UTC — 20532 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 11558 systemes
...
| connect | 4 | 3 | 10313 | 5194 | 676 | 356 | 988 | 819 | 1110 | 1041 | 10.1% |
| ref | 4 | 3 | 10095 | 2416 | 4262 | 4 | 1339 | 511 | 4 | 1559 | 15.4% |
...
- candidats AVEC connectivite : 1044, dont T2 : 100%
- candidats SANS connectivite : 1563, dont T2 : 100%
...
- **1110 systemes avec CONNECTED sur 8519 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1442 candidats
  - AVEC connectivite (565) : T0=13.36 T1=0.00 T2=2.85 — pondere **5.71**
  - SANS connectivite (877) : T0=15.80 T1=0.00 T2=2.67 — pondere **5.33**
...
- TROP-CHER : 1114 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 1110 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 8462 systemes
  - sans CONNECTED : 0.0% sur 1851 systemes
