...
genere 2026-08-26 23:25 UTC — 69427 systemes evalues
...
- moteur actif `0caa9267db60` (25685 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 31997 | 15904 | 2199 | 1073 | 3186 | 2550 | 3413 | 3267 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 31315 | 7216 | 13303 | 18 | 4332 | 1635 | 14 | 4797 | 15.3% |
...
- candidats AVEC connectivite : 3394, dont T2 : 100%
- candidats SANS connectivite : 5107, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3687 systemes avec CONNECTED sur 28658 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4211 candidats sur 8501 portent les champs bruts (50%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 534 candidats
  - AVEC connectivite (214) : resistance **42.0%**
  - SANS connectivite (320) : resistance **22.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 534 candidats
  - AVEC connectivite (214) : T0=13.00 T1=0.00 T2=3.09 — pondere **6.18**
  - SANS connectivite (320) : T0=16.03 T1=0.00 T2=2.68 — pondere **5.36**
...
- TROP-CHER : 3711 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3687 avec CONNECTED, 24 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 26157 systemes
  - sans CONNECTED : 0.0% sur 5840 systemes
