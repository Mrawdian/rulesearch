...
genere 2026-09-02 15:04 UTC — 313945 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 230601 systemes
...
- moteur actif `0caa9267db60` (270203 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 155454 | 77230 | 10570 | 5194 | 15802 | 12240 | 16478 | 15945 | 10.3% |
...
- candidats AVEC connectivite : 16072, dont T2 : 100%
...
- **16752 systemes avec CONNECTED sur 129389 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*35452 candidats sur 39742 portent les champs bruts (89%).*

- `5c556c16ea8b` — 29487 candidats
  - AVEC connectivite (11944) : resistance **41.1%**
...
- `5c556c16ea8b` — 29487 candidats
  - AVEC connectivite (11944) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 16825 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16752 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 126888 systemes
  - sans CONNECTED : 0.0% sur 28566 systemes
