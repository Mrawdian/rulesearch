...
genere 2026-08-26 20:01 UTC — 61958 systemes evalues
...
- moteur actif `0caa9267db60` (18216 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 28228 | 14058 | 1930 | 949 | 2801 | 2234 | 3003 | 2899 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 27615 | 6375 | 11705 | 15 | 3836 | 1422 | 12 | 4250 | 15.4% |
...
- candidats AVEC connectivite : 3026, dont T2 : 100%
- candidats SANS connectivite : 4560, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3277 systemes avec CONNECTED sur 25597 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3296 candidats sur 7586 portent les champs bruts (43%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 427 candidats
  - AVEC connectivite (182) : resistance **39.3%**
  - SANS connectivite (245) : resistance **19.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 427 candidats
  - AVEC connectivite (182) : T0=12.82 T1=0.00 T2=2.83 — pondere **5.66**
  - SANS connectivite (245) : T0=16.11 T1=0.00 T2=2.59 — pondere **5.18**
...
- TROP-CHER : 3299 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3277 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23096 systemes
  - sans CONNECTED : 0.0% sur 5132 systemes
