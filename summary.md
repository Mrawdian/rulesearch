...
genere 2026-08-29 22:40 UTC — 198297 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 114953 systemes
...
- moteur actif `0caa9267db60` (154555 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 97070 | 48208 | 6598 | 3264 | 9791 | 7722 | 10235 | 10006 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 95112 | 22187 | 40176 | 44 | 13156 | 4891 | 37 | 14615 | 15.4% |
...
- candidats AVEC connectivite : 10133, dont T2 : 100%
- candidats SANS connectivite : 14925, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10509 systemes avec CONNECTED sur 81678 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*20768 candidats sur 25058 portent les champs bruts (83%).*

- `5c556c16ea8b` — 14803 candidats
  - AVEC connectivite (6005) : resistance **41.1%**
  - SANS connectivite (8798) : resistance **21.5%**
...
- `5c556c16ea8b` — 14803 candidats
  - AVEC connectivite (6005) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (8798) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.32**
...
## cout
- temps total 61.2 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 10556 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10509 avec CONNECTED, 47 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 79177 systemes
  - sans CONNECTED : 0.0% sur 17893 systemes
