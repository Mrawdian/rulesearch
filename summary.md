...
genere 2026-08-27 07:30 UTC — 87203 systemes evalues
...
- moteur actif `0caa9267db60` (43461 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 40970 | 20389 | 2806 | 1393 | 4098 | 3223 | 4323 | 4208 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 40118 | 9239 | 17052 | 22 | 5571 | 2091 | 21 | 6122 | 15.3% |
...
- candidats AVEC connectivite : 4335, dont T2 : 100%
- candidats SANS connectivite : 6432, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4597 systemes avec CONNECTED sur 35981 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6477 candidats sur 10767 portent les champs bruts (60%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 512 candidats
  - AVEC connectivite (207) : resistance **41.6%**
  - SANS connectivite (305) : resistance **20.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 512 candidats
  - AVEC connectivite (207) : T0=13.08 T1=0.00 T2=3.04 — pondere **6.09**
  - SANS connectivite (305) : T0=15.87 T1=0.00 T2=2.58 — pondere **5.16**
...
- TROP-CHER : 4628 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4597 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 33480 systemes
  - sans CONNECTED : 0.0% sur 7490 systemes
