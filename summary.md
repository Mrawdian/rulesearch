...
genere 2026-09-05 21:07 UTC — 397951 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 314607 systemes
...
- moteur actif `0caa9267db60` (354209 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 197875 | 98225 | 13472 | 6597 | 20112 | 15583 | 21004 | 20363 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 193961 | 45137 | 81832 | 78 | 27025 | 10016 | 71 | 29787 | 15.4% |
...
- candidats AVEC connectivite : 20490, dont T2 : 100%
- candidats SANS connectivite : 30097, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21278 systemes avec CONNECTED sur 163918 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*46297 candidats sur 50587 portent les champs bruts (92%).*

- `5c556c16ea8b` — 40332 candidats
  - AVEC connectivite (16362) : resistance **41.1%**
  - SANS connectivite (23970) : resistance **21.3%**
...
- `5c556c16ea8b` — 40332 candidats
  - AVEC connectivite (16362) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.94**
  - SANS connectivite (23970) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 21359 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21278 avec CONNECTED, 81 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 161417 systemes
  - sans CONNECTED : 0.0% sur 36458 systemes
