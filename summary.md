...
genere 2026-09-02 05:10 UTC — 302663 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 219319 systemes
...
- moteur actif `0caa9267db60` (258921 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 149769 | 74407 | 10190 | 5023 | 15187 | 11794 | 15849 | 15401 | 10.3% |
...
- candidats AVEC connectivite : 15528, dont T2 : 100%
...
- **16123 systemes avec CONNECTED sur 124766 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*34038 candidats sur 38328 portent les champs bruts (89%).*

- `5c556c16ea8b` — 28073 candidats
  - AVEC connectivite (11400) : resistance **41.0%**
...
- `5c556c16ea8b` — 28073 candidats
  - AVEC connectivite (11400) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 16196 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16123 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 122265 systemes
  - sans CONNECTED : 0.0% sur 27504 systemes
