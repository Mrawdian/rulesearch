...
genere 2026-08-26 17:54 UTC — 57022 systemes evalues
...
- `0a74109317e5` : 135 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (13280 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `84fba70921e0`, `b71bb0907fb5`, `e40600351a72`, `e8a1f930f7b9`
...
**7601 enregistrements (13%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| ref | 4 | 3 | 25178 | 5797 | 10661 | 15 | 3520 | 1280 | 10 | 3895 | 15.5% |
...
- candidats SANS connectivite : 4205, dont T2 : 100%
...
*2675 candidats sur 6965 portent les champs bruts (38%).*
...
- `84fba70921e0` — 33 candidats
  ...
  - *groupes trop petits (< 20) — aucun test*
- `0a74109317e5` — 26 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (11) : resistance **37.6%**
  - SANS connectivite (15) : resistance **21.6%**
  - *groupes trop petits (< 20) — aucun test*
...
- `84fba70921e0` — 33 candidats
  ...
  - *groupes trop petits (< 20) — aucun test, aucune conclusion*
- `0a74109317e5` — 26 candidats
  - AVEC connectivite (11) : T0=14.18 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (15) : T0=15.20 T1=0.00 T2=2.73 — pondere **5.47**
  - *groupes trop petits (< 20) — aucun test, aucune conclusion*
