...
genere 2026-09-09 10:38 UTC — 477242 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 393898 systemes
...
- moteur actif `0caa9267db60` (433500 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 237937 | 118129 | 16225 | 7971 | 24081 | 18647 | 25337 | 24524 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 233190 | 54341 | 98253 | 92 | 32479 | 12039 | 84 | 35883 | 15.4% |
...
- candidats AVEC connectivite : 24651, dont T2 : 100%
- candidats SANS connectivite : 36193, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25611 systemes avec CONNECTED sur 196766 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*56554 candidats sur 60844 portent les champs bruts (93%).*

- `5c556c16ea8b` — 50589 candidats
  - AVEC connectivite (20523) : resistance **41.2%**
  - SANS connectivite (30066) : resistance **21.3%**
...
- `5c556c16ea8b` — 50589 candidats
  - AVEC connectivite (20523) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (30066) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
## cout
- temps total 148.8 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 25705 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25611 avec CONNECTED, 94 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 194265 systemes
  - sans CONNECTED : 0.0% sur 43672 systemes
