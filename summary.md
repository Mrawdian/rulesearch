...
genere 2026-09-02 09:39 UTC — 307878 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 224534 systemes
...
- moteur actif `0caa9267db60` (264136 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 152395 | 75707 | 10371 | 5103 | 15489 | 11996 | 16135 | 15647 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 149368 | 34801 | 63161 | 63 | 20658 | 7710 | 63 | 22900 | 15.3% |
...
- candidats AVEC connectivite : 15774, dont T2 : 100%
- candidats SANS connectivite : 23210, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16409 systemes avec CONNECTED sur 126894 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*34694 candidats sur 38984 portent les champs bruts (89%).*

- `5c556c16ea8b` — 28729 candidats
  - AVEC connectivite (11646) : resistance **41.1%**
  - SANS connectivite (17083) : resistance **21.3%**
...
- `5c556c16ea8b` — 28729 candidats
  - AVEC connectivite (11646) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (17083) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.29**
...
- TROP-CHER : 16482 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16409 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 124393 systemes
  - sans CONNECTED : 0.0% sur 28002 systemes
