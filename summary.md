...
genere 2026-09-10 07:26 UTC — 494847 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 411503 systemes
...
- moteur actif `0caa9267db60` (451105 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 246820 | 122539 | 16822 | 8289 | 24975 | 19363 | 26319 | 25383 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 241912 | 56414 | 101916 | 97 | 33663 | 12481 | 87 | 37233 | 15.4% |
...
- candidats AVEC connectivite : 25510, dont T2 : 100%
- candidats SANS connectivite : 37543, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **26593 systemes avec CONNECTED sur 204021 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*58763 candidats sur 63053 portent les champs bruts (93%).*

- `5c556c16ea8b` — 52798 candidats
  - AVEC connectivite (21382) : resistance **41.2%**
  - SANS connectivite (31416) : resistance **21.3%**
...
- `5c556c16ea8b` — 52798 candidats
  - AVEC connectivite (21382) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (31416) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 26690 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 26593 avec CONNECTED, 97 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 201520 systemes
  - sans CONNECTED : 0.0% sur 45300 systemes
