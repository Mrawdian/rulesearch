...
genere 2026-08-26 21:14 UTC — 64551 systemes evalues
...
- moteur actif `0caa9267db60` (20809 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 29531 | 14682 | 2019 | 991 | 2947 | 2334 | 3153 | 3030 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 28905 | 6664 | 12265 | 16 | 4013 | 1490 | 12 | 4445 | 15.4% |
...
- candidats AVEC connectivite : 3157, dont T2 : 100%
- candidats SANS connectivite : 4755, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3427 systemes avec CONNECTED sur 26656 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3622 candidats sur 7912 portent les champs bruts (46%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 753 candidats
  - AVEC connectivite (313) : resistance **40.0%**
  - SANS connectivite (440) : resistance **20.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 753 candidats
  - AVEC connectivite (313) : T0=12.87 T1=0.00 T2=2.84 — pondere **5.69**
  - SANS connectivite (440) : T0=16.19 T1=0.00 T2=2.67 — pondere **5.34**
  - test de permutation : **p = 0.1259** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e3baecf8377b` — 657 candidats
...
- TROP-CHER : 3449 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3427 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 24155 systemes
  - sans CONNECTED : 0.0% sur 5376 systemes
