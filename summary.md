...
genere 2026-08-27 01:54 UTC — 74937 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 10030 systemes
...
- moteur actif `0caa9267db60` (31195 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 34778 | 17307 | 2395 | 1177 | 3449 | 2764 | 3699 | 3543 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 34044 | 7849 | 14473 | 20 | 4724 | 1771 | 18 | 5189 | 15.2% |
...
- candidats AVEC connectivite : 3670, dont T2 : 100%
- candidats SANS connectivite : 5499, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3973 systemes avec CONNECTED sur 30953 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4879 candidats sur 9169 portent les champs bruts (53%).*
...
- `ab89a63b01ef` — 1202 candidats
  - AVEC connectivite (490) : resistance **41.2%**
...
- `ab89a63b01ef` — 1202 candidats
  - AVEC connectivite (490) : T0=13.03 T1=0.00 T2=3.04 — pondere **6.08**
...
- TROP-CHER : 4001 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3973 avec CONNECTED, 28 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 28452 systemes
  - sans CONNECTED : 0.0% sur 6326 systemes
