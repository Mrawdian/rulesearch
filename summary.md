...
genere 2026-09-03 10:55 UTC — 336668 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 253324 systemes
...
- moteur actif `0caa9267db60` (292926 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 166930 | 82955 | 11332 | 5592 | 17003 | 13179 | 17681 | 17049 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 163623 | 38109 | 69146 | 66 | 22693 | 8457 | 66 | 25074 | 15.3% |
...
- candidats AVEC connectivite : 17176, dont T2 : 100%
- candidats SANS connectivite : 25384, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **17955 systemes avec CONNECTED sur 138676 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*38270 candidats sur 42560 portent les champs bruts (90%).*

- `5c556c16ea8b` — 32305 candidats
  - AVEC connectivite (13048) : resistance **41.1%**
  - SANS connectivite (19257) : resistance **21.2%**
...
- `5c556c16ea8b` — 32305 candidats
  - AVEC connectivite (13048) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (19257) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.29**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 136175 systemes
  - sans CONNECTED : 0.0% sur 30755 systemes
