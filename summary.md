...
genere 2026-09-04 23:21 UTC — 375891 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 292547 systemes
...
- moteur actif `0caa9267db60` (332149 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 186735 | 92741 | 12694 | 6243 | 18995 | 14718 | 19796 | 19155 | 10.3% |
...
- candidats AVEC connectivite : 19282, dont T2 : 100%
...
- **20070 systemes avec CONNECTED sur 154827 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*43383 candidats sur 47673 portent les champs bruts (91%).*

- `5c556c16ea8b` — 37418 candidats
  - AVEC connectivite (15154) : resistance **41.1%**
...
- `5c556c16ea8b` — 37418 candidats
  - AVEC connectivite (15154) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.95**
...
- TROP-CHER : 20150 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 20070 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 152326 systemes
  - sans CONNECTED : 0.0% sur 34409 systemes
