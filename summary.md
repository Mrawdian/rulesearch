...
genere 2026-09-04 05:09 UTC — 356631 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 273287 systemes
...
- moteur actif `0caa9267db60` (312889 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 177012 | 87978 | 12041 | 5925 | 17999 | 13932 | 18763 | 18119 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 173504 | 40314 | 73280 | 70 | 24091 | 8994 | 70 | 26671 | 15.4% |
...
- candidats AVEC connectivite : 18246, dont T2 : 100%
- candidats SANS connectivite : 26981, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19037 systemes avec CONNECTED sur 146956 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*40937 candidats sur 45227 portent les champs bruts (91%).*

- `5c556c16ea8b` — 34972 candidats
  - AVEC connectivite (14118) : resistance **41.1%**
  - SANS connectivite (20854) : resistance **21.2%**
...
- `5c556c16ea8b` — 34972 candidats
  - AVEC connectivite (14118) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (20854) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 19117 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19037 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 144455 systemes
  - sans CONNECTED : 0.0% sur 32557 systemes
