...
genere 2026-08-29 22:42 UTC — 198341 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 114997 systemes
...
- moteur actif `0caa9267db60` (154599 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 97100 | 48222 | 6598 | 3265 | 9796 | 7725 | 10239 | 10009 | 10.3% |
...
- candidats AVEC connectivite : 10136, dont T2 : 100%
...
- **10513 systemes avec CONNECTED sur 81702 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*20774 candidats sur 25064 portent les champs bruts (83%).*

- `5c556c16ea8b` — 14809 candidats
  - AVEC connectivite (6008) : resistance **41.1%**
...
- `5c556c16ea8b` — 14809 candidats
  - AVEC connectivite (6008) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
...
- TROP-CHER : 10560 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10513 avec CONNECTED, 47 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 79201 systemes
  - sans CONNECTED : 0.0% sur 17899 systemes
