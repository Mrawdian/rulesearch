...
genere 2026-09-01 07:20 UTC — 276025 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 192681 systemes
...
- moteur actif `0caa9267db60` (232283 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 136321 | 67723 | 9226 | 4559 | 13831 | 10779 | 14411 | 14021 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 133589 | 31133 | 56453 | 58 | 18525 | 6907 | 60 | 20443 | 15.3% |
...
- candidats AVEC connectivite : 14148, dont T2 : 100%
- candidats SANS connectivite : 20753, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14685 systemes avec CONNECTED sur 113723 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*30611 candidats sur 34901 portent les champs bruts (88%).*

- `5c556c16ea8b` — 24646 candidats
  - AVEC connectivite (10020) : resistance **41.0%**
  - SANS connectivite (14626) : resistance **21.3%**
...
- `5c556c16ea8b` — 24646 candidats
  - AVEC connectivite (10020) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (14626) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 14755 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14685 avec CONNECTED, 70 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 111222 systemes
  - sans CONNECTED : 0.0% sur 25099 systemes
