...
- moteur actif `0caa9267db60` (8580 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23357 | 11638 | 1583 | 797 | 2330 | 1852 | 2496 | 2366 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 22850 | 5286 | 9654 | 14 | 3200 | 1162 | 10 | 3524 | 15.4% |
...
- candidats AVEC connectivite : 2493, dont T2 : 100%
- candidats SANS connectivite : 3834, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2770 systemes avec CONNECTED sur 21566 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2037 candidats sur 6327 portent les champs bruts (32%).*
...
- `06fe04a859f1` — 922 candidats
  - AVEC connectivite (355) : resistance **41.3%**
  - SANS connectivite (567) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 922 candidats
  - AVEC connectivite (355) : T0=13.25 T1=0.00 T2=3.04 — pondere **6.07**
  - SANS connectivite (567) : T0=16.03 T1=0.00 T2=2.65 — pondere **5.29**
...
- TROP-CHER : 2790 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2770 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19065 systemes
  - sans CONNECTED : 0.0% sur 4292 systemes
