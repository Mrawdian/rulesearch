...
genere 2026-08-26 23:53 UTC — 70429 systemes evalues
...
- moteur actif `0caa9267db60` (26687 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 31809 | 7339 | 13511 | 18 | 4406 | 1659 | 15 | 4861 | 15.3% |
...
- candidats SANS connectivite : 5171, dont T2 : 100%
...
*4320 candidats sur 8610 portent les champs bruts (50%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 643 candidats
  - AVEC connectivite (259) : resistance **42.2%**
  - SANS connectivite (384) : resistance **21.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 643 candidats
  ...
  - SANS connectivite (384) : T0=15.88 T1=0.00 T2=2.64 — pondere **5.27**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e3baecf8377b` — 657 candidats
