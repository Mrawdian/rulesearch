...
genere 2026-08-27 04:02 UTC — 79605 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 14698 systemes
...
- moteur actif `0caa9267db60` (35863 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 37141 | 18465 | 2563 | 1264 | 3680 | 2930 | 3942 | 3814 | 10.3% |
...
- candidats AVEC connectivite : 3941, dont T2 : 100%
- candidats SANS connectivite : 5846, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4216 systemes avec CONNECTED sur 32905 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5497 candidats sur 9787 portent les champs bruts (56%).*
...
- `ab89a63b01ef` — 1820 candidats
  - AVEC connectivite (761) : resistance **41.4%**
...
- `ab89a63b01ef` — 1820 candidats
  - AVEC connectivite (761) : T0=13.03 T1=0.00 T2=3.04 — pondere **6.09**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 30404 systemes
  - sans CONNECTED : 0.0% sur 6737 systemes
