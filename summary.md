...
genere 2026-08-26 18:46 UTC — 59201 systemes evalues
...
- moteur actif `0caa9267db60` (15459 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 26822 | 13382 | 1826 | 906 | 2661 | 2119 | 2850 | 2745 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 26264 | 6054 | 11123 | 15 | 3662 | 1351 | 10 | 4049 | 15.4% |
...
- candidats AVEC connectivite : 2872, dont T2 : 100%
- candidats SANS connectivite : 4359, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3124 systemes avec CONNECTED sur 24443 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2941 candidats sur 7231 portent les champs bruts (41%).*
...
- `e80bc1b2b437` — 75 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 72 candidats
  - AVEC connectivite (28) : resistance **46.4%**
  - SANS connectivite (44) : resistance **16.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 72 candidats
  - AVEC connectivite (28) : T0=13.11 T1=0.00 T2=3.21 — pondere **6.43**
  - SANS connectivite (44) : T0=16.32 T1=0.00 T2=2.48 — pondere **4.95**
...
- TROP-CHER : 3144 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3124 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 21942 systemes
  - sans CONNECTED : 0.0% sur 4880 systemes
