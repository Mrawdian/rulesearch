...
genere 2026-08-27 00:25 UTC — 71620 systemes evalues
...
- moteur actif `0caa9267db60` (27878 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 33105 | 16449 | 2279 | 1122 | 3290 | 2632 | 3530 | 3379 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 32400 | 7469 | 13751 | 18 | 4493 | 1699 | 16 | 4954 | 15.3% |
...
- candidats AVEC connectivite : 3506, dont T2 : 100%
- candidats SANS connectivite : 5264, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3804 systemes avec CONNECTED sur 29572 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4480 candidats sur 8770 portent les champs bruts (51%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 803 candidats
  - AVEC connectivite (326) : resistance **41.4%**
  - SANS connectivite (477) : resistance **21.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 803 candidats
  - AVEC connectivite (326) : T0=13.17 T1=0.00 T2=3.07 — pondere **6.15**
  - SANS connectivite (477) : T0=15.92 T1=0.00 T2=2.62 — pondere **5.24**
...
- TROP-CHER : 3830 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3804 avec CONNECTED, 26 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 27071 systemes
  - sans CONNECTED : 0.0% sur 6034 systemes
