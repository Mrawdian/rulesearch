...
genere 2026-08-26 20:41 UTC — 63411 systemes evalues
...
- moteur actif `0caa9267db60` (19669 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 28961 | 14414 | 1978 | 968 | 2877 | 2294 | 3084 | 2977 | 10.3% |
...
- candidats AVEC connectivite : 3104, dont T2 : 100%
- candidats SANS connectivite : 4662, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3358 systemes avec CONNECTED sur 26194 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3476 candidats sur 7766 portent les champs bruts (45%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 607 candidats
  - AVEC connectivite (260) : resistance **40.1%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 607 candidats
  - AVEC connectivite (260) : T0=12.75 T1=0.00 T2=2.85 — pondere **5.70**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23693 systemes
  - sans CONNECTED : 0.0% sur 5268 systemes
