...
genere 2026-08-27 04:49 UTC — 81472 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 16565 systemes
...
- moteur actif `0caa9267db60` (37730 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 38079 | 18947 | 2622 | 1298 | 3789 | 2989 | 4024 | 3915 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 37278 | 8596 | 15850 | 21 | 5167 | 1937 | 20 | 5687 | 15.3% |
...
- candidats AVEC connectivite : 4042, dont T2 : 100%
- candidats SANS connectivite : 5997, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4298 systemes avec CONNECTED sur 33661 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5749 candidats sur 10039 portent les champs bruts (57%).*
...
- `ab89a63b01ef` — 2072 candidats
  - AVEC connectivite (862) : resistance **41.4%**
...
- `ab89a63b01ef` — 2072 candidats
  - AVEC connectivite (862) : T0=13.03 T1=0.00 T2=3.03 — pondere **6.07**
...
- TROP-CHER : 4328 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4298 avec CONNECTED, 30 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 31160 systemes
  - sans CONNECTED : 0.0% sur 6919 systemes
