...
genere 2026-09-04 19:15 UTC — 371657 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 288313 systemes
...
- moteur actif `0caa9267db60` (327915 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 184601 | 91720 | 12563 | 6180 | 18764 | 14534 | 19559 | 18911 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 180941 | 42067 | 76445 | 75 | 25153 | 9361 | 70 | 27756 | 15.3% |
...
- candidats AVEC connectivite : 19038, dont T2 : 100%
...
- **19833 systemes avec CONNECTED sur 153100 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*42814 candidats sur 47104 portent les champs bruts (91%).*

- `5c556c16ea8b` — 36849 candidats
  - AVEC connectivite (14910) : resistance **41.0%**
...
- `5c556c16ea8b` — 36849 candidats
  - AVEC connectivite (14910) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.95**
...
- TROP-CHER : 19913 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19833 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 150599 systemes
