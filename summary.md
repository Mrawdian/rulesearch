...
genere 2026-08-26 18:10 UTC — 57644 systemes evalues
...
- `e80bc1b2b437` : 220 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (13902 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `84fba70921e0`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
**7686 enregistrements (13%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 26043 | 12973 | 1776 | 881 | 2579 | 2059 | 2781 | 2672 | 10.3% |
...
- candidats AVEC connectivite : 2799, dont T2 : 100%
- candidats SANS connectivite : 4244, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3055 systemes avec CONNECTED sur 23792 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2753 candidats sur 7043 portent les champs bruts (39%).*
...
- `b71bb0907fb5` — 53 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `e80bc1b2b437` — 24 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (14) : resistance **37.6%**
...
- `e80bc1b2b437` — 24 candidats
  - AVEC connectivite (14) : T0=12.71 T1=0.00 T2=2.36 — pondere **4.71**
...
- TROP-CHER : 3075 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3055 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 21291 systemes
  - sans CONNECTED : 0.0% sur 4752 systemes
