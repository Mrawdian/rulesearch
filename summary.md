...
genere 2026-08-31 20:52 UTC — 262868 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 179524 systemes
...
- moteur actif `0caa9267db60` (219126 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 129694 | 64474 | 8762 | 4351 | 13133 | 10253 | 13674 | 13358 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 127059 | 29618 | 53651 | 56 | 17621 | 6562 | 57 | 19484 | 15.3% |
...
- candidats AVEC connectivite : 13485, dont T2 : 100%
- candidats SANS connectivite : 19794, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13948 systemes avec CONNECTED sur 108324 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*28989 candidats sur 33279 portent les champs bruts (87%).*

- `5c556c16ea8b` — 23024 candidats
  - AVEC connectivite (9357) : resistance **41.0%**
  - SANS connectivite (13667) : resistance **21.3%**
...
- `5c556c16ea8b` — 23024 candidats
  - AVEC connectivite (9357) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.97**
  - SANS connectivite (13667) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 14015 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13948 avec CONNECTED, 67 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 105823 systemes
