...
genere 2026-08-27 02:19 UTC — 75721 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 10814 systemes
...
- moteur actif `0caa9267db60` (31979 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 35183 | 17504 | 2417 | 1192 | 3488 | 2794 | 3751 | 3586 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 34423 | 7928 | 14641 | 20 | 4778 | 1795 | 18 | 5243 | 15.2% |
...
- candidats AVEC connectivite : 3713, dont T2 : 100%
- candidats SANS connectivite : 5553, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4025 systemes avec CONNECTED sur 31291 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4976 candidats sur 9266 portent les champs bruts (54%).*
...
- `ab89a63b01ef` — 1299 candidats
  - AVEC connectivite (533) : resistance **41.2%**
  - SANS connectivite (766) : resistance **22.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1299 candidats
  - AVEC connectivite (533) : T0=13.02 T1=0.00 T2=3.06 — pondere **6.11**
  - SANS connectivite (766) : T0=15.95 T1=0.00 T2=2.69 — pondere **5.37**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- TROP-CHER : 4053 systemes abandonnes (5.4% des systemes), 96% du temps total
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 28790 systemes
  - sans CONNECTED : 0.0% sur 6393 systemes
