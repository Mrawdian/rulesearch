...
genere 2026-08-28 00:07 UTC — 120079 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 36735 systemes
...
- moteur actif `0caa9267db60` (76337 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 57557 | 28669 | 3978 | 1944 | 5713 | 4552 | 6078 | 5885 | 10.2% |
...
- candidats AVEC connectivite : 6012, dont T2 : 100%
- candidats SANS connectivite : 8953, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6352 systemes avec CONNECTED sur 49516 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10675 candidats sur 14965 portent les champs bruts (71%).*

- `5c556c16ea8b` — 4710 candidats
  - AVEC connectivite (1884) : resistance **41.9%**
...
- `5c556c16ea8b` — 4710 candidats
  - AVEC connectivite (1884) : T0=12.99 T1=0.00 T2=3.05 — pondere **6.10**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 47015 systemes
  - sans CONNECTED : 0.0% sur 10542 systemes
