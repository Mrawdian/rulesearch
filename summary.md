...
| connect | 4 | 3 | 7952 | 4010 | 516 | 272 | 760 | 633 | 838 | 830 | 10.4% |
...
- candidats AVEC connectivite : 833, dont T2 : 100%
...
- **838 systemes avec CONNECTED sur 6584 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 880 candidats
  - AVEC connectivite (354) : T0=13.40 T1=0.00 T2=2.84 — pondere **5.68**
...
- TROP-CHER : 841 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 838 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 6527 systemes
