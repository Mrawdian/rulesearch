...
genere 2026-08-26 08:03 UTC — 32444 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 23470 systemes
...
| d4 | 4 | 4 | 3068 | 1398 | 791 | 17 | 218 | 208 | 153 | 204 | 6.6% |
...
- candidats AVEC connectivite : 1545, dont T2 : 100%
- candidats SANS connectivite : 2392, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1763 systemes avec CONNECTED sur 13421 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2772 candidats
  - AVEC connectivite (1066) : T0=13.17 T1=0.00 T2=2.90 — pondere **5.80**
...
- TROP-CHER : 1773 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1763 avec CONNECTED, 10 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
