...
genere 2026-08-26 19:32 UTC — 60940 systemes evalues
...
- moteur actif `0caa9267db60` (17198 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 27120 | 6279 | 11467 | 15 | 3775 | 1400 | 11 | 4173 | 15.4% |
...
- candidats SANS connectivite : 4483, dont T2 : 100%
...
*3158 candidats sur 7448 portent les champs bruts (42%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 289 candidats
  - AVEC connectivite (121) : resistance **39.5%**
  - SANS connectivite (168) : resistance **18.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 289 candidats
  ...
  - SANS connectivite (168) : T0=16.07 T1=0.00 T2=2.55 — pondere **5.11**
...
**6 serie(s) reproductible(s) sur 12 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `62448a55927e` (p=0.0430), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
