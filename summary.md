...
- candidats AVEC connectivite : 3460, dont T2 : 100%
- candidats SANS connectivite : 5204, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3763 systemes avec CONNECTED sur 29231 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4374 candidats sur 8664 portent les champs bruts (50%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 697 candidats
  - AVEC connectivite (280) : resistance **41.5%**
...
- `ab89a63b01ef` — 697 candidats
  - AVEC connectivite (280) : T0=13.17 T1=0.00 T2=3.09 — pondere **6.18**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  ...
  - sans CONNECTED : 0.0% sur 5970 systemes
