...
- moteur actif `0caa9267db60` (7419 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22758 | 11343 | 1532 | 773 | 2270 | 1807 | 2438 | 2310 | 10.2% |
...
- candidats AVEC connectivite : 2437, dont T2 : 100%
- candidats SANS connectivite : 3752, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2712 systemes avec CONNECTED sur 21077 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1899 candidats sur 6189 portent les champs bruts (31%).*
...
- `06fe04a859f1` — 784 candidats
  - AVEC connectivite (299) : resistance **41.0%**
...
- `06fe04a859f1` — 784 candidats
  - AVEC connectivite (299) : T0=13.34 T1=0.00 T2=3.02 — pondere **6.04**
...
- TROP-CHER : 2732 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2712 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18576 systemes
  - sans CONNECTED : 0.0% sur 4182 systemes
