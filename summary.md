...
genere 2026-08-26 09:37 UTC — 36674 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 27700 systemes
...
| connect | 4 | 3 | 15838 | 7895 | 1034 | 543 | 1575 | 1264 | 1729 | 1597 | 10.1% |
| d4 | 4 | 4 | 5197 | 2394 | 1320 | 28 | 369 | 342 | 248 | 368 | 7.1% |
| ref | 4 | 3 | 15515 | 3641 | 6548 | 11 | 2132 | 786 | 7 | 2390 | 15.4% |
...
- candidats AVEC connectivite : 1703, dont T2 : 100%
- candidats SANS connectivite : 2659, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1968 systemes avec CONNECTED sur 15131 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*72 candidats sur 4362 portent les champs bruts (2%).*

- `89c65c03c4ad` — 72 candidats
  - AVEC connectivite (26) : resistance **51.4%**
  - SANS connectivite (46) : resistance **21.3%**
...
- `89c65c03c4ad` — 3197 candidats
  - AVEC connectivite (1224) : T0=13.09 T1=0.00 T2=2.95 — pondere **5.89**
  - SANS connectivite (1973) : T0=15.85 T1=0.02 T2=2.65 — pondere **5.33**
...
- TROP-CHER : 1984 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 1968 avec CONNECTED, 16 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.4% sur 12943 systemes
  - sans CONNECTED : 0.0% sur 2895 systemes
