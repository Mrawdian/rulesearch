...
genere 2026-09-05 08:56 UTC — 385815 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 302471 systemes
...
- moteur actif `0caa9267db60` (342073 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 191749 | 95233 | 13059 | 6376 | 19499 | 15106 | 20323 | 19705 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 187951 | 43737 | 79355 | 77 | 26141 | 9724 | 70 | 28833 | 15.3% |
...
- candidats AVEC connectivite : 19832, dont T2 : 100%
...
- **20597 systemes avec CONNECTED sur 158929 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*44685 candidats sur 48975 portent les champs bruts (91%).*

- `5c556c16ea8b` — 38720 candidats
  - AVEC connectivite (15704) : resistance **41.1%**
...
- `5c556c16ea8b` — 38720 candidats
  - AVEC connectivite (15704) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 20677 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 20597 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 156428 systemes
  - sans CONNECTED : 0.0% sur 35321 systemes
