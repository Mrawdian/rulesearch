...
genere 2026-09-07 12:22 UTC — 435605 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 352261 systemes
...
- moteur actif `0caa9267db60` (391863 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 216900 | 107759 | 14774 | 7218 | 21962 | 17005 | 23069 | 22357 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 212590 | 49494 | 89631 | 83 | 29630 | 10980 | 76 | 32678 | 15.4% |
...
- candidats AVEC connectivite : 22484, dont T2 : 100%
- candidats SANS connectivite : 32988, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23343 systemes avec CONNECTED sur 179576 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*51182 candidats sur 55472 portent les champs bruts (92%).*

- `5c556c16ea8b` — 45217 candidats
  - AVEC connectivite (18356) : resistance **41.1%**
  - SANS connectivite (26861) : resistance **21.3%**
...
- `5c556c16ea8b` — 45217 candidats
  - AVEC connectivite (18356) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (26861) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
## cout
- temps total 135.6 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 23429 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23343 avec CONNECTED, 86 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 177075 systemes
  - sans CONNECTED : 0.0% sur 39825 systemes
