...
genere 2026-08-27 03:00 UTC — 77363 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 12456 systemes
...
- moteur actif `0caa9267db60` (33621 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 36006 | 17912 | 2475 | 1220 | 3568 | 2846 | 3824 | 3690 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 35242 | 8138 | 14977 | 20 | 4873 | 1842 | 19 | 5373 | 15.2% |
...
- candidats AVEC connectivite : 3817, dont T2 : 100%
- candidats SANS connectivite : 5683, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4098 systemes avec CONNECTED sur 31978 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5210 candidats sur 9500 portent les champs bruts (55%).*
...
- `ab89a63b01ef` — 1533 candidats
  - AVEC connectivite (637) : resistance **41.3%**
  - SANS connectivite (896) : resistance **22.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1533 candidats
  - AVEC connectivite (637) : T0=13.01 T1=0.00 T2=3.05 — pondere **6.11**
  - SANS connectivite (896) : T0=15.95 T1=0.00 T2=2.70 — pondere **5.41**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- TROP-CHER : 4127 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4098 avec CONNECTED, 29 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 29477 systemes
  - sans CONNECTED : 0.0% sur 6529 systemes
