...
genere 2026-08-26 21:36 UTC — 65453 systemes evalues
...
- `ab89a63b01ef` : 546 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (21711 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
**8072 enregistrements (12%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| ref | 4 | 3 | 29344 | 6768 | 12460 | 16 | 4062 | 1516 | 12 | 4510 | 15.4% |
...
- candidats SANS connectivite : 4820, dont T2 : 100%
...
*3734 candidats sur 8024 portent les champs bruts (47%).*
...
- `e80bc1b2b437` — 75 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 57 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (24) : resistance **42.9%**
  - SANS connectivite (33) : resistance **22.0%**
...
- `ab89a63b01ef` — 57 candidats
  - AVEC connectivite (24) : T0=14.38 T1=0.00 T2=2.96 — pondere **5.92**
  - SANS connectivite (33) : T0=16.36 T1=0.00 T2=2.94 — pondere **5.88**
