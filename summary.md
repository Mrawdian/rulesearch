...
genere 2026-09-01 09:29 UTC — 278768 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 195424 systemes
...
- moteur actif `0caa9267db60` (235026 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 137708 | 68449 | 9320 | 4599 | 13965 | 10868 | 14552 | 14173 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 134945 | 31443 | 57026 | 58 | 18715 | 6989 | 60 | 20643 | 15.3% |
...
- candidats AVEC connectivite : 14300, dont T2 : 100%
- candidats SANS connectivite : 20953, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14826 systemes avec CONNECTED sur 114872 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*30963 candidats sur 35253 portent les champs bruts (88%).*

- `5c556c16ea8b` — 24998 candidats
  - AVEC connectivite (10172) : resistance **41.1%**
  - SANS connectivite (14826) : resistance **21.4%**
...
- `5c556c16ea8b` — 24998 candidats
  - AVEC connectivite (10172) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (14826) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.32**
...
## cout
- temps total 86.3 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 14896 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14826 avec CONNECTED, 70 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 112371 systemes
  - sans CONNECTED : 0.0% sur 25337 systemes
