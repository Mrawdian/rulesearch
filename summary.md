...
genere 2026-08-29 13:41 UTC — 184654 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 101310 systemes
...
- moteur actif `0caa9267db60` (140912 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 90177 | 44847 | 6130 | 3041 | 9071 | 7185 | 9482 | 9278 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 88362 | 20651 | 37298 | 43 | 12204 | 4533 | 35 | 13592 | 15.4% |
...
- candidats AVEC connectivite : 9405, dont T2 : 100%
- candidats SANS connectivite : 13902, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9756 systemes avec CONNECTED sur 76063 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*19017 candidats sur 23307 portent les champs bruts (82%).*

- `5c556c16ea8b` — 13052 candidats
  - AVEC connectivite (5277) : resistance **41.2%**
  - SANS connectivite (7775) : resistance **21.6%**
...
- `5c556c16ea8b` — 13052 candidats
  - AVEC connectivite (5277) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (7775) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.33**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 73562 systemes
  - sans CONNECTED : 0.0% sur 16615 systemes
