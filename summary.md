...
genere 2026-08-27 20:10 UTC — 112445 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 29101 systemes
...
- moteur actif `0caa9267db60` (68703 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 53706 | 26745 | 3719 | 1831 | 5306 | 4245 | 5677 | 5481 | 10.2% |
...
- candidats AVEC connectivite : 5608, dont T2 : 100%
- candidats SANS connectivite : 8354, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5951 systemes avec CONNECTED sur 46390 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*9672 candidats sur 13962 portent les champs bruts (69%).*
...
- `5c556c16ea8b` — 3707 candidats
  - AVEC connectivite (1480) : resistance **42.0%**
...
- `5c556c16ea8b` — 3707 candidats
  - AVEC connectivite (1480) : T0=12.94 T1=0.00 T2=3.06 — pondere **6.11**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 43889 systemes
  - sans CONNECTED : 0.0% sur 9817 systemes
