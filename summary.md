...
genere 2026-08-31 13:01 UTC — 252478 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 169134 systemes
...
- moteur actif `0caa9267db60` (208736 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 124439 | 61882 | 8437 | 4168 | 12553 | 9817 | 13140 | 12810 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 121924 | 28445 | 51471 | 54 | 16871 | 6304 | 56 | 18713 | 15.3% |
...
- candidats AVEC connectivite : 12937, dont T2 : 100%
...
- **13414 systemes avec CONNECTED sur 104061 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*27670 candidats sur 31960 portent les champs bruts (87%).*

- `5c556c16ea8b` — 21705 candidats
  - AVEC connectivite (8809) : resistance **41.0%**
...
- `5c556c16ea8b` — 21705 candidats
  - AVEC connectivite (8809) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 13480 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13414 avec CONNECTED, 66 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 101560 systemes
  - sans CONNECTED : 0.0% sur 22879 systemes
