...
genere 2026-08-28 06:16 UTC — 131648 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 48304 systemes
...
- moteur actif `0caa9267db60` (87906 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 63405 | 31513 | 4351 | 2149 | 6341 | 5052 | 6667 | 6514 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 62128 | 14373 | 26324 | 29 | 8634 | 3208 | 28 | 9530 | 15.3% |
...
- candidats AVEC connectivite : 6641, dont T2 : 100%
- candidats SANS connectivite : 9840, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6941 systemes avec CONNECTED sur 54226 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12191 candidats sur 16481 portent les champs bruts (74%).*

- `5c556c16ea8b` — 6226 candidats
  - AVEC connectivite (2513) : resistance **41.5%**
  - SANS connectivite (3713) : resistance **22.0%**
...
- `5c556c16ea8b` — 6226 candidats
  - AVEC connectivite (2513) : T0=12.97 T1=0.00 T2=3.02 — pondere **6.04**
  - SANS connectivite (3713) : T0=15.86 T1=0.00 T2=2.69 — pondere **5.37**
...
- TROP-CHER : 6979 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6941 avec CONNECTED, 38 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 51725 systemes
  - sans CONNECTED : 0.0% sur 11680 systemes
