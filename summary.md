...
genere 2026-08-26 21:07 UTC — 64255 systemes evalues
...
- moteur actif `0caa9267db60` (20513 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 29381 | 14609 | 2004 | 983 | 2928 | 2328 | 3140 | 3015 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 28759 | 6629 | 12205 | 16 | 3993 | 1482 | 12 | 4422 | 15.4% |
...
- candidats AVEC connectivite : 3142, dont T2 : 100%
- candidats SANS connectivite : 4732, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3414 systemes avec CONNECTED sur 26534 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3584 candidats sur 7874 portent les champs bruts (46%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 715 candidats
  - AVEC connectivite (298) : resistance **40.1%**
  - SANS connectivite (417) : resistance **20.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 715 candidats
  - AVEC connectivite (298) : T0=12.89 T1=0.00 T2=2.85 — pondere **5.70**
  - SANS connectivite (417) : T0=16.15 T1=0.00 T2=2.68 — pondere **5.36**
...
- TROP-CHER : 3436 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3414 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 24033 systemes
  - sans CONNECTED : 0.0% sur 5348 systemes
