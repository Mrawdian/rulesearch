...
genere 2026-08-30 01:03 UTC — 201964 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 118620 systemes
...
- moteur actif `0caa9267db60` (158222 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 98922 | 49092 | 6734 | 3319 | 9981 | 7882 | 10425 | 10203 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 96927 | 22617 | 40902 | 45 | 13402 | 5002 | 37 | 14915 | 15.4% |
...
- candidats AVEC connectivite : 10330, dont T2 : 100%
- candidats SANS connectivite : 15225, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10699 systemes avec CONNECTED sur 83166 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*21265 candidats sur 25555 portent les champs bruts (83%).*

- `5c556c16ea8b` — 15300 candidats
  - AVEC connectivite (6202) : resistance **41.1%**
  - SANS connectivite (9098) : resistance **21.5%**
...
- `5c556c16ea8b` — 15300 candidats
  - AVEC connectivite (6202) : T0=13.01 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (9098) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.33**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 80665 systemes
  - sans CONNECTED : 0.0% sur 18257 systemes
