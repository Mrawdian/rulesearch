...
genere 2026-08-27 14:50 UTC — 102047 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 18703 systemes
...
- moteur actif `0caa9267db60` (58305 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 48455 | 24148 | 3339 | 1657 | 4806 | 3830 | 5121 | 4928 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 47477 | 10983 | 20156 | 25 | 6575 | 2483 | 22 | 7232 | 15.2% |
...
- candidats AVEC connectivite : 5055, dont T2 : 100%
- candidats SANS connectivite : 7542, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5395 systemes avec CONNECTED sur 42098 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*8307 candidats sur 12597 portent les champs bruts (66%).*
...
- `5c556c16ea8b` — 2342 candidats
  - AVEC connectivite (927) : resistance **41.6%**
  - SANS connectivite (1415) : resistance **22.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 2342 candidats
  - AVEC connectivite (927) : T0=13.03 T1=0.00 T2=3.03 — pondere **6.06**
  - SANS connectivite (1415) : T0=15.77 T1=0.00 T2=2.68 — pondere **5.36**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 2280 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 39597 systemes
  - sans CONNECTED : 0.0% sur 8858 systemes
