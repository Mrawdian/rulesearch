...
genere 2026-08-27 23:35 UTC — 119031 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 35687 systemes
...
- moteur actif `0caa9267db60` (75289 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 57039 | 28422 | 3942 | 1932 | 5653 | 4513 | 6024 | 5821 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 55877 | 12891 | 23708 | 26 | 7769 | 2890 | 25 | 8566 | 15.3% |
...
- candidats AVEC connectivite : 5948, dont T2 : 100%
- candidats SANS connectivite : 8876, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6298 systemes avec CONNECTED sur 49093 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10534 candidats sur 14824 portent les champs bruts (71%).*

- `5c556c16ea8b` — 4569 candidats
  - AVEC connectivite (1820) : resistance **42.1%**
  - SANS connectivite (2749) : resistance **22.4%**
...
- `5c556c16ea8b` — 4569 candidats
  - AVEC connectivite (1820) : T0=12.97 T1=0.00 T2=3.06 — pondere **6.12**
  - SANS connectivite (2749) : T0=15.77 T1=0.00 T2=2.71 — pondere **5.42**
...
## cout
- temps total 36.8 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 6333 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6298 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 46592 systemes
  - sans CONNECTED : 0.0% sur 10447 systemes
