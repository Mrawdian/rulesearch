...
genere 2026-08-26 19:09 UTC — 60131 systemes evalues
...
- moteur actif `0caa9267db60` (16389 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27300 | 13617 | 1860 | 923 | 2704 | 2163 | 2898 | 2793 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 26716 | 6170 | 11306 | 15 | 3725 | 1375 | 10 | 4115 | 15.4% |
...
- candidats AVEC connectivite : 2920, dont T2 : 100%
- candidats SANS connectivite : 4425, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3172 systemes avec CONNECTED sur 24832 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3055 candidats sur 7345 portent les champs bruts (42%).*
...
- `23303c299f39` — 225 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 186 candidats
  - AVEC connectivite (76) : resistance **40.7%**
  - SANS connectivite (110) : resistance **18.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 186 candidats
  - AVEC connectivite (76) : T0=13.09 T1=0.00 T2=3.01 — pondere **6.03**
  - SANS connectivite (110) : T0=16.07 T1=0.00 T2=2.55 — pondere **5.11**
...
**6 serie(s) reproductible(s) sur 12 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0060), `62448a55927e` (p=0.0480), `b71bb0907fb5` (p=0.0110).
...
## cout
- temps total 18.6 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 3192 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3172 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22331 systemes
  - sans CONNECTED : 0.0% sur 4969 systemes
