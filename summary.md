...
genere 2026-08-30 05:54 UTC — 209176 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 125832 systemes
...
- moteur actif `0caa9267db60` (165434 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 102573 | 50923 | 6983 | 3435 | 10362 | 8180 | 10816 | 10538 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 100488 | 23399 | 42457 | 45 | 13879 | 5187 | 39 | 15474 | 15.4% |
...
- candidats AVEC connectivite : 10665, dont T2 : 100%
- candidats SANS connectivite : 15784, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11090 systemes avec CONNECTED sur 86151 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*22159 candidats sur 26449 portent les champs bruts (84%).*

- `5c556c16ea8b` — 16194 candidats
  - AVEC connectivite (6537) : resistance **41.1%**
  - SANS connectivite (9657) : resistance **21.5%**
...
- `5c556c16ea8b` — 16194 candidats
  - AVEC connectivite (6537) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (9657) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 11139 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11090 avec CONNECTED, 49 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 83650 systemes
  - sans CONNECTED : 0.0% sur 18923 systemes
