...
genere 2026-08-28 07:43 UTC — 134396 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 51052 systemes
...
- moteur actif `0caa9267db60` (90654 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 64795 | 32191 | 4447 | 2201 | 6502 | 5163 | 6802 | 6654 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 63486 | 14690 | 26869 | 29 | 8833 | 3282 | 28 | 9753 | 15.4% |
...
- candidats AVEC connectivite : 6781, dont T2 : 100%
- candidats SANS connectivite : 10063, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7076 systemes avec CONNECTED sur 55355 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12554 candidats sur 16844 portent les champs bruts (75%).*

- `5c556c16ea8b` — 6589 candidats
  - AVEC connectivite (2653) : resistance **41.4%**
  - SANS connectivite (3936) : resistance **21.9%**
...
- `5c556c16ea8b` — 6589 candidats
  - AVEC connectivite (2653) : T0=12.98 T1=0.00 T2=3.02 — pondere **6.04**
  - SANS connectivite (3936) : T0=15.85 T1=0.00 T2=2.68 — pondere **5.36**
...
## cout
- temps total 41.3 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 7114 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7076 avec CONNECTED, 38 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 52854 systemes
  - sans CONNECTED : 0.0% sur 11941 systemes
