...
genere 2026-08-26 10:07 UTC — 37969 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 28995 systemes
...
| connect | 4 | 3 | 16167 | 8070 | 1050 | 556 | 1609 | 1285 | 1766 | 1627 | 10.1% |
...
- candidats AVEC connectivite : 1750, dont T2 : 100%
- candidats SANS connectivite : 2736, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2031 systemes avec CONNECTED sur 15651 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*196 candidats sur 4486 portent les champs bruts (4%).*

- `89c65c03c4ad` — 196 candidats
  - AVEC connectivite (73) : resistance **48.4%**
  - SANS connectivite (123) : resistance **21.3%**
...
- `89c65c03c4ad` — 3321 candidats
  - AVEC connectivite (1271) : T0=13.04 T1=0.00 T2=2.97 — pondere **5.93**
  - SANS connectivite (2050) : T0=15.85 T1=0.02 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 2048 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2031 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.4% sur 13214 systemes
  - sans CONNECTED : 0.0% sur 2953 systemes
