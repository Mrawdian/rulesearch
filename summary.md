...
| connect | 4 | 3 | 18052 | 9023 | 1174 | 628 | 1789 | 1434 | 1963 | 1815 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 17676 | 4162 | 7458 | 12 | 2421 | 900 | 7 | 2716 | 15.4% |
...
- candidats AVEC connectivite : 1942, dont T2 : 100%
- candidats SANS connectivite : 3026, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2237 systemes avec CONNECTED sur 17245 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*678 candidats sur 4968 portent les champs bruts (14%).*
...
- `e3baecf8377b` — 414 candidats
  - AVEC connectivite (159) : resistance **44.4%**
  - SANS connectivite (255) : resistance **21.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 414 candidats
  - AVEC connectivite (159) : T0=12.94 T1=0.00 T2=3.24 — pondere **6.48**
  - SANS connectivite (255) : T0=16.01 T1=0.00 T2=2.68 — pondere **5.36**
...
- TROP-CHER : 2254 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2237 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14744 systemes
  - sans CONNECTED : 0.0% sur 3308 systemes
