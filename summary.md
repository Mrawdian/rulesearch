...
genere 2026-08-26 19:12 UTC — 60190 systemes evalues
...
- moteur actif `0caa9267db60` (16448 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27330 | 13633 | 1862 | 923 | 2704 | 2164 | 2903 | 2798 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 26745 | 6180 | 11320 | 15 | 3727 | 1375 | 10 | 4118 | 15.4% |
...
- candidats AVEC connectivite : 2925, dont T2 : 100%
- candidats SANS connectivite : 4428, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3177 systemes avec CONNECTED sur 24861 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3063 candidats sur 7353 portent les champs bruts (42%).*
...
- `23303c299f39` — 225 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 194 candidats
  - AVEC connectivite (81) : resistance **39.3%**
  - SANS connectivite (113) : resistance **18.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 194 candidats
  - AVEC connectivite (81) : T0=13.14 T1=0.00 T2=2.91 — pondere **5.83**
  - SANS connectivite (113) : T0=16.06 T1=0.00 T2=2.56 — pondere **5.12**
  - test de permutation : **p = 0.1184** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
- TROP-CHER : 3197 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3177 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22360 systemes
  - sans CONNECTED : 0.0% sur 4970 systemes
