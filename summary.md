...
genere 2026-08-26 14:29 UTC — 49056 systemes evalues
...
- moteur actif `0caa9267db60` (5314 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21696 | 10828 | 1446 | 745 | 2148 | 1723 | 2319 | 2212 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 21245 | 4941 | 8969 | 13 | 2943 | 1097 | 8 | 3274 | 15.4% |
...
- candidats SANS connectivite : 3584, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2593 systemes avec CONNECTED sur 20235 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1633 candidats sur 5923 portent les champs bruts (28%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 518 candidats
  - AVEC connectivite (201) : resistance **40.1%**
  - SANS connectivite (317) : resistance **20.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 518 candidats
  ...
  - SANS connectivite (317) : T0=16.05 T1=0.00 T2=2.64 — pondere **5.27**
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0160).
...
- TROP-CHER : 2611 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2593 avec CONNECTED, 18 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17734 systemes
  - sans CONNECTED : 0.0% sur 3962 systemes
