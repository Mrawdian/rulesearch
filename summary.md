...
genere 2026-08-26 04:11 UTC — 22810 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 13836 systemes
...
| connect | 4 | 3 | 11461 | 5748 | 753 | 396 | 1105 | 916 | 1238 | 1159 | 10.1% |
...
- candidats AVEC connectivite : 1162, dont T2 : 100%
...
- **1238 systemes avec CONNECTED sur 9448 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1730 candidats
  - AVEC connectivite (683) : T0=13.35 T1=0.00 T2=2.83 — pondere **5.67**
...
- TROP-CHER : 1242 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 1238 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 9391 systemes
  - sans CONNECTED : 0.0% sur 2070 systemes
