...
genere 2026-08-26 21:40 UTC — 65617 systemes evalues
...
- `ab89a63b01ef` : 710 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (21875 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
**8236 enregistrements (13%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
*3754 candidats sur 8044 portent les champs bruts (47%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 77 candidats (**NON REPRODUCTIBLE**)
...
- `ab89a63b01ef` — 77 candidats
  - AVEC connectivite (34) : T0=14.53 T1=0.00 T2=3.06 — pondere **6.12**
  - SANS connectivite (43) : T0=16.35 T1=0.00 T2=2.88 — pondere **5.77**
  - test de permutation : **p = 0.6387** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e80bc1b2b437` — 75 candidats
