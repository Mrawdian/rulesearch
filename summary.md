...
genere 2026-08-27 04:46 UTC — 81383 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 16476 systemes
...
- moteur actif `0caa9267db60` (37641 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 38035 | 18923 | 2621 | 1297 | 3782 | 2986 | 4018 | 3913 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 37233 | 8581 | 15830 | 21 | 5161 | 1936 | 20 | 5684 | 15.3% |
...
- candidats AVEC connectivite : 4040, dont T2 : 100%
- candidats SANS connectivite : 5994, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4292 systemes avec CONNECTED sur 33626 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5744 candidats sur 10034 portent les champs bruts (57%).*
...
- `ab89a63b01ef` — 2067 candidats
  - AVEC connectivite (860) : resistance **41.4%**
...
- `ab89a63b01ef` — 2067 candidats
  - AVEC connectivite (860) : T0=13.03 T1=0.00 T2=3.03 — pondere **6.06**
...
- TROP-CHER : 4322 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4292 avec CONNECTED, 30 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 31125 systemes
  - sans CONNECTED : 0.0% sur 6910 systemes
