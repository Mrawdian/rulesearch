...
- **1338 systemes avec CONNECTED sur 10157 (13.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- TROP-CHER : 1342 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1338 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 10100 systemes
  - sans CONNECTED : 0.0% sur 2228 systemes
