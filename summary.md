...
genere 2026-08-27 22:58 UTC — 117824 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 34480 systemes
...
- moteur actif `0caa9267db60` (74082 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 56427 | 28101 | 3903 | 1911 | 5596 | 4467 | 5964 | 5761 | 10.2% |
...
- candidats AVEC connectivite : 5888, dont T2 : 100%
- candidats SANS connectivite : 8781, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6238 systemes avec CONNECTED sur 48592 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10379 candidats sur 14669 portent les champs bruts (71%).*

- `5c556c16ea8b` — 4414 candidats
  - AVEC connectivite (1760) : resistance **42.0%**
...
- `5c556c16ea8b` — 4414 candidats
  - AVEC connectivite (1760) : T0=12.96 T1=0.00 T2=3.05 — pondere **6.11**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 46091 systemes
  - sans CONNECTED : 0.0% sur 10336 systemes
