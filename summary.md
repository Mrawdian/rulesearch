...
genere 2026-08-28 00:58 UTC — 121896 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 38552 systemes
...
- moteur actif `0caa9267db60` (78154 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 58482 | 29133 | 4040 | 1973 | 5813 | 4624 | 6153 | 5995 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 57299 | 13223 | 24320 | 28 | 7957 | 2970 | 26 | 8773 | 15.3% |
...
- candidats AVEC connectivite : 6122, dont T2 : 100%
- candidats SANS connectivite : 9083, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6427 systemes avec CONNECTED sur 50259 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10915 candidats sur 15205 portent les champs bruts (72%).*

- `5c556c16ea8b` — 4950 candidats
  - AVEC connectivite (1994) : resistance **42.0%**
  - SANS connectivite (2956) : resistance **22.3%**
...
- `5c556c16ea8b` — 4950 candidats
  - AVEC connectivite (1994) : T0=12.99 T1=0.00 T2=3.05 — pondere **6.10**
  - SANS connectivite (2956) : T0=15.85 T1=0.00 T2=2.72 — pondere **5.43**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 47758 systemes
  - sans CONNECTED : 0.0% sur 10724 systemes
