...
genere 2026-08-26 13:41 UTC — 47293 systemes evalues
...
- moteur actif `0caa9267db60` (3551 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20812 | 10388 | 1378 | 720 | 2068 | 1656 | 2214 | 2130 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20366 | 4764 | 8608 | 13 | 2818 | 1049 | 7 | 3107 | 15.3% |
...
- candidats AVEC connectivite : 2257, dont T2 : 100%
- candidats SANS connectivite : 3417, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2488 systemes avec CONNECTED sur 19496 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1384 candidats sur 5674 portent les champs bruts (24%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 269 candidats
  - AVEC connectivite (119) : resistance **39.0%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 269 candidats
  - AVEC connectivite (119) : T0=13.35 T1=0.00 T2=2.82 — pondere **5.63**
  - SANS connectivite (150) : T0=16.25 T1=0.00 T2=2.76 — pondere **5.52**
  - test de permutation : **p = 0.7681** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
- TROP-CHER : 2505 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2488 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 16995 systemes
  - sans CONNECTED : 0.0% sur 3817 systemes
