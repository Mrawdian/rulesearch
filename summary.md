...
- moteur actif `0caa9267db60` (48183 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 43348 | 21604 | 2973 | 1463 | 4327 | 3417 | 4566 | 4435 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 42462 | 9791 | 18013 | 25 | 5897 | 2216 | 22 | 6497 | 15.3% |
...
- candidats AVEC connectivite : 4562, dont T2 : 100%
- candidats SANS connectivite : 6807, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4840 systemes avec CONNECTED sur 37917 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*7079 candidats sur 11369 portent les champs bruts (62%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 1114 candidats
  - AVEC connectivite (434) : resistance **41.3%**
  - SANS connectivite (680) : resistance **21.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 1114 candidats
  - AVEC connectivite (434) : T0=13.01 T1=0.00 T2=3.01 — pondere **6.02**
  - SANS connectivite (680) : T0=15.76 T1=0.00 T2=2.63 — pondere **5.25**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
...
## cout
- temps total 28.3 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 4872 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4840 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 35416 systemes
  - sans CONNECTED : 0.0% sur 7932 systemes
