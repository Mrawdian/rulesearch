...
genere 2026-08-27 01:55 UTC — 74996 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 10089 systemes
...
- moteur actif `0caa9267db60` (31254 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 34808 | 17319 | 2396 | 1177 | 3455 | 2767 | 3700 | 3550 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 34073 | 7854 | 14487 | 20 | 4728 | 1774 | 18 | 5192 | 15.2% |
...
- candidats AVEC connectivite : 3677, dont T2 : 100%
- candidats SANS connectivite : 5502, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3974 systemes avec CONNECTED sur 30976 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4889 candidats sur 9179 portent les champs bruts (53%).*
...
- `ab89a63b01ef` — 1212 candidats
  - AVEC connectivite (497) : resistance **41.0%**
  - SANS connectivite (715) : resistance **22.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1212 candidats
  - AVEC connectivite (497) : T0=13.04 T1=0.00 T2=3.03 — pondere **6.06**
  - SANS connectivite (715) : T0=15.90 T1=0.00 T2=2.69 — pondere **5.37**
...
## cout
- temps total 23.2 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 4002 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3974 avec CONNECTED, 28 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 28475 systemes
  - sans CONNECTED : 0.0% sur 6333 systemes
