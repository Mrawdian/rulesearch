...
genere 2026-08-31 00:09 UTC — 234925 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 151581 systemes
...
- moteur actif `0caa9267db60` (191183 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 115577 | 57457 | 7848 | 3884 | 11609 | 9131 | 12234 | 11897 | 10.3% |
...
- candidats AVEC connectivite : 12024, dont T2 : 100%
...
- **12508 systemes avec CONNECTED sur 96888 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*25421 candidats sur 29711 portent les champs bruts (86%).*

- `5c556c16ea8b` — 19456 candidats
  - AVEC connectivite (7896) : resistance **41.1%**
...
- `5c556c16ea8b` — 19456 candidats
  - AVEC connectivite (7896) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.98**
...
## cout
- temps total 72.8 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 12568 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 12508 avec CONNECTED, 60 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 94387 systemes
  - sans CONNECTED : 0.0% sur 21190 systemes
