...
genere 2026-08-26 23:02 UTC — 68544 systemes evalues
...
- moteur actif `0caa9267db60` (24802 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 31548 | 15668 | 2160 | 1057 | 3144 | 2518 | 3367 | 3234 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 30881 | 7115 | 13126 | 18 | 4274 | 1604 | 14 | 4730 | 15.3% |
...
- candidats AVEC connectivite : 3361, dont T2 : 100%
- candidats SANS connectivite : 5040, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3641 systemes avec CONNECTED sur 28286 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4111 candidats sur 8401 portent les champs bruts (49%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 434 candidats
  - AVEC connectivite (181) : resistance **42.2%**
  - SANS connectivite (253) : resistance **21.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 434 candidats
  - AVEC connectivite (181) : T0=13.03 T1=0.00 T2=3.06 — pondere **6.12**
  - SANS connectivite (253) : T0=16.04 T1=0.00 T2=2.66 — pondere **5.32**
...
**6 serie(s) reproductible(s) sur 13 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `ab89a63b01ef` (p=0.0120), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 25785 systemes
  - sans CONNECTED : 0.0% sur 5763 systemes
