...
genere 2026-08-26 22:02 UTC — 66416 systemes evalues
...
- moteur actif `0caa9267db60` (22674 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 30473 | 15141 | 2084 | 1024 | 3045 | 2420 | 3247 | 3127 | 10.3% |
...
- candidats AVEC connectivite : 3254, dont T2 : 100%
- candidats SANS connectivite : 4894, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3521 systemes avec CONNECTED sur 27412 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3858 candidats sur 8148 portent les champs bruts (47%).*
...
- `23303c299f39` — 225 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 181 candidats
  - AVEC connectivite (74) : resistance **44.0%**
...
- `ab89a63b01ef` — 181 candidats
  - AVEC connectivite (74) : T0=13.14 T1=0.00 T2=3.09 — pondere **6.19**
  - SANS connectivite (107) : T0=15.91 T1=0.00 T2=2.84 — pondere **5.68**
  - test de permutation : **p = 0.3038** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
- TROP-CHER : 3544 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3521 avec CONNECTED, 23 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24911 systemes
  - sans CONNECTED : 0.0% sur 5562 systemes
