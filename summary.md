...
genere 2026-08-29 18:52 UTC — 192379 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 109035 systemes
...
- moteur actif `0caa9267db60` (148637 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 94084 | 46752 | 6405 | 3158 | 9477 | 7490 | 9932 | 9670 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 92180 | 21504 | 38909 | 43 | 12748 | 4746 | 36 | 14188 | 15.4% |
...
- candidats SANS connectivite : 14498, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10206 systemes avec CONNECTED sur 79259 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*20005 candidats sur 24295 portent les champs bruts (82%).*

- `5c556c16ea8b` — 14040 candidats
  - AVEC connectivite (5669) : resistance **41.2%**
  - SANS connectivite (8371) : resistance **21.5%**
...
- `5c556c16ea8b` — 14040 candidats
  ...
  - SANS connectivite (8371) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.33**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 76758 systemes
  - sans CONNECTED : 0.0% sur 17326 systemes
