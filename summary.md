...
| connect | 4 | 3 | 18950 | 9462 | 1241 | 657 | 1887 | 1508 | 2046 | 1914 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 18544 | 4355 | 7818 | 13 | 2547 | 962 | 7 | 2842 | 15.3% |
...
- candidats AVEC connectivite : 2041, dont T2 : 100%
- candidats SANS connectivite : 3152, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2320 systemes avec CONNECTED sur 17969 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*903 candidats sur 5193 portent les champs bruts (17%).*
...
- `e3baecf8377b` — 639 candidats
  - AVEC connectivite (258) : resistance **42.1%**
  - SANS connectivite (381) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 639 candidats
  - AVEC connectivite (258) : T0=13.08 T1=0.00 T2=3.10 — pondere **6.19**
  - SANS connectivite (381) : T0=15.98 T1=0.00 T2=2.61 — pondere **5.23**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
...
- TROP-CHER : 2337 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2320 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 15468 systemes
  - sans CONNECTED : 0.0% sur 3482 systemes
