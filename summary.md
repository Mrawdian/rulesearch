...
genere 2026-09-01 15:29 UTC — 286210 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 202866 systemes
...
- moteur actif `0caa9267db60` (242468 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 141467 | 70286 | 9588 | 4729 | 14373 | 11166 | 14944 | 14551 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 138628 | 32233 | 58610 | 59 | 19228 | 7179 | 62 | 21246 | 15.3% |
...
- candidats SANS connectivite : 21556, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15218 systemes avec CONNECTED sur 117918 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*31944 candidats sur 36234 portent les champs bruts (88%).*

- `5c556c16ea8b` — 25979 candidats
  - AVEC connectivite (10550) : resistance **41.1%**
  - SANS connectivite (15429) : resistance **21.4%**
...
- `5c556c16ea8b` — 25979 candidats
  ...
  - SANS connectivite (15429) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 15290 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15218 avec CONNECTED, 72 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 115417 systemes
