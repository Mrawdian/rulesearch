...
genere 2026-08-29 15:25 UTC — 187281 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 103937 systemes
...
- moteur actif `0caa9267db60` (143539 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 91506 | 45506 | 6220 | 3077 | 9209 | 7289 | 9631 | 9409 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 89660 | 20943 | 37837 | 43 | 12401 | 4598 | 36 | 13796 | 15.4% |
...
- candidats AVEC connectivite : 9536, dont T2 : 100%
- candidats SANS connectivite : 14106, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9905 systemes avec CONNECTED sur 77147 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*19352 candidats sur 23642 portent les champs bruts (82%).*

- `5c556c16ea8b` — 13387 candidats
  - AVEC connectivite (5408) : resistance **41.2%**
  - SANS connectivite (7979) : resistance **21.6%**
...
- `5c556c16ea8b` — 13387 candidats
  - AVEC connectivite (5408) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (7979) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.33**
...
- TROP-CHER : 9951 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 9905 avec CONNECTED, 46 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 74646 systemes
  - sans CONNECTED : 0.0% sur 16860 systemes
