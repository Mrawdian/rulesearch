...
genere 2026-08-28 14:38 UTC — 146233 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 62889 systemes
...
- moteur actif `0caa9267db60` (102491 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 70771 | 35160 | 4840 | 2403 | 7096 | 5648 | 7473 | 7248 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 69347 | 16094 | 29298 | 32 | 9604 | 3574 | 30 | 10712 | 15.4% |
...
- candidats AVEC connectivite : 7375, dont T2 : 100%
- candidats SANS connectivite : 11022, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7747 systemes avec CONNECTED sur 60227 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*14107 candidats sur 18397 portent les champs bruts (77%).*

- `5c556c16ea8b` — 8142 candidats
  - AVEC connectivite (3247) : resistance **41.2%**
  - SANS connectivite (4895) : resistance **21.8%**
...
- `5c556c16ea8b` — 8142 candidats
  - AVEC connectivite (3247) : T0=13.02 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (4895) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.36**
...
## cout
- temps total 45.2 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 7787 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7747 avec CONNECTED, 40 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 57726 systemes
  - sans CONNECTED : 0.0% sur 13045 systemes
