...
| connect | 4 | 3 | 18157 | 9074 | 1182 | 632 | 1802 | 1439 | 1973 | 1828 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 17778 | 4183 | 7503 | 12 | 2431 | 908 | 7 | 2734 | 15.4% |
...
- candidats AVEC connectivite : 1955, dont T2 : 100%
- candidats SANS connectivite : 3044, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2247 systemes avec CONNECTED sur 17330 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*709 candidats sur 4999 portent les champs bruts (14%).*
...
- `e3baecf8377b` — 445 candidats
  - AVEC connectivite (172) : resistance **43.5%**
  - SANS connectivite (273) : resistance **21.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 445 candidats
  - AVEC connectivite (172) : T0=12.99 T1=0.00 T2=3.17 — pondere **6.35**
  - SANS connectivite (273) : T0=16.10 T1=0.00 T2=2.68 — pondere **5.36**
...
**2 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0030).
...
- TROP-CHER : 2264 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2247 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14829 systemes
  - sans CONNECTED : 0.0% sur 3328 systemes
