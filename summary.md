...
genere 2026-09-07 12:29 UTC — 435693 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 352349 systemes
...
- moteur actif `0caa9267db60` (391951 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 216945 | 107783 | 14776 | 7219 | 21970 | 17007 | 23077 | 22357 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 212633 | 49509 | 89641 | 83 | 29639 | 10982 | 76 | 32685 | 15.4% |
...
- candidats SANS connectivite : 32995, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23351 systemes avec CONNECTED sur 179610 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*51189 candidats sur 55479 portent les champs bruts (92%).*

- `5c556c16ea8b` — 45224 candidats
  - AVEC connectivite (18356) : resistance **41.1%**
  - SANS connectivite (26868) : resistance **21.3%**
...
- `5c556c16ea8b` — 45224 candidats
  ...
  - SANS connectivite (26868) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 23437 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23351 avec CONNECTED, 86 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 177109 systemes
  - sans CONNECTED : 0.0% sur 39836 systemes
