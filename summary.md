...
genere 2026-09-04 07:49 UTC — 359562 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 276218 systemes
...
- moteur actif `0caa9267db60` (315820 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 178493 | 88714 | 12127 | 5968 | 18156 | 14066 | 18910 | 18280 | 10.2% |
...
- candidats AVEC connectivite : 18407, dont T2 : 100%
...
- **19184 systemes avec CONNECTED sur 148140 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*41308 candidats sur 45598 portent les champs bruts (91%).*

- `5c556c16ea8b` — 35343 candidats
  - AVEC connectivite (14279) : resistance **41.1%**
...
- `5c556c16ea8b` — 35343 candidats
  - AVEC connectivite (14279) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 19264 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19184 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 145639 systemes
  - sans CONNECTED : 0.0% sur 32854 systemes
