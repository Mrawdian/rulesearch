...
genere 2026-08-26 02:29 UTC — 18371 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 9397 systemes
...
| connect | 4 | 3 | 9223 | 4639 | 603 | 307 | 887 | 729 | 1003 | 944 | 10.2% |
...
- candidats AVEC connectivite : 947, dont T2 : 100%
...
- **1003 systemes avec CONNECTED sur 7639 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1188 candidats
  - AVEC connectivite (468) : T0=13.36 T1=0.00 T2=2.90 — pondere **5.81**
  - SANS connectivite (720) : T0=15.86 T1=0.00 T2=2.66 — pondere **5.33**
  - test de permutation : **p = 0.0115** — ecart significatif au seuil 0.05
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 7582 systemes
  - sans CONNECTED : 0.0% sur 1641 systemes
