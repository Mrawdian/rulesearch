...
genere 2026-08-28 06:11 UTC — 131544 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 48200 systemes
...
- moteur actif `0caa9267db60` (87802 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 63360 | 31494 | 4347 | 2149 | 6334 | 5051 | 6659 | 6509 | 10.3% |
...
- candidats AVEC connectivite : 6636, dont T2 : 100%
- candidats SANS connectivite : 9828, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6933 systemes avec CONNECTED sur 54189 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12174 candidats sur 16464 portent les champs bruts (74%).*

- `5c556c16ea8b` — 6209 candidats
  - AVEC connectivite (2508) : resistance **41.5%**
...
- `5c556c16ea8b` — 6209 candidats
  - AVEC connectivite (2508) : T0=12.97 T1=0.00 T2=3.02 — pondere **6.04**
...
- TROP-CHER : 6971 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6933 avec CONNECTED, 38 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 51688 systemes
  - sans CONNECTED : 0.0% sur 11672 systemes
