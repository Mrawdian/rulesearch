...
| connect | 4 | 3 | 18172 | 9081 | 1182 | 634 | 1805 | 1439 | 1975 | 1829 | 10.1% |
...
- candidats AVEC connectivite : 1956, dont T2 : 100%
- candidats SANS connectivite : 3044, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2249 systemes avec CONNECTED sur 17341 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*710 candidats sur 5000 portent les champs bruts (14%).*
...
- `e3baecf8377b` — 446 candidats
  - AVEC connectivite (173) : resistance **43.4%**
...
- `e3baecf8377b` — 446 candidats
  - AVEC connectivite (173) : T0=12.98 T1=0.00 T2=3.17 — pondere **6.34**
...
- TROP-CHER : 2266 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 2249 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14840 systemes
  - sans CONNECTED : 0.0% sur 3332 systemes
