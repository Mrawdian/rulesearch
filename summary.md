...
genere 2026-08-26 20:54 UTC — 63886 systemes evalues
...
- moteur actif `0caa9267db60` (20144 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 29201 | 14526 | 1993 | 976 | 2906 | 2314 | 3111 | 3001 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 28570 | 6591 | 12119 | 16 | 3971 | 1470 | 12 | 4391 | 15.4% |
...
- candidats AVEC connectivite : 3128, dont T2 : 100%
- candidats SANS connectivite : 4701, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3385 systemes avec CONNECTED sur 26388 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3539 candidats sur 7829 portent les champs bruts (45%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 670 candidats
  - AVEC connectivite (284) : resistance **40.2%**
  - SANS connectivite (386) : resistance **20.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 670 candidats
  - AVEC connectivite (284) : T0=12.81 T1=0.00 T2=2.87 — pondere **5.73**
  - SANS connectivite (386) : T0=16.13 T1=0.00 T2=2.69 — pondere **5.38**
  - test de permutation : **p = 0.1504** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e3baecf8377b` — 657 candidats
...
- TROP-CHER : 3407 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3385 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23887 systemes
  - sans CONNECTED : 0.0% sur 5314 systemes
