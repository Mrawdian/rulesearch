...
genere 2026-08-26 21:51 UTC — 66048 systemes evalues
...
- moteur actif `0caa9267db60` (22306 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 30293 | 15049 | 2070 | 1021 | 3032 | 2405 | 3225 | 3107 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 29640 | 6833 | 12598 | 16 | 4098 | 1531 | 13 | 4551 | 15.4% |
...
- candidats AVEC connectivite : 3234, dont T2 : 100%
- candidats SANS connectivite : 4861, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3499 systemes avec CONNECTED sur 27261 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3805 candidats sur 8095 portent les champs bruts (47%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 128 candidats
  - AVEC connectivite (54) : resistance **44.5%**
  - SANS connectivite (74) : resistance **22.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 128 candidats
  - AVEC connectivite (54) : T0=13.52 T1=0.00 T2=3.15 — pondere **6.30**
  - SANS connectivite (74) : T0=15.95 T1=0.00 T2=2.91 — pondere **5.81**
  - test de permutation : **p = 0.3983** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 3522 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3499 avec CONNECTED, 23 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24760 systemes
  - sans CONNECTED : 0.0% sur 5533 systemes
