...
genere 2026-08-26 12:30 UTC — 44003 systemes evalues
...
| connect | 4 | 3 | 19143 | 9551 | 1252 | 665 | 1908 | 1522 | 2070 | 1939 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 18745 | 4397 | 7901 | 13 | 2582 | 975 | 7 | 2870 | 15.3% |
...
- candidats AVEC connectivite : 2066, dont T2 : 100%
- candidats SANS connectivite : 3180, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2344 systemes avec CONNECTED sur 18132 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*956 candidats sur 5246 portent les champs bruts (18%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `e40600351a72` — 35 candidats
  - AVEC connectivite (15) : resistance **39.9%**
  - SANS connectivite (20) : resistance **18.9%**
...
- `e40600351a72` — 35 candidats
  - AVEC connectivite (15) : T0=14.33 T1=0.00 T2=3.20 — pondere **6.40**
  - SANS connectivite (20) : T0=17.50 T1=0.00 T2=2.60 — pondere **5.20**
  - *groupes trop petits (< 20) — aucun test, aucune conclusion*
...
- TROP-CHER : 2361 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2344 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 15631 systemes
  - sans CONNECTED : 0.0% sur 3512 systemes
