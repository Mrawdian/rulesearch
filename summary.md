...
genere 2026-09-07 18:49 UTC — 441557 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 358213 systemes
...
- moteur actif `0caa9267db60` (397815 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 219915 | 109238 | 15004 | 7324 | 22264 | 17224 | 23396 | 22669 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 215527 | 50191 | 90835 | 85 | 30031 | 11140 | 77 | 33150 | 15.4% |
...
- candidats AVEC connectivite : 22796, dont T2 : 100%
- candidats SANS connectivite : 33460, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23670 systemes avec CONNECTED sur 182060 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*51966 candidats sur 56256 portent les champs bruts (92%).*

- `5c556c16ea8b` — 46001 candidats
  - AVEC connectivite (18668) : resistance **41.1%**
  - SANS connectivite (27333) : resistance **21.3%**
...
- `5c556c16ea8b` — 46001 candidats
  - AVEC connectivite (18668) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (27333) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 23757 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23670 avec CONNECTED, 87 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 179559 systemes
  - sans CONNECTED : 0.0% sur 40356 systemes
