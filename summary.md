...
genere 2026-09-04 10:21 UTC — 362273 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 278929 systemes
...
- moteur actif `0caa9267db60` (318531 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 179863 | 89384 | 12223 | 6014 | 18306 | 14180 | 19052 | 18407 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 176295 | 40939 | 74497 | 72 | 24487 | 9135 | 70 | 27081 | 15.4% |
...
- candidats AVEC connectivite : 18534, dont T2 : 100%
- candidats SANS connectivite : 27391, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19326 systemes avec CONNECTED sur 149227 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*41635 candidats sur 45925 portent les champs bruts (91%).*

- `5c556c16ea8b` — 35670 candidats
  - AVEC connectivite (14406) : resistance **41.0%**
  - SANS connectivite (21264) : resistance **21.2%**
...
- `5c556c16ea8b` — 35670 candidats
  - AVEC connectivite (14406) : T0=13.03 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (21264) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 19406 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19326 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 146726 systemes
  - sans CONNECTED : 0.0% sur 33137 systemes
