...
genere 2026-08-27 22:03 UTC — 116104 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 32760 systemes
...
- moteur actif `0caa9267db60` (72362 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 55560 | 27680 | 3842 | 1889 | 5497 | 4397 | 5869 | 5668 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 54429 | 12552 | 23117 | 26 | 7549 | 2819 | 25 | 8339 | 15.3% |
...
- candidats AVEC connectivite : 5795, dont T2 : 100%
- candidats SANS connectivite : 8649, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6143 systemes avec CONNECTED sur 47893 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10154 candidats sur 14444 portent les champs bruts (70%).*

- `5c556c16ea8b` — 4189 candidats
  - AVEC connectivite (1667) : resistance **42.0%**
  - SANS connectivite (2522) : resistance **22.6%**
...
- `5c556c16ea8b` — 4189 candidats
  - AVEC connectivite (1667) : T0=12.93 T1=0.00 T2=3.05 — pondere **6.11**
  - SANS connectivite (2522) : T0=15.79 T1=0.00 T2=2.72 — pondere **5.44**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 45392 systemes
  - sans CONNECTED : 0.0% sur 10168 systemes
