...
genere 2026-09-02 08:48 UTC — 306860 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 223516 systemes
...
- moteur actif `0caa9267db60` (263118 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 151887 | 75461 | 10331 | 5089 | 15432 | 11949 | 16084 | 15598 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 148858 | 34667 | 62945 | 63 | 20600 | 7687 | 63 | 22821 | 15.3% |
...
- candidats AVEC connectivite : 15725, dont T2 : 100%
- candidats SANS connectivite : 23131, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16358 systemes avec CONNECTED sur 126492 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*34566 candidats sur 38856 portent les champs bruts (89%).*

- `5c556c16ea8b` — 28601 candidats
  - AVEC connectivite (11597) : resistance **41.1%**
  - SANS connectivite (17004) : resistance **21.3%**
...
- `5c556c16ea8b` — 28601 candidats
  - AVEC connectivite (11597) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (17004) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
## cout
- temps total 95.2 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 16431 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16358 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 123991 systemes
  - sans CONNECTED : 0.0% sur 27896 systemes
