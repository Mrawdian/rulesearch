...
genere 2026-08-28 06:36 UTC — 132313 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 48969 systemes
...
- moteur actif `0caa9267db60` (88571 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 63747 | 31676 | 4380 | 2166 | 6379 | 5074 | 6698 | 6553 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 62451 | 14445 | 26452 | 29 | 8695 | 3226 | 28 | 9574 | 15.3% |
...
- candidats AVEC connectivite : 6680, dont T2 : 100%
- candidats SANS connectivite : 9884, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6972 systemes avec CONNECTED sur 54505 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12274 candidats sur 16564 portent les champs bruts (74%).*

- `5c556c16ea8b` — 6309 candidats
  - AVEC connectivite (2552) : resistance **41.5%**
  - SANS connectivite (3757) : resistance **22.0%**
...
- `5c556c16ea8b` — 6309 candidats
  - AVEC connectivite (2552) : T0=12.97 T1=0.00 T2=3.01 — pondere **6.03**
  - SANS connectivite (3757) : T0=15.86 T1=0.00 T2=2.69 — pondere **5.38**
...
- TROP-CHER : 7010 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6972 avec CONNECTED, 38 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 52004 systemes
  - sans CONNECTED : 0.0% sur 11743 systemes
