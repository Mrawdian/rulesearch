...
genere 2026-08-29 11:47 UTC — 181658 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 98314 systemes
...
- moteur actif `0caa9267db60` (137916 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 88668 | 44065 | 6033 | 3000 | 8918 | 7078 | 9321 | 9124 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 86875 | 20297 | 36693 | 42 | 11994 | 4449 | 35 | 13359 | 15.4% |
...
- candidats AVEC connectivite : 9251, dont T2 : 100%
- candidats SANS connectivite : 13669, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9595 systemes avec CONNECTED sur 74826 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*18630 candidats sur 22920 portent les champs bruts (81%).*

- `5c556c16ea8b` — 12665 candidats
  - AVEC connectivite (5123) : resistance **41.2%**
  - SANS connectivite (7542) : resistance **21.5%**
...
- `5c556c16ea8b` — 12665 candidats
  - AVEC connectivite (5123) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (7542) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 9640 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 9595 avec CONNECTED, 45 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 72325 systemes
  - sans CONNECTED : 0.0% sur 16343 systemes
