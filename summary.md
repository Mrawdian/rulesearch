...
genere 2026-08-28 06:07 UTC — 131413 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 48069 systemes
...
- moteur actif `0caa9267db60` (87671 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 63286 | 31461 | 4342 | 2145 | 6326 | 5045 | 6652 | 6499 | 10.3% |
...
- candidats AVEC connectivite : 6626, dont T2 : 100%
- candidats SANS connectivite : 9821, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6926 systemes avec CONNECTED sur 54129 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12157 candidats sur 16447 portent les champs bruts (74%).*

- `5c556c16ea8b` — 6192 candidats
  - AVEC connectivite (2498) : resistance **41.5%**
...
- `5c556c16ea8b` — 6192 candidats
  - AVEC connectivite (2498) : T0=12.97 T1=0.00 T2=3.02 — pondere **6.04**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 51628 systemes
  - sans CONNECTED : 0.0% sur 11658 systemes
