...
genere 2026-08-28 01:45 UTC — 123409 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 40065 systemes
...
- moteur actif `0caa9267db60` (79667 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 59246 | 29496 | 4093 | 2005 | 5891 | 4695 | 6230 | 6075 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 58048 | 13418 | 24615 | 28 | 8067 | 3004 | 26 | 8888 | 15.3% |
...
- candidats SANS connectivite : 9198, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6504 systemes avec CONNECTED sur 50866 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11110 candidats sur 15400 portent les champs bruts (72%).*

- `5c556c16ea8b` — 5145 candidats
  - AVEC connectivite (2074) : resistance **41.9%**
  - SANS connectivite (3071) : resistance **22.3%**
...
- `5c556c16ea8b` — 5145 candidats
  ...
  - SANS connectivite (3071) : T0=15.84 T1=0.00 T2=2.71 — pondere **5.42**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 48365 systemes
