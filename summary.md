...
genere 2026-08-31 09:58 UTC — 248396 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 165052 systemes
...
- moteur actif `0caa9267db60` (204654 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 122380 | 60870 | 8295 | 4098 | 12315 | 9669 | 12931 | 12611 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 119901 | 27990 | 50610 | 53 | 16580 | 6199 | 54 | 18405 | 15.4% |
...
- candidats SANS connectivite : 18715, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13205 systemes avec CONNECTED sur 102404 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*27163 candidats sur 31453 portent les champs bruts (86%).*

- `5c556c16ea8b` — 21198 candidats
  - AVEC connectivite (8610) : resistance **41.0%**
  - SANS connectivite (12588) : resistance **21.3%**
...
- `5c556c16ea8b` — 21198 candidats
  ...
  - SANS connectivite (12588) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 99903 systemes
  - sans CONNECTED : 0.0% sur 22477 systemes
