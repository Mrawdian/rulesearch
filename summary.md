...
genere 2026-08-26 14:03 UTC — 48006 systemes evalues
...
- moteur actif `0caa9267db60` (4264 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21171 | 10563 | 1406 | 729 | 2099 | 1683 | 2264 | 2162 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20720 | 4835 | 8743 | 13 | 2876 | 1074 | 7 | 3172 | 15.3% |
...
- candidats AVEC connectivite : 2289, dont T2 : 100%
- candidats SANS connectivite : 3482, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2538 systemes avec CONNECTED sur 19793 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1481 candidats sur 5771 portent les champs bruts (26%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 366 candidats
  - AVEC connectivite (151) : resistance **39.3%**
  - SANS connectivite (215) : resistance **21.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 366 candidats
  - AVEC connectivite (151) : T0=13.39 T1=0.00 T2=2.90 — pondere **5.80**
  - SANS connectivite (215) : T0=16.11 T1=0.00 T2=2.70 — pondere **5.40**
...
- TROP-CHER : 2555 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2538 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17292 systemes
  - sans CONNECTED : 0.0% sur 3879 systemes
