...
genere 2026-09-02 13:11 UTC — 311987 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 228643 systemes
...
- moteur actif `0caa9267db60` (268245 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 154468 | 76742 | 10506 | 5168 | 15703 | 12159 | 16354 | 15858 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 151404 | 35253 | 64038 | 64 | 20937 | 7824 | 63 | 23213 | 15.3% |
...
- candidats AVEC connectivite : 15985, dont T2 : 100%
- candidats SANS connectivite : 23523, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16628 systemes avec CONNECTED sur 128590 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*35218 candidats sur 39508 portent les champs bruts (89%).*

- `5c556c16ea8b` — 29253 candidats
  - AVEC connectivite (11857) : resistance **41.1%**
  - SANS connectivite (17396) : resistance **21.3%**
...
- `5c556c16ea8b` — 29253 candidats
  - AVEC connectivite (11857) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (17396) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 126089 systemes
  - sans CONNECTED : 0.0% sur 28379 systemes
