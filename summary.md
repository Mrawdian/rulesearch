...
genere 2026-08-28 08:09 UTC — 135120 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 51776 systemes
...
- moteur actif `0caa9267db60` (91378 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 65170 | 32365 | 4478 | 2214 | 6530 | 5199 | 6847 | 6697 | 10.3% |
...
- candidats AVEC connectivite : 6824, dont T2 : 100%
...
- **7121 systemes avec CONNECTED sur 55662 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12655 candidats sur 16945 portent les champs bruts (75%).*

- `5c556c16ea8b` — 6690 candidats
  - AVEC connectivite (2696) : resistance **41.4%**
...
- `5c556c16ea8b` — 6690 candidats
  - AVEC connectivite (2696) : T0=12.98 T1=0.00 T2=3.02 — pondere **6.04**
...
- TROP-CHER : 7159 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7121 avec CONNECTED, 38 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 53161 systemes
  - sans CONNECTED : 0.0% sur 12009 systemes
