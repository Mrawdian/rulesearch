...
genere 2026-09-10 09:12 UTC — 496279 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 412935 systemes
...
- moteur actif `0caa9267db60` (452537 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 247536 | 122877 | 16867 | 8324 | 25039 | 19423 | 26399 | 25469 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 242628 | 56580 | 102212 | 97 | 33763 | 12508 | 87 | 37360 | 15.4% |
...
- candidats AVEC connectivite : 25596, dont T2 : 100%
- candidats SANS connectivite : 37670, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **26673 systemes avec CONNECTED sur 204615 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*58976 candidats sur 63266 portent les champs bruts (93%).*

- `5c556c16ea8b` — 53011 candidats
  - AVEC connectivite (21468) : resistance **41.2%**
  - SANS connectivite (31543) : resistance **21.3%**
...
- `5c556c16ea8b` — 53011 candidats
  - AVEC connectivite (21468) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (31543) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 202114 systemes
  - sans CONNECTED : 0.0% sur 45422 systemes
