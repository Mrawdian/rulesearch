...
genere 2026-09-03 18:38 UTC — 345089 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 261745 systemes
...
- moteur actif `0caa9267db60` (301347 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 171189 | 85087 | 11611 | 5736 | 17420 | 13509 | 18155 | 17492 | 10.2% |
...
- candidats AVEC connectivite : 17619, dont T2 : 100%
...
- **18429 systemes avec CONNECTED sur 142175 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39393 candidats sur 43683 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33428 candidats
  - AVEC connectivite (13491) : resistance **41.0%**
...
- `5c556c16ea8b` — 33428 candidats
  - AVEC connectivite (13491) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 18505 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18429 avec CONNECTED, 76 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 139674 systemes
  - sans CONNECTED : 0.0% sur 31515 systemes
