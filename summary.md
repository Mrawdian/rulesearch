...
genere 2026-09-03 18:16 UTC — 344722 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 261378 systemes
...
- moteur actif `0caa9267db60` (300980 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 170995 | 85003 | 11599 | 5729 | 17398 | 13490 | 18131 | 17468 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 167612 | 38988 | 70839 | 67 | 23246 | 8667 | 66 | 25727 | 15.3% |
...
- candidats AVEC connectivite : 17595, dont T2 : 100%
- candidats SANS connectivite : 26037, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18405 systemes avec CONNECTED sur 142021 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39342 candidats sur 43632 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33377 candidats
  - AVEC connectivite (13467) : resistance **41.0%**
  - SANS connectivite (19910) : resistance **21.2%**
...
- `5c556c16ea8b` — 33377 candidats
  - AVEC connectivite (13467) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (19910) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 139520 systemes
  - sans CONNECTED : 0.0% sur 31475 systemes
