...
| connect | 4 | 3 | 18501 | 9238 | 1199 | 641 | 1847 | 1474 | 2007 | 1865 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 18117 | 4267 | 7635 | 13 | 2480 | 935 | 7 | 2780 | 15.3% |
...
- candidats AVEC connectivite : 1992, dont T2 : 100%
- candidats SANS connectivite : 3090, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2281 systemes avec CONNECTED sur 17602 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*792 candidats sur 5082 portent les champs bruts (16%).*
...
- `e3baecf8377b` — 528 candidats
  - AVEC connectivite (209) : resistance **42.4%**
  - SANS connectivite (319) : resistance **21.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 528 candidats
  - AVEC connectivite (209) : T0=13.04 T1=0.00 T2=3.10 — pondere **6.19**
  - SANS connectivite (319) : T0=16.06 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 2298 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 2281 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 15101 systemes
  - sans CONNECTED : 0.0% sur 3400 systemes
