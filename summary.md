...
genere 2026-08-26 19:46 UTC — 61408 systemes evalues
...
- moteur actif `0caa9267db60` (17666 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27944 | 13925 | 1912 | 942 | 2763 | 2214 | 2972 | 2866 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 27349 | 6319 | 11576 | 15 | 3808 | 1410 | 11 | 4210 | 15.4% |
...
- candidats AVEC connectivite : 2993, dont T2 : 100%
- candidats SANS connectivite : 4520, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3246 systemes avec CONNECTED sur 25374 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3223 candidats sur 7513 portent les champs bruts (43%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 354 candidats
  - AVEC connectivite (149) : resistance **39.1%**
  - SANS connectivite (205) : resistance **19.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 354 candidats
  - AVEC connectivite (149) : T0=13.07 T1=0.00 T2=2.85 — pondere **5.70**
  - SANS connectivite (205) : T0=16.07 T1=0.00 T2=2.65 — pondere **5.30**
  - test de permutation : **p = 0.2339** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- TROP-CHER : 3267 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3246 avec CONNECTED, 21 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22873 systemes
  - sans CONNECTED : 0.0% sur 5071 systemes
