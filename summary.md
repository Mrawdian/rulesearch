...
genere 2026-08-27 06:28 UTC — 84958 systemes evalues
...
- moteur actif `0caa9267db60` (41216 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 39839 | 19842 | 2728 | 1356 | 3965 | 3134 | 4212 | 4089 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 39004 | 8985 | 16597 | 22 | 5406 | 2036 | 21 | 5937 | 15.2% |
...
- candidats AVEC connectivite : 4216, dont T2 : 100%
- candidats SANS connectivite : 6247, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4486 systemes avec CONNECTED sur 35080 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6173 candidats sur 10463 portent les champs bruts (59%).*
...
- `23303c299f39` — 225 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 208 candidats
  - AVEC connectivite (88) : resistance **43.1%**
  - SANS connectivite (120) : resistance **21.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 208 candidats
  - AVEC connectivite (88) : T0=12.73 T1=0.00 T2=3.12 — pondere **6.25**
  - SANS connectivite (120) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.32**
...
**7 serie(s) reproductible(s) sur 14 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `ab89a63b01ef` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0060), `5c556c16ea8b` (p=0.0270), `b71bb0907fb5` (p=0.0110).
...
- TROP-CHER : 4517 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4486 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 32579 systemes
  - sans CONNECTED : 0.0% sur 7260 systemes
