...
genere 2026-08-26 20:55 UTC — 63929 systemes evalues
...
- moteur actif `0caa9267db60` (20187 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 29216 | 14534 | 1993 | 976 | 2910 | 2315 | 3112 | 3002 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 28598 | 6597 | 12131 | 16 | 3974 | 1471 | 12 | 4397 | 15.4% |
...
- candidats AVEC connectivite : 3129, dont T2 : 100%
- candidats SANS connectivite : 4707, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3386 systemes avec CONNECTED sur 26399 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3546 candidats sur 7836 portent les champs bruts (45%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 677 candidats
  - AVEC connectivite (285) : resistance **40.2%**
  - SANS connectivite (392) : resistance **20.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 677 candidats
  - AVEC connectivite (285) : T0=12.81 T1=0.00 T2=2.86 — pondere **5.72**
  - SANS connectivite (392) : T0=16.11 T1=0.00 T2=2.68 — pondere **5.37**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23898 systemes
  - sans CONNECTED : 0.0% sur 5318 systemes
