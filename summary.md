...
genere 2026-08-31 23:44 UTC — 266489 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 183145 systemes
...
- moteur actif `0caa9267db60` (222747 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 131519 | 65373 | 8877 | 4422 | 13325 | 10397 | 13881 | 13535 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 128855 | 30032 | 54435 | 56 | 17846 | 6673 | 57 | 19746 | 15.3% |
...
- candidats AVEC connectivite : 13662, dont T2 : 100%
- candidats SANS connectivite : 20056, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14155 systemes avec CONNECTED sur 109819 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*29428 candidats sur 33718 portent les champs bruts (87%).*

- `5c556c16ea8b` — 23463 candidats
  - AVEC connectivite (9534) : resistance **41.0%**
  - SANS connectivite (13929) : resistance **21.3%**
...
- `5c556c16ea8b` — 23463 candidats
  - AVEC connectivite (9534) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (13929) : T0=15.93 T1=0.00 T2=2.66 — pondere **5.31**
...
## cout
- temps total 82.4 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 14222 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14155 avec CONNECTED, 67 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 107318 systemes
  - sans CONNECTED : 0.0% sur 24201 systemes
