...
genere 2026-08-26 09:34 UTC — 36466 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 27492 systemes
...
| connect | 4 | 3 | 15793 | 7876 | 1032 | 541 | 1564 | 1260 | 1725 | 1594 | 10.1% |
| d4 | 4 | 4 | 5092 | 2342 | 1299 | 26 | 362 | 336 | 245 | 357 | 7.0% |
| ref | 4 | 3 | 15457 | 3628 | 6521 | 11 | 2123 | 782 | 6 | 2386 | 15.4% |
...
- candidats SANS connectivite : 2649, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1961 systemes avec CONNECTED sur 15052 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*54 candidats sur 4344 portent les champs bruts (1%).*

- `89c65c03c4ad` — 54 candidats
  - AVEC connectivite (18) : resistance **56.7%**
  - SANS connectivite (36) : resistance **22.9%**
...
- `89c65c03c4ad` — 3179 candidats
  - AVEC connectivite (1216) : T0=13.10 T1=0.00 T2=2.95 — pondere **5.90**
  - SANS connectivite (1963) : T0=15.86 T1=0.02 T2=2.66 — pondere **5.34**
...
- TROP-CHER : 1976 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 1961 avec CONNECTED, 15 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.4% sur 12913 systemes
  - sans CONNECTED : 0.0% sur 2880 systemes
