...
genere 2026-08-27 05:43 UTC — 83462 systemes evalues
...
- moteur actif `0caa9267db60` (39720 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 39077 | 19455 | 2687 | 1336 | 3882 | 3079 | 4122 | 4009 | 10.3% |
...
- candidats AVEC connectivite : 4136, dont T2 : 100%
- candidats SANS connectivite : 6133, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4396 systemes avec CONNECTED sur 34463 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5979 candidats sur 10269 portent les champs bruts (58%).*
...
- TROP-CHER : 4427 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4396 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 31962 systemes
  - sans CONNECTED : 0.0% sur 7115 systemes
