...
genere 2026-09-01 13:30 UTC — 283870 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 200526 systemes
...
- moteur actif `0caa9267db60` (240128 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 140276 | 69734 | 9490 | 4691 | 14250 | 11065 | 14808 | 14425 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 137479 | 31994 | 58119 | 59 | 19079 | 7119 | 61 | 21037 | 15.3% |
...
- candidats AVEC connectivite : 14552, dont T2 : 100%
- candidats SANS connectivite : 21347, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15082 systemes avec CONNECTED sur 116957 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*31609 candidats sur 35899 portent les champs bruts (88%).*

- `5c556c16ea8b` — 25644 candidats
  - AVEC connectivite (10424) : resistance **41.0%**
  - SANS connectivite (15220) : resistance **21.4%**
...
- `5c556c16ea8b` — 25644 candidats
  - AVEC connectivite (10424) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (15220) : T0=15.93 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 15153 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15082 avec CONNECTED, 71 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 114456 systemes
  - sans CONNECTED : 0.0% sur 25820 systemes
