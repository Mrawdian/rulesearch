...
genere 2026-08-29 09:40 UTC — 178496 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 95152 systemes
...
- moteur actif `0caa9267db60` (134754 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 87068 | 43300 | 5925 | 2952 | 8742 | 6929 | 9131 | 8982 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 85313 | 19932 | 36051 | 39 | 11770 | 4346 | 35 | 13134 | 15.4% |
...
- candidats SANS connectivite : 13444, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9405 systemes avec CONNECTED sur 73546 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*18263 candidats sur 22553 portent les champs bruts (81%).*

- `5c556c16ea8b` — 12298 candidats
  - AVEC connectivite (4981) : resistance **41.2%**
  - SANS connectivite (7317) : resistance **21.6%**
...
- `5c556c16ea8b` — 12298 candidats
  ...
  - SANS connectivite (7317) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.33**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 71045 systemes
  - sans CONNECTED : 0.0% sur 16023 systemes
