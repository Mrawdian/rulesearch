...
genere 2026-08-25 22:32 UTC — 8563 systemes evalues
...
| connect | 4 | 3 | 4273 | 2154 | 275 | 149 | 409 | 334 | 444 | 458 | 10.7% |
...
- candidats AVEC connectivite : 461, dont T2 : 100%
...
- **444 systemes avec CONNECTED sur 3570 (12.4%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- TROP-CHER : 446 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 444 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.6% sur 3513 systemes
  - sans CONNECTED : 0.0% sur 760 systemes
