...
**7466 enregistrements (74%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 5064 | 2539 | 320 | 181 | 492 | 413 | 527 | 534 | 10.5% |
| ref | 4 | 3 | 4941 | 1199 | 2072 | 1 | 652 | 238 | 2 | 777 | 15.7% |
...
- candidats AVEC connectivite : 537, dont T2 : 100%
- candidats SANS connectivite : 781, dont T2 : 100%
...
- **527 systemes avec CONNECTED sur 4198 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 153 candidats
  - AVEC connectivite (58) : T0=13.02 T1=0.00 T2=2.95 — pondere **5.90**
  - SANS connectivite (95) : T0=16.22 T1=0.00 T2=2.83 — pondere **5.66**
...
- TROP-CHER : 529 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 527 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 4141 systemes
  - sans CONNECTED : 0.0% sur 923 systemes
