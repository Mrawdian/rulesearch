...
genere 2026-08-27 21:21 UTC — 114628 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 31284 systemes
...
- moteur actif `0caa9267db60` (70886 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 54812 | 27302 | 3790 | 1856 | 5413 | 4339 | 5802 | 5597 | 10.2% |
...
- candidats AVEC connectivite : 5724, dont T2 : 100%
- candidats SANS connectivite : 8525, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6076 systemes avec CONNECTED sur 47292 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*9959 candidats sur 14249 portent les champs bruts (70%).*

- `5c556c16ea8b` — 3994 candidats
  - AVEC connectivite (1596) : resistance **42.1%**
...
- `5c556c16ea8b` — 3994 candidats
  - AVEC connectivite (1596) : T0=12.93 T1=0.00 T2=3.06 — pondere **6.12**
...
- TROP-CHER : 6111 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6076 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 44791 systemes
  - sans CONNECTED : 0.0% sur 10021 systemes
