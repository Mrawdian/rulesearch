...
genere 2026-08-28 15:33 UTC — 147767 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 64423 systemes
...
- moteur actif `0caa9267db60` (104025 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 71548 | 35529 | 4887 | 2440 | 7179 | 5697 | 7559 | 7342 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 70104 | 16277 | 29630 | 32 | 9699 | 3614 | 31 | 10818 | 15.4% |
...
- candidats AVEC connectivite : 7469, dont T2 : 100%
- candidats SANS connectivite : 11128, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7833 systemes avec CONNECTED sur 60868 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*14307 candidats sur 18597 portent les champs bruts (77%).*

- `5c556c16ea8b` — 8342 candidats
  - AVEC connectivite (3341) : resistance **41.2%**
  - SANS connectivite (5001) : resistance **21.8%**
...
- `5c556c16ea8b` — 8342 candidats
  - AVEC connectivite (3341) : T0=13.02 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (5001) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.37**
...
## cout
- temps total 45.7 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 7874 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7833 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 58367 systemes
  - sans CONNECTED : 0.0% sur 13181 systemes
