...
| connect | 4 | 3 | 17200 | 8601 | 1111 | 595 | 1705 | 1368 | 1871 | 1733 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 16851 | 3970 | 7135 | 11 | 2301 | 854 | 7 | 2573 | 15.3% |
...
- candidats AVEC connectivite : 1860, dont T2 : 100%
- candidats SANS connectivite : 2883, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2145 systemes avec CONNECTED sur 16552 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*453 candidats sur 4743 portent les champs bruts (10%).*
...
- `e3baecf8377b` — 189 candidats
  - AVEC connectivite (77) : resistance **42.6%**
  - SANS connectivite (112) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 189 candidats
  - AVEC connectivite (77) : T0=13.17 T1=0.00 T2=3.14 — pondere **6.29**
  - SANS connectivite (112) : T0=15.91 T1=0.00 T2=2.59 — pondere **5.18**
...
- TROP-CHER : 2162 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2145 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14051 systemes
  - sans CONNECTED : 0.0% sur 3149 systemes
