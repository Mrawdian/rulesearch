...
genere 2026-09-07 10:15 UTC — 433639 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 350295 systemes
...
- moteur actif `0caa9267db60` (389897 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 215913 | 107253 | 14697 | 7194 | 21872 | 16935 | 22958 | 22257 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 211611 | 49254 | 89218 | 82 | 29486 | 10944 | 76 | 32533 | 15.4% |
...
- candidats AVEC connectivite : 22384, dont T2 : 100%
- candidats SANS connectivite : 32843, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23232 systemes avec CONNECTED sur 178765 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*50937 candidats sur 55227 portent les champs bruts (92%).*

- `5c556c16ea8b` — 44972 candidats
  - AVEC connectivite (18256) : resistance **41.1%**
  - SANS connectivite (26716) : resistance **21.3%**
...
- `5c556c16ea8b` — 44972 candidats
  - AVEC connectivite (18256) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (26716) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
## cout
- temps total 135.0 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 23318 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23232 avec CONNECTED, 86 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 176264 systemes
  - sans CONNECTED : 0.0% sur 39649 systemes
