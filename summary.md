...
genere 2026-08-27 02:43 UTC — 76684 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 11777 systemes
...
- moteur actif `0caa9267db60` (32942 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 35663 | 17748 | 2448 | 1209 | 3538 | 2825 | 3793 | 3640 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 34906 | 8042 | 14850 | 20 | 4826 | 1825 | 19 | 5324 | 15.3% |
...
- candidats AVEC connectivite : 3767, dont T2 : 100%
- candidats SANS connectivite : 5634, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4067 systemes avec CONNECTED sur 31689 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5111 candidats sur 9401 portent les champs bruts (54%).*
...
- `ab89a63b01ef` — 1434 candidats
  - AVEC connectivite (587) : resistance **41.2%**
  - SANS connectivite (847) : resistance **22.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1434 candidats
  - AVEC connectivite (587) : T0=12.98 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (847) : T0=15.93 T1=0.00 T2=2.70 — pondere **5.40**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- TROP-CHER : 4096 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4067 avec CONNECTED, 29 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 29188 systemes
  - sans CONNECTED : 0.0% sur 6475 systemes
