...
- moteur actif `0caa9267db60` (7640 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22878 | 11403 | 1543 | 776 | 2279 | 1816 | 2449 | 2324 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 22389 | 5186 | 9442 | 14 | 3134 | 1144 | 10 | 3459 | 15.4% |
...
- candidats AVEC connectivite : 2451, dont T2 : 100%
- candidats SANS connectivite : 3769, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2723 systemes avec CONNECTED sur 21175 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1930 candidats sur 6220 portent les champs bruts (31%).*
...
- `06fe04a859f1` — 815 candidats
  - AVEC connectivite (313) : resistance **41.2%**
  - SANS connectivite (502) : resistance **20.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 815 candidats
  - AVEC connectivite (313) : T0=13.31 T1=0.00 T2=3.03 — pondere **6.06**
  - SANS connectivite (502) : T0=16.00 T1=0.00 T2=2.62 — pondere **5.23**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e3baecf8377b` — 657 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18674 systemes
  - sans CONNECTED : 0.0% sur 4204 systemes
