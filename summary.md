...
| connect | 4 | 3 | 18142 | 9068 | 1179 | 632 | 1800 | 1438 | 1971 | 1827 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 17749 | 4175 | 7494 | 12 | 2427 | 905 | 7 | 2729 | 15.4% |
...
- candidats AVEC connectivite : 1954, dont T2 : 100%
- candidats SANS connectivite : 3039, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2245 systemes avec CONNECTED sur 17318 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*703 candidats sur 4993 portent les champs bruts (14%).*
...
- `e3baecf8377b` — 439 candidats
  - AVEC connectivite (171) : resistance **43.6%**
  - SANS connectivite (268) : resistance **21.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 439 candidats
  - AVEC connectivite (171) : T0=12.98 T1=0.00 T2=3.19 — pondere **6.37**
  - SANS connectivite (268) : T0=16.08 T1=0.00 T2=2.67 — pondere **5.34**
...
- TROP-CHER : 2262 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2245 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14817 systemes
  - sans CONNECTED : 0.0% sur 3325 systemes
