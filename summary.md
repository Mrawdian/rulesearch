...
genere 2026-08-26 16:22 UTC — 53489 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 8306 systemes
...
- moteur actif `0caa9267db60` (9747 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23939 | 11943 | 1630 | 813 | 2376 | 1889 | 2557 | 2431 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 23435 | 5420 | 9903 | 14 | 3282 | 1195 | 10 | 3611 | 15.4% |
...
- candidats AVEC connectivite : 2558, dont T2 : 100%
- candidats SANS connectivite : 3921, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2831 systemes avec CONNECTED sur 22055 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2189 candidats sur 6479 portent les champs bruts (34%).*
...
- `06fe04a859f1` — 1074 candidats
  - AVEC connectivite (420) : resistance **40.9%**
  - SANS connectivite (654) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1074 candidats
  - AVEC connectivite (420) : T0=13.16 T1=0.00 T2=3.02 — pondere **6.05**
  - SANS connectivite (654) : T0=15.98 T1=0.00 T2=2.65 — pondere **5.29**
...
## cout
- temps total 16.6 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2851 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2831 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19554 systemes
  - sans CONNECTED : 0.0% sur 4385 systemes
