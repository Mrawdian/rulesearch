...
genere 2026-09-08 11:31 UTC — 456596 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 373252 systemes
...
- moteur actif `0caa9267db60` (412854 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 227509 | 112999 | 15476 | 7612 | 23015 | 17828 | 24245 | 23436 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 222972 | 51924 | 93982 | 88 | 31070 | 11530 | 81 | 34279 | 15.4% |
...
- candidats SANS connectivite : 34589, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **24519 systemes avec CONNECTED sur 188287 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*53862 candidats sur 58152 portent les champs bruts (93%).*

- `5c556c16ea8b` — 47897 candidats
  - AVEC connectivite (19435) : resistance **41.2%**
  - SANS connectivite (28462) : resistance **21.3%**
...
- `5c556c16ea8b` — 47897 candidats
  ...
  - SANS connectivite (28462) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 24610 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 24519 avec CONNECTED, 91 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 185786 systemes
  - sans CONNECTED : 0.0% sur 41723 systemes
