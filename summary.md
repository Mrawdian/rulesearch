...
genere 2026-09-03 18:13 UTC — 344662 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 261318 systemes
...
- moteur actif `0caa9267db60` (300920 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 170965 | 84990 | 11599 | 5727 | 17392 | 13490 | 18127 | 17463 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 167582 | 38981 | 70827 | 67 | 23243 | 8664 | 66 | 25722 | 15.3% |
...
- candidats AVEC connectivite : 17590, dont T2 : 100%
- candidats SANS connectivite : 26032, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18401 systemes avec CONNECTED sur 141994 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39332 candidats sur 43622 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33367 candidats
  - AVEC connectivite (13462) : resistance **41.0%**
  - SANS connectivite (19905) : resistance **21.2%**
...
- `5c556c16ea8b` — 33367 candidats
  - AVEC connectivite (13462) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (19905) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 18477 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18401 avec CONNECTED, 76 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 139493 systemes
  - sans CONNECTED : 0.0% sur 31472 systemes
