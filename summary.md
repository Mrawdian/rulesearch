...
genere 2026-08-30 11:43 UTC — 217339 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 133995 systemes
...
- moteur actif `0caa9267db60` (173597 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 106700 | 52994 | 7273 | 3562 | 10748 | 8477 | 11294 | 10963 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 104524 | 24381 | 44142 | 49 | 14423 | 5403 | 41 | 16076 | 15.4% |
...
- candidats AVEC connectivite : 11090, dont T2 : 100%
- candidats SANS connectivite : 16386, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11568 systemes avec CONNECTED sur 89556 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*23186 candidats sur 27476 portent les champs bruts (84%).*

- `5c556c16ea8b` — 17221 candidats
  - AVEC connectivite (6962) : resistance **41.1%**
  - SANS connectivite (10259) : resistance **21.5%**
...
- `5c556c16ea8b` — 17221 candidats
  - AVEC connectivite (6962) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (10259) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.33**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 87055 systemes
  - sans CONNECTED : 0.0% sur 19645 systemes
