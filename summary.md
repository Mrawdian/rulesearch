...
genere 2026-09-05 04:41 UTC — 381416 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 298072 systemes
...
- moteur actif `0caa9267db60` (337674 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 189523 | 94126 | 12906 | 6328 | 19280 | 14927 | 20093 | 19436 | 10.3% |
...
- candidats AVEC connectivite : 19563, dont T2 : 100%
...
- **20367 systemes avec CONNECTED sur 157109 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*44089 candidats sur 48379 portent les champs bruts (91%).*

- `5c556c16ea8b` — 38124 candidats
  - AVEC connectivite (15435) : resistance **41.1%**
...
- `5c556c16ea8b` — 38124 candidats
  - AVEC connectivite (15435) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
...
- TROP-CHER : 20447 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 20367 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 154608 systemes
  - sans CONNECTED : 0.0% sur 34915 systemes
