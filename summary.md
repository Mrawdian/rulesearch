...
genere 2026-08-26 18:15 UTC — 57880 systemes evalues
...
- moteur actif `0caa9267db60` (14138 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `84fba70921e0`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 26163 | 13037 | 1782 | 886 | 2594 | 2065 | 2790 | 2686 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 25602 | 5893 | 10853 | 15 | 3574 | 1311 | 10 | 3946 | 15.4% |
...
- candidats AVEC connectivite : 2813, dont T2 : 100%
- candidats SANS connectivite : 4256, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3064 systemes avec CONNECTED sur 23892 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2779 candidats sur 7069 portent les champs bruts (39%).*
...
- `0a74109317e5` — 80 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `e80bc1b2b437` — 50 candidats
  - AVEC connectivite (28) : resistance **38.2%**
  - SANS connectivite (22) : resistance **19.0%**
...
- `e80bc1b2b437` — 50 candidats
  - AVEC connectivite (28) : T0=12.96 T1=0.00 T2=2.54 — pondere **5.07**
  - SANS connectivite (22) : T0=15.64 T1=0.00 T2=2.59 — pondere **5.18**
  - test de permutation : **p = 0.9250** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `b71bb0907fb5` — 53 candidats
...
- TROP-CHER : 3084 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3064 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 21391 systemes
  - sans CONNECTED : 0.0% sur 4772 systemes
