...
- `89c65c03c4ad` — 293 candidats
  - AVEC connectivite (105) : T0=13.16 T1=0.00 T2=2.79 — pondere **5.58**
  - SANS connectivite (188) : T0=15.99 T1=0.00 T2=2.64 — pondere **5.28**
  - test de permutation : **p = 0.4198** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
