...
genere 2026-08-30 12:14 UTC — 218078 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 134734 systemes
...
- moteur actif `0caa9267db60` (174336 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 107074 | 53189 | 7294 | 3572 | 10783 | 8509 | 11334 | 10999 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 104889 | 24453 | 44298 | 49 | 14478 | 5425 | 41 | 16136 | 15.4% |
...
- candidats AVEC connectivite : 11126, dont T2 : 100%
...
- **11608 systemes avec CONNECTED sur 89856 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*23282 candidats sur 27572 portent les champs bruts (84%).*

- `5c556c16ea8b` — 17317 candidats
  - AVEC connectivite (6998) : resistance **41.1%**
...
- `5c556c16ea8b` — 17317 candidats
  - AVEC connectivite (6998) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.99**
...
- TROP-CHER : 11659 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11608 avec CONNECTED, 51 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 87355 systemes
  - sans CONNECTED : 0.0% sur 19719 systemes
