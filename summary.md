...
| connect | 4 | 3 | 17888 | 8948 | 1161 | 619 | 1771 | 1417 | 1950 | 1798 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 17501 | 4120 | 7382 | 12 | 2397 | 893 | 7 | 2690 | 15.4% |
...
- candidats AVEC connectivite : 1925, dont T2 : 100%
- candidats SANS connectivite : 3000, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2224 systemes avec CONNECTED sur 17117 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*635 candidats sur 4925 portent les champs bruts (13%).*
...
- `e3baecf8377b` — 371 candidats
  - AVEC connectivite (142) : resistance **44.0%**
  - SANS connectivite (229) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 371 candidats
  - AVEC connectivite (142) : T0=12.92 T1=0.00 T2=3.20 — pondere **6.41**
  - SANS connectivite (229) : T0=16.10 T1=0.00 T2=2.65 — pondere **5.29**
...
- TROP-CHER : 2241 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 2224 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14616 systemes
  - sans CONNECTED : 0.0% sur 3272 systemes
