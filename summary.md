...
genere 2026-09-09 05:11 UTC — 472510 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 389166 systemes
...
- moteur actif `0caa9267db60` (428768 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 235546 | 116972 | 16063 | 7894 | 23831 | 18448 | 25074 | 24271 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 230849 | 53776 | 97259 | 92 | 32156 | 11932 | 83 | 35532 | 15.4% |
...
- candidats SANS connectivite : 35842, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25348 systemes avec CONNECTED sur 194827 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55950 candidats sur 60240 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49985 candidats
  - AVEC connectivite (20270) : resistance **41.2%**
  - SANS connectivite (29715) : resistance **21.3%**
...
- `5c556c16ea8b` — 49985 candidats
  ...
  - SANS connectivite (29715) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 192326 systemes
  - sans CONNECTED : 0.0% sur 43220 systemes
