...
genere 2026-09-07 08:01 UTC — 431534 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 348190 systemes
...
- moteur actif `0caa9267db60` (387792 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 214837 | 106699 | 14629 | 7159 | 21772 | 16868 | 22847 | 22131 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 210582 | 49024 | 88797 | 81 | 29340 | 10877 | 76 | 32369 | 15.4% |
...
- candidats SANS connectivite : 32679, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23121 systemes avec CONNECTED sur 177865 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*50647 candidats sur 54937 portent les champs bruts (92%).*

- `5c556c16ea8b` — 44682 candidats
  - AVEC connectivite (18130) : resistance **41.1%**
  - SANS connectivite (26552) : resistance **21.3%**
...
- `5c556c16ea8b` — 44682 candidats
  ...
  - SANS connectivite (26552) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 175364 systemes
  - sans CONNECTED : 0.0% sur 39473 systemes
