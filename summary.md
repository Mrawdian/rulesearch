...
genere 2026-09-04 13:07 UTC — 365181 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 281837 systemes
...
- moteur actif `0caa9267db60` (321439 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 181331 | 90112 | 12327 | 6057 | 18447 | 14288 | 19212 | 18567 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 177735 | 41299 | 75100 | 72 | 24690 | 9203 | 70 | 27287 | 15.4% |
...
- candidats AVEC connectivite : 18694, dont T2 : 100%
- candidats SANS connectivite : 27597, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19486 systemes avec CONNECTED sur 150426 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*42001 candidats sur 46291 portent les champs bruts (91%).*

- `5c556c16ea8b` — 36036 candidats
  - AVEC connectivite (14566) : resistance **41.0%**
  - SANS connectivite (21470) : resistance **21.2%**
...
- `5c556c16ea8b` — 36036 candidats
  - AVEC connectivite (14566) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (21470) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 19566 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19486 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 147925 systemes
  - sans CONNECTED : 0.0% sur 33406 systemes
