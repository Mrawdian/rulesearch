...
genere 2026-08-26 14:39 UTC — 49458 systemes evalues
...
- moteur actif `0caa9267db60` (5716 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21906 | 10924 | 1469 | 751 | 2171 | 1736 | 2340 | 2238 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 21437 | 4983 | 9052 | 13 | 2974 | 1104 | 9 | 3302 | 15.4% |
...
- candidats AVEC connectivite : 2365, dont T2 : 100%
- candidats SANS connectivite : 3612, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2614 systemes avec CONNECTED sur 20399 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1687 candidats sur 5977 portent les champs bruts (28%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 572 candidats
  - AVEC connectivite (227) : resistance **40.6%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 572 candidats
  - AVEC connectivite (227) : T0=13.41 T1=0.00 T2=3.03 — pondere **6.05**
...
- TROP-CHER : 2633 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2614 avec CONNECTED, 19 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17898 systemes
  - sans CONNECTED : 0.0% sur 4008 systemes
