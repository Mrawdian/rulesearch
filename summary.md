...
| connect | 4 | 3 | 7682 | 3867 | 506 | 266 | 735 | 613 | 808 | 800 | 10.4% |
| ref | 4 | 3 | 7510 | 1821 | 3136 | 1 | 1003 | 370 | 3 | 1176 | 15.7% |
...
- candidats AVEC connectivite : 803, dont T2 : 100%
...
- **808 systemes avec CONNECTED sur 6359 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 818 candidats
  - AVEC connectivite (324) : T0=13.41 T1=0.00 T2=2.87 — pondere **5.73**
...
- TROP-CHER : 811 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 808 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 6302 systemes
  - sans CONNECTED : 0.0% sur 1380 systemes
