...
genere 2026-08-28 11:12 UTC — 140337 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 56993 systemes
...
- moteur actif `0caa9267db60` (96595 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 67800 | 33679 | 4655 | 2310 | 6800 | 5402 | 7146 | 6939 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 66422 | 15357 | 28085 | 30 | 9239 | 3432 | 30 | 10246 | 15.4% |
...
- candidats AVEC connectivite : 7066, dont T2 : 100%
- candidats SANS connectivite : 10556, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7420 systemes avec CONNECTED sur 57791 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*13332 candidats sur 17622 portent les champs bruts (76%).*

- `5c556c16ea8b` — 7367 candidats
  - AVEC connectivite (2938) : resistance **41.4%**
  - SANS connectivite (4429) : resistance **21.8%**
...
- `5c556c16ea8b` — 7367 candidats
  - AVEC connectivite (2938) : T0=13.00 T1=0.00 T2=3.01 — pondere **6.03**
  - SANS connectivite (4429) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.35**
...
- TROP-CHER : 7460 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7420 avec CONNECTED, 40 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 55290 systemes
  - sans CONNECTED : 0.0% sur 12510 systemes
