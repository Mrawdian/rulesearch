...
genere 2026-09-05 15:22 UTC — 392230 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 308886 systemes
...
- moteur actif `0caa9267db60` (348488 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 194990 | 96836 | 13276 | 6496 | 19829 | 15339 | 20686 | 20048 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 191125 | 44492 | 80641 | 78 | 26616 | 9881 | 71 | 29332 | 15.3% |
...
- candidats AVEC connectivite : 20175, dont T2 : 100%
- candidats SANS connectivite : 29642, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20960 systemes avec CONNECTED sur 161565 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*45527 candidats sur 49817 portent les champs bruts (91%).*

- `5c556c16ea8b` — 39562 candidats
  - AVEC connectivite (16047) : resistance **41.0%**
  - SANS connectivite (23515) : resistance **21.3%**
...
- `5c556c16ea8b` — 39562 candidats
  - AVEC connectivite (16047) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.94**
  - SANS connectivite (23515) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 159064 systemes
  - sans CONNECTED : 0.0% sur 35926 systemes
