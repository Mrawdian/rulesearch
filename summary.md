...
genere 2026-09-06 06:59 UTC — 407645 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 324301 systemes
...
- moteur actif `0caa9267db60` (363903 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 202770 | 100684 | 13832 | 6745 | 20563 | 15939 | 21539 | 20887 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 198760 | 46201 | 83887 | 78 | 27685 | 10271 | 73 | 30548 | 15.4% |
...
- candidats AVEC connectivite : 21014, dont T2 : 100%
...
- **21813 systemes avec CONNECTED sur 167959 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*47582 candidats sur 51872 portent les champs bruts (92%).*

- `5c556c16ea8b` — 41617 candidats
  - AVEC connectivite (16886) : resistance **41.1%**
...
- `5c556c16ea8b` — 41617 candidats
  - AVEC connectivite (16886) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 21896 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21813 avec CONNECTED, 83 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 165458 systemes
  - sans CONNECTED : 0.0% sur 37312 systemes
