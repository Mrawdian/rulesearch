...
genere 2026-08-26 12:24 UTC — 43799 systemes evalues
...
- `e40600351a72` : 57 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)

Les lignes de dsl_hash differents ne sont pas comparables entre elles.

**7523 enregistrements (17%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
*928 candidats sur 5218 portent les champs bruts (18%).*
