...
genere 2026-08-26 19:50 UTC — 61542 systemes evalues
...
- moteur actif `0caa9267db60` (17800 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 28018 | 13955 | 1918 | 947 | 2772 | 2219 | 2981 | 2875 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 27409 | 6333 | 11602 | 15 | 3812 | 1412 | 12 | 4223 | 15.4% |
...
- candidats AVEC connectivite : 3002, dont T2 : 100%
- candidats SANS connectivite : 4533, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3255 systemes avec CONNECTED sur 25431 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3245 candidats sur 7535 portent les champs bruts (43%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 376 candidats
  - AVEC connectivite (158) : resistance **38.9%**
  - SANS connectivite (218) : resistance **19.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 376 candidats
  - AVEC connectivite (158) : T0=13.13 T1=0.00 T2=2.85 — pondere **5.70**
  - SANS connectivite (218) : T0=16.07 T1=0.00 T2=2.59 — pondere **5.17**
  - test de permutation : **p = 0.1109** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22930 systemes
  - sans CONNECTED : 0.0% sur 5088 systemes
