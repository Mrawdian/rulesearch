...
genere 2026-08-31 19:43 UTC — 261463 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 178119 systemes
...
- moteur actif `0caa9267db60` (217721 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 128980 | 64113 | 8724 | 4323 | 13067 | 10196 | 13588 | 13286 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 126368 | 29448 | 53355 | 56 | 17527 | 6529 | 56 | 19387 | 15.3% |
...
- candidats AVEC connectivite : 13413, dont T2 : 100%
- candidats SANS connectivite : 19697, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13862 systemes avec CONNECTED sur 107724 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*28820 candidats sur 33110 portent les champs bruts (87%).*

- `5c556c16ea8b` — 22855 candidats
  - AVEC connectivite (9285) : resistance **41.1%**
  - SANS connectivite (13570) : resistance **21.4%**
...
- `5c556c16ea8b` — 22855 candidats
  - AVEC connectivite (9285) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (13570) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 13928 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13862 avec CONNECTED, 66 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 105223 systemes
  - sans CONNECTED : 0.0% sur 23757 systemes
