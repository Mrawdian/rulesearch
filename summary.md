...
genere 2026-09-01 10:55 UTC — 280596 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 197252 systemes
...
- moteur actif `0caa9267db60` (236854 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 138633 | 68912 | 9382 | 4631 | 14080 | 10925 | 14642 | 14263 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 135848 | 31637 | 57433 | 58 | 18835 | 7028 | 61 | 20785 | 15.3% |
...
- candidats AVEC connectivite : 14390, dont T2 : 100%
- candidats SANS connectivite : 21095, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14916 systemes avec CONNECTED sur 115618 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*31195 candidats sur 35485 portent les champs bruts (88%).*

- `5c556c16ea8b` — 25230 candidats
  - AVEC connectivite (10262) : resistance **41.0%**
  - SANS connectivite (14968) : resistance **21.4%**
...
- `5c556c16ea8b` — 25230 candidats
  - AVEC connectivite (10262) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (14968) : T0=15.93 T1=0.00 T2=2.66 — pondere **5.32**
...
## cout
- temps total 86.8 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 14987 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14916 avec CONNECTED, 71 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 113117 systemes
  - sans CONNECTED : 0.0% sur 25516 systemes
