...
genere 2026-08-27 21:32 UTC — 115028 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 31684 systemes
...
- moteur actif `0caa9267db60` (71286 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 55007 | 27393 | 3809 | 1867 | 5438 | 4351 | 5819 | 5616 | 10.2% |
...
- candidats AVEC connectivite : 5743, dont T2 : 100%
- candidats SANS connectivite : 8567, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6093 systemes avec CONNECTED sur 47445 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10020 candidats sur 14310 portent les champs bruts (70%).*

- `5c556c16ea8b` — 4055 candidats
  - AVEC connectivite (1615) : resistance **42.1%**
...
- `5c556c16ea8b` — 4055 candidats
  - AVEC connectivite (1615) : T0=12.93 T1=0.00 T2=3.06 — pondere **6.12**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 44944 systemes
  - sans CONNECTED : 0.0% sur 10063 systemes
