...
genere 2026-08-27 00:54 UTC — 72730 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 9167 systemes
- `ab89a63b01ef` : 7823 systemes
...
- moteur actif `0caa9267db60` (28988 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 33673 | 16740 | 2318 | 1143 | 3342 | 2674 | 3586 | 3439 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 32942 | 7595 | 13991 | 18 | 4574 | 1720 | 16 | 5028 | 15.3% |
...
- candidats AVEC connectivite : 3566, dont T2 : 100%
- candidats SANS connectivite : 5338, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3860 systemes avec CONNECTED sur 30045 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4614 candidats sur 8904 portent les champs bruts (52%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 937 candidats
  - AVEC connectivite (386) : resistance **40.8%**
  - SANS connectivite (551) : resistance **21.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 937 candidats
  - AVEC connectivite (386) : T0=13.10 T1=0.00 T2=3.02 — pondere **6.04**
  - SANS connectivite (551) : T0=15.95 T1=0.00 T2=2.63 — pondere **5.25**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
...
- TROP-CHER : 3886 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3860 avec CONNECTED, 26 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 27544 systemes
  - sans CONNECTED : 0.0% sur 6129 systemes
