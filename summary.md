...
genere 2026-08-28 02:15 UTC — 124470 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 41126 systemes
...
- moteur actif `0caa9267db60` (80728 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 59781 | 29779 | 4128 | 2023 | 5946 | 4733 | 6268 | 6138 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 58574 | 13549 | 24821 | 28 | 8149 | 3029 | 26 | 8970 | 15.3% |
...
- candidats SANS connectivite : 9280, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6542 systemes avec CONNECTED sur 51302 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11255 candidats sur 15545 portent les champs bruts (72%).*

- `5c556c16ea8b` — 5290 candidats
  - AVEC connectivite (2137) : resistance **41.8%**
  - SANS connectivite (3153) : resistance **22.2%**
...
- `5c556c16ea8b` — 5290 candidats
  ...
  - SANS connectivite (3153) : T0=15.84 T1=0.00 T2=2.70 — pondere **5.41**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 48801 systemes
  - sans CONNECTED : 0.0% sur 10980 systemes
