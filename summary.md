...
genere 2026-08-27 00:05 UTC — 70891 systemes evalues
...
- moteur actif `0caa9267db60` (27149 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 32745 | 16274 | 2249 | 1106 | 3260 | 2604 | 3492 | 3341 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 32031 | 7377 | 13597 | 18 | 4443 | 1679 | 15 | 4902 | 15.3% |
...
- candidats AVEC connectivite : 3468, dont T2 : 100%
- candidats SANS connectivite : 5212, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3766 systemes avec CONNECTED sur 29264 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4390 candidats sur 8680 portent les champs bruts (51%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 713 candidats
  - AVEC connectivite (288) : resistance **41.6%**
  - SANS connectivite (425) : resistance **21.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 713 candidats
  - AVEC connectivite (288) : T0=13.16 T1=0.00 T2=3.09 — pondere **6.18**
  - SANS connectivite (425) : T0=15.94 T1=0.00 T2=2.61 — pondere **5.22**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e3baecf8377b` — 657 candidats
...
- TROP-CHER : 3791 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3766 avec CONNECTED, 25 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 26763 systemes
  - sans CONNECTED : 0.0% sur 5982 systemes
