...
| connect | 4 | 3 | 7412 | 3732 | 491 | 258 | 704 | 599 | 776 | 771 | 10.4% |
...
- candidats AVEC connectivite : 774, dont T2 : 100%
...
- **776 systemes avec CONNECTED sur 6134 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 753 candidats
  - AVEC connectivite (295) : T0=13.24 T1=0.00 T2=2.93 — pondere **5.85**
...
- TROP-CHER : 778 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 776 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 6077 systemes
  - sans CONNECTED : 0.0% sur 1335 systemes
