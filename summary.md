...
genere 2026-08-28 12:42 UTC — 142907 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 59563 systemes
...
- moteur actif `0caa9267db60` (99165 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 69098 | 34341 | 4731 | 2348 | 6927 | 5508 | 7292 | 7067 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 67694 | 15704 | 28607 | 30 | 9382 | 3489 | 30 | 10449 | 15.4% |
...
- candidats AVEC connectivite : 7194, dont T2 : 100%
- candidats SANS connectivite : 10759, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7566 systemes avec CONNECTED sur 58856 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*13663 candidats sur 17953 portent les champs bruts (76%).*

- `5c556c16ea8b` — 7698 candidats
  - AVEC connectivite (3066) : resistance **41.2%**
  - SANS connectivite (4632) : resistance **21.8%**
...
- `5c556c16ea8b` — 7698 candidats
  - AVEC connectivite (3066) : T0=13.02 T1=0.00 T2=3.01 — pondere **6.01**
  - SANS connectivite (4632) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.37**
...
- TROP-CHER : 7606 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7566 avec CONNECTED, 40 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 56355 systemes
  - sans CONNECTED : 0.0% sur 12743 systemes
