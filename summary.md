...
genere 2026-09-02 01:02 UTC — 297718 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 214374 systemes
...
- moteur actif `0caa9267db60` (253976 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 147276 | 73156 | 10025 | 4937 | 14944 | 11600 | 15581 | 15137 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 144327 | 33578 | 61049 | 61 | 19992 | 7453 | 63 | 22119 | 15.3% |
...
- candidats AVEC connectivite : 15264, dont T2 : 100%
- candidats SANS connectivite : 22429, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15855 systemes avec CONNECTED sur 122722 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*33403 candidats sur 37693 portent les champs bruts (89%).*

- `5c556c16ea8b` — 27438 candidats
  - AVEC connectivite (11136) : resistance **41.0%**
  - SANS connectivite (16302) : resistance **21.3%**
...
- `5c556c16ea8b` — 27438 candidats
  - AVEC connectivite (11136) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (16302) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 15928 systemes abandonnes (5.4% des systemes), 96% du temps total
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 120221 systemes
  - sans CONNECTED : 0.0% sur 27055 systemes
