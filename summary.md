...
| connect | 4 | 3 | 7487 | 3765 | 495 | 259 | 715 | 604 | 789 | 778 | 10.4% |
...
- candidats AVEC connectivite : 781, dont T2 : 100%
...
- **789 systemes avec CONNECTED sur 6195 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 767 candidats
  - AVEC connectivite (302) : T0=13.29 T1=0.00 T2=2.90 — pondere **5.80**
  - SANS connectivite (465) : T0=15.78 T1=0.00 T2=2.65 — pondere **5.30**
  - test de permutation : **p = 0.0275** — ecart significatif au seuil 0.05
...
- TROP-CHER : 791 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 789 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 6138 systemes
