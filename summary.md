...
genere 2026-08-26 18:57 UTC — 59732 systemes evalues
...
- moteur actif `0caa9267db60` (15990 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27090 | 13517 | 1844 | 912 | 2688 | 2146 | 2871 | 2773 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 26527 | 6126 | 11232 | 15 | 3696 | 1367 | 10 | 4081 | 15.4% |
...
- candidats AVEC connectivite : 2900, dont T2 : 100%
- candidats SANS connectivite : 4391, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3145 systemes avec CONNECTED sur 24654 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3001 candidats sur 7291 portent les champs bruts (41%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 132 candidats
  - AVEC connectivite (56) : resistance **42.3%**
  - SANS connectivite (76) : resistance **18.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 132 candidats
  - AVEC connectivite (56) : T0=13.02 T1=0.00 T2=3.02 — pondere **6.04**
  - SANS connectivite (76) : T0=16.04 T1=0.00 T2=2.49 — pondere **4.97**
...
## cout
- temps total 18.4 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 3165 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3145 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22153 systemes
  - sans CONNECTED : 0.0% sur 4937 systemes
