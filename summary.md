...
genere 2026-08-26 12:47 UTC — 44859 systemes evalues
...
| connect | 4 | 3 | 19576 | 9765 | 1275 | 682 | 1957 | 1554 | 2103 | 1996 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 19168 | 4501 | 8086 | 13 | 2639 | 991 | 7 | 2931 | 15.3% |
...
- candidats AVEC connectivite : 2123, dont T2 : 100%
- candidats SANS connectivite : 3241, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2377 systemes avec CONNECTED sur 18484 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1074 candidats sur 5364 portent les champs bruts (20%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `e40600351a72` — 153 candidats
  - AVEC connectivite (72) : resistance **40.4%**
  - SANS connectivite (81) : resistance **19.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e40600351a72` — 153 candidats
  - AVEC connectivite (72) : T0=13.03 T1=0.00 T2=2.99 — pondere **5.97**
  - SANS connectivite (81) : T0=16.75 T1=0.00 T2=2.63 — pondere **5.26**
...
- TROP-CHER : 2394 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2377 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 15983 systemes
  - sans CONNECTED : 0.0% sur 3593 systemes
