...
| connect | 4 | 3 | 18905 | 9437 | 1234 | 654 | 1883 | 1507 | 2045 | 1912 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 18500 | 4346 | 7795 | 13 | 2543 | 957 | 7 | 2839 | 15.3% |
...
- candidats AVEC connectivite : 2039, dont T2 : 100%
- candidats SANS connectivite : 3149, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2319 systemes avec CONNECTED sur 17931 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*898 candidats sur 5188 portent les champs bruts (17%).*
...
- `e3baecf8377b` — 634 candidats
  - AVEC connectivite (256) : resistance **42.2%**
  - SANS connectivite (378) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 634 candidats
  - AVEC connectivite (256) : T0=13.09 T1=0.00 T2=3.11 — pondere **6.22**
  - SANS connectivite (378) : T0=15.97 T1=0.00 T2=2.61 — pondere **5.22**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
...
- TROP-CHER : 2336 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2319 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 15430 systemes
  - sans CONNECTED : 0.0% sur 3475 systemes
