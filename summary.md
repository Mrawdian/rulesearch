...
genere 2026-08-26 10:37 UTC — 39201 systemes evalues
...
- `e3baecf8377b` : 608 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
**8074 enregistrements (21%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| ref | 4 | 3 | 16364 | 3846 | 6930 | 11 | 2235 | 827 | 7 | 2508 | 15.3% |
...
- candidats SANS connectivite : 2818, dont T2 : 100%
...
*342 candidats sur 4632 portent les champs bruts (7%).*
...
- `e3baecf8377b` — 78 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (31) : resistance **37.0%**
  - SANS connectivite (47) : resistance **17.4%**
...
- `e3baecf8377b` — 78 candidats
  - AVEC connectivite (31) : T0=13.68 T1=0.00 T2=2.77 — pondere **5.55**
  - SANS connectivite (47) : T0=16.02 T1=0.00 T2=2.34 — pondere **4.68**
  - test de permutation : **p = 0.2509** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
