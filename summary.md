...
genere 2026-08-27 07:33 UTC — 87293 systemes evalues
...
- moteur actif `0caa9267db60` (43551 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 41015 | 20413 | 2809 | 1393 | 4100 | 3227 | 4328 | 4214 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 40163 | 9248 | 17068 | 22 | 5583 | 2092 | 21 | 6129 | 15.3% |
...
- candidats AVEC connectivite : 4341, dont T2 : 100%
- candidats SANS connectivite : 6439, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4602 systemes avec CONNECTED sur 36021 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6490 candidats sur 10780 portent les champs bruts (60%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 525 candidats
  - AVEC connectivite (213) : resistance **41.9%**
  - SANS connectivite (312) : resistance **20.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 525 candidats
  - AVEC connectivite (213) : T0=13.04 T1=0.00 T2=3.06 — pondere **6.11**
  - SANS connectivite (312) : T0=15.80 T1=0.00 T2=2.58 — pondere **5.16**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `23303c299f39` — 225 candidats
...
**7 serie(s) reproductible(s) sur 14 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `ab89a63b01ef` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `5c556c16ea8b` (p=0.0005), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 33520 systemes
  - sans CONNECTED : 0.0% sur 7495 systemes
