...
genere 2026-08-27 00:54 UTC — 72701 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 9167 systemes
- `ab89a63b01ef` : 7794 systemes
...
- moteur actif `0caa9267db60` (28959 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 33658 | 16728 | 2317 | 1143 | 3342 | 2674 | 3586 | 3437 | 10.2% |
...
- candidats AVEC connectivite : 3564, dont T2 : 100%
- candidats SANS connectivite : 5337, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3860 systemes avec CONNECTED sur 30030 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4611 candidats sur 8901 portent les champs bruts (52%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 934 candidats
  - AVEC connectivite (384) : resistance **40.8%**
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 934 candidats
  - AVEC connectivite (384) : T0=13.10 T1=0.00 T2=3.02 — pondere **6.04**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 27529 systemes
