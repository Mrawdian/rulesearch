...
genere 2026-08-27 02:41 UTC — 76596 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 11689 systemes
...
- moteur actif `0caa9267db60` (32854 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 35618 | 17720 | 2448 | 1208 | 3533 | 2821 | 3790 | 3638 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 34863 | 8034 | 14828 | 20 | 4824 | 1822 | 19 | 5316 | 15.2% |
...
- candidats AVEC connectivite : 3765, dont T2 : 100%
- candidats SANS connectivite : 5626, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4064 systemes avec CONNECTED sur 31652 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5101 candidats sur 9391 portent les champs bruts (54%).*
...
- `ab89a63b01ef` — 1424 candidats
  - AVEC connectivite (585) : resistance **41.3%**
  - SANS connectivite (839) : resistance **22.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1424 candidats
  - AVEC connectivite (585) : T0=12.98 T1=0.00 T2=3.05 — pondere **6.10**
  - SANS connectivite (839) : T0=15.93 T1=0.00 T2=2.69 — pondere **5.38**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- TROP-CHER : 4093 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4064 avec CONNECTED, 29 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 29151 systemes
  - sans CONNECTED : 0.0% sur 6467 systemes
