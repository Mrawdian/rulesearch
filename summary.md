...
genere 2026-09-02 15:43 UTC — 314725 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 231381 systemes
...
- moteur actif `0caa9267db60` (270983 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 155857 | 77427 | 10603 | 5209 | 15853 | 12264 | 16514 | 15984 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 152753 | 35577 | 64628 | 64 | 21092 | 7904 | 63 | 23413 | 15.3% |
...
- candidats SANS connectivite : 23723, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16788 systemes avec CONNECTED sur 129710 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*35544 candidats sur 39834 portent les champs bruts (89%).*

- `5c556c16ea8b` — 29579 candidats
  - AVEC connectivite (11983) : resistance **41.0%**
  - SANS connectivite (17596) : resistance **21.3%**
...
- `5c556c16ea8b` — 29579 candidats
  ...
  - SANS connectivite (17596) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 127209 systemes
  - sans CONNECTED : 0.0% sur 28648 systemes
