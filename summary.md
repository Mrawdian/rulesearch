...
genere 2026-08-31 04:32 UTC — 240903 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 157559 systemes
...
- moteur actif `0caa9267db60` (197161 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 118601 | 59009 | 8062 | 3979 | 11905 | 9342 | 12558 | 12199 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 116187 | 27125 | 49098 | 53 | 16042 | 5997 | 52 | 17810 | 15.3% |
...
- candidats AVEC connectivite : 12326, dont T2 : 100%
- candidats SANS connectivite : 18120, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12832 systemes avec CONNECTED sur 99368 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*26156 candidats sur 30446 portent les champs bruts (86%).*

- `5c556c16ea8b` — 20191 candidats
  - AVEC connectivite (8198) : resistance **41.0%**
  - SANS connectivite (11993) : resistance **21.4%**
...
- `5c556c16ea8b` — 20191 candidats
  - AVEC connectivite (8198) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (11993) : T0=15.90 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 12894 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 12832 avec CONNECTED, 62 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 96867 systemes
  - sans CONNECTED : 0.0% sur 21734 systemes
