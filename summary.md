...
- `89c65c03c4ad` — 265 candidats
  - AVEC connectivite (93) : T0=13.19 T1=0.00 T2=2.85 — pondere **5.70**
  - SANS connectivite (172) : T0=15.95 T1=0.00 T2=2.65 — pondere **5.29**
  - test de permutation : **p = 0.3003** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
