...
genere 2026-08-26 12:58 UTC — 45288 systemes evalues
...
- `06fe04a859f1` : 105 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (1546 systemes) : `06fe04a859f1`, `e40600351a72`
...
**7571 enregistrements (17%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 19800 | 9880 | 1290 | 685 | 1987 | 1564 | 2129 | 2019 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 19373 | 4546 | 8179 | 13 | 2665 | 1001 | 7 | 2962 | 15.3% |
...
- candidats SANS connectivite : 3272, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2403 systemes avec CONNECTED sur 18667 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1128 candidats sur 5418 portent les champs bruts (21%).*
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 16166 systemes
  - sans CONNECTED : 0.0% sur 3634 systemes
