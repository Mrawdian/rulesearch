...
genere 2026-09-07 06:58 UTC — 430552 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 347208 systemes
...
- moteur actif `0caa9267db60` (386810 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 214344 | 106445 | 14599 | 7147 | 21716 | 16832 | 22795 | 22080 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 210093 | 48912 | 88577 | 81 | 29287 | 10842 | 75 | 32301 | 15.4% |
...
- candidats AVEC connectivite : 22207, dont T2 : 100%
- candidats SANS connectivite : 32611, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23069 systemes avec CONNECTED sur 177458 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*50528 candidats sur 54818 portent les champs bruts (92%).*

- `5c556c16ea8b` — 44563 candidats
  - AVEC connectivite (18079) : resistance **41.1%**
  - SANS connectivite (26484) : resistance **21.3%**
...
- `5c556c16ea8b` — 44563 candidats
  - AVEC connectivite (18079) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (26484) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 174957 systemes
  - sans CONNECTED : 0.0% sur 39387 systemes
