...
genere 2026-08-27 19:22 UTC — 111040 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 27696 systemes
...
- moteur actif `0caa9267db60` (67298 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 52988 | 26374 | 3673 | 1811 | 5254 | 4194 | 5589 | 5403 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 51937 | 11999 | 22048 | 26 | 7182 | 2709 | 25 | 7946 | 15.3% |
...
- candidats AVEC connectivite : 5530, dont T2 : 100%
- candidats SANS connectivite : 8256, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5863 systemes avec CONNECTED sur 45777 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*9496 candidats sur 13786 portent les champs bruts (69%).*
...
- `5c556c16ea8b` — 3531 candidats
  - AVEC connectivite (1402) : resistance **42.1%**
  - SANS connectivite (2129) : resistance **22.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 3531 candidats
  - AVEC connectivite (1402) : T0=12.96 T1=0.00 T2=3.07 — pondere **6.14**
  - SANS connectivite (2129) : T0=15.78 T1=0.00 T2=2.71 — pondere **5.42**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 2280 candidats
...
- TROP-CHER : 5898 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 5863 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 43276 systemes
  - sans CONNECTED : 0.0% sur 9712 systemes
