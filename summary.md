...
genere 2026-09-01 03:33 UTC — 271316 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 187972 systemes
...
- moteur actif `0caa9267db60` (227574 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 133946 | 66555 | 9057 | 4493 | 13587 | 10604 | 14149 | 13764 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 131255 | 30587 | 55472 | 57 | 18195 | 6777 | 57 | 20100 | 15.3% |
...
- candidats AVEC connectivite : 13891, dont T2 : 100%
- candidats SANS connectivite : 20410, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14423 systemes avec CONNECTED sur 111773 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*30011 candidats sur 34301 portent les champs bruts (87%).*

- `5c556c16ea8b` — 24046 candidats
  - AVEC connectivite (9763) : resistance **41.0%**
  - SANS connectivite (14283) : resistance **21.3%**
...
- `5c556c16ea8b` — 24046 candidats
  - AVEC connectivite (9763) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (14283) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
## cout
- temps total 84.0 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 14490 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14423 avec CONNECTED, 67 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 109272 systemes
  - sans CONNECTED : 0.0% sur 24674 systemes
