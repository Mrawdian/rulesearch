...
genere 2026-09-07 21:12 UTC — 443714 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 360370 systemes
...
- moteur actif `0caa9267db60` (399972 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 221009 | 109764 | 15072 | 7377 | 22374 | 17308 | 23517 | 22783 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 216590 | 50448 | 91268 | 85 | 30185 | 11195 | 77 | 33314 | 15.4% |
...
- candidats AVEC connectivite : 22910, dont T2 : 100%
- candidats SANS connectivite : 33624, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23791 systemes avec CONNECTED sur 182963 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*52244 candidats sur 56534 portent les champs bruts (92%).*

- `5c556c16ea8b` — 46279 candidats
  - AVEC connectivite (18782) : resistance **41.2%**
  - SANS connectivite (27497) : resistance **21.3%**
...
- `5c556c16ea8b` — 46279 candidats
  - AVEC connectivite (18782) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (27497) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 23878 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23791 avec CONNECTED, 87 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 180462 systemes
  - sans CONNECTED : 0.0% sur 40547 systemes
