...
genere 2026-08-26 01:56 UTC — 17141 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 8167 systemes
...
| connect | 4 | 3 | 8609 | 4332 | 560 | 290 | 817 | 694 | 924 | 886 | 10.3% |
| ref | 4 | 3 | 8408 | 2031 | 3526 | 2 | 1130 | 410 | 3 | 1306 | 15.5% |
...
- candidats AVEC connectivite : 889, dont T2 : 100%
- candidats SANS connectivite : 1310, dont T2 : 100%
...
- **924 systemes avec CONNECTED sur 7126 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1034 candidats
  - AVEC connectivite (410) : T0=13.38 T1=0.00 T2=2.86 — pondere **5.73**
  - SANS connectivite (624) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 927 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 924 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 7069 systemes
  - sans CONNECTED : 0.0% sur 1540 systemes
