...
| connect | 4 | 3 | 17678 | 8840 | 1141 | 612 | 1758 | 1405 | 1922 | 1778 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 17296 | 4064 | 7315 | 12 | 2366 | 881 | 7 | 2651 | 15.3% |
...
- candidats SANS connectivite : 2961, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2196 systemes avec CONNECTED sur 16938 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*576 candidats sur 4866 portent les champs bruts (12%).*
...
- `e3baecf8377b` — 312 candidats
  - AVEC connectivite (122) : resistance **43.8%**
  - SANS connectivite (190) : resistance **21.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 312 candidats
  ...
  - SANS connectivite (190) : T0=16.05 T1=0.00 T2=2.68 — pondere **5.37**
...
- TROP-CHER : 2213 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2196 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14437 systemes
  - sans CONNECTED : 0.0% sur 3241 systemes
