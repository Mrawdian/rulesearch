...
genere 2026-08-27 00:19 UTC — 71426 systemes evalues
...
- moteur actif `0caa9267db60` (27684 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 33015 | 16396 | 2273 | 1118 | 3283 | 2629 | 3518 | 3374 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 32296 | 7437 | 13713 | 18 | 4480 | 1695 | 15 | 4938 | 15.3% |
...
- candidats AVEC connectivite : 3501, dont T2 : 100%
- candidats SANS connectivite : 5248, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3792 systemes avec CONNECTED sur 29489 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4459 candidats sur 8749 portent les champs bruts (51%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 782 candidats
  - AVEC connectivite (321) : resistance **41.4%**
  - SANS connectivite (461) : resistance **21.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 782 candidats
  - AVEC connectivite (321) : T0=13.17 T1=0.00 T2=3.07 — pondere **6.15**
  - SANS connectivite (461) : T0=15.90 T1=0.00 T2=2.62 — pondere **5.23**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 798 candidats
...
## cout
- temps total 22.2 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 3817 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3792 avec CONNECTED, 25 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 26988 systemes
  - sans CONNECTED : 0.0% sur 6027 systemes
