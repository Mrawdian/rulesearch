...
genere 2026-08-29 03:45 UTC — 168736 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 85392 systemes
...
- moteur actif `0caa9267db60` (124994 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 82136 | 40887 | 5586 | 2781 | 8244 | 6518 | 8630 | 8442 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 80485 | 18730 | 34062 | 37 | 11141 | 4088 | 34 | 12388 | 15.4% |
...
- candidats AVEC connectivite : 8569, dont T2 : 100%
- candidats SANS connectivite : 12698, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8904 systemes avec CONNECTED sur 69523 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*16977 candidats sur 21267 portent les champs bruts (80%).*

- `5c556c16ea8b` — 11012 candidats
  - AVEC connectivite (4441) : resistance **41.1%**
  - SANS connectivite (6571) : resistance **21.7%**
...
- `5c556c16ea8b` — 11012 candidats
  - AVEC connectivite (4441) : T0=13.01 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (6571) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.34**
...
- TROP-CHER : 8948 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8904 avec CONNECTED, 44 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 67022 systemes
  - sans CONNECTED : 0.0% sur 15114 systemes
