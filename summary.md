...
genere 2026-09-03 17:27 UTC — 343870 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 260526 systemes
...
- moteur actif `0caa9267db60` (300128 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 170564 | 84789 | 11577 | 5712 | 17347 | 13459 | 18078 | 17430 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 167191 | 38892 | 70652 | 67 | 23196 | 8648 | 66 | 25658 | 15.3% |
...
- candidats SANS connectivite : 25968, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18352 systemes avec CONNECTED sur 141668 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39235 candidats sur 43525 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33270 candidats
  - AVEC connectivite (13429) : resistance **41.0%**
  - SANS connectivite (19841) : resistance **21.2%**
...
- `5c556c16ea8b` — 33270 candidats
  ...
  - SANS connectivite (19841) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 139167 systemes
  - sans CONNECTED : 0.0% sur 31397 systemes
