...
**7466 enregistrements (68%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 5486 | 2756 | 353 | 200 | 528 | 450 | 572 | 566 | 10.3% |
| ref | 4 | 3 | 5351 | 1293 | 2237 | 1 | 709 | 262 | 2 | 847 | 15.8% |
...
- candidats AVEC connectivite : 569, dont T2 : 100%
- candidats SANS connectivite : 851, dont T2 : 100%
...
- **572 systemes avec CONNECTED sur 4542 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 255 candidats
  - AVEC connectivite (90) : T0=13.24 T1=0.00 T2=2.81 — pondere **5.62**
  - SANS connectivite (165) : T0=15.95 T1=0.00 T2=2.65 — pondere **5.30**
  - test de permutation : **p = 0.4328** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
## cout
- temps total 3.3 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 574 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 572 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 4485 systemes
  - sans CONNECTED : 0.0% sur 1001 systemes
