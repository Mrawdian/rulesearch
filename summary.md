...
genere 2026-08-26 09:04 UTC — 35231 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 26257 systemes
...
- candidats AVEC connectivite : 1652, dont T2 : 100%
- candidats SANS connectivite : 2572, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1898 systemes avec CONNECTED sur 14533 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 3059 candidats
  - AVEC connectivite (1173) : T0=13.15 T1=0.00 T2=2.93 — pondere **5.86**
