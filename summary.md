...
genere 2026-09-03 17:53 UTC — 344323 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 260979 systemes
...
- moteur actif `0caa9267db60` (300581 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 170801 | 84922 | 11590 | 5723 | 17368 | 13474 | 18105 | 17444 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 167407 | 38943 | 70753 | 67 | 23218 | 8659 | 66 | 25689 | 15.3% |
...
- candidats AVEC connectivite : 17571, dont T2 : 100%
- candidats SANS connectivite : 25999, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18379 systemes avec CONNECTED sur 141870 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39280 candidats sur 43570 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33315 candidats
  - AVEC connectivite (13443) : resistance **41.1%**
  - SANS connectivite (19872) : resistance **21.2%**
...
- `5c556c16ea8b` — 33315 candidats
  - AVEC connectivite (13443) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (19872) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 18455 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18379 avec CONNECTED, 76 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 139369 systemes
  - sans CONNECTED : 0.0% sur 31432 systemes
