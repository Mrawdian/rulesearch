...
genere 2026-09-02 02:29 UTC — 299384 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 216040 systemes
...
- moteur actif `0caa9267db60` (255642 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 148111 | 73571 | 10085 | 4968 | 15036 | 11651 | 15682 | 15216 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 145158 | 33765 | 61426 | 61 | 20096 | 7503 | 63 | 22232 | 15.3% |
...
- candidats AVEC connectivite : 15343, dont T2 : 100%
...
- **15956 systemes avec CONNECTED sur 123415 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*33595 candidats sur 37885 portent les champs bruts (89%).*

- `5c556c16ea8b` — 27630 candidats
  - AVEC connectivite (11215) : resistance **41.0%**
...
- `5c556c16ea8b` — 27630 candidats
  - AVEC connectivite (11215) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 16029 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 15956 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 120914 systemes
