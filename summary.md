...
genere 2026-08-28 00:21 UTC — 120552 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 37208 systemes
...
- moteur actif `0caa9267db60` (76810 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 57796 | 28781 | 4003 | 1954 | 5736 | 4572 | 6098 | 5912 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 56641 | 13076 | 24031 | 28 | 7881 | 2922 | 25 | 8676 | 15.3% |
...
- candidats SANS connectivite : 8986, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6372 systemes avec CONNECTED sur 49706 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10735 candidats sur 15025 portent les champs bruts (71%).*

- `5c556c16ea8b` — 4770 candidats
  - AVEC connectivite (1911) : resistance **42.0%**
  - SANS connectivite (2859) : resistance **22.5%**
...
- `5c556c16ea8b` — 4770 candidats
  ...
  - SANS connectivite (2859) : T0=15.80 T1=0.00 T2=2.72 — pondere **5.43**
...
- TROP-CHER : 6407 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6372 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 47205 systemes
  - sans CONNECTED : 0.0% sur 10591 systemes
