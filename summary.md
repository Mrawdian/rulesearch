...
genere 2026-08-26 06:11 UTC — 27648 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 18674 systemes
...
- candidats AVEC connectivite : 1384, dont T2 : 100%
- candidats SANS connectivite : 2077, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1512 systemes avec CONNECTED sur 11447 (13.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2296 candidats
  - AVEC connectivite (905) : T0=13.24 T1=0.00 T2=2.87 — pondere **5.74**
