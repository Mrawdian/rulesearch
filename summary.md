...
genere 2026-08-31 00:13 UTC — 234983 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 151639 systemes
...
- moteur actif `0caa9267db60` (191241 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 115607 | 57472 | 7849 | 3884 | 11612 | 9131 | 12241 | 11901 | 10.3% |
...
- candidats AVEC connectivite : 12028, dont T2 : 100%
...
- **12515 systemes avec CONNECTED sur 96913 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*25431 candidats sur 29721 portent les champs bruts (86%).*

- `5c556c16ea8b` — 19466 candidats
  - AVEC connectivite (7900) : resistance **41.1%**
...
- `5c556c16ea8b` — 19466 candidats
  - AVEC connectivite (7900) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.98**
...
- TROP-CHER : 12575 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 12515 avec CONNECTED, 60 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 94412 systemes
  - sans CONNECTED : 0.0% sur 21195 systemes
