...
genere 2026-08-29 03:08 UTC — 167761 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 84417 systemes
...
- moteur actif `0caa9267db60` (124019 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 81645 | 40629 | 5554 | 2773 | 8190 | 6481 | 8574 | 8404 | 10.3% |
...
- candidats AVEC connectivite : 8531, dont T2 : 100%
...
- **8848 systemes avec CONNECTED sur 69116 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*16863 candidats sur 21153 portent les champs bruts (80%).*

- `5c556c16ea8b` — 10898 candidats
  - AVEC connectivite (4403) : resistance **41.2%**
...
- `5c556c16ea8b` — 10898 candidats
  - AVEC connectivite (4403) : T0=13.01 T1=0.00 T2=3.00 — pondere **5.99**
...
- TROP-CHER : 8892 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8848 avec CONNECTED, 44 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 66615 systemes
  - sans CONNECTED : 0.0% sur 15030 systemes
