...
genere 2026-09-03 04:30 UTC — 329391 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 246047 systemes
...
- moteur actif `0caa9267db60` (285649 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 163254 | 81111 | 11089 | 5464 | 16621 | 12870 | 17299 | 16713 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 160022 | 37284 | 67640 | 65 | 22179 | 8267 | 65 | 24510 | 15.3% |
...
- candidats SANS connectivite : 24820, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **17573 systemes avec CONNECTED sur 135684 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*37370 candidats sur 41660 portent les champs bruts (90%).*

- `5c556c16ea8b` — 31405 candidats
  - AVEC connectivite (12712) : resistance **41.1%**
  - SANS connectivite (18693) : resistance **21.2%**
...
- `5c556c16ea8b` — 31405 candidats
  ...
  - SANS connectivite (18693) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 17648 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 17573 avec CONNECTED, 75 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 133183 systemes
  - sans CONNECTED : 0.0% sur 30071 systemes
