...
genere 2026-09-02 12:32 UTC — 311204 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 227860 systemes
...
- moteur actif `0caa9267db60` (267462 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 154078 | 76542 | 10485 | 5155 | 15662 | 12128 | 16320 | 15813 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 151011 | 35171 | 63875 | 64 | 20877 | 7796 | 63 | 23153 | 15.3% |
...
- candidats AVEC connectivite : 15940, dont T2 : 100%
- candidats SANS connectivite : 23463, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16594 systemes avec CONNECTED sur 128271 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*35113 candidats sur 39403 portent les champs bruts (89%).*

- `5c556c16ea8b` — 29148 candidats
  - AVEC connectivite (11812) : resistance **41.1%**
  - SANS connectivite (17336) : resistance **21.3%**
...
- `5c556c16ea8b` — 29148 candidats
  - AVEC connectivite (11812) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (17336) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
## cout
- temps total 96.5 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 16667 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16594 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 125770 systemes
  - sans CONNECTED : 0.0% sur 28308 systemes
