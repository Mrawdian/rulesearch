...
genere 2026-09-07 06:39 UTC — 430288 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 346944 systemes
...
- moteur actif `0caa9267db60` (386546 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 214209 | 106371 | 14588 | 7143 | 21706 | 16825 | 22774 | 22072 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 209964 | 48883 | 88516 | 81 | 29274 | 10838 | 75 | 32279 | 15.4% |
...
- candidats AVEC connectivite : 22199, dont T2 : 100%
- candidats SANS connectivite : 32589, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23048 systemes avec CONNECTED sur 177344 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*50498 candidats sur 54788 portent les champs bruts (92%).*

- `5c556c16ea8b` — 44533 candidats
  - AVEC connectivite (18071) : resistance **41.1%**
  - SANS connectivite (26462) : resistance **21.3%**
...
- `5c556c16ea8b` — 44533 candidats
  - AVEC connectivite (18071) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (26462) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 23133 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23048 avec CONNECTED, 85 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 174843 systemes
  - sans CONNECTED : 0.0% sur 39366 systemes
