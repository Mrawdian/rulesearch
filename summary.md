...
genere 2026-08-27 01:03 UTC — 73042 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 9167 systemes
- `ab89a63b01ef` : 8135 systemes
...
- moteur actif `0caa9267db60` (29300 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 33822 | 16814 | 2327 | 1149 | 3356 | 2686 | 3603 | 3455 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 33105 | 7632 | 14060 | 19 | 4599 | 1730 | 17 | 5048 | 15.2% |
...
- candidats AVEC connectivite : 3582, dont T2 : 100%
- candidats SANS connectivite : 5358, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3877 systemes avec CONNECTED sur 30167 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4650 candidats sur 8940 portent les champs bruts (52%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 973 candidats
  - AVEC connectivite (402) : resistance **40.8%**
  - SANS connectivite (571) : resistance **21.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 973 candidats
  - AVEC connectivite (402) : T0=13.07 T1=0.00 T2=3.03 — pondere **6.07**
  - SANS connectivite (571) : T0=15.92 T1=0.00 T2=2.64 — pondere **5.29**
...
**6 serie(s) reproductible(s) sur 13 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0005), `ab89a63b01ef` (p=0.0020), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
...
## cout
- temps total 22.7 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 3904 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3877 avec CONNECTED, 27 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 27666 systemes
  - sans CONNECTED : 0.0% sur 6156 systemes
