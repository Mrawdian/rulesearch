...
genere 2026-08-31 00:53 UTC — 235891 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 152547 systemes
...
- moteur actif `0caa9267db60` (192149 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 116071 | 57708 | 7887 | 3899 | 11660 | 9159 | 12291 | 11948 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 113705 | 26517 | 48067 | 53 | 15678 | 5876 | 50 | 17454 | 15.4% |
...
- candidats AVEC connectivite : 12075, dont T2 : 100%
- candidats SANS connectivite : 17764, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12565 systemes avec CONNECTED sur 97297 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*25549 candidats sur 29839 portent les champs bruts (86%).*

- `5c556c16ea8b` — 19584 candidats
  - AVEC connectivite (7947) : resistance **41.0%**
  - SANS connectivite (11637) : resistance **21.4%**
...
- `5c556c16ea8b` — 19584 candidats
  - AVEC connectivite (7947) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.97**
  - SANS connectivite (11637) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.32**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 94796 systemes
  - sans CONNECTED : 0.0% sur 21275 systemes
