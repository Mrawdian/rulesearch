...
genere 2026-08-28 02:26 UTC — 124872 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 41528 systemes
...
- moteur actif `0caa9267db60` (81130 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 59990 | 29878 | 4146 | 2030 | 5970 | 4750 | 6285 | 6160 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 58767 | 13595 | 24904 | 28 | 8172 | 3042 | 26 | 8998 | 15.3% |
...
- candidats AVEC connectivite : 6287, dont T2 : 100%
- candidats SANS connectivite : 9308, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6559 systemes avec CONNECTED sur 51467 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11305 candidats sur 15595 portent les champs bruts (72%).*

- `5c556c16ea8b` — 5340 candidats
  - AVEC connectivite (2159) : resistance **41.8%**
  - SANS connectivite (3181) : resistance **22.2%**
...
- `5c556c16ea8b` — 5340 candidats
  - AVEC connectivite (2159) : T0=12.99 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (3181) : T0=15.85 T1=0.00 T2=2.70 — pondere **5.40**
...
- TROP-CHER : 6595 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6559 avec CONNECTED, 36 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 48966 systemes
  - sans CONNECTED : 0.0% sur 11024 systemes
