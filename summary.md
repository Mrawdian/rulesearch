...
genere 2026-09-01 04:16 UTC — 272236 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 188892 systemes
...
- moteur actif `0caa9267db60` (228494 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 134411 | 66794 | 9083 | 4509 | 13632 | 10644 | 14194 | 13812 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 131710 | 30692 | 55673 | 58 | 18254 | 6795 | 59 | 20169 | 15.3% |
...
- candidats AVEC connectivite : 13939, dont T2 : 100%
...
- **14468 systemes avec CONNECTED sur 112155 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*30128 candidats sur 34418 portent les champs bruts (88%).*

- `5c556c16ea8b` — 24163 candidats
  - AVEC connectivite (9811) : resistance **41.0%**
...
- `5c556c16ea8b` — 24163 candidats
  - AVEC connectivite (9811) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 14537 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14468 avec CONNECTED, 69 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 109654 systemes
  - sans CONNECTED : 0.0% sur 24757 systemes
