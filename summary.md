...
**7466 enregistrements (70%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 5366 | 2692 | 345 | 193 | 520 | 443 | 560 | 554 | 10.3% |
| ref | 4 | 3 | 5234 | 1265 | 2188 | 1 | 694 | 253 | 2 | 831 | 15.9% |
...
- candidats AVEC connectivite : 557, dont T2 : 100%
- candidats SANS connectivite : 835, dont T2 : 100%
...
- **560 systemes avec CONNECTED sur 4439 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 227 candidats
  - AVEC connectivite (78) : T0=13.22 T1=0.00 T2=2.78 — pondere **5.56**
  - SANS connectivite (149) : T0=15.88 T1=0.00 T2=2.69 — pondere **5.38**
  - test de permutation : **p = 0.6597** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 562 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 560 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 4382 systemes
  - sans CONNECTED : 0.0% sur 984 systemes
