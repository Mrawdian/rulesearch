...
genere 2026-09-08 04:22 UTC — 450123 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 366779 systemes
...
- moteur actif `0caa9267db60` (406381 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 224233 | 111353 | 15269 | 7486 | 22690 | 17578 | 23896 | 23103 | 10.3% |
...
- candidats AVEC connectivite : 23230, dont T2 : 100%
...
- **24170 systemes avec CONNECTED sur 185598 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*53027 candidats sur 57317 portent les champs bruts (93%).*

- `5c556c16ea8b` — 47062 candidats
  - AVEC connectivite (19102) : resistance **41.2%**
...
- `5c556c16ea8b` — 47062 candidats
  - AVEC connectivite (19102) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 24259 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 24170 avec CONNECTED, 89 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 183097 systemes
  - sans CONNECTED : 0.0% sur 41136 systemes
