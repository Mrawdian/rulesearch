...
genere 2026-08-29 12:14 UTC — 182447 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 99103 systemes
...
- moteur actif `0caa9267db60` (138705 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 89057 | 44278 | 6059 | 3012 | 8954 | 7109 | 9354 | 9156 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 87275 | 20414 | 36846 | 43 | 12042 | 4475 | 35 | 13414 | 15.4% |
...
- candidats AVEC connectivite : 9283, dont T2 : 100%
- candidats SANS connectivite : 13724, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9628 systemes avec CONNECTED sur 75150 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*18717 candidats sur 23007 portent les champs bruts (81%).*

- `5c556c16ea8b` — 12752 candidats
  - AVEC connectivite (5155) : resistance **41.2%**
  - SANS connectivite (7597) : resistance **21.6%**
...
- `5c556c16ea8b` — 12752 candidats
  - AVEC connectivite (5155) : T0=12.99 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (7597) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 72649 systemes
  - sans CONNECTED : 0.0% sur 16408 systemes
