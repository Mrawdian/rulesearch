...
genere 2026-09-03 01:02 UTC — 325465 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 242121 systemes
...
- moteur actif `0caa9267db60` (281723 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 161280 | 80120 | 10957 | 5386 | 16430 | 12715 | 17084 | 16525 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 158070 | 36845 | 66796 | 64 | 21871 | 8166 | 65 | 24251 | 15.3% |
...
- candidats SANS connectivite : 24561, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **17358 systemes avec CONNECTED sur 134075 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*36923 candidats sur 41213 portent les champs bruts (90%).*

- `5c556c16ea8b` — 30958 candidats
  - AVEC connectivite (12524) : resistance **41.1%**
  - SANS connectivite (18434) : resistance **21.2%**
...
- `5c556c16ea8b` — 30958 candidats
  ...
  - SANS connectivite (18434) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 131574 systemes
  - sans CONNECTED : 0.0% sur 29706 systemes
