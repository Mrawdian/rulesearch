...
genere 2026-08-27 06:11 UTC — 84368 systemes evalues
...
- moteur actif `0caa9267db60` (40626 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 39541 | 19690 | 2714 | 1348 | 3936 | 3114 | 4178 | 4049 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 38712 | 8920 | 16475 | 22 | 5366 | 2018 | 21 | 5890 | 15.2% |
...
- candidats AVEC connectivite : 4176, dont T2 : 100%
- candidats SANS connectivite : 6200, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4452 systemes avec CONNECTED sur 34834 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6086 candidats sur 10376 portent les champs bruts (59%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 121 candidats
  - AVEC connectivite (48) : resistance **44.7%**
  - SANS connectivite (73) : resistance **21.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 121 candidats
  - AVEC connectivite (48) : T0=12.88 T1=0.00 T2=3.23 — pondere **6.46**
  - SANS connectivite (73) : T0=15.42 T1=0.00 T2=2.53 — pondere **5.07**
...
- TROP-CHER : 4483 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4452 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 32333 systemes
  - sans CONNECTED : 0.0% sur 7208 systemes
