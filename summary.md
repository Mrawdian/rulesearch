...
genere 2026-08-29 07:51 UTC — 175503 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 92159 systemes
...
- moteur actif `0caa9267db60` (131761 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 85561 | 42589 | 5818 | 2892 | 8578 | 6790 | 8979 | 8828 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 83827 | 19572 | 35437 | 39 | 11558 | 4274 | 35 | 12906 | 15.4% |
...
- candidats AVEC connectivite : 8955, dont T2 : 100%
- candidats SANS connectivite : 13216, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9253 systemes avec CONNECTED sur 72350 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*17881 candidats sur 22171 portent les champs bruts (81%).*

- `5c556c16ea8b` — 11916 candidats
  - AVEC connectivite (4827) : resistance **41.1%**
  - SANS connectivite (7089) : resistance **21.6%**
...
- `5c556c16ea8b` — 11916 candidats
  - AVEC connectivite (4827) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (7089) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.33**
...
- TROP-CHER : 9298 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 9253 avec CONNECTED, 45 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 69849 systemes
  - sans CONNECTED : 0.0% sur 15712 systemes
