...
genere 2026-08-26 18:42 UTC — 58965 systemes evalues
...
- moteur actif `0caa9267db60` (15223 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 26702 | 13316 | 1822 | 902 | 2647 | 2108 | 2844 | 2732 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 26148 | 6014 | 11084 | 15 | 3646 | 1345 | 10 | 4034 | 15.4% |
...
- candidats SANS connectivite : 4344, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3118 systemes avec CONNECTED sur 24344 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2913 candidats sur 7203 portent les champs bruts (40%).*
...
- `b71bb0907fb5` — 53 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 44 candidats
  - AVEC connectivite (15) : resistance **44.0%**
  - SANS connectivite (29) : resistance **15.4%**
...
- `62448a55927e` — 44 candidats
  ...
  - SANS connectivite (29) : T0=16.34 T1=0.00 T2=2.45 — pondere **4.90**
...
- TROP-CHER : 3138 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3118 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 21843 systemes
  - sans CONNECTED : 0.0% sur 4859 systemes
