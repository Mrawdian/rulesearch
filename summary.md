...
genere 2026-08-27 00:17 UTC — 71323 systemes evalues
...
- moteur actif `0caa9267db60` (27581 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 32955 | 16371 | 2267 | 1114 | 3277 | 2622 | 3514 | 3367 | 10.2% |
...
- candidats AVEC connectivite : 3494, dont T2 : 100%
- candidats SANS connectivite : 5245, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3788 systemes avec CONNECTED sur 29443 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4449 candidats sur 8739 portent les champs bruts (51%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 772 candidats
  - AVEC connectivite (314) : resistance **41.4%**
...
- `ab89a63b01ef` — 772 candidats
  - AVEC connectivite (314) : T0=13.19 T1=0.00 T2=3.08 — pondere **6.15**
...
- TROP-CHER : 3813 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3788 avec CONNECTED, 25 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 26942 systemes
  - sans CONNECTED : 0.0% sur 6013 systemes
