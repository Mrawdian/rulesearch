...
genere 2026-09-02 09:22 UTC — 307552 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 224208 systemes
...
- moteur actif `0caa9267db60` (263810 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 152231 | 75639 | 10356 | 5100 | 15469 | 11975 | 16116 | 15631 | 10.3% |
...
- candidats AVEC connectivite : 15758, dont T2 : 100%
...
- **16390 systemes avec CONNECTED sur 126769 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*34650 candidats sur 38940 portent les champs bruts (89%).*

- `5c556c16ea8b` — 28685 candidats
  - AVEC connectivite (11630) : resistance **41.1%**
...
- `5c556c16ea8b` — 28685 candidats
  - AVEC connectivite (11630) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 16463 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16390 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 124268 systemes
  - sans CONNECTED : 0.0% sur 27963 systemes
