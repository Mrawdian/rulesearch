...
genere 2026-09-07 07:05 UTC — 430640 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 347296 systemes
...
- moteur actif `0caa9267db60` (386898 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 214389 | 106466 | 14604 | 7148 | 21720 | 16836 | 22803 | 22081 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 210136 | 48921 | 88597 | 81 | 29292 | 10844 | 75 | 32308 | 15.4% |
...
- candidats AVEC connectivite : 22208, dont T2 : 100%
- candidats SANS connectivite : 32618, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23077 systemes avec CONNECTED sur 177497 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*50536 candidats sur 54826 portent les champs bruts (92%).*

- `5c556c16ea8b` — 44571 candidats
  - AVEC connectivite (18080) : resistance **41.1%**
  - SANS connectivite (26491) : resistance **21.3%**
...
- `5c556c16ea8b` — 44571 candidats
  - AVEC connectivite (18080) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (26491) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 174996 systemes
  - sans CONNECTED : 0.0% sur 39393 systemes
