...
| connect | 4 | 3 | 17140 | 8570 | 1108 | 591 | 1702 | 1363 | 1867 | 1724 | 10.1% |
...
- candidats AVEC connectivite : 1851, dont T2 : 100%
- candidats SANS connectivite : 2872, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2141 systemes avec CONNECTED sur 16501 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*433 candidats sur 4723 portent les champs bruts (9%).*
...
- `e3baecf8377b` — 169 candidats
  - AVEC connectivite (68) : resistance **42.8%**
...
- `e3baecf8377b` — 169 candidats
  - AVEC connectivite (68) : T0=13.25 T1=0.00 T2=3.22 — pondere **6.44**
...
- TROP-CHER : 2158 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2141 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14000 systemes
  - sans CONNECTED : 0.0% sur 3140 systemes
