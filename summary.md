...
genere 2026-08-26 17:16 UTC — 55593 systemes evalues
...
- moteur actif `0caa9267db60` (11851 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
| connect | 4 | 3 | 24998 | 12480 | 1703 | 844 | 2474 | 1972 | 2670 | 2544 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 24480 | 5659 | 10358 | 14 | 3420 | 1244 | 10 | 3775 | 15.4% |
...
- candidats SANS connectivite : 4085, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2944 systemes avec CONNECTED sur 22938 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2466 candidats sur 6756 portent les champs bruts (37%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 156 candidats
  - AVEC connectivite (57) : resistance **41.2%**
  - SANS connectivite (99) : resistance **20.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `23303c299f39` — 156 candidats
  ...
  - SANS connectivite (99) : T0=16.16 T1=0.00 T2=2.64 — pondere **5.27**
  - test de permutation : **p = 0.1989** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 2964 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2944 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 20437 systemes
  - sans CONNECTED : 0.0% sur 4561 systemes
