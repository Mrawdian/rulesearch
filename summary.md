...
genere 2026-08-31 23:01 UTC — 265614 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 182270 systemes
...
- moteur actif `0caa9267db60` (221872 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 131070 | 65154 | 8847 | 4407 | 13280 | 10362 | 13828 | 13486 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 128429 | 29951 | 54249 | 56 | 17789 | 6647 | 57 | 19670 | 15.3% |
...
- candidats SANS connectivite : 19980, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14102 systemes avec CONNECTED sur 109451 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*29303 candidats sur 33593 portent les champs bruts (87%).*

- `5c556c16ea8b` — 23338 candidats
  - AVEC connectivite (9485) : resistance **41.0%**
  - SANS connectivite (13853) : resistance **21.4%**
...
- `5c556c16ea8b` — 23338 candidats
  ...
  - SANS connectivite (13853) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 106950 systemes
  - sans CONNECTED : 0.0% sur 24120 systemes
