...
genere 2026-09-01 01:08 UTC — 268275 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 184931 systemes
...
- moteur actif `0caa9267db60` (224533 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 132413 | 65802 | 8956 | 4439 | 13424 | 10466 | 13980 | 13630 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 129747 | 30238 | 54822 | 57 | 17971 | 6718 | 57 | 19874 | 15.3% |
...
- candidats AVEC connectivite : 13757, dont T2 : 100%
- candidats SANS connectivite : 20184, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14254 systemes avec CONNECTED sur 110536 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*29651 candidats sur 33941 portent les champs bruts (87%).*

- `5c556c16ea8b` — 23686 candidats
  - AVEC connectivite (9629) : resistance **41.0%**
  - SANS connectivite (14057) : resistance **21.3%**
...
- `5c556c16ea8b` — 23686 candidats
  - AVEC connectivite (9629) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (14057) : T0=15.93 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 108035 systemes
  - sans CONNECTED : 0.0% sur 24378 systemes
