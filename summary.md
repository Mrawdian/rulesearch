...
genere 2026-08-25 22:50 UTC — 9284 systemes evalues
...
- `89c65c03c4ad` : 310 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
**7776 enregistrements (84%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
