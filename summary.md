...
genere 2026-08-27 01:55 UTC — 74966 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 10059 systemes
...
- moteur actif `0caa9267db60` (31224 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 34793 | 17315 | 2395 | 1177 | 3451 | 2767 | 3700 | 3544 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 34058 | 7852 | 14482 | 20 | 4724 | 1773 | 18 | 5189 | 15.2% |
...
- candidats AVEC connectivite : 3671, dont T2 : 100%
- candidats SANS connectivite : 5499, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3974 systemes avec CONNECTED sur 30964 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4880 candidats sur 9170 portent les champs bruts (53%).*
...
- `ab89a63b01ef` — 1203 candidats
  - AVEC connectivite (491) : resistance **41.1%**
  - SANS connectivite (712) : resistance **21.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1203 candidats
  - AVEC connectivite (491) : T0=13.04 T1=0.00 T2=3.03 — pondere **6.07**
  - SANS connectivite (712) : T0=15.91 T1=0.00 T2=2.68 — pondere **5.35**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 28463 systemes
  - sans CONNECTED : 0.0% sur 6330 systemes
