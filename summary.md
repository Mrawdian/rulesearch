...
genere 2026-08-29 00:44 UTC — 163756 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 80412 systemes
...
- moteur actif `0caa9267db60` (120014 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 79622 | 39610 | 5422 | 2701 | 7958 | 6343 | 8368 | 8209 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 78019 | 18137 | 33015 | 36 | 10772 | 3979 | 32 | 12043 | 15.4% |
...
- candidats AVEC connectivite : 8336, dont T2 : 100%
- candidats SANS connectivite : 12353, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8642 systemes avec CONNECTED sur 67455 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*16399 candidats sur 20689 portent les champs bruts (79%).*

- `5c556c16ea8b` — 10434 candidats
  - AVEC connectivite (4208) : resistance **41.1%**
  - SANS connectivite (6226) : resistance **21.7%**
...
- `5c556c16ea8b` — 10434 candidats
  - AVEC connectivite (4208) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (6226) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.35**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 64954 systemes
  - sans CONNECTED : 0.0% sur 14668 systemes
