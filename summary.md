...
| ref | 4 | 3 | 17428 | 4099 | 7363 | 12 | 2382 | 889 | 7 | 2676 | 15.4% |
...
- candidats SANS connectivite : 2986, dont T2 : 100%
...
*613 candidats sur 4903 portent les champs bruts (13%).*
...
- `e3baecf8377b` — 349 candidats
  - AVEC connectivite (134) : resistance **43.7%**
  - SANS connectivite (215) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 349 candidats
  ...
  - SANS connectivite (215) : T0=16.00 T1=0.00 T2=2.66 — pondere **5.31**
...
**2 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0050).
