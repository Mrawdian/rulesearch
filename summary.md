...
genere 2026-08-26 02:08 UTC — 17526 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 8552 systemes
...
| connect | 4 | 3 | 8804 | 4428 | 576 | 296 | 837 | 703 | 953 | 904 | 10.3% |
...
- candidats AVEC connectivite : 907, dont T2 : 100%
...
- **953 systemes avec CONNECTED sur 7295 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1078 candidats
  - AVEC connectivite (428) : T0=13.33 T1=0.00 T2=2.86 — pondere **5.71**
...
- TROP-CHER : 956 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 953 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 7238 systemes
  - sans CONNECTED : 0.0% sur 1566 systemes
