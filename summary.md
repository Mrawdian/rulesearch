...
genere 2026-09-01 01:10 UTC — 268320 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 184976 systemes
...
- moteur actif `0caa9267db60` (224578 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 132443 | 65818 | 8959 | 4439 | 13426 | 10469 | 13981 | 13633 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 129762 | 30240 | 54828 | 57 | 17973 | 6718 | 57 | 19879 | 15.3% |
...
- candidats AVEC connectivite : 13760, dont T2 : 100%
- candidats SANS connectivite : 20189, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14255 systemes avec CONNECTED sur 110560 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*29659 candidats sur 33949 portent les champs bruts (87%).*

- `5c556c16ea8b` — 23694 candidats
  - AVEC connectivite (9632) : resistance **41.0%**
  - SANS connectivite (14062) : resistance **21.3%**
...
- `5c556c16ea8b` — 23694 candidats
  - AVEC connectivite (9632) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (14062) : T0=15.93 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 14322 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14255 avec CONNECTED, 67 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 108059 systemes
  - sans CONNECTED : 0.0% sur 24384 systemes
