...
- moteur actif `0caa9267db60` (6853 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22474 | 11199 | 1511 | 767 | 2246 | 1778 | 2406 | 2286 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 22006 | 5103 | 9281 | 13 | 3077 | 1126 | 10 | 3396 | 15.4% |
...
- candidats AVEC connectivite : 2413, dont T2 : 100%
- candidats SANS connectivite : 3706, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2680 systemes avec CONNECTED sur 20843 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1829 candidats sur 6119 portent les champs bruts (30%).*
...
- `06fe04a859f1` — 714 candidats
  - AVEC connectivite (275) : resistance **41.1%**
  - SANS connectivite (439) : resistance **20.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 714 candidats
  - AVEC connectivite (275) : T0=13.31 T1=0.00 T2=3.03 — pondere **6.05**
  - SANS connectivite (439) : T0=16.03 T1=0.00 T2=2.62 — pondere **5.23**
...
- TROP-CHER : 2700 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2680 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18342 systemes
  - sans CONNECTED : 0.0% sur 4132 systemes
