...
genere 2026-08-27 22:40 UTC — 117242 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 33898 systemes
...
- moteur actif `0caa9267db60` (73500 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 56128 | 27946 | 3881 | 1904 | 5568 | 4448 | 5933 | 5726 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 54999 | 12686 | 23356 | 26 | 7632 | 2843 | 25 | 8429 | 15.3% |
...
- candidats SANS connectivite : 8739, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6207 systemes avec CONNECTED sur 48342 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10302 candidats sur 14592 portent les champs bruts (71%).*

- `5c556c16ea8b` — 4337 candidats
  - AVEC connectivite (1725) : resistance **42.0%**
  - SANS connectivite (2612) : resistance **22.5%**
...
- `5c556c16ea8b` — 4337 candidats
  ...
  - SANS connectivite (2612) : T0=15.78 T1=0.00 T2=2.71 — pondere **5.43**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 45841 systemes
  - sans CONNECTED : 0.0% sur 10287 systemes
