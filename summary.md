...
genere 2026-08-28 17:36 UTC — 151354 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 68010 systemes
...
- moteur actif `0caa9267db60` (107612 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 73353 | 36434 | 4997 | 2507 | 7362 | 5843 | 7745 | 7528 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 71886 | 16708 | 30390 | 33 | 9928 | 3700 | 31 | 11093 | 15.4% |
...
- candidats AVEC connectivite : 7655, dont T2 : 100%
...
- **8019 systemes avec CONNECTED sur 62341 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*14768 candidats sur 19058 portent les champs bruts (77%).*

- `5c556c16ea8b` — 8803 candidats
  - AVEC connectivite (3527) : resistance **41.1%**
...
- `5c556c16ea8b` — 8803 candidats
  - AVEC connectivite (3527) : T0=13.02 T1=0.00 T2=3.00 — pondere **5.99**
...
- TROP-CHER : 8060 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8019 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 59840 systemes
  - sans CONNECTED : 0.0% sur 13513 systemes
