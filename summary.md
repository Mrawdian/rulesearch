...
- moteur actif `0caa9267db60` (6793 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22444 | 11185 | 1508 | 767 | 2241 | 1777 | 2404 | 2281 | 10.2% |
...
- candidats AVEC connectivite : 2408, dont T2 : 100%
- candidats SANS connectivite : 3702, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2678 systemes avec CONNECTED sur 20820 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1820 candidats sur 6110 portent les champs bruts (30%).*
...
- `06fe04a859f1` — 705 candidats
  - AVEC connectivite (270) : resistance **41.3%**
...
- `06fe04a859f1` — 705 candidats
  - AVEC connectivite (270) : T0=13.28 T1=0.00 T2=3.04 — pondere **6.07**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18319 systemes
  - sans CONNECTED : 0.0% sur 4125 systemes
