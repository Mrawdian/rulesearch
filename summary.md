...
genere 2026-08-26 18:30 UTC — 58519 systemes evalues
...
- moteur actif `0caa9267db60` (14777 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 26478 | 13197 | 1805 | 895 | 2627 | 2092 | 2821 | 2714 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 25926 | 5961 | 10997 | 15 | 3615 | 1329 | 10 | 3999 | 15.4% |
...
- candidats SANS connectivite : 4309, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3095 systemes avec CONNECTED sur 24154 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2860 candidats sur 7150 portent les champs bruts (40%).*
...
- `0a74109317e5` — 80 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `8f22f0d2d442` — 56 candidats
  - AVEC connectivite (18) : resistance **42.4%**
  - SANS connectivite (38) : resistance **18.8%**
...
- `8f22f0d2d442` — 56 candidats
  ...
  - SANS connectivite (38) : T0=16.26 T1=0.00 T2=2.55 — pondere **5.11**
...
- TROP-CHER : 3115 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3095 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 21653 systemes
  - sans CONNECTED : 0.0% sur 4825 systemes
