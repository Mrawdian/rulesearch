...
genere 2026-09-08 12:56 UTC — 457837 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 374493 systemes
...
- moteur actif `0caa9267db60` (414095 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 228132 | 113308 | 15530 | 7635 | 23073 | 17874 | 24319 | 23489 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 223590 | 52072 | 94255 | 89 | 31158 | 11553 | 81 | 34364 | 15.4% |
...
- candidats AVEC connectivite : 23616, dont T2 : 100%
- candidats SANS connectivite : 34674, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **24593 systemes avec CONNECTED sur 188786 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*54000 candidats sur 58290 portent les champs bruts (93%).*

- `5c556c16ea8b` — 48035 candidats
  - AVEC connectivite (19488) : resistance **41.2%**
  - SANS connectivite (28547) : resistance **21.3%**
...
- `5c556c16ea8b` — 48035 candidats
  - AVEC connectivite (19488) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (28547) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 186285 systemes
  - sans CONNECTED : 0.0% sur 41847 systemes
