...
genere 2026-08-26 17:20 UTC — 55710 systemes evalues
...
- moteur actif `0caa9267db60` (11968 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
| ref | 4 | 3 | 24537 | 5674 | 10377 | 14 | 3429 | 1248 | 10 | 3785 | 15.4% |
...
- candidats SANS connectivite : 4095, dont T2 : 100%
...
*2489 candidats sur 6779 portent les champs bruts (37%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 179 candidats
  - AVEC connectivite (70) : resistance **43.2%**
  - SANS connectivite (109) : resistance **20.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `23303c299f39` — 179 candidats
  ...
  - SANS connectivite (109) : T0=16.20 T1=0.00 T2=2.61 — pondere **5.23**
...
**4 serie(s) reproductible(s) sur 7 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0335).
