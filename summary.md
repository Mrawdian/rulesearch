...
| connect | 4 | 3 | 7172 | 3609 | 471 | 250 | 681 | 582 | 747 | 752 | 10.5% |
| ref | 4 | 3 | 7009 | 1694 | 2917 | 1 | 941 | 348 | 2 | 1106 | 15.8% |
...
- candidats AVEC connectivite : 755, dont T2 : 100%
- candidats SANS connectivite : 1110, dont T2 : 100%
...
- **747 systemes avec CONNECTED sur 5936 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 700 candidats
  - AVEC connectivite (276) : T0=13.23 T1=0.00 T2=2.93 — pondere **5.86**
  - SANS connectivite (424) : T0=15.80 T1=0.00 T2=2.64 — pondere **5.28**
...
- TROP-CHER : 749 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 747 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 5879 systemes
  - sans CONNECTED : 0.0% sur 1293 systemes
