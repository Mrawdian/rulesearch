...
- moteur actif `0caa9267db60` (7344 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22728 | 11329 | 1530 | 773 | 2267 | 1802 | 2434 | 2309 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 22243 | 5157 | 9381 | 13 | 3108 | 1139 | 10 | 3435 | 15.4% |
...
- candidats AVEC connectivite : 2436, dont T2 : 100%
- candidats SANS connectivite : 3745, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2708 systemes avec CONNECTED sur 21054 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1891 candidats sur 6181 portent les champs bruts (31%).*
...
- `06fe04a859f1` — 776 candidats
  - AVEC connectivite (298) : resistance **41.1%**
  - SANS connectivite (478) : resistance **20.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 776 candidats
  - AVEC connectivite (298) : T0=13.33 T1=0.00 T2=3.02 — pondere **6.04**
  - SANS connectivite (478) : T0=16.05 T1=0.00 T2=2.61 — pondere **5.23**
...
- TROP-CHER : 2728 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2708 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18553 systemes
  - sans CONNECTED : 0.0% sur 4175 systemes
