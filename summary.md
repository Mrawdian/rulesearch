...
genere 2026-08-26 13:41 UTC — 47323 systemes evalues
...
- moteur actif `0caa9267db60` (3581 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20827 | 10396 | 1381 | 720 | 2069 | 1656 | 2215 | 2132 | 10.2% |
...
- candidats AVEC connectivite : 2259, dont T2 : 100%
- candidats SANS connectivite : 3422, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2489 systemes avec CONNECTED sur 19510 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1391 candidats sur 5681 portent les champs bruts (24%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 276 candidats
  - AVEC connectivite (121) : resistance **39.1%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 276 candidats
  - AVEC connectivite (121) : T0=13.30 T1=0.00 T2=2.81 — pondere **5.62**
  - SANS connectivite (155) : T0=16.25 T1=0.00 T2=2.75 — pondere **5.51**
  - test de permutation : **p = 0.7836** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
- TROP-CHER : 2506 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2489 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 17009 systemes
  - sans CONNECTED : 0.0% sur 3818 systemes
