...
genere 2026-08-26 17:47 UTC — 56724 systemes evalues
...
- `84fba70921e0` : 43 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (12982 systemes) : `06fe04a859f1`, `23303c299f39`, `84fba70921e0`, `b71bb0907fb5`, `e40600351a72`, `e8a1f930f7b9`
...
**7509 enregistrements (13%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 25579 | 12760 | 1738 | 861 | 2537 | 2018 | 2735 | 2614 | 10.2% |
...
- candidats AVEC connectivite : 2741, dont T2 : 100%
- candidats SANS connectivite : 4174, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3009 systemes avec CONNECTED sur 23413 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2625 candidats sur 6915 portent les champs bruts (38%).*
...
- TROP-CHER : 3029 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3009 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 20912 systemes
  - sans CONNECTED : 0.0% sur 4667 systemes
