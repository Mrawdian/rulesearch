...
genere 2026-09-09 20:55 UTC — 486012 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 402668 systemes
...
- moteur actif `0caa9267db60` (442270 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 242355 | 120350 | 16525 | 8112 | 24521 | 19003 | 25822 | 24948 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 237542 | 55368 | 100074 | 95 | 33077 | 12275 | 87 | 36545 | 15.4% |
...
- candidats AVEC connectivite : 25075, dont T2 : 100%
...
- **26096 systemes avec CONNECTED sur 200370 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*57640 candidats sur 61930 portent les champs bruts (93%).*

- `5c556c16ea8b` — 51675 candidats
  - AVEC connectivite (20947) : resistance **41.2%**
...
- `5c556c16ea8b` — 51675 candidats
  - AVEC connectivite (20947) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 26193 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 26096 avec CONNECTED, 97 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 197869 systemes
  - sans CONNECTED : 0.0% sur 44486 systemes
