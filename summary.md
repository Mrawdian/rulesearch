...
genere 2026-08-27 01:34 UTC — 74109 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 9202 systemes
...
- moteur actif `0caa9267db60` (30367 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 34361 | 17092 | 2351 | 1168 | 3413 | 2732 | 3665 | 3500 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 33633 | 7755 | 14296 | 20 | 4668 | 1748 | 17 | 5129 | 15.2% |
...
- candidats AVEC connectivite : 3627, dont T2 : 100%
- candidats SANS connectivite : 5439, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3939 systemes avec CONNECTED sur 30611 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4776 candidats sur 9066 portent les champs bruts (53%).*
...
- `ab89a63b01ef` — 1099 candidats
  - AVEC connectivite (447) : resistance **41.0%**
  - SANS connectivite (652) : resistance **21.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1099 candidats
  - AVEC connectivite (447) : T0=13.08 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (652) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.33**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- TROP-CHER : 3966 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 3939 avec CONNECTED, 27 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 28110 systemes
  - sans CONNECTED : 0.0% sur 6251 systemes
