...
genere 2026-09-09 09:36 UTC — 476326 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 392982 systemes
...
- moteur actif `0caa9267db60` (432584 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 237473 | 117910 | 16195 | 7956 | 24023 | 18604 | 25293 | 24477 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 232738 | 54245 | 98042 | 92 | 32419 | 12018 | 84 | 35819 | 15.4% |
...
- candidats AVEC connectivite : 24604, dont T2 : 100%
...
- **25567 systemes avec CONNECTED sur 196399 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*56443 candidats sur 60733 portent les champs bruts (93%).*

- `5c556c16ea8b` — 50478 candidats
  - AVEC connectivite (20476) : resistance **41.2%**
...
- `5c556c16ea8b` — 50478 candidats
  - AVEC connectivite (20476) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 25661 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25567 avec CONNECTED, 94 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 193898 systemes
  - sans CONNECTED : 0.0% sur 43575 systemes
