...
genere 2026-08-30 13:26 UTC — 219860 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 136516 systemes
...
- moteur actif `0caa9267db60` (176118 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 107967 | 53659 | 7339 | 3608 | 10862 | 8571 | 11423 | 11095 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 105778 | 24671 | 44668 | 49 | 14610 | 5470 | 41 | 16260 | 15.4% |
...
- candidats AVEC connectivite : 11222, dont T2 : 100%
- candidats SANS connectivite : 16570, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11697 systemes avec CONNECTED sur 90599 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*23502 candidats sur 27792 portent les champs bruts (85%).*

- `5c556c16ea8b` — 17537 candidats
  - AVEC connectivite (7094) : resistance **41.1%**
  - SANS connectivite (10443) : resistance **21.5%**
...
- `5c556c16ea8b` — 17537 candidats
  - AVEC connectivite (7094) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (10443) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 11748 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11697 avec CONNECTED, 51 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 88098 systemes
  - sans CONNECTED : 0.0% sur 19869 systemes
