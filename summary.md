...
genere 2026-08-26 10:44 UTC — 39499 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `615abe43d6bc` : 7172 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
- `e3baecf8377b` : 906 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
**8372 enregistrements (21%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 16871 | 8423 | 1085 | 584 | 1678 | 1341 | 1841 | 1707 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 16513 | 3888 | 6999 | 11 | 2249 | 833 | 7 | 2526 | 15.3% |
...
- candidats AVEC connectivite : 1834, dont T2 : 100%
- candidats SANS connectivite : 2836, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2115 systemes avec CONNECTED sur 16293 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*380 candidats sur 4670 portent les champs bruts (8%).*
...
- `e3baecf8377b` — 116 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (51) : resistance **40.5%**
  - SANS connectivite (65) : resistance **19.7%**
...
- `e3baecf8377b` — 116 candidats
  - AVEC connectivite (51) : T0=13.53 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (65) : T0=15.71 T1=0.00 T2=2.48 — pondere **4.95**
...
- TROP-CHER : 2132 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2115 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 13792 systemes
  - sans CONNECTED : 0.0% sur 3079 systemes
