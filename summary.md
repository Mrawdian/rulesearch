...
genere 2026-08-28 06:37 UTC — 132356 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 49012 systemes
...
- moteur actif `0caa9267db60` (88614 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 63762 | 31688 | 4380 | 2166 | 6380 | 5074 | 6698 | 6555 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 62479 | 14449 | 26462 | 29 | 8700 | 3227 | 28 | 9582 | 15.3% |
...
- candidats AVEC connectivite : 6682, dont T2 : 100%
- candidats SANS connectivite : 9892, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6972 systemes avec CONNECTED sur 54519 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12284 candidats sur 16574 portent les champs bruts (74%).*

- `5c556c16ea8b` — 6319 candidats
  - AVEC connectivite (2554) : resistance **41.5%**
  - SANS connectivite (3765) : resistance **22.0%**
...
- `5c556c16ea8b` — 6319 candidats
  - AVEC connectivite (2554) : T0=12.98 T1=0.00 T2=3.01 — pondere **6.03**
  - SANS connectivite (3765) : T0=15.86 T1=0.00 T2=2.69 — pondere **5.37**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 52018 systemes
