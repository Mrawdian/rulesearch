...
genere 2026-08-27 11:04 UTC — 94701 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 18378 systemes
- `5c556c16ea8b` : 11357 systemes
...
- moteur actif `0caa9267db60` (50959 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 44752 | 22313 | 3073 | 1517 | 4456 | 3537 | 4707 | 4568 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 43834 | 10108 | 18605 | 25 | 6090 | 2277 | 22 | 6706 | 15.3% |
...
- candidats AVEC connectivite : 4695, dont T2 : 100%
- candidats SANS connectivite : 7016, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4981 systemes avec CONNECTED sur 39057 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*7421 candidats sur 11711 portent les champs bruts (63%).*
...
- `ab89a63b01ef` — 2280 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 1456 candidats
  - AVEC connectivite (567) : resistance **41.5%**
  - SANS connectivite (889) : resistance **22.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 2280 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 1456 candidats
  - AVEC connectivite (567) : T0=13.07 T1=0.00 T2=3.03 — pondere **6.05**
  - SANS connectivite (889) : T0=15.77 T1=0.00 T2=2.66 — pondere **5.33**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 36556 systemes
  - sans CONNECTED : 0.0% sur 8196 systemes
