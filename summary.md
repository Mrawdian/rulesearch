...
genere 2026-08-28 15:28 UTC — 147574 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 64230 systemes
...
- moteur actif `0caa9267db60` (103832 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 71443 | 35474 | 4878 | 2434 | 7167 | 5694 | 7553 | 7328 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 70016 | 16252 | 29585 | 32 | 9690 | 3612 | 31 | 10811 | 15.4% |
...
- candidats AVEC connectivite : 7455, dont T2 : 100%
- candidats SANS connectivite : 11121, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7827 systemes avec CONNECTED sur 60778 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*14286 candidats sur 18576 portent les champs bruts (77%).*

- `5c556c16ea8b` — 8321 candidats
  - AVEC connectivite (3327) : resistance **41.2%**
  - SANS connectivite (4994) : resistance **21.8%**
...
- `5c556c16ea8b` — 8321 candidats
  - AVEC connectivite (3327) : T0=13.01 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (4994) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.37**
...
- TROP-CHER : 7868 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7827 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 58277 systemes
  - sans CONNECTED : 0.0% sur 13166 systemes
