...
genere 2026-08-30 22:26 UTC — 232585 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 149241 systemes
...
- moteur actif `0caa9267db60` (188843 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 114400 | 56887 | 7771 | 3835 | 11489 | 9043 | 12102 | 11772 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 112070 | 26146 | 47364 | 52 | 15460 | 5790 | 49 | 17199 | 15.3% |
...
- candidats AVEC connectivite : 11899, dont T2 : 100%
...
- **12376 systemes avec CONNECTED sur 95912 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*25118 candidats sur 29408 portent les champs bruts (85%).*

- `5c556c16ea8b` — 19153 candidats
  - AVEC connectivite (7771) : resistance **41.0%**
...
- `5c556c16ea8b` — 19153 candidats
  - AVEC connectivite (7771) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.98**
...
- TROP-CHER : 12435 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 12376 avec CONNECTED, 59 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 93411 systemes
  - sans CONNECTED : 0.0% sur 20989 systemes
