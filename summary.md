...
genere 2026-09-03 12:23 UTC — 338259 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 254915 systemes
...
- moteur actif `0caa9267db60` (294517 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 167739 | 83362 | 11386 | 5615 | 17078 | 13235 | 17773 | 17142 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 164405 | 38276 | 69498 | 66 | 22803 | 8488 | 66 | 25196 | 15.3% |
...
- candidats SANS connectivite : 25506, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18047 systemes avec CONNECTED sur 139355 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*38485 candidats sur 42775 portent les champs bruts (90%).*

- `5c556c16ea8b` — 32520 candidats
  - AVEC connectivite (13141) : resistance **41.1%**
  - SANS connectivite (19379) : resistance **21.2%**
...
- `5c556c16ea8b` — 32520 candidats
  ...
  - SANS connectivite (19379) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.29**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 136854 systemes
  - sans CONNECTED : 0.0% sur 30885 systemes
