...
genere 2026-08-27 22:14 UTC — 116416 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 33072 systemes
...
- moteur actif `0caa9267db60` (72674 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 55710 | 27756 | 3846 | 1890 | 5514 | 4412 | 5888 | 5684 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 54591 | 12587 | 23182 | 26 | 7575 | 2828 | 25 | 8366 | 15.3% |
...
- candidats SANS connectivite : 8676, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6162 systemes avec CONNECTED sur 48018 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10197 candidats sur 14487 portent les champs bruts (70%).*

- `5c556c16ea8b` — 4232 candidats
  - AVEC connectivite (1683) : resistance **41.9%**
  - SANS connectivite (2549) : resistance **22.5%**
...
- `5c556c16ea8b` — 4232 candidats
  ...
  - SANS connectivite (2549) : T0=15.80 T1=0.00 T2=2.72 — pondere **5.43**
...
- TROP-CHER : 6197 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6162 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 45517 systemes
  - sans CONNECTED : 0.0% sur 10193 systemes
