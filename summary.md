...
genere 2026-09-02 17:38 UTC — 316949 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 233605 systemes
...
- moteur actif `0caa9267db60` (273207 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 156976 | 78005 | 10683 | 5249 | 15960 | 12348 | 16633 | 16085 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 153858 | 35835 | 65098 | 64 | 21250 | 7956 | 63 | 23580 | 15.3% |
...
- candidats AVEC connectivite : 16212, dont T2 : 100%
...
- **16907 systemes avec CONNECTED sur 130640 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*35812 candidats sur 40102 portent les champs bruts (89%).*

- `5c556c16ea8b` — 29847 candidats
  - AVEC connectivite (12084) : resistance **41.0%**
...
- `5c556c16ea8b` — 29847 candidats
  - AVEC connectivite (12084) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 128139 systemes
  - sans CONNECTED : 0.0% sur 28837 systemes
