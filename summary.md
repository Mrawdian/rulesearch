...
genere 2026-08-27 20:35 UTC — 113151 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 29807 systemes
...
- moteur actif `0caa9267db60` (69409 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 54062 | 26918 | 3736 | 1837 | 5336 | 4281 | 5724 | 5523 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 52974 | 12224 | 22507 | 26 | 7332 | 2753 | 25 | 8105 | 15.3% |
...
- candidats AVEC connectivite : 5650, dont T2 : 100%
- candidats SANS connectivite : 8415, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5998 systemes avec CONNECTED sur 46681 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*9775 candidats sur 14065 portent les champs bruts (69%).*

- `5c556c16ea8b` — 3810 candidats
  - AVEC connectivite (1522) : resistance **42.0%**
  - SANS connectivite (2288) : resistance **22.4%**
...
- `5c556c16ea8b` — 3810 candidats
  - AVEC connectivite (1522) : T0=12.93 T1=0.00 T2=3.05 — pondere **6.11**
  - SANS connectivite (2288) : T0=15.77 T1=0.00 T2=2.70 — pondere **5.41**
...
- TROP-CHER : 6033 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 5998 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 44180 systemes
  - sans CONNECTED : 0.0% sur 9882 systemes
