...
genere 2026-08-28 03:49 UTC — 127372 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 44028 systemes
...
- moteur actif `0caa9267db60` (83630 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 61245 | 30464 | 4235 | 2072 | 6098 | 4870 | 6423 | 6296 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 60012 | 13887 | 25415 | 28 | 8355 | 3105 | 26 | 9194 | 15.3% |
...
- candidats AVEC connectivite : 6423, dont T2 : 100%
- candidats SANS connectivite : 9504, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6697 systemes avec CONNECTED sur 52475 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11637 candidats sur 15927 portent les champs bruts (73%).*

- `5c556c16ea8b` — 5672 candidats
  - AVEC connectivite (2295) : resistance **41.8%**
  - SANS connectivite (3377) : resistance **22.1%**
...
- `5c556c16ea8b` — 5672 candidats
  - AVEC connectivite (2295) : T0=12.98 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (3377) : T0=15.86 T1=0.00 T2=2.69 — pondere **5.38**
...
## cout
- temps total 39.1 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 6733 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6697 avec CONNECTED, 36 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 49974 systemes
  - sans CONNECTED : 0.0% sur 11271 systemes
