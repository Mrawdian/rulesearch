...
genere 2026-08-27 01:36 UTC — 74197 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 9290 systemes
...
- moteur actif `0caa9267db60` (30455 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 34405 | 17115 | 2354 | 1168 | 3417 | 2739 | 3668 | 3504 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 33677 | 7765 | 14313 | 20 | 4674 | 1753 | 18 | 5134 | 15.2% |
...
- candidats AVEC connectivite : 3631, dont T2 : 100%
- candidats SANS connectivite : 5444, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3942 systemes avec CONNECTED sur 30646 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4785 candidats sur 9075 portent les champs bruts (53%).*
...
- `ab89a63b01ef` — 1108 candidats
  - AVEC connectivite (451) : resistance **41.0%**
  - SANS connectivite (657) : resistance **21.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1108 candidats
  - AVEC connectivite (451) : T0=13.06 T1=0.00 T2=3.04 — pondere **6.07**
  - SANS connectivite (657) : T0=15.88 T1=0.00 T2=2.67 — pondere **5.33**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- TROP-CHER : 3970 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 3942 avec CONNECTED, 28 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 28145 systemes
  - sans CONNECTED : 0.0% sur 6260 systemes
