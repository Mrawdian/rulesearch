...
genere 2026-09-03 15:54 UTC — 342178 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 258834 systemes
...
- moteur actif `0caa9267db60` (298436 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 169711 | 84355 | 11513 | 5681 | 17260 | 13406 | 17984 | 17349 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 166352 | 38690 | 70313 | 67 | 23086 | 8601 | 66 | 25517 | 15.3% |
...
- candidats AVEC connectivite : 17476, dont T2 : 100%
- candidats SANS connectivite : 25827, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18258 systemes avec CONNECTED sur 140963 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39013 candidats sur 43303 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33048 candidats
  - AVEC connectivite (13348) : resistance **41.0%**
  - SANS connectivite (19700) : resistance **21.2%**
...
- `5c556c16ea8b` — 33048 candidats
  - AVEC connectivite (13348) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (19700) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.29**
...
- TROP-CHER : 18334 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18258 avec CONNECTED, 76 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 138462 systemes
  - sans CONNECTED : 0.0% sur 31249 systemes
