...
genere 2026-09-04 05:15 UTC — 356735 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 273391 systemes
...
- moteur actif `0caa9267db60` (312993 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 177057 | 87998 | 12044 | 5926 | 18004 | 13936 | 18768 | 18126 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 173563 | 40333 | 73300 | 70 | 24095 | 8998 | 70 | 26683 | 15.4% |
...
- candidats AVEC connectivite : 18253, dont T2 : 100%
- candidats SANS connectivite : 26993, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19042 systemes avec CONNECTED sur 146989 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*40956 candidats sur 45246 portent les champs bruts (91%).*

- `5c556c16ea8b` — 34991 candidats
  - AVEC connectivite (14125) : resistance **41.1%**
  - SANS connectivite (20866) : resistance **21.2%**
...
- `5c556c16ea8b` — 34991 candidats
  - AVEC connectivite (14125) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (20866) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 144488 systemes
  - sans CONNECTED : 0.0% sur 32569 systemes
