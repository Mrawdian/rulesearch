...
| connect | 4 | 3 | 17917 | 8960 | 1164 | 619 | 1776 | 1421 | 1952 | 1801 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 17530 | 4125 | 7397 | 12 | 2400 | 894 | 7 | 2695 | 15.4% |
...
- candidats AVEC connectivite : 1928, dont T2 : 100%
- candidats SANS connectivite : 3005, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2226 systemes avec CONNECTED sur 17136 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*643 candidats sur 4933 portent les champs bruts (13%).*
...
- `e3baecf8377b` — 379 candidats
  - AVEC connectivite (145) : resistance **44.2%**
  - SANS connectivite (234) : resistance **20.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 379 candidats
  - AVEC connectivite (145) : T0=12.93 T1=0.00 T2=3.23 — pondere **6.46**
  - SANS connectivite (234) : T0=16.06 T1=0.00 T2=2.62 — pondere **5.24**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
...
- TROP-CHER : 2243 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 2226 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14635 systemes
  - sans CONNECTED : 0.0% sur 3282 systemes
