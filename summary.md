...
genere 2026-09-08 03:18 UTC — 449160 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 365816 systemes
...
- moteur actif `0caa9267db60` (405418 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 223742 | 111109 | 15244 | 7473 | 22637 | 17537 | 23840 | 23050 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 219303 | 51098 | 92421 | 87 | 30566 | 11327 | 79 | 33707 | 15.4% |
...
- candidats AVEC connectivite : 23177, dont T2 : 100%
- candidats SANS connectivite : 34017, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **24114 systemes avec CONNECTED sur 185200 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*52904 candidats sur 57194 portent les champs bruts (92%).*

- `5c556c16ea8b` — 46939 candidats
  - AVEC connectivite (19049) : resistance **41.2%**
  - SANS connectivite (27890) : resistance **21.3%**
...
- `5c556c16ea8b` — 46939 candidats
  - AVEC connectivite (19049) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (27890) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
## cout
- temps total 140.1 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 24203 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 24114 avec CONNECTED, 89 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 182699 systemes
  - sans CONNECTED : 0.0% sur 41043 systemes
