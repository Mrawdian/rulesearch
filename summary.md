...
| connect | 4 | 3 | 17873 | 8945 | 1158 | 619 | 1770 | 1415 | 1945 | 1797 | 10.1% |
...
- candidats AVEC connectivite : 1924, dont T2 : 100%
- candidats SANS connectivite : 2997, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2219 systemes avec CONNECTED sur 17106 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*631 candidats sur 4921 portent les champs bruts (13%).*
...
- `e3baecf8377b` — 367 candidats
  - AVEC connectivite (141) : resistance **43.9%**
...
- `e3baecf8377b` — 367 candidats
  - AVEC connectivite (141) : T0=12.92 T1=0.00 T2=3.17 — pondere **6.34**
...
- TROP-CHER : 2236 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2219 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14605 systemes
  - sans CONNECTED : 0.0% sur 3268 systemes
