...
genere 2026-08-31 10:05 UTC — 248558 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 165214 systemes
...
- moteur actif `0caa9267db60` (204816 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 122453 | 60908 | 8303 | 4101 | 12321 | 9671 | 12941 | 12615 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 119990 | 28007 | 50651 | 53 | 16595 | 6202 | 54 | 18418 | 15.3% |
...
- candidats AVEC connectivite : 12742, dont T2 : 100%
- candidats SANS connectivite : 18728, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13215 systemes avec CONNECTED sur 102466 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*27180 candidats sur 31470 portent les champs bruts (86%).*

- `5c556c16ea8b` — 21215 candidats
  - AVEC connectivite (8614) : resistance **41.0%**
  - SANS connectivite (12601) : resistance **21.3%**
...
- `5c556c16ea8b` — 21215 candidats
  - AVEC connectivite (8614) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (12601) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 99965 systemes
