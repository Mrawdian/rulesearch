...
genere 2026-08-26 16:51 UTC — 54634 systemes evalues
...
- moteur actif `0caa9267db60` (10892 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
| connect | 4 | 3 | 24524 | 12238 | 1667 | 830 | 2432 | 1934 | 2616 | 2500 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 23995 | 5548 | 10147 | 14 | 3365 | 1216 | 10 | 3695 | 15.4% |
...
- candidats SANS connectivite : 4005, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2890 systemes avec CONNECTED sur 22541 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2342 candidats sur 6632 portent les champs bruts (35%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 32 candidats
  - AVEC connectivite (13) : resistance **34.5%**
  - SANS connectivite (19) : resistance **22.4%**
...
- `23303c299f39` — 32 candidats
  ...
  - SANS connectivite (19) : T0=18.00 T1=0.00 T2=2.68 — pondere **5.37**
  - *groupes trop petits (< 20) — aucun test, aucune conclusion*
...
- TROP-CHER : 2910 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2890 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 20040 systemes
  - sans CONNECTED : 0.0% sur 4484 systemes
