...
genere 2026-08-26 03:25 UTC — 20754 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 11780 systemes
...
| connect | 4 | 3 | 10433 | 5250 | 685 | 360 | 998 | 829 | 1133 | 1047 | 10.0% |
...
- candidats AVEC connectivite : 1050, dont T2 : 100%
...
- **1133 systemes avec CONNECTED sur 8620 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1461 candidats
  - AVEC connectivite (571) : T0=13.36 T1=0.00 T2=2.86 — pondere **5.72**
...
- TROP-CHER : 1137 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1133 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 8563 systemes
  - sans CONNECTED : 0.0% sur 1870 systemes
