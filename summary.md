...
genere 2026-09-02 17:21 UTC — 316637 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 233293 systemes
...
- moteur actif `0caa9267db60` (272895 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 156826 | 77935 | 10674 | 5243 | 15942 | 12335 | 16612 | 16074 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 153696 | 35802 | 65034 | 64 | 21220 | 7951 | 63 | 23550 | 15.3% |
...
- candidats AVEC connectivite : 16201, dont T2 : 100%
- candidats SANS connectivite : 23860, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16886 systemes avec CONNECTED sur 130519 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*35771 candidats sur 40061 portent les champs bruts (89%).*

- `5c556c16ea8b` — 29806 candidats
  - AVEC connectivite (12073) : resistance **41.0%**
  - SANS connectivite (17733) : resistance **21.2%**
...
- `5c556c16ea8b` — 29806 candidats
  - AVEC connectivite (12073) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (17733) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.29**
...
- TROP-CHER : 16959 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16886 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 128018 systemes
  - sans CONNECTED : 0.0% sur 28808 systemes
