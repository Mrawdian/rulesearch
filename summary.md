...
genere 2026-08-26 13:12 UTC — 45980 systemes evalues
...
- moteur actif `0caa9267db60` (2238 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20142 | 10056 | 1320 | 693 | 2021 | 1597 | 2156 | 2050 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 19723 | 4621 | 8331 | 13 | 2724 | 1019 | 7 | 3008 | 15.3% |
...
- candidats AVEC connectivite : 2177, dont T2 : 100%
- candidats SANS connectivite : 3318, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2430 systemes avec CONNECTED sur 18934 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1205 candidats sur 5495 portent les champs bruts (22%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 90 candidats
  - AVEC connectivite (39) : resistance **37.3%**
  - SANS connectivite (51) : resistance **20.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 90 candidats
  - AVEC connectivite (39) : T0=13.23 T1=0.00 T2=2.62 — pondere **5.23**
  - SANS connectivite (51) : T0=16.80 T1=0.00 T2=2.75 — pondere **5.49**
  - test de permutation : **p = 0.7096** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 2447 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2430 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16433 systemes
  - sans CONNECTED : 0.0% sur 3709 systemes
