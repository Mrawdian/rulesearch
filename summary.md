...
genere 2026-08-30 23:44 UTC — 234352 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 151008 systemes
...
- moteur actif `0caa9267db60` (190610 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 115298 | 57323 | 7829 | 3876 | 11576 | 9115 | 12202 | 11863 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 112939 | 26346 | 47730 | 53 | 15579 | 5835 | 50 | 17336 | 15.3% |
...
- candidats SANS connectivite : 17646, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12476 systemes avec CONNECTED sur 96659 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*25346 candidats sur 29636 portent les champs bruts (86%).*

- `5c556c16ea8b` — 19381 candidats
  - AVEC connectivite (7862) : resistance **41.0%**
  - SANS connectivite (11519) : resistance **21.4%**
...
- `5c556c16ea8b` — 19381 candidats
  ...
  - SANS connectivite (11519) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 94158 systemes
  - sans CONNECTED : 0.0% sur 21140 systemes
