...
genere 2026-08-26 22:02 UTC — 66371 systemes evalues
...
- moteur actif `0caa9267db60` (22629 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 29798 | 6870 | 12663 | 17 | 4117 | 1538 | 13 | 4580 | 15.4% |
...
- candidats SANS connectivite : 4890, dont T2 : 100%
...
*3851 candidats sur 8141 portent les champs bruts (47%).*
...
- `23303c299f39` — 225 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 174 candidats
  - AVEC connectivite (71) : resistance **44.5%**
  - SANS connectivite (103) : resistance **22.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 174 candidats
  ...
  - SANS connectivite (103) : T0=15.86 T1=0.00 T2=2.84 — pondere **5.69**
  - test de permutation : **p = 0.2939** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
