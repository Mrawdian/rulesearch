...
genere 2026-08-29 03:03 UTC — 167598 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 84254 systemes
...
- moteur actif `0caa9267db60` (123856 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 81570 | 40595 | 5547 | 2769 | 8185 | 6475 | 8567 | 8395 | 10.3% |
...
- candidats AVEC connectivite : 8522, dont T2 : 100%
...
- **8841 systemes avec CONNECTED sur 69054 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*16840 candidats sur 21130 portent les champs bruts (80%).*

- `5c556c16ea8b` — 10875 candidats
  - AVEC connectivite (4394) : resistance **41.2%**
...
- `5c556c16ea8b` — 10875 candidats
  - AVEC connectivite (4394) : T0=13.01 T1=0.00 T2=3.00 — pondere **5.99**
...
- TROP-CHER : 8885 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8841 avec CONNECTED, 44 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 66553 systemes
  - sans CONNECTED : 0.0% sur 15017 systemes
