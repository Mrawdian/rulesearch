...
genere 2026-09-02 13:18 UTC — 312118 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 228774 systemes
...
- moteur actif `0caa9267db60` (268376 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 154543 | 76781 | 10512 | 5171 | 15709 | 12165 | 16360 | 15867 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 151460 | 35264 | 64063 | 64 | 20939 | 7833 | 63 | 23222 | 15.3% |
...
- candidats SANS connectivite : 23532, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16634 systemes avec CONNECTED sur 128652 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*35236 candidats sur 39526 portent les champs bruts (89%).*

- `5c556c16ea8b` — 29271 candidats
  - AVEC connectivite (11866) : resistance **41.1%**
  - SANS connectivite (17405) : resistance **21.3%**
...
- `5c556c16ea8b` — 29271 candidats
  ...
  - SANS connectivite (17405) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 16707 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16634 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 126151 systemes
  - sans CONNECTED : 0.0% sur 28392 systemes
