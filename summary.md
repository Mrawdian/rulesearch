...
genere 2026-08-27 08:56 UTC — 90223 systemes evalues
...
- moteur actif `0caa9267db60` (46481 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 42495 | 21159 | 2920 | 1438 | 4247 | 3332 | 4480 | 4370 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 41613 | 9598 | 17679 | 24 | 5762 | 2168 | 22 | 6360 | 15.3% |
...
- candidats AVEC connectivite : 4497, dont T2 : 100%
- candidats SANS connectivite : 6670, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4754 systemes avec CONNECTED sur 37228 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6877 candidats sur 11167 portent les champs bruts (62%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 912 candidats
  - AVEC connectivite (369) : resistance **41.0%**
  - SANS connectivite (543) : resistance **21.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 912 candidats
  - AVEC connectivite (369) : T0=13.10 T1=0.00 T2=2.99 — pondere **5.97**
  - SANS connectivite (543) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 4786 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4754 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 34727 systemes
  - sans CONNECTED : 0.0% sur 7768 systemes
