...
genere 2026-08-26 15:03 UTC — 50330 systemes evalues
...
- moteur actif `0caa9267db60` (6588 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22339 | 11135 | 1500 | 764 | 2223 | 1773 | 2390 | 2274 | 10.2% |
...
- candidats AVEC connectivite : 2401, dont T2 : 100%
- candidats SANS connectivite : 3681, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2664 systemes avec CONNECTED sur 20737 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1792 candidats sur 6082 portent les champs bruts (29%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 677 candidats
  - AVEC connectivite (263) : resistance **40.9%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 677 candidats
  - AVEC connectivite (263) : T0=13.32 T1=0.00 T2=3.01 — pondere **6.02**
...
- TROP-CHER : 2684 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2664 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18236 systemes
  - sans CONNECTED : 0.0% sur 4103 systemes
