...
genere 2026-08-31 03:07 UTC — 238925 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 155581 systemes
...
- moteur actif `0caa9267db60` (195183 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 117597 | 58505 | 7985 | 3945 | 11815 | 9266 | 12458 | 12087 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 115213 | 26886 | 48695 | 53 | 15894 | 5953 | 52 | 17670 | 15.3% |
...
- candidats SANS connectivite : 17980, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12732 systemes avec CONNECTED sur 98538 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*25904 candidats sur 30194 portent les champs bruts (86%).*

- `5c556c16ea8b` — 19939 candidats
  - AVEC connectivite (8086) : resistance **41.0%**
  - SANS connectivite (11853) : resistance **21.4%**
...
- `5c556c16ea8b` — 19939 candidats
  ...
  - SANS connectivite (11853) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 12794 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 12732 avec CONNECTED, 62 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 96037 systemes
  - sans CONNECTED : 0.0% sur 21560 systemes
