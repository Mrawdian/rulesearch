...
genere 2026-08-25 20:30 UTC — 3152 systemes evalues

## versions du DSL presentes
- `615abe43d6bc` : 2175 systemes
...
| connect | 4 | 3 | 1537 | 772 | 108 | 58 | 162 | 120 | 147 | 153 | 10.0% |
| ref | 4 | 3 | 1491 | 346 | 638 | 0 | 205 | 69 | 1 | 232 | 15.6% |
...
- candidats AVEC connectivite : 156, dont T2 : 100%
- candidats SANS connectivite : 236, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **147 systemes avec CONNECTED sur 1310 (11.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
## cout
- temps total 0.9 h, dont 3% brule sur des systemes MORT
- TROP-CHER : 148 systemes abandonnes (4.7% des systemes), 95% du temps total
  dont 147 avec CONNECTED, 1 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 11.7% sur 1253 systemes
  - sans CONNECTED : 0.0% sur 284 systemes
