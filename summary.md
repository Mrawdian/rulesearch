...
genere 2026-08-26 14:38 UTC — 49443 systemes evalues
...
- moteur actif `0caa9267db60` (5701 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21891 | 10921 | 1464 | 751 | 2169 | 1735 | 2337 | 2237 | 10.2% |
...
- candidats AVEC connectivite : 2364, dont T2 : 100%
- candidats SANS connectivite : 3612, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2611 systemes avec CONNECTED sur 20389 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1686 candidats sur 5976 portent les champs bruts (28%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 571 candidats
  - AVEC connectivite (226) : resistance **40.7%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 571 candidats
  - AVEC connectivite (226) : T0=13.39 T1=0.00 T2=3.04 — pondere **6.07**
...
- TROP-CHER : 2630 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2611 avec CONNECTED, 19 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17888 systemes
  - sans CONNECTED : 0.0% sur 4003 systemes
