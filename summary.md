...
genere 2026-09-09 04:59 UTC — 472334 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 388990 systemes
...
- moteur actif `0caa9267db60` (428592 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 235456 | 116925 | 16058 | 7889 | 23825 | 18438 | 25063 | 24265 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 230763 | 53762 | 97223 | 92 | 32146 | 11924 | 83 | 35514 | 15.4% |
...
- candidats SANS connectivite : 35824, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25337 systemes avec CONNECTED sur 194753 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55926 candidats sur 60216 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49961 candidats
  - AVEC connectivite (20264) : resistance **41.2%**
  - SANS connectivite (29697) : resistance **21.3%**
...
- `5c556c16ea8b` — 49961 candidats
  ...
  - SANS connectivite (29697) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 25430 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25337 avec CONNECTED, 93 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 192252 systemes
