...
genere 2026-08-26 12:35 UTC — 44241 systemes evalues
...
| connect | 4 | 3 | 19263 | 9606 | 1258 | 671 | 1924 | 1528 | 2080 | 1958 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 18863 | 4430 | 7948 | 13 | 2599 | 979 | 7 | 2887 | 15.3% |
...
- candidats AVEC connectivite : 2085, dont T2 : 100%
- candidats SANS connectivite : 3197, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2354 systemes avec CONNECTED sur 18230 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*992 candidats sur 5282 portent les champs bruts (19%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `e40600351a72` — 71 candidats
  - AVEC connectivite (34) : resistance **37.6%**
  - SANS connectivite (37) : resistance **18.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e40600351a72` — 71 candidats
  - AVEC connectivite (34) : T0=13.06 T1=0.00 T2=2.88 — pondere **5.76**
  - SANS connectivite (37) : T0=17.11 T1=0.00 T2=2.49 — pondere **4.97**
  - test de permutation : **p = 0.2569** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 2371 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2354 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 15729 systemes
  - sans CONNECTED : 0.0% sur 3534 systemes
