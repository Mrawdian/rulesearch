...
genere 2026-08-28 22:54 UTC — 160562 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 77218 systemes
...
- moteur actif `0caa9267db60` (116820 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 78006 | 38749 | 5318 | 2655 | 7811 | 6239 | 8212 | 8029 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 76441 | 17767 | 32367 | 35 | 10541 | 3909 | 31 | 11787 | 15.4% |
...
- candidats AVEC connectivite : 8156, dont T2 : 100%
- candidats SANS connectivite : 12097, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8486 systemes avec CONNECTED sur 66110 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*15963 candidats sur 20253 portent les champs bruts (79%).*

- `5c556c16ea8b` — 9998 candidats
  - AVEC connectivite (4028) : resistance **41.2%**
  - SANS connectivite (5970) : resistance **21.8%**
...
- `5c556c16ea8b` — 9998 candidats
  - AVEC connectivite (4028) : T0=13.00 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (5970) : T0=15.89 T1=0.00 T2=2.68 — pondere **5.37**
...
## cout
- temps total 49.4 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 8527 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8486 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 63609 systemes
  - sans CONNECTED : 0.0% sur 14397 systemes
