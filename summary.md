...
genere 2026-08-29 20:05 UTC — 194279 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 110935 systemes
...
- moteur actif `0caa9267db60` (150537 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 95038 | 47204 | 6465 | 3201 | 9584 | 7571 | 10031 | 9771 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 93126 | 21717 | 39309 | 43 | 12895 | 4791 | 36 | 14329 | 15.4% |
...
- candidats AVEC connectivite : 9898, dont T2 : 100%
- candidats SANS connectivite : 14639, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10305 systemes avec CONNECTED sur 80013 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*20247 candidats sur 24537 portent les champs bruts (83%).*

- `5c556c16ea8b` — 14282 candidats
  - AVEC connectivite (5770) : resistance **41.2%**
  - SANS connectivite (8512) : resistance **21.5%**
...
- `5c556c16ea8b` — 14282 candidats
  - AVEC connectivite (5770) : T0=13.00 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (8512) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 10351 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10305 avec CONNECTED, 46 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 77512 systemes
  - sans CONNECTED : 0.0% sur 17526 systemes
