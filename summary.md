...
genere 2026-08-29 03:49 UTC — 168856 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 85512 systemes
...
- moteur actif `0caa9267db60` (125114 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 82196 | 40917 | 5591 | 2782 | 8253 | 6518 | 8634 | 8453 | 10.3% |
...
- candidats AVEC connectivite : 8580, dont T2 : 100%
...
- **8908 systemes avec CONNECTED sur 69574 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*17001 candidats sur 21291 portent les champs bruts (80%).*

- `5c556c16ea8b` — 11036 candidats
  - AVEC connectivite (4452) : resistance **41.2%**
...
- `5c556c16ea8b` — 11036 candidats
  - AVEC connectivite (4452) : T0=13.01 T1=0.00 T2=3.00 — pondere **5.99**
...
- TROP-CHER : 8952 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8908 avec CONNECTED, 44 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 67073 systemes
  - sans CONNECTED : 0.0% sur 15123 systemes
