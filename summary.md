...
| connect | 4 | 3 | 4826 | 2423 | 299 | 169 | 472 | 394 | 509 | 505 | 10.5% |
| ref | 4 | 3 | 4721 | 1146 | 1987 | 1 | 622 | 226 | 2 | 737 | 15.6% |
...
- candidats AVEC connectivite : 508, dont T2 : 100%
- candidats SANS connectivite : 741, dont T2 : 100%
...
- **509 systemes avec CONNECTED sur 4008 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 84 candidats
  - AVEC connectivite (29) : T0=12.76 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (55) : T0=15.89 T1=0.00 T2=2.85 — pondere **5.71**
...
- TROP-CHER : 511 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 509 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 3951 systemes
  - sans CONNECTED : 0.0% sur 875 systemes
