...
genere 2026-09-03 18:57 UTC — 345458 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 262114 systemes
...
- moteur actif `0caa9267db60` (301716 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 171369 | 85180 | 11624 | 5740 | 17438 | 13518 | 18172 | 17515 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 167974 | 39070 | 70988 | 67 | 23300 | 8691 | 66 | 25780 | 15.3% |
...
- candidats SANS connectivite : 26090, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18446 systemes avec CONNECTED sur 142325 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39442 candidats sur 43732 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33477 candidats
  - AVEC connectivite (13514) : resistance **41.1%**
  - SANS connectivite (19963) : resistance **21.2%**
...
- `5c556c16ea8b` — 33477 candidats
  ...
  - SANS connectivite (19963) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 139824 systemes
  - sans CONNECTED : 0.0% sur 31545 systemes
