...
genere 2026-09-01 22:15 UTC — 294345 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 211001 systemes
...
- moteur actif `0caa9267db60` (250603 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 145576 | 72297 | 9895 | 4882 | 14792 | 11476 | 15398 | 14960 | 10.3% |
...
- candidats AVEC connectivite : 15087, dont T2 : 100%
...
- **15672 systemes avec CONNECTED sur 121304 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*32972 candidats sur 37262 portent les champs bruts (88%).*

- `5c556c16ea8b` — 27007 candidats
  - AVEC connectivite (10959) : resistance **41.0%**
...
- `5c556c16ea8b` — 27007 candidats
  - AVEC connectivite (10959) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 15745 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15672 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 118803 systemes
  - sans CONNECTED : 0.0% sur 26773 systemes
