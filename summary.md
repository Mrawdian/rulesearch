...
genere 2026-08-26 13:26 UTC — 46540 systemes evalues
...
- moteur actif `0caa9267db60` (2798 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20425 | 10186 | 1344 | 704 | 2043 | 1624 | 2185 | 2087 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20000 | 4687 | 8447 | 13 | 2767 | 1035 | 7 | 3044 | 15.2% |
...
- candidats AVEC connectivite : 2214, dont T2 : 100%
- candidats SANS connectivite : 3354, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2459 systemes avec CONNECTED sur 19168 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1278 candidats sur 5568 portent les champs bruts (23%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 163 candidats
  - AVEC connectivite (76) : resistance **37.4%**
  - SANS connectivite (87) : resistance **23.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 163 candidats
  - AVEC connectivite (76) : T0=13.47 T1=0.00 T2=2.71 — pondere **5.42**
  - SANS connectivite (87) : T0=16.11 T1=0.00 T2=2.97 — pondere **5.93**
  - test de permutation : **p = 0.2919** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 2476 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2459 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16667 systemes
  - sans CONNECTED : 0.0% sur 3758 systemes
