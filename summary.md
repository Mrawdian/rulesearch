...
genere 2026-08-30 01:21 UTC — 202463 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 119119 systemes
...
- moteur actif `0caa9267db60` (158721 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 99176 | 49225 | 6748 | 3327 | 10008 | 7906 | 10447 | 10226 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 97172 | 22657 | 41026 | 45 | 13439 | 5014 | 37 | 14947 | 15.4% |
...
- candidats SANS connectivite : 15257, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10721 systemes avec CONNECTED sur 83372 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*21320 candidats sur 25610 portent les champs bruts (83%).*

- `5c556c16ea8b` — 15355 candidats
  - AVEC connectivite (6225) : resistance **41.1%**
  - SANS connectivite (9130) : resistance **21.5%**
...
- `5c556c16ea8b` — 15355 candidats
  ...
  - SANS connectivite (9130) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.33**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 80871 systemes
  - sans CONNECTED : 0.0% sur 18305 systemes
