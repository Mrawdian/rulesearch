...
genere 2026-08-26 20:56 UTC — 63974 systemes evalues
...
- moteur actif `0caa9267db60` (20232 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 29246 | 14551 | 1994 | 976 | 2914 | 2318 | 3114 | 3005 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 28613 | 6601 | 12136 | 16 | 3976 | 1471 | 12 | 4401 | 15.4% |
...
- candidats AVEC connectivite : 3132, dont T2 : 100%
- candidats SANS connectivite : 4711, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3388 systemes avec CONNECTED sur 26421 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3553 candidats sur 7843 portent les champs bruts (45%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 684 candidats
  - AVEC connectivite (288) : resistance **40.1%**
  - SANS connectivite (396) : resistance **20.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 684 candidats
  - AVEC connectivite (288) : T0=12.83 T1=0.00 T2=2.85 — pondere **5.70**
  - SANS connectivite (396) : T0=16.12 T1=0.00 T2=2.68 — pondere **5.35**
...
- TROP-CHER : 3410 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3388 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23920 systemes
  - sans CONNECTED : 0.0% sur 5326 systemes
