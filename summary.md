...
- moteur actif `0caa9267db60` (7741 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22922 | 11424 | 1546 | 777 | 2285 | 1820 | 2453 | 2329 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 22446 | 5196 | 9474 | 14 | 3140 | 1145 | 10 | 3467 | 15.4% |
...
- candidats AVEC connectivite : 2456, dont T2 : 100%
- candidats SANS connectivite : 3777, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2727 systemes avec CONNECTED sur 21211 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1943 candidats sur 6233 portent les champs bruts (31%).*
...
- `06fe04a859f1` — 828 candidats
  - AVEC connectivite (318) : resistance **41.1%**
  - SANS connectivite (510) : resistance **21.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 828 candidats
  - AVEC connectivite (318) : T0=13.30 T1=0.00 T2=3.02 — pondere **6.04**
  - SANS connectivite (510) : T0=16.00 T1=0.00 T2=2.64 — pondere **5.27**
...
- TROP-CHER : 2747 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2727 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18710 systemes
  - sans CONNECTED : 0.0% sur 4212 systemes
