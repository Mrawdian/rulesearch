...
genere 2026-08-27 00:02 UTC — 70756 systemes evalues
...
- moteur actif `0caa9267db60` (27014 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 32670 | 16241 | 2243 | 1104 | 3253 | 2597 | 3485 | 3329 | 10.2% |
...
- candidats AVEC connectivite : 3456, dont T2 : 100%
- candidats SANS connectivite : 5200, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3759 systemes avec CONNECTED sur 29208 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4366 candidats sur 8656 portent les champs bruts (50%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 689 candidats
  - AVEC connectivite (276) : resistance **41.7%**
...
- `ab89a63b01ef` — 689 candidats
  - AVEC connectivite (276) : T0=13.14 T1=0.00 T2=3.11 — pondere **6.22**
...
- TROP-CHER : 3784 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3759 avec CONNECTED, 25 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 26707 systemes
  - sans CONNECTED : 0.0% sur 5963 systemes
