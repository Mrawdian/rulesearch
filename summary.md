...
| connect | 4 | 3 | 18875 | 9422 | 1234 | 653 | 1879 | 1504 | 2043 | 1907 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 18485 | 4345 | 7787 | 13 | 2541 | 957 | 7 | 2835 | 15.3% |
...
- candidats AVEC connectivite : 2034, dont T2 : 100%
- candidats SANS connectivite : 3145, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2317 systemes avec CONNECTED sur 17907 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*889 candidats sur 5179 portent les champs bruts (17%).*
...
- `e3baecf8377b` — 625 candidats
  - AVEC connectivite (251) : T0=13.09 T1=0.00 T2=3.11 — pondere **6.22**
...
- TROP-CHER : 2334 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2317 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 15406 systemes
  - sans CONNECTED : 0.0% sur 3469 systemes
