...
genere 2026-08-26 14:53 UTC — 49946 systemes evalues
...
- moteur actif `0caa9267db60` (6204 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22146 | 11048 | 1485 | 759 | 2196 | 1754 | 2371 | 2255 | 10.2% |
...
- candidats AVEC connectivite : 2382, dont T2 : 100%
- candidats SANS connectivite : 3653, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2645 systemes avec CONNECTED sur 20591 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1745 candidats sur 6035 portent les champs bruts (29%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 630 candidats
  - AVEC connectivite (244) : resistance **41.0%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 630 candidats
  - AVEC connectivite (244) : T0=13.36 T1=0.00 T2=3.03 — pondere **6.06**
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0075).
...
- TROP-CHER : 2664 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2645 avec CONNECTED, 19 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18090 systemes
  - sans CONNECTED : 0.0% sur 4056 systemes
