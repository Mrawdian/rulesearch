...
genere 2026-09-04 03:02 UTC — 354361 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 271017 systemes
...
- moteur actif `0caa9267db60` (310619 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 175860 | 87411 | 11957 | 5876 | 17905 | 13832 | 18637 | 18000 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 172386 | 40055 | 72797 | 70 | 23956 | 8930 | 68 | 26496 | 15.4% |
...
- candidats AVEC connectivite : 18127, dont T2 : 100%
- candidats SANS connectivite : 26806, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18911 systemes avec CONNECTED sur 146005 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*40643 candidats sur 44933 portent les champs bruts (90%).*

- `5c556c16ea8b` — 34678 candidats
  - AVEC connectivite (13999) : resistance **41.0%**
  - SANS connectivite (20679) : resistance **21.3%**
...
- `5c556c16ea8b` — 34678 candidats
  - AVEC connectivite (13999) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (20679) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 143504 systemes
  - sans CONNECTED : 0.0% sur 32356 systemes
