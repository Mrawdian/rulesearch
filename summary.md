...
genere 2026-08-30 19:56 UTC — 229095 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 145751 systemes
...
- moteur actif `0caa9267db60` (185353 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 112635 | 56008 | 7651 | 3770 | 11316 | 8912 | 11915 | 11594 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 110345 | 25736 | 46615 | 51 | 15221 | 5706 | 45 | 16961 | 15.4% |
...
- candidats AVEC connectivite : 11721, dont T2 : 100%
- candidats SANS connectivite : 17271, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12189 systemes avec CONNECTED sur 94438 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*24702 candidats sur 28992 portent les champs bruts (85%).*

- `5c556c16ea8b` — 18737 candidats
  - AVEC connectivite (7593) : resistance **41.1%**
  - SANS connectivite (11144) : resistance **21.4%**
...
- `5c556c16ea8b` — 18737 candidats
  - AVEC connectivite (7593) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (11144) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 12244 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 12189 avec CONNECTED, 55 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 91937 systemes
  - sans CONNECTED : 0.0% sur 20698 systemes
