...
genere 2026-09-07 12:39 UTC — 435854 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 352510 systemes
...
- moteur actif `0caa9267db60` (392112 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 217033 | 107827 | 14789 | 7222 | 21976 | 17016 | 23084 | 22363 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 212706 | 49531 | 89669 | 83 | 29650 | 10986 | 76 | 32693 | 15.4% |
...
- candidats AVEC connectivite : 22490, dont T2 : 100%
- candidats SANS connectivite : 33003, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23358 systemes avec CONNECTED sur 179681 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*51203 candidats sur 55493 portent les champs bruts (92%).*

- `5c556c16ea8b` — 45238 candidats
  - AVEC connectivite (18362) : resistance **41.1%**
  - SANS connectivite (26876) : resistance **21.3%**
...
- `5c556c16ea8b` — 45238 candidats
  - AVEC connectivite (18362) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (26876) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 23444 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23358 avec CONNECTED, 86 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 177180 systemes
  - sans CONNECTED : 0.0% sur 39853 systemes
