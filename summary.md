...
genere 2026-09-05 23:29 UTC — 400302 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 316958 systemes
...
- moteur actif `0caa9267db60` (356560 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 199069 | 98828 | 13559 | 6635 | 20216 | 15685 | 21132 | 20482 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 195118 | 45401 | 82321 | 78 | 27180 | 10072 | 72 | 29977 | 15.4% |
...
- candidats SANS connectivite : 30287, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21406 systemes avec CONNECTED sur 164900 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*46606 candidats sur 50896 portent les champs bruts (92%).*

- `5c556c16ea8b` — 40641 candidats
  - AVEC connectivite (16481) : resistance **41.0%**
  - SANS connectivite (24160) : resistance **21.3%**
...
- `5c556c16ea8b` — 40641 candidats
  ...
  - SANS connectivite (24160) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 21488 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21406 avec CONNECTED, 82 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 162399 systemes
  - sans CONNECTED : 0.0% sur 36670 systemes
