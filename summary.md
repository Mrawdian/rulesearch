...
genere 2026-08-26 16:47 UTC — 54530 systemes evalues
...
- `23303c299f39` : 180 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (10788 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
**7646 enregistrements (14%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 24464 | 12210 | 1664 | 828 | 2418 | 1932 | 2607 | 2499 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 23951 | 5542 | 10125 | 14 | 3359 | 1215 | 10 | 3686 | 15.4% |
...
- candidats AVEC connectivite : 2626, dont T2 : 100%
- candidats SANS connectivite : 3996, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2881 systemes avec CONNECTED sur 22493 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2332 candidats sur 6622 portent les champs bruts (35%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 22 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (12) : resistance **36.6%**
  - SANS connectivite (10) : resistance **19.5%**
...
- `23303c299f39` — 22 candidats
  - AVEC connectivite (12) : T0=13.08 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (10) : T0=18.00 T1=0.00 T2=2.60 — pondere **5.20**
  - *groupes trop petits (< 20) — aucun test, aucune conclusion*
...
## cout
- temps total 16.9 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2901 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2881 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 19992 systemes
  - sans CONNECTED : 0.0% sur 4472 systemes
