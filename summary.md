...
genere 2026-09-02 03:25 UTC — 300506 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 217162 systemes
...
- moteur actif `0caa9267db60` (256764 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 148676 | 73868 | 10119 | 4982 | 15084 | 11697 | 15743 | 15279 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 145715 | 33887 | 61661 | 62 | 20177 | 7532 | 63 | 22321 | 15.3% |
...
- candidats SANS connectivite : 22631, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16017 systemes avec CONNECTED sur 123880 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*33747 candidats sur 38037 portent les champs bruts (89%).*

- `5c556c16ea8b` — 27782 candidats
  - AVEC connectivite (11278) : resistance **41.0%**
  - SANS connectivite (16504) : resistance **21.3%**
...
- `5c556c16ea8b` — 27782 candidats
  ...
  - SANS connectivite (16504) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 121379 systemes
  - sans CONNECTED : 0.0% sur 27297 systemes
