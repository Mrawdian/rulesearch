...
genere 2026-08-29 15:06 UTC — 186806 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 103462 systemes
...
- moteur actif `0caa9267db60` (143064 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 91266 | 45383 | 6201 | 3071 | 9186 | 7271 | 9605 | 9387 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 89425 | 20894 | 37732 | 43 | 12369 | 4584 | 35 | 13762 | 15.4% |
...
- candidats AVEC connectivite : 9514, dont T2 : 100%
- candidats SANS connectivite : 14072, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9879 systemes avec CONNECTED sur 76952 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*19296 candidats sur 23586 portent les champs bruts (82%).*

- `5c556c16ea8b` — 13331 candidats
  - AVEC connectivite (5386) : resistance **41.2%**
  - SANS connectivite (7945) : resistance **21.5%**
...
- `5c556c16ea8b` — 13331 candidats
  - AVEC connectivite (5386) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (7945) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.33**
...
## cout
- temps total 57.5 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 9924 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 9879 avec CONNECTED, 45 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 74451 systemes
  - sans CONNECTED : 0.0% sur 16815 systemes
