...
genere 2026-08-26 03:01 UTC — 19914 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 10940 systemes
...
| connect | 4 | 3 | 10000 | 5032 | 655 | 346 | 952 | 799 | 1075 | 1014 | 10.1% |
...
- candidats AVEC connectivite : 1017, dont T2 : 100%
...
- **1075 systemes avec CONNECTED sur 8267 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1375 candidats
  - AVEC connectivite (538) : T0=13.35 T1=0.00 T2=2.88 — pondere **5.76**
...
## cout
- temps total 6.2 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 1079 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 1075 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 8210 systemes
  - sans CONNECTED : 0.0% sur 1790 systemes
