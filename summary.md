...
genere 2026-09-02 07:35 UTC — 305417 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 222073 systemes
...
- moteur actif `0caa9267db60` (261675 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 151156 | 75108 | 10279 | 5060 | 15346 | 11896 | 16010 | 15525 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 148146 | 34503 | 62661 | 62 | 20500 | 7642 | 63 | 22703 | 15.3% |
...
- candidats AVEC connectivite : 15652, dont T2 : 100%
- candidats SANS connectivite : 23013, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16284 systemes avec CONNECTED sur 125890 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*34375 candidats sur 38665 portent les champs bruts (89%).*

- `5c556c16ea8b` — 28410 candidats
  - AVEC connectivite (11524) : resistance **41.1%**
  - SANS connectivite (16886) : resistance **21.3%**
...
- `5c556c16ea8b` — 28410 candidats
  - AVEC connectivite (11524) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (16886) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
## cout
- temps total 94.7 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 16357 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16284 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 123389 systemes
  - sans CONNECTED : 0.0% sur 27767 systemes
