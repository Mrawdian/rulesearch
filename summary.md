...
genere 2026-08-26 21:31 UTC — 65292 systemes evalues
...
- `ab89a63b01ef` : 385 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (21550 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
**7911 enregistrements (12%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 29905 | 14862 | 2042 | 1003 | 2997 | 2369 | 3186 | 3066 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 29272 | 6749 | 12432 | 16 | 4052 | 1511 | 12 | 4500 | 15.4% |
...
- candidats AVEC connectivite : 3193, dont T2 : 100%
- candidats SANS connectivite : 4810, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3460 systemes avec CONNECTED sur 26947 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3713 candidats sur 8003 portent les champs bruts (46%).*
...
- `8f22f0d2d442` — 65 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 36 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (13) : resistance **46.8%**
  - SANS connectivite (23) : resistance **20.1%**
...
- `ab89a63b01ef` — 36 candidats
  - AVEC connectivite (13) : T0=14.46 T1=0.00 T2=3.15 — pondere **6.31**
  - SANS connectivite (23) : T0=16.35 T1=0.00 T2=2.83 — pondere **5.65**
...
- TROP-CHER : 3482 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3460 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24446 systemes
  - sans CONNECTED : 0.0% sur 5459 systemes
