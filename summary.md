...
genere 2026-08-27 17:04 UTC — 106546 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 23202 systemes
...
- moteur actif `0caa9267db60` (62804 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 50722 | 25263 | 3506 | 1738 | 5028 | 4017 | 5352 | 5162 | 10.2% |
...
- candidats AVEC connectivite : 5289, dont T2 : 100%
- candidats SANS connectivite : 7919, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5626 systemes avec CONNECTED sur 43932 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*8918 candidats sur 13208 portent les champs bruts (68%).*
...
- `5c556c16ea8b` — 2953 candidats
  - AVEC connectivite (1161) : resistance **41.9%**
...
- `5c556c16ea8b` — 2953 candidats
  - AVEC connectivite (1161) : T0=13.01 T1=0.00 T2=3.06 — pondere **6.12**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 41431 systemes
  - sans CONNECTED : 0.0% sur 9291 systemes
