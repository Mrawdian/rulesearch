...
| connect | 4 | 3 | 6025 | 3039 | 388 | 220 | 576 | 482 | 623 | 626 | 10.4% |
...
- candidats AVEC connectivite : 629, dont T2 : 100%
...
- **623 systemes avec CONNECTED sur 4999 (12.5%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 394 candidats
  - AVEC connectivite (150) : T0=13.20 T1=0.00 T2=2.96 — pondere **5.92**
  - SANS connectivite (244) : T0=16.00 T1=0.00 T2=2.63 — pondere **5.26**
  - test de permutation : **p = 0.0430** — ecart significatif au seuil 0.05
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.6% sur 4942 systemes
  - sans CONNECTED : 0.0% sur 1083 systemes
