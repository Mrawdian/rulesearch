...
genere 2026-08-26 21:38 UTC — 65513 systemes evalues
...
- `ab89a63b01ef` : 606 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (21771 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
**8132 enregistrements (12%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 30024 | 14917 | 2051 | 1010 | 3007 | 2376 | 3201 | 3082 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 29374 | 6776 | 12473 | 16 | 4069 | 1516 | 12 | 4512 | 15.4% |
...
- candidats AVEC connectivite : 3209, dont T2 : 100%
- candidats SANS connectivite : 4822, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3475 systemes avec CONNECTED sur 27045 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3741 candidats sur 8031 portent les champs bruts (47%).*
...
- `e80bc1b2b437` — 75 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 64 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (29) : resistance **44.1%**
  - SANS connectivite (35) : resistance **21.4%**
...
- `ab89a63b01ef` — 64 candidats
  - AVEC connectivite (29) : T0=14.41 T1=0.00 T2=3.07 — pondere **6.14**
  - SANS connectivite (35) : T0=16.34 T1=0.00 T2=2.89 — pondere **5.77**
  - test de permutation : **p = 0.6777** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `0a74109317e5` — 80 candidats
...
**5 serie(s) reproductible(s) sur 12 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
...
## cout
- temps total 20.3 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 3497 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3475 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24544 systemes
  - sans CONNECTED : 0.0% sur 5480 systemes
