...
genere 2026-08-26 18:21 UTC — 58131 systemes evalues
...
- `8f22f0d2d442` : 30 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (14389 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 26283 | 13100 | 1786 | 891 | 2608 | 2075 | 2802 | 2697 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 25733 | 5920 | 10908 | 15 | 3592 | 1324 | 10 | 3964 | 15.4% |
...
- candidats AVEC connectivite : 2824, dont T2 : 100%
- candidats SANS connectivite : 4274, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3076 systemes avec CONNECTED sur 23995 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2808 candidats sur 7098 portent les champs bruts (40%).*
...
- TROP-CHER : 3096 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3076 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 21494 systemes
  - sans CONNECTED : 0.0% sur 4789 systemes
