...
genere 2026-08-26 19:30 UTC — 60853 systemes evalues
...
- moteur actif `0caa9267db60` (17111 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27660 | 13799 | 1885 | 932 | 2733 | 2192 | 2940 | 2832 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 27078 | 6264 | 11453 | 15 | 3770 | 1396 | 11 | 4169 | 15.4% |
...
- candidats AVEC connectivite : 2959, dont T2 : 100%
- candidats SANS connectivite : 4479, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3214 systemes avec CONNECTED sur 25138 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3148 candidats sur 7438 portent les champs bruts (42%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 279 candidats
  - AVEC connectivite (115) : resistance **39.3%**
  - SANS connectivite (164) : resistance **18.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 279 candidats
  - AVEC connectivite (115) : T0=12.98 T1=0.00 T2=2.90 — pondere **5.81**
  - SANS connectivite (164) : T0=16.09 T1=0.00 T2=2.55 — pondere **5.11**
...
- TROP-CHER : 3235 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3214 avec CONNECTED, 21 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22637 systemes
  - sans CONNECTED : 0.0% sur 5023 systemes
