...
genere 2026-08-28 18:48 UTC — 153514 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 70170 systemes
...
- moteur actif `0caa9267db60` (109772 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 74444 | 37006 | 5075 | 2540 | 7463 | 5929 | 7850 | 7637 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 72955 | 16966 | 30854 | 35 | 10055 | 3748 | 31 | 11263 | 15.4% |
...
- candidats AVEC connectivite : 7764, dont T2 : 100%
- candidats SANS connectivite : 11573, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8124 systemes avec CONNECTED sur 63234 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*15047 candidats sur 19337 portent les champs bruts (78%).*

- `5c556c16ea8b` — 9082 candidats
  - AVEC connectivite (3636) : resistance **41.1%**
  - SANS connectivite (5446) : resistance **21.7%**
...
- `5c556c16ea8b` — 9082 candidats
  - AVEC connectivite (3636) : T0=13.02 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (5446) : T0=15.89 T1=0.00 T2=2.68 — pondere **5.35**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 60733 systemes
  - sans CONNECTED : 0.0% sur 13711 systemes
