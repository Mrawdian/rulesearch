...
genere 2026-09-08 08:38 UTC — 454011 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 370667 systemes
...
- moteur actif `0caa9267db60` (410269 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 226191 | 112322 | 15398 | 7552 | 22883 | 17725 | 24103 | 23323 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 221705 | 51627 | 93450 | 88 | 30881 | 11466 | 81 | 34094 | 15.4% |
...
- candidats AVEC connectivite : 23450, dont T2 : 100%
- candidats SANS connectivite : 34404, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **24377 systemes avec CONNECTED sur 187211 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*53564 candidats sur 57854 portent les champs bruts (93%).*

- `5c556c16ea8b` — 47599 candidats
  - AVEC connectivite (19322) : resistance **41.1%**
  - SANS connectivite (28277) : resistance **21.3%**
...
- `5c556c16ea8b` — 47599 candidats
  - AVEC connectivite (19322) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (28277) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 24468 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 24377 avec CONNECTED, 91 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 184710 systemes
  - sans CONNECTED : 0.0% sur 41481 systemes
