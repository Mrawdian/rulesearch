...
| connect | 4 | 3 | 17828 | 8924 | 1156 | 615 | 1764 | 1412 | 1941 | 1792 | 10.1% |
...
- candidats AVEC connectivite : 1919, dont T2 : 100%
- candidats SANS connectivite : 2988, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2215 systemes avec CONNECTED sur 17068 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*617 candidats sur 4907 portent les champs bruts (13%).*
...
- `e3baecf8377b` — 353 candidats
  - AVEC connectivite (136) : resistance **43.9%**
...
- `e3baecf8377b` — 353 candidats
  - AVEC connectivite (136) : T0=12.90 T1=0.00 T2=3.17 — pondere **6.34**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14567 systemes
  - sans CONNECTED : 0.0% sur 3261 systemes
