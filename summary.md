...
genere 2026-09-07 12:48 UTC — 436004 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 352660 systemes
...
- moteur actif `0caa9267db60` (392262 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 217108 | 107865 | 14794 | 7225 | 21982 | 17021 | 23090 | 22374 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 212781 | 49551 | 89694 | 83 | 29662 | 10987 | 76 | 32710 | 15.4% |
...
- candidats AVEC connectivite : 22501, dont T2 : 100%
- candidats SANS connectivite : 33020, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23364 systemes avec CONNECTED sur 179743 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*51231 candidats sur 55521 portent les champs bruts (92%).*

- `5c556c16ea8b` — 45266 candidats
  - AVEC connectivite (18373) : resistance **41.1%**
  - SANS connectivite (26893) : resistance **21.3%**
...
- `5c556c16ea8b` — 45266 candidats
  - AVEC connectivite (18373) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (26893) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 23450 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23364 avec CONNECTED, 86 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 177242 systemes
  - sans CONNECTED : 0.0% sur 39866 systemes
