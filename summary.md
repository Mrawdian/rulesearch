...
genere 2026-08-30 04:44 UTC — 207531 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 124187 systemes
...
- moteur actif `0caa9267db60` (163789 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 101749 | 50532 | 6923 | 3405 | 10272 | 8115 | 10718 | 10459 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 99667 | 23221 | 42097 | 45 | 13771 | 5150 | 38 | 15338 | 15.4% |
...
- candidats AVEC connectivite : 10586, dont T2 : 100%
- candidats SANS connectivite : 15648, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10992 systemes avec CONNECTED sur 85480 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*21944 candidats sur 26234 portent les champs bruts (84%).*

- `5c556c16ea8b` — 15979 candidats
  - AVEC connectivite (6458) : resistance **41.1%**
  - SANS connectivite (9521) : resistance **21.5%**
...
- `5c556c16ea8b` — 15979 candidats
  - AVEC connectivite (6458) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (9521) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 11040 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10992 avec CONNECTED, 48 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 82979 systemes
  - sans CONNECTED : 0.0% sur 18770 systemes
