...
genere 2026-08-27 18:03 UTC — 108467 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 25123 systemes
...
- moteur actif `0caa9267db60` (64725 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 51693 | 25753 | 3578 | 1774 | 5117 | 4089 | 5454 | 5256 | 10.2% |
...
- candidats AVEC connectivite : 5383, dont T2 : 100%
- candidats SANS connectivite : 8054, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5728 systemes avec CONNECTED sur 44734 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*9147 candidats sur 13437 portent les champs bruts (68%).*
...
- `5c556c16ea8b` — 3182 candidats
  - AVEC connectivite (1255) : resistance **42.1%**
...
- `5c556c16ea8b` — 3182 candidats
  - AVEC connectivite (1255) : T0=13.00 T1=0.00 T2=3.07 — pondere **6.14**
...
- TROP-CHER : 5761 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 5728 avec CONNECTED, 33 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 42233 systemes
  - sans CONNECTED : 0.0% sur 9460 systemes
