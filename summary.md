...
genere 2026-09-05 13:18 UTC — 390128 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 306784 systemes
...
- moteur actif `0caa9267db60` (346386 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 193928 | 96308 | 13205 | 6460 | 19715 | 15267 | 20575 | 19926 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 190085 | 44255 | 80221 | 78 | 26451 | 9832 | 71 | 29163 | 15.3% |
...
- candidats AVEC connectivite : 20053, dont T2 : 100%
- candidats SANS connectivite : 29473, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20849 systemes avec CONNECTED sur 160687 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*45236 candidats sur 49526 portent les champs bruts (91%).*

- `5c556c16ea8b` — 39271 candidats
  - AVEC connectivite (15925) : resistance **41.1%**
  - SANS connectivite (23346) : resistance **21.3%**
...
- `5c556c16ea8b` — 39271 candidats
  - AVEC connectivite (15925) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (23346) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 158186 systemes
  - sans CONNECTED : 0.0% sur 35742 systemes
