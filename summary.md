...
genere 2026-09-04 14:49 UTC — 367050 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 283706 systemes
...
- moteur actif `0caa9267db60` (323308 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 182268 | 90600 | 12391 | 6086 | 18556 | 14358 | 19301 | 18643 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 178667 | 41529 | 75482 | 74 | 24822 | 9253 | 70 | 27423 | 15.3% |
...
- candidats AVEC connectivite : 18770, dont T2 : 100%
- candidats SANS connectivite : 27733, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19575 systemes avec CONNECTED sur 151172 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*42213 candidats sur 46503 portent les champs bruts (91%).*

- `5c556c16ea8b` — 36248 candidats
  - AVEC connectivite (14642) : resistance **41.0%**
  - SANS connectivite (21606) : resistance **21.2%**
...
- `5c556c16ea8b` — 36248 candidats
  - AVEC connectivite (14642) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.94**
  - SANS connectivite (21606) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 19655 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19575 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 148671 systemes
  - sans CONNECTED : 0.0% sur 33597 systemes
