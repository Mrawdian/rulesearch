...
genere 2026-08-26 13:47 UTC — 47529 systemes evalues
...
- moteur actif `0caa9267db60` (3787 systemes) : `06fe04a859f1`, `e40600351a72`
...
| ref | 4 | 3 | 20483 | 4791 | 8649 | 13 | 2835 | 1059 | 7 | 3129 | 15.3% |
...
- candidats SANS connectivite : 3439, dont T2 : 100%
...
*1415 candidats sur 5705 portent les champs bruts (25%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 300 candidats
  - AVEC connectivite (128) : resistance **39.8%**
  - SANS connectivite (172) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 300 candidats
  ...
  - SANS connectivite (172) : T0=16.16 T1=0.00 T2=2.73 — pondere **5.45**
  - test de permutation : **p = 0.3428** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
