...
genere 2026-08-28 11:22 UTC — 140634 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 57290 systemes
...
- moteur actif `0caa9267db60` (96892 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 67949 | 33758 | 4663 | 2319 | 6811 | 5410 | 7161 | 6955 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 66570 | 15394 | 28148 | 30 | 9255 | 3438 | 30 | 10272 | 15.4% |
...
- candidats SANS connectivite : 10582, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7435 systemes avec CONNECTED sur 57923 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*13374 candidats sur 17664 portent les champs bruts (76%).*

- `5c556c16ea8b` — 7409 candidats
  - AVEC connectivite (2954) : resistance **41.4%**
  - SANS connectivite (4455) : resistance **21.8%**
...
- `5c556c16ea8b` — 7409 candidats
  ...
  - SANS connectivite (4455) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.35**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 55422 systemes
  - sans CONNECTED : 0.0% sur 12527 systemes
