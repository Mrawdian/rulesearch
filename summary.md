...
genere 2026-08-28 02:42 UTC — 125436 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 42092 systemes
...
- moteur actif `0caa9267db60` (81694 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 60273 | 30010 | 4161 | 2038 | 6001 | 4783 | 6310 | 6195 | 10.3% |
...
- candidats AVEC connectivite : 6322, dont T2 : 100%
- candidats SANS connectivite : 9360, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6584 systemes avec CONNECTED sur 51692 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11392 candidats sur 15682 portent les champs bruts (73%).*

- `5c556c16ea8b` — 5427 candidats
  - AVEC connectivite (2194) : resistance **41.9%**
...
- `5c556c16ea8b` — 5427 candidats
  - AVEC connectivite (2194) : T0=12.98 T1=0.00 T2=3.04 — pondere **6.08**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 49191 systemes
  - sans CONNECTED : 0.0% sur 11082 systemes
