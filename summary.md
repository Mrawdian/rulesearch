...
genere 2026-08-26 23:47 UTC — 70281 systemes evalues
...
- moteur actif `0caa9267db60` (26539 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 32430 | 16131 | 2221 | 1094 | 3227 | 2582 | 3455 | 3305 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 31736 | 7324 | 13476 | 18 | 4392 | 1657 | 14 | 4855 | 15.3% |
...
- candidats AVEC connectivite : 3432, dont T2 : 100%
- candidats SANS connectivite : 5165, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3729 systemes avec CONNECTED sur 29017 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4307 candidats sur 8597 portent les champs bruts (50%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 630 candidats
  - AVEC connectivite (252) : resistance **42.1%**
  - SANS connectivite (378) : resistance **21.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 630 candidats
  - AVEC connectivite (252) : T0=13.06 T1=0.00 T2=3.13 — pondere **6.25**
  - SANS connectivite (378) : T0=15.91 T1=0.00 T2=2.64 — pondere **5.29**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e3baecf8377b` — 657 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 26516 systemes
  - sans CONNECTED : 0.0% sur 5914 systemes
