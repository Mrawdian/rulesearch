...
genere 2026-09-04 15:59 UTC — 368350 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 285006 systemes
...
- moteur actif `0caa9267db60` (324608 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 182927 | 90927 | 12435 | 6111 | 18622 | 14407 | 19360 | 18719 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 179308 | 41676 | 75755 | 74 | 24909 | 9289 | 70 | 27521 | 15.3% |
...
- candidats SANS connectivite : 27831, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19634 systemes avec CONNECTED sur 151719 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*42387 candidats sur 46677 portent les champs bruts (91%).*

- `5c556c16ea8b` — 36422 candidats
  - AVEC connectivite (14718) : resistance **41.0%**
  - SANS connectivite (21704) : resistance **21.2%**
...
- `5c556c16ea8b` — 36422 candidats
  ...
  - SANS connectivite (21704) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 149218 systemes
  - sans CONNECTED : 0.0% sur 33709 systemes
