...
genere 2026-08-30 08:54 UTC — 213275 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 129931 systemes
...
- moteur actif `0caa9267db60` (169533 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 104643 | 51956 | 7119 | 3491 | 10553 | 8329 | 11071 | 10761 | 10.3% |
...
- candidats AVEC connectivite : 10888, dont T2 : 100%
...
- **11345 systemes avec CONNECTED sur 87854 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*22672 candidats sur 26962 portent les champs bruts (84%).*

- `5c556c16ea8b` — 16707 candidats
  - AVEC connectivite (6760) : resistance **41.2%**
...
- `5c556c16ea8b` — 16707 candidats
  - AVEC connectivite (6760) : T0=13.00 T1=0.00 T2=3.00 — pondere **6.00**
...
- TROP-CHER : 11396 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11345 avec CONNECTED, 51 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 85353 systemes
  - sans CONNECTED : 0.0% sur 19290 systemes
