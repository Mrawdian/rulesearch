...
genere 2026-08-25 22:28 UTC — 8370 systemes evalues

## versions du DSL presentes
- `615abe43d6bc` : 7172 systemes
- `0327bdc4c76a` : 853 systemes
- `12a0c0c5e34b` : 221 systemes
...
| connect | 4 | 3 | 4168 | 2105 | 266 | 145 | 399 | 325 | 435 | 444 | 10.7% |
| ref | 4 | 3 | 4078 | 994 | 1714 | 1 | 543 | 192 | 2 | 632 | 15.5% |
...
- candidats AVEC connectivite : 447, dont T2 : 100%
- candidats SANS connectivite : 636, dont T2 : 100%
...
- **435 systemes avec CONNECTED sur 3484 (12.5%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- TROP-CHER : 437 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 435 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 3427 systemes
  - sans CONNECTED : 0.0% sur 741 systemes
