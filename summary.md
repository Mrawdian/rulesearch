...
genere 2026-08-26 13:36 UTC — 47030 systemes evalues
...
- moteur actif `0caa9267db60` (3288 systemes) : `06fe04a859f1`, `e40600351a72`
...
| ref | 4 | 3 | 20237 | 4735 | 8544 | 13 | 2807 | 1045 | 7 | 3086 | 15.2% |
...
- candidats SANS connectivite : 3396, dont T2 : 100%
...
*1350 candidats sur 5640 portent les champs bruts (24%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 235 candidats
  - AVEC connectivite (106) : resistance **38.3%**
  - SANS connectivite (129) : resistance **21.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 235 candidats
  ...
  - SANS connectivite (129) : T0=16.16 T1=0.00 T2=2.79 — pondere **5.58**
  - test de permutation : **p = 0.8666** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
