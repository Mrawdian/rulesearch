...
genere 2026-08-26 14:46 UTC — 49694 systemes evalues
...
- moteur actif `0caa9267db60` (5952 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22026 | 10990 | 1474 | 754 | 2184 | 1745 | 2356 | 2245 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 21553 | 5013 | 9097 | 13 | 2995 | 1109 | 9 | 3317 | 15.4% |
...
- candidats SANS connectivite : 3627, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2630 systemes avec CONNECTED sur 20496 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1709 candidats sur 5999 portent les champs bruts (28%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 594 candidats
  - AVEC connectivite (234) : resistance **41.1%**
  - SANS connectivite (360) : resistance **21.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 594 candidats
  ...
  - SANS connectivite (360) : T0=16.03 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 2649 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2630 avec CONNECTED, 19 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17995 systemes
  - sans CONNECTED : 0.0% sur 4031 systemes
