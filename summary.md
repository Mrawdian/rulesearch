...
genere 2026-08-26 22:35 UTC — 67586 systemes evalues
...
- moteur actif `0caa9267db60` (23844 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 30402 | 7002 | 12913 | 18 | 4214 | 1579 | 14 | 4662 | 15.3% |
...
- candidats SANS connectivite : 4972, dont T2 : 100%
...
*4001 candidats sur 8291 portent les champs bruts (48%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 324 candidats
  - AVEC connectivite (139) : resistance **42.6%**
  - SANS connectivite (185) : resistance **22.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 324 candidats
  ...
  - SANS connectivite (185) : T0=16.18 T1=0.00 T2=2.79 — pondere **5.59**
  - test de permutation : **p = 0.1149** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
