...
genere 2026-09-03 04:32 UTC — 329419 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 246075 systemes
...
- moteur actif `0caa9267db60` (285677 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 163268 | 81117 | 11090 | 5466 | 16623 | 12871 | 17301 | 16713 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 160036 | 37288 | 67647 | 65 | 22179 | 8268 | 65 | 24512 | 15.3% |
...
- candidats SANS connectivite : 24822, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **17575 systemes avec CONNECTED sur 135692 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*37372 candidats sur 41662 portent les champs bruts (90%).*

- `5c556c16ea8b` — 31407 candidats
  - AVEC connectivite (12712) : resistance **41.1%**
  - SANS connectivite (18695) : resistance **21.2%**
...
- `5c556c16ea8b` — 31407 candidats
  ...
  - SANS connectivite (18695) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 17650 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 17575 avec CONNECTED, 75 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 133191 systemes
  - sans CONNECTED : 0.0% sur 30077 systemes
