...
genere 2026-09-03 19:56 UTC — 346593 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 263249 systemes
...
- moteur actif `0caa9267db60` (302851 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 171951 | 85467 | 11669 | 5758 | 17510 | 13562 | 18222 | 17573 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 168527 | 39185 | 71244 | 67 | 23371 | 8722 | 66 | 25860 | 15.3% |
...
- candidats AVEC connectivite : 17700, dont T2 : 100%
- candidats SANS connectivite : 26170, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18496 systemes avec CONNECTED sur 142791 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39580 candidats sur 43870 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33615 candidats
  - AVEC connectivite (13572) : resistance **41.0%**
  - SANS connectivite (20043) : resistance **21.2%**
...
- `5c556c16ea8b` — 33615 candidats
  - AVEC connectivite (13572) : T0=13.03 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (20043) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.29**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 140290 systemes
  - sans CONNECTED : 0.0% sur 31661 systemes
