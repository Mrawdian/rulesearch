...
genere 2026-08-27 08:34 UTC — 89500 systemes evalues
...
- moteur actif `0caa9267db60` (45758 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 42123 | 20971 | 2899 | 1425 | 4203 | 3311 | 4437 | 4331 | 10.3% |
...
- candidats AVEC connectivite : 4458, dont T2 : 100%
- candidats SANS connectivite : 6614, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4711 systemes avec CONNECTED sur 36926 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6782 candidats sur 11072 portent les champs bruts (61%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 817 candidats
  - AVEC connectivite (330) : resistance **41.1%**
...
- `5c556c16ea8b` — 817 candidats
  - AVEC connectivite (330) : T0=13.11 T1=0.00 T2=3.00 — pondere **5.99**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 34425 systemes
  - sans CONNECTED : 0.0% sur 7698 systemes
