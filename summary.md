...
genere 2026-08-31 15:02 UTC — 255250 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 171906 systemes
...
- moteur actif `0caa9267db60` (211508 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 125844 | 62568 | 8516 | 4219 | 12713 | 9953 | 13272 | 12952 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 123291 | 28751 | 52045 | 55 | 17075 | 6374 | 56 | 18925 | 15.3% |
...
- candidats AVEC connectivite : 13079, dont T2 : 100%
- candidats SANS connectivite : 19235, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13546 systemes avec CONNECTED sur 105180 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*28024 candidats sur 32314 portent les champs bruts (87%).*

- `5c556c16ea8b` — 22059 candidats
  - AVEC connectivite (8951) : resistance **41.0%**
  - SANS connectivite (13108) : resistance **21.4%**
...
- `5c556c16ea8b` — 22059 candidats
  - AVEC connectivite (8951) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.97**
  - SANS connectivite (13108) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 102679 systemes
  - sans CONNECTED : 0.0% sur 23165 systemes
