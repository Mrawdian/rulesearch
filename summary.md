...
genere 2026-09-04 03:36 UTC — 354923 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 271579 systemes
...
- moteur actif `0caa9267db60` (311181 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 176143 | 87535 | 11980 | 5886 | 17936 | 13861 | 18678 | 18024 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 172665 | 40128 | 72905 | 70 | 23996 | 8945 | 68 | 26539 | 15.4% |
...
- candidats AVEC connectivite : 18151, dont T2 : 100%
- candidats SANS connectivite : 26849, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18952 systemes avec CONNECTED sur 146226 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*40710 candidats sur 45000 portent les champs bruts (90%).*

- `5c556c16ea8b` — 34745 candidats
  - AVEC connectivite (14023) : resistance **41.0%**
  - SANS connectivite (20722) : resistance **21.3%**
...
- `5c556c16ea8b` — 34745 candidats
  - AVEC connectivite (14023) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (20722) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 19030 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18952 avec CONNECTED, 78 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 143725 systemes
  - sans CONNECTED : 0.0% sur 32418 systemes
