...
genere 2026-09-08 08:35 UTC — 453951 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 370607 systemes
...
- moteur actif `0caa9267db60` (410209 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 226161 | 112300 | 15397 | 7552 | 22883 | 17722 | 24100 | 23323 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 221675 | 51622 | 93434 | 88 | 30874 | 11465 | 81 | 34093 | 15.4% |
...
- candidats SANS connectivite : 34403, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **24374 systemes avec CONNECTED sur 187185 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*53563 candidats sur 57853 portent les champs bruts (93%).*

- `5c556c16ea8b` — 47598 candidats
  - AVEC connectivite (19322) : resistance **41.1%**
  - SANS connectivite (28276) : resistance **21.3%**
...
- `5c556c16ea8b` — 47598 candidats
  ...
  - SANS connectivite (28276) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 184684 systemes
  - sans CONNECTED : 0.0% sur 41477 systemes
