...
genere 2026-09-03 18:49 UTC — 345296 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 261952 systemes
...
- moteur actif `0caa9267db60` (301554 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 171294 | 85138 | 11619 | 5738 | 17433 | 13515 | 18165 | 17505 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 167887 | 39047 | 70955 | 67 | 23287 | 8687 | 66 | 25766 | 15.3% |
...
- candidats AVEC connectivite : 17632, dont T2 : 100%
- candidats SANS connectivite : 26076, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18439 systemes avec CONNECTED sur 142263 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39418 candidats sur 43708 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33453 candidats
  - AVEC connectivite (13504) : resistance **41.0%**
  - SANS connectivite (19949) : resistance **21.2%**
...
- `5c556c16ea8b` — 33453 candidats
  - AVEC connectivite (13504) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (19949) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 139762 systemes
  - sans CONNECTED : 0.0% sur 31532 systemes
