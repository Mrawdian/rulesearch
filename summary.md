...
genere 2026-09-03 17:49 UTC — 344265 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 260921 systemes
...
- moteur actif `0caa9267db60` (300523 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 170771 | 84905 | 11589 | 5722 | 17366 | 13471 | 18101 | 17442 | 10.2% |
...
- candidats AVEC connectivite : 17569, dont T2 : 100%
...
- **18375 systemes avec CONNECTED sur 141845 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39274 candidats sur 43564 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33309 candidats
  - AVEC connectivite (13441) : resistance **41.1%**
...
- `5c556c16ea8b` — 33309 candidats
  - AVEC connectivite (13441) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 18451 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18375 avec CONNECTED, 76 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 139344 systemes
  - sans CONNECTED : 0.0% sur 31427 systemes
