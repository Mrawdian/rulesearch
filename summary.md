...
genere 2026-08-25 20:47 UTC — 4072 systemes evalues

## versions du DSL presentes
- `615abe43d6bc` : 3095 systemes
...
| connect | 4 | 3 | 2001 | 1006 | 141 | 67 | 207 | 156 | 186 | 216 | 10.8% |
...
- candidats AVEC connectivite : 219, dont T2 : 100%
- candidats SANS connectivite : 309, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **186 systemes avec CONNECTED sur 1686 (11.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- TROP-CHER : 187 systemes abandonnes (4.6% des systemes), 95% du temps total
  dont 186 avec CONNECTED, 1 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 11.4% sur 1629 systemes
  - sans CONNECTED : 0.0% sur 372 systemes
