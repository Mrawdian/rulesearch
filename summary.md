...
genere 2026-08-26 12:42 UTC — 44608 systemes evalues
...
| connect | 4 | 3 | 19457 | 9699 | 1271 | 678 | 1943 | 1545 | 2095 | 1983 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 19036 | 4469 | 8027 | 13 | 2624 | 986 | 7 | 2910 | 15.3% |
...
- candidats AVEC connectivite : 2110, dont T2 : 100%
- candidats SANS connectivite : 3220, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2369 systemes avec CONNECTED sur 18388 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1040 candidats sur 5330 portent les champs bruts (20%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `e40600351a72` — 119 candidats
  - AVEC connectivite (59) : resistance **40.1%**
  - SANS connectivite (60) : resistance **18.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e40600351a72` — 119 candidats
  - AVEC connectivite (59) : T0=12.93 T1=0.00 T2=2.97 — pondere **5.93**
  - SANS connectivite (60) : T0=17.10 T1=0.00 T2=2.58 — pondere **5.17**
...
- TROP-CHER : 2386 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2369 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 15887 systemes
  - sans CONNECTED : 0.0% sur 3570 systemes
