...
genere 2026-08-28 01:05 UTC — 122164 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 38820 systemes
...
- moteur actif `0caa9267db60` (78422 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 58617 | 29197 | 4052 | 1976 | 5828 | 4639 | 6162 | 6009 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 57432 | 13260 | 24368 | 28 | 7973 | 2979 | 26 | 8796 | 15.3% |
...
- candidats AVEC connectivite : 6136, dont T2 : 100%
- candidats SANS connectivite : 9106, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6436 systemes avec CONNECTED sur 50359 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10952 candidats sur 15242 portent les champs bruts (72%).*

- `5c556c16ea8b` — 4987 candidats
  - AVEC connectivite (2008) : resistance **42.0%**
  - SANS connectivite (2979) : resistance **22.3%**
...
- `5c556c16ea8b` — 4987 candidats
  - AVEC connectivite (2008) : T0=13.00 T1=0.00 T2=3.05 — pondere **6.10**
  - SANS connectivite (2979) : T0=15.85 T1=0.00 T2=2.71 — pondere **5.43**
...
## cout
- temps total 37.6 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 6472 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6436 avec CONNECTED, 36 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 47858 systemes
  - sans CONNECTED : 0.0% sur 10759 systemes
