...
genere 2026-09-02 11:09 UTC — 309605 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 226261 systemes
...
- moteur actif `0caa9267db60` (265863 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 153274 | 76136 | 10434 | 5128 | 15583 | 12065 | 16232 | 15731 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 150216 | 34993 | 63526 | 63 | 20766 | 7760 | 63 | 23033 | 15.3% |
...
- candidats AVEC connectivite : 15858, dont T2 : 100%
- candidats SANS connectivite : 23343, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16506 systemes avec CONNECTED sur 127600 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*34911 candidats sur 39201 portent les champs bruts (89%).*

- `5c556c16ea8b` — 28946 candidats
  - AVEC connectivite (11730) : resistance **41.1%**
  - SANS connectivite (17216) : resistance **21.3%**
...
- `5c556c16ea8b` — 28946 candidats
  - AVEC connectivite (11730) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (17216) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 16579 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16506 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 125099 systemes
  - sans CONNECTED : 0.0% sur 28175 systemes
