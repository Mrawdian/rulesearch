...
genere 2026-09-03 19:34 UTC — 346194 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 262850 systemes
...
- moteur actif `0caa9267db60` (302452 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 171744 | 85371 | 11651 | 5750 | 17484 | 13544 | 18201 | 17555 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 168335 | 39144 | 71157 | 67 | 23336 | 8712 | 66 | 25841 | 15.4% |
...
- candidats SANS connectivite : 26151, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18475 systemes avec CONNECTED sur 142627 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39543 candidats sur 43833 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33578 candidats
  - AVEC connectivite (13554) : resistance **41.0%**
  - SANS connectivite (20024) : resistance **21.2%**
...
- `5c556c16ea8b` — 33578 candidats
  ...
  - SANS connectivite (20024) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.29**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 140126 systemes
  - sans CONNECTED : 0.0% sur 31618 systemes
