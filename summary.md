...
genere 2026-08-26 04:44 UTC — 24180 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 15206 systemes
...
| connect | 4 | 3 | 12165 | 6101 | 797 | 423 | 1172 | 975 | 1314 | 1233 | 10.1% |
...
- candidats AVEC connectivite : 1236, dont T2 : 100%
...
- **1314 systemes avec CONNECTED sur 10026 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1905 candidats
  - AVEC connectivite (757) : T0=13.31 T1=0.00 T2=2.84 — pondere **5.68**
...
- TROP-CHER : 1318 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1314 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 9969 systemes
  - sans CONNECTED : 0.0% sur 2196 systemes
