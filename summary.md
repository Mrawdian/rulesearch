...
genere 2026-08-26 02:29 UTC — 18326 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 9352 systemes
...
| connect | 4 | 3 | 9208 | 4630 | 603 | 307 | 885 | 729 | 1002 | 941 | 10.2% |
| ref | 4 | 3 | 8994 | 2159 | 3786 | 2 | 1196 | 448 | 4 | 1399 | 15.6% |
...
- candidats AVEC connectivite : 944, dont T2 : 100%
- candidats SANS connectivite : 1403, dont T2 : 100%
...
- **1002 systemes avec CONNECTED sur 7625 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1182 candidats
  - AVEC connectivite (465) : T0=13.36 T1=0.00 T2=2.90 — pondere **5.81**
  - SANS connectivite (717) : T0=15.85 T1=0.00 T2=2.66 — pondere **5.32**
  - test de permutation : **p = 0.0100** — ecart significatif au seuil 0.05
...
- TROP-CHER : 1006 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1002 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 7568 systemes
  - sans CONNECTED : 0.0% sur 1640 systemes
