...
genere 2026-09-09 10:48 UTC — 477419 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 394075 systemes
...
- moteur actif `0caa9267db60` (433677 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 238027 | 118183 | 16232 | 7977 | 24084 | 18655 | 25340 | 24531 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 233277 | 54357 | 98294 | 92 | 32489 | 12048 | 84 | 35894 | 15.4% |
...
- candidats AVEC connectivite : 24658, dont T2 : 100%
- candidats SANS connectivite : 36204, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25614 systemes avec CONNECTED sur 196844 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*56572 candidats sur 60862 portent les champs bruts (93%).*

- `5c556c16ea8b` — 50607 candidats
  - AVEC connectivite (20530) : resistance **41.2%**
  - SANS connectivite (30077) : resistance **21.3%**
...
- `5c556c16ea8b` — 50607 candidats
  - AVEC connectivite (20530) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (30077) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 194343 systemes
  - sans CONNECTED : 0.0% sur 43684 systemes
