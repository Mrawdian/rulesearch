...
genere 2026-09-07 10:06 UTC — 433489 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 350145 systemes
...
- moteur actif `0caa9267db60` (389747 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 215838 | 107208 | 14693 | 7192 | 21869 | 16929 | 22951 | 22251 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 211536 | 49236 | 89187 | 82 | 29476 | 10941 | 76 | 32520 | 15.4% |
...
- candidats AVEC connectivite : 22378, dont T2 : 100%
- candidats SANS connectivite : 32830, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23225 systemes avec CONNECTED sur 178702 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*50918 candidats sur 55208 portent les champs bruts (92%).*

- `5c556c16ea8b` — 44953 candidats
  - AVEC connectivite (18250) : resistance **41.1%**
  - SANS connectivite (26703) : resistance **21.3%**
...
- `5c556c16ea8b` — 44953 candidats
  - AVEC connectivite (18250) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (26703) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 176201 systemes
  - sans CONNECTED : 0.0% sur 39637 systemes
