...
genere 2026-08-26 14:50 UTC — 49856 systemes evalues
...
- moteur actif `0caa9267db60` (6114 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22101 | 11026 | 1481 | 758 | 2192 | 1752 | 2364 | 2250 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 21640 | 5030 | 9127 | 13 | 3012 | 1114 | 9 | 3335 | 15.4% |
...
- candidats AVEC connectivite : 2377, dont T2 : 100%
- candidats SANS connectivite : 3645, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2638 systemes avec CONNECTED sur 20554 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1732 candidats sur 6022 portent les champs bruts (29%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 617 candidats
  - AVEC connectivite (239) : resistance **41.2%**
  - SANS connectivite (378) : resistance **21.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 617 candidats
  - AVEC connectivite (239) : T0=13.37 T1=0.00 T2=3.05 — pondere **6.10**
  - SANS connectivite (378) : T0=16.01 T1=0.00 T2=2.68 — pondere **5.35**
...
- TROP-CHER : 2657 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2638 avec CONNECTED, 19 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18053 systemes
  - sans CONNECTED : 0.0% sur 4048 systemes
