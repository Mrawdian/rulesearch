...
| connect | 4 | 3 | 4944 | 2482 | 310 | 175 | 479 | 401 | 520 | 519 | 10.5% |
...
- candidats AVEC connectivite : 522, dont T2 : 100%
...
- **520 systemes avec CONNECTED sur 4105 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 118 candidats
  - AVEC connectivite (43) : T0=12.49 T1=0.00 T2=3.05 — pondere **6.09**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 4048 systemes
  - sans CONNECTED : 0.0% sur 896 systemes
