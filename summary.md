...
genere 2026-08-27 03:12 UTC — 77833 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 12926 systemes
...
- moteur actif `0caa9267db60` (34091 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 36245 | 18027 | 2496 | 1228 | 3596 | 2862 | 3847 | 3715 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 35473 | 8185 | 15085 | 20 | 4902 | 1848 | 19 | 5414 | 15.3% |
...
- candidats SANS connectivite : 5724, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4121 systemes avec CONNECTED sur 32171 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5276 candidats sur 9566 portent les champs bruts (55%).*
...
- `ab89a63b01ef` — 1599 candidats
  - AVEC connectivite (662) : resistance **41.2%**
  - SANS connectivite (937) : resistance **22.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1599 candidats
  ...
  - SANS connectivite (937) : T0=15.92 T1=0.00 T2=2.72 — pondere **5.43**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- TROP-CHER : 4150 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4121 avec CONNECTED, 29 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 29670 systemes
  - sans CONNECTED : 0.0% sur 6575 systemes
