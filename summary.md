...
genere 2026-08-26 19:55 UTC — 61721 systemes evalues
...
- moteur actif `0caa9267db60` (17979 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 28108 | 14002 | 1922 | 947 | 2784 | 2223 | 2992 | 2886 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 27498 | 6349 | 11648 | 15 | 3824 | 1417 | 12 | 4233 | 15.4% |
...
- candidats AVEC connectivite : 3013, dont T2 : 100%
- candidats SANS connectivite : 4543, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3266 systemes avec CONNECTED sur 25506 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3266 candidats sur 7556 portent les champs bruts (43%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 397 candidats
  - AVEC connectivite (169) : resistance **39.3%**
  - SANS connectivite (228) : resistance **19.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 397 candidats
  - AVEC connectivite (169) : T0=12.96 T1=0.00 T2=2.85 — pondere **5.69**
  - SANS connectivite (228) : T0=16.08 T1=0.00 T2=2.58 — pondere **5.17**
  - test de permutation : **p = 0.0970** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
## cout
- temps total 19.1 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 3288 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3266 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23005 systemes
  - sans CONNECTED : 0.0% sur 5103 systemes
