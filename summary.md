...
genere 2026-08-26 20:00 UTC — 61928 systemes evalues
...
- moteur actif `0caa9267db60` (18186 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 28213 | 14051 | 1928 | 949 | 2797 | 2234 | 3002 | 2898 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 27600 | 6374 | 11696 | 15 | 3832 | 1422 | 12 | 4249 | 15.4% |
...
- candidats AVEC connectivite : 3025, dont T2 : 100%
- candidats SANS connectivite : 4559, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3276 systemes avec CONNECTED sur 25585 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3294 candidats sur 7584 portent les champs bruts (43%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 425 candidats
  - AVEC connectivite (181) : resistance **39.3%**
  - SANS connectivite (244) : resistance **19.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 425 candidats
  - AVEC connectivite (181) : T0=12.82 T1=0.00 T2=2.83 — pondere **5.66**
  - SANS connectivite (244) : T0=16.14 T1=0.00 T2=2.60 — pondere **5.20**
...
- TROP-CHER : 3298 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3276 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23084 systemes
  - sans CONNECTED : 0.0% sur 5129 systemes
