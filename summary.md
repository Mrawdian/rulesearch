...
genere 2026-08-27 02:48 UTC — 76919 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 12012 systemes
...
- moteur actif `0caa9267db60` (33177 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 35782 | 17810 | 2457 | 1210 | 3549 | 2832 | 3803 | 3658 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 35022 | 8079 | 14892 | 20 | 4840 | 1831 | 19 | 5341 | 15.3% |
...
- candidats AVEC connectivite : 3785, dont T2 : 100%
- candidats SANS connectivite : 5651, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4077 systemes avec CONNECTED sur 31790 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5146 candidats sur 9436 portent les champs bruts (55%).*
...
- `ab89a63b01ef` — 1469 candidats
  - AVEC connectivite (605) : resistance **41.2%**
  - SANS connectivite (864) : resistance **22.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1469 candidats
  - AVEC connectivite (605) : T0=13.01 T1=0.00 T2=3.05 — pondere **6.09**
  - SANS connectivite (864) : T0=15.95 T1=0.00 T2=2.70 — pondere **5.41**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 29289 systemes
  - sans CONNECTED : 0.0% sur 6493 systemes
