...
genere 2026-08-28 02:25 UTC — 124843 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 41499 systemes
...
- moteur actif `0caa9267db60` (81101 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 59976 | 29871 | 4145 | 2029 | 5967 | 4749 | 6284 | 6160 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 58752 | 13588 | 24901 | 28 | 8170 | 3042 | 26 | 8995 | 15.3% |
...
- candidats SANS connectivite : 9305, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6558 systemes avec CONNECTED sur 51457 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11302 candidats sur 15592 portent les champs bruts (72%).*

- `5c556c16ea8b` — 5337 candidats
  - AVEC connectivite (2159) : resistance **41.8%**
  - SANS connectivite (3178) : resistance **22.2%**
...
- `5c556c16ea8b` — 5337 candidats
  ...
  - SANS connectivite (3178) : T0=15.85 T1=0.00 T2=2.70 — pondere **5.40**
...
- TROP-CHER : 6594 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6558 avec CONNECTED, 36 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 48956 systemes
  - sans CONNECTED : 0.0% sur 11020 systemes
