...
genere 2026-08-27 10:09 UTC — 92864 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 18378 systemes
- `5c556c16ea8b` : 9520 systemes
...
- moteur actif `0caa9267db60` (49122 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 43828 | 21850 | 3008 | 1484 | 4372 | 3453 | 4606 | 4487 | 10.2% |
...
- candidats AVEC connectivite : 4614, dont T2 : 100%
- candidats SANS connectivite : 6857, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4880 systemes avec CONNECTED sur 38319 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*7181 candidats sur 11471 portent les champs bruts (63%).*
...
- `ab89a63b01ef` — 2280 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 1216 candidats
  - AVEC connectivite (486) : resistance **41.3%**
...
- `ab89a63b01ef` — 2280 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 1216 candidats
  - AVEC connectivite (486) : T0=12.98 T1=0.00 T2=3.00 — pondere **6.01**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 35818 systemes
  - sans CONNECTED : 0.0% sur 8010 systemes
