...
genere 2026-09-06 16:21 UTC — 416707 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 333363 systemes
...
- moteur actif `0caa9267db60` (372965 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 207352 | 102950 | 14128 | 6896 | 21017 | 16323 | 22033 | 21368 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 203240 | 47254 | 85747 | 79 | 28338 | 10496 | 73 | 31236 | 15.4% |
...
- candidats AVEC connectivite : 21495, dont T2 : 100%
- candidats SANS connectivite : 31546, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **22307 systemes avec CONNECTED sur 171696 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*48751 candidats sur 53041 portent les champs bruts (92%).*

- `5c556c16ea8b` — 42786 candidats
  - AVEC connectivite (17367) : resistance **41.1%**
  - SANS connectivite (25419) : resistance **21.3%**
...
- `5c556c16ea8b` — 42786 candidats
  - AVEC connectivite (17367) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (25419) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 169195 systemes
  - sans CONNECTED : 0.0% sur 38157 systemes
