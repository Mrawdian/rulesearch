...
genere 2026-08-27 00:25 UTC — 71650 systemes evalues
...
- moteur actif `0caa9267db60` (27908 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 33120 | 16454 | 2280 | 1122 | 3293 | 2634 | 3530 | 3383 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 32415 | 7472 | 13758 | 18 | 4495 | 1700 | 16 | 4956 | 15.3% |
...
- candidats AVEC connectivite : 3510, dont T2 : 100%
- candidats SANS connectivite : 5266, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3804 systemes avec CONNECTED sur 29582 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4486 candidats sur 8776 portent les champs bruts (51%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 809 candidats
  - AVEC connectivite (330) : resistance **41.5%**
  - SANS connectivite (479) : resistance **21.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 809 candidats
  - AVEC connectivite (330) : T0=13.16 T1=0.00 T2=3.08 — pondere **6.16**
  - SANS connectivite (479) : T0=15.93 T1=0.00 T2=2.62 — pondere **5.24**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 798 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 27081 systemes
  - sans CONNECTED : 0.0% sur 6039 systemes
