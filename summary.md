...
genere 2026-08-27 02:07 UTC — 75337 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 10430 systemes
...
- moteur actif `0caa9267db60` (31595 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 34988 | 17404 | 2405 | 1184 | 3471 | 2779 | 3728 | 3569 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 34234 | 7885 | 14563 | 20 | 4750 | 1782 | 18 | 5216 | 15.2% |
...
- candidats AVEC connectivite : 3696, dont T2 : 100%
- candidats SANS connectivite : 5526, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4002 systemes avec CONNECTED sur 31127 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4932 candidats sur 9222 portent les champs bruts (53%).*
...
- `ab89a63b01ef` — 1255 candidats
  - AVEC connectivite (516) : resistance **41.2%**
  - SANS connectivite (739) : resistance **22.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1255 candidats
  - AVEC connectivite (516) : T0=13.00 T1=0.00 T2=3.05 — pondere **6.09**
  - SANS connectivite (739) : T0=15.91 T1=0.00 T2=2.70 — pondere **5.41**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- TROP-CHER : 4030 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4002 avec CONNECTED, 28 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 28626 systemes
  - sans CONNECTED : 0.0% sur 6362 systemes
