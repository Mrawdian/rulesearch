...
genere 2026-08-28 17:49 UTC — 151738 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 68394 systemes
...
- moteur actif `0caa9267db60` (107996 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 73547 | 36530 | 5010 | 2515 | 7382 | 5863 | 7766 | 7543 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 72076 | 16744 | 30475 | 33 | 9953 | 3713 | 31 | 11124 | 15.4% |
...
- candidats AVEC connectivite : 7670, dont T2 : 100%
- candidats SANS connectivite : 11434, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8040 systemes avec CONNECTED sur 62494 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*14814 candidats sur 19104 portent les champs bruts (78%).*

- `5c556c16ea8b` — 8849 candidats
  - AVEC connectivite (3542) : resistance **41.1%**
  - SANS connectivite (5307) : resistance **21.7%**
...
- `5c556c16ea8b` — 8849 candidats
  - AVEC connectivite (3542) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (5307) : T0=15.89 T1=0.00 T2=2.68 — pondere **5.36**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 59993 systemes
