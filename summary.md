...
genere 2026-09-07 18:33 UTC — 441320 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 357976 systemes
...
- moteur actif `0caa9267db60` (397578 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 219795 | 109180 | 14997 | 7321 | 22248 | 17216 | 23383 | 22654 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 215410 | 50160 | 90788 | 85 | 30019 | 11138 | 77 | 33125 | 15.4% |
...
- candidats AVEC connectivite : 22781, dont T2 : 100%
- candidats SANS connectivite : 33435, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23657 systemes avec CONNECTED sur 181963 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*51926 candidats sur 56216 portent les champs bruts (92%).*

- `5c556c16ea8b` — 45961 candidats
  - AVEC connectivite (18653) : resistance **41.1%**
  - SANS connectivite (27308) : resistance **21.3%**
...
- `5c556c16ea8b` — 45961 candidats
  - AVEC connectivite (18653) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (27308) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 179462 systemes
  - sans CONNECTED : 0.0% sur 40333 systemes
