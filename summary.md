...
genere 2026-09-05 02:03 UTC — 378691 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 295347 systemes
...
- moteur actif `0caa9267db60` (334949 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 188150 | 93439 | 12812 | 6286 | 19133 | 14825 | 19947 | 19293 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 184426 | 42911 | 77891 | 77 | 25618 | 9543 | 70 | 28302 | 15.3% |
...
- candidats AVEC connectivite : 19420, dont T2 : 100%
- candidats SANS connectivite : 28612, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20221 systemes avec CONNECTED sur 155984 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*43742 candidats sur 48032 portent les champs bruts (91%).*

- `5c556c16ea8b` — 37777 candidats
  - AVEC connectivite (15292) : resistance **41.1%**
  - SANS connectivite (22485) : resistance **21.2%**
...
- `5c556c16ea8b` — 37777 candidats
  - AVEC connectivite (15292) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (22485) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 20301 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 20221 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 153483 systemes
  - sans CONNECTED : 0.0% sur 34667 systemes
