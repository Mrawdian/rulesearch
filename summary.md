...
genere 2026-09-02 03:11 UTC — 300165 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 216821 systemes
...
- moteur actif `0caa9267db60` (256423 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 148512 | 73780 | 10107 | 4977 | 15070 | 11682 | 15733 | 15259 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 145538 | 33843 | 61599 | 62 | 20151 | 7519 | 63 | 22289 | 15.3% |
...
- candidats AVEC connectivite : 15386, dont T2 : 100%
- candidats SANS connectivite : 22599, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16007 systemes avec CONNECTED sur 123743 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*33695 candidats sur 37985 portent les champs bruts (89%).*

- `5c556c16ea8b` — 27730 candidats
  - AVEC connectivite (11258) : resistance **41.0%**
  - SANS connectivite (16472) : resistance **21.3%**
...
- `5c556c16ea8b` — 27730 candidats
  - AVEC connectivite (11258) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (16472) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
## cout
- temps total 93.1 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 16080 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16007 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 121242 systemes
  - sans CONNECTED : 0.0% sur 27270 systemes
