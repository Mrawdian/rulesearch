...
genere 2026-08-26 17:56 UTC — 57097 systemes evalues
...
- moteur actif `0caa9267db60` (13355 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `84fba70921e0`, `b71bb0907fb5`, `e40600351a72`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 25759 | 12830 | 1758 | 871 | 2556 | 2035 | 2752 | 2639 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 25223 | 5809 | 10684 | 15 | 3521 | 1282 | 10 | 3902 | 15.5% |
...
- candidats AVEC connectivite : 2766, dont T2 : 100%
- candidats SANS connectivite : 4212, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3026 systemes avec CONNECTED sur 23556 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2688 candidats sur 6978 portent les champs bruts (39%).*
...
- `b71bb0907fb5` — 53 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `0a74109317e5` — 39 candidats
  - AVEC connectivite (17) : resistance **43.5%**
  - SANS connectivite (22) : resistance **22.9%**
...
- `0a74109317e5` — 39 candidats
  - AVEC connectivite (17) : T0=13.88 T1=0.00 T2=3.29 — pondere **6.59**
  - SANS connectivite (22) : T0=15.50 T1=0.00 T2=2.77 — pondere **5.55**
  - *groupes trop petits (< 20) — aucun test, aucune conclusion*
- `e8a1f930f7b9` — 28 candidats
...
- TROP-CHER : 3046 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3026 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 21055 systemes
  - sans CONNECTED : 0.0% sur 4704 systemes
