...
genere 2026-08-31 05:44 UTC — 242531 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 159187 systemes
...
- moteur actif `0caa9267db60` (198789 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 119424 | 59415 | 8116 | 4003 | 11979 | 9414 | 12646 | 12298 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 116992 | 27317 | 49430 | 53 | 16165 | 6037 | 52 | 17928 | 15.3% |
...
- candidats AVEC connectivite : 12425, dont T2 : 100%
...
- **12920 systemes avec CONNECTED sur 100039 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*26373 candidats sur 30663 portent les champs bruts (86%).*

- `5c556c16ea8b` — 20408 candidats
  - AVEC connectivite (8297) : resistance **40.9%**
...
- `5c556c16ea8b` — 20408 candidats
  - AVEC connectivite (8297) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 12982 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 12920 avec CONNECTED, 62 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 97538 systemes
  - sans CONNECTED : 0.0% sur 21886 systemes
