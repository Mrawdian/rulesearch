...
genere 2026-08-26 16:27 UTC — 53683 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 8500 systemes
...
- moteur actif `0caa9267db60` (9941 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 24044 | 11995 | 1638 | 814 | 2383 | 1902 | 2566 | 2444 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 23524 | 5446 | 9939 | 14 | 3291 | 1200 | 10 | 3624 | 15.4% |
...
- candidats AVEC connectivite : 2571, dont T2 : 100%
- candidats SANS connectivite : 3934, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2840 systemes avec CONNECTED sur 22142 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2215 candidats sur 6505 portent les champs bruts (34%).*
...
- `06fe04a859f1` — 1100 candidats
  - AVEC connectivite (433) : resistance **40.8%**
  - SANS connectivite (667) : resistance **21.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1100 candidats
  - AVEC connectivite (433) : T0=13.15 T1=0.00 T2=3.01 — pondere **6.01**
  - SANS connectivite (667) : T0=15.95 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 2860 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2840 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19641 systemes
  - sans CONNECTED : 0.0% sur 4403 systemes
