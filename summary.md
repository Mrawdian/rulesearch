...
genere 2026-08-27 10:01 UTC — 92536 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 18378 systemes
- `5c556c16ea8b` : 9192 systemes
...
- moteur actif `0caa9267db60` (48794 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 43663 | 21764 | 2994 | 1476 | 4355 | 3438 | 4595 | 4475 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 42758 | 9857 | 18146 | 25 | 5940 | 2235 | 22 | 6532 | 15.3% |
...
- candidats AVEC connectivite : 4602, dont T2 : 100%
- candidats SANS connectivite : 6842, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4869 systemes avec CONNECTED sur 38185 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*7154 candidats sur 11444 portent les champs bruts (63%).*
...
- `ab89a63b01ef` — 2280 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 1189 candidats
  - AVEC connectivite (474) : resistance **41.5%**
  - SANS connectivite (715) : resistance **21.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 2280 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 1189 candidats
  - AVEC connectivite (474) : T0=12.97 T1=0.00 T2=3.02 — pondere **6.04**
  - SANS connectivite (715) : T0=15.81 T1=0.00 T2=2.64 — pondere **5.28**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- TROP-CHER : 4901 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4869 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 35684 systemes
  - sans CONNECTED : 0.0% sur 7979 systemes
