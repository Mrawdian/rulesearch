...
| connect | 4 | 3 | 18412 | 9192 | 1195 | 640 | 1839 | 1461 | 1999 | 1857 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 18029 | 4253 | 7595 | 12 | 2466 | 929 | 7 | 2767 | 15.3% |
...
- candidats AVEC connectivite : 1984, dont T2 : 100%
- candidats SANS connectivite : 3077, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2273 systemes avec CONNECTED sur 17533 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*771 candidats sur 5061 portent les champs bruts (15%).*
...
- `e3baecf8377b` — 507 candidats
  - AVEC connectivite (201) : resistance **42.5%**
  - SANS connectivite (306) : resistance **21.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 507 candidats
  - AVEC connectivite (201) : T0=13.01 T1=0.00 T2=3.10 — pondere **6.21**
  - SANS connectivite (306) : T0=16.05 T1=0.00 T2=2.68 — pondere **5.36**
...
- TROP-CHER : 2290 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 2273 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 15032 systemes
  - sans CONNECTED : 0.0% sur 3380 systemes
