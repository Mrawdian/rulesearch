...
genere 2026-09-03 15:25 UTC — 341614 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 258270 systemes
...
- moteur actif `0caa9267db60` (297872 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 169427 | 84214 | 11487 | 5675 | 17241 | 13373 | 17958 | 17317 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 166072 | 38633 | 70200 | 66 | 23038 | 8586 | 66 | 25471 | 15.3% |
...
- candidats AVEC connectivite : 17444, dont T2 : 100%
- candidats SANS connectivite : 25781, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18232 systemes avec CONNECTED sur 140733 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*38935 candidats sur 43225 portent les champs bruts (90%).*

- `5c556c16ea8b` — 32970 candidats
  - AVEC connectivite (13316) : resistance **41.0%**
  - SANS connectivite (19654) : resistance **21.2%**
...
- `5c556c16ea8b` — 32970 candidats
  - AVEC connectivite (13316) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (19654) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.29**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 138232 systemes
  - sans CONNECTED : 0.0% sur 31195 systemes
