...
| connect | 4 | 3 | 7187 | 3618 | 471 | 250 | 681 | 583 | 749 | 754 | 10.5% |
...
- candidats AVEC connectivite : 757, dont T2 : 100%
...
- **749 systemes avec CONNECTED sur 5950 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 702 candidats
  - AVEC connectivite (278) : T0=13.21 T1=0.00 T2=2.93 — pondere **5.86**
...
- TROP-CHER : 751 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 749 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 5893 systemes
  - sans CONNECTED : 0.0% sur 1294 systemes
