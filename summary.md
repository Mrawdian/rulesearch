...
genere 2026-08-26 13:45 UTC — 47470 systemes evalues
...
- moteur actif `0caa9267db60` (3728 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20901 | 10437 | 1388 | 721 | 2074 | 1661 | 2223 | 2139 | 10.2% |
...
- candidats AVEC connectivite : 2266, dont T2 : 100%
- candidats SANS connectivite : 3434, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2497 systemes avec CONNECTED sur 19572 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1410 candidats sur 5700 portent les champs bruts (25%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 295 candidats
  - AVEC connectivite (128) : resistance **39.8%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 295 candidats
  - AVEC connectivite (128) : T0=13.32 T1=0.00 T2=2.90 — pondere **5.80**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 17071 systemes
  - sans CONNECTED : 0.0% sur 3830 systemes
