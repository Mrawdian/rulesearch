...
genere 2026-08-27 20:30 UTC — 113047 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 29703 systemes
...
- moteur actif `0caa9267db60` (69305 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 54002 | 26896 | 3735 | 1835 | 5328 | 4276 | 5712 | 5516 | 10.2% |
...
- candidats AVEC connectivite : 5643, dont T2 : 100%
- candidats SANS connectivite : 8409, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5986 systemes avec CONNECTED sur 46632 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*9762 candidats sur 14052 portent les champs bruts (69%).*

- `5c556c16ea8b` — 3797 candidats
  - AVEC connectivite (1515) : resistance **42.0%**
...
- `5c556c16ea8b` — 3797 candidats
  - AVEC connectivite (1515) : T0=12.94 T1=0.00 T2=3.05 — pondere **6.11**
...
- TROP-CHER : 6021 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 5986 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 44131 systemes
  - sans CONNECTED : 0.0% sur 9871 systemes
