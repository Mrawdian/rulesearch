...
genere 2026-08-28 23:28 UTC — 161564 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 78220 systemes
...
- moteur actif `0caa9267db60` (117822 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 78515 | 39005 | 5356 | 2670 | 7856 | 6278 | 8262 | 8090 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 76934 | 17879 | 32562 | 35 | 10622 | 3932 | 31 | 11869 | 15.4% |
...
- candidats AVEC connectivite : 8217, dont T2 : 100%
- candidats SANS connectivite : 12179, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8536 systemes avec CONNECTED sur 66522 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*16106 candidats sur 20396 portent les champs bruts (79%).*

- `5c556c16ea8b` — 10141 candidats
  - AVEC connectivite (4089) : resistance **41.1%**
  - SANS connectivite (6052) : resistance **21.8%**
...
- `5c556c16ea8b` — 10141 candidats
  - AVEC connectivite (4089) : T0=13.01 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (6052) : T0=15.89 T1=0.00 T2=2.68 — pondere **5.36**
...
## cout
- temps total 49.7 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 8577 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8536 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 64021 systemes
  - sans CONNECTED : 0.0% sur 14494 systemes
