...
genere 2026-08-26 12:58 UTC — 45273 systemes evalues
...
- `06fe04a859f1` : 90 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (1531 systemes) : `06fe04a859f1`, `e40600351a72`
...
**7556 enregistrements (17%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 19785 | 9872 | 1287 | 685 | 1985 | 1564 | 2129 | 2018 | 10.2% |
...
- candidats AVEC connectivite : 2145, dont T2 : 100%
- candidats SANS connectivite : 3272, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2403 systemes avec CONNECTED sur 18655 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1127 candidats sur 5417 portent les champs bruts (21%).*
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 16154 systemes
  - sans CONNECTED : 0.0% sur 3631 systemes
