...
genere 2026-08-26 18:58 UTC — 59762 systemes evalues
...
- moteur actif `0caa9267db60` (16020 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27105 | 13526 | 1844 | 912 | 2689 | 2147 | 2874 | 2774 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 26542 | 6130 | 11240 | 15 | 3696 | 1368 | 10 | 4083 | 15.4% |
...
- candidats AVEC connectivite : 2901, dont T2 : 100%
- candidats SANS connectivite : 4393, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3148 systemes avec CONNECTED sur 24667 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3004 candidats sur 7294 portent les champs bruts (41%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 135 candidats
  - AVEC connectivite (57) : resistance **42.2%**
  - SANS connectivite (78) : resistance **18.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 135 candidats
  - AVEC connectivite (57) : T0=12.98 T1=0.00 T2=3.04 — pondere **6.07**
  - SANS connectivite (78) : T0=16.09 T1=0.00 T2=2.51 — pondere **5.03**
  - test de permutation : **p = 0.0565** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 3168 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3148 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22166 systemes
  - sans CONNECTED : 0.0% sur 4939 systemes
