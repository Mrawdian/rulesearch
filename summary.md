...
genere 2026-08-26 18:19 UTC — 58087 systemes evalues
...
- moteur actif `0caa9267db60` (14345 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `84fba70921e0`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 26268 | 13094 | 1786 | 891 | 2605 | 2073 | 2799 | 2696 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 25704 | 5913 | 10899 | 15 | 3587 | 1320 | 10 | 3960 | 15.4% |
...
- candidats SANS connectivite : 4270, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3073 systemes avec CONNECTED sur 23982 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2803 candidats sur 7093 portent les champs bruts (40%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `e80bc1b2b437` — 74 candidats
  - AVEC connectivite (38) : resistance **36.9%**
  - SANS connectivite (36) : resistance **20.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e80bc1b2b437` — 74 candidats
  ...
  - SANS connectivite (36) : T0=15.97 T1=0.00 T2=2.67 — pondere **5.33**
  - test de permutation : **p = 0.5662** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `0a74109317e5` — 80 candidats
...
- TROP-CHER : 3093 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3073 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 21481 systemes
