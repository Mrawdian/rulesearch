...
genere 2026-08-28 00:31 UTC — 120908 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 37564 systemes
...
- moteur actif `0caa9267db60` (77166 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 57974 | 28873 | 4014 | 1958 | 5756 | 4586 | 6113 | 5933 | 10.2% |
...
- candidats AVEC connectivite : 6060, dont T2 : 100%
- candidats SANS connectivite : 9016, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6387 systemes avec CONNECTED sur 49850 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10786 candidats sur 15076 portent les champs bruts (72%).*

- `5c556c16ea8b` — 4821 candidats
  - AVEC connectivite (1932) : resistance **42.0%**
...
- `5c556c16ea8b` — 4821 candidats
  - AVEC connectivite (1932) : T0=12.98 T1=0.00 T2=3.06 — pondere **6.11**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 47349 systemes
