...
genere 2026-08-26 02:04 UTC — 17423 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 8449 systemes
...
| connect | 4 | 3 | 8744 | 4395 | 572 | 294 | 834 | 700 | 942 | 900 | 10.3% |
| ref | 4 | 3 | 8555 | 2065 | 3600 | 2 | 1143 | 421 | 3 | 1321 | 15.4% |
...
- candidats AVEC connectivite : 903, dont T2 : 100%
- candidats SANS connectivite : 1325, dont T2 : 100%
...
- **942 systemes avec CONNECTED sur 7241 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1063 candidats
  - AVEC connectivite (424) : T0=13.36 T1=0.00 T2=2.86 — pondere **5.72**
  - SANS connectivite (639) : T0=15.90 T1=0.00 T2=2.67 — pondere **5.33**
...
- TROP-CHER : 945 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 942 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 7184 systemes
  - sans CONNECTED : 0.0% sur 1560 systemes
