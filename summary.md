...
genere 2026-09-01 01:56 UTC — 269290 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 185946 systemes
...
- moteur actif `0caa9267db60` (225548 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 132932 | 66054 | 8988 | 4461 | 13478 | 10517 | 14035 | 13674 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 130243 | 30349 | 55035 | 57 | 18040 | 6740 | 57 | 19955 | 15.3% |
...
- candidats AVEC connectivite : 13801, dont T2 : 100%
- candidats SANS connectivite : 20265, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14309 systemes avec CONNECTED sur 110959 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*29776 candidats sur 34066 portent les champs bruts (87%).*

- `5c556c16ea8b` — 23811 candidats
  - AVEC connectivite (9673) : resistance **41.0%**
  - SANS connectivite (14138) : resistance **21.3%**
...
- `5c556c16ea8b` — 23811 candidats
  - AVEC connectivite (9673) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (14138) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 108458 systemes
  - sans CONNECTED : 0.0% sur 24474 systemes
