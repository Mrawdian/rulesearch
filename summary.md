...
genere 2026-09-04 14:14 UTC — 366427 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 283083 systemes
...
- moteur actif `0caa9267db60` (322685 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 181955 | 90433 | 12376 | 6075 | 18521 | 14334 | 19269 | 18616 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 178357 | 41453 | 75347 | 73 | 24784 | 9238 | 70 | 27378 | 15.4% |
...
- candidats AVEC connectivite : 18743, dont T2 : 100%
- candidats SANS connectivite : 27688, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19543 systemes avec CONNECTED sur 150923 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*42141 candidats sur 46431 portent les champs bruts (91%).*

- `5c556c16ea8b` — 36176 candidats
  - AVEC connectivite (14615) : resistance **41.0%**
  - SANS connectivite (21561) : resistance **21.2%**
...
- `5c556c16ea8b` — 36176 candidats
  - AVEC connectivite (14615) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (21561) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 19623 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19543 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 148422 systemes
  - sans CONNECTED : 0.0% sur 33533 systemes
