...
- `89c65c03c4ad` — 298 candidats
  - AVEC connectivite (108) : T0=13.13 T1=0.00 T2=2.78 — pondere **5.56**
  - SANS connectivite (190) : T0=15.97 T1=0.00 T2=2.63 — pondere **5.25**
  - test de permutation : **p = 0.4218** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
