...
genere 2026-08-27 20:44 UTC — 113429 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 30085 systemes
...
- moteur actif `0caa9267db60` (69687 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 54197 | 26993 | 3746 | 1840 | 5346 | 4286 | 5738 | 5540 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 53117 | 12260 | 22577 | 26 | 7348 | 2760 | 25 | 8119 | 15.3% |
...
- candidats SANS connectivite : 8429, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6012 systemes avec CONNECTED sur 46797 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*9806 candidats sur 14096 portent les champs bruts (70%).*

- `5c556c16ea8b` — 3841 candidats
  - AVEC connectivite (1539) : resistance **42.0%**
  - SANS connectivite (2302) : resistance **22.4%**
...
- `5c556c16ea8b` — 3841 candidats
  ...
  - SANS connectivite (2302) : T0=15.77 T1=0.00 T2=2.70 — pondere **5.41**
...
- TROP-CHER : 6047 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6012 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 44296 systemes
  - sans CONNECTED : 0.0% sur 9901 systemes
