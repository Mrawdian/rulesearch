...
genere 2026-08-27 07:13 UTC — 86656 systemes evalues
...
- moteur actif `0caa9267db60` (42914 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 40686 | 20252 | 2784 | 1387 | 4073 | 3201 | 4291 | 4172 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 39855 | 9179 | 16943 | 22 | 5532 | 2081 | 21 | 6077 | 15.2% |
...
- candidats AVEC connectivite : 4299, dont T2 : 100%
- candidats SANS connectivite : 6387, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4565 systemes avec CONNECTED sur 35746 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6396 candidats sur 10686 portent les champs bruts (60%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 431 candidats
  - AVEC connectivite (171) : resistance **41.6%**
  - SANS connectivite (260) : resistance **20.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 431 candidats
  - AVEC connectivite (171) : T0=13.16 T1=0.00 T2=3.05 — pondere **6.11**
  - SANS connectivite (260) : T0=15.78 T1=0.00 T2=2.63 — pondere **5.25**
...
**7 serie(s) reproductible(s) sur 14 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `ab89a63b01ef` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `5c556c16ea8b` (p=0.0050), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
...
- TROP-CHER : 4596 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4565 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 33245 systemes
  - sans CONNECTED : 0.0% sur 7441 systemes
