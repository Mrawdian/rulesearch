...
genere 2026-09-02 16:08 UTC — 315211 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 231867 systemes
...
- moteur actif `0caa9267db60` (271469 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 156096 | 77558 | 10619 | 5219 | 15875 | 12278 | 16540 | 16002 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 153000 | 35639 | 64732 | 64 | 21127 | 7917 | 63 | 23446 | 15.3% |
...
- candidats AVEC connectivite : 16129, dont T2 : 100%
...
- **16814 systemes avec CONNECTED sur 129913 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*35595 candidats sur 39885 portent les champs bruts (89%).*

- `5c556c16ea8b` — 29630 candidats
  - AVEC connectivite (12001) : resistance **41.0%**
...
- `5c556c16ea8b` — 29630 candidats
  - AVEC connectivite (12001) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 16887 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16814 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 127412 systemes
  - sans CONNECTED : 0.0% sur 28684 systemes
