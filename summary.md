...
genere 2026-08-27 07:21 UTC — 86936 systemes evalues
...
- moteur actif `0caa9267db60` (43194 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 40836 | 20332 | 2794 | 1389 | 4092 | 3207 | 4306 | 4190 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 39985 | 9213 | 16997 | 22 | 5548 | 2088 | 21 | 6096 | 15.2% |
...
- candidats AVEC connectivite : 4317, dont T2 : 100%
- candidats SANS connectivite : 6406, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4580 systemes avec CONNECTED sur 35869 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6433 candidats sur 10723 portent les champs bruts (60%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 468 candidats
  - AVEC connectivite (189) : resistance **42.0%**
  - SANS connectivite (279) : resistance **20.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 468 candidats
  - AVEC connectivite (189) : T0=12.98 T1=0.00 T2=3.06 — pondere **6.13**
  - SANS connectivite (279) : T0=15.78 T1=0.00 T2=2.61 — pondere **5.23**
...
- TROP-CHER : 4611 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4580 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 33368 systemes
  - sans CONNECTED : 0.0% sur 7468 systemes
