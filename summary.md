...
genere 2026-08-30 20:42 UTC — 230112 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 146768 systemes
...
- moteur actif `0caa9267db60` (186370 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 113159 | 56266 | 7695 | 3786 | 11359 | 8957 | 11975 | 11644 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 110838 | 25852 | 46843 | 52 | 15283 | 5729 | 47 | 17022 | 15.4% |
...
- candidats AVEC connectivite : 11771, dont T2 : 100%
- candidats SANS connectivite : 17332, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12249 systemes avec CONNECTED sur 94878 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*24813 candidats sur 29103 portent les champs bruts (85%).*

- `5c556c16ea8b` — 18848 candidats
  - AVEC connectivite (7643) : resistance **41.1%**
  - SANS connectivite (11205) : resistance **21.4%**
...
- `5c556c16ea8b` — 18848 candidats
  - AVEC connectivite (7643) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (11205) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 12306 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 12249 avec CONNECTED, 57 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 92377 systemes
  - sans CONNECTED : 0.0% sur 20782 systemes
