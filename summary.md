...
genere 2026-09-01 21:00 UTC — 292827 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 209483 systemes
...
- moteur actif `0caa9267db60` (249085 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 144800 | 71915 | 9845 | 4848 | 14701 | 11412 | 15319 | 14891 | 10.3% |
...
- candidats AVEC connectivite : 15018, dont T2 : 100%
...
- **15593 systemes avec CONNECTED sur 120673 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*32784 candidats sur 37074 portent les champs bruts (88%).*

- `5c556c16ea8b` — 26819 candidats
  - AVEC connectivite (10890) : resistance **41.0%**
...
- `5c556c16ea8b` — 26819 candidats
  - AVEC connectivite (10890) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 15666 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15593 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 118172 systemes
  - sans CONNECTED : 0.0% sur 26628 systemes
