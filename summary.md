...
genere 2026-09-08 02:58 UTC — 448864 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 365520 systemes
...
- moteur actif `0caa9267db60` (405122 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 223594 | 111032 | 15235 | 7469 | 22625 | 17522 | 23823 | 23037 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 219155 | 51055 | 92360 | 87 | 30554 | 11323 | 79 | 33679 | 15.4% |
...
- candidats AVEC connectivite : 23164, dont T2 : 100%
- candidats SANS connectivite : 33989, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **24097 systemes avec CONNECTED sur 185080 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*52863 candidats sur 57153 portent les champs bruts (92%).*

- `5c556c16ea8b` — 46898 candidats
  - AVEC connectivite (19036) : resistance **41.2%**
  - SANS connectivite (27862) : resistance **21.3%**
...
- `5c556c16ea8b` — 46898 candidats
  - AVEC connectivite (19036) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (27862) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
## cout
- temps total 140.0 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 24186 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 24097 avec CONNECTED, 89 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 182579 systemes
  - sans CONNECTED : 0.0% sur 41015 systemes
