...
genere 2026-08-25 21:28 UTC — 5750 systemes evalues

## versions du DSL presentes
- `615abe43d6bc` : 4773 systemes
...
| connect | 4 | 3 | 2852 | 1447 | 183 | 100 | 280 | 216 | 289 | 300 | 10.5% |
| ref | 4 | 3 | 2774 | 645 | 1184 | 1 | 379 | 134 | 1 | 430 | 15.5% |
...
- candidats AVEC connectivite : 303, dont T2 : 100%
- candidats SANS connectivite : 434, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **289 systemes avec CONNECTED sur 2401 (12.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- TROP-CHER : 290 systemes abandonnes (5.0% des systemes), 95% du temps total
  dont 289 avec CONNECTED, 1 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.3% sur 2344 systemes
  - sans CONNECTED : 0.0% sur 508 systemes
