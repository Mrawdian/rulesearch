...
genere 2026-08-27 03:29 UTC — 78441 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 13534 systemes
...
- moteur actif `0caa9267db60` (34699 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 36558 | 18161 | 2525 | 1241 | 3636 | 2892 | 3880 | 3746 | 10.2% |
...
- candidats AVEC connectivite : 3873, dont T2 : 100%
- candidats SANS connectivite : 5762, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4154 systemes avec CONNECTED sur 32414 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5345 candidats sur 9635 portent les champs bruts (55%).*
...
- `ab89a63b01ef` — 1668 candidats
  - AVEC connectivite (693) : resistance **41.2%**
...
- `ab89a63b01ef` — 1668 candidats
  - AVEC connectivite (693) : T0=13.04 T1=0.00 T2=3.03 — pondere **6.07**
...
- TROP-CHER : 4183 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4154 avec CONNECTED, 29 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 29913 systemes
