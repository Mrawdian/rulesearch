...
genere 2026-08-29 17:45 UTC — 190814 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 107470 systemes
...
- moteur actif `0caa9267db60` (147072 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 93289 | 46356 | 6356 | 3131 | 9401 | 7427 | 9832 | 9593 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 91410 | 21341 | 38571 | 43 | 12634 | 4702 | 36 | 14077 | 15.4% |
...
- candidats AVEC connectivite : 9720, dont T2 : 100%
- candidats SANS connectivite : 14387, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10106 systemes avec CONNECTED sur 78599 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*19817 candidats sur 24107 portent les champs bruts (82%).*

- `5c556c16ea8b` — 13852 candidats
  - AVEC connectivite (5592) : resistance **41.1%**
  - SANS connectivite (8260) : resistance **21.6%**
...
- `5c556c16ea8b` — 13852 candidats
  - AVEC connectivite (5592) : T0=12.99 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (8260) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.34**
...
- TROP-CHER : 10152 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10106 avec CONNECTED, 46 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 76098 systemes
  - sans CONNECTED : 0.0% sur 17191 systemes
