...
genere 2026-08-26 05:14 UTC — 25391 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 16417 systemes
...
| connect | 4 | 3 | 12774 | 6400 | 839 | 435 | 1242 | 1019 | 1384 | 1291 | 10.1% |
| ref | 4 | 3 | 12493 | 2985 | 5248 | 9 | 1692 | 631 | 4 | 1924 | 15.4% |
...
- candidats AVEC connectivite : 1294, dont T2 : 100%
- candidats SANS connectivite : 1928, dont T2 : 100%
...
- **1384 systemes avec CONNECTED sur 10523 (13.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2057 candidats
  - AVEC connectivite (815) : T0=13.25 T1=0.00 T2=2.85 — pondere **5.71**
  - SANS connectivite (1242) : T0=15.91 T1=0.00 T2=2.64 — pondere **5.28**
  - test de permutation : **p = 0.0035** — ecart significatif au seuil 0.05
...
- TROP-CHER : 1388 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1384 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 10466 systemes
  - sans CONNECTED : 0.0% sur 2308 systemes
