...
genere 2026-08-26 07:23 UTC — 30804 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 21830 systemes
...
- candidats AVEC connectivite : 1485, dont T2 : 100%
- candidats SANS connectivite : 2278, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1673 systemes avec CONNECTED sur 12740 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2598 candidats
  - AVEC connectivite (1006) : T0=13.19 T1=0.00 T2=2.88 — pondere **5.76**
...
- TROP-CHER : 1682 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1673 avec CONNECTED, 9 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
