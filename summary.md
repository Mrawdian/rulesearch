...
genere 2026-09-02 07:36 UTC — 305447 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 222103 systemes
...
- moteur actif `0caa9267db60` (261705 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 151171 | 75117 | 10281 | 5060 | 15347 | 11897 | 16010 | 15527 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 148161 | 34504 | 62670 | 62 | 20500 | 7642 | 63 | 22708 | 15.3% |
...
- candidats AVEC connectivite : 15654, dont T2 : 100%
- candidats SANS connectivite : 23018, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16284 systemes avec CONNECTED sur 125903 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*34382 candidats sur 38672 portent les champs bruts (89%).*

- `5c556c16ea8b` — 28417 candidats
  - AVEC connectivite (11526) : resistance **41.1%**
  - SANS connectivite (16891) : resistance **21.3%**
...
- `5c556c16ea8b` — 28417 candidats
  - AVEC connectivite (11526) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (16891) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 123402 systemes
  - sans CONNECTED : 0.0% sur 27769 systemes
