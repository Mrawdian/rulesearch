...
genere 2026-08-27 22:17 UTC — 116490 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 33146 systemes
...
- moteur actif `0caa9267db60` (72748 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 55754 | 27777 | 3851 | 1891 | 5520 | 4416 | 5893 | 5686 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 54621 | 12598 | 23195 | 26 | 7576 | 2829 | 25 | 8370 | 15.3% |
...
- candidats AVEC connectivite : 5813, dont T2 : 100%
- candidats SANS connectivite : 8680, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6167 systemes avec CONNECTED sur 48052 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10203 candidats sur 14493 portent les champs bruts (70%).*

- `5c556c16ea8b` — 4238 candidats
  - AVEC connectivite (1685) : resistance **41.9%**
  - SANS connectivite (2553) : resistance **22.5%**
...
- `5c556c16ea8b` — 4238 candidats
  - AVEC connectivite (1685) : T0=12.94 T1=0.00 T2=3.05 — pondere **6.09**
  - SANS connectivite (2553) : T0=15.79 T1=0.00 T2=2.72 — pondere **5.43**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 45551 systemes
  - sans CONNECTED : 0.0% sur 10203 systemes
