...
genere 2026-08-31 16:00 UTC — 256531 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 173187 systemes
...
- moteur actif `0caa9267db60` (212789 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 126487 | 62886 | 8556 | 4240 | 12786 | 10006 | 13339 | 13018 | 10.3% |
...
- candidats AVEC connectivite : 13145, dont T2 : 100%
...
- **13613 systemes avec CONNECTED sur 105701 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*28186 candidats sur 32476 portent les champs bruts (87%).*

- `5c556c16ea8b` — 22221 candidats
  - AVEC connectivite (9017) : resistance **41.0%**
...
- `5c556c16ea8b` — 22221 candidats
  - AVEC connectivite (9017) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.97**
...
- TROP-CHER : 13679 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13613 avec CONNECTED, 66 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 103200 systemes
  - sans CONNECTED : 0.0% sur 23287 systemes
