...
| connect | 4 | 3 | 4856 | 2435 | 303 | 170 | 474 | 396 | 510 | 511 | 10.5% |
...
- candidats AVEC connectivite : 514, dont T2 : 100%
...
- **510 systemes avec CONNECTED sur 4032 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 97 candidats
  - AVEC connectivite (35) : T0=12.26 T1=0.00 T2=3.03 — pondere **6.06**
...
- TROP-CHER : 512 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 510 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 3975 systemes
  - sans CONNECTED : 0.0% sur 881 systemes
