...
genere 2026-08-26 07:26 UTC — 30922 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 21948 systemes
...
| d4 | 4 | 4 | 2304 | 1061 | 586 | 13 | 170 | 154 | 111 | 152 | 6.6% |
| ref | 4 | 3 | 14092 | 3341 | 5917 | 9 | 1941 | 717 | 6 | 2161 | 15.3% |
...
- candidats AVEC connectivite : 1489, dont T2 : 100%
- candidats SANS connectivite : 2284, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1681 systemes avec CONNECTED sur 12795 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2608 candidats
  - AVEC connectivite (1010) : T0=13.19 T1=0.00 T2=2.89 — pondere **5.77**
  - SANS connectivite (1598) : T0=15.89 T1=0.01 T2=2.63 — pondere **5.27**
...
- TROP-CHER : 1690 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1681 avec CONNECTED, 9 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
