...
- `89c65c03c4ad` — 285 candidats
  - AVEC connectivite (100) : T0=13.16 T1=0.00 T2=2.80 — pondere **5.60**
  - SANS connectivite (185) : T0=15.96 T1=0.00 T2=2.64 — pondere **5.28**
  - test de permutation : **p = 0.3808** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
