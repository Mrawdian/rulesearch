...
genere 2026-08-26 06:22 UTC — 28242 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 19268 systemes
...
| connect | 4 | 3 | 13730 | 6868 | 898 | 478 | 1341 | 1088 | 1495 | 1382 | 10.1% |
...
- candidats AVEC connectivite : 1399, dont T2 : 100%
- candidats SANS connectivite : 2112, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1535 systemes avec CONNECTED sur 11689 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2346 candidats
  - AVEC connectivite (920) : T0=13.21 T1=0.00 T2=2.88 — pondere **5.75**
...
- TROP-CHER : 1541 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1535 avec CONNECTED, 6 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 11247 systemes
  - sans CONNECTED : 0.0% sur 2483 systemes
