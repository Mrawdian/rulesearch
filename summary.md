...
genere 2026-08-30 04:36 UTC — 207367 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 124023 systemes
...
- moteur actif `0caa9267db60` (163625 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 101660 | 50495 | 6918 | 3403 | 10262 | 8104 | 10705 | 10449 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 99592 | 23206 | 42071 | 45 | 13759 | 5144 | 38 | 15322 | 15.4% |
...
- candidats AVEC connectivite : 10576, dont T2 : 100%
- candidats SANS connectivite : 15632, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10979 systemes avec CONNECTED sur 85411 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*21918 candidats sur 26208 portent les champs bruts (84%).*

- `5c556c16ea8b` — 15953 candidats
  - AVEC connectivite (6448) : resistance **41.1%**
  - SANS connectivite (9505) : resistance **21.5%**
...
- `5c556c16ea8b` — 15953 candidats
  - AVEC connectivite (6448) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (9505) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 11027 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10979 avec CONNECTED, 48 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 82910 systemes
  - sans CONNECTED : 0.0% sur 18750 systemes
