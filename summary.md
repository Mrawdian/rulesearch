...
- moteur actif `0caa9267db60` (6736 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22414 | 11169 | 1506 | 767 | 2238 | 1776 | 2398 | 2279 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 21949 | 5090 | 9255 | 13 | 3067 | 1125 | 10 | 3389 | 15.4% |
...
- candidats AVEC connectivite : 2406, dont T2 : 100%
- candidats SANS connectivite : 3699, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2672 systemes avec CONNECTED sur 20792 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1815 candidats sur 6105 portent les champs bruts (30%).*
...
- `06fe04a859f1` — 700 candidats
  - AVEC connectivite (268) : resistance **41.2%**
  - SANS connectivite (432) : resistance **20.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 700 candidats
  - AVEC connectivite (268) : T0=13.28 T1=0.00 T2=3.03 — pondere **6.07**
  - SANS connectivite (432) : T0=16.03 T1=0.00 T2=2.62 — pondere **5.25**
...
- TROP-CHER : 2692 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2672 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18291 systemes
  - sans CONNECTED : 0.0% sur 4123 systemes
