...
| connect | 4 | 3 | 6471 | 3256 | 419 | 235 | 622 | 520 | 674 | 670 | 10.4% |
| ref | 4 | 3 | 6325 | 1535 | 2622 | 1 | 850 | 312 | 2 | 1003 | 15.9% |
...
- candidats AVEC connectivite : 673, dont T2 : 100%
- candidats SANS connectivite : 1007, dont T2 : 100%
...
- **674 systemes avec CONNECTED sur 5359 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 515 candidats
  - AVEC connectivite (194) : T0=13.21 T1=0.00 T2=2.89 — pondere **5.78**
  - SANS connectivite (321) : T0=15.83 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 676 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 674 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 5302 systemes
  - sans CONNECTED : 0.0% sur 1169 systemes
