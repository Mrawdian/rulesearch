...
genere 2026-09-08 11:07 UTC — 456227 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 372883 systemes
...
- moteur actif `0caa9267db60` (412485 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 227314 | 112903 | 15463 | 7601 | 22992 | 17817 | 24226 | 23417 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 222798 | 51879 | 93900 | 88 | 31048 | 11523 | 81 | 34261 | 15.4% |
...
- candidats SANS connectivite : 34571, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **24500 systemes avec CONNECTED sur 188124 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*53825 candidats sur 58115 portent les champs bruts (93%).*

- `5c556c16ea8b` — 47860 candidats
  - AVEC connectivite (19416) : resistance **41.2%**
  - SANS connectivite (28444) : resistance **21.3%**
...
- `5c556c16ea8b` — 47860 candidats
  ...
  - SANS connectivite (28444) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 185623 systemes
  - sans CONNECTED : 0.0% sur 41691 systemes
