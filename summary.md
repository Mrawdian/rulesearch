...
genere 2026-08-30 23:57 UTC — 234646 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 151302 systemes
...
- moteur actif `0caa9267db60` (190904 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 115447 | 57396 | 7837 | 3879 | 11593 | 9126 | 12218 | 11883 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 113084 | 26378 | 47790 | 53 | 15600 | 5842 | 50 | 17361 | 15.4% |
...
- candidats AVEC connectivite : 12010, dont T2 : 100%
- candidats SANS connectivite : 17671, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12492 systemes avec CONNECTED sur 96784 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*25391 candidats sur 29681 portent les champs bruts (86%).*

- `5c556c16ea8b` — 19426 candidats
  - AVEC connectivite (7882) : resistance **41.1%**
  - SANS connectivite (11544) : resistance **21.4%**
...
- `5c556c16ea8b` — 19426 candidats
  - AVEC connectivite (7882) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (11544) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 12552 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 12492 avec CONNECTED, 60 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 94283 systemes
  - sans CONNECTED : 0.0% sur 21164 systemes
