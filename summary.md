...
genere 2026-09-04 06:10 UTC — 357700 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 274356 systemes
...
- moteur actif `0caa9267db60` (313958 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 177551 | 88251 | 12068 | 5944 | 18054 | 13976 | 18825 | 18176 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 174034 | 40437 | 73508 | 70 | 24158 | 9030 | 70 | 26747 | 15.4% |
...
- candidats AVEC connectivite : 18303, dont T2 : 100%
- candidats SANS connectivite : 27057, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19099 systemes avec CONNECTED sur 147401 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*41070 candidats sur 45360 portent les champs bruts (91%).*

- `5c556c16ea8b` — 35105 candidats
  - AVEC connectivite (14175) : resistance **41.1%**
  - SANS connectivite (20930) : resistance **21.2%**
...
- `5c556c16ea8b` — 35105 candidats
  - AVEC connectivite (14175) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (20930) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
## cout
- temps total 111.1 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 19179 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19099 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 144900 systemes
  - sans CONNECTED : 0.0% sur 32651 systemes
