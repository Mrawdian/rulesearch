...
genere 2026-08-26 14:28 UTC — 48968 systemes evalues
...
- moteur actif `0caa9267db60` (5226 systemes) : `06fe04a859f1`, `e40600351a72`
...
| ref | 4 | 3 | 21202 | 4932 | 8953 | 13 | 2937 | 1093 | 8 | 3266 | 15.4% |
...
- candidats SANS connectivite : 3576, dont T2 : 100%
...
*1622 candidats sur 5912 portent les champs bruts (27%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 507 candidats
  - AVEC connectivite (198) : resistance **40.1%**
  - SANS connectivite (309) : resistance **20.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 507 candidats
  ...
  - SANS connectivite (309) : T0=16.06 T1=0.00 T2=2.65 — pondere **5.31**
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0285).
