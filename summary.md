...
genere 2026-08-30 17:36 UTC — 225811 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 142467 systemes
...
- moteur actif `0caa9267db60` (182069 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 110988 | 55170 | 7533 | 3712 | 11172 | 8784 | 11738 | 11435 | 10.3% |
...
- candidats AVEC connectivite : 11562, dont T2 : 100%
...
- **12012 systemes avec CONNECTED sur 93082 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*24314 candidats sur 28604 portent les champs bruts (85%).*

- `5c556c16ea8b` — 18349 candidats
  - AVEC connectivite (7434) : resistance **41.1%**
...
- `5c556c16ea8b` — 18349 candidats
  - AVEC connectivite (7434) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.97**
...
- TROP-CHER : 12066 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 12012 avec CONNECTED, 54 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 90581 systemes
  - sans CONNECTED : 0.0% sur 20407 systemes
