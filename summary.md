...
genere 2026-09-10 11:15 UTC — 497885 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 414541 systemes
...
- moteur actif `0caa9267db60` (454143 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 248355 | 123276 | 16915 | 8352 | 25130 | 19488 | 26488 | 25561 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 243415 | 56795 | 102531 | 97 | 33864 | 12547 | 87 | 37473 | 15.4% |
...
- candidats AVEC connectivite : 25688, dont T2 : 100%
- candidats SANS connectivite : 37783, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **26762 systemes avec CONNECTED sur 205285 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*59181 candidats sur 63471 portent les champs bruts (93%).*

- `5c556c16ea8b` — 53216 candidats
  - AVEC connectivite (21560) : resistance **41.2%**
  - SANS connectivite (31656) : resistance **21.3%**
...
- `5c556c16ea8b` — 53216 candidats
  - AVEC connectivite (21560) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (31656) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 202784 systemes
  - sans CONNECTED : 0.0% sur 45571 systemes
