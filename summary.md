...
| connect | 4 | 3 | 17350 | 8683 | 1120 | 598 | 1720 | 1381 | 1886 | 1744 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 16997 | 4003 | 7187 | 12 | 2329 | 859 | 7 | 2600 | 15.3% |
...
- candidats AVEC connectivite : 1871, dont T2 : 100%
- candidats SANS connectivite : 2910, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2160 systemes avec CONNECTED sur 16675 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*491 candidats sur 4781 portent les champs bruts (10%).*
...
- `e3baecf8377b` — 227 candidats
  - AVEC connectivite (88) : resistance **43.2%**
  - SANS connectivite (139) : resistance **21.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 227 candidats
  - AVEC connectivite (88) : T0=13.16 T1=0.00 T2=3.16 — pondere **6.32**
  - SANS connectivite (139) : T0=16.10 T1=0.00 T2=2.67 — pondere **5.34**
...
**2 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0250).
...
- TROP-CHER : 2177 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2160 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14174 systemes
  - sans CONNECTED : 0.0% sur 3176 systemes
