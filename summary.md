...
genere 2026-08-30 23:13 UTC — 233635 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 150291 systemes
...
- moteur actif `0caa9267db60` (189893 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 114939 | 57148 | 7805 | 3861 | 11540 | 9085 | 12163 | 11828 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 112581 | 26261 | 47575 | 53 | 15537 | 5817 | 49 | 17279 | 15.3% |
...
- candidats AVEC connectivite : 11955, dont T2 : 100%
- candidats SANS connectivite : 17589, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12437 systemes avec CONNECTED sur 96364 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*25254 candidats sur 29544 portent les champs bruts (85%).*

- `5c556c16ea8b` — 19289 candidats
  - AVEC connectivite (7827) : resistance **41.0%**
  - SANS connectivite (11462) : resistance **21.4%**
...
- `5c556c16ea8b` — 19289 candidats
  - AVEC connectivite (7827) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (11462) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 12496 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 12437 avec CONNECTED, 59 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 93863 systemes
  - sans CONNECTED : 0.0% sur 21076 systemes
