...
genere 2026-08-27 02:53 UTC — 77142 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 12235 systemes
...
- moteur actif `0caa9267db60` (33400 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 35902 | 17873 | 2467 | 1217 | 3554 | 2840 | 3811 | 3676 | 10.2% |
...
- candidats AVEC connectivite : 3803, dont T2 : 100%
- candidats SANS connectivite : 5664, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4085 systemes avec CONNECTED sur 31895 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5177 candidats sur 9467 portent les champs bruts (55%).*
...
- `ab89a63b01ef` — 1500 candidats
  - AVEC connectivite (623) : resistance **41.2%**
...
- `ab89a63b01ef` — 1500 candidats
  - AVEC connectivite (623) : T0=13.01 T1=0.00 T2=3.04 — pondere **6.09**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 29394 systemes
  - sans CONNECTED : 0.0% sur 6508 systemes
