...
genere 2026-09-01 11:02 UTC — 280742 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 197398 systemes
...
- moteur actif `0caa9267db60` (237000 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 138707 | 68948 | 9384 | 4636 | 14086 | 10936 | 14650 | 14268 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 135920 | 31655 | 57460 | 58 | 18846 | 7031 | 61 | 20798 | 15.3% |
...
- candidats AVEC connectivite : 14395, dont T2 : 100%
- candidats SANS connectivite : 21108, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14924 systemes avec CONNECTED sur 115678 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*31213 candidats sur 35503 portent les champs bruts (88%).*

- `5c556c16ea8b` — 25248 candidats
  - AVEC connectivite (10267) : resistance **41.0%**
  - SANS connectivite (14981) : resistance **21.4%**
...
- `5c556c16ea8b` — 25248 candidats
  - AVEC connectivite (10267) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (14981) : T0=15.93 T1=0.00 T2=2.66 — pondere **5.32**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 113177 systemes
  - sans CONNECTED : 0.0% sur 25530 systemes
