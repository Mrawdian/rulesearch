...
genere 2026-09-08 19:08 UTC — 463336 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 379992 systemes
...
- moteur actif `0caa9267db60` (419594 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 230916 | 114704 | 15722 | 7723 | 23340 | 18086 | 24629 | 23776 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 226305 | 52718 | 95371 | 90 | 31528 | 11700 | 81 | 34799 | 15.4% |
...
- candidats AVEC connectivite : 23903, dont T2 : 100%
- candidats SANS connectivite : 35109, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **24903 systemes avec CONNECTED sur 191087 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*54722 candidats sur 59012 portent les champs bruts (93%).*

- `5c556c16ea8b` — 48757 candidats
  - AVEC connectivite (19775) : resistance **41.2%**
  - SANS connectivite (28982) : resistance **21.3%**
...
- `5c556c16ea8b` — 48757 candidats
  - AVEC connectivite (19775) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (28982) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 24994 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 24903 avec CONNECTED, 91 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 188586 systemes
  - sans CONNECTED : 0.0% sur 42330 systemes
