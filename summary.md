...
genere 2026-09-06 04:51 UTC — 405594 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 322250 systemes
...
- moteur actif `0caa9267db60` (361852 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 201740 | 100160 | 13759 | 6716 | 20474 | 15868 | 21422 | 20777 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 197739 | 45981 | 83437 | 78 | 27547 | 10218 | 73 | 30388 | 15.4% |
...
- candidats AVEC connectivite : 20904, dont T2 : 100%
- candidats SANS connectivite : 30698, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21696 systemes avec CONNECTED sur 167103 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*47312 candidats sur 51602 portent les champs bruts (92%).*

- `5c556c16ea8b` — 41347 candidats
  - AVEC connectivite (16776) : resistance **41.1%**
  - SANS connectivite (24571) : resistance **21.3%**
...
- `5c556c16ea8b` — 41347 candidats
  - AVEC connectivite (16776) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (24571) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
## cout
- temps total 126.1 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 21779 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21696 avec CONNECTED, 83 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 164602 systemes
  - sans CONNECTED : 0.0% sur 37138 systemes
