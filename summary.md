...
| connect | 4 | 3 | 7112 | 3575 | 467 | 249 | 677 | 578 | 739 | 747 | 10.5% |
| ref | 4 | 3 | 6950 | 1679 | 2890 | 1 | 935 | 346 | 2 | 1097 | 15.8% |
...
- candidats AVEC connectivite : 750, dont T2 : 100%
- candidats SANS connectivite : 1101, dont T2 : 100%
...
- **739 systemes avec CONNECTED sur 5883 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 686 candidats
  - AVEC connectivite (271) : T0=13.22 T1=0.00 T2=2.91 — pondere **5.82**
  - SANS connectivite (415) : T0=15.82 T1=0.00 T2=2.64 — pondere **5.29**
...
- TROP-CHER : 741 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 739 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 5826 systemes
  - sans CONNECTED : 0.0% sur 1286 systemes
