...
| connect | 4 | 3 | 18995 | 9484 | 1242 | 659 | 1892 | 1512 | 2052 | 1919 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 18603 | 4372 | 7842 | 13 | 2555 | 966 | 7 | 2848 | 15.3% |
...
- candidats AVEC connectivite : 2046, dont T2 : 100%
- candidats SANS connectivite : 3158, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2326 systemes avec CONNECTED sur 18005 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*914 candidats sur 5204 portent les champs bruts (18%).*
...
- `e3baecf8377b` — 650 candidats
  - AVEC connectivite (263) : T0=13.04 T1=0.00 T2=3.08 — pondere **6.17**
...
- TROP-CHER : 2343 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2326 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 15504 systemes
  - sans CONNECTED : 0.0% sur 3491 systemes
