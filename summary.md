...
genere 2026-09-02 14:00 UTC — 312832 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 229488 systemes
...
- moteur actif `0caa9267db60` (269090 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 154903 | 76960 | 10535 | 5181 | 15740 | 12198 | 16407 | 15900 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 151814 | 35362 | 64204 | 64 | 20981 | 7850 | 63 | 23278 | 15.3% |
...
- candidats SANS connectivite : 23588, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16681 systemes avec CONNECTED sur 128947 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*35325 candidats sur 39615 portent les champs bruts (89%).*

- `5c556c16ea8b` — 29360 candidats
  - AVEC connectivite (11899) : resistance **41.1%**
  - SANS connectivite (17461) : resistance **21.3%**
...
- `5c556c16ea8b` — 29360 candidats
  ...
  - SANS connectivite (17461) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 126446 systemes
  - sans CONNECTED : 0.0% sur 28457 systemes
