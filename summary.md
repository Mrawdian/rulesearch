...
genere 2026-09-09 08:28 UTC — 475293 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 391949 systemes
...
- moteur actif `0caa9267db60` (431551 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 236952 | 117659 | 16157 | 7936 | 23966 | 18561 | 25247 | 24417 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 232226 | 54122 | 97813 | 92 | 32347 | 11996 | 84 | 35753 | 15.4% |
...
- candidats AVEC connectivite : 24544, dont T2 : 100%
- candidats SANS connectivite : 36063, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25521 systemes avec CONNECTED sur 195980 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*56317 candidats sur 60607 portent les champs bruts (93%).*

- `5c556c16ea8b` — 50352 candidats
  - AVEC connectivite (20416) : resistance **41.2%**
  - SANS connectivite (29936) : resistance **21.3%**
...
- `5c556c16ea8b` — 50352 candidats
  - AVEC connectivite (20416) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (29936) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 193479 systemes
  - sans CONNECTED : 0.0% sur 43473 systemes
