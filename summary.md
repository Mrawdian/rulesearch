...
| connect | 4 | 3 | 6367 | 3207 | 414 | 229 | 610 | 511 | 662 | 660 | 10.4% |
| ref | 4 | 3 | 6224 | 1510 | 2586 | 1 | 834 | 306 | 2 | 985 | 15.8% |
...
- candidats SANS connectivite : 989, dont T2 : 100%
...
- **662 systemes avec CONNECTED sur 5276 (12.5%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 487 candidats
  - AVEC connectivite (184) : T0=13.26 T1=0.00 T2=2.89 — pondere **5.77**
  - SANS connectivite (303) : T0=15.91 T1=0.00 T2=2.62 — pondere **5.25**
...
- TROP-CHER : 664 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 662 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 5219 systemes
