...
genere 2026-08-26 19:26 UTC — 60673 systemes evalues
...
- moteur actif `0caa9267db60` (16931 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27570 | 13750 | 1877 | 932 | 2725 | 2185 | 2933 | 2822 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 26988 | 6242 | 11416 | 15 | 3759 | 1389 | 11 | 4156 | 15.4% |
...
- candidats SANS connectivite : 4466, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3207 systemes avec CONNECTED sur 25063 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3125 candidats sur 7415 portent les champs bruts (42%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 256 candidats
  - AVEC connectivite (105) : resistance **39.2%**
  - SANS connectivite (151) : resistance **18.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 256 candidats
  ...
  - SANS connectivite (151) : T0=16.07 T1=0.00 T2=2.59 — pondere **5.18**
  - test de permutation : **p = 0.1134** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- TROP-CHER : 3228 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3207 avec CONNECTED, 21 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22562 systemes
  - sans CONNECTED : 0.0% sur 5008 systemes
