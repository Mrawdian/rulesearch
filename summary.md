...
genere 2026-08-26 14:15 UTC — 48479 systemes evalues
...
- moteur actif `0caa9267db60` (4737 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21411 | 10682 | 1424 | 738 | 2117 | 1701 | 2290 | 2188 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20953 | 4887 | 8839 | 13 | 2906 | 1083 | 7 | 3218 | 15.4% |
...
- candidats AVEC connectivite : 2315, dont T2 : 100%
- candidats SANS connectivite : 3528, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2564 systemes avec CONNECTED sur 19999 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1553 candidats sur 5843 portent les champs bruts (27%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 438 candidats
  - AVEC connectivite (177) : resistance **40.2%**
  - SANS connectivite (261) : resistance **20.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 438 candidats
  - AVEC connectivite (177) : T0=13.44 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (261) : T0=16.12 T1=0.00 T2=2.62 — pondere **5.25**
...
- TROP-CHER : 2581 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2564 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17498 systemes
  - sans CONNECTED : 0.0% sur 3913 systemes
