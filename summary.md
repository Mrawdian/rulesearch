...
genere 2026-08-26 16:12 UTC — 53060 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 7877 systemes
...
- moteur actif `0caa9267db60` (9318 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23729 | 11834 | 1611 | 809 | 2359 | 1877 | 2535 | 2406 | 10.1% |
...
- candidats AVEC connectivite : 2533, dont T2 : 100%
- candidats SANS connectivite : 3896, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2809 systemes avec CONNECTED sur 21878 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2139 candidats sur 6429 portent les champs bruts (33%).*
...
- `06fe04a859f1` — 1024 candidats
  - AVEC connectivite (395) : resistance **41.2%**
...
- `06fe04a859f1` — 1024 candidats
  - AVEC connectivite (395) : T0=13.17 T1=0.00 T2=3.04 — pondere **6.08**
...
- TROP-CHER : 2829 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2809 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19377 systemes
  - sans CONNECTED : 0.0% sur 4352 systemes
