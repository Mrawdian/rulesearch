...
genere 2026-08-28 17:20 UTC — 150851 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 67507 systemes
...
- moteur actif `0caa9267db60` (107109 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 73101 | 36304 | 4986 | 2497 | 7337 | 5821 | 7723 | 7498 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 71635 | 16652 | 30278 | 33 | 9891 | 3691 | 31 | 11056 | 15.4% |
...
- candidats AVEC connectivite : 7625, dont T2 : 100%
- candidats SANS connectivite : 11366, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7997 systemes avec CONNECTED sur 62137 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*14701 candidats sur 18991 portent les champs bruts (77%).*

- `5c556c16ea8b` — 8736 candidats
  - AVEC connectivite (3497) : resistance **41.1%**
  - SANS connectivite (5239) : resistance **21.7%**
...
- `5c556c16ea8b` — 8736 candidats
  - AVEC connectivite (3497) : T0=13.01 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (5239) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.36**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 59636 systemes
  - sans CONNECTED : 0.0% sur 13465 systemes
