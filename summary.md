...
| connect | 4 | 3 | 7922 | 3993 | 515 | 272 | 759 | 630 | 832 | 828 | 10.5% |
| ref | 4 | 3 | 7743 | 1869 | 3245 | 1 | 1040 | 378 | 3 | 1207 | 15.6% |
...
- candidats AVEC connectivite : 831, dont T2 : 100%
- candidats SANS connectivite : 1211, dont T2 : 100%
...
- **832 systemes avec CONNECTED sur 6558 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 877 candidats
  - AVEC connectivite (352) : T0=13.41 T1=0.00 T2=2.84 — pondere **5.69**
  - SANS connectivite (525) : T0=15.83 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 835 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 832 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 6501 systemes
  - sans CONNECTED : 0.0% sur 1421 systemes
