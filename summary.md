...
genere 2026-08-30 18:45 UTC — 227386 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 144042 systemes
...
- moteur actif `0caa9267db60` (183644 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 111783 | 55575 | 7594 | 3732 | 11243 | 8846 | 11829 | 11512 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 109488 | 25517 | 46248 | 50 | 15119 | 5655 | 45 | 16844 | 15.4% |
...
- candidats SANS connectivite : 17154, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12103 systemes avec CONNECTED sur 93739 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*24503 candidats sur 28793 portent les champs bruts (85%).*

- `5c556c16ea8b` — 18538 candidats
  - AVEC connectivite (7511) : resistance **41.0%**
  - SANS connectivite (11027) : resistance **21.5%**
...
- `5c556c16ea8b` — 18538 candidats
  ...
  - SANS connectivite (11027) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 12158 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 12103 avec CONNECTED, 55 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 91238 systemes
  - sans CONNECTED : 0.0% sur 20545 systemes
