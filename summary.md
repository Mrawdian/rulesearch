...
**7466 enregistrements (75%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 4959 | 2488 | 311 | 176 | 481 | 404 | 520 | 521 | 10.5% |
| ref | 4 | 3 | 4853 | 1180 | 2040 | 1 | 636 | 235 | 2 | 759 | 15.6% |
...
- candidats AVEC connectivite : 524, dont T2 : 100%
- candidats SANS connectivite : 763, dont T2 : 100%
...
- **520 systemes avec CONNECTED sur 4115 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 122 candidats
  - AVEC connectivite (45) : T0=12.62 T1=0.00 T2=3.02 — pondere **6.04**
  - SANS connectivite (77) : T0=16.09 T1=0.00 T2=2.74 — pondere **5.48**
...
- TROP-CHER : 522 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 520 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 4058 systemes
  - sans CONNECTED : 0.0% sur 901 systemes
