...
**7466 enregistrements (59%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 6323 | 3184 | 411 | 229 | 607 | 506 | 654 | 659 | 10.4% |
| ref | 4 | 3 | 6168 | 1497 | 2566 | 1 | 828 | 303 | 2 | 971 | 15.7% |
...
- candidats AVEC connectivite : 662, dont T2 : 100%
- candidats SANS connectivite : 975, dont T2 : 100%
...
- **654 systemes avec CONNECTED sur 5240 (12.5%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 472 candidats
  - AVEC connectivite (183) : T0=13.24 T1=0.00 T2=2.90 — pondere **5.79**
  - SANS connectivite (289) : T0=15.83 T1=0.00 T2=2.64 — pondere **5.29**
...
## cout
- temps total 3.8 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 656 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 654 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.6% sur 5183 systemes
  - sans CONNECTED : 0.0% sur 1140 systemes
