...
genere 2026-09-01 09:28 UTC — 278753 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 195409 systemes
...
- moteur actif `0caa9267db60` (235011 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 137693 | 68442 | 9319 | 4598 | 13965 | 10866 | 14550 | 14172 | 10.3% |
...
- candidats AVEC connectivite : 14299, dont T2 : 100%
...
- **14824 systemes avec CONNECTED sur 114860 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*30962 candidats sur 35252 portent les champs bruts (88%).*

- `5c556c16ea8b` — 24997 candidats
  - AVEC connectivite (10171) : resistance **41.1%**
...
- `5c556c16ea8b` — 24997 candidats
  - AVEC connectivite (10171) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 14894 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14824 avec CONNECTED, 70 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 112359 systemes
  - sans CONNECTED : 0.0% sur 25334 systemes
