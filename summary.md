...
genere 2026-08-29 07:37 UTC — 175148 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 91804 systemes
...
- moteur actif `0caa9267db60` (131406 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 85382 | 42493 | 5806 | 2885 | 8563 | 6782 | 8957 | 8810 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 83651 | 19527 | 35370 | 39 | 11536 | 4261 | 34 | 12878 | 15.4% |
...
- candidats AVEC connectivite : 8937, dont T2 : 100%
- candidats SANS connectivite : 13188, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9231 systemes avec CONNECTED sur 72196 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*17835 candidats sur 22125 portent les champs bruts (81%).*

- `5c556c16ea8b` — 11870 candidats
  - AVEC connectivite (4809) : resistance **41.2%**
  - SANS connectivite (7061) : resistance **21.6%**
...
- `5c556c16ea8b` — 11870 candidats
  - AVEC connectivite (4809) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (7061) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.33**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 69695 systemes
  - sans CONNECTED : 0.0% sur 15687 systemes
