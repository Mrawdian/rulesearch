...
genere 2026-09-04 01:57 UTC — 353201 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 269857 systemes
...
- moteur actif `0caa9267db60` (309459 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 175276 | 87118 | 11916 | 5859 | 17849 | 13792 | 18575 | 17936 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 171810 | 39939 | 72568 | 70 | 23864 | 8892 | 68 | 26395 | 15.4% |
...
- candidats AVEC connectivite : 18063, dont T2 : 100%
- candidats SANS connectivite : 26705, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18849 systemes avec CONNECTED sur 145521 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*40478 candidats sur 44768 portent les champs bruts (90%).*

- `5c556c16ea8b` — 34513 candidats
  - AVEC connectivite (13935) : resistance **41.0%**
  - SANS connectivite (20578) : resistance **21.3%**
...
- `5c556c16ea8b` — 34513 candidats
  - AVEC connectivite (13935) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (20578) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 143020 systemes
  - sans CONNECTED : 0.0% sur 32256 systemes
