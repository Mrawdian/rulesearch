...
genere 2026-08-29 09:07 UTC — 177560 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 94216 systemes
...
- moteur actif `0caa9267db60` (133818 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 86590 | 43075 | 5893 | 2937 | 8690 | 6877 | 9085 | 8931 | 10.3% |
...
- candidats AVEC connectivite : 9058, dont T2 : 100%
...
- **9359 systemes avec CONNECTED sur 73171 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*18144 candidats sur 22434 portent les champs bruts (81%).*

- `5c556c16ea8b` — 12179 candidats
  - AVEC connectivite (4930) : resistance **41.1%**
...
- `5c556c16ea8b` — 12179 candidats
  - AVEC connectivite (4930) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.98**
...
- TROP-CHER : 9404 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 9359 avec CONNECTED, 45 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 70670 systemes
  - sans CONNECTED : 0.0% sur 15920 systemes
