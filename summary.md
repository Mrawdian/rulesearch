...
genere 2026-08-28 10:29 UTC — 139081 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 55737 systemes
...
- moteur actif `0caa9267db60` (95339 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 67173 | 33375 | 4607 | 2289 | 6730 | 5356 | 7077 | 6880 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 65793 | 15220 | 27814 | 30 | 9164 | 3395 | 28 | 10139 | 15.4% |
...
- candidats AVEC connectivite : 7007, dont T2 : 100%
- candidats SANS connectivite : 10449, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7351 systemes avec CONNECTED sur 57295 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*13166 candidats sur 17456 portent les champs bruts (75%).*

- `5c556c16ea8b` — 7201 candidats
  - AVEC connectivite (2879) : resistance **41.4%**
  - SANS connectivite (4322) : resistance **21.7%**
...
- `5c556c16ea8b` — 7201 candidats
  - AVEC connectivite (2879) : T0=12.99 T1=0.00 T2=3.02 — pondere **6.03**
  - SANS connectivite (4322) : T0=15.88 T1=0.00 T2=2.67 — pondere **5.35**
...
- TROP-CHER : 7389 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7351 avec CONNECTED, 38 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 54794 systemes
  - sans CONNECTED : 0.0% sur 12379 systemes
