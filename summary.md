...
genere 2026-08-27 07:39 UTC — 87503 systemes evalues
...
- moteur actif `0caa9267db60` (43761 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 41120 | 20466 | 2820 | 1396 | 4107 | 3236 | 4340 | 4224 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 40268 | 9270 | 17119 | 22 | 5593 | 2097 | 21 | 6146 | 15.3% |
...
- candidats AVEC connectivite : 4351, dont T2 : 100%
- candidats SANS connectivite : 6456, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4614 systemes avec CONNECTED sur 36109 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6517 candidats sur 10807 portent les champs bruts (60%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 552 candidats
  - AVEC connectivite (223) : resistance **41.8%**
  - SANS connectivite (329) : resistance **20.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 552 candidats
  - AVEC connectivite (223) : T0=13.04 T1=0.00 T2=3.05 — pondere **6.10**
  - SANS connectivite (329) : T0=15.83 T1=0.00 T2=2.62 — pondere **5.23**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 33608 systemes
  - sans CONNECTED : 0.0% sur 7512 systemes
