...
| connect | 4 | 3 | 5650 | 2848 | 361 | 205 | 541 | 460 | 587 | 581 | 10.3% |
...
- candidats AVEC connectivite : 584, dont T2 : 100%
...
- **587 systemes avec CONNECTED sur 4682 (12.5%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 294 candidats
  - AVEC connectivite (105) : T0=13.16 T1=0.00 T2=2.79 — pondere **5.58**
  - SANS connectivite (189) : T0=15.98 T1=0.00 T2=2.63 — pondere **5.26**
  - test de permutation : **p = 0.3918** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 589 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 587 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 4625 systemes
  - sans CONNECTED : 0.0% sur 1025 systemes
