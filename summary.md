...
genere 2026-08-29 14:39 UTC — 186182 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 102838 systemes
...
- moteur actif `0caa9267db60` (142440 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 90952 | 45235 | 6178 | 3063 | 9160 | 7243 | 9561 | 9356 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 89115 | 20824 | 37605 | 43 | 12315 | 4568 | 35 | 13719 | 15.4% |
...
- candidats AVEC connectivite : 9483, dont T2 : 100%
- candidats SANS connectivite : 14029, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9835 systemes avec CONNECTED sur 76695 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*19222 candidats sur 23512 portent les champs bruts (82%).*

- `5c556c16ea8b` — 13257 candidats
  - AVEC connectivite (5355) : resistance **41.2%**
  - SANS connectivite (7902) : resistance **21.5%**
...
- `5c556c16ea8b` — 13257 candidats
  - AVEC connectivite (5355) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (7902) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.33**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 74194 systemes
  - sans CONNECTED : 0.0% sur 16758 systemes
