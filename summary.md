...
| connect | 4 | 3 | 5591 | 2819 | 358 | 204 | 533 | 458 | 580 | 574 | 10.3% |
| ref | 4 | 3 | 5452 | 1317 | 2284 | 1 | 722 | 266 | 2 | 860 | 15.8% |
...
- candidats SANS connectivite : 864, dont T2 : 100%
...
- **580 systemes avec CONNECTED sur 4634 (12.5%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 276 candidats
  - AVEC connectivite (98) : T0=13.20 T1=0.00 T2=2.83 — pondere **5.65**
  - SANS connectivite (178) : T0=16.04 T1=0.00 T2=2.62 — pondere **5.24**
  - test de permutation : **p = 0.2999** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 582 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 580 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 4577 systemes
  - sans CONNECTED : 0.0% sur 1014 systemes
