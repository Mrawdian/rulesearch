...
genere 2026-08-26 05:20 UTC — 25567 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 16593 systemes
...
| connect | 4 | 3 | 12862 | 6437 | 844 | 444 | 1248 | 1026 | 1399 | 1298 | 10.1% |
...
- candidats AVEC connectivite : 1301, dont T2 : 100%
...
- **1399 systemes avec CONNECTED sur 10597 (13.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2076 candidats
  - AVEC connectivite (822) : T0=13.26 T1=0.00 T2=2.86 — pondere **5.72**
...
- TROP-CHER : 1403 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1399 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 10540 systemes
  - sans CONNECTED : 0.0% sur 2322 systemes
