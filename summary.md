...
genere 2026-08-26 23:19 UTC — 69146 systemes evalues
...
- moteur actif `0caa9267db60` (25404 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 31862 | 15827 | 2189 | 1072 | 3169 | 2540 | 3401 | 3259 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 31169 | 7179 | 13251 | 18 | 4313 | 1618 | 14 | 4776 | 15.3% |
...
- candidats AVEC connectivite : 3386, dont T2 : 100%
- candidats SANS connectivite : 5086, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3675 systemes avec CONNECTED sur 28553 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4182 candidats sur 8472 portent les champs bruts (49%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 505 candidats
  - AVEC connectivite (206) : resistance **41.9%**
  - SANS connectivite (299) : resistance **22.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 505 candidats
  - AVEC connectivite (206) : T0=12.95 T1=0.00 T2=3.08 — pondere **6.16**
  - SANS connectivite (299) : T0=16.02 T1=0.00 T2=2.68 — pondere **5.35**
...
**6 serie(s) reproductible(s) sur 13 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `ab89a63b01ef` (p=0.0055), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
...
## cout
- temps total 21.5 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 3699 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3675 avec CONNECTED, 24 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 26052 systemes
  - sans CONNECTED : 0.0% sur 5810 systemes
