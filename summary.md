...
| connect | 4 | 3 | 6411 | 3227 | 418 | 232 | 612 | 512 | 670 | 666 | 10.4% |
| ref | 4 | 3 | 6251 | 1515 | 2599 | 1 | 840 | 306 | 2 | 988 | 15.8% |
...
- candidats SANS connectivite : 992, dont T2 : 100%
...
- **670 systemes avec CONNECTED sur 5317 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 496 candidats
  - AVEC connectivite (190) : T0=13.23 T1=0.00 T2=2.89 — pondere **5.79**
  - SANS connectivite (306) : T0=15.89 T1=0.00 T2=2.63 — pondere **5.27**
...
- TROP-CHER : 672 systemes abandonnes (5.3% des systemes), 96% du temps total
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 5260 systemes
  - sans CONNECTED : 0.0% sur 1151 systemes
