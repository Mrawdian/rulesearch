...
genere 2026-08-27 03:19 UTC — 78055 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 13148 systemes
...
- moteur actif `0caa9267db60` (34313 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 36364 | 18078 | 2505 | 1233 | 3612 | 2876 | 3860 | 3725 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 35576 | 8213 | 15135 | 20 | 4911 | 1852 | 19 | 5426 | 15.3% |
...
- candidats AVEC connectivite : 3852, dont T2 : 100%
- candidats SANS connectivite : 5736, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4134 systemes avec CONNECTED sur 32261 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5298 candidats sur 9588 portent les champs bruts (55%).*
...
- `ab89a63b01ef` — 1621 candidats
  - AVEC connectivite (672) : resistance **41.2%**
  - SANS connectivite (949) : resistance **22.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1621 candidats
  - AVEC connectivite (672) : T0=13.02 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (949) : T0=15.91 T1=0.00 T2=2.71 — pondere **5.42**
...
- TROP-CHER : 4163 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4134 avec CONNECTED, 29 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 29760 systemes
  - sans CONNECTED : 0.0% sur 6604 systemes
