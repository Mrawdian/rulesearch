...
| connect | 4 | 3 | 6486 | 3263 | 419 | 235 | 622 | 523 | 676 | 673 | 10.4% |
...
- candidats AVEC connectivite : 676, dont T2 : 100%
...
- **676 systemes avec CONNECTED sur 5372 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 523 candidats
  - AVEC connectivite (197) : T0=13.21 T1=0.00 T2=2.91 — pondere **5.82**
...
- TROP-CHER : 678 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 676 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 5315 systemes
  - sans CONNECTED : 0.0% sur 1171 systemes
