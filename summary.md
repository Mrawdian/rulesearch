...
| connect | 4 | 3 | 18097 | 9043 | 1176 | 630 | 1798 | 1436 | 1967 | 1821 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 17705 | 4169 | 7471 | 12 | 2425 | 903 | 7 | 2718 | 15.4% |
...
- candidats AVEC connectivite : 1948, dont T2 : 100%
- candidats SANS connectivite : 3028, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2241 systemes avec CONNECTED sur 17279 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*686 candidats sur 4976 portent les champs bruts (14%).*
...
- `e3baecf8377b` — 422 candidats
  - AVEC connectivite (165) : resistance **44.0%**
  - SANS connectivite (257) : resistance **21.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 422 candidats
  - AVEC connectivite (165) : T0=12.98 T1=0.00 T2=3.22 — pondere **6.44**
  - SANS connectivite (257) : T0=16.03 T1=0.00 T2=2.68 — pondere **5.37**
...
**2 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0015).
...
- TROP-CHER : 2258 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 2241 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14778 systemes
  - sans CONNECTED : 0.0% sur 3319 systemes
