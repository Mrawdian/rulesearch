...
genere 2026-08-31 14:06 UTC — 253960 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 170616 systemes
...
- moteur actif `0caa9267db60` (210218 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 125187 | 62241 | 8474 | 4197 | 12641 | 9889 | 13213 | 12887 | 10.3% |
...
- candidats AVEC connectivite : 13014, dont T2 : 100%
...
- **13487 systemes avec CONNECTED sur 104652 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*27854 candidats sur 32144 portent les champs bruts (87%).*

- `5c556c16ea8b` — 21889 candidats
  - AVEC connectivite (8886) : resistance **41.0%**
...
- `5c556c16ea8b` — 21889 candidats
  - AVEC connectivite (8886) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 13553 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13487 avec CONNECTED, 66 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 102151 systemes
  - sans CONNECTED : 0.0% sur 23036 systemes
