...
genere 2026-09-04 13:16 UTC — 365360 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 282016 systemes
...
- moteur actif `0caa9267db60` (321618 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 181421 | 90159 | 12336 | 6059 | 18459 | 14294 | 19219 | 18572 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 177824 | 41323 | 75137 | 72 | 24703 | 9207 | 70 | 27298 | 15.4% |
...
- candidats SANS connectivite : 27608, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19493 systemes avec CONNECTED sur 150498 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*42017 candidats sur 46307 portent les champs bruts (91%).*

- `5c556c16ea8b` — 36052 candidats
  - AVEC connectivite (14571) : resistance **41.0%**
  - SANS connectivite (21481) : resistance **21.2%**
...
- `5c556c16ea8b` — 36052 candidats
  ...
  - SANS connectivite (21481) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 147997 systemes
  - sans CONNECTED : 0.0% sur 33424 systemes
