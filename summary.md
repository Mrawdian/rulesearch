...
genere 2026-08-26 13:22 UTC — 46378 systemes evalues
...
- moteur actif `0caa9267db60` (2636 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20351 | 10154 | 1336 | 703 | 2039 | 1616 | 2177 | 2074 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 19912 | 4671 | 8408 | 13 | 2753 | 1030 | 7 | 3030 | 15.2% |
...
- candidats AVEC connectivite : 2201, dont T2 : 100%
- candidats SANS connectivite : 3340, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2451 systemes avec CONNECTED sur 19107 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1251 candidats sur 5541 portent les champs bruts (23%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 136 candidats
  - AVEC connectivite (63) : resistance **37.7%**
  - SANS connectivite (73) : resistance **22.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 136 candidats
  - AVEC connectivite (63) : T0=13.10 T1=0.00 T2=2.68 — pondere **5.37**
  - SANS connectivite (73) : T0=16.36 T1=0.00 T2=2.96 — pondere **5.92**
...
- TROP-CHER : 2468 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2451 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16606 systemes
