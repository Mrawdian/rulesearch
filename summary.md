...
genere 2026-08-31 08:03 UTC — 245731 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 162387 systemes
...
- moteur actif `0caa9267db60` (201989 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 121039 | 60209 | 8211 | 4058 | 12170 | 9553 | 12804 | 12464 | 10.3% |
...
- candidats AVEC connectivite : 12591, dont T2 : 100%
...
- **13078 systemes avec CONNECTED sur 101321 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*26805 candidats sur 31095 portent les champs bruts (86%).*

- `5c556c16ea8b` — 20840 candidats
  - AVEC connectivite (8463) : resistance **40.9%**
...
- `5c556c16ea8b` — 20840 candidats
  - AVEC connectivite (8463) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 13141 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13078 avec CONNECTED, 63 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 98820 systemes
  - sans CONNECTED : 0.0% sur 22219 systemes
