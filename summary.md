...
genere 2026-09-08 17:39 UTC — 461998 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 378654 systemes
...
- moteur actif `0caa9267db60` (418256 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 230241 | 114361 | 15666 | 7708 | 23285 | 18029 | 24557 | 23707 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 225642 | 52560 | 95090 | 89 | 31448 | 11666 | 81 | 34690 | 15.4% |
...
- candidats AVEC connectivite : 23834, dont T2 : 100%
...
- **24831 systemes avec CONNECTED sur 190525 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*54544 candidats sur 58834 portent les champs bruts (93%).*

- `5c556c16ea8b` — 48579 candidats
  - AVEC connectivite (19706) : resistance **41.2%**
...
- `5c556c16ea8b` — 48579 candidats
  - AVEC connectivite (19706) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 188024 systemes
  - sans CONNECTED : 0.0% sur 42217 systemes
