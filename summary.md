...
genere 2026-08-26 13:13 UTC — 45995 systemes evalues
...
- moteur actif `0caa9267db60` (2253 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20157 | 10064 | 1321 | 693 | 2021 | 1600 | 2157 | 2052 | 10.2% |
...
- candidats AVEC connectivite : 2179, dont T2 : 100%
- candidats SANS connectivite : 3318, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2431 systemes avec CONNECTED sur 18946 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1207 candidats sur 5497 portent les champs bruts (22%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 92 candidats
  - AVEC connectivite (41) : resistance **38.1%**
...
- `06fe04a859f1` — 92 candidats
  - AVEC connectivite (41) : T0=13.24 T1=0.00 T2=2.68 — pondere **5.37**
  - SANS connectivite (51) : T0=16.80 T1=0.00 T2=2.75 — pondere **5.49**
  - test de permutation : **p = 0.8731** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 2448 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2431 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16445 systemes
  - sans CONNECTED : 0.0% sur 3712 systemes
