...
| connect | 4 | 3 | 17515 | 8768 | 1128 | 603 | 1737 | 1391 | 1903 | 1764 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 17137 | 4034 | 7249 | 12 | 2345 | 866 | 7 | 2624 | 15.3% |
...
- candidats AVEC connectivite : 1891, dont T2 : 100%
- candidats SANS connectivite : 2934, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2177 systemes avec CONNECTED sur 16810 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*535 candidats sur 4825 portent les champs bruts (11%).*
...
- `e3baecf8377b` — 271 candidats
  - AVEC connectivite (108) : resistance **44.5%**
  - SANS connectivite (163) : resistance **21.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 271 candidats
  - AVEC connectivite (108) : T0=12.92 T1=0.00 T2=3.21 — pondere **6.43**
  - SANS connectivite (163) : T0=16.04 T1=0.00 T2=2.65 — pondere **5.30**
...
**2 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0040).
...
- TROP-CHER : 2194 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2177 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14309 systemes
  - sans CONNECTED : 0.0% sur 3206 systemes
