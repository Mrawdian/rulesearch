...
genere 2026-08-26 04:13 UTC — 22884 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 13910 systemes
...
**7466 enregistrements (33%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 11506 | 5766 | 759 | 398 | 1109 | 921 | 1243 | 1163 | 10.1% |
| ref | 4 | 3 | 11254 | 2680 | 4734 | 6 | 1526 | 572 | 4 | 1732 | 15.4% |
...
- candidats AVEC connectivite : 1166, dont T2 : 100%
- candidats SANS connectivite : 1736, dont T2 : 100%
...
- **1243 systemes avec CONNECTED sur 9482 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1737 candidats
  - AVEC connectivite (687) : T0=13.35 T1=0.00 T2=2.83 — pondere **5.67**
  - SANS connectivite (1050) : T0=15.84 T1=0.00 T2=2.65 — pondere **5.31**
  - test de permutation : **p = 0.0210** — ecart significatif au seuil 0.05
...
- `T2` indices=0.12 — NOTRIPLE@diags + COUNT(v1,1-1)@cols + SUM(8+-1)@blocks

## cout
- temps total 7.2 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 1247 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 1243 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 9425 systemes
  - sans CONNECTED : 0.0% sur 2081 systemes
