...
genere 2026-08-27 15:17 UTC — 103011 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 19667 systemes
...
- moteur actif `0caa9267db60` (59269 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 48948 | 24378 | 3380 | 1680 | 4861 | 3872 | 5167 | 4975 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 47948 | 11085 | 20357 | 25 | 6633 | 2508 | 23 | 7316 | 15.3% |
...
- candidats SANS connectivite : 7626, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5441 systemes avec CONNECTED sur 42498 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*8438 candidats sur 12728 portent les champs bruts (66%).*
...
- `5c556c16ea8b` — 2473 candidats
  - AVEC connectivite (974) : resistance **41.6%**
  - SANS connectivite (1499) : resistance **22.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 2473 candidats
  ...
  - SANS connectivite (1499) : T0=15.80 T1=0.00 T2=2.67 — pondere **5.34**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 2280 candidats
...
- TROP-CHER : 5474 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 5441 avec CONNECTED, 33 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 39997 systemes
  - sans CONNECTED : 0.0% sur 8951 systemes
