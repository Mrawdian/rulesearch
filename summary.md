...
- moteur actif `0caa9267db60` (47073 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 42795 | 21314 | 2937 | 1446 | 4274 | 3360 | 4511 | 4397 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 41905 | 9660 | 17796 | 24 | 5803 | 2185 | 22 | 6414 | 15.3% |
...
- candidats AVEC connectivite : 4524, dont T2 : 100%
- candidats SANS connectivite : 6724, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4785 systemes avec CONNECTED sur 37470 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6958 candidats sur 11248 portent les champs bruts (62%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 993 candidats
  - AVEC connectivite (396) : resistance **41.4%**
  - SANS connectivite (597) : resistance **21.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 993 candidats
  - AVEC connectivite (396) : T0=13.05 T1=0.00 T2=3.02 — pondere **6.04**
  - SANS connectivite (597) : T0=15.87 T1=0.00 T2=2.65 — pondere **5.29**
...
- TROP-CHER : 4817 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4785 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 34969 systemes
  - sans CONNECTED : 0.0% sur 7826 systemes
