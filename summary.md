...
genere 2026-09-09 18:53 UTC — 484308 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 400964 systemes
...
- moteur actif `0caa9267db60` (440566 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 241502 | 119913 | 16461 | 8087 | 24440 | 18941 | 25720 | 24878 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 236691 | 55162 | 99726 | 94 | 32971 | 12223 | 86 | 36408 | 15.4% |
...
- candidats AVEC connectivite : 25005, dont T2 : 100%
- candidats SANS connectivite : 36718, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25994 systemes avec CONNECTED sur 199672 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*57433 candidats sur 61723 portent les champs bruts (93%).*

- `5c556c16ea8b` — 51468 candidats
  - AVEC connectivite (20877) : resistance **41.2%**
  - SANS connectivite (30591) : resistance **21.3%**
...
- `5c556c16ea8b` — 51468 candidats
  - AVEC connectivite (20877) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (30591) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 26090 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25994 avec CONNECTED, 96 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 197171 systemes
  - sans CONNECTED : 0.0% sur 44331 systemes
