...
genere 2026-08-25 20:02 UTC — 1772 systemes evalues

## versions du DSL presentes
- `0327bdc4c76a` : 853 systemes
- `615abe43d6bc` : 795 systemes
...
| connect | 4 | 3 | 848 | 433 | 61 | 34 | 97 | 54 | 82 | 77 | 9.1% |
...
- candidats AVEC connectivite : 80, dont T2 : 100%
- candidats SANS connectivite : 125, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **82 systemes avec CONNECTED sur 748 (11.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- TROP-CHER : 83 systemes abandonnes (4.7% des systemes), 95% du temps total
  dont 82 avec CONNECTED, 1 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 11.9% sur 691 systemes
  - sans CONNECTED : 0.0% sur 157 systemes
