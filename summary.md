...
genere 2026-08-30 06:21 UTC — 209808 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 126464 systemes
...
- moteur actif `0caa9267db60` (166066 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 102899 | 51080 | 7011 | 3446 | 10395 | 8199 | 10853 | 10575 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 100794 | 23487 | 42584 | 46 | 13916 | 5200 | 40 | 15513 | 15.4% |
...
- candidats AVEC connectivite : 10702, dont T2 : 100%
...
- **11127 systemes avec CONNECTED sur 86416 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*22235 candidats sur 26525 portent les champs bruts (84%).*

- `5c556c16ea8b` — 16270 candidats
  - AVEC connectivite (6574) : resistance **41.1%**
...
- `5c556c16ea8b` — 16270 candidats
  - AVEC connectivite (6574) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.99**
...
- TROP-CHER : 11177 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11127 avec CONNECTED, 50 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 83915 systemes
  - sans CONNECTED : 0.0% sur 18984 systemes
