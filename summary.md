...
genere 2026-08-26 12:42 UTC — 44578 systemes evalues
...
| connect | 4 | 3 | 19442 | 9692 | 1270 | 677 | 1941 | 1543 | 2095 | 1981 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 19021 | 4466 | 8018 | 13 | 2622 | 985 | 7 | 2910 | 15.3% |
...
- candidats AVEC connectivite : 2108, dont T2 : 100%
- candidats SANS connectivite : 3220, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2369 systemes avec CONNECTED sur 18377 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1038 candidats sur 5328 portent les champs bruts (19%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `e40600351a72` — 117 candidats
  - AVEC connectivite (57) : resistance **39.9%**
...
- `e40600351a72` — 117 candidats
  - AVEC connectivite (57) : T0=13.05 T1=0.00 T2=2.95 — pondere **5.89**
...
- TROP-CHER : 2386 systemes abandonnes (5.4% des systemes), 95% du temps total
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 15876 systemes
  - sans CONNECTED : 0.0% sur 3566 systemes
