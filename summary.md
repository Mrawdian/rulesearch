...
genere 2026-08-26 18:33 UTC — 58638 systemes evalues
...
- `62448a55927e` : 30 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (14896 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 26538 | 13229 | 1811 | 897 | 2633 | 2097 | 2826 | 2718 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 25985 | 5972 | 11021 | 15 | 3624 | 1333 | 10 | 4010 | 15.4% |
...
- candidats AVEC connectivite : 2845, dont T2 : 100%
- candidats SANS connectivite : 4320, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3100 systemes avec CONNECTED sur 24205 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2875 candidats sur 7165 portent les champs bruts (40%).*
...
- TROP-CHER : 3120 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3100 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 21704 systemes
  - sans CONNECTED : 0.0% sur 4834 systemes
