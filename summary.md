...
genere 2026-09-05 16:35 UTC — 393429 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 310085 systemes
...
- moteur actif `0caa9267db60` (349687 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 195588 | 97125 | 13311 | 6520 | 19894 | 15388 | 20757 | 20106 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 191726 | 44646 | 80894 | 78 | 26693 | 9907 | 71 | 29423 | 15.3% |
...
- candidats SANS connectivite : 29733, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21031 systemes avec CONNECTED sur 162053 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*45676 candidats sur 49966 portent les champs bruts (91%).*

- `5c556c16ea8b` — 39711 candidats
  - AVEC connectivite (16105) : resistance **41.1%**
  - SANS connectivite (23606) : resistance **21.3%**
...
- `5c556c16ea8b` — 39711 candidats
  ...
  - SANS connectivite (23606) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 21112 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21031 avec CONNECTED, 81 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 159552 systemes
  - sans CONNECTED : 0.0% sur 36036 systemes
