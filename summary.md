...
genere 2026-09-02 10:20 UTC — 308681 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 225337 systemes
...
- moteur actif `0caa9267db60` (264939 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 152798 | 75908 | 10397 | 5114 | 15535 | 12022 | 16178 | 15690 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 149768 | 34892 | 63330 | 63 | 20700 | 7732 | 63 | 22976 | 15.3% |
...
- candidats AVEC connectivite : 15817, dont T2 : 100%
- candidats SANS connectivite : 23286, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16452 systemes avec CONNECTED sur 127220 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*34813 candidats sur 39103 portent les champs bruts (89%).*

- `5c556c16ea8b` — 28848 candidats
  - AVEC connectivite (11689) : resistance **41.1%**
  - SANS connectivite (17159) : resistance **21.3%**
...
- `5c556c16ea8b` — 28848 candidats
  - AVEC connectivite (11689) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (17159) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 16525 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16452 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 124719 systemes
  - sans CONNECTED : 0.0% sur 28079 systemes
