...
genere 2026-08-27 23:50 UTC — 119504 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 36160 systemes
...
- moteur actif `0caa9267db60` (75762 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 57276 | 28534 | 3958 | 1938 | 5680 | 4535 | 6049 | 5848 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 56113 | 12944 | 23816 | 26 | 7802 | 2898 | 25 | 8600 | 15.3% |
...
- candidats AVEC connectivite : 5975, dont T2 : 100%
- candidats SANS connectivite : 8910, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6323 systemes avec CONNECTED sur 49285 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10595 candidats sur 14885 portent les champs bruts (71%).*

- `5c556c16ea8b` — 4630 candidats
  - AVEC connectivite (1847) : resistance **42.0%**
  - SANS connectivite (2783) : resistance **22.4%**
...
- `5c556c16ea8b` — 4630 candidats
  - AVEC connectivite (1847) : T0=12.98 T1=0.00 T2=3.05 — pondere **6.11**
  - SANS connectivite (2783) : T0=15.78 T1=0.00 T2=2.71 — pondere **5.43**
...
## cout
- temps total 36.9 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 6358 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6323 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 46784 systemes
  - sans CONNECTED : 0.0% sur 10492 systemes
