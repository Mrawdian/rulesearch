...
genere 2026-08-29 13:08 UTC — 183884 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 100540 systemes
...
- moteur actif `0caa9267db60` (140142 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 89789 | 44662 | 6097 | 3032 | 9032 | 7159 | 9429 | 9237 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 87980 | 20570 | 37141 | 43 | 12137 | 4515 | 35 | 13533 | 15.4% |
...
- candidats AVEC connectivite : 9364, dont T2 : 100%
- candidats SANS connectivite : 13843, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9703 systemes avec CONNECTED sur 75748 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*18917 candidats sur 23207 portent les champs bruts (82%).*

- `5c556c16ea8b` — 12952 candidats
  - AVEC connectivite (5236) : resistance **41.2%**
  - SANS connectivite (7716) : resistance **21.6%**
...
- `5c556c16ea8b` — 12952 candidats
  - AVEC connectivite (5236) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (7716) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 9748 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 9703 avec CONNECTED, 45 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 73247 systemes
  - sans CONNECTED : 0.0% sur 16542 systemes
