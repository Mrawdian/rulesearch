...
genere 2026-08-27 03:11 UTC — 77773 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 12866 systemes
...
- moteur actif `0caa9267db60` (34031 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 36215 | 18012 | 2494 | 1224 | 3593 | 2861 | 3844 | 3714 | 10.3% |
...
- candidats AVEC connectivite : 3841, dont T2 : 100%
- candidats SANS connectivite : 5720, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4118 systemes avec CONNECTED sur 32145 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5271 candidats sur 9561 portent les champs bruts (55%).*
...
- `ab89a63b01ef` — 1594 candidats
  - AVEC connectivite (661) : resistance **41.3%**
...
- `ab89a63b01ef` — 1594 candidats
  - AVEC connectivite (661) : T0=13.01 T1=0.00 T2=3.05 — pondere **6.09**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 29644 systemes
  - sans CONNECTED : 0.0% sur 6571 systemes
