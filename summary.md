...
genere 2026-09-07 23:01 UTC — 445320 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 361976 systemes
...
- moteur actif `0caa9267db60` (401578 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 221816 | 110176 | 15128 | 7408 | 22443 | 17370 | 23617 | 22849 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 217389 | 50639 | 91609 | 85 | 30306 | 11247 | 78 | 33407 | 15.4% |
...
- candidats AVEC connectivite : 22976, dont T2 : 100%
- candidats SANS connectivite : 33717, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23891 systemes avec CONNECTED sur 183639 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*52403 candidats sur 56693 portent les champs bruts (92%).*

- `5c556c16ea8b` — 46438 candidats
  - AVEC connectivite (18848) : resistance **41.2%**
  - SANS connectivite (27590) : resistance **21.3%**
...
- `5c556c16ea8b` — 46438 candidats
  - AVEC connectivite (18848) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (27590) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
## cout
- temps total 138.8 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 23979 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23891 avec CONNECTED, 88 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 181138 systemes
  - sans CONNECTED : 0.0% sur 40678 systemes
