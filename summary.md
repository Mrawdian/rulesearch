...
genere 2026-09-05 20:43 UTC — 397570 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 314226 systemes
...
- moteur actif `0caa9267db60` (353828 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 197681 | 98121 | 13458 | 6594 | 20099 | 15565 | 20983 | 20343 | 10.3% |
...
- candidats AVEC connectivite : 20470, dont T2 : 100%
...
- **21257 systemes avec CONNECTED sur 163758 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*46251 candidats sur 50541 portent les champs bruts (92%).*

- `5c556c16ea8b` — 40286 candidats
  - AVEC connectivite (16342) : resistance **41.1%**
...
- `5c556c16ea8b` — 40286 candidats
  - AVEC connectivite (16342) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.94**
...
- TROP-CHER : 21338 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21257 avec CONNECTED, 81 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 161257 systemes
  - sans CONNECTED : 0.0% sur 36424 systemes
