...
genere 2026-08-30 00:46 UTC — 201540 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 118196 systemes
...
- moteur actif `0caa9267db60` (157798 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 98716 | 49005 | 6716 | 3311 | 9963 | 7862 | 10402 | 10180 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 96709 | 22559 | 40819 | 45 | 13374 | 4989 | 37 | 14879 | 15.4% |
...
- candidats AVEC connectivite : 10307, dont T2 : 100%
- candidats SANS connectivite : 15189, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10676 systemes avec CONNECTED sur 83004 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*21206 candidats sur 25496 portent les champs bruts (83%).*

- `5c556c16ea8b` — 15241 candidats
  - AVEC connectivite (6179) : resistance **41.2%**
  - SANS connectivite (9062) : resistance **21.5%**
...
- `5c556c16ea8b` — 15241 candidats
  - AVEC connectivite (6179) : T0=13.00 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (9062) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.33**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 80503 systemes
  - sans CONNECTED : 0.0% sur 18213 systemes
