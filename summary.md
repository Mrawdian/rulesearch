...
genere 2026-08-26 23:49 UTC — 70326 systemes evalues
...
- moteur actif `0caa9267db60` (26584 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 32460 | 16140 | 2223 | 1095 | 3234 | 2583 | 3461 | 3309 | 10.2% |
...
- candidats AVEC connectivite : 3436, dont T2 : 100%
- candidats SANS connectivite : 5166, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3735 systemes avec CONNECTED sur 29039 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4312 candidats sur 8602 portent les champs bruts (50%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 635 candidats
  - AVEC connectivite (256) : resistance **42.2%**
...
- `ab89a63b01ef` — 635 candidats
  - AVEC connectivite (256) : T0=13.09 T1=0.00 T2=3.13 — pondere **6.26**
...
- TROP-CHER : 3759 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3735 avec CONNECTED, 24 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 26538 systemes
  - sans CONNECTED : 0.0% sur 5922 systemes
