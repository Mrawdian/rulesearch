...
genere 2026-08-31 01:42 UTC — 236940 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 153596 systemes
...
- moteur actif `0caa9267db60` (193198 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 116594 | 57971 | 7919 | 3917 | 11717 | 9194 | 12357 | 11995 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 114231 | 26646 | 48276 | 53 | 15762 | 5907 | 51 | 17526 | 15.3% |
...
- candidats SANS connectivite : 17836, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12631 systemes avec CONNECTED sur 97715 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*25668 candidats sur 29958 portent les champs bruts (86%).*

- `5c556c16ea8b` — 19703 candidats
  - AVEC connectivite (7994) : resistance **41.0%**
  - SANS connectivite (11709) : resistance **21.4%**
...
- `5c556c16ea8b` — 19703 candidats
  ...
  - SANS connectivite (11709) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 95214 systemes
  - sans CONNECTED : 0.0% sur 21380 systemes
