...
genere 2026-09-04 23:16 UTC — 375831 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 292487 systemes
...
- moteur actif `0caa9267db60` (332089 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 186705 | 92730 | 12694 | 6241 | 18994 | 14715 | 19788 | 19150 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 183011 | 42561 | 77309 | 76 | 25424 | 9480 | 70 | 28077 | 15.3% |
...
- candidats AVEC connectivite : 19277, dont T2 : 100%
- candidats SANS connectivite : 28387, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20062 systemes avec CONNECTED sur 154803 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*43374 candidats sur 47664 portent les champs bruts (91%).*

- `5c556c16ea8b` — 37409 candidats
  - AVEC connectivite (15149) : resistance **41.1%**
  - SANS connectivite (22260) : resistance **21.2%**
...
- `5c556c16ea8b` — 37409 candidats
  - AVEC connectivite (15149) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (22260) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
## cout
- temps total 116.6 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 20142 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 20062 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 152302 systemes
  - sans CONNECTED : 0.0% sur 34403 systemes
