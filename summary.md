...
genere 2026-08-28 18:42 UTC — 153307 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 69963 systemes
...
- moteur actif `0caa9267db60` (109565 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 74339 | 36943 | 5066 | 2538 | 7456 | 5923 | 7843 | 7626 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 72853 | 16938 | 30809 | 35 | 10044 | 3747 | 31 | 11246 | 15.4% |
...
- candidats AVEC connectivite : 7753, dont T2 : 100%
- candidats SANS connectivite : 11556, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8117 systemes avec CONNECTED sur 63145 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*15019 candidats sur 19309 portent les champs bruts (78%).*

- `5c556c16ea8b` — 9054 candidats
  - AVEC connectivite (3625) : resistance **41.1%**
  - SANS connectivite (5429) : resistance **21.7%**
...
- `5c556c16ea8b` — 9054 candidats
  - AVEC connectivite (3625) : T0=13.02 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (5429) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.35**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 60644 systemes
  - sans CONNECTED : 0.0% sur 13695 systemes
