...
genere 2026-08-28 01:09 UTC — 122297 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 38953 systemes
...
- moteur actif `0caa9267db60` (78555 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 58677 | 29225 | 4055 | 1977 | 5834 | 4645 | 6168 | 6017 | 10.3% |
...
- candidats AVEC connectivite : 6144, dont T2 : 100%
- candidats SANS connectivite : 9119, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6442 systemes avec CONNECTED sur 50406 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10973 candidats sur 15263 portent les champs bruts (72%).*

- `5c556c16ea8b` — 5008 candidats
  - AVEC connectivite (2016) : resistance **42.0%**
...
- `5c556c16ea8b` — 5008 candidats
  - AVEC connectivite (2016) : T0=12.99 T1=0.00 T2=3.05 — pondere **6.10**
...
- TROP-CHER : 6478 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6442 avec CONNECTED, 36 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 47905 systemes
  - sans CONNECTED : 0.0% sur 10772 systemes
