...
genere 2026-08-27 20:31 UTC — 113062 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 29718 systemes
...
- moteur actif `0caa9267db60` (69320 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 54017 | 26903 | 3735 | 1835 | 5331 | 4276 | 5713 | 5520 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 52930 | 12216 | 22483 | 26 | 7326 | 2753 | 25 | 8099 | 15.3% |
...
- candidats AVEC connectivite : 5647, dont T2 : 100%
- candidats SANS connectivite : 8409, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5987 systemes avec CONNECTED sur 46644 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*9766 candidats sur 14056 portent les champs bruts (69%).*

- `5c556c16ea8b` — 3801 candidats
  - AVEC connectivite (1519) : resistance **42.0%**
  - SANS connectivite (2282) : resistance **22.4%**
...
- `5c556c16ea8b` — 3801 candidats
  - AVEC connectivite (1519) : T0=12.94 T1=0.00 T2=3.05 — pondere **6.11**
  - SANS connectivite (2282) : T0=15.77 T1=0.00 T2=2.70 — pondere **5.41**
...
## cout
- temps total 35.0 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 6022 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 5987 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 44143 systemes
  - sans CONNECTED : 0.0% sur 9874 systemes
