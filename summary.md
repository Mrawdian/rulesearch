...
genere 2026-08-30 20:34 UTC — 229935 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 146591 systemes
...
- moteur actif `0caa9267db60` (186193 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 113069 | 56226 | 7683 | 3783 | 11353 | 8946 | 11966 | 11635 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 110751 | 25833 | 46801 | 52 | 15271 | 5723 | 47 | 17014 | 15.4% |
...
- candidats AVEC connectivite : 11762, dont T2 : 100%
- candidats SANS connectivite : 17324, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12240 systemes avec CONNECTED sur 94801 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*24796 candidats sur 29086 portent les champs bruts (85%).*

- `5c556c16ea8b` — 18831 candidats
  - AVEC connectivite (7634) : resistance **41.1%**
  - SANS connectivite (11197) : resistance **21.4%**
...
- `5c556c16ea8b` — 18831 candidats
  - AVEC connectivite (7634) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (11197) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 92300 systemes
  - sans CONNECTED : 0.0% sur 20769 systemes
