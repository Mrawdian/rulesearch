...
genere 2026-09-07 12:25 UTC — 435634 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 352290 systemes
...
- moteur actif `0caa9267db60` (391892 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 216915 | 107770 | 14774 | 7218 | 21963 | 17005 | 23072 | 22357 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 212604 | 49498 | 89636 | 83 | 29632 | 10981 | 76 | 32680 | 15.4% |
...
- candidats SANS connectivite : 32990, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23346 systemes avec CONNECTED sur 179589 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*51184 candidats sur 55474 portent les champs bruts (92%).*

- `5c556c16ea8b` — 45219 candidats
  - AVEC connectivite (18356) : resistance **41.1%**
  - SANS connectivite (26863) : resistance **21.3%**
...
- `5c556c16ea8b` — 45219 candidats
  ...
  - SANS connectivite (26863) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 23432 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23346 avec CONNECTED, 86 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 177088 systemes
  - sans CONNECTED : 0.0% sur 39827 systemes
