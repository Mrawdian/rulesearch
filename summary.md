...
genere 2026-09-09 02:32 UTC — 470147 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 386803 systemes
...
- moteur actif `0caa9267db60` (426405 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 234351 | 116390 | 15982 | 7841 | 23721 | 18354 | 24950 | 24141 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 229681 | 53494 | 96775 | 92 | 32003 | 11864 | 82 | 35352 | 15.4% |
...
- candidats AVEC connectivite : 24268, dont T2 : 100%
...
- **25224 systemes avec CONNECTED sur 193843 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55640 candidats sur 59930 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49675 candidats
  - AVEC connectivite (20140) : resistance **41.2%**
...
- `5c556c16ea8b` — 49675 candidats
  - AVEC connectivite (20140) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 25316 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25224 avec CONNECTED, 92 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 191342 systemes
  - sans CONNECTED : 0.0% sur 43009 systemes
