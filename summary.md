...
genere 2026-09-06 15:51 UTC — 416204 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 332860 systemes
...
- moteur actif `0caa9267db60` (372462 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 207099 | 102825 | 14106 | 6891 | 21000 | 16294 | 22009 | 21339 | 10.3% |
...
- candidats AVEC connectivite : 21466, dont T2 : 100%
...
- **22283 systemes avec CONNECTED sur 171492 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*48689 candidats sur 52979 portent les champs bruts (92%).*

- `5c556c16ea8b` — 42724 candidats
  - AVEC connectivite (17338) : resistance **41.1%**
...
- `5c556c16ea8b` — 42724 candidats
  - AVEC connectivite (17338) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 22366 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 22283 avec CONNECTED, 83 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 168991 systemes
  - sans CONNECTED : 0.0% sur 38108 systemes
