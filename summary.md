...
genere 2026-08-26 20:53 UTC — 63856 systemes evalues
...
- moteur actif `0caa9267db60` (20114 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 29186 | 14522 | 1992 | 975 | 2904 | 2310 | 3109 | 3000 | 10.3% |
...
- candidats AVEC connectivite : 3127, dont T2 : 100%
- candidats SANS connectivite : 4699, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3383 systemes avec CONNECTED sur 26379 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3536 candidats sur 7826 portent les champs bruts (45%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 667 candidats
  - AVEC connectivite (283) : resistance **40.3%**
...
- `62448a55927e` — 667 candidats
  - AVEC connectivite (283) : T0=12.81 T1=0.00 T2=2.87 — pondere **5.73**
  - SANS connectivite (384) : T0=16.13 T1=0.00 T2=2.69 — pondere **5.38**
  - test de permutation : **p = 0.1704** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e3baecf8377b` — 657 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23878 systemes
  - sans CONNECTED : 0.0% sur 5308 systemes
