...
genere 2026-08-27 23:45 UTC — 119371 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 36027 systemes
...
- moteur actif `0caa9267db60` (75629 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 57202 | 28500 | 3953 | 1938 | 5672 | 4529 | 6042 | 5836 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 56054 | 12931 | 23793 | 26 | 7792 | 2896 | 25 | 8589 | 15.3% |
...
- candidats AVEC connectivite : 5963, dont T2 : 100%
- candidats SANS connectivite : 8899, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6316 systemes avec CONNECTED sur 49224 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10572 candidats sur 14862 portent les champs bruts (71%).*

- `5c556c16ea8b` — 4607 candidats
  - AVEC connectivite (1835) : resistance **42.0%**
  - SANS connectivite (2772) : resistance **22.4%**
...
- `5c556c16ea8b` — 4607 candidats
  - AVEC connectivite (1835) : T0=12.97 T1=0.00 T2=3.06 — pondere **6.12**
  - SANS connectivite (2772) : T0=15.77 T1=0.00 T2=2.71 — pondere **5.42**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 46723 systemes
  - sans CONNECTED : 0.0% sur 10479 systemes
