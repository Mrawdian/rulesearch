...
genere 2026-08-28 13:55 UTC — 144927 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 61583 systemes
...
- moteur actif `0caa9267db60` (101185 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 70112 | 34839 | 4786 | 2376 | 7034 | 5596 | 7408 | 7176 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 68700 | 15933 | 29032 | 32 | 9517 | 3534 | 30 | 10619 | 15.5% |
...
- candidats AVEC connectivite : 7303, dont T2 : 100%
- candidats SANS connectivite : 10929, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7682 systemes avec CONNECTED sur 59683 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*13942 candidats sur 18232 portent les champs bruts (76%).*

- `5c556c16ea8b` — 7977 candidats
  - AVEC connectivite (3175) : resistance **41.2%**
  - SANS connectivite (4802) : resistance **21.8%**
...
- `5c556c16ea8b` — 7977 candidats
  - AVEC connectivite (3175) : T0=13.01 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (4802) : T0=15.89 T1=0.00 T2=2.68 — pondere **5.36**
...
- TROP-CHER : 7722 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7682 avec CONNECTED, 40 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 57182 systemes
  - sans CONNECTED : 0.0% sur 12930 systemes
