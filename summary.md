...
genere 2026-08-28 21:03 UTC — 157327 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 73983 systemes
...
- moteur actif `0caa9267db60` (113585 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 76375 | 37957 | 5201 | 2594 | 7649 | 6095 | 8055 | 7851 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 74837 | 17397 | 31688 | 35 | 10316 | 3833 | 31 | 11534 | 15.4% |
...
- candidats AVEC connectivite : 7978, dont T2 : 100%
...
- **8329 systemes avec CONNECTED sur 64816 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*15532 candidats sur 19822 portent les champs bruts (78%).*

- `5c556c16ea8b` — 9567 candidats
  - AVEC connectivite (3850) : resistance **41.1%**
...
- `5c556c16ea8b` — 9567 candidats
  - AVEC connectivite (3850) : T0=13.01 T1=0.00 T2=3.00 — pondere **6.00**
...
- TROP-CHER : 8370 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8329 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 62315 systemes
  - sans CONNECTED : 0.0% sur 14060 systemes
