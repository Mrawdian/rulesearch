...
genere 2026-08-26 02:16 UTC — 17927 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 8953 systemes
...
| connect | 4 | 3 | 8999 | 4533 | 585 | 299 | 865 | 712 | 972 | 922 | 10.2% |
| ref | 4 | 3 | 8804 | 2120 | 3698 | 2 | 1175 | 435 | 3 | 1371 | 15.6% |
...
- candidats AVEC connectivite : 925, dont T2 : 100%
- candidats SANS connectivite : 1375, dont T2 : 100%
...
- **972 systemes avec CONNECTED sur 7455 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1135 candidats
  - AVEC connectivite (446) : T0=13.35 T1=0.00 T2=2.90 — pondere **5.79**
  - SANS connectivite (689) : T0=15.86 T1=0.00 T2=2.67 — pondere **5.34**
  - test de permutation : **p = 0.0200** — ecart significatif au seuil 0.05
...
- TROP-CHER : 975 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 972 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 7398 systemes
  - sans CONNECTED : 0.0% sur 1601 systemes
