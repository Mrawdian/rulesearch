...
genere 2026-09-07 09:22 UTC — 432840 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 349496 systemes
...
- moteur actif `0caa9267db60` (389098 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 215509 | 107045 | 14676 | 7180 | 21835 | 16909 | 22911 | 22212 | 10.3% |
...
- candidats AVEC connectivite : 22339, dont T2 : 100%
...
- **23185 systemes avec CONNECTED sur 178427 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*50828 candidats sur 55118 portent les champs bruts (92%).*

- `5c556c16ea8b` — 44863 candidats
  - AVEC connectivite (18211) : resistance **41.1%**
...
- `5c556c16ea8b` — 44863 candidats
  - AVEC connectivite (18211) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 23271 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23185 avec CONNECTED, 86 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 175926 systemes
  - sans CONNECTED : 0.0% sur 39583 systemes
