...
genere 2026-09-03 17:01 UTC — 343394 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 260050 systemes
...
- moteur actif `0caa9267db60` (299652 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 170325 | 84665 | 11554 | 5703 | 17321 | 13449 | 18051 | 17412 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 166954 | 38839 | 70569 | 67 | 23154 | 8632 | 66 | 25615 | 15.3% |
...
- candidats AVEC connectivite : 17539, dont T2 : 100%
- candidats SANS connectivite : 25925, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18325 systemes avec CONNECTED sur 141465 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39174 candidats sur 43464 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33209 candidats
  - AVEC connectivite (13411) : resistance **41.0%**
  - SANS connectivite (19798) : resistance **21.2%**
...
- `5c556c16ea8b` — 33209 candidats
  - AVEC connectivite (13411) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (19798) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 138964 systemes
  - sans CONNECTED : 0.0% sur 31361 systemes
