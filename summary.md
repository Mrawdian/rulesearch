...
genere 2026-08-30 00:27 UTC — 201051 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 117707 systemes
...
- moteur actif `0caa9267db60` (157309 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 98461 | 48888 | 6695 | 3306 | 9933 | 7838 | 10379 | 10149 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 96475 | 22513 | 40727 | 45 | 13329 | 4976 | 37 | 14842 | 15.4% |
...
- candidats SANS connectivite : 15152, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10653 systemes avec CONNECTED sur 82805 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*21138 candidats sur 25428 portent les champs bruts (83%).*

- `5c556c16ea8b` — 15173 candidats
  - AVEC connectivite (6148) : resistance **41.2%**
  - SANS connectivite (9025) : resistance **21.5%**
...
- `5c556c16ea8b` — 15173 candidats
  ...
  - SANS connectivite (9025) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 10700 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10653 avec CONNECTED, 47 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 80304 systemes
  - sans CONNECTED : 0.0% sur 18157 systemes
