...
| connect | 4 | 3 | 7367 | 3712 | 486 | 256 | 696 | 598 | 769 | 769 | 10.4% |
| ref | 4 | 3 | 7201 | 1742 | 2999 | 1 | 963 | 357 | 2 | 1137 | 15.8% |
...
- candidats AVEC connectivite : 772, dont T2 : 100%
- candidats SANS connectivite : 1141, dont T2 : 100%
...
- **769 systemes avec CONNECTED sur 6099 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 748 candidats
  - AVEC connectivite (293) : T0=13.22 T1=0.00 T2=2.93 — pondere **5.86**
  - SANS connectivite (455) : T0=15.80 T1=0.00 T2=2.67 — pondere **5.34**
...
- TROP-CHER : 771 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 769 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 6042 systemes
  - sans CONNECTED : 0.0% sur 1325 systemes
