...
genere 2026-08-29 08:06 UTC — 175885 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 92541 systemes
...
- moteur actif `0caa9267db60` (132143 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 85753 | 42679 | 5835 | 2898 | 8604 | 6802 | 9000 | 8846 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 84017 | 19614 | 35527 | 39 | 11584 | 4277 | 35 | 12935 | 15.4% |
...
- candidats AVEC connectivite : 8973, dont T2 : 100%
- candidats SANS connectivite : 13245, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9274 systemes avec CONNECTED sur 72503 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*17928 candidats sur 22218 portent les champs bruts (81%).*

- `5c556c16ea8b` — 11963 candidats
  - AVEC connectivite (4845) : resistance **41.1%**
  - SANS connectivite (7118) : resistance **21.6%**
...
- `5c556c16ea8b` — 11963 candidats
  - AVEC connectivite (4845) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (7118) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.33**
...
- TROP-CHER : 9319 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 9274 avec CONNECTED, 45 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 70002 systemes
  - sans CONNECTED : 0.0% sur 15751 systemes
