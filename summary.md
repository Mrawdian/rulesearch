...
genere 2026-09-08 22:55 UTC — 466881 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 383537 systemes
...
- moteur actif `0caa9267db60` (423139 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 232694 | 115596 | 15844 | 7791 | 23536 | 18223 | 24785 | 23966 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 228072 | 53119 | 96108 | 92 | 31770 | 11783 | 81 | 35100 | 15.4% |
...
- candidats AVEC connectivite : 24093, dont T2 : 100%
- candidats SANS connectivite : 35410, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25059 systemes avec CONNECTED sur 192517 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55213 candidats sur 59503 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49248 candidats
  - AVEC connectivite (19965) : resistance **41.2%**
  - SANS connectivite (29283) : resistance **21.3%**
...
- `5c556c16ea8b` — 49248 candidats
  - AVEC connectivite (19965) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (29283) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 25150 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25059 avec CONNECTED, 91 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 190016 systemes
  - sans CONNECTED : 0.0% sur 42678 systemes
