...
genere 2026-09-07 09:55 UTC — 433310 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 349966 systemes
...
- moteur actif `0caa9267db60` (389568 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 215748 | 107166 | 14688 | 7185 | 21857 | 16924 | 22943 | 22241 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 211447 | 49220 | 89144 | 82 | 29466 | 10931 | 76 | 32510 | 15.4% |
...
- candidats AVEC connectivite : 22368, dont T2 : 100%
- candidats SANS connectivite : 32820, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23217 systemes avec CONNECTED sur 178628 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*50898 candidats sur 55188 portent les champs bruts (92%).*

- `5c556c16ea8b` — 44933 candidats
  - AVEC connectivite (18240) : resistance **41.1%**
  - SANS connectivite (26693) : resistance **21.3%**
...
- `5c556c16ea8b` — 44933 candidats
  - AVEC connectivite (18240) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (26693) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
## cout
- temps total 134.9 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 23303 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23217 avec CONNECTED, 86 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 176127 systemes
  - sans CONNECTED : 0.0% sur 39621 systemes
