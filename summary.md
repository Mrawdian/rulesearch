...
genere 2026-08-26 10:37 UTC — 39171 systemes evalues
...
- `e3baecf8377b` : 578 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
**8044 enregistrements (21%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| ref | 4 | 3 | 16349 | 3845 | 6925 | 11 | 2232 | 824 | 7 | 2505 | 15.3% |
...
- candidats SANS connectivite : 2815, dont T2 : 100%
...
*338 candidats sur 4628 portent les champs bruts (7%).*
...
- `e3baecf8377b` — 74 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (30) : resistance **37.6%**
  - SANS connectivite (44) : resistance **17.4%**
...
- `e3baecf8377b` — 74 candidats
  - AVEC connectivite (30) : T0=13.67 T1=0.00 T2=2.83 — pondere **5.67**
  - SANS connectivite (44) : T0=15.98 T1=0.00 T2=2.32 — pondere **4.64**
