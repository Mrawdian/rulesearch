...
- moteur actif `0caa9267db60` (48555 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 43543 | 21705 | 2985 | 1472 | 4341 | 3428 | 4586 | 4460 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 42639 | 9826 | 18093 | 25 | 5922 | 2229 | 22 | 6521 | 15.3% |
...
- candidats AVEC connectivite : 4587, dont T2 : 100%
- candidats SANS connectivite : 6831, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4860 systemes avec CONNECTED sur 38088 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*7128 candidats sur 11418 portent les champs bruts (62%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 1163 candidats
  - AVEC connectivite (459) : resistance **41.5%**
  - SANS connectivite (704) : resistance **21.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 1163 candidats
  - AVEC connectivite (459) : T0=13.01 T1=0.00 T2=3.02 — pondere **6.03**
  - SANS connectivite (704) : T0=15.82 T1=0.00 T2=2.65 — pondere **5.30**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
...
## cout
- temps total 28.4 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 4892 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4860 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 35587 systemes
  - sans CONNECTED : 0.0% sur 7956 systemes
