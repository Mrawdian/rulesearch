...
genere 2026-08-31 12:09 UTC — 251294 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 167950 systemes
...
- moteur actif `0caa9267db60` (207552 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 123842 | 61589 | 8400 | 4149 | 12478 | 9771 | 13082 | 12753 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 121337 | 28305 | 51225 | 53 | 16783 | 6284 | 56 | 18621 | 15.3% |
...
- candidats AVEC connectivite : 12880, dont T2 : 100%
- candidats SANS connectivite : 18931, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13356 systemes avec CONNECTED sur 103574 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*27521 candidats sur 31811 portent les champs bruts (87%).*

- `5c556c16ea8b` — 21556 candidats
  - AVEC connectivite (8752) : resistance **40.9%**
  - SANS connectivite (12804) : resistance **21.4%**
...
- `5c556c16ea8b` — 21556 candidats
  - AVEC connectivite (8752) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (12804) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 101073 systemes
  - sans CONNECTED : 0.0% sur 22769 systemes
