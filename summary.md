...
genere 2026-08-26 03:46 UTC — 21875 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 12901 systemes
...
| connect | 4 | 3 | 10997 | 5531 | 724 | 381 | 1056 | 885 | 1179 | 1101 | 10.0% |
...
- candidats AVEC connectivite : 1104, dont T2 : 100%
...
- **1179 systemes avec CONNECTED sur 9064 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1594 candidats
  - AVEC connectivite (625) : T0=13.36 T1=0.00 T2=2.86 — pondere **5.73**
...
- TROP-CHER : 1183 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 1179 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 9007 systemes
  - sans CONNECTED : 0.0% sur 1990 systemes
