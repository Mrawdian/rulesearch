...
genere 2026-08-27 18:27 UTC — 109231 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 25887 systemes
...
- moteur actif `0caa9267db60` (65489 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 52078 | 25938 | 3602 | 1789 | 5156 | 4121 | 5496 | 5300 | 10.2% |
...
- **5770 systemes avec CONNECTED sur 45044 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*9249 candidats sur 13539 portent les champs bruts (68%).*
...
- TROP-CHER : 5804 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 5770 avec CONNECTED, 34 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 42543 systemes
  - sans CONNECTED : 0.0% sur 9535 systemes
