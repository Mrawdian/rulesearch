...
genere 2026-09-01 18:33 UTC — 289932 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 206588 systemes
...
- moteur actif `0caa9267db60` (246190 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 143350 | 71219 | 9726 | 4797 | 14557 | 11314 | 15148 | 14738 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 140467 | 32663 | 59427 | 59 | 19472 | 7257 | 63 | 21515 | 15.3% |
...
- candidats AVEC connectivite : 14865, dont T2 : 100%
- candidats SANS connectivite : 21825, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15422 systemes avec CONNECTED sur 119470 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*32400 candidats sur 36690 portent les champs bruts (88%).*

- `5c556c16ea8b` — 26435 candidats
  - AVEC connectivite (10737) : resistance **41.0%**
  - SANS connectivite (15698) : resistance **21.3%**
...
- `5c556c16ea8b` — 26435 candidats
  - AVEC connectivite (10737) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (15698) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 15495 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15422 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 116969 systemes
  - sans CONNECTED : 0.0% sur 26381 systemes
