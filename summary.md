...
genere 2026-08-26 10:45 UTC — 39574 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `615abe43d6bc` : 7172 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
- `e3baecf8377b` : 981 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
**8447 enregistrements (21%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 16901 | 8438 | 1086 | 584 | 1682 | 1347 | 1844 | 1707 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 16558 | 3896 | 7022 | 11 | 2255 | 835 | 7 | 2532 | 15.3% |
...
- candidats SANS connectivite : 2842, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2118 systemes avec CONNECTED sur 16313 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*386 candidats sur 4676 portent les champs bruts (8%).*
...
- `e3baecf8377b` — 122 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (51) : resistance **40.5%**
  - SANS connectivite (71) : resistance **20.2%**
...
- `e3baecf8377b` — 122 candidats
  - AVEC connectivite (51) : T0=13.53 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (71) : T0=15.76 T1=0.00 T2=2.55 — pondere **5.10**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.4% sur 13812 systemes
  - sans CONNECTED : 0.0% sur 3089 systemes
