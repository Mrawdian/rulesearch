...
genere 2026-09-09 04:11 UTC — 471600 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 388256 systemes
...
- moteur actif `0caa9267db60` (427858 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 235083 | 116754 | 16028 | 7872 | 23790 | 18402 | 25032 | 24219 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 230402 | 53680 | 97073 | 92 | 32099 | 11907 | 82 | 35450 | 15.4% |
...
- candidats AVEC connectivite : 24346, dont T2 : 100%
- candidats SANS connectivite : 35760, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25306 systemes avec CONNECTED sur 194450 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55816 candidats sur 60106 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49851 candidats
  - AVEC connectivite (20218) : resistance **41.2%**
  - SANS connectivite (29633) : resistance **21.3%**
...
- `5c556c16ea8b` — 49851 candidats
  - AVEC connectivite (20218) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.97**
  - SANS connectivite (29633) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 25398 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25306 avec CONNECTED, 92 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 191949 systemes
  - sans CONNECTED : 0.0% sur 43134 systemes
