...
genere 2026-08-28 02:06 UTC — 124133 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 40789 systemes
...
- moteur actif `0caa9267db60` (80391 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 59616 | 29689 | 4118 | 2015 | 5930 | 4719 | 6257 | 6122 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 58402 | 13508 | 24744 | 28 | 8125 | 3023 | 26 | 8946 | 15.3% |
...
- candidats AVEC connectivite : 6249, dont T2 : 100%
- candidats SANS connectivite : 9256, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6531 systemes avec CONNECTED sur 51165 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11215 candidats sur 15505 portent les champs bruts (72%).*

- `5c556c16ea8b` — 5250 candidats
  - AVEC connectivite (2121) : resistance **41.8%**
  - SANS connectivite (3129) : resistance **22.2%**
...
- `5c556c16ea8b` — 5250 candidats
  - AVEC connectivite (2121) : T0=12.99 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (3129) : T0=15.84 T1=0.00 T2=2.70 — pondere **5.41**
...
## cout
- temps total 38.1 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 6567 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6531 avec CONNECTED, 36 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 48664 systemes
  - sans CONNECTED : 0.0% sur 10952 systemes
