...
genere 2026-08-26 20:33 UTC — 63187 systemes evalues
...
- moteur actif `0caa9267db60` (19445 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 28841 | 14359 | 1973 | 965 | 2860 | 2286 | 3067 | 2967 | 10.3% |
...
- candidats AVEC connectivite : 3094, dont T2 : 100%
- candidats SANS connectivite : 4650, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3341 systemes avec CONNECTED sur 26100 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3454 candidats sur 7744 portent les champs bruts (45%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 585 candidats
  - AVEC connectivite (250) : resistance **40.0%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 585 candidats
  - AVEC connectivite (250) : T0=12.79 T1=0.00 T2=2.84 — pondere **5.68**
  - SANS connectivite (335) : T0=16.21 T1=0.00 T2=2.69 — pondere **5.37**
  - test de permutation : **p = 0.2514** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23599 systemes
  - sans CONNECTED : 0.0% sur 5242 systemes
