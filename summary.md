...
genere 2026-08-26 16:47 UTC — 54560 systemes evalues
...
- `23303c299f39` : 210 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (10818 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
**7676 enregistrements (14%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| ref | 4 | 3 | 23966 | 5544 | 10132 | 14 | 3361 | 1216 | 10 | 3689 | 15.4% |
...
- candidats SANS connectivite : 3999, dont T2 : 100%
...
*2335 candidats sur 6625 portent les champs bruts (35%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 25 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (12) : resistance **36.6%**
  - SANS connectivite (13) : resistance **21.7%**
...
- `23303c299f39` — 25 candidats
  - AVEC connectivite (12) : T0=13.08 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (13) : T0=17.92 T1=0.00 T2=2.69 — pondere **5.38**
  - *groupes trop petits (< 20) — aucun test, aucune conclusion*
