...
genere 2026-09-03 22:22 UTC — 349295 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 265951 systemes
...
- moteur actif `0caa9267db60` (305553 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 173308 | 86167 | 11766 | 5795 | 17637 | 13655 | 18364 | 17716 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 169872 | 39513 | 71774 | 69 | 23572 | 8786 | 66 | 26079 | 15.4% |
...
- candidats AVEC connectivite : 17843, dont T2 : 100%
- candidats SANS connectivite : 26389, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18638 systemes avec CONNECTED sur 143909 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39942 candidats sur 44232 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33977 candidats
  - AVEC connectivite (13715) : resistance **41.0%**
  - SANS connectivite (20262) : resistance **21.2%**
...
- `5c556c16ea8b` — 33977 candidats
  - AVEC connectivite (13715) : T0=13.03 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (20262) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 141408 systemes
  - sans CONNECTED : 0.0% sur 31900 systemes
