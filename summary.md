...
genere 2026-08-26 14:05 UTC — 48095 systemes evalues
...
- moteur actif `0caa9267db60` (4353 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21216 | 10588 | 1408 | 730 | 2101 | 1686 | 2269 | 2166 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20764 | 4845 | 8766 | 13 | 2878 | 1075 | 7 | 3180 | 15.3% |
...
- candidats AVEC connectivite : 2293, dont T2 : 100%
- candidats SANS connectivite : 3490, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2543 systemes avec CONNECTED sur 19832 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1493 candidats sur 5783 portent les champs bruts (26%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 378 candidats
  - AVEC connectivite (155) : resistance **39.3%**
  - SANS connectivite (223) : resistance **21.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 378 candidats
  - AVEC connectivite (155) : T0=13.39 T1=0.00 T2=2.92 — pondere **5.85**
  - SANS connectivite (223) : T0=16.08 T1=0.00 T2=2.69 — pondere **5.38**
...
- TROP-CHER : 2560 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2543 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17331 systemes
  - sans CONNECTED : 0.0% sur 3885 systemes
