...
genere 2026-08-29 01:13 UTC — 164544 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 81200 systemes
...
- moteur actif `0caa9267db60` (120802 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 78403 | 18221 | 33180 | 36 | 10833 | 3998 | 32 | 12098 | 15.4% |
...
- candidats SANS connectivite : 12408, dont T2 : 100%
...
*16504 candidats sur 20794 portent les champs bruts (79%).*

- `5c556c16ea8b` — 10539 candidats
  - AVEC connectivite (4258) : resistance **41.1%**
  - SANS connectivite (6281) : resistance **21.7%**
...
- `5c556c16ea8b` — 10539 candidats
  ...
  - SANS connectivite (6281) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.35**
...
- TROP-CHER : 8726 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8684 avec CONNECTED, 42 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
