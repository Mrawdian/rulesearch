...
genere 2026-08-26 13:32 UTC — 46837 systemes evalues
...
- moteur actif `0caa9267db60` (3095 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20573 | 10259 | 1357 | 713 | 2054 | 1635 | 2197 | 2104 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20149 | 4714 | 8512 | 13 | 2792 | 1042 | 7 | 3069 | 15.2% |
...
- candidats AVEC connectivite : 2231, dont T2 : 100%
- candidats SANS connectivite : 3379, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2471 systemes avec CONNECTED sur 19293 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1320 candidats sur 5610 portent les champs bruts (24%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 205 candidats
  - AVEC connectivite (93) : resistance **38.6%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 205 candidats
  - AVEC connectivite (93) : T0=13.53 T1=0.00 T2=2.80 — pondere **5.59**
  - SANS connectivite (112) : T0=16.14 T1=0.00 T2=2.88 — pondere **5.75**
  - test de permutation : **p = 0.7101** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
- TROP-CHER : 2488 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2471 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16792 systemes
  - sans CONNECTED : 0.0% sur 3781 systemes
