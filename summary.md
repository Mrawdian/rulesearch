...
genere 2026-08-26 01:35 UTC — 16353 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 7379 systemes
...
| connect | 4 | 3 | 8206 | 4139 | 532 | 281 | 782 | 655 | 871 | 852 | 10.4% |
...
- candidats AVEC connectivite : 855, dont T2 : 100%
...
- **871 systemes avec CONNECTED sur 6795 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 938 candidats
  - AVEC connectivite (376) : T0=13.39 T1=0.00 T2=2.83 — pondere **5.66**
...
- TROP-CHER : 874 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 871 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 6738 systemes
  - sans CONNECTED : 0.0% sur 1468 systemes
