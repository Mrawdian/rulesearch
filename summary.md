...
genere 2026-08-31 16:41 UTC — 257385 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 174041 systemes
...
- moteur actif `0caa9267db60` (213643 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 126921 | 63114 | 8584 | 4258 | 12817 | 10033 | 13390 | 13063 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 124349 | 28985 | 52504 | 56 | 17228 | 6424 | 56 | 19086 | 15.3% |
...
- candidats SANS connectivite : 19396, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13664 systemes avec CONNECTED sur 106068 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*28296 candidats sur 32586 portent les champs bruts (87%).*

- `5c556c16ea8b` — 22331 candidats
  - AVEC connectivite (9062) : resistance **41.0%**
  - SANS connectivite (13269) : resistance **21.3%**
...
- `5c556c16ea8b` — 22331 candidats
  ...
  - SANS connectivite (13269) : T0=15.90 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 103567 systemes
  - sans CONNECTED : 0.0% sur 23354 systemes
