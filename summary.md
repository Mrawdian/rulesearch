...
genere 2026-09-04 18:50 UTC — 371220 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 287876 systemes
...
- moteur actif `0caa9267db60` (327478 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 184377 | 91602 | 12547 | 6173 | 18748 | 14518 | 19537 | 18884 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 180728 | 42003 | 76361 | 75 | 25127 | 9352 | 70 | 27726 | 15.3% |
...
- candidats AVEC connectivite : 19011, dont T2 : 100%
- candidats SANS connectivite : 28036, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19811 systemes avec CONNECTED sur 152912 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*42757 candidats sur 47047 portent les champs bruts (91%).*

- `5c556c16ea8b` — 36792 candidats
  - AVEC connectivite (14883) : resistance **41.1%**
  - SANS connectivite (21909) : resistance **21.2%**
...
- `5c556c16ea8b` — 36792 candidats
  - AVEC connectivite (14883) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (21909) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 150411 systemes
  - sans CONNECTED : 0.0% sur 33966 systemes
