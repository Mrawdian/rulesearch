...
| connect | 4 | 3 | 18516 | 9243 | 1200 | 641 | 1850 | 1474 | 2011 | 1867 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 18132 | 4269 | 7641 | 13 | 2482 | 937 | 7 | 2783 | 15.3% |
...
- candidats AVEC connectivite : 1994, dont T2 : 100%
- candidats SANS connectivite : 3093, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2285 systemes avec CONNECTED sur 17614 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*797 candidats sur 5087 portent les champs bruts (16%).*
...
- `e3baecf8377b` — 533 candidats
  - AVEC connectivite (211) : resistance **42.3%**
  - SANS connectivite (322) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 533 candidats
  - AVEC connectivite (211) : T0=13.06 T1=0.00 T2=3.09 — pondere **6.17**
  - SANS connectivite (322) : T0=16.07 T1=0.00 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 2302 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 2285 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 15113 systemes
  - sans CONNECTED : 0.0% sur 3403 systemes
