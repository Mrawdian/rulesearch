...
genere 2026-09-01 05:39 UTC — 273996 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 190652 systemes
...
- moteur actif `0caa9267db60` (230254 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 135304 | 67253 | 9139 | 4531 | 13732 | 10710 | 14288 | 13900 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 132577 | 30889 | 56043 | 58 | 18374 | 6854 | 59 | 20290 | 15.3% |
...
- candidats AVEC connectivite : 14027, dont T2 : 100%
- candidats SANS connectivite : 20600, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14562 systemes avec CONNECTED sur 112884 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*30337 candidats sur 34627 portent les champs bruts (88%).*

- `5c556c16ea8b` — 24372 candidats
  - AVEC connectivite (9899) : resistance **41.0%**
  - SANS connectivite (14473) : resistance **21.3%**
...
- `5c556c16ea8b` — 24372 candidats
  - AVEC connectivite (9899) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (14473) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 14631 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14562 avec CONNECTED, 69 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 110383 systemes
  - sans CONNECTED : 0.0% sur 24921 systemes
