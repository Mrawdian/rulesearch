...
genere 2026-08-27 04:24 UTC — 80436 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 15529 systemes
...
- moteur actif `0caa9267db60` (36694 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 37559 | 18675 | 2589 | 1280 | 3732 | 2955 | 3981 | 3861 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 36762 | 8464 | 15654 | 21 | 5079 | 1919 | 20 | 5605 | 15.2% |
...
- candidats AVEC connectivite : 3988, dont T2 : 100%
- candidats SANS connectivite : 5915, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4255 systemes avec CONNECTED sur 33246 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5613 candidats sur 9903 portent les champs bruts (57%).*
...
- `ab89a63b01ef` — 1936 candidats
  - AVEC connectivite (808) : resistance **41.4%**
  - SANS connectivite (1128) : resistance **21.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1936 candidats
  - AVEC connectivite (808) : T0=13.07 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (1128) : T0=15.92 T1=0.00 T2=2.70 — pondere **5.39**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- TROP-CHER : 4285 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4255 avec CONNECTED, 30 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 30745 systemes
  - sans CONNECTED : 0.0% sur 6814 systemes
