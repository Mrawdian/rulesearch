...
genere 2026-09-10 07:00 UTC — 494492 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 411148 systemes
...
- moteur actif `0caa9267db60` (450750 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 246640 | 122442 | 16813 | 8282 | 24961 | 19351 | 26301 | 25364 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 241737 | 56370 | 101841 | 97 | 33641 | 12475 | 87 | 37205 | 15.4% |
...
- candidats AVEC connectivite : 25491, dont T2 : 100%
...
- **26575 systemes avec CONNECTED sur 203868 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*58716 candidats sur 63006 portent les champs bruts (93%).*

- `5c556c16ea8b` — 52751 candidats
  - AVEC connectivite (21363) : resistance **41.2%**
...
- `5c556c16ea8b` — 52751 candidats
  - AVEC connectivite (21363) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 26672 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 26575 avec CONNECTED, 97 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 201367 systemes
  - sans CONNECTED : 0.0% sur 45273 systemes
