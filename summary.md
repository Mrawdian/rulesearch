...
genere 2026-08-27 07:38 UTC — 87428 systemes evalues
...
- moteur actif `0caa9267db60` (43686 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 41075 | 20445 | 2815 | 1393 | 4103 | 3231 | 4339 | 4218 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 40238 | 9264 | 17102 | 22 | 5591 | 2096 | 21 | 6142 | 15.3% |
...
- candidats AVEC connectivite : 4345, dont T2 : 100%
- candidats SANS connectivite : 6452, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4613 systemes avec CONNECTED sur 36074 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6507 candidats sur 10797 portent les champs bruts (60%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 542 candidats
  - AVEC connectivite (217) : resistance **41.9%**
  - SANS connectivite (325) : resistance **20.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 542 candidats
  - AVEC connectivite (217) : T0=12.99 T1=0.00 T2=3.06 — pondere **6.11**
  - SANS connectivite (325) : T0=15.84 T1=0.00 T2=2.60 — pondere **5.20**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 33573 systemes
  - sans CONNECTED : 0.0% sur 7502 systemes
