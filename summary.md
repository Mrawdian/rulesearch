...
| connect | 4 | 3 | 6189 | 3125 | 396 | 224 | 594 | 496 | 640 | 641 | 10.4% |
| ref | 4 | 3 | 6037 | 1465 | 2515 | 1 | 806 | 299 | 2 | 949 | 15.7% |
...
- candidats SANS connectivite : 953, dont T2 : 100%
...
- **640 systemes avec CONNECTED sur 5131 (12.5%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 432 candidats
  - AVEC connectivite (165) : T0=13.26 T1=0.00 T2=2.96 — pondere **5.92**
  - SANS connectivite (267) : T0=15.95 T1=0.00 T2=2.62 — pondere **5.24**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.6% sur 5074 systemes
  - sans CONNECTED : 0.0% sur 1115 systemes
