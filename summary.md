...
genere 2026-08-30 00:22 UTC — 200888 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 117544 systemes
...
- moteur actif `0caa9267db60` (157146 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 98386 | 48855 | 6687 | 3306 | 9926 | 7832 | 10373 | 10138 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 96387 | 22493 | 40694 | 45 | 13319 | 4972 | 37 | 14821 | 15.4% |
...
- candidats AVEC connectivite : 10265, dont T2 : 100%
- candidats SANS connectivite : 15131, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10647 systemes avec CONNECTED sur 82742 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*21106 candidats sur 25396 portent les champs bruts (83%).*

- `5c556c16ea8b` — 15141 candidats
  - AVEC connectivite (6137) : resistance **41.2%**
  - SANS connectivite (9004) : resistance **21.5%**
...
- `5c556c16ea8b` — 15141 candidats
  - AVEC connectivite (6137) : T0=13.00 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (9004) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 10694 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10647 avec CONNECTED, 47 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 80241 systemes
  - sans CONNECTED : 0.0% sur 18145 systemes
