...
genere 2026-08-27 05:30 UTC — 83049 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 18142 systemes
...
- moteur actif `0caa9267db60` (39307 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 38869 | 19354 | 2670 | 1330 | 3861 | 3065 | 4099 | 3987 | 10.3% |
...
- candidats AVEC connectivite : 4114, dont T2 : 100%
- candidats SANS connectivite : 6102, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4373 systemes avec CONNECTED sur 34289 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5926 candidats sur 10216 portent les champs bruts (58%).*
...
- `ab89a63b01ef` — 2249 candidats
  - AVEC connectivite (934) : resistance **41.1%**
...
- `ab89a63b01ef` — 2249 candidats
  - AVEC connectivite (934) : T0=13.05 T1=0.00 T2=3.01 — pondere **6.02**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 31788 systemes
  - sans CONNECTED : 0.0% sur 7081 systemes
