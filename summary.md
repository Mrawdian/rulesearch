...
| connect | 4 | 3 | 17813 | 8918 | 1152 | 614 | 1763 | 1412 | 1940 | 1790 | 10.0% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 17443 | 4104 | 7367 | 12 | 2386 | 889 | 7 | 2678 | 15.4% |
...
- candidats AVEC connectivite : 1917, dont T2 : 100%
- candidats SANS connectivite : 2988, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2214 systemes avec CONNECTED sur 17056 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*615 candidats sur 4905 portent les champs bruts (13%).*
...
- `e3baecf8377b` — 351 candidats
  - AVEC connectivite (134) : resistance **43.7%**
  - SANS connectivite (217) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 351 candidats
  - AVEC connectivite (134) : T0=12.88 T1=0.00 T2=3.15 — pondere **6.30**
  - SANS connectivite (217) : T0=16.00 T1=0.00 T2=2.65 — pondere **5.29**
...
**2 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0025).
...
- TROP-CHER : 2231 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2214 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14555 systemes
  - sans CONNECTED : 0.0% sur 3258 systemes
