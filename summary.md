...
genere 2026-08-29 22:50 UTC — 198594 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 115250 systemes
...
- moteur actif `0caa9267db60` (154852 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 97220 | 48286 | 6607 | 3267 | 9808 | 7732 | 10248 | 10024 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 95259 | 22222 | 40227 | 44 | 13179 | 4900 | 37 | 14644 | 15.4% |
...
- candidats AVEC connectivite : 10151, dont T2 : 100%
- candidats SANS connectivite : 14954, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10522 systemes avec CONNECTED sur 81799 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*20815 candidats sur 25105 portent les champs bruts (83%).*

- `5c556c16ea8b` — 14850 candidats
  - AVEC connectivite (6023) : resistance **41.1%**
  - SANS connectivite (8827) : resistance **21.5%**
...
- `5c556c16ea8b` — 14850 candidats
  - AVEC connectivite (6023) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (8827) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 79298 systemes
  - sans CONNECTED : 0.0% sur 17922 systemes
