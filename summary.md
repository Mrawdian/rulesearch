...
genere 2026-08-26 14:08 UTC — 48258 systemes evalues
...
- moteur actif `0caa9267db60` (4516 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21291 | 10628 | 1414 | 732 | 2107 | 1691 | 2274 | 2175 | 10.2% |
...
- candidats AVEC connectivite : 2302, dont T2 : 100%
- candidats SANS connectivite : 3511, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2548 systemes avec CONNECTED sur 19896 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1523 candidats sur 5813 portent les champs bruts (26%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 408 candidats
  - AVEC connectivite (164) : resistance **39.8%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 408 candidats
  - AVEC connectivite (164) : T0=13.42 T1=0.00 T2=2.95 — pondere **5.89**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17395 systemes
  - sans CONNECTED : 0.0% sur 3896 systemes
