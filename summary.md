...
| connect | 4 | 3 | 18277 | 9133 | 1188 | 636 | 1818 | 1447 | 1986 | 1840 | 10.1% |
...
- candidats AVEC connectivite : 1967, dont T2 : 100%
- candidats SANS connectivite : 3054, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2260 systemes avec CONNECTED sur 17428 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*731 candidats sur 5021 portent les champs bruts (15%).*
...
- `e3baecf8377b` — 467 candidats
  - AVEC connectivite (184) : resistance **42.7%**
...
- `e3baecf8377b` — 467 candidats
  - AVEC connectivite (184) : T0=12.97 T1=0.00 T2=3.14 — pondere **6.27**
...
- TROP-CHER : 2277 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2260 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14927 systemes
  - sans CONNECTED : 0.0% sur 3350 systemes
