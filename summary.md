...
genere 2026-08-26 18:16 UTC — 57924 systemes evalues
...
- moteur actif `0caa9267db60` (14182 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `84fba70921e0`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 26178 | 13045 | 1782 | 887 | 2595 | 2067 | 2792 | 2687 | 10.3% |
...
- candidats AVEC connectivite : 2814, dont T2 : 100%
- candidats SANS connectivite : 4260, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3066 systemes avec CONNECTED sur 23905 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2784 candidats sur 7074 portent les champs bruts (39%).*
...
- `0a74109317e5` — 80 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `e80bc1b2b437` — 55 candidats
  - AVEC connectivite (29) : resistance **38.2%**
...
- `e80bc1b2b437` — 55 candidats
  - AVEC connectivite (29) : T0=12.83 T1=0.00 T2=2.55 — pondere **5.10**
  - SANS connectivite (26) : T0=15.81 T1=0.00 T2=2.42 — pondere **4.85**
  - test de permutation : **p = 0.7566** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `b71bb0907fb5` — 53 candidats
...
- TROP-CHER : 3086 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3066 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 21404 systemes
  - sans CONNECTED : 0.0% sur 4774 systemes
