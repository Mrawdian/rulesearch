...
genere 2026-09-03 15:42 UTC — 341953 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 258609 systemes
...
- moteur actif `0caa9267db60` (298211 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 169606 | 84303 | 11502 | 5681 | 17250 | 13397 | 17970 | 17340 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 166232 | 38668 | 70265 | 67 | 23063 | 8593 | 66 | 25498 | 15.3% |
...
- candidats AVEC connectivite : 17467, dont T2 : 100%
- candidats SANS connectivite : 25808, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18244 systemes avec CONNECTED sur 140877 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*38985 candidats sur 43275 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33020 candidats
  - AVEC connectivite (13339) : resistance **41.0%**
  - SANS connectivite (19681) : resistance **21.2%**
...
- `5c556c16ea8b` — 33020 candidats
  - AVEC connectivite (13339) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (19681) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.29**
...
- TROP-CHER : 18320 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18244 avec CONNECTED, 76 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 138376 systemes
  - sans CONNECTED : 0.0% sur 31230 systemes
