...
genere 2026-08-31 22:28 UTC — 264885 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 181541 systemes
...
- moteur actif `0caa9267db60` (221143 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 130712 | 64972 | 8823 | 4393 | 13249 | 10332 | 13791 | 13449 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 128058 | 29863 | 54083 | 56 | 17747 | 6628 | 57 | 19614 | 15.3% |
...
- candidats AVEC connectivite : 13576, dont T2 : 100%
- candidats SANS connectivite : 19924, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14065 systemes avec CONNECTED sur 109153 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*29210 candidats sur 33500 portent les champs bruts (87%).*

- `5c556c16ea8b` — 23245 candidats
  - AVEC connectivite (9448) : resistance **41.0%**
  - SANS connectivite (13797) : resistance **21.3%**
...
- `5c556c16ea8b` — 23245 candidats
  - AVEC connectivite (9448) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.97**
  - SANS connectivite (13797) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 106652 systemes
  - sans CONNECTED : 0.0% sur 24060 systemes
