...
genere 2026-09-04 10:53 UTC — 362821 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 279477 systemes
...
- moteur actif `0caa9267db60` (319079 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 180133 | 89517 | 12239 | 6024 | 18333 | 14195 | 19085 | 18441 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 176573 | 40999 | 74622 | 72 | 24530 | 9145 | 70 | 27121 | 15.4% |
...
- candidats AVEC connectivite : 18568, dont T2 : 100%
...
- **19359 systemes avec CONNECTED sur 149454 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*41709 candidats sur 45999 portent les champs bruts (91%).*

- `5c556c16ea8b` — 35744 candidats
  - AVEC connectivite (14440) : resistance **41.0%**
...
- `5c556c16ea8b` — 35744 candidats
  - AVEC connectivite (14440) : T0=13.03 T1=0.00 T2=2.97 — pondere **5.95**
...
- TROP-CHER : 19439 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19359 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 146953 systemes
  - sans CONNECTED : 0.0% sur 33180 systemes
