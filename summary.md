...
| connect | 4 | 3 | 5680 | 2859 | 363 | 205 | 545 | 463 | 592 | 586 | 10.3% |
| ref | 4 | 3 | 5552 | 1348 | 2317 | 1 | 740 | 270 | 2 | 874 | 15.7% |
...
- candidats AVEC connectivite : 589, dont T2 : 100%
- candidats SANS connectivite : 878, dont T2 : 100%
...
- **592 systemes avec CONNECTED sur 4706 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 302 candidats
  - AVEC connectivite (110) : T0=13.15 T1=0.00 T2=2.75 — pondere **5.51**
  - SANS connectivite (192) : T0=15.99 T1=0.00 T2=2.62 — pondere **5.24**
  - test de permutation : **p = 0.4618** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 594 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 592 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 4649 systemes
  - sans CONNECTED : 0.0% sur 1031 systemes
