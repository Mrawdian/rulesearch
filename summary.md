...
genere 2026-08-26 20:33 UTC — 63202 systemes evalues
...
- moteur actif `0caa9267db60` (19460 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 28856 | 14366 | 1974 | 966 | 2865 | 2286 | 3067 | 2968 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 28231 | 6521 | 11969 | 15 | 3919 | 1455 | 12 | 4340 | 15.4% |
...
- candidats AVEC connectivite : 3095, dont T2 : 100%
- candidats SANS connectivite : 4650, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3341 systemes avec CONNECTED sur 26113 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3455 candidats sur 7745 portent les champs bruts (45%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 586 candidats
  - AVEC connectivite (251) : resistance **39.9%**
  - SANS connectivite (335) : resistance **20.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 586 candidats
  - AVEC connectivite (251) : T0=12.77 T1=0.00 T2=2.84 — pondere **5.67**
  - SANS connectivite (335) : T0=16.21 T1=0.00 T2=2.69 — pondere **5.37**
  - test de permutation : **p = 0.2494** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
## cout
- temps total 19.5 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 3363 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3341 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23612 systemes
  - sans CONNECTED : 0.0% sur 5244 systemes
