...
genere 2026-08-26 03:31 UTC — 21063 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 12089 systemes
...
| connect | 4 | 3 | 10581 | 5327 | 694 | 366 | 1011 | 842 | 1145 | 1060 | 10.0% |
...
- candidats AVEC connectivite : 1063, dont T2 : 100%
...
- **1145 systemes avec CONNECTED sur 8740 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1494 candidats
  - AVEC connectivite (584) : T0=13.34 T1=0.00 T2=2.87 — pondere **5.73**
...
- TROP-CHER : 1149 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1145 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 8683 systemes
  - sans CONNECTED : 0.0% sur 1898 systemes
