...
genere 2026-08-28 10:17 UTC — 138757 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 55413 systemes
...
- moteur actif `0caa9267db60` (95015 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 67009 | 33296 | 4599 | 2282 | 6706 | 5345 | 7057 | 6867 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 65633 | 15174 | 27756 | 30 | 9147 | 3389 | 28 | 10106 | 15.4% |
...
- candidats AVEC connectivite : 6994, dont T2 : 100%
...
- **7331 systemes avec CONNECTED sur 57164 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*13120 candidats sur 17410 portent les champs bruts (75%).*

- `5c556c16ea8b` — 7155 candidats
  - AVEC connectivite (2866) : resistance **41.4%**
...
- `5c556c16ea8b` — 7155 candidats
  - AVEC connectivite (2866) : T0=12.99 T1=0.00 T2=3.01 — pondere **6.03**
...
- TROP-CHER : 7369 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7331 avec CONNECTED, 38 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 54663 systemes
  - sans CONNECTED : 0.0% sur 12346 systemes
