...
| connect | 4 | 3 | 17365 | 8691 | 1121 | 599 | 1721 | 1382 | 1887 | 1746 | 10.1% |
...
- candidats AVEC connectivite : 1873, dont T2 : 100%
- candidats SANS connectivite : 2910, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2161 systemes avec CONNECTED sur 16687 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*493 candidats sur 4783 portent les champs bruts (10%).*
...
- `e3baecf8377b` — 229 candidats
  - AVEC connectivite (90) : resistance **43.2%**
...
- `e3baecf8377b` — 229 candidats
  - AVEC connectivite (90) : T0=13.10 T1=0.00 T2=3.16 — pondere **6.31**
...
- TROP-CHER : 2178 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2161 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14186 systemes
  - sans CONNECTED : 0.0% sur 3179 systemes
