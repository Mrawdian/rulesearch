...
genere 2026-09-06 04:00 UTC — 404706 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 321362 systemes
...
- moteur actif `0caa9267db60` (360964 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 201292 | 99938 | 13719 | 6702 | 20425 | 15840 | 21381 | 20727 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 197299 | 45884 | 83272 | 78 | 27471 | 10186 | 73 | 30318 | 15.4% |
...
- candidats AVEC connectivite : 20854, dont T2 : 100%
- candidats SANS connectivite : 30628, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21655 systemes avec CONNECTED sur 166740 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*47192 candidats sur 51482 portent les champs bruts (92%).*

- `5c556c16ea8b` — 41227 candidats
  - AVEC connectivite (16726) : resistance **41.1%**
  - SANS connectivite (24501) : resistance **21.3%**
...
- `5c556c16ea8b` — 41227 candidats
  - AVEC connectivite (16726) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (24501) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 21738 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21655 avec CONNECTED, 83 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 164239 systemes
  - sans CONNECTED : 0.0% sur 37053 systemes
