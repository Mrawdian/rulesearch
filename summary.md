...
- moteur actif `0caa9267db60` (6987 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22549 | 11238 | 1515 | 770 | 2252 | 1784 | 2414 | 2295 | 10.2% |
...
- candidats AVEC connectivite : 2422, dont T2 : 100%
- candidats SANS connectivite : 3714, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2688 systemes avec CONNECTED sur 20906 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1846 candidats sur 6136 portent les champs bruts (30%).*
...
- `06fe04a859f1` — 731 candidats
  - AVEC connectivite (284) : resistance **41.2%**
...
- `06fe04a859f1` — 731 candidats
  - AVEC connectivite (284) : T0=13.33 T1=0.00 T2=3.03 — pondere **6.06**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18405 systemes
  - sans CONNECTED : 0.0% sur 4144 systemes
