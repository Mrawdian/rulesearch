...
genere 2026-09-08 19:40 UTC — 463810 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 380466 systemes
...
- moteur actif `0caa9267db60` (420068 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 231153 | 114820 | 15735 | 7734 | 23367 | 18106 | 24653 | 23801 | 10.3% |
...
- candidats AVEC connectivite : 23928, dont T2 : 100%
...
- **24927 systemes avec CONNECTED sur 191280 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*54780 candidats sur 59070 portent les champs bruts (93%).*

- `5c556c16ea8b` — 48815 candidats
  - AVEC connectivite (19800) : resistance **41.2%**
...
- `5c556c16ea8b` — 48815 candidats
  - AVEC connectivite (19800) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.97**
...
- TROP-CHER : 25018 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 24927 avec CONNECTED, 91 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 188779 systemes
