...
genere 2026-09-05 08:01 UTC — 384882 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 301538 systemes
...
- moteur actif `0caa9267db60` (341140 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 191269 | 94995 | 13029 | 6368 | 19447 | 15070 | 20272 | 19646 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 187498 | 43632 | 79158 | 77 | 26082 | 9700 | 70 | 28765 | 15.3% |
...
- candidats SANS connectivite : 29075, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20546 systemes avec CONNECTED sur 158536 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*44558 candidats sur 48848 portent les champs bruts (91%).*

- `5c556c16ea8b` — 38593 candidats
  - AVEC connectivite (15645) : resistance **41.1%**
  - SANS connectivite (22948) : resistance **21.3%**
...
- `5c556c16ea8b` — 38593 candidats
  ...
  - SANS connectivite (22948) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 156035 systemes
  - sans CONNECTED : 0.0% sur 35234 systemes
