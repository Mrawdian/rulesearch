...
genere 2026-08-26 17:04 UTC — 55132 systemes evalues
...
- moteur actif `0caa9267db60` (11390 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
| connect | 4 | 3 | 24774 | 12374 | 1683 | 840 | 2453 | 1950 | 2644 | 2520 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 24243 | 5609 | 10252 | 14 | 3394 | 1231 | 10 | 3733 | 15.4% |
...
- candidats AVEC connectivite : 2647, dont T2 : 100%
- candidats SANS connectivite : 4043, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2918 systemes avec CONNECTED sur 22756 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2400 candidats sur 6690 portent les champs bruts (36%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 90 candidats
  - AVEC connectivite (33) : resistance **39.8%**
  - SANS connectivite (57) : resistance **22.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `23303c299f39` — 90 candidats
  - AVEC connectivite (33) : T0=12.73 T1=0.00 T2=2.94 — pondere **5.88**
  - SANS connectivite (57) : T0=16.96 T1=0.00 T2=2.88 — pondere **5.75**
  - test de permutation : **p = 0.9020** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 2938 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2918 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 20255 systemes
  - sans CONNECTED : 0.0% sur 4519 systemes
