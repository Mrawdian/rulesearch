...
genere 2026-09-01 15:39 UTC — 286433 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 203089 systemes
...
- moteur actif `0caa9267db60` (242691 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 141572 | 70339 | 9597 | 4732 | 14382 | 11175 | 14955 | 14560 | 10.3% |
...
- candidats AVEC connectivite : 14687, dont T2 : 100%
...
- **15229 systemes avec CONNECTED sur 118009 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*31964 candidats sur 36254 portent les champs bruts (88%).*

- `5c556c16ea8b` — 25999 candidats
  - AVEC connectivite (10559) : resistance **41.0%**
...
- `5c556c16ea8b` — 25999 candidats
  - AVEC connectivite (10559) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
## cout
- temps total 88.6 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 15301 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15229 avec CONNECTED, 72 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 115508 systemes
  - sans CONNECTED : 0.0% sur 26064 systemes
