...
genere 2026-08-28 02:15 UTC — 124500 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 41156 systemes
...
- moteur actif `0caa9267db60` (80758 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 59796 | 29787 | 4130 | 2023 | 5947 | 4734 | 6268 | 6141 | 10.3% |
...
- candidats AVEC connectivite : 6268, dont T2 : 100%
- candidats SANS connectivite : 9283, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6542 systemes avec CONNECTED sur 51315 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11261 candidats sur 15551 portent les champs bruts (72%).*

- `5c556c16ea8b` — 5296 candidats
  - AVEC connectivite (2140) : resistance **41.8%**
...
- `5c556c16ea8b` — 5296 candidats
  - AVEC connectivite (2140) : T0=12.99 T1=0.00 T2=3.04 — pondere **6.08**
...
- TROP-CHER : 6578 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6542 avec CONNECTED, 36 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 48814 systemes
  - sans CONNECTED : 0.0% sur 10982 systemes
