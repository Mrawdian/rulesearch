...
genere 2026-08-26 19:17 UTC — 60366 systemes evalues
...
- moteur actif `0caa9267db60` (16624 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 26831 | 6200 | 11356 | 15 | 3738 | 1379 | 10 | 4133 | 15.4% |
...
- candidats SANS connectivite : 4443, dont T2 : 100%
...
*3090 candidats sur 7380 portent les champs bruts (42%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 221 candidats
  - AVEC connectivite (93) : resistance **39.7%**
  - SANS connectivite (128) : resistance **18.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 221 candidats
  ...
  - SANS connectivite (128) : T0=16.11 T1=0.00 T2=2.56 — pondere **5.12**
  - test de permutation : **p = 0.0900** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
