...
genere 2026-08-26 03:17 UTC — 20547 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 11573 systemes
...
| connect | 4 | 3 | 10328 | 5203 | 676 | 356 | 989 | 821 | 1111 | 1043 | 10.1% |
...
- candidats AVEC connectivite : 1046, dont T2 : 100%
...
- **1111 systemes avec CONNECTED sur 8532 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1444 candidats
  - AVEC connectivite (567) : T0=13.37 T1=0.00 T2=2.85 — pondere **5.70**
...
- TROP-CHER : 1115 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 1111 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 8475 systemes
  - sans CONNECTED : 0.0% sur 1853 systemes
