...
genere 2026-08-30 21:28 UTC — 231163 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 147819 systemes
...
- moteur actif `0caa9267db60` (187421 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 113684 | 56532 | 7725 | 3807 | 11415 | 8991 | 12035 | 11688 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 111364 | 25961 | 47060 | 52 | 15364 | 5759 | 47 | 17111 | 15.4% |
...
- candidats SANS connectivite : 17421, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12309 systemes avec CONNECTED sur 95316 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*24946 candidats sur 29236 portent les champs bruts (85%).*

- `5c556c16ea8b` — 18981 candidats
  - AVEC connectivite (7687) : resistance **41.1%**
  - SANS connectivite (11294) : resistance **21.4%**
...
- `5c556c16ea8b` — 18981 candidats
  ...
  - SANS connectivite (11294) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 12366 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 12309 avec CONNECTED, 57 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 92815 systemes
  - sans CONNECTED : 0.0% sur 20869 systemes
