...
genere 2026-09-04 17:26 UTC — 369802 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 286458 systemes
...
- moteur actif `0caa9267db60` (326060 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 183661 | 91282 | 12488 | 6139 | 18681 | 14459 | 19452 | 18803 | 10.2% |
...
- candidats AVEC connectivite : 18930, dont T2 : 100%
...
- **19726 systemes avec CONNECTED sur 152333 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*42575 candidats sur 46865 portent les champs bruts (91%).*

- `5c556c16ea8b` — 36610 candidats
  - AVEC connectivite (14802) : resistance **41.0%**
...
- `5c556c16ea8b` — 36610 candidats
  - AVEC connectivite (14802) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.95**
...
- TROP-CHER : 19806 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19726 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 149832 systemes
  - sans CONNECTED : 0.0% sur 33829 systemes
