...
genere 2026-08-29 11:38 UTC — 181436 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 98092 systemes
...
- moteur actif `0caa9267db60` (137694 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 88548 | 44013 | 6020 | 2995 | 8904 | 7069 | 9306 | 9114 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 86773 | 20268 | 36661 | 42 | 11985 | 4439 | 35 | 13337 | 15.4% |
...
- candidats AVEC connectivite : 9241, dont T2 : 100%
- candidats SANS connectivite : 13647, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9580 systemes avec CONNECTED sur 74728 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*18598 candidats sur 22888 portent les champs bruts (81%).*

- `5c556c16ea8b` — 12633 candidats
  - AVEC connectivite (5113) : resistance **41.2%**
  - SANS connectivite (7520) : resistance **21.5%**
...
- `5c556c16ea8b` — 12633 candidats
  - AVEC connectivite (5113) : T0=12.99 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (7520) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 9625 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 9580 avec CONNECTED, 45 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 72227 systemes
  - sans CONNECTED : 0.0% sur 16321 systemes
