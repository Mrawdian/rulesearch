...
genere 2026-08-25 20:31 UTC — 3167 systemes evalues

## versions du DSL presentes
- `615abe43d6bc` : 2190 systemes
...
| connect | 4 | 3 | 1552 | 779 | 109 | 58 | 164 | 121 | 150 | 154 | 9.9% |
...
- candidats AVEC connectivite : 157, dont T2 : 100%
- candidats SANS connectivite : 236, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **150 systemes avec CONNECTED sur 1322 (11.3%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- TROP-CHER : 151 systemes abandonnes (4.8% des systemes), 95% du temps total
  dont 150 avec CONNECTED, 1 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 11.9% sur 1265 systemes
  - sans CONNECTED : 0.0% sur 287 systemes
