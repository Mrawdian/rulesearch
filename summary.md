...
genere 2026-08-27 06:32 UTC — 85075 systemes evalues
...
- moteur actif `0caa9267db60` (41333 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 39899 | 19873 | 2732 | 1357 | 3972 | 3137 | 4218 | 4094 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 39061 | 8995 | 16622 | 22 | 5416 | 2038 | 21 | 5947 | 15.2% |
...
- candidats AVEC connectivite : 4221, dont T2 : 100%
- candidats SANS connectivite : 6257, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4492 systemes avec CONNECTED sur 35130 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6188 candidats sur 10478 portent les champs bruts (59%).*
...
- `23303c299f39` — 225 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 223 candidats
  - AVEC connectivite (93) : resistance **43.2%**
  - SANS connectivite (130) : resistance **22.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 223 candidats
  - AVEC connectivite (93) : T0=12.72 T1=0.00 T2=3.15 — pondere **6.30**
  - SANS connectivite (130) : T0=16.01 T1=0.00 T2=2.70 — pondere **5.40**
...
**7 serie(s) reproductible(s) sur 14 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `ab89a63b01ef` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0060), `5c556c16ea8b` (p=0.0335), `b71bb0907fb5` (p=0.0110).
...
- TROP-CHER : 4523 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4492 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 32629 systemes
  - sans CONNECTED : 0.0% sur 7270 systemes
