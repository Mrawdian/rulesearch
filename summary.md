...
genere 2026-08-26 21:37 UTC — 65498 systemes evalues
...
- `ab89a63b01ef` : 591 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (21756 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
**8117 enregistrements (12%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 30009 | 14910 | 2050 | 1010 | 3006 | 2376 | 3198 | 3079 | 10.3% |
...
- candidats AVEC connectivite : 3206, dont T2 : 100%
- candidats SANS connectivite : 4822, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3472 systemes avec CONNECTED sur 27032 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3738 candidats sur 8028 portent les champs bruts (47%).*
...
- `e80bc1b2b437` — 75 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 61 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (26) : resistance **43.2%**
...
- `ab89a63b01ef` — 61 candidats
  - AVEC connectivite (26) : T0=14.42 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (35) : T0=16.34 T1=0.00 T2=2.89 — pondere **5.77**
  - test de permutation : **p = 0.8096** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `0a74109317e5` — 80 candidats
...
- TROP-CHER : 3494 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3472 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24531 systemes
  - sans CONNECTED : 0.0% sur 5478 systemes
