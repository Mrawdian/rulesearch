...
genere 2026-08-30 16:28 UTC — 224295 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 140951 systemes
...
- moteur actif `0caa9267db60` (180553 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 110209 | 54775 | 7487 | 3684 | 11108 | 8733 | 11645 | 11338 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 107971 | 25162 | 45600 | 50 | 14916 | 5575 | 44 | 16614 | 15.4% |
...
- candidats SANS connectivite : 16924, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11919 systemes avec CONNECTED sur 92433 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*24099 candidats sur 28389 portent les champs bruts (85%).*

- `5c556c16ea8b` — 18134 candidats
  - AVEC connectivite (7337) : resistance **41.0%**
  - SANS connectivite (10797) : resistance **21.5%**
...
- `5c556c16ea8b` — 18134 candidats
  ...
  - SANS connectivite (10797) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 11973 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11919 avec CONNECTED, 54 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 89932 systemes
