...
genere 2026-09-05 10:38 UTC — 387463 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 304119 systemes
...
- moteur actif `0caa9267db60` (343721 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 192588 | 95640 | 13116 | 6409 | 19589 | 15156 | 20426 | 19789 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 188760 | 43940 | 79672 | 77 | 26266 | 9763 | 70 | 28958 | 15.3% |
...
- candidats AVEC connectivite : 19916, dont T2 : 100%
- candidats SANS connectivite : 29268, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20700 systemes avec CONNECTED sur 159607 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*44894 candidats sur 49184 portent les champs bruts (91%).*

- `5c556c16ea8b` — 38929 candidats
  - AVEC connectivite (15788) : resistance **41.1%**
  - SANS connectivite (23141) : resistance **21.3%**
...
- `5c556c16ea8b` — 38929 candidats
  - AVEC connectivite (15788) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (23141) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 20780 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 20700 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 157106 systemes
  - sans CONNECTED : 0.0% sur 35482 systemes
