...
genere 2026-09-05 12:22 UTC — 389147 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 305803 systemes
...
- moteur actif `0caa9267db60` (345405 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 193435 | 96059 | 13169 | 6445 | 19673 | 15222 | 20528 | 19870 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 189597 | 44135 | 80017 | 77 | 26381 | 9814 | 71 | 29088 | 15.3% |
...
- candidats AVEC connectivite : 19997, dont T2 : 100%
- candidats SANS connectivite : 29398, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20802 systemes avec CONNECTED sur 160291 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*45105 candidats sur 49395 portent les champs bruts (91%).*

- `5c556c16ea8b` — 39140 candidats
  - AVEC connectivite (15869) : resistance **41.1%**
  - SANS connectivite (23271) : resistance **21.3%**
...
- `5c556c16ea8b` — 39140 candidats
  - AVEC connectivite (15869) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (23271) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 157790 systemes
  - sans CONNECTED : 0.0% sur 35645 systemes
