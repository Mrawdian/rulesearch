...
genere 2026-08-26 19:22 UTC — 60585 systemes evalues
...
- moteur actif `0caa9267db60` (16843 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27525 | 13727 | 1877 | 930 | 2718 | 2181 | 2925 | 2821 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 26945 | 6228 | 11397 | 15 | 3755 | 1387 | 10 | 4153 | 15.4% |
...
- candidats AVEC connectivite : 2948, dont T2 : 100%
- candidats SANS connectivite : 4463, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3199 systemes avec CONNECTED sur 25027 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3121 candidats sur 7411 portent les champs bruts (42%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 252 candidats
  - AVEC connectivite (104) : resistance **39.1%**
  - SANS connectivite (148) : resistance **18.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 252 candidats
  - AVEC connectivite (104) : T0=13.12 T1=0.00 T2=2.89 — pondere **5.79**
  - SANS connectivite (148) : T0=16.05 T1=0.00 T2=2.59 — pondere **5.18**
...
- TROP-CHER : 3219 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3199 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22526 systemes
  - sans CONNECTED : 0.0% sur 4999 systemes
