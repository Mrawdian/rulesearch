...
| connect | 4 | 3 | 18322 | 9155 | 1192 | 637 | 1824 | 1452 | 1988 | 1845 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 17940 | 4225 | 7564 | 12 | 2457 | 923 | 7 | 2752 | 15.3% |
...
- candidats SANS connectivite : 3062, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2262 systemes avec CONNECTED sur 17463 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*744 candidats sur 5034 portent les champs bruts (15%).*
...
- `e3baecf8377b` — 480 candidats
  - AVEC connectivite (189) : resistance **42.8%**
  - SANS connectivite (291) : resistance **20.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 480 candidats
  ...
  - SANS connectivite (291) : T0=16.11 T1=0.00 T2=2.65 — pondere **5.29**
...
- TROP-CHER : 2279 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2262 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14962 systemes
  - sans CONNECTED : 0.0% sur 3360 systemes
