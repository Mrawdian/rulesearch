...
genere 2026-09-05 15:02 UTC — 391902 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 308558 systemes
...
- moteur actif `0caa9267db60` (348160 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 194825 | 96756 | 13260 | 6489 | 19813 | 15330 | 20668 | 20031 | 10.3% |
...
- candidats AVEC connectivite : 20158, dont T2 : 100%
...
- **20942 systemes avec CONNECTED sur 161427 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*45475 candidats sur 49765 portent les champs bruts (91%).*

- `5c556c16ea8b` — 39510 candidats
  - AVEC connectivite (16030) : resistance **41.0%**
...
- `5c556c16ea8b` — 39510 candidats
  - AVEC connectivite (16030) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.94**
...
- TROP-CHER : 21023 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 20942 avec CONNECTED, 81 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 158926 systemes
  - sans CONNECTED : 0.0% sur 35899 systemes
