...
**7466 enregistrements (57%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 6531 | 3284 | 422 | 235 | 629 | 528 | 680 | 678 | 10.4% |
| ref | 4 | 3 | 6370 | 1549 | 2636 | 1 | 853 | 315 | 2 | 1014 | 15.9% |
...
- candidats AVEC connectivite : 681, dont T2 : 100%
- candidats SANS connectivite : 1018, dont T2 : 100%
...
- **680 systemes avec CONNECTED sur 5406 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 534 candidats
  - AVEC connectivite (202) : T0=13.19 T1=0.00 T2=2.94 — pondere **5.87**
  - SANS connectivite (332) : T0=15.81 T1=0.00 T2=2.64 — pondere **5.28**
...
- TROP-CHER : 682 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 680 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 5349 systemes
  - sans CONNECTED : 0.0% sur 1182 systemes
