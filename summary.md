...
genere 2026-08-27 21:49 UTC — 115615 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 32271 systemes
...
- moteur actif `0caa9267db60` (71873 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 55307 | 27544 | 3830 | 1877 | 5473 | 4379 | 5846 | 5643 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 54193 | 12506 | 23014 | 26 | 7513 | 2810 | 25 | 8297 | 15.3% |
...
- candidats AVEC connectivite : 5770, dont T2 : 100%
- candidats SANS connectivite : 8607, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6120 systemes avec CONNECTED sur 47682 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10087 candidats sur 14377 portent les champs bruts (70%).*

- `5c556c16ea8b` — 4122 candidats
  - AVEC connectivite (1642) : resistance **42.0%**
...
- `5c556c16ea8b` — 4122 candidats
  - AVEC connectivite (1642) : T0=12.93 T1=0.00 T2=3.06 — pondere **6.11**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 45181 systemes
  - sans CONNECTED : 0.0% sur 10126 systemes
