...
genere 2026-08-26 17:37 UTC — 56374 systemes evalues
...
- `b71bb0907fb5` : 74 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (12632 systemes) : `06fe04a859f1`, `23303c299f39`, `b71bb0907fb5`, `e40600351a72`, `e8a1f930f7b9`
...
**7540 enregistrements (13%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 25400 | 12679 | 1729 | 855 | 2517 | 2004 | 2712 | 2592 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 24859 | 5744 | 10522 | 15 | 3475 | 1261 | 10 | 3832 | 15.4% |
...
- candidats AVEC connectivite : 2719, dont T2 : 100%
- candidats SANS connectivite : 4142, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2986 systemes avec CONNECTED sur 23266 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2571 candidats sur 6861 portent les champs bruts (37%).*
...
## cout
- temps total 17.5 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 3006 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2986 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 20765 systemes
  - sans CONNECTED : 0.0% sur 4635 systemes
