...
genere 2026-08-26 21:44 UTC — 65824 systemes evalues
...
- moteur actif `0caa9267db60` (22082 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 30173 | 14991 | 2062 | 1015 | 3019 | 2394 | 3211 | 3100 | 10.3% |
...
- candidats AVEC connectivite : 3227, dont T2 : 100%
- candidats SANS connectivite : 4841, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3485 systemes avec CONNECTED sur 27167 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3778 candidats sur 8068 portent les champs bruts (47%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 101 candidats
  - AVEC connectivite (47) : resistance **45.3%**
...
- `ab89a63b01ef` — 101 candidats
  - AVEC connectivite (47) : T0=13.87 T1=0.00 T2=3.21 — pondere **6.43**
  - SANS connectivite (54) : T0=15.98 T1=0.00 T2=3.00 — pondere **6.00**
  - test de permutation : **p = 0.5502** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 3507 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3485 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24666 systemes
  - sans CONNECTED : 0.0% sur 5507 systemes
