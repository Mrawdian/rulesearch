...
genere 2026-08-29 00:51 UTC — 163963 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 80619 systemes
...
- moteur actif `0caa9267db60` (120221 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 79726 | 39663 | 5426 | 2707 | 7970 | 6347 | 8378 | 8223 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 78122 | 18157 | 33057 | 36 | 10795 | 3986 | 32 | 12054 | 15.4% |
...
- candidats AVEC connectivite : 8350, dont T2 : 100%
...
- **8652 systemes avec CONNECTED sur 67546 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*16424 candidats sur 20714 portent les champs bruts (79%).*

- `5c556c16ea8b` — 10459 candidats
  - AVEC connectivite (4222) : resistance **41.1%**
...
- `5c556c16ea8b` — 10459 candidats
  - AVEC connectivite (4222) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.98**
...
- TROP-CHER : 8694 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8652 avec CONNECTED, 42 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 65045 systemes
  - sans CONNECTED : 0.0% sur 14681 systemes
