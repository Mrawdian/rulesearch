...
genere 2026-08-31 22:37 UTC — 265110 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 181766 systemes
...
- moteur actif `0caa9267db60` (221368 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 130817 | 65032 | 8828 | 4400 | 13254 | 10336 | 13798 | 13466 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 128178 | 29888 | 54138 | 56 | 17760 | 6635 | 57 | 19634 | 15.3% |
...
- candidats AVEC connectivite : 13593, dont T2 : 100%
- candidats SANS connectivite : 19944, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14072 systemes avec CONNECTED sur 109249 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*29247 candidats sur 33537 portent les champs bruts (87%).*

- `5c556c16ea8b` — 23282 candidats
  - AVEC connectivite (9465) : resistance **41.0%**
  - SANS connectivite (13817) : resistance **21.3%**
...
- `5c556c16ea8b` — 23282 candidats
  - AVEC connectivite (9465) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.97**
  - SANS connectivite (13817) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 14139 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14072 avec CONNECTED, 67 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 106748 systemes
  - sans CONNECTED : 0.0% sur 24069 systemes
