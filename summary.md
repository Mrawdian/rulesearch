...
genere 2026-09-07 05:49 UTC — 429502 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 346158 systemes
...
- moteur actif `0caa9267db60` (385760 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 213819 | 106169 | 14560 | 7127 | 21672 | 16800 | 22732 | 22035 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 209568 | 48787 | 88353 | 81 | 29214 | 10822 | 75 | 32218 | 15.4% |
...
- candidats AVEC connectivite : 22162, dont T2 : 100%
- candidats SANS connectivite : 32528, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23006 systemes avec CONNECTED sur 177014 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*50400 candidats sur 54690 portent les champs bruts (92%).*

- `5c556c16ea8b` — 44435 candidats
  - AVEC connectivite (18034) : resistance **41.1%**
  - SANS connectivite (26401) : resistance **21.3%**
...
- `5c556c16ea8b` — 44435 candidats
  - AVEC connectivite (18034) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (26401) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 23091 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23006 avec CONNECTED, 85 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 174513 systemes
  - sans CONNECTED : 0.0% sur 39306 systemes
