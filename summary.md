...
genere 2026-08-31 13:12 UTC — 252747 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 169403 systemes
...
- moteur actif `0caa9267db60` (209005 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 124574 | 61949 | 8441 | 4170 | 12575 | 9834 | 13152 | 12820 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 122058 | 28481 | 51518 | 54 | 16894 | 6312 | 56 | 18733 | 15.3% |
...
- candidats AVEC connectivite : 12947, dont T2 : 100%
...
- **13426 systemes avec CONNECTED sur 104157 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*27700 candidats sur 31990 portent les champs bruts (87%).*

- `5c556c16ea8b` — 21735 candidats
  - AVEC connectivite (8819) : resistance **41.0%**
...
- `5c556c16ea8b` — 21735 candidats
  - AVEC connectivite (8819) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 13492 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13426 avec CONNECTED, 66 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 101656 systemes
  - sans CONNECTED : 0.0% sur 22918 systemes
