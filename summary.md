...
genere 2026-08-26 21:58 UTC — 66301 systemes evalues
...
- moteur actif `0caa9267db60` (22559 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 29773 | 6866 | 12654 | 16 | 4113 | 1537 | 13 | 4574 | 15.4% |
...
- candidats SANS connectivite : 4884, dont T2 : 100%
...
*3844 candidats sur 8134 portent les champs bruts (47%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 167 candidats
  - AVEC connectivite (70) : resistance **44.9%**
  - SANS connectivite (97) : resistance **23.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 167 candidats
  ...
  - SANS connectivite (97) : T0=15.91 T1=0.00 T2=2.88 — pondere **5.75**
  - test de permutation : **p = 0.3083** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
