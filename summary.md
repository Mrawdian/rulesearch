...
genere 2026-08-28 04:53 UTC — 129213 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 45869 systemes
...
- moteur actif `0caa9267db60` (85471 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 62186 | 30934 | 4288 | 2104 | 6203 | 4937 | 6530 | 6388 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 60912 | 14095 | 25785 | 28 | 8470 | 3154 | 27 | 9351 | 15.4% |
...
- candidats AVEC connectivite : 6515, dont T2 : 100%
- candidats SANS connectivite : 9661, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6804 systemes avec CONNECTED sur 53254 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11886 candidats sur 16176 portent les champs bruts (73%).*

- `5c556c16ea8b` — 5921 candidats
  - AVEC connectivite (2387) : resistance **41.7%**
  - SANS connectivite (3534) : resistance **22.0%**
...
- `5c556c16ea8b` — 5921 candidats
  - AVEC connectivite (2387) : T0=12.99 T1=0.00 T2=3.03 — pondere **6.07**
  - SANS connectivite (3534) : T0=15.86 T1=0.00 T2=2.69 — pondere **5.39**
...
- TROP-CHER : 6841 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6804 avec CONNECTED, 37 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 50753 systemes
  - sans CONNECTED : 0.0% sur 11433 systemes
