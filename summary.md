...
genere 2026-09-05 15:43 UTC — 392585 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 309241 systemes
...
- moteur actif `0caa9267db60` (348843 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 195169 | 96920 | 13286 | 6505 | 19852 | 15356 | 20706 | 20063 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 191301 | 44537 | 80715 | 78 | 26639 | 9889 | 71 | 29358 | 15.3% |
...
- candidats SANS connectivite : 29668, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20980 systemes avec CONNECTED sur 161704 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*45568 candidats sur 49858 portent les champs bruts (91%).*

- `5c556c16ea8b` — 39603 candidats
  - AVEC connectivite (16062) : resistance **41.0%**
  - SANS connectivite (23541) : resistance **21.3%**
...
- `5c556c16ea8b` — 39603 candidats
  ...
  - SANS connectivite (23541) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 21061 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 20980 avec CONNECTED, 81 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 159203 systemes
  - sans CONNECTED : 0.0% sur 35966 systemes
