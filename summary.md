...
genere 2026-08-31 23:47 UTC — 266576 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 183232 systemes
...
- moteur actif `0caa9267db60` (222834 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 131564 | 65396 | 8883 | 4422 | 13333 | 10398 | 13884 | 13538 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 128897 | 30042 | 54456 | 56 | 17851 | 6675 | 57 | 19750 | 15.3% |
...
- candidats AVEC connectivite : 13665, dont T2 : 100%
- candidats SANS connectivite : 20060, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14158 systemes avec CONNECTED sur 109854 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*29435 candidats sur 33725 portent les champs bruts (87%).*

- `5c556c16ea8b` — 23470 candidats
  - AVEC connectivite (9537) : resistance **41.0%**
  - SANS connectivite (13933) : resistance **21.3%**
...
- `5c556c16ea8b` — 23470 candidats
  - AVEC connectivite (9537) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (13933) : T0=15.93 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 14225 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14158 avec CONNECTED, 67 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 107353 systemes
  - sans CONNECTED : 0.0% sur 24211 systemes
