...
genere 2026-09-06 17:43 UTC — 417968 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 334624 systemes
...
- moteur actif `0caa9267db60` (374226 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 207981 | 103255 | 14167 | 6920 | 21079 | 16377 | 22113 | 21430 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 203872 | 47416 | 86003 | 80 | 28433 | 10517 | 73 | 31333 | 15.4% |
...
- candidats AVEC connectivite : 21557, dont T2 : 100%
...
- **22387 systemes avec CONNECTED sur 172206 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*48910 candidats sur 53200 portent les champs bruts (92%).*

- `5c556c16ea8b` — 42945 candidats
  - AVEC connectivite (17429) : resistance **41.1%**
...
- `5c556c16ea8b` — 42945 candidats
  - AVEC connectivite (17429) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 22470 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 22387 avec CONNECTED, 83 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 169705 systemes
  - sans CONNECTED : 0.0% sur 38276 systemes
