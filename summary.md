...
genere 2026-08-27 05:34 UTC — 83181 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 18274 systemes
...
- moteur actif `0caa9267db60` (39439 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 38944 | 19395 | 2678 | 1333 | 3868 | 3067 | 4106 | 3993 | 10.3% |
...
- candidats AVEC connectivite : 4120, dont T2 : 100%
- candidats SANS connectivite : 6112, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4380 systemes avec CONNECTED sur 34356 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5942 candidats sur 10232 portent les champs bruts (58%).*
...
- `ab89a63b01ef` — 2265 candidats
  - AVEC connectivite (940) : resistance **41.1%**
...
- `ab89a63b01ef` — 2265 candidats
  - AVEC connectivite (940) : T0=13.04 T1=0.00 T2=3.01 — pondere **6.02**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 31855 systemes
  - sans CONNECTED : 0.0% sur 7089 systemes
