...
genere 2026-08-26 13:02 UTC — 45407 systemes evalues
...
- moteur actif `0caa9267db60` (1665 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 19860 | 9916 | 1295 | 686 | 1993 | 1568 | 2136 | 2020 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 19432 | 4560 | 8207 | 13 | 2674 | 1003 | 7 | 2968 | 15.3% |
...
- candidats AVEC connectivite : 2147, dont T2 : 100%
- candidats SANS connectivite : 3278, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2410 systemes avec CONNECTED sur 18717 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1135 candidats sur 5425 portent les champs bruts (21%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 20 candidats
  - AVEC connectivite (9) : resistance **37.5%**
  - SANS connectivite (11) : resistance **21.4%**
...
- `06fe04a859f1` — 20 candidats
  - AVEC connectivite (9) : T0=14.44 T1=0.00 T2=2.44 — pondere **4.89**
  - SANS connectivite (11) : T0=17.64 T1=0.00 T2=2.73 — pondere **5.45**
  - *groupes trop petits (< 20) — aucun test, aucune conclusion*
...
- TROP-CHER : 2427 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2410 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 16216 systemes
  - sans CONNECTED : 0.0% sur 3644 systemes
