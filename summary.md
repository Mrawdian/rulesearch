...
genere 2026-08-26 05:58 UTC — 27140 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 18166 systemes
...
| d4 | 4 | 4 | 402 | 187 | 98 | 0 | 28 | 30 | 20 | 27 | 6.7% |
...
- candidats AVEC connectivite : 1368, dont T2 : 100%
- candidats SANS connectivite : 2045, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1482 systemes avec CONNECTED sur 11237 (13.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2248 candidats
  - AVEC connectivite (889) : T0=13.23 T1=0.00 T2=2.87 — pondere **5.73**
...
- TROP-CHER : 1488 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1482 avec CONNECTED, 6 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
