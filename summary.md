...
genere 2026-09-07 14:05 UTC — 437214 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 353870 systemes
...
- moteur actif `0caa9267db60` (393472 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 217721 | 108174 | 14841 | 7244 | 22037 | 17077 | 23153 | 22433 | 10.3% |
...
- candidats AVEC connectivite : 22560, dont T2 : 100%
...
- **23427 systemes avec CONNECTED sur 180248 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*51385 candidats sur 55675 portent les champs bruts (92%).*

- `5c556c16ea8b` — 45420 candidats
  - AVEC connectivite (18432) : resistance **41.1%**
...
- `5c556c16ea8b` — 45420 candidats
  - AVEC connectivite (18432) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 23514 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23427 avec CONNECTED, 87 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 177747 systemes
  - sans CONNECTED : 0.0% sur 39974 systemes
