...
genere 2026-09-04 09:07 UTC — 360918 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 277574 systemes
...
- moteur actif `0caa9267db60` (317176 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 179179 | 89051 | 12174 | 5990 | 18236 | 14112 | 18985 | 18347 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 175624 | 40801 | 74202 | 72 | 24380 | 9103 | 70 | 26982 | 15.4% |
...
- candidats AVEC connectivite : 18474, dont T2 : 100%
- candidats SANS connectivite : 27292, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19259 systemes avec CONNECTED sur 148691 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*41476 candidats sur 45766 portent les champs bruts (91%).*

- `5c556c16ea8b` — 35511 candidats
  - AVEC connectivite (14346) : resistance **41.1%**
  - SANS connectivite (21165) : resistance **21.3%**
...
- `5c556c16ea8b` — 35511 candidats
  - AVEC connectivite (14346) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (21165) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 19339 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19259 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 146190 systemes
  - sans CONNECTED : 0.0% sur 32989 systemes
