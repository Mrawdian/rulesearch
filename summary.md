...
genere 2026-08-26 19:58 UTC — 61854 systemes evalues
...
- moteur actif `0caa9267db60` (18112 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 28168 | 14029 | 1925 | 948 | 2791 | 2231 | 2998 | 2893 | 10.3% |
...
- candidats AVEC connectivite : 3020, dont T2 : 100%
- candidats SANS connectivite : 4555, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3272 systemes avec CONNECTED sur 25551 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3285 candidats sur 7575 portent les champs bruts (43%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 416 candidats
  - AVEC connectivite (176) : resistance **39.1%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 416 candidats
  - AVEC connectivite (176) : T0=12.89 T1=0.00 T2=2.82 — pondere **5.64**
  - SANS connectivite (240) : T0=16.11 T1=0.00 T2=2.60 — pondere **5.19**
  - test de permutation : **p = 0.1319** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23050 systemes
  - sans CONNECTED : 0.0% sur 5118 systemes
