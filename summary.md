...
genere 2026-09-07 22:53 UTC — 445216 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 361872 systemes
...
- moteur actif `0caa9267db60` (401474 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 221757 | 110150 | 15125 | 7405 | 22439 | 17362 | 23607 | 22844 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 217344 | 50630 | 91597 | 85 | 30294 | 11242 | 77 | 33401 | 15.4% |
...
- candidats AVEC connectivite : 22971, dont T2 : 100%
- candidats SANS connectivite : 33711, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23881 systemes avec CONNECTED sur 183590 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*52392 candidats sur 56682 portent les champs bruts (92%).*

- `5c556c16ea8b` — 46427 candidats
  - AVEC connectivite (18843) : resistance **41.2%**
  - SANS connectivite (27584) : resistance **21.3%**
...
- `5c556c16ea8b` — 46427 candidats
  - AVEC connectivite (18843) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (27584) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 181089 systemes
  - sans CONNECTED : 0.0% sur 40668 systemes
