...
genere 2026-09-06 00:01 UTC — 400864 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 317520 systemes
...
- moteur actif `0caa9267db60` (357122 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 199350 | 98967 | 13579 | 6644 | 20245 | 15696 | 21156 | 20525 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 195399 | 45458 | 82436 | 78 | 27228 | 10090 | 72 | 30020 | 15.4% |
...
- candidats AVEC connectivite : 20652, dont T2 : 100%
- candidats SANS connectivite : 30330, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21430 systemes avec CONNECTED sur 165140 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*46692 candidats sur 50982 portent les champs bruts (92%).*

- `5c556c16ea8b` — 40727 candidats
  - AVEC connectivite (16524) : resistance **41.0%**
  - SANS connectivite (24203) : resistance **21.3%**
...
- `5c556c16ea8b` — 40727 candidats
  - AVEC connectivite (16524) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.94**
  - SANS connectivite (24203) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 21512 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21430 avec CONNECTED, 82 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 162639 systemes
  - sans CONNECTED : 0.0% sur 36711 systemes
