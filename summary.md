...
genere 2026-08-26 10:26 UTC — 38800 systemes evalues
...
- `e3baecf8377b` : 207 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
- `6680f7b47e6f` : 124 systemes

Les lignes de dsl_hash differents ne sont pas comparables entre elles.

**7673 enregistrements (20%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 16512 | 8241 | 1068 | 567 | 1640 | 1320 | 1801 | 1666 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 16173 | 3802 | 6849 | 11 | 2212 | 815 | 7 | 2477 | 15.3% |
...
- candidats AVEC connectivite : 1793, dont T2 : 100%
- candidats SANS connectivite : 2787, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2075 systemes avec CONNECTED sur 15995 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*290 candidats sur 4580 portent les champs bruts (6%).*
...
- `e3baecf8377b` — 26 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (10) : resistance **34.9%**
...
- `e3baecf8377b` — 26 candidats
  - AVEC connectivite (10) : T0=14.00 T1=0.00 T2=2.90 — pondere **5.80**
  - SANS connectivite (16) : T0=15.62 T1=0.00 T2=2.12 — pondere **4.25**
  - *groupes trop petits (< 20) — aucun test, aucune conclusion*
...
- TROP-CHER : 2092 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2075 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 13494 systemes
  - sans CONNECTED : 0.0% sur 3018 systemes
