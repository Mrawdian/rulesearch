...
genere 2026-08-26 17:43 UTC — 56565 systemes evalues
...
- moteur actif `0caa9267db60` (12823 systemes) : `06fe04a859f1`, `23303c299f39`, `b71bb0907fb5`, `e40600351a72`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 25490 | 12720 | 1733 | 858 | 2525 | 2010 | 2726 | 2604 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 24960 | 5764 | 10567 | 15 | 3494 | 1265 | 10 | 3845 | 15.4% |
...
- candidats AVEC connectivite : 2731, dont T2 : 100%
- candidats SANS connectivite : 4155, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3000 systemes avec CONNECTED sur 23343 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2596 candidats sur 6886 portent les champs bruts (38%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `b71bb0907fb5` — 33 candidats
  - AVEC connectivite (15) : resistance **42.4%**
  - SANS connectivite (18) : resistance **15.3%**
...
- `b71bb0907fb5` — 33 candidats
  - AVEC connectivite (15) : T0=12.93 T1=0.00 T2=3.27 — pondere **6.53**
  - SANS connectivite (18) : T0=16.17 T1=0.00 T2=2.11 — pondere **4.22**
  - *groupes trop petits (< 20) — aucun test, aucune conclusion*
- `e8a1f930f7b9` — 28 candidats
...
- TROP-CHER : 3020 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3000 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 20842 systemes
  - sans CONNECTED : 0.0% sur 4648 systemes
