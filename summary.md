...
genere 2026-08-28 03:05 UTC — 126081 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 42737 systemes
...
- moteur actif `0caa9267db60` (82339 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 60603 | 30160 | 4186 | 2050 | 6040 | 4811 | 6351 | 6227 | 10.3% |
...
- candidats AVEC connectivite : 6354, dont T2 : 100%
- candidats SANS connectivite : 9395, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6625 systemes avec CONNECTED sur 51956 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11459 candidats sur 15749 portent les champs bruts (73%).*

- `5c556c16ea8b` — 5494 candidats
  - AVEC connectivite (2226) : resistance **41.9%**
...
- `5c556c16ea8b` — 5494 candidats
  - AVEC connectivite (2226) : T0=12.98 T1=0.00 T2=3.04 — pondere **6.08**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 49455 systemes
  - sans CONNECTED : 0.0% sur 11148 systemes
