...
genere 2026-08-27 06:39 UTC — 85414 systemes evalues
...
- moteur actif `0caa9267db60` (41672 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 40062 | 19955 | 2743 | 1362 | 3992 | 3148 | 4228 | 4117 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 39237 | 9031 | 16698 | 22 | 5438 | 2048 | 21 | 5979 | 15.2% |
...
- candidats AVEC connectivite : 4244, dont T2 : 100%
- candidats SANS connectivite : 6289, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4502 systemes avec CONNECTED sur 35264 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6243 candidats sur 10533 portent les champs bruts (59%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 278 candidats
  - AVEC connectivite (116) : resistance **41.7%**
  - SANS connectivite (162) : resistance **22.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 278 candidats
  - AVEC connectivite (116) : T0=12.97 T1=0.00 T2=3.04 — pondere **6.09**
  - SANS connectivite (162) : T0=15.82 T1=0.00 T2=2.70 — pondere **5.41**
  - test de permutation : **p = 0.0740** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 32763 systemes
  - sans CONNECTED : 0.0% sur 7299 systemes
