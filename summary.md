...
genere 2026-08-27 15:33 UTC — 103612 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 20268 systemes
...
- moteur actif `0caa9267db60` (59870 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 49244 | 24525 | 3405 | 1686 | 4891 | 3899 | 5191 | 5010 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 48253 | 11159 | 20490 | 25 | 6678 | 2519 | 23 | 7358 | 15.2% |
...
- candidats AVEC connectivite : 5137, dont T2 : 100%
- candidats SANS connectivite : 7668, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5465 systemes avec CONNECTED sur 42734 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*8515 candidats sur 12805 portent les champs bruts (66%).*
...
- `5c556c16ea8b` — 2550 candidats
  - AVEC connectivite (1009) : resistance **41.8%**
  - SANS connectivite (1541) : resistance **22.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 2550 candidats
  - AVEC connectivite (1009) : T0=13.02 T1=0.00 T2=3.05 — pondere **6.09**
  - SANS connectivite (1541) : T0=15.77 T1=0.00 T2=2.67 — pondere **5.35**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 2280 candidats
...
- TROP-CHER : 5498 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 5465 avec CONNECTED, 33 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 40233 systemes
  - sans CONNECTED : 0.0% sur 9011 systemes
