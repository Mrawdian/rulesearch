...
genere 2026-08-27 21:46 UTC — 115528 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 32184 systemes
...
- moteur actif `0caa9267db60` (71786 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 55262 | 27521 | 3828 | 1875 | 5465 | 4378 | 5841 | 5639 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 54151 | 12497 | 22989 | 26 | 7508 | 2808 | 25 | 8296 | 15.3% |
...
- candidats AVEC connectivite : 5766, dont T2 : 100%
- candidats SANS connectivite : 8606, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6115 systemes avec CONNECTED sur 47645 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10082 candidats sur 14372 portent les champs bruts (70%).*

- `5c556c16ea8b` — 4117 candidats
  - AVEC connectivite (1638) : resistance **42.0%**
  - SANS connectivite (2479) : resistance **22.6%**
...
- `5c556c16ea8b` — 4117 candidats
  - AVEC connectivite (1638) : T0=12.93 T1=0.00 T2=3.05 — pondere **6.11**
  - SANS connectivite (2479) : T0=15.78 T1=0.00 T2=2.72 — pondere **5.44**
...
- TROP-CHER : 6150 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6115 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 45144 systemes
  - sans CONNECTED : 0.0% sur 10118 systemes
