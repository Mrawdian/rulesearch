...
genere 2026-08-27 22:25 UTC — 116787 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 33443 systemes
...
- moteur actif `0caa9267db60` (73045 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
**7585 enregistrements (6%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 55904 | 27844 | 3867 | 1899 | 5535 | 4424 | 5906 | 5708 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 54768 | 12630 | 23255 | 26 | 7600 | 2837 | 25 | 8393 | 15.3% |
...
- candidats AVEC connectivite : 5835, dont T2 : 100%
- candidats SANS connectivite : 8703, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6180 systemes avec CONNECTED sur 48177 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10248 candidats sur 14538 portent les champs bruts (70%).*

- `5c556c16ea8b` — 4283 candidats
  - AVEC connectivite (1707) : resistance **42.0%**
  - SANS connectivite (2576) : resistance **22.5%**
...
- `5c556c16ea8b` — 4283 candidats
  - AVEC connectivite (1707) : T0=12.94 T1=0.00 T2=3.05 — pondere **6.10**
  - SANS connectivite (2576) : T0=15.80 T1=0.00 T2=2.72 — pondere **5.43**
...
## cout
- temps total 36.1 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 6215 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6180 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 45676 systemes
  - sans CONNECTED : 0.0% sur 10228 systemes
