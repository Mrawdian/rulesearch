...
genere 2026-08-28 05:24 UTC — 130248 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 46904 systemes
...
- moteur actif `0caa9267db60` (86506 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 62707 | 31188 | 4310 | 2128 | 6260 | 4990 | 6578 | 6442 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 61426 | 14210 | 26018 | 29 | 8540 | 3176 | 27 | 9424 | 15.3% |
...
- candidats AVEC connectivite : 6569, dont T2 : 100%
- candidats SANS connectivite : 9734, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6852 systemes avec CONNECTED sur 53668 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12013 candidats sur 16303 portent les champs bruts (74%).*

- `5c556c16ea8b` — 6048 candidats
  - AVEC connectivite (2441) : resistance **41.6%**
  - SANS connectivite (3607) : resistance **22.0%**
...
- `5c556c16ea8b` — 6048 candidats
  - AVEC connectivite (2441) : T0=12.98 T1=0.00 T2=3.03 — pondere **6.05**
  - SANS connectivite (3607) : T0=15.86 T1=0.00 T2=2.69 — pondere **5.39**
...
## cout
- temps total 40.0 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 6889 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6852 avec CONNECTED, 37 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 51167 systemes
  - sans CONNECTED : 0.0% sur 11540 systemes
