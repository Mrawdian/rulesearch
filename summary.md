...
genere 2026-09-04 00:19 UTC — 351481 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 268137 systemes
...
- moteur actif `0caa9267db60` (307739 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 174412 | 86711 | 11852 | 5835 | 17756 | 13725 | 18470 | 17842 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 170954 | 39734 | 72220 | 70 | 23750 | 8844 | 67 | 26255 | 15.4% |
...
- candidats SANS connectivite : 26565, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18744 systemes avec CONNECTED sur 144817 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*40244 candidats sur 44534 portent les champs bruts (90%).*

- `5c556c16ea8b` — 34279 candidats
  - AVEC connectivite (13841) : resistance **41.0%**
  - SANS connectivite (20438) : resistance **21.2%**
...
- `5c556c16ea8b` — 34279 candidats
  ...
  - SANS connectivite (20438) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 142316 systemes
  - sans CONNECTED : 0.0% sur 32096 systemes
