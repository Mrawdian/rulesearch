...
genere 2026-08-27 02:15 UTC — 75646 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 10739 systemes
...
- moteur actif `0caa9267db60` (31904 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 35138 | 17482 | 2416 | 1191 | 3483 | 2790 | 3742 | 3583 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 34393 | 7920 | 14631 | 20 | 4774 | 1791 | 18 | 5239 | 15.2% |
...
- candidats AVEC connectivite : 3710, dont T2 : 100%
- candidats SANS connectivite : 5549, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4016 systemes avec CONNECTED sur 31254 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4969 candidats sur 9259 portent les champs bruts (54%).*
...
- `ab89a63b01ef` — 1292 candidats
  - AVEC connectivite (530) : resistance **41.2%**
  - SANS connectivite (762) : resistance **22.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1292 candidats
  - AVEC connectivite (530) : T0=13.02 T1=0.00 T2=3.05 — pondere **6.11**
  - SANS connectivite (762) : T0=15.94 T1=0.00 T2=2.68 — pondere **5.37**
...
- TROP-CHER : 4044 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4016 avec CONNECTED, 28 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 28753 systemes
  - sans CONNECTED : 0.0% sur 6385 systemes
