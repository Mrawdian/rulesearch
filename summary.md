...
genere 2026-09-01 02:36 UTC — 270161 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 186817 systemes
...
- moteur actif `0caa9267db60` (226419 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 133365 | 66269 | 9016 | 4479 | 13529 | 10556 | 14078 | 13707 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 130681 | 30456 | 55224 | 57 | 18106 | 6757 | 57 | 20014 | 15.3% |
...
- candidats SANS connectivite : 20324, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14352 systemes avec CONNECTED sur 111306 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*29868 candidats sur 34158 portent les champs bruts (87%).*

- `5c556c16ea8b` — 23903 candidats
  - AVEC connectivite (9706) : resistance **41.0%**
  - SANS connectivite (14197) : resistance **21.3%**
...
- `5c556c16ea8b` — 23903 candidats
  ...
  - SANS connectivite (14197) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 14419 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14352 avec CONNECTED, 67 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 108805 systemes
  - sans CONNECTED : 0.0% sur 24560 systemes
