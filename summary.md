...
genere 2026-08-26 18:15 UTC — 57865 systemes evalues
...
- moteur actif `0caa9267db60` (14123 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `84fba70921e0`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 26148 | 13028 | 1781 | 884 | 2592 | 2065 | 2790 | 2685 | 10.3% |
...
- candidats AVEC connectivite : 2812, dont T2 : 100%
- candidats SANS connectivite : 4256, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3064 systemes avec CONNECTED sur 23880 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2778 candidats sur 7068 portent les champs bruts (39%).*
...
- `0a74109317e5` — 80 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `e80bc1b2b437` — 49 candidats
  - AVEC connectivite (27) : resistance **39.0%**
...
- `e80bc1b2b437` — 49 candidats
  - AVEC connectivite (27) : T0=13.11 T1=0.00 T2=2.59 — pondere **5.19**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 21379 systemes
  - sans CONNECTED : 0.0% sur 4769 systemes
