...
genere 2026-09-09 11:26 UTC — 477995 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 394651 systemes
...
- moteur actif `0caa9267db60` (434253 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 238310 | 118312 | 16251 | 7983 | 24129 | 18687 | 25364 | 24554 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 233570 | 54434 | 98399 | 92 | 32536 | 12064 | 84 | 35942 | 15.4% |
...
- candidats AVEC connectivite : 24681, dont T2 : 100%
...
- **25638 systemes avec CONNECTED sur 197053 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*56643 candidats sur 60933 portent les champs bruts (93%).*

- `5c556c16ea8b` — 50678 candidats
  - AVEC connectivite (20553) : resistance **41.2%**
...
- `5c556c16ea8b` — 50678 candidats
  - AVEC connectivite (20553) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 25732 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25638 avec CONNECTED, 94 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 194552 systemes
  - sans CONNECTED : 0.0% sur 43758 systemes
