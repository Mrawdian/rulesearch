...
genere 2026-08-28 11:19 UTC — 140531 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 57187 systemes
...
- moteur actif `0caa9267db60` (96789 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 67905 | 33735 | 4662 | 2317 | 6806 | 5407 | 7157 | 6950 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 66511 | 15379 | 28121 | 30 | 9250 | 3436 | 30 | 10262 | 15.4% |
...
- candidats AVEC connectivite : 7077, dont T2 : 100%
- candidats SANS connectivite : 10572, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7431 systemes avec CONNECTED sur 57885 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*13359 candidats sur 17649 portent les champs bruts (76%).*

- `5c556c16ea8b` — 7394 candidats
  - AVEC connectivite (2949) : resistance **41.4%**
  - SANS connectivite (4445) : resistance **21.8%**
...
- `5c556c16ea8b` — 7394 candidats
  - AVEC connectivite (2949) : T0=13.00 T1=0.00 T2=3.02 — pondere **6.03**
  - SANS connectivite (4445) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.35**
...
- TROP-CHER : 7471 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7431 avec CONNECTED, 40 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 55384 systemes
  - sans CONNECTED : 0.0% sur 12521 systemes
