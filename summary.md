...
genere 2026-09-04 18:45 UTC — 371130 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 287786 systemes
...
- moteur actif `0caa9267db60` (327388 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 184332 | 91580 | 12544 | 6171 | 18741 | 14516 | 19531 | 18882 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 180683 | 41998 | 76339 | 75 | 25116 | 9350 | 70 | 27721 | 15.3% |
...
- candidats SANS connectivite : 28031, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19805 systemes avec CONNECTED sur 152876 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*42750 candidats sur 47040 portent les champs bruts (91%).*

- `5c556c16ea8b` — 36785 candidats
  - AVEC connectivite (14881) : resistance **41.1%**
  - SANS connectivite (21904) : resistance **21.2%**
...
- `5c556c16ea8b` — 36785 candidats
  ...
  - SANS connectivite (21904) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 150375 systemes
  - sans CONNECTED : 0.0% sur 33957 systemes
