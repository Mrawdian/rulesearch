...
genere 2026-08-27 00:11 UTC — 71161 systemes evalues
...
- moteur actif `0caa9267db60` (27419 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 32880 | 16343 | 2262 | 1112 | 3267 | 2614 | 3502 | 3358 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 32166 | 7406 | 13653 | 18 | 4463 | 1687 | 15 | 4924 | 15.3% |
...
- candidats AVEC connectivite : 3485, dont T2 : 100%
- candidats SANS connectivite : 5234, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3776 systemes avec CONNECTED sur 29382 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4429 candidats sur 8719 portent les champs bruts (51%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 752 candidats
  - AVEC connectivite (305) : resistance **41.6%**
  - SANS connectivite (447) : resistance **21.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 752 candidats
  - AVEC connectivite (305) : T0=13.15 T1=0.00 T2=3.08 — pondere **6.16**
  - SANS connectivite (447) : T0=15.93 T1=0.00 T2=2.59 — pondere **5.19**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 798 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 26881 systemes
  - sans CONNECTED : 0.0% sur 5999 systemes
