...
- `89c65c03c4ad` — 866 candidats
  - AVEC connectivite (346) : T0=13.39 T1=0.00 T2=2.84 — pondere **5.69**
  - SANS connectivite (520) : T0=15.80 T1=0.00 T2=2.65 — pondere **5.30**
  - test de permutation : **p = 0.0785** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
