...
genere 2026-08-26 22:15 UTC — 66877 systemes evalues
...
- moteur actif `0caa9267db60` (23135 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 30712 | 15261 | 2102 | 1033 | 3062 | 2442 | 3271 | 3151 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 30050 | 6926 | 12765 | 18 | 4155 | 1554 | 14 | 4618 | 15.4% |
...
- candidats AVEC connectivite : 3278, dont T2 : 100%
- candidats SANS connectivite : 4928, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3545 systemes avec CONNECTED sur 27612 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3916 candidats sur 8206 portent les champs bruts (48%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 239 candidats
  - AVEC connectivite (98) : resistance **42.8%**
  - SANS connectivite (141) : resistance **22.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 239 candidats
  - AVEC connectivite (98) : T0=12.97 T1=0.00 T2=3.05 — pondere **6.10**
  - SANS connectivite (141) : T0=16.16 T1=0.00 T2=2.77 — pondere **5.53**
  - test de permutation : **p = 0.1794** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- TROP-CHER : 3569 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3545 avec CONNECTED, 24 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 25111 systemes
  - sans CONNECTED : 0.0% sur 5601 systemes
