...
genere 2026-08-26 16:25 UTC — 53623 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 8440 systemes
...
- moteur actif `0caa9267db60` (9881 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 24014 | 11984 | 1636 | 813 | 2379 | 1896 | 2562 | 2442 | 10.2% |
...
- candidats AVEC connectivite : 2569, dont T2 : 100%
- candidats SANS connectivite : 3928, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2836 systemes avec CONNECTED sur 22121 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2207 candidats sur 6497 portent les champs bruts (34%).*
...
- `06fe04a859f1` — 1092 candidats
  - AVEC connectivite (431) : resistance **40.8%**
...
- `06fe04a859f1` — 1092 candidats
  - AVEC connectivite (431) : T0=13.15 T1=0.00 T2=3.01 — pondere **6.02**
...
- TROP-CHER : 2856 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2836 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19620 systemes
  - sans CONNECTED : 0.0% sur 4394 systemes
