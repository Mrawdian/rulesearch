...
genere 2026-09-06 09:48 UTC — 410377 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 327033 systemes
...
- moteur actif `0caa9267db60` (366635 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 204154 | 101362 | 13926 | 6801 | 20701 | 16051 | 21688 | 21024 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 200108 | 46515 | 84442 | 79 | 27893 | 10342 | 73 | 30747 | 15.4% |
...
- candidats SANS connectivite : 31057, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21962 systemes avec CONNECTED sur 169095 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*47918 candidats sur 52208 portent les champs bruts (92%).*

- `5c556c16ea8b` — 41953 candidats
  - AVEC connectivite (17023) : resistance **41.1%**
  - SANS connectivite (24930) : resistance **21.3%**
...
- `5c556c16ea8b` — 41953 candidats
  ...
  - SANS connectivite (24930) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 22045 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21962 avec CONNECTED, 83 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 166594 systemes
  - sans CONNECTED : 0.0% sur 37560 systemes
