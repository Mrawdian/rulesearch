...
| connect | 4 | 3 | 17798 | 8906 | 1152 | 614 | 1763 | 1411 | 1939 | 1789 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 17413 | 4096 | 7358 | 12 | 2382 | 886 | 7 | 2672 | 15.3% |
...
- candidats AVEC connectivite : 1916, dont T2 : 100%
- candidats SANS connectivite : 2982, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2213 systemes avec CONNECTED sur 17043 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*608 candidats sur 4898 portent les champs bruts (12%).*
...
- `e3baecf8377b` — 344 candidats
  - AVEC connectivite (133) : resistance **43.5%**
  - SANS connectivite (211) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 344 candidats
  - AVEC connectivite (133) : T0=12.92 T1=0.00 T2=3.14 — pondere **6.29**
  - SANS connectivite (211) : T0=16.01 T1=0.00 T2=2.65 — pondere **5.31**
...
## cout
- temps total 13.0 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2230 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2213 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14542 systemes
  - sans CONNECTED : 0.0% sur 3256 systemes
