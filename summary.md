...
genere 2026-09-03 19:16 UTC — 345843 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 262499 systemes
...
- moteur actif `0caa9267db60` (302101 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 171564 | 85272 | 11637 | 5742 | 17462 | 13539 | 18186 | 17541 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 168164 | 39109 | 71077 | 67 | 23321 | 8700 | 66 | 25812 | 15.3% |
...
- candidats AVEC connectivite : 17668, dont T2 : 100%
- candidats SANS connectivite : 26122, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18460 systemes avec CONNECTED sur 142477 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39500 candidats sur 43790 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33535 candidats
  - AVEC connectivite (13540) : resistance **41.0%**
  - SANS connectivite (19995) : resistance **21.2%**
...
- `5c556c16ea8b` — 33535 candidats
  - AVEC connectivite (13540) : T0=13.03 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (19995) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 18536 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18460 avec CONNECTED, 76 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 139976 systemes
  - sans CONNECTED : 0.0% sur 31588 systemes
