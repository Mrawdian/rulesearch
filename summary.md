...
genere 2026-08-27 18:15 UTC — 108858 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 25514 systemes
...
- moteur actif `0caa9267db60` (65116 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 50844 | 11769 | 21588 | 26 | 7018 | 2647 | 24 | 7770 | 15.3% |
...
- candidats SANS connectivite : 8080, dont T2 : 100%
...
*9198 candidats sur 13488 portent les champs bruts (68%).*
...
- `5c556c16ea8b` — 3233 candidats
  - AVEC connectivite (1280) : resistance **42.0%**
  - SANS connectivite (1953) : resistance **22.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 3233 candidats
  ...
  - SANS connectivite (1953) : T0=15.78 T1=0.00 T2=2.70 — pondere **5.39**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 2280 candidats
