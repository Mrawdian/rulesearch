...
genere 2026-08-27 04:31 UTC — 80714 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 15807 systemes
...
- moteur actif `0caa9267db60` (36972 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 37707 | 18758 | 2599 | 1280 | 3748 | 2966 | 3993 | 3874 | 10.3% |
...
- candidats AVEC connectivite : 4001, dont T2 : 100%
- candidats SANS connectivite : 5933, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4267 systemes avec CONNECTED sur 33368 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5644 candidats sur 9934 portent les champs bruts (57%).*
...
- `ab89a63b01ef` — 1967 candidats
  - AVEC connectivite (821) : resistance **41.5%**
...
- `ab89a63b01ef` — 1967 candidats
  - AVEC connectivite (821) : T0=13.05 T1=0.00 T2=3.05 — pondere **6.09**
...
- TROP-CHER : 4297 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4267 avec CONNECTED, 30 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 30867 systemes
