...
genere 2026-08-27 00:08 UTC — 70981 systemes evalues
...
- moteur actif `0caa9267db60` (27239 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 32790 | 16297 | 2254 | 1108 | 3261 | 2606 | 3496 | 3348 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 32076 | 7385 | 13619 | 18 | 4448 | 1682 | 15 | 4909 | 15.3% |
...
- candidats SANS connectivite : 5219, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3770 systemes avec CONNECTED sur 29304 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4404 candidats sur 8694 portent les champs bruts (51%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 727 candidats
  - AVEC connectivite (295) : resistance **41.6%**
  - SANS connectivite (432) : resistance **21.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 727 candidats
  ...
  - SANS connectivite (432) : T0=15.94 T1=0.00 T2=2.60 — pondere **5.19**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e3baecf8377b` — 657 candidats
...
- TROP-CHER : 3795 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3770 avec CONNECTED, 25 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 26803 systemes
  - sans CONNECTED : 0.0% sur 5987 systemes
