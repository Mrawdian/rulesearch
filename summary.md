...
genere 2026-08-26 12:57 UTC — 45243 systemes evalues
...
- `06fe04a859f1` : 60 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (1501 systemes) : `06fe04a859f1`, `e40600351a72`
...
**7526 enregistrements (17%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 19770 | 9865 | 1286 | 685 | 1983 | 1564 | 2127 | 2015 | 10.2% |
...
- candidats AVEC connectivite : 2142, dont T2 : 100%
- candidats SANS connectivite : 3271, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2401 systemes avec CONNECTED sur 18642 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1123 candidats sur 5413 portent les champs bruts (21%).*
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 16141 systemes
  - sans CONNECTED : 0.0% sur 3629 systemes
