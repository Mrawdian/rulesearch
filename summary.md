...
| connect | 4 | 3 | 17035 | 8509 | 1097 | 589 | 1693 | 1356 | 1857 | 1719 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 16674 | 3927 | 7067 | 11 | 2268 | 842 | 7 | 2552 | 15.3% |
...
- candidats AVEC connectivite : 1846, dont T2 : 100%
- candidats SANS connectivite : 2862, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2131 systemes avec CONNECTED sur 16422 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*418 candidats sur 4708 portent les champs bruts (9%).*
...
- `e3baecf8377b` — 154 candidats
  - AVEC connectivite (63) : resistance **41.9%**
  - SANS connectivite (91) : resistance **20.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 154 candidats
  - AVEC connectivite (63) : T0=13.40 T1=0.00 T2=3.16 — pondere **6.32**
  - SANS connectivite (91) : T0=15.78 T1=0.00 T2=2.57 — pondere **5.14**
...
- TROP-CHER : 2148 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2131 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 13921 systemes
  - sans CONNECTED : 0.0% sur 3114 systemes
