...
genere 2026-08-27 03:52 UTC — 79268 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 14361 systemes
...
- moteur actif `0caa9267db60` (35526 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 36977 | 18377 | 2555 | 1260 | 3664 | 2921 | 3922 | 3796 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 36176 | 8333 | 15398 | 21 | 5004 | 1890 | 19 | 5511 | 15.2% |
...
- candidats AVEC connectivite : 3923, dont T2 : 100%
- candidats SANS connectivite : 5821, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4196 systemes avec CONNECTED sur 32769 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5454 candidats sur 9744 portent les champs bruts (56%).*
...
- `ab89a63b01ef` — 1777 candidats
  - AVEC connectivite (743) : resistance **41.1%**
  - SANS connectivite (1034) : resistance **21.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1777 candidats
  - AVEC connectivite (743) : T0=13.03 T1=0.00 T2=3.02 — pondere **6.05**
  - SANS connectivite (1034) : T0=15.92 T1=0.00 T2=2.69 — pondere **5.39**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- TROP-CHER : 4225 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4196 avec CONNECTED, 29 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 30268 systemes
  - sans CONNECTED : 0.0% sur 6709 systemes
