...
genere 2026-08-27 02:20 UTC — 75781 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 10874 systemes
...
- moteur actif `0caa9267db60` (32039 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 35213 | 17516 | 2420 | 1193 | 3491 | 2798 | 3753 | 3591 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 34453 | 7938 | 14652 | 20 | 4780 | 1798 | 18 | 5247 | 15.2% |
...
- candidats AVEC connectivite : 3718, dont T2 : 100%
- candidats SANS connectivite : 5557, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4027 systemes avec CONNECTED sur 31316 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4985 candidats sur 9275 portent les champs bruts (54%).*
...
- `ab89a63b01ef` — 1308 candidats
  - AVEC connectivite (538) : resistance **41.1%**
  - SANS connectivite (770) : resistance **22.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1308 candidats
  - AVEC connectivite (538) : T0=13.03 T1=0.00 T2=3.04 — pondere **6.09**
  - SANS connectivite (770) : T0=15.96 T1=0.00 T2=2.69 — pondere **5.37**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- TROP-CHER : 4055 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 4027 avec CONNECTED, 28 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 28815 systemes
  - sans CONNECTED : 0.0% sur 6398 systemes
