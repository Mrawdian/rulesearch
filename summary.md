...
genere 2026-09-04 15:50 UTC — 368216 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 284872 systemes
...
- moteur actif `0caa9267db60` (324474 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 182852 | 90885 | 12432 | 6109 | 18620 | 14404 | 19348 | 18711 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 179249 | 41662 | 75738 | 74 | 24898 | 9284 | 70 | 27509 | 15.3% |
...
- candidats AVEC connectivite : 18838, dont T2 : 100%
- candidats SANS connectivite : 27819, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19622 systemes avec CONNECTED sur 151649 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*42367 candidats sur 46657 portent les champs bruts (91%).*

- `5c556c16ea8b` — 36402 candidats
  - AVEC connectivite (14710) : resistance **41.0%**
  - SANS connectivite (21692) : resistance **21.2%**
...
- `5c556c16ea8b` — 36402 candidats
  - AVEC connectivite (14710) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (21692) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 19702 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19622 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 149148 systemes
  - sans CONNECTED : 0.0% sur 33704 systemes
