...
genere 2026-09-04 05:21 UTC — 356839 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 273495 systemes
...
- moteur actif `0caa9267db60` (313097 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 177117 | 88025 | 12048 | 5927 | 18009 | 13945 | 18776 | 18132 | 10.2% |
...
- candidats AVEC connectivite : 18259, dont T2 : 100%
...
- **19050 systemes avec CONNECTED sur 147037 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*40965 candidats sur 45255 portent les champs bruts (91%).*

- `5c556c16ea8b` — 35000 candidats
  - AVEC connectivite (14131) : resistance **41.1%**
...
- `5c556c16ea8b` — 35000 candidats
  - AVEC connectivite (14131) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 19130 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19050 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 144536 systemes
  - sans CONNECTED : 0.0% sur 32581 systemes
