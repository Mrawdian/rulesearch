...
| connect | 4 | 3 | 5501 | 2762 | 353 | 201 | 529 | 452 | 574 | 569 | 10.3% |
| ref | 4 | 3 | 5366 | 1297 | 2239 | 1 | 712 | 264 | 2 | 851 | 15.9% |
...
- candidats AVEC connectivite : 572, dont T2 : 100%
- candidats SANS connectivite : 855, dont T2 : 100%
...
- **574 systemes avec CONNECTED sur 4554 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 262 candidats
  - AVEC connectivite (93) : T0=13.19 T1=0.00 T2=2.85 — pondere **5.70**
  - SANS connectivite (169) : T0=15.95 T1=0.00 T2=2.66 — pondere **5.33**
  - test de permutation : **p = 0.3538** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 576 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 574 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 4497 systemes
  - sans CONNECTED : 0.0% sur 1004 systemes
