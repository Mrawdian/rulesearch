...
genere 2026-08-27 07:24 UTC — 86996 systemes evalues
...
- moteur actif `0caa9267db60` (43254 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 40866 | 20339 | 2798 | 1390 | 4094 | 3211 | 4311 | 4196 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 40015 | 9221 | 17010 | 22 | 5551 | 2088 | 21 | 6102 | 15.2% |
...
- candidats SANS connectivite : 6412, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4585 systemes avec CONNECTED sur 35892 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6445 candidats sur 10735 portent les champs bruts (60%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 480 candidats
  - AVEC connectivite (195) : resistance **41.7%**
  - SANS connectivite (285) : resistance **20.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 480 candidats
  ...
  - SANS connectivite (285) : T0=15.79 T1=0.00 T2=2.60 — pondere **5.19**
...
- TROP-CHER : 4616 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4585 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 33391 systemes
  - sans CONNECTED : 0.0% sur 7475 systemes
