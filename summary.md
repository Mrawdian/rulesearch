...
genere 2026-08-27 02:28 UTC — 76091 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 11184 systemes
...
- moteur actif `0caa9267db60` (32349 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 35363 | 17596 | 2431 | 1198 | 3505 | 2803 | 3766 | 3610 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 34613 | 7975 | 14726 | 20 | 4792 | 1811 | 19 | 5270 | 15.2% |
...
- candidats AVEC connectivite : 3737, dont T2 : 100%
- candidats SANS connectivite : 5580, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4040 systemes avec CONNECTED sur 31444 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5027 candidats sur 9317 portent les champs bruts (54%).*
...
- `ab89a63b01ef` — 1350 candidats
  - AVEC connectivite (557) : resistance **41.0%**
  - SANS connectivite (793) : resistance **22.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1350 candidats
  - AVEC connectivite (557) : T0=13.03 T1=0.00 T2=3.03 — pondere **6.06**
  - SANS connectivite (793) : T0=15.94 T1=0.00 T2=2.69 — pondere **5.38**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 28943 systemes
  - sans CONNECTED : 0.0% sur 6420 systemes
