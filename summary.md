...
genere 2026-08-26 20:16 UTC — 62579 systemes evalues
...
- moteur actif `0caa9267db60` (18837 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 28542 | 14215 | 1952 | 957 | 2833 | 2265 | 3031 | 2930 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 27922 | 6453 | 11826 | 15 | 3880 | 1434 | 12 | 4302 | 15.4% |
...
- candidats SANS connectivite : 4612, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3305 systemes avec CONNECTED sur 25846 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3379 candidats sur 7669 portent les champs bruts (44%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 510 candidats
  - AVEC connectivite (213) : resistance **39.5%**
  - SANS connectivite (297) : resistance **20.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 510 candidats
  ...
  - SANS connectivite (297) : T0=16.17 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 3327 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3305 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23345 systemes
  - sans CONNECTED : 0.0% sur 5197 systemes
