...
genere 2026-08-28 00:33 UTC — 120968 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 37624 systemes
...
- moteur actif `0caa9267db60` (77226 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 58004 | 28889 | 4014 | 1961 | 5758 | 4586 | 6117 | 5938 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 56849 | 13124 | 24115 | 28 | 7900 | 2942 | 26 | 8712 | 15.3% |
...
- candidats AVEC connectivite : 6065, dont T2 : 100%
- candidats SANS connectivite : 9022, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6391 systemes avec CONNECTED sur 49878 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10797 candidats sur 15087 portent les champs bruts (72%).*

- `5c556c16ea8b` — 4832 candidats
  - AVEC connectivite (1937) : resistance **42.0%**
  - SANS connectivite (2895) : resistance **22.4%**
...
- `5c556c16ea8b` — 4832 candidats
  - AVEC connectivite (1937) : T0=12.98 T1=0.00 T2=3.06 — pondere **6.11**
  - SANS connectivite (2895) : T0=15.83 T1=0.00 T2=2.72 — pondere **5.43**
...
- TROP-CHER : 6427 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6391 avec CONNECTED, 36 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 47377 systemes
  - sans CONNECTED : 0.0% sur 10627 systemes
