...
| connect | 4 | 3 | 6115 | 3082 | 393 | 221 | 586 | 491 | 635 | 634 | 10.4% |
| ref | 4 | 3 | 5978 | 1453 | 2488 | 1 | 797 | 294 | 2 | 943 | 15.8% |
...
- candidats AVEC connectivite : 637, dont T2 : 100%
- candidats SANS connectivite : 947, dont T2 : 100%
...
- **635 systemes avec CONNECTED sur 5071 (12.5%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 419 candidats
  - AVEC connectivite (158) : T0=13.20 T1=0.00 T2=2.94 — pondere **5.89**
  - SANS connectivite (261) : T0=15.98 T1=0.00 T2=2.61 — pondere **5.23**
  - test de permutation : **p = 0.0380** — ecart significatif au seuil 0.05
...
- TROP-CHER : 637 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 635 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 5014 systemes
  - sans CONNECTED : 0.0% sur 1101 systemes
