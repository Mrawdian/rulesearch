...
genere 2026-08-27 07:25 UTC — 87069 systemes evalues
...
- moteur actif `0caa9267db60` (43327 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 40896 | 20357 | 2798 | 1392 | 4095 | 3215 | 4312 | 4198 | 10.3% |
...
- candidats AVEC connectivite : 4325, dont T2 : 100%
- candidats SANS connectivite : 6422, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4586 systemes avec CONNECTED sur 35917 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6457 candidats sur 10747 portent les champs bruts (60%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 492 candidats
  - AVEC connectivite (197) : resistance **41.7%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 492 candidats
  - AVEC connectivite (197) : T0=13.04 T1=0.00 T2=3.04 — pondere **6.07**
  - SANS connectivite (295) : T0=15.80 T1=0.00 T2=2.62 — pondere **5.23**
  - test de permutation : **p = 0.0055** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `23303c299f39` — 225 candidats
...
**7 serie(s) reproductible(s) sur 14 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `ab89a63b01ef` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `5c556c16ea8b` (p=0.0055), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 33416 systemes
  - sans CONNECTED : 0.0% sur 7480 systemes
