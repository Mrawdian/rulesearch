...
genere 2026-08-27 01:26 UTC — 73813 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 9167 systemes
- `ab89a63b01ef` : 8906 systemes
...
- moteur actif `0caa9267db60` (30071 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 34212 | 17010 | 2346 | 1159 | 3401 | 2725 | 3650 | 3485 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 33486 | 7721 | 14228 | 20 | 4648 | 1746 | 17 | 5106 | 15.2% |
...
- candidats AVEC connectivite : 3612, dont T2 : 100%
- candidats SANS connectivite : 5416, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3924 systemes avec CONNECTED sur 30480 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4738 candidats sur 9028 portent les champs bruts (52%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 1061 candidats
  - AVEC connectivite (432) : resistance **41.1%**
  - SANS connectivite (629) : resistance **21.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 1061 candidats
  - AVEC connectivite (432) : T0=13.05 T1=0.00 T2=3.04 — pondere **6.09**
  - SANS connectivite (629) : T0=15.88 T1=0.00 T2=2.65 — pondere **5.29**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
...
## cout
- temps total 22.9 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 3951 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 3924 avec CONNECTED, 27 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 27979 systemes
  - sans CONNECTED : 0.0% sur 6233 systemes
