...
genere 2026-08-27 02:13 UTC — 75558 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 10651 systemes
...
- moteur actif `0caa9267db60` (31816 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 35093 | 17457 | 2413 | 1189 | 3481 | 2785 | 3737 | 3581 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 34350 | 7909 | 14616 | 20 | 4769 | 1788 | 18 | 5230 | 15.2% |
...
- candidats AVEC connectivite : 3708, dont T2 : 100%
- candidats SANS connectivite : 5540, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4011 systemes avec CONNECTED sur 31215 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4958 candidats sur 9248 portent les champs bruts (54%).*
...
- `ab89a63b01ef` — 1281 candidats
  - AVEC connectivite (528) : resistance **41.2%**
  - SANS connectivite (753) : resistance **22.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1281 candidats
  - AVEC connectivite (528) : T0=13.02 T1=0.00 T2=3.05 — pondere **6.11**
  - SANS connectivite (753) : T0=15.92 T1=0.00 T2=2.70 — pondere **5.40**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
## cout
- temps total 23.5 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 4039 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4011 avec CONNECTED, 28 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 28714 systemes
  - sans CONNECTED : 0.0% sur 6379 systemes
