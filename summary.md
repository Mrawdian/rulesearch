...
genere 2026-08-27 05:16 UTC — 82589 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 17682 systemes
...
- moteur actif `0caa9267db60` (38847 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 37829 | 8733 | 16086 | 21 | 5242 | 1968 | 20 | 5759 | 15.2% |
...
- candidats SANS connectivite : 6069, dont T2 : 100%
...
*5873 candidats sur 10163 portent les champs bruts (58%).*
...
- `ab89a63b01ef` — 2196 candidats
  - AVEC connectivite (914) : resistance **41.3%**
  - SANS connectivite (1282) : resistance **21.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 2196 candidats
  ...
  - SANS connectivite (1282) : T0=15.97 T1=0.00 T2=2.67 — pondere **5.35**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
