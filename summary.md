...
genere 2026-08-27 02:22 UTC — 75869 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 10962 systemes
...
- moteur actif `0caa9267db60` (32127 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 35258 | 17545 | 2422 | 1194 | 3494 | 2799 | 3756 | 3596 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 34496 | 7946 | 14673 | 20 | 4783 | 1801 | 18 | 5255 | 15.2% |
...
- candidats AVEC connectivite : 3723, dont T2 : 100%
- candidats SANS connectivite : 5565, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4030 systemes avec CONNECTED sur 31356 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4998 candidats sur 9288 portent les champs bruts (54%).*
...
- `ab89a63b01ef` — 1321 candidats
  - AVEC connectivite (543) : resistance **41.2%**
  - SANS connectivite (778) : resistance **22.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1321 candidats
  - AVEC connectivite (543) : T0=13.03 T1=0.00 T2=3.05 — pondere **6.10**
  - SANS connectivite (778) : T0=15.94 T1=0.00 T2=2.69 — pondere **5.37**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
## cout
- temps total 23.6 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 4058 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4030 avec CONNECTED, 28 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 28855 systemes
  - sans CONNECTED : 0.0% sur 6403 systemes
