...
genere 2026-08-27 08:22 UTC — 89114 systemes evalues
...
- moteur actif `0caa9267db60` (45372 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 41928 | 20882 | 2882 | 1419 | 4181 | 3296 | 4417 | 4306 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 41071 | 9469 | 17456 | 23 | 5691 | 2139 | 21 | 6272 | 15.3% |
...
- candidats AVEC connectivite : 4433, dont T2 : 100%
- candidats SANS connectivite : 6582, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4691 systemes avec CONNECTED sur 36769 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6725 candidats sur 11015 portent les champs bruts (61%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 760 candidats
  - AVEC connectivite (305) : resistance **41.1%**
  - SANS connectivite (455) : resistance **21.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 760 candidats
  - AVEC connectivite (305) : T0=13.10 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (455) : T0=15.87 T1=0.00 T2=2.62 — pondere **5.25**
...
- TROP-CHER : 4722 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4691 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 34268 systemes
  - sans CONNECTED : 0.0% sur 7660 systemes
