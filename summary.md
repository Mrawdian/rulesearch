...
genere 2026-08-27 05:51 UTC — 83730 systemes evalues
...
- moteur actif `0caa9267db60` (39988 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 39211 | 19521 | 2697 | 1340 | 3896 | 3090 | 4139 | 4019 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 38404 | 8859 | 16336 | 22 | 5317 | 2001 | 21 | 5848 | 15.2% |
...
- candidats AVEC connectivite : 4146, dont T2 : 100%
- candidats SANS connectivite : 6158, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4413 systemes avec CONNECTED sur 34573 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6014 candidats sur 10304 portent les champs bruts (58%).*
...
- `8f22f0d2d442` — 65 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 49 candidats
  - AVEC connectivite (18) : resistance **43.5%**
  - SANS connectivite (31) : resistance **22.9%**
...
- `5c556c16ea8b` — 49 candidats
  - AVEC connectivite (18) : T0=12.56 T1=0.00 T2=3.17 — pondere **6.33**
  - SANS connectivite (31) : T0=16.52 T1=0.00 T2=2.58 — pondere **5.16**
...
- TROP-CHER : 4444 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4413 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 32072 systemes
  - sans CONNECTED : 0.0% sur 7139 systemes
