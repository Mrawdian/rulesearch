...
genere 2026-08-26 18:47 UTC — 59261 systemes evalues
...
- moteur actif `0caa9267db60` (15519 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 26852 | 13395 | 1829 | 907 | 2664 | 2122 | 2853 | 2747 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 26294 | 6061 | 11133 | 15 | 3669 | 1353 | 10 | 4053 | 15.4% |
...
- candidats AVEC connectivite : 2874, dont T2 : 100%
- candidats SANS connectivite : 4363, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3127 systemes avec CONNECTED sur 24468 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2947 candidats sur 7237 portent les champs bruts (41%).*
...
- `e80bc1b2b437` — 75 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 78 candidats
  - AVEC connectivite (30) : resistance **47.0%**
  - SANS connectivite (48) : resistance **16.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 78 candidats
  - AVEC connectivite (30) : T0=13.10 T1=0.00 T2=3.33 — pondere **6.67**
  - SANS connectivite (48) : T0=16.52 T1=0.00 T2=2.48 — pondere **4.96**
...
## cout
- temps total 18.3 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 3147 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3127 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 21967 systemes
  - sans CONNECTED : 0.0% sur 4885 systemes
