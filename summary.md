...
genere 2026-08-26 13:28 UTC — 46660 systemes evalues
...
- moteur actif `0caa9267db60` (2918 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20485 | 10218 | 1350 | 707 | 2046 | 1629 | 2190 | 2092 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20060 | 4700 | 8471 | 13 | 2777 | 1038 | 7 | 3054 | 15.2% |
...
- candidats SANS connectivite : 3364, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2464 systemes avec CONNECTED sur 19220 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1293 candidats sur 5583 portent les champs bruts (23%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 178 candidats
  - AVEC connectivite (81) : resistance **38.4%**
  - SANS connectivite (97) : resistance **22.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 178 candidats
  ...
  - SANS connectivite (97) : T0=16.32 T1=0.00 T2=2.97 — pondere **5.94**
  - test de permutation : **p = 0.4073** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
- TROP-CHER : 2481 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2464 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16719 systemes
  - sans CONNECTED : 0.0% sur 3766 systemes
