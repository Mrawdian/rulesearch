...
genere 2026-08-26 02:33 UTC — 18490 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 9516 systemes
...
| connect | 4 | 3 | 9283 | 4663 | 608 | 312 | 892 | 731 | 1013 | 953 | 10.3% |
| ref | 4 | 3 | 9083 | 2181 | 3825 | 2 | 1206 | 451 | 4 | 1414 | 15.6% |
...
- candidats AVEC connectivite : 956, dont T2 : 100%
- candidats SANS connectivite : 1418, dont T2 : 100%
...
- **1013 systemes avec CONNECTED sur 7689 (13.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1209 candidats
  - AVEC connectivite (477) : T0=13.32 T1=0.00 T2=2.91 — pondere **5.82**
  - SANS connectivite (732) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.34**
...
## cout
- temps total 5.9 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 1017 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1013 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 7632 systemes
  - sans CONNECTED : 0.0% sur 1651 systemes
