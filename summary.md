...
genere 2026-08-27 01:28 UTC — 73902 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 9167 systemes
- `ab89a63b01ef` : 8995 systemes
...
- moteur actif `0caa9267db60` (30160 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 34257 | 17030 | 2349 | 1165 | 3405 | 2728 | 3653 | 3488 | 10.2% |
...
- candidats AVEC connectivite : 3615, dont T2 : 100%
- candidats SANS connectivite : 5424, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3927 systemes avec CONNECTED sur 30518 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4749 candidats sur 9039 portent les champs bruts (53%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 1072 candidats
  - AVEC connectivite (435) : resistance **41.0%**
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 1072 candidats
  - AVEC connectivite (435) : T0=13.05 T1=0.00 T2=3.04 — pondere **6.07**
...
- TROP-CHER : 3954 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 3927 avec CONNECTED, 27 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 28017 systemes
