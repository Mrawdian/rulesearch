...
genere 2026-08-26 20:52 UTC — 63782 systemes evalues
...
- moteur actif `0caa9267db60` (20040 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 29141 | 14495 | 1989 | 974 | 2900 | 2307 | 3108 | 2995 | 10.3% |
...
- candidats AVEC connectivite : 3122, dont T2 : 100%
- candidats SANS connectivite : 4696, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3382 systemes avec CONNECTED sur 26342 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3528 candidats sur 7818 portent les champs bruts (45%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 659 candidats
  - AVEC connectivite (278) : resistance **40.0%**
...
- `62448a55927e` — 659 candidats
  - AVEC connectivite (278) : T0=12.82 T1=0.00 T2=2.85 — pondere **5.69**
  - SANS connectivite (381) : T0=16.11 T1=0.00 T2=2.69 — pondere **5.38**
  - test de permutation : **p = 0.2044** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e3baecf8377b` — 657 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23841 systemes
  - sans CONNECTED : 0.0% sur 5300 systemes
