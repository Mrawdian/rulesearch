...
genere 2026-08-28 06:48 UTC — 132711 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 49367 systemes
...
- moteur actif `0caa9267db60` (88969 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 63942 | 31782 | 4390 | 2171 | 6404 | 5085 | 6716 | 6573 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 62654 | 14486 | 26543 | 29 | 8717 | 3239 | 28 | 9610 | 15.3% |
...
- candidats AVEC connectivite : 6700, dont T2 : 100%
- candidats SANS connectivite : 9920, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6990 systemes avec CONNECTED sur 54664 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12330 candidats sur 16620 portent les champs bruts (74%).*

- `5c556c16ea8b` — 6365 candidats
  - AVEC connectivite (2572) : resistance **41.5%**
...
- `5c556c16ea8b` — 6365 candidats
  - AVEC connectivite (2572) : T0=12.98 T1=0.00 T2=3.02 — pondere **6.03**
...
- TROP-CHER : 7028 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6990 avec CONNECTED, 38 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 52163 systemes
  - sans CONNECTED : 0.0% sur 11779 systemes
