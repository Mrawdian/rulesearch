...
genere 2026-08-28 17:27 UTC — 151087 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 67743 systemes
...
- moteur actif `0caa9267db60` (107345 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 73219 | 36361 | 4990 | 2502 | 7350 | 5833 | 7731 | 7516 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 71753 | 16681 | 30322 | 33 | 9909 | 3693 | 31 | 11081 | 15.4% |
...
- candidats AVEC connectivite : 7643, dont T2 : 100%
- candidats SANS connectivite : 11391, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8005 systemes avec CONNECTED sur 62230 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*14744 candidats sur 19034 portent les champs bruts (77%).*

- `5c556c16ea8b` — 8779 candidats
  - AVEC connectivite (3515) : resistance **41.1%**
  - SANS connectivite (5264) : resistance **21.7%**
...
- `5c556c16ea8b` — 8779 candidats
  - AVEC connectivite (3515) : T0=13.02 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (5264) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.36**
...
## cout
- temps total 46.7 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 8046 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8005 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 59729 systemes
  - sans CONNECTED : 0.0% sur 13490 systemes
