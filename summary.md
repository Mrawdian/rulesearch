...
genere 2026-09-01 11:04 UTC — 280800 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 197456 systemes
...
- moteur actif `0caa9267db60` (237058 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 138736 | 68962 | 9385 | 4640 | 14093 | 10937 | 14650 | 14270 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 135949 | 31660 | 57473 | 58 | 18849 | 7034 | 61 | 20803 | 15.3% |
...
- candidats AVEC connectivite : 14397, dont T2 : 100%
- candidats SANS connectivite : 21113, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14924 systemes avec CONNECTED sur 115700 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*31220 candidats sur 35510 portent les champs bruts (88%).*

- `5c556c16ea8b` — 25255 candidats
  - AVEC connectivite (10269) : resistance **41.0%**
  - SANS connectivite (14986) : resistance **21.4%**
...
- `5c556c16ea8b` — 25255 candidats
  - AVEC connectivite (10269) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (14986) : T0=15.93 T1=0.00 T2=2.66 — pondere **5.32**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 113199 systemes
  - sans CONNECTED : 0.0% sur 25537 systemes
