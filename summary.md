...
genere 2026-08-28 02:24 UTC — 124813 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 41469 systemes
...
- moteur actif `0caa9267db60` (81071 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 59961 | 29862 | 4144 | 2029 | 5967 | 4749 | 6282 | 6157 | 10.3% |
...
- candidats AVEC connectivite : 6284, dont T2 : 100%
- candidats SANS connectivite : 9303, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6556 systemes avec CONNECTED sur 51442 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11297 candidats sur 15587 portent les champs bruts (72%).*

- `5c556c16ea8b` — 5332 candidats
  - AVEC connectivite (2156) : resistance **41.8%**
...
- `5c556c16ea8b` — 5332 candidats
  - AVEC connectivite (2156) : T0=12.99 T1=0.00 T2=3.04 — pondere **6.08**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 48941 systemes
