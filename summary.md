...
- moteur actif `0caa9267db60` (47650 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 43079 | 21461 | 2955 | 1456 | 4303 | 3390 | 4538 | 4415 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 42198 | 9729 | 17916 | 25 | 5846 | 2202 | 22 | 6457 | 15.3% |
...
- candidats AVEC connectivite : 4542, dont T2 : 100%
- candidats SANS connectivite : 6767, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4812 systemes avec CONNECTED sur 37694 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*7019 candidats sur 11309 portent les champs bruts (62%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 1054 candidats
  - AVEC connectivite (414) : resistance **41.3%**
  - SANS connectivite (640) : resistance **21.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 1054 candidats
  - AVEC connectivite (414) : T0=13.02 T1=0.00 T2=3.01 — pondere **6.01**
  - SANS connectivite (640) : T0=15.83 T1=0.00 T2=2.64 — pondere **5.28**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
...
- TROP-CHER : 4844 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4812 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 35193 systemes
  - sans CONNECTED : 0.0% sur 7886 systemes
