...
genere 2026-08-26 03:54 UTC — 22142 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 13168 systemes
...
| connect | 4 | 3 | 11131 | 5591 | 735 | 385 | 1073 | 893 | 1197 | 1116 | 10.0% |
...
- candidats AVEC connectivite : 1119, dont T2 : 100%
...
- **1197 systemes avec CONNECTED sur 9173 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1624 candidats
  - AVEC connectivite (640) : T0=13.35 T1=0.00 T2=2.85 — pondere **5.70**
...
- TROP-CHER : 1201 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 1197 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 9116 systemes
  - sans CONNECTED : 0.0% sur 2015 systemes
