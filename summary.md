...
genere 2026-08-27 16:55 UTC — 106250 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 22906 systemes
...
- moteur actif `0caa9267db60` (62508 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 50573 | 25175 | 3496 | 1732 | 5021 | 4005 | 5336 | 5154 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 49562 | 11459 | 21035 | 25 | 6838 | 2591 | 23 | 7589 | 15.3% |
...
- candidats AVEC connectivite : 5281, dont T2 : 100%
- candidats SANS connectivite : 7899, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5610 systemes avec CONNECTED sur 43805 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*8890 candidats sur 13180 portent les champs bruts (67%).*
...
- `5c556c16ea8b` — 2925 candidats
  - AVEC connectivite (1153) : resistance **41.9%**
  - SANS connectivite (1772) : resistance **22.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 2925 candidats
  - AVEC connectivite (1153) : T0=13.01 T1=0.00 T2=3.06 — pondere **6.12**
  - SANS connectivite (1772) : T0=15.78 T1=0.00 T2=2.69 — pondere **5.37**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 2280 candidats
...
- TROP-CHER : 5643 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 5610 avec CONNECTED, 33 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 41304 systemes
  - sans CONNECTED : 0.0% sur 9269 systemes
