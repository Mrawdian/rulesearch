...
genere 2026-08-29 11:15 UTC — 180860 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 97516 systemes
...
- moteur actif `0caa9267db60` (137118 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 88265 | 43874 | 6004 | 2990 | 8872 | 7035 | 9274 | 9092 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 86480 | 20196 | 36530 | 40 | 11944 | 4424 | 35 | 13305 | 15.4% |
...
- candidats AVEC connectivite : 9219, dont T2 : 100%
...
- **9548 systemes avec CONNECTED sur 74514 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*18544 candidats sur 22834 portent les champs bruts (81%).*

- `5c556c16ea8b` — 12579 candidats
  - AVEC connectivite (5091) : resistance **41.2%**
...
- `5c556c16ea8b` — 12579 candidats
  - AVEC connectivite (5091) : T0=12.99 T1=0.00 T2=3.00 — pondere **5.99**
...
- TROP-CHER : 9593 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 9548 avec CONNECTED, 45 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 72013 systemes
  - sans CONNECTED : 0.0% sur 16252 systemes
