...
genere 2026-08-28 18:03 UTC — 152166 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 68822 systemes
...
- moteur actif `0caa9267db60` (108424 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 73757 | 36629 | 5028 | 2522 | 7404 | 5880 | 7784 | 7570 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 72294 | 16789 | 30571 | 33 | 9981 | 3726 | 31 | 11160 | 15.4% |
...
- candidats AVEC connectivite : 7697, dont T2 : 100%
- candidats SANS connectivite : 11470, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8058 systemes avec CONNECTED sur 62664 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*14877 candidats sur 19167 portent les champs bruts (78%).*

- `5c556c16ea8b` — 8912 candidats
  - AVEC connectivite (3569) : resistance **41.1%**
  - SANS connectivite (5343) : resistance **21.7%**
...
- `5c556c16ea8b` — 8912 candidats
  - AVEC connectivite (3569) : T0=13.03 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (5343) : T0=15.89 T1=0.00 T2=2.68 — pondere **5.36**
...
- TROP-CHER : 8099 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8058 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 60163 systemes
  - sans CONNECTED : 0.0% sur 13594 systemes
