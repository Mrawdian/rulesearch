...
genere 2026-08-26 18:30 UTC — 58489 systemes evalues
...
- moteur actif `0caa9267db60` (14747 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 26463 | 13185 | 1805 | 895 | 2626 | 2092 | 2820 | 2714 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 25911 | 5958 | 10991 | 15 | 3614 | 1329 | 10 | 3994 | 15.4% |
...
- candidats AVEC connectivite : 2841, dont T2 : 100%
- candidats SANS connectivite : 4304, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3094 systemes avec CONNECTED sur 24141 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2855 candidats sur 7145 portent les champs bruts (40%).*
...
- `0a74109317e5` — 80 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `8f22f0d2d442` — 51 candidats
  - AVEC connectivite (18) : resistance **42.4%**
  - SANS connectivite (33) : resistance **17.7%**
...
- `8f22f0d2d442` — 51 candidats
  - AVEC connectivite (18) : T0=13.33 T1=0.00 T2=2.83 — pondere **5.67**
  - SANS connectivite (33) : T0=16.03 T1=0.00 T2=2.42 — pondere **4.85**
...
- TROP-CHER : 3114 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3094 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 21640 systemes
  - sans CONNECTED : 0.0% sur 4823 systemes
