...
genere 2026-08-30 07:49 UTC — 211785 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 128441 systemes
...
- moteur actif `0caa9267db60` (168043 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 103896 | 51584 | 7072 | 3468 | 10482 | 8278 | 10981 | 10679 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 101774 | 23733 | 42977 | 47 | 14039 | 5264 | 40 | 15666 | 15.4% |
...
- candidats AVEC connectivite : 10806, dont T2 : 100%
- candidats SANS connectivite : 15976, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11255 systemes avec CONNECTED sur 87240 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*22492 candidats sur 26782 portent les champs bruts (84%).*

- `5c556c16ea8b` — 16527 candidats
  - AVEC connectivite (6678) : resistance **41.1%**
  - SANS connectivite (9849) : resistance **21.5%**
...
- `5c556c16ea8b` — 16527 candidats
  - AVEC connectivite (6678) : T0=13.01 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (9849) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 11305 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11255 avec CONNECTED, 50 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 84739 systemes
  - sans CONNECTED : 0.0% sur 19157 systemes
