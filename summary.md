...
genere 2026-08-26 14:06 UTC — 48125 systemes evalues
...
- moteur actif `0caa9267db60` (4383 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21231 | 10595 | 1410 | 731 | 2102 | 1687 | 2270 | 2167 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20779 | 4847 | 8771 | 13 | 2884 | 1075 | 7 | 3182 | 15.3% |
...
- candidats AVEC connectivite : 2294, dont T2 : 100%
- candidats SANS connectivite : 3492, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2544 systemes avec CONNECTED sur 19845 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1496 candidats sur 5786 portent les champs bruts (26%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 381 candidats
  - AVEC connectivite (156) : resistance **39.3%**
  - SANS connectivite (225) : resistance **21.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 381 candidats
  - AVEC connectivite (156) : T0=13.38 T1=0.00 T2=2.93 — pondere **5.86**
  - SANS connectivite (225) : T0=16.09 T1=0.00 T2=2.69 — pondere **5.39**
...
- TROP-CHER : 2561 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2544 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17344 systemes
  - sans CONNECTED : 0.0% sur 3887 systemes
