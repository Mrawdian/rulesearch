...
genere 2026-08-30 23:36 UTC — 234142 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 150798 systemes
...
- moteur actif `0caa9267db60` (190400 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 115193 | 57273 | 7826 | 3871 | 11567 | 9105 | 12192 | 11845 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 112834 | 26316 | 47684 | 53 | 15569 | 5829 | 50 | 17323 | 15.4% |
...
- candidats SANS connectivite : 17633, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12466 systemes avec CONNECTED sur 96571 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*25315 candidats sur 29605 portent les champs bruts (86%).*

- `5c556c16ea8b` — 19350 candidats
  - AVEC connectivite (7844) : resistance **41.0%**
  - SANS connectivite (11506) : resistance **21.4%**
...
- `5c556c16ea8b` — 19350 candidats
  ...
  - SANS connectivite (11506) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 12526 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 12466 avec CONNECTED, 60 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 94070 systemes
  - sans CONNECTED : 0.0% sur 21123 systemes
