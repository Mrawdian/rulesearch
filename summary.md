...
genere 2026-08-27 09:01 UTC — 90430 systemes evalues
...
- moteur actif `0caa9267db60` (46688 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 42600 | 21214 | 2924 | 1440 | 4259 | 3345 | 4488 | 4377 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 41715 | 9625 | 17717 | 24 | 5776 | 2174 | 22 | 6377 | 15.3% |
...
- candidats AVEC connectivite : 4504, dont T2 : 100%
- candidats SANS connectivite : 6687, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4762 systemes avec CONNECTED sur 37311 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6901 candidats sur 11191 portent les champs bruts (62%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 936 candidats
  - AVEC connectivite (376) : resistance **41.1%**
  - SANS connectivite (560) : resistance **21.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 936 candidats
  - AVEC connectivite (376) : T0=13.08 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (560) : T0=15.87 T1=0.00 T2=2.65 — pondere **5.30**
  - test de permutation : **p = 0.0030** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 798 candidats
...
**7 serie(s) reproductible(s) sur 14 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `ab89a63b01ef` (p=0.0005), `06fe04a859f1` (p=0.0005), `5c556c16ea8b` (p=0.0030), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
...
- TROP-CHER : 4794 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4762 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 34810 systemes
  - sans CONNECTED : 0.0% sur 7790 systemes
