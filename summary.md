...
genere 2026-08-26 12:33 UTC — 44107 systemes evalues
...
| connect | 4 | 3 | 19203 | 9577 | 1254 | 669 | 1915 | 1527 | 2076 | 1948 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 18789 | 4408 | 7919 | 13 | 2587 | 978 | 7 | 2877 | 15.3% |
...
- candidats AVEC connectivite : 2075, dont T2 : 100%
- candidats SANS connectivite : 3187, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2350 systemes avec CONNECTED sur 18179 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*972 candidats sur 5262 portent les champs bruts (18%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `e40600351a72` — 51 candidats
  - AVEC connectivite (24) : resistance **36.3%**
  - SANS connectivite (27) : resistance **20.8%**
...
- `e40600351a72` — 51 candidats
  - AVEC connectivite (24) : T0=13.50 T1=0.00 T2=2.92 — pondere **5.83**
  - SANS connectivite (27) : T0=17.26 T1=0.00 T2=2.63 — pondere **5.26**
  - test de permutation : **p = 0.5382** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 2367 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2350 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 15678 systemes
  - sans CONNECTED : 0.0% sur 3525 systemes
