...
genere 2026-08-31 16:22 UTC — 256972 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 173628 systemes
...
- moteur actif `0caa9267db60` (213230 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 126711 | 63003 | 8570 | 4248 | 12803 | 10022 | 13367 | 13039 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 124146 | 28925 | 52431 | 55 | 17203 | 6416 | 56 | 19050 | 15.3% |
...
- candidats AVEC connectivite : 13166, dont T2 : 100%
- candidats SANS connectivite : 19360, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13641 systemes avec CONNECTED sur 105888 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*28236 candidats sur 32526 portent les champs bruts (87%).*

- `5c556c16ea8b` — 22271 candidats
  - AVEC connectivite (9038) : resistance **41.0%**
  - SANS connectivite (13233) : resistance **21.3%**
...
- `5c556c16ea8b` — 22271 candidats
  - AVEC connectivite (9038) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.97**
  - SANS connectivite (13233) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 103387 systemes
  - sans CONNECTED : 0.0% sur 23324 systemes
