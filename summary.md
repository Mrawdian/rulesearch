...
| connect | 4 | 3 | 7607 | 3831 | 499 | 265 | 727 | 609 | 802 | 789 | 10.4% |
...
- candidats AVEC connectivite : 792, dont T2 : 100%
...
- **802 systemes avec CONNECTED sur 6297 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 796 candidats
  - AVEC connectivite (313) : T0=13.35 T1=0.00 T2=2.89 — pondere **5.79**
...
- TROP-CHER : 804 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 802 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 6240 systemes
  - sans CONNECTED : 0.0% sur 1367 systemes
