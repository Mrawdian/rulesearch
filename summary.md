...
genere 2026-09-03 13:11 UTC — 339217 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 255873 systemes
...
- moteur actif `0caa9267db60` (295475 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 168214 | 83608 | 11407 | 5632 | 17124 | 13275 | 17814 | 17201 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 164888 | 38369 | 69713 | 66 | 22879 | 8509 | 66 | 25274 | 15.3% |
...
- candidats AVEC connectivite : 17328, dont T2 : 100%
- candidats SANS connectivite : 25584, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18088 systemes avec CONNECTED sur 139746 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*38622 candidats sur 42912 portent les champs bruts (90%).*

- `5c556c16ea8b` — 32657 candidats
  - AVEC connectivite (13200) : resistance **41.1%**
  - SANS connectivite (19457) : resistance **21.2%**
...
- `5c556c16ea8b` — 32657 candidats
  - AVEC connectivite (13200) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (19457) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.29**
...
## cout
- temps total 105.2 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 18164 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18088 avec CONNECTED, 76 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 137245 systemes
  - sans CONNECTED : 0.0% sur 30969 systemes
