...
genere 2026-08-26 10:41 UTC — 39351 systemes evalues
...
- `e3baecf8377b` : 758 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
**8224 enregistrements (21%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| ref | 4 | 3 | 16439 | 3875 | 6962 | 11 | 2242 | 827 | 7 | 2515 | 15.3% |
...
- candidats SANS connectivite : 2825, dont T2 : 100%
...
*361 candidats sur 4651 portent les champs bruts (8%).*
...
- `e3baecf8377b` — 97 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (43) : resistance **40.0%**
  - SANS connectivite (54) : resistance **19.1%**
...
- `e3baecf8377b` — 97 candidats
  - AVEC connectivite (43) : T0=13.37 T1=0.00 T2=2.95 — pondere **5.91**
  - SANS connectivite (54) : T0=15.78 T1=0.00 T2=2.43 — pondere **4.85**
