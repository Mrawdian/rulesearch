...
genere 2026-09-06 08:00 UTC — 408577 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 325233 systemes
...
- moteur actif `0caa9267db60` (364835 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 203244 | 100915 | 13862 | 6765 | 20611 | 15968 | 21600 | 20934 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 199218 | 46309 | 84074 | 78 | 27754 | 10300 | 73 | 30613 | 15.4% |
...
- candidats AVEC connectivite : 21061, dont T2 : 100%
- candidats SANS connectivite : 30923, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21874 systemes avec CONNECTED sur 168356 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*47694 candidats sur 51984 portent les champs bruts (92%).*

- `5c556c16ea8b` — 41729 candidats
  - AVEC connectivite (16933) : resistance **41.1%**
  - SANS connectivite (24796) : resistance **21.3%**
...
- `5c556c16ea8b` — 41729 candidats
  - AVEC connectivite (16933) : T0=13.00 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (24796) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 21957 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21874 avec CONNECTED, 83 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 165855 systemes
  - sans CONNECTED : 0.0% sur 37389 systemes
