...
genere 2026-08-28 16:01 UTC — 148602 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 65258 systemes
...
- moteur actif `0caa9267db60` (104860 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 71967 | 35735 | 4919 | 2453 | 7221 | 5737 | 7603 | 7381 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 70520 | 16377 | 29799 | 32 | 9746 | 3637 | 31 | 10895 | 15.4% |
...
- candidats AVEC connectivite : 7508, dont T2 : 100%
- candidats SANS connectivite : 11205, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7877 systemes avec CONNECTED sur 61202 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*14423 candidats sur 18713 portent les champs bruts (77%).*

- `5c556c16ea8b` — 8458 candidats
  - AVEC connectivite (3380) : resistance **41.2%**
  - SANS connectivite (5078) : resistance **21.8%**
...
- `5c556c16ea8b` — 8458 candidats
  - AVEC connectivite (3380) : T0=13.02 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (5078) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.36**
...
- TROP-CHER : 7918 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7877 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 58701 systemes
  - sans CONNECTED : 0.0% sur 13266 systemes
