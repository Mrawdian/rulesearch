...
genere 2026-08-27 06:34 UTC — 85177 systemes evalues
...
- moteur actif `0caa9267db60` (41435 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 39943 | 19902 | 2732 | 1358 | 3975 | 3142 | 4221 | 4097 | 10.3% |
...
- candidats AVEC connectivite : 4224, dont T2 : 100%
- candidats SANS connectivite : 6272, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4495 systemes avec CONNECTED sur 35169 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6206 candidats sur 10496 portent les champs bruts (59%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 241 candidats
  - AVEC connectivite (96) : resistance **42.6%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 241 candidats
  - AVEC connectivite (96) : T0=12.73 T1=0.00 T2=3.10 — pondere **6.21**
  - SANS connectivite (145) : T0=15.86 T1=0.00 T2=2.67 — pondere **5.34**
  - test de permutation : **p = 0.0360** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `23303c299f39` — 225 candidats
...
**7 serie(s) reproductible(s) sur 14 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `ab89a63b01ef` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `5c556c16ea8b` (p=0.0360), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 32668 systemes
  - sans CONNECTED : 0.0% sur 7275 systemes
