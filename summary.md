...
genere 2026-08-26 21:27 UTC — 65071 systemes evalues
...
- `ab89a63b01ef` : 164 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (21329 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
**7690 enregistrements (12%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 29800 | 14804 | 2034 | 998 | 2983 | 2364 | 3179 | 3060 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 29156 | 6723 | 12375 | 16 | 4040 | 1504 | 12 | 4486 | 15.4% |
...
- candidats AVEC connectivite : 3187, dont T2 : 100%
- candidats SANS connectivite : 4796, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3453 systemes avec CONNECTED sur 26868 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3693 candidats sur 7983 portent les champs bruts (46%).*
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24367 systemes
  - sans CONNECTED : 0.0% sur 5433 systemes
