...
| connect | 4 | 3 | 18442 | 9206 | 1196 | 640 | 1840 | 1466 | 2003 | 1861 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 18044 | 4254 | 7600 | 13 | 2470 | 930 | 7 | 2770 | 15.4% |
...
- candidats AVEC connectivite : 1988, dont T2 : 100%
- candidats SANS connectivite : 3080, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2277 systemes avec CONNECTED sur 17557 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*778 candidats sur 5068 portent les champs bruts (15%).*
...
- `e3baecf8377b` — 514 candidats
  - AVEC connectivite (205) : resistance **42.4%**
  - SANS connectivite (309) : resistance **21.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 514 candidats
  - AVEC connectivite (205) : T0=13.04 T1=0.00 T2=3.10 — pondere **6.20**
  - SANS connectivite (309) : T0=16.04 T1=0.00 T2=2.69 — pondere **5.37**
...
- TROP-CHER : 2294 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 2277 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 15056 systemes
  - sans CONNECTED : 0.0% sur 3386 systemes
