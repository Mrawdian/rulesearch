...
genere 2026-09-01 22:08 UTC — 294212 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 210868 systemes
...
- moteur actif `0caa9267db60` (250470 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 145501 | 72255 | 9889 | 4880 | 14783 | 11472 | 15392 | 14955 | 10.3% |
...
- candidats AVEC connectivite : 15082, dont T2 : 100%
...
- **15666 systemes avec CONNECTED sur 121240 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*32960 candidats sur 37250 portent les champs bruts (88%).*

- `5c556c16ea8b` — 26995 candidats
  - AVEC connectivite (10954) : resistance **41.0%**
...
- `5c556c16ea8b` — 26995 candidats
  - AVEC connectivite (10954) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 15739 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15666 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 118739 systemes
  - sans CONNECTED : 0.0% sur 26762 systemes
