...
genere 2026-08-26 23:24 UTC — 69368 systemes evalues
...
- moteur actif `0caa9267db60` (25626 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 31967 | 15887 | 2197 | 1072 | 3183 | 2547 | 3411 | 3265 | 10.2% |
...
- candidats AVEC connectivite : 3392, dont T2 : 100%
- candidats SANS connectivite : 5102, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3685 systemes avec CONNECTED sur 28634 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4204 candidats sur 8494 portent les champs bruts (49%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 527 candidats
  - AVEC connectivite (212) : resistance **42.0%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 527 candidats
  - AVEC connectivite (212) : T0=12.95 T1=0.00 T2=3.08 — pondere **6.17**
...
- TROP-CHER : 3709 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3685 avec CONNECTED, 24 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 26133 systemes
  - sans CONNECTED : 0.0% sur 5834 systemes
