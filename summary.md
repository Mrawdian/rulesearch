...
genere 2026-08-26 13:14 UTC — 46069 systemes evalues
...
- moteur actif `0caa9267db60` (2327 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20187 | 10075 | 1324 | 694 | 2024 | 1604 | 2160 | 2057 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 19767 | 4630 | 8352 | 13 | 2730 | 1022 | 7 | 3013 | 15.2% |
...
- candidats AVEC connectivite : 2184, dont T2 : 100%
- candidats SANS connectivite : 3323, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2434 systemes avec CONNECTED sur 18969 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1217 candidats sur 5507 portent les champs bruts (22%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 102 candidats
  - AVEC connectivite (46) : resistance **37.9%**
  - SANS connectivite (56) : resistance **21.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 102 candidats
  - AVEC connectivite (46) : T0=13.22 T1=0.00 T2=2.74 — pondere **5.48**
  - SANS connectivite (56) : T0=16.86 T1=0.00 T2=2.88 — pondere **5.75**
  - test de permutation : **p = 0.6947** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 2451 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2434 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16468 systemes
  - sans CONNECTED : 0.0% sur 3719 systemes
