...
genere 2026-09-06 00:51 UTC — 401704 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 318360 systemes
...
- moteur actif `0caa9267db60` (357962 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 199767 | 99178 | 13602 | 6657 | 20295 | 15725 | 21200 | 20567 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 195822 | 45549 | 82612 | 78 | 27288 | 10117 | 72 | 30089 | 15.4% |
...
- candidats SANS connectivite : 30399, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21474 systemes avec CONNECTED sur 165483 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*46803 candidats sur 51093 portent les champs bruts (92%).*

- `5c556c16ea8b` — 40838 candidats
  - AVEC connectivite (16566) : resistance **41.0%**
  - SANS connectivite (24272) : resistance **21.3%**
...
- `5c556c16ea8b` — 40838 candidats
  ...
  - SANS connectivite (24272) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 21556 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21474 avec CONNECTED, 82 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 162982 systemes
  - sans CONNECTED : 0.0% sur 36785 systemes
