...
genere 2026-09-09 20:27 UTC — 485630 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 402286 systemes
...
- moteur actif `0caa9267db60` (441888 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 242160 | 120241 | 16508 | 8109 | 24501 | 18997 | 25797 | 24935 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 237355 | 55331 | 99996 | 94 | 33053 | 12263 | 87 | 36510 | 15.4% |
...
- candidats AVEC connectivite : 25062, dont T2 : 100%
- candidats SANS connectivite : 36820, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **26071 systemes avec CONNECTED sur 200204 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*57592 candidats sur 61882 portent les champs bruts (93%).*

- `5c556c16ea8b` — 51627 candidats
  - AVEC connectivite (20934) : resistance **41.2%**
  - SANS connectivite (30693) : resistance **21.3%**
...
- `5c556c16ea8b` — 51627 candidats
  - AVEC connectivite (20934) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (30693) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 26168 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 26071 avec CONNECTED, 97 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 197703 systemes
  - sans CONNECTED : 0.0% sur 44457 systemes
