...
genere 2026-09-04 15:43 UTC — 368083 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 284739 systemes
...
- moteur actif `0caa9267db60` (324341 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 182792 | 90857 | 12426 | 6107 | 18614 | 14400 | 19343 | 18703 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 179176 | 41645 | 75710 | 74 | 24891 | 9275 | 70 | 27497 | 15.3% |
...
- candidats AVEC connectivite : 18830, dont T2 : 100%
- candidats SANS connectivite : 27807, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19617 systemes avec CONNECTED sur 151600 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*42347 candidats sur 46637 portent les champs bruts (91%).*

- `5c556c16ea8b` — 36382 candidats
  - AVEC connectivite (14702) : resistance **41.0%**
  - SANS connectivite (21680) : resistance **21.2%**
...
- `5c556c16ea8b` — 36382 candidats
  - AVEC connectivite (14702) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (21680) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 19697 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19617 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 149099 systemes
  - sans CONNECTED : 0.0% sur 33693 systemes
