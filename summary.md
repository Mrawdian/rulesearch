...
genere 2026-09-05 18:19 UTC — 395219 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 311875 systemes
...
- moteur actif `0caa9267db60` (351477 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 196500 | 97561 | 13376 | 6552 | 19981 | 15465 | 20843 | 20224 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 192604 | 44825 | 81264 | 78 | 26817 | 9961 | 71 | 29574 | 15.4% |
...
- candidats AVEC connectivite : 20351, dont T2 : 100%
- candidats SANS connectivite : 29884, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21117 systemes avec CONNECTED sur 162804 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*45945 candidats sur 50235 portent les champs bruts (91%).*

- `5c556c16ea8b` — 39980 candidats
  - AVEC connectivite (16223) : resistance **41.1%**
  - SANS connectivite (23757) : resistance **21.3%**
...
- `5c556c16ea8b` — 39980 candidats
  - AVEC connectivite (16223) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (23757) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 21198 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21117 avec CONNECTED, 81 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 160303 systemes
  - sans CONNECTED : 0.0% sur 36197 systemes
