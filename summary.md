...
genere 2026-08-26 14:09 UTC — 48273 systemes evalues
...
- moteur actif `0caa9267db60` (4531 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21306 | 10635 | 1415 | 732 | 2107 | 1693 | 2276 | 2178 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20852 | 4861 | 8798 | 13 | 2893 | 1079 | 7 | 3201 | 15.4% |
...
- candidats AVEC connectivite : 2305, dont T2 : 100%
- candidats SANS connectivite : 3511, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2550 systemes avec CONNECTED sur 19910 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1526 candidats sur 5816 portent les champs bruts (26%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 411 candidats
  - AVEC connectivite (167) : resistance **39.8%**
  - SANS connectivite (244) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 411 candidats
  - AVEC connectivite (167) : T0=13.43 T1=0.00 T2=2.95 — pondere **5.90**
  - SANS connectivite (244) : T0=16.05 T1=0.00 T2=2.66 — pondere **5.32**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17409 systemes
  - sans CONNECTED : 0.0% sur 3897 systemes
