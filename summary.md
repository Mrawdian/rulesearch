...
| connect | 4 | 3 | 6590 | 3317 | 426 | 236 | 632 | 532 | 685 | 685 | 10.4% |
| ref | 4 | 3 | 6445 | 1569 | 2667 | 1 | 863 | 318 | 2 | 1025 | 15.9% |
...
- candidats AVEC connectivite : 688, dont T2 : 100%
- candidats SANS connectivite : 1029, dont T2 : 100%
...
- **685 systemes avec CONNECTED sur 5458 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 552 candidats
  - AVEC connectivite (209) : T0=13.19 T1=0.00 T2=2.97 — pondere **5.94**
  - SANS connectivite (343) : T0=15.82 T1=0.00 T2=2.63 — pondere **5.27**
...
- TROP-CHER : 687 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 685 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 5401 systemes
  - sans CONNECTED : 0.0% sur 1189 systemes
