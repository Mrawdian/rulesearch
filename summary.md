...
genere 2026-08-29 11:50 UTC — 181762 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 98418 systemes
...
- moteur actif `0caa9267db60` (138020 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 88713 | 44090 | 6034 | 3001 | 8922 | 7083 | 9324 | 9129 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 86934 | 20315 | 36719 | 42 | 11999 | 4452 | 35 | 13366 | 15.4% |
...
- candidats SANS connectivite : 13676, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9598 systemes avec CONNECTED sur 74862 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*18642 candidats sur 22932 portent les champs bruts (81%).*

- `5c556c16ea8b` — 12677 candidats
  - AVEC connectivite (5128) : resistance **41.2%**
  - SANS connectivite (7549) : resistance **21.5%**
...
- `5c556c16ea8b` — 12677 candidats
  ...
  - SANS connectivite (7549) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 72361 systemes
  - sans CONNECTED : 0.0% sur 16352 systemes
