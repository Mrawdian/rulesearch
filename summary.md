...
genere 2026-09-07 03:42 UTC — 427491 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 344147 systemes
...
- moteur actif `0caa9267db60` (383749 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 212791 | 105646 | 14489 | 7081 | 21587 | 16734 | 22624 | 21923 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 208585 | 48550 | 87947 | 81 | 29077 | 10770 | 75 | 32067 | 15.4% |
...
- candidats AVEC connectivite : 22050, dont T2 : 100%
- candidats SANS connectivite : 32377, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **22898 systemes avec CONNECTED sur 176147 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*50137 candidats sur 54427 portent les champs bruts (92%).*

- `5c556c16ea8b` — 44172 candidats
  - AVEC connectivite (17922) : resistance **41.1%**
  - SANS connectivite (26250) : resistance **21.3%**
...
- `5c556c16ea8b` — 44172 candidats
  - AVEC connectivite (17922) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (26250) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
## cout
- temps total 133.1 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 22983 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 22898 avec CONNECTED, 85 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 173646 systemes
  - sans CONNECTED : 0.0% sur 39145 systemes
