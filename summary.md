...
genere 2026-08-26 13:56 UTC — 47797 systemes evalues
...
- moteur actif `0caa9267db60` (4055 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21066 | 10515 | 1394 | 726 | 2089 | 1674 | 2249 | 2155 | 10.2% |
...
- candidats AVEC connectivite : 2282, dont T2 : 100%
- candidats SANS connectivite : 3466, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2523 systemes avec CONNECTED sur 19709 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1458 candidats sur 5748 portent les champs bruts (25%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 343 candidats
  - AVEC connectivite (144) : resistance **39.8%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 343 candidats
  - AVEC connectivite (144) : T0=13.36 T1=0.00 T2=2.92 — pondere **5.85**
...
- TROP-CHER : 2540 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2523 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17208 systemes
  - sans CONNECTED : 0.0% sur 3858 systemes
