...
genere 2026-08-28 19:49 UTC — 155200 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 71856 systemes
...
- moteur actif `0caa9267db60` (111458 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 75297 | 37410 | 5124 | 2563 | 7559 | 6002 | 7947 | 7739 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 73788 | 17157 | 31221 | 35 | 10169 | 3783 | 31 | 11389 | 15.4% |
...
- candidats AVEC connectivite : 7866, dont T2 : 100%
- candidats SANS connectivite : 11699, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8221 systemes avec CONNECTED sur 63923 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*15275 candidats sur 19565 portent les champs bruts (78%).*

- `5c556c16ea8b` — 9310 candidats
  - AVEC connectivite (3738) : resistance **41.1%**
  - SANS connectivite (5572) : resistance **21.7%**
...
- `5c556c16ea8b` — 9310 candidats
  - AVEC connectivite (3738) : T0=13.01 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (5572) : T0=15.90 T1=0.00 T2=2.68 — pondere **5.36**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 61422 systemes
  - sans CONNECTED : 0.0% sur 13875 systemes
