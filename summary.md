...
genere 2026-08-27 06:43 UTC — 85594 systemes evalues
...
- moteur actif `0caa9267db60` (41852 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 40152 | 19994 | 2750 | 1366 | 4005 | 3156 | 4235 | 4126 | 10.3% |
...
- **4509 systemes avec CONNECTED sur 35334 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6265 candidats sur 10555 portent les champs bruts (59%).*
...
- `5c556c16ea8b` — 300 candidats
  ...
  - test de permutation : **p = 0.0585** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- TROP-CHER : 4540 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4509 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 32833 systemes
  - sans CONNECTED : 0.0% sur 7319 systemes
