...
genere 2026-08-26 07:54 UTC — 32070 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 23096 systemes
...
**7466 enregistrements (23%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 14686 | 7331 | 962 | 509 | 1437 | 1170 | 1606 | 1482 | 10.1% |
| d4 | 4 | 4 | 2873 | 1315 | 735 | 15 | 205 | 193 | 140 | 193 | 6.7% |
| ref | 4 | 3 | 14387 | 3396 | 6039 | 9 | 1985 | 732 | 6 | 2220 | 15.4% |
...
- candidats AVEC connectivite : 1533, dont T2 : 100%
- candidats SANS connectivite : 2369, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1742 systemes avec CONNECTED sur 13259 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2737 candidats
  - AVEC connectivite (1054) : T0=13.18 T1=0.00 T2=2.90 — pondere **5.79**
  - SANS connectivite (1683) : T0=15.92 T1=0.01 T2=2.64 — pondere **5.30**
...
## cout
- temps total 10.2 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 1752 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1742 avec CONNECTED, 10 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.4% sur 12022 systemes
  - sans CONNECTED : 0.0% sur 2664 systemes
