...
genere 2026-08-26 21:11 UTC — 64431 systemes evalues
...
- moteur actif `0caa9267db60` (20689 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 29471 | 14653 | 2015 | 988 | 2940 | 2331 | 3148 | 3021 | 10.3% |
...
- candidats AVEC connectivite : 3148, dont T2 : 100%
- candidats SANS connectivite : 4741, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3422 systemes avec CONNECTED sur 26609 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3599 candidats sur 7889 portent les champs bruts (46%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 730 candidats
  - AVEC connectivite (304) : resistance **40.0%**
...
- `62448a55927e` — 730 candidats
  - AVEC connectivite (304) : T0=12.86 T1=0.00 T2=2.85 — pondere **5.70**
  - SANS connectivite (426) : T0=16.18 T1=0.00 T2=2.68 — pondere **5.36**
  - test de permutation : **p = 0.1424** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e3baecf8377b` — 657 candidats
...
- TROP-CHER : 3444 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3422 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 24108 systemes
  - sans CONNECTED : 0.0% sur 5363 systemes
