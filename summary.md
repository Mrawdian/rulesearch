...
genere 2026-09-09 04:15 UTC — 471659 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 388315 systemes
...
- moteur actif `0caa9267db60` (427917 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 235113 | 116770 | 16029 | 7874 | 23794 | 18404 | 25036 | 24219 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 230431 | 53688 | 97083 | 92 | 32106 | 11907 | 82 | 35454 | 15.4% |
...
- candidats SANS connectivite : 35764, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25310 systemes avec CONNECTED sur 194473 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55820 candidats sur 60110 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49855 candidats
  - AVEC connectivite (20218) : resistance **41.2%**
  - SANS connectivite (29637) : resistance **21.3%**
...
- `5c556c16ea8b` — 49855 candidats
  ...
  - SANS connectivite (29637) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 25402 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25310 avec CONNECTED, 92 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 191972 systemes
  - sans CONNECTED : 0.0% sur 43141 systemes
