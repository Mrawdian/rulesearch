...
genere 2026-09-08 18:37 UTC — 462872 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 379528 systemes
...
- moteur actif `0caa9267db60` (419130 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 230676 | 114584 | 15697 | 7716 | 23324 | 18075 | 24602 | 23745 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 226081 | 52657 | 95278 | 90 | 31505 | 11687 | 81 | 34765 | 15.4% |
...
- candidats SANS connectivite : 35075, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **24876 systemes avec CONNECTED sur 190882 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*54657 candidats sur 58947 portent les champs bruts (93%).*

- `5c556c16ea8b` — 48692 candidats
  - AVEC connectivite (19744) : resistance **41.2%**
  - SANS connectivite (28948) : resistance **21.3%**
...
- `5c556c16ea8b` — 48692 candidats
  ...
  - SANS connectivite (28948) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 188381 systemes
  - sans CONNECTED : 0.0% sur 42295 systemes
