...
genere 2026-09-02 21:17 UTC — 321151 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 237807 systemes
...
- moteur actif `0caa9267db60` (277409 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 159099 | 79050 | 10821 | 5315 | 16185 | 12525 | 16855 | 16311 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 155937 | 36345 | 65939 | 64 | 21553 | 8043 | 64 | 23917 | 15.3% |
...
- candidats AVEC connectivite : 16438, dont T2 : 100%
- candidats SANS connectivite : 24227, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **17129 systemes avec CONNECTED sur 132345 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*36375 candidats sur 40665 portent les champs bruts (89%).*

- `5c556c16ea8b` — 30410 candidats
  - AVEC connectivite (12310) : resistance **41.1%**
  - SANS connectivite (18100) : resistance **21.2%**
...
- `5c556c16ea8b` — 30410 candidats
  - AVEC connectivite (12310) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (18100) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.29**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 129844 systemes
  - sans CONNECTED : 0.0% sur 29255 systemes
