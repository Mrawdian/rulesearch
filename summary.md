...
genere 2026-09-07 08:08 UTC — 431637 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 348293 systemes
...
- moteur actif `0caa9267db60` (387895 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 214897 | 106726 | 14631 | 7159 | 21778 | 16871 | 22856 | 22143 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 210625 | 49035 | 88807 | 82 | 29348 | 10880 | 76 | 32379 | 15.4% |
...
- candidats AVEC connectivite : 22270, dont T2 : 100%
- candidats SANS connectivite : 32689, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23130 systemes avec CONNECTED sur 177919 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*50669 candidats sur 54959 portent les champs bruts (92%).*

- `5c556c16ea8b` — 44704 candidats
  - AVEC connectivite (18142) : resistance **41.1%**
  - SANS connectivite (26562) : resistance **21.3%**
...
- `5c556c16ea8b` — 44704 candidats
  - AVEC connectivite (18142) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (26562) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 23216 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23130 avec CONNECTED, 86 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 175418 systemes
  - sans CONNECTED : 0.0% sur 39479 systemes
