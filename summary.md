...
genere 2026-09-03 15:48 UTC — 342088 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 258744 systemes
...
- moteur actif `0caa9267db60` (298346 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 169666 | 84338 | 11506 | 5681 | 17258 | 13401 | 17975 | 17344 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 166307 | 38680 | 70291 | 67 | 23083 | 8599 | 66 | 25509 | 15.3% |
...
- candidats AVEC connectivite : 17471, dont T2 : 100%
- candidats SANS connectivite : 25819, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18249 systemes avec CONNECTED sur 140925 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39000 candidats sur 43290 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33035 candidats
  - AVEC connectivite (13343) : resistance **41.0%**
  - SANS connectivite (19692) : resistance **21.2%**
...
- `5c556c16ea8b` — 33035 candidats
  - AVEC connectivite (13343) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (19692) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.29**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 138424 systemes
  - sans CONNECTED : 0.0% sur 31242 systemes
