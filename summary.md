...
genere 2026-08-26 14:51 UTC — 49871 systemes evalues
...
- moteur actif `0caa9267db60` (6129 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22116 | 11033 | 1483 | 759 | 2193 | 1752 | 2367 | 2251 | 10.2% |
...
- candidats AVEC connectivite : 2378, dont T2 : 100%
- candidats SANS connectivite : 3645, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2641 systemes avec CONNECTED sur 20566 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1733 candidats sur 6023 portent les champs bruts (29%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 618 candidats
  - AVEC connectivite (240) : resistance **41.1%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 618 candidats
  - AVEC connectivite (240) : T0=13.38 T1=0.00 T2=3.04 — pondere **6.08**
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0090).
...
- TROP-CHER : 2660 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2641 avec CONNECTED, 19 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18065 systemes
  - sans CONNECTED : 0.0% sur 4051 systemes
