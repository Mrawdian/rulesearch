...
genere 2026-09-05 06:26 UTC — 383226 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 299882 systemes
...
- moteur actif `0caa9267db60` (339484 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 190432 | 94590 | 12966 | 6351 | 19365 | 15004 | 20187 | 19535 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 186679 | 43447 | 78823 | 77 | 25946 | 9666 | 70 | 28636 | 15.3% |
...
- candidats AVEC connectivite : 19662, dont T2 : 100%
- candidats SANS connectivite : 28946, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20461 systemes avec CONNECTED sur 157849 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*44318 candidats sur 48608 portent les champs bruts (91%).*

- `5c556c16ea8b` — 38353 candidats
  - AVEC connectivite (15534) : resistance **41.1%**
  - SANS connectivite (22819) : resistance **21.3%**
...
- `5c556c16ea8b` — 38353 candidats
  - AVEC connectivite (15534) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (22819) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 20541 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 20461 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 155348 systemes
  - sans CONNECTED : 0.0% sur 35084 systemes
