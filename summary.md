...
genere 2026-08-30 23:56 UTC — 234601 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 151257 systemes
...
- moteur actif `0caa9267db60` (190859 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 115417 | 57383 | 7833 | 3878 | 11592 | 9124 | 12217 | 11876 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 113069 | 26375 | 47784 | 53 | 15596 | 5841 | 50 | 17360 | 15.4% |
...
- candidats AVEC connectivite : 12003, dont T2 : 100%
- candidats SANS connectivite : 17670, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12491 systemes avec CONNECTED sur 96757 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*25383 candidats sur 29673 portent les champs bruts (86%).*

- `5c556c16ea8b` — 19418 candidats
  - AVEC connectivite (7875) : resistance **41.1%**
  - SANS connectivite (11543) : resistance **21.4%**
...
- `5c556c16ea8b` — 19418 candidats
  - AVEC connectivite (7875) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (11543) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.31**
...
## cout
- temps total 72.7 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 12551 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 12491 avec CONNECTED, 60 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 94256 systemes
  - sans CONNECTED : 0.0% sur 21161 systemes
