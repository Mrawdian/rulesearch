...
genere 2026-08-27 03:36 UTC — 78692 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 13785 systemes
...
- moteur actif `0caa9267db60` (34950 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 36677 | 18226 | 2530 | 1247 | 3646 | 2903 | 3892 | 3755 | 10.2% |
...
- candidats AVEC connectivite : 3882, dont T2 : 100%
- candidats SANS connectivite : 5776, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4166 systemes avec CONNECTED sur 32514 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5368 candidats sur 9658 portent les champs bruts (56%).*
...
- `ab89a63b01ef` — 1691 candidats
  - AVEC connectivite (702) : resistance **41.2%**
...
- `ab89a63b01ef` — 1691 candidats
  - AVEC connectivite (702) : T0=13.04 T1=0.00 T2=3.03 — pondere **6.06**
...
- TROP-CHER : 4195 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4166 avec CONNECTED, 29 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 30013 systemes
  - sans CONNECTED : 0.0% sur 6664 systemes
