...
genere 2026-09-06 17:50 UTC — 418087 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 334743 systemes
...
- moteur actif `0caa9267db60` (374345 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 208041 | 103285 | 14174 | 6922 | 21084 | 16384 | 22117 | 21434 | 10.3% |
...
- candidats AVEC connectivite : 21561, dont T2 : 100%
...
- **22391 systemes avec CONNECTED sur 172255 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*48927 candidats sur 53217 portent les champs bruts (92%).*

- `5c556c16ea8b` — 42962 candidats
  - AVEC connectivite (17433) : resistance **41.1%**
...
- `5c556c16ea8b` — 42962 candidats
  - AVEC connectivite (17433) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 22474 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 22391 avec CONNECTED, 83 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 169754 systemes
  - sans CONNECTED : 0.0% sur 38287 systemes
