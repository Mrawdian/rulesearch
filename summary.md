...
genere 2026-08-26 23:34 UTC — 69778 systemes evalues
...
- moteur actif `0caa9267db60` (26036 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 32177 | 16002 | 2207 | 1082 | 3206 | 2561 | 3429 | 3281 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 31486 | 7260 | 13378 | 18 | 4354 | 1645 | 14 | 4817 | 15.3% |
...
- candidats AVEC connectivite : 3408, dont T2 : 100%
- candidats SANS connectivite : 5127, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3703 systemes avec CONNECTED sur 28807 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4245 candidats sur 8535 portent les champs bruts (50%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 568 candidats
  - AVEC connectivite (228) : resistance **42.4%**
  - SANS connectivite (340) : resistance **22.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 568 candidats
  - AVEC connectivite (228) : T0=13.07 T1=0.00 T2=3.13 — pondere **6.25**
  - SANS connectivite (340) : T0=16.03 T1=0.00 T2=2.66 — pondere **5.32**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `23303c299f39` — 225 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 26306 systemes
  - sans CONNECTED : 0.0% sur 5871 systemes
