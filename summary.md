...
genere 2026-08-30 01:37 UTC — 202920 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 119576 systemes
...
- moteur actif `0caa9267db60` (159178 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 99415 | 49333 | 6770 | 3334 | 10034 | 7937 | 10465 | 10246 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 97390 | 22713 | 41116 | 45 | 13475 | 5023 | 37 | 14974 | 15.4% |
...
- candidats AVEC connectivite : 10373, dont T2 : 100%
- candidats SANS connectivite : 15284, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10739 systemes avec CONNECTED sur 83560 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*21367 candidats sur 25657 portent les champs bruts (83%).*

- `5c556c16ea8b` — 15402 candidats
  - AVEC connectivite (6245) : resistance **41.1%**
  - SANS connectivite (9157) : resistance **21.5%**
...
- `5c556c16ea8b` — 15402 candidats
  - AVEC connectivite (6245) : T0=13.01 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (9157) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 10786 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10739 avec CONNECTED, 47 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 81059 systemes
  - sans CONNECTED : 0.0% sur 18356 systemes
