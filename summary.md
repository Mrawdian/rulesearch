...
genere 2026-08-26 18:24 UTC — 58221 systemes evalues
...
- `8f22f0d2d442` : 120 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (14479 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 26328 | 13119 | 1790 | 892 | 2612 | 2080 | 2809 | 2701 | 10.3% |
...
- candidats AVEC connectivite : 2828, dont T2 : 100%
- candidats SANS connectivite : 4287, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3083 systemes avec CONNECTED sur 24032 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2825 candidats sur 7115 portent les champs bruts (40%).*
...
- `84fba70921e0` — 33 candidats
  ...
  - *groupes trop petits (< 20) — aucun test*
- `8f22f0d2d442` — 21 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (5) : resistance **33.4%**
...
- `84fba70921e0` — 33 candidats
  ...
  - *groupes trop petits (< 20) — aucun test, aucune conclusion*
- `8f22f0d2d442` — 21 candidats
  - AVEC connectivite (5) : T0=13.60 T1=0.00 T2=2.20 — pondere **4.40**
...
- TROP-CHER : 3103 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3083 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 21531 systemes
  - sans CONNECTED : 0.0% sur 4797 systemes
