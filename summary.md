...
**7466 enregistrements (76%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 4914 | 2465 | 308 | 173 | 478 | 399 | 517 | 516 | 10.5% |
| ref | 4 | 3 | 4795 | 1168 | 2011 | 1 | 629 | 232 | 2 | 752 | 15.7% |
...
- candidats AVEC connectivite : 519, dont T2 : 100%
- candidats SANS connectivite : 756, dont T2 : 100%
...
- **517 systemes avec CONNECTED sur 4080 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 110 candidats
  - AVEC connectivite (40) : T0=12.55 T1=0.00 T2=3.02 — pondere **6.05**
  - SANS connectivite (70) : T0=15.84 T1=0.00 T2=2.79 — pondere **5.57**
...
- TROP-CHER : 519 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 517 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 4023 systemes
  - sans CONNECTED : 0.0% sur 891 systemes
