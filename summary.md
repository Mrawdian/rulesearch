...
genere 2026-08-27 05:03 UTC — 82096 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 17189 systemes
...
- moteur actif `0caa9267db60` (38354 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 38392 | 19120 | 2643 | 1315 | 3815 | 3012 | 4046 | 3943 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 37589 | 8679 | 15979 | 21 | 5209 | 1955 | 20 | 5726 | 15.2% |
...
- candidats AVEC connectivite : 4070, dont T2 : 100%
- candidats SANS connectivite : 6036, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4320 systemes avec CONNECTED sur 33914 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5816 candidats sur 10106 portent les champs bruts (58%).*
...
- `ab89a63b01ef` — 2139 candidats
  - AVEC connectivite (890) : resistance **41.5%**
...
- `ab89a63b01ef` — 2139 candidats
  - AVEC connectivite (890) : T0=13.03 T1=0.00 T2=3.04 — pondere **6.08**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 31413 systemes
  - sans CONNECTED : 0.0% sur 6979 systemes
