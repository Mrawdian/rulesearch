...
| connect | 4 | 3 | 18756 | 9358 | 1220 | 651 | 1869 | 1495 | 2035 | 1895 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 18354 | 4313 | 7734 | 13 | 2522 | 947 | 7 | 2818 | 15.4% |
...
- candidats AVEC connectivite : 2022, dont T2 : 100%
- candidats SANS connectivite : 3128, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2309 systemes avec CONNECTED sur 17808 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*860 candidats sur 5150 portent les champs bruts (17%).*
...
- `e3baecf8377b` — 596 candidats
  - AVEC connectivite (239) : resistance **42.1%**
  - SANS connectivite (357) : resistance **21.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 596 candidats
  - AVEC connectivite (239) : T0=13.10 T1=0.00 T2=3.09 — pondere **6.18**
  - SANS connectivite (357) : T0=15.97 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 15307 systemes
  - sans CONNECTED : 0.0% sur 3449 systemes
