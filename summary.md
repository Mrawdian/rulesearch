...
genere 2026-08-28 00:43 UTC — 121354 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 38010 systemes
...
- moteur actif `0caa9267db60` (77612 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 58198 | 28993 | 4026 | 1965 | 5777 | 4603 | 6131 | 5956 | 10.2% |
...
- candidats AVEC connectivite : 6083, dont T2 : 100%
- candidats SANS connectivite : 9047, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6405 systemes avec CONNECTED sur 50032 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10840 candidats sur 15130 portent les champs bruts (72%).*

- `5c556c16ea8b` — 4875 candidats
  - AVEC connectivite (1955) : resistance **42.0%**
...
- `5c556c16ea8b` — 4875 candidats
  - AVEC connectivite (1955) : T0=12.99 T1=0.00 T2=3.06 — pondere **6.11**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 47531 systemes
  - sans CONNECTED : 0.0% sur 10667 systemes
