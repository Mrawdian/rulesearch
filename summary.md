...
genere 2026-08-27 01:51 UTC — 74877 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 9970 systemes
...
- moteur actif `0caa9267db60` (31135 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 34748 | 17293 | 2392 | 1177 | 3446 | 2763 | 3693 | 3540 | 10.2% |
...
- candidats AVEC connectivite : 3667, dont T2 : 100%
- candidats SANS connectivite : 5495, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3967 systemes avec CONNECTED sur 30926 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4872 candidats sur 9162 portent les champs bruts (53%).*
...
- `ab89a63b01ef` — 1195 candidats
  - AVEC connectivite (487) : T0=13.03 T1=0.00 T2=3.04 — pondere **6.07**
...
- TROP-CHER : 3995 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3967 avec CONNECTED, 28 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 28425 systemes
  - sans CONNECTED : 0.0% sur 6323 systemes
