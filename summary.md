...
genere 2026-08-25 21:08 UTC — 4842 systemes evalues

## versions du DSL presentes
- `615abe43d6bc` : 3865 systemes
...
| connect | 4 | 3 | 2387 | 1195 | 164 | 86 | 240 | 180 | 239 | 254 | 10.6% |
...
- candidats AVEC connectivite : 257, dont T2 : 100%
- candidats SANS connectivite : 376, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **239 systemes avec CONNECTED sur 2010 (11.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- TROP-CHER : 240 systemes abandonnes (5.0% des systemes), 95% du temps total
  dont 239 avec CONNECTED, 1 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.2% sur 1953 systemes
  - sans CONNECTED : 0.0% sur 434 systemes
