...
genere 2026-09-03 23:16 UTC — 350303 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 266959 systemes
...
- moteur actif `0caa9267db60` (306561 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 173817 | 86412 | 11803 | 5816 | 17696 | 13687 | 18414 | 17775 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 170371 | 39604 | 71990 | 70 | 23656 | 8817 | 66 | 26154 | 15.4% |
...
- candidats AVEC connectivite : 17902, dont T2 : 100%
- candidats SANS connectivite : 26464, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18688 systemes avec CONNECTED sur 144328 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*40076 candidats sur 44366 portent les champs bruts (90%).*

- `5c556c16ea8b` — 34111 candidats
  - AVEC connectivite (13774) : resistance **41.1%**
  - SANS connectivite (20337) : resistance **21.2%**
...
- `5c556c16ea8b` — 34111 candidats
  - AVEC connectivite (13774) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (20337) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 18764 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18688 avec CONNECTED, 76 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 141827 systemes
  - sans CONNECTED : 0.0% sur 31990 systemes
