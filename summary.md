...
genere 2026-09-10 04:10 UTC — 492141 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 408797 systemes
...
- moteur actif `0caa9267db60` (448399 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 245448 | 121871 | 16711 | 8233 | 24835 | 19257 | 26168 | 25255 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 240578 | 56081 | 101353 | 96 | 33497 | 12427 | 87 | 37016 | 15.4% |
...
- candidats AVEC connectivite : 25382, dont T2 : 100%
...
- **26442 systemes avec CONNECTED sur 202907 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*58418 candidats sur 62708 portent les champs bruts (93%).*

- `5c556c16ea8b` — 52453 candidats
  - AVEC connectivite (21254) : resistance **41.2%**
...
- `5c556c16ea8b` — 52453 candidats
  - AVEC connectivite (21254) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 26539 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 26442 avec CONNECTED, 97 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 200406 systemes
  - sans CONNECTED : 0.0% sur 45042 systemes
