...
genere 2026-08-26 13:30 UTC — 46733 systemes evalues
...
- moteur actif `0caa9267db60` (2991 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20529 | 10239 | 1352 | 713 | 2051 | 1632 | 2194 | 2094 | 10.2% |
...
- candidats AVEC connectivite : 2221, dont T2 : 100%
- candidats SANS connectivite : 3371, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2468 systemes avec CONNECTED sur 19256 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1302 candidats sur 5592 portent les champs bruts (23%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 187 candidats
  - AVEC connectivite (83) : resistance **38.4%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 187 candidats
  - AVEC connectivite (83) : T0=13.54 T1=0.00 T2=2.78 — pondere **5.57**
...
- TROP-CHER : 2485 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2468 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16755 systemes
  - sans CONNECTED : 0.0% sur 3774 systemes
