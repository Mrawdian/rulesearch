...
genere 2026-08-26 14:11 UTC — 48375 systemes evalues
...
- moteur actif `0caa9267db60` (4633 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21351 | 10654 | 1418 | 736 | 2111 | 1697 | 2282 | 2183 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20909 | 4873 | 8823 | 13 | 2900 | 1082 | 7 | 3211 | 15.4% |
...
- candidats AVEC connectivite : 2310, dont T2 : 100%
- candidats SANS connectivite : 3521, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2556 systemes avec CONNECTED sur 19947 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1541 candidats sur 5831 portent les champs bruts (26%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 426 candidats
  - AVEC connectivite (172) : resistance **39.8%**
  - SANS connectivite (254) : resistance **20.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 426 candidats
  - AVEC connectivite (172) : T0=13.45 T1=0.00 T2=2.97 — pondere **5.93**
  - SANS connectivite (254) : T0=16.08 T1=0.00 T2=2.64 — pondere **5.28**
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0335).
...
- TROP-CHER : 2573 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2556 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17446 systemes
  - sans CONNECTED : 0.0% sur 3905 systemes
