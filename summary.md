...
genere 2026-08-26 10:28 UTC — 38844 systemes evalues
...
- `e3baecf8377b` : 251 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
- `6680f7b47e6f` : 124 systemes

Les lignes de dsl_hash differents ne sont pas comparables entre elles.

**7717 enregistrements (20%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 16542 | 8262 | 1069 | 567 | 1642 | 1322 | 1804 | 1666 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 16187 | 3804 | 6859 | 11 | 2212 | 815 | 7 | 2479 | 15.3% |
...
- candidats SANS connectivite : 2789, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2078 systemes avec CONNECTED sur 16021 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*292 candidats sur 4582 portent les champs bruts (6%).*
...
- `e3baecf8377b` — 28 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (10) : resistance **34.9%**
  - SANS connectivite (18) : resistance **16.0%**
...
- `e3baecf8377b` — 28 candidats
  - AVEC connectivite (10) : T0=14.00 T1=0.00 T2=2.90 — pondere **5.80**
  - SANS connectivite (18) : T0=15.67 T1=0.00 T2=2.11 — pondere **4.22**
  - *groupes trop petits (< 20) — aucun test, aucune conclusion*
...
- TROP-CHER : 2095 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2078 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 13520 systemes
  - sans CONNECTED : 0.0% sur 3022 systemes
