...
genere 2026-09-01 03:42 UTC — 271478 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 188134 systemes
...
- moteur actif `0caa9267db60` (227736 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 134036 | 66592 | 9061 | 4498 | 13597 | 10610 | 14162 | 13777 | 10.3% |
...
- candidats AVEC connectivite : 13904, dont T2 : 100%
...
- **14436 systemes avec CONNECTED sur 111850 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*30034 candidats sur 34324 portent les champs bruts (88%).*

- `5c556c16ea8b` — 24069 candidats
  - AVEC connectivite (9776) : resistance **41.0%**
...
- `5c556c16ea8b` — 24069 candidats
  - AVEC connectivite (9776) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 14503 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14436 avec CONNECTED, 67 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 109349 systemes
  - sans CONNECTED : 0.0% sur 24687 systemes
