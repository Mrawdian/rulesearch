...
genere 2026-08-26 22:56 UTC — 68294 systemes evalues
...
- moteur actif `0caa9267db60` (24552 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 30751 | 7081 | 13072 | 18 | 4258 | 1599 | 14 | 4709 | 15.3% |
...
- candidats SANS connectivite : 5019, dont T2 : 100%
...
*4081 candidats sur 8371 portent les champs bruts (49%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 404 candidats
  - AVEC connectivite (172) : resistance **42.5%**
  - SANS connectivite (232) : resistance **21.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 404 candidats
  ...
  - SANS connectivite (232) : T0=16.12 T1=0.00 T2=2.71 — pondere **5.42**
...
**6 serie(s) reproductible(s) sur 13 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `ab89a63b01ef` (p=0.0235), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
