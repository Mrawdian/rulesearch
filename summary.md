...
genere 2026-08-26 18:57 UTC — 59674 systemes evalues
...
- moteur actif `0caa9267db60` (15932 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27061 | 13499 | 1843 | 911 | 2684 | 2144 | 2871 | 2770 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 26498 | 6118 | 11222 | 15 | 3692 | 1367 | 10 | 4074 | 15.4% |
...
- candidats AVEC connectivite : 2897, dont T2 : 100%
- candidats SANS connectivite : 4384, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3145 systemes avec CONNECTED sur 24631 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2991 candidats sur 7281 portent les champs bruts (41%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 122 candidats
  - AVEC connectivite (53) : resistance **42.7%**
  - SANS connectivite (69) : resistance **18.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 122 candidats
  - AVEC connectivite (53) : T0=13.00 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (69) : T0=16.12 T1=0.00 T2=2.46 — pondere **4.93**
...
**6 serie(s) reproductible(s) sur 12 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0060), `62448a55927e` (p=0.0490), `b71bb0907fb5` (p=0.0110).
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22130 systemes
  - sans CONNECTED : 0.0% sur 4931 systemes
