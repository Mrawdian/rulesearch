...
genere 2026-09-04 02:38 UTC — 353914 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 270570 systemes
...
- moteur actif `0caa9267db60` (310172 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 175636 | 87295 | 11942 | 5868 | 17879 | 13819 | 18616 | 17978 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 172163 | 40019 | 72703 | 70 | 23925 | 8915 | 68 | 26449 | 15.4% |
...
- candidats SANS connectivite : 26759, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18890 systemes avec CONNECTED sur 145822 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*40574 candidats sur 44864 portent les champs bruts (90%).*

- `5c556c16ea8b` — 34609 candidats
  - AVEC connectivite (13977) : resistance **41.1%**
  - SANS connectivite (20632) : resistance **21.2%**
...
- `5c556c16ea8b` — 34609 candidats
  ...
  - SANS connectivite (20632) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 18968 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18890 avec CONNECTED, 78 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 143321 systemes
  - sans CONNECTED : 0.0% sur 32315 systemes
