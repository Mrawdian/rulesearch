...
genere 2026-08-26 20:33 UTC — 63231 systemes evalues
...
- moteur actif `0caa9267db60` (19489 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 28245 | 6525 | 11978 | 15 | 3919 | 1455 | 12 | 4341 | 15.4% |
...
- candidats SANS connectivite : 4651, dont T2 : 100%
...
*3457 candidats sur 7747 portent les champs bruts (45%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 588 candidats
  - AVEC connectivite (252) : resistance **40.0%**
  - SANS connectivite (336) : resistance **20.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 588 candidats
  ...
  - SANS connectivite (336) : T0=16.20 T1=0.00 T2=2.69 — pondere **5.38**
  - test de permutation : **p = 0.2544** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
