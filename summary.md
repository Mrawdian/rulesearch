...
genere 2026-09-05 10:48 UTC — 387640 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 304296 systemes
...
- moteur actif `0caa9267db60` (343898 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 192678 | 95690 | 13121 | 6415 | 19598 | 15162 | 20434 | 19795 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 188847 | 43963 | 79702 | 77 | 26277 | 9770 | 70 | 28974 | 15.3% |
...
- candidats SANS connectivite : 29284, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20708 systemes avec CONNECTED sur 159684 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*44916 candidats sur 49206 portent les champs bruts (91%).*

- `5c556c16ea8b` — 38951 candidats
  - AVEC connectivite (15794) : resistance **41.1%**
  - SANS connectivite (23157) : resistance **21.3%**
...
- `5c556c16ea8b` — 38951 candidats
  ...
  - SANS connectivite (23157) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 20788 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 20708 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 157183 systemes
  - sans CONNECTED : 0.0% sur 35495 systemes
