...
genere 2026-08-26 12:55 UTC — 45156 systemes evalues
...
| connect | 4 | 3 | 19726 | 9841 | 1284 | 683 | 1982 | 1560 | 2121 | 2011 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 19315 | 4537 | 8150 | 13 | 2657 | 997 | 7 | 2954 | 15.3% |
...
- candidats AVEC connectivite : 2138, dont T2 : 100%
- candidats SANS connectivite : 3264, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2395 systemes avec CONNECTED sur 18605 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1112 candidats sur 5402 portent les champs bruts (21%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `e40600351a72` — 191 candidats
  - AVEC connectivite (87) : resistance **40.0%**
  - SANS connectivite (104) : resistance **19.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e40600351a72` — 191 candidats
  ...
  - SANS connectivite (104) : T0=16.58 T1=0.00 T2=2.57 — pondere **5.13**
...
- TROP-CHER : 2412 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2395 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 16104 systemes
  - sans CONNECTED : 0.0% sur 3622 systemes
