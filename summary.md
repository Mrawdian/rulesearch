...
genere 2026-08-29 04:58 UTC — 170871 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 87527 systemes
...
- moteur actif `0caa9267db60` (127129 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 83214 | 41418 | 5659 | 2812 | 8352 | 6607 | 8728 | 8579 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 81542 | 18977 | 34520 | 39 | 11282 | 4143 | 34 | 12542 | 15.4% |
...
- candidats AVEC connectivite : 8706, dont T2 : 100%
- candidats SANS connectivite : 12852, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9002 systemes avec CONNECTED sur 70403 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*17268 candidats sur 21558 portent les champs bruts (80%).*

- `5c556c16ea8b` — 11303 candidats
  - AVEC connectivite (4578) : resistance **41.2%**
  - SANS connectivite (6725) : resistance **21.7%**
...
- `5c556c16ea8b` — 11303 candidats
  - AVEC connectivite (4578) : T0=13.01 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (6725) : T0=15.90 T1=0.00 T2=2.67 — pondere **5.33**
...
- TROP-CHER : 9046 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 9002 avec CONNECTED, 44 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 67902 systemes
  - sans CONNECTED : 0.0% sur 15312 systemes
