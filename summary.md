...
genere 2026-08-30 10:52 UTC — 216038 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 132694 systemes
...
- moteur actif `0caa9267db60` (172296 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 106043 | 52650 | 7234 | 3539 | 10677 | 8429 | 11232 | 10900 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 103880 | 24232 | 43884 | 49 | 14338 | 5360 | 41 | 15968 | 15.4% |
...
- candidats AVEC connectivite : 11027, dont T2 : 100%
- candidats SANS connectivite : 16278, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11506 systemes avec CONNECTED sur 89017 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*23015 candidats sur 27305 portent les champs bruts (84%).*

- `5c556c16ea8b` — 17050 candidats
  - AVEC connectivite (6899) : resistance **41.1%**
  - SANS connectivite (10151) : resistance **21.5%**
...
- `5c556c16ea8b` — 17050 candidats
  - AVEC connectivite (6899) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (10151) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 11557 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11506 avec CONNECTED, 51 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 86516 systemes
  - sans CONNECTED : 0.0% sur 19527 systemes
