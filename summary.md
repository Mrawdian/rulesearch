...
genere 2026-08-26 21:14 UTC — 64596 systemes evalues
...
- moteur actif `0caa9267db60` (20854 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 29561 | 14698 | 2020 | 991 | 2953 | 2338 | 3154 | 3032 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 28920 | 6668 | 12271 | 16 | 4014 | 1491 | 12 | 4448 | 15.4% |
...
- candidats AVEC connectivite : 3159, dont T2 : 100%
- candidats SANS connectivite : 4758, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3428 systemes avec CONNECTED sur 26678 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3627 candidats sur 7917 portent les champs bruts (46%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 758 candidats
  - AVEC connectivite (315) : resistance **40.1%**
  - SANS connectivite (443) : resistance **20.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 758 candidats
  - AVEC connectivite (315) : T0=12.89 T1=0.00 T2=2.86 — pondere **5.71**
  - SANS connectivite (443) : T0=16.18 T1=0.00 T2=2.66 — pondere **5.32**
  - test de permutation : **p = 0.0720** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e3baecf8377b` — 657 candidats
...
- TROP-CHER : 3450 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3428 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24177 systemes
  - sans CONNECTED : 0.0% sur 5384 systemes
