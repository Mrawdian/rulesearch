...
| connect | 4 | 3 | 5860 | 2949 | 377 | 213 | 563 | 473 | 609 | 606 | 10.3% |
...
- candidats AVEC connectivite : 609, dont T2 : 100%
...
- **609 systemes avec CONNECTED sur 4861 (12.5%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 355 candidats
  - AVEC connectivite (130) : T0=13.08 T1=0.00 T2=2.89 — pondere **5.78**
...
- TROP-CHER : 611 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 609 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 4804 systemes
  - sans CONNECTED : 0.0% sur 1056 systemes
