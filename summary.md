...
genere 2026-08-28 18:47 UTC — 153485 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 70141 systemes
...
- moteur actif `0caa9267db60` (109743 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 74429 | 36997 | 5072 | 2540 | 7463 | 5928 | 7849 | 7636 | 10.3% |
...
- candidats AVEC connectivite : 7763, dont T2 : 100%
...
- **8123 systemes avec CONNECTED sur 63222 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*15046 candidats sur 19336 portent les champs bruts (78%).*

- `5c556c16ea8b` — 9081 candidats
  - AVEC connectivite (3635) : resistance **41.1%**
...
- `5c556c16ea8b` — 9081 candidats
  - AVEC connectivite (3635) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.99**
...
- TROP-CHER : 8164 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8123 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 60721 systemes
  - sans CONNECTED : 0.0% sur 13708 systemes
