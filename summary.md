...
genere 2026-08-26 12:57 UTC — 45228 systemes evalues
...
- `06fe04a859f1` : 45 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (1486 systemes) : `06fe04a859f1`, `e40600351a72`
...
**7511 enregistrements (17%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
*1121 candidats sur 5411 portent les champs bruts (21%).*
