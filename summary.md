...
genere 2026-08-27 05:49 UTC — 83670 systemes evalues
...
- moteur actif `0caa9267db60` (39928 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 39181 | 19507 | 2694 | 1337 | 3896 | 3088 | 4134 | 4016 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 38374 | 8852 | 16325 | 22 | 5313 | 1999 | 21 | 5842 | 15.2% |
...
- candidats AVEC connectivite : 4143, dont T2 : 100%
- candidats SANS connectivite : 6152, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4408 systemes avec CONNECTED sur 34545 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6005 candidats sur 10295 portent les champs bruts (58%).*
...
- `b71bb0907fb5` — 53 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 40 candidats
  - AVEC connectivite (15) : resistance **40.9%**
  - SANS connectivite (25) : resistance **22.4%**
...
- `5c556c16ea8b` — 40 candidats
  - AVEC connectivite (15) : T0=12.60 T1=0.00 T2=3.07 — pondere **6.13**
  - SANS connectivite (25) : T0=16.72 T1=0.00 T2=2.48 — pondere **4.96**
...
- TROP-CHER : 4439 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4408 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 32044 systemes
  - sans CONNECTED : 0.0% sur 7137 systemes
