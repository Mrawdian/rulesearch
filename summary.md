...
genere 2026-08-25 20:29 UTC — 3108 systemes evalues

## versions du DSL presentes
- `615abe43d6bc` : 2131 systemes
...
| connect | 4 | 3 | 1522 | 768 | 106 | 58 | 160 | 119 | 145 | 149 | 9.8% |
...
- candidats AVEC connectivite : 152, dont T2 : 100%
- candidats SANS connectivite : 229, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **145 systemes avec CONNECTED sur 1296 (11.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- TROP-CHER : 146 systemes abandonnes (4.7% des systemes), 95% du temps total
  dont 145 avec CONNECTED, 1 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 11.7% sur 1239 systemes
  - sans CONNECTED : 0.0% sur 283 systemes
