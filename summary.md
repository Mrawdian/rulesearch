...
genere 2026-08-26 13:35 UTC — 46986 systemes evalues
...
- moteur actif `0caa9267db60` (3244 systemes) : `06fe04a859f1`, `e40600351a72`
...
| ref | 4 | 3 | 20223 | 4731 | 8540 | 13 | 2806 | 1044 | 7 | 3082 | 15.2% |
...
- candidats SANS connectivite : 3392, dont T2 : 100%
...
*1342 candidats sur 5632 portent les champs bruts (24%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 227 candidats
  - AVEC connectivite (102) : resistance **38.2%**
  - SANS connectivite (125) : resistance **21.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 227 candidats
  ...
  - SANS connectivite (125) : T0=16.10 T1=0.00 T2=2.80 — pondere **5.60**
  - test de permutation : **p = 0.8361** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
