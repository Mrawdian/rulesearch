...
genere 2026-08-29 22:53 UTC — 198668 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 115324 systemes
...
- moteur actif `0caa9267db60` (154926 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 97265 | 48308 | 6611 | 3269 | 9811 | 7737 | 10250 | 10031 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 95288 | 22233 | 40237 | 44 | 13184 | 4900 | 37 | 14647 | 15.4% |
...
- candidats AVEC connectivite : 10158, dont T2 : 100%
...
- **10524 systemes avec CONNECTED sur 81834 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*20825 candidats sur 25115 portent les champs bruts (83%).*

- `5c556c16ea8b` — 14860 candidats
  - AVEC connectivite (6030) : resistance **41.1%**
...
- `5c556c16ea8b` — 14860 candidats
  - AVEC connectivite (6030) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
...
- TROP-CHER : 10571 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10524 avec CONNECTED, 47 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 79333 systemes
  - sans CONNECTED : 0.0% sur 17932 systemes
