...
genere 2026-08-29 23:24 UTC — 199433 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 116089 systemes
...
- moteur actif `0caa9267db60` (155691 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 97653 | 48498 | 6644 | 3280 | 9848 | 7770 | 10295 | 10064 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 95665 | 22330 | 40389 | 44 | 13221 | 4921 | 37 | 14717 | 15.4% |
...
- candidats AVEC connectivite : 10191, dont T2 : 100%
- candidats SANS connectivite : 15027, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10569 systemes avec CONNECTED sur 82150 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*20928 candidats sur 25218 portent les champs bruts (83%).*

- `5c556c16ea8b` — 14963 candidats
  - AVEC connectivite (6063) : resistance **41.1%**
  - SANS connectivite (8900) : resistance **21.5%**
...
- `5c556c16ea8b` — 14963 candidats
  - AVEC connectivite (6063) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (8900) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 10616 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10569 avec CONNECTED, 47 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 79649 systemes
  - sans CONNECTED : 0.0% sur 18004 systemes
