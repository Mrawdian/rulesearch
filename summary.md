...
genere 2026-09-08 08:26 UTC — 453803 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 370459 systemes
...
- moteur actif `0caa9267db60` (410061 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 226086 | 112255 | 15393 | 7548 | 22879 | 17717 | 24097 | 23314 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 221602 | 51604 | 93403 | 88 | 30863 | 11462 | 81 | 34083 | 15.4% |
...
- candidats AVEC connectivite : 23441, dont T2 : 100%
- candidats SANS connectivite : 34393, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **24371 systemes avec CONNECTED sur 187122 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*53544 candidats sur 57834 portent les champs bruts (93%).*

- `5c556c16ea8b` — 47579 candidats
  - AVEC connectivite (19313) : resistance **41.1%**
  - SANS connectivite (28266) : resistance **21.3%**
...
- `5c556c16ea8b` — 47579 candidats
  - AVEC connectivite (19313) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (28266) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 24462 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 24371 avec CONNECTED, 91 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 184621 systemes
