...
genere 2026-08-28 21:45 UTC — 158596 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 75252 systemes
...
- moteur actif `0caa9267db60` (114854 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 77017 | 38260 | 5246 | 2618 | 7724 | 6149 | 8111 | 7925 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 75464 | 17548 | 31942 | 35 | 10398 | 3863 | 31 | 11643 | 15.4% |
...
- candidats AVEC connectivite : 8052, dont T2 : 100%
- candidats SANS connectivite : 11953, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8385 systemes avec CONNECTED sur 65318 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*15715 candidats sur 20005 portent les champs bruts (79%).*

- `5c556c16ea8b` — 9750 candidats
  - AVEC connectivite (3924) : resistance **41.2%**
  - SANS connectivite (5826) : resistance **21.8%**
...
- `5c556c16ea8b` — 9750 candidats
  - AVEC connectivite (3924) : T0=13.01 T1=0.00 T2=3.00 — pondere **6.01**
  - SANS connectivite (5826) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.36**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 62817 systemes
  - sans CONNECTED : 0.0% sur 14200 systemes
