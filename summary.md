...
genere 2026-08-27 07:49 UTC — 87988 systemes evalues
...
- moteur actif `0caa9267db60` (44246 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 41359 | 20589 | 2843 | 1404 | 4128 | 3257 | 4356 | 4249 | 10.3% |
...
- candidats AVEC connectivite : 4376, dont T2 : 100%
- candidats SANS connectivite : 6493, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4630 systemes avec CONNECTED sur 36301 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6579 candidats sur 10869 portent les champs bruts (61%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 614 candidats
  - AVEC connectivite (248) : resistance **41.1%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 614 candidats
  - AVEC connectivite (248) : T0=13.03 T1=0.00 T2=3.00 — pondere **6.01**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 33800 systemes
  - sans CONNECTED : 0.0% sur 7559 systemes
