...
genere 2026-08-28 14:37 UTC — 146203 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 62859 systemes
...
- moteur actif `0caa9267db60` (102461 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 70756 | 35155 | 4839 | 2402 | 7094 | 5646 | 7470 | 7247 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 69332 | 16093 | 29288 | 32 | 9603 | 3573 | 30 | 10710 | 15.4% |
...
- candidats AVEC connectivite : 7374, dont T2 : 100%
- candidats SANS connectivite : 11020, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7744 systemes avec CONNECTED sur 60214 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*14104 candidats sur 18394 portent les champs bruts (77%).*

- `5c556c16ea8b` — 8139 candidats
  - AVEC connectivite (3246) : resistance **41.2%**
  - SANS connectivite (4893) : resistance **21.8%**
...
- `5c556c16ea8b` — 8139 candidats
  - AVEC connectivite (3246) : T0=13.02 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (4893) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.36**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 57713 systemes
  - sans CONNECTED : 0.0% sur 13043 systemes
