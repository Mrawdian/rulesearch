...
genere 2026-08-27 00:56 UTC — 72789 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 9167 systemes
- `ab89a63b01ef` : 7882 systemes
...
- moteur actif `0caa9267db60` (29047 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 33702 | 16753 | 2320 | 1147 | 3344 | 2676 | 3590 | 3441 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 32972 | 7599 | 14008 | 18 | 4580 | 1721 | 16 | 5030 | 15.3% |
...
- candidats AVEC connectivite : 3568, dont T2 : 100%
- candidats SANS connectivite : 5340, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3864 systemes avec CONNECTED sur 30069 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4618 candidats sur 8908 portent les champs bruts (52%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 941 candidats
  - AVEC connectivite (388) : resistance **40.7%**
  - SANS connectivite (553) : resistance **21.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 941 candidats
  - AVEC connectivite (388) : T0=13.10 T1=0.00 T2=3.01 — pondere **6.03**
  - SANS connectivite (553) : T0=15.94 T1=0.00 T2=2.62 — pondere **5.24**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
...
- TROP-CHER : 3890 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3864 avec CONNECTED, 26 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 27568 systemes
  - sans CONNECTED : 0.0% sur 6134 systemes
