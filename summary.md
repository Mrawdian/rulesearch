...
genere 2026-08-27 20:07 UTC — 112341 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 28997 systemes
...
- moteur actif `0caa9267db60` (68599 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 53646 | 26716 | 3715 | 1830 | 5302 | 4240 | 5672 | 5469 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 52580 | 12148 | 22324 | 26 | 7280 | 2738 | 25 | 8037 | 15.3% |
...
- candidats AVEC connectivite : 5596, dont T2 : 100%
- candidats SANS connectivite : 8347, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5946 systemes avec CONNECTED sur 46337 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*9653 candidats sur 13943 portent les champs bruts (69%).*
...
- `5c556c16ea8b` — 3688 candidats
  - AVEC connectivite (1468) : resistance **42.1%**
  - SANS connectivite (2220) : resistance **22.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 3688 candidats
  - AVEC connectivite (1468) : T0=12.94 T1=0.00 T2=3.06 — pondere **6.13**
  - SANS connectivite (2220) : T0=15.78 T1=0.00 T2=2.71 — pondere **5.42**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 2280 candidats
...
- TROP-CHER : 5981 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 5946 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 43836 systemes
  - sans CONNECTED : 0.0% sur 9810 systemes
