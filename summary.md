...
genere 2026-09-01 21:12 UTC — 293050 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 209706 systemes
...
- moteur actif `0caa9267db60` (249308 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 144920 | 71970 | 9856 | 4852 | 14714 | 11416 | 15334 | 14906 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 142015 | 33013 | 60068 | 60 | 19690 | 7342 | 63 | 21768 | 15.3% |
...
- candidats AVEC connectivite : 15033, dont T2 : 100%
- candidats SANS connectivite : 22078, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15608 systemes avec CONNECTED sur 120772 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*32821 candidats sur 37111 portent les champs bruts (88%).*

- `5c556c16ea8b` — 26856 candidats
  - AVEC connectivite (10905) : resistance **41.0%**
  - SANS connectivite (15951) : resistance **21.4%**
...
- `5c556c16ea8b` — 26856 candidats
  - AVEC connectivite (10905) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (15951) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 118271 systemes
