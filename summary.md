...
genere 2026-09-08 10:40 UTC — 455796 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 372452 systemes
...
- moteur actif `0caa9267db60` (412054 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 227104 | 112794 | 15445 | 7592 | 22974 | 17802 | 24207 | 23397 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 222577 | 51836 | 93809 | 88 | 31005 | 11512 | 81 | 34228 | 15.4% |
...
- candidats AVEC connectivite : 23524, dont T2 : 100%
- candidats SANS connectivite : 34538, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **24481 systemes avec CONNECTED sur 187952 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*53772 candidats sur 58062 portent les champs bruts (93%).*

- `5c556c16ea8b` — 47807 candidats
  - AVEC connectivite (19396) : resistance **41.2%**
  - SANS connectivite (28411) : resistance **21.3%**
...
- `5c556c16ea8b` — 47807 candidats
  - AVEC connectivite (19396) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (28411) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 24572 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 24481 avec CONNECTED, 91 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 185451 systemes
  - sans CONNECTED : 0.0% sur 41653 systemes
