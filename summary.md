...
| connect | 4 | 3 | 7427 | 3738 | 492 | 258 | 709 | 599 | 777 | 773 | 10.4% |
| ref | 4 | 3 | 7258 | 1757 | 3025 | 1 | 973 | 358 | 2 | 1142 | 15.7% |
...
- candidats AVEC connectivite : 776, dont T2 : 100%
- candidats SANS connectivite : 1146, dont T2 : 100%
...
- **777 systemes avec CONNECTED sur 6145 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 757 candidats
  - AVEC connectivite (297) : T0=13.24 T1=0.00 T2=2.91 — pondere **5.82**
  - SANS connectivite (460) : T0=15.79 T1=0.00 T2=2.66 — pondere **5.32**
  - test de permutation : **p = 0.0305** — ecart significatif au seuil 0.05
...
## cout
- temps total 4.5 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 779 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 777 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 6088 systemes
  - sans CONNECTED : 0.0% sur 1339 systemes
