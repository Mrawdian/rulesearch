...
genere 2026-08-28 04:02 UTC — 127682 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 44338 systemes
...
- moteur actif `0caa9267db60` (83940 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 61410 | 30535 | 4243 | 2078 | 6120 | 4883 | 6449 | 6312 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 60157 | 13920 | 25478 | 28 | 8371 | 3115 | 26 | 9217 | 15.3% |
...
- candidats AVEC connectivite : 6439, dont T2 : 100%
- candidats SANS connectivite : 9527, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6723 systemes avec CONNECTED sur 52611 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11676 candidats sur 15966 portent les champs bruts (73%).*

- `5c556c16ea8b` — 5711 candidats
  - AVEC connectivite (2311) : resistance **41.8%**
  - SANS connectivite (3400) : resistance **22.1%**
...
- `5c556c16ea8b` — 5711 candidats
  - AVEC connectivite (2311) : T0=12.99 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (3400) : T0=15.86 T1=0.00 T2=2.69 — pondere **5.39**
...
- TROP-CHER : 6759 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6723 avec CONNECTED, 36 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 50110 systemes
  - sans CONNECTED : 0.0% sur 11300 systemes
