...
genere 2026-08-26 16:40 UTC — 54216 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 9033 systemes
...
- moteur actif `0caa9267db60` (10474 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 24314 | 12129 | 1657 | 823 | 2409 | 1923 | 2593 | 2477 | 10.2% |
...
- candidats AVEC connectivite : 2604, dont T2 : 100%
- candidats SANS connectivite : 3979, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2867 systemes avec CONNECTED sur 22366 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2293 candidats sur 6583 portent les champs bruts (35%).*
...
- `06fe04a859f1` — 1178 candidats
  - AVEC connectivite (466) : resistance **41.0%**
...
- `06fe04a859f1` — 1178 candidats
  - AVEC connectivite (466) : T0=13.12 T1=0.00 T2=3.03 — pondere **6.06**
...
- TROP-CHER : 2887 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2867 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19865 systemes
  - sans CONNECTED : 0.0% sur 4449 systemes
