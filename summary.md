...
genere 2026-09-09 17:47 UTC — 483329 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 399985 systemes
...
- moteur actif `0caa9267db60` (439587 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 241010 | 119642 | 16432 | 8074 | 24398 | 18908 | 25673 | 24827 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 236204 | 55047 | 99525 | 94 | 32904 | 12192 | 86 | 36335 | 15.4% |
...
- candidats AVEC connectivite : 24954, dont T2 : 100%
- candidats SANS connectivite : 36645, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25947 systemes avec CONNECTED sur 199253 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*57309 candidats sur 61599 portent les champs bruts (93%).*

- `5c556c16ea8b` — 51344 candidats
  - AVEC connectivite (20826) : resistance **41.2%**
  - SANS connectivite (30518) : resistance **21.3%**
...
- `5c556c16ea8b` — 51344 candidats
  - AVEC connectivite (20826) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.97**
  - SANS connectivite (30518) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
## cout
- temps total 150.7 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 26043 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25947 avec CONNECTED, 96 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 196752 systemes
  - sans CONNECTED : 0.0% sur 44258 systemes
