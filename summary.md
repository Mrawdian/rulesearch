...
genere 2026-09-04 22:01 UTC — 374481 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 291137 systemes
...
- moteur actif `0caa9267db60` (330739 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 186016 | 92390 | 12640 | 6225 | 18913 | 14652 | 19723 | 19087 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 182350 | 42412 | 77045 | 76 | 25330 | 9442 | 70 | 27961 | 15.3% |
...
- candidats AVEC connectivite : 19214, dont T2 : 100%
- candidats SANS connectivite : 28271, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19997 systemes avec CONNECTED sur 154251 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*43195 candidats sur 47485 portent les champs bruts (91%).*

- `5c556c16ea8b` — 37230 candidats
  - AVEC connectivite (15086) : resistance **41.1%**
  - SANS connectivite (22144) : resistance **21.2%**
...
- `5c556c16ea8b` — 37230 candidats
  - AVEC connectivite (15086) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (22144) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 151750 systemes
  - sans CONNECTED : 0.0% sur 34266 systemes
