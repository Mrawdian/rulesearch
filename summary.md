...
| connect | 4 | 3 | 6545 | 3292 | 423 | 236 | 631 | 529 | 681 | 678 | 10.4% |
| ref | 4 | 3 | 6400 | 1557 | 2653 | 1 | 856 | 316 | 2 | 1015 | 15.9% |
...
- candidats SANS connectivite : 1019, dont T2 : 100%
...
- **681 systemes avec CONNECTED sur 5416 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 535 candidats
  - AVEC connectivite (202) : T0=13.19 T1=0.00 T2=2.94 — pondere **5.87**
  - SANS connectivite (333) : T0=15.80 T1=0.00 T2=2.64 — pondere **5.27**
...
- TROP-CHER : 683 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 681 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 5359 systemes
  - sans CONNECTED : 0.0% sur 1186 systemes
