...
genere 2026-08-26 19:42 UTC — 61249 systemes evalues
...
- moteur actif `0caa9267db60` (17507 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27869 | 13889 | 1908 | 937 | 2756 | 2210 | 2965 | 2854 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 27265 | 6305 | 11538 | 15 | 3793 | 1406 | 11 | 4197 | 15.4% |
...
- candidats AVEC connectivite : 2981, dont T2 : 100%
- candidats SANS connectivite : 4507, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3239 systemes avec CONNECTED sur 25305 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3198 candidats sur 7488 portent les champs bruts (43%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 329 candidats
  - AVEC connectivite (137) : resistance **39.5%**
  - SANS connectivite (192) : resistance **19.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 329 candidats
  - AVEC connectivite (137) : T0=13.05 T1=0.00 T2=2.88 — pondere **5.75**
  - SANS connectivite (192) : T0=16.14 T1=0.00 T2=2.65 — pondere **5.29**
  - test de permutation : **p = 0.1884** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
## cout
- temps total 18.9 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 3260 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3239 avec CONNECTED, 21 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22804 systemes
  - sans CONNECTED : 0.0% sur 5065 systemes
