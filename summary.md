...
genere 2026-08-26 13:42 UTC — 47353 systemes evalues
...
- moteur actif `0caa9267db60` (3611 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20842 | 10405 | 1383 | 720 | 2070 | 1656 | 2216 | 2134 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20396 | 4769 | 8617 | 13 | 2822 | 1054 | 7 | 3114 | 15.3% |
...
- candidats SANS connectivite : 3424, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2490 systemes avec CONNECTED sur 19522 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1395 candidats sur 5685 portent les champs bruts (25%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 280 candidats
  - AVEC connectivite (123) : resistance **39.1%**
  - SANS connectivite (157) : resistance **21.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 280 candidats
  ...
  - SANS connectivite (157) : T0=16.25 T1=0.00 T2=2.75 — pondere **5.49**
  - test de permutation : **p = 0.7161** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 17021 systemes
  - sans CONNECTED : 0.0% sur 3821 systemes
