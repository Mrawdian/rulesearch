...
genere 2026-08-27 01:15 UTC — 73442 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 9167 systemes
- `ab89a63b01ef` : 8535 systemes
...
- moteur actif `0caa9267db60` (29700 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 34032 | 16933 | 2335 | 1155 | 3376 | 2704 | 3625 | 3470 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 33295 | 7680 | 14145 | 20 | 4623 | 1736 | 17 | 5074 | 15.2% |
...
- candidats AVEC connectivite : 3597, dont T2 : 100%
- candidats SANS connectivite : 5384, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3899 systemes avec CONNECTED sur 30343 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4691 candidats sur 8981 portent les champs bruts (52%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 1014 candidats
  - AVEC connectivite (417) : resistance **41.1%**
  - SANS connectivite (597) : resistance **21.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 1014 candidats
  - AVEC connectivite (417) : T0=13.07 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (597) : T0=15.88 T1=0.00 T2=2.65 — pondere **5.30**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
...
- TROP-CHER : 3926 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3899 avec CONNECTED, 27 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 27842 systemes
  - sans CONNECTED : 0.0% sur 6190 systemes
