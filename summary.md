...
genere 2026-08-27 10:17 UTC — 93085 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 18378 systemes
- `5c556c16ea8b` : 9741 systemes
...
- moteur actif `0caa9267db60` (49343 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 43933 | 21896 | 3014 | 1488 | 4381 | 3462 | 4625 | 4497 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 43037 | 9922 | 18278 | 25 | 5978 | 2251 | 22 | 6560 | 15.2% |
...
- candidats AVEC connectivite : 4624, dont T2 : 100%
- candidats SANS connectivite : 6870, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4899 systemes avec CONNECTED sur 38402 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*7204 candidats sur 11494 portent les champs bruts (63%).*
...
- `ab89a63b01ef` — 2280 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 1239 candidats
  - AVEC connectivite (496) : resistance **41.3%**
  - SANS connectivite (743) : resistance **21.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 2280 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 1239 candidats
  - AVEC connectivite (496) : T0=13.00 T1=0.00 T2=3.01 — pondere **6.01**
  - SANS connectivite (743) : T0=15.79 T1=0.00 T2=2.65 — pondere **5.30**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 35901 systemes
  - sans CONNECTED : 0.0% sur 8032 systemes
