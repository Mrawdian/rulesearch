...
genere 2026-08-29 19:02 UTC — 192674 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 109330 systemes
...
- moteur actif `0caa9267db60` (148932 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 94233 | 46819 | 6417 | 3166 | 9493 | 7505 | 9945 | 9688 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 92326 | 21543 | 38974 | 43 | 12770 | 4750 | 36 | 14204 | 15.4% |
...
- candidats SANS connectivite : 14514, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10219 systemes avec CONNECTED sur 79375 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*20039 candidats sur 24329 portent les champs bruts (82%).*

- `5c556c16ea8b` — 14074 candidats
  - AVEC connectivite (5687) : resistance **41.2%**
  - SANS connectivite (8387) : resistance **21.5%**
...
- `5c556c16ea8b` — 14074 candidats
  ...
  - SANS connectivite (8387) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 10265 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10219 avec CONNECTED, 46 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 76874 systemes
