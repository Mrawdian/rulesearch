...
genere 2026-08-28 01:24 UTC — 122795 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 39451 systemes
...
- moteur actif `0caa9267db60` (79053 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 58932 | 29343 | 4074 | 1991 | 5864 | 4671 | 6193 | 6038 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 57748 | 13336 | 24506 | 28 | 8020 | 2992 | 26 | 8838 | 15.3% |
...
- candidats AVEC connectivite : 6165, dont T2 : 100%
- candidats SANS connectivite : 9148, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6467 systemes avec CONNECTED sur 50604 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11023 candidats sur 15313 portent les champs bruts (72%).*

- `5c556c16ea8b` — 5058 candidats
  - AVEC connectivite (2037) : resistance **42.0%**
  - SANS connectivite (3021) : resistance **22.3%**
...
- `5c556c16ea8b` — 5058 candidats
  - AVEC connectivite (2037) : T0=12.99 T1=0.00 T2=3.05 — pondere **6.10**
  - SANS connectivite (3021) : T0=15.84 T1=0.00 T2=2.71 — pondere **5.42**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 48103 systemes
  - sans CONNECTED : 0.0% sur 10829 systemes
