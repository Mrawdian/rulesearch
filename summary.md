...
genere 2026-08-27 07:05 UTC — 86418 systemes evalues
...
- moteur actif `0caa9267db60` (42676 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 40567 | 20199 | 2773 | 1383 | 4058 | 3195 | 4274 | 4159 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 39736 | 9156 | 16894 | 22 | 5514 | 2075 | 21 | 6054 | 15.2% |
...
- candidats AVEC connectivite : 4286, dont T2 : 100%
- candidats SANS connectivite : 6364, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4548 systemes avec CONNECTED sur 35649 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6360 candidats sur 10650 portent les champs bruts (60%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 395 candidats
  - AVEC connectivite (158) : resistance **42.2%**
  - SANS connectivite (237) : resistance **21.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 395 candidats
  - AVEC connectivite (158) : T0=13.14 T1=0.00 T2=3.08 — pondere **6.16**
  - SANS connectivite (237) : T0=15.84 T1=0.00 T2=2.71 — pondere **5.42**
  - test de permutation : **p = 0.0215** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `23303c299f39` — 225 candidats
...
**7 serie(s) reproductible(s) sur 14 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `ab89a63b01ef` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `5c556c16ea8b` (p=0.0215), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
...
## cout
- temps total 26.6 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 4579 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4548 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 33148 systemes
  - sans CONNECTED : 0.0% sur 7419 systemes
