...
genere 2026-08-27 01:32 UTC — 74005 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 9167 systemes
- `ab89a63b01ef` : 9098 systemes
...
- moteur actif `0caa9267db60` (30263 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 33574 | 7746 | 14263 | 20 | 4659 | 1746 | 17 | 5123 | 15.3% |
...
- candidats SANS connectivite : 5433, dont T2 : 100%
...
*4765 candidats sur 9055 portent les champs bruts (53%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 1088 candidats
  - AVEC connectivite (442) : resistance **41.0%**
  - SANS connectivite (646) : resistance **21.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1088 candidats
  ...
  - SANS connectivite (646) : T0=15.89 T1=0.00 T2=2.64 — pondere **5.29**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
