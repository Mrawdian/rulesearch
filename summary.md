...
| connect | 4 | 3 | 18292 | 9140 | 1190 | 637 | 1820 | 1449 | 1986 | 1841 | 10.1% |
...
- candidats AVEC connectivite : 1968, dont T2 : 100%
- candidats SANS connectivite : 3058, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2260 systemes avec CONNECTED sur 17439 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*736 candidats sur 5026 portent les champs bruts (15%).*
...
- `e3baecf8377b` — 472 candidats
  - AVEC connectivite (185) : resistance **42.7%**
...
- `e3baecf8377b` — 472 candidats
  - AVEC connectivite (185) : T0=12.98 T1=0.00 T2=3.14 — pondere **6.27**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14938 systemes
  - sans CONNECTED : 0.0% sur 3354 systemes
