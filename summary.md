...
genere 2026-09-05 03:17 UTC — 379934 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 296590 systemes
...
- moteur actif `0caa9267db60` (336192 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 188776 | 93756 | 12854 | 6301 | 19191 | 14881 | 20018 | 19357 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 185043 | 43045 | 78163 | 77 | 25699 | 9576 | 70 | 28399 | 15.3% |
...
- candidats AVEC connectivite : 19484, dont T2 : 100%
- candidats SANS connectivite : 28709, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20292 systemes avec CONNECTED sur 156496 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*43903 candidats sur 48193 portent les champs bruts (91%).*

- `5c556c16ea8b` — 37938 candidats
  - AVEC connectivite (15356) : resistance **41.1%**
  - SANS connectivite (22582) : resistance **21.2%**
...
- `5c556c16ea8b` — 37938 candidats
  - AVEC connectivite (15356) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (22582) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 20372 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 20292 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 153995 systemes
  - sans CONNECTED : 0.0% sur 34781 systemes
