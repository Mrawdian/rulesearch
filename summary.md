...
genere 2026-08-27 06:23 UTC — 84753 systemes evalues
...
- moteur actif `0caa9267db60` (41011 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 38903 | 8963 | 16557 | 22 | 5392 | 2029 | 21 | 5919 | 15.2% |
...
- candidats SANS connectivite : 6229, dont T2 : 100%
...
*6142 candidats sur 10432 portent les champs bruts (59%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 177 candidats
  - AVEC connectivite (75) : resistance **44.4%**
  - SANS connectivite (102) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 177 candidats
  ...
  - SANS connectivite (102) : T0=15.75 T1=0.00 T2=2.54 — pondere **5.08**
...
**7 serie(s) reproductible(s) sur 14 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `ab89a63b01ef` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0060), `5c556c16ea8b` (p=0.0045), `b71bb0907fb5` (p=0.0110).
