...
genere 2026-08-28 00:01 UTC — 119918 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 36574 systemes
...
- moteur actif `0caa9267db60` (76176 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 57483 | 28633 | 3973 | 1943 | 5704 | 4547 | 6067 | 5880 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 56320 | 12995 | 23902 | 27 | 7834 | 2908 | 25 | 8627 | 15.3% |
...
- candidats AVEC connectivite : 6007, dont T2 : 100%
- candidats SANS connectivite : 8937, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6341 systemes avec CONNECTED sur 49459 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10654 candidats sur 14944 portent les champs bruts (71%).*

- `5c556c16ea8b` — 4689 candidats
  - AVEC connectivite (1879) : resistance **41.9%**
  - SANS connectivite (2810) : resistance **22.5%**
...
- `5c556c16ea8b` — 4689 candidats
  - AVEC connectivite (1879) : T0=12.99 T1=0.00 T2=3.05 — pondere **6.10**
  - SANS connectivite (2810) : T0=15.79 T1=0.00 T2=2.72 — pondere **5.44**
...
- TROP-CHER : 6376 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6341 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 46958 systemes
  - sans CONNECTED : 0.0% sur 10525 systemes
