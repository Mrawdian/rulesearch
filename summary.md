...
genere 2026-08-27 15:32 UTC — 103582 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 20238 systemes
...
- moteur actif `0caa9267db60` (59840 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 49229 | 24518 | 3402 | 1686 | 4890 | 3898 | 5189 | 5009 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 48238 | 11156 | 20482 | 25 | 6676 | 2519 | 23 | 7356 | 15.2% |
...
- candidats AVEC connectivite : 5136, dont T2 : 100%
- candidats SANS connectivite : 7666, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5463 systemes avec CONNECTED sur 42723 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*8512 candidats sur 12802 portent les champs bruts (66%).*
...
- `5c556c16ea8b` — 2547 candidats
  - AVEC connectivite (1008) : resistance **41.8%**
  - SANS connectivite (1539) : resistance **22.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 2547 candidats
  - AVEC connectivite (1008) : T0=13.01 T1=0.00 T2=3.05 — pondere **6.09**
  - SANS connectivite (1539) : T0=15.78 T1=0.00 T2=2.67 — pondere **5.34**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 2280 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 40222 systemes
  - sans CONNECTED : 0.0% sur 9007 systemes
