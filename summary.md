...
genere 2026-09-07 11:06 UTC — 434420 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 351076 systemes
...
- moteur actif `0caa9267db60` (390678 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 216302 | 107459 | 14724 | 7201 | 21908 | 16961 | 23002 | 22295 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 212003 | 49357 | 89387 | 83 | 29537 | 10953 | 76 | 32592 | 15.4% |
...
- candidats SANS connectivite : 32902, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23276 systemes avec CONNECTED sur 179094 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*51034 candidats sur 55324 portent les champs bruts (92%).*

- `5c556c16ea8b` — 45069 candidats
  - AVEC connectivite (18294) : resistance **41.1%**
  - SANS connectivite (26775) : resistance **21.3%**
...
- `5c556c16ea8b` — 45069 candidats
  ...
  - SANS connectivite (26775) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 23362 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23276 avec CONNECTED, 86 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 176593 systemes
  - sans CONNECTED : 0.0% sur 39709 systemes
