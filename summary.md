...
genere 2026-08-26 16:41 UTC — 54261 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 9078 systemes
...
- moteur actif `0caa9267db60` (10519 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 24329 | 12136 | 1657 | 823 | 2410 | 1923 | 2595 | 2481 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 23817 | 5517 | 10059 | 14 | 3337 | 1209 | 10 | 3671 | 15.4% |
...
- candidats AVEC connectivite : 2608, dont T2 : 100%
- candidats SANS connectivite : 3981, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2869 systemes avec CONNECTED sur 22380 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2299 candidats sur 6589 portent les champs bruts (35%).*
...
- `06fe04a859f1` — 1184 candidats
  - AVEC connectivite (470) : resistance **41.1%**
...
- `06fe04a859f1` — 1184 candidats
  - AVEC connectivite (470) : T0=13.12 T1=0.00 T2=3.03 — pondere **6.06**
...
- TROP-CHER : 2889 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2869 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19879 systemes
  - sans CONNECTED : 0.0% sur 4450 systemes
