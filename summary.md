...
| connect | 4 | 3 | 16961 | 8472 | 1090 | 587 | 1686 | 1351 | 1850 | 1711 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 16603 | 3911 | 7037 | 11 | 2261 | 836 | 7 | 2540 | 15.3% |
...
- candidats AVEC connectivite : 1838, dont T2 : 100%
- candidats SANS connectivite : 2850, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2124 systemes avec CONNECTED sur 16364 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*398 candidats sur 4688 portent les champs bruts (8%).*
...
- `e3baecf8377b` — 134 candidats
  - AVEC connectivite (55) : resistance **40.5%**
  - SANS connectivite (79) : resistance **20.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 134 candidats
  - AVEC connectivite (55) : T0=13.47 T1=0.00 T2=3.04 — pondere **6.07**
  - SANS connectivite (79) : T0=15.77 T1=0.00 T2=2.53 — pondere **5.06**
...
- TROP-CHER : 2141 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2124 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 13863 systemes
  - sans CONNECTED : 0.0% sur 3098 systemes
