...
genere 2026-08-27 20:18 UTC — 112664 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 29320 systemes
...
- moteur actif `0caa9267db60` (68922 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 53809 | 26792 | 3722 | 1833 | 5315 | 4259 | 5691 | 5495 | 10.2% |
...
- candidats AVEC connectivite : 5622, dont T2 : 100%
- candidats SANS connectivite : 8374, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5965 systemes avec CONNECTED sur 46469 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*9706 candidats sur 13996 portent les champs bruts (69%).*
...
- `5c556c16ea8b` — 3741 candidats
  - AVEC connectivite (1494) : resistance **42.0%**
...
- `5c556c16ea8b` — 3741 candidats
  - AVEC connectivite (1494) : T0=12.94 T1=0.00 T2=3.05 — pondere **6.11**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 43968 systemes
  - sans CONNECTED : 0.0% sur 9841 systemes
