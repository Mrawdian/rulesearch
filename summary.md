...
genere 2026-08-26 14:28 UTC — 49026 systemes evalues
...
- moteur actif `0caa9267db60` (5284 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21681 | 10818 | 1445 | 745 | 2147 | 1722 | 2318 | 2212 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 21230 | 4938 | 8962 | 13 | 2942 | 1097 | 8 | 3270 | 15.4% |
...
- candidats AVEC connectivite : 2339, dont T2 : 100%
- candidats SANS connectivite : 3580, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2592 systemes avec CONNECTED sur 20222 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1629 candidats sur 5919 portent les champs bruts (28%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 514 candidats
  - AVEC connectivite (201) : resistance **40.1%**
  - SANS connectivite (313) : resistance **20.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 514 candidats
  - AVEC connectivite (201) : T0=13.43 T1=0.00 T2=2.99 — pondere **5.97**
  - SANS connectivite (313) : T0=16.09 T1=0.00 T2=2.65 — pondere **5.30**
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0195).
...
## cout
- temps total 15.2 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2610 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2592 avec CONNECTED, 18 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17721 systemes
  - sans CONNECTED : 0.0% sur 3960 systemes
