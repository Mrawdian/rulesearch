...
genere 2026-09-02 03:35 UTC — 300683 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 217339 systemes
...
- moteur actif `0caa9267db60` (256941 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 148765 | 73912 | 10127 | 4987 | 15092 | 11699 | 15755 | 15288 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 145803 | 33908 | 61702 | 62 | 20187 | 7537 | 63 | 22332 | 15.3% |
...
- candidats AVEC connectivite : 15415, dont T2 : 100%
- candidats SANS connectivite : 22642, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16029 systemes avec CONNECTED sur 123955 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*33767 candidats sur 38057 portent les champs bruts (89%).*

- `5c556c16ea8b` — 27802 candidats
  - AVEC connectivite (11287) : resistance **41.0%**
  - SANS connectivite (16515) : resistance **21.3%**
...
- `5c556c16ea8b` — 27802 candidats
  - AVEC connectivite (11287) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (16515) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 16102 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16029 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 121454 systemes
