...
genere 2026-09-01 00:48 UTC — 267799 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 184455 systemes
...
- moteur actif `0caa9267db60` (224057 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 132173 | 65674 | 8937 | 4433 | 13405 | 10447 | 13959 | 13605 | 10.3% |
...
- candidats AVEC connectivite : 13732, dont T2 : 100%
...
- **14233 systemes avec CONNECTED sur 110335 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*29600 candidats sur 33890 portent les champs bruts (87%).*

- `5c556c16ea8b` — 23635 candidats
  - AVEC connectivite (9604) : resistance **41.0%**
...
- `5c556c16ea8b` — 23635 candidats
  - AVEC connectivite (9604) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 14300 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14233 avec CONNECTED, 67 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 107834 systemes
  - sans CONNECTED : 0.0% sur 24339 systemes
