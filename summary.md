...
genere 2026-08-27 00:00 UTC — 70682 systemes evalues
...
- moteur actif `0caa9267db60` (26940 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 31927 | 7356 | 13556 | 18 | 4428 | 1669 | 15 | 4885 | 15.3% |
...
- candidats SANS connectivite : 5195, dont T2 : 100%
...
*4356 candidats sur 8646 portent les champs bruts (50%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 679 candidats
  - AVEC connectivite (271) : resistance **41.6%**
  - SANS connectivite (408) : resistance **21.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 679 candidats
  ...
  - SANS connectivite (408) : T0=15.98 T1=0.00 T2=2.63 — pondere **5.25**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e3baecf8377b` — 657 candidats
