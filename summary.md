...
genere 2026-08-26 22:57 UTC — 68382 systemes evalues
...
- moteur actif `0caa9267db60` (24640 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 31473 | 15627 | 2155 | 1056 | 3136 | 2513 | 3359 | 3227 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 30794 | 7095 | 13086 | 18 | 4264 | 1599 | 14 | 4718 | 15.3% |
...
- candidats SANS connectivite : 5028, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3633 systemes avec CONNECTED sur 28221 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4092 candidats sur 8382 portent les champs bruts (49%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 415 candidats
  - AVEC connectivite (174) : resistance **42.5%**
  - SANS connectivite (241) : resistance **22.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 415 candidats
  ...
  - SANS connectivite (241) : T0=16.09 T1=0.00 T2=2.71 — pondere **5.42**
...
- TROP-CHER : 3657 systemes abandonnes (5.3% des systemes), 96% du temps total
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 25720 systemes
  - sans CONNECTED : 0.0% sur 5753 systemes
