...
genere 2026-08-26 19:10 UTC — 60160 systemes evalues
...
- moteur actif `0caa9267db60` (16418 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27315 | 13625 | 1860 | 923 | 2704 | 2164 | 2900 | 2796 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 26730 | 6175 | 11312 | 15 | 3726 | 1375 | 10 | 4117 | 15.4% |
...
- candidats AVEC connectivite : 2923, dont T2 : 100%
- candidats SANS connectivite : 4427, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3174 systemes avec CONNECTED sur 24846 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3060 candidats sur 7350 portent les champs bruts (42%).*
...
- `23303c299f39` — 225 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 191 candidats
  - AVEC connectivite (79) : resistance **39.9%**
  - SANS connectivite (112) : resistance **18.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 191 candidats
  - AVEC connectivite (79) : T0=13.10 T1=0.00 T2=2.96 — pondere **5.92**
  - SANS connectivite (112) : T0=16.04 T1=0.00 T2=2.57 — pondere **5.14**
...
- TROP-CHER : 3194 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3174 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22345 systemes
