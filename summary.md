...
genere 2026-09-01 06:13 UTC — 274678 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 191334 systemes
...
- moteur actif `0caa9267db60` (230936 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 135649 | 67409 | 9172 | 4546 | 13757 | 10725 | 14331 | 13950 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 132914 | 30961 | 56182 | 58 | 18426 | 6873 | 59 | 20345 | 15.3% |
...
- candidats AVEC connectivite : 14077, dont T2 : 100%
- candidats SANS connectivite : 20655, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14605 systemes avec CONNECTED sur 113185 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*30442 candidats sur 34732 portent les champs bruts (88%).*

- `5c556c16ea8b` — 24477 candidats
  - AVEC connectivite (9949) : resistance **41.0%**
  - SANS connectivite (14528) : resistance **21.3%**
...
- `5c556c16ea8b` — 24477 candidats
  - AVEC connectivite (9949) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (14528) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 14674 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14605 avec CONNECTED, 69 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 110684 systemes
  - sans CONNECTED : 0.0% sur 24965 systemes
