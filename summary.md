...
genere 2026-08-27 02:12 UTC — 75485 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 10578 systemes
...
- moteur actif `0caa9267db60` (31743 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 35063 | 17440 | 2410 | 1188 | 3478 | 2783 | 3737 | 3578 | 10.2% |
...
- candidats AVEC connectivite : 3705, dont T2 : 100%
- candidats SANS connectivite : 5535, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4011 systemes avec CONNECTED sur 31190 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4950 candidats sur 9240 portent les champs bruts (54%).*
...
- `ab89a63b01ef` — 1273 candidats
  - AVEC connectivite (525) : resistance **41.2%**
...
- `ab89a63b01ef` — 1273 candidats
  - AVEC connectivite (525) : T0=13.02 T1=0.00 T2=3.05 — pondere **6.10**
...
- TROP-CHER : 4039 systemes abandonnes (5.4% des systemes), 96% du temps total
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 28689 systemes
  - sans CONNECTED : 0.0% sur 6374 systemes
