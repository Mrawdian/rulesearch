...
genere 2026-08-26 05:28 UTC — 25893 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 16919 systemes
...
| connect | 4 | 3 | 13026 | 6513 | 855 | 453 | 1269 | 1037 | 1418 | 1314 | 10.1% |
| ref | 4 | 3 | 12743 | 3044 | 5353 | 9 | 1731 | 641 | 4 | 1961 | 15.4% |
...
- candidats AVEC connectivite : 1317, dont T2 : 100%
- candidats SANS connectivite : 1965, dont T2 : 100%
...
- **1418 systemes avec CONNECTED sur 10729 (13.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2117 candidats
  - AVEC connectivite (838) : T0=13.27 T1=0.00 T2=2.86 — pondere **5.71**
  - SANS connectivite (1279) : T0=15.90 T1=0.00 T2=2.63 — pondere **5.27**
...
## cout
- temps total 8.2 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 1422 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1418 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 10672 systemes
  - sans CONNECTED : 0.0% sur 2354 systemes
