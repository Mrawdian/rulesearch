...
genere 2026-08-27 04:18 UTC — 80213 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 15306 systemes
...
- moteur actif `0caa9267db60` (36471 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 37455 | 18617 | 2585 | 1277 | 3723 | 2948 | 3971 | 3849 | 10.3% |
...
- candidats AVEC connectivite : 3976, dont T2 : 100%
- candidats SANS connectivite : 5897, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4245 systemes avec CONNECTED sur 33157 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5583 candidats sur 9873 portent les champs bruts (57%).*
...
- `ab89a63b01ef` — 1906 candidats
  - AVEC connectivite (796) : resistance **41.4%**
...
- `ab89a63b01ef` — 1906 candidats
  - AVEC connectivite (796) : T0=13.07 T1=0.00 T2=3.04 — pondere **6.09**
...
- TROP-CHER : 4275 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4245 avec CONNECTED, 30 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 30656 systemes
  - sans CONNECTED : 0.0% sur 6799 systemes
