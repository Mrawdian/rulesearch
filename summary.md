...
genere 2026-08-26 19:27 UTC — 60703 systemes evalues
...
- moteur actif `0caa9267db60` (16961 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27585 | 13758 | 1878 | 932 | 2726 | 2186 | 2934 | 2825 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 27003 | 6246 | 11421 | 15 | 3762 | 1391 | 11 | 4157 | 15.4% |
...
- candidats AVEC connectivite : 2952, dont T2 : 100%
- candidats SANS connectivite : 4467, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3208 systemes avec CONNECTED sur 25076 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3129 candidats sur 7419 portent les champs bruts (42%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 260 candidats
  - AVEC connectivite (108) : resistance **39.7%**
  - SANS connectivite (152) : resistance **18.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 260 candidats
  - AVEC connectivite (108) : T0=13.09 T1=0.00 T2=2.94 — pondere **5.87**
  - SANS connectivite (152) : T0=16.04 T1=0.00 T2=2.59 — pondere **5.18**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22575 systemes
  - sans CONNECTED : 0.0% sur 5010 systemes
