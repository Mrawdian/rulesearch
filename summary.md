...
genere 2026-09-09 10:51 UTC — 477464 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 394120 systemes
...
- moteur actif `0caa9267db60` (433722 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 238042 | 118193 | 16233 | 7977 | 24086 | 18655 | 25341 | 24532 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 233307 | 54368 | 98305 | 92 | 32493 | 12049 | 84 | 35897 | 15.4% |
...
- candidats AVEC connectivite : 24659, dont T2 : 100%
- candidats SANS connectivite : 36207, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25615 systemes avec CONNECTED sur 196857 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*56576 candidats sur 60866 portent les champs bruts (93%).*

- `5c556c16ea8b` — 50611 candidats
  - AVEC connectivite (20531) : resistance **41.2%**
  - SANS connectivite (30080) : resistance **21.3%**
...
- `5c556c16ea8b` — 50611 candidats
  - AVEC connectivite (20531) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (30080) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 25709 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25615 avec CONNECTED, 94 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 194356 systemes
  - sans CONNECTED : 0.0% sur 43686 systemes
