...
genere 2026-08-26 18:11 UTC — 57703 systemes evalues
...
- `e80bc1b2b437` : 279 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (13961 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `84fba70921e0`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
**7745 enregistrements (13%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 26073 | 12986 | 1777 | 881 | 2584 | 2062 | 2784 | 2676 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 25515 | 5879 | 10811 | 15 | 3561 | 1303 | 10 | 3936 | 15.4% |
...
- candidats AVEC connectivite : 2803, dont T2 : 100%
- candidats SANS connectivite : 4246, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3058 systemes avec CONNECTED sur 23816 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2759 candidats sur 7049 portent les champs bruts (39%).*
...
- `b71bb0907fb5` — 53 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `e80bc1b2b437` — 30 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (18) : resistance **40.3%**
  - SANS connectivite (12) : resistance **25.7%**
...
- `e80bc1b2b437` — 30 candidats
  - AVEC connectivite (18) : T0=12.39 T1=0.00 T2=2.61 — pondere **5.22**
  - SANS connectivite (12) : T0=15.17 T1=0.00 T2=3.25 — pondere **6.50**
  - *groupes trop petits (< 20) — aucun test, aucune conclusion*
- `e8a1f930f7b9` — 28 candidats
...
- TROP-CHER : 3078 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3058 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 21315 systemes
  - sans CONNECTED : 0.0% sur 4758 systemes
