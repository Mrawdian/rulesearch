...
genere 2026-09-04 08:03 UTC — 359794 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 276450 systemes
...
- moteur actif `0caa9267db60` (316052 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 178610 | 88770 | 12134 | 5973 | 18175 | 14072 | 18923 | 18289 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 175069 | 40678 | 73953 | 71 | 24306 | 9076 | 70 | 26901 | 15.4% |
...
- candidats AVEC connectivite : 18416, dont T2 : 100%
...
- **19197 systemes avec CONNECTED sur 148232 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*41337 candidats sur 45627 portent les champs bruts (91%).*

- `5c556c16ea8b` — 35372 candidats
  - AVEC connectivite (14288) : resistance **41.1%**
...
- `5c556c16ea8b` — 35372 candidats
  - AVEC connectivite (14288) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 19277 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19197 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 145731 systemes
  - sans CONNECTED : 0.0% sur 32879 systemes
