...
genere 2026-08-26 17:18 UTC — 55622 systemes evalues
...
- moteur actif `0caa9267db60` (11880 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
| connect | 4 | 3 | 25013 | 12487 | 1703 | 844 | 2477 | 1972 | 2673 | 2546 | 10.2% |
...
- candidats AVEC connectivite : 2673, dont T2 : 100%
- candidats SANS connectivite : 4088, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2947 systemes avec CONNECTED sur 22950 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2471 candidats sur 6761 portent les champs bruts (37%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 161 candidats
  - AVEC connectivite (59) : resistance **41.4%**
...
- `23303c299f39` — 161 candidats
  - AVEC connectivite (59) : T0=12.73 T1=0.00 T2=3.00 — pondere **6.00**
...
## cout
- temps total 17.2 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2967 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2947 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 20449 systemes
  - sans CONNECTED : 0.0% sur 4564 systemes
