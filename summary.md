...
genere 2026-08-26 20:42 UTC — 63486 systemes evalues
...
- moteur actif `0caa9267db60` (19744 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 28380 | 6548 | 12047 | 16 | 3938 | 1463 | 12 | 4356 | 15.3% |
...
- candidats SANS connectivite : 4666, dont T2 : 100%
...
*3482 candidats sur 7772 portent les champs bruts (45%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 613 candidats
  - AVEC connectivite (262) : resistance **40.1%**
  - SANS connectivite (351) : resistance **20.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 613 candidats
  ...
  - SANS connectivite (351) : T0=16.15 T1=0.00 T2=2.67 — pondere **5.34**
  - test de permutation : **p = 0.1754** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
