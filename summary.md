...
genere 2026-08-26 22:03 UTC — 66446 systemes evalues
...
- moteur actif `0caa9267db60` (22704 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 29843 | 6881 | 12684 | 17 | 4121 | 1541 | 13 | 4586 | 15.4% |
...
- candidats SANS connectivite : 4896, dont T2 : 100%
...
*3864 candidats sur 8154 portent les champs bruts (47%).*
...
- `23303c299f39` — 225 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 187 candidats
  - AVEC connectivite (78) : resistance **42.9%**
  - SANS connectivite (109) : resistance **22.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 187 candidats
  ...
  - SANS connectivite (109) : T0=15.90 T1=0.00 T2=2.82 — pondere **5.63**
  - test de permutation : **p = 0.4038** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
