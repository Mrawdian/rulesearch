...
genere 2026-08-26 10:37 UTC — 39186 systemes evalues
...
- `e3baecf8377b` : 593 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
**8059 enregistrements (21%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 16707 | 8342 | 1076 | 578 | 1660 | 1329 | 1825 | 1686 | 10.1% |
...
- candidats AVEC connectivite : 1813, dont T2 : 100%
- candidats SANS connectivite : 2818, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2099 systemes avec CONNECTED sur 16157 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*341 candidats sur 4631 portent les champs bruts (7%).*
...
- `e3baecf8377b` — 77 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (30) : resistance **37.6%**
...
- `e3baecf8377b` — 77 candidats
  - AVEC connectivite (30) : T0=13.67 T1=0.00 T2=2.83 — pondere **5.67**
...
- TROP-CHER : 2116 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2099 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.4% sur 13656 systemes
  - sans CONNECTED : 0.0% sur 3051 systemes
