...
genere 2026-08-26 09:54 UTC — 37431 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 28457 systemes
...
| connect | 4 | 3 | 16032 | 7996 | 1047 | 550 | 1596 | 1276 | 1750 | 1615 | 10.1% |
| d4 | 4 | 4 | 5571 | 2558 | 1416 | 28 | 395 | 371 | 264 | 396 | 7.1% |
| ref | 4 | 3 | 15704 | 3688 | 6631 | 11 | 2156 | 796 | 7 | 2415 | 15.4% |
...
- candidats AVEC connectivite : 1730, dont T2 : 100%
- candidats SANS connectivite : 2703, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2004 systemes avec CONNECTED sur 15433 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*143 candidats sur 4433 portent les champs bruts (3%).*

- `89c65c03c4ad` — 143 candidats
  - AVEC connectivite (53) : resistance **47.1%**
  - SANS connectivite (90) : resistance **22.1%**
...
- `89c65c03c4ad` — 3268 candidats
  - AVEC connectivite (1251) : T0=13.06 T1=0.00 T2=2.95 — pondere **5.90**
  - SANS connectivite (2017) : T0=15.84 T1=0.02 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 2021 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2004 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.4% sur 13100 systemes
  - sans CONNECTED : 0.0% sur 2932 systemes
