...
genere 2026-09-05 13:51 UTC — 390746 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 307402 systemes
...
- moteur actif `0caa9267db60` (347004 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 194243 | 96469 | 13229 | 6467 | 19755 | 15291 | 20598 | 19960 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 190388 | 44316 | 80354 | 78 | 26494 | 9847 | 71 | 29214 | 15.3% |
...
- candidats AVEC connectivite : 20087, dont T2 : 100%
- candidats SANS connectivite : 29524, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20872 systemes avec CONNECTED sur 160938 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*45321 candidats sur 49611 portent les champs bruts (91%).*

- `5c556c16ea8b` — 39356 candidats
  - AVEC connectivite (15959) : resistance **41.0%**
  - SANS connectivite (23397) : resistance **21.3%**
...
- `5c556c16ea8b` — 39356 candidats
  - AVEC connectivite (15959) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (23397) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 158437 systemes
  - sans CONNECTED : 0.0% sur 35806 systemes
