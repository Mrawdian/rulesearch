...
| connect | 4 | 3 | 7052 | 3542 | 464 | 246 | 669 | 571 | 735 | 745 | 10.6% |
...
- candidats AVEC connectivite : 748, dont T2 : 100%
...
- **735 systemes avec CONNECTED sur 5839 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 678 candidats
  - AVEC connectivite (269) : T0=13.23 T1=0.00 T2=2.92 — pondere **5.84**
...
- TROP-CHER : 737 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 735 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 5782 systemes
  - sans CONNECTED : 0.0% sur 1270 systemes
