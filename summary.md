...
**7466 enregistrements (60%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 6234 | 3145 | 399 | 226 | 602 | 500 | 642 | 647 | 10.4% |
| ref | 4 | 3 | 6081 | 1474 | 2535 | 1 | 809 | 301 | 2 | 959 | 15.8% |
...
- candidats AVEC connectivite : 650, dont T2 : 100%
- candidats SANS connectivite : 963, dont T2 : 100%
...
- **642 systemes avec CONNECTED sur 5165 (12.4%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 448 candidats
  - AVEC connectivite (171) : T0=13.27 T1=0.00 T2=2.97 — pondere **5.94**
  - SANS connectivite (277) : T0=15.89 T1=0.00 T2=2.61 — pondere **5.21**
...
## cout
- temps total 3.7 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 644 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 642 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.6% sur 5108 systemes
  - sans CONNECTED : 0.0% sur 1126 systemes
