...
| connect | 4 | 3 | 4123 | 2077 | 264 | 144 | 398 | 322 | 433 | 437 | 10.6% |
| ref | 4 | 3 | 4019 | 971 | 1694 | 1 | 536 | 189 | 2 | 626 | 15.6% |
...
- candidats AVEC connectivite : 440, dont T2 : 100%
- candidats SANS connectivite : 630, dont T2 : 100%
...
- **433 systemes avec CONNECTED sur 3445 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
## cout
- temps total 2.5 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 435 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 433 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 3388 systemes
  - sans CONNECTED : 0.0% sur 735 systemes
