...
genere 2026-09-08 01:08 UTC — 447206 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 363862 systemes
...
- moteur actif `0caa9267db60` (403464 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 222760 | 110621 | 15184 | 7437 | 22546 | 17444 | 23732 | 22954 | 10.3% |
...
- candidats AVEC connectivite : 23081, dont T2 : 100%
...
- **24006 systemes avec CONNECTED sur 184407 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*52634 candidats sur 56924 portent les champs bruts (92%).*

- `5c556c16ea8b` — 46669 candidats
  - AVEC connectivite (18953) : resistance **41.2%**
...
- `5c556c16ea8b` — 46669 candidats
  - AVEC connectivite (18953) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 24094 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 24006 avec CONNECTED, 88 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 181906 systemes
  - sans CONNECTED : 0.0% sur 40854 systemes
