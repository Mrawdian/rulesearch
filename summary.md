...
genere 2026-08-26 15:00 UTC — 50242 systemes evalues
...
- moteur actif `0caa9267db60` (6500 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22295 | 11111 | 1499 | 764 | 2220 | 1768 | 2384 | 2269 | 10.2% |
...
- candidats AVEC connectivite : 2396, dont T2 : 100%
- candidats SANS connectivite : 3674, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2658 systemes avec CONNECTED sur 20701 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1780 candidats sur 6070 portent les champs bruts (29%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 665 candidats
  - AVEC connectivite (258) : resistance **41.0%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 665 candidats
  - AVEC connectivite (258) : T0=13.33 T1=0.00 T2=3.02 — pondere **6.04**
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0040).
...
- TROP-CHER : 2678 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2658 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18200 systemes
  - sans CONNECTED : 0.0% sur 4095 systemes
