...
genere 2026-09-01 05:47 UTC — 274145 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 190801 systemes
...
- moteur actif `0caa9267db60` (230403 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 135379 | 67284 | 9146 | 4532 | 13736 | 10713 | 14298 | 13917 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 132651 | 30902 | 56079 | 58 | 18384 | 6855 | 59 | 20304 | 15.3% |
...
- candidats AVEC connectivite : 14044, dont T2 : 100%
- candidats SANS connectivite : 20614, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14572 systemes avec CONNECTED sur 112952 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*30368 candidats sur 34658 portent les champs bruts (88%).*

- `5c556c16ea8b` — 24403 candidats
  - AVEC connectivite (9916) : resistance **41.0%**
  - SANS connectivite (14487) : resistance **21.3%**
...
- `5c556c16ea8b` — 24403 candidats
  - AVEC connectivite (9916) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (14487) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 110451 systemes
  - sans CONNECTED : 0.0% sur 24928 systemes
