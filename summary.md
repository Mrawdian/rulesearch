...
| connect | 4 | 3 | 7517 | 3786 | 496 | 262 | 715 | 604 | 793 | 779 | 10.4% |
| ref | 4 | 3 | 7333 | 1774 | 3056 | 1 | 985 | 362 | 2 | 1153 | 15.7% |
...
- candidats AVEC connectivite : 782, dont T2 : 100%
- candidats SANS connectivite : 1157, dont T2 : 100%
...
- **793 systemes avec CONNECTED sur 6224 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 774 candidats
  - AVEC connectivite (303) : T0=13.30 T1=0.00 T2=2.91 — pondere **5.82**
  - SANS connectivite (471) : T0=15.78 T1=0.00 T2=2.65 — pondere **5.31**
  - test de permutation : **p = 0.0280** — ecart significatif au seuil 0.05
...
- TROP-CHER : 795 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 793 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 6167 systemes
  - sans CONNECTED : 0.0% sur 1350 systemes
