...
genere 2026-08-27 10:45 UTC — 94036 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 18378 systemes
- `5c556c16ea8b` : 10692 systemes
...
- moteur actif `0caa9267db60` (50294 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 44423 | 22138 | 3051 | 1505 | 4425 | 3509 | 4673 | 4544 | 10.2% |
...
- candidats AVEC connectivite : 4671, dont T2 : 100%
- candidats SANS connectivite : 6955, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4947 systemes avec CONNECTED sur 38797 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*7336 candidats sur 11626 portent les champs bruts (63%).*
...
- `ab89a63b01ef` — 2280 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 1371 candidats
  - AVEC connectivite (543) : resistance **41.4%**
...
- `ab89a63b01ef` — 2280 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 1371 candidats
  - AVEC connectivite (543) : T0=13.01 T1=0.00 T2=3.01 — pondere **6.03**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 36296 systemes
  - sans CONNECTED : 0.0% sur 8127 systemes
