...
genere 2026-09-05 11:27 UTC — 388290 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 304946 systemes
...
- moteur actif `0caa9267db60` (344548 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 193004 | 95856 | 13141 | 6433 | 19627 | 15182 | 20469 | 19829 | 10.3% |
...
- candidats AVEC connectivite : 19956, dont T2 : 100%
...
- **20743 systemes avec CONNECTED sur 159956 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*44994 candidats sur 49284 portent les champs bruts (91%).*

- `5c556c16ea8b` — 39029 candidats
  - AVEC connectivite (15828) : resistance **41.1%**
...
- `5c556c16ea8b` — 39029 candidats
  - AVEC connectivite (15828) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
...
- TROP-CHER : 20823 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 20743 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 157455 systemes
  - sans CONNECTED : 0.0% sur 35549 systemes
