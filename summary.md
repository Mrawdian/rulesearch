...
genere 2026-09-01 10:58 UTC — 280655 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 197311 systemes
...
- moteur actif `0caa9267db60` (236913 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 138663 | 68925 | 9383 | 4632 | 14084 | 10931 | 14645 | 14265 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 135877 | 31645 | 57443 | 58 | 18840 | 7028 | 61 | 20791 | 15.3% |
...
- candidats AVEC connectivite : 14392, dont T2 : 100%
- candidats SANS connectivite : 21101, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14919 systemes avec CONNECTED sur 115640 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*31203 candidats sur 35493 portent les champs bruts (88%).*

- `5c556c16ea8b` — 25238 candidats
  - AVEC connectivite (10264) : resistance **41.0%**
  - SANS connectivite (14974) : resistance **21.4%**
...
- `5c556c16ea8b` — 25238 candidats
  - AVEC connectivite (10264) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (14974) : T0=15.93 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 14990 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14919 avec CONNECTED, 71 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 113139 systemes
  - sans CONNECTED : 0.0% sur 25524 systemes
