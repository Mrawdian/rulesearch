...
genere 2026-08-26 02:13 UTC — 17733 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 8759 systemes
...
| connect | 4 | 3 | 8909 | 4479 | 580 | 298 | 854 | 707 | 965 | 917 | 10.3% |
| ref | 4 | 3 | 8700 | 2099 | 3657 | 2 | 1159 | 428 | 3 | 1352 | 15.5% |
...
- candidats AVEC connectivite : 920, dont T2 : 100%
- candidats SANS connectivite : 1356, dont T2 : 100%
...
- **965 systemes avec CONNECTED sur 7381 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1111 candidats
  - AVEC connectivite (441) : T0=13.34 T1=0.00 T2=2.90 — pondere **5.79**
  - SANS connectivite (670) : T0=15.92 T1=0.00 T2=2.68 — pondere **5.36**
  - test de permutation : **p = 0.0340** — ecart significatif au seuil 0.05
...
- TROP-CHER : 968 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 965 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 7324 systemes
  - sans CONNECTED : 0.0% sur 1585 systemes
