...
genere 2026-08-29 09:05 UTC — 177515 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 94171 systemes
...
- moteur actif `0caa9267db60` (133773 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 86575 | 43067 | 5892 | 2937 | 8689 | 6877 | 9083 | 8928 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 84825 | 19805 | 35846 | 39 | 11706 | 4324 | 35 | 13064 | 15.4% |
...
- candidats AVEC connectivite : 9055, dont T2 : 100%
- candidats SANS connectivite : 13374, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9357 systemes avec CONNECTED sur 73157 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*18139 candidats sur 22429 portent les champs bruts (81%).*

- `5c556c16ea8b` — 12174 candidats
  - AVEC connectivite (4927) : resistance **41.1%**
  - SANS connectivite (7247) : resistance **21.6%**
...
- `5c556c16ea8b` — 12174 candidats
  - AVEC connectivite (4927) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (7247) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 9402 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 9357 avec CONNECTED, 45 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 70656 systemes
  - sans CONNECTED : 0.0% sur 15919 systemes
