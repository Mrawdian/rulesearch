...
genere 2026-09-09 03:11 UTC — 470738 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 387394 systemes
...
- moteur actif `0caa9267db60` (426996 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 234649 | 116529 | 15999 | 7860 | 23755 | 18376 | 24981 | 24172 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 229974 | 53575 | 96891 | 92 | 32044 | 11882 | 82 | 35389 | 15.4% |
...
- candidats AVEC connectivite : 24299, dont T2 : 100%
- candidats SANS connectivite : 35699, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25255 systemes avec CONNECTED sur 194085 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55708 candidats sur 59998 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49743 candidats
  - AVEC connectivite (20171) : resistance **41.2%**
  - SANS connectivite (29572) : resistance **21.3%**
...
- `5c556c16ea8b` — 49743 candidats
  - AVEC connectivite (20171) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.97**
  - SANS connectivite (29572) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 191584 systemes
  - sans CONNECTED : 0.0% sur 43065 systemes
