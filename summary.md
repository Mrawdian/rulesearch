...
genere 2026-08-26 19:32 UTC — 60912 systemes evalues
...
- moteur actif `0caa9267db60` (17170 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27690 | 13814 | 1887 | 933 | 2733 | 2197 | 2943 | 2836 | 10.2% |
...
- candidats AVEC connectivite : 2963, dont T2 : 100%
- candidats SANS connectivite : 4482, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3217 systemes avec CONNECTED sur 25164 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3155 candidats sur 7445 portent les champs bruts (42%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 286 candidats
  - AVEC connectivite (119) : resistance **39.6%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 286 candidats
  - AVEC connectivite (119) : T0=12.99 T1=0.00 T2=2.93 — pondere **5.87**
  - SANS connectivite (167) : T0=16.09 T1=0.00 T2=2.56 — pondere **5.11**
  - test de permutation : **p = 0.0470** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `23303c299f39` — 225 candidats
...
**6 serie(s) reproductible(s) sur 12 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `62448a55927e` (p=0.0470), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22663 systemes
  - sans CONNECTED : 0.0% sur 5027 systemes
