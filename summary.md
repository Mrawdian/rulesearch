...
| connect | 4 | 3 | 18561 | 9267 | 1202 | 643 | 1854 | 1479 | 2013 | 1873 | 10.1% |
...
- candidats AVEC connectivite : 2000, dont T2 : 100%
- candidats SANS connectivite : 3100, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2287 systemes avec CONNECTED sur 17648 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*810 candidats sur 5100 portent les champs bruts (16%).*
...
- `e3baecf8377b` — 546 candidats
  - AVEC connectivite (217) : resistance **42.1%**
...
- `e3baecf8377b` — 546 candidats
  - AVEC connectivite (217) : T0=13.11 T1=0.00 T2=3.07 — pondere **6.15**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 15147 systemes
  - sans CONNECTED : 0.0% sur 3414 systemes
