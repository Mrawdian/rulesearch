...
genere 2026-08-30 05:48 UTC — 209014 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 125670 systemes
...
- moteur actif `0caa9267db60` (165272 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 102498 | 50887 | 6979 | 3430 | 10354 | 8174 | 10807 | 10531 | 10.3% |
...
- candidats AVEC connectivite : 10658, dont T2 : 100%
...
- **11081 systemes avec CONNECTED sur 86092 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*22139 candidats sur 26429 portent les champs bruts (84%).*

- `5c556c16ea8b` — 16174 candidats
  - AVEC connectivite (6530) : resistance **41.1%**
...
- `5c556c16ea8b` — 16174 candidats
  - AVEC connectivite (6530) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.99**
...
- TROP-CHER : 11130 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11081 avec CONNECTED, 49 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 83591 systemes
  - sans CONNECTED : 0.0% sur 18907 systemes
