...
genere 2026-08-28 04:59 UTC — 129389 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 46045 systemes
...
- moteur actif `0caa9267db60` (85647 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 62276 | 30976 | 4294 | 2107 | 6208 | 4946 | 6542 | 6399 | 10.3% |
...
- candidats AVEC connectivite : 6526, dont T2 : 100%
- candidats SANS connectivite : 9672, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6816 systemes avec CONNECTED sur 53331 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11908 candidats sur 16198 portent les champs bruts (74%).*

- `5c556c16ea8b` — 5943 candidats
  - AVEC connectivite (2398) : resistance **41.7%**
...
- `5c556c16ea8b` — 5943 candidats
  - AVEC connectivite (2398) : T0=12.99 T1=0.00 T2=3.03 — pondere **6.07**
...
- TROP-CHER : 6853 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6816 avec CONNECTED, 37 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 50830 systemes
  - sans CONNECTED : 0.0% sur 11446 systemes
