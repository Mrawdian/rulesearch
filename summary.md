...
genere 2026-08-30 12:15 UTC — 218123 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 134779 systemes
...
- moteur actif `0caa9267db60` (174381 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 107089 | 53197 | 7294 | 3574 | 10783 | 8512 | 11335 | 11000 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 104919 | 24464 | 44311 | 49 | 14480 | 5427 | 41 | 16138 | 15.4% |
...
- candidats AVEC connectivite : 11127, dont T2 : 100%
...
- **11609 systemes avec CONNECTED sur 89867 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*23285 candidats sur 27575 portent les champs bruts (84%).*

- `5c556c16ea8b` — 17320 candidats
  - AVEC connectivite (6999) : resistance **41.1%**
...
- `5c556c16ea8b` — 17320 candidats
  - AVEC connectivite (6999) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.99**
...
- TROP-CHER : 11660 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11609 avec CONNECTED, 51 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 87366 systemes
  - sans CONNECTED : 0.0% sur 19723 systemes
