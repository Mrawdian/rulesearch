...
genere 2026-08-27 07:46 UTC — 87872 systemes evalues
...
- moteur actif `0caa9267db60` (44130 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 41299 | 20558 | 2840 | 1403 | 4121 | 3254 | 4351 | 4240 | 10.3% |
...
- candidats AVEC connectivite : 4367, dont T2 : 100%
- candidats SANS connectivite : 6482, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4625 systemes avec CONNECTED sur 36252 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6559 candidats sur 10849 portent les champs bruts (60%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 594 candidats
  - AVEC connectivite (239) : resistance **41.1%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 594 candidats
  - AVEC connectivite (239) : T0=13.06 T1=0.00 T2=3.01 — pondere **6.03**
...
- TROP-CHER : 4656 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4625 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 33751 systemes
  - sans CONNECTED : 0.0% sur 7548 systemes
