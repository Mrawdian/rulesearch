...
genere 2026-08-26 14:16 UTC — 48523 systemes evalues
...
- moteur actif `0caa9267db60` (4781 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21426 | 10690 | 1424 | 738 | 2119 | 1701 | 2293 | 2190 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20982 | 4899 | 8846 | 13 | 2911 | 1084 | 7 | 3222 | 15.4% |
...
- candidats AVEC connectivite : 2317, dont T2 : 100%
- candidats SANS connectivite : 3532, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2567 systemes avec CONNECTED sur 20013 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1559 candidats sur 5849 portent les champs bruts (27%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 444 candidats
  - AVEC connectivite (179) : resistance **39.9%**
  - SANS connectivite (265) : resistance **20.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 444 candidats
  - AVEC connectivite (179) : T0=13.46 T1=0.00 T2=2.97 — pondere **5.94**
  - SANS connectivite (265) : T0=16.10 T1=0.00 T2=2.64 — pondere **5.28**
  - test de permutation : **p = 0.0315** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e40600351a72` — 194 candidats
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0315).
...
- TROP-CHER : 2584 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2567 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17512 systemes
  - sans CONNECTED : 0.0% sur 3914 systemes
