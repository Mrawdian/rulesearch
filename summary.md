...
- moteur actif `0caa9267db60` (7712 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22907 | 11419 | 1546 | 777 | 2281 | 1818 | 2452 | 2326 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 22432 | 5192 | 9470 | 14 | 3137 | 1144 | 10 | 3465 | 15.4% |
...
- candidats AVEC connectivite : 2453, dont T2 : 100%
- candidats SANS connectivite : 3775, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2726 systemes avec CONNECTED sur 21200 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1938 candidats sur 6228 portent les champs bruts (31%).*
...
- `06fe04a859f1` — 823 candidats
  - AVEC connectivite (315) : resistance **41.0%**
  - SANS connectivite (508) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 823 candidats
  - AVEC connectivite (315) : T0=13.33 T1=0.00 T2=3.02 — pondere **6.04**
  - SANS connectivite (508) : T0=16.01 T1=0.00 T2=2.63 — pondere **5.26**
...
## cout
- temps total 16.0 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2746 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2726 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18699 systemes
  - sans CONNECTED : 0.0% sur 4208 systemes
