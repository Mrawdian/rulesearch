...
| connect | 4 | 3 | 7502 | 3775 | 495 | 261 | 715 | 604 | 791 | 779 | 10.4% |
| ref | 4 | 3 | 7318 | 1771 | 3052 | 1 | 982 | 362 | 2 | 1148 | 15.7% |
...
- candidats SANS connectivite : 1152, dont T2 : 100%
...
- **791 systemes avec CONNECTED sur 6210 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 769 candidats
  - AVEC connectivite (303) : T0=13.30 T1=0.00 T2=2.91 — pondere **5.82**
  - SANS connectivite (466) : T0=15.78 T1=0.00 T2=2.65 — pondere **5.30**
  - test de permutation : **p = 0.0335** — ecart significatif au seuil 0.05
...
- TROP-CHER : 793 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 791 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 6153 systemes
  - sans CONNECTED : 0.0% sur 1349 systemes
