...
genere 2026-08-30 11:45 UTC — 217413 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 134069 systemes
...
- moteur actif `0caa9267db60` (173671 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 106730 | 53013 | 7274 | 3566 | 10749 | 8479 | 11295 | 10964 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 104568 | 24389 | 44163 | 49 | 14427 | 5407 | 41 | 16083 | 15.4% |
...
- candidats SANS connectivite : 16393, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11569 systemes avec CONNECTED sur 89582 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*23194 candidats sur 27484 portent les champs bruts (84%).*

- `5c556c16ea8b` — 17229 candidats
  - AVEC connectivite (6963) : resistance **41.1%**
  - SANS connectivite (10266) : resistance **21.5%**
...
- `5c556c16ea8b` — 17229 candidats
  ...
  - SANS connectivite (10266) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 11620 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11569 avec CONNECTED, 51 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 87081 systemes
  - sans CONNECTED : 0.0% sur 19649 systemes
