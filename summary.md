...
genere 2026-09-08 06:37 UTC — 452164 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 368820 systemes
...
- moteur actif `0caa9267db60` (408422 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 225267 | 111850 | 15336 | 7516 | 22807 | 17654 | 24006 | 23225 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 220782 | 51424 | 93061 | 87 | 30761 | 11412 | 80 | 33939 | 15.4% |
...
- candidats AVEC connectivite : 23352, dont T2 : 100%
- candidats SANS connectivite : 34249, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **24280 systemes avec CONNECTED sur 186446 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*53311 candidats sur 57601 portent les champs bruts (93%).*

- `5c556c16ea8b` — 47346 candidats
  - AVEC connectivite (19224) : resistance **41.2%**
  - SANS connectivite (28122) : resistance **21.3%**
...
- `5c556c16ea8b` — 47346 candidats
  - AVEC connectivite (19224) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (28122) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 183945 systemes
  - sans CONNECTED : 0.0% sur 41322 systemes
