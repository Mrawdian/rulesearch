...
| connect | 4 | 3 | 17962 | 8984 | 1166 | 619 | 1779 | 1427 | 1956 | 1807 | 10.1% |
...
- candidats AVEC connectivite : 1934, dont T2 : 100%
- candidats SANS connectivite : 3010, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2230 systemes avec CONNECTED sur 17171 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*654 candidats sur 4944 portent les champs bruts (13%).*
...
- `e3baecf8377b` — 390 candidats
  - AVEC connectivite (151) : resistance **44.5%**
...
- `e3baecf8377b` — 390 candidats
  - AVEC connectivite (151) : T0=12.95 T1=0.00 T2=3.26 — pondere **6.52**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14670 systemes
  - sans CONNECTED : 0.0% sur 3292 systemes
