...
genere 2026-09-07 21:20 UTC — 443848 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 360504 systemes
...
- moteur actif `0caa9267db60` (400106 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 221068 | 109790 | 15079 | 7381 | 22380 | 17313 | 23521 | 22790 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 216665 | 50466 | 91292 | 85 | 30199 | 11199 | 77 | 33329 | 15.4% |
...
- candidats AVEC connectivite : 22917, dont T2 : 100%
- candidats SANS connectivite : 33639, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23795 systemes avec CONNECTED sur 183011 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*52266 candidats sur 56556 portent les champs bruts (92%).*

- `5c556c16ea8b` — 46301 candidats
  - AVEC connectivite (18789) : resistance **41.2%**
  - SANS connectivite (27512) : resistance **21.3%**
...
- `5c556c16ea8b` — 46301 candidats
  - AVEC connectivite (18789) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (27512) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 180510 systemes
  - sans CONNECTED : 0.0% sur 40558 systemes
