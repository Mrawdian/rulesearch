...
genere 2026-08-26 12:44 UTC — 44711 systemes evalues
...
| connect | 4 | 3 | 19502 | 9723 | 1274 | 680 | 1947 | 1550 | 2099 | 1985 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 19094 | 4478 | 8051 | 13 | 2636 | 989 | 7 | 2920 | 15.3% |
...
- candidats AVEC connectivite : 2112, dont T2 : 100%
- candidats SANS connectivite : 3230, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2373 systemes avec CONNECTED sur 18425 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1052 candidats sur 5342 portent les champs bruts (20%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `e40600351a72` — 131 candidats
  - AVEC connectivite (61) : resistance **40.3%**
  - SANS connectivite (70) : resistance **18.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e40600351a72` — 131 candidats
  - AVEC connectivite (61) : T0=12.98 T1=0.00 T2=2.97 — pondere **5.93**
  - SANS connectivite (70) : T0=16.84 T1=0.00 T2=2.56 — pondere **5.11**
...
- TROP-CHER : 2390 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2373 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 15924 systemes
  - sans CONNECTED : 0.0% sur 3578 systemes
