...
| connect | 4 | 3 | 17005 | 8491 | 1096 | 589 | 1691 | 1353 | 1855 | 1715 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 16660 | 3924 | 7058 | 11 | 2268 | 842 | 7 | 2550 | 15.3% |
...
- candidats AVEC connectivite : 1842, dont T2 : 100%
- candidats SANS connectivite : 2860, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2129 systemes avec CONNECTED sur 16399 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*412 candidats sur 4702 portent les champs bruts (9%).*
...
- `e3baecf8377b` — 148 candidats
  - AVEC connectivite (59) : resistance **41.0%**
  - SANS connectivite (89) : resistance **20.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 148 candidats
  - AVEC connectivite (59) : T0=13.47 T1=0.00 T2=3.10 — pondere **6.20**
  - SANS connectivite (89) : T0=15.78 T1=0.00 T2=2.54 — pondere **5.08**
...
**2 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0460).
...
- TROP-CHER : 2146 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2129 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 13898 systemes
  - sans CONNECTED : 0.0% sur 3107 systemes
