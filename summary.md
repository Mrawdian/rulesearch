...
genere 2026-09-09 15:59 UTC — 481810 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 398466 systemes
...
- moteur actif `0caa9267db60` (438068 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 240246 | 119260 | 16384 | 8048 | 24316 | 18848 | 25585 | 24756 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 235449 | 54855 | 99224 | 92 | 32804 | 12160 | 86 | 36209 | 15.4% |
...
- candidats AVEC connectivite : 24883, dont T2 : 100%
- candidats SANS connectivite : 36519, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25859 systemes avec CONNECTED sur 198629 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*57112 candidats sur 61402 portent les champs bruts (93%).*

- `5c556c16ea8b` — 51147 candidats
  - AVEC connectivite (20755) : resistance **41.2%**
  - SANS connectivite (30392) : resistance **21.3%**
...
- `5c556c16ea8b` — 51147 candidats
  - AVEC connectivite (20755) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (30392) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 196128 systemes
  - sans CONNECTED : 0.0% sur 44118 systemes
