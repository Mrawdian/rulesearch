...
| connect | 4 | 3 | 5635 | 2843 | 361 | 204 | 538 | 459 | 586 | 577 | 10.2% |
| ref | 4 | 3 | 5496 | 1330 | 2296 | 1 | 732 | 268 | 2 | 867 | 15.8% |
...
- candidats AVEC connectivite : 580, dont T2 : 100%
- candidats SANS connectivite : 871, dont T2 : 100%
...
- **586 systemes avec CONNECTED sur 4670 (12.5%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 286 candidats
  - AVEC connectivite (101) : T0=13.15 T1=0.00 T2=2.79 — pondere **5.58**
  - SANS connectivite (185) : T0=15.96 T1=0.00 T2=2.64 — pondere **5.28**
  - test de permutation : **p = 0.4118** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 588 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 586 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 4613 systemes
  - sans CONNECTED : 0.0% sur 1022 systemes
