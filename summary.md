...
- moteur actif `0caa9267db60` (8258 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23192 | 11556 | 1572 | 787 | 2312 | 1843 | 2479 | 2352 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 22693 | 5249 | 9580 | 14 | 3183 | 1157 | 10 | 3500 | 15.4% |
...
- candidats AVEC connectivite : 2479, dont T2 : 100%
- candidats SANS connectivite : 3810, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2753 systemes avec CONNECTED sur 21431 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1999 candidats sur 6289 portent les champs bruts (32%).*
...
- `06fe04a859f1` — 884 candidats
  - AVEC connectivite (341) : resistance **41.3%**
  - SANS connectivite (543) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 884 candidats
  - AVEC connectivite (341) : T0=13.23 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (543) : T0=16.02 T1=0.00 T2=2.64 — pondere **5.27**
...
- TROP-CHER : 2773 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2753 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18930 systemes
  - sans CONNECTED : 0.0% sur 4262 systemes
