...
genere 2026-09-01 23:27 UTC — 295898 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 212554 systemes
...
- moteur actif `0caa9267db60` (252156 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 146350 | 72688 | 9954 | 4908 | 14864 | 11539 | 15469 | 15043 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 143433 | 33369 | 60668 | 61 | 19861 | 7410 | 63 | 21990 | 15.3% |
...
- candidats AVEC connectivite : 15170, dont T2 : 100%
- candidats SANS connectivite : 22300, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15743 systemes avec CONNECTED sur 121945 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*33180 candidats sur 37470 portent les champs bruts (89%).*

- `5c556c16ea8b` — 27215 candidats
  - AVEC connectivite (11042) : resistance **41.0%**
  - SANS connectivite (16173) : resistance **21.3%**
...
- `5c556c16ea8b` — 27215 candidats
  - AVEC connectivite (11042) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (16173) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 119444 systemes
