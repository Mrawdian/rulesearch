...
genere 2026-09-09 17:20 UTC — 482941 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 399597 systemes
...
- moteur actif `0caa9267db60` (439199 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 240815 | 119541 | 16415 | 8071 | 24376 | 18891 | 25653 | 24815 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 236011 | 54997 | 99451 | 94 | 32878 | 12183 | 86 | 36301 | 15.4% |
...
- candidats AVEC connectivite : 24942, dont T2 : 100%
- candidats SANS connectivite : 36611, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25927 systemes avec CONNECTED sur 199097 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*57263 candidats sur 61553 portent les champs bruts (93%).*

- `5c556c16ea8b` — 51298 candidats
  - AVEC connectivite (20814) : resistance **41.2%**
  - SANS connectivite (30484) : resistance **21.3%**
...
- `5c556c16ea8b` — 51298 candidats
  - AVEC connectivite (20814) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.97**
  - SANS connectivite (30484) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 26023 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25927 avec CONNECTED, 96 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 196596 systemes
  - sans CONNECTED : 0.0% sur 44219 systemes
