...
genere 2026-08-26 04:51 UTC — 24372 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 15398 systemes
...
| connect | 4 | 3 | 12254 | 6138 | 805 | 424 | 1179 | 981 | 1332 | 1244 | 10.2% |
| ref | 4 | 3 | 11994 | 2858 | 5046 | 9 | 1622 | 610 | 4 | 1845 | 15.4% |
...
- candidats AVEC connectivite : 1247, dont T2 : 100%
- candidats SANS connectivite : 1849, dont T2 : 100%
...
- **1332 systemes avec CONNECTED sur 10101 (13.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1931 candidats
  - AVEC connectivite (768) : T0=13.31 T1=0.00 T2=2.83 — pondere **5.65**
  - SANS connectivite (1163) : T0=15.87 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 1336 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1332 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 10044 systemes
  - sans CONNECTED : 0.0% sur 2210 systemes
