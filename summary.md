...
genere 2026-09-03 05:30 UTC — 330515 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 247171 systemes
...
- moteur actif `0caa9267db60` (286773 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 163820 | 81397 | 11130 | 5479 | 16686 | 12912 | 17361 | 16758 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 160580 | 37420 | 67884 | 65 | 22251 | 8301 | 65 | 24582 | 15.3% |
...
- candidats AVEC connectivite : 16885, dont T2 : 100%
- candidats SANS connectivite : 24892, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **17635 systemes avec CONNECTED sur 136141 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*37487 candidats sur 41777 portent les champs bruts (90%).*

- `5c556c16ea8b` — 31522 candidats
  - AVEC connectivite (12757) : resistance **41.1%**
  - SANS connectivite (18765) : resistance **21.2%**
...
- `5c556c16ea8b` — 31522 candidats
  - AVEC connectivite (12757) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (18765) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 17710 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 17635 avec CONNECTED, 75 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 133640 systemes
  - sans CONNECTED : 0.0% sur 30180 systemes
