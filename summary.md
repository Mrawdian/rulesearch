...
genere 2026-08-26 23:09 UTC — 68748 systemes evalues
...
- moteur actif `0caa9267db60` (25006 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 31653 | 15721 | 2168 | 1062 | 3155 | 2525 | 3383 | 3236 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 30980 | 7134 | 13174 | 18 | 4285 | 1608 | 14 | 4747 | 15.3% |
...
- candidats SANS connectivite : 5057, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3657 systemes avec CONNECTED sur 28375 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4130 candidats sur 8420 portent les champs bruts (49%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 453 candidats
  - AVEC connectivite (183) : resistance **42.3%**
  - SANS connectivite (270) : resistance **22.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 453 candidats
  ...
  - SANS connectivite (270) : T0=16.03 T1=0.00 T2=2.68 — pondere **5.36**
...
- TROP-CHER : 3681 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 3657 avec CONNECTED, 24 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 25874 systemes
  - sans CONNECTED : 0.0% sur 5779 systemes
