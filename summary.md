...
genere 2026-09-04 10:55 UTC — 362851 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 279507 systemes
...
- moteur actif `0caa9267db60` (319109 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 180148 | 89522 | 12241 | 6024 | 18336 | 14197 | 19087 | 18442 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 176588 | 41002 | 74630 | 72 | 24532 | 9145 | 70 | 27123 | 15.4% |
...
- candidats AVEC connectivite : 18569, dont T2 : 100%
- candidats SANS connectivite : 27433, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19361 systemes avec CONNECTED sur 149463 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*41712 candidats sur 46002 portent les champs bruts (91%).*

- `5c556c16ea8b` — 35747 candidats
  - AVEC connectivite (14441) : resistance **41.0%**
  - SANS connectivite (21306) : resistance **21.2%**
...
- `5c556c16ea8b` — 35747 candidats
  - AVEC connectivite (14441) : T0=13.03 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (21306) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 146962 systemes
  - sans CONNECTED : 0.0% sur 33186 systemes
