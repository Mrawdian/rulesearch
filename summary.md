...
genere 2026-08-26 14:10 UTC — 48331 systemes evalues
...
- moteur actif `0caa9267db60` (4589 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21336 | 10649 | 1417 | 735 | 2109 | 1695 | 2280 | 2181 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20880 | 4864 | 8812 | 13 | 2897 | 1079 | 7 | 3208 | 15.4% |
...
- candidats AVEC connectivite : 2308, dont T2 : 100%
- candidats SANS connectivite : 3518, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2554 systemes avec CONNECTED sur 19935 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1536 candidats sur 5826 portent les champs bruts (26%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 421 candidats
  - AVEC connectivite (170) : resistance **39.7%**
  - SANS connectivite (251) : resistance **20.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 421 candidats
  - AVEC connectivite (170) : T0=13.44 T1=0.00 T2=2.95 — pondere **5.91**
  - SANS connectivite (251) : T0=16.07 T1=0.00 T2=2.65 — pondere **5.29**
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0495).
...
- TROP-CHER : 2571 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2554 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17434 systemes
  - sans CONNECTED : 0.0% sur 3902 systemes
