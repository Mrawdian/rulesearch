...
genere 2026-09-05 22:27 UTC — 399251 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 315907 systemes
...
- moteur actif `0caa9267db60` (355509 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 198531 | 98560 | 13518 | 6617 | 20165 | 15639 | 21080 | 20427 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 194605 | 45291 | 82101 | 78 | 27095 | 10052 | 72 | 29900 | 15.4% |
...
- candidats SANS connectivite : 30210, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21354 systemes avec CONNECTED sur 164464 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*46474 candidats sur 50764 portent les champs bruts (92%).*

- `5c556c16ea8b` — 40509 candidats
  - AVEC connectivite (16426) : resistance **41.1%**
  - SANS connectivite (24083) : resistance **21.3%**
...
- `5c556c16ea8b` — 40509 candidats
  ...
  - SANS connectivite (24083) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 21436 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21354 avec CONNECTED, 82 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 161963 systemes
  - sans CONNECTED : 0.0% sur 36568 systemes
