...
genere 2026-09-03 10:37 UTC — 336270 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 252926 systemes
...
- moteur actif `0caa9267db60` (292528 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 166735 | 82851 | 11320 | 5581 | 16981 | 13166 | 17667 | 17032 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 163420 | 38061 | 69065 | 66 | 22666 | 8443 | 66 | 25041 | 15.3% |
...
- candidats AVEC connectivite : 17159, dont T2 : 100%
...
- **17941 systemes avec CONNECTED sur 138520 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*38220 candidats sur 42510 portent les champs bruts (90%).*

- `5c556c16ea8b` — 32255 candidats
  - AVEC connectivite (13031) : resistance **41.1%**
...
- `5c556c16ea8b` — 32255 candidats
  - AVEC connectivite (13031) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 18017 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 17941 avec CONNECTED, 76 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 136019 systemes
  - sans CONNECTED : 0.0% sur 30716 systemes
