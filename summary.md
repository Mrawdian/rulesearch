...
genere 2026-09-01 23:07 UTC — 295440 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 212096 systemes
...
- moteur actif `0caa9267db60` (251698 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 146128 | 72565 | 9931 | 4903 | 14844 | 11520 | 15451 | 15030 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 143197 | 33314 | 60578 | 61 | 19828 | 7395 | 63 | 21947 | 15.3% |
...
- candidats AVEC connectivite : 15157, dont T2 : 100%
- candidats SANS connectivite : 22257, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15725 systemes avec CONNECTED sur 121759 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*33124 candidats sur 37414 portent les champs bruts (89%).*

- `5c556c16ea8b` — 27159 candidats
  - AVEC connectivite (11029) : resistance **41.0%**
  - SANS connectivite (16130) : resistance **21.3%**
...
- `5c556c16ea8b` — 27159 candidats
  - AVEC connectivite (11029) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (16130) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 15798 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15725 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 119258 systemes
  - sans CONNECTED : 0.0% sur 26870 systemes
