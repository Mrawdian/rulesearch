...
genere 2026-08-28 07:31 UTC — 133966 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 50622 systemes
...
- moteur actif `0caa9267db60` (90224 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 64586 | 32077 | 4434 | 2194 | 6482 | 5147 | 6785 | 6632 | 10.3% |
...
- candidats AVEC connectivite : 6759, dont T2 : 100%
...
- **7059 systemes avec CONNECTED sur 55178 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12488 candidats sur 16778 portent les champs bruts (74%).*

- `5c556c16ea8b` — 6523 candidats
  - AVEC connectivite (2631) : resistance **41.4%**
...
- `5c556c16ea8b` — 6523 candidats
  - AVEC connectivite (2631) : T0=12.98 T1=0.00 T2=3.01 — pondere **6.02**
...
- TROP-CHER : 7097 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7059 avec CONNECTED, 38 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 52677 systemes
  - sans CONNECTED : 0.0% sur 11909 systemes
