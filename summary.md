...
genere 2026-08-26 04:14 UTC — 22958 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 13984 systemes
...
| connect | 4 | 3 | 11536 | 5777 | 762 | 398 | 1114 | 927 | 1245 | 1165 | 10.1% |
...
- candidats AVEC connectivite : 1168, dont T2 : 100%
...
- **1245 systemes avec CONNECTED sur 9502 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1742 candidats
  - AVEC connectivite (689) : T0=13.36 T1=0.00 T2=2.83 — pondere **5.66**
...
- TROP-CHER : 1249 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 1245 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 9445 systemes
