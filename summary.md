...
- candidats SANS connectivite : 3259, dont T2 : 100%
...
*1101 candidats sur 5391 portent les champs bruts (20%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `e40600351a72` — 180 candidats
  - AVEC connectivite (81) : resistance **39.8%**
  - SANS connectivite (99) : resistance **19.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e40600351a72` — 180 candidats
  ...
  - SANS connectivite (99) : T0=16.62 T1=0.00 T2=2.58 — pondere **5.15**
