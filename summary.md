...
genere 2026-08-31 10:17 UTC — 248844 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 165500 systemes
...
- moteur actif `0caa9267db60` (205102 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 122600 | 60975 | 8312 | 4106 | 12335 | 9688 | 12951 | 12634 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 120129 | 28045 | 50702 | 53 | 16612 | 6209 | 54 | 18444 | 15.4% |
...
- candidats SANS connectivite : 18754, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13225 systemes avec CONNECTED sur 102578 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*27225 candidats sur 31515 portent les champs bruts (86%).*

- `5c556c16ea8b` — 21260 candidats
  - AVEC connectivite (8633) : resistance **41.0%**
  - SANS connectivite (12627) : resistance **21.3%**
...
- `5c556c16ea8b` — 21260 candidats
  ...
  - SANS connectivite (12627) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 13289 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13225 avec CONNECTED, 64 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 100077 systemes
  - sans CONNECTED : 0.0% sur 22523 systemes
