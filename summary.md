...
genere 2026-08-26 19:08 UTC — 60102 systemes evalues
...
- moteur actif `0caa9267db60` (16360 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27285 | 13614 | 1858 | 922 | 2703 | 2161 | 2895 | 2791 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 26702 | 6168 | 11300 | 15 | 3720 | 1375 | 10 | 4114 | 15.4% |
...
- candidats AVEC connectivite : 2918, dont T2 : 100%
- candidats SANS connectivite : 4424, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3169 systemes avec CONNECTED sur 24820 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3052 candidats sur 7342 portent les champs bruts (42%).*
...
- `23303c299f39` — 225 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 183 candidats
  - AVEC connectivite (74) : resistance **40.2%**
  - SANS connectivite (109) : resistance **18.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 183 candidats
  - AVEC connectivite (74) : T0=13.12 T1=0.00 T2=2.96 — pondere **5.92**
  - SANS connectivite (109) : T0=16.03 T1=0.00 T2=2.56 — pondere **5.12**
  - test de permutation : **p = 0.0790** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
## cout
- temps total 18.5 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 3189 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3169 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22319 systemes
  - sans CONNECTED : 0.0% sur 4966 systemes
