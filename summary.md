...
genere 2026-08-29 13:34 UTC — 184493 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 101149 systemes
...
- moteur actif `0caa9267db60` (140751 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 90088 | 44805 | 6123 | 3038 | 9064 | 7178 | 9471 | 9268 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 88290 | 20637 | 37267 | 43 | 12188 | 4531 | 35 | 13583 | 15.4% |
...
- candidats SANS connectivite : 13893, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9745 systemes avec CONNECTED sur 75988 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*18998 candidats sur 23288 portent les champs bruts (82%).*

- `5c556c16ea8b` — 13033 candidats
  - AVEC connectivite (5267) : resistance **41.1%**
  - SANS connectivite (7766) : resistance **21.6%**
...
- `5c556c16ea8b` — 13033 candidats
  ...
  - SANS connectivite (7766) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.33**
...
- TROP-CHER : 9790 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 9745 avec CONNECTED, 45 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 73487 systemes
  - sans CONNECTED : 0.0% sur 16601 systemes
