...
genere 2026-08-26 14:21 UTC — 48732 systemes evalues
...
- moteur actif `0caa9267db60` (4990 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21531 | 10743 | 1432 | 742 | 2131 | 1711 | 2303 | 2197 | 10.2% |
...
- candidats AVEC connectivite : 2324, dont T2 : 100%
- candidats SANS connectivite : 3554, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2577 systemes avec CONNECTED sur 20097 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1588 candidats sur 5878 portent les champs bruts (27%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 473 candidats
  - AVEC connectivite (186) : resistance **40.3%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 473 candidats
  - AVEC connectivite (186) : T0=13.37 T1=0.00 T2=2.99 — pondere **5.99**
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0210).
...
- TROP-CHER : 2595 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2577 avec CONNECTED, 18 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17596 systemes
  - sans CONNECTED : 0.0% sur 3935 systemes
