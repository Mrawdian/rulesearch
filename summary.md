...
genere 2026-08-29 15:22 UTC — 187191 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 103847 systemes
...
- moteur actif `0caa9267db60` (143449 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 91461 | 45484 | 6216 | 3076 | 9205 | 7286 | 9626 | 9404 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 89615 | 20936 | 37813 | 43 | 12397 | 4598 | 36 | 13786 | 15.4% |
...
- candidats AVEC connectivite : 9531, dont T2 : 100%
- candidats SANS connectivite : 14096, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9900 systemes avec CONNECTED sur 77108 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*19337 candidats sur 23627 portent les champs bruts (82%).*

- `5c556c16ea8b` — 13372 candidats
  - AVEC connectivite (5403) : resistance **41.2%**
  - SANS connectivite (7969) : resistance **21.6%**
...
- `5c556c16ea8b` — 13372 candidats
  - AVEC connectivite (5403) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (7969) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.33**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 74607 systemes
  - sans CONNECTED : 0.0% sur 16854 systemes
