...
genere 2026-08-28 01:03 UTC — 122089 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 38745 systemes
...
- moteur actif `0caa9267db60` (78347 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 58572 | 29177 | 4047 | 1976 | 5823 | 4632 | 6159 | 6006 | 10.3% |
...
- candidats AVEC connectivite : 6133, dont T2 : 100%
- candidats SANS connectivite : 9103, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6433 systemes avec CONNECTED sur 50328 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10946 candidats sur 15236 portent les champs bruts (72%).*

- `5c556c16ea8b` — 4981 candidats
  - AVEC connectivite (2005) : resistance **42.0%**
...
- `5c556c16ea8b` — 4981 candidats
  - AVEC connectivite (2005) : T0=13.00 T1=0.00 T2=3.05 — pondere **6.10**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 47827 systemes
  - sans CONNECTED : 0.0% sur 10745 systemes
