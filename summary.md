...
genere 2026-08-28 10:12 UTC — 138653 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 55309 systemes
...
- moteur actif `0caa9267db60` (94911 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 66949 | 33265 | 4594 | 2280 | 6705 | 5338 | 7048 | 6862 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 65589 | 15165 | 27735 | 30 | 9140 | 3385 | 28 | 10103 | 15.4% |
...
- candidats AVEC connectivite : 6989, dont T2 : 100%
- candidats SANS connectivite : 10413, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7322 systemes avec CONNECTED sur 57115 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*13112 candidats sur 17402 portent les champs bruts (75%).*

- `5c556c16ea8b` — 7147 candidats
  - AVEC connectivite (2861) : resistance **41.4%**
  - SANS connectivite (4286) : resistance **21.7%**
...
- `5c556c16ea8b` — 7147 candidats
  - AVEC connectivite (2861) : T0=12.99 T1=0.00 T2=3.01 — pondere **6.03**
  - SANS connectivite (4286) : T0=15.86 T1=0.00 T2=2.67 — pondere **5.35**
...
## cout
- temps total 42.7 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 7360 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7322 avec CONNECTED, 38 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 54614 systemes
  - sans CONNECTED : 0.0% sur 12335 systemes
