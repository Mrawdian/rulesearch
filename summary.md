...
genere 2026-08-25 22:47 UTC — 9061 systemes evalues
...
- `89c65c03c4ad` : 87 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)

Les lignes de dsl_hash differents ne sont pas comparables entre elles.

**7553 enregistrements (83%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
