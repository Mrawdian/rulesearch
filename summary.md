...
- **4284 systemes avec CONNECTED sur 33534 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- TROP-CHER : 4314 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4284 avec CONNECTED, 30 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 31033 systemes
  - sans CONNECTED : 0.0% sur 6883 systemes
