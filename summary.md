...
genere 2026-08-27 00:33 UTC — 71916 systemes evalues
...
- moteur actif `0caa9267db60` (28174 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 33254 | 16524 | 2286 | 1125 | 3305 | 2643 | 3546 | 3400 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 32547 | 7505 | 13816 | 18 | 4519 | 1704 | 16 | 4969 | 15.3% |
...
- candidats AVEC connectivite : 3527, dont T2 : 100%
- candidats SANS connectivite : 5279, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3820 systemes avec CONNECTED sur 29697 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4516 candidats sur 8806 portent les champs bruts (51%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 839 candidats
  - AVEC connectivite (347) : resistance **41.2%**
  - SANS connectivite (492) : resistance **21.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 839 candidats
  - AVEC connectivite (347) : T0=13.11 T1=0.00 T2=3.06 — pondere **6.13**
  - SANS connectivite (492) : T0=15.93 T1=0.00 T2=2.60 — pondere **5.20**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 798 candidats
...
- TROP-CHER : 3846 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3820 avec CONNECTED, 26 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 27196 systemes
  - sans CONNECTED : 0.0% sur 6058 systemes
