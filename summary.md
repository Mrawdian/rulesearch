...
genere 2026-08-30 19:15 UTC — 228145 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 144801 systemes
...
- moteur actif `0caa9267db60` (184403 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 112156 | 55770 | 7617 | 3750 | 11274 | 8867 | 11864 | 11556 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 109874 | 25614 | 46411 | 51 | 15167 | 5676 | 45 | 16900 | 15.4% |
...
- candidats AVEC connectivite : 11683, dont T2 : 100%
- candidats SANS connectivite : 17210, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12138 systemes avec CONNECTED sur 94048 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*24603 candidats sur 28893 portent les champs bruts (85%).*

- `5c556c16ea8b` — 18638 candidats
  - AVEC connectivite (7555) : resistance **41.1%**
  - SANS connectivite (11083) : resistance **21.5%**
...
- `5c556c16ea8b` — 18638 candidats
  - AVEC connectivite (7555) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (11083) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 12193 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 12138 avec CONNECTED, 55 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 91547 systemes
  - sans CONNECTED : 0.0% sur 20609 systemes
