...
- moteur actif `0caa9267db60` (47043 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 42780 | 21310 | 2937 | 1446 | 4273 | 3359 | 4506 | 4393 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 41890 | 9660 | 17787 | 24 | 5802 | 2184 | 22 | 6410 | 15.3% |
...
- candidats AVEC connectivite : 4520, dont T2 : 100%
- candidats SANS connectivite : 6720, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4780 systemes avec CONNECTED sur 37457 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6950 candidats sur 11240 portent les champs bruts (62%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 985 candidats
  - AVEC connectivite (392) : resistance **41.3%**
  - SANS connectivite (593) : resistance **21.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 985 candidats
  - AVEC connectivite (392) : T0=13.06 T1=0.00 T2=3.00 — pondere **6.01**
  - SANS connectivite (593) : T0=15.86 T1=0.00 T2=2.65 — pondere **5.30**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
...
- TROP-CHER : 4812 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4780 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 34956 systemes
  - sans CONNECTED : 0.0% sur 7824 systemes
