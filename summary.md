...
genere 2026-08-26 16:06 UTC — 52853 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 7670 systemes
...
- moteur actif `0caa9267db60` (9111 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23624 | 11781 | 1604 | 806 | 2350 | 1872 | 2523 | 2392 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 23114 | 5355 | 9761 | 14 | 3231 | 1176 | 10 | 3567 | 15.4% |
...
- candidats AVEC connectivite : 2519, dont T2 : 100%
- candidats SANS connectivite : 3877, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2797 systemes avec CONNECTED sur 21788 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2106 candidats sur 6396 portent les champs bruts (33%).*
...
- `06fe04a859f1` — 991 candidats
  - AVEC connectivite (381) : resistance **41.4%**
  - SANS connectivite (610) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 991 candidats
  - AVEC connectivite (381) : T0=13.20 T1=0.00 T2=3.03 — pondere **6.07**
  - SANS connectivite (610) : T0=16.00 T1=0.00 T2=2.64 — pondere **5.29**
...
- TROP-CHER : 2817 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2797 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19287 systemes
  - sans CONNECTED : 0.0% sur 4337 systemes
