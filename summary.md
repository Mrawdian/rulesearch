...
genere 2026-09-01 12:26 UTC — 282523 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 199179 systemes
...
- moteur actif `0caa9267db60` (238781 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 139602 | 69400 | 9452 | 4669 | 14184 | 10997 | 14741 | 14356 | 10.3% |
...
- candidats AVEC connectivite : 14483, dont T2 : 100%
...
- **15015 systemes avec CONNECTED sur 116415 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*31452 candidats sur 35742 portent les champs bruts (88%).*

- `5c556c16ea8b` — 25487 candidats
  - AVEC connectivite (10355) : resistance **41.0%**
...
- `5c556c16ea8b` — 25487 candidats
  - AVEC connectivite (10355) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 15086 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15015 avec CONNECTED, 71 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 113914 systemes
  - sans CONNECTED : 0.0% sur 25688 systemes
