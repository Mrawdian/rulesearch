...
genere 2026-08-27 19:02 UTC — 110388 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 27044 systemes
...
- moteur actif `0caa9267db60` (66646 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 51613 | 11927 | 21914 | 26 | 7134 | 2689 | 24 | 7897 | 15.3% |
...
- candidats SANS connectivite : 8207, dont T2 : 100%
...
*9415 candidats sur 13705 portent les champs bruts (69%).*
...
- `5c556c16ea8b` — 3450 candidats
  - AVEC connectivite (1370) : resistance **42.2%**
  - SANS connectivite (2080) : resistance **22.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 3450 candidats
  ...
  - SANS connectivite (2080) : T0=15.78 T1=0.00 T2=2.71 — pondere **5.42**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 2280 candidats
