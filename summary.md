...
genere 2026-08-30 19:52 UTC — 228991 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 145647 systemes
...
- moteur actif `0caa9267db60` (185249 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 112590 | 55982 | 7650 | 3768 | 11312 | 8911 | 11911 | 11590 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 110286 | 25718 | 46588 | 51 | 15213 | 5705 | 45 | 16956 | 15.4% |
...
- candidats SANS connectivite : 17266, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12185 systemes avec CONNECTED sur 94399 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*24693 candidats sur 28983 portent les champs bruts (85%).*

- `5c556c16ea8b` — 18728 candidats
  - AVEC connectivite (7589) : resistance **41.1%**
  - SANS connectivite (11139) : resistance **21.4%**
...
- `5c556c16ea8b` — 18728 candidats
  ...
  - SANS connectivite (11139) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 12240 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 12185 avec CONNECTED, 55 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 91898 systemes
  - sans CONNECTED : 0.0% sur 20692 systemes
