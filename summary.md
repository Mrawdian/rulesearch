...
- candidats AVEC connectivite : 2871, dont T2 : 100%
- candidats SANS connectivite : 4359, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3123 systemes avec CONNECTED sur 24432 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2940 candidats sur 7230 portent les champs bruts (41%).*
...
- `e80bc1b2b437` — 75 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 71 candidats
  - AVEC connectivite (27) : resistance **47.5%**
...
- `62448a55927e` — 71 candidats
  - AVEC connectivite (27) : T0=13.00 T1=0.00 T2=3.30 — pondere **6.59**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 21931 systemes
  - sans CONNECTED : 0.0% sur 4876 systemes
