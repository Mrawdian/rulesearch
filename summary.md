...
genere 2026-09-02 02:55 UTC — 299839 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 216495 systemes
...
- moteur actif `0caa9267db60` (256097 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 148348 | 73695 | 10097 | 4973 | 15055 | 11668 | 15715 | 15243 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 145376 | 33808 | 61534 | 62 | 20124 | 7516 | 63 | 22257 | 15.3% |
...
- candidats AVEC connectivite : 15370, dont T2 : 100%
- candidats SANS connectivite : 22567, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15989 systemes avec CONNECTED sur 123611 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*33647 candidats sur 37937 portent les champs bruts (89%).*

- `5c556c16ea8b` — 27682 candidats
  - AVEC connectivite (11242) : resistance **41.0%**
  - SANS connectivite (16440) : resistance **21.3%**
...
- `5c556c16ea8b` — 27682 candidats
  - AVEC connectivite (11242) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (16440) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.30**
...
## cout
- temps total 93.0 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 16062 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 15989 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 121110 systemes
  - sans CONNECTED : 0.0% sur 27238 systemes
