...
genere 2026-08-27 01:57 UTC — 75056 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 10149 systemes
...
- moteur actif `0caa9267db60` (31314 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 34838 | 17335 | 2398 | 1178 | 3457 | 2771 | 3704 | 3551 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 34103 | 7859 | 14502 | 20 | 4732 | 1775 | 18 | 5197 | 15.2% |
...
- candidats AVEC connectivite : 3678, dont T2 : 100%
- candidats SANS connectivite : 5507, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3978 systemes avec CONNECTED sur 31000 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4895 candidats sur 9185 portent les champs bruts (53%).*
...
- `ab89a63b01ef` — 1218 candidats
  - AVEC connectivite (498) : resistance **41.1%**
  - SANS connectivite (720) : resistance **22.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1218 candidats
  - AVEC connectivite (498) : T0=13.03 T1=0.00 T2=3.03 — pondere **6.06**
  - SANS connectivite (720) : T0=15.89 T1=0.00 T2=2.70 — pondere **5.40**
...
- TROP-CHER : 4006 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3978 avec CONNECTED, 28 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 28499 systemes
  - sans CONNECTED : 0.0% sur 6339 systemes
