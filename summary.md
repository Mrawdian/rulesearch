...
genere 2026-08-26 16:45 UTC — 54440 systemes evalues
...
- `23303c299f39` : 90 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (10698 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
**7556 enregistrements (14%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 24419 | 12182 | 1663 | 824 | 2416 | 1930 | 2604 | 2495 | 10.2% |
...
- candidats AVEC connectivite : 2622, dont T2 : 100%
- candidats SANS connectivite : 3993, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2878 systemes avec CONNECTED sur 22453 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2325 candidats sur 6615 portent les champs bruts (35%).*
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19952 systemes
  - sans CONNECTED : 0.0% sur 4467 systemes
