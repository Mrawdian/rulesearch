...
genere 2026-08-26 13:49 UTC — 47603 systemes evalues
...
- moteur actif `0caa9267db60` (3861 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20961 | 10465 | 1389 | 721 | 2080 | 1670 | 2232 | 2143 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20527 | 4799 | 8668 | 13 | 2845 | 1062 | 7 | 3133 | 15.3% |
...
- candidats AVEC connectivite : 2270, dont T2 : 100%
- candidats SANS connectivite : 3443, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2506 systemes avec CONNECTED sur 19619 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1423 candidats sur 5713 portent les champs bruts (25%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 308 candidats
  - AVEC connectivite (132) : resistance **39.4%**
  - SANS connectivite (176) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 308 candidats
  - AVEC connectivite (132) : T0=13.39 T1=0.00 T2=2.86 — pondere **5.73**
  - SANS connectivite (176) : T0=16.16 T1=0.00 T2=2.72 — pondere **5.44**
  - test de permutation : **p = 0.4408** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
## cout
- temps total 14.7 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2523 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2506 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 17118 systemes
  - sans CONNECTED : 0.0% sur 3843 systemes
