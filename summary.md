...
| connect | 4 | 3 | 17738 | 8875 | 1145 | 613 | 1760 | 1411 | 1928 | 1783 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 17370 | 4086 | 7341 | 12 | 2376 | 884 | 7 | 2664 | 15.3% |
...
- candidats SANS connectivite : 2974, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2202 systemes avec CONNECTED sur 16988 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*594 candidats sur 4884 portent les champs bruts (12%).*
...
- `e3baecf8377b` — 330 candidats
  - AVEC connectivite (127) : resistance **43.2%**
  - SANS connectivite (203) : resistance **21.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 330 candidats
  ...
  - SANS connectivite (203) : T0=16.10 T1=0.00 T2=2.69 — pondere **5.39**
...
**2 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0200).
...
- TROP-CHER : 2219 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2202 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14487 systemes
  - sans CONNECTED : 0.0% sur 3251 systemes
