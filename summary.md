...
genere 2026-09-04 14:22 UTC — 366573 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 283229 systemes
...
- moteur actif `0caa9267db60` (322831 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 182029 | 90472 | 12377 | 6079 | 18531 | 14338 | 19277 | 18623 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 178429 | 41469 | 75380 | 73 | 24792 | 9242 | 70 | 27389 | 15.4% |
...
- candidats AVEC connectivite : 18750, dont T2 : 100%
- candidats SANS connectivite : 27699, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19551 systemes avec CONNECTED sur 150983 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*42159 candidats sur 46449 portent les champs bruts (91%).*

- `5c556c16ea8b` — 36194 candidats
  - AVEC connectivite (14622) : resistance **41.0%**
  - SANS connectivite (21572) : resistance **21.2%**
...
- `5c556c16ea8b` — 36194 candidats
  - AVEC connectivite (14622) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (21572) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 148482 systemes
  - sans CONNECTED : 0.0% sur 33547 systemes
