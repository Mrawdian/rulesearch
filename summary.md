...
genere 2026-08-27 03:43 UTC — 78942 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 14035 systemes
...
- moteur actif `0caa9267db60` (35200 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 36812 | 18298 | 2539 | 1250 | 3654 | 2913 | 3904 | 3773 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 36015 | 8303 | 15329 | 20 | 4977 | 1882 | 19 | 5485 | 15.2% |
...
- candidats AVEC connectivite : 3900, dont T2 : 100%
- candidats SANS connectivite : 5795, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4178 systemes avec CONNECTED sur 32628 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5405 candidats sur 9695 portent les champs bruts (56%).*
...
- `ab89a63b01ef` — 1728 candidats
  - AVEC connectivite (720) : resistance **41.3%**
  - SANS connectivite (1008) : resistance **21.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1728 candidats
  - AVEC connectivite (720) : T0=13.03 T1=0.00 T2=3.03 — pondere **6.06**
  - SANS connectivite (1008) : T0=15.92 T1=0.00 T2=2.70 — pondere **5.39**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 30127 systemes
  - sans CONNECTED : 0.0% sur 6685 systemes
