...
genere 2026-09-01 04:10 UTC — 272117 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 188773 systemes
...
- moteur actif `0caa9267db60` (228375 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 134351 | 66765 | 9080 | 4506 | 13630 | 10637 | 14188 | 13802 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 131651 | 30679 | 55647 | 57 | 18244 | 6795 | 59 | 20160 | 15.3% |
...
- candidats AVEC connectivite : 13929, dont T2 : 100%
- candidats SANS connectivite : 20470, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14462 systemes avec CONNECTED sur 112104 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*30109 candidats sur 34399 portent les champs bruts (88%).*

- `5c556c16ea8b` — 24144 candidats
  - AVEC connectivite (9801) : resistance **41.0%**
  - SANS connectivite (14343) : resistance **21.3%**
...
- `5c556c16ea8b` — 24144 candidats
  - AVEC connectivite (9801) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (14343) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 109603 systemes
  - sans CONNECTED : 0.0% sur 24748 systemes
