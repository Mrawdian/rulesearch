...
genere 2026-09-04 02:25 UTC — 353676 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 270332 systemes
...
- moteur actif `0caa9267db60` (309934 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 175516 | 87239 | 11934 | 5864 | 17870 | 13810 | 18604 | 17962 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 172045 | 39983 | 72666 | 70 | 23909 | 8906 | 68 | 26429 | 15.4% |
...
- candidats AVEC connectivite : 18089, dont T2 : 100%
- candidats SANS connectivite : 26739, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18878 systemes avec CONNECTED sur 145721 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*40538 candidats sur 44828 portent les champs bruts (90%).*

- `5c556c16ea8b` — 34573 candidats
  - AVEC connectivite (13961) : resistance **41.1%**
  - SANS connectivite (20612) : resistance **21.3%**
...
- `5c556c16ea8b` — 34573 candidats
  - AVEC connectivite (13961) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (20612) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 18956 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18878 avec CONNECTED, 78 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 143220 systemes
  - sans CONNECTED : 0.0% sur 32296 systemes
