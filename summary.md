...
| connect | 4 | 3 | 5351 | 2683 | 342 | 193 | 520 | 441 | 559 | 554 | 10.4% |
...
- **559 systemes avec CONNECTED sur 4426 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- TROP-CHER : 561 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 559 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 4369 systemes
  - sans CONNECTED : 0.0% sur 982 systemes
