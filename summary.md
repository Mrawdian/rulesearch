...
genere 2026-08-27 02:02 UTC — 75218 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 10311 systemes
...
- moteur actif `0caa9267db60` (31476 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 34928 | 17380 | 2404 | 1183 | 3467 | 2773 | 3714 | 3562 | 10.2% |
...
- candidats AVEC connectivite : 3689, dont T2 : 100%
- candidats SANS connectivite : 5517, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3988 systemes avec CONNECTED sur 31076 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4916 candidats sur 9206 portent les champs bruts (53%).*
...
- `ab89a63b01ef` — 1239 candidats
  - AVEC connectivite (509) : T0=13.02 T1=0.00 T2=3.05 — pondere **6.09**
...
- TROP-CHER : 4016 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3988 avec CONNECTED, 28 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 28575 systemes
  - sans CONNECTED : 0.0% sur 6353 systemes
