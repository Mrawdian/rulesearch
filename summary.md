...
genere 2026-09-08 04:40 UTC — 450388 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 367044 systemes
...
- moteur actif `0caa9267db60` (406646 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 224368 | 111416 | 15278 | 7489 | 22711 | 17590 | 23912 | 23111 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 219905 | 51231 | 92686 | 87 | 30653 | 11357 | 79 | 33794 | 15.4% |
...
- candidats AVEC connectivite : 23238, dont T2 : 100%
- candidats SANS connectivite : 34104, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **24186 systemes avec CONNECTED sur 185702 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*53052 candidats sur 57342 portent les champs bruts (93%).*

- `5c556c16ea8b` — 47087 candidats
  - AVEC connectivite (19110) : resistance **41.2%**
  - SANS connectivite (27977) : resistance **21.3%**
...
- `5c556c16ea8b` — 47087 candidats
  - AVEC connectivite (19110) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (27977) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 183201 systemes
  - sans CONNECTED : 0.0% sur 41167 systemes
