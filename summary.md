...
genere 2026-09-09 08:36 UTC — 475425 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 392081 systemes
...
- moteur actif `0caa9267db60` (431683 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 237011 | 117683 | 16164 | 7940 | 23972 | 18567 | 25250 | 24424 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 232299 | 54141 | 97840 | 92 | 32360 | 11998 | 84 | 35765 | 15.4% |
...
- candidats AVEC connectivite : 24551, dont T2 : 100%
- candidats SANS connectivite : 36075, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25524 systemes avec CONNECTED sur 196029 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*56336 candidats sur 60626 portent les champs bruts (93%).*

- `5c556c16ea8b` — 50371 candidats
  - AVEC connectivite (20423) : resistance **41.2%**
  - SANS connectivite (29948) : resistance **21.3%**
...
- `5c556c16ea8b` — 50371 candidats
  - AVEC connectivite (20423) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (29948) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 25618 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25524 avec CONNECTED, 94 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 193528 systemes
  - sans CONNECTED : 0.0% sur 43483 systemes
