...
genere 2026-09-04 11:23 UTC — 363357 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 280013 systemes
...
- moteur actif `0caa9267db60` (319615 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 180403 | 89643 | 12263 | 6030 | 18366 | 14214 | 19114 | 18472 | 10.2% |
...
- candidats AVEC connectivite : 18599, dont T2 : 100%
...
- **19388 systemes avec CONNECTED sur 149666 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*41778 candidats sur 46068 portent les champs bruts (91%).*

- `5c556c16ea8b` — 35813 candidats
  - AVEC connectivite (14471) : resistance **41.0%**
...
- `5c556c16ea8b` — 35813 candidats
  - AVEC connectivite (14471) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.95**
...
- TROP-CHER : 19468 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19388 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 147165 systemes
