...
genere 2026-09-04 18:15 UTC — 370600 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 287256 systemes
...
- moteur actif `0caa9267db60` (326858 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 184064 | 91453 | 12526 | 6154 | 18717 | 14492 | 19504 | 18853 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 180421 | 41941 | 76229 | 75 | 25075 | 9339 | 70 | 27678 | 15.3% |
...
- candidats AVEC connectivite : 18980, dont T2 : 100%
...
- **19778 systemes avec CONNECTED sur 152660 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*42678 candidats sur 46968 portent les champs bruts (91%).*

- `5c556c16ea8b` — 36713 candidats
  - AVEC connectivite (14852) : resistance **41.0%**
...
- `5c556c16ea8b` — 36713 candidats
  - AVEC connectivite (14852) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.95**
...
- TROP-CHER : 19858 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19778 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 150159 systemes
  - sans CONNECTED : 0.0% sur 33905 systemes
