...
genere 2026-08-30 05:31 UTC — 208601 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 125257 systemes
...
- moteur actif `0caa9267db60` (164859 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 102289 | 50787 | 6962 | 3425 | 10330 | 8159 | 10785 | 10509 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 100197 | 23327 | 42342 | 45 | 13839 | 5174 | 38 | 15425 | 15.4% |
...
- candidats AVEC connectivite : 10636, dont T2 : 100%
- candidats SANS connectivite : 15735, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11059 systemes avec CONNECTED sur 85918 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*22081 candidats sur 26371 portent les champs bruts (84%).*

- `5c556c16ea8b` — 16116 candidats
  - AVEC connectivite (6508) : resistance **41.1%**
  - SANS connectivite (9608) : resistance **21.5%**
...
- `5c556c16ea8b` — 16116 candidats
  - AVEC connectivite (6508) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (9608) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.32**
...
## cout
- temps total 64.4 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 11107 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11059 avec CONNECTED, 48 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 83417 systemes
  - sans CONNECTED : 0.0% sur 18872 systemes
