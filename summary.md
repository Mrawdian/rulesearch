...
genere 2026-09-02 19:58 UTC — 319545 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 236201 systemes
...
- moteur actif `0caa9267db60` (275803 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 158292 | 78651 | 10780 | 5287 | 16092 | 12446 | 16787 | 16225 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 155138 | 36163 | 65613 | 64 | 21428 | 8012 | 63 | 23783 | 15.3% |
...
- candidats AVEC connectivite : 16352, dont T2 : 100%
- candidats SANS connectivite : 24093, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **17061 systemes avec CONNECTED sur 131723 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*36155 candidats sur 40445 portent les champs bruts (89%).*

- `5c556c16ea8b` — 30190 candidats
  - AVEC connectivite (12224) : resistance **41.0%**
  - SANS connectivite (17966) : resistance **21.2%**
...
- `5c556c16ea8b` — 30190 candidats
  - AVEC connectivite (12224) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (17966) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.29**
...
## cout
- temps total 99.2 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 17134 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 17061 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 129222 systemes
  - sans CONNECTED : 0.0% sur 29070 systemes
