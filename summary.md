...
genere 2026-08-31 10:43 UTC — 249386 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 166042 systemes
...
- moteur actif `0caa9267db60` (205644 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 122884 | 61116 | 8331 | 4122 | 12369 | 9702 | 12984 | 12658 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 120387 | 28103 | 50818 | 53 | 16645 | 6226 | 54 | 18478 | 15.3% |
...
- candidats AVEC connectivite : 12785, dont T2 : 100%
...
- **13258 systemes avec CONNECTED sur 102809 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*27283 candidats sur 31573 portent les champs bruts (86%).*

- `5c556c16ea8b` — 21318 candidats
  - AVEC connectivite (8657) : resistance **41.0%**
...
- `5c556c16ea8b` — 21318 candidats
  - AVEC connectivite (8657) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 13322 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13258 avec CONNECTED, 64 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 100308 systemes
  - sans CONNECTED : 0.0% sur 22576 systemes
