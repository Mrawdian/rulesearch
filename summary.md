...
genere 2026-09-02 02:41 UTC — 299589 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 216245 systemes
...
- moteur actif `0caa9267db60` (255847 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 148215 | 73624 | 10088 | 4971 | 15048 | 11656 | 15698 | 15228 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 145259 | 33786 | 61473 | 62 | 20112 | 7511 | 63 | 22240 | 15.3% |
...
- candidats AVEC connectivite : 15355, dont T2 : 100%
- candidats SANS connectivite : 22550, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15972 systemes avec CONNECTED sur 123500 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*33615 candidats sur 37905 portent les champs bruts (89%).*

- `5c556c16ea8b` — 27650 candidats
  - AVEC connectivite (11227) : resistance **41.0%**
  - SANS connectivite (16423) : resistance **21.3%**
...
- `5c556c16ea8b` — 27650 candidats
  - AVEC connectivite (11227) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (16423) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.30**
...
## cout
- temps total 92.9 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 16045 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 15972 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 120999 systemes
  - sans CONNECTED : 0.0% sur 27216 systemes
