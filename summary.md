...
genere 2026-08-30 03:25 UTC — 205637 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 122293 systemes
...
- moteur actif `0caa9267db60` (161895 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 100791 | 50040 | 6867 | 3375 | 10165 | 8049 | 10606 | 10375 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 98731 | 23000 | 41710 | 45 | 13643 | 5108 | 38 | 15180 | 15.4% |
...
- candidats AVEC connectivite : 10502, dont T2 : 100%
- candidats SANS connectivite : 15490, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10880 systemes avec CONNECTED sur 84687 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*21702 candidats sur 25992 portent les champs bruts (83%).*

- `5c556c16ea8b` — 15737 candidats
  - AVEC connectivite (6374) : resistance **41.1%**
  - SANS connectivite (9363) : resistance **21.5%**
...
- `5c556c16ea8b` — 15737 candidats
  - AVEC connectivite (6374) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (9363) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 10928 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10880 avec CONNECTED, 48 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 82186 systemes
  - sans CONNECTED : 0.0% sur 18605 systemes
