...
| connect | 4 | 3 | 18666 | 9313 | 1214 | 646 | 1866 | 1488 | 2022 | 1887 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 18265 | 4292 | 7697 | 13 | 2510 | 942 | 7 | 2804 | 15.4% |
...
- candidats AVEC connectivite : 2014, dont T2 : 100%
- candidats SANS connectivite : 3114, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2296 systemes avec CONNECTED sur 17728 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*838 candidats sur 5128 portent les champs bruts (16%).*
...
- `e3baecf8377b` — 574 candidats
  - AVEC connectivite (231) : resistance **42.0%**
  - SANS connectivite (343) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 574 candidats
  - AVEC connectivite (231) : T0=13.14 T1=0.00 T2=3.07 — pondere **6.15**
  - SANS connectivite (343) : T0=16.01 T1=0.00 T2=2.64 — pondere **5.28**
...
- TROP-CHER : 2313 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 2296 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 15227 systemes
  - sans CONNECTED : 0.0% sur 3439 systemes
