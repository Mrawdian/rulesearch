...
- moteur actif `0caa9267db60` (7610 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22863 | 11393 | 1543 | 776 | 2279 | 1813 | 2449 | 2322 | 10.2% |
...
- candidats AVEC connectivite : 2449, dont T2 : 100%
- candidats SANS connectivite : 3768, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2723 systemes avec CONNECTED sur 21162 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1927 candidats sur 6217 portent les champs bruts (31%).*
...
- `06fe04a859f1` — 812 candidats
  - AVEC connectivite (311) : resistance **41.1%**
...
- `06fe04a859f1` — 812 candidats
  - AVEC connectivite (311) : T0=13.32 T1=0.00 T2=3.03 — pondere **6.06**
...
- TROP-CHER : 2743 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2723 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18661 systemes
  - sans CONNECTED : 0.0% sur 4202 systemes
