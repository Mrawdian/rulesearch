...
genere 2026-08-28 23:07 UTC — 160963 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 77619 systemes
...
- moteur actif `0caa9267db60` (117221 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 78215 | 38851 | 5336 | 2661 | 7831 | 6260 | 8230 | 8050 | 10.3% |
...
- candidats AVEC connectivite : 8177, dont T2 : 100%
...
- **8504 systemes avec CONNECTED sur 66276 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*16017 candidats sur 20307 portent les champs bruts (79%).*

- `5c556c16ea8b` — 10052 candidats
  - AVEC connectivite (4049) : resistance **41.1%**
...
- `5c556c16ea8b` — 10052 candidats
  - AVEC connectivite (4049) : T0=13.01 T1=0.00 T2=3.00 — pondere **6.00**
...
- TROP-CHER : 8545 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8504 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 63775 systemes
  - sans CONNECTED : 0.0% sur 14440 systemes
