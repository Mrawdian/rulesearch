...
genere 2026-08-26 18:53 UTC — 59438 systemes evalues
...
- moteur actif `0caa9267db60` (15696 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 26381 | 6089 | 11170 | 15 | 3674 | 1360 | 10 | 4063 | 15.4% |
...
- candidats SANS connectivite : 4373, dont T2 : 100%
...
*2961 candidats sur 7251 portent les champs bruts (41%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 92 candidats
  - AVEC connectivite (34) : resistance **47.1%**
  - SANS connectivite (58) : resistance **16.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 92 candidats
  ...
  - SANS connectivite (58) : T0=16.16 T1=0.00 T2=2.43 — pondere **4.86**
...
**6 serie(s) reproductible(s) sur 12 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0060), `62448a55927e` (p=0.0090), `b71bb0907fb5` (p=0.0110).
