...
genere 2026-09-03 03:27 UTC — 328237 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 244893 systemes
...
- moteur actif `0caa9267db60` (284495 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 162670 | 80828 | 11053 | 5442 | 16562 | 12821 | 17231 | 16654 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 159452 | 37140 | 67400 | 65 | 22095 | 8242 | 65 | 24433 | 15.3% |
...
- candidats AVEC connectivite : 16781, dont T2 : 100%
- candidats SANS connectivite : 24743, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **17505 systemes avec CONNECTED sur 135209 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*37234 candidats sur 41524 portent les champs bruts (90%).*

- `5c556c16ea8b` — 31269 candidats
  - AVEC connectivite (12653) : resistance **41.1%**
  - SANS connectivite (18616) : resistance **21.2%**
...
- `5c556c16ea8b` — 31269 candidats
  - AVEC connectivite (12653) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (18616) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 17580 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 17505 avec CONNECTED, 75 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 132708 systemes
  - sans CONNECTED : 0.0% sur 29962 systemes
