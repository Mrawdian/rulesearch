...
genere 2026-08-27 23:11 UTC — 118342 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 34998 systemes
...
- moteur actif `0caa9267db60` (74600 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 56681 | 28240 | 3921 | 1924 | 5619 | 4484 | 5982 | 5783 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 55546 | 12822 | 23564 | 26 | 7720 | 2871 | 25 | 8516 | 15.3% |
...
- candidats AVEC connectivite : 5910, dont T2 : 100%
- candidats SANS connectivite : 8826, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6256 systemes avec CONNECTED sur 48801 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10446 candidats sur 14736 portent les champs bruts (71%).*

- `5c556c16ea8b` — 4481 candidats
  - AVEC connectivite (1782) : resistance **42.0%**
  - SANS connectivite (2699) : resistance **22.4%**
...
- `5c556c16ea8b` — 4481 candidats
  - AVEC connectivite (1782) : T0=12.97 T1=0.00 T2=3.06 — pondere **6.11**
  - SANS connectivite (2699) : T0=15.78 T1=0.00 T2=2.71 — pondere **5.42**
...
- TROP-CHER : 6291 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6256 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 46300 systemes
  - sans CONNECTED : 0.0% sur 10381 systemes
