...
genere 2026-08-26 10:02 UTC — 37790 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 28816 systemes
...
- candidats SANS connectivite : 2721, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2022 systemes avec CONNECTED sur 15574 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*173 candidats sur 4463 portent les champs bruts (4%).*

- `89c65c03c4ad` — 173 candidats
  - AVEC connectivite (65) : resistance **47.5%**
  - SANS connectivite (108) : resistance **21.4%**
...
- `89c65c03c4ad` — 3298 candidats
  - AVEC connectivite (1263) : T0=13.05 T1=0.00 T2=2.96 — pondere **5.92**
  - SANS connectivite (2035) : T0=15.85 T1=0.02 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 2039 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2022 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
