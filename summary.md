...
genere 2026-09-07 01:02 UTC — 425047 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 341703 systemes
...
- moteur actif `0caa9267db60` (381305 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 211565 | 105055 | 14408 | 7050 | 21452 | 16628 | 22479 | 21808 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 207367 | 48217 | 87490 | 80 | 28904 | 10702 | 73 | 31883 | 15.4% |
...
- candidats AVEC connectivite : 21935, dont T2 : 100%
- candidats SANS connectivite : 32193, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **22753 systemes avec CONNECTED sur 175169 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*49838 candidats sur 54128 portent les champs bruts (92%).*

- `5c556c16ea8b` — 43873 candidats
  - AVEC connectivite (17807) : resistance **41.1%**
  - SANS connectivite (26066) : resistance **21.3%**
...
- `5c556c16ea8b` — 43873 candidats
  - AVEC connectivite (17807) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (26066) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 22836 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 22753 avec CONNECTED, 83 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 172668 systemes
  - sans CONNECTED : 0.0% sur 38897 systemes
