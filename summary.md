...
genere 2026-09-09 01:37 UTC — 469332 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 385988 systemes
...
- moteur actif `0caa9267db60` (425590 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 233935 | 116179 | 15943 | 7828 | 23675 | 18333 | 24907 | 24104 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 229282 | 53395 | 96606 | 92 | 31952 | 11847 | 82 | 35289 | 15.4% |
...
- candidats AVEC connectivite : 24231, dont T2 : 100%
- candidats SANS connectivite : 35599, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25181 systemes avec CONNECTED sur 193501 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55540 candidats sur 59830 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49575 candidats
  - AVEC connectivite (20103) : resistance **41.2%**
  - SANS connectivite (29472) : resistance **21.3%**
...
- `5c556c16ea8b` — 49575 candidats
  - AVEC connectivite (20103) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (29472) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
## cout
- temps total 146.3 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 25273 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25181 avec CONNECTED, 92 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 191000 systemes
  - sans CONNECTED : 0.0% sur 42935 systemes
