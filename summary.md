...
- moteur actif `0caa9267db60` (7032 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22564 | 11245 | 1515 | 770 | 2254 | 1786 | 2417 | 2296 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 22095 | 5121 | 9319 | 13 | 3088 | 1135 | 10 | 3409 | 15.4% |
...
- candidats AVEC connectivite : 2423, dont T2 : 100%
- candidats SANS connectivite : 3719, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2691 systemes avec CONNECTED sur 20917 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1852 candidats sur 6142 portent les champs bruts (30%).*
...
- `06fe04a859f1` — 737 candidats
  - AVEC connectivite (285) : resistance **41.1%**
  - SANS connectivite (452) : resistance **20.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 737 candidats
  - AVEC connectivite (285) : T0=13.34 T1=0.00 T2=3.02 — pondere **6.05**
  - SANS connectivite (452) : T0=16.02 T1=0.00 T2=2.62 — pondere **5.24**
...
## cout
- temps total 15.8 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2711 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2691 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18416 systemes
  - sans CONNECTED : 0.0% sur 4148 systemes
