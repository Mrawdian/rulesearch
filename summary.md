...
genere 2026-08-28 02:02 UTC — 123972 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 40628 systemes
...
- moteur actif `0caa9267db60` (80230 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 59528 | 29640 | 4113 | 2012 | 5921 | 4712 | 6251 | 6114 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 58329 | 13489 | 24714 | 28 | 8111 | 3021 | 26 | 8938 | 15.3% |
...
- candidats AVEC connectivite : 6241, dont T2 : 100%
- candidats SANS connectivite : 9248, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6525 systemes avec CONNECTED sur 51094 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11199 candidats sur 15489 portent les champs bruts (72%).*

- `5c556c16ea8b` — 5234 candidats
  - AVEC connectivite (2113) : resistance **41.8%**
  - SANS connectivite (3121) : resistance **22.2%**
...
- `5c556c16ea8b` — 5234 candidats
  - AVEC connectivite (2113) : T0=12.99 T1=0.00 T2=3.04 — pondere **6.09**
  - SANS connectivite (3121) : T0=15.84 T1=0.00 T2=2.71 — pondere **5.41**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 48593 systemes
  - sans CONNECTED : 0.0% sur 10935 systemes
