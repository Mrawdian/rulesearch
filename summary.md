...
| connect | 4 | 3 | 5322 | 2668 | 340 | 191 | 518 | 436 | 558 | 552 | 10.4% |
...
- candidats AVEC connectivite : 555, dont T2 : 100%
...
- **558 systemes avec CONNECTED sur 4403 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 222 candidats
  - AVEC connectivite (76) : T0=13.18 T1=0.00 T2=2.79 — pondere **5.58**
  - SANS connectivite (146) : T0=15.88 T1=0.00 T2=2.70 — pondere **5.40**
  - test de permutation : **p = 0.6587** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 560 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 558 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 4346 systemes
  - sans CONNECTED : 0.0% sur 976 systemes
