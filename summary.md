...
genere 2026-08-26 02:03 UTC — 17378 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 8404 systemes
...
| connect | 4 | 3 | 8729 | 4387 | 571 | 294 | 831 | 700 | 940 | 899 | 10.3% |
...
- candidats AVEC connectivite : 902, dont T2 : 100%
...
- **940 systemes avec CONNECTED sur 7228 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1060 candidats
  - AVEC connectivite (423) : T0=13.36 T1=0.00 T2=2.86 — pondere **5.72**
...
- TROP-CHER : 943 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 940 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 7171 systemes
  - sans CONNECTED : 0.0% sur 1558 systemes
