...
genere 2026-08-30 13:03 UTC — 219325 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 135981 systemes
...
- moteur actif `0caa9267db60` (175583 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 107699 | 53512 | 7322 | 3600 | 10845 | 8557 | 11392 | 11066 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 105511 | 24613 | 44556 | 49 | 14569 | 5455 | 41 | 16219 | 15.4% |
...
- candidats AVEC connectivite : 11193, dont T2 : 100%
- candidats SANS connectivite : 16529, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11666 systemes avec CONNECTED sur 90367 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*23432 candidats sur 27722 portent les champs bruts (85%).*

- `5c556c16ea8b` — 17467 candidats
  - AVEC connectivite (7065) : resistance **41.1%**
  - SANS connectivite (10402) : resistance **21.5%**
...
- `5c556c16ea8b` — 17467 candidats
  - AVEC connectivite (7065) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (10402) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 11717 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11666 avec CONNECTED, 51 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 87866 systemes
  - sans CONNECTED : 0.0% sur 19833 systemes
