...
genere 2026-09-08 15:00 UTC — 459685 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 376341 systemes
...
- moteur actif `0caa9267db60` (415943 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 229061 | 113782 | 15593 | 7671 | 23161 | 17931 | 24420 | 23593 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 224509 | 52282 | 94642 | 89 | 31282 | 11610 | 81 | 34505 | 15.4% |
...
- candidats AVEC connectivite : 23720, dont T2 : 100%
- candidats SANS connectivite : 34815, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **24694 systemes avec CONNECTED sur 189563 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*54245 candidats sur 58535 portent les champs bruts (93%).*

- `5c556c16ea8b` — 48280 candidats
  - AVEC connectivite (19592) : resistance **41.2%**
  - SANS connectivite (28688) : resistance **21.3%**
...
- `5c556c16ea8b` — 48280 candidats
  - AVEC connectivite (19592) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (28688) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 187062 systemes
  - sans CONNECTED : 0.0% sur 41999 systemes
