...
genere 2026-08-26 17:46 UTC — 56709 systemes evalues
...
- `84fba70921e0` : 28 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (12967 systemes) : `06fe04a859f1`, `23303c299f39`, `84fba70921e0`, `b71bb0907fb5`, `e40600351a72`, `e8a1f930f7b9`
...
**7494 enregistrements (13%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 25564 | 12752 | 1737 | 861 | 2536 | 2016 | 2733 | 2613 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 25030 | 5776 | 10597 | 15 | 3498 | 1270 | 10 | 3864 | 15.4% |
...
- candidats AVEC connectivite : 2740, dont T2 : 100%
- candidats SANS connectivite : 4174, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3007 systemes avec CONNECTED sur 23401 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2624 candidats sur 6914 portent les champs bruts (38%).*
...
- TROP-CHER : 3027 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3007 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 20900 systemes
  - sans CONNECTED : 0.0% sur 4664 systemes
