...
genere 2026-08-26 08:04 UTC — 32534 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 23560 systemes
...
- candidats AVEC connectivite : 1554, dont T2 : 100%
- candidats SANS connectivite : 2398, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1765 systemes avec CONNECTED sur 13457 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2787 candidats
  - AVEC connectivite (1075) : T0=13.17 T1=0.00 T2=2.90 — pondere **5.81**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  ...
  - sans CONNECTED : 0.0% sur 2684 systemes
