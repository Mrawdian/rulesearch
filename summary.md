...
| connect | 4 | 3 | 18741 | 9349 | 1220 | 651 | 1868 | 1493 | 2033 | 1894 | 10.1% |
...
- candidats AVEC connectivite : 2021, dont T2 : 100%
- candidats SANS connectivite : 3124, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2307 systemes avec CONNECTED sur 17795 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*855 candidats sur 5145 portent les champs bruts (17%).*
...
- `e3baecf8377b` — 591 candidats
  - AVEC connectivite (238) : resistance **42.1%**
...
- `e3baecf8377b` — 591 candidats
  - AVEC connectivite (238) : T0=13.11 T1=0.00 T2=3.09 — pondere **6.18**
...
- TROP-CHER : 2324 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 2307 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 15294 systemes
  - sans CONNECTED : 0.0% sur 3447 systemes
