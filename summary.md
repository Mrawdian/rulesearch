...
genere 2026-08-26 17:41 UTC — 56477 systemes evalues
...
- moteur actif `0caa9267db60` (12735 systemes) : `06fe04a859f1`, `23303c299f39`, `b71bb0907fb5`, `e40600351a72`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 25445 | 12700 | 1730 | 856 | 2520 | 2007 | 2722 | 2597 | 10.2% |
...
- candidats AVEC connectivite : 2724, dont T2 : 100%
- candidats SANS connectivite : 4148, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2996 systemes avec CONNECTED sur 23306 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2582 candidats sur 6872 portent les champs bruts (38%).*
...
- TROP-CHER : 3016 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2996 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 20805 systemes
