...
genere 2026-09-03 00:38 UTC — 325031 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 241687 systemes
...
- moteur actif `0caa9267db60` (281289 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 161056 | 80010 | 10940 | 5380 | 16408 | 12698 | 17057 | 16502 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 157860 | 36797 | 66711 | 64 | 21843 | 8153 | 65 | 24215 | 15.3% |
...
- candidats AVEC connectivite : 16629, dont T2 : 100%
- candidats SANS connectivite : 24525, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **17331 systemes avec CONNECTED sur 133896 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*36864 candidats sur 41154 portent les champs bruts (90%).*

- `5c556c16ea8b` — 30899 candidats
  - AVEC connectivite (12501) : resistance **41.1%**
  - SANS connectivite (18398) : resistance **21.2%**
...
- `5c556c16ea8b` — 30899 candidats
  - AVEC connectivite (12501) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (18398) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
## cout
- temps total 100.8 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 17406 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 17331 avec CONNECTED, 75 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 131395 systemes
  - sans CONNECTED : 0.0% sur 29661 systemes
