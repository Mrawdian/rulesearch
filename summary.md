...
genere 2026-08-26 21:52 UTC — 66122 systemes evalues
...
- moteur actif `0caa9267db60` (22380 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 29684 | 6845 | 12618 | 16 | 4102 | 1531 | 13 | 4559 | 15.4% |
...
- candidats SANS connectivite : 4869, dont T2 : 100%
...
*3816 candidats sur 8106 portent les champs bruts (47%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 139 candidats
  - AVEC connectivite (57) : resistance **44.0%**
  - SANS connectivite (82) : resistance **23.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 139 candidats
  ...
  - SANS connectivite (82) : T0=15.90 T1=0.00 T2=2.91 — pondere **5.83**
  - test de permutation : **p = 0.5447** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
