...
genere 2026-08-30 02:31 UTC — 204245 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 120901 systemes
...
- moteur actif `0caa9267db60` (160503 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 100089 | 49666 | 6823 | 3355 | 10099 | 7996 | 10539 | 10308 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 98041 | 22854 | 41408 | 45 | 13551 | 5059 | 37 | 15080 | 15.4% |
...
- candidats AVEC connectivite : 10435, dont T2 : 100%
- candidats SANS connectivite : 15390, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10813 systemes avec CONNECTED sur 84115 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*21535 candidats sur 25825 portent les champs bruts (83%).*

- `5c556c16ea8b` — 15570 candidats
  - AVEC connectivite (6307) : resistance **41.1%**
  - SANS connectivite (9263) : resistance **21.5%**
...
- `5c556c16ea8b` — 15570 candidats
  - AVEC connectivite (6307) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (9263) : T0=15.88 T1=0.00 T2=2.67 — pondere **5.33**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 81614 systemes
  - sans CONNECTED : 0.0% sur 18475 systemes
