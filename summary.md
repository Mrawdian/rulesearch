...
- moteur actif `0caa9267db60` (8374 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23252 | 11585 | 1578 | 790 | 2319 | 1845 | 2486 | 2358 | 10.1% |
...
- candidats AVEC connectivite : 2485, dont T2 : 100%
- candidats SANS connectivite : 3821, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2760 systemes avec CONNECTED sur 21480 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2016 candidats sur 6306 portent les champs bruts (32%).*
...
- `06fe04a859f1` — 901 candidats
  - AVEC connectivite (347) : resistance **41.3%**
...
- `06fe04a859f1` — 901 candidats
  - AVEC connectivite (347) : T0=13.20 T1=0.00 T2=3.03 — pondere **6.06**
...
- TROP-CHER : 2780 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2760 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18979 systemes
  - sans CONNECTED : 0.0% sur 4273 systemes
