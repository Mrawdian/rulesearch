...
| connect | 4 | 3 | 18232 | 9112 | 1186 | 636 | 1810 | 1445 | 1979 | 1835 | 10.1% |
...
- candidats AVEC connectivite : 1962, dont T2 : 100%
- candidats SANS connectivite : 3052, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2253 systemes avec CONNECTED sur 17389 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*724 candidats sur 5014 portent les champs bruts (14%).*
...
- `e3baecf8377b` — 460 candidats
  - AVEC connectivite (179) : resistance **42.8%**
...
- `e3baecf8377b` — 460 candidats
  - AVEC connectivite (179) : T0=13.03 T1=0.00 T2=3.12 — pondere **6.25**
...
- TROP-CHER : 2270 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2253 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14888 systemes
  - sans CONNECTED : 0.0% sur 3344 systemes
