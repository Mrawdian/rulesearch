...
genere 2026-08-27 07:47 UTC — 87887 systemes evalues
...
- moteur actif `0caa9267db60` (44145 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 41314 | 20566 | 2840 | 1403 | 4122 | 3256 | 4353 | 4242 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 40458 | 9315 | 17202 | 22 | 5621 | 2105 | 21 | 6172 | 15.3% |
...
- candidats AVEC connectivite : 4369, dont T2 : 100%
- candidats SANS connectivite : 6482, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4627 systemes avec CONNECTED sur 36265 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6561 candidats sur 10851 portent les champs bruts (60%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 596 candidats
  - AVEC connectivite (241) : resistance **41.0%**
  - SANS connectivite (355) : resistance **20.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 596 candidats
  - AVEC connectivite (241) : T0=13.09 T1=0.00 T2=3.00 — pondere **6.01**
  - SANS connectivite (355) : T0=15.88 T1=0.00 T2=2.62 — pondere **5.25**
...
- TROP-CHER : 4658 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4627 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 33764 systemes
  - sans CONNECTED : 0.0% sur 7550 systemes
