...
genere 2026-08-31 08:11 UTC — 245907 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 162563 systemes
...
- moteur actif `0caa9267db60` (202165 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 121126 | 60246 | 8218 | 4062 | 12177 | 9562 | 12813 | 12476 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 118666 | 27710 | 50102 | 53 | 16394 | 6127 | 53 | 18217 | 15.4% |
...
- candidats AVEC connectivite : 12603, dont T2 : 100%
- candidats SANS connectivite : 18527, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13087 systemes avec CONNECTED sur 101390 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*26840 candidats sur 31130 portent les champs bruts (86%).*

- `5c556c16ea8b` — 20875 candidats
  - AVEC connectivite (8475) : resistance **40.9%**
  - SANS connectivite (12400) : resistance **21.3%**
...
- `5c556c16ea8b` — 20875 candidats
  - AVEC connectivite (8475) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (12400) : T0=15.90 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 13150 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13087 avec CONNECTED, 63 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 98889 systemes
  - sans CONNECTED : 0.0% sur 22237 systemes
