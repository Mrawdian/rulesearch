...
genere 2026-08-26 02:05 UTC — 17453 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 8479 systemes
...
**7466 enregistrements (43%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 8759 | 4404 | 573 | 294 | 836 | 700 | 944 | 901 | 10.3% |
| ref | 4 | 3 | 8570 | 2068 | 3604 | 2 | 1144 | 423 | 3 | 1326 | 15.5% |
...
- candidats AVEC connectivite : 904, dont T2 : 100%
- candidats SANS connectivite : 1330, dont T2 : 100%
...
- **944 systemes avec CONNECTED sur 7254 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1069 candidats
  - AVEC connectivite (425) : T0=13.35 T1=0.00 T2=2.86 — pondere **5.72**
  - SANS connectivite (644) : T0=15.91 T1=0.00 T2=2.67 — pondere **5.34**
...
## cout
- temps total 5.5 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 947 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 944 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 7197 systemes
  - sans CONNECTED : 0.0% sur 1562 systemes
