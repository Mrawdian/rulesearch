...
genere 2026-08-28 04:00 UTC — 127608 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 44264 systemes
...
- moteur actif `0caa9267db60` (83866 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 61365 | 30513 | 4242 | 2077 | 6111 | 4881 | 6445 | 6307 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 60128 | 13914 | 25467 | 28 | 8368 | 3112 | 26 | 9211 | 15.3% |
...
- candidats AVEC connectivite : 6434, dont T2 : 100%
- candidats SANS connectivite : 9521, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6719 systemes avec CONNECTED sur 52575 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11665 candidats sur 15955 portent les champs bruts (73%).*

- `5c556c16ea8b` — 5700 candidats
  - AVEC connectivite (2306) : resistance **41.8%**
  - SANS connectivite (3394) : resistance **22.1%**
...
- `5c556c16ea8b` — 5700 candidats
  - AVEC connectivite (2306) : T0=12.98 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (3394) : T0=15.87 T1=0.00 T2=2.69 — pondere **5.39**
...
- TROP-CHER : 6755 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6719 avec CONNECTED, 36 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 50074 systemes
  - sans CONNECTED : 0.0% sur 11291 systemes
