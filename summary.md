...
genere 2026-08-28 11:43 UTC — 141228 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 57884 systemes
...
- moteur actif `0caa9267db60` (97486 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 68248 | 33906 | 4687 | 2325 | 6839 | 5440 | 7195 | 6983 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 66865 | 15469 | 28281 | 30 | 9281 | 3455 | 30 | 10316 | 15.4% |
...
- candidats SANS connectivite : 10626, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7469 systemes avec CONNECTED sur 58158 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*13446 candidats sur 17736 portent les champs bruts (76%).*

- `5c556c16ea8b` — 7481 candidats
  - AVEC connectivite (2982) : resistance **41.3%**
  - SANS connectivite (4499) : resistance **21.8%**
...
- `5c556c16ea8b` — 7481 candidats
  ...
  - SANS connectivite (4499) : T0=15.87 T1=0.00 T2=2.68 — pondere **5.36**
...
- TROP-CHER : 7509 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7469 avec CONNECTED, 40 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 55657 systemes
  - sans CONNECTED : 0.0% sur 12591 systemes
