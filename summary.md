...
genere 2026-08-26 09:21 UTC — 35973 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 26999 systemes
...
| connect | 4 | 3 | 15658 | 7805 | 1023 | 535 | 1549 | 1251 | 1711 | 1584 | 10.1% |
| d4 | 4 | 4 | 4852 | 2227 | 1239 | 26 | 346 | 323 | 231 | 339 | 7.0% |
| ref | 4 | 3 | 15339 | 3603 | 6470 | 11 | 2104 | 780 | 6 | 2365 | 15.4% |
...
- candidats AVEC connectivite : 1679, dont T2 : 100%
- candidats SANS connectivite : 2616, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1933 systemes avec CONNECTED sur 14836 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 3130 candidats
  - AVEC connectivite (1200) : T0=13.12 T1=0.00 T2=2.94 — pondere **5.88**
  - SANS connectivite (1930) : T0=15.88 T1=0.02 T2=2.66 — pondere **5.34**
...
- TROP-CHER : 1948 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 1933 avec CONNECTED, 15 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.4% sur 12798 systemes
  - sans CONNECTED : 0.0% sur 2860 systemes
