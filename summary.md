...
genere 2026-08-26 22:32 UTC — 67451 systemes evalues
...
- moteur actif `0caa9267db60` (23709 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 30994 | 15390 | 2122 | 1040 | 3085 | 2470 | 3307 | 3185 | 10.3% |
...
- candidats AVEC connectivite : 3312, dont T2 : 100%
- candidats SANS connectivite : 4968, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3581 systemes avec CONNECTED sur 27842 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3990 candidats sur 8280 portent les champs bruts (48%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 313 candidats
  - AVEC connectivite (132) : resistance **43.0%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 313 candidats
  - AVEC connectivite (132) : T0=12.82 T1=0.00 T2=3.11 — pondere **6.21**
...
- TROP-CHER : 3605 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3581 avec CONNECTED, 24 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 25341 systemes
