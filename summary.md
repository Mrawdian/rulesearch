...
genere 2026-08-26 01:34 UTC — 16308 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 7334 systemes
...
| connect | 4 | 3 | 8191 | 4133 | 531 | 281 | 780 | 652 | 869 | 851 | 10.4% |
| ref | 4 | 3 | 7993 | 1940 | 3352 | 1 | 1064 | 392 | 3 | 1241 | 15.5% |
...
- candidats AVEC connectivite : 854, dont T2 : 100%
...
- **869 systemes avec CONNECTED sur 6785 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 934 candidats
  - AVEC connectivite (375) : T0=13.39 T1=0.00 T2=2.83 — pondere **5.67**
...
- TROP-CHER : 872 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 869 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 6728 systemes
  - sans CONNECTED : 0.0% sur 1463 systemes
