...
genere 2026-08-26 18:18 UTC — 58013 systemes evalues
...
- moteur actif `0caa9267db60` (14271 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `84fba70921e0`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 26223 | 13070 | 1784 | 888 | 2600 | 2070 | 2797 | 2690 | 10.3% |
...
- candidats AVEC connectivite : 2817, dont T2 : 100%
- candidats SANS connectivite : 4266, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3071 systemes avec CONNECTED sur 23942 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2793 candidats sur 7083 portent les champs bruts (39%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `e80bc1b2b437` — 64 candidats
  - AVEC connectivite (32) : resistance **38.3%**
...
- `e80bc1b2b437` — 64 candidats
  - AVEC connectivite (32) : T0=12.88 T1=0.00 T2=2.62 — pondere **5.25**
  - SANS connectivite (32) : T0=15.81 T1=0.00 T2=2.72 — pondere **5.44**
  - test de permutation : **p = 0.8531** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `0a74109317e5` — 80 candidats
...
- TROP-CHER : 3091 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3071 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 21441 systemes
  - sans CONNECTED : 0.0% sur 4782 systemes
