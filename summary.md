...
genere 2026-09-02 05:15 UTC — 302753 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 219409 systemes
...
- moteur actif `0caa9267db60` (259011 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 149814 | 74427 | 10192 | 5024 | 15192 | 11799 | 15855 | 15407 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 146824 | 34170 | 62130 | 62 | 20312 | 7579 | 63 | 22496 | 15.3% |
...
- candidats AVEC connectivite : 15534, dont T2 : 100%
- candidats SANS connectivite : 22806, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16129 systemes avec CONNECTED sur 124801 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*34050 candidats sur 38340 portent les champs bruts (89%).*

- `5c556c16ea8b` — 28085 candidats
  - AVEC connectivite (11406) : resistance **41.1%**
  - SANS connectivite (16679) : resistance **21.3%**
...
- `5c556c16ea8b` — 28085 candidats
  - AVEC connectivite (11406) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (16679) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 16202 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16129 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 122300 systemes
  - sans CONNECTED : 0.0% sur 27514 systemes
