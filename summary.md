...
genere 2026-08-28 09:22 UTC — 137115 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 53771 systemes
...
- moteur actif `0caa9267db60` (93373 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 66173 | 32869 | 4538 | 2248 | 6615 | 5276 | 6972 | 6802 | 10.3% |
...
- candidats AVEC connectivite : 6929, dont T2 : 100%
...
- **7246 systemes avec CONNECTED sur 56499 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12921 candidats sur 17211 portent les champs bruts (75%).*

- `5c556c16ea8b` — 6956 candidats
  - AVEC connectivite (2801) : resistance **41.5%**
...
- `5c556c16ea8b` — 6956 candidats
  - AVEC connectivite (2801) : T0=12.97 T1=0.00 T2=3.02 — pondere **6.04**
...
- TROP-CHER : 7284 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7246 avec CONNECTED, 38 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 53998 systemes
  - sans CONNECTED : 0.0% sur 12175 systemes
