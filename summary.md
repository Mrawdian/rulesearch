...
genere 2026-08-31 21:43 UTC — 263907 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 180563 systemes
...
- moteur actif `0caa9267db60` (220165 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 130219 | 64727 | 8792 | 4369 | 13193 | 10292 | 13738 | 13411 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 127573 | 29746 | 53882 | 56 | 17688 | 6595 | 57 | 19539 | 15.3% |
...
- candidats AVEC connectivite : 13538, dont T2 : 100%
- candidats SANS connectivite : 19849, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14012 systemes avec CONNECTED sur 108754 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*29097 candidats sur 33387 portent les champs bruts (87%).*

- `5c556c16ea8b` — 23132 candidats
  - AVEC connectivite (9410) : resistance **41.1%**
  - SANS connectivite (13722) : resistance **21.4%**
...
- `5c556c16ea8b` — 23132 candidats
  - AVEC connectivite (9410) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.97**
  - SANS connectivite (13722) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.32**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 106253 systemes
  - sans CONNECTED : 0.0% sur 23966 systemes
