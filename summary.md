...
genere 2026-08-27 05:58 UTC — 83895 systemes evalues
...
- moteur actif `0caa9267db60` (40153 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 39301 | 19559 | 2702 | 1341 | 3908 | 3097 | 4154 | 4029 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 38479 | 8873 | 16375 | 22 | 5327 | 2003 | 21 | 5858 | 15.2% |
...
- candidats AVEC connectivite : 4156, dont T2 : 100%
- candidats SANS connectivite : 6168, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4428 systemes avec CONNECTED sur 34646 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6034 candidats sur 10324 portent les champs bruts (58%).*
...
- `e80bc1b2b437` — 75 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 69 candidats
  - AVEC connectivite (28) : resistance **43.2%**
  - SANS connectivite (41) : resistance **23.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 69 candidats
  - AVEC connectivite (28) : T0=12.75 T1=0.00 T2=3.11 — pondere **6.21**
  - SANS connectivite (41) : T0=16.05 T1=0.00 T2=2.61 — pondere **5.22**
  - test de permutation : **p = 0.1709** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `0a74109317e5` — 80 candidats
...
- TROP-CHER : 4459 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4428 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 32145 systemes
  - sans CONNECTED : 0.0% sur 7156 systemes
