...
genere 2026-08-27 00:01 UTC — 70726 systemes evalues
...
- moteur actif `0caa9267db60` (26984 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 32655 | 16233 | 2241 | 1103 | 3252 | 2597 | 3484 | 3327 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 31956 | 7361 | 13567 | 18 | 4436 | 1670 | 15 | 4889 | 15.3% |
...
- candidats AVEC connectivite : 3454, dont T2 : 100%
- candidats SANS connectivite : 5199, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3758 systemes avec CONNECTED sur 29195 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4363 candidats sur 8653 portent les champs bruts (50%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 686 candidats
  - AVEC connectivite (274) : resistance **41.7%**
  - SANS connectivite (412) : resistance **21.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 686 candidats
  - AVEC connectivite (274) : T0=13.14 T1=0.00 T2=3.11 — pondere **6.22**
  - SANS connectivite (412) : T0=15.96 T1=0.00 T2=2.62 — pondere **5.24**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e3baecf8377b` — 657 candidats
...
- TROP-CHER : 3783 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3758 avec CONNECTED, 25 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 26694 systemes
  - sans CONNECTED : 0.0% sur 5961 systemes
