...
genere 2026-08-26 20:19 UTC — 62684 systemes evalues
...
- moteur actif `0caa9267db60` (18942 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 27982 | 6469 | 11854 | 15 | 3887 | 1437 | 12 | 4308 | 15.4% |
...
- candidats SANS connectivite : 4618, dont T2 : 100%
...
*3388 candidats sur 7678 portent les champs bruts (44%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 519 candidats
  - AVEC connectivite (216) : resistance **39.8%**
  - SANS connectivite (303) : resistance **20.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 519 candidats
  ...
  - SANS connectivite (303) : T0=16.16 T1=0.00 T2=2.65 — pondere **5.30**
  - test de permutation : **p = 0.0985** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
