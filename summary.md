...
genere 2026-08-26 21:33 UTC — 65337 systemes evalues
...
- `ab89a63b01ef` : 430 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (21595 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
**7956 enregistrements (12%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 29935 | 14878 | 2043 | 1005 | 2999 | 2370 | 3191 | 3069 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 29287 | 6752 | 12436 | 16 | 4057 | 1512 | 12 | 4502 | 15.4% |
...
- candidats AVEC connectivite : 3196, dont T2 : 100%
- candidats SANS connectivite : 4812, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3465 systemes avec CONNECTED sur 26974 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3718 candidats sur 8008 portent les champs bruts (46%).*
...
- `8f22f0d2d442` — 65 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 41 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (16) : resistance **43.8%**
  - SANS connectivite (25) : resistance **19.2%**
...
- `ab89a63b01ef` — 41 candidats
  - AVEC connectivite (16) : T0=14.19 T1=0.00 T2=2.88 — pondere **5.75**
  - SANS connectivite (25) : T0=16.28 T1=0.00 T2=2.72 — pondere **5.44**
...
- TROP-CHER : 3487 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3465 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24473 systemes
  - sans CONNECTED : 0.0% sur 5462 systemes
