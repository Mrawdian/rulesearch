...
genere 2026-09-07 09:49 UTC — 433223 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 349879 systemes
...
- moteur actif `0caa9267db60` (389481 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 215703 | 107142 | 14687 | 7185 | 21854 | 16920 | 22937 | 22235 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 211405 | 49213 | 89130 | 82 | 29457 | 10929 | 76 | 32500 | 15.4% |
...
- candidats AVEC connectivite : 22362, dont T2 : 100%
- candidats SANS connectivite : 32810, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23211 systemes avec CONNECTED sur 178590 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*50882 candidats sur 55172 portent les champs bruts (92%).*

- `5c556c16ea8b` — 44917 candidats
  - AVEC connectivite (18234) : resistance **41.1%**
  - SANS connectivite (26683) : resistance **21.3%**
...
- `5c556c16ea8b` — 44917 candidats
  - AVEC connectivite (18234) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (26683) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 23297 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23211 avec CONNECTED, 86 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 176089 systemes
  - sans CONNECTED : 0.0% sur 39614 systemes
