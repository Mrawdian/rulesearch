...
genere 2026-08-26 21:49 UTC — 65973 systemes evalues
...
- moteur actif `0caa9267db60` (22231 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 29610 | 6827 | 12586 | 16 | 4096 | 1528 | 12 | 4545 | 15.3% |
...
- candidats SANS connectivite : 4855, dont T2 : 100%
...
*3798 candidats sur 8088 portent les champs bruts (47%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 121 candidats
  - AVEC connectivite (53) : resistance **44.3%**
  - SANS connectivite (68) : resistance **22.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 121 candidats
  ...
  - SANS connectivite (68) : T0=15.78 T1=0.00 T2=2.94 — pondere **5.88**
  - test de permutation : **p = 0.5012** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
