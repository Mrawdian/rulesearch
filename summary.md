...
genere 2026-09-07 01:59 UTC — 425921 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 342577 systemes
...
- moteur actif `0caa9267db60` (382179 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 212000 | 105270 | 14436 | 7059 | 21504 | 16658 | 22530 | 21853 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 207806 | 48320 | 87664 | 81 | 28974 | 10726 | 73 | 31950 | 15.4% |
...
- candidats SANS connectivite : 32260, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **22804 systemes avec CONNECTED sur 175518 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*49950 candidats sur 54240 portent les champs bruts (92%).*

- `5c556c16ea8b` — 43985 candidats
  - AVEC connectivite (17852) : resistance **41.1%**
  - SANS connectivite (26133) : resistance **21.3%**
...
- `5c556c16ea8b` — 43985 candidats
  ...
  - SANS connectivite (26133) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 22887 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 22804 avec CONNECTED, 83 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 173017 systemes
  - sans CONNECTED : 0.0% sur 38983 systemes
