...
genere 2026-09-02 12:23 UTC — 310997 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 227653 systemes
...
- moteur actif `0caa9267db60` (267255 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 153973 | 76487 | 10474 | 5149 | 15652 | 12119 | 16313 | 15806 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 150909 | 35143 | 63832 | 63 | 20860 | 7795 | 63 | 23141 | 15.3% |
...
- candidats SANS connectivite : 23451, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16587 systemes avec CONNECTED sur 128183 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*35094 candidats sur 39384 portent les champs bruts (89%).*

- `5c556c16ea8b` — 29129 candidats
  - AVEC connectivite (11805) : resistance **41.1%**
  - SANS connectivite (17324) : resistance **21.3%**
...
- `5c556c16ea8b` — 29129 candidats
  ...
  - SANS connectivite (17324) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 16660 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16587 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 125682 systemes
  - sans CONNECTED : 0.0% sur 28291 systemes
