...
genere 2026-08-26 10:45 UTC — 39589 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `615abe43d6bc` : 7172 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
- `e3baecf8377b` : 996 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
**8462 enregistrements (21%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
*388 candidats sur 4678 portent les champs bruts (8%).*
...
- `e3baecf8377b` — 124 candidats (**NON REPRODUCTIBLE**)
