...
genere 2026-08-26 16:03 UTC — 52733 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 7550 systemes
...
- moteur actif `0caa9267db60` (8991 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23564 | 11748 | 1598 | 804 | 2346 | 1868 | 2516 | 2388 | 10.1% |
...
- candidats AVEC connectivite : 2515, dont T2 : 100%
- candidats SANS connectivite : 3867, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2790 systemes avec CONNECTED sur 21738 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2092 candidats sur 6382 portent les champs bruts (33%).*
...
- `06fe04a859f1` — 977 candidats
  - AVEC connectivite (377) : resistance **41.4%**
...
- `06fe04a859f1` — 977 candidats
  - AVEC connectivite (377) : T0=13.20 T1=0.00 T2=3.04 — pondere **6.07**
...
- TROP-CHER : 2810 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2790 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19237 systemes
  - sans CONNECTED : 0.0% sur 4327 systemes
