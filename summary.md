...
- moteur actif `0caa9267db60` (47219 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 42869 | 21348 | 2941 | 1450 | 4284 | 3369 | 4516 | 4403 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 41977 | 9677 | 17828 | 25 | 5810 | 2189 | 22 | 6425 | 15.3% |
...
- candidats AVEC connectivite : 4530, dont T2 : 100%
- candidats SANS connectivite : 6735, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4790 systemes avec CONNECTED sur 37527 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6975 candidats sur 11265 portent les champs bruts (62%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 1010 candidats
  - AVEC connectivite (402) : resistance **41.3%**
  - SANS connectivite (608) : resistance **22.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 1010 candidats
  - AVEC connectivite (402) : T0=13.04 T1=0.00 T2=3.02 — pondere **6.03**
  - SANS connectivite (608) : T0=15.84 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 4822 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4790 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 35026 systemes
  - sans CONNECTED : 0.0% sur 7843 systemes
