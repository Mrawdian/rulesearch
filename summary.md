...
genere 2026-08-26 09:52 UTC — 37299 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 28325 systemes
...
| connect | 4 | 3 | 16003 | 7984 | 1044 | 550 | 1591 | 1273 | 1749 | 1610 | 10.1% |
| d4 | 4 | 4 | 5512 | 2537 | 1399 | 28 | 390 | 369 | 259 | 389 | 7.1% |
| ref | 4 | 3 | 15660 | 3680 | 6606 | 11 | 2149 | 796 | 7 | 2411 | 15.4% |
...
- candidats AVEC connectivite : 1723, dont T2 : 100%
- candidats SANS connectivite : 2694, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1998 systemes avec CONNECTED sur 15384 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*127 candidats sur 4417 portent les champs bruts (3%).*

- `89c65c03c4ad` — 127 candidats
  - AVEC connectivite (46) : resistance **48.1%**
  - SANS connectivite (81) : resistance **21.3%**
...
- `89c65c03c4ad` — 3252 candidats
  - AVEC connectivite (1244) : T0=13.07 T1=0.00 T2=2.95 — pondere **5.90**
  - SANS connectivite (2008) : T0=15.85 T1=0.02 T2=2.66 — pondere **5.33**
...
## cout
- temps total 11.7 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2015 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 1998 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.4% sur 13079 systemes
  - sans CONNECTED : 0.0% sur 2924 systemes
