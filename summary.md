...
genere 2026-09-08 14:39 UTC — 459360 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 376016 systemes
...
- moteur actif `0caa9267db60` (415618 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 228896 | 113698 | 15576 | 7666 | 23147 | 17924 | 24404 | 23573 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 224349 | 52241 | 94584 | 89 | 31256 | 11601 | 81 | 34479 | 15.4% |
...
- candidats AVEC connectivite : 23700, dont T2 : 100%
...
- **24678 systemes avec CONNECTED sur 189420 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*54199 candidats sur 58489 portent les champs bruts (93%).*

- `5c556c16ea8b` — 48234 candidats
  - AVEC connectivite (19572) : resistance **41.2%**
...
- `5c556c16ea8b` — 48234 candidats
  - AVEC connectivite (19572) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 24769 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 24678 avec CONNECTED, 91 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 186919 systemes
  - sans CONNECTED : 0.0% sur 41977 systemes
