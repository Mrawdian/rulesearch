...
genere 2026-09-09 09:14 UTC — 475998 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 392654 systemes
...
- moteur actif `0caa9267db60` (432256 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 237309 | 117833 | 16186 | 7951 | 23997 | 18595 | 25276 | 24458 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 232574 | 54211 | 97968 | 92 | 32396 | 12010 | 84 | 35794 | 15.4% |
...
- candidats AVEC connectivite : 24585, dont T2 : 100%
...
- **25550 systemes avec CONNECTED sur 196273 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*56399 candidats sur 60689 portent les champs bruts (93%).*

- `5c556c16ea8b` — 50434 candidats
  - AVEC connectivite (20457) : resistance **41.2%**
...
- `5c556c16ea8b` — 50434 candidats
  - AVEC connectivite (20457) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 25644 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25550 avec CONNECTED, 94 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 193772 systemes
  - sans CONNECTED : 0.0% sur 43537 systemes
