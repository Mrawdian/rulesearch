...
genere 2026-08-26 02:37 UTC — 18728 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 9754 systemes
...
| connect | 4 | 3 | 9402 | 4731 | 615 | 315 | 900 | 743 | 1021 | 963 | 10.2% |
...
- candidats AVEC connectivite : 966, dont T2 : 100%
...
- **1021 systemes avec CONNECTED sur 7786 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1236 candidats
  - AVEC connectivite (487) : T0=13.32 T1=0.00 T2=2.91 — pondere **5.81**
...
- TROP-CHER : 1025 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1021 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 7729 systemes
  - sans CONNECTED : 0.0% sur 1673 systemes
