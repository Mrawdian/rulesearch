...
genere 2026-08-27 08:06 UTC — 88522 systemes evalues
...
- moteur actif `0caa9267db60` (44780 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 41629 | 20725 | 2862 | 1413 | 4157 | 3273 | 4389 | 4273 | 10.3% |
...
- candidats AVEC connectivite : 4400, dont T2 : 100%
- candidats SANS connectivite : 6539, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4663 systemes avec CONNECTED sur 36524 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6649 candidats sur 10939 portent les champs bruts (61%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 684 candidats
  - AVEC connectivite (272) : resistance **40.6%**
...
- `5c556c16ea8b` — 684 candidats
  - AVEC connectivite (272) : T0=13.07 T1=0.00 T2=2.96 — pondere **5.91**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 34023 systemes
  - sans CONNECTED : 0.0% sur 7606 systemes
