...
genere 2026-09-03 00:37 UTC — 325001 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 241657 systemes
...
- moteur actif `0caa9267db60` (281259 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 161041 | 80000 | 10940 | 5380 | 16407 | 12697 | 17057 | 16499 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 157845 | 36793 | 66707 | 64 | 21839 | 8153 | 65 | 24212 | 15.3% |
...
- candidats SANS connectivite : 24522, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **17331 systemes avec CONNECTED sur 133883 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*36858 candidats sur 41148 portent les champs bruts (90%).*

- `5c556c16ea8b` — 30893 candidats
  - AVEC connectivite (12498) : resistance **41.1%**
  - SANS connectivite (18395) : resistance **21.2%**
...
- `5c556c16ea8b` — 30893 candidats
  ...
  - SANS connectivite (18395) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 131382 systemes
  - sans CONNECTED : 0.0% sur 29659 systemes
