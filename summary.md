...
genere 2026-08-28 05:00 UTC — 129417 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 46073 systemes
...
- moteur actif `0caa9267db60` (85675 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 62290 | 30981 | 4294 | 2107 | 6215 | 4947 | 6542 | 6399 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 61012 | 14112 | 25838 | 28 | 8480 | 3159 | 27 | 9366 | 15.4% |
...
- candidats SANS connectivite : 9676, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6816 systemes avec CONNECTED sur 53337 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11912 candidats sur 16202 portent les champs bruts (74%).*

- `5c556c16ea8b` — 5947 candidats
  - AVEC connectivite (2398) : resistance **41.7%**
  - SANS connectivite (3549) : resistance **22.0%**
...
- `5c556c16ea8b` — 5947 candidats
  ...
  - SANS connectivite (3549) : T0=15.87 T1=0.00 T2=2.69 — pondere **5.39**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 50836 systemes
  - sans CONNECTED : 0.0% sur 11454 systemes
