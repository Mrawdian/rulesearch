...
genere 2026-08-29 02:53 UTC — 167330 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 83986 systemes
...
- moteur actif `0caa9267db60` (123588 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 81435 | 40524 | 5540 | 2764 | 8174 | 6465 | 8553 | 8381 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 79780 | 18558 | 33761 | 36 | 11041 | 4057 | 34 | 12288 | 15.4% |
...
- candidats AVEC connectivite : 8508, dont T2 : 100%
- candidats SANS connectivite : 12598, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8827 systemes avec CONNECTED sur 68943 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*16816 candidats sur 21106 portent les champs bruts (80%).*

- `5c556c16ea8b` — 10851 candidats
  - AVEC connectivite (4380) : resistance **41.2%**
  - SANS connectivite (6471) : resistance **21.6%**
...
- `5c556c16ea8b` — 10851 candidats
  - AVEC connectivite (4380) : T0=13.01 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (6471) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.34**
...
- TROP-CHER : 8871 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8827 avec CONNECTED, 44 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 66442 systemes
  - sans CONNECTED : 0.0% sur 14993 systemes
