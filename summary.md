...
genere 2026-08-27 07:11 UTC — 86582 systemes evalues
...
- moteur actif `0caa9267db60` (42840 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 39810 | 9171 | 16925 | 22 | 5521 | 2079 | 21 | 6071 | 15.2% |
...
- candidats SANS connectivite : 6381, dont T2 : 100%
...
*6387 candidats sur 10677 portent les champs bruts (60%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 422 candidats
  - AVEC connectivite (168) : resistance **41.9%**
  - SANS connectivite (254) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 422 candidats
  ...
  - SANS connectivite (254) : T0=15.80 T1=0.00 T2=2.65 — pondere **5.31**
  - test de permutation : **p = 0.0100** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `23303c299f39` — 225 candidats
...
**7 serie(s) reproductible(s) sur 14 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `ab89a63b01ef` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `5c556c16ea8b` (p=0.0100), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
