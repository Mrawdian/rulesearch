...
genere 2026-08-26 21:27 UTC — 65100 systemes evalues
...
- `ab89a63b01ef` : 193 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (21358 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
**7719 enregistrements (12%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 29815 | 14811 | 2036 | 998 | 2985 | 2365 | 3179 | 3063 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 29170 | 6727 | 12381 | 16 | 4041 | 1505 | 12 | 4488 | 15.4% |
...
- candidats SANS connectivite : 4798, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3453 systemes avec CONNECTED sur 26878 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3698 candidats sur 7988 portent les champs bruts (46%).*
...
- `84fba70921e0` — 33 candidats
  ...
  - *groupes trop petits (< 20) — aucun test*
- `ab89a63b01ef` — 21 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (10) : resistance **54.4%**
  - SANS connectivite (11) : resistance **22.7%**
  - *groupes trop petits (< 20) — aucun test*
...
- `84fba70921e0` — 33 candidats
  ...
  - *groupes trop petits (< 20) — aucun test, aucune conclusion*
- `ab89a63b01ef` — 21 candidats
  - AVEC connectivite (10) : T0=14.10 T1=0.00 T2=3.70 — pondere **7.40**
  - SANS connectivite (11) : T0=16.00 T1=0.00 T2=3.18 — pondere **6.36**
  - *groupes trop petits (< 20) — aucun test, aucune conclusion*
...
- TROP-CHER : 3475 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3453 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24377 systemes
  - sans CONNECTED : 0.0% sur 5438 systemes
