...
genere 2026-09-03 22:57 UTC — 349963 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 266619 systemes
...
- moteur actif `0caa9267db60` (306221 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 173652 | 86331 | 11792 | 5808 | 17682 | 13680 | 18394 | 17754 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 170196 | 39571 | 71917 | 70 | 23629 | 8799 | 66 | 26130 | 15.4% |
...
- candidats AVEC connectivite : 17881, dont T2 : 100%
- candidats SANS connectivite : 26440, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18668 systemes avec CONNECTED sur 144181 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*40031 candidats sur 44321 portent les champs bruts (90%).*

- `5c556c16ea8b` — 34066 candidats
  - AVEC connectivite (13753) : resistance **41.0%**
  - SANS connectivite (20313) : resistance **21.2%**
...
- `5c556c16ea8b` — 34066 candidats
  - AVEC connectivite (13753) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (20313) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 141680 systemes
  - sans CONNECTED : 0.0% sur 31972 systemes
