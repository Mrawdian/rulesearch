...
genere 2026-08-26 13:13 UTC — 46040 systemes evalues
...
- moteur actif `0caa9267db60` (2298 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20172 | 10070 | 1322 | 694 | 2023 | 1602 | 2157 | 2055 | 10.2% |
...
- candidats AVEC connectivite : 2182, dont T2 : 100%
- candidats SANS connectivite : 3322, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2431 systemes avec CONNECTED sur 18957 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1214 candidats sur 5504 portent les champs bruts (22%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 99 candidats
  - AVEC connectivite (44) : resistance **37.8%**
...
- `06fe04a859f1` — 99 candidats
  - AVEC connectivite (44) : T0=13.14 T1=0.00 T2=2.66 — pondere **5.32**
  - SANS connectivite (55) : T0=16.89 T1=0.00 T2=2.84 — pondere **5.67**
  - test de permutation : **p = 0.5877** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16456 systemes
  - sans CONNECTED : 0.0% sur 3716 systemes
