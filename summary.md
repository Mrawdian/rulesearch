...
genere 2026-08-26 20:27 UTC — 62997 systemes evalues
...
- moteur actif `0caa9267db60` (19255 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 28752 | 14319 | 1969 | 964 | 2850 | 2279 | 3054 | 2956 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 28130 | 6503 | 11924 | 15 | 3904 | 1448 | 12 | 4324 | 15.4% |
...
- candidats AVEC connectivite : 3083, dont T2 : 100%
- candidats SANS connectivite : 4634, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3328 systemes avec CONNECTED sur 26024 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3427 candidats sur 7717 portent les champs bruts (44%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 558 candidats
  - AVEC connectivite (239) : resistance **39.4%**
  - SANS connectivite (319) : resistance **20.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 558 candidats
  - AVEC connectivite (239) : T0=12.86 T1=0.00 T2=2.82 — pondere **5.63**
  - SANS connectivite (319) : T0=16.17 T1=0.00 T2=2.64 — pondere **5.29**
...
- TROP-CHER : 3350 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3328 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23523 systemes
  - sans CONNECTED : 0.0% sur 5229 systemes
