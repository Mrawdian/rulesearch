...
genere 2026-08-26 23:40 UTC — 70014 systemes evalues
...
- moteur actif `0caa9267db60` (26272 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 32295 | 16061 | 2212 | 1088 | 3219 | 2570 | 3441 | 3293 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 31604 | 7292 | 13419 | 18 | 4374 | 1652 | 14 | 4835 | 15.3% |
...
- candidats AVEC connectivite : 3420, dont T2 : 100%
- candidats SANS connectivite : 5145, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3715 systemes avec CONNECTED sur 28902 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4275 candidats sur 8565 portent les champs bruts (50%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 598 candidats
  - AVEC connectivite (240) : resistance **42.2%**
  - SANS connectivite (358) : resistance **22.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 598 candidats
  - AVEC connectivite (240) : T0=13.08 T1=0.00 T2=3.12 — pondere **6.25**
  - SANS connectivite (358) : T0=15.92 T1=0.00 T2=2.63 — pondere **5.26**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 26401 systemes
  - sans CONNECTED : 0.0% sur 5894 systemes
