...
- moteur actif `0caa9267db60` (48540 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 43528 | 21696 | 2982 | 1472 | 4341 | 3428 | 4585 | 4458 | 10.2% |
...
- candidats AVEC connectivite : 4585, dont T2 : 100%
- candidats SANS connectivite : 6831, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4859 systemes avec CONNECTED sur 38074 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*7126 candidats sur 11416 portent les champs bruts (62%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 1161 candidats
  - AVEC connectivite (457) : resistance **41.5%**
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 1161 candidats
  - AVEC connectivite (457) : T0=13.00 T1=0.00 T2=3.02 — pondere **6.04**
...
- TROP-CHER : 4891 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4859 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 35573 systemes
  - sans CONNECTED : 0.0% sur 7955 systemes
