...
genere 2026-09-07 12:34 UTC — 435765 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 352421 systemes
...
- moteur actif `0caa9267db60` (392023 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 216989 | 107802 | 14782 | 7221 | 21975 | 17011 | 23081 | 22361 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 212661 | 49519 | 89649 | 83 | 29645 | 10984 | 76 | 32687 | 15.4% |
...
- candidats AVEC connectivite : 22488, dont T2 : 100%
- candidats SANS connectivite : 32997, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23355 systemes avec CONNECTED sur 179644 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*51195 candidats sur 55485 portent les champs bruts (92%).*

- `5c556c16ea8b` — 45230 candidats
  - AVEC connectivite (18360) : resistance **41.1%**
  - SANS connectivite (26870) : resistance **21.3%**
...
- `5c556c16ea8b` — 45230 candidats
  - AVEC connectivite (18360) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (26870) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 23441 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23355 avec CONNECTED, 86 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 177143 systemes
  - sans CONNECTED : 0.0% sur 39846 systemes
