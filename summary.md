...
genere 2026-09-01 10:43 UTC — 280332 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 196988 systemes
...
- moteur actif `0caa9267db60` (236590 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 138498 | 68846 | 9373 | 4625 | 14062 | 10916 | 14630 | 14255 | 10.3% |
...
- candidats AVEC connectivite : 14382, dont T2 : 100%
...
- **14904 systemes avec CONNECTED sur 115510 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*31161 candidats sur 35451 portent les champs bruts (88%).*

- `5c556c16ea8b` — 25196 candidats
  - AVEC connectivite (10254) : resistance **41.1%**
...
- `5c556c16ea8b` — 25196 candidats
  - AVEC connectivite (10254) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 14975 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14904 avec CONNECTED, 71 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 113009 systemes
  - sans CONNECTED : 0.0% sur 25489 systemes
