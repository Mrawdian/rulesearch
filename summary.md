...
| connect | 4 | 3 | 7232 | 3637 | 476 | 251 | 684 | 589 | 756 | 758 | 10.5% |
| ref | 4 | 3 | 7069 | 1709 | 2945 | 1 | 948 | 352 | 2 | 1112 | 15.7% |
...
- candidats AVEC connectivite : 761, dont T2 : 100%
- candidats SANS connectivite : 1116, dont T2 : 100%
...
- **756 systemes avec CONNECTED sur 5989 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 712 candidats
  - AVEC connectivite (282) : T0=13.26 T1=0.00 T2=2.92 — pondere **5.84**
  - SANS connectivite (430) : T0=15.78 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 758 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 756 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 5932 systemes
  - sans CONNECTED : 0.0% sur 1300 systemes
