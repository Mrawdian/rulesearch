...
genere 2026-09-05 22:43 UTC — 399532 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 316188 systemes
...
- moteur actif `0caa9267db60` (355790 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 198681 | 98642 | 13532 | 6620 | 20179 | 15649 | 21091 | 20441 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 194736 | 45325 | 82156 | 78 | 27109 | 10057 | 72 | 29922 | 15.4% |
...
- candidats AVEC connectivite : 20568, dont T2 : 100%
- candidats SANS connectivite : 30232, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21365 systemes avec CONNECTED sur 164592 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*46510 candidats sur 50800 portent les champs bruts (92%).*

- `5c556c16ea8b` — 40545 candidats
  - AVEC connectivite (16440) : resistance **41.1%**
  - SANS connectivite (24105) : resistance **21.3%**
...
- `5c556c16ea8b` — 40545 candidats
  - AVEC connectivite (16440) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.94**
  - SANS connectivite (24105) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
## cout
- temps total 124.2 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 21447 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21365 avec CONNECTED, 82 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 162091 systemes
  - sans CONNECTED : 0.0% sur 36590 systemes
