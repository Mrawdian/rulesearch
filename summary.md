...
genere 2026-08-26 19:45 UTC — 61379 systemes evalues
...
- moteur actif `0caa9267db60` (17637 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27929 | 13918 | 1910 | 942 | 2761 | 2214 | 2970 | 2864 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 27335 | 6318 | 11570 | 15 | 3805 | 1408 | 11 | 4208 | 15.4% |
...
- candidats AVEC connectivite : 2991, dont T2 : 100%
- candidats SANS connectivite : 4518, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3244 systemes avec CONNECTED sur 25361 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3219 candidats sur 7509 portent les champs bruts (43%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 350 candidats
  - AVEC connectivite (147) : resistance **39.2%**
  - SANS connectivite (203) : resistance **19.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 350 candidats
  - AVEC connectivite (147) : T0=13.07 T1=0.00 T2=2.85 — pondere **5.70**
  - SANS connectivite (203) : T0=16.02 T1=0.00 T2=2.64 — pondere **5.28**
...
- TROP-CHER : 3265 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3244 avec CONNECTED, 21 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22860 systemes
  - sans CONNECTED : 0.0% sur 5069 systemes
