...
genere 2026-08-26 21:13 UTC — 64521 systemes evalues
...
- moteur actif `0caa9267db60` (20779 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 29516 | 14675 | 2018 | 990 | 2945 | 2333 | 3152 | 3028 | 10.3% |
...
- candidats AVEC connectivite : 3155, dont T2 : 100%
- candidats SANS connectivite : 4751, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3426 systemes avec CONNECTED sur 26646 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3616 candidats sur 7906 portent les champs bruts (46%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 747 candidats
  - AVEC connectivite (311) : resistance **39.9%**
...
- `62448a55927e` — 747 candidats
  - AVEC connectivite (311) : T0=12.86 T1=0.00 T2=2.84 — pondere **5.68**
...
- TROP-CHER : 3448 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3426 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 24145 systemes
  - sans CONNECTED : 0.0% sur 5371 systemes
