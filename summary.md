...
genere 2026-08-26 05:44 UTC — 26532 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 17558 systemes
...
| connect | 4 | 3 | 13296 | 6646 | 872 | 464 | 1303 | 1058 | 1445 | 1340 | 10.1% |
| d4 | 4 | 4 | 90 | 41 | 22 | 0 | 3 | 7 | 6 | 8 | 8.9% |
| ref | 4 | 3 | 13022 | 3111 | 5469 | 9 | 1776 | 652 | 5 | 2000 | 15.4% |
...
- candidats AVEC connectivite : 1344, dont T2 : 100%
- candidats SANS connectivite : 2011, dont T2 : 100%
...
- **1451 systemes avec CONNECTED sur 10983 (13.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2190 candidats
  - AVEC connectivite (865) : T0=13.25 T1=0.00 T2=2.87 — pondere **5.74**
  - SANS connectivite (1325) : T0=15.89 T1=0.00 T2=2.64 — pondere **5.28**
...
**1 serie(s) reproductible(s) sur 3 etablissent l'ecart** : `89c65c03c4ad` (p=0.0025).
...
- TROP-CHER : 1456 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1451 avec CONNECTED, 5 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 10889 systemes
  - sans CONNECTED : 0.0% sur 2407 systemes
