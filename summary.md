...
genere 2026-08-26 14:25 UTC — 48879 systemes evalues
...
- moteur actif `0caa9267db60` (5137 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21606 | 10781 | 1438 | 744 | 2138 | 1718 | 2311 | 2202 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 21158 | 4925 | 8933 | 13 | 2931 | 1092 | 8 | 3256 | 15.4% |
...
- candidats AVEC connectivite : 2329, dont T2 : 100%
- candidats SANS connectivite : 3566, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2585 systemes avec CONNECTED sur 20158 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1605 candidats sur 5895 portent les champs bruts (27%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 490 candidats
  - AVEC connectivite (191) : resistance **39.8%**
  - SANS connectivite (299) : resistance **20.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 490 candidats
  - AVEC connectivite (191) : T0=13.38 T1=0.00 T2=2.95 — pondere **5.91**
  - SANS connectivite (299) : T0=16.10 T1=0.00 T2=2.66 — pondere **5.31**
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0385).
...
- TROP-CHER : 2603 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2585 avec CONNECTED, 18 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17657 systemes
  - sans CONNECTED : 0.0% sur 3949 systemes
