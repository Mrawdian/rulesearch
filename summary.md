...
genere 2026-09-05 21:32 UTC — 398336 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 314992 systemes
...
- moteur actif `0caa9267db60` (354594 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 198069 | 98330 | 13485 | 6603 | 20127 | 15596 | 21032 | 20376 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 194152 | 45185 | 81909 | 78 | 27045 | 10029 | 72 | 29818 | 15.4% |
...
- candidats AVEC connectivite : 20503, dont T2 : 100%
- candidats SANS connectivite : 30128, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21306 systemes avec CONNECTED sur 164080 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*46341 candidats sur 50631 portent les champs bruts (92%).*

- `5c556c16ea8b` — 40376 candidats
  - AVEC connectivite (16375) : resistance **41.0%**
  - SANS connectivite (24001) : resistance **21.3%**
...
- `5c556c16ea8b` — 40376 candidats
  - AVEC connectivite (16375) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.94**
  - SANS connectivite (24001) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 21388 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21306 avec CONNECTED, 82 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 161579 systemes
  - sans CONNECTED : 0.0% sur 36490 systemes
