...
- moteur actif `0caa9267db60` (48720 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 43618 | 21740 | 2991 | 1473 | 4352 | 3435 | 4593 | 4468 | 10.2% |
...
- candidats AVEC connectivite : 4595, dont T2 : 100%
- candidats SANS connectivite : 6840, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4867 systemes avec CONNECTED sur 38146 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*7145 candidats sur 11435 portent les champs bruts (62%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 1180 candidats
  - AVEC connectivite (467) : resistance **41.5%**
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 1180 candidats
  - AVEC connectivite (467) : T0=13.00 T1=0.00 T2=3.02 — pondere **6.03**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 35645 systemes
  - sans CONNECTED : 0.0% sur 7973 systemes
