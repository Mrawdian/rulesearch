...
genere 2026-09-09 08:56 UTC — 475734 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 392390 systemes
...
- moteur actif `0caa9267db60` (431992 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 237176 | 117771 | 16178 | 7943 | 23986 | 18582 | 25262 | 24443 | 10.3% |
...
- candidats AVEC connectivite : 24570, dont T2 : 100%
...
- **25536 systemes avec CONNECTED sur 196164 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*56373 candidats sur 60663 portent les champs bruts (93%).*

- `5c556c16ea8b` — 50408 candidats
  - AVEC connectivite (20442) : resistance **41.2%**
...
- `5c556c16ea8b` — 50408 candidats
  - AVEC connectivite (20442) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 25630 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25536 avec CONNECTED, 94 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 193663 systemes
  - sans CONNECTED : 0.0% sur 43513 systemes
