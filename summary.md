...
genere 2026-08-26 17:24 UTC — 55871 systemes evalues
...
- moteur actif `0caa9267db60` (12129 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
| connect | 4 | 3 | 25147 | 12541 | 1712 | 849 | 2489 | 1989 | 2686 | 2569 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 24609 | 5690 | 10411 | 14 | 3439 | 1251 | 10 | 3794 | 15.4% |
...
- candidats AVEC connectivite : 2696, dont T2 : 100%
- candidats SANS connectivite : 4104, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2960 systemes avec CONNECTED sur 23055 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2510 candidats sur 6800 portent les champs bruts (37%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 200 candidats
  - AVEC connectivite (82) : resistance **43.2%**
  - SANS connectivite (118) : resistance **20.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `23303c299f39` — 200 candidats
  - AVEC connectivite (82) : T0=12.94 T1=0.00 T2=3.12 — pondere **6.24**
  - SANS connectivite (118) : T0=16.21 T1=0.00 T2=2.57 — pondere **5.14**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 20554 systemes
  - sans CONNECTED : 0.0% sur 4593 systemes
