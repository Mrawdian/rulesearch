...
genere 2026-08-27 06:35 UTC — 85282 systemes evalues
...
- moteur actif `0caa9267db60` (41540 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 40003 | 19935 | 2738 | 1360 | 3982 | 3146 | 4222 | 4104 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 39164 | 9023 | 16662 | 22 | 5426 | 2043 | 21 | 5967 | 15.2% |
...
- candidats AVEC connectivite : 4231, dont T2 : 100%
- candidats SANS connectivite : 6277, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4496 systemes avec CONNECTED sur 35216 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6218 candidats sur 10508 portent les champs bruts (59%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 253 candidats
  - AVEC connectivite (103) : resistance **42.7%**
  - SANS connectivite (150) : resistance **21.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 253 candidats
  - AVEC connectivite (103) : T0=12.83 T1=0.00 T2=3.12 — pondere **6.23**
  - SANS connectivite (150) : T0=15.83 T1=0.00 T2=2.64 — pondere **5.28**
  - test de permutation : **p = 0.0185** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `23303c299f39` — 225 candidats
...
**7 serie(s) reproductible(s) sur 14 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `ab89a63b01ef` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `5c556c16ea8b` (p=0.0185), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 32715 systemes
  - sans CONNECTED : 0.0% sur 7288 systemes
