...
genere 2026-09-01 15:52 UTC — 286713 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 203369 systemes
...
- moteur actif `0caa9267db60` (242971 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 141720 | 70417 | 9606 | 4737 | 14396 | 11187 | 14968 | 14576 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 138878 | 32294 | 58718 | 59 | 19259 | 7194 | 62 | 21281 | 15.3% |
...
- candidats SANS connectivite : 21591, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15242 systemes avec CONNECTED sur 118131 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*32004 candidats sur 36294 portent les champs bruts (88%).*

- `5c556c16ea8b` — 26039 candidats
  - AVEC connectivite (10575) : resistance **41.0%**
  - SANS connectivite (15464) : resistance **21.4%**
...
- `5c556c16ea8b` — 26039 candidats
  ...
  - SANS connectivite (15464) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 115630 systemes
  - sans CONNECTED : 0.0% sur 26090 systemes
