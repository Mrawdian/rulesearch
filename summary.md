...
genere 2026-08-27 08:13 UTC — 88745 systemes evalues
...
- moteur actif `0caa9267db60` (45003 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 41749 | 20793 | 2871 | 1414 | 4168 | 3279 | 4401 | 4282 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 40881 | 9414 | 17379 | 22 | 5668 | 2130 | 21 | 6247 | 15.3% |
...
- candidats AVEC connectivite : 4409, dont T2 : 100%
- candidats SANS connectivite : 6557, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4675 systemes avec CONNECTED sur 36623 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6676 candidats sur 10966 portent les champs bruts (61%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 711 candidats
  - AVEC connectivite (281) : resistance **41.1%**
  - SANS connectivite (430) : resistance **21.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 711 candidats
  - AVEC connectivite (281) : T0=13.06 T1=0.00 T2=3.01 — pondere **6.01**
  - SANS connectivite (430) : T0=15.80 T1=0.00 T2=2.63 — pondere **5.26**
...
## cout
- temps total 27.3 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 4706 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4675 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 34122 systemes
  - sans CONNECTED : 0.0% sur 7627 systemes
