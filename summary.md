...
genere 2026-09-01 11:53 UTC — 281812 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 198468 systemes
...
- moteur actif `0caa9267db60` (238070 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 139243 | 69211 | 9428 | 4654 | 14149 | 10971 | 14706 | 14323 | 10.3% |
...
- candidats AVEC connectivite : 14450, dont T2 : 100%
...
- **14980 systemes avec CONNECTED sur 116121 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*31360 candidats sur 35650 portent les champs bruts (88%).*

- `5c556c16ea8b` — 25395 candidats
  - AVEC connectivite (10322) : resistance **41.0%**
...
- `5c556c16ea8b` — 25395 candidats
  - AVEC connectivite (10322) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 15051 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14980 avec CONNECTED, 71 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 113620 systemes
  - sans CONNECTED : 0.0% sur 25623 systemes
