...
genere 2026-08-28 20:26 UTC — 156234 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 72890 systemes
...
- moteur actif `0caa9267db60` (112492 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 75820 | 37680 | 5163 | 2578 | 7600 | 6049 | 8001 | 7790 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 74299 | 17274 | 31445 | 35 | 10242 | 3806 | 31 | 11463 | 15.4% |
...
- candidats SANS connectivite : 11773, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8275 systemes avec CONNECTED sur 64355 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*15400 candidats sur 19690 portent les champs bruts (78%).*

- `5c556c16ea8b` — 9435 candidats
  - AVEC connectivite (3789) : resistance **41.1%**
  - SANS connectivite (5646) : resistance **21.7%**
...
- `5c556c16ea8b` — 9435 candidats
  ...
  - SANS connectivite (5646) : T0=15.90 T1=0.00 T2=2.68 — pondere **5.36**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 61854 systemes
  - sans CONNECTED : 0.0% sur 13966 systemes
