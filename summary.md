...
genere 2026-08-30 15:59 UTC — 223615 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 140271 systemes
...
- moteur actif `0caa9267db60` (179873 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 109864 | 54601 | 7470 | 3667 | 11075 | 8710 | 11611 | 11297 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 107636 | 25076 | 45461 | 50 | 14883 | 5556 | 43 | 16557 | 15.4% |
...
- candidats AVEC connectivite : 11424, dont T2 : 100%
- candidats SANS connectivite : 16867, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11885 systemes avec CONNECTED sur 92138 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*24001 candidats sur 28291 portent les champs bruts (85%).*

- `5c556c16ea8b` — 18036 candidats
  - AVEC connectivite (7296) : resistance **41.0%**
  - SANS connectivite (10740) : resistance **21.5%**
...
- `5c556c16ea8b` — 18036 candidats
  - AVEC connectivite (7296) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.97**
  - SANS connectivite (10740) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 11938 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11885 avec CONNECTED, 53 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 89637 systemes
  - sans CONNECTED : 0.0% sur 20227 systemes
