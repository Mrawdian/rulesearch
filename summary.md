...
genere 2026-08-27 08:54 UTC — 90149 systemes evalues
...
- moteur actif `0caa9267db60` (46407 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 42450 | 21138 | 2917 | 1435 | 4239 | 3329 | 4476 | 4369 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 41584 | 9586 | 17672 | 24 | 5759 | 2165 | 22 | 6356 | 15.3% |
...
- candidats AVEC connectivite : 4496, dont T2 : 100%
- candidats SANS connectivite : 6666, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4750 systemes avec CONNECTED sur 37195 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6872 candidats sur 11162 portent les champs bruts (62%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 907 candidats
  - AVEC connectivite (368) : resistance **40.9%**
  - SANS connectivite (539) : resistance **21.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 907 candidats
  - AVEC connectivite (368) : T0=13.08 T1=0.00 T2=2.98 — pondere **5.97**
  - SANS connectivite (539) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.33**
  - test de permutation : **p = 0.0035** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 798 candidats
...
**7 serie(s) reproductible(s) sur 14 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `ab89a63b01ef` (p=0.0005), `06fe04a859f1` (p=0.0005), `5c556c16ea8b` (p=0.0035), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
...
## cout
- temps total 27.8 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 4782 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4750 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 34694 systemes
  - sans CONNECTED : 0.0% sur 7756 systemes
