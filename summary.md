...
genere 2026-08-29 13:53 UTC — 184963 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 101619 systemes
...
- moteur actif `0caa9267db60` (141221 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 90326 | 44925 | 6138 | 3043 | 9082 | 7196 | 9498 | 9299 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 88522 | 20684 | 37355 | 43 | 12228 | 4541 | 35 | 13630 | 15.4% |
...
- candidats AVEC connectivite : 9426, dont T2 : 100%
- candidats SANS connectivite : 13940, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9772 systemes avec CONNECTED sur 76189 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*19076 candidats sur 23366 portent les champs bruts (82%).*

- `5c556c16ea8b` — 13111 candidats
  - AVEC connectivite (5298) : resistance **41.2%**
  - SANS connectivite (7813) : resistance **21.5%**
...
- `5c556c16ea8b` — 13111 candidats
  - AVEC connectivite (5298) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (7813) : T0=15.90 T1=0.00 T2=2.67 — pondere **5.33**
...
- TROP-CHER : 9817 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 9772 avec CONNECTED, 45 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 73688 systemes
  - sans CONNECTED : 0.0% sur 16638 systemes
