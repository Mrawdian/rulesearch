...
genere 2026-09-02 11:29 UTC — 309944 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 226600 systemes
...
- moteur actif `0caa9267db60` (266202 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 153436 | 76212 | 10443 | 5134 | 15596 | 12078 | 16257 | 15749 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 150393 | 35032 | 63601 | 63 | 20790 | 7769 | 63 | 23063 | 15.3% |
...
- candidats AVEC connectivite : 15876, dont T2 : 100%
- candidats SANS connectivite : 23373, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16531 systemes avec CONNECTED sur 127735 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*34959 candidats sur 39249 portent les champs bruts (89%).*

- `5c556c16ea8b` — 28994 candidats
  - AVEC connectivite (11748) : resistance **41.1%**
  - SANS connectivite (17246) : resistance **21.3%**
...
- `5c556c16ea8b` — 28994 candidats
  - AVEC connectivite (11748) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (17246) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 125234 systemes
  - sans CONNECTED : 0.0% sur 28202 systemes
