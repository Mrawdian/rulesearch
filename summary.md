...
| connect | 4 | 3 | 17125 | 8562 | 1105 | 591 | 1701 | 1363 | 1865 | 1723 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 16777 | 3947 | 7108 | 11 | 2292 | 850 | 7 | 2562 | 15.3% |
...
- candidats AVEC connectivite : 1850, dont T2 : 100%
- candidats SANS connectivite : 2872, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2139 systemes avec CONNECTED sur 16489 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*432 candidats sur 4722 portent les champs bruts (9%).*
...
- `e3baecf8377b` — 168 candidats
  - AVEC connectivite (67) : resistance **42.9%**
  - SANS connectivite (101) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 168 candidats
  - AVEC connectivite (67) : T0=13.31 T1=0.00 T2=3.24 — pondere **6.48**
  - SANS connectivite (101) : T0=15.91 T1=0.00 T2=2.60 — pondere **5.21**
...
- TROP-CHER : 2156 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2139 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 13988 systemes
  - sans CONNECTED : 0.0% sur 3137 systemes
