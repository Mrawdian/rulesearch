...
genere 2026-08-28 05:10 UTC — 129759 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 46415 systemes
...
- moteur actif `0caa9267db60` (86017 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 62455 | 31064 | 4301 | 2115 | 6234 | 4962 | 6558 | 6415 | 10.3% |
...
- candidats AVEC connectivite : 6542, dont T2 : 100%
- candidats SANS connectivite : 9697, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6832 systemes avec CONNECTED sur 53471 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11949 candidats sur 16239 portent les champs bruts (74%).*

- `5c556c16ea8b` — 5984 candidats
  - AVEC connectivite (2414) : resistance **41.6%**
...
- `5c556c16ea8b` — 5984 candidats
  - AVEC connectivite (2414) : T0=12.99 T1=0.00 T2=3.03 — pondere **6.06**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 50970 systemes
  - sans CONNECTED : 0.0% sur 11485 systemes
