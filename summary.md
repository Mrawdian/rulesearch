...
genere 2026-09-06 04:44 UTC — 405474 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 322130 systemes
...
- moteur actif `0caa9267db60` (361732 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 201680 | 100133 | 13753 | 6714 | 20464 | 15867 | 21415 | 20770 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 197679 | 45970 | 83413 | 78 | 27539 | 10214 | 73 | 30375 | 15.4% |
...
- candidats AVEC connectivite : 20897, dont T2 : 100%
- candidats SANS connectivite : 30685, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21689 systemes avec CONNECTED sur 167054 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*47292 candidats sur 51582 portent les champs bruts (92%).*

- `5c556c16ea8b` — 41327 candidats
  - AVEC connectivite (16769) : resistance **41.1%**
  - SANS connectivite (24558) : resistance **21.3%**
...
- `5c556c16ea8b` — 41327 candidats
  - AVEC connectivite (16769) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (24558) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 164553 systemes
  - sans CONNECTED : 0.0% sur 37127 systemes
