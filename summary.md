...
genere 2026-09-04 06:56 UTC — 358554 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 275210 systemes
...
- moteur actif `0caa9267db60` (314812 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 177983 | 88469 | 12096 | 5957 | 18100 | 14016 | 18866 | 18214 | 10.2% |
...
- candidats AVEC connectivite : 18341, dont T2 : 100%
...
- **19140 systemes avec CONNECTED sur 147736 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*41172 candidats sur 45462 portent les champs bruts (91%).*

- `5c556c16ea8b` — 35207 candidats
  - AVEC connectivite (14213) : resistance **41.1%**
...
- `5c556c16ea8b` — 35207 candidats
  - AVEC connectivite (14213) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 19220 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19140 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 145235 systemes
  - sans CONNECTED : 0.0% sur 32748 systemes
