...
genere 2026-08-31 11:23 UTC — 250289 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 166945 systemes
...
- moteur actif `0caa9267db60` (206547 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 123333 | 61350 | 8364 | 4137 | 12412 | 9731 | 13030 | 12698 | 10.3% |
...
- candidats AVEC connectivite : 12825, dont T2 : 100%
...
- **13304 systemes avec CONNECTED sur 103179 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*27390 candidats sur 31680 portent les champs bruts (86%).*

- `5c556c16ea8b` — 21425 candidats
  - AVEC connectivite (8697) : resistance **40.9%**
...
- `5c556c16ea8b` — 21425 candidats
  - AVEC connectivite (8697) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 13369 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13304 avec CONNECTED, 65 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 100678 systemes
  - sans CONNECTED : 0.0% sur 22655 systemes
