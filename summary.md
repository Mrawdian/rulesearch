...
- moteur actif `0caa9267db60` (6868 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22489 | 11206 | 1512 | 768 | 2248 | 1779 | 2408 | 2287 | 10.2% |
...
- candidats AVEC connectivite : 2414, dont T2 : 100%
- candidats SANS connectivite : 3706, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2682 systemes avec CONNECTED sur 20855 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1830 candidats sur 6120 portent les champs bruts (30%).*
...
- `06fe04a859f1` — 715 candidats
  - AVEC connectivite (276) : resistance **41.2%**
...
- `06fe04a859f1` — 715 candidats
  - AVEC connectivite (276) : T0=13.33 T1=0.00 T2=3.03 — pondere **6.05**
...
- TROP-CHER : 2702 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2682 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18354 systemes
  - sans CONNECTED : 0.0% sur 4135 systemes
