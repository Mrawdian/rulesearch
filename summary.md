...
genere 2026-08-28 15:30 UTC — 147648 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 64304 systemes
...
- moteur actif `0caa9267db60` (103906 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 71488 | 35500 | 4882 | 2436 | 7170 | 5694 | 7557 | 7334 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 70045 | 16263 | 29597 | 32 | 9693 | 3614 | 31 | 10812 | 15.4% |
...
- candidats AVEC connectivite : 7461, dont T2 : 100%
- candidats SANS connectivite : 11122, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7831 systemes avec CONNECTED sur 60819 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*14293 candidats sur 18583 portent les champs bruts (77%).*

- `5c556c16ea8b` — 8328 candidats
  - AVEC connectivite (3333) : resistance **41.2%**
  - SANS connectivite (4995) : resistance **21.8%**
...
- `5c556c16ea8b` — 8328 candidats
  - AVEC connectivite (3333) : T0=13.01 T1=0.00 T2=3.00 — pondere **6.01**
  - SANS connectivite (4995) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.37**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 58318 systemes
  - sans CONNECTED : 0.0% sur 13170 systemes
