...
genere 2026-08-28 01:02 UTC — 122059 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 38715 systemes
...
- moteur actif `0caa9267db60` (78317 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 58557 | 29166 | 4046 | 1976 | 5821 | 4632 | 6159 | 6005 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 57387 | 13247 | 24351 | 28 | 7965 | 2976 | 26 | 8792 | 15.3% |
...
- candidats AVEC connectivite : 6132, dont T2 : 100%
- candidats SANS connectivite : 9102, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6433 systemes avec CONNECTED sur 50317 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10944 candidats sur 15234 portent les champs bruts (72%).*

- `5c556c16ea8b` — 4979 candidats
  - AVEC connectivite (2004) : resistance **42.0%**
  - SANS connectivite (2975) : resistance **22.3%**
...
- `5c556c16ea8b` — 4979 candidats
  - AVEC connectivite (2004) : T0=13.00 T1=0.00 T2=3.05 — pondere **6.10**
  - SANS connectivite (2975) : T0=15.85 T1=0.00 T2=2.72 — pondere **5.43**
...
- TROP-CHER : 6469 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6433 avec CONNECTED, 36 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 47816 systemes
  - sans CONNECTED : 0.0% sur 10741 systemes
