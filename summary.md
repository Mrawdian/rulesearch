...
genere 2026-09-09 04:48 UTC — 472176 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 388832 systemes
...
- moteur actif `0caa9267db60` (428434 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 235367 | 116883 | 16051 | 7883 | 23822 | 18429 | 25055 | 24252 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 230694 | 53750 | 97193 | 92 | 32135 | 11919 | 83 | 35503 | 15.4% |
...
- candidats AVEC connectivite : 24379, dont T2 : 100%
- candidats SANS connectivite : 35813, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25329 systemes avec CONNECTED sur 194673 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55902 candidats sur 60192 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49937 candidats
  - AVEC connectivite (20251) : resistance **41.2%**
  - SANS connectivite (29686) : resistance **21.3%**
...
- `5c556c16ea8b` — 49937 candidats
  - AVEC connectivite (20251) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (29686) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 192172 systemes
  - sans CONNECTED : 0.0% sur 43195 systemes
