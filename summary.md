...
| connect | 4 | 3 | 7397 | 3727 | 488 | 257 | 702 | 598 | 774 | 770 | 10.4% |
| ref | 4 | 3 | 7230 | 1750 | 3011 | 1 | 971 | 357 | 2 | 1138 | 15.7% |
...
- candidats AVEC connectivite : 773, dont T2 : 100%
- candidats SANS connectivite : 1142, dont T2 : 100%
...
- **774 systemes avec CONNECTED sur 6123 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 750 candidats
  - AVEC connectivite (294) : T0=13.23 T1=0.00 T2=2.93 — pondere **5.85**
  - SANS connectivite (456) : T0=15.80 T1=0.00 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 776 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 774 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 6066 systemes
  - sans CONNECTED : 0.0% sur 1331 systemes
