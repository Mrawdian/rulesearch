...
genere 2026-09-02 05:46 UTC — 303318 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 219974 systemes
...
- moteur actif `0caa9267db60` (259576 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 150098 | 74558 | 10207 | 5033 | 15225 | 11820 | 15895 | 15438 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 147105 | 34231 | 62241 | 62 | 20359 | 7595 | 63 | 22542 | 15.3% |
...
- candidats AVEC connectivite : 15565, dont T2 : 100%
- candidats SANS connectivite : 22852, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16169 systemes avec CONNECTED sur 125034 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*34127 candidats sur 38417 portent les champs bruts (89%).*

- `5c556c16ea8b` — 28162 candidats
  - AVEC connectivite (11437) : resistance **41.0%**
  - SANS connectivite (16725) : resistance **21.3%**
...
- `5c556c16ea8b` — 28162 candidats
  - AVEC connectivite (11437) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (16725) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.30**
...
## cout
- temps total 94.1 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 16242 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16169 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 122533 systemes
  - sans CONNECTED : 0.0% sur 27565 systemes
