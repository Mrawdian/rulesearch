...
| connect | 4 | 3 | 17020 | 8500 | 1096 | 589 | 1691 | 1354 | 1857 | 1718 | 10.1% |
...
- candidats AVEC connectivite : 1845, dont T2 : 100%
- candidats SANS connectivite : 2862, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2131 systemes avec CONNECTED sur 16411 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*417 candidats sur 4707 portent les champs bruts (9%).*
...
- `e3baecf8377b` — 153 candidats
  - AVEC connectivite (62) : resistance **41.3%**
...
- `e3baecf8377b` — 153 candidats
  - AVEC connectivite (62) : T0=13.44 T1=0.00 T2=3.13 — pondere **6.26**
...
**2 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0450).
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.4% sur 13910 systemes
  - sans CONNECTED : 0.0% sur 3110 systemes
