...
genere 2026-08-26 17:26 UTC — 55945 systemes evalues
...
- moteur actif `0caa9267db60` (12203 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
| connect | 4 | 3 | 25176 | 12554 | 1713 | 849 | 2494 | 1992 | 2691 | 2571 | 10.2% |
...
- candidats AVEC connectivite : 2698, dont T2 : 100%
- candidats SANS connectivite : 4110, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2965 systemes avec CONNECTED sur 23074 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2518 candidats sur 6808 portent les champs bruts (37%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 208 candidats
  - AVEC connectivite (84) : resistance **43.6%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `23303c299f39` — 208 candidats
  - AVEC connectivite (84) : T0=12.90 T1=0.00 T2=3.15 — pondere **6.31**
...
**4 serie(s) reproductible(s) sur 7 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0170).
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 20573 systemes
  - sans CONNECTED : 0.0% sur 4603 systemes
