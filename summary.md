...
genere 2026-09-03 20:44 UTC — 347556 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 264212 systemes
...
- moteur actif `0caa9267db60` (303814 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 172426 | 85709 | 11710 | 5772 | 17559 | 13592 | 18262 | 17628 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 169015 | 39302 | 71445 | 67 | 23439 | 8746 | 66 | 25937 | 15.3% |
...
- candidats AVEC connectivite : 17755, dont T2 : 100%
- candidats SANS connectivite : 26247, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18536 systemes avec CONNECTED sur 143176 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39712 candidats sur 44002 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33747 candidats
  - AVEC connectivite (13627) : resistance **41.0%**
  - SANS connectivite (20120) : resistance **21.2%**
...
- `5c556c16ea8b` — 33747 candidats
  - AVEC connectivite (13627) : T0=13.03 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (20120) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.29**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 140675 systemes
  - sans CONNECTED : 0.0% sur 31751 systemes
