...
genere 2026-08-27 18:44 UTC — 109793 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 26449 systemes
...
- moteur actif `0caa9267db60` (66051 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 51318 | 11871 | 21780 | 26 | 7086 | 2677 | 24 | 7852 | 15.3% |
...
- candidats SANS connectivite : 8162, dont T2 : 100%
...
*9336 candidats sur 13626 portent les champs bruts (69%).*
...
- `5c556c16ea8b` — 3371 candidats
  - AVEC connectivite (1336) : resistance **42.0%**
  - SANS connectivite (2035) : resistance **22.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 3371 candidats
  ...
  - SANS connectivite (2035) : T0=15.80 T1=0.00 T2=2.70 — pondere **5.41**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 2280 candidats
