...
genere 2026-09-04 06:15 UTC — 357818 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 274474 systemes
...
- moteur actif `0caa9267db60` (314076 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 177611 | 88284 | 12070 | 5944 | 18059 | 13985 | 18827 | 18184 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 174092 | 40451 | 73536 | 70 | 24164 | 9032 | 70 | 26755 | 15.4% |
...
- candidats AVEC connectivite : 18311, dont T2 : 100%
- candidats SANS connectivite : 27065, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19101 systemes avec CONNECTED sur 147444 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*41086 candidats sur 45376 portent les champs bruts (91%).*

- `5c556c16ea8b` — 35121 candidats
  - AVEC connectivite (14183) : resistance **41.1%**
  - SANS connectivite (20938) : resistance **21.2%**
...
- `5c556c16ea8b` — 35121 candidats
  - AVEC connectivite (14183) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (20938) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 19181 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19101 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 144943 systemes
  - sans CONNECTED : 0.0% sur 32668 systemes
