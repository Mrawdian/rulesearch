...
genere 2026-08-27 00:08 UTC — 71026 systemes evalues
...
- moteur actif `0caa9267db60` (27284 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 32805 | 16308 | 2254 | 1108 | 3262 | 2608 | 3497 | 3348 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 32106 | 7393 | 13632 | 18 | 4450 | 1682 | 15 | 4916 | 15.3% |
...
- candidats AVEC connectivite : 3475, dont T2 : 100%
- candidats SANS connectivite : 5226, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3771 systemes avec CONNECTED sur 29317 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4411 candidats sur 8701 portent les champs bruts (51%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 734 candidats
  - AVEC connectivite (295) : resistance **41.6%**
  - SANS connectivite (439) : resistance **21.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 734 candidats
  - AVEC connectivite (295) : T0=13.16 T1=0.00 T2=3.08 — pondere **6.17**
  - SANS connectivite (439) : T0=15.97 T1=0.00 T2=2.60 — pondere **5.21**
...
## cout
- temps total 22.1 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 3796 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3771 avec CONNECTED, 25 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 26816 systemes
  - sans CONNECTED : 0.0% sur 5989 systemes
