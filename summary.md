...
genere 2026-08-30 14:34 UTC — 221528 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 138184 systemes
...
- moteur actif `0caa9267db60` (177786 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 108805 | 54060 | 7396 | 3636 | 10961 | 8637 | 11507 | 11183 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 106608 | 24860 | 45009 | 49 | 14732 | 5508 | 43 | 16398 | 15.4% |
...
- candidats SANS connectivite : 16708, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11781 systemes avec CONNECTED sur 91269 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*23728 candidats sur 28018 portent les champs bruts (85%).*

- `5c556c16ea8b` — 17763 candidats
  - AVEC connectivite (7182) : resistance **41.1%**
  - SANS connectivite (10581) : resistance **21.5%**
...
- `5c556c16ea8b` — 17763 candidats
  ...
  - SANS connectivite (10581) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 11834 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11781 avec CONNECTED, 53 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 88768 systemes
  - sans CONNECTED : 0.0% sur 20037 systemes
