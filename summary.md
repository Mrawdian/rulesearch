...
genere 2026-09-03 08:48 UTC — 334196 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 250852 systemes
...
- moteur actif `0caa9267db60` (290454 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 165688 | 82324 | 11258 | 5545 | 16876 | 13063 | 17561 | 16938 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 162393 | 37824 | 68648 | 66 | 22525 | 8392 | 66 | 24860 | 15.3% |
...
- candidats SANS connectivite : 25170, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **17835 systemes avec CONNECTED sur 137679 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*37945 candidats sur 42235 portent les champs bruts (90%).*

- `5c556c16ea8b` — 31980 candidats
  - AVEC connectivite (12937) : resistance **41.1%**
  - SANS connectivite (19043) : resistance **21.2%**
...
- `5c556c16ea8b` — 31980 candidats
  ...
  - SANS connectivite (19043) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.29**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 135178 systemes
  - sans CONNECTED : 0.0% sur 30510 systemes
