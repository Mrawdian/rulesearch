...
genere 2026-09-04 00:58 UTC — 352190 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 268846 systemes
...
- moteur actif `0caa9267db60` (308448 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 174771 | 86877 | 11880 | 5845 | 17798 | 13753 | 18510 | 17882 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 171304 | 39817 | 72363 | 70 | 23791 | 8864 | 67 | 26318 | 15.4% |
...
- candidats AVEC connectivite : 18009, dont T2 : 100%
- candidats SANS connectivite : 26628, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18784 systemes avec CONNECTED sur 145108 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*40347 candidats sur 44637 portent les champs bruts (90%).*

- `5c556c16ea8b` — 34382 candidats
  - AVEC connectivite (13881) : resistance **41.0%**
  - SANS connectivite (20501) : resistance **21.3%**
...
- `5c556c16ea8b` — 34382 candidats
  - AVEC connectivite (13881) : T0=13.03 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (20501) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 18861 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18784 avec CONNECTED, 77 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 142607 systemes
  - sans CONNECTED : 0.0% sur 32164 systemes
