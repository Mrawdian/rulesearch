...
genere 2026-08-26 14:49 UTC — 49781 systemes evalues
...
- moteur actif `0caa9267db60` (6039 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22071 | 11011 | 1480 | 755 | 2187 | 1750 | 2362 | 2248 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 21595 | 5022 | 9109 | 13 | 3005 | 1111 | 9 | 3326 | 15.4% |
...
- candidats AVEC connectivite : 2375, dont T2 : 100%
- candidats SANS connectivite : 3636, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2636 systemes avec CONNECTED sur 20532 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1721 candidats sur 6011 portent les champs bruts (29%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 606 candidats
  - AVEC connectivite (237) : resistance **41.2%**
  - SANS connectivite (369) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 606 candidats
  - AVEC connectivite (237) : T0=13.36 T1=0.00 T2=3.05 — pondere **6.09**
  - SANS connectivite (369) : T0=15.99 T1=0.00 T2=2.66 — pondere **5.33**
...
## cout
- temps total 15.4 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2655 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2636 avec CONNECTED, 19 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18031 systemes
  - sans CONNECTED : 0.0% sur 4040 systemes
