...
genere 2026-08-27 04:07 UTC — 79770 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 14863 systemes
...
- moteur actif `0caa9267db60` (36028 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 37231 | 18508 | 2569 | 1268 | 3693 | 2932 | 3952 | 3826 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 36424 | 8375 | 15515 | 21 | 5038 | 1905 | 20 | 5550 | 15.2% |
...
- candidats AVEC connectivite : 3953, dont T2 : 100%
- candidats SANS connectivite : 5860, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4226 systemes avec CONNECTED sur 32980 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5523 candidats sur 9813 portent les champs bruts (56%).*
...
- `ab89a63b01ef` — 1846 candidats
  - AVEC connectivite (773) : resistance **41.3%**
  - SANS connectivite (1073) : resistance **21.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1846 candidats
  - AVEC connectivite (773) : T0=13.06 T1=0.00 T2=3.03 — pondere **6.06**
  - SANS connectivite (1073) : T0=15.92 T1=0.00 T2=2.69 — pondere **5.38**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- TROP-CHER : 4256 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4226 avec CONNECTED, 30 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 30479 systemes
  - sans CONNECTED : 0.0% sur 6752 systemes
