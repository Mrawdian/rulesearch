...
genere 2026-09-10 08:20 UTC — 495583 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 412239 systemes
...
- moteur actif `0caa9267db60` (451841 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 247192 | 122714 | 16844 | 8305 | 25004 | 19403 | 26358 | 25429 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 242276 | 56500 | 102063 | 97 | 33712 | 12498 | 87 | 37298 | 15.4% |
...
- candidats AVEC connectivite : 25556, dont T2 : 100%
- candidats SANS connectivite : 37608, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **26632 systemes avec CONNECTED sur 204328 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*58874 candidats sur 63164 portent les champs bruts (93%).*

- `5c556c16ea8b` — 52909 candidats
  - AVEC connectivite (21428) : resistance **41.2%**
  - SANS connectivite (31481) : resistance **21.3%**
...
- `5c556c16ea8b` — 52909 candidats
  - AVEC connectivite (21428) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (31481) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 201827 systemes
  - sans CONNECTED : 0.0% sur 45365 systemes
