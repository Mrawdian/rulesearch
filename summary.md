...
genere 2026-08-28 06:04 UTC — 131323 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 47979 systemes
...
- moteur actif `0caa9267db60` (87581 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 63241 | 31439 | 4341 | 2145 | 6320 | 5041 | 6647 | 6493 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 61967 | 14335 | 26255 | 29 | 8615 | 3199 | 28 | 9504 | 15.3% |
...
- candidats SANS connectivite : 9814, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6921 systemes avec CONNECTED sur 54093 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12144 candidats sur 16434 portent les champs bruts (74%).*

- `5c556c16ea8b` — 6179 candidats
  - AVEC connectivite (2492) : resistance **41.5%**
  - SANS connectivite (3687) : resistance **22.0%**
...
- `5c556c16ea8b` — 6179 candidats
  ...
  - SANS connectivite (3687) : T0=15.86 T1=0.00 T2=2.69 — pondere **5.37**
...
- TROP-CHER : 6959 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6921 avec CONNECTED, 38 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 51592 systemes
  - sans CONNECTED : 0.0% sur 11649 systemes
