...
| connect | 4 | 3 | 6353 | 3199 | 414 | 229 | 609 | 508 | 661 | 660 | 10.4% |
| ref | 4 | 3 | 6195 | 1502 | 2578 | 1 | 832 | 305 | 2 | 975 | 15.7% |
...
- candidats AVEC connectivite : 663, dont T2 : 100%
- candidats SANS connectivite : 979, dont T2 : 100%
...
- **661 systemes avec CONNECTED sur 5266 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 477 candidats
  - AVEC connectivite (184) : T0=13.26 T1=0.00 T2=2.89 — pondere **5.77**
  - SANS connectivite (293) : T0=15.84 T1=0.00 T2=2.62 — pondere **5.25**
...
- TROP-CHER : 663 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 661 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 5209 systemes
  - sans CONNECTED : 0.0% sur 1144 systemes
