...
genere 2026-08-30 09:36 UTC — 214196 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 130852 systemes
...
- moteur actif `0caa9267db60` (170454 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 105105 | 52178 | 7159 | 3505 | 10593 | 8365 | 11135 | 10797 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 102976 | 24029 | 43481 | 48 | 14216 | 5311 | 41 | 15842 | 15.4% |
...
- candidats AVEC connectivite : 10924, dont T2 : 100%
- candidats SANS connectivite : 16152, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11409 systemes avec CONNECTED sur 88232 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*22786 candidats sur 27076 portent les champs bruts (84%).*

- `5c556c16ea8b` — 16821 candidats
  - AVEC connectivite (6796) : resistance **41.2%**
  - SANS connectivite (10025) : resistance **21.5%**
...
- `5c556c16ea8b` — 16821 candidats
  - AVEC connectivite (6796) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (10025) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 11460 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 11409 avec CONNECTED, 51 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 85731 systemes
  - sans CONNECTED : 0.0% sur 19374 systemes
