...
genere 2026-08-26 17:27 UTC — 56034 systemes evalues
...
- moteur actif `0caa9267db60` (12292 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
| ref | 4 | 3 | 24698 | 5709 | 10457 | 14 | 3447 | 1254 | 10 | 3807 | 15.4% |
...
- candidats SANS connectivite : 4117, dont T2 : 100%
...
*2531 candidats sur 6821 portent les champs bruts (37%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 221 candidats
  - AVEC connectivite (90) : resistance **44.0%**
  - SANS connectivite (131) : resistance **20.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `23303c299f39` — 221 candidats
  ...
  - SANS connectivite (131) : T0=16.20 T1=0.00 T2=2.59 — pondere **5.18**
...
**4 serie(s) reproductible(s) sur 7 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0075).
