...
genere 2026-08-26 14:54 UTC — 49961 systemes evalues
...
- moteur actif `0caa9267db60` (6219 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22161 | 11052 | 1486 | 759 | 2198 | 1755 | 2374 | 2258 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 21685 | 5038 | 9148 | 13 | 3020 | 1114 | 9 | 3343 | 15.4% |
...
- candidats AVEC connectivite : 2385, dont T2 : 100%
- candidats SANS connectivite : 3653, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2648 systemes avec CONNECTED sur 20603 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1748 candidats sur 6038 portent les champs bruts (29%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 633 candidats
  - AVEC connectivite (247) : resistance **41.1%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 633 candidats
  - AVEC connectivite (247) : T0=13.34 T1=0.00 T2=3.03 — pondere **6.06**
  - SANS connectivite (386) : T0=16.05 T1=0.00 T2=2.67 — pondere **5.34**
...
- TROP-CHER : 2667 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2648 avec CONNECTED, 19 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18102 systemes
  - sans CONNECTED : 0.0% sur 4059 systemes
