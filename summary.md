...
genere 2026-08-28 15:26 UTC — 147499 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 64155 systemes
...
- moteur actif `0caa9267db60` (103757 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 71413 | 35457 | 4877 | 2434 | 7166 | 5688 | 7551 | 7325 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 69971 | 16244 | 29562 | 32 | 9684 | 3610 | 31 | 10805 | 15.4% |
...
- candidats AVEC connectivite : 7452, dont T2 : 100%
- candidats SANS connectivite : 11115, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7825 systemes avec CONNECTED sur 60755 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*14277 candidats sur 18567 portent les champs bruts (77%).*

- `5c556c16ea8b` — 8312 candidats
  - AVEC connectivite (3324) : resistance **41.2%**
  - SANS connectivite (4988) : resistance **21.8%**
...
- `5c556c16ea8b` — 8312 candidats
  - AVEC connectivite (3324) : T0=13.01 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (4988) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.37**
...
- TROP-CHER : 7866 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7825 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 58254 systemes
  - sans CONNECTED : 0.0% sur 13159 systemes
