...
genere 2026-08-27 06:18 UTC — 84603 systemes evalues
...
- moteur actif `0caa9267db60` (40861 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 38828 | 8947 | 16520 | 22 | 5384 | 2028 | 21 | 5906 | 15.2% |
...
- candidats SANS connectivite : 6216, dont T2 : 100%
...
*6117 candidats sur 10407 portent les champs bruts (59%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 152 candidats
  - AVEC connectivite (63) : resistance **43.5%**
  - SANS connectivite (89) : resistance **21.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 152 candidats
  ...
  - SANS connectivite (89) : T0=15.51 T1=0.00 T2=2.53 — pondere **5.06**
...
**7 serie(s) reproductible(s) sur 14 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `ab89a63b01ef` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0060), `5c556c16ea8b` (p=0.0150), `b71bb0907fb5` (p=0.0110).
