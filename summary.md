...
genere 2026-08-29 19:01 UTC — 192645 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 109301 systemes
...
- moteur actif `0caa9267db60` (148903 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 94218 | 46808 | 6417 | 3164 | 9492 | 7505 | 9944 | 9688 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 92312 | 21539 | 38969 | 43 | 12767 | 4750 | 36 | 14202 | 15.4% |
...
- candidats SANS connectivite : 14512, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10218 systemes avec CONNECTED sur 79360 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*20037 candidats sur 24327 portent les champs bruts (82%).*

- `5c556c16ea8b` — 14072 candidats
  - AVEC connectivite (5687) : resistance **41.2%**
  - SANS connectivite (8385) : resistance **21.5%**
...
- `5c556c16ea8b` — 14072 candidats
  ...
  - SANS connectivite (8385) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 10264 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10218 avec CONNECTED, 46 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 76859 systemes
