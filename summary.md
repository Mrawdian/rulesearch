...
genere 2026-08-26 18:47 UTC — 59246 systemes evalues
...
- moteur actif `0caa9267db60` (15504 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 26279 | 6058 | 11127 | 15 | 3665 | 1352 | 10 | 4052 | 15.4% |
...
- candidats SANS connectivite : 4362, dont T2 : 100%
...
*2946 candidats sur 7236 portent les champs bruts (41%).*
...
- `e80bc1b2b437` — 75 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 77 candidats
  - AVEC connectivite (30) : resistance **47.0%**
  - SANS connectivite (47) : resistance **16.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 77 candidats
  ...
  - SANS connectivite (47) : T0=16.51 T1=0.00 T2=2.49 — pondere **4.98**
...
**6 serie(s) reproductible(s) sur 12 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0060), `62448a55927e` (p=0.0370), `b71bb0907fb5` (p=0.0110).
