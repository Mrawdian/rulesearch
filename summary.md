...
genere 2026-08-28 00:18 UTC — 120450 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 37106 systemes
...
- moteur actif `0caa9267db60` (76708 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 57752 | 28762 | 3998 | 1951 | 5732 | 4568 | 6094 | 5907 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 56583 | 13060 | 24008 | 28 | 7871 | 2920 | 25 | 8669 | 15.3% |
...
- candidats AVEC connectivite : 6034, dont T2 : 100%
- candidats SANS connectivite : 8979, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6368 systemes avec CONNECTED sur 49674 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10723 candidats sur 15013 portent les champs bruts (71%).*

- `5c556c16ea8b` — 4758 candidats
  - AVEC connectivite (1906) : resistance **42.0%**
  - SANS connectivite (2852) : resistance **22.5%**
...
- `5c556c16ea8b` — 4758 candidats
  - AVEC connectivite (1906) : T0=12.98 T1=0.00 T2=3.05 — pondere **6.11**
  - SANS connectivite (2852) : T0=15.80 T1=0.00 T2=2.72 — pondere **5.44**
...
## cout
- temps total 37.2 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 6403 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6368 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 47173 systemes
  - sans CONNECTED : 0.0% sur 10579 systemes
