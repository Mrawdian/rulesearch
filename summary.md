...
| connect | 4 | 3 | 5605 | 2825 | 359 | 204 | 537 | 458 | 581 | 574 | 10.2% |
...
- **581 systemes avec CONNECTED sur 4643 (12.5%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 278 candidats
  - AVEC connectivite (98) : T0=13.20 T1=0.00 T2=2.83 — pondere **5.65**
  - SANS connectivite (180) : T0=15.99 T1=0.00 T2=2.63 — pondere **5.26**
  - test de permutation : **p = 0.3088** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 583 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 581 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 4586 systemes
  - sans CONNECTED : 0.0% sur 1019 systemes
