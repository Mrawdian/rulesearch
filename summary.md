...
genere 2026-08-30 19:46 UTC — 228841 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 145497 systemes
...
- moteur actif `0caa9267db60` (185099 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 112515 | 55943 | 7641 | 3765 | 11304 | 8903 | 11906 | 11589 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 110211 | 25702 | 46555 | 51 | 15206 | 5699 | 45 | 16943 | 15.4% |
...
- candidats AVEC connectivite : 11716, dont T2 : 100%
- candidats SANS connectivite : 17253, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12180 systemes avec CONNECTED sur 94337 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*24679 candidats sur 28969 portent les champs bruts (85%).*

- `5c556c16ea8b` — 18714 candidats
  - AVEC connectivite (7588) : resistance **41.1%**
  - SANS connectivite (11126) : resistance **21.5%**
...
- `5c556c16ea8b` — 18714 candidats
  - AVEC connectivite (7588) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (11126) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
## cout
- temps total 70.9 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 12235 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 12180 avec CONNECTED, 55 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 91836 systemes
  - sans CONNECTED : 0.0% sur 20679 systemes
