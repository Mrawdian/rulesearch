...
genere 2026-08-31 21:46 UTC — 263982 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 180638 systemes
...
- moteur actif `0caa9267db60` (220240 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 130249 | 64741 | 8796 | 4370 | 13196 | 10297 | 13740 | 13412 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 127618 | 29754 | 53900 | 56 | 17696 | 6596 | 57 | 19549 | 15.3% |
...
- candidats SANS connectivite : 19859, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14014 systemes avec CONNECTED sur 108775 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*29108 candidats sur 33398 portent les champs bruts (87%).*

- `5c556c16ea8b` — 23143 candidats
  - AVEC connectivite (9411) : resistance **41.0%**
  - SANS connectivite (13732) : resistance **21.4%**
...
- `5c556c16ea8b` — 23143 candidats
  ...
  - SANS connectivite (13732) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 14081 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14014 avec CONNECTED, 67 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 106274 systemes
  - sans CONNECTED : 0.0% sur 23975 systemes
