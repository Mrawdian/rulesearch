...
genere 2026-08-26 12:39 UTC — 44448 systemes evalues
...
| connect | 4 | 3 | 19367 | 9655 | 1265 | 675 | 1935 | 1537 | 2089 | 1971 | 10.2% |
...
- candidats AVEC connectivite : 2098, dont T2 : 100%
- candidats SANS connectivite : 3211, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2363 systemes avec CONNECTED sur 18315 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1019 candidats sur 5309 portent les champs bruts (19%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `e40600351a72` — 98 candidats
  - AVEC connectivite (47) : resistance **38.6%**
...
- `e40600351a72` — 98 candidats
  - AVEC connectivite (47) : T0=12.89 T1=0.00 T2=2.85 — pondere **5.70**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 15814 systemes
  - sans CONNECTED : 0.0% sur 3553 systemes
