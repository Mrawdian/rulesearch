...
genere 2026-08-27 07:44 UTC — 87784 systemes evalues
...
- moteur actif `0caa9267db60` (44042 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 41254 | 20536 | 2836 | 1402 | 4118 | 3251 | 4346 | 4234 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 40415 | 9306 | 17181 | 22 | 5614 | 2104 | 21 | 6167 | 15.3% |
...
- candidats AVEC connectivite : 4361, dont T2 : 100%
- candidats SANS connectivite : 6477, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4620 systemes avec CONNECTED sur 36215 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6548 candidats sur 10838 portent les champs bruts (60%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 583 candidats
  - AVEC connectivite (233) : resistance **41.2%**
  - SANS connectivite (350) : resistance **20.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 583 candidats
  - AVEC connectivite (233) : T0=13.06 T1=0.00 T2=3.02 — pondere **6.04**
  - SANS connectivite (350) : T0=15.90 T1=0.00 T2=2.63 — pondere **5.27**
...
- TROP-CHER : 4651 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4620 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 33714 systemes
  - sans CONNECTED : 0.0% sur 7540 systemes
