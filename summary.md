...
genere 2026-09-01 22:59 UTC — 295261 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 211917 systemes
...
- moteur actif `0caa9267db60` (251519 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 146039 | 72525 | 9925 | 4896 | 14832 | 11514 | 15444 | 15020 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 143107 | 33289 | 60542 | 61 | 19819 | 7389 | 63 | 21933 | 15.3% |
...
- candidats AVEC connectivite : 15147, dont T2 : 100%
- candidats SANS connectivite : 22243, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15718 systemes avec CONNECTED sur 121686 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*33100 candidats sur 37390 portent les champs bruts (89%).*

- `5c556c16ea8b` — 27135 candidats
  - AVEC connectivite (11019) : resistance **41.0%**
  - SANS connectivite (16116) : resistance **21.3%**
...
- `5c556c16ea8b` — 27135 candidats
  - AVEC connectivite (11019) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (16116) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 15791 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15718 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 119185 systemes
  - sans CONNECTED : 0.0% sur 26854 systemes
