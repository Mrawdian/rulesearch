...
genere 2026-08-26 19:28 UTC — 60778 systemes evalues
...
- moteur actif `0caa9267db60` (17036 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27630 | 13783 | 1881 | 932 | 2730 | 2190 | 2937 | 2831 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 27033 | 6254 | 11436 | 15 | 3765 | 1391 | 11 | 4161 | 15.4% |
...
- candidats AVEC connectivite : 2958, dont T2 : 100%
- candidats SANS connectivite : 4471, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3211 systemes avec CONNECTED sur 25113 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3139 candidats sur 7429 portent les champs bruts (42%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 270 candidats
  - AVEC connectivite (114) : resistance **39.3%**
  - SANS connectivite (156) : resistance **18.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 270 candidats
  - AVEC connectivite (114) : T0=13.01 T1=0.00 T2=2.91 — pondere **5.82**
  - SANS connectivite (156) : T0=16.06 T1=0.00 T2=2.58 — pondere **5.15**
  - test de permutation : **p = 0.0870** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- TROP-CHER : 3232 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3211 avec CONNECTED, 21 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22612 systemes
  - sans CONNECTED : 0.0% sur 5018 systemes
