...
genere 2026-09-04 04:18 UTC — 355661 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 272317 systemes
...
- moteur actif `0caa9267db60` (311919 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 176518 | 87723 | 12003 | 5903 | 17968 | 13890 | 18721 | 18064 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 173028 | 40209 | 73063 | 70 | 24040 | 8964 | 68 | 26600 | 15.4% |
...
- candidats AVEC connectivite : 18191, dont T2 : 100%
- candidats SANS connectivite : 26910, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18995 systemes avec CONNECTED sur 146534 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*40811 candidats sur 45101 portent les champs bruts (90%).*

- `5c556c16ea8b` — 34846 candidats
  - AVEC connectivite (14063) : resistance **41.0%**
  - SANS connectivite (20783) : resistance **21.3%**
...
- `5c556c16ea8b` — 34846 candidats
  - AVEC connectivite (14063) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (20783) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 19073 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18995 avec CONNECTED, 78 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 144033 systemes
  - sans CONNECTED : 0.0% sur 32485 systemes
