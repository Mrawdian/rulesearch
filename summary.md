...
genere 2026-08-31 09:30 UTC — 247770 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 164426 systemes
...
- moteur actif `0caa9267db60` (204028 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 122066 | 60709 | 8283 | 4088 | 12278 | 9642 | 12900 | 12582 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 119589 | 27923 | 50481 | 53 | 16524 | 6187 | 54 | 18357 | 15.4% |
...
- candidats AVEC connectivite : 12709, dont T2 : 100%
- candidats SANS connectivite : 18667, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13174 systemes avec CONNECTED sur 102146 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*27086 candidats sur 31376 portent les champs bruts (86%).*

- `5c556c16ea8b` — 21121 candidats
  - AVEC connectivite (8581) : resistance **40.9%**
  - SANS connectivite (12540) : resistance **21.3%**
...
- `5c556c16ea8b` — 21121 candidats
  - AVEC connectivite (8581) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (12540) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 99645 systemes
  - sans CONNECTED : 0.0% sur 22421 systemes
