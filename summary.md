...
genere 2026-08-26 14:32 UTC — 49161 systemes evalues
...
- moteur actif `0caa9267db60` (5419 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21756 | 10859 | 1455 | 747 | 2153 | 1725 | 2325 | 2217 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 21290 | 4947 | 8989 | 13 | 2950 | 1099 | 8 | 3284 | 15.4% |
...
- candidats SANS connectivite : 3594, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2599 systemes avec CONNECTED sur 20285 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1648 candidats sur 5938 portent les champs bruts (28%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 533 candidats
  - AVEC connectivite (206) : resistance **39.8%**
  - SANS connectivite (327) : resistance **20.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 533 candidats
  ...
  - SANS connectivite (327) : T0=16.06 T1=0.00 T2=2.62 — pondere **5.24**
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0140).
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17784 systemes
  - sans CONNECTED : 0.0% sur 3972 systemes
