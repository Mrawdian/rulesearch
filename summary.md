...
genere 2026-08-27 07:45 UTC — 87829 systemes evalues
...
- moteur actif `0caa9267db60` (44087 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 41284 | 20550 | 2839 | 1403 | 4120 | 3253 | 4348 | 4239 | 10.3% |
...
- candidats AVEC connectivite : 4366, dont T2 : 100%
- candidats SANS connectivite : 6478, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4622 systemes avec CONNECTED sur 36240 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6554 candidats sur 10844 portent les champs bruts (60%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 589 candidats
  - AVEC connectivite (238) : resistance **41.2%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 589 candidats
  - AVEC connectivite (238) : T0=13.03 T1=0.00 T2=3.01 — pondere **6.03**
...
- TROP-CHER : 4653 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4622 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 33739 systemes
