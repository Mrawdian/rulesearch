...
genere 2026-08-28 04:16 UTC — 128078 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 44734 systemes
...
- moteur actif `0caa9267db60` (84336 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 61605 | 30645 | 4254 | 2080 | 6137 | 4896 | 6472 | 6330 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 60358 | 13967 | 25566 | 28 | 8389 | 3126 | 26 | 9254 | 15.3% |
...
- candidats SANS connectivite : 9564, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6746 systemes avec CONNECTED sur 52776 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11731 candidats sur 16021 portent les champs bruts (73%).*

- `5c556c16ea8b` — 5766 candidats
  - AVEC connectivite (2329) : resistance **41.7%**
  - SANS connectivite (3437) : resistance **22.1%**
...
- `5c556c16ea8b` — 5766 candidats
  ...
  - SANS connectivite (3437) : T0=15.86 T1=0.00 T2=2.70 — pondere **5.40**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 50275 systemes
  - sans CONNECTED : 0.0% sur 11330 systemes
