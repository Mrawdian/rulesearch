...
| connect | 4 | 3 | 5576 | 2809 | 356 | 203 | 533 | 457 | 579 | 574 | 10.3% |
| ref | 4 | 3 | 5438 | 1315 | 2275 | 1 | 722 | 265 | 2 | 858 | 15.8% |
...
- candidats AVEC connectivite : 577, dont T2 : 100%
- candidats SANS connectivite : 862, dont T2 : 100%
...
- **579 systemes avec CONNECTED sur 4620 (12.5%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 274 candidats
  - AVEC connectivite (98) : T0=13.20 T1=0.00 T2=2.83 — pondere **5.65**
  - SANS connectivite (176) : T0=16.04 T1=0.00 T2=2.62 — pondere **5.25**
  - test de permutation : **p = 0.2809** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 581 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 579 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 4563 systemes
  - sans CONNECTED : 0.0% sur 1013 systemes
