...
genere 2026-08-30 06:09 UTC — 209560 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 126216 systemes
...
- moteur actif `0caa9267db60` (165818 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 102767 | 51020 | 7001 | 3438 | 10381 | 8192 | 10834 | 10562 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 100678 | 23461 | 42531 | 46 | 13902 | 5194 | 40 | 15496 | 15.4% |
...
- candidats SANS connectivite : 15806, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11108 systemes avec CONNECTED sur 86310 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*22205 candidats sur 26495 portent les champs bruts (84%).*

- `5c556c16ea8b` — 16240 candidats
  - AVEC connectivite (6561) : resistance **41.1%**
  - SANS connectivite (9679) : resistance **21.5%**
...
- `5c556c16ea8b` — 16240 candidats
  ...
  - SANS connectivite (9679) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 11158 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11108 avec CONNECTED, 50 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 83809 systemes
  - sans CONNECTED : 0.0% sur 18958 systemes
