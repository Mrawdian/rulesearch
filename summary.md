...
genere 2026-08-27 15:26 UTC — 103389 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 20045 systemes
...
- moteur actif `0caa9267db60` (59647 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 48135 | 11131 | 20447 | 25 | 6657 | 2514 | 23 | 7337 | 15.2% |
...
- candidats SANS connectivite : 7647, dont T2 : 100%
...
*8483 candidats sur 12773 portent les champs bruts (66%).*
...
- `5c556c16ea8b` — 2518 candidats
  - AVEC connectivite (998) : resistance **41.7%**
  - SANS connectivite (1520) : resistance **22.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 2518 candidats
  ...
  - SANS connectivite (1520) : T0=15.80 T1=0.00 T2=2.67 — pondere **5.34**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 2280 candidats
