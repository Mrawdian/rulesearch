...
| connect | 4 | 3 | 18726 | 9341 | 1220 | 651 | 1867 | 1491 | 2031 | 1892 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 18339 | 4310 | 7728 | 13 | 2520 | 947 | 7 | 2814 | 15.3% |
...
- candidats AVEC connectivite : 2019, dont T2 : 100%
- candidats SANS connectivite : 3124, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2305 systemes avec CONNECTED sur 17783 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*853 candidats sur 5143 portent les champs bruts (17%).*
...
- `e3baecf8377b` — 589 candidats
  - AVEC connectivite (236) : resistance **42.0%**
  - SANS connectivite (353) : resistance **21.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 589 candidats
  - AVEC connectivite (236) : T0=13.11 T1=0.00 T2=3.09 — pondere **6.19**
  - SANS connectivite (353) : T0=15.99 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 2322 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 2305 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 15282 systemes
  - sans CONNECTED : 0.0% sur 3444 systemes
