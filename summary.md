...
genere 2026-08-28 22:15 UTC — 159416 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 76072 systemes
...
- moteur actif `0caa9267db60` (115674 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 77437 | 38467 | 5274 | 2635 | 7753 | 6193 | 8156 | 7970 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 75864 | 17644 | 32123 | 35 | 10449 | 3881 | 31 | 11697 | 15.4% |
...
- candidats AVEC connectivite : 8097, dont T2 : 100%
...
- **8430 systemes avec CONNECTED sur 65658 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*15814 candidats sur 20104 portent les champs bruts (79%).*

- `5c556c16ea8b` — 9849 candidats
  - AVEC connectivite (3969) : resistance **41.1%**
...
- `5c556c16ea8b` — 9849 candidats
  - AVEC connectivite (3969) : T0=13.01 T1=0.00 T2=3.00 — pondere **6.00**
...
- TROP-CHER : 8471 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8430 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 63157 systemes
  - sans CONNECTED : 0.0% sur 14280 systemes
