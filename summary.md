...
genere 2026-09-04 11:12 UTC — 363164 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 279820 systemes
...
- moteur actif `0caa9267db60` (319422 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 180313 | 89602 | 12257 | 6028 | 18354 | 14205 | 19103 | 18463 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 176736 | 41040 | 74692 | 72 | 24551 | 9155 | 70 | 27142 | 15.4% |
...
- candidats AVEC connectivite : 18590, dont T2 : 100%
- candidats SANS connectivite : 27452, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19377 systemes avec CONNECTED sur 149599 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*41752 candidats sur 46042 portent les champs bruts (91%).*

- `5c556c16ea8b` — 35787 candidats
  - AVEC connectivite (14462) : resistance **41.0%**
  - SANS connectivite (21325) : resistance **21.2%**
...
- `5c556c16ea8b` — 35787 candidats
  - AVEC connectivite (14462) : T0=13.03 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (21325) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 147098 systemes
  - sans CONNECTED : 0.0% sur 33215 systemes
