...
genere 2026-08-30 12:28 UTC — 218429 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 135085 systemes
...
- moteur actif `0caa9267db60` (174687 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 107250 | 53278 | 7301 | 3581 | 10802 | 8526 | 11352 | 11015 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 105064 | 24503 | 44366 | 49 | 14504 | 5437 | 41 | 16155 | 15.4% |
...
- candidats AVEC connectivite : 11142, dont T2 : 100%
- candidats SANS connectivite : 16465, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11626 systemes avec CONNECTED sur 89995 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*23317 candidats sur 27607 portent les champs bruts (84%).*

- `5c556c16ea8b` — 17352 candidats
  - AVEC connectivite (7014) : resistance **41.1%**
  - SANS connectivite (10338) : resistance **21.5%**
...
- `5c556c16ea8b` — 17352 candidats
  - AVEC connectivite (7014) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (10338) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 87494 systemes
  - sans CONNECTED : 0.0% sur 19756 systemes
