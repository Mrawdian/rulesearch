...
genere 2026-08-29 19:25 UTC — 193258 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 109914 systemes
...
- moteur actif `0caa9267db60` (149516 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 94528 | 46965 | 6436 | 3180 | 9526 | 7528 | 9975 | 9714 | 10.3% |
...
- candidats AVEC connectivite : 9841, dont T2 : 100%
...
- **10249 systemes avec CONNECTED sur 79608 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*20119 candidats sur 24409 portent les champs bruts (82%).*

- `5c556c16ea8b` — 14154 candidats
  - AVEC connectivite (5713) : resistance **41.2%**
...
- `5c556c16ea8b` — 14154 candidats
  - AVEC connectivite (5713) : T0=13.00 T1=0.00 T2=3.00 — pondere **6.00**
...
- TROP-CHER : 10295 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10249 avec CONNECTED, 46 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 77107 systemes
  - sans CONNECTED : 0.0% sur 17421 systemes
