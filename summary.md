...
genere 2026-08-28 00:39 UTC — 121161 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 37817 systemes
...
- moteur actif `0caa9267db60` (77419 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 58109 | 28948 | 4020 | 1961 | 5770 | 4590 | 6128 | 5948 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 56937 | 13142 | 24157 | 28 | 7912 | 2947 | 26 | 8723 | 15.3% |
...
- candidats AVEC connectivite : 6075, dont T2 : 100%
- candidats SANS connectivite : 9033, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6402 systemes avec CONNECTED sur 49965 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10818 candidats sur 15108 portent les champs bruts (72%).*

- `5c556c16ea8b` — 4853 candidats
  - AVEC connectivite (1947) : resistance **42.1%**
  - SANS connectivite (2906) : resistance **22.4%**
...
- `5c556c16ea8b` — 4853 candidats
  - AVEC connectivite (1947) : T0=12.98 T1=0.00 T2=3.06 — pondere **6.11**
  - SANS connectivite (2906) : T0=15.84 T1=0.00 T2=2.72 — pondere **5.43**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 47464 systemes
  - sans CONNECTED : 0.0% sur 10645 systemes
