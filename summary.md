...
genere 2026-08-29 17:00 UTC — 189727 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 106383 systemes
...
- moteur actif `0caa9267db60` (145985 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 92735 | 46095 | 6315 | 3114 | 9342 | 7372 | 9765 | 9543 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 90877 | 21219 | 38351 | 43 | 12565 | 4667 | 36 | 13990 | 15.4% |
...
- candidats AVEC connectivite : 9670, dont T2 : 100%
- candidats SANS connectivite : 14300, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10039 systemes avec CONNECTED sur 78156 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*19680 candidats sur 23970 portent les champs bruts (82%).*

- `5c556c16ea8b` — 13715 candidats
  - AVEC connectivite (5542) : resistance **41.2%**
  - SANS connectivite (8173) : resistance **21.5%**
...
- `5c556c16ea8b` — 13715 candidats
  - AVEC connectivite (5542) : T0=12.99 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (8173) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.34**
...
- TROP-CHER : 10085 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10039 avec CONNECTED, 46 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 75655 systemes
  - sans CONNECTED : 0.0% sur 17080 systemes
