...
genere 2026-08-27 20:45 UTC — 113459 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 30115 systemes
...
- moteur actif `0caa9267db60` (69717 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 54212 | 27002 | 3746 | 1840 | 5350 | 4287 | 5739 | 5540 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 53132 | 12260 | 22583 | 26 | 7351 | 2761 | 25 | 8124 | 15.3% |
...
- candidats AVEC connectivite : 5667, dont T2 : 100%
- candidats SANS connectivite : 8434, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6013 systemes avec CONNECTED sur 46807 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*9811 candidats sur 14101 portent les champs bruts (70%).*

- `5c556c16ea8b` — 3846 candidats
  - AVEC connectivite (1539) : resistance **42.0%**
...
- `5c556c16ea8b` — 3846 candidats
  - AVEC connectivite (1539) : T0=12.93 T1=0.00 T2=3.05 — pondere **6.10**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 44306 systemes
  - sans CONNECTED : 0.0% sur 9906 systemes
