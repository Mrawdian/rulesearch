...
genere 2026-08-30 19:50 UTC — 228931 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 145587 systemes
...
- moteur actif `0caa9267db60` (185189 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 112560 | 55968 | 7645 | 3766 | 11307 | 8908 | 11911 | 11590 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 110256 | 25713 | 46573 | 51 | 15209 | 5702 | 45 | 16953 | 15.4% |
...
- candidats SANS connectivite : 17263, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12185 systemes avec CONNECTED sur 94376 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*24690 candidats sur 28980 portent les champs bruts (85%).*

- `5c556c16ea8b` — 18725 candidats
  - AVEC connectivite (7589) : resistance **41.1%**
  - SANS connectivite (11136) : resistance **21.4%**
...
- `5c556c16ea8b` — 18725 candidats
  ...
  - SANS connectivite (11136) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 91875 systemes
  - sans CONNECTED : 0.0% sur 20685 systemes
