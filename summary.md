...
genere 2026-08-27 01:31 UTC — 73976 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 9167 systemes
- `ab89a63b01ef` : 9069 systemes
...
- moteur actif `0caa9267db60` (30234 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 34302 | 17059 | 2349 | 1165 | 3409 | 2728 | 3660 | 3493 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 33559 | 7743 | 14258 | 20 | 4656 | 1746 | 17 | 5119 | 15.3% |
...
- candidats AVEC connectivite : 3620, dont T2 : 100%
- candidats SANS connectivite : 5429, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3934 systemes avec CONNECTED sur 30560 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4759 candidats sur 9049 portent les champs bruts (53%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 1082 candidats
  - AVEC connectivite (440) : resistance **41.1%**
  - SANS connectivite (642) : resistance **21.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 1082 candidats
  - AVEC connectivite (440) : T0=13.05 T1=0.00 T2=3.05 — pondere **6.09**
  - SANS connectivite (642) : T0=15.89 T1=0.00 T2=2.64 — pondere **5.28**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
...
- TROP-CHER : 3961 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 3934 avec CONNECTED, 27 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 28059 systemes
  - sans CONNECTED : 0.0% sur 6243 systemes
