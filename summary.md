...
genere 2026-08-26 20:45 UTC — 63561 systemes evalues
...
- moteur actif `0caa9267db60` (19819 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 29036 | 14448 | 1982 | 971 | 2890 | 2297 | 3092 | 2986 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 28410 | 6553 | 12058 | 16 | 3943 | 1466 | 12 | 4362 | 15.4% |
...
- candidats AVEC connectivite : 3113, dont T2 : 100%
- candidats SANS connectivite : 4672, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3366 systemes avec CONNECTED sur 26257 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3495 candidats sur 7785 portent les champs bruts (45%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 626 candidats
  - AVEC connectivite (269) : resistance **40.0%**
  - SANS connectivite (357) : resistance **20.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 626 candidats
  - AVEC connectivite (269) : T0=12.80 T1=0.00 T2=2.86 — pondere **5.71**
  - SANS connectivite (357) : T0=16.12 T1=0.00 T2=2.66 — pondere **5.33**
  - test de permutation : **p = 0.1479** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
## cout
- temps total 19.7 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 3388 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3366 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23756 systemes
  - sans CONNECTED : 0.0% sur 5280 systemes
