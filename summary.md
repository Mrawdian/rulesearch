...
genere 2026-09-03 23:17 UTC — 350317 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 266973 systemes
...
- moteur actif `0caa9267db60` (306575 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 173831 | 86422 | 11803 | 5816 | 17698 | 13687 | 18415 | 17776 | 10.2% |
...
- candidats AVEC connectivite : 17903, dont T2 : 100%
...
- **18689 systemes avec CONNECTED sur 144340 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*40077 candidats sur 44367 portent les champs bruts (90%).*

- `5c556c16ea8b` — 34112 candidats
  - AVEC connectivite (13775) : resistance **41.0%**
...
- `5c556c16ea8b` — 34112 candidats
  - AVEC connectivite (13775) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 18765 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18689 avec CONNECTED, 76 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 141839 systemes
  - sans CONNECTED : 0.0% sur 31992 systemes
