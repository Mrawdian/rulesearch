...
genere 2026-08-26 16:02 UTC — 52718 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 7535 systemes
...
- moteur actif `0caa9267db60` (8976 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23549 | 11739 | 1594 | 804 | 2346 | 1868 | 2515 | 2387 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 23054 | 5340 | 9737 | 14 | 3222 | 1174 | 10 | 3557 | 15.4% |
...
- candidats AVEC connectivite : 2514, dont T2 : 100%
- candidats SANS connectivite : 3867, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2789 systemes avec CONNECTED sur 21724 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2091 candidats sur 6381 portent les champs bruts (33%).*
...
- `06fe04a859f1` — 976 candidats
  - AVEC connectivite (376) : resistance **41.4%**
  - SANS connectivite (600) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 976 candidats
  - AVEC connectivite (376) : T0=13.21 T1=0.00 T2=3.04 — pondere **6.07**
  - SANS connectivite (600) : T0=16.00 T1=0.00 T2=2.64 — pondere **5.28**
...
- TROP-CHER : 2809 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2789 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19223 systemes
  - sans CONNECTED : 0.0% sur 4326 systemes
