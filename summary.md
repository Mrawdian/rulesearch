...
genere 2026-09-02 14:28 UTC — 313305 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 229961 systemes
...
- moteur actif `0caa9267db60` (269563 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 155140 | 77069 | 10555 | 5190 | 15766 | 12218 | 16438 | 15918 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 152050 | 35412 | 64309 | 64 | 21007 | 7868 | 63 | 23315 | 15.3% |
...
- candidats SANS connectivite : 23625, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16712 systemes avec CONNECTED sur 129131 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*35380 candidats sur 39670 portent les champs bruts (89%).*

- `5c556c16ea8b` — 29415 candidats
  - AVEC connectivite (11917) : resistance **41.1%**
  - SANS connectivite (17498) : resistance **21.3%**
...
- `5c556c16ea8b` — 29415 candidats
  ...
  - SANS connectivite (17498) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 16785 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16712 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 126630 systemes
  - sans CONNECTED : 0.0% sur 28510 systemes
