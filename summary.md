...
genere 2026-09-01 03:31 UTC — 271273 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 187929 systemes
...
- moteur actif `0caa9267db60` (227531 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 133931 | 66548 | 9056 | 4492 | 13585 | 10604 | 14148 | 13761 | 10.3% |
...
- candidats AVEC connectivite : 13888, dont T2 : 100%
...
- **14422 systemes avec CONNECTED sur 111760 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*30007 candidats sur 34297 portent les champs bruts (87%).*

- `5c556c16ea8b` — 24042 candidats
  - AVEC connectivite (9760) : resistance **41.0%**
...
- `5c556c16ea8b` — 24042 candidats
  - AVEC connectivite (9760) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 14489 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14422 avec CONNECTED, 67 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 109259 systemes
  - sans CONNECTED : 0.0% sur 24672 systemes
