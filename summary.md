...
genere 2026-09-05 16:24 UTC — 393268 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 309924 systemes
...
- moteur actif `0caa9267db60` (349526 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 195513 | 97085 | 13309 | 6518 | 19889 | 15382 | 20744 | 20099 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 191640 | 44626 | 80854 | 78 | 26680 | 9905 | 71 | 29412 | 15.3% |
...
- candidats AVEC connectivite : 20226, dont T2 : 100%
- candidats SANS connectivite : 29722, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21018 systemes avec CONNECTED sur 161987 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*45658 candidats sur 49948 portent les champs bruts (91%).*

- `5c556c16ea8b` — 39693 candidats
  - AVEC connectivite (16098) : resistance **41.1%**
  - SANS connectivite (23595) : resistance **21.3%**
...
- `5c556c16ea8b` — 39693 candidats
  - AVEC connectivite (16098) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.94**
  - SANS connectivite (23595) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 159486 systemes
  - sans CONNECTED : 0.0% sur 36027 systemes
