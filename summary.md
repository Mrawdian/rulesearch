...
genere 2026-08-26 14:06 UTC — 48169 systemes evalues
...
- moteur actif `0caa9267db60` (4427 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21246 | 10606 | 1410 | 731 | 2105 | 1687 | 2270 | 2168 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20808 | 4855 | 8782 | 13 | 2887 | 1076 | 7 | 3188 | 15.3% |
...
- candidats AVEC connectivite : 2295, dont T2 : 100%
- candidats SANS connectivite : 3498, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2544 systemes avec CONNECTED sur 19858 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1503 candidats sur 5793 portent les champs bruts (26%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 388 candidats
  - AVEC connectivite (157) : resistance **39.5%**
  - SANS connectivite (231) : resistance **21.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 388 candidats
  - AVEC connectivite (157) : T0=13.39 T1=0.00 T2=2.94 — pondere **5.87**
  - SANS connectivite (231) : T0=16.08 T1=0.00 T2=2.70 — pondere **5.39**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17357 systemes
  - sans CONNECTED : 0.0% sur 3889 systemes
