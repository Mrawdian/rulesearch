...
genere 2026-09-08 19:43 UTC — 463855 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 380511 systemes
...
- moteur actif `0caa9267db60` (420113 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 231168 | 114828 | 15735 | 7734 | 23367 | 18106 | 24657 | 23803 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 226572 | 52778 | 95489 | 90 | 31563 | 11714 | 81 | 34839 | 15.4% |
...
- candidats AVEC connectivite : 23930, dont T2 : 100%
- candidats SANS connectivite : 35149, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **24931 systemes avec CONNECTED sur 191295 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*54789 candidats sur 59079 portent les champs bruts (93%).*

- `5c556c16ea8b` — 48824 candidats
  - AVEC connectivite (19802) : resistance **41.2%**
  - SANS connectivite (29022) : resistance **21.3%**
...
- `5c556c16ea8b` — 48824 candidats
  - AVEC connectivite (19802) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (29022) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 25022 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 24931 avec CONNECTED, 91 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 188794 systemes
  - sans CONNECTED : 0.0% sur 42374 systemes
