...
genere 2026-08-26 03:15 UTC — 20502 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 11528 systemes
...
| connect | 4 | 3 | 10298 | 5190 | 673 | 354 | 987 | 818 | 1108 | 1040 | 10.1% |
| ref | 4 | 3 | 10080 | 2411 | 4257 | 4 | 1339 | 510 | 4 | 1555 | 15.4% |
...
- candidats AVEC connectivite : 1043, dont T2 : 100%
- candidats SANS connectivite : 1559, dont T2 : 100%
...
- **1108 systemes avec CONNECTED sur 8509 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1437 candidats
  - AVEC connectivite (564) : T0=13.36 T1=0.00 T2=2.85 — pondere **5.71**
  - SANS connectivite (873) : T0=15.80 T1=0.00 T2=2.67 — pondere **5.34**
...
- TROP-CHER : 1112 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 1108 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 8452 systemes
  - sans CONNECTED : 0.0% sur 1846 systemes
