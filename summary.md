...
genere 2026-09-08 18:48 UTC — 463051 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 379707 systemes
...
- moteur actif `0caa9267db60` (419309 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 230766 | 114629 | 15709 | 7720 | 23331 | 18078 | 24608 | 23756 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 226170 | 52682 | 95320 | 90 | 31514 | 11689 | 81 | 34776 | 15.4% |
...
- candidats AVEC connectivite : 23883, dont T2 : 100%
...
- **24882 systemes avec CONNECTED sur 190957 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*54679 candidats sur 58969 portent les champs bruts (93%).*

- `5c556c16ea8b` — 48714 candidats
  - AVEC connectivite (19755) : resistance **41.2%**
...
- `5c556c16ea8b` — 48714 candidats
  - AVEC connectivite (19755) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 24973 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 24882 avec CONNECTED, 91 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 188456 systemes
  - sans CONNECTED : 0.0% sur 42310 systemes
