...
genere 2026-09-06 00:04 UTC — 400936 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 317592 systemes
...
- moteur actif `0caa9267db60` (357194 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 199380 | 98983 | 13584 | 6644 | 20247 | 15698 | 21157 | 20528 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 195441 | 45467 | 82458 | 78 | 27233 | 10091 | 72 | 30025 | 15.4% |
...
- candidats AVEC connectivite : 20655, dont T2 : 100%
- candidats SANS connectivite : 30335, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21431 systemes avec CONNECTED sur 165167 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*46700 candidats sur 50990 portent les champs bruts (92%).*

- `5c556c16ea8b` — 40735 candidats
  - AVEC connectivite (16527) : resistance **41.0%**
  - SANS connectivite (24208) : resistance **21.3%**
...
- `5c556c16ea8b` — 40735 candidats
  - AVEC connectivite (16527) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.94**
  - SANS connectivite (24208) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 21513 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21431 avec CONNECTED, 82 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 162666 systemes
  - sans CONNECTED : 0.0% sur 36714 systemes
