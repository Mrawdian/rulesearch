...
genere 2026-09-01 01:57 UTC — 269319 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 185975 systemes
...
- moteur actif `0caa9267db60` (225577 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 132947 | 66061 | 8991 | 4461 | 13480 | 10518 | 14035 | 13676 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 130257 | 30351 | 55042 | 57 | 18042 | 6741 | 57 | 19957 | 15.3% |
...
- candidats AVEC connectivite : 13803, dont T2 : 100%
- candidats SANS connectivite : 20267, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14309 systemes avec CONNECTED sur 110970 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*29780 candidats sur 34070 portent les champs bruts (87%).*

- `5c556c16ea8b` — 23815 candidats
  - AVEC connectivite (9675) : resistance **41.0%**
  - SANS connectivite (14140) : resistance **21.3%**
...
- `5c556c16ea8b` — 23815 candidats
  - AVEC connectivite (9675) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (14140) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 108469 systemes
  - sans CONNECTED : 0.0% sur 24478 systemes
