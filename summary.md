...
genere 2026-08-26 20:34 UTC — 63246 systemes evalues
...
- moteur actif `0caa9267db60` (19504 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 28871 | 14373 | 1975 | 967 | 2868 | 2288 | 3067 | 2969 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 28260 | 6528 | 11985 | 16 | 3920 | 1456 | 12 | 4343 | 15.4% |
...
- candidats SANS connectivite : 4653, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3341 systemes avec CONNECTED sur 26122 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3459 candidats sur 7749 portent les champs bruts (45%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 590 candidats
  - AVEC connectivite (252) : resistance **40.0%**
  - SANS connectivite (338) : resistance **20.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 590 candidats
  ...
  - SANS connectivite (338) : T0=16.20 T1=0.00 T2=2.68 — pondere **5.36**
  - test de permutation : **p = 0.2399** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23621 systemes
  - sans CONNECTED : 0.0% sur 5250 systemes
