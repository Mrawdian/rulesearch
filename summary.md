...
genere 2026-08-26 22:10 UTC — 66699 systemes evalues
...
- moteur actif `0caa9267db60` (22957 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 29961 | 6907 | 12730 | 18 | 4141 | 1545 | 13 | 4607 | 15.4% |
...
- candidats SANS connectivite : 4917, dont T2 : 100%
...
*3896 candidats sur 8186 portent les champs bruts (48%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 219 candidats
  - AVEC connectivite (89) : resistance **42.9%**
  - SANS connectivite (130) : resistance **22.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 219 candidats
  ...
  - SANS connectivite (130) : T0=16.07 T1=0.00 T2=2.71 — pondere **5.42**
  - test de permutation : **p = 0.1284** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
