...
genere 2026-09-05 21:05 UTC — 397921 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 314577 systemes
...
- moteur actif `0caa9267db60` (354179 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 197860 | 98211 | 13472 | 6597 | 20111 | 15583 | 21004 | 20363 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 193946 | 45135 | 81828 | 78 | 27021 | 10014 | 71 | 29784 | 15.4% |
...
- candidats SANS connectivite : 30094, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21278 systemes avec CONNECTED sur 163903 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*46294 candidats sur 50584 portent les champs bruts (92%).*

- `5c556c16ea8b` — 40329 candidats
  - AVEC connectivite (16362) : resistance **41.1%**
  - SANS connectivite (23967) : resistance **21.3%**
...
- `5c556c16ea8b` — 40329 candidats
  ...
  - SANS connectivite (23967) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 161402 systemes
