...
genere 2026-09-04 15:27 UTC — 367800 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 284456 systemes
...
- moteur actif `0caa9267db60` (324058 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 182642 | 90780 | 12418 | 6102 | 18597 | 14387 | 19329 | 18690 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 179043 | 41612 | 75647 | 74 | 24876 | 9269 | 70 | 27481 | 15.3% |
...
- candidats AVEC connectivite : 18817, dont T2 : 100%
...
- **19603 systemes avec CONNECTED sur 151479 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*42318 candidats sur 46608 portent les champs bruts (91%).*

- `5c556c16ea8b` — 36353 candidats
  - AVEC connectivite (14689) : resistance **41.0%**
...
- `5c556c16ea8b` — 36353 candidats
  - AVEC connectivite (14689) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.95**
...
- TROP-CHER : 19683 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19603 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 148978 systemes
  - sans CONNECTED : 0.0% sur 33664 systemes
