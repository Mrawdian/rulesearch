...
| connect | 4 | 3 | 7157 | 3600 | 471 | 249 | 679 | 582 | 745 | 751 | 10.5% |
| ref | 4 | 3 | 6979 | 1685 | 2906 | 1 | 938 | 346 | 2 | 1101 | 15.8% |
...
- candidats SANS connectivite : 1105, dont T2 : 100%
...
- **745 systemes avec CONNECTED sur 5922 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 694 candidats
  - AVEC connectivite (275) : T0=13.24 T1=0.00 T2=2.93 — pondere **5.86**
  - SANS connectivite (419) : T0=15.80 T1=0.00 T2=2.64 — pondere **5.28**
...
- TROP-CHER : 747 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 745 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 5865 systemes
  - sans CONNECTED : 0.0% sur 1292 systemes
