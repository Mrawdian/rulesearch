...
genere 2026-08-26 18:25 UTC — 58310 systemes evalues
...
- `8f22f0d2d442` : 209 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (14568 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
**7675 enregistrements (13%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| ref | 4 | 3 | 25822 | 5936 | 10946 | 15 | 3604 | 1327 | 10 | 3984 | 15.4% |
...
- candidats SANS connectivite : 4294, dont T2 : 100%
...
*2839 candidats sur 7129 portent les champs bruts (40%).*
...
- `b71bb0907fb5` — 53 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `8f22f0d2d442` — 35 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (12) : resistance **39.4%**
  - SANS connectivite (23) : resistance **18.6%**
...
- `8f22f0d2d442` — 35 candidats
  - AVEC connectivite (12) : T0=13.75 T1=0.00 T2=2.83 — pondere **5.67**
  - SANS connectivite (23) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.30**
  - *groupes trop petits (< 20) — aucun test, aucune conclusion*
- `e8a1f930f7b9` — 28 candidats
