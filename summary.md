...
genere 2026-08-28 23:35 UTC — 161773 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 78429 systemes
...
- moteur actif `0caa9267db60` (118031 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 78620 | 39074 | 5359 | 2673 | 7861 | 6285 | 8272 | 8097 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 77038 | 17900 | 32613 | 35 | 10640 | 3933 | 31 | 11882 | 15.4% |
...
- candidats AVEC connectivite : 8224, dont T2 : 100%
- candidats SANS connectivite : 12192, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8546 systemes avec CONNECTED sur 66614 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*16126 candidats sur 20416 portent les champs bruts (79%).*

- `5c556c16ea8b` — 10161 candidats
  - AVEC connectivite (4096) : resistance **41.1%**
  - SANS connectivite (6065) : resistance **21.7%**
...
- `5c556c16ea8b` — 10161 candidats
  - AVEC connectivite (4096) : T0=13.01 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (6065) : T0=15.90 T1=0.00 T2=2.68 — pondere **5.36**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 64113 systemes
  - sans CONNECTED : 0.0% sur 14507 systemes
