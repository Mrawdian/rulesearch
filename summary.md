...
genere 2026-09-06 22:45 UTC — 422901 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 339557 systemes
...
- moteur actif `0caa9267db60` (379159 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 210475 | 104512 | 14338 | 7003 | 21347 | 16545 | 22358 | 21697 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 206311 | 47963 | 87028 | 80 | 28761 | 10660 | 73 | 31729 | 15.4% |
...
- candidats AVEC connectivite : 21824, dont T2 : 100%
- candidats SANS connectivite : 32039, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **22632 systemes avec CONNECTED sur 174264 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*49573 candidats sur 53863 portent les champs bruts (92%).*

- `5c556c16ea8b` — 43608 candidats
  - AVEC connectivite (17696) : resistance **41.1%**
  - SANS connectivite (25912) : resistance **21.3%**
...
- `5c556c16ea8b` — 43608 candidats
  - AVEC connectivite (17696) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (25912) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 22715 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 22632 avec CONNECTED, 83 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 171763 systemes
  - sans CONNECTED : 0.0% sur 38712 systemes
