...
genere 2026-08-26 09:39 UTC — 36793 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 27819 systemes
...
| d4 | 4 | 4 | 5257 | 2425 | 1335 | 28 | 371 | 344 | 251 | 374 | 7.1% |
...
- candidats AVEC connectivite : 1709, dont T2 : 100%
- candidats SANS connectivite : 2667, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1971 systemes avec CONNECTED sur 15179 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*86 candidats sur 4376 portent les champs bruts (2%).*

- `89c65c03c4ad` — 86 candidats
  - AVEC connectivite (32) : resistance **48.7%**
...
- `89c65c03c4ad` — 3211 candidats
  - AVEC connectivite (1230) : T0=13.08 T1=0.00 T2=2.95 — pondere **5.89**
...
- TROP-CHER : 1987 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 1971 avec CONNECTED, 16 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
