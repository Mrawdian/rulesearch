...
genere 2026-08-30 15:45 UTC — 223216 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 139872 systemes
...
- moteur actif `0caa9267db60` (179474 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 109669 | 54506 | 7451 | 3660 | 11060 | 8694 | 11595 | 11272 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 107432 | 25029 | 45368 | 49 | 14848 | 5550 | 43 | 16536 | 15.4% |
...
- candidats AVEC connectivite : 11399, dont T2 : 100%
- candidats SANS connectivite : 16846, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11869 systemes avec CONNECTED sur 91974 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*23955 candidats sur 28245 portent les champs bruts (85%).*

- `5c556c16ea8b` — 17990 candidats
  - AVEC connectivite (7271) : resistance **41.0%**
  - SANS connectivite (10719) : resistance **21.5%**
...
- `5c556c16ea8b` — 17990 candidats
  - AVEC connectivite (7271) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.97**
  - SANS connectivite (10719) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 89473 systemes
  - sans CONNECTED : 0.0% sur 20196 systemes
