...
genere 2026-09-05 23:59 UTC — 400836 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 317492 systemes
...
- moteur actif `0caa9267db60` (357094 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 199337 | 98961 | 13579 | 6644 | 20243 | 15694 | 21154 | 20524 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 195384 | 45454 | 82428 | 78 | 27227 | 10090 | 72 | 30018 | 15.4% |
...
- candidats AVEC connectivite : 20651, dont T2 : 100%
- candidats SANS connectivite : 30328, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21428 systemes avec CONNECTED sur 165131 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*46689 candidats sur 50979 portent les champs bruts (92%).*

- `5c556c16ea8b` — 40724 candidats
  - AVEC connectivite (16523) : resistance **41.0%**
  - SANS connectivite (24201) : resistance **21.3%**
...
- `5c556c16ea8b` — 40724 candidats
  - AVEC connectivite (16523) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.94**
  - SANS connectivite (24201) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 21510 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21428 avec CONNECTED, 82 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 162630 systemes
  - sans CONNECTED : 0.0% sur 36707 systemes
