...
genere 2026-08-27 04:59 UTC — 81948 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 17041 systemes
...
- moteur actif `0caa9267db60` (38206 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 38318 | 19078 | 2637 | 1308 | 3812 | 3008 | 4039 | 3938 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 37515 | 8659 | 15944 | 21 | 5200 | 1953 | 20 | 5718 | 15.2% |
...
- candidats AVEC connectivite : 4065, dont T2 : 100%
- candidats SANS connectivite : 6028, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4313 systemes avec CONNECTED sur 33850 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5803 candidats sur 10093 portent les champs bruts (57%).*
...
- `ab89a63b01ef` — 2126 candidats
  - AVEC connectivite (885) : resistance **41.6%**
  - SANS connectivite (1241) : resistance **21.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 2126 candidats
  - AVEC connectivite (885) : T0=13.03 T1=0.00 T2=3.04 — pondere **6.09**
  - SANS connectivite (1241) : T0=15.96 T1=0.00 T2=2.68 — pondere **5.35**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 31349 systemes
