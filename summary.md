...
genere 2026-09-02 02:21 UTC — 299206 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 215862 systemes
...
- moteur actif `0caa9267db60` (255464 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 148021 | 73522 | 10080 | 4967 | 15021 | 11647 | 15673 | 15209 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 145070 | 33738 | 61389 | 61 | 20083 | 7499 | 63 | 22225 | 15.3% |
...
- candidats AVEC connectivite : 15336, dont T2 : 100%
- candidats SANS connectivite : 22535, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15947 systemes avec CONNECTED sur 123344 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*33581 candidats sur 37871 portent les champs bruts (89%).*

- `5c556c16ea8b` — 27616 candidats
  - AVEC connectivite (11208) : resistance **41.0%**
  - SANS connectivite (16408) : resistance **21.3%**
...
- `5c556c16ea8b` — 27616 candidats
  - AVEC connectivite (11208) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (16408) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 120843 systemes
  - sans CONNECTED : 0.0% sur 27178 systemes
