...
genere 2026-08-29 23:33 UTC — 199685 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 116341 systemes
...
- moteur actif `0caa9267db60` (155943 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 97772 | 48561 | 6648 | 3281 | 9861 | 7783 | 10306 | 10076 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 95798 | 22355 | 40447 | 44 | 13239 | 4929 | 37 | 14741 | 15.4% |
...
- candidats AVEC connectivite : 10203, dont T2 : 100%
...
- **10580 systemes avec CONNECTED sur 82246 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*20964 candidats sur 25254 portent les champs bruts (83%).*

- `5c556c16ea8b` — 14999 candidats
  - AVEC connectivite (6075) : resistance **41.1%**
...
- `5c556c16ea8b` — 14999 candidats
  - AVEC connectivite (6075) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
...
- TROP-CHER : 10627 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10580 avec CONNECTED, 47 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 79745 systemes
  - sans CONNECTED : 0.0% sur 18027 systemes
