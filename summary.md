...
**7466 enregistrements (77%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 4870 | 2443 | 303 | 170 | 475 | 396 | 512 | 514 | 10.6% |
| ref | 4 | 3 | 4765 | 1158 | 2004 | 1 | 623 | 230 | 2 | 747 | 15.7% |
...
- candidats AVEC connectivite : 517, dont T2 : 100%
- candidats SANS connectivite : 751, dont T2 : 100%
...
- **512 systemes avec CONNECTED sur 4045 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 103 candidats
  - AVEC connectivite (38) : T0=12.50 T1=0.00 T2=3.08 — pondere **6.16**
  - SANS connectivite (65) : T0=15.86 T1=0.00 T2=2.71 — pondere **5.42**
...
- TROP-CHER : 514 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 512 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 3988 systemes
  - sans CONNECTED : 0.0% sur 882 systemes
