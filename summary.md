...
genere 2026-08-29 22:31 UTC — 198092 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 114748 systemes
...
- moteur actif `0caa9267db60` (154350 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 96966 | 48147 | 6592 | 3262 | 9781 | 7718 | 10224 | 9997 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 95011 | 22169 | 40121 | 44 | 13150 | 4885 | 37 | 14599 | 15.4% |
...
- candidats AVEC connectivite : 10124, dont T2 : 100%
- candidats SANS connectivite : 14909, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10498 systemes avec CONNECTED sur 81588 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*20743 candidats sur 25033 portent les champs bruts (83%).*

- `5c556c16ea8b` — 14778 candidats
  - AVEC connectivite (5996) : resistance **41.2%**
  - SANS connectivite (8782) : resistance **21.5%**
...
- `5c556c16ea8b` — 14778 candidats
  - AVEC connectivite (5996) : T0=13.00 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (8782) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.32**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 79087 systemes
  - sans CONNECTED : 0.0% sur 17879 systemes
