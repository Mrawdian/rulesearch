...
| connect | 4 | 3 | 4974 | 2493 | 314 | 177 | 483 | 405 | 522 | 522 | 10.5% |
...
- candidats AVEC connectivite : 525, dont T2 : 100%
...
- **522 systemes avec CONNECTED sur 4126 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 123 candidats
  - AVEC connectivite (46) : T0=12.59 T1=0.00 T2=3.00 — pondere **6.00**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 4069 systemes
  - sans CONNECTED : 0.0% sur 905 systemes
