...
- `89c65c03c4ad` — 305 candidats
  - AVEC connectivite (111) : T0=13.14 T1=0.00 T2=2.74 — pondere **5.48**
  - SANS connectivite (194) : T0=16.02 T1=0.00 T2=2.61 — pondere **5.23**
  - test de permutation : **p = 0.4843** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
