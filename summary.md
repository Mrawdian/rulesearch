...
genere 2026-08-26 19:54 UTC — 61706 systemes evalues
...
- moteur actif `0caa9267db60` (17964 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 28093 | 13996 | 1920 | 947 | 2783 | 2221 | 2990 | 2884 | 10.3% |
...
- candidats AVEC connectivite : 3011, dont T2 : 100%
- candidats SANS connectivite : 4543, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3264 systemes avec CONNECTED sur 25496 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3264 candidats sur 7554 portent les champs bruts (43%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 395 candidats
  - AVEC connectivite (167) : resistance **39.5%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 395 candidats
  - AVEC connectivite (167) : T0=12.95 T1=0.00 T2=2.86 — pondere **5.72**
  - SANS connectivite (228) : T0=16.08 T1=0.00 T2=2.58 — pondere **5.17**
  - test de permutation : **p = 0.0715** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- TROP-CHER : 3286 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3264 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22995 systemes
  - sans CONNECTED : 0.0% sur 5098 systemes
