...
genere 2026-08-30 08:32 UTC — 212673 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 129329 systemes
...
- moteur actif `0caa9267db60` (168931 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 104344 | 51810 | 7098 | 3482 | 10524 | 8303 | 11048 | 10719 | 10.3% |
...
- candidats AVEC connectivite : 10846, dont T2 : 100%
...
- **11322 systemes avec CONNECTED sur 87611 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*22587 candidats sur 26877 portent les champs bruts (84%).*

- `5c556c16ea8b` — 16622 candidats
  - AVEC connectivite (6718) : resistance **41.1%**
...
- `5c556c16ea8b` — 16622 candidats
  - AVEC connectivite (6718) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
...
- TROP-CHER : 11373 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11322 avec CONNECTED, 51 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 85110 systemes
  - sans CONNECTED : 0.0% sur 19234 systemes
