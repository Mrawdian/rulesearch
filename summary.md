...
genere 2026-08-28 01:32 UTC — 123070 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 39726 systemes
...
- moteur actif `0caa9267db60` (79328 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 59081 | 29420 | 4082 | 1998 | 5876 | 4681 | 6204 | 6060 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 57874 | 13365 | 24555 | 28 | 8038 | 2996 | 26 | 8864 | 15.3% |
...
- candidats AVEC connectivite : 6187, dont T2 : 100%
- candidats SANS connectivite : 9174, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6478 systemes avec CONNECTED sur 50731 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11071 candidats sur 15361 portent les champs bruts (72%).*

- `5c556c16ea8b` — 5106 candidats
  - AVEC connectivite (2059) : resistance **41.9%**
  - SANS connectivite (3047) : resistance **22.3%**
...
- `5c556c16ea8b` — 5106 candidats
  - AVEC connectivite (2059) : T0=12.99 T1=0.00 T2=3.05 — pondere **6.10**
  - SANS connectivite (3047) : T0=15.84 T1=0.00 T2=2.71 — pondere **5.42**
...
- TROP-CHER : 6514 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6478 avec CONNECTED, 36 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 48230 systemes
