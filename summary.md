...
genere 2026-08-28 00:23 UTC — 120700 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 37356 systemes
...
- moteur actif `0caa9267db60` (76958 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 57869 | 28819 | 4008 | 1956 | 5746 | 4579 | 6100 | 5921 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 56716 | 13091 | 24065 | 28 | 7888 | 2930 | 25 | 8687 | 15.3% |
...
- candidats SANS connectivite : 8997, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6374 systemes avec CONNECTED sur 49764 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10755 candidats sur 15045 portent les champs bruts (71%).*

- `5c556c16ea8b` — 4790 candidats
  - AVEC connectivite (1920) : resistance **42.0%**
  - SANS connectivite (2870) : resistance **22.5%**
...
- `5c556c16ea8b` — 4790 candidats
  ...
  - SANS connectivite (2870) : T0=15.81 T1=0.00 T2=2.72 — pondere **5.43**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 47263 systemes
  - sans CONNECTED : 0.0% sur 10606 systemes
