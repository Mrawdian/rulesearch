...
genere 2026-09-01 20:05 UTC — 291713 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 208369 systemes
...
- moteur actif `0caa9267db60` (247971 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 144246 | 71651 | 9797 | 4829 | 14644 | 11368 | 15257 | 14836 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 141352 | 32859 | 59790 | 59 | 19592 | 7308 | 63 | 21670 | 15.3% |
...
- candidats AVEC connectivite : 14963, dont T2 : 100%
- candidats SANS connectivite : 21980, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15531 systemes avec CONNECTED sur 120216 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*32653 candidats sur 36943 portent les champs bruts (88%).*

- `5c556c16ea8b` — 26688 candidats
  - AVEC connectivite (10835) : resistance **41.0%**
  - SANS connectivite (15853) : resistance **21.4%**
...
- `5c556c16ea8b` — 26688 candidats
  - AVEC connectivite (10835) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (15853) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 15604 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15531 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 117715 systemes
  - sans CONNECTED : 0.0% sur 26531 systemes
