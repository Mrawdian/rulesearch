...
genere 2026-08-27 05:40 UTC — 83374 systemes evalues
...
- moteur actif `0caa9267db60` (39632 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 39034 | 19437 | 2682 | 1336 | 3877 | 3075 | 4118 | 4004 | 10.3% |
...
- candidats AVEC connectivite : 4131, dont T2 : 100%
- candidats SANS connectivite : 6128, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4392 systemes avec CONNECTED sur 34430 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5969 candidats sur 10259 portent les champs bruts (58%).*
...
- TROP-CHER : 4423 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4392 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 31929 systemes
  - sans CONNECTED : 0.0% sur 7105 systemes
