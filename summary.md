...
- moteur actif `0caa9267db60` (48765 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 43648 | 21756 | 2993 | 1476 | 4354 | 3438 | 4594 | 4471 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 42744 | 9852 | 18140 | 25 | 5939 | 2234 | 22 | 6531 | 15.3% |
...
- candidats AVEC connectivite : 4598, dont T2 : 100%
- candidats SANS connectivite : 6841, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4868 systemes avec CONNECTED sur 38171 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*7149 candidats sur 11439 portent les champs bruts (62%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 1184 candidats
  - AVEC connectivite (470) : resistance **41.5%**
  - SANS connectivite (714) : resistance **21.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 1184 candidats
  - AVEC connectivite (470) : T0=12.99 T1=0.00 T2=3.01 — pondere **6.03**
  - SANS connectivite (714) : T0=15.82 T1=0.00 T2=2.64 — pondere **5.28**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
...
- TROP-CHER : 4900 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4868 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 35670 systemes
  - sans CONNECTED : 0.0% sur 7978 systemes
