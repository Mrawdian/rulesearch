...
genere 2026-08-26 19:57 UTC — 61824 systemes evalues
...
- moteur actif `0caa9267db60` (18082 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 28153 | 14022 | 1925 | 947 | 2789 | 2230 | 2996 | 2891 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 27556 | 6365 | 11675 | 15 | 3827 | 1420 | 12 | 4242 | 15.4% |
...
- candidats AVEC connectivite : 3018, dont T2 : 100%
- candidats SANS connectivite : 4552, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3270 systemes avec CONNECTED sur 25539 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3280 candidats sur 7570 portent les champs bruts (43%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 411 candidats
  - AVEC connectivite (174) : resistance **39.2%**
  - SANS connectivite (237) : resistance **19.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 411 candidats
  - AVEC connectivite (174) : T0=12.89 T1=0.00 T2=2.82 — pondere **5.64**
  - SANS connectivite (237) : T0=16.06 T1=0.00 T2=2.57 — pondere **5.15**
  - test de permutation : **p = 0.1099** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- TROP-CHER : 3292 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3270 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23038 systemes
  - sans CONNECTED : 0.0% sur 5115 systemes
