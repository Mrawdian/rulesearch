...
genere 2026-08-26 21:42 UTC — 65735 systemes evalues
...
- moteur actif `0caa9267db60` (21993 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 29492 | 6800 | 12532 | 16 | 4086 | 1522 | 12 | 4524 | 15.3% |
...
- candidats SANS connectivite : 4834, dont T2 : 100%
...
*3766 candidats sur 8056 portent les champs bruts (47%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 89 candidats
  - AVEC connectivite (42) : resistance **43.6%**
  - SANS connectivite (47) : resistance **22.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 89 candidats
  ...
  - SANS connectivite (47) : T0=16.17 T1=0.00 T2=3.00 — pondere **6.00**
  - test de permutation : **p = 0.7446** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e80bc1b2b437` — 75 candidats
