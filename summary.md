...
genere 2026-08-25 21:51 UTC — 6814 systemes evalues

## versions du DSL presentes
- `615abe43d6bc` : 5837 systemes
...
| connect | 4 | 3 | 3388 | 1707 | 219 | 118 | 331 | 263 | 344 | 363 | 10.7% |
...
- candidats AVEC connectivite : 366, dont T2 : 100%
- candidats SANS connectivite : 523, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **344 systemes avec CONNECTED sur 2832 (12.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- TROP-CHER : 345 systemes abandonnes (5.1% des systemes), 96% du temps total
  dont 344 avec CONNECTED, 1 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.4% sur 2775 systemes
  - sans CONNECTED : 0.0% sur 613 systemes
