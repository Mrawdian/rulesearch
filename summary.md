...
genere 2026-09-07 13:57 UTC — 437095 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 353751 systemes
...
- moteur actif `0caa9267db60` (393353 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 217661 | 108136 | 14836 | 7242 | 22036 | 17073 | 23146 | 22430 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 213319 | 49690 | 89910 | 83 | 29730 | 11014 | 77 | 32797 | 15.4% |
...
- candidats SANS connectivite : 33107, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23420 systemes avec CONNECTED sur 180194 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*51374 candidats sur 55664 portent les champs bruts (92%).*

- `5c556c16ea8b` — 45409 candidats
  - AVEC connectivite (18429) : resistance **41.1%**
  - SANS connectivite (26980) : resistance **21.3%**
...
- `5c556c16ea8b` — 45409 candidats
  ...
  - SANS connectivite (26980) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 23507 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23420 avec CONNECTED, 87 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 177693 systemes
