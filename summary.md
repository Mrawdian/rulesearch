...
genere 2026-08-27 08:25 UTC — 89218 systemes evalues
...
- moteur actif `0caa9267db60` (45476 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 41988 | 20911 | 2885 | 1420 | 4190 | 3302 | 4421 | 4314 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 41115 | 9473 | 17480 | 23 | 5698 | 2141 | 22 | 6278 | 15.3% |
...
- candidats AVEC connectivite : 4441, dont T2 : 100%
- candidats SANS connectivite : 6588, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4695 systemes avec CONNECTED sur 36814 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6739 candidats sur 11029 portent les champs bruts (61%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 774 candidats
  - AVEC connectivite (313) : resistance **41.4%**
  - SANS connectivite (461) : resistance **21.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 774 candidats
  - AVEC connectivite (313) : T0=13.08 T1=0.00 T2=3.02 — pondere **6.04**
  - SANS connectivite (461) : T0=15.90 T1=0.00 T2=2.63 — pondere **5.27**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e3baecf8377b` — 657 candidats
...
- TROP-CHER : 4727 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4695 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 34313 systemes
