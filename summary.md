...
genere 2026-08-28 02:35 UTC — 125198 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 41854 systemes
...
- moteur actif `0caa9267db60` (81456 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 60153 | 29959 | 4155 | 2032 | 5987 | 4775 | 6298 | 6175 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 58930 | 13635 | 24966 | 28 | 8199 | 3052 | 26 | 9022 | 15.3% |
...
- candidats AVEC connectivite : 6302, dont T2 : 100%
- candidats SANS connectivite : 9332, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6572 systemes avec CONNECTED sur 51592 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11344 candidats sur 15634 portent les champs bruts (73%).*

- `5c556c16ea8b` — 5379 candidats
  - AVEC connectivite (2174) : resistance **41.8%**
  - SANS connectivite (3205) : resistance **22.2%**
...
- `5c556c16ea8b` — 5379 candidats
  - AVEC connectivite (2174) : T0=12.99 T1=0.00 T2=3.04 — pondere **6.07**
  - SANS connectivite (3205) : T0=15.85 T1=0.00 T2=2.71 — pondere **5.41**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 49091 systemes
  - sans CONNECTED : 0.0% sur 11062 systemes
