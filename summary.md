...
genere 2026-09-05 17:52 UTC — 394763 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 311419 systemes
...
- moteur actif `0caa9267db60` (351021 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 196261 | 97448 | 13357 | 6544 | 19951 | 15446 | 20820 | 20200 | 10.3% |
...
- candidats AVEC connectivite : 20327, dont T2 : 100%
...
- **21094 systemes avec CONNECTED sur 162616 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*45886 candidats sur 50176 portent les champs bruts (91%).*

- `5c556c16ea8b` — 39921 candidats
  - AVEC connectivite (16199) : resistance **41.1%**
...
- `5c556c16ea8b` — 39921 candidats
  - AVEC connectivite (16199) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
...
- TROP-CHER : 21175 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21094 avec CONNECTED, 81 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 160115 systemes
  - sans CONNECTED : 0.0% sur 36146 systemes
