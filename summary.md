...
genere 2026-08-26 10:39 UTC — 39261 systemes evalues
...
- `e3baecf8377b` : 668 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
**8134 enregistrements (21%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 16752 | 8363 | 1078 | 579 | 1665 | 1335 | 1831 | 1690 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 16394 | 3857 | 6943 | 11 | 2237 | 827 | 7 | 2512 | 15.3% |
...
- candidats AVEC connectivite : 1817, dont T2 : 100%
- candidats SANS connectivite : 2822, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2105 systemes avec CONNECTED sur 16191 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*349 candidats sur 4639 portent les champs bruts (8%).*
...
- `e3baecf8377b` — 85 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (34) : resistance **37.2%**
...
- `e3baecf8377b` — 85 candidats
  - AVEC connectivite (34) : T0=13.71 T1=0.00 T2=2.76 — pondere **5.53**
  - SANS connectivite (51) : T0=15.90 T1=0.00 T2=2.41 — pondere **4.82**
  - test de permutation : **p = 0.2994** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.4% sur 13690 systemes
  - sans CONNECTED : 0.0% sur 3062 systemes
