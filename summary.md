...
genere 2026-08-30 13:53 UTC — 220509 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 137165 systemes
...
- moteur actif `0caa9267db60` (176767 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 108296 | 53809 | 7356 | 3613 | 10911 | 8600 | 11459 | 11133 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 106098 | 24743 | 44801 | 49 | 14661 | 5485 | 41 | 16309 | 15.4% |
...
- candidats AVEC connectivite : 11260, dont T2 : 100%
- candidats SANS connectivite : 16619, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11733 systemes avec CONNECTED sur 90851 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*23589 candidats sur 27879 portent les champs bruts (85%).*

- `5c556c16ea8b` — 17624 candidats
  - AVEC connectivite (7132) : resistance **41.1%**
  - SANS connectivite (10492) : resistance **21.5%**
...
- `5c556c16ea8b` — 17624 candidats
  - AVEC connectivite (7132) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (10492) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 11784 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11733 avec CONNECTED, 51 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 88350 systemes
  - sans CONNECTED : 0.0% sur 19946 systemes
