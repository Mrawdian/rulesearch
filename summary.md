...
genere 2026-08-27 01:16 UTC — 73486 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 9167 systemes
- `ab89a63b01ef` : 8579 systemes
...
- moteur actif `0caa9267db60` (29744 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 33324 | 7684 | 14157 | 20 | 4630 | 1738 | 17 | 5078 | 15.2% |
...
- candidats SANS connectivite : 5388, dont T2 : 100%
...
*4697 candidats sur 8987 portent les champs bruts (52%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 1020 candidats
  - AVEC connectivite (419) : resistance **41.0%**
  - SANS connectivite (601) : resistance **21.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1020 candidats
  ...
  - SANS connectivite (601) : T0=15.89 T1=0.00 T2=2.65 — pondere **5.29**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
