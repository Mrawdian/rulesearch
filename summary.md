...
genere 2026-08-26 10:31 UTC — 38962 systemes evalues
...
- `e3baecf8377b` : 369 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
**7835 enregistrements (20%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 16602 | 8288 | 1071 | 570 | 1648 | 1324 | 1812 | 1679 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 16245 | 3818 | 6885 | 11 | 2218 | 817 | 7 | 2489 | 15.3% |
...
- candidats AVEC connectivite : 1806, dont T2 : 100%
- candidats SANS connectivite : 2799, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2086 systemes avec CONNECTED sur 16073 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*315 candidats sur 4605 portent les champs bruts (7%).*
...
- `e3baecf8377b` — 51 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (23) : resistance **36.6%**
  - SANS connectivite (28) : resistance **16.1%**
...
- `e3baecf8377b` — 51 candidats
  - AVEC connectivite (23) : T0=13.91 T1=0.00 T2=2.87 — pondere **5.74**
  - SANS connectivite (28) : T0=15.89 T1=0.00 T2=2.14 — pondere **4.29**
...
- TROP-CHER : 2103 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2086 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.4% sur 13572 systemes
  - sans CONNECTED : 0.0% sur 3030 systemes
