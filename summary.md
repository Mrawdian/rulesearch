...
genere 2026-08-31 13:40 UTC — 253339 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 169995 systemes
...
- moteur actif `0caa9267db60` (209597 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 124873 | 62092 | 8457 | 4185 | 12612 | 9856 | 13186 | 12850 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 122351 | 28545 | 51651 | 54 | 16942 | 6321 | 56 | 18772 | 15.3% |
...
- candidats AVEC connectivite : 12977, dont T2 : 100%
- candidats SANS connectivite : 19082, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13460 systemes avec CONNECTED sur 104399 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*27769 candidats sur 32059 portent les champs bruts (87%).*

- `5c556c16ea8b` — 21804 candidats
  - AVEC connectivite (8849) : resistance **41.0%**
  - SANS connectivite (12955) : resistance **21.4%**
...
- `5c556c16ea8b` — 21804 candidats
  - AVEC connectivite (8849) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (12955) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.32**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 101898 systemes
  - sans CONNECTED : 0.0% sur 22975 systemes
