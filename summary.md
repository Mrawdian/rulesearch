...
genere 2026-08-26 15:01 UTC — 50257 systemes evalues
...
- moteur actif `0caa9267db60` (6515 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22310 | 11121 | 1499 | 764 | 2221 | 1769 | 2386 | 2270 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 21832 | 5069 | 9206 | 13 | 3050 | 1120 | 10 | 3364 | 15.4% |
...
- candidats AVEC connectivite : 2397, dont T2 : 100%
- candidats SANS connectivite : 3674, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2660 systemes avec CONNECTED sur 20714 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1781 candidats sur 6071 portent les champs bruts (29%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 666 candidats
  - AVEC connectivite (259) : resistance **41.1%**
  - SANS connectivite (407) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 666 candidats
  - AVEC connectivite (259) : T0=13.33 T1=0.00 T2=3.02 — pondere **6.05**
  - SANS connectivite (407) : T0=16.02 T1=0.00 T2=2.65 — pondere **5.31**
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0030).
...
- TROP-CHER : 2680 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2660 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18213 systemes
  - sans CONNECTED : 0.0% sur 4097 systemes
