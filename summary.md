...
genere 2026-08-26 14:13 UTC — 48420 systemes evalues
...
- moteur actif `0caa9267db60` (4678 systemes) : `06fe04a859f1`, `e40600351a72`
...
**7466 enregistrements (15%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 21381 | 10667 | 1423 | 737 | 2113 | 1699 | 2286 | 2186 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20924 | 4878 | 8830 | 13 | 2901 | 1082 | 7 | 3213 | 15.4% |
...
- candidats AVEC connectivite : 2313, dont T2 : 100%
- candidats SANS connectivite : 3523, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2560 systemes avec CONNECTED sur 19974 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1546 candidats sur 5836 portent les champs bruts (26%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 431 candidats
  - AVEC connectivite (175) : resistance **40.1%**
  - SANS connectivite (256) : resistance **20.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 431 candidats
  - AVEC connectivite (175) : T0=13.43 T1=0.00 T2=2.98 — pondere **5.97**
  - SANS connectivite (256) : T0=16.09 T1=0.00 T2=2.63 — pondere **5.26**
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0245).
...
## cout
- temps total 15.0 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2577 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2560 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17473 systemes
  - sans CONNECTED : 0.0% sur 3908 systemes
