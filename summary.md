...
genere 2026-08-29 16:25 UTC — 188869 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 105525 systemes
...
- moteur actif `0caa9267db60` (145127 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 92301 | 45887 | 6278 | 3104 | 9298 | 7341 | 9711 | 9502 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 90453 | 21133 | 38173 | 43 | 12516 | 4639 | 36 | 13907 | 15.4% |
...
- candidats AVEC connectivite : 9629, dont T2 : 100%
- candidats SANS connectivite : 14217, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9985 systemes avec CONNECTED sur 77797 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*19556 candidats sur 23846 portent les champs bruts (82%).*

- `5c556c16ea8b` — 13591 candidats
  - AVEC connectivite (5501) : resistance **41.2%**
  - SANS connectivite (8090) : resistance **21.5%**
...
- `5c556c16ea8b` — 13591 candidats
  - AVEC connectivite (5501) : T0=12.99 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (8090) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.34**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 75296 systemes
  - sans CONNECTED : 0.0% sur 17005 systemes
