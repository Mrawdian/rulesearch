...
genere 2026-08-29 02:16 UTC — 166410 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 83066 systemes
...
- moteur actif `0caa9267db60` (122668 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 80971 | 40286 | 5506 | 2749 | 8120 | 6434 | 8494 | 8351 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 79324 | 18442 | 33580 | 36 | 10969 | 4037 | 33 | 12222 | 15.4% |
...
- candidats AVEC connectivite : 8478, dont T2 : 100%
- candidats SANS connectivite : 12532, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8768 systemes avec CONNECTED sur 68567 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*16720 candidats sur 21010 portent les champs bruts (80%).*

- `5c556c16ea8b` — 10755 candidats
  - AVEC connectivite (4350) : resistance **41.1%**
  - SANS connectivite (6405) : resistance **21.7%**
...
- `5c556c16ea8b` — 10755 candidats
  - AVEC connectivite (4350) : T0=13.01 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (6405) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.34**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 66066 systemes
  - sans CONNECTED : 0.0% sur 14905 systemes
