...
genere 2026-09-05 21:49 UTC — 398615 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 315271 systemes
...
- moteur actif `0caa9267db60` (354873 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 198218 | 98410 | 13494 | 6608 | 20141 | 15604 | 21046 | 20393 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 194282 | 45219 | 81962 | 78 | 27064 | 10035 | 72 | 29836 | 15.4% |
...
- candidats SANS connectivite : 30146, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21320 systemes avec CONNECTED sur 164206 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*46376 candidats sur 50666 portent les champs bruts (92%).*

- `5c556c16ea8b` — 40411 candidats
  - AVEC connectivite (16392) : resistance **41.1%**
  - SANS connectivite (24019) : resistance **21.3%**
...
- `5c556c16ea8b` — 40411 candidats
  ...
  - SANS connectivite (24019) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 21402 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21320 avec CONNECTED, 82 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 161705 systemes
  - sans CONNECTED : 0.0% sur 36513 systemes
