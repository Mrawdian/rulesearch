...
genere 2026-08-31 07:31 UTC — 245031 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 161687 systemes
...
- moteur actif `0caa9267db60` (201289 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 120679 | 60035 | 8191 | 4049 | 12127 | 9518 | 12763 | 12429 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 118237 | 27592 | 49951 | 53 | 16341 | 6102 | 53 | 18135 | 15.3% |
...
- candidats SANS connectivite : 18445, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13037 systemes avec CONNECTED sur 101041 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*26711 candidats sur 31001 portent les champs bruts (86%).*

- `5c556c16ea8b` — 20746 candidats
  - AVEC connectivite (8428) : resistance **40.9%**
  - SANS connectivite (12318) : resistance **21.4%**
...
- `5c556c16ea8b` — 20746 candidats
  ...
  - SANS connectivite (12318) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 13100 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13037 avec CONNECTED, 63 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 98540 systemes
  - sans CONNECTED : 0.0% sur 22139 systemes
