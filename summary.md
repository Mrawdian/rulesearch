...
genere 2026-09-08 22:47 UTC — 466764 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 383420 systemes
...
- moteur actif `0caa9267db60` (423022 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 232634 | 115562 | 15839 | 7791 | 23533 | 18220 | 24779 | 23958 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 228015 | 53108 | 96079 | 92 | 31763 | 11781 | 81 | 35092 | 15.4% |
...
- candidats AVEC connectivite : 24085, dont T2 : 100%
- candidats SANS connectivite : 35402, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25053 systemes avec CONNECTED sur 192467 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55197 candidats sur 59487 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49232 candidats
  - AVEC connectivite (19957) : resistance **41.2%**
  - SANS connectivite (29275) : resistance **21.3%**
...
- `5c556c16ea8b` — 49232 candidats
  - AVEC connectivite (19957) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (29275) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 25144 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25053 avec CONNECTED, 91 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 189966 systemes
  - sans CONNECTED : 0.0% sur 42668 systemes
