...
genere 2026-09-05 16:23 UTC — 393239 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 309895 systemes
...
- moteur actif `0caa9267db60` (349497 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 195498 | 97081 | 13307 | 6518 | 19885 | 15382 | 20744 | 20096 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 191626 | 44622 | 80847 | 78 | 26680 | 9905 | 71 | 29409 | 15.3% |
...
- candidats AVEC connectivite : 20223, dont T2 : 100%
- candidats SANS connectivite : 29719, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21018 systemes avec CONNECTED sur 161976 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*45652 candidats sur 49942 portent les champs bruts (91%).*

- `5c556c16ea8b` — 39687 candidats
  - AVEC connectivite (16095) : resistance **41.1%**
  - SANS connectivite (23592) : resistance **21.3%**
...
- `5c556c16ea8b` — 39687 candidats
  - AVEC connectivite (16095) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (23592) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 21099 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21018 avec CONNECTED, 81 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 159475 systemes
  - sans CONNECTED : 0.0% sur 36023 systemes
