...
genere 2026-08-31 03:22 UTC — 239236 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 155892 systemes
...
- moteur actif `0caa9267db60` (195494 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 117761 | 58590 | 7996 | 3952 | 11825 | 9281 | 12478 | 12101 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 115360 | 26918 | 48765 | 53 | 15911 | 5960 | 52 | 17691 | 15.3% |
...
- candidats AVEC connectivite : 12228, dont T2 : 100%
- candidats SANS connectivite : 18001, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12752 systemes avec CONNECTED sur 98677 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*25939 candidats sur 30229 portent les champs bruts (86%).*

- `5c556c16ea8b` — 19974 candidats
  - AVEC connectivite (8100) : resistance **41.0%**
  - SANS connectivite (11874) : resistance **21.4%**
...
- `5c556c16ea8b` — 19974 candidats
  - AVEC connectivite (8100) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.97**
  - SANS connectivite (11874) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
## cout
- temps total 74.3 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 12814 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 12752 avec CONNECTED, 62 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 96176 systemes
  - sans CONNECTED : 0.0% sur 21585 systemes
