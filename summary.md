...
genere 2026-08-29 23:32 UTC — 199640 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 116296 systemes
...
- moteur actif `0caa9267db60` (155898 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 97757 | 48553 | 6648 | 3281 | 9859 | 7782 | 10304 | 10074 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 95768 | 22348 | 40433 | 44 | 13238 | 4928 | 37 | 14734 | 15.4% |
...
- candidats AVEC connectivite : 10201, dont T2 : 100%
- candidats SANS connectivite : 15044, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10578 systemes avec CONNECTED sur 82232 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*20955 candidats sur 25245 portent les champs bruts (83%).*

- `5c556c16ea8b` — 14990 candidats
  - AVEC connectivite (6073) : resistance **41.1%**
  - SANS connectivite (8917) : resistance **21.5%**
...
- `5c556c16ea8b` — 14990 candidats
  - AVEC connectivite (6073) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (8917) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
## cout
- temps total 61.6 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 10625 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10578 avec CONNECTED, 47 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 79731 systemes
  - sans CONNECTED : 0.0% sur 18026 systemes
