...
genere 2026-09-04 08:27 UTC — 360220 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 276876 systemes
...
- moteur actif `0caa9267db60` (316478 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 178819 | 88871 | 12151 | 5980 | 18193 | 14090 | 18947 | 18310 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 175286 | 40726 | 74050 | 71 | 24331 | 9091 | 70 | 26933 | 15.4% |
...
- candidats AVEC connectivite : 18437, dont T2 : 100%
- candidats SANS connectivite : 27243, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19221 systemes avec CONNECTED sur 148404 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*41390 candidats sur 45680 portent les champs bruts (91%).*

- `5c556c16ea8b` — 35425 candidats
  - AVEC connectivite (14309) : resistance **41.1%**
  - SANS connectivite (21116) : resistance **21.3%**
...
- `5c556c16ea8b` — 35425 candidats
  - AVEC connectivite (14309) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (21116) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 19301 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19221 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 145903 systemes
  - sans CONNECTED : 0.0% sur 32916 systemes
