...
genere 2026-08-26 17:26 UTC — 55960 systemes evalues
...
- moteur actif `0caa9267db60` (12218 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
| ref | 4 | 3 | 24654 | 5703 | 10429 | 14 | 3445 | 1253 | 10 | 3800 | 15.4% |
...
- candidats SANS connectivite : 4110, dont T2 : 100%
...
*2522 candidats sur 6812 portent les champs bruts (37%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 212 candidats
  - AVEC connectivite (88) : resistance **44.3%**
  - SANS connectivite (124) : resistance **20.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `23303c299f39` — 212 candidats
  ...
  - SANS connectivite (124) : T0=16.20 T1=0.00 T2=2.57 — pondere **5.15**
...
**4 serie(s) reproductible(s) sur 7 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0025).
