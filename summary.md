...
genere 2026-09-05 05:11 UTC — 381885 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 298541 systemes
...
- moteur actif `0caa9267db60` (338143 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 189763 | 94235 | 12921 | 6337 | 19301 | 14950 | 20124 | 19465 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 186007 | 43292 | 78555 | 77 | 25828 | 9628 | 70 | 28543 | 15.3% |
...
- candidats AVEC connectivite : 19592, dont T2 : 100%
- candidats SANS connectivite : 28853, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20398 systemes avec CONNECTED sur 157301 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*44155 candidats sur 48445 portent les champs bruts (91%).*

- `5c556c16ea8b` — 38190 candidats
  - AVEC connectivite (15464) : resistance **41.1%**
  - SANS connectivite (22726) : resistance **21.2%**
...
- `5c556c16ea8b` — 38190 candidats
  - AVEC connectivite (15464) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (22726) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 154800 systemes
  - sans CONNECTED : 0.0% sur 34963 systemes
