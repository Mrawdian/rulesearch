...
- moteur actif `0caa9267db60` (8095 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23102 | 11513 | 1560 | 785 | 2301 | 1839 | 2469 | 2345 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 22620 | 5235 | 9546 | 14 | 3170 | 1154 | 10 | 3491 | 15.4% |
...
- candidats AVEC connectivite : 2472, dont T2 : 100%
- candidats SANS connectivite : 3801, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2743 systemes avec CONNECTED sur 21356 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1983 candidats sur 6273 portent les champs bruts (32%).*
...
- `06fe04a859f1` — 868 candidats
  - AVEC connectivite (334) : resistance **41.1%**
  - SANS connectivite (534) : resistance **21.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 868 candidats
  - AVEC connectivite (334) : T0=13.26 T1=0.00 T2=3.02 — pondere **6.05**
  - SANS connectivite (534) : T0=16.03 T1=0.00 T2=2.65 — pondere **5.29**
...
- TROP-CHER : 2763 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2743 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18855 systemes
  - sans CONNECTED : 0.0% sur 4247 systemes
