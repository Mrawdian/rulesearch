...
genere 2026-08-31 14:34 UTC — 254584 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 171240 systemes
...
- moteur actif `0caa9267db60` (210842 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 125502 | 62381 | 8497 | 4211 | 12677 | 9925 | 13243 | 12920 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 122967 | 28677 | 51907 | 54 | 17031 | 6357 | 56 | 18875 | 15.3% |
...
- candidats AVEC connectivite : 13047, dont T2 : 100%
- candidats SANS connectivite : 19185, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13517 systemes avec CONNECTED sur 104903 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*27942 candidats sur 32232 portent les champs bruts (87%).*

- `5c556c16ea8b` — 21977 candidats
  - AVEC connectivite (8919) : resistance **41.0%**
  - SANS connectivite (13058) : resistance **21.4%**
...
- `5c556c16ea8b` — 21977 candidats
  - AVEC connectivite (8919) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.97**
  - SANS connectivite (13058) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 102402 systemes
  - sans CONNECTED : 0.0% sur 23100 systemes
