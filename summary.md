...
genere 2026-08-27 12:06 UTC — 96670 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 18378 systemes
- `5c556c16ea8b` : 13326 systemes
...
- moteur actif `0caa9267db60` (52928 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 45752 | 22811 | 3137 | 1552 | 4564 | 3606 | 4824 | 4668 | 10.2% |
...
- candidats AVEC connectivite : 4795, dont T2 : 100%
- candidats SANS connectivite : 7162, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5098 systemes avec CONNECTED sur 39888 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*7667 candidats sur 11957 portent les champs bruts (64%).*
...
- `ab89a63b01ef` — 2280 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 1702 candidats
  - AVEC connectivite (667) : resistance **41.8%**
...
- `ab89a63b01ef` — 2280 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 1702 candidats
  - AVEC connectivite (667) : T0=13.04 T1=0.00 T2=3.05 — pondere **6.10**
...
- TROP-CHER : 5130 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 5098 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 37387 systemes
  - sans CONNECTED : 0.0% sur 8365 systemes
