...
genere 2026-08-28 14:06 UTC — 145240 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 61896 systemes
...
- moteur actif `0caa9267db60` (101498 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 70276 | 34917 | 4797 | 2385 | 7053 | 5607 | 7425 | 7193 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 68849 | 15977 | 29090 | 32 | 9539 | 3547 | 30 | 10631 | 15.4% |
...
- candidats AVEC connectivite : 7320, dont T2 : 100%
- candidats SANS connectivite : 10941, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7699 systemes avec CONNECTED sur 59817 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*13971 candidats sur 18261 portent les champs bruts (77%).*

- `5c556c16ea8b` — 8006 candidats
  - AVEC connectivite (3192) : resistance **41.3%**
  - SANS connectivite (4814) : resistance **21.8%**
...
- `5c556c16ea8b` — 8006 candidats
  - AVEC connectivite (3192) : T0=13.01 T1=0.00 T2=3.00 — pondere **6.01**
  - SANS connectivite (4814) : T0=15.89 T1=0.00 T2=2.68 — pondere **5.36**
...
- TROP-CHER : 7739 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7699 avec CONNECTED, 40 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 57316 systemes
  - sans CONNECTED : 0.0% sur 12960 systemes
