...
genere 2026-08-26 22:41 UTC — 67839 systemes evalues
...
- moteur actif `0caa9267db60` (24097 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 31189 | 15495 | 2133 | 1045 | 3109 | 2484 | 3326 | 3202 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 30535 | 7033 | 12972 | 18 | 4233 | 1585 | 14 | 4680 | 15.3% |
...
- candidats AVEC connectivite : 3329, dont T2 : 100%
- candidats SANS connectivite : 4990, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3600 systemes avec CONNECTED sur 27995 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4029 candidats sur 8319 portent les champs bruts (48%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 352 candidats
  - AVEC connectivite (149) : resistance **42.7%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 352 candidats
  - AVEC connectivite (149) : T0=12.87 T1=0.00 T2=3.08 — pondere **6.16**
  - SANS connectivite (203) : T0=16.11 T1=0.00 T2=2.75 — pondere **5.50**
  - test de permutation : **p = 0.0540** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- TROP-CHER : 3624 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3600 avec CONNECTED, 24 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 25494 systemes
  - sans CONNECTED : 0.0% sur 5695 systemes
