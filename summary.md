...
genere 2026-09-01 02:58 UTC — 270603 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 187259 systemes
...
- moteur actif `0caa9267db60` (226861 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 133588 | 66380 | 9030 | 4486 | 13556 | 10572 | 14106 | 13725 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 130900 | 30508 | 55310 | 57 | 18140 | 6765 | 57 | 20053 | 15.3% |
...
- candidats SANS connectivite : 20363, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14380 systemes avec CONNECTED sur 111483 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*29925 candidats sur 34215 portent les champs bruts (87%).*

- `5c556c16ea8b` — 23960 candidats
  - AVEC connectivite (9724) : resistance **41.0%**
  - SANS connectivite (14236) : resistance **21.3%**
...
- `5c556c16ea8b` — 23960 candidats
  ...
  - SANS connectivite (14236) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 108982 systemes
  - sans CONNECTED : 0.0% sur 24606 systemes
