...
genere 2026-08-25 22:55 UTC — 9448 systemes evalues
...
| connect | 4 | 3 | 4722 | 2381 | 290 | 166 | 459 | 382 | 497 | 493 | 10.4% |
| ref | 4 | 3 | 4602 | 1123 | 1935 | 1 | 604 | 220 | 2 | 717 | 15.6% |
...
- candidats AVEC connectivite : 496, dont T2 : 100%
- candidats SANS connectivite : 721, dont T2 : 100%
...
- **497 systemes avec CONNECTED sur 3930 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 52 candidats
  - AVEC connectivite (17) : T0=12.53 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (35) : T0=15.94 T1=0.00 T2=3.03 — pondere **6.06**
...
- TROP-CHER : 499 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 497 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 3873 systemes
  - sans CONNECTED : 0.0% sur 849 systemes
