...
genere 2026-08-27 23:22 UTC — 118608 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 35264 systemes
...
- moteur actif `0caa9267db60` (74866 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 56815 | 28308 | 3925 | 1925 | 5633 | 4492 | 6003 | 5800 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 55678 | 12846 | 23619 | 26 | 7742 | 2882 | 25 | 8536 | 15.3% |
...
- candidats SANS connectivite : 8846, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6277 systemes avec CONNECTED sur 48913 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10483 candidats sur 14773 portent les champs bruts (71%).*

- `5c556c16ea8b` — 4518 candidats
  - AVEC connectivite (1799) : resistance **42.1%**
  - SANS connectivite (2719) : resistance **22.4%**
...
- `5c556c16ea8b` — 4518 candidats
  ...
  - SANS connectivite (2719) : T0=15.78 T1=0.00 T2=2.71 — pondere **5.41**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 46412 systemes
  - sans CONNECTED : 0.0% sur 10403 systemes
