...
genere 2026-08-28 18:04 UTC — 152196 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 68852 systemes
...
- moteur actif `0caa9267db60` (108454 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 73772 | 36636 | 5029 | 2522 | 7406 | 5882 | 7785 | 7572 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 72309 | 16792 | 30578 | 33 | 9983 | 3726 | 31 | 11163 | 15.4% |
...
- candidats AVEC connectivite : 7699, dont T2 : 100%
- candidats SANS connectivite : 11473, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8059 systemes avec CONNECTED sur 62675 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*14882 candidats sur 19172 portent les champs bruts (78%).*

- `5c556c16ea8b` — 8917 candidats
  - AVEC connectivite (3571) : resistance **41.1%**
  - SANS connectivite (5346) : resistance **21.7%**
...
- `5c556c16ea8b` — 8917 candidats
  - AVEC connectivite (3571) : T0=13.03 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (5346) : T0=15.89 T1=0.00 T2=2.68 — pondere **5.36**
...
- TROP-CHER : 8100 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8059 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 60174 systemes
  - sans CONNECTED : 0.0% sur 13598 systemes
