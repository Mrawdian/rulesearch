...
- moteur actif `0caa9267db60` (6706 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22399 | 11165 | 1505 | 766 | 2233 | 1776 | 2396 | 2277 | 10.2% |
...
- candidats AVEC connectivite : 2404, dont T2 : 100%
- candidats SANS connectivite : 3696, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2670 systemes avec CONNECTED sur 20782 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1810 candidats sur 6100 portent les champs bruts (30%).*
...
- `06fe04a859f1` — 695 candidats
  - AVEC connectivite (266) : resistance **41.2%**
...
- `06fe04a859f1` — 695 candidats
  - AVEC connectivite (266) : T0=13.30 T1=0.00 T2=3.03 — pondere **6.06**
...
- TROP-CHER : 2690 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2670 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18281 systemes
  - sans CONNECTED : 0.0% sur 4118 systemes
