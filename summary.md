...
genere 2026-08-26 20:08 UTC — 62256 systemes evalues
...
- moteur actif `0caa9267db60` (18514 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 28378 | 14127 | 1944 | 953 | 2814 | 2250 | 3017 | 2916 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 27763 | 6417 | 11762 | 15 | 3857 | 1425 | 12 | 4275 | 15.4% |
...
- candidats SANS connectivite : 4585, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3291 systemes avec CONNECTED sur 25716 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3338 candidats sur 7628 portent les champs bruts (44%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 469 candidats
  - AVEC connectivite (199) : resistance **39.6%**
  - SANS connectivite (270) : resistance **19.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 469 candidats
  ...
  - SANS connectivite (270) : T0=16.15 T1=0.00 T2=2.60 — pondere **5.20**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23215 systemes
  - sans CONNECTED : 0.0% sur 5163 systemes
