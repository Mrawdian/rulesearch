...
genere 2026-09-05 18:50 UTC — 395723 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 312379 systemes
...
- moteur actif `0caa9267db60` (351981 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 196755 | 97681 | 13398 | 6562 | 20001 | 15486 | 20874 | 20252 | 10.3% |
...
- candidats AVEC connectivite : 20379, dont T2 : 100%
...
- **21148 systemes avec CONNECTED sur 163012 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*46008 candidats sur 50298 portent les champs bruts (91%).*

- `5c556c16ea8b` — 40043 candidats
  - AVEC connectivite (16251) : resistance **41.1%**
...
- `5c556c16ea8b` — 40043 candidats
  - AVEC connectivite (16251) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
...
- TROP-CHER : 21229 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21148 avec CONNECTED, 81 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 160511 systemes
  - sans CONNECTED : 0.0% sur 36244 systemes
