...
genere 2026-08-31 18:52 UTC — 260314 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 176970 systemes
...
- moteur actif `0caa9267db60` (216572 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 128401 | 63833 | 8682 | 4308 | 12986 | 10153 | 13534 | 13226 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 125798 | 29311 | 53112 | 56 | 17429 | 6505 | 56 | 19319 | 15.4% |
...
- candidats AVEC connectivite : 13353, dont T2 : 100%
- candidats SANS connectivite : 19629, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13808 systemes avec CONNECTED sur 107264 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*28692 candidats sur 32982 portent les champs bruts (87%).*

- `5c556c16ea8b` — 22727 candidats
  - AVEC connectivite (9225) : resistance **41.0%**
  - SANS connectivite (13502) : resistance **21.4%**
...
- `5c556c16ea8b` — 22727 candidats
  - AVEC connectivite (9225) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (13502) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.32**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 104763 systemes
  - sans CONNECTED : 0.0% sur 23638 systemes
