...
genere 2026-08-26 01:57 UTC — 17216 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 8242 systemes
...
| connect | 4 | 3 | 8639 | 4347 | 561 | 292 | 822 | 696 | 926 | 889 | 10.3% |
...
- candidats AVEC connectivite : 892, dont T2 : 100%
...
- **926 systemes avec CONNECTED sur 7151 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1041 candidats
  - AVEC connectivite (413) : T0=13.36 T1=0.00 T2=2.87 — pondere **5.73**
  - SANS connectivite (628) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.32**
  - test de permutation : **p = 0.0390** — ecart significatif au seuil 0.05
...
- TROP-CHER : 929 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 926 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 7094 systemes
  - sans CONNECTED : 0.0% sur 1545 systemes
