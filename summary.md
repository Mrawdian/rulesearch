...
genere 2026-08-26 14:50 UTC — 49826 systemes evalues
...
- moteur actif `0caa9267db60` (6084 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22086 | 11019 | 1481 | 756 | 2189 | 1751 | 2363 | 2249 | 10.2% |
...
- candidats AVEC connectivite : 2376, dont T2 : 100%
- candidats SANS connectivite : 3643, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2637 systemes avec CONNECTED sur 20544 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1729 candidats sur 6019 portent les champs bruts (29%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 614 candidats
  - AVEC connectivite (238) : resistance **41.1%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 614 candidats
  - AVEC connectivite (238) : T0=13.38 T1=0.00 T2=3.05 — pondere **6.09**
...
- TROP-CHER : 2656 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2637 avec CONNECTED, 19 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18043 systemes
  - sans CONNECTED : 0.0% sur 4043 systemes
