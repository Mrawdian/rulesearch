...
genere 2026-08-29 05:00 UTC — 170930 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 87586 systemes
...
- moteur actif `0caa9267db60` (127188 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 83244 | 41434 | 5662 | 2812 | 8356 | 6610 | 8731 | 8580 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 81571 | 18985 | 34531 | 39 | 11285 | 4145 | 34 | 12547 | 15.4% |
...
- candidats AVEC connectivite : 8707, dont T2 : 100%
- candidats SANS connectivite : 12857, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9005 systemes avec CONNECTED sur 70428 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*17274 candidats sur 21564 portent les champs bruts (80%).*

- `5c556c16ea8b` — 11309 candidats
  - AVEC connectivite (4579) : resistance **41.2%**
  - SANS connectivite (6730) : resistance **21.7%**
...
- `5c556c16ea8b` — 11309 candidats
  - AVEC connectivite (4579) : T0=13.01 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (6730) : T0=15.90 T1=0.00 T2=2.67 — pondere **5.34**
...
- TROP-CHER : 9049 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 9005 avec CONNECTED, 44 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 67927 systemes
  - sans CONNECTED : 0.0% sur 15317 systemes
