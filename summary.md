...
genere 2026-08-26 23:56 UTC — 70548 systemes evalues
...
- moteur actif `0caa9267db60` (26806 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 31868 | 7349 | 13535 | 18 | 4416 | 1664 | 15 | 4871 | 15.3% |
...
- candidats SANS connectivite : 5181, dont T2 : 100%
...
*4334 candidats sur 8624 portent les champs bruts (50%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 657 candidats
  - AVEC connectivite (263) : resistance **42.0%**
  - SANS connectivite (394) : resistance **21.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 657 candidats
  ...
  - SANS connectivite (394) : T0=15.94 T1=0.00 T2=2.62 — pondere **5.24**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e3baecf8377b` — 657 candidats
