...
genere 2026-08-26 10:36 UTC — 39142 systemes evalues
...
- `e3baecf8377b` : 549 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
**8015 enregistrements (20%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 16692 | 8336 | 1075 | 577 | 1657 | 1326 | 1825 | 1685 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 16335 | 3842 | 6918 | 11 | 2230 | 823 | 7 | 2504 | 15.3% |
...
- candidats SANS connectivite : 2814, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2099 systemes avec CONNECTED sur 16150 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*336 candidats sur 4626 portent les champs bruts (7%).*
...
- `e3baecf8377b` — 72 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (29) : resistance **37.1%**
  - SANS connectivite (43) : resistance **17.4%**
...
- `e3baecf8377b` — 72 candidats
  - AVEC connectivite (29) : T0=13.69 T1=0.00 T2=2.83 — pondere **5.66**
  - SANS connectivite (43) : T0=16.05 T1=0.00 T2=2.30 — pondere **4.60**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.4% sur 13649 systemes
  - sans CONNECTED : 0.0% sur 3043 systemes
