...
genere 2026-08-27 20:24 UTC — 112826 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 29482 systemes
...
- moteur actif `0caa9267db60` (69084 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 53898 | 26837 | 3730 | 1834 | 5322 | 4270 | 5703 | 5499 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 52813 | 12194 | 22435 | 26 | 7308 | 2747 | 25 | 8076 | 15.3% |
...
- candidats SANS connectivite : 8386, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5977 systemes avec CONNECTED sur 46541 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*9722 candidats sur 14012 portent les champs bruts (69%).*
...
- `5c556c16ea8b` — 3757 candidats
  - AVEC connectivite (1498) : resistance **42.0%**
  - SANS connectivite (2259) : resistance **22.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 3757 candidats
  ...
  - SANS connectivite (2259) : T0=15.79 T1=0.00 T2=2.71 — pondere **5.42**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 2280 candidats
...
- TROP-CHER : 6012 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 5977 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 44040 systemes
  - sans CONNECTED : 0.0% sur 9858 systemes
