...
genere 2026-09-04 23:01 UTC — 375538 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 292194 systemes
...
- moteur actif `0caa9267db60` (331796 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 186555 | 92652 | 12685 | 6238 | 18977 | 14698 | 19776 | 19137 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 182868 | 42537 | 77247 | 76 | 25399 | 9471 | 70 | 28054 | 15.3% |
...
- candidats AVEC connectivite : 19264, dont T2 : 100%
- candidats SANS connectivite : 28364, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20050 systemes avec CONNECTED sur 154685 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*43338 candidats sur 47628 portent les champs bruts (91%).*

- `5c556c16ea8b` — 37373 candidats
  - AVEC connectivite (15136) : resistance **41.1%**
  - SANS connectivite (22237) : resistance **21.2%**
...
- `5c556c16ea8b` — 37373 candidats
  - AVEC connectivite (15136) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (22237) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 20130 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 20050 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 152184 systemes
  - sans CONNECTED : 0.0% sur 34371 systemes
