...
genere 2026-08-26 20:50 UTC — 63709 systemes evalues
...
- moteur actif `0caa9267db60` (19967 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 29111 | 14481 | 1987 | 973 | 2897 | 2304 | 3105 | 2993 | 10.3% |
...
- candidats AVEC connectivite : 3120, dont T2 : 100%
- candidats SANS connectivite : 4690, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3379 systemes avec CONNECTED sur 26318 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3520 candidats sur 7810 portent les champs bruts (45%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 651 candidats
  - AVEC connectivite (276) : resistance **39.9%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 651 candidats
  - AVEC connectivite (276) : T0=12.83 T1=0.00 T2=2.84 — pondere **5.69**
  - SANS connectivite (375) : T0=16.11 T1=0.00 T2=2.69 — pondere **5.37**
  - test de permutation : **p = 0.2154** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- TROP-CHER : 3401 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3379 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23817 systemes
