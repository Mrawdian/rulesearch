...
genere 2026-09-03 21:39 UTC — 348502 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 265158 systemes
...
- moteur actif `0caa9267db60` (304760 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 172906 | 85957 | 11743 | 5780 | 17603 | 13625 | 18321 | 17677 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 169481 | 39420 | 71618 | 67 | 23503 | 8771 | 66 | 26023 | 15.4% |
...
- candidats AVEC connectivite : 17804, dont T2 : 100%
- candidats SANS connectivite : 26333, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18595 systemes avec CONNECTED sur 143578 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39847 candidats sur 44137 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33882 candidats
  - AVEC connectivite (13676) : resistance **41.0%**
  - SANS connectivite (20206) : resistance **21.2%**
...
- `5c556c16ea8b` — 33882 candidats
  - AVEC connectivite (13676) : T0=13.03 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (20206) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.29**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 141077 systemes
  - sans CONNECTED : 0.0% sur 31829 systemes
