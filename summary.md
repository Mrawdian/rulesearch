...
genere 2026-08-31 12:32 UTC — 251814 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 168470 systemes
...
- moteur actif `0caa9267db60` (208072 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 124111 | 61728 | 8416 | 4155 | 12506 | 9793 | 13109 | 12780 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 121588 | 28365 | 51326 | 54 | 16828 | 6291 | 56 | 18658 | 15.3% |
...
- candidats AVEC connectivite : 12907, dont T2 : 100%
- candidats SANS connectivite : 18968, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13383 systemes avec CONNECTED sur 103801 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*27585 candidats sur 31875 portent les champs bruts (87%).*

- `5c556c16ea8b` — 21620 candidats
  - AVEC connectivite (8779) : resistance **41.0%**
  - SANS connectivite (12841) : resistance **21.3%**
...
- `5c556c16ea8b` — 21620 candidats
  - AVEC connectivite (8779) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (12841) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 101300 systemes
  - sans CONNECTED : 0.0% sur 22811 systemes
