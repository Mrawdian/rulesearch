...
genere 2026-08-26 01:41 UTC — 16592 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 7618 systemes
...
| connect | 4 | 3 | 8326 | 4192 | 543 | 284 | 791 | 668 | 886 | 861 | 10.3% |
| ref | 4 | 3 | 8142 | 1971 | 3415 | 2 | 1086 | 399 | 3 | 1266 | 15.5% |
...
- candidats AVEC connectivite : 864, dont T2 : 100%
- candidats SANS connectivite : 1270, dont T2 : 100%
...
- **886 systemes avec CONNECTED sur 6893 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 969 candidats
  - AVEC connectivite (385) : T0=13.38 T1=0.00 T2=2.84 — pondere **5.68**
  - SANS connectivite (584) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 889 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 886 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 6836 systemes
  - sans CONNECTED : 0.0% sur 1490 systemes
