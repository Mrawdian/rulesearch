...
| connect | 4 | 3 | 6977 | 3505 | 456 | 244 | 662 | 566 | 728 | 737 | 10.6% |
| ref | 4 | 3 | 6807 | 1641 | 2827 | 1 | 914 | 341 | 2 | 1081 | 15.9% |
...
- candidats AVEC connectivite : 740, dont T2 : 100%
- candidats SANS connectivite : 1085, dont T2 : 100%
...
- **728 systemes avec CONNECTED sur 5778 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 660 candidats
  - AVEC connectivite (261) : T0=13.26 T1=0.00 T2=2.94 — pondere **5.89**
  - SANS connectivite (399) : T0=15.79 T1=0.00 T2=2.64 — pondere **5.29**
...
- TROP-CHER : 730 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 728 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 5721 systemes
  - sans CONNECTED : 0.0% sur 1256 systemes
