...
genere 2026-09-03 20:46 UTC — 347584 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 264240 systemes
...
- moteur actif `0caa9267db60` (303842 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 172441 | 85715 | 11710 | 5772 | 17561 | 13594 | 18265 | 17630 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 169028 | 39305 | 71448 | 67 | 23441 | 8748 | 66 | 25940 | 15.3% |
...
- candidats AVEC connectivite : 17757, dont T2 : 100%
- candidats SANS connectivite : 26250, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18539 systemes avec CONNECTED sur 143187 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39717 candidats sur 44007 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33752 candidats
  - AVEC connectivite (13629) : resistance **41.0%**
  - SANS connectivite (20123) : resistance **21.2%**
...
- `5c556c16ea8b` — 33752 candidats
  - AVEC connectivite (13629) : T0=13.03 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (20123) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.29**
...
- TROP-CHER : 18615 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18539 avec CONNECTED, 76 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 140686 systemes
  - sans CONNECTED : 0.0% sur 31755 systemes
