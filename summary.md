...
genere 2026-08-26 16:23 UTC — 53504 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 8321 systemes
...
- moteur actif `0caa9267db60` (9762 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23954 | 11950 | 1632 | 813 | 2377 | 1890 | 2558 | 2434 | 10.2% |
...
- candidats AVEC connectivite : 2561, dont T2 : 100%
- candidats SANS connectivite : 3921, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2832 systemes avec CONNECTED sur 22068 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2192 candidats sur 6482 portent les champs bruts (34%).*
...
- `06fe04a859f1` — 1077 candidats
  - AVEC connectivite (423) : resistance **40.9%**
...
- `06fe04a859f1` — 1077 candidats
  - AVEC connectivite (423) : T0=13.16 T1=0.00 T2=3.02 — pondere **6.05**
...
- TROP-CHER : 2852 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2832 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19567 systemes
  - sans CONNECTED : 0.0% sur 4387 systemes
