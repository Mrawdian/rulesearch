...
genere 2026-08-26 02:32 UTC — 18445 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 9471 systemes
...
| connect | 4 | 3 | 9268 | 4657 | 606 | 310 | 892 | 730 | 1010 | 952 | 10.3% |
...
- candidats AVEC connectivite : 955, dont T2 : 100%
...
- **1010 systemes avec CONNECTED sur 7676 (13.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1202 candidats
  - AVEC connectivite (476) : T0=13.33 T1=0.00 T2=2.91 — pondere **5.82**
...
- TROP-CHER : 1014 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1010 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 7619 systemes
  - sans CONNECTED : 0.0% sur 1649 systemes
