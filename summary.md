...
genere 2026-08-26 21:04 UTC — 64181 systemes evalues
...
- moteur actif `0caa9267db60` (20439 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
**7466 enregistrements (12%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 29351 | 14598 | 2001 | 981 | 2924 | 2326 | 3133 | 3014 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 28715 | 6625 | 12187 | 16 | 3985 | 1478 | 12 | 4412 | 15.4% |
...
- candidats AVEC connectivite : 3141, dont T2 : 100%
- candidats SANS connectivite : 4722, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3407 systemes avec CONNECTED sur 26510 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3573 candidats sur 7863 portent les champs bruts (45%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 704 candidats
  - AVEC connectivite (297) : resistance **39.9%**
  - SANS connectivite (407) : resistance **20.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 704 candidats
  - AVEC connectivite (297) : T0=12.89 T1=0.00 T2=2.85 — pondere **5.69**
  - SANS connectivite (407) : T0=16.12 T1=0.00 T2=2.67 — pondere **5.34**
...
## cout
- temps total 19.9 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 3429 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3407 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24009 systemes
  - sans CONNECTED : 0.0% sur 5342 systemes
