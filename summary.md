...
genere 2026-08-26 02:22 UTC — 18088 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 9114 systemes
...
| connect | 4 | 3 | 9089 | 4574 | 590 | 303 | 873 | 721 | 986 | 931 | 10.2% |
...
- candidats AVEC connectivite : 934, dont T2 : 100%
...
- **986 systemes avec CONNECTED sur 7528 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1152 candidats
  - AVEC connectivite (455) : T0=13.37 T1=0.00 T2=2.89 — pondere **5.78**
...
- TROP-CHER : 989 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 986 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 7471 systemes
  - sans CONNECTED : 0.0% sur 1618 systemes
