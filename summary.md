...
genere 2026-08-26 21:39 UTC — 65587 systemes evalues
...
- `ab89a63b01ef` : 680 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (21845 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
**8206 enregistrements (13%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 30053 | 14931 | 2053 | 1012 | 3011 | 2378 | 3202 | 3086 | 10.3% |
...
- candidats AVEC connectivite : 3213, dont T2 : 100%
- candidats SANS connectivite : 4828, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3476 systemes avec CONNECTED sur 27067 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3751 candidats sur 8041 portent les champs bruts (47%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 74 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (33) : resistance **42.9%**
...
- `ab89a63b01ef` — 74 candidats
  - AVEC connectivite (33) : T0=14.52 T1=0.00 T2=3.03 — pondere **6.06**
  - SANS connectivite (41) : T0=16.46 T1=0.00 T2=2.93 — pondere **5.85**
  - test de permutation : **p = 0.8241** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e80bc1b2b437` — 75 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24566 systemes
  - sans CONNECTED : 0.0% sur 5487 systemes
