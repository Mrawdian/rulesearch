...
genere 2026-09-08 11:34 UTC — 456653 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 373309 systemes
...
- moteur actif `0caa9267db60` (412911 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 227538 | 113016 | 15479 | 7614 | 23018 | 17831 | 24246 | 23436 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 223000 | 51929 | 93995 | 88 | 31073 | 11531 | 81 | 34285 | 15.4% |
...
- candidats AVEC connectivite : 23563, dont T2 : 100%
- candidats SANS connectivite : 34595, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **24520 systemes avec CONNECTED sur 188310 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*53868 candidats sur 58158 portent les champs bruts (93%).*

- `5c556c16ea8b` — 47903 candidats
  - AVEC connectivite (19435) : resistance **41.2%**
  - SANS connectivite (28468) : resistance **21.3%**
...
- `5c556c16ea8b` — 47903 candidats
  - AVEC connectivite (19435) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (28468) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
## cout
- temps total 142.5 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 24611 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 24520 avec CONNECTED, 91 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 185809 systemes
  - sans CONNECTED : 0.0% sur 41729 systemes
