...
| connect | 4 | 3 | 5381 | 2696 | 348 | 193 | 522 | 445 | 562 | 556 | 10.3% |
| ref | 4 | 3 | 5264 | 1275 | 2200 | 1 | 697 | 254 | 2 | 835 | 15.9% |
...
- candidats AVEC connectivite : 559, dont T2 : 100%
- candidats SANS connectivite : 839, dont T2 : 100%
...
- **562 systemes avec CONNECTED sur 4448 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 233 candidats
  - AVEC connectivite (80) : T0=13.26 T1=0.00 T2=2.76 — pondere **5.53**
  - SANS connectivite (153) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
  - test de permutation : **p = 0.5967** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 564 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 562 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 4391 systemes
  - sans CONNECTED : 0.0% sur 990 systemes
