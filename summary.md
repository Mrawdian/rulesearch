...
genere 2026-08-26 20:42 UTC — 63471 systemes evalues
...
- moteur actif `0caa9267db60` (19729 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 28991 | 14431 | 1980 | 968 | 2882 | 2295 | 3086 | 2979 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 28365 | 6545 | 12040 | 16 | 3937 | 1461 | 12 | 4354 | 15.3% |
...
- **3360 systemes avec CONNECTED sur 26218 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3480 candidats sur 7770 portent les champs bruts (45%).*
...
- `62448a55927e` — 611 candidats
  ...
  - test de permutation : **p = 0.1604** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- TROP-CHER : 3382 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3360 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23717 systemes
  - sans CONNECTED : 0.0% sur 5274 systemes
