...
- moteur actif `0caa9267db60` (6751 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22429 | 11176 | 1508 | 767 | 2239 | 1776 | 2402 | 2280 | 10.2% |
...
- candidats AVEC connectivite : 2407, dont T2 : 100%
- candidats SANS connectivite : 3699, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2676 systemes avec CONNECTED sur 20807 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1816 candidats sur 6106 portent les champs bruts (30%).*
...
- `06fe04a859f1` — 701 candidats
  - AVEC connectivite (269) : resistance **41.2%**
...
- `06fe04a859f1` — 701 candidats
  - AVEC connectivite (269) : T0=13.29 T1=0.00 T2=3.03 — pondere **6.06**
...
- TROP-CHER : 2696 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2676 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18306 systemes
