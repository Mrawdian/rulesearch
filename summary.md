...
genere 2026-08-25 21:05 UTC — 4725 systemes evalues

## versions du DSL presentes
- `615abe43d6bc` : 3748 systemes
...
| connect | 4 | 3 | 2329 | 1170 | 163 | 81 | 236 | 174 | 231 | 247 | 10.6% |
...
- candidats AVEC connectivite : 250, dont T2 : 100%
- candidats SANS connectivite : 362, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **231 systemes avec CONNECTED sur 1963 (11.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- TROP-CHER : 232 systemes abandonnes (4.9% des systemes), 95% du temps total
  dont 231 avec CONNECTED, 1 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.1% sur 1906 systemes
  - sans CONNECTED : 0.0% sur 423 systemes
