...
genere 2026-09-04 00:37 UTC — 351821 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 268477 systemes
...
- moteur actif `0caa9267db60` (308079 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 174592 | 86792 | 11869 | 5839 | 17778 | 13742 | 18488 | 17859 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 171114 | 39764 | 72290 | 70 | 23765 | 8851 | 67 | 26293 | 15.4% |
...
- candidats SANS connectivite : 26603, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18762 systemes avec CONNECTED sur 144957 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*40299 candidats sur 44589 portent les champs bruts (90%).*

- `5c556c16ea8b` — 34334 candidats
  - AVEC connectivite (13858) : resistance **41.0%**
  - SANS connectivite (20476) : resistance **21.3%**
...
- `5c556c16ea8b` — 34334 candidats
  ...
  - SANS connectivite (20476) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 142456 systemes
  - sans CONNECTED : 0.0% sur 32136 systemes
