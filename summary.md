...
genere 2026-08-26 07:49 UTC — 31877 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 22903 systemes
...
| connect | 4 | 3 | 14641 | 7313 | 960 | 508 | 1436 | 1166 | 1599 | 1471 | 10.0% |
...
- candidats AVEC connectivite : 1519, dont T2 : 100%
- candidats SANS connectivite : 2359, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1731 systemes avec CONNECTED sur 13178 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2713 candidats
  - AVEC connectivite (1040) : T0=13.18 T1=0.00 T2=2.89 — pondere **5.78**
...
- TROP-CHER : 1741 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1731 avec CONNECTED, 10 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 11982 systemes
  - sans CONNECTED : 0.0% sur 2659 systemes
