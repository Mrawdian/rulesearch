...
| ref | 4 | 3 | 17180 | 4047 | 7265 | 12 | 2349 | 869 | 7 | 2631 | 15.3% |
...
- candidats SANS connectivite : 2941, dont T2 : 100%
...
*545 candidats sur 4835 portent les champs bruts (11%).*
...
- `e3baecf8377b` — 281 candidats
  - AVEC connectivite (111) : resistance **44.2%**
  - SANS connectivite (170) : resistance **21.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 281 candidats
  ...
  - SANS connectivite (170) : T0=16.12 T1=0.00 T2=2.66 — pondere **5.33**
...
**2 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0065).
