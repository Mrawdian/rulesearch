...
genere 2026-09-01 13:14 UTC — 283528 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 200184 systemes
...
- moteur actif `0caa9267db60` (239786 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 140111 | 69650 | 9477 | 4685 | 14234 | 11053 | 14792 | 14408 | 10.3% |
...
- candidats AVEC connectivite : 14535, dont T2 : 100%
...
- **15066 systemes avec CONNECTED sur 116820 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*31568 candidats sur 35858 portent les champs bruts (88%).*

- `5c556c16ea8b` — 25603 candidats
  - AVEC connectivite (10407) : resistance **41.0%**
...
- `5c556c16ea8b` — 25603 candidats
  - AVEC connectivite (10407) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 15137 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15066 avec CONNECTED, 71 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 114319 systemes
  - sans CONNECTED : 0.0% sur 25792 systemes
