...
genere 2026-08-25 22:18 UTC — 7970 systemes evalues

## versions du DSL presentes
- `615abe43d6bc` : 6993 systemes
...
| connect | 4 | 3 | 3973 | 2005 | 254 | 140 | 381 | 318 | 408 | 420 | 10.6% |
...
- candidats AVEC connectivite : 423, dont T2 : 100%
- candidats SANS connectivite : 604, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **408 systemes avec CONNECTED sur 3313 (12.3%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- TROP-CHER : 410 systemes abandonnes (5.1% des systemes), 96% du temps total
  dont 408 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.5% sur 3256 systemes
  - sans CONNECTED : 0.0% sur 717 systemes
