...
| connect | 4 | 3 | 17440 | 8727 | 1127 | 601 | 1729 | 1387 | 1894 | 1755 | 10.1% |
...
- candidats AVEC connectivite : 1882, dont T2 : 100%
- candidats SANS connectivite : 2928, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2168 systemes avec CONNECTED sur 16747 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*520 candidats sur 4810 portent les champs bruts (11%).*
...
- `e3baecf8377b` — 256 candidats
  - AVEC connectivite (99) : resistance **43.3%**
...
- `e3baecf8377b` — 256 candidats
  - AVEC connectivite (99) : T0=12.97 T1=0.00 T2=3.15 — pondere **6.30**
...
- TROP-CHER : 2185 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2168 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14246 systemes
  - sans CONNECTED : 0.0% sur 3194 systemes
