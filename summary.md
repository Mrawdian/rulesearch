...
genere 2026-08-26 17:07 UTC — 55295 systemes evalues
...
- moteur actif `0caa9267db60` (11553 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
| connect | 4 | 3 | 24848 | 12411 | 1688 | 843 | 2457 | 1956 | 2650 | 2532 | 10.2% |
...
- candidats AVEC connectivite : 2659, dont T2 : 100%
- candidats SANS connectivite : 4058, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2924 systemes avec CONNECTED sur 22819 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2427 candidats sur 6717 portent les champs bruts (36%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 117 candidats
  - AVEC connectivite (45) : resistance **40.2%**
...
- `23303c299f39` — 117 candidats
  - AVEC connectivite (45) : T0=12.76 T1=0.00 T2=2.91 — pondere **5.82**
  - SANS connectivite (72) : T0=16.86 T1=0.00 T2=2.76 — pondere **5.53**
  - test de permutation : **p = 0.6457** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 2944 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2924 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 20318 systemes
  - sans CONNECTED : 0.0% sur 4530 systemes
