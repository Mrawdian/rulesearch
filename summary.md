...
genere 2026-08-26 16:24 UTC — 53534 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 8351 systemes
...
- moteur actif `0caa9267db60` (9792 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23969 | 11956 | 1633 | 813 | 2377 | 1892 | 2561 | 2436 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 23450 | 5424 | 9911 | 14 | 3284 | 1195 | 10 | 3612 | 15.4% |
...
- candidats AVEC connectivite : 2563, dont T2 : 100%
- candidats SANS connectivite : 3922, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2835 systemes avec CONNECTED sur 22081 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2195 candidats sur 6485 portent les champs bruts (34%).*
...
- `06fe04a859f1` — 1080 candidats
  - AVEC connectivite (425) : resistance **40.8%**
  - SANS connectivite (655) : resistance **21.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1080 candidats
  - AVEC connectivite (425) : T0=13.17 T1=0.00 T2=3.02 — pondere **6.03**
  - SANS connectivite (655) : T0=15.98 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 2855 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2835 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19580 systemes
  - sans CONNECTED : 0.0% sur 4389 systemes
