...
genere 2026-09-04 17:30 UTC — 369875 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 286531 systemes
...
- moteur actif `0caa9267db60` (326133 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 183691 | 91294 | 12492 | 6141 | 18684 | 14461 | 19455 | 18806 | 10.2% |
...
- candidats AVEC connectivite : 18933, dont T2 : 100%
...
- **19729 systemes avec CONNECTED sur 152358 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*42582 candidats sur 46872 portent les champs bruts (91%).*

- `5c556c16ea8b` — 36617 candidats
  - AVEC connectivite (14805) : resistance **41.0%**
...
- `5c556c16ea8b` — 36617 candidats
  - AVEC connectivite (14805) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.95**
...
- TROP-CHER : 19809 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19729 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 149857 systemes
  - sans CONNECTED : 0.0% sur 33834 systemes
