...
genere 2026-09-04 14:09 UTC — 366339 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 282995 systemes
...
- moteur actif `0caa9267db60` (322597 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 181911 | 90410 | 12374 | 6075 | 18514 | 14333 | 19264 | 18612 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 178313 | 41442 | 75330 | 73 | 24782 | 9235 | 70 | 27367 | 15.3% |
...
- candidats AVEC connectivite : 18739, dont T2 : 100%
...
- **19538 systemes avec CONNECTED sur 150888 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*42126 candidats sur 46416 portent les champs bruts (91%).*

- `5c556c16ea8b` — 36161 candidats
  - AVEC connectivite (14611) : resistance **41.0%**
...
- `5c556c16ea8b` — 36161 candidats
  - AVEC connectivite (14611) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.95**
...
- TROP-CHER : 19618 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19538 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 148387 systemes
  - sans CONNECTED : 0.0% sur 33524 systemes
