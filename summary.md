...
genere 2026-08-26 13:54 UTC — 47677 systemes evalues
...
- moteur actif `0caa9267db60` (3935 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21006 | 10480 | 1391 | 721 | 2085 | 1673 | 2245 | 2148 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20556 | 4804 | 8679 | 13 | 2850 | 1063 | 7 | 3140 | 15.3% |
...
- candidats AVEC connectivite : 2275, dont T2 : 100%
- candidats SANS connectivite : 3450, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2519 systemes avec CONNECTED sur 19656 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1435 candidats sur 5725 portent les champs bruts (25%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 320 candidats
  - AVEC connectivite (137) : resistance **39.8%**
  - SANS connectivite (183) : resistance **21.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 320 candidats
  - AVEC connectivite (137) : T0=13.42 T1=0.00 T2=2.90 — pondere **5.80**
  - SANS connectivite (183) : T0=16.15 T1=0.00 T2=2.72 — pondere **5.44**
  - test de permutation : **p = 0.3238** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
- TROP-CHER : 2536 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2519 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17155 systemes
  - sans CONNECTED : 0.0% sur 3851 systemes
