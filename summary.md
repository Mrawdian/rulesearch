...
genere 2026-08-26 23:59 UTC — 70638 systemes evalues
...
- moteur actif `0caa9267db60` (26896 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 32610 | 16214 | 2238 | 1102 | 3246 | 2594 | 3479 | 3320 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 31913 | 7355 | 13548 | 18 | 4426 | 1668 | 15 | 4883 | 15.3% |
...
- candidats AVEC connectivite : 3447, dont T2 : 100%
- candidats SANS connectivite : 5193, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3753 systemes avec CONNECTED sur 29159 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4350 candidats sur 8640 portent les champs bruts (50%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 673 candidats
  - AVEC connectivite (267) : resistance **42.0%**
  - SANS connectivite (406) : resistance **21.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 673 candidats
  - AVEC connectivite (267) : T0=13.11 T1=0.00 T2=3.12 — pondere **6.24**
  - SANS connectivite (406) : T0=15.96 T1=0.00 T2=2.63 — pondere **5.25**
...
- TROP-CHER : 3778 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3753 avec CONNECTED, 25 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 26658 systemes
  - sans CONNECTED : 0.0% sur 5952 systemes
