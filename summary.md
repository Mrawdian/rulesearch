...
genere 2026-09-01 12:25 UTC — 282493 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 199149 systemes
...
- moteur actif `0caa9267db60` (238751 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 139587 | 69393 | 9452 | 4669 | 14182 | 10996 | 14740 | 14353 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 136791 | 31824 | 57832 | 59 | 18978 | 7080 | 61 | 20946 | 15.3% |
...
- candidats AVEC connectivite : 14480, dont T2 : 100%
- candidats SANS connectivite : 21256, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15014 systemes avec CONNECTED sur 116403 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*31446 candidats sur 35736 portent les champs bruts (88%).*

- `5c556c16ea8b` — 25481 candidats
  - AVEC connectivite (10352) : resistance **41.0%**
  - SANS connectivite (15129) : resistance **21.4%**
...
- `5c556c16ea8b` — 25481 candidats
  - AVEC connectivite (10352) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (15129) : T0=15.93 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 15085 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15014 avec CONNECTED, 71 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 113902 systemes
  - sans CONNECTED : 0.0% sur 25685 systemes
