...
genere 2026-09-02 07:16 UTC — 305050 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 221706 systemes
...
- moteur actif `0caa9267db60` (261308 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 150963 | 75008 | 10264 | 5059 | 15322 | 11884 | 15988 | 15509 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 147972 | 34459 | 62604 | 62 | 20468 | 7634 | 63 | 22670 | 15.3% |
...
- candidats AVEC connectivite : 15636, dont T2 : 100%
- candidats SANS connectivite : 22980, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16262 systemes avec CONNECTED sur 125736 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*34326 candidats sur 38616 portent les champs bruts (89%).*

- `5c556c16ea8b` — 28361 candidats
  - AVEC connectivite (11508) : resistance **41.1%**
  - SANS connectivite (16853) : resistance **21.3%**
...
- `5c556c16ea8b` — 28361 candidats
  - AVEC connectivite (11508) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (16853) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 16335 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16262 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 123235 systemes
  - sans CONNECTED : 0.0% sur 27728 systemes
