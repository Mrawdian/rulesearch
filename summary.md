...
genere 2026-08-26 01:30 UTC — 16176 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 7202 systemes
...
| connect | 4 | 3 | 8117 | 4091 | 527 | 278 | 774 | 647 | 859 | 848 | 10.4% |
| ref | 4 | 3 | 7935 | 1922 | 3331 | 1 | 1055 | 387 | 3 | 1236 | 15.6% |
...
- candidats AVEC connectivite : 851, dont T2 : 100%
- candidats SANS connectivite : 1240, dont T2 : 100%
...
- **859 systemes avec CONNECTED sur 6722 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 926 candidats
  - AVEC connectivite (372) : T0=13.44 T1=0.00 T2=2.84 — pondere **5.69**
  - SANS connectivite (554) : T0=15.86 T1=0.00 T2=2.65 — pondere **5.30**
...
## cout
- temps total 5.0 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 862 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 859 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 6665 systemes
  - sans CONNECTED : 0.0% sur 1452 systemes
