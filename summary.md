...
genere 2026-08-27 17:40 UTC — 107745 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 24401 systemes
...
- moteur actif `0caa9267db60` (64003 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 51335 | 25574 | 3549 | 1757 | 5088 | 4064 | 5415 | 5223 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 50295 | 11658 | 21328 | 26 | 6943 | 2624 | 23 | 7691 | 15.3% |
...
- candidats AVEC connectivite : 5350, dont T2 : 100%
- candidats SANS connectivite : 8001, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5689 systemes avec CONNECTED sur 44435 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*9061 candidats sur 13351 portent les champs bruts (68%).*
...
- `5c556c16ea8b` — 3096 candidats
  - AVEC connectivite (1222) : resistance **42.0%**
...
- `5c556c16ea8b` — 3096 candidats
  - AVEC connectivite (1222) : T0=12.99 T1=0.00 T2=3.06 — pondere **6.13**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 41934 systemes
  - sans CONNECTED : 0.0% sur 9401 systemes
