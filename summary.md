...
| connect | 4 | 3 | 5034 | 2525 | 316 | 178 | 489 | 412 | 524 | 532 | 10.6% |
...
- candidats AVEC connectivite : 535, dont T2 : 100%
...
- **524 systemes avec CONNECTED sur 4173 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 146 candidats
  - AVEC connectivite (56) : T0=13.02 T1=0.00 T2=2.93 — pondere **5.86**
...
- TROP-CHER : 526 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 524 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 4116 systemes
  - sans CONNECTED : 0.0% sur 918 systemes
