...
genere 2026-09-07 02:12 UTC — 426112 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 342768 systemes
...
- moteur actif `0caa9267db60` (382370 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 212103 | 105320 | 14443 | 7060 | 21515 | 16670 | 22544 | 21861 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 207894 | 48343 | 87701 | 81 | 28987 | 10730 | 74 | 31960 | 15.4% |
...
- candidats AVEC connectivite : 21988, dont T2 : 100%
- candidats SANS connectivite : 32270, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **22818 systemes avec CONNECTED sur 175600 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*49968 candidats sur 54258 portent les champs bruts (92%).*

- `5c556c16ea8b` — 44003 candidats
  - AVEC connectivite (17860) : resistance **41.1%**
  - SANS connectivite (26143) : resistance **21.3%**
...
- `5c556c16ea8b` — 44003 candidats
  - AVEC connectivite (17860) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (26143) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 22902 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 22818 avec CONNECTED, 84 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 173099 systemes
  - sans CONNECTED : 0.0% sur 39004 systemes
