...
genere 2026-08-30 21:34 UTC — 231297 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 147953 systemes
...
- moteur actif `0caa9267db60` (187555 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 113759 | 56562 | 7730 | 3810 | 11423 | 8999 | 12043 | 11698 | 10.3% |
...
- candidats AVEC connectivite : 11825, dont T2 : 100%
...
- **12317 systemes avec CONNECTED sur 95377 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*24961 candidats sur 29251 portent les champs bruts (85%).*

- `5c556c16ea8b` — 18996 candidats
  - AVEC connectivite (7697) : resistance **41.1%**
...
- `5c556c16ea8b` — 18996 candidats
  - AVEC connectivite (7697) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.98**
...
- TROP-CHER : 12374 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 12317 avec CONNECTED, 57 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 92876 systemes
  - sans CONNECTED : 0.0% sur 20883 systemes
