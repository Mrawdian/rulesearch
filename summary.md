...
| connect | 4 | 3 | 18202 | 9095 | 1184 | 634 | 1807 | 1443 | 1978 | 1832 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 17823 | 4194 | 7520 | 12 | 2440 | 911 | 7 | 2739 | 15.4% |
...
- candidats SANS connectivite : 3049, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2252 systemes avec CONNECTED sur 17365 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*718 candidats sur 5008 portent les champs bruts (14%).*
...
- `e3baecf8377b` — 454 candidats
  - AVEC connectivite (176) : resistance **43.2%**
  - SANS connectivite (278) : resistance **21.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 454 candidats
  ...
  - SANS connectivite (278) : T0=16.11 T1=0.00 T2=2.68 — pondere **5.35**
...
- TROP-CHER : 2269 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2252 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14864 systemes
  - sans CONNECTED : 0.0% sur 3338 systemes
