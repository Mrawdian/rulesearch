...
genere 2026-08-27 06:40 UTC — 85504 systemes evalues
...
- moteur actif `0caa9267db60` (41762 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 40107 | 19972 | 2746 | 1364 | 3998 | 3153 | 4230 | 4125 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 39282 | 9042 | 16717 | 22 | 5445 | 2050 | 21 | 5985 | 15.2% |
...
- candidats AVEC connectivite : 4252, dont T2 : 100%
- candidats SANS connectivite : 6295, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4504 systemes avec CONNECTED sur 35298 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6257 candidats sur 10547 portent les champs bruts (59%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 292 candidats
  - AVEC connectivite (124) : resistance **41.3%**
  - SANS connectivite (168) : resistance **22.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 292 candidats
  - AVEC connectivite (124) : T0=13.05 T1=0.00 T2=3.03 — pondere **6.06**
  - SANS connectivite (168) : T0=15.83 T1=0.00 T2=2.71 — pondere **5.42**
  - test de permutation : **p = 0.0695** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
**6 serie(s) reproductible(s) sur 14 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `ab89a63b01ef` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
...
- TROP-CHER : 4535 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4504 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 32797 systemes
  - sans CONNECTED : 0.0% sur 7310 systemes
