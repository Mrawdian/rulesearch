...
genere 2026-09-09 11:00 UTC — 477580 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 394236 systemes
...
- moteur actif `0caa9267db60` (433838 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 238101 | 118217 | 16238 | 7980 | 24092 | 18658 | 25350 | 24541 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 233364 | 54386 | 98329 | 92 | 32500 | 12051 | 84 | 35903 | 15.4% |
...
- candidats AVEC connectivite : 24668, dont T2 : 100%
- candidats SANS connectivite : 36213, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25624 systemes avec CONNECTED sur 196906 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*56591 candidats sur 60881 portent les champs bruts (93%).*

- `5c556c16ea8b` — 50626 candidats
  - AVEC connectivite (20540) : resistance **41.2%**
  - SANS connectivite (30086) : resistance **21.3%**
...
- `5c556c16ea8b` — 50626 candidats
  - AVEC connectivite (20540) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (30086) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 194405 systemes
  - sans CONNECTED : 0.0% sur 43696 systemes
