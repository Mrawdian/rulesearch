...
genere 2026-09-03 00:06 UTC — 324353 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 241009 systemes
...
- moteur actif `0caa9267db60` (280611 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 160714 | 79827 | 10920 | 5376 | 16372 | 12667 | 17030 | 16466 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 157524 | 36726 | 66561 | 64 | 21794 | 8136 | 65 | 24166 | 15.3% |
...
- candidats AVEC connectivite : 16593, dont T2 : 100%
- candidats SANS connectivite : 24476, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **17304 systemes avec CONNECTED sur 133626 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*36779 candidats sur 41069 portent les champs bruts (90%).*

- `5c556c16ea8b` — 30814 candidats
  - AVEC connectivite (12465) : resistance **41.1%**
  - SANS connectivite (18349) : resistance **21.2%**
...
- `5c556c16ea8b` — 30814 candidats
  - AVEC connectivite (12465) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (18349) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 131125 systemes
