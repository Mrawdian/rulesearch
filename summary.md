...
genere 2026-08-28 12:46 UTC — 143010 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 59666 systemes
...
- moteur actif `0caa9267db60` (99268 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 69143 | 34362 | 4734 | 2348 | 6930 | 5514 | 7298 | 7072 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 67752 | 15720 | 28630 | 32 | 9386 | 3494 | 30 | 10457 | 15.4% |
...
- candidats AVEC connectivite : 7199, dont T2 : 100%
- candidats SANS connectivite : 10767, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7572 systemes avec CONNECTED sur 58891 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*13676 candidats sur 17966 portent les champs bruts (76%).*

- `5c556c16ea8b` — 7711 candidats
  - AVEC connectivite (3071) : resistance **41.2%**
  - SANS connectivite (4640) : resistance **21.8%**
...
- `5c556c16ea8b` — 7711 candidats
  - AVEC connectivite (3071) : T0=13.02 T1=0.00 T2=3.01 — pondere **6.01**
  - SANS connectivite (4640) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.37**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 56390 systemes
  - sans CONNECTED : 0.0% sur 12753 systemes
