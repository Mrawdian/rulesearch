...
genere 2026-09-10 10:33 UTC — 497297 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 413953 systemes
...
- moteur actif `0caa9267db60` (453555 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 248059 | 123135 | 16897 | 8340 | 25098 | 19455 | 26461 | 25529 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 243123 | 56715 | 102409 | 97 | 33828 | 12532 | 87 | 37434 | 15.4% |
...
- candidats AVEC connectivite : 25656, dont T2 : 100%
...
- **26735 systemes avec CONNECTED sur 205048 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*59110 candidats sur 63400 portent les champs bruts (93%).*

- `5c556c16ea8b` — 53145 candidats
  - AVEC connectivite (21528) : resistance **41.2%**
...
- `5c556c16ea8b` — 53145 candidats
  - AVEC connectivite (21528) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 26832 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 26735 avec CONNECTED, 97 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 202547 systemes
  - sans CONNECTED : 0.0% sur 45512 systemes
