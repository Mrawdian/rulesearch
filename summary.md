...
genere 2026-08-26 09:12 UTC — 35529 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 26555 systemes
...
- candidats AVEC connectivite : 1663, dont T2 : 100%
- candidats SANS connectivite : 2590, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1914 systemes avec CONNECTED sur 14657 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 3088 candidats
  - AVEC connectivite (1184) : T0=13.15 T1=0.00 T2=2.93 — pondere **5.85**
