...
genere 2026-08-26 13:12 UTC — 45950 systemes evalues
...
- moteur actif `0caa9267db60` (2208 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20127 | 10052 | 1318 | 693 | 2016 | 1595 | 2155 | 2049 | 10.2% |
...
- candidats AVEC connectivite : 2176, dont T2 : 100%
- candidats SANS connectivite : 3315, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2429 systemes avec CONNECTED sur 18925 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1201 candidats sur 5491 portent les champs bruts (22%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 86 candidats
  - AVEC connectivite (38) : resistance **37.0%**
...
- `06fe04a859f1` — 86 candidats
  - AVEC connectivite (38) : T0=13.21 T1=0.00 T2=2.58 — pondere **5.16**
  - SANS connectivite (48) : T0=16.75 T1=0.00 T2=2.77 — pondere **5.54**
  - test de permutation : **p = 0.5647** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 2446 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2429 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16424 systemes
  - sans CONNECTED : 0.0% sur 3703 systemes
