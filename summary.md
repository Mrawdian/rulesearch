...
genere 2026-09-10 09:27 UTC — 496500 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 413156 systemes
...
- moteur actif `0caa9267db60` (452758 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 247656 | 122947 | 16875 | 8328 | 25053 | 19432 | 26406 | 25477 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 242729 | 56608 | 102251 | 97 | 33776 | 12516 | 87 | 37373 | 15.4% |
...
- candidats AVEC connectivite : 25604, dont T2 : 100%
- candidats SANS connectivite : 37683, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **26680 systemes avec CONNECTED sur 204712 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*58997 candidats sur 63287 portent les champs bruts (93%).*

- `5c556c16ea8b` — 53032 candidats
  - AVEC connectivite (21476) : resistance **41.2%**
  - SANS connectivite (31556) : resistance **21.3%**
...
- `5c556c16ea8b` — 53032 candidats
  - AVEC connectivite (21476) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (31556) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- `T2` indices=0.06 — PAIRDIFF(>=1)@knight + CONNECTED(v0) + NOSQUARE(v0) + COUNT(v0,1-3)@grid + PAIRSTEP(1)@knight
...
- `T2` indices=0.06 — CONNECTED(v2) + NOSQUARE(v2) + COUNT(v2,1-2)@grid + PAIRDIFF(>=1)@knight + PAIRSTEP(1)@knight
- `T2` indices=0.06 — PAIRDIFF(>=1)@knight + PAIRSTEP(1)@knight + CONNECTED(v0) + NOSQUARE(v0) + COUNT(v0,1-5)@grid
- `T2` indices=0.06 — CONNECTED(v2) + COUNT(v2,1-3)@grid + PAIRDIFF(>=1)@adj + PAIRSTEP(1)@knight
...
- `T2` indices=0.06 — PAIRDIFF(>=1)@knight + CONNECTED(v2) + NOSQUARE(v2) + COUNT(v2,1-3)@grid + PAIRSTEP(1)@knight
- `T2` indices=0.06 — PAIRDIFF(>=1)@knight + CONNECTED(v0) + NOSQUARE(v0) + COUNT(v0,1-2)@grid + PAIRSTEP(1)@knight
- `T2` indices=0.06 — PAIRSTEP(1)@knight + CONNECTED(v0) + COUNT(v0,1-5)@grid + PAIRDIFF(>=1)@knight
- `T2` indices=0.06 — PAIRDIFF(>=1)@knight + CONNECTED(v2) + COUNT(v2,1-4)@grid + PAIRSTEP(1)@knight
...
## cout
- temps total 155.0 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 26777 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 26680 avec CONNECTED, 97 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 202211 systemes
  - sans CONNECTED : 0.0% sur 45445 systemes
