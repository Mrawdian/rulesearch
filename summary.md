...
genere 2026-09-06 05:49 UTC — 406476 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 323132 systemes
...
- moteur actif `0caa9267db60` (362734 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 202187 | 100374 | 13797 | 6730 | 20513 | 15896 | 21480 | 20826 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 198174 | 46082 | 83631 | 78 | 27602 | 10242 | 73 | 30449 | 15.4% |
...
- candidats AVEC connectivite : 20953, dont T2 : 100%
- candidats SANS connectivite : 30759, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21754 systemes avec CONNECTED sur 167471 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*47422 candidats sur 51712 portent les champs bruts (92%).*

- `5c556c16ea8b` — 41457 candidats
  - AVEC connectivite (16825) : resistance **41.1%**
  - SANS connectivite (24632) : resistance **21.3%**
...
- `5c556c16ea8b` — 41457 candidats
  - AVEC connectivite (16825) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (24632) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 21837 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21754 avec CONNECTED, 83 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 164970 systemes
