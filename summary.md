...
genere 2026-08-26 23:42 UTC — 70103 systemes evalues
...
- moteur actif `0caa9267db60` (26361 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 31648 | 7301 | 13438 | 18 | 4381 | 1654 | 14 | 4842 | 15.3% |
...
- candidats SANS connectivite : 5152, dont T2 : 100%
...
*4289 candidats sur 8579 portent les champs bruts (50%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 612 candidats
  - AVEC connectivite (247) : resistance **42.3%**
  - SANS connectivite (365) : resistance **21.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 612 candidats
  ...
  - SANS connectivite (365) : T0=15.92 T1=0.00 T2=2.63 — pondere **5.25**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e3baecf8377b` — 657 candidats
