...
genere 2026-08-28 22:44 UTC — 160294 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 76950 systemes
...
- moteur actif `0caa9267db60` (116552 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 77871 | 38680 | 5308 | 2654 | 7797 | 6225 | 8198 | 8016 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 76308 | 17734 | 32312 | 35 | 10518 | 3904 | 31 | 11770 | 15.4% |
...
- candidats AVEC connectivite : 8143, dont T2 : 100%
- candidats SANS connectivite : 12080, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8472 systemes avec CONNECTED sur 66008 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*15933 candidats sur 20223 portent les champs bruts (79%).*

- `5c556c16ea8b` — 9968 candidats
  - AVEC connectivite (4015) : resistance **41.2%**
  - SANS connectivite (5953) : resistance **21.8%**
...
- `5c556c16ea8b` — 9968 candidats
  - AVEC connectivite (4015) : T0=13.00 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (5953) : T0=15.89 T1=0.00 T2=2.69 — pondere **5.37**
...
- TROP-CHER : 8513 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8472 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 63507 systemes
  - sans CONNECTED : 0.0% sur 14364 systemes
