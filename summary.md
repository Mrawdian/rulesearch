...
genere 2026-08-30 15:02 UTC — 222210 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 138866 systemes
...
- moteur actif `0caa9267db60` (178468 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 109149 | 54239 | 7414 | 3649 | 10999 | 8663 | 11541 | 11216 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 106946 | 24931 | 45161 | 49 | 14774 | 5525 | 43 | 16454 | 15.4% |
...
- candidats AVEC connectivite : 11343, dont T2 : 100%
- candidats SANS connectivite : 16764, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11815 systemes avec CONNECTED sur 91549 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*23817 candidats sur 28107 portent les champs bruts (85%).*

- `5c556c16ea8b` — 17852 candidats
  - AVEC connectivite (7215) : resistance **41.0%**
  - SANS connectivite (10637) : resistance **21.5%**
...
- `5c556c16ea8b` — 17852 candidats
  - AVEC connectivite (7215) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (10637) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 11868 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11815 avec CONNECTED, 53 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 89048 systemes
  - sans CONNECTED : 0.0% sur 20101 systemes
