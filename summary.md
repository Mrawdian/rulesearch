...
genere 2026-08-29 15:46 UTC — 187874 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 104530 systemes
...
- moteur actif `0caa9267db60` (144132 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 91806 | 45666 | 6246 | 3088 | 9235 | 7302 | 9658 | 9441 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 89953 | 21008 | 37963 | 43 | 12439 | 4616 | 36 | 13842 | 15.4% |
...
- candidats AVEC connectivite : 9568, dont T2 : 100%
- candidats SANS connectivite : 14152, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9932 systemes avec CONNECTED sur 77400 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*19430 candidats sur 23720 portent les champs bruts (82%).*

- `5c556c16ea8b` — 13465 candidats
  - AVEC connectivite (5440) : resistance **41.2%**
  - SANS connectivite (8025) : resistance **21.6%**
...
- `5c556c16ea8b` — 13465 candidats
  - AVEC connectivite (5440) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (8025) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.34**
...
- TROP-CHER : 9978 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 9932 avec CONNECTED, 46 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 74899 systemes
  - sans CONNECTED : 0.0% sur 16907 systemes
