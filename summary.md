...
genere 2026-08-27 08:07 UTC — 88537 systemes evalues
...
- moteur actif `0caa9267db60` (44795 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 41644 | 20733 | 2863 | 1413 | 4160 | 3273 | 4389 | 4275 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 40778 | 9382 | 17344 | 22 | 5658 | 2122 | 21 | 6229 | 15.3% |
...
- candidats SANS connectivite : 6539, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4663 systemes avec CONNECTED sur 36536 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6651 candidats sur 10941 portent les champs bruts (61%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 686 candidats
  - AVEC connectivite (274) : resistance **40.6%**
  - SANS connectivite (412) : resistance **21.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 686 candidats
  ...
  - SANS connectivite (412) : T0=15.83 T1=0.00 T2=2.63 — pondere **5.26**
...
**7 serie(s) reproductible(s) sur 14 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `ab89a63b01ef` (p=0.0005), `06fe04a859f1` (p=0.0005), `5c556c16ea8b` (p=0.0070), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
...
- TROP-CHER : 4694 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4663 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 34035 systemes
  - sans CONNECTED : 0.0% sur 7609 systemes
