...
genere 2026-08-27 00:38 UTC — 72063 systemes evalues
...
- moteur actif `0caa9267db60` (28321 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 33329 | 16565 | 2289 | 1130 | 3310 | 2647 | 3556 | 3406 | 10.2% |
...
- candidats AVEC connectivite : 3533, dont T2 : 100%
- candidats SANS connectivite : 5291, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3830 systemes avec CONNECTED sur 29761 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4534 candidats sur 8824 portent les champs bruts (51%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 857 candidats
  - AVEC connectivite (353) : resistance **41.0%**
...
- `ab89a63b01ef` — 857 candidats
  - AVEC connectivite (353) : T0=13.08 T1=0.00 T2=3.05 — pondere **6.10**
...
- TROP-CHER : 3856 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 3830 avec CONNECTED, 26 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 27260 systemes
  - sans CONNECTED : 0.0% sur 6069 systemes
