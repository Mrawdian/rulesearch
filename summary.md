...
genere 2026-08-27 22:04 UTC — 116133 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 32789 systemes
...
- moteur actif `0caa9267db60` (72391 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 55575 | 27690 | 3843 | 1889 | 5499 | 4398 | 5869 | 5669 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 54443 | 12555 | 23123 | 26 | 7552 | 2820 | 25 | 8340 | 15.3% |
...
- candidats AVEC connectivite : 5796, dont T2 : 100%
- candidats SANS connectivite : 8650, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6143 systemes avec CONNECTED sur 47904 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10156 candidats sur 14446 portent les champs bruts (70%).*

- `5c556c16ea8b` — 4191 candidats
  - AVEC connectivite (1668) : resistance **42.0%**
  - SANS connectivite (2523) : resistance **22.5%**
...
- `5c556c16ea8b` — 4191 candidats
  - AVEC connectivite (1668) : T0=12.93 T1=0.00 T2=3.05 — pondere **6.11**
  - SANS connectivite (2523) : T0=15.79 T1=0.00 T2=2.72 — pondere **5.44**
...
- TROP-CHER : 6178 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6143 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 45403 systemes
  - sans CONNECTED : 0.0% sur 10172 systemes
