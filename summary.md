...
genere 2026-08-26 12:33 UTC — 44137 systemes evalues
...
| connect | 4 | 3 | 19218 | 9583 | 1256 | 669 | 1918 | 1528 | 2076 | 1951 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 18804 | 4411 | 7923 | 13 | 2591 | 978 | 7 | 2881 | 15.3% |
...
- candidats AVEC connectivite : 2078, dont T2 : 100%
- candidats SANS connectivite : 3191, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2350 systemes avec CONNECTED sur 18191 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*979 candidats sur 5269 portent les champs bruts (19%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `e40600351a72` — 58 candidats
  - AVEC connectivite (27) : resistance **35.6%**
  - SANS connectivite (31) : resistance **19.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e40600351a72` — 58 candidats
  - AVEC connectivite (27) : T0=13.48 T1=0.00 T2=2.81 — pondere **5.63**
  - SANS connectivite (31) : T0=17.29 T1=0.00 T2=2.58 — pondere **5.16**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 15690 systemes
  - sans CONNECTED : 0.0% sur 3528 systemes
