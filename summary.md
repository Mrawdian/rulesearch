...
genere 2026-08-26 14:28 UTC — 48998 systemes evalues
...
- moteur actif `0caa9267db60` (5256 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21666 | 10807 | 1443 | 745 | 2147 | 1721 | 2318 | 2211 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 21217 | 4935 | 8958 | 13 | 2940 | 1095 | 8 | 3268 | 15.4% |
...
- candidats AVEC connectivite : 2338, dont T2 : 100%
- candidats SANS connectivite : 3578, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2592 systemes avec CONNECTED sur 20209 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1626 candidats sur 5916 portent les champs bruts (27%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 511 candidats
  - AVEC connectivite (200) : resistance **40.1%**
  - SANS connectivite (311) : resistance **20.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 511 candidats
  - AVEC connectivite (200) : T0=13.43 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (311) : T0=16.07 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17708 systemes
  - sans CONNECTED : 0.0% sur 3958 systemes
