...
genere 2026-08-26 18:17 UTC — 57939 systemes evalues
...
- moteur actif `0caa9267db60` (14197 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `84fba70921e0`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 26193 | 13050 | 1783 | 888 | 2597 | 2067 | 2796 | 2688 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 25631 | 5898 | 10865 | 15 | 3579 | 1314 | 10 | 3950 | 15.4% |
...
- candidats AVEC connectivite : 2815, dont T2 : 100%
- candidats SANS connectivite : 4260, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3070 systemes avec CONNECTED sur 23918 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2785 candidats sur 7075 portent les champs bruts (39%).*
...
- `0a74109317e5` — 80 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `e80bc1b2b437` — 56 candidats
  - AVEC connectivite (30) : resistance **39.1%**
  - SANS connectivite (26) : resistance **17.9%**
  - test de permutation : **p = 0.0020** — significatif.
...
- `e80bc1b2b437` — 56 candidats
  - AVEC connectivite (30) : T0=12.83 T1=0.00 T2=2.63 — pondere **5.27**
  - SANS connectivite (26) : T0=15.81 T1=0.00 T2=2.42 — pondere **4.85**
  - test de permutation : **p = 0.6507** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `b71bb0907fb5` — 53 candidats
...
- TROP-CHER : 3090 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3070 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 21417 systemes
  - sans CONNECTED : 0.0% sur 4776 systemes
