...
genere 2026-08-26 14:53 UTC — 49916 systemes evalues
...
- moteur actif `0caa9267db60` (6174 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22131 | 11039 | 1484 | 759 | 2195 | 1754 | 2370 | 2252 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 21670 | 5033 | 9140 | 13 | 3019 | 1114 | 9 | 3342 | 15.4% |
...
- candidats AVEC connectivite : 2379, dont T2 : 100%
- candidats SANS connectivite : 3652, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2644 systemes avec CONNECTED sur 20577 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1741 candidats sur 6031 portent les champs bruts (29%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 626 candidats
  - AVEC connectivite (241) : resistance **41.0%**
  - SANS connectivite (385) : resistance **21.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 626 candidats
  - AVEC connectivite (241) : T0=13.38 T1=0.00 T2=3.03 — pondere **6.07**
  - SANS connectivite (385) : T0=16.03 T1=0.00 T2=2.68 — pondere **5.35**
...
- TROP-CHER : 2663 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2644 avec CONNECTED, 19 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18076 systemes
  - sans CONNECTED : 0.0% sur 4055 systemes
