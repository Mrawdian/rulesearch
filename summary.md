...
| connect | 4 | 3 | 7202 | 3623 | 473 | 250 | 682 | 585 | 752 | 756 | 10.5% |
| ref | 4 | 3 | 7024 | 1700 | 2922 | 1 | 943 | 349 | 2 | 1107 | 15.8% |
...
- candidats AVEC connectivite : 759, dont T2 : 100%
- candidats SANS connectivite : 1111, dont T2 : 100%
...
- **752 systemes avec CONNECTED sur 5964 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 705 candidats
  - AVEC connectivite (280) : T0=13.22 T1=0.00 T2=2.92 — pondere **5.85**
  - SANS connectivite (425) : T0=15.80 T1=0.00 T2=2.65 — pondere **5.29**
...
- TROP-CHER : 754 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 752 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 5907 systemes
  - sans CONNECTED : 0.0% sur 1295 systemes
