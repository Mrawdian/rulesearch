...
genere 2026-09-02 23:06 UTC — 323180 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 239836 systemes
...
- moteur actif `0caa9267db60` (279438 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 160130 | 79537 | 10884 | 5355 | 16313 | 12620 | 16971 | 16401 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 156935 | 36586 | 66324 | 64 | 21710 | 8101 | 65 | 24073 | 15.3% |
...
- candidats AVEC connectivite : 16528, dont T2 : 100%
...
- **17245 systemes avec CONNECTED sur 133144 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*36621 candidats sur 40911 portent les champs bruts (90%).*

- `5c556c16ea8b` — 30656 candidats
  - AVEC connectivite (12400) : resistance **41.1%**
...
- `5c556c16ea8b` — 30656 candidats
  - AVEC connectivite (12400) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 17320 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 17245 avec CONNECTED, 75 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 130643 systemes
  - sans CONNECTED : 0.0% sur 29487 systemes
