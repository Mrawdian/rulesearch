...
genere 2026-08-27 06:51 UTC — 85858 systemes evalues
...
- moteur actif `0caa9267db60` (42116 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 40285 | 20054 | 2757 | 1372 | 4022 | 3170 | 4251 | 4138 | 10.3% |
...
- candidats AVEC connectivite : 4265, dont T2 : 100%
- candidats SANS connectivite : 6321, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4525 systemes avec CONNECTED sur 35434 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6296 candidats sur 10586 portent les champs bruts (59%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 331 candidats
  - AVEC connectivite (137) : resistance **42.1%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 331 candidats
  - AVEC connectivite (137) : T0=12.98 T1=0.00 T2=3.08 — pondere **6.16**
...
- TROP-CHER : 4556 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4525 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 32933 systemes
  - sans CONNECTED : 0.0% sur 7352 systemes
