...
genere 2026-09-05 22:03 UTC — 398851 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 315507 systemes
...
- moteur actif `0caa9267db60` (355109 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 198337 | 98467 | 13501 | 6612 | 20150 | 15619 | 21059 | 20406 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 194399 | 45254 | 82007 | 78 | 27075 | 10044 | 72 | 29853 | 15.4% |
...
- candidats SANS connectivite : 30163, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21333 systemes avec CONNECTED sur 164302 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*46406 candidats sur 50696 portent les champs bruts (92%).*

- `5c556c16ea8b` — 40441 candidats
  - AVEC connectivite (16405) : resistance **41.1%**
  - SANS connectivite (24036) : resistance **21.3%**
...
- `5c556c16ea8b` — 40441 candidats
  ...
  - SANS connectivite (24036) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 21415 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21333 avec CONNECTED, 82 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 161801 systemes
  - sans CONNECTED : 0.0% sur 36536 systemes
