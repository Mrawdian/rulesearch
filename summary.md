...
| connect | 4 | 3 | 7937 | 4003 | 515 | 272 | 759 | 633 | 833 | 829 | 10.4% |
| ref | 4 | 3 | 7758 | 1873 | 3252 | 1 | 1043 | 378 | 3 | 1208 | 15.6% |
...
- candidats AVEC connectivite : 832, dont T2 : 100%
- candidats SANS connectivite : 1212, dont T2 : 100%
...
- **833 systemes avec CONNECTED sur 6570 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 879 candidats
  - AVEC connectivite (353) : T0=13.41 T1=0.00 T2=2.84 — pondere **5.68**
  - SANS connectivite (526) : T0=15.83 T1=0.00 T2=2.65 — pondere **5.29**
...
- TROP-CHER : 836 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 833 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 6513 systemes
  - sans CONNECTED : 0.0% sur 1424 systemes
