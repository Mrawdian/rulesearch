...
genere 2026-08-26 14:34 UTC — 49294 systemes evalues
...
- moteur actif `0caa9267db60` (5552 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21816 | 10885 | 1459 | 749 | 2160 | 1728 | 2328 | 2230 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 21363 | 4966 | 9021 | 13 | 2961 | 1100 | 8 | 3294 | 15.4% |
...
- candidats AVEC connectivite : 2357, dont T2 : 100%
- candidats SANS connectivite : 3604, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2602 systemes avec CONNECTED sur 20333 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1671 candidats sur 5961 portent les champs bruts (28%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 556 candidats
  - AVEC connectivite (219) : resistance **40.3%**
  - SANS connectivite (337) : resistance **20.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 556 candidats
  - AVEC connectivite (219) : T0=13.46 T1=0.00 T2=3.02 — pondere **6.05**
  - SANS connectivite (337) : T0=16.07 T1=0.00 T2=2.65 — pondere **5.30**
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0080).
...
- TROP-CHER : 2620 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2602 avec CONNECTED, 18 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17832 systemes
  - sans CONNECTED : 0.0% sur 3984 systemes
