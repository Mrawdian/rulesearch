...
genere 2026-08-28 04:41 UTC — 128829 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 45485 systemes
...
- moteur actif `0caa9267db60` (85087 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 61991 | 30835 | 4276 | 2097 | 6183 | 4919 | 6513 | 6369 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 60723 | 14063 | 25705 | 28 | 8447 | 3141 | 27 | 9310 | 15.3% |
...
- candidats AVEC connectivite : 6496, dont T2 : 100%
- candidats SANS connectivite : 9620, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6787 systemes avec CONNECTED sur 53088 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11826 candidats sur 16116 portent les champs bruts (73%).*

- `5c556c16ea8b` — 5861 candidats
  - AVEC connectivite (2368) : resistance **41.7%**
  - SANS connectivite (3493) : resistance **22.1%**
...
- `5c556c16ea8b` — 5861 candidats
  - AVEC connectivite (2368) : T0=12.99 T1=0.00 T2=3.04 — pondere **6.07**
  - SANS connectivite (3493) : T0=15.85 T1=0.00 T2=2.69 — pondere **5.39**
...
## cout
- temps total 39.6 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 6824 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6787 avec CONNECTED, 37 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 50587 systemes
  - sans CONNECTED : 0.0% sur 11404 systemes
