...
genere 2026-08-27 17:34 UTC — 107583 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 24239 systemes
...
- moteur actif `0caa9267db60` (63841 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 51246 | 25537 | 3543 | 1754 | 5076 | 4058 | 5402 | 5212 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 50222 | 11637 | 21300 | 26 | 6935 | 2624 | 23 | 7675 | 15.3% |
...
- candidats AVEC connectivite : 5339, dont T2 : 100%
- candidats SANS connectivite : 7985, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5676 systemes avec CONNECTED sur 44364 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*9034 candidats sur 13324 portent les champs bruts (68%).*
...
- `5c556c16ea8b` — 3069 candidats
  - AVEC connectivite (1211) : resistance **42.1%**
  - SANS connectivite (1858) : resistance **22.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 3069 candidats
  - AVEC connectivite (1211) : T0=12.99 T1=0.00 T2=3.07 — pondere **6.14**
  - SANS connectivite (1858) : T0=15.78 T1=0.00 T2=2.69 — pondere **5.39**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 2280 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 41863 systemes
  - sans CONNECTED : 0.0% sur 9383 systemes
