...
genere 2026-08-26 14:48 UTC — 49766 systemes evalues
...
- moteur actif `0caa9267db60` (6024 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22056 | 11003 | 1480 | 754 | 2187 | 1747 | 2361 | 2246 | 10.2% |
...
- candidats AVEC connectivite : 2373, dont T2 : 100%
- candidats SANS connectivite : 3636, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2635 systemes avec CONNECTED sur 20520 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1719 candidats sur 6009 portent les champs bruts (29%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 604 candidats
  - AVEC connectivite (235) : resistance **41.1%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 604 candidats
  - AVEC connectivite (235) : T0=13.37 T1=0.00 T2=3.04 — pondere **6.09**
...
- TROP-CHER : 2654 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2635 avec CONNECTED, 19 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18019 systemes
  - sans CONNECTED : 0.0% sur 4037 systemes
