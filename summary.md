...
| connect | 4 | 3 | 6263 | 3161 | 401 | 227 | 603 | 501 | 646 | 651 | 10.4% |
| ref | 4 | 3 | 6124 | 1484 | 2547 | 1 | 822 | 301 | 2 | 967 | 15.8% |
...
- candidats AVEC connectivite : 654, dont T2 : 100%
- candidats SANS connectivite : 971, dont T2 : 100%
...
- **646 systemes avec CONNECTED sur 5191 (12.4%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 460 candidats
  - AVEC connectivite (175) : T0=13.23 T1=0.00 T2=2.94 — pondere **5.87**
  - SANS connectivite (285) : T0=15.83 T1=0.00 T2=2.61 — pondere **5.23**
...
- TROP-CHER : 648 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 646 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.6% sur 5134 systemes
  - sans CONNECTED : 0.0% sur 1129 systemes
