...
genere 2026-08-26 13:16 UTC — 46157 systemes evalues
...
- moteur actif `0caa9267db60` (2415 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20232 | 10096 | 1330 | 697 | 2031 | 1604 | 2165 | 2060 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 19810 | 4641 | 8369 | 13 | 2735 | 1026 | 7 | 3019 | 15.2% |
...
- candidats AVEC connectivite : 2187, dont T2 : 100%
- candidats SANS connectivite : 3329, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2439 systemes avec CONNECTED sur 19007 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1226 candidats sur 5516 portent les champs bruts (22%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 111 candidats
  - AVEC connectivite (49) : resistance **38.9%**
...
- `06fe04a859f1` — 111 candidats
  - AVEC connectivite (49) : T0=13.08 T1=0.00 T2=2.78 — pondere **5.55**
  - SANS connectivite (62) : T0=16.69 T1=0.00 T2=2.95 — pondere **5.90**
  - test de permutation : **p = 0.5667** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16506 systemes
  - sans CONNECTED : 0.0% sur 3726 systemes
