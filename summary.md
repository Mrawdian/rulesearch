...
genere 2026-09-09 02:50 UTC — 470416 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 387072 systemes
...
- moteur actif `0caa9267db60` (426674 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 234485 | 116447 | 15987 | 7849 | 23740 | 18363 | 24964 | 24160 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 229816 | 53529 | 96829 | 92 | 32027 | 11872 | 82 | 35366 | 15.4% |
...
- candidats AVEC connectivite : 24287, dont T2 : 100%
- candidats SANS connectivite : 35676, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25238 systemes avec CONNECTED sur 193949 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55673 candidats sur 59963 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49708 candidats
  - AVEC connectivite (20159) : resistance **41.2%**
  - SANS connectivite (29549) : resistance **21.3%**
...
- `5c556c16ea8b` — 49708 candidats
  - AVEC connectivite (20159) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (29549) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 191448 systemes
