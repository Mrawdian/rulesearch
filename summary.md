...
genere 2026-08-26 23:27 UTC — 69501 systemes evalues
...
- moteur actif `0caa9267db60` (25759 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 32042 | 15922 | 2201 | 1075 | 3194 | 2554 | 3418 | 3272 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 31344 | 7222 | 13317 | 18 | 4335 | 1637 | 14 | 4801 | 15.3% |
...
- candidats SANS connectivite : 5111, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3692 systemes avec CONNECTED sur 28690 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4220 candidats sur 8510 portent les champs bruts (50%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 543 candidats
  - AVEC connectivite (219) : resistance **42.3%**
  - SANS connectivite (324) : resistance **22.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 543 candidats
  ...
  - SANS connectivite (324) : T0=16.02 T1=0.00 T2=2.69 — pondere **5.38**
...
- TROP-CHER : 3716 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3692 avec CONNECTED, 24 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 26189 systemes
  - sans CONNECTED : 0.0% sur 5853 systemes
