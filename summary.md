...
genere 2026-08-26 19:49 UTC — 61483 systemes evalues
...
- moteur actif `0caa9267db60` (17741 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27989 | 13945 | 1914 | 943 | 2768 | 2218 | 2981 | 2870 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 27379 | 6326 | 11591 | 15 | 3809 | 1411 | 12 | 4215 | 15.4% |
...
- candidats AVEC connectivite : 2997, dont T2 : 100%
- candidats SANS connectivite : 4525, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3255 systemes avec CONNECTED sur 25409 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3232 candidats sur 7522 portent les champs bruts (43%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 363 candidats
  - AVEC connectivite (153) : resistance **39.1%**
  - SANS connectivite (210) : resistance **19.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 363 candidats
  - AVEC connectivite (153) : T0=13.12 T1=0.00 T2=2.86 — pondere **5.73**
  - SANS connectivite (210) : T0=16.07 T1=0.00 T2=2.62 — pondere **5.24**
...
## cout
- temps total 19.0 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 3277 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3255 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22908 systemes
  - sans CONNECTED : 0.0% sur 5081 systemes
