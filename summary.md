...
genere 2026-08-26 13:50 UTC — 47618 systemes evalues
...
- moteur actif `0caa9267db60` (3876 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20976 | 10470 | 1390 | 721 | 2082 | 1671 | 2235 | 2145 | 10.2% |
...
- candidats AVEC connectivite : 2272, dont T2 : 100%
- candidats SANS connectivite : 3443, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2509 systemes avec CONNECTED sur 19631 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1425 candidats sur 5715 portent les champs bruts (25%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 310 candidats
  - AVEC connectivite (134) : resistance **39.5%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 310 candidats
  - AVEC connectivite (134) : T0=13.43 T1=0.00 T2=2.88 — pondere **5.76**
...
- TROP-CHER : 2526 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2509 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 17130 systemes
  - sans CONNECTED : 0.0% sur 3846 systemes
