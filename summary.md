...
genere 2026-08-30 19:10 UTC — 228026 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 144682 systemes
...
- moteur actif `0caa9267db60` (184284 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 112096 | 55741 | 7613 | 3747 | 11271 | 8865 | 11856 | 11546 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 109815 | 25599 | 46385 | 51 | 15160 | 5670 | 45 | 16895 | 15.4% |
...
- candidats AVEC connectivite : 11673, dont T2 : 100%
- candidats SANS connectivite : 17205, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12130 systemes avec CONNECTED sur 93994 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*24588 candidats sur 28878 portent les champs bruts (85%).*

- `5c556c16ea8b` — 18623 candidats
  - AVEC connectivite (7545) : resistance **41.0%**
  - SANS connectivite (11078) : resistance **21.5%**
...
- `5c556c16ea8b` — 18623 candidats
  - AVEC connectivite (7545) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.97**
  - SANS connectivite (11078) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 12185 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 12130 avec CONNECTED, 55 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 91493 systemes
  - sans CONNECTED : 0.0% sur 20603 systemes
