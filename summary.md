...
genere 2026-09-05 07:35 UTC — 384440 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 301096 systemes
...
- moteur actif `0caa9267db60` (340698 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 191045 | 94886 | 13014 | 6363 | 19425 | 15053 | 20246 | 19619 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 187280 | 43585 | 79062 | 77 | 26047 | 9694 | 70 | 28731 | 15.3% |
...
- candidats AVEC connectivite : 19746, dont T2 : 100%
- candidats SANS connectivite : 29041, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20520 systemes avec CONNECTED sur 158351 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*44497 candidats sur 48787 portent les champs bruts (91%).*

- `5c556c16ea8b` — 38532 candidats
  - AVEC connectivite (15618) : resistance **41.1%**
  - SANS connectivite (22914) : resistance **21.3%**
...
- `5c556c16ea8b` — 38532 candidats
  - AVEC connectivite (15618) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (22914) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 155850 systemes
  - sans CONNECTED : 0.0% sur 35195 systemes
