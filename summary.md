...
genere 2026-08-28 07:32 UTC — 134011 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 50667 systemes
...
- moteur actif `0caa9267db60` (90269 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 64601 | 32084 | 4434 | 2195 | 6482 | 5150 | 6788 | 6633 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 63295 | 14642 | 26792 | 29 | 8814 | 3274 | 28 | 9714 | 15.3% |
...
- candidats SANS connectivite : 10024, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7062 systemes avec CONNECTED sur 55190 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12494 candidats sur 16784 portent les champs bruts (74%).*

- `5c556c16ea8b` — 6529 candidats
  - AVEC connectivite (2632) : resistance **41.4%**
  - SANS connectivite (3897) : resistance **21.9%**
...
- `5c556c16ea8b` — 6529 candidats
  ...
  - SANS connectivite (3897) : T0=15.85 T1=0.00 T2=2.68 — pondere **5.36**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 52689 systemes
  - sans CONNECTED : 0.0% sur 11912 systemes
