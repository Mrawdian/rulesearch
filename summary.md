...
genere 2026-08-29 18:13 UTC — 191418 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 108074 systemes
...
- moteur actif `0caa9267db60` (147676 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 93589 | 46507 | 6377 | 3138 | 9426 | 7443 | 9878 | 9626 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 91714 | 21403 | 38708 | 43 | 12677 | 4719 | 36 | 14122 | 15.4% |
...
- candidats AVEC connectivite : 9753, dont T2 : 100%
...
- **10152 systemes avec CONNECTED sur 78859 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*19895 candidats sur 24185 portent les champs bruts (82%).*

- `5c556c16ea8b` — 13930 candidats
  - AVEC connectivite (5625) : resistance **41.2%**
...
- `5c556c16ea8b` — 13930 candidats
  - AVEC connectivite (5625) : T0=12.99 T1=0.00 T2=2.99 — pondere **5.99**
...
- TROP-CHER : 10198 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10152 avec CONNECTED, 46 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 76358 systemes
  - sans CONNECTED : 0.0% sur 17231 systemes
