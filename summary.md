...
genere 2026-09-01 09:05 UTC — 278251 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 194907 systemes
...
- moteur actif `0caa9267db60` (234509 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 137440 | 68314 | 9303 | 4591 | 13939 | 10849 | 14525 | 14139 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 134696 | 31395 | 56909 | 58 | 18679 | 6975 | 60 | 20609 | 15.3% |
...
- candidats AVEC connectivite : 14266, dont T2 : 100%
- candidats SANS connectivite : 20919, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14799 systemes avec CONNECTED sur 114652 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*30895 candidats sur 35185 portent les champs bruts (88%).*

- `5c556c16ea8b` — 24930 candidats
  - AVEC connectivite (10138) : resistance **41.0%**
  - SANS connectivite (14792) : resistance **21.3%**
...
- `5c556c16ea8b` — 24930 candidats
  - AVEC connectivite (10138) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (14792) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 14869 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14799 avec CONNECTED, 70 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 112151 systemes
  - sans CONNECTED : 0.0% sur 25289 systemes
