...
genere 2026-09-10 06:17 UTC — 493929 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 410585 systemes
...
- moteur actif `0caa9267db60` (450187 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 246355 | 122315 | 16789 | 8270 | 24925 | 19330 | 26265 | 25335 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 241459 | 56312 | 101709 | 96 | 33609 | 12466 | 87 | 37159 | 15.4% |
...
- candidats AVEC connectivite : 25462, dont T2 : 100%
- candidats SANS connectivite : 37469, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **26539 systemes avec CONNECTED sur 203637 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*58641 candidats sur 62931 portent les champs bruts (93%).*

- `5c556c16ea8b` — 52676 candidats
  - AVEC connectivite (21334) : resistance **41.2%**
  - SANS connectivite (31342) : resistance **21.3%**
...
- `5c556c16ea8b` — 52676 candidats
  - AVEC connectivite (21334) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (31342) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 26636 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 26539 avec CONNECTED, 97 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 201136 systemes
  - sans CONNECTED : 0.0% sur 45219 systemes
