...
genere 2026-08-29 19:49 UTC — 193865 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 110521 systemes
...
- moteur actif `0caa9267db60` (150123 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 94828 | 47096 | 6453 | 3192 | 9566 | 7555 | 10009 | 9747 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 92922 | 21668 | 39226 | 43 | 12855 | 4784 | 36 | 14304 | 15.4% |
...
- candidats AVEC connectivite : 9874, dont T2 : 100%
...
- **10283 systemes avec CONNECTED sur 79839 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*20198 candidats sur 24488 portent les champs bruts (82%).*

- `5c556c16ea8b` — 14233 candidats
  - AVEC connectivite (5746) : resistance **41.2%**
...
- `5c556c16ea8b` — 14233 candidats
  - AVEC connectivite (5746) : T0=13.00 T1=0.00 T2=3.00 — pondere **6.00**
...
- TROP-CHER : 10329 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10283 avec CONNECTED, 46 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 77338 systemes
  - sans CONNECTED : 0.0% sur 17490 systemes
