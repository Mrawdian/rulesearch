...
genere 2026-08-26 22:44 UTC — 67898 systemes evalues
...
- moteur actif `0caa9267db60` (24156 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 31219 | 15506 | 2135 | 1048 | 3112 | 2486 | 3332 | 3205 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 30564 | 7041 | 12982 | 18 | 4240 | 1588 | 14 | 4681 | 15.3% |
...
- candidats AVEC connectivite : 3332, dont T2 : 100%
- candidats SANS connectivite : 4991, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3606 systemes avec CONNECTED sur 28018 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4033 candidats sur 8323 portent les champs bruts (48%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 356 candidats
  - AVEC connectivite (152) : resistance **42.6%**
  - SANS connectivite (204) : resistance **22.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 356 candidats
  - AVEC connectivite (152) : T0=12.88 T1=0.00 T2=3.07 — pondere **6.13**
  - SANS connectivite (204) : T0=16.11 T1=0.00 T2=2.74 — pondere **5.48**
  - test de permutation : **p = 0.0475** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `23303c299f39` — 225 candidats
...
**6 serie(s) reproductible(s) sur 13 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `ab89a63b01ef` (p=0.0475), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
...
- TROP-CHER : 3630 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3606 avec CONNECTED, 24 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 25517 systemes
  - sans CONNECTED : 0.0% sur 5702 systemes
