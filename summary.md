...
genere 2026-08-27 01:43 UTC — 74539 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 9632 systemes
...
- moteur actif `0caa9267db60` (30797 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 34584 | 17204 | 2379 | 1172 | 3433 | 2751 | 3678 | 3524 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 33840 | 7801 | 14390 | 20 | 4695 | 1758 | 18 | 5158 | 15.2% |
...
- candidats AVEC connectivite : 3651, dont T2 : 100%
- candidats SANS connectivite : 5468, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3952 systemes avec CONNECTED sur 30791 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4829 candidats sur 9119 portent les champs bruts (53%).*
...
- `ab89a63b01ef` — 1152 candidats
  - AVEC connectivite (471) : resistance **41.2%**
  - SANS connectivite (681) : resistance **21.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1152 candidats
  - AVEC connectivite (471) : T0=13.01 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (681) : T0=15.91 T1=0.00 T2=2.68 — pondere **5.36**
...
- TROP-CHER : 3980 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3952 avec CONNECTED, 28 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 28290 systemes
  - sans CONNECTED : 0.0% sur 6294 systemes
