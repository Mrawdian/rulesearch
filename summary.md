...
genere 2026-08-26 20:32 UTC — 63128 systemes evalues
...
- moteur actif `0caa9267db60` (19386 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 28811 | 14343 | 1973 | 965 | 2856 | 2281 | 3064 | 2965 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 28202 | 6514 | 11958 | 15 | 3914 | 1454 | 12 | 4335 | 15.4% |
...
- candidats AVEC connectivite : 3092, dont T2 : 100%
- candidats SANS connectivite : 4645, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3338 systemes avec CONNECTED sur 26078 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3447 candidats sur 7737 portent les champs bruts (45%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 578 candidats
  - AVEC connectivite (248) : resistance **39.9%**
  - SANS connectivite (330) : resistance **20.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 578 candidats
  - AVEC connectivite (248) : T0=12.79 T1=0.00 T2=2.84 — pondere **5.68**
  - SANS connectivite (330) : T0=16.22 T1=0.00 T2=2.68 — pondere **5.35**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23577 systemes
  - sans CONNECTED : 0.0% sur 5234 systemes
