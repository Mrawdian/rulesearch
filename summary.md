...
genere 2026-08-31 14:40 UTC — 254733 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 171389 systemes
...
- moteur actif `0caa9267db60` (210991 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 125577 | 62419 | 8500 | 4213 | 12687 | 9931 | 13251 | 12927 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 123041 | 28695 | 51937 | 54 | 17040 | 6362 | 56 | 18887 | 15.4% |
...
- candidats AVEC connectivite : 13054, dont T2 : 100%
- candidats SANS connectivite : 19197, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13525 systemes avec CONNECTED sur 104966 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*27961 candidats sur 32251 portent les champs bruts (87%).*

- `5c556c16ea8b` — 21996 candidats
  - AVEC connectivite (8926) : resistance **41.0%**
  - SANS connectivite (13070) : resistance **21.4%**
...
- `5c556c16ea8b` — 21996 candidats
  - AVEC connectivite (8926) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.97**
  - SANS connectivite (13070) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 13591 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13525 avec CONNECTED, 66 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 102465 systemes
  - sans CONNECTED : 0.0% sur 23112 systemes
