...
genere 2026-09-01 19:40 UTC — 291234 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 207890 systemes
...
- moteur actif `0caa9267db60` (247492 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 144006 | 71532 | 9780 | 4821 | 14623 | 11351 | 15226 | 14811 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 141113 | 32807 | 59689 | 59 | 19559 | 7293 | 63 | 21632 | 15.3% |
...
- candidats AVEC connectivite : 14938, dont T2 : 100%
- candidats SANS connectivite : 21942, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15500 systemes avec CONNECTED sur 120019 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*32590 candidats sur 36880 portent les champs bruts (88%).*

- `5c556c16ea8b` — 26625 candidats
  - AVEC connectivite (10810) : resistance **41.0%**
  - SANS connectivite (15815) : resistance **21.3%**
...
- `5c556c16ea8b` — 26625 candidats
  - AVEC connectivite (10810) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (15815) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 15573 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15500 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 117518 systemes
  - sans CONNECTED : 0.0% sur 26488 systemes
