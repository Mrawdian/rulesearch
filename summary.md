...
genere 2026-08-31 18:02 UTC — 259161 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 175817 systemes
...
- moteur actif `0caa9267db60` (215419 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 127819 | 63553 | 8644 | 4288 | 12907 | 10110 | 13482 | 13159 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 125227 | 29173 | 52882 | 56 | 17347 | 6479 | 56 | 19224 | 15.4% |
...
- candidats AVEC connectivite : 13286, dont T2 : 100%
- candidats SANS connectivite : 19534, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13756 systemes avec CONNECTED sur 106799 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*28530 candidats sur 32820 portent les champs bruts (87%).*

- `5c556c16ea8b` — 22565 candidats
  - AVEC connectivite (9158) : resistance **41.0%**
  - SANS connectivite (13407) : resistance **21.4%**
...
- `5c556c16ea8b` — 22565 candidats
  - AVEC connectivite (9158) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.97**
  - SANS connectivite (13407) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 104298 systemes
  - sans CONNECTED : 0.0% sur 23521 systemes
