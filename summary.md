...
genere 2026-08-29 04:32 UTC — 170148 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 86804 systemes
...
- moteur actif `0caa9267db60` (126406 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 82854 | 41247 | 5626 | 2797 | 8323 | 6574 | 8691 | 8540 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 81179 | 18906 | 34356 | 38 | 11237 | 4118 | 34 | 12485 | 15.4% |
...
- candidats AVEC connectivite : 8667, dont T2 : 100%
...
- **8965 systemes avec CONNECTED sur 70117 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*17172 candidats sur 21462 portent les champs bruts (80%).*

- `5c556c16ea8b` — 11207 candidats
  - AVEC connectivite (4539) : resistance **41.2%**
...
- `5c556c16ea8b` — 11207 candidats
  - AVEC connectivite (4539) : T0=13.02 T1=0.00 T2=3.00 — pondere **5.99**
...
- TROP-CHER : 9009 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8965 avec CONNECTED, 44 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 67616 systemes
  - sans CONNECTED : 0.0% sur 15238 systemes
