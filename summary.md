...
genere 2026-08-28 07:40 UTC — 134234 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 50890 systemes
...
- moteur actif `0caa9267db60` (90492 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 64721 | 32150 | 4444 | 2199 | 6492 | 5158 | 6799 | 6644 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 63398 | 14668 | 26830 | 29 | 8822 | 3278 | 28 | 9741 | 15.4% |
...
- candidats AVEC connectivite : 6771, dont T2 : 100%
- candidats SANS connectivite : 10051, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7073 systemes avec CONNECTED sur 55293 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12532 candidats sur 16822 portent les champs bruts (74%).*

- `5c556c16ea8b` — 6567 candidats
  - AVEC connectivite (2643) : resistance **41.4%**
  - SANS connectivite (3924) : resistance **21.9%**
...
- `5c556c16ea8b` — 6567 candidats
  - AVEC connectivite (2643) : T0=12.98 T1=0.00 T2=3.01 — pondere **6.03**
  - SANS connectivite (3924) : T0=15.85 T1=0.00 T2=2.68 — pondere **5.36**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 52792 systemes
  - sans CONNECTED : 0.0% sur 11929 systemes
