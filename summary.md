...
genere 2026-08-26 04:32 UTC — 23619 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 14645 systemes
...
| connect | 4 | 3 | 11880 | 5946 | 778 | 411 | 1143 | 960 | 1287 | 1205 | 10.1% |
...
- candidats AVEC connectivite : 1208, dont T2 : 100%
...
- **1287 systemes avec CONNECTED sur 9785 (13.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1837 candidats
  - AVEC connectivite (729) : T0=13.33 T1=0.00 T2=2.85 — pondere **5.69**
...
- TROP-CHER : 1291 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1287 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 9728 systemes
  - sans CONNECTED : 0.0% sur 2152 systemes
