...
genere 2026-09-02 04:44 UTC — 302201 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 218857 systemes
...
- moteur actif `0caa9267db60` (258459 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 149529 | 74297 | 10167 | 5019 | 15164 | 11772 | 15817 | 15378 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 146557 | 34086 | 62025 | 62 | 20283 | 7566 | 63 | 22460 | 15.3% |
...
- candidats AVEC connectivite : 15505, dont T2 : 100%
- candidats SANS connectivite : 22770, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16091 systemes avec CONNECTED sur 124567 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*33985 candidats sur 38275 portent les champs bruts (89%).*

- `5c556c16ea8b` — 28020 candidats
  - AVEC connectivite (11377) : resistance **41.0%**
  - SANS connectivite (16643) : resistance **21.3%**
...
- `5c556c16ea8b` — 28020 candidats
  - AVEC connectivite (11377) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (16643) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 122066 systemes
  - sans CONNECTED : 0.0% sur 27463 systemes
