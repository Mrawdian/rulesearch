...
genere 2026-09-04 04:21 UTC — 355721 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 272377 systemes
...
- moteur actif `0caa9267db60` (311979 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 176548 | 87737 | 12005 | 5906 | 17969 | 13894 | 18724 | 18066 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 173058 | 40216 | 73075 | 70 | 24043 | 8967 | 68 | 26605 | 15.4% |
...
- candidats AVEC connectivite : 18193, dont T2 : 100%
...
- **18998 systemes avec CONNECTED sur 146560 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*40818 candidats sur 45108 portent les champs bruts (90%).*

- `5c556c16ea8b` — 34853 candidats
  - AVEC connectivite (14065) : resistance **41.0%**
...
- `5c556c16ea8b` — 34853 candidats
  - AVEC connectivite (14065) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 19076 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18998 avec CONNECTED, 78 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 144059 systemes
  - sans CONNECTED : 0.0% sur 32489 systemes
