...
genere 2026-08-29 17:06 UTC — 189846 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 106502 systemes
...
- moteur actif `0caa9267db60` (146104 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 92794 | 46119 | 6320 | 3115 | 9353 | 7375 | 9773 | 9549 | 10.3% |
...
- candidats AVEC connectivite : 9676, dont T2 : 100%
...
- **10047 systemes avec CONNECTED sur 78199 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*19700 candidats sur 23990 portent les champs bruts (82%).*

- `5c556c16ea8b` — 13735 candidats
  - AVEC connectivite (5548) : resistance **41.2%**
...
- `5c556c16ea8b` — 13735 candidats
  - AVEC connectivite (5548) : T0=12.99 T1=0.00 T2=2.99 — pondere **5.99**
...
- TROP-CHER : 10093 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10047 avec CONNECTED, 46 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 75698 systemes
  - sans CONNECTED : 0.0% sur 17096 systemes
