...
genere 2026-08-28 10:33 UTC — 139258 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 55914 systemes
...
- moteur actif `0caa9267db60` (95516 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 67263 | 33420 | 4618 | 2291 | 6740 | 5364 | 7082 | 6888 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 65880 | 15240 | 27841 | 30 | 9176 | 3404 | 28 | 10158 | 15.4% |
...
- candidats AVEC connectivite : 7015, dont T2 : 100%
- candidats SANS connectivite : 10468, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7356 systemes avec CONNECTED sur 57366 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*13193 candidats sur 17483 portent les champs bruts (75%).*

- `5c556c16ea8b` — 7228 candidats
  - AVEC connectivite (2887) : resistance **41.4%**
  - SANS connectivite (4341) : resistance **21.8%**
...
- `5c556c16ea8b` — 7228 candidats
  - AVEC connectivite (2887) : T0=13.00 T1=0.00 T2=3.02 — pondere **6.03**
  - SANS connectivite (4341) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.35**
...
- TROP-CHER : 7394 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7356 avec CONNECTED, 38 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 54865 systemes
  - sans CONNECTED : 0.0% sur 12398 systemes
