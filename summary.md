...
genere 2026-08-28 11:41 UTC — 141169 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 57825 systemes
...
- moteur actif `0caa9267db60` (97427 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 68218 | 33890 | 4685 | 2324 | 6836 | 5437 | 7191 | 6982 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 66836 | 15462 | 28268 | 30 | 9278 | 3455 | 30 | 10310 | 15.4% |
...
- candidats AVEC connectivite : 7109, dont T2 : 100%
- candidats SANS connectivite : 10620, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7465 systemes avec CONNECTED sur 58134 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*13439 candidats sur 17729 portent les champs bruts (76%).*

- `5c556c16ea8b` — 7474 candidats
  - AVEC connectivite (2981) : resistance **41.3%**
  - SANS connectivite (4493) : resistance **21.8%**
...
- `5c556c16ea8b` — 7474 candidats
  - AVEC connectivite (2981) : T0=13.01 T1=0.00 T2=3.01 — pondere **6.02**
  - SANS connectivite (4493) : T0=15.87 T1=0.00 T2=2.68 — pondere **5.35**
...
- TROP-CHER : 7505 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7465 avec CONNECTED, 40 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 55633 systemes
  - sans CONNECTED : 0.0% sur 12585 systemes
