...
genere 2026-08-27 08:03 UTC — 88433 systemes evalues
...
- moteur actif `0caa9267db60` (44691 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 41584 | 20701 | 2859 | 1413 | 4151 | 3271 | 4383 | 4270 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 40734 | 9375 | 17324 | 22 | 5654 | 2117 | 21 | 6221 | 15.3% |
...
- candidats SANS connectivite : 6531, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4657 systemes avec CONNECTED sur 36488 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6638 candidats sur 10928 portent les champs bruts (61%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 673 candidats
  - AVEC connectivite (269) : resistance **40.7%**
  - SANS connectivite (404) : resistance **21.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 673 candidats
  ...
  - SANS connectivite (404) : T0=15.84 T1=0.00 T2=2.64 — pondere **5.29**
...
- TROP-CHER : 4688 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4657 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 33987 systemes
  - sans CONNECTED : 0.0% sur 7597 systemes
