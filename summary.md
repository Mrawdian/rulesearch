...
genere 2026-09-01 20:33 UTC — 292293 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 208949 systemes
...
- moteur actif `0caa9267db60` (248551 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 144530 | 71783 | 9824 | 4838 | 14678 | 11389 | 15288 | 14863 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 141648 | 32927 | 59917 | 59 | 19633 | 7323 | 63 | 21715 | 15.3% |
...
- candidats SANS connectivite : 22025, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15562 systemes avec CONNECTED sur 120445 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*32725 candidats sur 37015 portent les champs bruts (88%).*

- `5c556c16ea8b` — 26760 candidats
  - AVEC connectivite (10862) : resistance **41.0%**
  - SANS connectivite (15898) : resistance **21.4%**
...
- `5c556c16ea8b` — 26760 candidats
  ...
  - SANS connectivite (15898) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 117944 systemes
  - sans CONNECTED : 0.0% sur 26586 systemes
