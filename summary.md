...
genere 2026-08-29 15:48 UTC — 187904 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 104560 systemes
...
- moteur actif `0caa9267db60` (144162 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 91821 | 45676 | 6246 | 3088 | 9235 | 7303 | 9661 | 9442 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 89968 | 21012 | 37969 | 43 | 12443 | 4616 | 36 | 13843 | 15.4% |
...
- candidats AVEC connectivite : 9569, dont T2 : 100%
- candidats SANS connectivite : 14153, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9935 systemes avec CONNECTED sur 77414 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*19432 candidats sur 23722 portent les champs bruts (82%).*

- `5c556c16ea8b` — 13467 candidats
  - AVEC connectivite (5441) : resistance **41.2%**
  - SANS connectivite (8026) : resistance **21.6%**
...
- `5c556c16ea8b` — 13467 candidats
  - AVEC connectivite (5441) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (8026) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.34**
...
- TROP-CHER : 9981 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 9935 avec CONNECTED, 46 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 74913 systemes
  - sans CONNECTED : 0.0% sur 16908 systemes
