...
genere 2026-09-04 00:49 UTC — 352027 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 268683 systemes
...
- moteur actif `0caa9267db60` (308285 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 174696 | 86843 | 11877 | 5842 | 17789 | 13748 | 18499 | 17873 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 171216 | 39790 | 72334 | 70 | 23776 | 8858 | 67 | 26307 | 15.4% |
...
- candidats AVEC connectivite : 18000, dont T2 : 100%
- candidats SANS connectivite : 26617, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18773 systemes avec CONNECTED sur 145044 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*40327 candidats sur 44617 portent les champs bruts (90%).*

- `5c556c16ea8b` — 34362 candidats
  - AVEC connectivite (13872) : resistance **41.0%**
  - SANS connectivite (20490) : resistance **21.3%**
...
- `5c556c16ea8b` — 34362 candidats
  - AVEC connectivite (13872) : T0=13.03 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (20490) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 142543 systemes
  - sans CONNECTED : 0.0% sur 32153 systemes
