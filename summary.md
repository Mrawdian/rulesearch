...
genere 2026-09-04 13:15 UTC — 365330 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 281986 systemes
...
- moteur actif `0caa9267db60` (321588 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 181406 | 90151 | 12334 | 6059 | 18456 | 14292 | 19219 | 18572 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 177809 | 41318 | 75131 | 72 | 24701 | 9207 | 70 | 27296 | 15.4% |
...
- candidats AVEC connectivite : 18699, dont T2 : 100%
- candidats SANS connectivite : 27606, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19493 systemes avec CONNECTED sur 150490 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*42015 candidats sur 46305 portent les champs bruts (91%).*

- `5c556c16ea8b` — 36050 candidats
  - AVEC connectivite (14571) : resistance **41.0%**
  - SANS connectivite (21479) : resistance **21.2%**
...
- `5c556c16ea8b` — 36050 candidats
  - AVEC connectivite (14571) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (21479) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
## cout
- temps total 113.4 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 19573 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19493 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 147989 systemes
  - sans CONNECTED : 0.0% sur 33417 systemes
