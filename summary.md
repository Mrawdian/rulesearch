...
genere 2026-08-28 00:10 UTC — 120168 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 36824 systemes
...
- moteur actif `0caa9267db60` (76426 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 57602 | 28692 | 3982 | 1946 | 5717 | 4554 | 6082 | 5891 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 56451 | 13030 | 23949 | 27 | 7853 | 2914 | 25 | 8651 | 15.3% |
...
- candidats AVEC connectivite : 6018, dont T2 : 100%
- candidats SANS connectivite : 8961, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6356 systemes avec CONNECTED sur 49553 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10689 candidats sur 14979 portent les champs bruts (71%).*

- `5c556c16ea8b` — 4724 candidats
  - AVEC connectivite (1890) : resistance **42.0%**
  - SANS connectivite (2834) : resistance **22.5%**
...
- `5c556c16ea8b` — 4724 candidats
  - AVEC connectivite (1890) : T0=12.98 T1=0.00 T2=3.05 — pondere **6.11**
  - SANS connectivite (2834) : T0=15.79 T1=0.00 T2=2.72 — pondere **5.45**
...
- TROP-CHER : 6391 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6356 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 47052 systemes
  - sans CONNECTED : 0.0% sur 10550 systemes
