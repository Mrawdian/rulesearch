...
genere 2026-09-07 22:27 UTC — 444814 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 361470 systemes
...
- moteur actif `0caa9267db60` (401072 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 221562 | 110048 | 15108 | 7403 | 22420 | 17346 | 23588 | 22826 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 217137 | 50574 | 91506 | 85 | 30266 | 11232 | 77 | 33379 | 15.4% |
...
- candidats AVEC connectivite : 22953, dont T2 : 100%
- candidats SANS connectivite : 33689, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23862 systemes avec CONNECTED sur 183439 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*52352 candidats sur 56642 portent les champs bruts (92%).*

- `5c556c16ea8b` — 46387 candidats
  - AVEC connectivite (18825) : resistance **41.2%**
  - SANS connectivite (27562) : resistance **21.3%**
...
- `5c556c16ea8b` — 46387 candidats
  - AVEC connectivite (18825) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (27562) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
## cout
- temps total 138.6 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 23949 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23862 avec CONNECTED, 87 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 180938 systemes
  - sans CONNECTED : 0.0% sur 40624 systemes
