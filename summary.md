...
**7466 enregistrements (48%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 7877 | 3975 | 514 | 271 | 751 | 625 | 827 | 822 | 10.4% |
| ref | 4 | 3 | 7700 | 1860 | 3222 | 1 | 1034 | 377 | 3 | 1203 | 15.6% |
...
- candidats AVEC connectivite : 825, dont T2 : 100%
- candidats SANS connectivite : 1207, dont T2 : 100%
...
- **827 systemes avec CONNECTED sur 6524 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 867 candidats
  - AVEC connectivite (346) : T0=13.39 T1=0.00 T2=2.84 — pondere **5.69**
  - SANS connectivite (521) : T0=15.81 T1=0.00 T2=2.65 — pondere **5.29**
...
## cout
- temps total 4.8 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 830 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 827 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 6467 systemes
  - sans CONNECTED : 0.0% sur 1410 systemes
