...
genere 2026-08-26 16:09 UTC — 52955 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 7772 systemes
...
- moteur actif `0caa9267db60` (9213 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23669 | 11804 | 1605 | 806 | 2357 | 1874 | 2529 | 2398 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 23171 | 5365 | 9785 | 14 | 3238 | 1179 | 10 | 3580 | 15.5% |
...
- candidats AVEC connectivite : 2525, dont T2 : 100%
- candidats SANS connectivite : 3890, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2803 systemes avec CONNECTED sur 21824 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2125 candidats sur 6415 portent les champs bruts (33%).*
...
- `06fe04a859f1` — 1010 candidats
  - AVEC connectivite (387) : resistance **41.3%**
  - SANS connectivite (623) : resistance **20.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1010 candidats
  - AVEC connectivite (387) : T0=13.18 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (623) : T0=16.00 T1=0.00 T2=2.63 — pondere **5.26**
...
## cout
- temps total 16.4 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2823 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2803 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19323 systemes
  - sans CONNECTED : 0.0% sur 4346 systemes
