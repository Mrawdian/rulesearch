...
| connect | 4 | 3 | 6620 | 3326 | 430 | 237 | 635 | 537 | 689 | 689 | 10.4% |
...
- candidats AVEC connectivite : 692, dont T2 : 100%
...
- **689 systemes avec CONNECTED sur 5480 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 559 candidats
  - AVEC connectivite (213) : T0=13.18 T1=0.00 T2=2.97 — pondere **5.94**
...
- TROP-CHER : 691 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 689 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 5423 systemes
  - sans CONNECTED : 0.0% sur 1197 systemes
