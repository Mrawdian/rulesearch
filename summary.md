...
genere 2026-08-27 23:47 UTC — 119401 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 36057 systemes
...
- moteur actif `0caa9267db60` (75659 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 57217 | 28509 | 3953 | 1938 | 5673 | 4530 | 6044 | 5838 | 10.2% |
...
- candidats AVEC connectivite : 5965, dont T2 : 100%
- candidats SANS connectivite : 8901, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6318 systemes avec CONNECTED sur 49237 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10576 candidats sur 14866 portent les champs bruts (71%).*

- `5c556c16ea8b` — 4611 candidats
  - AVEC connectivite (1837) : resistance **42.0%**
...
- `5c556c16ea8b` — 4611 candidats
  - AVEC connectivite (1837) : T0=12.98 T1=0.00 T2=3.06 — pondere **6.12**
...
- TROP-CHER : 6353 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6318 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 46736 systemes
  - sans CONNECTED : 0.0% sur 10481 systemes
