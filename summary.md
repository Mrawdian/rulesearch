...
genere 2026-08-27 14:45 UTC — 101912 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 18568 systemes
...
- moteur actif `0caa9267db60` (58170 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 48395 | 24118 | 3333 | 1656 | 4804 | 3828 | 5111 | 4920 | 10.2% |
...
- candidats AVEC connectivite : 5047, dont T2 : 100%
- candidats SANS connectivite : 7529, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5385 systemes avec CONNECTED sur 42042 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*8286 candidats sur 12576 portent les champs bruts (66%).*
...
- `5c556c16ea8b` — 2321 candidats
  - AVEC connectivite (919) : resistance **41.6%**
...
- `5c556c16ea8b` — 2321 candidats
  - AVEC connectivite (919) : T0=13.03 T1=0.00 T2=3.03 — pondere **6.06**
...
- TROP-CHER : 5417 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 5385 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 39541 systemes
  - sans CONNECTED : 0.0% sur 8854 systemes
