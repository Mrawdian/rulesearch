...
genere 2026-09-09 00:35 UTC — 468354 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 385010 systemes
...
- moteur actif `0caa9267db60` (424612 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 233440 | 115937 | 15908 | 7813 | 23631 | 18287 | 24865 | 24040 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 228799 | 53288 | 96407 | 92 | 31885 | 11816 | 82 | 35210 | 15.4% |
...
- candidats AVEC connectivite : 24167, dont T2 : 100%
- candidats SANS connectivite : 35520, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25139 systemes avec CONNECTED sur 193102 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55397 candidats sur 59687 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49432 candidats
  - AVEC connectivite (20039) : resistance **41.2%**
  - SANS connectivite (29393) : resistance **21.3%**
...
- `5c556c16ea8b` — 49432 candidats
  - AVEC connectivite (20039) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.97**
  - SANS connectivite (29393) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 190601 systemes
  - sans CONNECTED : 0.0% sur 42839 systemes
