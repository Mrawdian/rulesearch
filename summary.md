...
genere 2026-08-26 13:31 UTC — 46778 systemes evalues
...
- moteur actif `0caa9267db60` (3036 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20544 | 10244 | 1353 | 713 | 2053 | 1633 | 2195 | 2099 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20119 | 4706 | 8495 | 13 | 2790 | 1041 | 7 | 3067 | 15.2% |
...
- candidats AVEC connectivite : 2226, dont T2 : 100%
- candidats SANS connectivite : 3377, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2469 systemes avec CONNECTED sur 19268 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1313 candidats sur 5603 portent les champs bruts (23%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 198 candidats
  - AVEC connectivite (88) : resistance **38.4%**
  - SANS connectivite (110) : resistance **22.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 198 candidats
  - AVEC connectivite (88) : T0=13.45 T1=0.00 T2=2.78 — pondere **5.57**
  - SANS connectivite (110) : T0=16.16 T1=0.00 T2=2.89 — pondere **5.78**
  - test de permutation : **p = 0.6242** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
- TROP-CHER : 2486 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2469 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16767 systemes
  - sans CONNECTED : 0.0% sur 3777 systemes
