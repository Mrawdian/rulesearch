...
genere 2026-09-05 05:20 UTC — 382046 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 298702 systemes
...
- moteur actif `0caa9267db60` (338304 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 189838 | 94278 | 12923 | 6337 | 19309 | 14954 | 20132 | 19475 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 186093 | 43309 | 78594 | 77 | 25840 | 9634 | 70 | 28555 | 15.3% |
...
- candidats AVEC connectivite : 19602, dont T2 : 100%
- candidats SANS connectivite : 28865, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20406 systemes avec CONNECTED sur 157365 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*44177 candidats sur 48467 portent les champs bruts (91%).*

- `5c556c16ea8b` — 38212 candidats
  - AVEC connectivite (15474) : resistance **41.1%**
  - SANS connectivite (22738) : resistance **21.2%**
...
- `5c556c16ea8b` — 38212 candidats
  - AVEC connectivite (15474) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (22738) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 154864 systemes
  - sans CONNECTED : 0.0% sur 34974 systemes
