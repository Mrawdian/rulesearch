...
genere 2026-08-26 14:03 UTC — 48036 systemes evalues
...
- moteur actif `0caa9267db60` (4294 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21186 | 10571 | 1406 | 730 | 2100 | 1685 | 2265 | 2163 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20735 | 4837 | 8753 | 13 | 2876 | 1074 | 7 | 3175 | 15.3% |
...
- candidats AVEC connectivite : 2290, dont T2 : 100%
- candidats SANS connectivite : 3485, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2539 systemes avec CONNECTED sur 19805 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1485 candidats sur 5775 portent les champs bruts (26%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 370 candidats
  - AVEC connectivite (152) : resistance **39.2%**
  - SANS connectivite (218) : resistance **21.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 370 candidats
  - AVEC connectivite (152) : T0=13.39 T1=0.00 T2=2.90 — pondere **5.80**
  - SANS connectivite (218) : T0=16.11 T1=0.00 T2=2.70 — pondere **5.40**
  - test de permutation : **p = 0.2254** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
- TROP-CHER : 2556 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2539 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17304 systemes
  - sans CONNECTED : 0.0% sur 3882 systemes
