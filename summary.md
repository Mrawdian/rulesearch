...
- moteur actif `0caa9267db60` (7550 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22833 | 11379 | 1541 | 775 | 2277 | 1813 | 2448 | 2313 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 22344 | 5182 | 9421 | 14 | 3126 | 1141 | 10 | 3450 | 15.4% |
...
- candidats AVEC connectivite : 2440, dont T2 : 100%
- candidats SANS connectivite : 3760, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2722 systemes avec CONNECTED sur 21134 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1910 candidats sur 6200 portent les champs bruts (31%).*
...
- `06fe04a859f1` — 795 candidats
  - AVEC connectivite (302) : resistance **41.1%**
  - SANS connectivite (493) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 795 candidats
  - AVEC connectivite (302) : T0=13.35 T1=0.00 T2=3.03 — pondere **6.06**
  - SANS connectivite (493) : T0=16.02 T1=0.00 T2=2.63 — pondere **5.25**
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0015), `e3baecf8377b` (p=0.0005).
...
- TROP-CHER : 2742 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2722 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18633 systemes
  - sans CONNECTED : 0.0% sur 4200 systemes
