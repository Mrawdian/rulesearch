...
genere 2026-09-06 00:12 UTC — 401068 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 317724 systemes
...
- moteur actif `0caa9267db60` (357326 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 199454 | 99021 | 13588 | 6645 | 20256 | 15703 | 21163 | 20539 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 195499 | 45483 | 82483 | 78 | 27240 | 10095 | 72 | 30031 | 15.4% |
...
- candidats AVEC connectivite : 20666, dont T2 : 100%
- candidats SANS connectivite : 30341, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21437 systemes avec CONNECTED sur 165227 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*46717 candidats sur 51007 portent les champs bruts (92%).*

- `5c556c16ea8b` — 40752 candidats
  - AVEC connectivite (16538) : resistance **41.0%**
  - SANS connectivite (24214) : resistance **21.3%**
...
- `5c556c16ea8b` — 40752 candidats
  - AVEC connectivite (16538) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.94**
  - SANS connectivite (24214) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 162726 systemes
  - sans CONNECTED : 0.0% sur 36728 systemes
