...
genere 2026-08-26 13:27 UTC — 46615 systemes evalues
...
- moteur actif `0caa9267db60` (2873 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20470 | 10212 | 1349 | 707 | 2045 | 1628 | 2188 | 2089 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20030 | 4693 | 8460 | 13 | 2773 | 1036 | 7 | 3048 | 15.2% |
...
- candidats AVEC connectivite : 2216, dont T2 : 100%
- candidats SANS connectivite : 3358, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2462 systemes avec CONNECTED sur 19207 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1284 candidats sur 5574 portent les champs bruts (23%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 169 candidats
  - AVEC connectivite (78) : resistance **37.7%**
  - SANS connectivite (91) : resistance **23.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 169 candidats
  - AVEC connectivite (78) : T0=13.50 T1=0.00 T2=2.72 — pondere **5.44**
  - SANS connectivite (91) : T0=16.31 T1=0.00 T2=3.00 — pondere **6.00**
  - test de permutation : **p = 0.2274** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 2479 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2462 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16706 systemes
  - sans CONNECTED : 0.0% sur 3764 systemes
