...
| connect | 4 | 3 | 7337 | 3695 | 484 | 254 | 691 | 598 | 766 | 768 | 10.5% |
| ref | 4 | 3 | 7156 | 1729 | 2981 | 1 | 960 | 354 | 2 | 1129 | 15.8% |
...
- candidats AVEC connectivite : 771, dont T2 : 100%
- candidats SANS connectivite : 1133, dont T2 : 100%
...
- **766 systemes avec CONNECTED sur 6075 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 739 candidats
  - AVEC connectivite (292) : T0=13.22 T1=0.00 T2=2.94 — pondere **5.88**
  - SANS connectivite (447) : T0=15.80 T1=0.00 T2=2.64 — pondere **5.28**
...
- TROP-CHER : 768 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 766 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 6018 systemes
  - sans CONNECTED : 0.0% sur 1319 systemes
