...
genere 2026-08-26 02:16 UTC — 17882 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 8908 systemes
...
| connect | 4 | 3 | 8984 | 4525 | 582 | 299 | 863 | 712 | 971 | 921 | 10.3% |
| ref | 4 | 3 | 8774 | 2114 | 3684 | 2 | 1171 | 432 | 3 | 1368 | 15.6% |
...
- candidats AVEC connectivite : 924, dont T2 : 100%
- candidats SANS connectivite : 1372, dont T2 : 100%
...
- **971 systemes avec CONNECTED sur 7443 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1131 candidats
  - AVEC connectivite (445) : T0=13.35 T1=0.00 T2=2.90 — pondere **5.80**
  - SANS connectivite (686) : T0=15.88 T1=0.00 T2=2.67 — pondere **5.35**
  - test de permutation : **p = 0.0230** — ecart significatif au seuil 0.05
...
- TROP-CHER : 974 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 971 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 7386 systemes
  - sans CONNECTED : 0.0% sur 1598 systemes
