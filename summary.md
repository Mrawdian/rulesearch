...
genere 2026-08-26 22:31 UTC — 67423 systemes evalues
...
- moteur actif `0caa9267db60` (23681 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 30979 | 15381 | 2121 | 1040 | 3085 | 2470 | 3305 | 3182 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 30329 | 6985 | 12877 | 18 | 4201 | 1578 | 14 | 4656 | 15.4% |
...
- candidats AVEC connectivite : 3309, dont T2 : 100%
- candidats SANS connectivite : 4966, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3579 systemes avec CONNECTED sur 27827 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3985 candidats sur 8275 portent les champs bruts (48%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 308 candidats
  - AVEC connectivite (129) : resistance **43.0%**
  - SANS connectivite (179) : resistance **22.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 308 candidats
  - AVEC connectivite (129) : T0=12.83 T1=0.00 T2=3.09 — pondere **6.19**
  - SANS connectivite (179) : T0=16.17 T1=0.00 T2=2.79 — pondere **5.59**
  - test de permutation : **p = 0.1004** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- TROP-CHER : 3603 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3579 avec CONNECTED, 24 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 25326 systemes
  - sans CONNECTED : 0.0% sur 5653 systemes
