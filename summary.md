...
genere 2026-08-26 13:20 UTC — 46261 systemes evalues
...
- moteur actif `0caa9267db60` (2519 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20291 | 10125 | 1335 | 699 | 2032 | 1611 | 2172 | 2067 | 10.2% |
...
- candidats AVEC connectivite : 2194, dont T2 : 100%
- candidats SANS connectivite : 3334, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2446 systemes avec CONNECTED sur 19059 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1238 candidats sur 5528 portent les champs bruts (22%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 123 candidats
  - AVEC connectivite (56) : resistance **38.2%**
...
- `06fe04a859f1` — 123 candidats
  - AVEC connectivite (56) : T0=12.96 T1=0.00 T2=2.75 — pondere **5.50**
  - SANS connectivite (67) : T0=16.60 T1=0.00 T2=2.94 — pondere **5.88**
  - test de permutation : **p = 0.5077** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16558 systemes
  - sans CONNECTED : 0.0% sur 3733 systemes
