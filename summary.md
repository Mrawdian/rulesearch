...
| connect | 4 | 3 | 18980 | 9477 | 1241 | 659 | 1888 | 1512 | 2050 | 1918 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 18588 | 4366 | 7837 | 13 | 2551 | 966 | 7 | 2848 | 15.3% |
...
- candidats AVEC connectivite : 2045, dont T2 : 100%
- candidats SANS connectivite : 3158, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2324 systemes avec CONNECTED sur 17993 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*913 candidats sur 5203 portent les champs bruts (18%).*
...
- `e3baecf8377b` — 649 candidats
  - AVEC connectivite (262) : resistance **42.0%**
  - SANS connectivite (387) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 649 candidats
  - AVEC connectivite (262) : T0=13.03 T1=0.00 T2=3.08 — pondere **6.17**
  - SANS connectivite (387) : T0=15.99 T1=0.00 T2=2.61 — pondere **5.22**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
...
- TROP-CHER : 2341 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2324 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 15492 systemes
  - sans CONNECTED : 0.0% sur 3488 systemes
