...
- moteur actif `0caa9267db60` (47871 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 43199 | 21528 | 2963 | 1458 | 4315 | 3401 | 4549 | 4423 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 42299 | 9757 | 17948 | 25 | 5867 | 2209 | 22 | 6470 | 15.3% |
...
- candidats AVEC connectivite : 4550, dont T2 : 100%
- candidats SANS connectivite : 6780, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4823 systemes avec CONNECTED sur 37792 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*7040 candidats sur 11330 portent les champs bruts (62%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 1075 candidats
  - AVEC connectivite (422) : resistance **41.2%**
  - SANS connectivite (653) : resistance **21.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 1075 candidats
  - AVEC connectivite (422) : T0=13.04 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (653) : T0=15.81 T1=0.00 T2=2.64 — pondere **5.27**
...
**7 serie(s) reproductible(s) sur 14 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `ab89a63b01ef` (p=0.0005), `06fe04a859f1` (p=0.0005), `5c556c16ea8b` (p=0.0010), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
...
## cout
- temps total 28.2 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 4855 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4823 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 35291 systemes
  - sans CONNECTED : 0.0% sur 7908 systemes
