...
genere 2026-08-27 00:00 UTC — 70697 systemes evalues
...
- moteur actif `0caa9267db60` (26955 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 32640 | 16226 | 2240 | 1103 | 3251 | 2596 | 3482 | 3324 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 31942 | 7359 | 13562 | 18 | 4432 | 1670 | 15 | 4886 | 15.3% |
...
- candidats AVEC connectivite : 3451, dont T2 : 100%
- candidats SANS connectivite : 5196, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3756 systemes avec CONNECTED sur 29183 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4357 candidats sur 8647 portent les champs bruts (50%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 680 candidats
  - AVEC connectivite (271) : resistance **41.6%**
  - SANS connectivite (409) : resistance **21.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 680 candidats
  - AVEC connectivite (271) : T0=13.13 T1=0.00 T2=3.10 — pondere **6.21**
  - SANS connectivite (409) : T0=15.98 T1=0.00 T2=2.63 — pondere **5.25**
...
- TROP-CHER : 3781 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3756 avec CONNECTED, 25 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 26682 systemes
  - sans CONNECTED : 0.0% sur 5958 systemes
