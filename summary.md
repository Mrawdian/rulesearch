...
genere 2026-08-31 13:24 UTC — 253013 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 169669 systemes
...
- moteur actif `0caa9267db60` (209271 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 124709 | 62017 | 8448 | 4176 | 12591 | 9844 | 13165 | 12834 | 10.3% |
...
- candidats AVEC connectivite : 12961, dont T2 : 100%
...
- **13439 systemes avec CONNECTED sur 104267 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*27733 candidats sur 32023 portent les champs bruts (87%).*

- `5c556c16ea8b` — 21768 candidats
  - AVEC connectivite (8833) : resistance **41.0%**
...
- `5c556c16ea8b` — 21768 candidats
  - AVEC connectivite (8833) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 13505 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13439 avec CONNECTED, 66 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 101766 systemes
