...
genere 2026-09-01 17:17 UTC — 288349 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 205005 systemes
...
- moteur actif `0caa9267db60` (244607 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 142541 | 70814 | 9667 | 4766 | 14474 | 11247 | 15068 | 14662 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 139693 | 32480 | 59086 | 59 | 19368 | 7235 | 63 | 21391 | 15.3% |
...
- candidats AVEC connectivite : 14789, dont T2 : 100%
- candidats SANS connectivite : 21701, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15342 systemes avec CONNECTED sur 118815 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*32200 candidats sur 36490 portent les champs bruts (88%).*

- `5c556c16ea8b` — 26235 candidats
  - AVEC connectivite (10661) : resistance **41.0%**
  - SANS connectivite (15574) : resistance **21.3%**
...
- `5c556c16ea8b` — 26235 candidats
  - AVEC connectivite (10661) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (15574) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 15415 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15342 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 116314 systemes
  - sans CONNECTED : 0.0% sur 26227 systemes
