...
genere 2026-08-31 05:05 UTC — 241689 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 158345 systemes
...
- moteur actif `0caa9267db60` (197947 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 118990 | 59198 | 8088 | 3990 | 11945 | 9378 | 12596 | 12245 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 116584 | 27214 | 49271 | 53 | 16096 | 6018 | 52 | 17870 | 15.3% |
...
- candidats SANS connectivite : 18180, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12870 systemes avec CONNECTED sur 99683 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*26262 candidats sur 30552 portent les champs bruts (86%).*

- `5c556c16ea8b` — 20297 candidats
  - AVEC connectivite (8244) : resistance **40.9%**
  - SANS connectivite (12053) : resistance **21.4%**
...
- `5c556c16ea8b` — 20297 candidats
  ...
  - SANS connectivite (12053) : T0=15.90 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 97182 systemes
  - sans CONNECTED : 0.0% sur 21808 systemes
