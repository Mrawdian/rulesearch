...
genere 2026-08-27 08:31 UTC — 89411 systemes evalues
...
- moteur actif `0caa9267db60` (45669 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 42078 | 20950 | 2893 | 1423 | 4199 | 3307 | 4433 | 4328 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 41218 | 9502 | 17523 | 23 | 5708 | 2144 | 22 | 6296 | 15.3% |
...
- candidats AVEC connectivite : 4455, dont T2 : 100%
- candidats SANS connectivite : 6606, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4707 systemes avec CONNECTED sur 36890 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6771 candidats sur 11061 portent les champs bruts (61%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 806 candidats
  - AVEC connectivite (327) : resistance **41.1%**
  - SANS connectivite (479) : resistance **21.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 806 candidats
  - AVEC connectivite (327) : T0=13.11 T1=0.00 T2=3.00 — pondere **6.01**
  - SANS connectivite (479) : T0=15.91 T1=0.00 T2=2.64 — pondere **5.29**
...
- TROP-CHER : 4739 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4707 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 34389 systemes
  - sans CONNECTED : 0.0% sur 7689 systemes
