...
genere 2026-08-26 04:30 UTC — 23544 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 14570 systemes
...
| connect | 4 | 3 | 11835 | 5926 | 775 | 409 | 1138 | 955 | 1283 | 1200 | 10.1% |
...
- candidats AVEC connectivite : 1203, dont T2 : 100%
...
- **1283 systemes avec CONNECTED sur 9748 (13.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1825 candidats
  - AVEC connectivite (724) : T0=13.34 T1=0.00 T2=2.84 — pondere **5.69**
...
- TROP-CHER : 1287 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1283 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 9691 systemes
  - sans CONNECTED : 0.0% sur 2144 systemes
