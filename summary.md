...
- moteur actif `0caa9267db60` (7389 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22743 | 11335 | 1531 | 773 | 2269 | 1805 | 2436 | 2309 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 22273 | 5165 | 9393 | 13 | 3113 | 1139 | 10 | 3440 | 15.4% |
...
- candidats SANS connectivite : 3750, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2710 systemes avec CONNECTED sur 21065 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1896 candidats sur 6186 portent les champs bruts (31%).*
...
- `06fe04a859f1` — 781 candidats
  - AVEC connectivite (298) : resistance **41.1%**
  - SANS connectivite (483) : resistance **20.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 781 candidats
  ...
  - SANS connectivite (483) : T0=16.04 T1=0.00 T2=2.61 — pondere **5.23**
...
- TROP-CHER : 2730 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2710 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18564 systemes
  - sans CONNECTED : 0.0% sur 4179 systemes
