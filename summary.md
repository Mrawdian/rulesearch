...
genere 2026-08-30 05:02 UTC — 207978 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 124634 systemes
...
- moteur actif `0caa9267db60` (164236 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 101974 | 50643 | 6942 | 3410 | 10292 | 8134 | 10742 | 10481 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 99889 | 23262 | 42205 | 45 | 13799 | 5156 | 38 | 15377 | 15.4% |
...
- candidats AVEC connectivite : 10608, dont T2 : 100%
- candidats SANS connectivite : 15687, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11016 systemes avec CONNECTED sur 85664 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*22005 candidats sur 26295 portent les champs bruts (84%).*

- `5c556c16ea8b` — 16040 candidats
  - AVEC connectivite (6480) : resistance **41.1%**
  - SANS connectivite (9560) : resistance **21.5%**
...
- `5c556c16ea8b` — 16040 candidats
  - AVEC connectivite (6480) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (9560) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 11064 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11016 avec CONNECTED, 48 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 83163 systemes
  - sans CONNECTED : 0.0% sur 18811 systemes
