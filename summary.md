...
genere 2026-08-31 15:16 UTC — 255603 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 172259 systemes
...
- moteur actif `0caa9267db60` (211861 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 126024 | 62659 | 8526 | 4224 | 12734 | 9967 | 13285 | 12976 | 10.3% |
...
- candidats AVEC connectivite : 13103, dont T2 : 100%
...
- **13559 systemes avec CONNECTED sur 105329 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*28079 candidats sur 32369 portent les champs bruts (87%).*

- `5c556c16ea8b` — 22114 candidats
  - AVEC connectivite (8975) : resistance **41.0%**
...
- `5c556c16ea8b` — 22114 candidats
  - AVEC connectivite (8975) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.97**
...
- TROP-CHER : 13625 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13559 avec CONNECTED, 66 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 102828 systemes
  - sans CONNECTED : 0.0% sur 23196 systemes
