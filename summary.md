...
genere 2026-08-27 04:10 UTC — 79887 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 14980 systemes
...
- moteur actif `0caa9267db60` (36145 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 37291 | 18542 | 2572 | 1271 | 3700 | 2937 | 3955 | 3831 | 10.3% |
...
- candidats AVEC connectivite : 3958, dont T2 : 100%
- candidats SANS connectivite : 5867, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4229 systemes avec CONNECTED sur 33027 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5535 candidats sur 9825 portent les champs bruts (56%).*
...
- `ab89a63b01ef` — 1858 candidats
  - AVEC connectivite (778) : resistance **41.3%**
...
- `ab89a63b01ef` — 1858 candidats
  - AVEC connectivite (778) : T0=13.06 T1=0.00 T2=3.04 — pondere **6.07**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 30526 systemes
  - sans CONNECTED : 0.0% sur 6765 systemes
