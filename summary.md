...
genere 2026-08-25 20:10 UTC — 2351 systemes evalues

## versions du DSL presentes
- `615abe43d6bc` : 1374 systemes
...
| connect | 4 | 3 | 1133 | 581 | 84 | 46 | 127 | 82 | 97 | 102 | 9.0% |
...
- candidats AVEC connectivite : 105, dont T2 : 100%
- candidats SANS connectivite : 172, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **97 systemes avec CONNECTED sur 977 (9.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- TROP-CHER : 98 systemes abandonnes (4.2% des systemes), 94% du temps total
  dont 97 avec CONNECTED, 1 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 10.5% sur 920 systemes
