...
| connect | 4 | 3 | 8102 | 4079 | 527 | 277 | 774 | 647 | 857 | 848 | 10.5% |
| ref | 4 | 3 | 7905 | 1911 | 3319 | 1 | 1053 | 386 | 3 | 1232 | 15.6% |
...
- candidats SANS connectivite : 1236, dont T2 : 100%
...
- **857 systemes avec CONNECTED sur 6708 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 922 candidats
  - AVEC connectivite (372) : T0=13.44 T1=0.00 T2=2.84 — pondere **5.69**
  - SANS connectivite (550) : T0=15.86 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 860 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 857 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 6651 systemes
  - sans CONNECTED : 0.0% sur 1451 systemes
