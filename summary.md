...
genere 2026-08-26 13:10 UTC — 45846 systemes evalues
...
- moteur actif `0caa9267db60` (2104 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20082 | 10032 | 1311 | 692 | 2011 | 1593 | 2152 | 2043 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 19649 | 4605 | 8306 | 13 | 2704 | 1015 | 7 | 2999 | 15.3% |
...
- candidats AVEC connectivite : 2170, dont T2 : 100%
- candidats SANS connectivite : 3309, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2426 systemes avec CONNECTED sur 18888 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1189 candidats sur 5479 portent les champs bruts (22%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 74 candidats
  - AVEC connectivite (32) : resistance **37.1%**
  - SANS connectivite (42) : resistance **19.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 74 candidats
  - AVEC connectivite (32) : T0=13.66 T1=0.00 T2=2.62 — pondere **5.25**
  - SANS connectivite (42) : T0=16.64 T1=0.00 T2=2.64 — pondere **5.29**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16387 systemes
  - sans CONNECTED : 0.0% sur 3695 systemes
