...
genere 2026-08-26 07:19 UTC — 30670 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 21696 systemes
...
| connect | 4 | 3 | 14327 | 7160 | 939 | 495 | 1404 | 1135 | 1564 | 1446 | 10.1% |
...
- candidats AVEC connectivite : 1481, dont T2 : 100%
- candidats SANS connectivite : 2267, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1664 systemes avec CONNECTED sur 12677 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2583 candidats
  - AVEC connectivite (1002) : T0=13.19 T1=0.00 T2=2.88 — pondere **5.77**
...
- TROP-CHER : 1673 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1664 avec CONNECTED, 9 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 11727 systemes
  - sans CONNECTED : 0.0% sur 2600 systemes
