...
genere 2026-08-27 02:44 UTC — 76773 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 11866 systemes
...
- moteur actif `0caa9267db60` (33031 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 35708 | 17777 | 2452 | 1210 | 3541 | 2828 | 3795 | 3643 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 34950 | 8060 | 14864 | 20 | 4832 | 1825 | 19 | 5330 | 15.3% |
...
- candidats AVEC connectivite : 3770, dont T2 : 100%
- candidats SANS connectivite : 5640, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4069 systemes avec CONNECTED sur 31727 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5120 candidats sur 9410 portent les champs bruts (54%).*
...
- `ab89a63b01ef` — 1443 candidats
  - AVEC connectivite (590) : resistance **41.2%**
  - SANS connectivite (853) : resistance **22.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1443 candidats
  - AVEC connectivite (590) : T0=12.97 T1=0.00 T2=3.05 — pondere **6.09**
  - SANS connectivite (853) : T0=15.93 T1=0.00 T2=2.70 — pondere **5.40**
...
**6 serie(s) reproductible(s) sur 13 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `ab89a63b01ef` (p=0.0015), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
...
- TROP-CHER : 4098 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4069 avec CONNECTED, 29 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 29226 systemes
  - sans CONNECTED : 0.0% sur 6482 systemes
