...
genere 2026-09-07 01:08 UTC — 425136 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 341792 systemes
...
- moteur actif `0caa9267db60` (381394 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 211610 | 105074 | 14414 | 7051 | 21456 | 16632 | 22485 | 21813 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 207411 | 48229 | 87504 | 80 | 28910 | 10706 | 73 | 31891 | 15.4% |
...
- candidats AVEC connectivite : 21940, dont T2 : 100%
- candidats SANS connectivite : 32201, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **22759 systemes avec CONNECTED sur 175206 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*49851 candidats sur 54141 portent les champs bruts (92%).*

- `5c556c16ea8b` — 43886 candidats
  - AVEC connectivite (17812) : resistance **41.1%**
  - SANS connectivite (26074) : resistance **21.3%**
...
- `5c556c16ea8b` — 43886 candidats
  - AVEC connectivite (17812) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (26074) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 22842 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 22759 avec CONNECTED, 83 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 172705 systemes
  - sans CONNECTED : 0.0% sur 38905 systemes
