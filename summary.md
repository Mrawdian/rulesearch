...
| connect | 4 | 3 | 5049 | 2533 | 316 | 179 | 491 | 413 | 526 | 533 | 10.6% |
| ref | 4 | 3 | 4926 | 1197 | 2066 | 1 | 649 | 237 | 2 | 774 | 15.7% |
...
- candidats AVEC connectivite : 536, dont T2 : 100%
- candidats SANS connectivite : 778, dont T2 : 100%
...
- **526 systemes avec CONNECTED sur 4185 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 149 candidats
  - AVEC connectivite (57) : T0=13.04 T1=0.00 T2=2.95 — pondere **5.89**
  - SANS connectivite (92) : T0=16.24 T1=0.00 T2=2.82 — pondere **5.63**
...
- TROP-CHER : 528 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 526 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 4128 systemes
  - sans CONNECTED : 0.0% sur 921 systemes
