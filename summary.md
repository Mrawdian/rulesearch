...
genere 2026-08-28 00:38 UTC — 121086 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 37742 systemes
...
- moteur actif `0caa9267db60` (77344 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 58064 | 28920 | 4017 | 1961 | 5764 | 4588 | 6126 | 5945 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 56907 | 13136 | 24144 | 28 | 7907 | 2946 | 26 | 8718 | 15.3% |
...
- candidats SANS connectivite : 9028, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6400 systemes avec CONNECTED sur 49928 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10810 candidats sur 15100 portent les champs bruts (72%).*

- `5c556c16ea8b` — 4845 candidats
  - AVEC connectivite (1944) : resistance **42.1%**
  - SANS connectivite (2901) : resistance **22.4%**
...
- `5c556c16ea8b` — 4845 candidats
  ...
  - SANS connectivite (2901) : T0=15.83 T1=0.00 T2=2.72 — pondere **5.43**
...
- TROP-CHER : 6436 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6400 avec CONNECTED, 36 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 47427 systemes
  - sans CONNECTED : 0.0% sur 10637 systemes
