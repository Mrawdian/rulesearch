...
genere 2026-08-28 15:11 UTC — 147171 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 63827 systemes
...
- moteur actif `0caa9267db60` (103429 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 71248 | 35387 | 4870 | 2427 | 7146 | 5681 | 7523 | 7300 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 69808 | 16206 | 29492 | 32 | 9656 | 3604 | 31 | 10784 | 15.4% |
...
- candidats AVEC connectivite : 7427, dont T2 : 100%
- candidats SANS connectivite : 11094, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7797 systemes avec CONNECTED sur 60616 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*14231 candidats sur 18521 portent les champs bruts (77%).*

- `5c556c16ea8b` — 8266 candidats
  - AVEC connectivite (3299) : resistance **41.2%**
  - SANS connectivite (4967) : resistance **21.8%**
...
- `5c556c16ea8b` — 8266 candidats
  - AVEC connectivite (3299) : T0=13.01 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (4967) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.37**
...
- TROP-CHER : 7838 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7797 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 58115 systemes
  - sans CONNECTED : 0.0% sur 13133 systemes
