...
genere 2026-08-31 22:06 UTC — 264397 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 181053 systemes
...
- moteur actif `0caa9267db60` (220655 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 130458 | 64849 | 8806 | 4382 | 13218 | 10312 | 13766 | 13428 | 10.3% |
...
- candidats AVEC connectivite : 13555, dont T2 : 100%
...
- **14040 systemes avec CONNECTED sur 108948 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*29146 candidats sur 33436 portent les champs bruts (87%).*

- `5c556c16ea8b` — 23181 candidats
  - AVEC connectivite (9427) : resistance **41.0%**
...
- `5c556c16ea8b` — 23181 candidats
  - AVEC connectivite (9427) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.97**
...
- TROP-CHER : 14107 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14040 avec CONNECTED, 67 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 106447 systemes
  - sans CONNECTED : 0.0% sur 24011 systemes
