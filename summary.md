...
genere 2026-08-26 22:23 UTC — 67126 systemes evalues
...
- moteur actif `0caa9267db60` (23384 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 30181 | 6950 | 12821 | 18 | 4177 | 1568 | 14 | 4633 | 15.4% |
...
- candidats SANS connectivite : 4943, dont T2 : 100%
...
*3945 candidats sur 8235 portent les champs bruts (48%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 268 candidats
  - AVEC connectivite (112) : resistance **44.1%**
  - SANS connectivite (156) : resistance **22.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 268 candidats
  ...
  - SANS connectivite (156) : T0=16.01 T1=0.00 T2=2.79 — pondere **5.58**
  - test de permutation : **p = 0.0605** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
