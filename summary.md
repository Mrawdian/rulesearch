...
genere 2026-08-26 16:42 UTC — 54290 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 9107 systemes
...
- moteur actif `0caa9267db60` (10548 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 24344 | 12143 | 1657 | 823 | 2412 | 1923 | 2597 | 2485 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 23831 | 5518 | 10068 | 14 | 3341 | 1209 | 10 | 3671 | 15.4% |
...
- candidats AVEC connectivite : 2612, dont T2 : 100%
- candidats SANS connectivite : 3981, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2871 systemes avec CONNECTED sur 22393 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2303 candidats sur 6593 portent les champs bruts (35%).*
...
- `06fe04a859f1` — 1188 candidats
  - AVEC connectivite (474) : resistance **41.0%**
  - SANS connectivite (714) : resistance **20.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1188 candidats
  - AVEC connectivite (474) : T0=13.11 T1=0.00 T2=3.03 — pondere **6.05**
  - SANS connectivite (714) : T0=15.96 T1=0.00 T2=2.62 — pondere **5.24**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
...
- TROP-CHER : 2891 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2871 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19892 systemes
  - sans CONNECTED : 0.0% sur 4452 systemes
