...
genere 2026-09-09 21:05 UTC — 486162 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 402818 systemes
...
- moteur actif `0caa9267db60` (442420 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 242430 | 120387 | 16531 | 8115 | 24527 | 19005 | 25828 | 24961 | 10.3% |
...
- candidats AVEC connectivite : 25088, dont T2 : 100%
...
- **26102 systemes avec CONNECTED sur 200436 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*57661 candidats sur 61951 portent les champs bruts (93%).*

- `5c556c16ea8b` — 51696 candidats
  - AVEC connectivite (20960) : resistance **41.2%**
...
- `5c556c16ea8b` — 51696 candidats
  - AVEC connectivite (20960) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 26199 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 26102 avec CONNECTED, 97 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 197935 systemes
  - sans CONNECTED : 0.0% sur 44495 systemes
