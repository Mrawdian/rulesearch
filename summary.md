...
genere 2026-08-26 13:58 UTC — 47872 systemes evalues
...
- moteur actif `0caa9267db60` (4130 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21096 | 10530 | 1395 | 729 | 2090 | 1679 | 2252 | 2157 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20661 | 4827 | 8721 | 13 | 2865 | 1068 | 7 | 3160 | 15.3% |
...
- candidats AVEC connectivite : 2284, dont T2 : 100%
- candidats SANS connectivite : 3470, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2526 systemes avec CONNECTED sur 19732 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1464 candidats sur 5754 portent les champs bruts (25%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 349 candidats
  - AVEC connectivite (146) : resistance **39.8%**
  - SANS connectivite (203) : resistance **20.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 349 candidats
  - AVEC connectivite (146) : T0=13.35 T1=0.00 T2=2.93 — pondere **5.86**
  - SANS connectivite (203) : T0=16.13 T1=0.00 T2=2.70 — pondere **5.40**
...
- TROP-CHER : 2543 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2526 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17231 systemes
  - sans CONNECTED : 0.0% sur 3865 systemes
