...
- `89c65c03c4ad` — 270 candidats
  - AVEC connectivite (95) : T0=13.18 T1=0.00 T2=2.84 — pondere **5.68**
  - SANS connectivite (175) : T0=16.03 T1=0.00 T2=2.63 — pondere **5.27**
  - test de permutation : **p = 0.3013** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
