...
- moteur actif `0caa9267db60` (6972 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22534 | 11228 | 1514 | 769 | 2252 | 1782 | 2414 | 2294 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 22065 | 5116 | 9307 | 13 | 3083 | 1132 | 10 | 3404 | 15.4% |
...
- candidats AVEC connectivite : 2421, dont T2 : 100%
- candidats SANS connectivite : 3714, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2688 systemes avec CONNECTED sur 20894 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1845 candidats sur 6135 portent les champs bruts (30%).*
...
- `06fe04a859f1` — 730 candidats
  - AVEC connectivite (283) : resistance **41.1%**
  - SANS connectivite (447) : resistance **20.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 730 candidats
  - AVEC connectivite (283) : T0=13.33 T1=0.00 T2=3.02 — pondere **6.04**
  - SANS connectivite (447) : T0=16.02 T1=0.00 T2=2.62 — pondere **5.23**
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0020), `e3baecf8377b` (p=0.0005).
...
## cout
- temps total 15.7 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2708 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2688 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18393 systemes
  - sans CONNECTED : 0.0% sur 4141 systemes
