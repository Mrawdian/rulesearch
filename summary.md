...
- moteur actif `0caa9267db60` (7092 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22594 | 11259 | 1518 | 770 | 2256 | 1791 | 2419 | 2300 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 22125 | 5129 | 9332 | 13 | 3091 | 1136 | 10 | 3414 | 15.4% |
...
- candidats AVEC connectivite : 2427, dont T2 : 100%
- candidats SANS connectivite : 3724, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2693 systemes avec CONNECTED sur 20941 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1861 candidats sur 6151 portent les champs bruts (30%).*
...
- `06fe04a859f1` — 746 candidats
  - AVEC connectivite (289) : resistance **41.3%**
  - SANS connectivite (457) : resistance **20.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 746 candidats
  - AVEC connectivite (289) : T0=13.34 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (457) : T0=16.02 T1=0.00 T2=2.61 — pondere **5.22**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e3baecf8377b` — 657 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18440 systemes
