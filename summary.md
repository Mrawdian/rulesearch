...
genere 2026-08-28 22:07 UTC — 159252 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 75908 systemes
...
- moteur actif `0caa9267db60` (115510 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 77347 | 38426 | 5269 | 2634 | 7747 | 6180 | 8142 | 7960 | 10.3% |
...
- candidats AVEC connectivite : 8087, dont T2 : 100%
...
- **8416 systemes avec CONNECTED sur 65590 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*15793 candidats sur 20083 portent les champs bruts (79%).*

- `5c556c16ea8b` — 9828 candidats
  - AVEC connectivite (3959) : resistance **41.2%**
...
- `5c556c16ea8b` — 9828 candidats
  - AVEC connectivite (3959) : T0=13.01 T1=0.00 T2=3.00 — pondere **6.01**
...
- TROP-CHER : 8457 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8416 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 63089 systemes
  - sans CONNECTED : 0.0% sur 14258 systemes
