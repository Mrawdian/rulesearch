...
genere 2026-08-26 21:52 UTC — 66078 systemes evalues
...
- moteur actif `0caa9267db60` (22336 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 30308 | 15060 | 2070 | 1021 | 3032 | 2407 | 3226 | 3108 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 29655 | 6835 | 12609 | 16 | 4098 | 1531 | 13 | 4553 | 15.4% |
...
- candidats AVEC connectivite : 3235, dont T2 : 100%
- candidats SANS connectivite : 4863, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3500 systemes avec CONNECTED sur 27274 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3808 candidats sur 8098 portent les champs bruts (47%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 131 candidats
  - AVEC connectivite (55) : resistance **44.5%**
  - SANS connectivite (76) : resistance **22.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 131 candidats
  - AVEC connectivite (55) : T0=13.42 T1=0.00 T2=3.15 — pondere **6.29**
  - SANS connectivite (76) : T0=15.97 T1=0.00 T2=2.89 — pondere **5.79**
  - test de permutation : **p = 0.4013** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
## cout
- temps total 20.5 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 3523 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3500 avec CONNECTED, 23 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24773 systemes
  - sans CONNECTED : 0.0% sur 5535 systemes
