...
| connect | 4 | 3 | 6575 | 3309 | 426 | 236 | 631 | 531 | 684 | 683 | 10.4% |
| ref | 4 | 3 | 6430 | 1564 | 2661 | 1 | 862 | 318 | 2 | 1022 | 15.9% |
...
- candidats AVEC connectivite : 686, dont T2 : 100%
- candidats SANS connectivite : 1026, dont T2 : 100%
...
- **684 systemes avec CONNECTED sur 5445 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 547 candidats
  - AVEC connectivite (207) : T0=13.20 T1=0.00 T2=2.97 — pondere **5.93**
  - SANS connectivite (340) : T0=15.79 T1=0.00 T2=2.64 — pondere **5.28**
...
- TROP-CHER : 686 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 684 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 5388 systemes
  - sans CONNECTED : 0.0% sur 1187 systemes
