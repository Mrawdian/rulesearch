...
genere 2026-09-09 17:52 UTC — 483418 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 400074 systemes
...
- moteur actif `0caa9267db60` (439676 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 241055 | 119670 | 16433 | 8076 | 24400 | 18909 | 25676 | 24835 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 236248 | 55057 | 99549 | 94 | 32907 | 12194 | 86 | 36340 | 15.4% |
...
- candidats AVEC connectivite : 24962, dont T2 : 100%
- candidats SANS connectivite : 36650, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25950 systemes avec CONNECTED sur 199293 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*57322 candidats sur 61612 portent les champs bruts (93%).*

- `5c556c16ea8b` — 51357 candidats
  - AVEC connectivite (20834) : resistance **41.2%**
  - SANS connectivite (30523) : resistance **21.3%**
...
- `5c556c16ea8b` — 51357 candidats
  - AVEC connectivite (20834) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.97**
  - SANS connectivite (30523) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 26046 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25950 avec CONNECTED, 96 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 196792 systemes
  - sans CONNECTED : 0.0% sur 44263 systemes
