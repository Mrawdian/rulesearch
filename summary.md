...
genere 2026-08-30 17:16 UTC — 225371 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 142027 systemes
...
- moteur actif `0caa9267db60` (181629 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 110763 | 55068 | 7517 | 3699 | 11156 | 8772 | 11711 | 11397 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 108493 | 25287 | 45816 | 50 | 14979 | 5607 | 44 | 16700 | 15.4% |
...
- candidats AVEC connectivite : 11524, dont T2 : 100%
- candidats SANS connectivite : 17010, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11985 systemes avec CONNECTED sur 92892 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*24244 candidats sur 28534 portent les champs bruts (85%).*

- `5c556c16ea8b` — 18279 candidats
  - AVEC connectivite (7396) : resistance **41.1%**
  - SANS connectivite (10883) : resistance **21.5%**
...
- `5c556c16ea8b` — 18279 candidats
  - AVEC connectivite (7396) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.97**
  - SANS connectivite (10883) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 12039 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11985 avec CONNECTED, 54 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 90391 systemes
  - sans CONNECTED : 0.0% sur 20372 systemes
