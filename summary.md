...
genere 2026-08-26 13:07 UTC — 45714 systemes evalues
...
- moteur actif `0caa9267db60` (1972 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20008 | 9994 | 1305 | 687 | 2007 | 1584 | 2147 | 2037 | 10.2% |
...
- **2421 systemes avec CONNECTED sur 18828 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1175 candidats sur 5465 portent les champs bruts (22%).*
...
- `06fe04a859f1` — 60 candidats
  ...
  - test de permutation : **p = 0.6332** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 2438 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2421 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16327 systemes
