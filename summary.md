...
**7466 enregistrements (56%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 6635 | 3333 | 431 | 238 | 635 | 538 | 692 | 691 | 10.4% |
| ref | 4 | 3 | 6475 | 1573 | 2680 | 1 | 871 | 320 | 2 | 1028 | 15.9% |
...
- candidats AVEC connectivite : 694, dont T2 : 100%
- candidats SANS connectivite : 1032, dont T2 : 100%
...
- **692 systemes avec CONNECTED sur 5494 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 561 candidats
  - AVEC connectivite (215) : T0=13.19 T1=0.00 T2=2.96 — pondere **5.93**
  - SANS connectivite (346) : T0=15.79 T1=0.00 T2=2.62 — pondere **5.25**
...
## cout
- temps total 4.0 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 694 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 692 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 5437 systemes
  - sans CONNECTED : 0.0% sur 1198 systemes
