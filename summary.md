...
genere 2026-09-08 23:46 UTC — 467589 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 384245 systemes
...
- moteur actif `0caa9267db60` (423847 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 233051 | 115754 | 15869 | 7800 | 23585 | 18253 | 24833 | 24000 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 228423 | 53205 | 96238 | 92 | 31831 | 11795 | 82 | 35161 | 15.4% |
...
- candidats AVEC connectivite : 24127, dont T2 : 100%
- candidats SANS connectivite : 35471, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25107 systemes avec CONNECTED sur 192789 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55308 candidats sur 59598 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49343 candidats
  - AVEC connectivite (19999) : resistance **41.2%**
  - SANS connectivite (29344) : resistance **21.3%**
...
- `5c556c16ea8b` — 49343 candidats
  - AVEC connectivite (19999) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (29344) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
## cout
- temps total 145.9 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 25199 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25107 avec CONNECTED, 92 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 190288 systemes
  - sans CONNECTED : 0.0% sur 42763 systemes
