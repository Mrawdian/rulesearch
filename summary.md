...
genere 2026-08-26 17:25 UTC — 55915 systemes evalues
...
- moteur actif `0caa9267db60` (12173 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
| connect | 4 | 3 | 25161 | 12547 | 1713 | 849 | 2490 | 1992 | 2688 | 2570 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 24639 | 5699 | 10421 | 14 | 3443 | 1253 | 10 | 3799 | 15.4% |
...
- candidats AVEC connectivite : 2697, dont T2 : 100%
- candidats SANS connectivite : 4109, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2962 systemes avec CONNECTED sur 23063 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2516 candidats sur 6806 portent les champs bruts (37%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 206 candidats
  - AVEC connectivite (83) : resistance **43.3%**
  - SANS connectivite (123) : resistance **20.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `23303c299f39` — 206 candidats
  - AVEC connectivite (83) : T0=12.92 T1=0.00 T2=3.12 — pondere **6.24**
  - SANS connectivite (123) : T0=16.20 T1=0.00 T2=2.59 — pondere **5.17**
...
**4 serie(s) reproductible(s) sur 7 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0160).
...
## cout
- temps total 17.3 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2982 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2962 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 20562 systemes
  - sans CONNECTED : 0.0% sur 4599 systemes
