...
genere 2026-08-31 14:46 UTC — 254865 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 171521 systemes
...
- moteur actif `0caa9267db60` (211123 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 125651 | 62458 | 8503 | 4216 | 12693 | 9942 | 13257 | 12933 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 123099 | 28709 | 51959 | 55 | 17047 | 6367 | 56 | 18896 | 15.4% |
...
- candidats AVEC connectivite : 13060, dont T2 : 100%
- candidats SANS connectivite : 19206, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13531 systemes avec CONNECTED sur 105024 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*27976 candidats sur 32266 portent les champs bruts (87%).*

- `5c556c16ea8b` — 22011 candidats
  - AVEC connectivite (8932) : resistance **41.0%**
  - SANS connectivite (13079) : resistance **21.4%**
...
- `5c556c16ea8b` — 22011 candidats
  - AVEC connectivite (8932) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.97**
  - SANS connectivite (13079) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 102523 systemes
  - sans CONNECTED : 0.0% sur 23128 systemes
