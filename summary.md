...
genere 2026-08-27 23:03 UTC — 118029 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 34685 systemes
...
- moteur actif `0caa9267db60` (74287 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 56531 | 28154 | 3906 | 1918 | 5609 | 4477 | 5971 | 5770 | 10.2% |
...
- candidats AVEC connectivite : 5897, dont T2 : 100%
- candidats SANS connectivite : 8802, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6245 systemes avec CONNECTED sur 48674 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10409 candidats sur 14699 portent les champs bruts (71%).*

- `5c556c16ea8b` — 4444 candidats
  - AVEC connectivite (1769) : resistance **42.0%**
...
- `5c556c16ea8b` — 4444 candidats
  - AVEC connectivite (1769) : T0=12.96 T1=0.00 T2=3.06 — pondere **6.12**
...
- TROP-CHER : 6280 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6245 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 46173 systemes
  - sans CONNECTED : 0.0% sur 10358 systemes
