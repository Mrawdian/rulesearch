...
| connect | 4 | 3 | 18187 | 9086 | 1183 | 634 | 1807 | 1440 | 1977 | 1832 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 17793 | 4188 | 7507 | 12 | 2433 | 909 | 7 | 2737 | 15.4% |
...
- candidats AVEC connectivite : 1959, dont T2 : 100%
- candidats SANS connectivite : 3047, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2251 systemes avec CONNECTED sur 17353 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*716 candidats sur 5006 portent les champs bruts (14%).*
...
- `e3baecf8377b` — 452 candidats
  - AVEC connectivite (176) : resistance **43.2%**
  - SANS connectivite (276) : resistance **21.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 452 candidats
  - AVEC connectivite (176) : T0=12.98 T1=0.00 T2=3.15 — pondere **6.31**
  - SANS connectivite (276) : T0=16.12 T1=0.00 T2=2.67 — pondere **5.35**
...
**2 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0035).
...
## cout
- temps total 13.2 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2268 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 2251 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14852 systemes
  - sans CONNECTED : 0.0% sur 3335 systemes
