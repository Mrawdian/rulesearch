...
genere 2026-08-26 19:44 UTC — 61349 systemes evalues
...
- moteur actif `0caa9267db60` (17607 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 27320 | 6314 | 11563 | 15 | 3804 | 1407 | 11 | 4206 | 15.4% |
...
- candidats SANS connectivite : 4516, dont T2 : 100%
...
*3215 candidats sur 7505 portent les champs bruts (43%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 346 candidats
  - AVEC connectivite (145) : resistance **39.2%**
  - SANS connectivite (201) : resistance **19.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 346 candidats
  ...
  - SANS connectivite (201) : T0=16.04 T1=0.00 T2=2.65 — pondere **5.29**
  - test de permutation : **p = 0.2369** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
