...
genere 2026-08-26 22:29 UTC — 67335 systemes evalues
...
- moteur actif `0caa9267db60` (23593 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 30934 | 15357 | 2117 | 1038 | 3083 | 2466 | 3303 | 3176 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 30286 | 6976 | 12861 | 18 | 4194 | 1574 | 14 | 4649 | 15.4% |
...
- candidats AVEC connectivite : 3303, dont T2 : 100%
- candidats SANS connectivite : 4959, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3577 systemes avec CONNECTED sur 27787 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3972 candidats sur 8262 portent les champs bruts (48%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 295 candidats
  - AVEC connectivite (123) : resistance **43.1%**
  - SANS connectivite (172) : resistance **22.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 295 candidats
  - AVEC connectivite (123) : T0=12.85 T1=0.00 T2=3.10 — pondere **6.20**
  - SANS connectivite (172) : T0=16.09 T1=0.00 T2=2.80 — pondere **5.60**
  - test de permutation : **p = 0.1089** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
## cout
- temps total 20.9 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 3601 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3577 avec CONNECTED, 24 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 25286 systemes
  - sans CONNECTED : 0.0% sur 5648 systemes
