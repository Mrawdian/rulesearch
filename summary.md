...
genere 2026-09-04 03:09 UTC — 354480 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 271136 systemes
...
- moteur actif `0caa9267db60` (310738 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 175919 | 87440 | 11961 | 5876 | 17910 | 13839 | 18647 | 18003 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 172446 | 40069 | 72816 | 70 | 23968 | 8935 | 68 | 26506 | 15.4% |
...
- candidats AVEC connectivite : 18130, dont T2 : 100%
- candidats SANS connectivite : 26816, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18921 systemes avec CONNECTED sur 146052 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*40656 candidats sur 44946 portent les champs bruts (90%).*

- `5c556c16ea8b` — 34691 candidats
  - AVEC connectivite (14002) : resistance **41.0%**
  - SANS connectivite (20689) : resistance **21.3%**
...
- `5c556c16ea8b` — 34691 candidats
  - AVEC connectivite (14002) : T0=13.03 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (20689) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 18999 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18921 avec CONNECTED, 78 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 143551 systemes
  - sans CONNECTED : 0.0% sur 32368 systemes
