...
genere 2026-09-01 20:47 UTC — 292545 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 209201 systemes
...
- moteur actif `0caa9267db60` (248803 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 144665 | 71850 | 9833 | 4844 | 14689 | 11398 | 15307 | 14875 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 141765 | 32950 | 59971 | 59 | 19656 | 7327 | 63 | 21728 | 15.3% |
...
- candidats AVEC connectivite : 15002, dont T2 : 100%
...
- **15581 systemes avec CONNECTED sur 120563 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*32750 candidats sur 37040 portent les champs bruts (88%).*

- `5c556c16ea8b` — 26785 candidats
  - AVEC connectivite (10874) : resistance **41.0%**
...
- `5c556c16ea8b` — 26785 candidats
  - AVEC connectivite (10874) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 15654 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 15581 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 118062 systemes
