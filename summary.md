...
genere 2026-08-26 15:57 UTC — 52497 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 7314 systemes
...
- moteur actif `0caa9267db60` (8755 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23446 | 11686 | 1587 | 800 | 2339 | 1858 | 2503 | 2377 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 22936 | 5306 | 9691 | 14 | 3208 | 1168 | 10 | 3539 | 15.4% |
...
- candidats AVEC connectivite : 2504, dont T2 : 100%
- candidats SANS connectivite : 3849, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2777 systemes avec CONNECTED sur 21634 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2063 candidats sur 6353 portent les champs bruts (32%).*
...
- `06fe04a859f1` — 948 candidats
  - AVEC connectivite (366) : resistance **41.5%**
  - SANS connectivite (582) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 948 candidats
  - AVEC connectivite (366) : T0=13.21 T1=0.00 T2=3.04 — pondere **6.09**
  - SANS connectivite (582) : T0=16.04 T1=0.00 T2=2.65 — pondere **5.29**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
...
- TROP-CHER : 2797 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2777 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19133 systemes
  - sans CONNECTED : 0.0% sur 4313 systemes
