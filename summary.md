...
genere 2026-08-27 23:00 UTC — 117883 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 34539 systemes
...
- moteur actif `0caa9267db60` (74141 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 56457 | 28116 | 3903 | 1913 | 5598 | 4471 | 5967 | 5764 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 55311 | 12764 | 23487 | 26 | 7675 | 2857 | 25 | 8475 | 15.3% |
...
- candidats AVEC connectivite : 5891, dont T2 : 100%
- candidats SANS connectivite : 8785, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6241 systemes avec CONNECTED sur 48616 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10386 candidats sur 14676 portent les champs bruts (71%).*

- `5c556c16ea8b` — 4421 candidats
  - AVEC connectivite (1763) : resistance **42.0%**
...
- `5c556c16ea8b` — 4421 candidats
  - AVEC connectivite (1763) : T0=12.96 T1=0.00 T2=3.06 — pondere **6.11**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 46115 systemes
  - sans CONNECTED : 0.0% sur 10342 systemes
