...
genere 2026-08-26 13:09 UTC — 45758 systemes evalues
...
- moteur actif `0caa9267db60` (2016 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20038 | 10009 | 1310 | 688 | 2008 | 1587 | 2151 | 2038 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 19605 | 4598 | 8281 | 13 | 2698 | 1014 | 7 | 2994 | 15.3% |
...
- candidats AVEC connectivite : 2165, dont T2 : 100%
- candidats SANS connectivite : 3304, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2425 systemes avec CONNECTED sur 18853 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1179 candidats sur 5469 portent les champs bruts (22%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 64 candidats
  - AVEC connectivite (27) : resistance **36.7%**
  - SANS connectivite (37) : resistance **20.5%**
...
- `06fe04a859f1` — 64 candidats
  - AVEC connectivite (27) : T0=13.70 T1=0.00 T2=2.48 — pondere **4.96**
  - SANS connectivite (37) : T0=16.70 T1=0.00 T2=2.70 — pondere **5.41**
  - test de permutation : **p = 0.5787** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 2442 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2425 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 16352 systemes
  - sans CONNECTED : 0.0% sur 3686 systemes
