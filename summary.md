...
genere 2026-09-01 15:30 UTC — 286240 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 202896 systemes
...
- moteur actif `0caa9267db60` (242498 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 141482 | 70294 | 9589 | 4729 | 14374 | 11167 | 14945 | 14554 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 138643 | 32235 | 58617 | 59 | 19230 | 7181 | 62 | 21248 | 15.3% |
...
- candidats AVEC connectivite : 14681, dont T2 : 100%
...
- **15219 systemes avec CONNECTED sur 117933 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*31949 candidats sur 36239 portent les champs bruts (88%).*

- `5c556c16ea8b` — 25984 candidats
  - AVEC connectivite (10553) : resistance **41.0%**
...
- `5c556c16ea8b` — 25984 candidats
  - AVEC connectivite (10553) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 15291 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15219 avec CONNECTED, 72 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 115432 systemes
  - sans CONNECTED : 0.0% sur 26050 systemes
