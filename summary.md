...
| connect | 4 | 3 | 18830 | 9396 | 1228 | 653 | 1875 | 1498 | 2042 | 1905 | 10.1% |
...
- candidats AVEC connectivite : 2032, dont T2 : 100%
- candidats SANS connectivite : 3142, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2316 systemes avec CONNECTED sur 17871 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*884 candidats sur 5174 portent les champs bruts (17%).*
...
- `e3baecf8377b` — 620 candidats
  - AVEC connectivite (249) : resistance **42.0%**
...
- `e3baecf8377b` — 620 candidats
  - AVEC connectivite (249) : T0=13.10 T1=0.00 T2=3.10 — pondere **6.19**
...
- TROP-CHER : 2333 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2316 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 15370 systemes
  - sans CONNECTED : 0.0% sur 3460 systemes
