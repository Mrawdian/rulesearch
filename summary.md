...
genere 2026-09-02 11:07 UTC — 309546 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 226202 systemes
...
- moteur actif `0caa9267db60` (265804 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 153245 | 76123 | 10431 | 5127 | 15579 | 12063 | 16230 | 15728 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 150186 | 34987 | 63513 | 63 | 20762 | 7758 | 63 | 23028 | 15.3% |
...
- candidats AVEC connectivite : 15855, dont T2 : 100%
- candidats SANS connectivite : 23338, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16504 systemes avec CONNECTED sur 127576 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*34903 candidats sur 39193 portent les champs bruts (89%).*

- `5c556c16ea8b` — 28938 candidats
  - AVEC connectivite (11727) : resistance **41.1%**
  - SANS connectivite (17211) : resistance **21.3%**
...
- `5c556c16ea8b` — 28938 candidats
  - AVEC connectivite (11727) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (17211) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 16577 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16504 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 125075 systemes
  - sans CONNECTED : 0.0% sur 28170 systemes
