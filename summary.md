...
- moteur actif `0caa9267db60` (6661 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22384 | 11157 | 1504 | 764 | 2231 | 1776 | 2395 | 2276 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 21904 | 5082 | 9236 | 13 | 3059 | 1124 | 10 | 3380 | 15.4% |
...
- candidats AVEC connectivite : 2403, dont T2 : 100%
- candidats SANS connectivite : 3690, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2669 systemes avec CONNECTED sur 20769 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1803 candidats sur 6093 portent les champs bruts (30%).*
...
- `06fe04a859f1` — 688 candidats
  - AVEC connectivite (265) : resistance **41.1%**
  - SANS connectivite (423) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 688 candidats
  - AVEC connectivite (265) : T0=13.31 T1=0.00 T2=3.02 — pondere **6.04**
  - SANS connectivite (423) : T0=16.02 T1=0.00 T2=2.64 — pondere **5.29**
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0025), `e3baecf8377b` (p=0.0005).
...
## cout
- temps total 15.6 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2689 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2669 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18268 systemes
  - sans CONNECTED : 0.0% sur 4116 systemes
