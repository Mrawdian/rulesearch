...
genere 2026-08-26 14:34 UTC — 49309 systemes evalues
...
- moteur actif `0caa9267db60` (5567 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21831 | 10890 | 1461 | 750 | 2162 | 1730 | 2329 | 2232 | 10.2% |
...
- candidats AVEC connectivite : 2359, dont T2 : 100%
- candidats SANS connectivite : 3604, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2603 systemes avec CONNECTED sur 20344 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1673 candidats sur 5963 portent les champs bruts (28%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 558 candidats
  - AVEC connectivite (221) : resistance **40.2%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 558 candidats
  - AVEC connectivite (221) : T0=13.45 T1=0.00 T2=3.02 — pondere **6.04**
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0070).
...
- TROP-CHER : 2621 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2603 avec CONNECTED, 18 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17843 systemes
  - sans CONNECTED : 0.0% sur 3988 systemes
