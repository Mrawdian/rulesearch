...
| connect | 4 | 3 | 18307 | 9146 | 1191 | 637 | 1822 | 1450 | 1987 | 1845 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 17911 | 4215 | 7553 | 12 | 2455 | 921 | 7 | 2748 | 15.3% |
...
- candidats AVEC connectivite : 1972, dont T2 : 100%
- candidats SANS connectivite : 3058, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2261 systemes avec CONNECTED sur 17450 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*740 candidats sur 5030 portent les champs bruts (15%).*
...
- `e3baecf8377b` — 476 candidats
  - AVEC connectivite (189) : resistance **42.8%**
  - SANS connectivite (287) : resistance **20.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 476 candidats
  - AVEC connectivite (189) : T0=13.00 T1=0.00 T2=3.13 — pondere **6.25**
  - SANS connectivite (287) : T0=16.10 T1=0.00 T2=2.66 — pondere **5.31**
...
## cout
- temps total 13.3 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2278 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2261 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14949 systemes
  - sans CONNECTED : 0.0% sur 3358 systemes
