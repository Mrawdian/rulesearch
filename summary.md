...
genere 2026-09-05 21:03 UTC — 397893 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 314549 systemes
...
- moteur actif `0caa9267db60` (354151 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 197845 | 98207 | 13469 | 6597 | 20109 | 15582 | 21000 | 20362 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 193933 | 45130 | 81824 | 78 | 27019 | 10013 | 71 | 29783 | 15.4% |
...
- candidats AVEC connectivite : 20489, dont T2 : 100%
- candidats SANS connectivite : 30093, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21274 systemes avec CONNECTED sur 163892 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*46292 candidats sur 50582 portent les champs bruts (92%).*

- `5c556c16ea8b` — 40327 candidats
  - AVEC connectivite (16361) : resistance **41.1%**
  - SANS connectivite (23966) : resistance **21.3%**
...
- `5c556c16ea8b` — 40327 candidats
  - AVEC connectivite (16361) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.94**
  - SANS connectivite (23966) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 21355 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21274 avec CONNECTED, 81 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 161391 systemes
  - sans CONNECTED : 0.0% sur 36454 systemes
