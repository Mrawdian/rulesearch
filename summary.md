...
genere 2026-08-31 03:00 UTC — 238763 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 155419 systemes
...
- moteur actif `0caa9267db60` (195021 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 117522 | 58458 | 7980 | 3944 | 11812 | 9261 | 12451 | 12080 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 115126 | 26868 | 48657 | 53 | 15881 | 5950 | 52 | 17655 | 15.3% |
...
- candidats AVEC connectivite : 12207, dont T2 : 100%
- candidats SANS connectivite : 17965, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12725 systemes avec CONNECTED sur 98473 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*25882 candidats sur 30172 portent les champs bruts (86%).*

- `5c556c16ea8b` — 19917 candidats
  - AVEC connectivite (8079) : resistance **41.0%**
  - SANS connectivite (11838) : resistance **21.4%**
...
- `5c556c16ea8b` — 19917 candidats
  - AVEC connectivite (8079) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.97**
  - SANS connectivite (11838) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 12787 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 12725 avec CONNECTED, 62 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 95972 systemes
  - sans CONNECTED : 0.0% sur 21550 systemes
