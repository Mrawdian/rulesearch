...
genere 2026-08-30 22:32 UTC — 232732 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 149388 systemes
...
- moteur actif `0caa9267db60` (188990 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 114475 | 56915 | 7781 | 3837 | 11499 | 9049 | 12107 | 11785 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 112142 | 26169 | 47395 | 53 | 15469 | 5793 | 49 | 17204 | 15.3% |
...
- candidats AVEC connectivite : 11912, dont T2 : 100%
- candidats SANS connectivite : 17514, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12381 systemes avec CONNECTED sur 95971 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*25136 candidats sur 29426 portent les champs bruts (85%).*

- `5c556c16ea8b` — 19171 candidats
  - AVEC connectivite (7784) : resistance **41.0%**
  - SANS connectivite (11387) : resistance **21.4%**
...
- `5c556c16ea8b` — 19171 candidats
  - AVEC connectivite (7784) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (11387) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 12440 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 12381 avec CONNECTED, 59 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 93470 systemes
  - sans CONNECTED : 0.0% sur 21005 systemes
