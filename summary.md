...
| connect | 4 | 3 | 5079 | 2545 | 320 | 183 | 494 | 415 | 529 | 535 | 10.5% |
| ref | 4 | 3 | 4971 | 1208 | 2081 | 1 | 655 | 238 | 2 | 786 | 15.8% |
...
- candidats SANS connectivite : 790, dont T2 : 100%
...
- **529 systemes avec CONNECTED sur 4210 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 163 candidats
  ...
  - SANS connectivite (104) : T0=16.11 T1=0.00 T2=2.76 — pondere **5.52**
...
- TROP-CHER : 531 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 529 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 4153 systemes
  - sans CONNECTED : 0.0% sur 926 systemes
