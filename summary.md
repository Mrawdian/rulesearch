...
genere 2026-08-30 02:20 UTC — 203906 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 120562 systemes
...
- moteur actif `0caa9267db60` (160164 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 99910 | 49570 | 6808 | 3351 | 10082 | 7980 | 10526 | 10292 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 97881 | 22819 | 41337 | 45 | 13530 | 5053 | 37 | 15053 | 15.4% |
...
- candidats AVEC connectivite : 10419, dont T2 : 100%
- candidats SANS connectivite : 15363, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10800 systemes avec CONNECTED sur 83970 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*21492 candidats sur 25782 portent les champs bruts (83%).*

- `5c556c16ea8b` — 15527 candidats
  - AVEC connectivite (6291) : resistance **41.1%**
  - SANS connectivite (9236) : resistance **21.5%**
...
- `5c556c16ea8b` — 15527 candidats
  - AVEC connectivite (6291) : T0=13.00 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (9236) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 10847 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10800 avec CONNECTED, 47 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 81469 systemes
  - sans CONNECTED : 0.0% sur 18441 systemes
