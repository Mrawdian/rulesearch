...
genere 2026-08-26 21:33 UTC — 65322 systemes evalues
...
- `ab89a63b01ef` : 415 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (21580 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
**7941 enregistrements (12%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 29920 | 14868 | 2043 | 1003 | 2997 | 2370 | 3191 | 3068 | 10.3% |
...
- candidats AVEC connectivite : 3195, dont T2 : 100%
- candidats SANS connectivite : 4812, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3465 systemes avec CONNECTED sur 26961 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3717 candidats sur 8007 portent les champs bruts (46%).*
...
- `8f22f0d2d442` — 65 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 40 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (15) : resistance **44.5%**
...
- `ab89a63b01ef` — 40 candidats
  - AVEC connectivite (15) : T0=14.07 T1=0.00 T2=2.93 — pondere **5.87**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24460 systemes
  - sans CONNECTED : 0.0% sur 5460 systemes
