...
genere 2026-08-31 02:15 UTC — 237690 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 154346 systemes
...
- moteur actif `0caa9267db60` (193948 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 116983 | 58177 | 7943 | 3932 | 11763 | 9220 | 12399 | 12023 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 114592 | 26741 | 48421 | 53 | 15814 | 5925 | 51 | 17577 | 15.3% |
...
- candidats AVEC connectivite : 12150, dont T2 : 100%
- candidats SANS connectivite : 17887, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12673 systemes avec CONNECTED sur 98030 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*25747 candidats sur 30037 portent les champs bruts (86%).*

- `5c556c16ea8b` — 19782 candidats
  - AVEC connectivite (8022) : resistance **41.0%**
  - SANS connectivite (11760) : resistance **21.4%**
...
- `5c556c16ea8b` — 19782 candidats
  - AVEC connectivite (8022) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.97**
  - SANS connectivite (11760) : T0=15.90 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 95529 systemes
  - sans CONNECTED : 0.0% sur 21454 systemes
