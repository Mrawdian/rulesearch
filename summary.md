...
genere 2026-09-01 19:04 UTC — 290612 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 207268 systemes
...
- moteur actif `0caa9267db60` (246870 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 143692 | 71386 | 9752 | 4812 | 14592 | 11334 | 15176 | 14780 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 140805 | 32736 | 59568 | 59 | 19524 | 7275 | 63 | 21569 | 15.3% |
...
- candidats AVEC connectivite : 14907, dont T2 : 100%
- candidats SANS connectivite : 21879, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15450 systemes avec CONNECTED sur 119753 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*32496 candidats sur 36786 portent les champs bruts (88%).*

- `5c556c16ea8b` — 26531 candidats
  - AVEC connectivite (10779) : resistance **41.0%**
  - SANS connectivite (15752) : resistance **21.3%**
...
- `5c556c16ea8b` — 26531 candidats
  - AVEC connectivite (10779) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (15752) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 117252 systemes
  - sans CONNECTED : 0.0% sur 26440 systemes
