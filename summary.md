...
genere 2026-08-26 23:20 UTC — 69204 systemes evalues
...
- moteur actif `0caa9267db60` (25462 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 31892 | 15846 | 2192 | 1072 | 3172 | 2540 | 3403 | 3262 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 31197 | 7183 | 13260 | 18 | 4317 | 1623 | 14 | 4782 | 15.3% |
...
- candidats SANS connectivite : 5092, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3677 systemes avec CONNECTED sur 28581 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4191 candidats sur 8481 portent les champs bruts (49%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 514 candidats
  - AVEC connectivite (209) : resistance **41.9%**
  - SANS connectivite (305) : resistance **22.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 514 candidats
  ...
  - SANS connectivite (305) : T0=16.07 T1=0.00 T2=2.68 — pondere **5.36**
...
- TROP-CHER : 3701 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3677 avec CONNECTED, 24 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 26080 systemes
  - sans CONNECTED : 0.0% sur 5812 systemes
