...
genere 2026-08-26 05:51 UTC — 26829 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 17855 systemes
...
| d4 | 4 | 4 | 240 | 114 | 58 | 0 | 15 | 16 | 13 | 16 | 6.7% |
...
- candidats SANS connectivite : 2026, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1466 systemes avec CONNECTED sur 11106 (13.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2213 candidats
  - AVEC connectivite (873) : T0=13.24 T1=0.00 T2=2.86 — pondere **5.73**
  - SANS connectivite (1340) : T0=15.89 T1=0.00 T2=2.64 — pondere **5.28**
...
- TROP-CHER : 1472 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1466 avec CONNECTED, 6 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
