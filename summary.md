...
genere 2026-09-02 16:47 UTC — 315945 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 232601 systemes
...
- moteur actif `0caa9267db60` (272203 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 156469 | 77749 | 10649 | 5236 | 15906 | 12301 | 16582 | 16039 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 153361 | 35731 | 64894 | 64 | 21170 | 7930 | 63 | 23497 | 15.3% |
...
- candidats AVEC connectivite : 16166, dont T2 : 100%
- candidats SANS connectivite : 23807, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16856 systemes avec CONNECTED sur 130223 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*35683 candidats sur 39973 portent les champs bruts (89%).*

- `5c556c16ea8b` — 29718 candidats
  - AVEC connectivite (12038) : resistance **41.0%**
  - SANS connectivite (17680) : resistance **21.3%**
...
- `5c556c16ea8b` — 29718 candidats
  - AVEC connectivite (12038) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (17680) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.29**
...
- TROP-CHER : 16929 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16856 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 127722 systemes
  - sans CONNECTED : 0.0% sur 28747 systemes
