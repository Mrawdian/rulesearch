...
genere 2026-09-02 10:07 UTC — 308398 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 225054 systemes
...
- moteur actif `0caa9267db60` (264656 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 152664 | 75842 | 10388 | 5111 | 15514 | 12009 | 16167 | 15680 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 149619 | 34852 | 63272 | 63 | 20685 | 7725 | 63 | 22947 | 15.3% |
...
- candidats AVEC connectivite : 15807, dont T2 : 100%
...
- **16441 systemes avec CONNECTED sur 127124 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*34774 candidats sur 39064 portent les champs bruts (89%).*

- `5c556c16ea8b` — 28809 candidats
  - AVEC connectivite (11679) : resistance **41.1%**
...
- `5c556c16ea8b` — 28809 candidats
  - AVEC connectivite (11679) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 16514 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16441 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 124623 systemes
  - sans CONNECTED : 0.0% sur 28041 systemes
