...
genere 2026-09-04 22:07 UTC — 374584 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 291240 systemes
...
- moteur actif `0caa9267db60` (330842 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 186076 | 92415 | 12648 | 6225 | 18921 | 14656 | 19728 | 19096 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 182393 | 42419 | 77065 | 76 | 25332 | 9447 | 70 | 27970 | 15.3% |
...
- candidats AVEC connectivite : 19223, dont T2 : 100%
- candidats SANS connectivite : 28280, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20002 systemes avec CONNECTED sur 154299 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*43213 candidats sur 47503 portent les champs bruts (91%).*

- `5c556c16ea8b` — 37248 candidats
  - AVEC connectivite (15095) : resistance **41.1%**
  - SANS connectivite (22153) : resistance **21.2%**
...
- `5c556c16ea8b` — 37248 candidats
  - AVEC connectivite (15095) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (22153) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
## cout
- temps total 116.3 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 20082 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 20002 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 151798 systemes
  - sans CONNECTED : 0.0% sur 34278 systemes
