...
genere 2026-09-02 15:57 UTC — 315003 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 231659 systemes
...
- moteur actif `0caa9267db60` (271261 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 155991 | 77499 | 10614 | 5213 | 15865 | 12273 | 16528 | 15996 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 152897 | 35609 | 64687 | 64 | 21113 | 7916 | 63 | 23433 | 15.3% |
...
- candidats SANS connectivite : 23743, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16802 systemes avec CONNECTED sur 129820 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*35576 candidats sur 39866 portent les champs bruts (89%).*

- `5c556c16ea8b` — 29611 candidats
  - AVEC connectivite (11995) : resistance **41.0%**
  - SANS connectivite (17616) : resistance **21.3%**
...
- `5c556c16ea8b` — 29611 candidats
  ...
  - SANS connectivite (17616) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 127319 systemes
  - sans CONNECTED : 0.0% sur 28672 systemes
