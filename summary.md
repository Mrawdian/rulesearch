...
genere 2026-09-05 19:38 UTC — 396478 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 313134 systemes
...
- moteur actif `0caa9267db60` (352736 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 197129 | 97863 | 13420 | 6571 | 20043 | 15514 | 20924 | 20284 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 193234 | 44965 | 81540 | 78 | 26916 | 9980 | 71 | 29669 | 15.4% |
...
- candidats AVEC connectivite : 20411, dont T2 : 100%
- candidats SANS connectivite : 29979, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21198 systemes avec CONNECTED sur 163313 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*46100 candidats sur 50390 portent les champs bruts (91%).*

- `5c556c16ea8b` — 40135 candidats
  - AVEC connectivite (16283) : resistance **41.1%**
  - SANS connectivite (23852) : resistance **21.3%**
...
- `5c556c16ea8b` — 40135 candidats
  - AVEC connectivite (16283) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (23852) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 160812 systemes
  - sans CONNECTED : 0.0% sur 36317 systemes
