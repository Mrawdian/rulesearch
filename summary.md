...
genere 2026-08-26 23:32 UTC — 69709 systemes evalues
...
- moteur actif `0caa9267db60` (25967 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 32147 | 15985 | 2206 | 1082 | 3204 | 2558 | 3427 | 3278 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 31447 | 7252 | 13356 | 18 | 4351 | 1644 | 14 | 4812 | 15.3% |
...
- candidats AVEC connectivite : 3405, dont T2 : 100%
- candidats SANS connectivite : 5122, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3701 systemes avec CONNECTED sur 28782 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4237 candidats sur 8527 portent les champs bruts (50%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 560 candidats
  - AVEC connectivite (225) : resistance **42.4%**
  - SANS connectivite (335) : resistance **22.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 560 candidats
  - AVEC connectivite (225) : T0=13.04 T1=0.00 T2=3.13 — pondere **6.26**
  - SANS connectivite (335) : T0=16.01 T1=0.00 T2=2.67 — pondere **5.34**
...
- TROP-CHER : 3725 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3701 avec CONNECTED, 24 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 26281 systemes
  - sans CONNECTED : 0.0% sur 5866 systemes
