...
genere 2026-08-27 14:44 UTC — 101868 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 18524 systemes
...
- moteur actif `0caa9267db60` (58126 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 48365 | 24105 | 3331 | 1655 | 4798 | 3825 | 5109 | 4918 | 10.2% |
...
- candidats AVEC connectivite : 5045, dont T2 : 100%
- candidats SANS connectivite : 7528, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5383 systemes avec CONNECTED sur 42020 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*8283 candidats sur 12573 portent les champs bruts (66%).*
...
- `5c556c16ea8b` — 2318 candidats
  - AVEC connectivite (917) : resistance **41.6%**
...
- `5c556c16ea8b` — 2318 candidats
  - AVEC connectivite (917) : T0=13.03 T1=0.00 T2=3.03 — pondere **6.05**
...
- TROP-CHER : 5415 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 5383 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 39519 systemes
  - sans CONNECTED : 0.0% sur 8846 systemes
