...
genere 2026-08-27 06:18 UTC — 84618 systemes evalues
...
- moteur actif `0caa9267db60` (40876 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 39660 | 19753 | 2720 | 1352 | 3948 | 3118 | 4192 | 4064 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 38843 | 8949 | 16529 | 22 | 5386 | 2028 | 21 | 5908 | 15.2% |
...
- candidats AVEC connectivite : 4191, dont T2 : 100%
- candidats SANS connectivite : 6218, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4466 systemes avec CONNECTED sur 34935 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6119 candidats sur 10409 portent les champs bruts (59%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 154 candidats
  - AVEC connectivite (63) : resistance **43.5%**
  - SANS connectivite (91) : resistance **21.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 154 candidats
  - AVEC connectivite (63) : T0=12.86 T1=0.00 T2=3.11 — pondere **6.22**
  - SANS connectivite (91) : T0=15.66 T1=0.00 T2=2.55 — pondere **5.10**
...
- TROP-CHER : 4497 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4466 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 32434 systemes
  - sans CONNECTED : 0.0% sur 7226 systemes
