...
genere 2026-08-28 11:16 UTC — 140442 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 57098 systemes
...
- moteur actif `0caa9267db60` (96700 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 67860 | 33711 | 4659 | 2313 | 6805 | 5404 | 7151 | 6946 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 66467 | 15369 | 28101 | 30 | 9246 | 3434 | 30 | 10254 | 15.4% |
...
- candidats AVEC connectivite : 7073, dont T2 : 100%
- candidats SANS connectivite : 10564, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7425 systemes avec CONNECTED sur 57846 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*13347 candidats sur 17637 portent les champs bruts (76%).*

- `5c556c16ea8b` — 7382 candidats
  - AVEC connectivite (2945) : resistance **41.4%**
  - SANS connectivite (4437) : resistance **21.8%**
...
- `5c556c16ea8b` — 7382 candidats
  - AVEC connectivite (2945) : T0=13.00 T1=0.00 T2=3.02 — pondere **6.03**
  - SANS connectivite (4437) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.35**
...
## cout
- temps total 43.3 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 7465 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7425 avec CONNECTED, 40 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 55345 systemes
  - sans CONNECTED : 0.0% sur 12515 systemes
