...
genere 2026-09-07 03:11 UTC — 427061 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 343717 systemes
...
- moteur actif `0caa9267db60` (383319 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 212582 | 105549 | 14477 | 7073 | 21567 | 16717 | 22592 | 21904 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 208364 | 48487 | 87865 | 81 | 29046 | 10761 | 74 | 32032 | 15.4% |
...
- candidats AVEC connectivite : 22031, dont T2 : 100%
- candidats SANS connectivite : 32342, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **22866 systemes avec CONNECTED sur 175975 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*50083 candidats sur 54373 portent les champs bruts (92%).*

- `5c556c16ea8b` — 44118 candidats
  - AVEC connectivite (17903) : resistance **41.1%**
  - SANS connectivite (26215) : resistance **21.3%**
...
- `5c556c16ea8b` — 44118 candidats
  - AVEC connectivite (17903) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (26215) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 22950 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 22866 avec CONNECTED, 84 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 173474 systemes
  - sans CONNECTED : 0.0% sur 39108 systemes
