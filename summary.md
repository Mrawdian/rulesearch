...
genere 2026-08-30 03:57 UTC — 206376 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 123032 systemes
...
- moteur actif `0caa9267db60` (162634 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 101166 | 50242 | 6891 | 3387 | 10203 | 8075 | 10652 | 10399 | 10.3% |
...
- candidats AVEC connectivite : 10526, dont T2 : 100%
...
- **10926 systemes avec CONNECTED sur 84999 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*21787 candidats sur 26077 portent les champs bruts (84%).*

- `5c556c16ea8b` — 15822 candidats
  - AVEC connectivite (6398) : resistance **41.1%**
...
- `5c556c16ea8b` — 15822 candidats
  - AVEC connectivite (6398) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.99**
...
- TROP-CHER : 10974 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10926 avec CONNECTED, 48 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 82498 systemes
  - sans CONNECTED : 0.0% sur 18668 systemes
