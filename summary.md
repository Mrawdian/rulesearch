...
genere 2026-08-26 19:08 UTC — 60087 systemes evalues
...
- moteur actif `0caa9267db60` (16345 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27270 | 13609 | 1856 | 921 | 2700 | 2159 | 2894 | 2790 | 10.2% |
...
- candidats AVEC connectivite : 2917, dont T2 : 100%
- candidats SANS connectivite : 4424, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3168 systemes avec CONNECTED sur 24810 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3051 candidats sur 7341 portent les champs bruts (42%).*
...
- `23303c299f39` — 225 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 182 candidats
  - AVEC connectivite (73) : resistance **40.5%**
...
- `62448a55927e` — 182 candidats
  - AVEC connectivite (73) : T0=13.12 T1=0.00 T2=2.97 — pondere **5.95**
...
- TROP-CHER : 3188 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3168 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22309 systemes
  - sans CONNECTED : 0.0% sur 4961 systemes
