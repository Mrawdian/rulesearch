...
| connect | 4 | 3 | 6249 | 3153 | 400 | 227 | 602 | 501 | 643 | 650 | 10.4% |
| ref | 4 | 3 | 6109 | 1481 | 2543 | 1 | 815 | 301 | 2 | 966 | 15.8% |
...
- candidats AVEC connectivite : 653, dont T2 : 100%
- candidats SANS connectivite : 970, dont T2 : 100%
...
- **643 systemes avec CONNECTED sur 5178 (12.4%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 458 candidats
  - AVEC connectivite (174) : T0=13.22 T1=0.00 T2=2.95 — pondere **5.90**
  - SANS connectivite (284) : T0=15.83 T1=0.00 T2=2.62 — pondere **5.24**
...
- TROP-CHER : 645 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 643 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.6% sur 5121 systemes
  - sans CONNECTED : 0.0% sur 1128 systemes
