...
genere 2026-08-26 22:29 UTC — 67290 systemes evalues
...
- moteur actif `0caa9267db60` (23548 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 30919 | 15351 | 2116 | 1037 | 3081 | 2464 | 3302 | 3175 | 10.3% |
...
- candidats AVEC connectivite : 3302, dont T2 : 100%
- candidats SANS connectivite : 4955, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3576 systemes avec CONNECTED sur 27776 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3967 candidats sur 8257 portent les champs bruts (48%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 290 candidats
  - AVEC connectivite (122) : resistance **42.9%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 290 candidats
  - AVEC connectivite (122) : T0=12.84 T1=0.00 T2=3.09 — pondere **6.18**
  - SANS connectivite (168) : T0=16.06 T1=0.00 T2=2.79 — pondere **5.58**
  - test de permutation : **p = 0.1239** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- TROP-CHER : 3600 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3576 avec CONNECTED, 24 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 25275 systemes
  - sans CONNECTED : 0.0% sur 5644 systemes
