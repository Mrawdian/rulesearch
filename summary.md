...
genere 2026-09-05 17:37 UTC — 394524 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 311180 systemes
...
- moteur actif `0caa9267db60` (350782 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 196141 | 97400 | 13352 | 6540 | 19939 | 15429 | 20806 | 20180 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 192268 | 44749 | 81126 | 78 | 26770 | 9938 | 71 | 29522 | 15.4% |
...
- candidats AVEC connectivite : 20307, dont T2 : 100%
- candidats SANS connectivite : 29832, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21080 systemes avec CONNECTED sur 162522 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*45849 candidats sur 50139 portent les champs bruts (91%).*

- `5c556c16ea8b` — 39884 candidats
  - AVEC connectivite (16179) : resistance **41.1%**
  - SANS connectivite (23705) : resistance **21.3%**
...
- `5c556c16ea8b` — 39884 candidats
  - AVEC connectivite (16179) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (23705) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 21161 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21080 avec CONNECTED, 81 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 160021 systemes
  - sans CONNECTED : 0.0% sur 36120 systemes
