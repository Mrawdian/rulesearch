...
| connect | 4 | 3 | 17380 | 8697 | 1121 | 600 | 1723 | 1384 | 1890 | 1747 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 17023 | 4006 | 7197 | 12 | 2333 | 860 | 7 | 2608 | 15.3% |
...
- candidats AVEC connectivite : 1874, dont T2 : 100%
- candidats SANS connectivite : 2918, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2164 systemes avec CONNECTED sur 16699 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*502 candidats sur 4792 portent les champs bruts (10%).*
...
- `e3baecf8377b` — 238 candidats
  - AVEC connectivite (91) : resistance **43.1%**
  - SANS connectivite (147) : resistance **21.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 238 candidats
  - AVEC connectivite (91) : T0=13.10 T1=0.00 T2=3.15 — pondere **6.31**
  - SANS connectivite (147) : T0=16.16 T1=0.00 T2=2.67 — pondere **5.33**
...
**2 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0220).
...
- TROP-CHER : 2181 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2164 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14198 systemes
  - sans CONNECTED : 0.0% sur 3182 systemes
