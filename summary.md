...
genere 2026-08-26 22:41 UTC — 67765 systemes evalues
...
- moteur actif `0caa9267db60` (24023 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 31159 | 15482 | 2129 | 1043 | 3107 | 2480 | 3325 | 3198 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 30491 | 7025 | 12951 | 18 | 4230 | 1584 | 14 | 4669 | 15.3% |
...
- candidats AVEC connectivite : 3325, dont T2 : 100%
- candidats SANS connectivite : 4979, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3599 systemes avec CONNECTED sur 27974 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4014 candidats sur 8304 portent les champs bruts (48%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 337 candidats
  - AVEC connectivite (145) : resistance **42.6%**
  - SANS connectivite (192) : resistance **22.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 337 candidats
  - AVEC connectivite (145) : T0=12.88 T1=0.00 T2=3.08 — pondere **6.17**
  - SANS connectivite (192) : T0=16.17 T1=0.00 T2=2.82 — pondere **5.64**
  - test de permutation : **p = 0.1299** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 25473 systemes
  - sans CONNECTED : 0.0% sur 5686 systemes
