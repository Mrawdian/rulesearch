...
genere 2026-08-26 19:02 UTC — 59896 systemes evalues
...
- moteur actif `0caa9267db60` (16154 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27180 | 13567 | 1848 | 915 | 2694 | 2152 | 2882 | 2783 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 26601 | 6144 | 11264 | 15 | 3706 | 1370 | 10 | 4092 | 15.4% |
...
- candidats AVEC connectivite : 2910, dont T2 : 100%
- candidats SANS connectivite : 4402, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3156 systemes avec CONNECTED sur 24733 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3022 candidats sur 7312 portent les champs bruts (41%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 153 candidats
  - AVEC connectivite (66) : resistance **40.2%**
  - SANS connectivite (87) : resistance **18.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 153 candidats
  - AVEC connectivite (66) : T0=13.11 T1=0.00 T2=2.92 — pondere **5.85**
  - SANS connectivite (87) : T0=16.06 T1=0.00 T2=2.57 — pondere **5.15**
  - test de permutation : **p = 0.1869** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 3176 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3156 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22232 systemes
  - sans CONNECTED : 0.0% sur 4948 systemes
