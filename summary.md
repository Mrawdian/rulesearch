...
genere 2026-09-02 04:12 UTC — 301503 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 218159 systemes
...
- moteur actif `0caa9267db60` (257761 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 149185 | 74135 | 10147 | 5001 | 15123 | 11741 | 15786 | 15341 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 146203 | 33993 | 61873 | 62 | 20242 | 7555 | 63 | 22403 | 15.3% |
...
- candidats AVEC connectivite : 15468, dont T2 : 100%
- candidats SANS connectivite : 22713, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16060 systemes avec CONNECTED sur 124304 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*33891 candidats sur 38181 portent les champs bruts (89%).*

- `5c556c16ea8b` — 27926 candidats
  - AVEC connectivite (11340) : resistance **41.0%**
  - SANS connectivite (16586) : resistance **21.3%**
...
- `5c556c16ea8b` — 27926 candidats
  - AVEC connectivite (11340) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (16586) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 16133 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16060 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 121803 systemes
  - sans CONNECTED : 0.0% sur 27382 systemes
