...
| connect | 4 | 3 | 6204 | 3132 | 397 | 226 | 597 | 497 | 640 | 642 | 10.3% |
| ref | 4 | 3 | 6067 | 1471 | 2529 | 1 | 808 | 300 | 2 | 956 | 15.8% |
...
- candidats AVEC connectivite : 645, dont T2 : 100%
- candidats SANS connectivite : 960, dont T2 : 100%
...
- **640 systemes avec CONNECTED sur 5142 (12.4%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 440 candidats
  - AVEC connectivite (166) : T0=13.27 T1=0.00 T2=2.96 — pondere **5.93**
  - SANS connectivite (274) : T0=15.92 T1=0.00 T2=2.62 — pondere **5.24**
...
- TROP-CHER : 642 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 640 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.6% sur 5085 systemes
  - sans CONNECTED : 0.0% sur 1119 systemes
