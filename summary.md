...
genere 2026-08-26 21:52 UTC — 66107 systemes evalues
...
- moteur actif `0caa9267db60` (22365 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 30323 | 15070 | 2071 | 1021 | 3033 | 2408 | 3226 | 3110 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 29669 | 6841 | 12612 | 16 | 4100 | 1531 | 13 | 4556 | 15.4% |
...
- candidats AVEC connectivite : 3237, dont T2 : 100%
- candidats SANS connectivite : 4866, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3500 systemes avec CONNECTED sur 27286 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3813 candidats sur 8103 portent les champs bruts (47%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 136 candidats
  - AVEC connectivite (57) : resistance **44.0%**
  - SANS connectivite (79) : resistance **22.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 136 candidats
  - AVEC connectivite (57) : T0=13.39 T1=0.00 T2=3.09 — pondere **6.18**
  - SANS connectivite (79) : T0=16.08 T1=0.00 T2=2.89 — pondere **5.77**
  - test de permutation : **p = 0.4603** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24785 systemes
  - sans CONNECTED : 0.0% sur 5538 systemes
