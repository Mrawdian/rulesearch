...
genere 2026-08-27 22:14 UTC — 116431 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 33087 systemes
...
- moteur actif `0caa9267db60` (72689 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 55725 | 27765 | 3847 | 1890 | 5514 | 4415 | 5889 | 5685 | 10.2% |
...
- candidats AVEC connectivite : 5812, dont T2 : 100%
- candidats SANS connectivite : 8676, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6163 systemes avec CONNECTED sur 48032 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10198 candidats sur 14488 portent les champs bruts (70%).*

- `5c556c16ea8b` — 4233 candidats
  - AVEC connectivite (1684) : resistance **41.9%**
...
- `5c556c16ea8b` — 4233 candidats
  - AVEC connectivite (1684) : T0=12.94 T1=0.00 T2=3.05 — pondere **6.09**
...
- TROP-CHER : 6198 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6163 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 45531 systemes
  - sans CONNECTED : 0.0% sur 10194 systemes
