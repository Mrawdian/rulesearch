...
genere 2026-09-01 22:48 UTC — 295039 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 211695 systemes
...
- moteur actif `0caa9267db60` (251297 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 145920 | 72468 | 9920 | 4895 | 14821 | 11505 | 15433 | 14997 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 143004 | 33258 | 60498 | 61 | 19809 | 7384 | 63 | 21920 | 15.3% |
...
- candidats AVEC connectivite : 15124, dont T2 : 100%
...
- **15707 systemes avec CONNECTED sur 121586 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*33064 candidats sur 37354 portent les champs bruts (89%).*

- `5c556c16ea8b` — 27099 candidats
  - AVEC connectivite (10996) : resistance **41.0%**
...
- `5c556c16ea8b` — 27099 candidats
  - AVEC connectivite (10996) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 15780 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15707 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 119085 systemes
  - sans CONNECTED : 0.0% sur 26835 systemes
