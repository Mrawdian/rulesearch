...
genere 2026-08-26 20:26 UTC — 62922 systemes evalues
...
- moteur actif `0caa9267db60` (19180 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 28707 | 14293 | 1967 | 962 | 2848 | 2276 | 3053 | 2948 | 10.3% |
...
- candidats AVEC connectivite : 3075, dont T2 : 100%
- candidats SANS connectivite : 4628, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3327 systemes avec CONNECTED sur 25985 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3413 candidats sur 7703 portent les champs bruts (44%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 544 candidats
  - AVEC connectivite (231) : resistance **39.6%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 544 candidats
  - AVEC connectivite (231) : T0=12.83 T1=0.00 T2=2.84 — pondere **5.67**
  - SANS connectivite (313) : T0=16.18 T1=0.00 T2=2.66 — pondere **5.32**
  - test de permutation : **p = 0.1819** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23484 systemes
  - sans CONNECTED : 0.0% sur 5223 systemes
