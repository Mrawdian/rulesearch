...
genere 2026-09-05 02:07 UTC — 378764 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 295420 systemes
...
- moteur actif `0caa9267db60` (335022 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 188180 | 93455 | 12815 | 6286 | 19138 | 14827 | 19949 | 19294 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 184469 | 42916 | 77914 | 77 | 25622 | 9546 | 70 | 28310 | 15.3% |
...
- candidats SANS connectivite : 28620, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20223 systemes avec CONNECTED sur 156006 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*43751 candidats sur 48041 portent les champs bruts (91%).*

- `5c556c16ea8b` — 37786 candidats
  - AVEC connectivite (15293) : resistance **41.1%**
  - SANS connectivite (22493) : resistance **21.2%**
...
- `5c556c16ea8b` — 37786 candidats
  ...
  - SANS connectivite (22493) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 20303 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 20223 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 153505 systemes
  - sans CONNECTED : 0.0% sur 34675 systemes
