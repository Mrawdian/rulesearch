...
genere 2026-09-01 15:59 UTC — 286843 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 203499 systemes
...
- moteur actif `0caa9267db60` (243101 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 141779 | 70442 | 9609 | 4740 | 14403 | 11190 | 14976 | 14583 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 138949 | 32310 | 58752 | 59 | 19268 | 7196 | 62 | 21291 | 15.3% |
...
- candidats AVEC connectivite : 14710, dont T2 : 100%
- candidats SANS connectivite : 21601, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15250 systemes avec CONNECTED sur 118177 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*32021 candidats sur 36311 portent les champs bruts (88%).*

- `5c556c16ea8b` — 26056 candidats
  - AVEC connectivite (10582) : resistance **41.0%**
  - SANS connectivite (15474) : resistance **21.4%**
...
- `5c556c16ea8b` — 26056 candidats
  - AVEC connectivite (10582) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (15474) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
## cout
- temps total 88.8 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 15322 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15250 avec CONNECTED, 72 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 115676 systemes
  - sans CONNECTED : 0.0% sur 26103 systemes
