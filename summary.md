...
genere 2026-08-26 05:09 UTC — 25141 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 16167 systemes
...
**7466 enregistrements (30%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 12641 | 6330 | 830 | 432 | 1225 | 1009 | 1373 | 1281 | 10.1% |
| ref | 4 | 3 | 12376 | 2951 | 5208 | 9 | 1672 | 627 | 4 | 1905 | 15.4% |
...
- candidats AVEC connectivite : 1284, dont T2 : 100%
- candidats SANS connectivite : 1909, dont T2 : 100%
...
- **1373 systemes avec CONNECTED sur 10417 (13.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2028 candidats
  - AVEC connectivite (805) : T0=13.25 T1=0.00 T2=2.85 — pondere **5.70**
  - SANS connectivite (1223) : T0=15.91 T1=0.00 T2=2.64 — pondere **5.27**
  - test de permutation : **p = 0.0015** — ecart significatif au seuil 0.05
...
## cout
- temps total 8.0 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 1377 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1373 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 10360 systemes
  - sans CONNECTED : 0.0% sur 2281 systemes
