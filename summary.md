...
genere 2026-08-31 19:51 UTC — 261642 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 178298 systemes
...
- moteur actif `0caa9267db60` (217900 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 129070 | 64168 | 8728 | 4326 | 13075 | 10199 | 13598 | 13292 | 10.3% |
...
- candidats AVEC connectivite : 13419, dont T2 : 100%
...
- **13872 systemes avec CONNECTED sur 107804 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*28835 candidats sur 33125 portent les champs bruts (87%).*

- `5c556c16ea8b` — 22870 candidats
  - AVEC connectivite (9291) : resistance **41.1%**
...
- `5c556c16ea8b` — 22870 candidats
  - AVEC connectivite (9291) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.98**
...
- TROP-CHER : 13938 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13872 avec CONNECTED, 66 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 105303 systemes
  - sans CONNECTED : 0.0% sur 23767 systemes
