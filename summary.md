...
genere 2026-09-06 00:36 UTC — 401465 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 318121 systemes
...
- moteur actif `0caa9267db60` (357723 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 199647 | 99117 | 13596 | 6651 | 20282 | 15717 | 21185 | 20557 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 195703 | 45520 | 82570 | 78 | 27268 | 10111 | 72 | 30067 | 15.4% |
...
- candidats AVEC connectivite : 20684, dont T2 : 100%
- candidats SANS connectivite : 30377, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21459 systemes avec CONNECTED sur 165378 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*46771 candidats sur 51061 portent les champs bruts (92%).*

- `5c556c16ea8b` — 40806 candidats
  - AVEC connectivite (16556) : resistance **41.0%**
  - SANS connectivite (24250) : resistance **21.3%**
...
- `5c556c16ea8b` — 40806 candidats
  - AVEC connectivite (16556) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.94**
  - SANS connectivite (24250) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
## cout
- temps total 124.7 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 21541 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21459 avec CONNECTED, 82 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 162877 systemes
  - sans CONNECTED : 0.0% sur 36770 systemes
