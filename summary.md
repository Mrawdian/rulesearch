...
genere 2026-08-27 08:46 UTC — 89856 systemes evalues
...
- moteur actif `0caa9267db60` (46114 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 42302 | 21068 | 2905 | 1430 | 4220 | 3319 | 4461 | 4353 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 41439 | 9552 | 17616 | 24 | 5732 | 2158 | 22 | 6335 | 15.3% |
...
- candidats AVEC connectivite : 4480, dont T2 : 100%
- candidats SANS connectivite : 6645, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4735 systemes avec CONNECTED sur 37081 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6835 candidats sur 11125 portent les champs bruts (61%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 870 candidats
  - AVEC connectivite (352) : resistance **40.9%**
  - SANS connectivite (518) : resistance **21.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 870 candidats
  - AVEC connectivite (352) : T0=13.13 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (518) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.29**
...
- TROP-CHER : 4767 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4735 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 34580 systemes
  - sans CONNECTED : 0.0% sur 7722 systemes
