...
genere 2026-09-03 15:39 UTC — 341893 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 258549 systemes
...
- moteur actif `0caa9267db60` (298151 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 169576 | 84289 | 11498 | 5681 | 17248 | 13390 | 17969 | 17338 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 166202 | 38661 | 70251 | 67 | 23060 | 8592 | 66 | 25493 | 15.3% |
...
- candidats SANS connectivite : 25803, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18243 systemes avec CONNECTED sur 140855 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*38978 candidats sur 43268 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33013 candidats
  - AVEC connectivite (13337) : resistance **41.0%**
  - SANS connectivite (19676) : resistance **21.2%**
...
- `5c556c16ea8b` — 33013 candidats
  ...
  - SANS connectivite (19676) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.29**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 138354 systemes
  - sans CONNECTED : 0.0% sur 31222 systemes
