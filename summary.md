...
| connect | 4 | 3 | 18546 | 9260 | 1202 | 643 | 1853 | 1476 | 2011 | 1871 | 10.1% |
...
- candidats AVEC connectivite : 1998, dont T2 : 100%
- candidats SANS connectivite : 3094, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2285 systemes avec CONNECTED sur 17637 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*802 candidats sur 5092 portent les champs bruts (16%).*
...
- `e3baecf8377b` — 538 candidats
  - AVEC connectivite (215) : resistance **42.2%**
...
- `e3baecf8377b` — 538 candidats
  - AVEC connectivite (215) : T0=13.09 T1=0.00 T2=3.08 — pondere **6.17**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 15136 systemes
  - sans CONNECTED : 0.0% sur 3410 systemes
