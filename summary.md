...
genere 2026-08-26 02:29 UTC — 18386 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 9412 systemes
...
**7466 enregistrements (41%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 9238 | 4645 | 605 | 309 | 888 | 729 | 1003 | 948 | 10.3% |
| ref | 4 | 3 | 9024 | 2167 | 3802 | 2 | 1199 | 448 | 4 | 1402 | 15.5% |
...
- candidats AVEC connectivite : 951, dont T2 : 100%
- candidats SANS connectivite : 1406, dont T2 : 100%
...
- **1003 systemes avec CONNECTED sur 7652 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1192 candidats
  - AVEC connectivite (472) : T0=13.35 T1=0.00 T2=2.91 — pondere **5.82**
  - SANS connectivite (720) : T0=15.86 T1=0.00 T2=2.66 — pondere **5.33**
  - test de permutation : **p = 0.0080** — ecart significatif au seuil 0.05
...
## cout
- temps total 5.8 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 1007 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1003 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 7595 systemes
  - sans CONNECTED : 0.0% sur 1643 systemes
