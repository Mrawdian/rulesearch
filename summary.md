...
genere 2026-08-26 10:06 UTC — 37940 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 28966 systemes
...
| connect | 4 | 3 | 16152 | 8063 | 1050 | 554 | 1606 | 1285 | 1765 | 1626 | 10.1% |
| d4 | 4 | 4 | 5841 | 2681 | 1484 | 30 | 409 | 393 | 275 | 421 | 7.2% |
| ref | 4 | 3 | 15823 | 3721 | 6685 | 11 | 2168 | 802 | 7 | 2429 | 15.4% |
...
- candidats AVEC connectivite : 1749, dont T2 : 100%
- candidats SANS connectivite : 2734, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2030 systemes avec CONNECTED sur 15638 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*193 candidats sur 4483 portent les champs bruts (4%).*

- `89c65c03c4ad` — 193 candidats
  - AVEC connectivite (72) : resistance **47.9%**
  - SANS connectivite (121) : resistance **21.5%**
...
- `89c65c03c4ad` — 3318 candidats
  - AVEC connectivite (1270) : T0=13.04 T1=0.00 T2=2.96 — pondere **5.93**
  - SANS connectivite (2048) : T0=15.85 T1=0.02 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 2047 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2030 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.4% sur 13201 systemes
  - sans CONNECTED : 0.0% sur 2951 systemes
