...
genere 2026-08-28 00:17 UTC — 120421 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 37077 systemes
...
- moteur actif `0caa9267db60` (76679 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 57737 | 28755 | 3995 | 1951 | 5731 | 4567 | 6094 | 5904 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 56569 | 13055 | 24003 | 28 | 7868 | 2920 | 25 | 8668 | 15.3% |
...
- candidats AVEC connectivite : 6031, dont T2 : 100%
- candidats SANS connectivite : 8978, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6368 systemes avec CONNECTED sur 49662 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10719 candidats sur 15009 portent les champs bruts (71%).*

- `5c556c16ea8b` — 4754 candidats
  - AVEC connectivite (1903) : resistance **42.0%**
  - SANS connectivite (2851) : resistance **22.5%**
...
- `5c556c16ea8b` — 4754 candidats
  - AVEC connectivite (1903) : T0=12.98 T1=0.00 T2=3.05 — pondere **6.10**
  - SANS connectivite (2851) : T0=15.80 T1=0.00 T2=2.72 — pondere **5.44**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 47161 systemes
  - sans CONNECTED : 0.0% sur 10576 systemes
