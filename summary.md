...
- moteur actif `0caa9267db60` (47796 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 42269 | 9751 | 17940 | 25 | 5858 | 2207 | 22 | 6465 | 15.3% |
...
- candidats SANS connectivite : 6775, dont T2 : 100%
...
*7032 candidats sur 11322 portent les champs bruts (62%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 1067 candidats
  - AVEC connectivite (419) : resistance **41.2%**
  - SANS connectivite (648) : resistance **21.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 1067 candidats
  ...
  - SANS connectivite (648) : T0=15.81 T1=0.00 T2=2.63 — pondere **5.27**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
