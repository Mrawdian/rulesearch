...
genere 2026-08-26 15:00 UTC — 50198 systemes evalues
...
- moteur actif `0caa9267db60` (6456 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22280 | 11106 | 1496 | 764 | 2218 | 1765 | 2384 | 2267 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 21803 | 5063 | 9194 | 13 | 3041 | 1119 | 10 | 3363 | 15.4% |
...
- candidats AVEC connectivite : 2394, dont T2 : 100%
- candidats SANS connectivite : 3673, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2658 systemes avec CONNECTED sur 20691 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1777 candidats sur 6067 portent les champs bruts (29%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 662 candidats
  - AVEC connectivite (256) : resistance **41.0%**
  - SANS connectivite (406) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 662 candidats
  - AVEC connectivite (256) : T0=13.33 T1=0.00 T2=3.02 — pondere **6.04**
  - SANS connectivite (406) : T0=16.03 T1=0.00 T2=2.65 — pondere **5.30**
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0045).
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18190 systemes
  - sans CONNECTED : 0.0% sur 4090 systemes
