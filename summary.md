...
genere 2026-09-06 16:15 UTC — 416588 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 333244 systemes
...
- moteur actif `0caa9267db60` (372846 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 207292 | 102913 | 14125 | 6895 | 21013 | 16317 | 22032 | 21360 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 203181 | 47243 | 85721 | 79 | 28325 | 10494 | 73 | 31229 | 15.4% |
...
- candidats AVEC connectivite : 21487, dont T2 : 100%
- candidats SANS connectivite : 31539, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **22306 systemes avec CONNECTED sur 171648 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*48736 candidats sur 53026 portent les champs bruts (92%).*

- `5c556c16ea8b` — 42771 candidats
  - AVEC connectivite (17359) : resistance **41.1%**
  - SANS connectivite (25412) : resistance **21.3%**
...
- `5c556c16ea8b` — 42771 candidats
  - AVEC connectivite (17359) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (25412) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 22389 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 22306 avec CONNECTED, 83 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 169147 systemes
  - sans CONNECTED : 0.0% sur 38145 systemes
