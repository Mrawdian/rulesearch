...
| connect | 4 | 3 | 6293 | 3174 | 404 | 228 | 606 | 502 | 649 | 657 | 10.4% |
| ref | 4 | 3 | 6153 | 1491 | 2559 | 1 | 827 | 303 | 2 | 970 | 15.8% |
...
- candidats AVEC connectivite : 660, dont T2 : 100%
- candidats SANS connectivite : 974, dont T2 : 100%
...
- **649 systemes avec CONNECTED sur 5216 (12.4%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 469 candidats
  - AVEC connectivite (181) : T0=13.24 T1=0.00 T2=2.91 — pondere **5.81**
  - SANS connectivite (288) : T0=15.82 T1=0.00 T2=2.63 — pondere **5.26**
...
- TROP-CHER : 651 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 649 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.6% sur 5159 systemes
  - sans CONNECTED : 0.0% sur 1134 systemes
