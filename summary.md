...
| connect | 4 | 3 | 5197 | 2606 | 327 | 186 | 506 | 428 | 543 | 542 | 10.4% |
| ref | 4 | 3 | 5074 | 1232 | 2126 | 1 | 665 | 244 | 2 | 804 | 15.8% |
...
- candidats AVEC connectivite : 545, dont T2 : 100%
- candidats SANS connectivite : 808, dont T2 : 100%
...
- **543 systemes avec CONNECTED sur 4297 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 188 candidats
  - AVEC connectivite (66) : T0=13.26 T1=0.00 T2=2.85 — pondere **5.70**
  - SANS connectivite (122) : T0=16.11 T1=0.00 T2=2.67 — pondere **5.34**
...
- TROP-CHER : 545 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 543 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 4240 systemes
  - sans CONNECTED : 0.0% sur 957 systemes
