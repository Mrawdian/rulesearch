...
genere 2026-08-27 02:34 UTC — 76314 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 11407 systemes
...
- moteur actif `0caa9267db60` (32572 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 35483 | 17650 | 2440 | 1202 | 3520 | 2814 | 3777 | 3623 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 34716 | 7995 | 14769 | 20 | 4805 | 1815 | 19 | 5293 | 15.2% |
...
- candidats AVEC connectivite : 3750, dont T2 : 100%
- candidats SANS connectivite : 5603, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4051 systemes avec CONNECTED sur 31537 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5063 candidats sur 9353 portent les champs bruts (54%).*
...
- `ab89a63b01ef` — 1386 candidats
  - AVEC connectivite (570) : resistance **41.0%**
  - SANS connectivite (816) : resistance **22.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1386 candidats
  - AVEC connectivite (570) : T0=13.00 T1=0.00 T2=3.03 — pondere **6.05**
  - SANS connectivite (816) : T0=15.91 T1=0.00 T2=2.69 — pondere **5.38**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- TROP-CHER : 4080 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4051 avec CONNECTED, 29 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 29036 systemes
  - sans CONNECTED : 0.0% sur 6447 systemes
