...
genere 2026-08-28 13:22 UTC — 144025 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 60681 systemes
...
- moteur actif `0caa9267db60` (100283 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 69663 | 34610 | 4766 | 2362 | 6987 | 5568 | 7354 | 7123 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 68247 | 15839 | 28841 | 32 | 9451 | 3518 | 30 | 10533 | 15.4% |
...
- candidats AVEC connectivite : 7250, dont T2 : 100%
...
- **7628 systemes avec CONNECTED sur 59312 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*13803 candidats sur 18093 portent les champs bruts (76%).*

- `5c556c16ea8b` — 7838 candidats
  - AVEC connectivite (3122) : resistance **41.3%**
...
- `5c556c16ea8b` — 7838 candidats
  - AVEC connectivite (3122) : T0=13.00 T1=0.00 T2=3.00 — pondere **6.01**
...
- TROP-CHER : 7668 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7628 avec CONNECTED, 40 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 56811 systemes
  - sans CONNECTED : 0.0% sur 12852 systemes
