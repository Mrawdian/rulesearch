...
genere 2026-08-28 05:12 UTC — 129862 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 46518 systemes
...
- moteur actif `0caa9267db60` (86120 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 62514 | 31095 | 4302 | 2116 | 6238 | 4972 | 6559 | 6423 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 61233 | 14157 | 25942 | 28 | 8511 | 3169 | 27 | 9397 | 15.3% |
...
- candidats AVEC connectivite : 6550, dont T2 : 100%
- candidats SANS connectivite : 9707, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6833 systemes avec CONNECTED sur 53515 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11967 candidats sur 16257 portent les champs bruts (74%).*

- `5c556c16ea8b` — 6002 candidats
  - AVEC connectivite (2422) : resistance **41.6%**
  - SANS connectivite (3580) : resistance **22.0%**
...
- `5c556c16ea8b` — 6002 candidats
  - AVEC connectivite (2422) : T0=12.99 T1=0.00 T2=3.03 — pondere **6.05**
  - SANS connectivite (3580) : T0=15.87 T1=0.00 T2=2.70 — pondere **5.39**
...
## cout
- temps total 39.9 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 6870 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6833 avec CONNECTED, 37 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 51014 systemes
  - sans CONNECTED : 0.0% sur 11500 systemes
