...
genere 2026-09-09 07:29 UTC — 474492 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 391148 systemes
...
- moteur actif `0caa9267db60` (430750 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 236547 | 117461 | 16131 | 7923 | 23926 | 18530 | 25192 | 24379 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 231830 | 54020 | 97657 | 92 | 32282 | 11976 | 83 | 35701 | 15.4% |
...
- candidats AVEC connectivite : 24506, dont T2 : 100%
- candidats SANS connectivite : 36011, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25466 systemes avec CONNECTED sur 195651 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*56227 candidats sur 60517 portent les champs bruts (93%).*

- `5c556c16ea8b` — 50262 candidats
  - AVEC connectivite (20378) : resistance **41.2%**
  - SANS connectivite (29884) : resistance **21.3%**
...
- `5c556c16ea8b` — 50262 candidats
  - AVEC connectivite (20378) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (29884) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
## cout
- temps total 147.9 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 25559 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25466 avec CONNECTED, 93 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 193150 systemes
  - sans CONNECTED : 0.0% sur 43397 systemes
