...
genere 2026-08-27 00:19 UTC — 71396 systemes evalues
...
- moteur actif `0caa9267db60` (27654 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 33000 | 16391 | 2272 | 1118 | 3280 | 2625 | 3518 | 3373 | 10.2% |
...
- candidats AVEC connectivite : 3500, dont T2 : 100%
- candidats SANS connectivite : 5246, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3792 systemes avec CONNECTED sur 29480 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4456 candidats sur 8746 portent les champs bruts (51%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 779 candidats
  - AVEC connectivite (320) : resistance **41.4%**
...
- `ab89a63b01ef` — 779 candidats
  - AVEC connectivite (320) : T0=13.18 T1=0.00 T2=3.07 — pondere **6.14**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 26979 systemes
  - sans CONNECTED : 0.0% sur 6021 systemes
