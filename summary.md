...
genere 2026-09-02 00:43 UTC — 297391 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 214047 systemes
...
- moteur actif `0caa9267db60` (253649 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 147112 | 73085 | 10012 | 4932 | 14927 | 11588 | 15553 | 15122 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 144164 | 33534 | 60989 | 61 | 19966 | 7444 | 63 | 22095 | 15.3% |
...
- candidats AVEC connectivite : 15249, dont T2 : 100%
- candidats SANS connectivite : 22405, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15827 systemes avec CONNECTED sur 122588 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*33364 candidats sur 37654 portent les champs bruts (89%).*

- `5c556c16ea8b` — 27399 candidats
  - AVEC connectivite (11121) : resistance **41.0%**
  - SANS connectivite (16278) : resistance **21.3%**
...
- `5c556c16ea8b` — 27399 candidats
  - AVEC connectivite (11121) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (16278) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
## cout
- temps total 92.1 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 15900 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15827 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 120087 systemes
  - sans CONNECTED : 0.0% sur 27025 systemes
