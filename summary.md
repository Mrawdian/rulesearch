...
genere 2026-08-26 12:53 UTC — 45097 systemes evalues
...
**7466 enregistrements (17%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 19696 | 9828 | 1282 | 683 | 1975 | 1559 | 2118 | 2007 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 19286 | 4531 | 8136 | 13 | 2653 | 994 | 7 | 2952 | 15.3% |
...
- candidats AVEC connectivite : 2134, dont T2 : 100%
- candidats SANS connectivite : 3262, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2392 systemes avec CONNECTED sur 18584 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1106 candidats sur 5396 portent les champs bruts (20%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `e40600351a72` — 185 candidats
  - AVEC connectivite (83) : resistance **39.6%**
  - SANS connectivite (102) : resistance **19.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e40600351a72` — 185 candidats
  - AVEC connectivite (83) : T0=12.94 T1=0.00 T2=2.88 — pondere **5.76**
  - SANS connectivite (102) : T0=16.62 T1=0.00 T2=2.60 — pondere **5.20**
...
**2 serie(s) reproductible(s) sur 5 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005).
...
## cout
- temps total 14.0 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2409 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2392 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 16083 systemes
  - sans CONNECTED : 0.0% sur 3613 systemes
