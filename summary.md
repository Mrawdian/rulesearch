...
genere 2026-08-30 10:09 UTC — 214947 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 131603 systemes
...
- moteur actif `0caa9267db60` (171205 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 105491 | 52364 | 7188 | 3518 | 10640 | 8388 | 11181 | 10835 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 103341 | 24112 | 43637 | 48 | 14272 | 5328 | 41 | 15895 | 15.4% |
...
- candidats AVEC connectivite : 10962, dont T2 : 100%
- candidats SANS connectivite : 16205, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11455 systemes avec CONNECTED sur 88551 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*22877 candidats sur 27167 portent les champs bruts (84%).*

- `5c556c16ea8b` — 16912 candidats
  - AVEC connectivite (6834) : resistance **41.1%**
  - SANS connectivite (10078) : resistance **21.5%**
...
- `5c556c16ea8b` — 16912 candidats
  - AVEC connectivite (6834) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (10078) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 11506 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 11455 avec CONNECTED, 51 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 86050 systemes
  - sans CONNECTED : 0.0% sur 19441 systemes
