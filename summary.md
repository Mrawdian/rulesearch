...
- moteur actif `0caa9267db60` (7315 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22714 | 11323 | 1529 | 772 | 2265 | 1801 | 2433 | 2307 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 22228 | 5153 | 9380 | 13 | 3105 | 1139 | 10 | 3428 | 15.4% |
...
- candidats AVEC connectivite : 2434, dont T2 : 100%
- candidats SANS connectivite : 3738, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2707 systemes avec CONNECTED sur 21042 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1882 candidats sur 6172 portent les champs bruts (30%).*
...
- `06fe04a859f1` — 767 candidats
  - AVEC connectivite (296) : resistance **41.2%**
  - SANS connectivite (471) : resistance **20.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 767 candidats
  - AVEC connectivite (296) : T0=13.35 T1=0.00 T2=3.03 — pondere **6.06**
  - SANS connectivite (471) : T0=16.03 T1=0.00 T2=2.61 — pondere **5.23**
...
- TROP-CHER : 2727 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2707 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18541 systemes
  - sans CONNECTED : 0.0% sur 4173 systemes
