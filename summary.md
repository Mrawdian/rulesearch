...
genere 2026-08-28 22:36 UTC — 160011 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 76667 systemes
...
- moteur actif `0caa9267db60` (116269 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 77736 | 38601 | 5304 | 2649 | 7784 | 6218 | 8187 | 8001 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 76160 | 17707 | 32247 | 35 | 10492 | 3897 | 31 | 11747 | 15.4% |
...
- candidats AVEC connectivite : 8128, dont T2 : 100%
- candidats SANS connectivite : 12057, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8461 systemes avec CONNECTED sur 65896 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*15895 candidats sur 20185 portent les champs bruts (79%).*

- `5c556c16ea8b` — 9930 candidats
  - AVEC connectivite (4000) : resistance **41.2%**
  - SANS connectivite (5930) : resistance **21.8%**
...
- `5c556c16ea8b` — 9930 candidats
  - AVEC connectivite (4000) : T0=13.00 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (5930) : T0=15.88 T1=0.00 T2=2.69 — pondere **5.37**
...
- TROP-CHER : 8502 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8461 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 63395 systemes
  - sans CONNECTED : 0.0% sur 14341 systemes
