...
genere 2026-09-02 02:58 UTC — 299913 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 216569 systemes
...
- moteur actif `0caa9267db60` (256171 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 148378 | 73713 | 10100 | 4974 | 15056 | 11669 | 15719 | 15245 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 145420 | 33814 | 61556 | 62 | 20129 | 7517 | 63 | 22267 | 15.3% |
...
- candidats AVEC connectivite : 15372, dont T2 : 100%
- candidats SANS connectivite : 22577, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15993 systemes avec CONNECTED sur 123636 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*33659 candidats sur 37949 portent les champs bruts (89%).*

- `5c556c16ea8b` — 27694 candidats
  - AVEC connectivite (11244) : resistance **41.0%**
  - SANS connectivite (16450) : resistance **21.3%**
...
- `5c556c16ea8b` — 27694 candidats
  - AVEC connectivite (11244) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (16450) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 16066 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 15993 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 121135 systemes
  - sans CONNECTED : 0.0% sur 27243 systemes
