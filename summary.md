...
genere 2026-08-27 23:47 UTC — 119430 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 36086 systemes
...
- moteur actif `0caa9267db60` (75688 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 57232 | 28517 | 3954 | 1938 | 5674 | 4531 | 6045 | 5840 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 56083 | 12937 | 23809 | 26 | 7796 | 2896 | 25 | 8592 | 15.3% |
...
- candidats AVEC connectivite : 5967, dont T2 : 100%
- candidats SANS connectivite : 8902, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6319 systemes avec CONNECTED sur 49249 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10579 candidats sur 14869 portent les champs bruts (71%).*

- `5c556c16ea8b` — 4614 candidats
  - AVEC connectivite (1839) : resistance **42.0%**
  - SANS connectivite (2775) : resistance **22.4%**
...
- `5c556c16ea8b` — 4614 candidats
  - AVEC connectivite (1839) : T0=12.98 T1=0.00 T2=3.06 — pondere **6.12**
  - SANS connectivite (2775) : T0=15.77 T1=0.00 T2=2.71 — pondere **5.42**
...
- TROP-CHER : 6354 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6319 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 46748 systemes
  - sans CONNECTED : 0.0% sur 10484 systemes
