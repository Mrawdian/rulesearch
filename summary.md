...
genere 2026-08-26 14:30 UTC — 49086 systemes evalues
...
- moteur actif `0caa9267db60` (5344 systemes) : `06fe04a859f1`, `e40600351a72`
...
| ref | 4 | 3 | 21260 | 4941 | 8977 | 13 | 2945 | 1099 | 8 | 3277 | 15.4% |
...
- candidats SANS connectivite : 3587, dont T2 : 100%
...
*1639 candidats sur 5929 portent les champs bruts (28%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 524 candidats
  - AVEC connectivite (204) : resistance **40.0%**
  - SANS connectivite (320) : resistance **20.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 524 candidats
  ...
  - SANS connectivite (320) : T0=16.06 T1=0.00 T2=2.62 — pondere **5.25**
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0110).
