...
genere 2026-09-09 02:52 UTC — 470460 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 387116 systemes
...
- moteur actif `0caa9267db60` (426718 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 234500 | 116456 | 15989 | 7851 | 23740 | 18363 | 24965 | 24161 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 229845 | 53540 | 96840 | 92 | 32030 | 11873 | 82 | 35369 | 15.4% |
...
- candidats AVEC connectivite : 24288, dont T2 : 100%
- candidats SANS connectivite : 35679, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25239 systemes avec CONNECTED sur 193964 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55677 candidats sur 59967 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49712 candidats
  - AVEC connectivite (20160) : resistance **41.2%**
  - SANS connectivite (29552) : resistance **21.3%**
...
- `5c556c16ea8b` — 49712 candidats
  - AVEC connectivite (20160) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (29552) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
## cout
- temps total 146.6 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 25331 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25239 avec CONNECTED, 92 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 191463 systemes
  - sans CONNECTED : 0.0% sur 43037 systemes
