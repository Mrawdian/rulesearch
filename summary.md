...
| connect | 4 | 3 | 17768 | 8890 | 1147 | 613 | 1763 | 1411 | 1934 | 1786 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 17384 | 4089 | 7347 | 12 | 2378 | 884 | 7 | 2667 | 15.3% |
...
- candidats AVEC connectivite : 1913, dont T2 : 100%
- candidats SANS connectivite : 2977, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2208 systemes avec CONNECTED sur 17015 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*600 candidats sur 4890 portent les champs bruts (12%).*
...
- `e3baecf8377b` — 336 candidats
  - AVEC connectivite (130) : resistance **43.7%**
  - SANS connectivite (206) : resistance **21.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 336 candidats
  - AVEC connectivite (130) : T0=12.95 T1=0.00 T2=3.15 — pondere **6.31**
  - SANS connectivite (206) : T0=16.10 T1=0.00 T2=2.68 — pondere **5.36**
...
**2 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0130).
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14514 systemes
  - sans CONNECTED : 0.0% sur 3254 systemes
