...
| connect | 4 | 3 | 18007 | 9002 | 1170 | 626 | 1784 | 1429 | 1960 | 1810 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 17618 | 4147 | 7433 | 12 | 2412 | 896 | 7 | 2711 | 15.4% |
...
- candidats AVEC connectivite : 1937, dont T2 : 100%
- candidats SANS connectivite : 3021, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2234 systemes avec CONNECTED sur 17209 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*668 candidats sur 4958 portent les champs bruts (13%).*
...
- `e3baecf8377b` — 404 candidats
  - AVEC connectivite (154) : resistance **44.3%**
  - SANS connectivite (250) : resistance **21.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 404 candidats
  - AVEC connectivite (154) : T0=12.94 T1=0.00 T2=3.23 — pondere **6.47**
  - SANS connectivite (250) : T0=16.02 T1=0.00 T2=2.67 — pondere **5.34**
...
**2 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0020).
...
## cout
- temps total 13.1 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2251 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 2234 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14708 systemes
  - sans CONNECTED : 0.0% sur 3299 systemes
