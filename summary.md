...
genere 2026-08-31 09:21 UTC — 247577 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 164233 systemes
...
- moteur actif `0caa9267db60` (203835 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 121961 | 60653 | 8277 | 4088 | 12269 | 9630 | 12887 | 12574 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 119501 | 27898 | 50448 | 53 | 16516 | 6178 | 54 | 18344 | 15.4% |
...
- candidats AVEC connectivite : 12701, dont T2 : 100%
- candidats SANS connectivite : 18654, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13161 systemes avec CONNECTED sur 102062 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*27065 candidats sur 31355 portent les champs bruts (86%).*

- `5c556c16ea8b` — 21100 candidats
  - AVEC connectivite (8573) : resistance **40.9%**
  - SANS connectivite (12527) : resistance **21.3%**
...
- `5c556c16ea8b` — 21100 candidats
  - AVEC connectivite (8573) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (12527) : T0=15.90 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 99561 systemes
  - sans CONNECTED : 0.0% sur 22400 systemes
