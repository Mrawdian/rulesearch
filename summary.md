...
genere 2026-08-27 06:42 UTC — 85549 systemes evalues
...
- moteur actif `0caa9267db60` (41807 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 40137 | 19984 | 2749 | 1366 | 4004 | 3155 | 4234 | 4126 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 39297 | 9045 | 16723 | 22 | 5448 | 2050 | 21 | 5988 | 15.2% |
...
- candidats AVEC connectivite : 4253, dont T2 : 100%
- candidats SANS connectivite : 6298, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4508 systemes avec CONNECTED sur 35321 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6261 candidats sur 10551 portent les champs bruts (59%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 296 candidats
  - AVEC connectivite (125) : resistance **41.1%**
  - SANS connectivite (171) : resistance **21.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 296 candidats
  - AVEC connectivite (125) : T0=13.06 T1=0.00 T2=3.02 — pondere **6.03**
  - SANS connectivite (171) : T0=15.81 T1=0.00 T2=2.70 — pondere **5.40**
  - test de permutation : **p = 0.0875** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- TROP-CHER : 4539 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4508 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 32820 systemes
  - sans CONNECTED : 0.0% sur 7317 systemes
