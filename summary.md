...
genere 2026-08-26 13:27 UTC — 46600 systemes evalues
...
- moteur actif `0caa9267db60` (2858 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20455 | 10205 | 1347 | 706 | 2044 | 1627 | 2186 | 2088 | 10.2% |
...
- candidats AVEC connectivite : 2215, dont T2 : 100%
- candidats SANS connectivite : 3358, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2460 systemes avec CONNECTED sur 19193 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1283 candidats sur 5573 portent les champs bruts (23%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 168 candidats
  - AVEC connectivite (77) : resistance **37.6%**
...
- `06fe04a859f1` — 168 candidats
  - AVEC connectivite (77) : T0=13.48 T1=0.00 T2=2.71 — pondere **5.43**
  - SANS connectivite (91) : T0=16.31 T1=0.00 T2=3.00 — pondere **6.00**
  - test de permutation : **p = 0.2489** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 2477 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2460 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16692 systemes
  - sans CONNECTED : 0.0% sur 3763 systemes
