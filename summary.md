...
genere 2026-08-27 23:31 UTC — 118885 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 35541 systemes
...
- moteur actif `0caa9267db60` (75143 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 56965 | 28387 | 3936 | 1931 | 5644 | 4504 | 6019 | 5813 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 55805 | 12875 | 23676 | 26 | 7757 | 2886 | 25 | 8558 | 15.3% |
...
- candidats SANS connectivite : 8868, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6293 systemes avec CONNECTED sur 49040 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10518 candidats sur 14808 portent les champs bruts (71%).*

- `5c556c16ea8b` — 4553 candidats
  - AVEC connectivite (1812) : resistance **42.1%**
  - SANS connectivite (2741) : resistance **22.4%**
...
- `5c556c16ea8b` — 4553 candidats
  ...
  - SANS connectivite (2741) : T0=15.78 T1=0.00 T2=2.71 — pondere **5.42**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 46539 systemes
  - sans CONNECTED : 0.0% sur 10426 systemes
