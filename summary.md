...
- moteur actif `0caa9267db60` (6942 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22519 | 11223 | 1513 | 768 | 2250 | 1781 | 2412 | 2291 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 22050 | 5114 | 9299 | 13 | 3082 | 1131 | 10 | 3401 | 15.4% |
...
- candidats AVEC connectivite : 2418, dont T2 : 100%
- candidats SANS connectivite : 3711, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2686 systemes avec CONNECTED sur 20883 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1839 candidats sur 6129 portent les champs bruts (30%).*
...
- `06fe04a859f1` — 724 candidats
  - AVEC connectivite (280) : resistance **41.2%**
  - SANS connectivite (444) : resistance **20.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 724 candidats
  - AVEC connectivite (280) : T0=13.33 T1=0.00 T2=3.02 — pondere **6.04**
  - SANS connectivite (444) : T0=16.02 T1=0.00 T2=2.61 — pondere **5.22**
...
- TROP-CHER : 2706 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2686 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18382 systemes
