...
genere 2026-08-26 14:23 UTC — 48776 systemes evalues
...
- moteur actif `0caa9267db60` (5034 systemes) : `06fe04a859f1`, `e40600351a72`
...
| ref | 4 | 3 | 21100 | 4915 | 8908 | 13 | 2922 | 1089 | 8 | 3245 | 15.4% |
...
- candidats SANS connectivite : 3555, dont T2 : 100%
...
*1591 candidats sur 5881 portent les champs bruts (27%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 476 candidats
  - AVEC connectivite (188) : resistance **40.0%**
  - SANS connectivite (288) : resistance **21.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 476 candidats
  ...
  - SANS connectivite (288) : T0=16.10 T1=0.00 T2=2.67 — pondere **5.34**
  - test de permutation : **p = 0.0380** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e40600351a72` — 194 candidats
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0380).
