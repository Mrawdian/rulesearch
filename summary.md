...
genere 2026-08-27 03:49 UTC — 79193 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 14286 systemes
...
- moteur actif `0caa9267db60` (35451 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 36932 | 18358 | 2550 | 1257 | 3662 | 2919 | 3916 | 3788 | 10.3% |
...
- candidats AVEC connectivite : 3915, dont T2 : 100%
- candidats SANS connectivite : 5817, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4190 systemes avec CONNECTED sur 32731 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5442 candidats sur 9732 portent les champs bruts (56%).*
...
- `ab89a63b01ef` — 1765 candidats
  - AVEC connectivite (735) : resistance **41.2%**
...
- `ab89a63b01ef` — 1765 candidats
  - AVEC connectivite (735) : T0=13.02 T1=0.00 T2=3.03 — pondere **6.06**
...
- TROP-CHER : 4219 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4190 avec CONNECTED, 29 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 30230 systemes
  - sans CONNECTED : 0.0% sur 6702 systemes
