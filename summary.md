...
genere 2026-09-08 22:41 UTC — 466675 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 383331 systemes
...
- moteur actif `0caa9267db60` (422933 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 232589 | 115539 | 15835 | 7790 | 23529 | 18217 | 24776 | 23953 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 227971 | 53102 | 96059 | 91 | 31755 | 11780 | 81 | 35084 | 15.4% |
...
- candidats AVEC connectivite : 24080, dont T2 : 100%
- candidats SANS connectivite : 35394, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25050 systemes avec CONNECTED sur 192430 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55184 candidats sur 59474 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49219 candidats
  - AVEC connectivite (19952) : resistance **41.2%**
  - SANS connectivite (29267) : resistance **21.3%**
...
- `5c556c16ea8b` — 49219 candidats
  - AVEC connectivite (19952) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.97**
  - SANS connectivite (29267) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 25141 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25050 avec CONNECTED, 91 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 189929 systemes
  - sans CONNECTED : 0.0% sur 42660 systemes
