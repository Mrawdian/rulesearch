...
genere 2026-08-26 22:19 UTC — 67008 systemes evalues
...
- moteur actif `0caa9267db60` (23266 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 30770 | 15284 | 2108 | 1035 | 3066 | 2451 | 3281 | 3154 | 10.3% |
...
- **3555 systemes avec CONNECTED sur 27656 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3931 candidats sur 8221 portent les champs bruts (48%).*
...
- `ab89a63b01ef` — 254 candidats
  ...
  - test de permutation : **p = 0.1859** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- TROP-CHER : 3579 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3555 avec CONNECTED, 24 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 25155 systemes
  - sans CONNECTED : 0.0% sur 5615 systemes
