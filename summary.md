...
- moteur actif `0caa9267db60` (48435 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 43483 | 21674 | 2981 | 1468 | 4339 | 3425 | 4579 | 4452 | 10.2% |
...
- candidats AVEC connectivite : 4579, dont T2 : 100%
- candidats SANS connectivite : 6820, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4853 systemes avec CONNECTED sur 38034 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*7109 candidats sur 11399 portent les champs bruts (62%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 1144 candidats
  - AVEC connectivite (451) : resistance **41.4%**
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 1144 candidats
  - AVEC connectivite (451) : T0=13.00 T1=0.00 T2=3.01 — pondere **6.03**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 35533 systemes
  - sans CONNECTED : 0.0% sur 7950 systemes
