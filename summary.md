...
genere 2026-08-26 01:40 UTC — 16562 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 7588 systemes
...
| connect | 4 | 3 | 8311 | 4189 | 541 | 284 | 791 | 663 | 882 | 860 | 10.3% |
| ref | 4 | 3 | 8127 | 1969 | 3408 | 1 | 1083 | 398 | 3 | 1265 | 15.6% |
...
- candidats AVEC connectivite : 863, dont T2 : 100%
- candidats SANS connectivite : 1269, dont T2 : 100%
...
- **882 systemes avec CONNECTED sur 6883 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 967 candidats
  - AVEC connectivite (384) : T0=13.39 T1=0.00 T2=2.84 — pondere **5.67**
  - SANS connectivite (583) : T0=15.93 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 885 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 882 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 6826 systemes
  - sans CONNECTED : 0.0% sur 1485 systemes
