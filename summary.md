...
genere 2026-08-26 22:16 UTC — 66949 systemes evalues
...
- moteur actif `0caa9267db60` (23207 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 30741 | 15272 | 2106 | 1035 | 3064 | 2446 | 3275 | 3153 | 10.3% |
...
- candidats AVEC connectivite : 3280, dont T2 : 100%
- candidats SANS connectivite : 4932, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3549 systemes avec CONNECTED sur 27636 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3922 candidats sur 8212 portent les champs bruts (48%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 245 candidats
  - AVEC connectivite (100) : resistance **42.9%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 245 candidats
  - AVEC connectivite (100) : T0=12.94 T1=0.00 T2=3.05 — pondere **6.10**
  - SANS connectivite (145) : T0=16.12 T1=0.00 T2=2.77 — pondere **5.54**
  - test de permutation : **p = 0.1634** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- TROP-CHER : 3573 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3549 avec CONNECTED, 24 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 25135 systemes
  - sans CONNECTED : 0.0% sur 5606 systemes
