...
- moteur actif `0caa9267db60` (7875 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22997 | 11462 | 1555 | 779 | 2290 | 1827 | 2459 | 2337 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 22505 | 5207 | 9497 | 14 | 3151 | 1150 | 10 | 3476 | 15.4% |
...
- candidats AVEC connectivite : 2464, dont T2 : 100%
- candidats SANS connectivite : 3786, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2733 systemes avec CONNECTED sur 21274 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1960 candidats sur 6250 portent les champs bruts (31%).*
...
- `06fe04a859f1` — 845 candidats
  - AVEC connectivite (326) : resistance **41.1%**
  - SANS connectivite (519) : resistance **21.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 845 candidats
  - AVEC connectivite (326) : T0=13.27 T1=0.00 T2=3.02 — pondere **6.05**
  - SANS connectivite (519) : T0=16.01 T1=0.00 T2=2.64 — pondere **5.28**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18773 systemes
  - sans CONNECTED : 0.0% sur 4224 systemes
