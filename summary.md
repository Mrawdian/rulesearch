...
genere 2026-08-27 06:00 UTC — 83984 systemes evalues
...
- moteur actif `0caa9267db60` (40242 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 39346 | 19582 | 2705 | 1342 | 3913 | 3101 | 4159 | 4033 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 38523 | 8884 | 16396 | 22 | 5332 | 2003 | 21 | 5865 | 15.2% |
...
- candidats AVEC connectivite : 4160, dont T2 : 100%
- candidats SANS connectivite : 6175, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4433 systemes avec CONNECTED sur 34680 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6045 candidats sur 10335 portent les champs bruts (58%).*
...
- `e80bc1b2b437` — 75 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 80 candidats
  - AVEC connectivite (32) : resistance **41.0%**
  - SANS connectivite (48) : resistance **22.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 80 candidats
  - AVEC connectivite (32) : T0=13.09 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (48) : T0=15.65 T1=0.00 T2=2.54 — pondere **5.08**
  - test de permutation : **p = 0.1749** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `0a74109317e5` — 80 candidats
...
## cout
- temps total 25.9 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 4464 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4433 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 32179 systemes
  - sans CONNECTED : 0.0% sur 7167 systemes
