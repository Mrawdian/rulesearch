...
genere 2026-09-01 12:12 UTC — 282225 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 198881 systemes
...
- moteur actif `0caa9267db60` (238483 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 139452 | 69322 | 9442 | 4666 | 14169 | 10985 | 14727 | 14339 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 136658 | 31798 | 57772 | 59 | 18957 | 7076 | 61 | 20924 | 15.3% |
...
- candidats SANS connectivite : 21234, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15001 systemes avec CONNECTED sur 116290 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*31410 candidats sur 35700 portent les champs bruts (88%).*

- `5c556c16ea8b` — 25445 candidats
  - AVEC connectivite (10338) : resistance **41.0%**
  - SANS connectivite (15107) : resistance **21.3%**
...
- `5c556c16ea8b` — 25445 candidats
  ...
  - SANS connectivite (15107) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 113789 systemes
  - sans CONNECTED : 0.0% sur 25663 systemes
