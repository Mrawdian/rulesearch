...
genere 2026-08-27 13:47 UTC — 99992 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 18378 systemes
- `5c556c16ea8b` : 16648 systemes
...
- moteur actif `0caa9267db60` (56250 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 46453 | 10756 | 19711 | 25 | 6424 | 2426 | 22 | 7088 | 15.3% |
...
- candidats SANS connectivite : 7398, dont T2 : 100%
...
*8071 candidats sur 12361 portent les champs bruts (65%).*
...
- `ab89a63b01ef` — 2280 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 2106 candidats
  - AVEC connectivite (835) : resistance **41.8%**
  - SANS connectivite (1271) : resistance **22.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 2106 candidats
  ...
  - SANS connectivite (1271) : T0=15.78 T1=0.00 T2=2.68 — pondere **5.35**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
