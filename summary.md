...
genere 2026-09-05 05:53 UTC — 382653 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 299309 systemes
...
- moteur actif `0caa9267db60` (338911 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 190151 | 94451 | 12946 | 6344 | 19334 | 14978 | 20157 | 19509 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 186387 | 43377 | 78709 | 77 | 25899 | 9650 | 70 | 28591 | 15.3% |
...
- candidats AVEC connectivite : 19636, dont T2 : 100%
...
- **20431 systemes avec CONNECTED sur 157627 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*44247 candidats sur 48537 portent les champs bruts (91%).*

- `5c556c16ea8b` — 38282 candidats
  - AVEC connectivite (15508) : resistance **41.1%**
...
- `5c556c16ea8b` — 38282 candidats
  - AVEC connectivite (15508) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
...
- TROP-CHER : 20511 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 20431 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 155126 systemes
  - sans CONNECTED : 0.0% sur 35025 systemes
