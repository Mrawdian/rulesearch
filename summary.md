...
genere 2026-08-27 00:37 UTC — 72035 systemes evalues
...
- moteur actif `0caa9267db60` (28293 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 32606 | 7518 | 13843 | 18 | 4526 | 1707 | 16 | 4978 | 15.3% |
...
- candidats SANS connectivite : 5288, dont T2 : 100%
...
*4530 candidats sur 8820 portent les champs bruts (51%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 853 candidats
  - AVEC connectivite (352) : resistance **41.1%**
  - SANS connectivite (501) : resistance **21.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 853 candidats
  ...
  - SANS connectivite (501) : T0=15.95 T1=0.00 T2=2.59 — pondere **5.18**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 798 candidats
