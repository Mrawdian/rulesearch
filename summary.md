...
genere 2026-09-01 12:15 UTC — 282299 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 198955 systemes
...
- moteur actif `0caa9267db60` (238557 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 139482 | 69336 | 9444 | 4666 | 14174 | 10988 | 14729 | 14343 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 136702 | 31808 | 57791 | 59 | 18965 | 7076 | 61 | 20931 | 15.3% |
...
- candidats SANS connectivite : 21241, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15003 systemes avec CONNECTED sur 116314 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*31421 candidats sur 35711 portent les champs bruts (88%).*

- `5c556c16ea8b` — 25456 candidats
  - AVEC connectivite (10342) : resistance **41.0%**
  - SANS connectivite (15114) : resistance **21.4%**
...
- `5c556c16ea8b` — 25456 candidats
  ...
  - SANS connectivite (15114) : T0=15.93 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 113813 systemes
  - sans CONNECTED : 0.0% sur 25669 systemes
