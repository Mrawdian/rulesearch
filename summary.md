...
genere 2026-08-28 11:27 UTC — 140813 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 57469 systemes
...
- moteur actif `0caa9267db60` (97071 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 68039 | 33806 | 4667 | 2320 | 6820 | 5420 | 7168 | 6966 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 66659 | 15420 | 28184 | 30 | 9262 | 3446 | 30 | 10284 | 15.4% |
...
- candidats AVEC connectivite : 7093, dont T2 : 100%
- candidats SANS connectivite : 10594, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7442 systemes avec CONNECTED sur 57992 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*13397 candidats sur 17687 portent les champs bruts (76%).*

- `5c556c16ea8b` — 7432 candidats
  - AVEC connectivite (2965) : resistance **41.3%**
  - SANS connectivite (4467) : resistance **21.8%**
...
- `5c556c16ea8b` — 7432 candidats
  - AVEC connectivite (2965) : T0=13.00 T1=0.00 T2=3.01 — pondere **6.02**
  - SANS connectivite (4467) : T0=15.87 T1=0.00 T2=2.68 — pondere **5.36**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 55491 systemes
  - sans CONNECTED : 0.0% sur 12548 systemes
