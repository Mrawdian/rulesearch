...
genere 2026-09-01 16:46 UTC — 287701 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 204357 systemes
...
- moteur actif `0caa9267db60` (243959 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 142214 | 70657 | 9646 | 4758 | 14436 | 11219 | 15036 | 14623 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 139372 | 32418 | 58942 | 59 | 19327 | 7209 | 63 | 21343 | 15.3% |
...
- candidats AVEC connectivite : 14750, dont T2 : 100%
- candidats SANS connectivite : 21653, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15310 systemes avec CONNECTED sur 118551 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*32113 candidats sur 36403 portent les champs bruts (88%).*

- `5c556c16ea8b` — 26148 candidats
  - AVEC connectivite (10622) : resistance **41.0%**
  - SANS connectivite (15526) : resistance **21.3%**
...
- `5c556c16ea8b` — 26148 candidats
  - AVEC connectivite (10622) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (15526) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
## cout
- temps total 89.1 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 15383 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15310 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 116050 systemes
  - sans CONNECTED : 0.0% sur 26164 systemes
