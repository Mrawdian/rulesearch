...
genere 2026-08-26 17:19 UTC — 55696 systemes evalues
...
- moteur actif `0caa9267db60` (11954 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
| connect | 4 | 3 | 25058 | 12506 | 1705 | 844 | 2479 | 1979 | 2677 | 2557 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 24523 | 5669 | 10373 | 14 | 3428 | 1247 | 10 | 3782 | 15.4% |
...
- candidats AVEC connectivite : 2684, dont T2 : 100%
- candidats SANS connectivite : 4092, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2951 systemes avec CONNECTED sur 22987 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2486 candidats sur 6776 portent les champs bruts (37%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 176 candidats
  - AVEC connectivite (70) : resistance **43.2%**
  - SANS connectivite (106) : resistance **20.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `23303c299f39` — 176 candidats
  - AVEC connectivite (70) : T0=12.81 T1=0.00 T2=3.17 — pondere **6.34**
  - SANS connectivite (106) : T0=16.15 T1=0.00 T2=2.64 — pondere **5.28**
...
**4 serie(s) reproductible(s) sur 7 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0430).
...
- TROP-CHER : 2971 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2951 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 20486 systemes
  - sans CONNECTED : 0.0% sur 4572 systemes
