...
genere 2026-08-27 08:58 UTC — 90298 systemes evalues
...
- moteur actif `0caa9267db60` (46556 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 42525 | 21173 | 2922 | 1439 | 4252 | 3334 | 4482 | 4373 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 41658 | 9608 | 17695 | 24 | 5771 | 2171 | 22 | 6367 | 15.3% |
...
- candidats AVEC connectivite : 4500, dont T2 : 100%
- candidats SANS connectivite : 6677, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4756 systemes avec CONNECTED sur 37251 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6887 candidats sur 11177 portent les champs bruts (62%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 922 candidats
  - AVEC connectivite (372) : resistance **41.0%**
  - SANS connectivite (550) : resistance **21.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 922 candidats
  - AVEC connectivite (372) : T0=13.08 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (550) : T0=15.89 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 4788 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4756 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 34750 systemes
  - sans CONNECTED : 0.0% sur 7775 systemes
