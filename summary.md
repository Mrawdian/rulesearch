...
genere 2026-08-26 19:31 UTC — 60897 systemes evalues
...
- moteur actif `0caa9267db60` (17155 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 27092 | 6267 | 11460 | 15 | 3770 | 1398 | 11 | 4171 | 15.4% |
...
- candidats SANS connectivite : 4481, dont T2 : 100%
...
*3154 candidats sur 7444 portent les champs bruts (42%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 285 candidats
  - AVEC connectivite (119) : resistance **39.6%**
  - SANS connectivite (166) : resistance **18.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 285 candidats
  ...
  - SANS connectivite (166) : T0=16.10 T1=0.00 T2=2.55 — pondere **5.11**
...
**6 serie(s) reproductible(s) sur 12 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `62448a55927e` (p=0.0450), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
