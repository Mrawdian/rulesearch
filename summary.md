...
genere 2026-09-01 15:08 UTC — 285826 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 202482 systemes
...
- moteur actif `0caa9267db60` (242084 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 141272 | 70198 | 9572 | 4724 | 14353 | 11148 | 14918 | 14533 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 138439 | 32192 | 58534 | 59 | 19199 | 7168 | 62 | 21214 | 15.3% |
...
- candidats AVEC connectivite : 14660, dont T2 : 100%
- candidats SANS connectivite : 21524, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15192 systemes avec CONNECTED sur 117757 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*31894 candidats sur 36184 portent les champs bruts (88%).*

- `5c556c16ea8b` — 25929 candidats
  - AVEC connectivite (10532) : resistance **41.0%**
  - SANS connectivite (15397) : resistance **21.4%**
...
- `5c556c16ea8b` — 25929 candidats
  - AVEC connectivite (10532) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (15397) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 15264 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15192 avec CONNECTED, 72 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 115256 systemes
  - sans CONNECTED : 0.0% sur 26016 systemes
