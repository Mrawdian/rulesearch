...
| connect | 4 | 3 | 18352 | 9163 | 1193 | 638 | 1831 | 1458 | 1990 | 1850 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 17955 | 4230 | 7568 | 12 | 2459 | 925 | 7 | 2754 | 15.3% |
...
- candidats AVEC connectivite : 1977, dont T2 : 100%
- candidats SANS connectivite : 3064, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2264 systemes avec CONNECTED sur 17484 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*751 candidats sur 5041 portent les champs bruts (15%).*
...
- `e3baecf8377b` — 487 candidats
  - AVEC connectivite (194) : resistance **42.9%**
  - SANS connectivite (293) : resistance **20.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 487 candidats
  - AVEC connectivite (194) : T0=13.02 T1=0.00 T2=3.12 — pondere **6.25**
  - SANS connectivite (293) : T0=16.09 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14983 systemes
  - sans CONNECTED : 0.0% sur 3369 systemes
