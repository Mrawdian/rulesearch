...
genere 2026-08-30 21:06 UTC — 230692 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 147348 systemes
...
- moteur actif `0caa9267db60` (186950 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 113444 | 56414 | 7712 | 3797 | 11389 | 8973 | 12004 | 11671 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 111133 | 25910 | 46965 | 52 | 15331 | 5745 | 47 | 17073 | 15.4% |
...
- candidats SANS connectivite : 17383, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12278 systemes avec CONNECTED sur 95113 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*24891 candidats sur 29181 portent les champs bruts (85%).*

- `5c556c16ea8b` — 18926 candidats
  - AVEC connectivite (7670) : resistance **41.1%**
  - SANS connectivite (11256) : resistance **21.4%**
...
- `5c556c16ea8b` — 18926 candidats
  ...
  - SANS connectivite (11256) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 12335 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 12278 avec CONNECTED, 57 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 92612 systemes
  - sans CONNECTED : 0.0% sur 20832 systemes
