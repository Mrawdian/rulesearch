...
genere 2026-08-30 06:20 UTC — 209778 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 126434 systemes
...
- moteur actif `0caa9267db60` (166036 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 102884 | 51073 | 7010 | 3445 | 10394 | 8199 | 10850 | 10573 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 100779 | 23484 | 42573 | 46 | 13916 | 5199 | 40 | 15513 | 15.4% |
...
- candidats AVEC connectivite : 10700, dont T2 : 100%
- candidats SANS connectivite : 15823, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11124 systemes avec CONNECTED sur 86402 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*22233 candidats sur 26523 portent les champs bruts (84%).*

- `5c556c16ea8b` — 16268 candidats
  - AVEC connectivite (6572) : resistance **41.1%**
  - SANS connectivite (9696) : resistance **21.5%**
...
- `5c556c16ea8b` — 16268 candidats
  - AVEC connectivite (6572) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (9696) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.32**
...
## cout
- temps total 64.8 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 11174 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11124 avec CONNECTED, 50 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 83901 systemes
  - sans CONNECTED : 0.0% sur 18983 systemes
