...
genere 2026-08-27 22:01 UTC — 116031 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 32687 systemes
...
- moteur actif `0caa9267db60` (72289 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 55517 | 27660 | 3842 | 1885 | 5490 | 4391 | 5865 | 5666 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 54399 | 12547 | 23103 | 26 | 7545 | 2818 | 25 | 8333 | 15.3% |
...
- candidats AVEC connectivite : 5793, dont T2 : 100%
- candidats SANS connectivite : 8643, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6139 systemes avec CONNECTED sur 47861 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10146 candidats sur 14436 portent les champs bruts (70%).*

- `5c556c16ea8b` — 4181 candidats
  - AVEC connectivite (1665) : resistance **42.0%**
  - SANS connectivite (2516) : resistance **22.6%**
...
- `5c556c16ea8b` — 4181 candidats
  - AVEC connectivite (1665) : T0=12.93 T1=0.00 T2=3.05 — pondere **6.10**
  - SANS connectivite (2516) : T0=15.79 T1=0.00 T2=2.72 — pondere **5.44**
...
## cout
- temps total 35.8 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 6174 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6139 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 45360 systemes
  - sans CONNECTED : 0.0% sur 10157 systemes
