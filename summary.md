...
genere 2026-08-27 14:34 UTC — 101515 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 18378 systemes
- `5c556c16ea8b` : 18171 systemes
...
- moteur actif `0caa9267db60` (57773 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 48185 | 24013 | 3317 | 1649 | 4780 | 3812 | 5092 | 4900 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 47215 | 10933 | 20028 | 25 | 6541 | 2472 | 22 | 7193 | 15.2% |
...
- candidats AVEC connectivite : 5027, dont T2 : 100%
- candidats SANS connectivite : 7503, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5366 systemes avec CONNECTED sur 41872 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*8240 candidats sur 12530 portent les champs bruts (66%).*
...
- `ab89a63b01ef` — 2280 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 2275 candidats
  - AVEC connectivite (899) : resistance **41.7%**
  - SANS connectivite (1376) : resistance **22.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 2280 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 2275 candidats
  - AVEC connectivite (899) : T0=13.01 T1=0.00 T2=3.03 — pondere **6.06**
  - SANS connectivite (1376) : T0=15.76 T1=0.00 T2=2.69 — pondere **5.37**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 39371 systemes
  - sans CONNECTED : 0.0% sur 8814 systemes
