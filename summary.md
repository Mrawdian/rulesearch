...
genere 2026-09-08 19:30 UTC — 463662 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 380318 systemes
...
- moteur actif `0caa9267db60` (419920 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 231079 | 114782 | 15731 | 7729 | 23361 | 18099 | 24647 | 23794 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 226468 | 52758 | 95439 | 90 | 31549 | 11711 | 81 | 34822 | 15.4% |
...
- candidats SANS connectivite : 35132, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **24921 systemes avec CONNECTED sur 191218 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*54763 candidats sur 59053 portent les champs bruts (93%).*

- `5c556c16ea8b` — 48798 candidats
  - AVEC connectivite (19793) : resistance **41.2%**
  - SANS connectivite (29005) : resistance **21.3%**
...
- `5c556c16ea8b` — 48798 candidats
  ...
  - SANS connectivite (29005) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 25012 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 24921 avec CONNECTED, 91 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 188717 systemes
