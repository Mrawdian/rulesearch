...
genere 2026-08-26 19:32 UTC — 60927 systemes evalues
...
- moteur actif `0caa9267db60` (17185 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27705 | 13820 | 1888 | 933 | 2736 | 2199 | 2943 | 2838 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 27107 | 6273 | 11464 | 15 | 3773 | 1399 | 11 | 4172 | 15.4% |
...
- candidats AVEC connectivite : 2965, dont T2 : 100%
- candidats SANS connectivite : 4482, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3217 systemes avec CONNECTED sur 25174 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3157 candidats sur 7447 portent les champs bruts (42%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 288 candidats
  - AVEC connectivite (121) : resistance **39.5%**
  - SANS connectivite (167) : resistance **18.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 288 candidats
  - AVEC connectivite (121) : T0=13.03 T1=0.00 T2=2.93 — pondere **5.85**
  - SANS connectivite (167) : T0=16.09 T1=0.00 T2=2.56 — pondere **5.11**
...
- TROP-CHER : 3238 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3217 avec CONNECTED, 21 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22673 systemes
  - sans CONNECTED : 0.0% sur 5032 systemes
