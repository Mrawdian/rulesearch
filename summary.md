...
genere 2026-08-26 12:52 UTC — 45039 systemes evalues
...
- candidats AVEC connectivite : 2132, dont T2 : 100%
...
*1103 candidats sur 5393 portent les champs bruts (20%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `e40600351a72` — 182 candidats
  - AVEC connectivite (81) : resistance **39.8%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e40600351a72` — 182 candidats
  - AVEC connectivite (81) : T0=12.94 T1=0.00 T2=2.91 — pondere **5.83**
