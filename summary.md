...
genere 2026-08-26 16:51 UTC — 54664 systemes evalues
...
- moteur actif `0caa9267db60` (10922 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
| connect | 4 | 3 | 24539 | 12249 | 1668 | 830 | 2433 | 1935 | 2617 | 2500 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 24010 | 5552 | 10150 | 14 | 3365 | 1220 | 10 | 3699 | 15.4% |
...
- candidats SANS connectivite : 4009, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2891 systemes avec CONNECTED sur 22555 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2346 candidats sur 6636 portent les champs bruts (35%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 36 candidats
  - AVEC connectivite (13) : resistance **34.5%**
  - SANS connectivite (23) : resistance **21.6%**
...
- `23303c299f39` — 36 candidats
  ...
  - SANS connectivite (23) : T0=17.39 T1=0.00 T2=2.74 — pondere **5.48**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 20054 systemes
  - sans CONNECTED : 0.0% sur 4485 systemes
