...
genere 2026-08-30 09:40 UTC — 214284 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 130940 systemes
...
- moteur actif `0caa9267db60` (170542 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 105149 | 52199 | 7162 | 3506 | 10599 | 8368 | 11140 | 10802 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 103020 | 24038 | 43499 | 48 | 14224 | 5316 | 41 | 15846 | 15.4% |
...
- candidats AVEC connectivite : 10929, dont T2 : 100%
- candidats SANS connectivite : 16156, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11414 systemes avec CONNECTED sur 88268 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*22795 candidats sur 27085 portent les champs bruts (84%).*

- `5c556c16ea8b` — 16830 candidats
  - AVEC connectivite (6801) : resistance **41.2%**
  - SANS connectivite (10029) : resistance **21.5%**
...
- `5c556c16ea8b` — 16830 candidats
  - AVEC connectivite (6801) : T0=13.00 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (10029) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 11465 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 11414 avec CONNECTED, 51 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 85767 systemes
  - sans CONNECTED : 0.0% sur 19382 systemes
