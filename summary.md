...
genere 2026-08-26 02:55 UTC — 19602 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 10628 systemes
...
| connect | 4 | 3 | 9851 | 4954 | 647 | 339 | 939 | 783 | 1061 | 1005 | 10.2% |
| ref | 4 | 3 | 9627 | 2302 | 4060 | 3 | 1281 | 490 | 4 | 1487 | 15.4% |
...
- candidats AVEC connectivite : 1008, dont T2 : 100%
- candidats SANS connectivite : 1491, dont T2 : 100%
...
- **1061 systemes avec CONNECTED sur 8145 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1334 candidats
  - AVEC connectivite (529) : T0=13.34 T1=0.00 T2=2.89 — pondere **5.77**
  - SANS connectivite (805) : T0=15.84 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 1065 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 1061 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 8088 systemes
  - sans CONNECTED : 0.0% sur 1763 systemes
