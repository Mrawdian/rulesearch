...
| connect | 4 | 3 | 18965 | 9468 | 1241 | 657 | 1888 | 1510 | 2049 | 1917 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 18559 | 4356 | 7827 | 13 | 2548 | 963 | 7 | 2845 | 15.3% |
...
- candidats AVEC connectivite : 2044, dont T2 : 100%
- candidats SANS connectivite : 3155, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2323 systemes avec CONNECTED sur 17980 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*909 candidats sur 5199 portent les champs bruts (17%).*
...
- `e3baecf8377b` — 645 candidats
  - AVEC connectivite (261) : resistance **42.2%**
  - SANS connectivite (384) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 645 candidats
  - AVEC connectivite (261) : T0=13.03 T1=0.00 T2=3.09 — pondere **6.18**
  - SANS connectivite (384) : T0=16.00 T1=0.00 T2=2.62 — pondere **5.23**
...
- TROP-CHER : 2340 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2323 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 15479 systemes
  - sans CONNECTED : 0.0% sur 3486 systemes
