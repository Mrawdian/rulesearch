...
genere 2026-08-29 17:41 UTC — 190725 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 107381 systemes
...
- moteur actif `0caa9267db60` (146983 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 93244 | 46334 | 6352 | 3129 | 9399 | 7422 | 9825 | 9590 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 91366 | 21330 | 38556 | 43 | 12623 | 4699 | 36 | 14073 | 15.4% |
...
- candidats AVEC connectivite : 9717, dont T2 : 100%
- candidats SANS connectivite : 14383, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10099 systemes avec CONNECTED sur 78562 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*19810 candidats sur 24100 portent les champs bruts (82%).*

- `5c556c16ea8b` — 13845 candidats
  - AVEC connectivite (5589) : resistance **41.1%**
  - SANS connectivite (8256) : resistance **21.5%**
...
- `5c556c16ea8b` — 13845 candidats
  - AVEC connectivite (5589) : T0=12.99 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (8256) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.34**
...
- TROP-CHER : 10145 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10099 avec CONNECTED, 46 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 76061 systemes
  - sans CONNECTED : 0.0% sur 17183 systemes
