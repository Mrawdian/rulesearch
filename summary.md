...
genere 2026-08-27 01:48 UTC — 74703 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 9796 systemes
...
- moteur actif `0caa9267db60` (30961 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 34659 | 17246 | 2384 | 1174 | 3438 | 2758 | 3688 | 3528 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 33929 | 7818 | 14427 | 20 | 4710 | 1765 | 18 | 5171 | 15.2% |
...
- candidats AVEC connectivite : 3655, dont T2 : 100%
- candidats SANS connectivite : 5481, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3962 systemes avec CONNECTED sur 30853 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4846 candidats sur 9136 portent les champs bruts (53%).*
...
- `ab89a63b01ef` — 1169 candidats
  - AVEC connectivite (475) : resistance **41.4%**
  - SANS connectivite (694) : resistance **21.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1169 candidats
  - AVEC connectivite (475) : T0=13.00 T1=0.00 T2=3.05 — pondere **6.11**
  - SANS connectivite (694) : T0=15.91 T1=0.00 T2=2.68 — pondere **5.35**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- TROP-CHER : 3990 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3962 avec CONNECTED, 28 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 28352 systemes
  - sans CONNECTED : 0.0% sur 6307 systemes
