...
genere 2026-08-28 18:54 UTC — 153723 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 70379 systemes
...
- moteur actif `0caa9267db60` (109981 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 74549 | 37061 | 5080 | 2544 | 7477 | 5932 | 7858 | 7652 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 73059 | 16994 | 30888 | 35 | 10077 | 3754 | 31 | 11277 | 15.4% |
...
- candidats AVEC connectivite : 7779, dont T2 : 100%
- candidats SANS connectivite : 11587, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8132 systemes avec CONNECTED sur 63321 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*15076 candidats sur 19366 portent les champs bruts (78%).*

- `5c556c16ea8b` — 9111 candidats
  - AVEC connectivite (3651) : resistance **41.1%**
  - SANS connectivite (5460) : resistance **21.7%**
...
- `5c556c16ea8b` — 9111 candidats
  - AVEC connectivite (3651) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (5460) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.35**
...
## cout
- temps total 47.4 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 8173 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8132 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 60820 systemes
  - sans CONNECTED : 0.0% sur 13729 systemes
