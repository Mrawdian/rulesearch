...
genere 2026-08-27 08:41 UTC — 89723 systemes evalues
...
- moteur actif `0caa9267db60` (45981 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 42242 | 21035 | 2904 | 1429 | 4216 | 3317 | 4450 | 4345 | 10.3% |
...
- candidats AVEC connectivite : 4472, dont T2 : 100%
- candidats SANS connectivite : 6636, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4724 systemes avec CONNECTED sur 37027 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6818 candidats sur 11108 portent les champs bruts (61%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 853 candidats
  - AVEC connectivite (344) : resistance **40.8%**
...
- `5c556c16ea8b` — 853 candidats
  - AVEC connectivite (344) : T0=13.13 T1=0.00 T2=2.97 — pondere **5.94**
  - SANS connectivite (509) : T0=15.96 T1=0.00 T2=2.65 — pondere **5.30**
  - test de permutation : **p = 0.0040** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 798 candidats
...
**7 serie(s) reproductible(s) sur 14 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `ab89a63b01ef` (p=0.0005), `06fe04a859f1` (p=0.0005), `5c556c16ea8b` (p=0.0040), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
...
- TROP-CHER : 4756 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4724 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 34526 systemes
  - sans CONNECTED : 0.0% sur 7716 systemes
