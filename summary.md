...
genere 2026-09-08 23:04 UTC — 467014 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 383670 systemes
...
- moteur actif `0caa9267db60` (423272 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 232769 | 115625 | 15850 | 7793 | 23548 | 18232 | 24794 | 23973 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 228130 | 53138 | 96128 | 92 | 31780 | 11784 | 81 | 35108 | 15.4% |
...
- candidats AVEC connectivite : 24100, dont T2 : 100%
- candidats SANS connectivite : 35418, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25068 systemes avec CONNECTED sur 192571 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55228 candidats sur 59518 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49263 candidats
  - AVEC connectivite (19972) : resistance **41.2%**
  - SANS connectivite (29291) : resistance **21.3%**
...
- `5c556c16ea8b` — 49263 candidats
  - AVEC connectivite (19972) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (29291) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
## cout
- temps total 145.6 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 25159 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25068 avec CONNECTED, 91 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 190070 systemes
  - sans CONNECTED : 0.0% sur 42699 systemes
