...
genere 2026-08-26 21:16 UTC — 64655 systemes evalues
...
- moteur actif `0caa9267db60` (20913 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 29591 | 14710 | 2023 | 992 | 2956 | 2342 | 3156 | 3037 | 10.3% |
...
- candidats AVEC connectivite : 3164, dont T2 : 100%
- candidats SANS connectivite : 4763, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3430 systemes avec CONNECTED sur 26701 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3637 candidats sur 7927 portent les champs bruts (46%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 768 candidats
  - AVEC connectivite (320) : resistance **40.3%**
...
- `62448a55927e` — 768 candidats
  - AVEC connectivite (320) : T0=12.87 T1=0.00 T2=2.88 — pondere **5.75**
  - SANS connectivite (448) : T0=16.19 T1=0.00 T2=2.66 — pondere **5.33**
  - test de permutation : **p = 0.0660** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e3baecf8377b` — 657 candidats
...
- TROP-CHER : 3452 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3430 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24200 systemes
