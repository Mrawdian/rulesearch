...
genere 2026-08-26 17:36 UTC — 56359 systemes evalues
...
- `b71bb0907fb5` : 59 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (12617 systemes) : `06fe04a859f1`, `23303c299f39`, `b71bb0907fb5`, `e40600351a72`, `e8a1f930f7b9`
...
**7525 enregistrements (13%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 25385 | 12672 | 1728 | 854 | 2516 | 2004 | 2710 | 2589 | 10.2% |
...
- **2984 systemes avec CONNECTED sur 23252 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2568 candidats sur 6858 portent les champs bruts (37%).*
...
- TROP-CHER : 3004 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2984 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 20751 systemes
  - sans CONNECTED : 0.0% sur 4634 systemes
