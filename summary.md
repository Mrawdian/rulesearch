...
genere 2026-08-27 19:30 UTC — 111307 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 27963 systemes
...
- moteur actif `0caa9267db60` (67565 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 53123 | 26447 | 3681 | 1815 | 5262 | 4201 | 5601 | 5424 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 52069 | 12031 | 22109 | 26 | 7198 | 2714 | 25 | 7964 | 15.3% |
...
- candidats AVEC connectivite : 5551, dont T2 : 100%
- candidats SANS connectivite : 8274, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5875 systemes avec CONNECTED sur 45899 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*9535 candidats sur 13825 portent les champs bruts (69%).*
...
- `5c556c16ea8b` — 3570 candidats
  - AVEC connectivite (1423) : resistance **42.1%**
  - SANS connectivite (2147) : resistance **22.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 3570 candidats
  - AVEC connectivite (1423) : T0=12.95 T1=0.00 T2=3.06 — pondere **6.13**
  - SANS connectivite (2147) : T0=15.78 T1=0.00 T2=2.71 — pondere **5.43**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 2280 candidats
...
- TROP-CHER : 5910 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 5875 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 43398 systemes
  - sans CONNECTED : 0.0% sur 9725 systemes
