...
- `89c65c03c4ad` — 327 candidats
  - AVEC connectivite (117) : T0=13.18 T1=0.00 T2=2.71 — pondere **5.42**
  - SANS connectivite (210) : T0=16.00 T1=0.00 T2=2.65 — pondere **5.30**
  - test de permutation : **p = 0.7361** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
