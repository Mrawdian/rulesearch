...
genere 2026-08-27 01:35 UTC — 74139 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 9232 systemes
...
- moteur actif `0caa9267db60` (30397 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 34376 | 17098 | 2353 | 1168 | 3415 | 2733 | 3667 | 3502 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 33648 | 7758 | 14301 | 20 | 4670 | 1750 | 17 | 5132 | 15.3% |
...
- candidats AVEC connectivite : 3629, dont T2 : 100%
- candidats SANS connectivite : 5442, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3941 systemes avec CONNECTED sur 30625 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4781 candidats sur 9071 portent les champs bruts (53%).*
...
- `ab89a63b01ef` — 1104 candidats
  - AVEC connectivite (449) : resistance **41.0%**
  - SANS connectivite (655) : resistance **21.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1104 candidats
  - AVEC connectivite (449) : T0=13.08 T1=0.00 T2=3.03 — pondere **6.06**
  - SANS connectivite (655) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.34**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- TROP-CHER : 3968 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 3941 avec CONNECTED, 27 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 28124 systemes
  - sans CONNECTED : 0.0% sur 6252 systemes
