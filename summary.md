...
genere 2026-09-04 08:50 UTC — 360620 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 277276 systemes
...
- moteur actif `0caa9267db60` (316878 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 179029 | 88974 | 12166 | 5984 | 18222 | 14102 | 18968 | 18332 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 175476 | 40772 | 74135 | 72 | 24359 | 9094 | 70 | 26960 | 15.4% |
...
- candidats AVEC connectivite : 18459, dont T2 : 100%
- candidats SANS connectivite : 27270, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19242 systemes avec CONNECTED sur 148564 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*41439 candidats sur 45729 portent les champs bruts (91%).*

- `5c556c16ea8b` — 35474 candidats
  - AVEC connectivite (14331) : resistance **41.1%**
  - SANS connectivite (21143) : resistance **21.3%**
...
- `5c556c16ea8b` — 35474 candidats
  - AVEC connectivite (14331) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (21143) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 19322 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19242 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 146063 systemes
  - sans CONNECTED : 0.0% sur 32966 systemes
