...
genere 2026-08-31 06:34 UTC — 243653 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 160309 systemes
...
- moteur actif `0caa9267db60` (199911 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 119992 | 59674 | 8149 | 4025 | 12054 | 9471 | 12706 | 12356 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 117546 | 27438 | 49668 | 53 | 16256 | 6064 | 52 | 18005 | 15.3% |
...
- candidats SANS connectivite : 18315, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12980 systemes avec CONNECTED sur 100477 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*26508 candidats sur 30798 portent les champs bruts (86%).*

- `5c556c16ea8b` — 20543 candidats
  - AVEC connectivite (8355) : resistance **40.9%**
  - SANS connectivite (12188) : resistance **21.4%**
...
- `5c556c16ea8b` — 20543 candidats
  ...
  - SANS connectivite (12188) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 97976 systemes
  - sans CONNECTED : 0.0% sur 22016 systemes
