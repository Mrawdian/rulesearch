...
genere 2026-08-27 11:33 UTC — 95689 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 18378 systemes
- `5c556c16ea8b` : 12345 systemes
...
- moteur actif `0caa9267db60` (51947 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 45259 | 22571 | 3097 | 1534 | 4510 | 3577 | 4760 | 4624 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 44315 | 10222 | 18805 | 25 | 6151 | 2308 | 22 | 6781 | 15.3% |
...
- candidats AVEC connectivite : 4751, dont T2 : 100%
- candidats SANS connectivite : 7091, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5034 systemes avec CONNECTED sur 39478 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*7552 candidats sur 11842 portent les champs bruts (64%).*
...
- `ab89a63b01ef` — 2280 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 1587 candidats
  - AVEC connectivite (623) : resistance **41.4%**
...
- `ab89a63b01ef` — 2280 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 1587 candidats
  - AVEC connectivite (623) : T0=13.07 T1=0.00 T2=3.02 — pondere **6.04**
...
- TROP-CHER : 5066 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 5034 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 36977 systemes
  - sans CONNECTED : 0.0% sur 8282 systemes
