...
genere 2026-09-07 10:50 UTC — 434169 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 350825 systemes
...
- moteur actif `0caa9267db60` (390427 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 216182 | 107392 | 14717 | 7198 | 21896 | 16952 | 22990 | 22286 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 211872 | 49328 | 89331 | 83 | 29518 | 10952 | 76 | 32566 | 15.4% |
...
- candidats AVEC connectivite : 22413, dont T2 : 100%
- candidats SANS connectivite : 32876, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23264 systemes avec CONNECTED sur 178994 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*50999 candidats sur 55289 portent les champs bruts (92%).*

- `5c556c16ea8b` — 45034 candidats
  - AVEC connectivite (18285) : resistance **41.1%**
  - SANS connectivite (26749) : resistance **21.3%**
...
- `5c556c16ea8b` — 45034 candidats
  - AVEC connectivite (18285) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (26749) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 23350 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23264 avec CONNECTED, 86 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 176493 systemes
  - sans CONNECTED : 0.0% sur 39689 systemes
