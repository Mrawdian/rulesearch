...
genere 2026-09-06 10:43 UTC — 411312 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 327968 systemes
...
- moteur actif `0caa9267db60` (367570 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 204618 | 101590 | 13961 | 6813 | 20748 | 16089 | 21731 | 21083 | 10.3% |
...
- candidats AVEC connectivite : 21210, dont T2 : 100%
...
- **22005 systemes avec CONNECTED sur 169477 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*48058 candidats sur 52348 portent les champs bruts (92%).*

- `5c556c16ea8b` — 42093 candidats
  - AVEC connectivite (17082) : resistance **41.1%**
...
- `5c556c16ea8b` — 42093 candidats
  - AVEC connectivite (17082) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 22088 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 22005 avec CONNECTED, 83 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 166976 systemes
  - sans CONNECTED : 0.0% sur 37642 systemes
