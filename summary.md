...
genere 2026-09-01 23:14 UTC — 295586 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 212242 systemes
...
- moteur actif `0caa9267db60` (251844 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 146202 | 72599 | 9941 | 4906 | 14852 | 11527 | 15459 | 15034 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 143269 | 33328 | 60608 | 61 | 19836 | 7400 | 63 | 21962 | 15.3% |
...
- candidats SANS connectivite : 22272, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15733 systemes avec CONNECTED sur 121819 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*33143 candidats sur 37433 portent les champs bruts (89%).*

- `5c556c16ea8b` — 27178 candidats
  - AVEC connectivite (11033) : resistance **41.0%**
  - SANS connectivite (16145) : resistance **21.3%**
...
- `5c556c16ea8b` — 27178 candidats
  ...
  - SANS connectivite (16145) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 119318 systemes
  - sans CONNECTED : 0.0% sur 26884 systemes
