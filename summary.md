...
genere 2026-09-10 09:24 UTC — 496455 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 413111 systemes
...
- moteur actif `0caa9267db60` (452713 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 247626 | 122932 | 16872 | 8327 | 25049 | 19428 | 26404 | 25476 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 242714 | 56604 | 102244 | 97 | 33774 | 12516 | 87 | 37371 | 15.4% |
...
- candidats SANS connectivite : 37681, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **26678 systemes avec CONNECTED sur 204690 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*58994 candidats sur 63284 portent les champs bruts (93%).*

- `5c556c16ea8b` — 53029 candidats
  - AVEC connectivite (21475) : resistance **41.2%**
  - SANS connectivite (31554) : resistance **21.3%**
...
- `5c556c16ea8b` — 53029 candidats
  ...
  - SANS connectivite (31554) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 26775 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 26678 avec CONNECTED, 97 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 202189 systemes
  - sans CONNECTED : 0.0% sur 45437 systemes
