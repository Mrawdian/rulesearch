...
genere 2026-08-27 01:27 UTC — 73842 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 9167 systemes
- `ab89a63b01ef` : 8935 systemes
...
- moteur actif `0caa9267db60` (30100 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 34227 | 17016 | 2347 | 1161 | 3403 | 2727 | 3651 | 3486 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 33500 | 7725 | 14234 | 20 | 4649 | 1746 | 17 | 5109 | 15.3% |
...
- candidats AVEC connectivite : 3613, dont T2 : 100%
- candidats SANS connectivite : 5419, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3925 systemes avec CONNECTED sur 30491 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4742 candidats sur 9032 portent les champs bruts (53%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 1065 candidats
  - AVEC connectivite (433) : resistance **41.1%**
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 1065 candidats
  - AVEC connectivite (433) : T0=13.06 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (632) : T0=15.88 T1=0.00 T2=2.64 — pondere **5.29**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
...
- TROP-CHER : 3952 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 3925 avec CONNECTED, 27 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 27990 systemes
  - sans CONNECTED : 0.0% sur 6237 systemes
