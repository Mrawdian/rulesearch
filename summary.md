...
genere 2026-08-26 13:54 UTC — 47722 systemes evalues
...
- moteur actif `0caa9267db60` (3980 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21021 | 10491 | 1392 | 721 | 2086 | 1673 | 2245 | 2150 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20586 | 4808 | 8690 | 13 | 2854 | 1065 | 7 | 3149 | 15.3% |
...
- candidats SANS connectivite : 3459, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2519 systemes avec CONNECTED sur 19669 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1446 candidats sur 5736 portent les champs bruts (25%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 331 candidats
  - AVEC connectivite (139) : resistance **39.8%**
  - SANS connectivite (192) : resistance **21.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 331 candidats
  ...
  - SANS connectivite (192) : T0=16.14 T1=0.00 T2=2.75 — pondere **5.50**
  - test de permutation : **p = 0.3338** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17168 systemes
  - sans CONNECTED : 0.0% sur 3853 systemes
