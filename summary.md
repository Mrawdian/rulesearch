...
genere 2026-09-01 10:29 UTC — 280035 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 196691 systemes
...
- moteur actif `0caa9267db60` (236293 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 138349 | 68775 | 9358 | 4617 | 14041 | 10910 | 14615 | 14245 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 135571 | 31594 | 57289 | 58 | 18797 | 7019 | 60 | 20743 | 15.3% |
...
- candidats SANS connectivite : 21053, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14889 systemes avec CONNECTED sur 115390 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*31135 candidats sur 35425 portent les champs bruts (88%).*

- `5c556c16ea8b` — 25170 candidats
  - AVEC connectivite (10244) : resistance **41.1%**
  - SANS connectivite (14926) : resistance **21.4%**
...
- `5c556c16ea8b` — 25170 candidats
  ...
  - SANS connectivite (14926) : T0=15.93 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 14959 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14889 avec CONNECTED, 70 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 112889 systemes
  - sans CONNECTED : 0.0% sur 25460 systemes
