...
- moteur actif `0caa9267db60` (8036 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23072 | 11502 | 1558 | 781 | 2299 | 1835 | 2465 | 2343 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 22591 | 5227 | 9536 | 14 | 3164 | 1154 | 10 | 3486 | 15.4% |
...
- candidats AVEC connectivite : 2470, dont T2 : 100%
- candidats SANS connectivite : 3796, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2739 systemes avec CONNECTED sur 21331 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1976 candidats sur 6266 portent les champs bruts (32%).*
...
- `06fe04a859f1` — 861 candidats
  - AVEC connectivite (332) : resistance **41.2%**
...
- `06fe04a859f1` — 861 candidats
  - AVEC connectivite (332) : T0=13.25 T1=0.00 T2=3.03 — pondere **6.06**
...
- TROP-CHER : 2759 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2739 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18830 systemes
  - sans CONNECTED : 0.0% sur 4242 systemes
