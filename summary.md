...
genere 2026-08-30 09:57 UTC — 214680 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 131336 systemes
...
- moteur actif `0caa9267db60` (170938 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 105357 | 52291 | 7179 | 3510 | 10629 | 8382 | 11163 | 10826 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 103208 | 24087 | 43577 | 48 | 14249 | 5320 | 41 | 15878 | 15.4% |
...
- candidats AVEC connectivite : 10953, dont T2 : 100%
- candidats SANS connectivite : 16188, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11437 systemes avec CONNECTED sur 88434 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*22851 candidats sur 27141 portent les champs bruts (84%).*

- `5c556c16ea8b` — 16886 candidats
  - AVEC connectivite (6825) : resistance **41.1%**
  - SANS connectivite (10061) : resistance **21.5%**
...
- `5c556c16ea8b` — 16886 candidats
  - AVEC connectivite (6825) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (10061) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 11488 systemes abandonnes (5.4% des systemes), 96% du temps total
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 85933 systemes
  - sans CONNECTED : 0.0% sur 19424 systemes
