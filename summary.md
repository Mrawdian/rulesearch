...
genere 2026-08-27 06:45 UTC — 85666 systemes evalues
...
- moteur actif `0caa9267db60` (41924 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 40195 | 20015 | 2751 | 1367 | 4012 | 3162 | 4240 | 4128 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 39356 | 9067 | 16743 | 22 | 5454 | 2053 | 21 | 5996 | 15.2% |
...
- candidats SANS connectivite : 6306, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4514 systemes avec CONNECTED sur 35366 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6271 candidats sur 10561 portent les champs bruts (59%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 306 candidats
  - AVEC connectivite (127) : resistance **41.3%**
  - SANS connectivite (179) : resistance **21.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 306 candidats
  ...
  - SANS connectivite (179) : T0=15.87 T1=0.00 T2=2.66 — pondere **5.33**
  - test de permutation : **p = 0.0425** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `23303c299f39` — 225 candidats
...
**7 serie(s) reproductible(s) sur 14 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `ab89a63b01ef` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `5c556c16ea8b` (p=0.0425), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
...
- TROP-CHER : 4545 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4514 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 32865 systemes
  - sans CONNECTED : 0.0% sur 7330 systemes
