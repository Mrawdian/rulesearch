...
genere 2026-08-26 18:25 UTC — 58251 systemes evalues
...
- `8f22f0d2d442` : 150 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (14509 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 26343 | 13125 | 1792 | 892 | 2614 | 2080 | 2811 | 2703 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 25793 | 5931 | 10935 | 15 | 3599 | 1325 | 10 | 3978 | 15.4% |
...
- candidats AVEC connectivite : 2830, dont T2 : 100%
- candidats SANS connectivite : 4288, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3085 systemes avec CONNECTED sur 24045 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2828 candidats sur 7118 portent les champs bruts (40%).*
...
- `84fba70921e0` — 33 candidats
  ...
  - *groupes trop petits (< 20) — aucun test*
- `8f22f0d2d442` — 24 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (7) : resistance **32.0%**
  - SANS connectivite (17) : resistance **17.9%**
  - *groupes trop petits (< 20) — aucun test*
...
- `84fba70921e0` — 33 candidats
  ...
  - *groupes trop petits (< 20) — aucun test, aucune conclusion*
- `8f22f0d2d442` — 24 candidats
  - AVEC connectivite (7) : T0=14.71 T1=0.00 T2=2.43 — pondere **4.86**
  - SANS connectivite (17) : T0=15.94 T1=0.00 T2=2.59 — pondere **5.18**
  - *groupes trop petits (< 20) — aucun test, aucune conclusion*
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 21544 systemes
  - sans CONNECTED : 0.0% sur 4799 systemes
