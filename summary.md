...
genere 2026-09-05 18:14 UTC — 395146 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 311802 systemes
...
- moteur actif `0caa9267db60` (351404 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 196455 | 97532 | 13375 | 6550 | 19980 | 15461 | 20839 | 20220 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 192576 | 44821 | 81251 | 78 | 26810 | 9960 | 71 | 29571 | 15.4% |
...
- candidats AVEC connectivite : 20347, dont T2 : 100%
...
- **21113 systemes avec CONNECTED sur 162768 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*45938 candidats sur 50228 portent les champs bruts (91%).*

- `5c556c16ea8b` — 39973 candidats
  - AVEC connectivite (16219) : resistance **41.1%**
...
- `5c556c16ea8b` — 39973 candidats
  - AVEC connectivite (16219) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 160267 systemes
  - sans CONNECTED : 0.0% sur 36188 systemes
