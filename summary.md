...
genere 2026-09-04 18:19 UTC — 370672 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 287328 systemes
...
- moteur actif `0caa9267db60` (326930 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 184094 | 91465 | 12527 | 6157 | 18721 | 14494 | 19507 | 18858 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 180463 | 41950 | 76246 | 75 | 25083 | 9341 | 70 | 27684 | 15.3% |
...
- candidats SANS connectivite : 27994, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19781 systemes avec CONNECTED sur 152684 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*42689 candidats sur 46979 portent les champs bruts (91%).*

- `5c556c16ea8b` — 36724 candidats
  - AVEC connectivite (14857) : resistance **41.0%**
  - SANS connectivite (21867) : resistance **21.3%**
...
- `5c556c16ea8b` — 36724 candidats
  ...
  - SANS connectivite (21867) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 19861 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19781 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 150183 systemes
  - sans CONNECTED : 0.0% sur 33911 systemes
