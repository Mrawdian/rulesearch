...
genere 2026-08-26 23:53 UTC — 70416 systemes evalues
...
- moteur actif `0caa9267db60` (26674 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 32505 | 16161 | 2225 | 1099 | 3240 | 2585 | 3468 | 3312 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 31796 | 7337 | 13504 | 18 | 4403 | 1659 | 15 | 4860 | 15.3% |
...
- candidats AVEC connectivite : 3439, dont T2 : 100%
- candidats SANS connectivite : 5170, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3742 systemes avec CONNECTED sur 29076 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4319 candidats sur 8609 portent les champs bruts (50%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 642 candidats
  - AVEC connectivite (259) : resistance **42.2%**
  - SANS connectivite (383) : resistance **21.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 642 candidats
  - AVEC connectivite (259) : T0=13.08 T1=0.00 T2=3.14 — pondere **6.28**
  - SANS connectivite (383) : T0=15.90 T1=0.00 T2=2.64 — pondere **5.28**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e3baecf8377b` — 657 candidats
...
## cout
- temps total 21.9 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 3767 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3742 avec CONNECTED, 25 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 26575 systemes
  - sans CONNECTED : 0.0% sur 5930 systemes
