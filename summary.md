...
genere 2026-08-28 00:48 UTC — 121545 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 38201 systemes
...
- moteur actif `0caa9267db60` (77803 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 58302 | 29042 | 4031 | 1968 | 5790 | 4611 | 6138 | 5972 | 10.2% |
...
- candidats AVEC connectivite : 6099, dont T2 : 100%
- candidats SANS connectivite : 9055, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6412 systemes avec CONNECTED sur 50116 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10864 candidats sur 15154 portent les champs bruts (72%).*

- `5c556c16ea8b` — 4899 candidats
  - AVEC connectivite (1971) : resistance **42.0%**
...
- `5c556c16ea8b` — 4899 candidats
  - AVEC connectivite (1971) : T0=12.99 T1=0.00 T2=3.05 — pondere **6.11**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 47615 systemes
  - sans CONNECTED : 0.0% sur 10687 systemes
