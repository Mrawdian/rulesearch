...
genere 2026-08-28 02:07 UTC — 124176 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 40832 systemes
...
- moteur actif `0caa9267db60` (80434 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 59631 | 29696 | 4118 | 2015 | 5931 | 4720 | 6258 | 6127 | 10.3% |
...
- candidats AVEC connectivite : 6254, dont T2 : 100%
- candidats SANS connectivite : 9258, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6532 systemes avec CONNECTED sur 51178 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11222 candidats sur 15512 portent les champs bruts (72%).*

- `5c556c16ea8b` — 5257 candidats
  - AVEC connectivite (2126) : resistance **41.8%**
...
- `5c556c16ea8b` — 5257 candidats
  - AVEC connectivite (2126) : T0=12.99 T1=0.00 T2=3.04 — pondere **6.08**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 48677 systemes
  - sans CONNECTED : 0.0% sur 10954 systemes
