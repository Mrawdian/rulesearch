...
genere 2026-08-28 07:43 UTC — 134366 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 51022 systemes
...
- moteur actif `0caa9267db60` (90624 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 64780 | 32183 | 4445 | 2200 | 6499 | 5162 | 6802 | 6654 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 63471 | 14687 | 26862 | 29 | 8831 | 3282 | 28 | 9750 | 15.4% |
...
- candidats SANS connectivite : 10060, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7076 systemes avec CONNECTED sur 55345 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12551 candidats sur 16841 portent les champs bruts (75%).*

- `5c556c16ea8b` — 6586 candidats
  - AVEC connectivite (2653) : resistance **41.4%**
  - SANS connectivite (3933) : resistance **21.9%**
...
- `5c556c16ea8b` — 6586 candidats
  ...
  - SANS connectivite (3933) : T0=15.85 T1=0.00 T2=2.68 — pondere **5.36**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 52844 systemes
