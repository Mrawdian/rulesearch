...
genere 2026-08-29 01:41 UTC — 165445 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 82101 systemes
...
- moteur actif `0caa9267db60` (121703 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 80476 | 40038 | 5477 | 2730 | 8054 | 6403 | 8445 | 8306 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 78854 | 18331 | 33385 | 36 | 10894 | 4012 | 33 | 12158 | 15.4% |
...
- candidats AVEC connectivite : 8433, dont T2 : 100%
...
- **8719 systemes avec CONNECTED sur 68159 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*16611 candidats sur 20901 portent les champs bruts (79%).*

- `5c556c16ea8b` — 10646 candidats
  - AVEC connectivite (4305) : resistance **41.1%**
...
- `5c556c16ea8b` — 10646 candidats
  - AVEC connectivite (4305) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
...
- TROP-CHER : 8762 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8719 avec CONNECTED, 43 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 65658 systemes
  - sans CONNECTED : 0.0% sur 14818 systemes
