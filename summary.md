...
genere 2026-08-29 21:06 UTC — 195749 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 112405 systemes
...
- moteur actif `0caa9267db60` (152007 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 95784 | 47555 | 6511 | 3225 | 9656 | 7627 | 10120 | 9867 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 93850 | 21880 | 39623 | 43 | 13004 | 4828 | 37 | 14429 | 15.4% |
...
- candidats SANS connectivite : 14739, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10394 systemes avec CONNECTED sur 80632 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*20443 candidats sur 24733 portent les champs bruts (83%).*

- `5c556c16ea8b` — 14478 candidats
  - AVEC connectivite (5866) : resistance **41.2%**
  - SANS connectivite (8612) : resistance **21.5%**
...
- `5c556c16ea8b` — 14478 candidats
  ...
  - SANS connectivite (8612) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.33**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 78131 systemes
  - sans CONNECTED : 0.0% sur 17653 systemes
