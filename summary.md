...
genere 2026-08-26 12:27 UTC — 43886 systemes evalues
...
- `e40600351a72` : 144 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
- `6680f7b47e6f` : 124 systemes

Les lignes de dsl_hash differents ne sont pas comparables entre elles.

**7610 enregistrements (17%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 19084 | 9522 | 1248 | 663 | 1902 | 1517 | 2064 | 1932 | 10.1% |
...
- **2338 systemes avec CONNECTED sur 18082 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*941 candidats sur 5231 portent les champs bruts (18%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `e40600351a72` — 20 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (8) : resistance **38.2%**
...
- `e40600351a72` — 20 candidats
  - AVEC connectivite (8) : T0=15.00 T1=0.00 T2=3.12 — pondere **6.25**
...
- TROP-CHER : 2355 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2338 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 15581 systemes
  - sans CONNECTED : 0.0% sur 3503 systemes
