...
genere 2026-08-26 17:27 UTC — 56019 systemes evalues
...
- moteur actif `0caa9267db60` (12277 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
| connect | 4 | 3 | 25221 | 12581 | 1718 | 849 | 2495 | 1996 | 2693 | 2577 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 24683 | 5706 | 10448 | 14 | 3447 | 1254 | 10 | 3804 | 15.4% |
...
- candidats AVEC connectivite : 2704, dont T2 : 100%
- candidats SANS connectivite : 4114, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2967 systemes avec CONNECTED sur 23115 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2528 candidats sur 6818 portent les champs bruts (37%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 218 candidats
  - AVEC connectivite (90) : resistance **44.0%**
  - SANS connectivite (128) : resistance **20.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `23303c299f39` — 218 candidats
  - AVEC connectivite (90) : T0=13.07 T1=0.00 T2=3.23 — pondere **6.47**
  - SANS connectivite (128) : T0=16.21 T1=0.00 T2=2.57 — pondere **5.14**
...
**4 serie(s) reproductible(s) sur 7 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0055).
...
- TROP-CHER : 2987 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2967 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 20614 systemes
  - sans CONNECTED : 0.0% sur 4607 systemes
