...
genere 2026-08-26 22:38 UTC — 67690 systemes evalues
...
- moteur actif `0caa9267db60` (23948 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 31114 | 15453 | 2127 | 1043 | 3103 | 2478 | 3320 | 3195 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 30461 | 7019 | 12937 | 18 | 4223 | 1583 | 14 | 4667 | 15.3% |
...
- candidats AVEC connectivite : 3322, dont T2 : 100%
- candidats SANS connectivite : 4977, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3594 systemes avec CONNECTED sur 27934 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4009 candidats sur 8299 portent les champs bruts (48%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 332 candidats
  - AVEC connectivite (142) : resistance **43.0%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 332 candidats
  - AVEC connectivite (142) : T0=12.83 T1=0.00 T2=3.11 — pondere **6.23**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 25433 systemes
  - sans CONNECTED : 0.0% sur 5681 systemes
