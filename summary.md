...
genere 2026-08-27 03:58 UTC — 79474 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 14567 systemes
...
- moteur actif `0caa9267db60` (35732 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 37082 | 18437 | 2560 | 1263 | 3670 | 2924 | 3934 | 3811 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 36277 | 8351 | 15449 | 21 | 5017 | 1898 | 19 | 5522 | 15.2% |
...
- candidats AVEC connectivite : 3938, dont T2 : 100%
- candidats SANS connectivite : 5832, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4208 systemes avec CONNECTED sur 32863 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5480 candidats sur 9770 portent les champs bruts (56%).*
...
- `ab89a63b01ef` — 1803 candidats
  - AVEC connectivite (758) : resistance **41.4%**
  - SANS connectivite (1045) : resistance **21.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1803 candidats
  - AVEC connectivite (758) : T0=13.03 T1=0.00 T2=3.05 — pondere **6.09**
  - SANS connectivite (1045) : T0=15.92 T1=0.00 T2=2.69 — pondere **5.37**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
## cout
- temps total 24.6 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 4237 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4208 avec CONNECTED, 29 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 30362 systemes
  - sans CONNECTED : 0.0% sur 6720 systemes
