...
genere 2026-08-28 05:13 UTC — 129905 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 46561 systemes
...
- moteur actif `0caa9267db60` (86163 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 62528 | 31103 | 4302 | 2117 | 6241 | 4973 | 6559 | 6424 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 61262 | 14162 | 25950 | 29 | 8518 | 3173 | 27 | 9401 | 15.3% |
...
- candidats AVEC connectivite : 6551, dont T2 : 100%
- candidats SANS connectivite : 9711, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6833 systemes avec CONNECTED sur 53525 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11972 candidats sur 16262 portent les champs bruts (74%).*

- `5c556c16ea8b` — 6007 candidats
  - AVEC connectivite (2423) : resistance **41.6%**
  - SANS connectivite (3584) : resistance **22.0%**
...
- `5c556c16ea8b` — 6007 candidats
  - AVEC connectivite (2423) : T0=12.99 T1=0.00 T2=3.03 — pondere **6.05**
  - SANS connectivite (3584) : T0=15.87 T1=0.00 T2=2.70 — pondere **5.39**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 51024 systemes
  - sans CONNECTED : 0.0% sur 11504 systemes
