...
genere 2026-09-03 23:31 UTC — 350552 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 267208 systemes
...
- moteur actif `0caa9267db60` (306810 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 173949 | 86477 | 11815 | 5820 | 17715 | 13691 | 18430 | 17787 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 170488 | 39631 | 72030 | 70 | 23676 | 8825 | 67 | 26175 | 15.4% |
...
- candidats AVEC connectivite : 17914, dont T2 : 100%
- candidats SANS connectivite : 26485, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18704 systemes avec CONNECTED sur 144435 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*40109 candidats sur 44399 portent les champs bruts (90%).*

- `5c556c16ea8b` — 34144 candidats
  - AVEC connectivite (13786) : resistance **41.0%**
  - SANS connectivite (20358) : resistance **21.2%**
...
- `5c556c16ea8b` — 34144 candidats
  - AVEC connectivite (13786) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (20358) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 141934 systemes
  - sans CONNECTED : 0.0% sur 32015 systemes
