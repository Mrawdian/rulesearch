...
genere 2026-08-28 07:18 UTC — 133523 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 50179 systemes
...
- moteur actif `0caa9267db60` (89781 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 64362 | 31979 | 4418 | 2184 | 6452 | 5119 | 6766 | 6613 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 63046 | 14584 | 26686 | 29 | 8777 | 3258 | 28 | 9682 | 15.4% |
...
- candidats AVEC connectivite : 6740, dont T2 : 100%
- candidats SANS connectivite : 9992, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7040 systemes avec CONNECTED sur 55003 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12442 candidats sur 16732 portent les champs bruts (74%).*

- `5c556c16ea8b` — 6477 candidats
  - AVEC connectivite (2612) : resistance **41.4%**
  - SANS connectivite (3865) : resistance **21.9%**
...
- `5c556c16ea8b` — 6477 candidats
  - AVEC connectivite (2612) : T0=12.98 T1=0.00 T2=3.02 — pondere **6.04**
  - SANS connectivite (3865) : T0=15.86 T1=0.00 T2=2.68 — pondere **5.36**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 52502 systemes
  - sans CONNECTED : 0.0% sur 11860 systemes
