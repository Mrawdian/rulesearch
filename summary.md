...
**7466 enregistrements (69%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 5441 | 2732 | 351 | 199 | 525 | 449 | 566 | 559 | 10.3% |
| ref | 4 | 3 | 5308 | 1281 | 2223 | 1 | 701 | 258 | 2 | 842 | 15.9% |
...
- candidats AVEC connectivite : 562, dont T2 : 100%
- candidats SANS connectivite : 846, dont T2 : 100%
...
- **566 systemes avec CONNECTED sur 4502 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 243 candidats
  - AVEC connectivite (83) : T0=13.25 T1=0.00 T2=2.71 — pondere **5.42**
  - SANS connectivite (160) : T0=15.93 T1=0.00 T2=2.67 — pondere **5.34**
...
- TROP-CHER : 568 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 566 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 4445 systemes
  - sans CONNECTED : 0.0% sur 996 systemes
