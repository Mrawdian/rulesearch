...
genere 2026-08-31 15:12 UTC — 255501 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 172157 systemes
...
- moteur actif `0caa9267db60` (211759 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 125964 | 62628 | 8523 | 4221 | 12729 | 9959 | 13280 | 12972 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 123422 | 28777 | 52105 | 55 | 17094 | 6380 | 56 | 18945 | 15.3% |
...
- candidats SANS connectivite : 19255, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13554 systemes avec CONNECTED sur 105281 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*28064 candidats sur 32354 portent les champs bruts (87%).*

- `5c556c16ea8b` — 22099 candidats
  - AVEC connectivite (8971) : resistance **41.0%**
  - SANS connectivite (13128) : resistance **21.4%**
...
- `5c556c16ea8b` — 22099 candidats
  ...
  - SANS connectivite (13128) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 13620 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13554 avec CONNECTED, 66 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 102780 systemes
  - sans CONNECTED : 0.0% sur 23184 systemes
