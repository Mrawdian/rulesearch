...
genere 2026-08-31 14:53 UTC — 255029 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 171685 systemes
...
- moteur actif `0caa9267db60` (211287 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 125726 | 62500 | 8510 | 4217 | 12700 | 9945 | 13266 | 12939 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 123188 | 28728 | 52001 | 55 | 17057 | 6369 | 56 | 18912 | 15.4% |
...
- candidats SANS connectivite : 19222, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13540 systemes avec CONNECTED sur 105088 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*27998 candidats sur 32288 portent les champs bruts (87%).*

- `5c556c16ea8b` — 22033 candidats
  - AVEC connectivite (8938) : resistance **41.0%**
  - SANS connectivite (13095) : resistance **21.4%**
...
- `5c556c16ea8b` — 22033 candidats
  ...
  - SANS connectivite (13095) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 13606 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13540 avec CONNECTED, 66 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 102587 systemes
  - sans CONNECTED : 0.0% sur 23139 systemes
