...
genere 2026-08-26 13:09 UTC — 45802 systemes evalues
...
- moteur actif `0caa9267db60` (2060 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20053 | 10015 | 1310 | 690 | 2009 | 1591 | 2151 | 2039 | 10.2% |
...
- candidats AVEC connectivite : 2166, dont T2 : 100%
- candidats SANS connectivite : 3308, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2425 systemes avec CONNECTED sur 18863 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1184 candidats sur 5474 portent les champs bruts (22%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 69 candidats
  - AVEC connectivite (28) : resistance **36.9%**
...
- `06fe04a859f1` — 69 candidats
  - AVEC connectivite (28) : T0=13.64 T1=0.00 T2=2.50 — pondere **5.00**
  - SANS connectivite (41) : T0=16.61 T1=0.00 T2=2.63 — pondere **5.27**
  - test de permutation : **p = 0.7246** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16362 systemes
  - sans CONNECTED : 0.0% sur 3691 systemes
