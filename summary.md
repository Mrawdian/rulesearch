...
genere 2026-09-07 03:57 UTC — 427729 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 344385 systemes
...
- moteur actif `0caa9267db60` (383987 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 212910 | 105704 | 14499 | 7082 | 21598 | 16741 | 22639 | 21939 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 208704 | 48590 | 87992 | 81 | 29089 | 10777 | 75 | 32082 | 15.4% |
...
- candidats SANS connectivite : 32392, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **22913 systemes avec CONNECTED sur 176244 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*50168 candidats sur 54458 portent les champs bruts (92%).*

- `5c556c16ea8b` — 44203 candidats
  - AVEC connectivite (17938) : resistance **41.1%**
  - SANS connectivite (26265) : resistance **21.3%**
...
- `5c556c16ea8b` — 44203 candidats
  ...
  - SANS connectivite (26265) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 22998 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 22913 avec CONNECTED, 85 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 173743 systemes
  - sans CONNECTED : 0.0% sur 39167 systemes
