...
| connect | 4 | 3 | 17753 | 8883 | 1145 | 613 | 1762 | 1411 | 1930 | 1785 | 10.1% |
...
- candidats AVEC connectivite : 1912, dont T2 : 100%
- candidats SANS connectivite : 2977, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2204 systemes avec CONNECTED sur 17001 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*599 candidats sur 4889 portent les champs bruts (12%).*
...
- `e3baecf8377b` — 335 candidats
  - AVEC connectivite (129) : resistance **43.3%**
...
- `e3baecf8377b` — 335 candidats
  - AVEC connectivite (129) : T0=13.00 T1=0.00 T2=3.12 — pondere **6.25**
...
**2 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0090).
...
- TROP-CHER : 2221 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2204 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14500 systemes
  - sans CONNECTED : 0.0% sur 3253 systemes
