...
genere 2026-09-07 13:16 UTC — 436418 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 353074 systemes
...
- moteur actif `0caa9267db60` (392676 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 217317 | 107971 | 14809 | 7233 | 22004 | 17038 | 23115 | 22388 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 212986 | 49615 | 89768 | 83 | 29680 | 10998 | 77 | 32747 | 15.4% |
...
- candidats SANS connectivite : 33057, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23389 systemes avec CONNECTED sur 179912 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*51282 candidats sur 55572 portent les champs bruts (92%).*

- `5c556c16ea8b` — 45317 candidats
  - AVEC connectivite (18387) : resistance **41.1%**
  - SANS connectivite (26930) : resistance **21.3%**
...
- `5c556c16ea8b` — 45317 candidats
  ...
  - SANS connectivite (26930) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 177411 systemes
  - sans CONNECTED : 0.0% sur 39906 systemes
