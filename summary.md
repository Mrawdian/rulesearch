...
genere 2026-08-26 17:25 UTC — 55900 systemes evalues
...
- moteur actif `0caa9267db60` (12158 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
| ref | 4 | 3 | 24624 | 5697 | 10414 | 14 | 3440 | 1252 | 10 | 3797 | 15.4% |
...
- candidats SANS connectivite : 4107, dont T2 : 100%
...
*2514 candidats sur 6804 portent les champs bruts (37%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 204 candidats
  - AVEC connectivite (83) : resistance **43.3%**
  - SANS connectivite (121) : resistance **20.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `23303c299f39` — 204 candidats
  ...
  - SANS connectivite (121) : T0=16.18 T1=0.00 T2=2.60 — pondere **5.21**
  - test de permutation : **p = 0.0325** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e40600351a72` — 194 candidats
...
**4 serie(s) reproductible(s) sur 7 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0325).
