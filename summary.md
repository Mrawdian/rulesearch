...
| connect | 4 | 3 | 7667 | 3859 | 506 | 266 | 733 | 611 | 808 | 798 | 10.4% |
| ref | 4 | 3 | 7496 | 1816 | 3131 | 1 | 1002 | 369 | 2 | 1175 | 15.7% |
...
- candidats AVEC connectivite : 801, dont T2 : 100%
- candidats SANS connectivite : 1179, dont T2 : 100%
...
- **808 systemes avec CONNECTED sur 6348 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 815 candidats
  - AVEC connectivite (322) : T0=13.39 T1=0.00 T2=2.88 — pondere **5.76**
  - SANS connectivite (493) : T0=15.79 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 810 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 808 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 6291 systemes
  - sans CONNECTED : 0.0% sur 1376 systemes
