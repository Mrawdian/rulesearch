...
genere 2026-08-27 02:44 UTC — 76729 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 11822 systemes
...
- moteur actif `0caa9267db60` (32987 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 35693 | 17768 | 2450 | 1210 | 3541 | 2826 | 3794 | 3642 | 10.2% |
...
- candidats AVEC connectivite : 3769, dont T2 : 100%
- candidats SANS connectivite : 5637, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4068 systemes avec CONNECTED sur 31714 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5116 candidats sur 9406 portent les champs bruts (54%).*
...
- `ab89a63b01ef` — 1439 candidats
  - AVEC connectivite (589) : resistance **41.2%**
...
- `ab89a63b01ef` — 1439 candidats
  - AVEC connectivite (589) : T0=12.97 T1=0.00 T2=3.04 — pondere **6.09**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 29213 systemes
  - sans CONNECTED : 0.0% sur 6480 systemes
