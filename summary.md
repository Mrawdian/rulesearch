...
- moteur actif `0caa9267db60` (48005 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 43259 | 21561 | 2966 | 1458 | 4322 | 3405 | 4555 | 4429 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 42373 | 9773 | 17978 | 25 | 5882 | 2213 | 22 | 6479 | 15.3% |
...
- candidats AVEC connectivite : 4556, dont T2 : 100%
- candidats SANS connectivite : 6789, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4829 systemes avec CONNECTED sur 37846 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*7055 candidats sur 11345 portent les champs bruts (62%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 1090 candidats
  - AVEC connectivite (428) : resistance **41.2%**
  - SANS connectivite (662) : resistance **21.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 1090 candidats
  - AVEC connectivite (428) : T0=13.04 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (662) : T0=15.79 T1=0.00 T2=2.63 — pondere **5.26**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
...
- TROP-CHER : 4861 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4829 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 35345 systemes
  - sans CONNECTED : 0.0% sur 7914 systemes
