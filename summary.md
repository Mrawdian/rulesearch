...
genere 2026-08-26 10:12 UTC — 38178 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29204 systemes
...
| connect | 4 | 3 | 16212 | 8097 | 1052 | 556 | 1612 | 1289 | 1771 | 1630 | 10.1% |
| d4 | 4 | 4 | 5961 | 2735 | 1513 | 30 | 420 | 402 | 282 | 430 | 7.2% |
| ref | 4 | 3 | 15881 | 3731 | 6717 | 11 | 2174 | 804 | 7 | 2437 | 15.3% |
...
- candidats AVEC connectivite : 1757, dont T2 : 100%
- candidats SANS connectivite : 2747, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2043 systemes avec CONNECTED sur 15740 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*214 candidats sur 4504 portent les champs bruts (5%).*

- `89c65c03c4ad` — 214 candidats
  - AVEC connectivite (80) : resistance **47.6%**
  - SANS connectivite (134) : resistance **21.2%**
...
- `89c65c03c4ad` — 3339 candidats
  - AVEC connectivite (1278) : T0=13.03 T1=0.00 T2=2.97 — pondere **5.93**
  - SANS connectivite (2061) : T0=15.85 T1=0.02 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 2060 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2043 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.4% sur 13251 systemes
  - sans CONNECTED : 0.0% sur 2961 systemes
