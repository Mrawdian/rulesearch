...
- moteur actif `0caa9267db60` (8595 systemes) : `06fe04a859f1`, `e40600351a72`
...
| ref | 4 | 3 | 22865 | 5287 | 9659 | 14 | 3203 | 1163 | 10 | 3529 | 15.4% |
...
- candidats SANS connectivite : 3839, dont T2 : 100%
...
*2042 candidats sur 6332 portent les champs bruts (32%).*
...
- `06fe04a859f1` — 927 candidats
  - AVEC connectivite (355) : resistance **41.3%**
  - SANS connectivite (572) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 927 candidats
  ...
  - SANS connectivite (572) : T0=16.02 T1=0.00 T2=2.65 — pondere **5.30**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e3baecf8377b` — 657 candidats
