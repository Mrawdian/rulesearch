...
genere 2026-08-29 07:10 UTC — 174373 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 91029 systemes
...
- moteur actif `0caa9267db60` (130631 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 84992 | 42302 | 5775 | 2869 | 8533 | 6743 | 8922 | 8772 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 83266 | 19442 | 35208 | 39 | 11484 | 4239 | 34 | 12815 | 15.4% |
...
- candidats AVEC connectivite : 8899, dont T2 : 100%
- candidats SANS connectivite : 13125, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9196 systemes avec CONNECTED sur 71876 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*17734 candidats sur 22024 portent les champs bruts (81%).*

- `5c556c16ea8b` — 11769 candidats
  - AVEC connectivite (4771) : resistance **41.2%**
  - SANS connectivite (6998) : resistance **21.6%**
...
- `5c556c16ea8b` — 11769 candidats
  - AVEC connectivite (4771) : T0=13.01 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (6998) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.33**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 69375 systemes
  - sans CONNECTED : 0.0% sur 15617 systemes
