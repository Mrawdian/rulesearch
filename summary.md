...
genere 2026-08-29 06:34 UTC — 173401 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 90057 systemes
...
- moteur actif `0caa9267db60` (129659 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 84498 | 42069 | 5751 | 2851 | 8474 | 6701 | 8871 | 8709 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 82788 | 19322 | 35009 | 39 | 11431 | 4208 | 34 | 12740 | 15.4% |
...
- candidats AVEC connectivite : 8836, dont T2 : 100%
- candidats SANS connectivite : 13050, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9145 systemes avec CONNECTED sur 71476 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*17596 candidats sur 21886 portent les champs bruts (80%).*

- `5c556c16ea8b` — 11631 candidats
  - AVEC connectivite (4708) : resistance **41.2%**
  - SANS connectivite (6923) : resistance **21.6%**
...
- `5c556c16ea8b` — 11631 candidats
  - AVEC connectivite (4708) : T0=13.01 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (6923) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 9189 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 9145 avec CONNECTED, 44 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 68975 systemes
  - sans CONNECTED : 0.0% sur 15523 systemes
