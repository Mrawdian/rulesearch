...
genere 2026-08-27 00:28 UTC — 71768 systemes evalues
...
- moteur actif `0caa9267db60` (28026 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 32473 | 7487 | 13782 | 18 | 4503 | 1701 | 16 | 4966 | 15.3% |
...
- candidats SANS connectivite : 5276, dont T2 : 100%
...
*4507 candidats sur 8797 portent les champs bruts (51%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 830 candidats
  - AVEC connectivite (341) : resistance **41.3%**
  - SANS connectivite (489) : resistance **21.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 830 candidats
  ...
  - SANS connectivite (489) : T0=15.95 T1=0.00 T2=2.61 — pondere **5.21**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 798 candidats
