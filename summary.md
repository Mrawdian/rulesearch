...
- moteur actif `0caa9267db60` (6808 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22459 | 11193 | 1509 | 767 | 2243 | 1777 | 2404 | 2285 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 21976 | 5096 | 9271 | 13 | 3068 | 1126 | 10 | 3392 | 15.4% |
...
- candidats AVEC connectivite : 2412, dont T2 : 100%
- candidats SANS connectivite : 3702, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2678 systemes avec CONNECTED sur 20833 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1824 candidats sur 6114 portent les champs bruts (30%).*
...
- `06fe04a859f1` — 709 candidats
  - AVEC connectivite (274) : resistance **41.2%**
  - SANS connectivite (435) : resistance **20.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 709 candidats
  - AVEC connectivite (274) : T0=13.30 T1=0.00 T2=3.03 — pondere **6.06**
  - SANS connectivite (435) : T0=16.04 T1=0.00 T2=2.61 — pondere **5.23**
...
- TROP-CHER : 2698 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2678 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18332 systemes
  - sans CONNECTED : 0.0% sur 4127 systemes
