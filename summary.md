...
genere 2026-09-09 14:40 UTC — 480688 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 397344 systemes
...
- moteur actif `0caa9267db60` (436946 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 239680 | 118981 | 16341 | 8027 | 24261 | 18801 | 25523 | 24701 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 234893 | 54731 | 98976 | 92 | 32724 | 12133 | 86 | 36132 | 15.4% |
...
- candidats AVEC connectivite : 24828, dont T2 : 100%
- candidats SANS connectivite : 36442, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25797 systemes avec CONNECTED sur 198168 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*56980 candidats sur 61270 portent les champs bruts (93%).*

- `5c556c16ea8b` — 51015 candidats
  - AVEC connectivite (20700) : resistance **41.2%**
  - SANS connectivite (30315) : resistance **21.3%**
...
- `5c556c16ea8b` — 51015 candidats
  - AVEC connectivite (20700) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (30315) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 25893 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25797 avec CONNECTED, 96 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 195667 systemes
  - sans CONNECTED : 0.0% sur 44013 systemes
