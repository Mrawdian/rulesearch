...
genere 2026-09-05 14:08 UTC — 391027 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 307683 systemes
...
- moteur actif `0caa9267db60` (347285 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 194378 | 96538 | 13234 | 6472 | 19765 | 15302 | 20615 | 19977 | 10.3% |
...
- candidats AVEC connectivite : 20104, dont T2 : 100%
...
- **20889 systemes avec CONNECTED sur 161054 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*45367 candidats sur 49657 portent les champs bruts (91%).*

- `5c556c16ea8b` — 39402 candidats
  - AVEC connectivite (15976) : resistance **41.0%**
...
- `5c556c16ea8b` — 39402 candidats
  - AVEC connectivite (15976) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.94**
...
- TROP-CHER : 20970 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 20889 avec CONNECTED, 81 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 158553 systemes
