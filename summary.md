...
genere 2026-08-27 07:44 UTC — 87814 systemes evalues
...
- moteur actif `0caa9267db60` (44072 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 41269 | 20541 | 2839 | 1403 | 4120 | 3253 | 4346 | 4236 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 40430 | 9308 | 17188 | 22 | 5618 | 2105 | 21 | 6168 | 15.3% |
...
- candidats AVEC connectivite : 4363, dont T2 : 100%
- candidats SANS connectivite : 6478, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4620 systemes avec CONNECTED sur 36225 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6551 candidats sur 10841 portent les champs bruts (60%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 586 candidats
  - AVEC connectivite (235) : resistance **41.3%**
  - SANS connectivite (351) : resistance **20.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 586 candidats
  - AVEC connectivite (235) : T0=13.01 T1=0.00 T2=3.02 — pondere **6.03**
  - SANS connectivite (351) : T0=15.91 T1=0.00 T2=2.63 — pondere **5.26**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 33724 systemes
  - sans CONNECTED : 0.0% sur 7545 systemes
