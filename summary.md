...
genere 2026-09-03 19:02 UTC — 345546 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 262202 systemes
...
- moteur actif `0caa9267db60` (301804 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 171414 | 85201 | 11626 | 5741 | 17447 | 13520 | 18176 | 17520 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 168017 | 39077 | 71010 | 67 | 23307 | 8693 | 66 | 25785 | 15.3% |
...
- candidats SANS connectivite : 26095, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18450 systemes avec CONNECTED sur 142358 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39452 candidats sur 43742 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33487 candidats
  - AVEC connectivite (13519) : resistance **41.1%**
  - SANS connectivite (19968) : resistance **21.2%**
...
- `5c556c16ea8b` — 33487 candidats
  ...
  - SANS connectivite (19968) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 139857 systemes
  - sans CONNECTED : 0.0% sur 31557 systemes
