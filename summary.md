...
genere 2026-08-28 12:21 UTC — 142280 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 58936 systemes
...
- moteur actif `0caa9267db60` (98538 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 68784 | 34184 | 4715 | 2335 | 6897 | 5483 | 7258 | 7033 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 67381 | 15624 | 28483 | 30 | 9341 | 3472 | 30 | 10398 | 15.4% |
...
- candidats AVEC connectivite : 7160, dont T2 : 100%
- candidats SANS connectivite : 10708, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7532 systemes avec CONNECTED sur 58593 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*13578 candidats sur 17868 portent les champs bruts (76%).*

- `5c556c16ea8b` — 7613 candidats
  - AVEC connectivite (3032) : resistance **41.2%**
  - SANS connectivite (4581) : resistance **21.8%**
...
- `5c556c16ea8b` — 7613 candidats
  - AVEC connectivite (3032) : T0=13.02 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (4581) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.36**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 56092 systemes
  - sans CONNECTED : 0.0% sur 12692 systemes
