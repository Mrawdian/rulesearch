...
genere 2026-09-04 05:03 UTC — 356511 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 273167 systemes
...
- moteur actif `0caa9267db60` (312769 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 176952 | 87941 | 12036 | 5922 | 17998 | 13926 | 18759 | 18115 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 173444 | 40297 | 73257 | 70 | 24085 | 8991 | 70 | 26660 | 15.4% |
...
- candidats SANS connectivite : 26970, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19033 systemes avec CONNECTED sur 146903 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*40922 candidats sur 45212 portent les champs bruts (91%).*

- `5c556c16ea8b` — 34957 candidats
  - AVEC connectivite (14114) : resistance **41.1%**
  - SANS connectivite (20843) : resistance **21.2%**
...
- `5c556c16ea8b` — 34957 candidats
  ...
  - SANS connectivite (20843) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 144402 systemes
  - sans CONNECTED : 0.0% sur 32550 systemes
