...
| connect | 4 | 3 | 18427 | 9198 | 1196 | 640 | 1840 | 1465 | 2001 | 1858 | 10.1% |
...
- candidats AVEC connectivite : 1985, dont T2 : 100%
- candidats SANS connectivite : 3080, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2275 systemes avec CONNECTED sur 17543 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*775 candidats sur 5065 portent les champs bruts (15%).*
...
- `e3baecf8377b` — 511 candidats
  - AVEC connectivite (202) : resistance **42.7%**
...
- `e3baecf8377b` — 511 candidats
  - AVEC connectivite (202) : T0=13.01 T1=0.00 T2=3.12 — pondere **6.24**
...
- TROP-CHER : 2292 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 2275 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 15042 systemes
  - sans CONNECTED : 0.0% sur 3385 systemes
