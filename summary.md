...
genere 2026-08-26 17:13 UTC — 55475 systemes evalues
...
- moteur actif `0caa9267db60` (11733 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
| connect | 4 | 3 | 24938 | 12450 | 1697 | 843 | 2467 | 1967 | 2664 | 2539 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 24422 | 5648 | 10329 | 14 | 3413 | 1241 | 10 | 3767 | 15.4% |
...
- candidats AVEC connectivite : 2666, dont T2 : 100%
- candidats SANS connectivite : 4077, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2938 systemes avec CONNECTED sur 22886 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2453 candidats sur 6743 portent les champs bruts (36%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 143 candidats
  - AVEC connectivite (52) : resistance **41.5%**
...
- `23303c299f39` — 143 candidats
  - AVEC connectivite (52) : T0=12.81 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (91) : T0=16.41 T1=0.00 T2=2.74 — pondere **5.47**
  - test de permutation : **p = 0.3673** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 2958 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2938 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 20385 systemes
  - sans CONNECTED : 0.0% sur 4553 systemes
