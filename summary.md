...
genere 2026-08-26 03:11 UTC — 20356 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 11382 systemes
...
| connect | 4 | 3 | 10223 | 5152 | 665 | 351 | 979 | 816 | 1098 | 1034 | 10.1% |
...
- candidats AVEC connectivite : 1037, dont T2 : 100%
...
- **1098 systemes avec CONNECTED sur 8446 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1423 candidats
  - AVEC connectivite (558) : T0=13.35 T1=0.00 T2=2.87 — pondere **5.73**
...
- TROP-CHER : 1102 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 1098 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 8389 systemes
  - sans CONNECTED : 0.0% sur 1834 systemes
