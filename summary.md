...
genere 2026-08-28 04:58 UTC — 129374 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 46030 systemes
...
- moteur actif `0caa9267db60` (85632 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 62261 | 30971 | 4293 | 2106 | 6208 | 4943 | 6540 | 6396 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 60998 | 14109 | 25833 | 28 | 8478 | 3159 | 27 | 9362 | 15.3% |
...
- candidats AVEC connectivite : 6523, dont T2 : 100%
- candidats SANS connectivite : 9672, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6814 systemes avec CONNECTED sur 53319 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11905 candidats sur 16195 portent les champs bruts (74%).*

- `5c556c16ea8b` — 5940 candidats
  - AVEC connectivite (2395) : resistance **41.7%**
  - SANS connectivite (3545) : resistance **22.0%**
...
- `5c556c16ea8b` — 5940 candidats
  - AVEC connectivite (2395) : T0=12.99 T1=0.00 T2=3.03 — pondere **6.06**
  - SANS connectivite (3545) : T0=15.87 T1=0.00 T2=2.69 — pondere **5.39**
...
- TROP-CHER : 6851 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6814 avec CONNECTED, 37 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 50818 systemes
  - sans CONNECTED : 0.0% sur 11443 systemes
