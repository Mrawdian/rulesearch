...
genere 2026-09-03 16:20 UTC — 342639 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 259295 systemes
...
- moteur actif `0caa9267db60` (298897 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 169950 | 84482 | 11528 | 5690 | 17285 | 13418 | 18012 | 17371 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 166574 | 38748 | 70394 | 67 | 23122 | 8614 | 66 | 25551 | 15.3% |
...
- candidats AVEC connectivite : 17498, dont T2 : 100%
- candidats SANS connectivite : 25861, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18286 systemes avec CONNECTED sur 141163 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39069 candidats sur 43359 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33104 candidats
  - AVEC connectivite (13370) : resistance **41.0%**
  - SANS connectivite (19734) : resistance **21.2%**
...
- `5c556c16ea8b` — 33104 candidats
  - AVEC connectivite (13370) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (19734) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.29**
...
- TROP-CHER : 18362 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18286 avec CONNECTED, 76 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 138662 systemes
  - sans CONNECTED : 0.0% sur 31288 systemes
