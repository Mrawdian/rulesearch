...
genere 2026-08-27 04:09 UTC — 79844 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 14937 systemes
...
- moteur actif `0caa9267db60` (36102 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 37261 | 18527 | 2570 | 1269 | 3697 | 2933 | 3954 | 3828 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 36468 | 8388 | 15536 | 21 | 5043 | 1906 | 20 | 5554 | 15.2% |
...
- candidats SANS connectivite : 5864, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4228 systemes avec CONNECTED sur 33005 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5529 candidats sur 9819 portent les champs bruts (56%).*
...
- `ab89a63b01ef` — 1852 candidats
  - AVEC connectivite (775) : resistance **41.3%**
  - SANS connectivite (1077) : resistance **21.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1852 candidats
  ...
  - SANS connectivite (1077) : T0=15.91 T1=0.00 T2=2.69 — pondere **5.38**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 30504 systemes
  - sans CONNECTED : 0.0% sur 6757 systemes
