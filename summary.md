...
genere 2026-08-26 19:13 UTC — 60233 systemes evalues
...
- moteur actif `0caa9267db60` (16491 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27345 | 13640 | 1863 | 923 | 2704 | 2166 | 2907 | 2799 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 26773 | 6190 | 11331 | 15 | 3730 | 1375 | 10 | 4122 | 15.4% |
...
- candidats AVEC connectivite : 2926, dont T2 : 100%
- candidats SANS connectivite : 4432, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3181 systemes avec CONNECTED sur 24874 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3068 candidats sur 7358 portent les champs bruts (42%).*
...
- `23303c299f39` — 225 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 199 candidats
  - AVEC connectivite (82) : resistance **39.5%**
  - SANS connectivite (117) : resistance **18.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 199 candidats
  - AVEC connectivite (82) : T0=13.13 T1=0.00 T2=2.91 — pondere **5.83**
  - SANS connectivite (117) : T0=16.07 T1=0.00 T2=2.55 — pondere **5.09**
...
- TROP-CHER : 3201 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3181 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22373 systemes
  - sans CONNECTED : 0.0% sur 4972 systemes
