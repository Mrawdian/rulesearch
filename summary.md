...
genere 2026-08-26 19:39 UTC — 61191 systemes evalues
...
- moteur actif `0caa9267db60` (17449 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27840 | 13878 | 1905 | 935 | 2753 | 2208 | 2959 | 2852 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 27236 | 6304 | 11523 | 15 | 3790 | 1402 | 11 | 4191 | 15.4% |
...
- candidats AVEC connectivite : 2979, dont T2 : 100%
- candidats SANS connectivite : 4501, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3233 systemes avec CONNECTED sur 25280 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3190 candidats sur 7480 portent les champs bruts (43%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 321 candidats
  - AVEC connectivite (135) : resistance **39.4%**
  - SANS connectivite (186) : resistance **19.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 321 candidats
  - AVEC connectivite (135) : T0=13.07 T1=0.00 T2=2.88 — pondere **5.76**
  - SANS connectivite (186) : T0=16.08 T1=0.00 T2=2.63 — pondere **5.27**
  - test de permutation : **p = 0.1669** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- TROP-CHER : 3254 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3233 avec CONNECTED, 21 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22779 systemes
  - sans CONNECTED : 0.0% sur 5061 systemes
