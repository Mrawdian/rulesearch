...
genere 2026-08-31 19:26 UTC — 261051 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 177707 systemes
...
- moteur actif `0caa9267db60` (217309 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 128772 | 64017 | 8708 | 4314 | 13035 | 10184 | 13571 | 13263 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 126164 | 29397 | 53266 | 56 | 17493 | 6519 | 56 | 19367 | 15.4% |
...
- candidats SANS connectivite : 19677, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13845 systemes avec CONNECTED sur 107557 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*28777 candidats sur 33067 portent les champs bruts (87%).*

- `5c556c16ea8b` — 22812 candidats
  - AVEC connectivite (9262) : resistance **41.0%**
  - SANS connectivite (13550) : resistance **21.4%**
...
- `5c556c16ea8b` — 22812 candidats
  ...
  - SANS connectivite (13550) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 13911 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13845 avec CONNECTED, 66 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 105056 systemes
  - sans CONNECTED : 0.0% sur 23716 systemes
