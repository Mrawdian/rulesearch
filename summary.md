...
genere 2026-08-26 16:16 UTC — 53208 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 8025 systemes
...
- moteur actif `0caa9267db60` (9466 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23804 | 11878 | 1615 | 811 | 2365 | 1878 | 2546 | 2413 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 23289 | 5394 | 9836 | 14 | 3257 | 1189 | 10 | 3589 | 15.4% |
...
- candidats AVEC connectivite : 2540, dont T2 : 100%
- candidats SANS connectivite : 3899, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2820 systemes avec CONNECTED sur 21944 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2149 candidats sur 6439 portent les champs bruts (33%).*
...
- `06fe04a859f1` — 1034 candidats
  - AVEC connectivite (402) : resistance **41.2%**
...
- `06fe04a859f1` — 1034 candidats
  - AVEC connectivite (402) : T0=13.18 T1=0.00 T2=3.04 — pondere **6.08**
...
- TROP-CHER : 2840 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2820 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19443 systemes
  - sans CONNECTED : 0.0% sur 4361 systemes
