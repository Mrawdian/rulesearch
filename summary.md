...
genere 2026-08-26 13:33 UTC — 46882 systemes evalues
...
- moteur actif `0caa9267db60` (3140 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20603 | 10275 | 1360 | 715 | 2055 | 1636 | 2198 | 2109 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20164 | 4717 | 8521 | 13 | 2795 | 1042 | 7 | 3069 | 15.2% |
...
- candidats AVEC connectivite : 2236, dont T2 : 100%
- candidats SANS connectivite : 3379, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2472 systemes avec CONNECTED sur 19321 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1325 candidats sur 5615 portent les champs bruts (24%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 210 candidats
  - AVEC connectivite (98) : resistance **39.0%**
  - SANS connectivite (112) : resistance **22.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 210 candidats
  - AVEC connectivite (98) : T0=13.51 T1=0.00 T2=2.80 — pondere **5.59**
  - SANS connectivite (112) : T0=16.14 T1=0.00 T2=2.88 — pondere **5.75**
  - test de permutation : **p = 0.7241** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
- TROP-CHER : 2489 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2472 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16820 systemes
  - sans CONNECTED : 0.0% sur 3783 systemes
