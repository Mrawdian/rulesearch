...
| connect | 4 | 3 | 5411 | 2714 | 350 | 195 | 524 | 447 | 563 | 559 | 10.3% |
| ref | 4 | 3 | 5279 | 1276 | 2209 | 1 | 699 | 255 | 2 | 837 | 15.9% |
...
- candidats SANS connectivite : 841, dont T2 : 100%
...
- **563 systemes avec CONNECTED sur 4475 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 238 candidats
  - AVEC connectivite (83) : T0=13.25 T1=0.00 T2=2.71 — pondere **5.42**
  - SANS connectivite (155) : T0=15.91 T1=0.00 T2=2.64 — pondere **5.28**
  - test de permutation : **p = 0.7356** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 565 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 563 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 4418 systemes
  - sans CONNECTED : 0.0% sur 993 systemes
