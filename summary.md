...
genere 2026-08-27 15:13 UTC — 102863 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 19519 systemes
...
- moteur actif `0caa9267db60` (59121 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 47875 | 11067 | 20322 | 25 | 6627 | 2504 | 23 | 7306 | 15.3% |
...
- candidats SANS connectivite : 7616, dont T2 : 100%
...
*8422 candidats sur 12712 portent les champs bruts (66%).*
...
- `5c556c16ea8b` — 2457 candidats
  - AVEC connectivite (968) : resistance **41.6%**
  - SANS connectivite (1489) : resistance **22.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 2457 candidats
  ...
  - SANS connectivite (1489) : T0=15.78 T1=0.00 T2=2.67 — pondere **5.35**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 2280 candidats
