...
genere 2026-08-31 13:17 UTC — 252864 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 169520 systemes
...
- moteur actif `0caa9267db60` (209122 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 124634 | 61979 | 8444 | 4174 | 12585 | 9838 | 13156 | 12825 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 122115 | 28500 | 51543 | 54 | 16900 | 6314 | 56 | 18738 | 15.3% |
...
- candidats SANS connectivite : 19048, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13430 systemes avec CONNECTED sur 104203 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*27710 candidats sur 32000 portent les champs bruts (87%).*

- `5c556c16ea8b` — 21745 candidats
  - AVEC connectivite (8824) : resistance **41.0%**
  - SANS connectivite (12921) : resistance **21.4%**
...
- `5c556c16ea8b` — 21745 candidats
  ...
  - SANS connectivite (12921) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 101702 systemes
  - sans CONNECTED : 0.0% sur 22932 systemes
