...
genere 2026-08-28 16:43 UTC — 149708 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 66364 systemes
...
- moteur actif `0caa9267db60` (105966 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 72519 | 36009 | 4958 | 2475 | 7273 | 5781 | 7671 | 7427 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 71074 | 16524 | 30035 | 33 | 9807 | 3667 | 31 | 10974 | 15.4% |
...
- candidats SANS connectivite : 11284, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7945 systemes avec CONNECTED sur 61656 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*14548 candidats sur 18838 portent les champs bruts (77%).*

- `5c556c16ea8b` — 8583 candidats
  - AVEC connectivite (3426) : resistance **41.1%**
  - SANS connectivite (5157) : resistance **21.8%**
...
- `5c556c16ea8b` — 8583 candidats
  ...
  - SANS connectivite (5157) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.36**
...
- TROP-CHER : 7986 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7945 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 59155 systemes
  - sans CONNECTED : 0.0% sur 13364 systemes
