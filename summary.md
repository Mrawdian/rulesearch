...
genere 2026-08-27 13:46 UTC — 99962 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 18378 systemes
- `5c556c16ea8b` : 16618 systemes
...
- moteur actif `0caa9267db60` (56220 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 47409 | 23631 | 3255 | 1623 | 4705 | 3741 | 5007 | 4834 | 10.2% |
...
- candidats AVEC connectivite : 4961, dont T2 : 100%
- candidats SANS connectivite : 7398, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5281 systemes avec CONNECTED sur 41253 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*8069 candidats sur 12359 portent les champs bruts (65%).*
...
- `ab89a63b01ef` — 2280 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 2104 candidats
  - AVEC connectivite (833) : resistance **41.8%**
...
- `ab89a63b01ef` — 2280 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 2104 candidats
  - AVEC connectivite (833) : T0=13.04 T1=0.00 T2=3.04 — pondere **6.09**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 38752 systemes
  - sans CONNECTED : 0.0% sur 8657 systemes
