...
genere 2026-08-26 22:04 UTC — 66491 systemes evalues
...
- moteur actif `0caa9267db60` (22749 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 30518 | 15160 | 2086 | 1026 | 3050 | 2427 | 3251 | 3133 | 10.3% |
...
- candidats AVEC connectivite : 3260, dont T2 : 100%
- candidats SANS connectivite : 4898, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3525 systemes avec CONNECTED sur 27446 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3868 candidats sur 8158 portent les champs bruts (47%).*
...
- `23303c299f39` — 225 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 191 candidats
  - AVEC connectivite (80) : resistance **43.2%**
...
- `ab89a63b01ef` — 191 candidats
  - AVEC connectivite (80) : T0=13.24 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (111) : T0=15.84 T1=0.00 T2=2.79 — pondere **5.59**
  - test de permutation : **p = 0.3208** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
- TROP-CHER : 3548 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3525 avec CONNECTED, 23 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24945 systemes
  - sans CONNECTED : 0.0% sur 5573 systemes
