...
genere 2026-08-26 12:59 UTC — 45348 systemes evalues
...
- `06fe04a859f1` : 165 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (1606 systemes) : `06fe04a859f1`, `e40600351a72`
...
**7631 enregistrements (17%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 19830 | 9902 | 1292 | 685 | 1990 | 1566 | 2130 | 2019 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 19403 | 4553 | 8192 | 13 | 2670 | 1001 | 7 | 2967 | 15.3% |
...
- candidats SANS connectivite : 3277, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2404 systemes avec CONNECTED sur 18691 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1133 candidats sur 5423 portent les champs bruts (21%).*
...
- TROP-CHER : 2421 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2404 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 16190 systemes
  - sans CONNECTED : 0.0% sur 3640 systemes
