...
genere 2026-08-28 04:21 UTC — 128285 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 44941 systemes
...
- moteur actif `0caa9267db60` (84543 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 61708 | 30700 | 4258 | 2085 | 6151 | 4906 | 6478 | 6337 | 10.3% |
...
- candidats AVEC connectivite : 6464, dont T2 : 100%
- candidats SANS connectivite : 9579, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6752 systemes avec CONNECTED sur 52855 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11753 candidats sur 16043 portent les champs bruts (73%).*

- `5c556c16ea8b` — 5788 candidats
  - AVEC connectivite (2336) : resistance **41.7%**
...
- `5c556c16ea8b` — 5788 candidats
  - AVEC connectivite (2336) : T0=12.99 T1=0.00 T2=3.04 — pondere **6.07**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 50354 systemes
  - sans CONNECTED : 0.0% sur 11354 systemes
