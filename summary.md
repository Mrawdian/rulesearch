...
genere 2026-08-26 12:54 UTC — 45112 systemes evalues
...
| connect | 4 | 3 | 19711 | 9834 | 1284 | 683 | 1977 | 1560 | 2120 | 2009 | 10.2% |
...
- candidats AVEC connectivite : 2136, dont T2 : 100%
- candidats SANS connectivite : 3262, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2394 systemes avec CONNECTED sur 18595 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1108 candidats sur 5398 portent les champs bruts (21%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `e40600351a72` — 187 candidats
  - AVEC connectivite (85) : resistance **39.8%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e40600351a72` — 187 candidats
  - AVEC connectivite (85) : T0=12.91 T1=0.00 T2=2.88 — pondere **5.76**
...
- TROP-CHER : 2411 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2394 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 16094 systemes
  - sans CONNECTED : 0.0% sur 3617 systemes
