...
genere 2026-08-26 14:20 UTC — 48643 systemes evalues
...
- moteur actif `0caa9267db60` (4901 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21486 | 10717 | 1431 | 741 | 2124 | 1705 | 2301 | 2196 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 21042 | 4910 | 8873 | 13 | 2915 | 1086 | 7 | 3238 | 15.4% |
...
- candidats AVEC connectivite : 2323, dont T2 : 100%
- candidats SANS connectivite : 3548, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2575 systemes avec CONNECTED sur 20065 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1581 candidats sur 5871 portent les champs bruts (27%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 466 candidats
  - AVEC connectivite (185) : resistance **40.4%**
  - SANS connectivite (281) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 466 candidats
  - AVEC connectivite (185) : T0=13.39 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (281) : T0=16.11 T1=0.00 T2=2.68 — pondere **5.35**
...
- TROP-CHER : 2592 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2575 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17564 systemes
  - sans CONNECTED : 0.0% sur 3922 systemes
