...
| ref | 4 | 3 | 17012 | 4005 | 7193 | 12 | 2331 | 860 | 7 | 2604 | 15.3% |
...
- candidats SANS connectivite : 2914, dont T2 : 100%
...
*498 candidats sur 4788 portent les champs bruts (10%).*
...
- `e3baecf8377b` — 234 candidats
  - AVEC connectivite (91) : resistance **43.1%**
  - SANS connectivite (143) : resistance **21.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 234 candidats
  ...
  - SANS connectivite (143) : T0=16.13 T1=0.00 T2=2.69 — pondere **5.38**
...
**2 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0365).
