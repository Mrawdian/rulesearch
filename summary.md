...
genere 2026-08-28 07:29 UTC — 133921 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 50577 systemes
...
- moteur actif `0caa9267db60` (90179 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 64556 | 32063 | 4431 | 2193 | 6476 | 5145 | 6783 | 6631 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 63250 | 14636 | 26772 | 29 | 8805 | 3271 | 28 | 9707 | 15.3% |
...
- candidats SANS connectivite : 10017, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7057 systemes avec CONNECTED sur 55154 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12485 candidats sur 16775 portent les champs bruts (74%).*

- `5c556c16ea8b` — 6520 candidats
  - AVEC connectivite (2630) : resistance **41.4%**
  - SANS connectivite (3890) : resistance **21.9%**
...
- `5c556c16ea8b` — 6520 candidats
  ...
  - SANS connectivite (3890) : T0=15.84 T1=0.00 T2=2.68 — pondere **5.36**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 52653 systemes
  - sans CONNECTED : 0.0% sur 11903 systemes
