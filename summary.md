...
genere 2026-09-04 04:30 UTC — 355901 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 272557 systemes
...
- moteur actif `0caa9267db60` (312159 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 176638 | 87787 | 12012 | 5908 | 17975 | 13899 | 18730 | 18079 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 173148 | 40233 | 73118 | 70 | 24057 | 8972 | 68 | 26616 | 15.4% |
...
- candidats AVEC connectivite : 18206, dont T2 : 100%
- candidats SANS connectivite : 26926, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19004 systemes avec CONNECTED sur 146640 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*40842 candidats sur 45132 portent les champs bruts (90%).*

- `5c556c16ea8b` — 34877 candidats
  - AVEC connectivite (14078) : resistance **41.0%**
  - SANS connectivite (20799) : resistance **21.3%**
...
- `5c556c16ea8b` — 34877 candidats
  - AVEC connectivite (14078) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (20799) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 144139 systemes
  - sans CONNECTED : 0.0% sur 32499 systemes
