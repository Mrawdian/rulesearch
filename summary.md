...
genere 2026-09-08 04:07 UTC — 449903 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 366559 systemes
...
- moteur actif `0caa9267db60` (406161 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 224116 | 111300 | 15265 | 7482 | 22678 | 17564 | 23883 | 23088 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 219672 | 51177 | 92584 | 87 | 30623 | 11343 | 79 | 33761 | 15.4% |
...
- candidats AVEC connectivite : 23215, dont T2 : 100%
- candidats SANS connectivite : 34071, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **24157 systemes avec CONNECTED sur 185504 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*52996 candidats sur 57286 portent les champs bruts (93%).*

- `5c556c16ea8b` — 47031 candidats
  - AVEC connectivite (19087) : resistance **41.2%**
  - SANS connectivite (27944) : resistance **21.3%**
...
- `5c556c16ea8b` — 47031 candidats
  - AVEC connectivite (19087) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (27944) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 24246 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 24157 avec CONNECTED, 89 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 183003 systemes
  - sans CONNECTED : 0.0% sur 41113 systemes
