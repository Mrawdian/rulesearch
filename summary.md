...
genere 2026-08-29 20:12 UTC — 194426 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 111082 systemes
...
- moteur actif `0caa9267db60` (150684 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 95113 | 47242 | 6470 | 3204 | 9591 | 7573 | 10041 | 9779 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 93198 | 21729 | 39341 | 43 | 12906 | 4794 | 37 | 14342 | 15.4% |
...
- candidats SANS connectivite : 14652, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10315 systemes avec CONNECTED sur 80077 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*20268 candidats sur 24558 portent les champs bruts (83%).*

- `5c556c16ea8b` — 14303 candidats
  - AVEC connectivite (5778) : resistance **41.2%**
  - SANS connectivite (8525) : resistance **21.5%**
...
- `5c556c16ea8b` — 14303 candidats
  ...
  - SANS connectivite (8525) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 10362 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10315 avec CONNECTED, 47 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 77576 systemes
  - sans CONNECTED : 0.0% sur 17537 systemes
