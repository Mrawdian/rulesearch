...
genere 2026-09-04 17:33 UTC — 369935 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 286591 systemes
...
- moteur actif `0caa9267db60` (326193 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 183721 | 91305 | 12496 | 6143 | 18687 | 14462 | 19458 | 18811 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 180099 | 41867 | 76084 | 75 | 25022 | 9330 | 70 | 27637 | 15.3% |
...
- candidats AVEC connectivite : 18938, dont T2 : 100%
- candidats SANS connectivite : 27947, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19732 systemes avec CONNECTED sur 152383 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*42595 candidats sur 46885 portent les champs bruts (91%).*

- `5c556c16ea8b` — 36630 candidats
  - AVEC connectivite (14810) : resistance **41.0%**
  - SANS connectivite (21820) : resistance **21.3%**
...
- `5c556c16ea8b` — 36630 candidats
  - AVEC connectivite (14810) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (21820) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 19812 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19732 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 149882 systemes
  - sans CONNECTED : 0.0% sur 33839 systemes
