...
genere 2026-08-26 14:04 UTC — 48065 systemes evalues
...
- moteur actif `0caa9267db60` (4323 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21201 | 10578 | 1408 | 730 | 2101 | 1685 | 2266 | 2166 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20749 | 4840 | 8760 | 13 | 2877 | 1074 | 7 | 3178 | 15.3% |
...
- candidats SANS connectivite : 3488, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2540 systemes avec CONNECTED sur 19819 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1491 candidats sur 5781 portent les champs bruts (26%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 376 candidats
  - AVEC connectivite (155) : resistance **39.3%**
  - SANS connectivite (221) : resistance **21.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 376 candidats
  ...
  - SANS connectivite (221) : T0=16.09 T1=0.00 T2=2.71 — pondere **5.41**
...
- TROP-CHER : 2557 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2540 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17318 systemes
  - sans CONNECTED : 0.0% sur 3883 systemes
