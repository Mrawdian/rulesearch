...
genere 2026-08-28 15:43 UTC — 148035 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 64691 systemes
...
- moteur actif `0caa9267db60` (104293 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 71682 | 35587 | 4900 | 2441 | 7193 | 5709 | 7576 | 7360 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 70238 | 16308 | 29686 | 32 | 9716 | 3621 | 31 | 10841 | 15.4% |
...
- candidats AVEC connectivite : 7487, dont T2 : 100%
- candidats SANS connectivite : 11151, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7850 systemes avec CONNECTED sur 60976 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*14348 candidats sur 18638 portent les champs bruts (77%).*

- `5c556c16ea8b` — 8383 candidats
  - AVEC connectivite (3359) : resistance **41.2%**
  - SANS connectivite (5024) : resistance **21.8%**
...
- `5c556c16ea8b` — 8383 candidats
  - AVEC connectivite (3359) : T0=13.02 T1=0.00 T2=3.00 — pondere **6.01**
  - SANS connectivite (5024) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.37**
...
- TROP-CHER : 7891 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7850 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 58475 systemes
  - sans CONNECTED : 0.0% sur 13207 systemes
