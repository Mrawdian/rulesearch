...
genere 2026-08-26 22:54 UTC — 68239 systemes evalues
...
- moteur actif `0caa9267db60` (24497 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 31399 | 15590 | 2151 | 1055 | 3124 | 2503 | 3353 | 3223 | 10.3% |
...
- candidats AVEC connectivite : 3350, dont T2 : 100%
- candidats SANS connectivite : 5013, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3627 systemes avec CONNECTED sur 28169 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4073 candidats sur 8363 portent les champs bruts (49%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 396 candidats
  - AVEC connectivite (170) : resistance **42.7%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 396 candidats
  - AVEC connectivite (170) : T0=12.90 T1=0.00 T2=3.08 — pondere **6.16**
...
- TROP-CHER : 3651 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 3627 avec CONNECTED, 24 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 25668 systemes
  - sans CONNECTED : 0.0% sur 5731 systemes
