...
genere 2026-08-26 15:54 UTC — 52364 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 7181 systemes
...
- moteur actif `0caa9267db60` (8622 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23371 | 11644 | 1583 | 798 | 2332 | 1853 | 2497 | 2369 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 22878 | 5292 | 9664 | 14 | 3203 | 1163 | 10 | 3532 | 15.4% |
...
- candidats AVEC connectivite : 2496, dont T2 : 100%
- candidats SANS connectivite : 3842, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2771 systemes avec CONNECTED sur 21577 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2048 candidats sur 6338 portent les champs bruts (32%).*
...
- `06fe04a859f1` — 933 candidats
  - AVEC connectivite (358) : resistance **41.5%**
  - SANS connectivite (575) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 933 candidats
  - AVEC connectivite (358) : T0=13.23 T1=0.00 T2=3.04 — pondere **6.09**
  - SANS connectivite (575) : T0=16.03 T1=0.00 T2=2.65 — pondere **5.29**
...
- TROP-CHER : 2791 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2771 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19076 systemes
  - sans CONNECTED : 0.0% sur 4295 systemes
