...
genere 2026-08-26 13:40 UTC — 47249 systemes evalues
...
- moteur actif `0caa9267db60` (3507 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20782 | 10373 | 1373 | 720 | 2066 | 1653 | 2211 | 2128 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20352 | 4758 | 8603 | 13 | 2818 | 1049 | 7 | 3104 | 15.3% |
...
- candidats AVEC connectivite : 2255, dont T2 : 100%
- candidats SANS connectivite : 3414, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2485 systemes avec CONNECTED sur 19472 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1379 candidats sur 5669 portent les champs bruts (24%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 264 candidats
  - AVEC connectivite (117) : resistance **38.6%**
  - SANS connectivite (147) : resistance **21.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 264 candidats
  - AVEC connectivite (117) : T0=13.36 T1=0.00 T2=2.79 — pondere **5.57**
  - SANS connectivite (147) : T0=16.24 T1=0.00 T2=2.79 — pondere **5.58**
...
- TROP-CHER : 2502 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2485 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 16971 systemes
  - sans CONNECTED : 0.0% sur 3811 systemes
