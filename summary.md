...
| connect | 4 | 3 | 7697 | 3873 | 506 | 267 | 736 | 615 | 809 | 804 | 10.4% |
...
- candidats AVEC connectivite : 807, dont T2 : 100%
...
- **809 systemes avec CONNECTED sur 6371 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 822 candidats
  - AVEC connectivite (328) : T0=13.40 T1=0.00 T2=2.86 — pondere **5.72**
...
- TROP-CHER : 812 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 809 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 6314 systemes
  - sans CONNECTED : 0.0% sur 1383 systemes
