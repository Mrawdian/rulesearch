...
genere 2026-09-03 16:28 UTC — 342758 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 259414 systemes
...
- moteur actif `0caa9267db60` (299016 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 170010 | 84505 | 11532 | 5692 | 17293 | 13424 | 18022 | 17378 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 166633 | 38758 | 70426 | 67 | 23127 | 8618 | 66 | 25559 | 15.3% |
...
- candidats AVEC connectivite : 17505, dont T2 : 100%
...
- **18296 systemes avec CONNECTED sur 141213 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39084 candidats sur 43374 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33119 candidats
  - AVEC connectivite (13377) : resistance **41.0%**
...
- `5c556c16ea8b` — 33119 candidats
  - AVEC connectivite (13377) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 18372 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18296 avec CONNECTED, 76 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 138712 systemes
  - sans CONNECTED : 0.0% sur 31298 systemes
