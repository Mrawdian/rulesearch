...
genere 2026-09-01 03:56 UTC — 271777 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 188433 systemes
...
- moteur actif `0caa9267db60` (228035 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 134186 | 66673 | 9074 | 4500 | 13614 | 10621 | 14176 | 13787 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 131476 | 30643 | 55564 | 57 | 18227 | 6786 | 57 | 20132 | 15.3% |
...
- candidats AVEC connectivite : 13914, dont T2 : 100%
- candidats SANS connectivite : 20442, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14450 systemes avec CONNECTED sur 111970 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*30066 candidats sur 34356 portent les champs bruts (88%).*

- `5c556c16ea8b` — 24101 candidats
  - AVEC connectivite (9786) : resistance **41.0%**
  - SANS connectivite (14315) : resistance **21.3%**
...
- `5c556c16ea8b` — 24101 candidats
  - AVEC connectivite (9786) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (14315) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 14517 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14450 avec CONNECTED, 67 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 109469 systemes
