...
genere 2026-08-27 08:48 UTC — 89973 systemes evalues
...
- moteur actif `0caa9267db60` (46231 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 42361 | 21096 | 2912 | 1430 | 4230 | 3323 | 4463 | 4361 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 41497 | 9563 | 17640 | 24 | 5743 | 2161 | 22 | 6344 | 15.3% |
...
- candidats AVEC connectivite : 4488, dont T2 : 100%
- candidats SANS connectivite : 6654, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4737 systemes avec CONNECTED sur 37125 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6852 candidats sur 11142 portent les champs bruts (61%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 887 candidats
  - AVEC connectivite (360) : resistance **40.9%**
  - SANS connectivite (527) : resistance **21.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 887 candidats
  - AVEC connectivite (360) : T0=13.10 T1=0.00 T2=2.98 — pondere **5.97**
  - SANS connectivite (527) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.29**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 34624 systemes
  - sans CONNECTED : 0.0% sur 7737 systemes
