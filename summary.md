...
- moteur actif `0caa9267db60` (8287 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23207 | 11564 | 1572 | 787 | 2313 | 1844 | 2483 | 2353 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 22707 | 5253 | 9589 | 14 | 3183 | 1157 | 10 | 3501 | 15.4% |
...
- candidats AVEC connectivite : 2480, dont T2 : 100%
- candidats SANS connectivite : 3811, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2757 systemes avec CONNECTED sur 21444 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2001 candidats sur 6291 portent les champs bruts (32%).*
...
- `06fe04a859f1` — 886 candidats
  - AVEC connectivite (342) : resistance **41.3%**
  - SANS connectivite (544) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 886 candidats
  - AVEC connectivite (342) : T0=13.23 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (544) : T0=16.01 T1=0.00 T2=2.63 — pondere **5.26**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e3baecf8377b` — 657 candidats
...
- TROP-CHER : 2777 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2757 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18943 systemes
  - sans CONNECTED : 0.0% sur 4264 systemes
