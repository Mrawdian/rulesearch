...
genere 2026-08-26 18:40 UTC — 58905 systemes evalues
...
- moteur actif `0caa9267db60` (15163 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 26672 | 13298 | 1820 | 901 | 2645 | 2107 | 2841 | 2730 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 26118 | 6009 | 11071 | 15 | 3642 | 1342 | 10 | 4029 | 15.4% |
...
- candidats AVEC connectivite : 2857, dont T2 : 100%
- candidats SANS connectivite : 4339, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3115 systemes avec CONNECTED sur 24317 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2906 candidats sur 7196 portent les champs bruts (40%).*
...
- `b71bb0907fb5` — 53 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 37 candidats
  - AVEC connectivite (13) : resistance **44.3%**
  - SANS connectivite (24) : resistance **14.1%**
...
- `62448a55927e` — 37 candidats
  - AVEC connectivite (13) : T0=13.15 T1=0.00 T2=3.31 — pondere **6.62**
  - SANS connectivite (24) : T0=15.96 T1=0.00 T2=2.12 — pondere **4.25**
...
- TROP-CHER : 3135 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3115 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 21816 systemes
  - sans CONNECTED : 0.0% sur 4856 systemes
