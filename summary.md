...
genere 2026-08-28 03:38 UTC — 127074 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 43730 systemes
...
- moteur actif `0caa9267db60` (83332 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 61096 | 30388 | 4226 | 2063 | 6085 | 4860 | 6404 | 6283 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 59863 | 13855 | 25359 | 28 | 8331 | 3093 | 26 | 9169 | 15.3% |
...
- candidats AVEC connectivite : 6410, dont T2 : 100%
- candidats SANS connectivite : 9479, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6678 systemes avec CONNECTED sur 52352 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11599 candidats sur 15889 portent les champs bruts (73%).*

- `5c556c16ea8b` — 5634 candidats
  - AVEC connectivite (2282) : resistance **41.9%**
  - SANS connectivite (3352) : resistance **22.1%**
...
- `5c556c16ea8b` — 5634 candidats
  - AVEC connectivite (2282) : T0=12.98 T1=0.00 T2=3.04 — pondere **6.09**
  - SANS connectivite (3352) : T0=15.86 T1=0.00 T2=2.70 — pondere **5.39**
...
- TROP-CHER : 6714 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6678 avec CONNECTED, 36 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 49851 systemes
  - sans CONNECTED : 0.0% sur 11245 systemes
