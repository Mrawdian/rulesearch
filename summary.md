...
genere 2026-09-01 16:56 UTC — 287924 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 204580 systemes
...
- moteur actif `0caa9267db60` (244182 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 142333 | 70710 | 9656 | 4760 | 14450 | 11229 | 15045 | 14643 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 139476 | 32440 | 58987 | 59 | 19338 | 7218 | 63 | 21360 | 15.3% |
...
- candidats SANS connectivite : 21670, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15319 systemes avec CONNECTED sur 118645 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*32150 candidats sur 36440 portent les champs bruts (88%).*

- `5c556c16ea8b` — 26185 candidats
  - AVEC connectivite (10642) : resistance **41.0%**
  - SANS connectivite (15543) : resistance **21.3%**
...
- `5c556c16ea8b` — 26185 candidats
  ...
  - SANS connectivite (15543) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 15392 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15319 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 116144 systemes
  - sans CONNECTED : 0.0% sur 26189 systemes
