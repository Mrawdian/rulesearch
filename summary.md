...
genere 2026-09-09 09:34 UTC — 476296 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 392952 systemes
...
- moteur actif `0caa9267db60` (432554 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 237458 | 117902 | 16193 | 7956 | 24023 | 18604 | 25290 | 24475 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 232723 | 54241 | 98033 | 92 | 32417 | 12018 | 84 | 35819 | 15.4% |
...
- candidats AVEC connectivite : 24602, dont T2 : 100%
- candidats SANS connectivite : 36129, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25564 systemes avec CONNECTED sur 196385 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*56441 candidats sur 60731 portent les champs bruts (93%).*

- `5c556c16ea8b` — 50476 candidats
  - AVEC connectivite (20474) : resistance **41.2%**
  - SANS connectivite (30002) : resistance **21.3%**
...
- `5c556c16ea8b` — 50476 candidats
  - AVEC connectivite (20474) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (30002) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
## cout
- temps total 148.5 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 25658 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25564 avec CONNECTED, 94 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 193884 systemes
  - sans CONNECTED : 0.0% sur 43574 systemes
