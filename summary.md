...
genere 2026-08-26 14:26 UTC — 48924 systemes evalues
...
- moteur actif `0caa9267db60` (5182 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21636 | 10794 | 1440 | 745 | 2142 | 1720 | 2314 | 2207 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 21173 | 4927 | 8939 | 13 | 2934 | 1093 | 8 | 3259 | 15.4% |
...
- candidats AVEC connectivite : 2334, dont T2 : 100%
- candidats SANS connectivite : 3569, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2588 systemes avec CONNECTED sur 20183 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1613 candidats sur 5903 portent les champs bruts (27%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 498 candidats
  - AVEC connectivite (196) : resistance **40.2%**
  - SANS connectivite (302) : resistance **20.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 498 candidats
  - AVEC connectivite (196) : T0=13.41 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (302) : T0=16.12 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 2606 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2588 avec CONNECTED, 18 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17682 systemes
  - sans CONNECTED : 0.0% sur 3954 systemes
