...
genere 2026-09-03 23:55 UTC — 351052 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 267708 systemes
...
- moteur actif `0caa9267db60` (307310 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 174203 | 86605 | 11837 | 5830 | 17737 | 13713 | 18447 | 17817 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 170734 | 39684 | 72142 | 70 | 23716 | 8831 | 67 | 26210 | 15.4% |
...
- candidats AVEC connectivite : 17944, dont T2 : 100%
- candidats SANS connectivite : 26520, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18721 systemes avec CONNECTED sur 144643 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*40174 candidats sur 44464 portent les champs bruts (90%).*

- `5c556c16ea8b` — 34209 candidats
  - AVEC connectivite (13816) : resistance **41.0%**
  - SANS connectivite (20393) : resistance **21.2%**
...
- `5c556c16ea8b` — 34209 candidats
  - AVEC connectivite (13816) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (20393) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 18798 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18721 avec CONNECTED, 77 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 142142 systemes
  - sans CONNECTED : 0.0% sur 32061 systemes
