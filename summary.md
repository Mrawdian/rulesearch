...
| ref | 4 | 3 | 16837 | 3967 | 7130 | 11 | 2299 | 853 | 7 | 2570 | 15.3% |
...
- candidats SANS connectivite : 2880, dont T2 : 100%
...
*450 candidats sur 4740 portent les champs bruts (9%).*
...
- `e3baecf8377b` — 186 candidats
  - AVEC connectivite (77) : resistance **42.6%**
  - SANS connectivite (109) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 186 candidats
  ...
  - SANS connectivite (109) : T0=15.90 T1=0.00 T2=2.60 — pondere **5.19**
...
**2 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0315).
