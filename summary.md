...
genere 2026-08-26 23:54 UTC — 70459 systemes evalues
...
- moteur actif `0caa9267db60` (26717 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 32520 | 16168 | 2228 | 1099 | 3242 | 2586 | 3469 | 3313 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 31824 | 7341 | 13518 | 18 | 4410 | 1659 | 15 | 4863 | 15.3% |
...
- candidats AVEC connectivite : 3440, dont T2 : 100%
- candidats SANS connectivite : 5173, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3743 systemes avec CONNECTED sur 29087 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4323 candidats sur 8613 portent les champs bruts (50%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 646 candidats
  - AVEC connectivite (260) : resistance **42.1%**
  - SANS connectivite (386) : resistance **21.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 646 candidats
  - AVEC connectivite (260) : T0=13.09 T1=0.00 T2=3.13 — pondere **6.26**
  - SANS connectivite (386) : T0=15.90 T1=0.00 T2=2.63 — pondere **5.27**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e3baecf8377b` — 657 candidats
...
- TROP-CHER : 3768 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3743 avec CONNECTED, 25 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 26586 systemes
  - sans CONNECTED : 0.0% sur 5934 systemes
