...
| connect | 4 | 3 | 5396 | 2707 | 349 | 193 | 522 | 446 | 563 | 557 | 10.3% |
...
- candidats AVEC connectivite : 560, dont T2 : 100%
...
- **563 systemes avec CONNECTED sur 4462 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 234 candidats
  - AVEC connectivite (81) : T0=13.26 T1=0.00 T2=2.75 — pondere **5.51**
  - SANS connectivite (153) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
  - test de permutation : **p = 0.6272** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 4405 systemes
  - sans CONNECTED : 0.0% sur 991 systemes
