...
genere 2026-09-05 09:19 UTC — 386180 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 302836 systemes
...
- moteur actif `0caa9267db60` (342438 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 191929 | 95317 | 13071 | 6382 | 19515 | 15122 | 20347 | 19724 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 188136 | 43785 | 79428 | 77 | 26173 | 9740 | 70 | 28849 | 15.3% |
...
- candidats AVEC connectivite : 19851, dont T2 : 100%
- candidats SANS connectivite : 29159, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20621 systemes avec CONNECTED sur 159076 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*44720 candidats sur 49010 portent les champs bruts (91%).*

- `5c556c16ea8b` — 38755 candidats
  - AVEC connectivite (15723) : resistance **41.1%**
  - SANS connectivite (23032) : resistance **21.3%**
...
- `5c556c16ea8b` — 38755 candidats
  - AVEC connectivite (15723) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (23032) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 20701 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 20621 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 156575 systemes
  - sans CONNECTED : 0.0% sur 35354 systemes
