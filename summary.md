...
genere 2026-08-29 07:57 UTC — 175679 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 92335 systemes
...
- moteur actif `0caa9267db60` (131937 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 85650 | 42639 | 5825 | 2893 | 8587 | 6795 | 8985 | 8837 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 83914 | 19588 | 35479 | 39 | 11569 | 4276 | 35 | 12922 | 15.4% |
...
- candidats AVEC connectivite : 8964, dont T2 : 100%
- candidats SANS connectivite : 13232, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9259 systemes avec CONNECTED sur 72423 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*17906 candidats sur 22196 portent les champs bruts (81%).*

- `5c556c16ea8b` — 11941 candidats
  - AVEC connectivite (4836) : resistance **41.1%**
  - SANS connectivite (7105) : resistance **21.6%**
...
- `5c556c16ea8b` — 11941 candidats
  - AVEC connectivite (4836) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (7105) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.33**
...
- TROP-CHER : 9304 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 9259 avec CONNECTED, 45 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 69922 systemes
  - sans CONNECTED : 0.0% sur 15728 systemes
