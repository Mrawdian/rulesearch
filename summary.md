...
**7466 enregistrements (62%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 6010 | 3033 | 387 | 216 | 576 | 481 | 623 | 624 | 10.4% |
| ref | 4 | 3 | 5876 | 1430 | 2442 | 1 | 786 | 289 | 2 | 926 | 15.8% |
...
- candidats AVEC connectivite : 627, dont T2 : 100%
- candidats SANS connectivite : 930, dont T2 : 100%
...
- **623 systemes avec CONNECTED sur 4985 (12.5%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 392 candidats
  - AVEC connectivite (148) : T0=13.16 T1=0.00 T2=2.95 — pondere **5.89**
  - SANS connectivite (244) : T0=16.00 T1=0.00 T2=2.63 — pondere **5.26**
...
- TROP-CHER : 625 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 623 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.6% sur 4928 systemes
  - sans CONNECTED : 0.0% sur 1082 systemes
