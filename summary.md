...
| connect | 4 | 3 | 6842 | 3444 | 448 | 240 | 651 | 553 | 717 | 711 | 10.4% |
| ref | 4 | 3 | 6678 | 1615 | 2771 | 1 | 898 | 332 | 2 | 1059 | 15.9% |
...
- candidats SANS connectivite : 1063, dont T2 : 100%
...
- **717 systemes avec CONNECTED sur 5670 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 612 candidats
  - AVEC connectivite (235) : T0=13.23 T1=0.00 T2=2.94 — pondere **5.87**
  - SANS connectivite (377) : T0=15.74 T1=0.00 T2=2.64 — pondere **5.27**
...
- TROP-CHER : 719 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 717 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 5613 systemes
  - sans CONNECTED : 0.0% sur 1229 systemes
