...
- `89c65c03c4ad` — 246 candidats
  - AVEC connectivite (83) : T0=13.25 T1=0.00 T2=2.71 — pondere **5.42**
  - SANS connectivite (163) : T0=15.94 T1=0.00 T2=2.67 — pondere **5.34**
  - test de permutation : **p = 0.8541** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
