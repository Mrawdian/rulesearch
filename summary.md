...
genere 2026-08-28 18:00 UTC — 152078 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 68734 systemes
...
- moteur actif `0caa9267db60` (108336 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 73712 | 36612 | 5018 | 2521 | 7399 | 5874 | 7782 | 7566 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 72251 | 16781 | 30552 | 33 | 9974 | 3725 | 31 | 11152 | 15.4% |
...
- candidats AVEC connectivite : 7693, dont T2 : 100%
- candidats SANS connectivite : 11462, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8056 systemes avec CONNECTED sur 62631 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*14865 candidats sur 19155 portent les champs bruts (78%).*

- `5c556c16ea8b` — 8900 candidats
  - AVEC connectivite (3565) : resistance **41.0%**
  - SANS connectivite (5335) : resistance **21.7%**
...
- `5c556c16ea8b` — 8900 candidats
  - AVEC connectivite (3565) : T0=13.03 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (5335) : T0=15.89 T1=0.00 T2=2.68 — pondere **5.36**
...
- TROP-CHER : 8097 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8056 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 60130 systemes
  - sans CONNECTED : 0.0% sur 13582 systemes
