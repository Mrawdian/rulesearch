...
genere 2026-09-05 16:47 UTC — 393637 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 310293 systemes
...
- moteur actif `0caa9267db60` (349895 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 195693 | 97183 | 13316 | 6525 | 19900 | 15394 | 20767 | 20119 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 191829 | 44661 | 80945 | 78 | 26708 | 9912 | 71 | 29440 | 15.3% |
...
- candidats AVEC connectivite : 20246, dont T2 : 100%
- candidats SANS connectivite : 29750, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21041 systemes avec CONNECTED sur 162144 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*45706 candidats sur 49996 portent les champs bruts (91%).*

- `5c556c16ea8b` — 39741 candidats
  - AVEC connectivite (16118) : resistance **41.1%**
  - SANS connectivite (23623) : resistance **21.3%**
...
- `5c556c16ea8b` — 39741 candidats
  - AVEC connectivite (16118) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (23623) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 159643 systemes
  - sans CONNECTED : 0.0% sur 36050 systemes
