...
genere 2026-08-28 06:33 UTC — 132208 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 48864 systemes
...
- moteur actif `0caa9267db60` (88466 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 63687 | 31636 | 4378 | 2163 | 6375 | 5070 | 6694 | 6550 | 10.3% |
...
- candidats AVEC connectivite : 6677, dont T2 : 100%
- candidats SANS connectivite : 9876, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6968 systemes avec CONNECTED sur 54454 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12263 candidats sur 16553 portent les champs bruts (74%).*

- `5c556c16ea8b` — 6298 candidats
  - AVEC connectivite (2549) : resistance **41.5%**
...
- `5c556c16ea8b` — 6298 candidats
  - AVEC connectivite (2549) : T0=12.97 T1=0.00 T2=3.01 — pondere **6.02**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 51953 systemes
  - sans CONNECTED : 0.0% sur 11734 systemes
