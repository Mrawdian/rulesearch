...
| connect | 4 | 3 | 5905 | 2976 | 380 | 213 | 565 | 476 | 615 | 610 | 10.3% |
| ref | 4 | 3 | 5774 | 1404 | 2401 | 1 | 771 | 284 | 2 | 911 | 15.8% |
...
- candidats AVEC connectivite : 613, dont T2 : 100%
...
- **615 systemes avec CONNECTED sur 4898 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 363 candidats
  - AVEC connectivite (134) : T0=13.10 T1=0.00 T2=2.91 — pondere **5.82**
...
- TROP-CHER : 617 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 615 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 4841 systemes
  - sans CONNECTED : 0.0% sur 1064 systemes
