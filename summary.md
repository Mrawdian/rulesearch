...
genere 2026-08-26 16:24 UTC — 53608 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 8425 systemes
...
- moteur actif `0caa9267db60` (9866 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23999 | 11975 | 1635 | 813 | 2377 | 1895 | 2561 | 2441 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 23494 | 5439 | 9928 | 14 | 3289 | 1196 | 10 | 3618 | 15.4% |
...
- candidats AVEC connectivite : 2568, dont T2 : 100%
- candidats SANS connectivite : 3928, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2835 systemes avec CONNECTED sur 22109 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2206 candidats sur 6496 portent les champs bruts (34%).*
...
- `06fe04a859f1` — 1091 candidats
  - AVEC connectivite (430) : resistance **40.8%**
  - SANS connectivite (661) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1091 candidats
  - AVEC connectivite (430) : T0=13.15 T1=0.00 T2=3.01 — pondere **6.02**
  - SANS connectivite (661) : T0=15.96 T1=0.00 T2=2.64 — pondere **5.28**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19608 systemes
  - sans CONNECTED : 0.0% sur 4391 systemes
