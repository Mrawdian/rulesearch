...
genere 2026-09-01 09:15 UTC — 278516 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 195172 systemes
...
- moteur actif `0caa9267db60` (234774 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 137574 | 68388 | 9312 | 4595 | 13951 | 10861 | 14532 | 14155 | 10.3% |
...
- candidats AVEC connectivite : 14282, dont T2 : 100%
...
- **14806 systemes avec CONNECTED sur 114759 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*30925 candidats sur 35215 portent les champs bruts (88%).*

- `5c556c16ea8b` — 24960 candidats
  - AVEC connectivite (10154) : resistance **41.0%**
...
- `5c556c16ea8b` — 24960 candidats
  - AVEC connectivite (10154) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 14876 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14806 avec CONNECTED, 70 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 112258 systemes
  - sans CONNECTED : 0.0% sur 25316 systemes
