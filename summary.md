...
genere 2026-08-27 06:03 UTC — 84118 systemes evalues
...
- moteur actif `0caa9267db60` (40376 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 39406 | 19617 | 2707 | 1344 | 3925 | 3103 | 4163 | 4036 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 38597 | 8903 | 16427 | 22 | 5342 | 2009 | 21 | 5873 | 15.2% |
...
- candidats AVEC connectivite : 4163, dont T2 : 100%
- candidats SANS connectivite : 6183, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4437 systemes avec CONNECTED sur 34725 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6056 candidats sur 10346 portent les champs bruts (59%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 91 candidats
  - AVEC connectivite (35) : resistance **42.0%**
  - SANS connectivite (56) : resistance **22.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 91 candidats
  - AVEC connectivite (35) : T0=13.11 T1=0.00 T2=3.03 — pondere **6.06**
  - SANS connectivite (56) : T0=15.48 T1=0.00 T2=2.59 — pondere **5.18**
  - test de permutation : **p = 0.1809** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e80bc1b2b437` — 75 candidats
...
- TROP-CHER : 4468 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4437 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 32224 systemes
  - sans CONNECTED : 0.0% sur 7182 systemes
