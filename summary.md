...
genere 2026-09-04 15:52 UTC — 368246 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 284902 systemes
...
- moteur actif `0caa9267db60` (324504 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 182867 | 90891 | 12433 | 6109 | 18622 | 14404 | 19351 | 18714 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 179264 | 41667 | 75741 | 74 | 24901 | 9286 | 70 | 27511 | 15.3% |
...
- candidats AVEC connectivite : 18841, dont T2 : 100%
- candidats SANS connectivite : 27821, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19625 systemes avec CONNECTED sur 151662 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*42372 candidats sur 46662 portent les champs bruts (91%).*

- `5c556c16ea8b` — 36407 candidats
  - AVEC connectivite (14713) : resistance **41.0%**
  - SANS connectivite (21694) : resistance **21.2%**
...
- `5c556c16ea8b` — 36407 candidats
  - AVEC connectivite (14713) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (21694) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 19705 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19625 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 149161 systemes
  - sans CONNECTED : 0.0% sur 33706 systemes
