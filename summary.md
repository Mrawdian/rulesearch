...
genere 2026-08-26 03:52 UTC — 22098 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 13124 systemes
...
| connect | 4 | 3 | 11102 | 5575 | 732 | 385 | 1069 | 893 | 1193 | 1114 | 10.0% |
| ref | 4 | 3 | 10872 | 2590 | 4589 | 6 | 1462 | 556 | 4 | 1665 | 15.3% |
...
- candidats AVEC connectivite : 1117, dont T2 : 100%
- candidats SANS connectivite : 1669, dont T2 : 100%
...
- **1193 systemes avec CONNECTED sur 9149 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1621 candidats
  - AVEC connectivite (638) : T0=13.35 T1=0.00 T2=2.85 — pondere **5.71**
  - SANS connectivite (983) : T0=15.82 T1=0.00 T2=2.67 — pondere **5.34**
...
- TROP-CHER : 1197 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 1193 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 9092 systemes
  - sans CONNECTED : 0.0% sur 2010 systemes
