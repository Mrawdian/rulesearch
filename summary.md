...
genere 2026-08-31 12:51 UTC — 252228 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 168884 systemes
...
- moteur actif `0caa9267db60` (208486 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 124320 | 61820 | 8433 | 4163 | 12533 | 9810 | 13133 | 12800 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 121793 | 28416 | 51413 | 54 | 16853 | 6302 | 56 | 18689 | 15.3% |
...
- candidats AVEC connectivite : 12927, dont T2 : 100%
- candidats SANS connectivite : 18999, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13407 systemes avec CONNECTED sur 103974 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*27636 candidats sur 31926 portent les champs bruts (87%).*

- `5c556c16ea8b` — 21671 candidats
  - AVEC connectivite (8799) : resistance **41.0%**
  - SANS connectivite (12872) : resistance **21.4%**
...
- `5c556c16ea8b` — 21671 candidats
  - AVEC connectivite (8799) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (12872) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 13473 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13407 avec CONNECTED, 66 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 101473 systemes
  - sans CONNECTED : 0.0% sur 22847 systemes
