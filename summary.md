...
genere 2026-08-26 04:09 UTC — 22750 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 13776 systemes
...
| connect | 4 | 3 | 11431 | 5737 | 749 | 395 | 1103 | 916 | 1232 | 1154 | 10.1% |
...
- candidats AVEC connectivite : 1157, dont T2 : 100%
...
- **1232 systemes avec CONNECTED sur 9420 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1719 candidats
  - AVEC connectivite (678) : T0=13.33 T1=0.00 T2=2.83 — pondere **5.66**
...
- TROP-CHER : 1236 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 1232 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 9363 systemes
  - sans CONNECTED : 0.0% sur 2068 systemes
