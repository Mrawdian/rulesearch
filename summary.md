...
genere 2026-08-30 09:24 UTC — 213914 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 130570 systemes
...
- moteur actif `0caa9267db60` (170172 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 104972 | 52113 | 7153 | 3501 | 10576 | 8356 | 11119 | 10788 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 102827 | 23983 | 43419 | 48 | 14204 | 5303 | 41 | 15821 | 15.4% |
...
- candidats AVEC connectivite : 10915, dont T2 : 100%
- candidats SANS connectivite : 16131, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11393 systemes avec CONNECTED sur 88128 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*22756 candidats sur 27046 portent les champs bruts (84%).*

- `5c556c16ea8b` — 16791 candidats
  - AVEC connectivite (6787) : resistance **41.2%**
  - SANS connectivite (10004) : resistance **21.5%**
...
- `5c556c16ea8b` — 16791 candidats
  - AVEC connectivite (6787) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (10004) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 11444 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11393 avec CONNECTED, 51 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 85627 systemes
  - sans CONNECTED : 0.0% sur 19345 systemes
