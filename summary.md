...
genere 2026-08-26 10:41 UTC — 39366 systemes evalues
...
- `e3baecf8377b` : 773 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
**8239 enregistrements (21%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 16797 | 8384 | 1081 | 581 | 1669 | 1337 | 1834 | 1699 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 16454 | 3880 | 6968 | 11 | 2243 | 828 | 7 | 2517 | 15.3% |
...
- candidats SANS connectivite : 2827, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2108 systemes avec CONNECTED sur 16229 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*363 candidats sur 4653 portent les champs bruts (8%).*
...
- `e3baecf8377b` — 99 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (43) : resistance **40.0%**
  - SANS connectivite (56) : resistance **19.5%**
...
- `e3baecf8377b` — 99 candidats
  - AVEC connectivite (43) : T0=13.37 T1=0.00 T2=2.95 — pondere **5.91**
  - SANS connectivite (56) : T0=15.75 T1=0.00 T2=2.46 — pondere **4.93**
...
- TROP-CHER : 2125 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2108 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.4% sur 13728 systemes
  - sans CONNECTED : 0.0% sur 3069 systemes
