...
genere 2026-08-29 07:39 UTC — 175222 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 91878 systemes
...
- moteur actif `0caa9267db60` (131480 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 85412 | 42505 | 5811 | 2886 | 8565 | 6783 | 8961 | 8815 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 83695 | 19537 | 35387 | 39 | 11542 | 4263 | 34 | 12887 | 15.4% |
...
- candidats AVEC connectivite : 8942, dont T2 : 100%
- candidats SANS connectivite : 13197, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9235 systemes avec CONNECTED sur 72223 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*17849 candidats sur 22139 portent les champs bruts (81%).*

- `5c556c16ea8b` — 11884 candidats
  - AVEC connectivite (4814) : resistance **41.2%**
  - SANS connectivite (7070) : resistance **21.6%**
...
- `5c556c16ea8b` — 11884 candidats
  - AVEC connectivite (4814) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (7070) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 9279 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 9235 avec CONNECTED, 44 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 69722 systemes
  - sans CONNECTED : 0.0% sur 15690 systemes
