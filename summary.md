...
genere 2026-09-05 14:40 UTC — 391529 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 308185 systemes
...
- moteur actif `0caa9267db60` (347787 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 194631 | 96658 | 13245 | 6483 | 19794 | 15318 | 20647 | 20011 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 190783 | 44413 | 80512 | 78 | 26559 | 9866 | 71 | 29270 | 15.3% |
...
- candidats AVEC connectivite : 20138, dont T2 : 100%
- candidats SANS connectivite : 29580, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20921 systemes avec CONNECTED sur 161269 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*45428 candidats sur 49718 portent les champs bruts (91%).*

- `5c556c16ea8b` — 39463 candidats
  - AVEC connectivite (16010) : resistance **41.0%**
  - SANS connectivite (23453) : resistance **21.3%**
...
- `5c556c16ea8b` — 39463 candidats
  - AVEC connectivite (16010) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.94**
  - SANS connectivite (23453) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 21002 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 20921 avec CONNECTED, 81 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 158768 systemes
  - sans CONNECTED : 0.0% sur 35863 systemes
