...
genere 2026-08-26 21:53 UTC — 66151 systemes evalues
...
- moteur actif `0caa9267db60` (22409 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 30338 | 15076 | 2074 | 1021 | 3035 | 2409 | 3227 | 3112 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 29698 | 6847 | 12622 | 16 | 4107 | 1531 | 13 | 4562 | 15.4% |
...
- candidats AVEC connectivite : 3239, dont T2 : 100%
- candidats SANS connectivite : 4872, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3501 systemes avec CONNECTED sur 27298 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3821 candidats sur 8111 portent les champs bruts (47%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 144 candidats
  - AVEC connectivite (59) : resistance **44.1%**
  - SANS connectivite (85) : resistance **23.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 144 candidats
  - AVEC connectivite (59) : T0=13.29 T1=0.00 T2=3.10 — pondere **6.20**
  - SANS connectivite (85) : T0=15.95 T1=0.00 T2=2.93 — pondere **5.86**
  - test de permutation : **p = 0.5562** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24797 systemes
  - sans CONNECTED : 0.0% sur 5541 systemes
