...
| connect | 4 | 3 | 18487 | 9231 | 1197 | 641 | 1845 | 1473 | 2006 | 1864 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 18102 | 4266 | 7624 | 13 | 2479 | 935 | 7 | 2778 | 15.3% |
...
- candidats AVEC connectivite : 1991, dont T2 : 100%
- candidats SANS connectivite : 3088, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2280 systemes avec CONNECTED sur 17592 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*789 candidats sur 5079 portent les champs bruts (16%).*
...
- `e3baecf8377b` — 525 candidats
  - AVEC connectivite (208) : resistance **42.3%**
  - SANS connectivite (317) : resistance **21.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 525 candidats
  - AVEC connectivite (208) : T0=13.06 T1=0.00 T2=3.09 — pondere **6.17**
  - SANS connectivite (317) : T0=16.05 T1=0.00 T2=2.66 — pondere **5.32**
...
**2 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0045).
...
- TROP-CHER : 2297 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 2280 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 15091 systemes
  - sans CONNECTED : 0.0% sur 3396 systemes
