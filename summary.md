...
genere 2026-09-04 16:50 UTC — 369213 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 285869 systemes
...
- moteur actif `0caa9267db60` (325471 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 183361 | 91142 | 12464 | 6125 | 18661 | 14432 | 19413 | 18771 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 179737 | 41787 | 75932 | 74 | 24967 | 9308 | 70 | 27585 | 15.3% |
...
- candidats AVEC connectivite : 18898, dont T2 : 100%
- candidats SANS connectivite : 27895, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19687 systemes avec CONNECTED sur 152084 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*42503 candidats sur 46793 portent les champs bruts (91%).*

- `5c556c16ea8b` — 36538 candidats
  - AVEC connectivite (14770) : resistance **41.0%**
  - SANS connectivite (21768) : resistance **21.2%**
...
- `5c556c16ea8b` — 36538 candidats
  - AVEC connectivite (14770) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.94**
  - SANS connectivite (21768) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 19767 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19687 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 149583 systemes
  - sans CONNECTED : 0.0% sur 33778 systemes
