...
genere 2026-09-02 15:49 UTC — 314858 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 231514 systemes
...
- moteur actif `0caa9267db60` (271116 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 155916 | 77459 | 10609 | 5210 | 15857 | 12268 | 16520 | 15990 | 10.3% |
...
- candidats AVEC connectivite : 16117, dont T2 : 100%
...
- **16794 systemes avec CONNECTED sur 129760 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*35563 candidats sur 39853 portent les champs bruts (89%).*

- `5c556c16ea8b` — 29598 candidats
  - AVEC connectivite (11989) : resistance **41.0%**
...
- `5c556c16ea8b` — 29598 candidats
  - AVEC connectivite (11989) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 16867 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16794 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 127259 systemes
  - sans CONNECTED : 0.0% sur 28657 systemes
