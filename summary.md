...
genere 2026-08-26 16:54 UTC — 54781 systemes evalues
...
- moteur actif `0caa9267db60` (11039 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
| connect | 4 | 3 | 24598 | 12285 | 1670 | 833 | 2436 | 1940 | 2622 | 2505 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 24068 | 5567 | 10176 | 14 | 3372 | 1221 | 10 | 3708 | 15.4% |
...
- candidats SANS connectivite : 4018, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2896 systemes avec CONNECTED sur 22605 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2360 candidats sur 6650 portent les champs bruts (35%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 50 candidats
  - AVEC connectivite (18) : resistance **37.1%**
  - SANS connectivite (32) : resistance **23.4%**
...
- `23303c299f39` — 50 candidats
  ...
  - SANS connectivite (32) : T0=16.91 T1=0.00 T2=2.94 — pondere **5.88**
...
- TROP-CHER : 2916 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2896 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 20104 systemes
  - sans CONNECTED : 0.0% sur 4494 systemes
