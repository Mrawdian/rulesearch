...
genere 2026-09-07 22:47 UTC — 445112 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 361768 systemes
...
- moteur actif `0caa9267db60` (401370 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 221712 | 110126 | 15123 | 7404 | 22435 | 17355 | 23605 | 22839 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 217285 | 50613 | 91574 | 85 | 30286 | 11238 | 77 | 33394 | 15.4% |
...
- candidats AVEC connectivite : 22966, dont T2 : 100%
- candidats SANS connectivite : 33704, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23879 systemes avec CONNECTED sur 183558 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*52380 candidats sur 56670 portent les champs bruts (92%).*

- `5c556c16ea8b` — 46415 candidats
  - AVEC connectivite (18838) : resistance **41.2%**
  - SANS connectivite (27577) : resistance **21.3%**
...
- `5c556c16ea8b` — 46415 candidats
  - AVEC connectivite (18838) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (27577) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 23966 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23879 avec CONNECTED, 87 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 181057 systemes
  - sans CONNECTED : 0.0% sur 40655 systemes
