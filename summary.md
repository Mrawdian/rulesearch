...
genere 2026-08-28 05:00 UTC — 129447 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 46103 systemes
...
- moteur actif `0caa9267db60` (85705 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 62305 | 30990 | 4295 | 2108 | 6218 | 4947 | 6542 | 6400 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 61027 | 14115 | 25846 | 28 | 8483 | 3159 | 27 | 9367 | 15.3% |
...
- candidats AVEC connectivite : 6527, dont T2 : 100%
- candidats SANS connectivite : 9677, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6816 systemes avec CONNECTED sur 53350 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11914 candidats sur 16204 portent les champs bruts (74%).*

- `5c556c16ea8b` — 5949 candidats
  - AVEC connectivite (2399) : resistance **41.7%**
  - SANS connectivite (3550) : resistance **22.0%**
...
- `5c556c16ea8b` — 5949 candidats
  - AVEC connectivite (2399) : T0=12.98 T1=0.00 T2=3.03 — pondere **6.07**
  - SANS connectivite (3550) : T0=15.87 T1=0.00 T2=2.69 — pondere **5.39**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 50849 systemes
  - sans CONNECTED : 0.0% sur 11456 systemes
