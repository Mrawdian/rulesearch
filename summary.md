...
genere 2026-08-26 02:02 UTC — 17363 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 8389 systemes
...
| connect | 4 | 3 | 8714 | 4384 | 568 | 294 | 829 | 699 | 937 | 896 | 10.3% |
| ref | 4 | 3 | 8525 | 2056 | 3586 | 2 | 1141 | 418 | 3 | 1319 | 15.5% |
...
- candidats AVEC connectivite : 899, dont T2 : 100%
- candidats SANS connectivite : 1323, dont T2 : 100%
...
- **937 systemes avec CONNECTED sur 7215 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1057 candidats
  - AVEC connectivite (420) : T0=13.38 T1=0.00 T2=2.86 — pondere **5.72**
  - SANS connectivite (637) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.32**
  - test de permutation : **p = 0.0485** — ecart significatif au seuil 0.05
...
- TROP-CHER : 940 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 937 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 7158 systemes
  - sans CONNECTED : 0.0% sur 1556 systemes
