...
genere 2026-08-29 21:56 UTC — 197101 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 113757 systemes
...
- moteur actif `0caa9267db60` (153359 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 96472 | 47892 | 6560 | 3248 | 9729 | 7685 | 10182 | 9943 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 94514 | 22043 | 39917 | 43 | 13079 | 4855 | 37 | 14534 | 15.4% |
...
- candidats AVEC connectivite : 10070, dont T2 : 100%
- candidats SANS connectivite : 14844, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10456 systemes avec CONNECTED sur 81184 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*20624 candidats sur 24914 portent les champs bruts (83%).*

- `5c556c16ea8b` — 14659 candidats
  - AVEC connectivite (5942) : resistance **41.2%**
  - SANS connectivite (8717) : resistance **21.5%**
...
- `5c556c16ea8b` — 14659 candidats
  - AVEC connectivite (5942) : T0=13.00 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (8717) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.32**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 78683 systemes
