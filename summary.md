...
genere 2026-08-27 01:39 UTC — 74331 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 9424 systemes
...
- moteur actif `0caa9267db60` (30589 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 34480 | 17148 | 2362 | 1168 | 3424 | 2746 | 3673 | 3517 | 10.2% |
...
- candidats AVEC connectivite : 3644, dont T2 : 100%
- candidats SANS connectivite : 5451, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3947 systemes avec CONNECTED sur 30706 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4805 candidats sur 9095 portent les champs bruts (53%).*
...
- `ab89a63b01ef` — 1128 candidats
  - AVEC connectivite (464) : resistance **41.1%**
...
- `ab89a63b01ef` — 1128 candidats
  - AVEC connectivite (464) : T0=13.03 T1=0.00 T2=3.03 — pondere **6.06**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 28205 systemes
  - sans CONNECTED : 0.0% sur 6275 systemes
