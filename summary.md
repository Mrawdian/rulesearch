...
genere 2026-08-27 00:00 UTC — 70653 systemes evalues
...
- moteur actif `0caa9267db60` (26911 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 32625 | 16219 | 2239 | 1103 | 3247 | 2596 | 3481 | 3322 | 10.2% |
...
- candidats AVEC connectivite : 3449, dont T2 : 100%
- candidats SANS connectivite : 5193, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3755 systemes avec CONNECTED sur 29172 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4352 candidats sur 8642 portent les champs bruts (50%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 675 candidats
  - AVEC connectivite (269) : resistance **41.9%**
...
- `ab89a63b01ef` — 675 candidats
  - AVEC connectivite (269) : T0=13.13 T1=0.00 T2=3.12 — pondere **6.24**
...
- TROP-CHER : 3780 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 3755 avec CONNECTED, 25 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 26671 systemes
  - sans CONNECTED : 0.0% sur 5954 systemes
