...
genere 2026-09-09 11:18 UTC — 477890 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 394546 systemes
...
- moteur actif `0caa9267db60` (434148 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 238265 | 118292 | 16249 | 7982 | 24125 | 18679 | 25358 | 24552 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 233510 | 54422 | 98383 | 92 | 32525 | 12060 | 84 | 35925 | 15.4% |
...
- candidats AVEC connectivite : 24679, dont T2 : 100%
- candidats SANS connectivite : 36235, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25632 systemes avec CONNECTED sur 197016 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*56624 candidats sur 60914 portent les champs bruts (93%).*

- `5c556c16ea8b` — 50659 candidats
  - AVEC connectivite (20551) : resistance **41.2%**
  - SANS connectivite (30108) : resistance **21.3%**
...
- `5c556c16ea8b` — 50659 candidats
  - AVEC connectivite (20551) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (30108) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 194515 systemes
  - sans CONNECTED : 0.0% sur 43750 systemes
