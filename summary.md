...
genere 2026-09-02 14:11 UTC — 313037 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 229693 systemes
...
- moteur actif `0caa9267db60` (269295 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 155005 | 77015 | 10544 | 5185 | 15754 | 12205 | 16416 | 15903 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 151917 | 35385 | 64246 | 64 | 20993 | 7857 | 63 | 23297 | 15.3% |
...
- candidats AVEC connectivite : 16030, dont T2 : 100%
- candidats SANS connectivite : 23607, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16690 systemes avec CONNECTED sur 129023 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*35347 candidats sur 39637 portent les champs bruts (89%).*

- `5c556c16ea8b` — 29382 candidats
  - AVEC connectivite (11902) : resistance **41.1%**
  - SANS connectivite (17480) : resistance **21.3%**
...
- `5c556c16ea8b` — 29382 candidats
  - AVEC connectivite (11902) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (17480) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 16763 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16690 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 126522 systemes
  - sans CONNECTED : 0.0% sur 28483 systemes
