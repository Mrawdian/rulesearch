...
genere 2026-08-31 16:16 UTC — 256826 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 173482 systemes
...
- moteur actif `0caa9267db60` (213084 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 126637 | 62957 | 8564 | 4248 | 12796 | 10019 | 13362 | 13032 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 124074 | 28913 | 52394 | 55 | 17193 | 6413 | 56 | 19040 | 15.3% |
...
- candidats AVEC connectivite : 13159, dont T2 : 100%
- candidats SANS connectivite : 19350, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13636 systemes avec CONNECTED sur 105824 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*28219 candidats sur 32509 portent les champs bruts (87%).*

- `5c556c16ea8b` — 22254 candidats
  - AVEC connectivite (9031) : resistance **41.0%**
  - SANS connectivite (13223) : resistance **21.4%**
...
- `5c556c16ea8b` — 22254 candidats
  - AVEC connectivite (9031) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.97**
  - SANS connectivite (13223) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 13702 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13636 avec CONNECTED, 66 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 103323 systemes
  - sans CONNECTED : 0.0% sur 23314 systemes
