...
genere 2026-09-04 17:28 UTC — 369846 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 286502 systemes
...
- moteur actif `0caa9267db60` (326104 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 183676 | 91288 | 12490 | 6139 | 18683 | 14461 | 19453 | 18805 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 180055 | 41859 | 76067 | 74 | 25016 | 9327 | 70 | 27628 | 15.3% |
...
- candidats AVEC connectivite : 18932, dont T2 : 100%
- candidats SANS connectivite : 27938, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19727 systemes avec CONNECTED sur 152345 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*42580 candidats sur 46870 portent les champs bruts (91%).*

- `5c556c16ea8b` — 36615 candidats
  - AVEC connectivite (14804) : resistance **41.0%**
  - SANS connectivite (21811) : resistance **21.2%**
...
- `5c556c16ea8b` — 36615 candidats
  - AVEC connectivite (14804) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (21811) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 19807 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19727 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 149844 systemes
  - sans CONNECTED : 0.0% sur 33832 systemes
