...
genere 2026-09-01 05:53 UTC — 274279 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 190935 systemes
...
- moteur actif `0caa9267db60` (230537 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 135439 | 67309 | 9149 | 4537 | 13739 | 10717 | 14304 | 13928 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 132725 | 30920 | 56109 | 58 | 18400 | 6859 | 59 | 20310 | 15.3% |
...
- candidats AVEC connectivite : 14055, dont T2 : 100%
...
- **14578 systemes avec CONNECTED sur 113005 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*30385 candidats sur 34675 portent les champs bruts (88%).*

- `5c556c16ea8b` — 24420 candidats
  - AVEC connectivite (9927) : resistance **41.0%**
...
- `5c556c16ea8b` — 24420 candidats
  - AVEC connectivite (9927) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 14647 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14578 avec CONNECTED, 69 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 110504 systemes
  - sans CONNECTED : 0.0% sur 24935 systemes
