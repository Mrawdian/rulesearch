...
genere 2026-08-27 09:02 UTC — 90474 systemes evalues
...
- moteur actif `0caa9267db60` (46732 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 42615 | 21224 | 2926 | 1440 | 4259 | 3346 | 4489 | 4378 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 41744 | 9628 | 17730 | 24 | 5780 | 2174 | 22 | 6385 | 15.3% |
...
- candidats AVEC connectivite : 4505, dont T2 : 100%
- candidats SANS connectivite : 6695, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4763 systemes avec CONNECTED sur 37325 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6910 candidats sur 11200 portent les champs bruts (62%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 945 candidats
  - AVEC connectivite (377) : resistance **41.0%**
  - SANS connectivite (568) : resistance **21.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 945 candidats
  - AVEC connectivite (377) : T0=13.08 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (568) : T0=15.85 T1=0.00 T2=2.64 — pondere **5.28**
...
- TROP-CHER : 4795 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4763 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 34824 systemes
  - sans CONNECTED : 0.0% sur 7791 systemes
