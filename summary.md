...
genere 2026-08-28 17:51 UTC — 151811 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 68467 systemes
...
- moteur actif `0caa9267db60` (108069 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 73577 | 36545 | 5012 | 2518 | 7384 | 5864 | 7768 | 7548 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 72119 | 16754 | 30497 | 33 | 9957 | 3716 | 31 | 11128 | 15.4% |
...
- candidats AVEC connectivite : 7675, dont T2 : 100%
- candidats SANS connectivite : 11438, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8042 systemes avec CONNECTED sur 62521 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*14823 candidats sur 19113 portent les champs bruts (78%).*

- `5c556c16ea8b` — 8858 candidats
  - AVEC connectivite (3547) : resistance **41.1%**
  - SANS connectivite (5311) : resistance **21.7%**
...
- `5c556c16ea8b` — 8858 candidats
  - AVEC connectivite (3547) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (5311) : T0=15.89 T1=0.00 T2=2.68 — pondere **5.36**
...
## cout
- temps total 46.9 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 8083 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8042 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 60020 systemes
  - sans CONNECTED : 0.0% sur 13557 systemes
