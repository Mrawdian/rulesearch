...
genere 2026-08-30 10:43 UTC — 215817 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 132473 systemes
...
- moteur actif `0caa9267db60` (172075 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 105923 | 52582 | 7221 | 3532 | 10671 | 8425 | 11221 | 10889 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 103779 | 24205 | 43839 | 49 | 14328 | 5354 | 41 | 15955 | 15.4% |
...
- candidats AVEC connectivite : 11016, dont T2 : 100%
- candidats SANS connectivite : 16265, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11495 systemes avec CONNECTED sur 88912 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*22991 candidats sur 27281 portent les champs bruts (84%).*

- `5c556c16ea8b` — 17026 candidats
  - AVEC connectivite (6888) : resistance **41.1%**
  - SANS connectivite (10138) : resistance **21.5%**
...
- `5c556c16ea8b` — 17026 candidats
  - AVEC connectivite (6888) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (10138) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 11546 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11495 avec CONNECTED, 51 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 86411 systemes
  - sans CONNECTED : 0.0% sur 19512 systemes
