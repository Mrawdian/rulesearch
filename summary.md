...
genere 2026-08-26 13:32 UTC — 46867 systemes evalues
...
- moteur actif `0caa9267db60` (3125 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20588 | 10267 | 1358 | 714 | 2055 | 1635 | 2197 | 2108 | 10.2% |
...
- candidats AVEC connectivite : 2235, dont T2 : 100%
- candidats SANS connectivite : 3379, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2471 systemes avec CONNECTED sur 19307 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1324 candidats sur 5614 portent les champs bruts (24%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 209 candidats
  - AVEC connectivite (97) : resistance **39.0%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 209 candidats
  - AVEC connectivite (97) : T0=13.49 T1=0.00 T2=2.80 — pondere **5.61**
  - SANS connectivite (112) : T0=16.14 T1=0.00 T2=2.88 — pondere **5.75**
  - test de permutation : **p = 0.7381** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16806 systemes
  - sans CONNECTED : 0.0% sur 3782 systemes
