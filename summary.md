...
genere 2026-08-25 21:15 UTC — 5215 systemes evalues

## versions du DSL presentes
- `615abe43d6bc` : 4238 systemes
...
| connect | 4 | 3 | 2582 | 1302 | 174 | 92 | 257 | 193 | 255 | 278 | 10.8% |
...
- **255 systemes avec CONNECTED sur 2174 (11.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- TROP-CHER : 256 systemes abandonnes (4.9% des systemes), 95% du temps total
  dont 255 avec CONNECTED, 1 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.0% sur 2117 systemes
  - sans CONNECTED : 0.0% sur 465 systemes
