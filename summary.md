...
genere 2026-08-27 01:59 UTC — 75130 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 10223 systemes
...
- moteur actif `0caa9267db60` (31388 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 34883 | 17359 | 2401 | 1180 | 3461 | 2771 | 3708 | 3559 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 34132 | 7865 | 14516 | 20 | 4735 | 1775 | 18 | 5203 | 15.2% |
...
- candidats AVEC connectivite : 3686, dont T2 : 100%
- candidats SANS connectivite : 5513, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3982 systemes avec CONNECTED sur 31039 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4909 candidats sur 9199 portent les champs bruts (53%).*
...
- `ab89a63b01ef` — 1232 candidats
  - AVEC connectivite (506) : resistance **41.3%**
  - SANS connectivite (726) : resistance **22.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1232 candidats
  - AVEC connectivite (506) : T0=13.02 T1=0.00 T2=3.05 — pondere **6.09**
  - SANS connectivite (726) : T0=15.91 T1=0.00 T2=2.71 — pondere **5.42**
...
## cout
- temps total 23.3 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 4010 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3982 avec CONNECTED, 28 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 28538 systemes
  - sans CONNECTED : 0.0% sur 6345 systemes
