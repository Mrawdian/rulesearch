...
genere 2026-08-27 01:13 UTC — 73323 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 9167 systemes
- `ab89a63b01ef` : 8416 systemes
...
- moteur actif `0caa9267db60` (29581 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 33236 | 7661 | 14119 | 20 | 4615 | 1735 | 17 | 5069 | 15.3% |
...
- candidats SANS connectivite : 5379, dont T2 : 100%
...
*4682 candidats sur 8972 portent les champs bruts (52%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 1005 candidats
  - AVEC connectivite (413) : resistance **41.0%**
  - SANS connectivite (592) : resistance **21.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1005 candidats
  ...
  - SANS connectivite (592) : T0=15.88 T1=0.00 T2=2.65 — pondere **5.30**
...
**6 serie(s) reproductible(s) sur 13 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0005), `ab89a63b01ef` (p=0.0015), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
