...
genere 2026-08-26 16:58 UTC — 54913 systemes evalues
...
- moteur actif `0caa9267db60` (11171 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
| ref | 4 | 3 | 24143 | 5584 | 10204 | 14 | 3385 | 1226 | 10 | 3720 | 15.4% |
...
- candidats SANS connectivite : 4030, dont T2 : 100%
...
*2375 candidats sur 6665 portent les champs bruts (36%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 65 candidats
  - AVEC connectivite (21) : resistance **37.8%**
  - SANS connectivite (44) : resistance **21.2%**
  - test de permutation : **p = 0.0030** — significatif.
...
- `23303c299f39` — 65 candidats
  ...
  - SANS connectivite (44) : T0=16.91 T1=0.00 T2=2.75 — pondere **5.50**
  - test de permutation : **p = 0.8391** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
