...
genere 2026-08-26 13:47 UTC — 47543 systemes evalues
...
- moteur actif `0caa9267db60` (3801 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20931 | 10452 | 1389 | 721 | 2076 | 1667 | 2228 | 2139 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20497 | 4792 | 8658 | 13 | 2837 | 1060 | 7 | 3130 | 15.3% |
...
- candidats SANS connectivite : 3440, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2502 systemes avec CONNECTED sur 19595 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1416 candidats sur 5706 portent les champs bruts (25%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 301 candidats
  - AVEC connectivite (128) : resistance **39.8%**
  - SANS connectivite (173) : resistance **20.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 301 candidats
  ...
  - SANS connectivite (173) : T0=16.16 T1=0.00 T2=2.72 — pondere **5.43**
  - test de permutation : **p = 0.3318** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
- TROP-CHER : 2519 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2502 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 17094 systemes
  - sans CONNECTED : 0.0% sur 3837 systemes
