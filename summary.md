...
genere 2026-08-27 05:44 UTC — 83536 systemes evalues
...
- moteur actif `0caa9267db60` (39794 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 39121 | 19480 | 2690 | 1336 | 3888 | 3082 | 4125 | 4012 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 38300 | 8840 | 16294 | 22 | 5300 | 1994 | 21 | 5829 | 15.2% |
...
- candidats AVEC connectivite : 4139, dont T2 : 100%
- candidats SANS connectivite : 6139, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4399 systemes avec CONNECTED sur 34497 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5988 candidats sur 10278 portent les champs bruts (58%).*
...
- `84fba70921e0` — 33 candidats
  ...
  - *groupes trop petits (< 20) — aucun test*
- `5c556c16ea8b` — 23 candidats
  - AVEC connectivite (11) : resistance **41.7%**
  - SANS connectivite (12) : resistance **26.9%**
  - *groupes trop petits (< 20) — aucun test*
...
- `84fba70921e0` — 33 candidats
  ...
  - *groupes trop petits (< 20) — aucun test, aucune conclusion*
- `5c556c16ea8b` — 23 candidats
  - AVEC connectivite (11) : T0=12.18 T1=0.00 T2=3.18 — pondere **6.36**
  - SANS connectivite (12) : T0=18.08 T1=0.00 T2=2.75 — pondere **5.50**
  - *groupes trop petits (< 20) — aucun test, aucune conclusion*
...
- TROP-CHER : 4430 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4399 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 31996 systemes
  - sans CONNECTED : 0.0% sur 7125 systemes
