...
genere 2026-08-26 07:07 UTC — 29972 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 20998 systemes
...
- candidats AVEC connectivite : 1461, dont T2 : 100%
- candidats SANS connectivite : 2225, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1638 systemes avec CONNECTED sur 12404 (13.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2521 candidats
  - AVEC connectivite (982) : T0=13.20 T1=0.00 T2=2.88 — pondere **5.76**
...
- TROP-CHER : 1647 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1638 avec CONNECTED, 9 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 11601 systemes
  - sans CONNECTED : 0.0% sur 2561 systemes
