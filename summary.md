...
genere 2026-09-08 23:26 UTC — 467310 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 383966 systemes
...
- moteur actif `0caa9267db60` (423568 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 232916 | 115692 | 15860 | 7796 | 23568 | 18244 | 24814 | 23986 | 10.3% |
...
- candidats AVEC connectivite : 24113, dont T2 : 100%
...
- **25088 systemes avec CONNECTED sur 192683 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55271 candidats sur 59561 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49306 candidats
  - AVEC connectivite (19985) : resistance **41.2%**
...
- `5c556c16ea8b` — 49306 candidats
  - AVEC connectivite (19985) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 25180 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25088 avec CONNECTED, 92 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 190182 systemes
  - sans CONNECTED : 0.0% sur 42734 systemes
