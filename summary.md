...
genere 2026-09-01 15:06 UTC — 285767 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 202423 systemes
...
- moteur actif `0caa9267db60` (242025 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 141242 | 70182 | 9567 | 4724 | 14351 | 11144 | 14917 | 14531 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 138410 | 32182 | 58523 | 59 | 19196 | 7165 | 62 | 21212 | 15.3% |
...
- candidats SANS connectivite : 21522, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15191 systemes avec CONNECTED sur 117732 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*31890 candidats sur 36180 portent les champs bruts (88%).*

- `5c556c16ea8b` — 25925 candidats
  - AVEC connectivite (10530) : resistance **41.0%**
  - SANS connectivite (15395) : resistance **21.4%**
...
- `5c556c16ea8b` — 25925 candidats
  ...
  - SANS connectivite (15395) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 115231 systemes
  - sans CONNECTED : 0.0% sur 26011 systemes
