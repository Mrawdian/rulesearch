...
genere 2026-08-26 19:03 UTC — 59926 systemes evalues
...
- moteur actif `0caa9267db60` (16184 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27195 | 13576 | 1848 | 916 | 2695 | 2152 | 2884 | 2784 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 26616 | 6148 | 11268 | 15 | 3707 | 1371 | 10 | 4097 | 15.4% |
...
- candidats AVEC connectivite : 2911, dont T2 : 100%
- candidats SANS connectivite : 4407, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3158 systemes avec CONNECTED sur 24747 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3028 candidats sur 7318 portent les champs bruts (41%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 159 candidats
  - AVEC connectivite (67) : resistance **40.2%**
  - SANS connectivite (92) : resistance **19.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 159 candidats
  - AVEC connectivite (67) : T0=13.07 T1=0.00 T2=2.93 — pondere **5.85**
  - SANS connectivite (92) : T0=15.95 T1=0.00 T2=2.60 — pondere **5.20**
...
- TROP-CHER : 3178 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3158 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22246 systemes
  - sans CONNECTED : 0.0% sur 4949 systemes
