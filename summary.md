...
genere 2026-08-28 22:02 UTC — 159135 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 75791 systemes
...
- moteur actif `0caa9267db60` (115393 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 77287 | 38401 | 5265 | 2629 | 7742 | 6173 | 8134 | 7955 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 75733 | 17613 | 32065 | 35 | 10433 | 3873 | 31 | 11679 | 15.4% |
...
- candidats AVEC connectivite : 8082, dont T2 : 100%
- candidats SANS connectivite : 11989, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8408 systemes avec CONNECTED sur 65543 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*15781 candidats sur 20071 portent les champs bruts (79%).*

- `5c556c16ea8b` — 9816 candidats
  - AVEC connectivite (3954) : resistance **41.2%**
  - SANS connectivite (5862) : resistance **21.8%**
...
- `5c556c16ea8b` — 9816 candidats
  - AVEC connectivite (3954) : T0=13.01 T1=0.00 T2=3.00 — pondere **6.01**
  - SANS connectivite (5862) : T0=15.89 T1=0.00 T2=2.68 — pondere **5.37**
...
- TROP-CHER : 8449 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8408 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 63042 systemes
  - sans CONNECTED : 0.0% sur 14245 systemes
