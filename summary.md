...
genere 2026-08-31 08:13 UTC — 245980 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 162636 systemes
...
- moteur actif `0caa9267db60` (202238 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 121155 | 60260 | 8221 | 4062 | 12181 | 9567 | 12815 | 12477 | 10.3% |
...
- candidats AVEC connectivite : 12604, dont T2 : 100%
...
- **13089 systemes avec CONNECTED sur 101409 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*26846 candidats sur 31136 portent les champs bruts (86%).*

- `5c556c16ea8b` — 20881 candidats
  - AVEC connectivite (8476) : resistance **40.9%**
...
- `5c556c16ea8b` — 20881 candidats
  - AVEC connectivite (8476) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 13152 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13089 avec CONNECTED, 63 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 98908 systemes
  - sans CONNECTED : 0.0% sur 22247 systemes
