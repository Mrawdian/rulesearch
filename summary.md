...
genere 2026-08-26 19:57 UTC — 61781 systemes evalues
...
- moteur actif `0caa9267db60` (18039 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 28138 | 14014 | 1924 | 947 | 2787 | 2229 | 2995 | 2889 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 27528 | 6359 | 11662 | 15 | 3825 | 1418 | 12 | 4237 | 15.4% |
...
- candidats AVEC connectivite : 3016, dont T2 : 100%
- candidats SANS connectivite : 4547, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3269 systemes avec CONNECTED sur 25527 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3273 candidats sur 7563 portent les champs bruts (43%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 404 candidats
  - AVEC connectivite (172) : resistance **39.2%**
  - SANS connectivite (232) : resistance **19.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 404 candidats
  - AVEC connectivite (172) : T0=12.91 T1=0.00 T2=2.83 — pondere **5.66**
  - SANS connectivite (232) : T0=16.06 T1=0.00 T2=2.59 — pondere **5.18**
  - test de permutation : **p = 0.1174** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- TROP-CHER : 3291 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3269 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23026 systemes
  - sans CONNECTED : 0.0% sur 5112 systemes
