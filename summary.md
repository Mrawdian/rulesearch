...
genere 2026-09-09 00:57 UTC — 468695 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 385351 systemes
...
- moteur actif `0caa9267db60` (424953 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 233620 | 116019 | 15919 | 7820 | 23651 | 18301 | 24882 | 24066 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 228960 | 53322 | 96469 | 92 | 31910 | 11825 | 82 | 35241 | 15.4% |
...
- candidats AVEC connectivite : 24193, dont T2 : 100%
- candidats SANS connectivite : 35551, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25156 systemes avec CONNECTED sur 193247 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55454 candidats sur 59744 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49489 candidats
  - AVEC connectivite (20065) : resistance **41.2%**
  - SANS connectivite (29424) : resistance **21.3%**
...
- `5c556c16ea8b` — 49489 candidats
  - AVEC connectivite (20065) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.97**
  - SANS connectivite (29424) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 25248 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25156 avec CONNECTED, 92 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 190746 systemes
  - sans CONNECTED : 0.0% sur 42874 systemes
