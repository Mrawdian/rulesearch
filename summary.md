...
genere 2026-09-09 10:29 UTC — 477095 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 393751 systemes
...
- moteur actif `0caa9267db60` (433353 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 237862 | 118093 | 16219 | 7971 | 24070 | 18642 | 25333 | 24513 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 233118 | 54324 | 98224 | 92 | 32471 | 12035 | 84 | 35869 | 15.4% |
...
- candidats SANS connectivite : 36179, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25607 systemes avec CONNECTED sur 196705 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*56529 candidats sur 60819 portent les champs bruts (93%).*

- `5c556c16ea8b` — 50564 candidats
  - AVEC connectivite (20512) : resistance **41.2%**
  - SANS connectivite (30052) : resistance **21.3%**
...
- `5c556c16ea8b` — 50564 candidats
  ...
  - SANS connectivite (30052) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 25701 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25607 avec CONNECTED, 94 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 194204 systemes
  - sans CONNECTED : 0.0% sur 43658 systemes
