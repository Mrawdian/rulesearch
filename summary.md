...
genere 2026-08-31 19:20 UTC — 260932 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 177588 systemes
...
- moteur actif `0caa9267db60` (217190 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 128712 | 63985 | 8704 | 4314 | 13030 | 10178 | 13563 | 13258 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 126105 | 29385 | 53244 | 56 | 17481 | 6516 | 56 | 19357 | 15.3% |
...
- candidats AVEC connectivite : 13385, dont T2 : 100%
- candidats SANS connectivite : 19667, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13837 systemes avec CONNECTED sur 107507 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*28762 candidats sur 33052 portent les champs bruts (87%).*

- `5c556c16ea8b` — 22797 candidats
  - AVEC connectivite (9257) : resistance **41.0%**
  - SANS connectivite (13540) : resistance **21.4%**
...
- `5c556c16ea8b` — 22797 candidats
  - AVEC connectivite (9257) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.97**
  - SANS connectivite (13540) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.32**
...
## cout
- temps total 80.6 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 13903 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13837 avec CONNECTED, 66 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 105006 systemes
  - sans CONNECTED : 0.0% sur 23706 systemes
