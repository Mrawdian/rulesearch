...
genere 2026-08-30 00:40 UTC — 201362 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 118018 systemes
...
- moteur actif `0caa9267db60` (157620 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 98626 | 48958 | 6709 | 3309 | 9951 | 7857 | 10395 | 10172 | 10.3% |
...
- candidats AVEC connectivite : 10299, dont T2 : 100%
...
- **10669 systemes avec CONNECTED sur 82932 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*21185 candidats sur 25475 portent les champs bruts (83%).*

- `5c556c16ea8b` — 15220 candidats
  - AVEC connectivite (6171) : resistance **41.2%**
...
- `5c556c16ea8b` — 15220 candidats
  - AVEC connectivite (6171) : T0=13.00 T1=0.00 T2=3.00 — pondere **6.00**
...
- TROP-CHER : 10716 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10669 avec CONNECTED, 47 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 80431 systemes
  - sans CONNECTED : 0.0% sur 18195 systemes
