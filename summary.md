...
genere 2026-09-02 09:57 UTC — 308193 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 224849 systemes
...
- moteur actif `0caa9267db60` (264451 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 152560 | 75789 | 10382 | 5106 | 15506 | 12005 | 16156 | 15666 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 149518 | 34828 | 63226 | 63 | 20676 | 7721 | 63 | 22929 | 15.3% |
...
- candidats AVEC connectivite : 15793, dont T2 : 100%
- candidats SANS connectivite : 23239, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16430 systemes avec CONNECTED sur 127033 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*34742 candidats sur 39032 portent les champs bruts (89%).*

- `5c556c16ea8b` — 28777 candidats
  - AVEC connectivite (11665) : resistance **41.1%**
  - SANS connectivite (17112) : resistance **21.3%**
...
- `5c556c16ea8b` — 28777 candidats
  - AVEC connectivite (11665) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (17112) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 16503 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16430 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 124532 systemes
  - sans CONNECTED : 0.0% sur 28028 systemes
