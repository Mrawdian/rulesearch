...
genere 2026-08-26 10:37 UTC — 39216 systemes evalues
...
- `e3baecf8377b` : 623 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
**8089 enregistrements (21%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 16722 | 8348 | 1076 | 578 | 1663 | 1332 | 1827 | 1687 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 16379 | 3849 | 6939 | 11 | 2237 | 827 | 7 | 2509 | 15.3% |
...
- candidats AVEC connectivite : 1814, dont T2 : 100%
- candidats SANS connectivite : 2819, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2101 systemes avec CONNECTED sur 16166 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*343 candidats sur 4633 portent les champs bruts (7%).*
...
- `e3baecf8377b` — 79 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (31) : resistance **37.0%**
  - SANS connectivite (48) : resistance **17.3%**
...
- `e3baecf8377b` — 79 candidats
  - AVEC connectivite (31) : T0=13.68 T1=0.00 T2=2.77 — pondere **5.55**
  - SANS connectivite (48) : T0=16.00 T1=0.00 T2=2.31 — pondere **4.62**
  - test de permutation : **p = 0.2069** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 2118 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2101 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.4% sur 13665 systemes
  - sans CONNECTED : 0.0% sur 3057 systemes
