...
genere 2026-08-26 13:24 UTC — 46482 systemes evalues
...
- moteur actif `0caa9267db60` (2740 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20395 | 10173 | 1342 | 704 | 2040 | 1619 | 2182 | 2083 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 19972 | 4685 | 8436 | 13 | 2759 | 1032 | 7 | 3040 | 15.2% |
...
- candidats AVEC connectivite : 2210, dont T2 : 100%
- candidats SANS connectivite : 3350, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2456 systemes avec CONNECTED sur 19146 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1270 candidats sur 5560 portent les champs bruts (23%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 155 candidats
  - AVEC connectivite (72) : resistance **37.9%**
  - SANS connectivite (83) : resistance **22.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 155 candidats
  - AVEC connectivite (72) : T0=13.35 T1=0.00 T2=2.71 — pondere **5.42**
  - SANS connectivite (83) : T0=16.18 T1=0.00 T2=2.96 — pondere **5.93**
  - test de permutation : **p = 0.3078** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 2473 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2456 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16645 systemes
  - sans CONNECTED : 0.0% sur 3750 systemes
