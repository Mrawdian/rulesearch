...
genere 2026-09-10 07:18 UTC — 494743 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 411399 systemes
...
- moteur actif `0caa9267db60` (451001 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 246760 | 122510 | 16820 | 8286 | 24968 | 19355 | 26314 | 25377 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 241868 | 56404 | 101900 | 97 | 33657 | 12479 | 87 | 37223 | 15.4% |
...
- candidats AVEC connectivite : 25504, dont T2 : 100%
- candidats SANS connectivite : 37533, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **26588 systemes avec CONNECTED sur 203976 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*58747 candidats sur 63037 portent les champs bruts (93%).*

- `5c556c16ea8b` — 52782 candidats
  - AVEC connectivite (21376) : resistance **41.2%**
  - SANS connectivite (31406) : resistance **21.3%**
...
- `5c556c16ea8b` — 52782 candidats
  - AVEC connectivite (21376) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (31406) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 201475 systemes
  - sans CONNECTED : 0.0% sur 45285 systemes
