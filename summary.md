...
genere 2026-08-26 16:15 UTC — 53178 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 7995 systemes
...
- moteur actif `0caa9267db60` (9436 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23789 | 11871 | 1615 | 811 | 2363 | 1878 | 2543 | 2410 | 10.1% |
...
- candidats AVEC connectivite : 2537, dont T2 : 100%
- candidats SANS connectivite : 3899, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2817 systemes avec CONNECTED sur 21931 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2146 candidats sur 6436 portent les champs bruts (33%).*
...
- `06fe04a859f1` — 1031 candidats
  - AVEC connectivite (399) : resistance **41.2%**
...
- `06fe04a859f1` — 1031 candidats
  - AVEC connectivite (399) : T0=13.19 T1=0.00 T2=3.04 — pondere **6.09**
...
- TROP-CHER : 2837 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2817 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19430 systemes
  - sans CONNECTED : 0.0% sur 4359 systemes
