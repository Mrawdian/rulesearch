...
genere 2026-08-26 16:35 UTC — 54052 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 8869 systemes
...
- moteur actif `0caa9267db60` (10310 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 24224 | 12079 | 1652 | 822 | 2402 | 1916 | 2583 | 2467 | 10.2% |
...
- candidats AVEC connectivite : 2594, dont T2 : 100%
- candidats SANS connectivite : 3969, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2857 systemes avec CONNECTED sur 22291 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2273 candidats sur 6563 portent les champs bruts (35%).*
...
- `06fe04a859f1` — 1158 candidats
  - AVEC connectivite (456) : resistance **41.0%**
...
- `06fe04a859f1` — 1158 candidats
  - AVEC connectivite (456) : T0=13.11 T1=0.00 T2=3.03 — pondere **6.05**
...
- TROP-CHER : 2877 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2857 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19790 systemes
  - sans CONNECTED : 0.0% sur 4434 systemes
