...
genere 2026-08-30 23:20 UTC — 233784 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 150440 systemes
...
- moteur actif `0caa9267db60` (190042 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 115014 | 57184 | 7813 | 3863 | 11546 | 9090 | 12172 | 11835 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 112655 | 26276 | 47604 | 53 | 15549 | 5818 | 49 | 17296 | 15.4% |
...
- candidats AVEC connectivite : 11962, dont T2 : 100%
- candidats SANS connectivite : 17606, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12446 systemes avec CONNECTED sur 96429 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*25278 candidats sur 29568 portent les champs bruts (85%).*

- `5c556c16ea8b` — 19313 candidats
  - AVEC connectivite (7834) : resistance **41.0%**
  - SANS connectivite (11479) : resistance **21.4%**
...
- `5c556c16ea8b` — 19313 candidats
  - AVEC connectivite (7834) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (11479) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 12505 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 12446 avec CONNECTED, 59 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 93928 systemes
  - sans CONNECTED : 0.0% sur 21086 systemes
