...
genere 2026-08-26 16:03 UTC — 52778 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 7595 systemes
...
- moteur actif `0caa9267db60` (9036 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23579 | 11758 | 1599 | 804 | 2347 | 1869 | 2517 | 2389 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 23084 | 5347 | 9750 | 14 | 3230 | 1174 | 10 | 3559 | 15.4% |
...
- candidats AVEC connectivite : 2516, dont T2 : 100%
- candidats SANS connectivite : 3869, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2791 systemes avec CONNECTED sur 21752 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2095 candidats sur 6385 portent les champs bruts (33%).*
...
- `06fe04a859f1` — 980 candidats
  - AVEC connectivite (378) : resistance **41.4%**
  - SANS connectivite (602) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 980 candidats
  - AVEC connectivite (378) : T0=13.20 T1=0.00 T2=3.04 — pondere **6.07**
  - SANS connectivite (602) : T0=16.00 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 2811 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2791 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19251 systemes
  - sans CONNECTED : 0.0% sur 4328 systemes
