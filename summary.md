...
genere 2026-08-26 14:28 UTC — 48954 systemes evalues
...
- moteur actif `0caa9267db60` (5212 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21651 | 10799 | 1441 | 745 | 2145 | 1721 | 2317 | 2209 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 21188 | 4932 | 8945 | 13 | 2935 | 1093 | 8 | 3262 | 15.4% |
...
- candidats AVEC connectivite : 2336, dont T2 : 100%
- candidats SANS connectivite : 3572, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2591 systemes avec CONNECTED sur 20196 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1618 candidats sur 5908 portent les champs bruts (27%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 503 candidats
  - AVEC connectivite (198) : resistance **40.1%**
  - SANS connectivite (305) : resistance **20.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 503 candidats
  - AVEC connectivite (198) : T0=13.41 T1=0.00 T2=2.96 — pondere **5.93**
  - SANS connectivite (305) : T0=16.09 T1=0.00 T2=2.65 — pondere **5.30**
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0310).
...
- TROP-CHER : 2609 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2591 avec CONNECTED, 18 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17695 systemes
  - sans CONNECTED : 0.0% sur 3956 systemes
