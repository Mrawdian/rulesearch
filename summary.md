...
genere 2026-09-09 07:07 UTC — 474199 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 390855 systemes
...
- moteur actif `0caa9267db60` (430457 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 236397 | 117395 | 16116 | 7918 | 23917 | 18515 | 25170 | 24363 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 231687 | 53977 | 97599 | 92 | 32269 | 11970 | 83 | 35678 | 15.4% |
...
- candidats AVEC connectivite : 24490, dont T2 : 100%
- candidats SANS connectivite : 35988, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25444 systemes avec CONNECTED sur 195526 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*56188 candidats sur 60478 portent les champs bruts (93%).*

- `5c556c16ea8b` — 50223 candidats
  - AVEC connectivite (20362) : resistance **41.2%**
  - SANS connectivite (29861) : resistance **21.3%**
...
- `5c556c16ea8b` — 50223 candidats
  - AVEC connectivite (20362) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (29861) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
## cout
- temps total 147.8 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 25537 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25444 avec CONNECTED, 93 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 193025 systemes
  - sans CONNECTED : 0.0% sur 43372 systemes
