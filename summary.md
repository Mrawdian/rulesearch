...
genere 2026-08-26 03:30 UTC — 20990 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 12016 systemes
...
| connect | 4 | 3 | 10551 | 5315 | 693 | 365 | 1006 | 837 | 1143 | 1058 | 10.0% |
...
- candidats AVEC connectivite : 1061, dont T2 : 100%
...
- **1143 systemes avec CONNECTED sur 8719 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1485 candidats
  - AVEC connectivite (582) : T0=13.33 T1=0.00 T2=2.87 — pondere **5.74**
...
- TROP-CHER : 1147 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1143 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 8662 systemes
  - sans CONNECTED : 0.0% sur 1889 systemes
