...
| connect | 4 | 3 | 6382 | 3214 | 416 | 229 | 610 | 511 | 666 | 662 | 10.4% |
| ref | 4 | 3 | 6238 | 1513 | 2592 | 1 | 837 | 306 | 2 | 987 | 15.8% |
...
- candidats AVEC connectivite : 665, dont T2 : 100%
- candidats SANS connectivite : 991, dont T2 : 100%
...
- **666 systemes avec CONNECTED sur 5291 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 491 candidats
  - AVEC connectivite (186) : T0=13.27 T1=0.00 T2=2.89 — pondere **5.77**
  - SANS connectivite (305) : T0=15.89 T1=0.00 T2=2.63 — pondere **5.26**
...
- TROP-CHER : 668 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 666 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 5234 systemes
  - sans CONNECTED : 0.0% sur 1148 systemes
