...
genere 2026-09-04 21:13 UTC — 373586 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 290242 systemes
...
- moteur actif `0caa9267db60` (329844 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 185568 | 92170 | 12608 | 6213 | 18863 | 14613 | 19683 | 19040 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 181903 | 42302 | 76854 | 75 | 25275 | 9411 | 70 | 27902 | 15.3% |
...
- candidats AVEC connectivite : 19167, dont T2 : 100%
- candidats SANS connectivite : 28212, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19957 systemes avec CONNECTED sur 153886 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*43089 candidats sur 47379 portent les champs bruts (91%).*

- `5c556c16ea8b` — 37124 candidats
  - AVEC connectivite (15039) : resistance **41.1%**
  - SANS connectivite (22085) : resistance **21.2%**
...
- `5c556c16ea8b` — 37124 candidats
  - AVEC connectivite (15039) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (22085) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 20037 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19957 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 151385 systemes
  - sans CONNECTED : 0.0% sur 34183 systemes
