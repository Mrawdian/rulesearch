...
genere 2026-08-26 21:13 UTC — 64491 systemes evalues
...
- moteur actif `0caa9267db60` (20749 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 29501 | 14670 | 2016 | 988 | 2943 | 2332 | 3151 | 3026 | 10.3% |
...
- candidats AVEC connectivite : 3153, dont T2 : 100%
- candidats SANS connectivite : 4748, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3425 systemes avec CONNECTED sur 26634 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3611 candidats sur 7901 portent les champs bruts (46%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 742 candidats
  - AVEC connectivite (309) : resistance **40.0%**
...
- `62448a55927e` — 742 candidats
  - AVEC connectivite (309) : T0=12.85 T1=0.00 T2=2.85 — pondere **5.70**
  - SANS connectivite (433) : T0=16.18 T1=0.00 T2=2.68 — pondere **5.35**
  - test de permutation : **p = 0.1334** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e3baecf8377b` — 657 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 24133 systemes
  - sans CONNECTED : 0.0% sur 5368 systemes
