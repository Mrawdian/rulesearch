...
| connect | 4 | 3 | 17589 | 8804 | 1134 | 607 | 1746 | 1398 | 1911 | 1768 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 17208 | 4048 | 7277 | 12 | 2353 | 872 | 7 | 2639 | 15.3% |
...
- candidats SANS connectivite : 2949, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2185 systemes avec CONNECTED sur 16866 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*554 candidats sur 4844 portent les champs bruts (11%).*
...
- `e3baecf8377b` — 290 candidats
  - AVEC connectivite (112) : resistance **44.3%**
  - SANS connectivite (178) : resistance **21.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 290 candidats
  ...
  - SANS connectivite (178) : T0=16.12 T1=0.00 T2=2.69 — pondere **5.37**
...
**2 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0100).
...
- TROP-CHER : 2202 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2185 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14365 systemes
  - sans CONNECTED : 0.0% sur 3224 systemes
