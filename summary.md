...
genere 2026-09-03 19:18 UTC — 345886 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 262542 systemes
...
- moteur actif `0caa9267db60` (302144 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 171594 | 85290 | 11638 | 5746 | 17466 | 13540 | 18187 | 17542 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 168177 | 39113 | 71082 | 67 | 23323 | 8700 | 66 | 25814 | 15.3% |
...
- candidats AVEC connectivite : 17669, dont T2 : 100%
- candidats SANS connectivite : 26124, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18461 systemes avec CONNECTED sur 142502 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39503 candidats sur 43793 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33538 candidats
  - AVEC connectivite (13541) : resistance **41.0%**
  - SANS connectivite (19997) : resistance **21.2%**
...
- `5c556c16ea8b` — 33538 candidats
  - AVEC connectivite (13541) : T0=13.03 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (19997) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 18537 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18461 avec CONNECTED, 76 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 140001 systemes
  - sans CONNECTED : 0.0% sur 31593 systemes
