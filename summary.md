...
genere 2026-08-27 05:43 UTC — 83477 systemes evalues
...
- moteur actif `0caa9267db60` (39735 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 39092 | 19461 | 2689 | 1336 | 3884 | 3081 | 4123 | 4010 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 38270 | 8836 | 16281 | 22 | 5295 | 1992 | 21 | 5823 | 15.2% |
...
- candidats AVEC connectivite : 4137, dont T2 : 100%
- candidats SANS connectivite : 6133, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4397 systemes avec CONNECTED sur 34473 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5980 candidats sur 10270 portent les champs bruts (58%).*
...
- TROP-CHER : 4428 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4397 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 31972 systemes
  - sans CONNECTED : 0.0% sur 7120 systemes
