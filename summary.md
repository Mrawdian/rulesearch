...
genere 2026-08-27 21:58 UTC — 115897 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 32553 systemes
...
- moteur actif `0caa9267db60` (72155 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 55457 | 27627 | 3840 | 1884 | 5485 | 4386 | 5860 | 5658 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 54325 | 12530 | 23072 | 26 | 7537 | 2815 | 25 | 8318 | 15.3% |
...
- candidats AVEC connectivite : 5785, dont T2 : 100%
- candidats SANS connectivite : 8628, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6134 systemes avec CONNECTED sur 47812 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10123 candidats sur 14413 portent les champs bruts (70%).*

- `5c556c16ea8b` — 4158 candidats
  - AVEC connectivite (1657) : resistance **42.1%**
  - SANS connectivite (2501) : resistance **22.6%**
...
- `5c556c16ea8b` — 4158 candidats
  - AVEC connectivite (1657) : T0=12.93 T1=0.00 T2=3.05 — pondere **6.11**
  - SANS connectivite (2501) : T0=15.79 T1=0.00 T2=2.72 — pondere **5.44**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 45311 systemes
  - sans CONNECTED : 0.0% sur 10146 systemes
