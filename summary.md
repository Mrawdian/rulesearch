...
genere 2026-08-26 22:00 UTC — 66343 systemes evalues
...
- moteur actif `0caa9267db60` (22601 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 30443 | 15124 | 2083 | 1023 | 3042 | 2419 | 3243 | 3124 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 29785 | 6869 | 12657 | 16 | 4114 | 1538 | 13 | 4578 | 15.4% |
...
- candidats AVEC connectivite : 3251, dont T2 : 100%
- candidats SANS connectivite : 4888, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3517 systemes avec CONNECTED sur 27386 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3849 candidats sur 8139 portent les champs bruts (47%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 172 candidats
  - AVEC connectivite (71) : resistance **44.5%**
  - SANS connectivite (101) : resistance **22.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 172 candidats
  - AVEC connectivite (71) : T0=13.10 T1=0.00 T2=3.10 — pondere **6.20**
  - SANS connectivite (101) : T0=15.89 T1=0.00 T2=2.82 — pondere **5.64**
  - test de permutation : **p = 0.2529** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 3540 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3517 avec CONNECTED, 23 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24885 systemes
  - sans CONNECTED : 0.0% sur 5558 systemes
