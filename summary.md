...
genere 2026-08-28 10:58 UTC — 139908 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 56564 systemes
...
- moteur actif `0caa9267db60` (96166 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 67592 | 33575 | 4644 | 2301 | 6772 | 5386 | 7124 | 6923 | 10.2% |
...
- candidats AVEC connectivite : 7050, dont T2 : 100%
...
- **7398 systemes avec CONNECTED sur 57633 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*13279 candidats sur 17569 portent les champs bruts (76%).*

- `5c556c16ea8b` — 7314 candidats
  - AVEC connectivite (2922) : resistance **41.4%**
...
- `5c556c16ea8b` — 7314 candidats
  - AVEC connectivite (2922) : T0=12.99 T1=0.00 T2=3.01 — pondere **6.02**
...
- TROP-CHER : 7437 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7398 avec CONNECTED, 39 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 55132 systemes
  - sans CONNECTED : 0.0% sur 12460 systemes
