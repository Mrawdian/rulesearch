...
genere 2026-08-26 16:34 UTC — 54023 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 8840 systemes
...
- moteur actif `0caa9267db60` (10281 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 24209 | 12071 | 1651 | 822 | 2402 | 1916 | 2580 | 2464 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 23699 | 5488 | 10009 | 14 | 3319 | 1203 | 10 | 3656 | 15.4% |
...
- candidats AVEC connectivite : 2591, dont T2 : 100%
- candidats SANS connectivite : 3966, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2854 systemes avec CONNECTED sur 22277 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2267 candidats sur 6557 portent les champs bruts (35%).*
...
- `06fe04a859f1` — 1152 candidats
  - AVEC connectivite (453) : resistance **41.0%**
  - SANS connectivite (699) : resistance **20.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1152 candidats
  - AVEC connectivite (453) : T0=13.12 T1=0.00 T2=3.02 — pondere **6.05**
  - SANS connectivite (699) : T0=15.98 T1=0.00 T2=2.63 — pondere **5.26**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
...
- TROP-CHER : 2874 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2854 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 19776 systemes
  - sans CONNECTED : 0.0% sur 4433 systemes
