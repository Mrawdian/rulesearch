...
| connect | 4 | 3 | 17215 | 8606 | 1113 | 595 | 1706 | 1370 | 1874 | 1735 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 16865 | 3972 | 7143 | 11 | 2301 | 854 | 7 | 2577 | 15.3% |
...
- candidats AVEC connectivite : 1862, dont T2 : 100%
- candidats SANS connectivite : 2887, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2148 systemes avec CONNECTED sur 16564 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*459 candidats sur 4749 portent les champs bruts (10%).*
...
- `e3baecf8377b` — 195 candidats
  - AVEC connectivite (79) : resistance **42.9%**
  - SANS connectivite (116) : resistance **20.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 195 candidats
  - AVEC connectivite (79) : T0=13.18 T1=0.00 T2=3.15 — pondere **6.30**
  - SANS connectivite (116) : T0=15.99 T1=0.00 T2=2.60 — pondere **5.21**
...
- TROP-CHER : 2165 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2148 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14063 systemes
  - sans CONNECTED : 0.0% sur 3152 systemes
