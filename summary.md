...
genere 2026-08-31 07:48 UTC — 245403 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 162059 systemes
...
- moteur actif `0caa9267db60` (201661 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 120874 | 60130 | 8199 | 4055 | 12152 | 9542 | 12785 | 12441 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 118414 | 27638 | 50020 | 53 | 16369 | 6107 | 53 | 18164 | 15.3% |
...
- candidats SANS connectivite : 18474, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13059 systemes avec CONNECTED sur 101186 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*26752 candidats sur 31042 portent les champs bruts (86%).*

- `5c556c16ea8b` — 20787 candidats
  - AVEC connectivite (8440) : resistance **40.9%**
  - SANS connectivite (12347) : resistance **21.4%**
...
- `5c556c16ea8b` — 20787 candidats
  ...
  - SANS connectivite (12347) : T0=15.90 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 98685 systemes
  - sans CONNECTED : 0.0% sur 22189 systemes
