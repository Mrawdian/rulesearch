...
genere 2026-08-29 02:11 UTC — 166276 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 82932 systemes
...
- moteur actif `0caa9267db60` (122534 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 80896 | 40249 | 5501 | 2743 | 8111 | 6430 | 8487 | 8345 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 79265 | 18427 | 33554 | 36 | 10963 | 4034 | 33 | 12213 | 15.4% |
...
- candidats AVEC connectivite : 8472, dont T2 : 100%
- candidats SANS connectivite : 12523, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8761 systemes avec CONNECTED sur 68504 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*16705 candidats sur 20995 portent les champs bruts (80%).*

- `5c556c16ea8b` — 10740 candidats
  - AVEC connectivite (4344) : resistance **41.1%**
  - SANS connectivite (6396) : resistance **21.7%**
...
- `5c556c16ea8b` — 10740 candidats
  - AVEC connectivite (4344) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (6396) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.34**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 66003 systemes
  - sans CONNECTED : 0.0% sur 14893 systemes
