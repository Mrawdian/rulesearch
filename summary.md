...
genere 2026-09-05 17:30 UTC — 394393 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 311049 systemes
...
- moteur actif `0caa9267db60` (350651 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 196082 | 97372 | 13348 | 6538 | 19935 | 15422 | 20802 | 20171 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 192196 | 44736 | 81091 | 78 | 26761 | 9934 | 71 | 29511 | 15.4% |
...
- candidats AVEC connectivite : 20298, dont T2 : 100%
- candidats SANS connectivite : 29821, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21076 systemes avec CONNECTED sur 162476 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*45829 candidats sur 50119 portent les champs bruts (91%).*

- `5c556c16ea8b` — 39864 candidats
  - AVEC connectivite (16170) : resistance **41.1%**
  - SANS connectivite (23694) : resistance **21.3%**
...
- `5c556c16ea8b` — 39864 candidats
  - AVEC connectivite (16170) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (23694) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 21157 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21076 avec CONNECTED, 81 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 159975 systemes
