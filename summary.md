...
genere 2026-08-28 07:06 UTC — 133199 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 49855 systemes
...
- moteur actif `0caa9267db60` (89457 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 64197 | 31895 | 4409 | 2177 | 6437 | 5109 | 6747 | 6596 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 62887 | 14544 | 26630 | 29 | 8750 | 3250 | 28 | 9654 | 15.4% |
...
- candidats SANS connectivite : 9964, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7021 systemes avec CONNECTED sur 54861 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12397 candidats sur 16687 portent les champs bruts (74%).*

- `5c556c16ea8b` — 6432 candidats
  - AVEC connectivite (2595) : resistance **41.4%**
  - SANS connectivite (3837) : resistance **21.9%**
...
- `5c556c16ea8b` — 6432 candidats
  ...
  - SANS connectivite (3837) : T0=15.86 T1=0.00 T2=2.68 — pondere **5.36**
...
- TROP-CHER : 7059 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7021 avec CONNECTED, 38 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 52360 systemes
  - sans CONNECTED : 0.0% sur 11837 systemes
