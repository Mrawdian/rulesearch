...
genere 2026-08-26 08:59 UTC — 34947 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 25973 systemes
...
| d4 | 4 | 4 | 4327 | 1968 | 1115 | 22 | 314 | 293 | 212 | 301 | 7.0% |
...
- candidats SANS connectivite : 2548, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1888 systemes avec CONNECTED sur 14420 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 3024 candidats
  - AVEC connectivite (1162) : T0=13.15 T1=0.00 T2=2.92 — pondere **5.85**
  - SANS connectivite (1862) : T0=15.87 T1=0.01 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 1901 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 1888 avec CONNECTED, 13 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
