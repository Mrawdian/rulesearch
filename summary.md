...
genere 2026-08-27 14:54 UTC — 102152 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 18808 systemes
...
- moteur actif `0caa9267db60` (58410 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 48515 | 24178 | 3343 | 1659 | 4813 | 3834 | 5129 | 4933 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 47522 | 10994 | 20167 | 25 | 6585 | 2485 | 22 | 7243 | 15.2% |
...
- candidats AVEC connectivite : 5060, dont T2 : 100%
- candidats SANS connectivite : 7553, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5403 systemes avec CONNECTED sur 42148 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*8323 candidats sur 12613 portent les champs bruts (66%).*
...
- `5c556c16ea8b` — 2358 candidats
  - AVEC connectivite (932) : resistance **41.7%**
  - SANS connectivite (1426) : resistance **22.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 2358 candidats
  - AVEC connectivite (932) : T0=13.04 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (1426) : T0=15.78 T1=0.00 T2=2.69 — pondere **5.37**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 2280 candidats
...
- TROP-CHER : 5435 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 5403 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 39647 systemes
  - sans CONNECTED : 0.0% sur 8868 systemes
