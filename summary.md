...
genere 2026-08-28 02:01 UTC — 123942 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 40598 systemes
...
- moteur actif `0caa9267db60` (80200 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 59513 | 29633 | 4111 | 2010 | 5920 | 4712 | 6249 | 6113 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 58314 | 13486 | 24706 | 28 | 8110 | 3021 | 26 | 8935 | 15.3% |
...
- candidats AVEC connectivite : 6240, dont T2 : 100%
- candidats SANS connectivite : 9245, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6523 systemes avec CONNECTED sur 51080 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11195 candidats sur 15485 portent les champs bruts (72%).*

- `5c556c16ea8b` — 5230 candidats
  - AVEC connectivite (2112) : resistance **41.8%**
...
- `5c556c16ea8b` — 5230 candidats
  - AVEC connectivite (2112) : T0=12.99 T1=0.00 T2=3.04 — pondere **6.09**
...
- TROP-CHER : 6559 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6523 avec CONNECTED, 36 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 48579 systemes
  - sans CONNECTED : 0.0% sur 10934 systemes
