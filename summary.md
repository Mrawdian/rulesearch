...
genere 2026-08-26 16:17 UTC — 53252 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 8069 systemes
...
- moteur actif `0caa9267db60` (9510 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23819 | 11884 | 1617 | 812 | 2366 | 1879 | 2548 | 2415 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 23318 | 5402 | 9848 | 14 | 3261 | 1191 | 10 | 3592 | 15.4% |
...
- candidats AVEC connectivite : 2542, dont T2 : 100%
- candidats SANS connectivite : 3902, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2822 systemes avec CONNECTED sur 21957 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2154 candidats sur 6444 portent les champs bruts (33%).*
...
- `06fe04a859f1` — 1039 candidats
  - AVEC connectivite (404) : resistance **41.1%**
  - SANS connectivite (635) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1039 candidats
  - AVEC connectivite (404) : T0=13.17 T1=0.00 T2=3.03 — pondere **6.07**
  - SANS connectivite (635) : T0=15.97 T1=0.00 T2=2.64 — pondere **5.28**
...
- TROP-CHER : 2842 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2822 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19456 systemes
  - sans CONNECTED : 0.0% sur 4363 systemes
