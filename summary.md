...
genere 2026-09-04 08:11 UTC — 359957 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 276613 systemes
...
- moteur actif `0caa9267db60` (316215 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 178684 | 88812 | 12139 | 5975 | 18178 | 14078 | 18930 | 18298 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 175158 | 40701 | 73990 | 71 | 24314 | 9084 | 70 | 26914 | 15.4% |
...
- candidats AVEC connectivite : 18425, dont T2 : 100%
- candidats SANS connectivite : 27224, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19204 systemes avec CONNECTED sur 148297 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*41359 candidats sur 45649 portent les champs bruts (91%).*

- `5c556c16ea8b` — 35394 candidats
  - AVEC connectivite (14297) : resistance **41.1%**
  - SANS connectivite (21097) : resistance **21.3%**
...
- `5c556c16ea8b` — 35394 candidats
  - AVEC connectivite (14297) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (21097) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
## cout
- temps total 111.7 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 19284 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19204 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 145796 systemes
  - sans CONNECTED : 0.0% sur 32888 systemes
