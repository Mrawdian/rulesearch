...
genere 2026-08-26 21:20 UTC — 64832 systemes evalues
...
- moteur actif `0caa9267db60` (21090 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 29680 | 14750 | 2031 | 994 | 2968 | 2347 | 3163 | 3050 | 10.3% |
...
- candidats AVEC connectivite : 3177, dont T2 : 100%
- candidats SANS connectivite : 4777, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3437 systemes avec CONNECTED sur 26775 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3664 candidats sur 7954 portent les champs bruts (46%).*
...
- `62448a55927e` — 795 candidats
  ...
  - test de permutation : **p = 0.0940** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e3baecf8377b` — 657 candidats
...
- TROP-CHER : 3459 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3437 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24274 systemes
  - sans CONNECTED : 0.0% sur 5406 systemes
