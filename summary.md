...
genere 2026-09-06 16:59 UTC — 417273 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 333929 systemes
...
- moteur actif `0caa9267db60` (373531 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 207636 | 103089 | 14146 | 6908 | 21043 | 16344 | 22072 | 21395 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 203522 | 47329 | 85845 | 79 | 28387 | 10506 | 73 | 31286 | 15.4% |
...
- candidats SANS connectivite : 31596, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **22346 systemes avec CONNECTED sur 171929 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*48828 candidats sur 53118 portent les champs bruts (92%).*

- `5c556c16ea8b` — 42863 candidats
  - AVEC connectivite (17394) : resistance **41.1%**
  - SANS connectivite (25469) : resistance **21.3%**
...
- `5c556c16ea8b` — 42863 candidats
  ...
  - SANS connectivite (25469) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 169428 systemes
  - sans CONNECTED : 0.0% sur 38208 systemes
