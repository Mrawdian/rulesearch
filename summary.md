...
genere 2026-08-26 09:36 UTC — 36600 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 27626 systemes
...
| connect | 4 | 3 | 15823 | 7888 | 1033 | 541 | 1570 | 1264 | 1729 | 1597 | 10.1% |
| d4 | 4 | 4 | 5152 | 2375 | 1311 | 26 | 368 | 338 | 246 | 361 | 7.0% |
| ref | 4 | 3 | 15501 | 3637 | 6546 | 11 | 2126 | 785 | 7 | 2389 | 15.4% |
...
- candidats AVEC connectivite : 1699, dont T2 : 100%
- candidats SANS connectivite : 2655, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1966 systemes avec CONNECTED sur 15097 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*64 candidats sur 4354 portent les champs bruts (1%).*

- `89c65c03c4ad` — 64 candidats
  - AVEC connectivite (22) : resistance **53.7%**
  - SANS connectivite (42) : resistance **20.9%**
...
- `89c65c03c4ad` — 3189 candidats
  - AVEC connectivite (1220) : T0=13.10 T1=0.00 T2=2.95 — pondere **5.90**
  - SANS connectivite (1969) : T0=15.85 T1=0.02 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 1982 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 1966 avec CONNECTED, 16 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.4% sur 12934 systemes
  - sans CONNECTED : 0.0% sur 2889 systemes
