...
genere 2026-09-01 01:59 UTC — 269379 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 186035 systemes
...
- moteur actif `0caa9267db60` (225637 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 132977 | 66074 | 8995 | 4463 | 13485 | 10520 | 14035 | 13680 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 130287 | 30357 | 55053 | 57 | 18046 | 6743 | 57 | 19964 | 15.3% |
...
- candidats AVEC connectivite : 13807, dont T2 : 100%
- candidats SANS connectivite : 20274, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14309 systemes avec CONNECTED sur 110993 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*29791 candidats sur 34081 portent les champs bruts (87%).*

- `5c556c16ea8b` — 23826 candidats
  - AVEC connectivite (9679) : resistance **41.0%**
  - SANS connectivite (14147) : resistance **21.3%**
...
- `5c556c16ea8b` — 23826 candidats
  - AVEC connectivite (9679) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (14147) : T0=15.93 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 108492 systemes
  - sans CONNECTED : 0.0% sur 24485 systemes
