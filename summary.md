...
genere 2026-09-03 15:37 UTC — 341850 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 258506 systemes
...
- moteur actif `0caa9267db60` (298108 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 169547 | 84277 | 11495 | 5679 | 17247 | 13387 | 17966 | 17333 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 166188 | 38659 | 70243 | 67 | 23058 | 8592 | 66 | 25491 | 15.3% |
...
- candidats SANS connectivite : 25801, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18240 systemes avec CONNECTED sur 140829 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*38971 candidats sur 43261 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33006 candidats
  - AVEC connectivite (13332) : resistance **41.0%**
  - SANS connectivite (19674) : resistance **21.2%**
...
- `5c556c16ea8b` — 33006 candidats
  ...
  - SANS connectivite (19674) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.29**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 138328 systemes
  - sans CONNECTED : 0.0% sur 31219 systemes
