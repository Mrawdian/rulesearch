...
genere 2026-09-06 15:07 UTC — 415537 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 332193 systemes
...
- moteur actif `0caa9267db60` (371795 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 206754 | 102660 | 14088 | 6881 | 20962 | 16263 | 21967 | 21302 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 202668 | 47113 | 85497 | 79 | 28256 | 10471 | 73 | 31162 | 15.4% |
...
- candidats AVEC connectivite : 21429, dont T2 : 100%
...
- **22241 systemes avec CONNECTED sur 171218 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*48611 candidats sur 52901 portent les champs bruts (92%).*

- `5c556c16ea8b` — 42646 candidats
  - AVEC connectivite (17301) : resistance **41.1%**
...
- `5c556c16ea8b` — 42646 candidats
  - AVEC connectivite (17301) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 22324 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 22241 avec CONNECTED, 83 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 168717 systemes
  - sans CONNECTED : 0.0% sur 38037 systemes
