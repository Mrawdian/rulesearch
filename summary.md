...
genere 2026-08-28 09:33 UTC — 137470 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 54126 systemes
...
- moteur actif `0caa9267db60` (93728 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 66353 | 32972 | 4545 | 2254 | 6638 | 5287 | 6987 | 6814 | 10.3% |
...
- candidats AVEC connectivite : 6941, dont T2 : 100%
...
- **7261 systemes avec CONNECTED sur 56643 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12965 candidats sur 17255 portent les champs bruts (75%).*

- `5c556c16ea8b` — 7000 candidats
  - AVEC connectivite (2813) : resistance **41.4%**
...
- `5c556c16ea8b` — 7000 candidats
  - AVEC connectivite (2813) : T0=12.97 T1=0.00 T2=3.02 — pondere **6.04**
...
## cout
- temps total 42.3 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 7299 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7261 avec CONNECTED, 38 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 54142 systemes
