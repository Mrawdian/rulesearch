...
genere 2026-08-26 13:17 UTC — 46201 systemes evalues
...
- moteur actif `0caa9267db60` (2459 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20261 | 10114 | 1333 | 699 | 2031 | 1607 | 2167 | 2061 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 19825 | 4646 | 8374 | 13 | 2737 | 1027 | 7 | 3021 | 15.2% |
...
- candidats AVEC connectivite : 2188, dont T2 : 100%
- candidats SANS connectivite : 3331, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2441 systemes avec CONNECTED sur 19033 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1229 candidats sur 5519 portent les champs bruts (22%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 114 candidats
  - AVEC connectivite (50) : resistance **39.4%**
  - SANS connectivite (64) : resistance **23.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 114 candidats
  - AVEC connectivite (50) : T0=13.00 T1=0.00 T2=2.82 — pondere **5.64**
  - SANS connectivite (64) : T0=16.61 T1=0.00 T2=2.94 — pondere **5.88**
  - test de permutation : **p = 0.7136** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
## cout
- temps total 14.3 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2458 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2441 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16532 systemes
  - sans CONNECTED : 0.0% sur 3729 systemes
