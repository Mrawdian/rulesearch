...
genere 2026-08-27 06:56 UTC — 86035 systemes evalues
...
- moteur actif `0caa9267db60` (42293 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 40375 | 20105 | 2763 | 1375 | 4033 | 3175 | 4259 | 4143 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 39545 | 9115 | 16814 | 22 | 5484 | 2064 | 21 | 6025 | 15.2% |
...
- **4533 systemes avec CONNECTED sur 35505 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6315 candidats sur 10605 portent les champs bruts (60%).*
...
**7 serie(s) reproductible(s) sur 14 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `ab89a63b01ef` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `5c556c16ea8b` (p=0.0115), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 33004 systemes
  - sans CONNECTED : 0.0% sur 7371 systemes
