...
genere 2026-08-27 07:47 UTC — 87902 systemes evalues
...
- moteur actif `0caa9267db60` (44160 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 40473 | 9318 | 17207 | 22 | 5622 | 2108 | 21 | 6175 | 15.3% |
...
- candidats SANS connectivite : 6485, dont T2 : 100%
...
*6564 candidats sur 10854 portent les champs bruts (60%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 599 candidats
  - AVEC connectivite (241) : resistance **41.0%**
  - SANS connectivite (358) : resistance **20.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 599 candidats
  ...
  - SANS connectivite (358) : T0=15.86 T1=0.00 T2=2.62 — pondere **5.23**
...
**7 serie(s) reproductible(s) sur 14 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `ab89a63b01ef` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `5c556c16ea8b` (p=0.0035), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
