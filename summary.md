...
genere 2026-09-05 06:30 UTC — 383301 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 299957 systemes
...
- moteur actif `0caa9267db60` (339559 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 190477 | 94611 | 12970 | 6351 | 19367 | 15006 | 20191 | 19546 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 186709 | 43453 | 78836 | 77 | 25951 | 9666 | 70 | 28642 | 15.3% |
...
- candidats AVEC connectivite : 19673, dont T2 : 100%
- candidats SANS connectivite : 28952, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20465 systemes avec CONNECTED sur 157889 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*44335 candidats sur 48625 portent les champs bruts (91%).*

- `5c556c16ea8b` — 38370 candidats
  - AVEC connectivite (15545) : resistance **41.1%**
  - SANS connectivite (22825) : resistance **21.3%**
...
- `5c556c16ea8b` — 38370 candidats
  - AVEC connectivite (15545) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (22825) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 155388 systemes
  - sans CONNECTED : 0.0% sur 35089 systemes
