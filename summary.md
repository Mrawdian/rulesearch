...
- `89c65c03c4ad` — 236 candidats
  - AVEC connectivite (81) : T0=13.26 T1=0.00 T2=2.75 — pondere **5.51**
  - SANS connectivite (155) : T0=15.91 T1=0.00 T2=2.64 — pondere **5.28**
  - test de permutation : **p = 0.5707** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
