...
| connect | 4 | 3 | 18067 | 9032 | 1175 | 629 | 1789 | 1436 | 1963 | 1817 | 10.1% |
...
- candidats AVEC connectivite : 1944, dont T2 : 100%
- candidats SANS connectivite : 3026, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2237 systemes avec CONNECTED sur 17257 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*680 candidats sur 4970 portent les champs bruts (14%).*
...
- `e3baecf8377b` — 416 candidats
  - AVEC connectivite (161) : resistance **44.4%**
...
- `e3baecf8377b` — 416 candidats
  - AVEC connectivite (161) : T0=12.93 T1=0.00 T2=3.24 — pondere **6.48**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14756 systemes
  - sans CONNECTED : 0.0% sur 3311 systemes
