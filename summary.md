...
genere 2026-09-07 16:45 UTC — 439638 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 356294 systemes
...
- moteur actif `0caa9267db60` (395896 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 218943 | 108765 | 14933 | 7292 | 22163 | 17158 | 23293 | 22556 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 214580 | 49977 | 90447 | 83 | 29913 | 11086 | 77 | 32979 | 15.4% |
...
- candidats AVEC connectivite : 22683, dont T2 : 100%
...
- **23567 systemes avec CONNECTED sur 181259 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*51682 candidats sur 55972 portent les champs bruts (92%).*

- `5c556c16ea8b` — 45717 candidats
  - AVEC connectivite (18555) : resistance **41.1%**
...
- `5c556c16ea8b` — 45717 candidats
  - AVEC connectivite (18555) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 23654 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23567 avec CONNECTED, 87 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 178758 systemes
  - sans CONNECTED : 0.0% sur 40185 systemes
