...
genere 2026-08-27 00:09 UTC — 71056 systemes evalues
...
- moteur actif `0caa9267db60` (27314 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 32820 | 16314 | 2256 | 1109 | 3263 | 2610 | 3497 | 3351 | 10.2% |
...
- candidats AVEC connectivite : 3478, dont T2 : 100%
- candidats SANS connectivite : 5227, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3771 systemes avec CONNECTED sur 29330 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4415 candidats sur 8705 portent les champs bruts (51%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 738 candidats
  - AVEC connectivite (298) : resistance **41.5%**
...
- `ab89a63b01ef` — 738 candidats
  - AVEC connectivite (298) : T0=13.15 T1=0.00 T2=3.09 — pondere **6.17**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 26829 systemes
  - sans CONNECTED : 0.0% sur 5991 systemes
