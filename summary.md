...
genere 2026-08-30 10:11 UTC — 215019 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 131675 systemes
...
- moteur actif `0caa9267db60` (171277 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 105520 | 52380 | 7190 | 3518 | 10641 | 8391 | 11182 | 10841 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 103384 | 24119 | 43657 | 48 | 14278 | 5332 | 41 | 15901 | 15.4% |
...
- candidats AVEC connectivite : 10968, dont T2 : 100%
- candidats SANS connectivite : 16211, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11456 systemes avec CONNECTED sur 88577 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*22889 candidats sur 27179 portent les champs bruts (84%).*

- `5c556c16ea8b` — 16924 candidats
  - AVEC connectivite (6840) : resistance **41.1%**
  - SANS connectivite (10084) : resistance **21.5%**
...
- `5c556c16ea8b` — 16924 candidats
  - AVEC connectivite (6840) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (10084) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 11507 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 11456 avec CONNECTED, 51 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 86076 systemes
  - sans CONNECTED : 0.0% sur 19444 systemes
