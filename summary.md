...
**7466 enregistrements (64%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 5875 | 2958 | 378 | 213 | 564 | 473 | 612 | 607 | 10.3% |
| ref | 4 | 3 | 5730 | 1391 | 2386 | 1 | 763 | 280 | 2 | 907 | 15.8% |
...
- candidats SANS connectivite : 911, dont T2 : 100%
...
- **612 systemes avec CONNECTED sur 4875 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 356 candidats
  - AVEC connectivite (131) : T0=13.07 T1=0.00 T2=2.91 — pondere **5.82**
  - SANS connectivite (225) : T0=15.93 T1=0.00 T2=2.64 — pondere **5.27**
...
- TROP-CHER : 614 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 612 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 4818 systemes
  - sans CONNECTED : 0.0% sur 1057 systemes
