...
genere 2026-08-29 08:46 UTC — 176964 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 93620 systemes
...
- moteur actif `0caa9267db60` (133222 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 86291 | 42935 | 5868 | 2919 | 8670 | 6852 | 9057 | 8893 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 84558 | 19747 | 35736 | 39 | 11666 | 4314 | 35 | 13015 | 15.4% |
...
- candidats AVEC connectivite : 9020, dont T2 : 100%
- candidats SANS connectivite : 13325, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9331 systemes avec CONNECTED sur 72926 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*18055 candidats sur 22345 portent les champs bruts (81%).*

- `5c556c16ea8b` — 12090 candidats
  - AVEC connectivite (4892) : resistance **41.1%**
  - SANS connectivite (7198) : resistance **21.6%**
...
- `5c556c16ea8b` — 12090 candidats
  - AVEC connectivite (4892) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (7198) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 70425 systemes
  - sans CONNECTED : 0.0% sur 15866 systemes
