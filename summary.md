...
genere 2026-08-28 17:32 UTC — 151236 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 67892 systemes
...
- moteur actif `0caa9267db60` (107494 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 73294 | 36401 | 4993 | 2504 | 7357 | 5839 | 7740 | 7523 | 10.3% |
...
- candidats AVEC connectivite : 7650, dont T2 : 100%
...
- **8014 systemes avec CONNECTED sur 62292 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*14759 candidats sur 19049 portent les champs bruts (77%).*

- `5c556c16ea8b` — 8794 candidats
  - AVEC connectivite (3522) : resistance **41.1%**
...
- `5c556c16ea8b` — 8794 candidats
  - AVEC connectivite (3522) : T0=13.02 T1=0.00 T2=3.00 — pondere **5.99**
...
- TROP-CHER : 8055 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8014 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 59791 systemes
  - sans CONNECTED : 0.0% sur 13503 systemes
