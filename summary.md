...
genere 2026-08-27 19:42 UTC — 111632 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 28288 systemes
...
- moteur actif `0caa9267db60` (67890 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 53287 | 26531 | 3696 | 1818 | 5274 | 4212 | 5624 | 5439 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 52230 | 12076 | 22174 | 26 | 7220 | 2717 | 25 | 7990 | 15.3% |
...
- candidats AVEC connectivite : 5566, dont T2 : 100%
- candidats SANS connectivite : 8300, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5898 systemes avec CONNECTED sur 46037 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*9576 candidats sur 13866 portent les champs bruts (69%).*
...
- `5c556c16ea8b` — 3611 candidats
  - AVEC connectivite (1438) : resistance **42.2%**
...
- `5c556c16ea8b` — 3611 candidats
  - AVEC connectivite (1438) : T0=12.94 T1=0.00 T2=3.07 — pondere **6.14**
...
- TROP-CHER : 5933 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 5898 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 43536 systemes
  - sans CONNECTED : 0.0% sur 9751 systemes
