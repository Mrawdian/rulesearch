...
genere 2026-08-26 22:06 UTC — 66551 systemes evalues
...
- moteur actif `0caa9267db60` (22809 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 29888 | 6891 | 12702 | 17 | 4125 | 1543 | 13 | 4597 | 15.4% |
...
- candidats SANS connectivite : 4907, dont T2 : 100%
...
*3880 candidats sur 8170 portent les champs bruts (47%).*
...
- `23303c299f39` — 225 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 203 candidats
  - AVEC connectivite (83) : resistance **43.6%**
  - SANS connectivite (120) : resistance **21.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 203 candidats
  ...
  - SANS connectivite (120) : T0=15.94 T1=0.00 T2=2.74 — pondere **5.48**
  - test de permutation : **p = 0.1274** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
