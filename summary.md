...
genere 2026-08-26 16:39 UTC — 54186 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 9003 systemes
...
- moteur actif `0caa9267db60` (10444 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 24299 | 12120 | 1656 | 823 | 2409 | 1922 | 2592 | 2474 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 23772 | 5501 | 10041 | 14 | 3330 | 1207 | 10 | 3669 | 15.4% |
...
- candidats AVEC connectivite : 2601, dont T2 : 100%
- candidats SANS connectivite : 3979, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2866 systemes avec CONNECTED sur 22353 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2290 candidats sur 6580 portent les champs bruts (35%).*
...
- `06fe04a859f1` — 1175 candidats
  - AVEC connectivite (463) : resistance **41.0%**
  - SANS connectivite (712) : resistance **20.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1175 candidats
  - AVEC connectivite (463) : T0=13.12 T1=0.00 T2=3.03 — pondere **6.05**
  - SANS connectivite (712) : T0=15.95 T1=0.00 T2=2.62 — pondere **5.25**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19852 systemes
  - sans CONNECTED : 0.0% sur 4447 systemes
