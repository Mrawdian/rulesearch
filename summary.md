...
| connect | 4 | 3 | 5168 | 2591 | 326 | 185 | 503 | 425 | 541 | 538 | 10.4% |
| ref | 4 | 3 | 5060 | 1229 | 2117 | 1 | 664 | 244 | 2 | 803 | 15.9% |
...
- candidats SANS connectivite : 807, dont T2 : 100%
...
- **541 systemes avec CONNECTED sur 4274 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 183 candidats
  ...
  - SANS connectivite (121) : T0=16.12 T1=0.00 T2=2.68 — pondere **5.36**
...
- TROP-CHER : 543 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 541 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 4217 systemes
  - sans CONNECTED : 0.0% sur 951 systemes
