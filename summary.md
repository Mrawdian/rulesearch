...
genere 2026-09-08 08:52 UTC — 454204 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 370860 systemes
...
- moteur actif `0caa9267db60` (410462 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 226295 | 112376 | 15403 | 7558 | 22895 | 17731 | 24117 | 23330 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 221794 | 51650 | 93489 | 88 | 30890 | 11470 | 81 | 34108 | 15.4% |
...
- candidats SANS connectivite : 34418, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **24391 systemes avec CONNECTED sur 187296 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*53585 candidats sur 57875 portent les champs bruts (93%).*

- `5c556c16ea8b` — 47620 candidats
  - AVEC connectivite (19329) : resistance **41.1%**
  - SANS connectivite (28291) : resistance **21.3%**
...
- `5c556c16ea8b` — 47620 candidats
  ...
  - SANS connectivite (28291) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 184795 systemes
  - sans CONNECTED : 0.0% sur 41500 systemes
