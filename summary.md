...
genere 2026-08-27 21:40 UTC — 115291 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 31947 systemes
...
- moteur actif `0caa9267db60` (71549 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 55142 | 27456 | 3819 | 1873 | 5454 | 4366 | 5833 | 5627 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 54034 | 12467 | 22941 | 26 | 7497 | 2803 | 25 | 8273 | 15.3% |
...
- candidats AVEC connectivite : 5754, dont T2 : 100%
- candidats SANS connectivite : 8583, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6107 systemes avec CONNECTED sur 47549 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10047 candidats sur 14337 portent les champs bruts (70%).*

- `5c556c16ea8b` — 4082 candidats
  - AVEC connectivite (1626) : resistance **42.0%**
  - SANS connectivite (2456) : resistance **22.5%**
...
- `5c556c16ea8b` — 4082 candidats
  - AVEC connectivite (1626) : T0=12.93 T1=0.00 T2=3.06 — pondere **6.11**
  - SANS connectivite (2456) : T0=15.78 T1=0.00 T2=2.71 — pondere **5.42**
...
- TROP-CHER : 6142 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6107 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 45048 systemes
  - sans CONNECTED : 0.0% sur 10094 systemes
