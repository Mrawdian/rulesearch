...
genere 2026-08-26 03:38 UTC — 21402 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 12428 systemes
...
| connect | 4 | 3 | 10760 | 5410 | 707 | 372 | 1033 | 857 | 1161 | 1082 | 10.1% |
...
- candidats AVEC connectivite : 1085, dont T2 : 100%
...
- **1161 systemes avec CONNECTED sur 8879 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1534 candidats
  - AVEC connectivite (606) : T0=13.37 T1=0.00 T2=2.86 — pondere **5.73**
...
- TROP-CHER : 1165 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 1161 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 8822 systemes
  - sans CONNECTED : 0.0% sur 1938 systemes
