...
genere 2026-08-26 13:35 UTC — 46971 systemes evalues
...
- moteur actif `0caa9267db60` (3229 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20648 | 10296 | 1363 | 718 | 2058 | 1643 | 2202 | 2113 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20208 | 4728 | 8536 | 13 | 2803 | 1044 | 7 | 3077 | 15.2% |
...
- candidats AVEC connectivite : 2240, dont T2 : 100%
- candidats SANS connectivite : 3387, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2476 systemes avec CONNECTED sur 19356 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1337 candidats sur 5627 portent les champs bruts (24%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 222 candidats
  - AVEC connectivite (102) : resistance **38.2%**
  - SANS connectivite (120) : resistance **21.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 222 candidats
  - AVEC connectivite (102) : T0=13.57 T1=0.00 T2=2.75 — pondere **5.51**
  - SANS connectivite (120) : T0=16.18 T1=0.00 T2=2.82 — pondere **5.63**
  - test de permutation : **p = 0.7916** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16855 systemes
  - sans CONNECTED : 0.0% sur 3793 systemes
