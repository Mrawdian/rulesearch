...
genere 2026-09-04 08:29 UTC — 360249 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 276905 systemes
...
- moteur actif `0caa9267db60` (316507 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 178834 | 88878 | 12152 | 5980 | 18195 | 14091 | 18949 | 18312 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 175300 | 40732 | 74056 | 71 | 24332 | 9091 | 70 | 26934 | 15.4% |
...
- candidats AVEC connectivite : 18439, dont T2 : 100%
- candidats SANS connectivite : 27244, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19223 systemes avec CONNECTED sur 148414 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*41393 candidats sur 45683 portent les champs bruts (91%).*

- `5c556c16ea8b` — 35428 candidats
  - AVEC connectivite (14311) : resistance **41.1%**
  - SANS connectivite (21117) : resistance **21.3%**
...
- `5c556c16ea8b` — 35428 candidats
  - AVEC connectivite (14311) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (21117) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 19303 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19223 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 145913 systemes
  - sans CONNECTED : 0.0% sur 32921 systemes
