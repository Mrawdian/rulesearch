...
genere 2026-09-08 05:54 UTC — 451513 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 368169 systemes
...
- moteur actif `0caa9267db60` (407771 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 224938 | 111692 | 15320 | 7503 | 22769 | 17634 | 23973 | 23177 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 220460 | 51352 | 92938 | 87 | 30710 | 11387 | 79 | 33889 | 15.4% |
...
- candidats AVEC connectivite : 23304, dont T2 : 100%
- candidats SANS connectivite : 34199, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **24247 systemes avec CONNECTED sur 186177 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*53213 candidats sur 57503 portent les champs bruts (93%).*

- `5c556c16ea8b` — 47248 candidats
  - AVEC connectivite (19176) : resistance **41.2%**
  - SANS connectivite (28072) : resistance **21.3%**
...
- `5c556c16ea8b` — 47248 candidats
  - AVEC connectivite (19176) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (28072) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 24336 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 24247 avec CONNECTED, 89 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 183676 systemes
  - sans CONNECTED : 0.0% sur 41262 systemes
