...
genere 2026-09-08 02:32 UTC — 448448 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 365104 systemes
...
- moteur actif `0caa9267db60` (404706 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 223384 | 110917 | 15224 | 7463 | 22607 | 17500 | 23804 | 23020 | 10.3% |
...
- candidats AVEC connectivite : 23147, dont T2 : 100%
...
- **24078 systemes avec CONNECTED sur 184913 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*52806 candidats sur 57096 portent les champs bruts (92%).*

- `5c556c16ea8b` — 46841 candidats
  - AVEC connectivite (19019) : resistance **41.2%**
...
- `5c556c16ea8b` — 46841 candidats
  - AVEC connectivite (19019) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 24167 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 24078 avec CONNECTED, 89 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 182412 systemes
  - sans CONNECTED : 0.0% sur 40972 systemes
