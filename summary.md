...
genere 2026-08-29 22:01 UTC — 197250 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 113906 systemes
...
- moteur actif `0caa9267db60` (153508 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 96547 | 47932 | 6565 | 3250 | 9734 | 7690 | 10189 | 9953 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 94588 | 22056 | 39955 | 43 | 13092 | 4859 | 37 | 14540 | 15.4% |
...
- candidats AVEC connectivite : 10080, dont T2 : 100%
...
- **10463 systemes avec CONNECTED sur 81250 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*20640 candidats sur 24930 portent les champs bruts (83%).*

- `5c556c16ea8b` — 14675 candidats
  - AVEC connectivite (5952) : resistance **41.2%**
...
- `5c556c16ea8b` — 14675 candidats
  - AVEC connectivite (5952) : T0=13.00 T1=0.00 T2=3.00 — pondere **6.00**
...
- TROP-CHER : 10510 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10463 avec CONNECTED, 47 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 78749 systemes
  - sans CONNECTED : 0.0% sur 17798 systemes
