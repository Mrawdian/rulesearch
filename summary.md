...
genere 2026-09-03 23:46 UTC — 350877 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 267533 systemes
...
- moteur actif `0caa9267db60` (307135 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 174114 | 86558 | 11828 | 5824 | 17733 | 13706 | 18440 | 17808 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 170648 | 39669 | 72101 | 70 | 23704 | 8829 | 67 | 26194 | 15.3% |
...
- candidats AVEC connectivite : 17935, dont T2 : 100%
- candidats SANS connectivite : 26504, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18714 systemes avec CONNECTED sur 144566 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*40149 candidats sur 44439 portent les champs bruts (90%).*

- `5c556c16ea8b` — 34184 candidats
  - AVEC connectivite (13807) : resistance **41.0%**
  - SANS connectivite (20377) : resistance **21.2%**
...
- `5c556c16ea8b` — 34184 candidats
  - AVEC connectivite (13807) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (20377) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
## cout
- temps total 108.8 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 18791 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18714 avec CONNECTED, 77 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 142065 systemes
  - sans CONNECTED : 0.0% sur 32049 systemes
