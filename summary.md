...
genere 2026-08-26 19:50 UTC — 61528 systemes evalues
...
- moteur actif `0caa9267db60` (17786 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 28004 | 13951 | 1915 | 945 | 2770 | 2219 | 2981 | 2873 | 10.3% |
...
- candidats AVEC connectivite : 3000, dont T2 : 100%
- candidats SANS connectivite : 4533, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3255 systemes avec CONNECTED sur 25420 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3243 candidats sur 7533 portent les champs bruts (43%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 374 candidats
  - AVEC connectivite (156) : resistance **39.1%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 374 candidats
  - AVEC connectivite (156) : T0=13.12 T1=0.00 T2=2.85 — pondere **5.71**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22919 systemes
  - sans CONNECTED : 0.0% sur 5085 systemes
