...
| connect | 4 | 3 | 7727 | 3885 | 509 | 267 | 738 | 616 | 812 | 812 | 10.5% |
| ref | 4 | 3 | 7538 | 1827 | 3152 | 1 | 1008 | 371 | 3 | 1176 | 15.6% |
...
- candidats AVEC connectivite : 815, dont T2 : 100%
...
- **812 systemes avec CONNECTED sur 6397 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 830 candidats
  - AVEC connectivite (336) : T0=13.39 T1=0.00 T2=2.87 — pondere **5.73**
...
- TROP-CHER : 815 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 812 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 6340 systemes
  - sans CONNECTED : 0.0% sur 1387 systemes
