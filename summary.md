...
genere 2026-08-25 21:33 UTC — 6016 systemes evalues

## versions du DSL presentes
- `615abe43d6bc` : 5039 systemes
...
| connect | 4 | 3 | 2985 | 1508 | 193 | 104 | 302 | 230 | 299 | 310 | 10.4% |
...
- candidats AVEC connectivite : 313, dont T2 : 100%
- candidats SANS connectivite : 464, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **299 systemes avec CONNECTED sur 2497 (12.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- TROP-CHER : 300 systemes abandonnes (5.0% des systemes), 95% du temps total
  dont 299 avec CONNECTED, 1 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.3% sur 2440 systemes
  - sans CONNECTED : 0.0% sur 545 systemes
