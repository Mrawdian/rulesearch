...
| connect | 4 | 3 | 18127 | 9063 | 1178 | 631 | 1799 | 1437 | 1969 | 1824 | 10.1% |
...
- candidats AVEC connectivite : 1951, dont T2 : 100%
- candidats SANS connectivite : 3039, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2243 systemes avec CONNECTED sur 17307 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*700 candidats sur 4990 portent les champs bruts (14%).*
...
- `e3baecf8377b` — 436 candidats
  - AVEC connectivite (168) : resistance **44.0%**
...
- `e3baecf8377b` — 436 candidats
  - AVEC connectivite (168) : T0=12.97 T1=0.00 T2=3.21 — pondere **6.43**
...
- TROP-CHER : 2260 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2243 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14806 systemes
  - sans CONNECTED : 0.0% sur 3321 systemes
