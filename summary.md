...
genere 2026-08-31 04:40 UTC — 241155 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 157811 systemes
...
- moteur actif `0caa9267db60` (197413 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 118720 | 59067 | 8072 | 3982 | 11917 | 9351 | 12565 | 12219 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 116320 | 27149 | 49162 | 53 | 16056 | 6003 | 52 | 17835 | 15.3% |
...
- candidats AVEC connectivite : 12346, dont T2 : 100%
- candidats SANS connectivite : 18145, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12839 systemes avec CONNECTED sur 99465 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*26201 candidats sur 30491 portent les champs bruts (86%).*

- `5c556c16ea8b` — 20236 candidats
  - AVEC connectivite (8218) : resistance **40.9%**
  - SANS connectivite (12018) : resistance **21.4%**
...
- `5c556c16ea8b` — 20236 candidats
  - AVEC connectivite (8218) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (12018) : T0=15.90 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 12901 systemes abandonnes (5.3% des systemes), 96% du temps total
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 96964 systemes
  - sans CONNECTED : 0.0% sur 21756 systemes
