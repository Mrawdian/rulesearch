...
| connect | 4 | 3 | 18337 | 9159 | 1193 | 638 | 1828 | 1453 | 1990 | 1847 | 10.1% |
...
- candidats AVEC connectivite : 1974, dont T2 : 100%
- candidats SANS connectivite : 3062, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2264 systemes avec CONNECTED sur 17475 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*746 candidats sur 5036 portent les champs bruts (15%).*
...
- `e3baecf8377b` — 482 candidats
  - AVEC connectivite (191) : resistance **42.8%**
...
- `e3baecf8377b` — 482 candidats
  - AVEC connectivite (191) : T0=13.01 T1=0.00 T2=3.13 — pondere **6.25**
...
- TROP-CHER : 2281 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2264 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14974 systemes
  - sans CONNECTED : 0.0% sur 3363 systemes
