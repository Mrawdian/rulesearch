...
genere 2026-08-26 13:34 UTC — 46911 systemes evalues
...
- moteur actif `0caa9267db60` (3169 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20618 | 10283 | 1360 | 716 | 2055 | 1639 | 2200 | 2110 | 10.2% |
...
- candidats AVEC connectivite : 2237, dont T2 : 100%
- candidats SANS connectivite : 3381, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2474 systemes avec CONNECTED sur 19333 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1328 candidats sur 5618 portent les champs bruts (24%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 213 candidats
  - AVEC connectivite (99) : resistance **38.7%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 213 candidats
  - AVEC connectivite (99) : T0=13.52 T1=0.00 T2=2.78 — pondere **5.56**
  - SANS connectivite (114) : T0=16.13 T1=0.00 T2=2.87 — pondere **5.74**
  - test de permutation : **p = 0.6622** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
- TROP-CHER : 2491 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2474 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16832 systemes
  - sans CONNECTED : 0.0% sur 3786 systemes
