...
genere 2026-08-31 02:52 UTC — 238568 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 155224 systemes
...
- moteur actif `0caa9267db60` (194826 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 117417 | 58398 | 7971 | 3939 | 11805 | 9253 | 12441 | 12075 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 115036 | 26847 | 48621 | 53 | 15872 | 5943 | 52 | 17638 | 15.3% |
...
- candidats AVEC connectivite : 12202, dont T2 : 100%
- candidats SANS connectivite : 17948, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12715 systemes avec CONNECTED sur 98385 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*25860 candidats sur 30150 portent les champs bruts (86%).*

- `5c556c16ea8b` — 19895 candidats
  - AVEC connectivite (8074) : resistance **41.0%**
  - SANS connectivite (11821) : resistance **21.4%**
...
- `5c556c16ea8b` — 19895 candidats
  - AVEC connectivite (8074) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.97**
  - SANS connectivite (11821) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 95884 systemes
  - sans CONNECTED : 0.0% sur 21533 systemes
