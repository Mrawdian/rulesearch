...
genere 2026-08-31 05:40 UTC — 242457 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 159113 systemes
...
- moteur actif `0caa9267db60` (198715 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 119379 | 59395 | 8114 | 4000 | 11977 | 9411 | 12641 | 12289 | 10.3% |
...
- candidats AVEC connectivite : 12416, dont T2 : 100%
...
- **12915 systemes avec CONNECTED sur 99999 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*26364 candidats sur 30654 portent les champs bruts (86%).*

- `5c556c16ea8b` — 20399 candidats
  - AVEC connectivite (8288) : resistance **40.9%**
...
- `5c556c16ea8b` — 20399 candidats
  - AVEC connectivite (8288) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 12977 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 12915 avec CONNECTED, 62 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 97498 systemes
  - sans CONNECTED : 0.0% sur 21881 systemes
