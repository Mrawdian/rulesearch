...
genere 2026-08-26 03:02 UTC — 19929 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 10955 systemes
...
| connect | 4 | 3 | 10015 | 5041 | 655 | 347 | 955 | 799 | 1076 | 1015 | 10.1% |
| ref | 4 | 3 | 9790 | 2342 | 4128 | 3 | 1297 | 497 | 4 | 1519 | 15.5% |
...
- candidats AVEC connectivite : 1018, dont T2 : 100%
- candidats SANS connectivite : 1523, dont T2 : 100%
...
- **1076 systemes avec CONNECTED sur 8280 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1376 candidats
  - AVEC connectivite (539) : T0=13.35 T1=0.00 T2=2.88 — pondere **5.77**
  - SANS connectivite (837) : T0=15.82 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 1080 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 1076 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 8223 systemes
  - sans CONNECTED : 0.0% sur 1792 systemes
