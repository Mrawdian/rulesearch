...
| connect | 4 | 3 | 18651 | 9305 | 1212 | 645 | 1865 | 1487 | 2021 | 1886 | 10.1% |
...
- candidats AVEC connectivite : 2013, dont T2 : 100%
- candidats SANS connectivite : 3114, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2295 systemes avec CONNECTED sur 17717 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*837 candidats sur 5127 portent les champs bruts (16%).*
...
- `e3baecf8377b` — 573 candidats
  - AVEC connectivite (230) : resistance **42.0%**
...
- `e3baecf8377b` — 573 candidats
  - AVEC connectivite (230) : T0=13.15 T1=0.00 T2=3.08 — pondere **6.16**
...
- TROP-CHER : 2312 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 2295 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 15216 systemes
  - sans CONNECTED : 0.0% sur 3435 systemes
