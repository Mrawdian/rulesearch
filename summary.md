...
genere 2026-09-05 09:08 UTC — 385977 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 302633 systemes
...
- moteur actif `0caa9267db60` (342235 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 191824 | 95264 | 13060 | 6379 | 19509 | 15113 | 20337 | 19712 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 188038 | 43758 | 79392 | 77 | 26152 | 9734 | 70 | 28841 | 15.3% |
...
- candidats AVEC connectivite : 19839, dont T2 : 100%
- candidats SANS connectivite : 29151, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20611 systemes avec CONNECTED sur 158989 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*44700 candidats sur 48990 portent les champs bruts (91%).*

- `5c556c16ea8b` — 38735 candidats
  - AVEC connectivite (15711) : resistance **41.1%**
  - SANS connectivite (23024) : resistance **21.3%**
...
- `5c556c16ea8b` — 38735 candidats
  - AVEC connectivite (15711) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (23024) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
## cout
- temps total 119.8 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 20691 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 20611 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 156488 systemes
  - sans CONNECTED : 0.0% sur 35336 systemes
