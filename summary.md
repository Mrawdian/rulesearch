...
genere 2026-08-26 18:32 UTC — 58564 systemes evalues
...
- moteur actif `0caa9267db60` (14822 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 26508 | 13216 | 1808 | 895 | 2628 | 2095 | 2824 | 2715 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 25941 | 5964 | 11003 | 15 | 3618 | 1330 | 10 | 4001 | 15.4% |
...
- candidats AVEC connectivite : 2842, dont T2 : 100%
- candidats SANS connectivite : 4311, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3098 systemes avec CONNECTED sur 24182 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2863 candidats sur 7153 portent les champs bruts (40%).*
...
- `0a74109317e5` — 80 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `8f22f0d2d442` — 59 candidats
  - AVEC connectivite (19) : resistance **41.9%**
  - SANS connectivite (40) : resistance **19.0%**
...
- `8f22f0d2d442` — 59 candidats
  - AVEC connectivite (19) : T0=13.42 T1=0.00 T2=2.79 — pondere **5.58**
  - SANS connectivite (40) : T0=16.07 T1=0.00 T2=2.52 — pondere **5.05**
...
- TROP-CHER : 3118 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3098 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 21681 systemes
  - sans CONNECTED : 0.0% sur 4827 systemes
