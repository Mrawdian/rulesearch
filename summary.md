...
genere 2026-08-28 00:40 UTC — 121220 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 37876 systemes
...
- moteur actif `0caa9267db60` (77478 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 58138 | 28963 | 4022 | 1963 | 5773 | 4592 | 6128 | 5952 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 56967 | 13148 | 24173 | 28 | 7915 | 2949 | 26 | 8726 | 15.3% |
...
- candidats AVEC connectivite : 6079, dont T2 : 100%
- candidats SANS connectivite : 9036, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6402 systemes avec CONNECTED sur 49988 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10825 candidats sur 15115 portent les champs bruts (72%).*

- `5c556c16ea8b` — 4860 candidats
  - AVEC connectivite (1951) : resistance **42.1%**
  - SANS connectivite (2909) : resistance **22.4%**
...
- `5c556c16ea8b` — 4860 candidats
  - AVEC connectivite (1951) : T0=12.98 T1=0.00 T2=3.06 — pondere **6.11**
  - SANS connectivite (2909) : T0=15.84 T1=0.00 T2=2.72 — pondere **5.43**
...
## cout
- temps total 37.4 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 6438 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6402 avec CONNECTED, 36 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 47487 systemes
  - sans CONNECTED : 0.0% sur 10651 systemes
