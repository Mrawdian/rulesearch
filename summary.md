...
genere 2026-09-07 00:33 UTC — 424541 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 341197 systemes
...
- moteur actif `0caa9267db60` (380799 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 211310 | 104914 | 14394 | 7040 | 21431 | 16612 | 22459 | 21780 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 207116 | 48152 | 87385 | 80 | 28866 | 10692 | 73 | 31850 | 15.4% |
...
- candidats SANS connectivite : 32160, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **22733 systemes avec CONNECTED sur 174952 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*49777 candidats sur 54067 portent les champs bruts (92%).*

- `5c556c16ea8b` — 43812 candidats
  - AVEC connectivite (17779) : resistance **41.1%**
  - SANS connectivite (26033) : resistance **21.3%**
...
- `5c556c16ea8b` — 43812 candidats
  ...
  - SANS connectivite (26033) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 22816 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 22733 avec CONNECTED, 83 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 172451 systemes
  - sans CONNECTED : 0.0% sur 38859 systemes
