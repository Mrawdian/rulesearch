...
genere 2026-08-28 14:43 UTC — 146398 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 63054 systemes
...
- moteur actif `0caa9267db60` (102656 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 70861 | 35206 | 4847 | 2407 | 7104 | 5654 | 7479 | 7259 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 69422 | 16110 | 29333 | 32 | 9613 | 3578 | 30 | 10723 | 15.4% |
...
- candidats AVEC connectivite : 7386, dont T2 : 100%
- candidats SANS connectivite : 11033, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7753 systemes avec CONNECTED sur 60302 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*14129 candidats sur 18419 portent les champs bruts (77%).*

- `5c556c16ea8b` — 8164 candidats
  - AVEC connectivite (3258) : resistance **41.2%**
  - SANS connectivite (4906) : resistance **21.8%**
...
- `5c556c16ea8b` — 8164 candidats
  - AVEC connectivite (3258) : T0=13.02 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (4906) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.36**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 57801 systemes
  - sans CONNECTED : 0.0% sur 13060 systemes
