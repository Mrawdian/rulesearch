...
genere 2026-08-27 04:44 UTC — 81278 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 16371 systemes
...
- moteur actif `0caa9267db60` (37536 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 37990 | 18904 | 2618 | 1295 | 3779 | 2980 | 4015 | 3905 | 10.3% |
...
- candidats AVEC connectivite : 4032, dont T2 : 100%
- candidats SANS connectivite : 5982, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4289 systemes avec CONNECTED sur 33594 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5724 candidats sur 10014 portent les champs bruts (57%).*
...
- `ab89a63b01ef` — 2047 candidats
  - AVEC connectivite (852) : resistance **41.4%**
...
- `ab89a63b01ef` — 2047 candidats
  - AVEC connectivite (852) : T0=13.04 T1=0.00 T2=3.03 — pondere **6.07**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 31093 systemes
  - sans CONNECTED : 0.0% sur 6897 systemes
