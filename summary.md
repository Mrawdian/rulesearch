...
genere 2026-08-28 14:24 UTC — 145789 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 62445 systemes
...
- moteur actif `0caa9267db60` (102047 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 70546 | 35047 | 4818 | 2396 | 7079 | 5623 | 7453 | 7227 | 10.2% |
...
- candidats AVEC connectivite : 7354, dont T2 : 100%
...
- **7727 systemes avec CONNECTED sur 60046 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*14048 candidats sur 18338 portent les champs bruts (77%).*

- `5c556c16ea8b` — 8083 candidats
  - AVEC connectivite (3226) : resistance **41.2%**
...
- `5c556c16ea8b` — 8083 candidats
  - AVEC connectivite (3226) : T0=13.02 T1=0.00 T2=3.00 — pondere **6.00**
...
- TROP-CHER : 7767 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7727 avec CONNECTED, 40 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 57545 systemes
  - sans CONNECTED : 0.0% sur 13001 systemes
