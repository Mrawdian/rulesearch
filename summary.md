...
genere 2026-08-26 07:25 UTC — 30862 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 21888 systemes
...
| connect | 4 | 3 | 14387 | 7189 | 940 | 498 | 1409 | 1143 | 1571 | 1451 | 10.1% |
...
- candidats AVEC connectivite : 1487, dont T2 : 100%
- candidats SANS connectivite : 2281, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1678 systemes avec CONNECTED sur 12767 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2603 candidats
  - AVEC connectivite (1008) : T0=13.19 T1=0.00 T2=2.88 — pondere **5.77**
...
- TROP-CHER : 1687 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1678 avec CONNECTED, 9 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 11777 systemes
  - sans CONNECTED : 0.0% sur 2610 systemes
