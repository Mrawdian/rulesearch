...
genere 2026-08-27 01:13 UTC — 73368 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 9167 systemes
- `ab89a63b01ef` : 8461 systemes
...
- moteur actif `0caa9267db60` (29626 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 33987 | 16906 | 2335 | 1153 | 3370 | 2699 | 3624 | 3467 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 33266 | 7667 | 14133 | 20 | 4621 | 1736 | 17 | 5072 | 15.2% |
...
- candidats AVEC connectivite : 3594, dont T2 : 100%
- candidats SANS connectivite : 5382, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3898 systemes avec CONNECTED sur 30307 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4686 candidats sur 8976 portent les champs bruts (52%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 1009 candidats
  - AVEC connectivite (414) : resistance **40.9%**
  - SANS connectivite (595) : resistance **21.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 1009 candidats
  - AVEC connectivite (414) : T0=13.08 T1=0.00 T2=3.03 — pondere **6.07**
  - SANS connectivite (595) : T0=15.89 T1=0.00 T2=2.65 — pondere **5.30**
...
**6 serie(s) reproductible(s) sur 13 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0005), `ab89a63b01ef` (p=0.0010), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
...
- TROP-CHER : 3925 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3898 avec CONNECTED, 27 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 27806 systemes
  - sans CONNECTED : 0.0% sur 6181 systemes
