...
genere 2026-08-28 09:52 UTC — 138032 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 54688 systemes
...
- moteur actif `0caa9267db60` (94290 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 66636 | 33102 | 4568 | 2264 | 6669 | 5317 | 7017 | 6843 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 65281 | 15094 | 27595 | 30 | 9098 | 3377 | 28 | 10056 | 15.4% |
...
- candidats SANS connectivite : 10366, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7291 systemes avec CONNECTED sur 56865 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*13046 candidats sur 17336 portent les champs bruts (75%).*

- `5c556c16ea8b` — 7081 candidats
  - AVEC connectivite (2842) : resistance **41.4%**
  - SANS connectivite (4239) : resistance **21.8%**
...
- `5c556c16ea8b` — 7081 candidats
  ...
  - SANS connectivite (4239) : T0=15.87 T1=0.00 T2=2.68 — pondere **5.35**
...
- TROP-CHER : 7329 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7291 avec CONNECTED, 38 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 54364 systemes
  - sans CONNECTED : 0.0% sur 12272 systemes
