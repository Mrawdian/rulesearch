...
genere 2026-08-28 10:20 UTC — 138860 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 55516 systemes
...
- moteur actif `0caa9267db60` (95118 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 67054 | 33313 | 4602 | 2285 | 6716 | 5348 | 7062 | 6870 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 65691 | 15190 | 27782 | 30 | 9151 | 3392 | 28 | 10115 | 15.4% |
...
- candidats AVEC connectivite : 6997, dont T2 : 100%
- candidats SANS connectivite : 10425, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7336 systemes avec CONNECTED sur 57197 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*13132 candidats sur 17422 portent les champs bruts (75%).*

- `5c556c16ea8b` — 7167 candidats
  - AVEC connectivite (2869) : resistance **41.4%**
  - SANS connectivite (4298) : resistance **21.7%**
...
- `5c556c16ea8b` — 7167 candidats
  - AVEC connectivite (2869) : T0=12.99 T1=0.00 T2=3.01 — pondere **6.03**
  - SANS connectivite (4298) : T0=15.86 T1=0.00 T2=2.67 — pondere **5.35**
...
- TROP-CHER : 7374 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7336 avec CONNECTED, 38 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 54696 systemes
  - sans CONNECTED : 0.0% sur 12358 systemes
