...
genere 2026-08-26 10:45 UTC — 39529 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `615abe43d6bc` : 7172 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
- `e3baecf8377b` : 936 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
**8402 enregistrements (21%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 16886 | 8430 | 1086 | 584 | 1679 | 1345 | 1843 | 1707 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 16528 | 3889 | 7007 | 11 | 2253 | 834 | 7 | 2527 | 15.3% |
...
- candidats SANS connectivite : 2837, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2117 systemes avec CONNECTED sur 16303 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*381 candidats sur 4671 portent les champs bruts (8%).*
...
- `e3baecf8377b` — 117 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (51) : resistance **40.5%**
  - SANS connectivite (66) : resistance **19.8%**
...
- `e3baecf8377b` — 117 candidats
  - AVEC connectivite (51) : T0=13.53 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (66) : T0=15.76 T1=0.00 T2=2.50 — pondere **5.00**
...
- TROP-CHER : 2134 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2117 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.4% sur 13802 systemes
  - sans CONNECTED : 0.0% sur 3084 systemes
