...
genere 2026-08-30 20:04 UTC — 229304 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 145960 systemes
...
- moteur actif `0caa9267db60` (185562 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 112740 | 56065 | 7658 | 3773 | 11324 | 8920 | 11925 | 11603 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 110449 | 25752 | 46668 | 51 | 15237 | 5708 | 45 | 16978 | 15.4% |
...
- candidats AVEC connectivite : 11730, dont T2 : 100%
- candidats SANS connectivite : 17288, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12199 systemes avec CONNECTED sur 94526 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*24728 candidats sur 29018 portent les champs bruts (85%).*

- `5c556c16ea8b` — 18763 candidats
  - AVEC connectivite (7602) : resistance **41.1%**
  - SANS connectivite (11161) : resistance **21.4%**
...
- `5c556c16ea8b` — 18763 candidats
  - AVEC connectivite (7602) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (11161) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
## cout
- temps total 71.0 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 12254 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 12199 avec CONNECTED, 55 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 92025 systemes
  - sans CONNECTED : 0.0% sur 20715 systemes
