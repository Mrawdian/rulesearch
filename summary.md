...
genere 2026-08-31 11:35 UTC — 250527 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 167183 systemes
...
- moteur actif `0caa9267db60` (206785 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 123453 | 61401 | 8370 | 4139 | 12433 | 9740 | 13045 | 12713 | 10.3% |
...
- candidats AVEC connectivite : 12840, dont T2 : 100%
...
- **13319 systemes avec CONNECTED sur 103270 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*27426 candidats sur 31716 portent les champs bruts (86%).*

- `5c556c16ea8b` — 21461 candidats
  - AVEC connectivite (8712) : resistance **40.9%**
...
- `5c556c16ea8b` — 21461 candidats
  - AVEC connectivite (8712) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 13384 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13319 avec CONNECTED, 65 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 100769 systemes
  - sans CONNECTED : 0.0% sur 22684 systemes
