...
genere 2026-08-26 23:44 UTC — 70147 systemes evalues
...
- moteur actif `0caa9267db60` (26405 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 31662 | 7305 | 13445 | 18 | 4382 | 1654 | 14 | 4844 | 15.3% |
...
- candidats SANS connectivite : 5154, dont T2 : 100%
...
*4292 candidats sur 8582 portent les champs bruts (50%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 615 candidats
  - AVEC connectivite (248) : resistance **42.3%**
  - SANS connectivite (367) : resistance **21.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 615 candidats
  ...
  - SANS connectivite (367) : T0=15.92 T1=0.00 T2=2.63 — pondere **5.26**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e3baecf8377b` — 657 candidats
