...
genere 2026-08-28 03:40 UTC — 127118 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 43774 systemes
...
- moteur actif `0caa9267db60` (83376 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 61126 | 30403 | 4226 | 2063 | 6089 | 4861 | 6408 | 6289 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 59877 | 13860 | 25362 | 28 | 8332 | 3095 | 26 | 9172 | 15.3% |
...
- candidats AVEC connectivite : 6416, dont T2 : 100%
- candidats SANS connectivite : 9482, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6682 systemes avec CONNECTED sur 52377 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11608 candidats sur 15898 portent les champs bruts (73%).*

- `5c556c16ea8b` — 5643 candidats
  - AVEC connectivite (2288) : resistance **41.8%**
  - SANS connectivite (3355) : resistance **22.1%**
...
- `5c556c16ea8b` — 5643 candidats
  - AVEC connectivite (2288) : T0=12.98 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (3355) : T0=15.86 T1=0.00 T2=2.70 — pondere **5.39**
...
- TROP-CHER : 6718 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6682 avec CONNECTED, 36 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 49876 systemes
  - sans CONNECTED : 0.0% sur 11250 systemes
