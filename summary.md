...
genere 2026-09-02 06:54 UTC — 304671 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 221327 systemes
...
- moteur actif `0caa9267db60` (260929 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 150770 | 74907 | 10255 | 5054 | 15301 | 11870 | 15962 | 15494 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 147786 | 34415 | 62522 | 62 | 20448 | 7622 | 63 | 22642 | 15.3% |
...
- candidats SANS connectivite : 22952, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16236 systemes avec CONNECTED sur 125575 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*34283 candidats sur 38573 portent les champs bruts (89%).*

- `5c556c16ea8b` — 28318 candidats
  - AVEC connectivite (11493) : resistance **41.1%**
  - SANS connectivite (16825) : resistance **21.3%**
...
- `5c556c16ea8b` — 28318 candidats
  ...
  - SANS connectivite (16825) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 123074 systemes
  - sans CONNECTED : 0.0% sur 27696 systemes
