...
genere 2026-08-28 13:44 UTC — 144663 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 61319 systemes
...
- moteur actif `0caa9267db60` (100921 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 69978 | 34769 | 4781 | 2371 | 7025 | 5592 | 7389 | 7155 | 10.2% |
...
- candidats AVEC connectivite : 7282, dont T2 : 100%
...
- **7663 systemes avec CONNECTED sur 59564 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*13895 candidats sur 18185 portent les champs bruts (76%).*

- `5c556c16ea8b` — 7930 candidats
  - AVEC connectivite (3154) : resistance **41.2%**
...
- `5c556c16ea8b` — 7930 candidats
  - AVEC connectivite (3154) : T0=13.00 T1=0.00 T2=3.00 — pondere **6.00**
...
- TROP-CHER : 7703 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7663 avec CONNECTED, 40 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 57063 systemes
  - sans CONNECTED : 0.0% sur 12915 systemes
