...
genere 2026-08-31 15:46 UTC — 256235 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 172891 systemes
...
- moteur actif `0caa9267db60` (212493 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 126337 | 62815 | 8548 | 4234 | 12771 | 9993 | 13321 | 12999 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 123783 | 28851 | 52264 | 55 | 17152 | 6396 | 56 | 18999 | 15.3% |
...
- candidats SANS connectivite : 19309, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13595 systemes avec CONNECTED sur 105579 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*28145 candidats sur 32435 portent les champs bruts (87%).*

- `5c556c16ea8b` — 22180 candidats
  - AVEC connectivite (8998) : resistance **41.0%**
  - SANS connectivite (13182) : resistance **21.4%**
...
- `5c556c16ea8b` — 22180 candidats
  ...
  - SANS connectivite (13182) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 13661 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13595 avec CONNECTED, 66 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 103078 systemes
  - sans CONNECTED : 0.0% sur 23259 systemes
