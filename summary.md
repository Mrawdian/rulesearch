...
genere 2026-08-26 14:20 UTC — 48628 systemes evalues
...
- moteur actif `0caa9267db60` (4886 systemes) : `06fe04a859f1`, `e40600351a72`
...
| ref | 4 | 3 | 21027 | 4907 | 8866 | 13 | 2913 | 1085 | 7 | 3236 | 15.4% |
...
- candidats SANS connectivite : 3546, dont T2 : 100%
...
*1579 candidats sur 5869 portent les champs bruts (27%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 464 candidats
  - AVEC connectivite (185) : resistance **40.4%**
  - SANS connectivite (279) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 464 candidats
  ...
  - SANS connectivite (279) : T0=16.11 T1=0.00 T2=2.66 — pondere **5.33**
  - test de permutation : **p = 0.0300** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e40600351a72` — 194 candidats
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0300).
