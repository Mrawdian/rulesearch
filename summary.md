...
genere 2026-08-30 18:51 UTC — 227565 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 144221 systemes
...
- moteur actif `0caa9267db60` (183823 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 111872 | 55626 | 7599 | 3734 | 11250 | 8854 | 11833 | 11522 | 10.3% |
...
- candidats AVEC connectivite : 11649, dont T2 : 100%
...
- **12107 systemes avec CONNECTED sur 93811 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*24529 candidats sur 28819 portent les champs bruts (85%).*

- `5c556c16ea8b` — 18564 candidats
  - AVEC connectivite (7521) : resistance **41.1%**
...
- `5c556c16ea8b` — 18564 candidats
  - AVEC connectivite (7521) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.98**
...
- TROP-CHER : 12162 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 12107 avec CONNECTED, 55 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 91310 systemes
  - sans CONNECTED : 0.0% sur 20562 systemes
