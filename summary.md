...
genere 2026-09-01 08:07 UTC — 277048 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 193704 systemes
...
- moteur actif `0caa9267db60` (233306 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 136842 | 68000 | 9259 | 4572 | 13881 | 10814 | 14459 | 14082 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 134091 | 31256 | 56651 | 58 | 18590 | 6942 | 60 | 20524 | 15.3% |
...
- candidats AVEC connectivite : 14209, dont T2 : 100%
- candidats SANS connectivite : 20834, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14733 systemes avec CONNECTED sur 114151 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*30753 candidats sur 35043 portent les champs bruts (88%).*

- `5c556c16ea8b` — 24788 candidats
  - AVEC connectivite (10081) : resistance **41.0%**
  - SANS connectivite (14707) : resistance **21.3%**
...
- `5c556c16ea8b` — 24788 candidats
  - AVEC connectivite (10081) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (14707) : T0=15.93 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 111650 systemes
  - sans CONNECTED : 0.0% sur 25192 systemes
