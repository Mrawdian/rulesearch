...
genere 2026-09-01 18:16 UTC — 289607 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 206263 systemes
...
- moteur actif `0caa9267db60` (245865 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 143185 | 71140 | 9714 | 4789 | 14545 | 11298 | 15129 | 14721 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 140307 | 32626 | 59354 | 59 | 19448 | 7253 | 63 | 21493 | 15.3% |
...
- candidats AVEC connectivite : 14848, dont T2 : 100%
- candidats SANS connectivite : 21803, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15403 systemes avec CONNECTED sur 119333 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*32361 candidats sur 36651 portent les champs bruts (88%).*

- `5c556c16ea8b` — 26396 candidats
  - AVEC connectivite (10720) : resistance **41.0%**
  - SANS connectivite (15676) : resistance **21.3%**
...
- `5c556c16ea8b` — 26396 candidats
  - AVEC connectivite (10720) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (15676) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
## cout
- temps total 89.7 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 15476 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15403 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 116832 systemes
  - sans CONNECTED : 0.0% sur 26353 systemes
