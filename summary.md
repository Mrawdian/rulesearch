...
genere 2026-08-26 18:59 UTC — 59791 systemes evalues
...
- moteur actif `0caa9267db60` (16049 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27120 | 13534 | 1845 | 912 | 2690 | 2148 | 2875 | 2777 | 10.2% |
...
- candidats AVEC connectivite : 2904, dont T2 : 100%
- candidats SANS connectivite : 4396, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3149 systemes avec CONNECTED sur 24679 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3010 candidats sur 7300 portent les champs bruts (41%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 141 candidats
  - AVEC connectivite (60) : resistance **41.3%**
...
- `62448a55927e` — 141 candidats
  - AVEC connectivite (60) : T0=13.07 T1=0.00 T2=2.98 — pondere **5.97**
...
- TROP-CHER : 3169 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3149 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22178 systemes
  - sans CONNECTED : 0.0% sur 4942 systemes
