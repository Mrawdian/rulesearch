...
genere 2026-08-29 05:02 UTC — 170989 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 87645 systemes
...
- moteur actif `0caa9267db60` (127247 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 83274 | 41452 | 5665 | 2813 | 8357 | 6614 | 8733 | 8581 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 81600 | 18992 | 34544 | 39 | 11290 | 4148 | 34 | 12548 | 15.4% |
...
- candidats AVEC connectivite : 8708, dont T2 : 100%
- candidats SANS connectivite : 12858, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9007 systemes avec CONNECTED sur 70451 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*17276 candidats sur 21566 portent les champs bruts (80%).*

- `5c556c16ea8b` — 11311 candidats
  - AVEC connectivite (4580) : resistance **41.2%**
  - SANS connectivite (6731) : resistance **21.7%**
...
- `5c556c16ea8b` — 11311 candidats
  - AVEC connectivite (4580) : T0=13.01 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (6731) : T0=15.90 T1=0.00 T2=2.67 — pondere **5.34**
...
- TROP-CHER : 9051 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 9007 avec CONNECTED, 44 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 67950 systemes
  - sans CONNECTED : 0.0% sur 15324 systemes
