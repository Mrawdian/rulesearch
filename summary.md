...
genere 2026-08-27 06:58 UTC — 86136 systemes evalues
...
- moteur actif `0caa9267db60` (42394 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 40433 | 20134 | 2766 | 1377 | 4043 | 3181 | 4261 | 4149 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 39588 | 9124 | 16830 | 22 | 5492 | 2069 | 21 | 6030 | 15.2% |
...
- candidats AVEC connectivite : 4276, dont T2 : 100%
- candidats SANS connectivite : 6340, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4535 systemes avec CONNECTED sur 35548 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6326 candidats sur 10616 portent les champs bruts (60%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 361 candidats
  - AVEC connectivite (148) : resistance **42.0%**
  - SANS connectivite (213) : resistance **21.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 361 candidats
  - AVEC connectivite (148) : T0=13.06 T1=0.00 T2=3.08 — pondere **6.16**
  - SANS connectivite (213) : T0=15.81 T1=0.00 T2=2.67 — pondere **5.34**
  - test de permutation : **p = 0.0170** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `23303c299f39` — 225 candidats
...
**7 serie(s) reproductible(s) sur 14 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `ab89a63b01ef` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `5c556c16ea8b` (p=0.0170), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 33047 systemes
  - sans CONNECTED : 0.0% sur 7386 systemes
