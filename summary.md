...
genere 2026-09-05 21:16 UTC — 398081 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 314737 systemes
...
- moteur actif `0caa9267db60` (354339 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 197949 | 98264 | 13479 | 6599 | 20118 | 15587 | 21015 | 20368 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 194017 | 45149 | 81857 | 78 | 27029 | 10019 | 71 | 29799 | 15.4% |
...
- candidats SANS connectivite : 30109, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21289 systemes avec CONNECTED sur 163979 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*46314 candidats sur 50604 portent les champs bruts (92%).*

- `5c556c16ea8b` — 40349 candidats
  - AVEC connectivite (16367) : resistance **41.1%**
  - SANS connectivite (23982) : resistance **21.3%**
...
- `5c556c16ea8b` — 40349 candidats
  ...
  - SANS connectivite (23982) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 21370 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21289 avec CONNECTED, 81 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 161478 systemes
  - sans CONNECTED : 0.0% sur 36471 systemes
