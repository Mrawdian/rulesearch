...
genere 2026-09-04 11:48 UTC — 363790 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 280446 systemes
...
- moteur actif `0caa9267db60` (320048 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 180628 | 89762 | 12280 | 6039 | 18378 | 14223 | 19139 | 18502 | 10.2% |
...
- candidats AVEC connectivite : 18629, dont T2 : 100%
...
- **19413 systemes avec CONNECTED sur 149865 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*41835 candidats sur 46125 portent les champs bruts (91%).*

- `5c556c16ea8b` — 35870 candidats
  - AVEC connectivite (14501) : resistance **41.0%**
...
- `5c556c16ea8b` — 35870 candidats
  - AVEC connectivite (14501) : T0=13.03 T1=0.00 T2=2.97 — pondere **5.95**
...
- TROP-CHER : 19493 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19413 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 147364 systemes
  - sans CONNECTED : 0.0% sur 33264 systemes
