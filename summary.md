...
genere 2026-08-26 23:26 UTC — 69471 systemes evalues
...
- moteur actif `0caa9267db60` (25729 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 32027 | 15916 | 2201 | 1075 | 3192 | 2553 | 3416 | 3268 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 31329 | 7219 | 13309 | 18 | 4334 | 1637 | 14 | 4798 | 15.3% |
...
- candidats SANS connectivite : 5108, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3690 systemes avec CONNECTED sur 28679 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4213 candidats sur 8503 portent les champs bruts (50%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 536 candidats
  - AVEC connectivite (215) : resistance **41.9%**
  - SANS connectivite (321) : resistance **22.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 536 candidats
  ...
  - SANS connectivite (321) : T0=16.02 T1=0.00 T2=2.67 — pondere **5.35**
...
**6 serie(s) reproductible(s) sur 13 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `ab89a63b01ef` (p=0.0025), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
...
- TROP-CHER : 3714 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3690 avec CONNECTED, 24 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 26178 systemes
  - sans CONNECTED : 0.0% sur 5849 systemes
