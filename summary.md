...
| connect | 4 | 3 | 5815 | 2924 | 373 | 211 | 559 | 472 | 604 | 602 | 10.4% |
...
- candidats AVEC connectivite : 605, dont T2 : 100%
...
- **604 systemes avec CONNECTED sur 4821 (12.5%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 343 candidats
  - AVEC connectivite (126) : T0=13.07 T1=0.00 T2=2.85 — pondere **5.70**
  - SANS connectivite (217) : T0=16.01 T1=0.00 T2=2.65 — pondere **5.31**
  - test de permutation : **p = 0.2644** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 606 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 604 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 4764 systemes
  - sans CONNECTED : 0.0% sur 1051 systemes
