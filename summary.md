...
genere 2026-08-26 10:05 UTC — 37910 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 28936 systemes
...
- candidats AVEC connectivite : 1748, dont T2 : 100%
- candidats SANS connectivite : 2731, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2027 systemes avec CONNECTED sur 15626 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*189 candidats sur 4479 portent les champs bruts (4%).*

- `89c65c03c4ad` — 189 candidats
  - AVEC connectivite (71) : resistance **47.7%**
...
- `89c65c03c4ad` — 3314 candidats
  - AVEC connectivite (1269) : T0=13.04 T1=0.00 T2=2.96 — pondere **5.93**
...
- TROP-CHER : 2044 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2027 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
