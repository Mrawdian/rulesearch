...
| connect | 4 | 3 | 6040 | 3044 | 389 | 220 | 578 | 483 | 627 | 627 | 10.4% |
| ref | 4 | 3 | 5890 | 1434 | 2451 | 1 | 787 | 289 | 2 | 926 | 15.7% |
...
- candidats AVEC connectivite : 630, dont T2 : 100%
...
- **627 systemes avec CONNECTED sur 5012 (12.5%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 395 candidats
  - AVEC connectivite (151) : T0=13.19 T1=0.00 T2=2.97 — pondere **5.95**
...
- TROP-CHER : 629 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 627 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 4955 systemes
  - sans CONNECTED : 0.0% sur 1085 systemes
