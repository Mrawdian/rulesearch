...
genere 2026-08-27 20:53 UTC — 113680 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 30336 systemes
...
- moteur actif `0caa9267db60` (69938 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 54332 | 27062 | 3754 | 1841 | 5362 | 4298 | 5756 | 5551 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 53233 | 12286 | 22628 | 26 | 7360 | 2763 | 25 | 8143 | 15.3% |
...
- candidats AVEC connectivite : 5678, dont T2 : 100%
- candidats SANS connectivite : 8453, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6030 systemes avec CONNECTED sur 46905 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*9841 candidats sur 14131 portent les champs bruts (70%).*

- `5c556c16ea8b` — 3876 candidats
  - AVEC connectivite (1550) : resistance **42.0%**
  - SANS connectivite (2326) : resistance **22.4%**
...
- `5c556c16ea8b` — 3876 candidats
  - AVEC connectivite (1550) : T0=12.94 T1=0.00 T2=3.05 — pondere **6.11**
  - SANS connectivite (2326) : T0=15.78 T1=0.00 T2=2.71 — pondere **5.41**
...
- TROP-CHER : 6065 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6030 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 44404 systemes
  - sans CONNECTED : 0.0% sur 9928 systemes
