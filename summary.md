...
genere 2026-09-07 04:01 UTC — 427787 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 344443 systemes
...
- moteur actif `0caa9267db60` (384045 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 212940 | 105719 | 14505 | 7083 | 21599 | 16743 | 22643 | 21940 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 208732 | 48595 | 88003 | 81 | 29096 | 10780 | 75 | 32084 | 15.4% |
...
- candidats AVEC connectivite : 22067, dont T2 : 100%
...
- **22917 systemes avec CONNECTED sur 176271 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*50171 candidats sur 54461 portent les champs bruts (92%).*

- `5c556c16ea8b` — 44206 candidats
  - AVEC connectivite (17939) : resistance **41.1%**
...
- `5c556c16ea8b` — 44206 candidats
  - AVEC connectivite (17939) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 23002 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 22917 avec CONNECTED, 85 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 173770 systemes
