...
genere 2026-09-09 01:04 UTC — 468811 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 385467 systemes
...
- moteur actif `0caa9267db60` (425069 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 233680 | 116055 | 15922 | 7821 | 23656 | 18306 | 24885 | 24073 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 229016 | 53337 | 96497 | 92 | 31918 | 11827 | 82 | 35244 | 15.4% |
...
- candidats AVEC connectivite : 24200, dont T2 : 100%
...
- **25159 systemes avec CONNECTED sur 193296 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55464 candidats sur 59754 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49499 candidats
  - AVEC connectivite (20072) : resistance **41.2%**
...
- `5c556c16ea8b` — 49499 candidats
  - AVEC connectivite (20072) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.97**
...
- TROP-CHER : 25251 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25159 avec CONNECTED, 92 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 190795 systemes
  - sans CONNECTED : 0.0% sur 42885 systemes
