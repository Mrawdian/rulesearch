...
genere 2026-09-08 21:53 UTC — 465906 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 382562 systemes
...
- moteur actif `0caa9267db60` (422164 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 232199 | 115345 | 15800 | 7773 | 23489 | 18188 | 24745 | 23912 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 227592 | 53016 | 95916 | 91 | 31701 | 11763 | 81 | 35006 | 15.4% |
...
- candidats SANS connectivite : 35316, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25019 systemes avec CONNECTED sur 192114 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55065 candidats sur 59355 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49100 candidats
  - AVEC connectivite (19911) : resistance **41.2%**
  - SANS connectivite (29189) : resistance **21.3%**
...
- `5c556c16ea8b` — 49100 candidats
  ...
  - SANS connectivite (29189) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 25110 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25019 avec CONNECTED, 91 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 189613 systemes
  - sans CONNECTED : 0.0% sur 42586 systemes
