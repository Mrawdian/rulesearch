...
genere 2026-08-28 13:40 UTC — 144545 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 61201 systemes
...
- moteur actif `0caa9267db60` (100803 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 69918 | 34736 | 4777 | 2370 | 7020 | 5587 | 7383 | 7150 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 68512 | 15892 | 28954 | 32 | 9490 | 3527 | 30 | 10584 | 15.4% |
...
- candidats AVEC connectivite : 7277, dont T2 : 100%
- candidats SANS connectivite : 10894, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7657 systemes avec CONNECTED sur 59514 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*13881 candidats sur 18171 portent les champs bruts (76%).*

- `5c556c16ea8b` — 7916 candidats
  - AVEC connectivite (3149) : resistance **41.3%**
  - SANS connectivite (4767) : resistance **21.7%**
...
- `5c556c16ea8b` — 7916 candidats
  - AVEC connectivite (3149) : T0=13.00 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (4767) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.35**
...
- TROP-CHER : 7697 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7657 avec CONNECTED, 40 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 57013 systemes
  - sans CONNECTED : 0.0% sur 12905 systemes
