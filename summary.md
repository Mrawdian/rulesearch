...
genere 2026-08-30 18:00 UTC — 226315 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 142971 systemes
...
- moteur actif `0caa9267db60` (182573 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 111243 | 55289 | 7552 | 3719 | 11196 | 8802 | 11774 | 11464 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 108957 | 25401 | 46006 | 50 | 15047 | 5634 | 45 | 16764 | 15.4% |
...
- candidats AVEC connectivite : 11591, dont T2 : 100%
- candidats SANS connectivite : 17074, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12048 systemes avec CONNECTED sur 93296 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*24375 candidats sur 28665 portent les champs bruts (85%).*

- `5c556c16ea8b` — 18410 candidats
  - AVEC connectivite (7463) : resistance **41.0%**
  - SANS connectivite (10947) : resistance **21.5%**
...
- `5c556c16ea8b` — 18410 candidats
  - AVEC connectivite (7463) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.97**
  - SANS connectivite (10947) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
## cout
- temps total 70.1 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 12103 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 12048 avec CONNECTED, 55 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 90795 systemes
  - sans CONNECTED : 0.0% sur 20448 systemes
