...
genere 2026-09-01 17:50 UTC — 289086 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 205742 systemes
...
- moteur actif `0caa9267db60` (245344 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 142915 | 71004 | 9692 | 4778 | 14522 | 11277 | 15100 | 14694 | 10.3% |
...
- candidats AVEC connectivite : 14821, dont T2 : 100%
...
- **15374 systemes avec CONNECTED sur 119113 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*32293 candidats sur 36583 portent les champs bruts (88%).*

- `5c556c16ea8b` — 26328 candidats
  - AVEC connectivite (10693) : resistance **41.0%**
...
- `5c556c16ea8b` — 26328 candidats
  - AVEC connectivite (10693) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 15447 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15374 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 116612 systemes
