...
genere 2026-08-27 06:04 UTC — 84148 systemes evalues
...
- moteur actif `0caa9267db60` (40406 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 39421 | 19625 | 2707 | 1345 | 3928 | 3104 | 4165 | 4036 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 38612 | 8907 | 16435 | 22 | 5343 | 2010 | 21 | 5874 | 15.2% |
...
- candidats SANS connectivite : 6184, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4439 systemes avec CONNECTED sur 34737 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6057 candidats sur 10347 portent les champs bruts (59%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 92 candidats
  - AVEC connectivite (35) : resistance **42.0%**
  - SANS connectivite (57) : resistance **22.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 92 candidats
  ...
  - SANS connectivite (57) : T0=15.47 T1=0.00 T2=2.56 — pondere **5.12**
...
- TROP-CHER : 4470 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4439 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 32236 systemes
  - sans CONNECTED : 0.0% sur 7185 systemes
