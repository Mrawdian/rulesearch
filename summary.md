...
genere 2026-08-26 18:55 UTC — 59615 systemes evalues
...
- moteur actif `0caa9267db60` (15873 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27032 | 13485 | 1841 | 911 | 2680 | 2141 | 2869 | 2767 | 10.2% |
...
- candidats AVEC connectivite : 2894, dont T2 : 100%
- candidats SANS connectivite : 4381, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3143 systemes avec CONNECTED sur 24610 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2985 candidats sur 7275 portent les champs bruts (41%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 116 candidats
  - AVEC connectivite (50) : resistance **43.3%**
...
- `62448a55927e` — 116 candidats
  - AVEC connectivite (50) : T0=13.06 T1=0.00 T2=3.04 — pondere **6.08**
...
**6 serie(s) reproductible(s) sur 12 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0060), `62448a55927e` (p=0.0400), `b71bb0907fb5` (p=0.0110).
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22109 systemes
  - sans CONNECTED : 0.0% sur 4923 systemes
