...
genere 2026-08-26 20:09 UTC — 62286 systemes evalues
...
- moteur actif `0caa9267db60` (18544 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 27778 | 6418 | 11771 | 15 | 3859 | 1426 | 12 | 4277 | 15.4% |
...
- candidats SANS connectivite : 4587, dont T2 : 100%
...
*3342 candidats sur 7632 portent les champs bruts (44%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 473 candidats
  - AVEC connectivite (201) : resistance **39.5%**
  - SANS connectivite (272) : resistance **19.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 473 candidats
  ...
  - SANS connectivite (272) : T0=16.13 T1=0.00 T2=2.59 — pondere **5.18**
  - test de permutation : **p = 0.0775** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
