...
genere 2026-09-06 15:38 UTC — 416025 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 332681 systemes
...
- moteur actif `0caa9267db60` (372283 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 207009 | 102781 | 14104 | 6889 | 20989 | 16282 | 21995 | 21334 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 202901 | 47171 | 85600 | 79 | 28284 | 10481 | 73 | 31196 | 15.4% |
...
- candidats AVEC connectivite : 21461, dont T2 : 100%
- candidats SANS connectivite : 31506, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **22269 systemes avec CONNECTED sur 171426 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*48677 candidats sur 52967 portent les champs bruts (92%).*

- `5c556c16ea8b` — 42712 candidats
  - AVEC connectivite (17333) : resistance **41.1%**
  - SANS connectivite (25379) : resistance **21.3%**
...
- `5c556c16ea8b` — 42712 candidats
  - AVEC connectivite (17333) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (25379) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 22352 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 22269 avec CONNECTED, 83 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 168925 systemes
  - sans CONNECTED : 0.0% sur 38084 systemes
