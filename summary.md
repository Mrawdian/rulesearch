...
genere 2026-09-03 18:07 UTC — 344558 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 261214 systemes
...
- moteur actif `0caa9267db60` (300816 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 170920 | 84973 | 11596 | 5727 | 17385 | 13484 | 18120 | 17459 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 167523 | 38970 | 70801 | 67 | 23231 | 8664 | 66 | 25712 | 15.3% |
...
- candidats AVEC connectivite : 17586, dont T2 : 100%
- candidats SANS connectivite : 26022, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18394 systemes avec CONNECTED sur 141961 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39318 candidats sur 43608 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33353 candidats
  - AVEC connectivite (13458) : resistance **41.0%**
  - SANS connectivite (19895) : resistance **21.2%**
...
- `5c556c16ea8b` — 33353 candidats
  - AVEC connectivite (13458) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (19895) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 18470 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18394 avec CONNECTED, 76 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 139460 systemes
  - sans CONNECTED : 0.0% sur 31460 systemes
