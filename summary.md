...
genere 2026-08-26 17:19 UTC — 55667 systemes evalues
...
- moteur actif `0caa9267db60` (11925 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
| connect | 4 | 3 | 25043 | 12500 | 1704 | 844 | 2477 | 1977 | 2677 | 2553 | 10.2% |
...
- candidats AVEC connectivite : 2680, dont T2 : 100%
- candidats SANS connectivite : 4089, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2951 systemes avec CONNECTED sur 22976 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2479 candidats sur 6769 portent les champs bruts (37%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 169 candidats
  - AVEC connectivite (66) : resistance **42.8%**
...
- `23303c299f39` — 169 candidats
  - AVEC connectivite (66) : T0=12.79 T1=0.00 T2=3.09 — pondere **6.18**
  - SANS connectivite (103) : T0=16.04 T1=0.00 T2=2.62 — pondere **5.24**
  - test de permutation : **p = 0.0700** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 20475 systemes
  - sans CONNECTED : 0.0% sur 4568 systemes
