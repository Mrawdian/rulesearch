...
genere 2026-08-28 17:14 UTC — 150657 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 67313 systemes
...
- moteur actif `0caa9267db60` (106915 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 72996 | 36244 | 4985 | 2493 | 7324 | 5813 | 7715 | 7489 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 71546 | 16634 | 30230 | 33 | 9883 | 3687 | 31 | 11045 | 15.4% |
...
- candidats AVEC connectivite : 7616, dont T2 : 100%
- candidats SANS connectivite : 11355, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7989 systemes avec CONNECTED sur 62051 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*14681 candidats sur 18971 portent les champs bruts (77%).*

- `5c556c16ea8b` — 8716 candidats
  - AVEC connectivite (3488) : resistance **41.1%**
  - SANS connectivite (5228) : resistance **21.7%**
...
- `5c556c16ea8b` — 8716 candidats
  - AVEC connectivite (3488) : T0=13.01 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (5228) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.36**
...
- TROP-CHER : 8030 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7989 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 59550 systemes
  - sans CONNECTED : 0.0% sur 13446 systemes
