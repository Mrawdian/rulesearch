...
| connect | 4 | 3 | 6516 | 3277 | 421 | 235 | 626 | 527 | 679 | 676 | 10.4% |
...
- **679 systemes avec CONNECTED sur 5395 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- TROP-CHER : 681 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 679 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 5338 systemes
  - sans CONNECTED : 0.0% sur 1178 systemes
