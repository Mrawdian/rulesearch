...
genere 2026-08-27 00:19 UTC — 71441 systemes evalues
...
- moteur actif `0caa9267db60` (27699 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 32311 | 7443 | 13719 | 18 | 4481 | 1696 | 15 | 4939 | 15.3% |
...
- candidats SANS connectivite : 5249, dont T2 : 100%
...
*4460 candidats sur 8750 portent les champs bruts (51%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 783 candidats
  - AVEC connectivite (321) : resistance **41.4%**
  - SANS connectivite (462) : resistance **21.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 783 candidats
  ...
  - SANS connectivite (462) : T0=15.90 T1=0.00 T2=2.62 — pondere **5.24**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 798 candidats
