...
genere 2026-08-26 10:33 UTC — 39022 systemes evalues
...
- `e3baecf8377b` : 429 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
**7895 enregistrements (20%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 16632 | 8307 | 1071 | 572 | 1651 | 1324 | 1816 | 1681 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 16275 | 3824 | 6901 | 11 | 2221 | 819 | 7 | 2492 | 15.3% |
...
- candidats AVEC connectivite : 1808, dont T2 : 100%
- candidats SANS connectivite : 2802, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2090 systemes avec CONNECTED sur 16098 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*320 candidats sur 4610 portent les champs bruts (7%).*
...
- `e3baecf8377b` — 56 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (25) : resistance **36.1%**
  - SANS connectivite (31) : resistance **16.4%**
...
- `e3baecf8377b` — 56 candidats
  - AVEC connectivite (25) : T0=13.96 T1=0.00 T2=2.84 — pondere **5.68**
  - SANS connectivite (31) : T0=15.74 T1=0.00 T2=2.26 — pondere **4.52**
...
- TROP-CHER : 2107 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2090 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.4% sur 13597 systemes
  - sans CONNECTED : 0.0% sur 3035 systemes
