...
- **4391 systemes avec CONNECTED sur 34416 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- TROP-CHER : 4422 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4391 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 31915 systemes
  - sans CONNECTED : 0.0% sur 7104 systemes
