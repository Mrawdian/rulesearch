...
genere 2026-08-26 21:17 UTC — 64744 systemes evalues
...
- moteur actif `0caa9267db60` (21002 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 29635 | 14727 | 2027 | 993 | 2964 | 2347 | 3159 | 3042 | 10.3% |
...
- candidats AVEC connectivite : 3169, dont T2 : 100%
- candidats SANS connectivite : 4772, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3433 systemes avec CONNECTED sur 26733 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3651 candidats sur 7941 portent les champs bruts (46%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 782 candidats
  - AVEC connectivite (325) : resistance **40.4%**
...
- `62448a55927e` — 782 candidats
  - AVEC connectivite (325) : T0=12.89 T1=0.00 T2=2.87 — pondere **5.75**
...
- TROP-CHER : 3455 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3433 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24232 systemes
