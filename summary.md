...
genere 2026-08-26 20:52 UTC — 63812 systemes evalues
...
- moteur actif `0caa9267db60` (20070 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 28541 | 6586 | 12106 | 16 | 3965 | 1469 | 12 | 4387 | 15.4% |
...
- candidats SANS connectivite : 4697, dont T2 : 100%
...
*3530 candidats sur 7820 portent les champs bruts (45%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 661 candidats
  - AVEC connectivite (279) : resistance **40.0%**
  - SANS connectivite (382) : resistance **20.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 661 candidats
  ...
  - SANS connectivite (382) : T0=16.13 T1=0.00 T2=2.69 — pondere **5.37**
  - test de permutation : **p = 0.1934** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e3baecf8377b` — 657 candidats
