...
genere 2026-09-06 06:33 UTC — 407218 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 323874 systemes
...
- moteur actif `0caa9267db60` (363476 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 202560 | 100573 | 13822 | 6743 | 20542 | 15924 | 21515 | 20866 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 198543 | 46149 | 83799 | 78 | 27656 | 10260 | 73 | 30511 | 15.4% |
...
- candidats AVEC connectivite : 20993, dont T2 : 100%
- candidats SANS connectivite : 30821, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21789 systemes avec CONNECTED sur 167784 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*47524 candidats sur 51814 portent les champs bruts (92%).*

- `5c556c16ea8b` — 41559 candidats
  - AVEC connectivite (16865) : resistance **41.1%**
  - SANS connectivite (24694) : resistance **21.3%**
...
- `5c556c16ea8b` — 41559 candidats
  - AVEC connectivite (16865) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (24694) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 21872 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21789 avec CONNECTED, 83 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 165283 systemes
  - sans CONNECTED : 0.0% sur 37277 systemes
