...
genere 2026-09-06 02:53 UTC — 403608 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 320264 systemes
...
- moteur actif `0caa9267db60` (359866 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 200738 | 99653 | 13678 | 6681 | 20378 | 15801 | 21323 | 20672 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 196755 | 45741 | 83041 | 78 | 27418 | 10155 | 73 | 30232 | 15.4% |
...
- candidats AVEC connectivite : 20799, dont T2 : 100%
- candidats SANS connectivite : 30542, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21597 systemes avec CONNECTED sur 166285 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*47051 candidats sur 51341 portent les champs bruts (92%).*

- `5c556c16ea8b` — 41086 candidats
  - AVEC connectivite (16671) : resistance **41.0%**
  - SANS connectivite (24415) : resistance **21.3%**
...
- `5c556c16ea8b` — 41086 candidats
  - AVEC connectivite (16671) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.94**
  - SANS connectivite (24415) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
## cout
- temps total 125.5 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 21680 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21597 avec CONNECTED, 83 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 163784 systemes
  - sans CONNECTED : 0.0% sur 36954 systemes
