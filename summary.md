...
| connect | 4 | 3 | 18367 | 9171 | 1193 | 639 | 1832 | 1458 | 1993 | 1852 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 17970 | 4236 | 7570 | 12 | 2462 | 927 | 7 | 2756 | 15.3% |
...
- candidats AVEC connectivite : 1979, dont T2 : 100%
- candidats SANS connectivite : 3066, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2267 systemes avec CONNECTED sur 17498 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*755 candidats sur 5045 portent les champs bruts (15%).*
...
- `e3baecf8377b` — 491 candidats
  - AVEC connectivite (196) : resistance **42.9%**
  - SANS connectivite (295) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 491 candidats
  - AVEC connectivite (196) : T0=12.96 T1=0.00 T2=3.13 — pondere **6.26**
  - SANS connectivite (295) : T0=16.09 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 2284 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2267 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14997 systemes
  - sans CONNECTED : 0.0% sur 3370 systemes
