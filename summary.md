...
genere 2026-08-26 15:54 UTC — 52394 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 7211 systemes
...
- moteur actif `0caa9267db60` (8652 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23386 | 11653 | 1583 | 798 | 2333 | 1854 | 2498 | 2371 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 22893 | 5297 | 9672 | 14 | 3203 | 1163 | 10 | 3534 | 15.4% |
...
- candidats AVEC connectivite : 2498, dont T2 : 100%
- candidats SANS connectivite : 3844, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2772 systemes avec CONNECTED sur 21590 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2052 candidats sur 6342 portent les champs bruts (32%).*
...
- `06fe04a859f1` — 937 candidats
  - AVEC connectivite (360) : resistance **41.4%**
...
- `06fe04a859f1` — 937 candidats
  - AVEC connectivite (360) : T0=13.22 T1=0.00 T2=3.04 — pondere **6.09**
...
- TROP-CHER : 2792 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2772 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19089 systemes
  - sans CONNECTED : 0.0% sur 4297 systemes
