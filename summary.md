...
genere 2026-08-27 04:45 UTC — 81338 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 16431 systemes
...
- moteur actif `0caa9267db60` (37596 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 38020 | 18916 | 2621 | 1296 | 3780 | 2986 | 4016 | 3910 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 37203 | 8576 | 15814 | 21 | 5156 | 1936 | 20 | 5680 | 15.3% |
...
- candidats AVEC connectivite : 4037, dont T2 : 100%
- candidats SANS connectivite : 5990, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4290 systemes avec CONNECTED sur 33613 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5737 candidats sur 10027 portent les champs bruts (57%).*
...
- `ab89a63b01ef` — 2060 candidats
  - AVEC connectivite (857) : resistance **41.4%**
  - SANS connectivite (1203) : resistance **21.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 2060 candidats
  - AVEC connectivite (857) : T0=13.03 T1=0.00 T2=3.04 — pondere **6.07**
  - SANS connectivite (1203) : T0=15.92 T1=0.00 T2=2.68 — pondere **5.35**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 31112 systemes
  - sans CONNECTED : 0.0% sur 6908 systemes
