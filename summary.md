...
genere 2026-08-31 10:18 UTC — 248874 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 165530 systemes
...
- moteur actif `0caa9267db60` (205132 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 122615 | 60985 | 8312 | 4106 | 12337 | 9689 | 12952 | 12635 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 120144 | 28050 | 50706 | 53 | 16614 | 6209 | 54 | 18448 | 15.4% |
...
- candidats AVEC connectivite : 12762, dont T2 : 100%
- candidats SANS connectivite : 18758, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13226 systemes avec CONNECTED sur 102589 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*27230 candidats sur 31520 portent les champs bruts (86%).*

- `5c556c16ea8b` — 21265 candidats
  - AVEC connectivite (8634) : resistance **41.0%**
  - SANS connectivite (12631) : resistance **21.3%**
...
- `5c556c16ea8b` — 21265 candidats
  - AVEC connectivite (8634) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (12631) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 13290 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13226 avec CONNECTED, 64 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 100088 systemes
  - sans CONNECTED : 0.0% sur 22527 systemes
