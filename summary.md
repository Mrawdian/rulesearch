...
genere 2026-08-26 21:22 UTC — 64937 systemes evalues
...
- `ab89a63b01ef` : 30 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (21195 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
**7556 enregistrements (12%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 29725 | 14772 | 2031 | 995 | 2973 | 2354 | 3169 | 3054 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 29097 | 6708 | 12345 | 16 | 4035 | 1500 | 12 | 4481 | 15.4% |
...
- candidats AVEC connectivite : 3181, dont T2 : 100%
- candidats SANS connectivite : 4791, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3443 systemes avec CONNECTED sur 26809 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3682 candidats sur 7972 portent les champs bruts (46%).*
...
- TROP-CHER : 3465 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3443 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24308 systemes
  - sans CONNECTED : 0.0% sur 5417 systemes
