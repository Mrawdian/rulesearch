...
genere 2026-08-27 08:31 UTC — 89381 systemes evalues
...
- moteur actif `0caa9267db60` (45639 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 42063 | 20943 | 2892 | 1422 | 4196 | 3307 | 4433 | 4325 | 10.3% |
...
- candidats AVEC connectivite : 4452, dont T2 : 100%
- candidats SANS connectivite : 6602, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4707 systemes avec CONNECTED sur 36879 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6764 candidats sur 11054 portent les champs bruts (61%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 799 candidats
  - AVEC connectivite (324) : resistance **41.2%**
...
- `5c556c16ea8b` — 799 candidats
  - AVEC connectivite (324) : T0=13.10 T1=0.00 T2=3.01 — pondere **6.01**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 34378 systemes
  - sans CONNECTED : 0.0% sur 7685 systemes
