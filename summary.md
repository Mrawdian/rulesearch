...
genere 2026-08-26 21:54 UTC — 66196 systemes evalues
...
- moteur actif `0caa9267db60` (22454 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 30368 | 15086 | 2077 | 1023 | 3037 | 2412 | 3230 | 3119 | 10.3% |
...
- candidats AVEC connectivite : 3246, dont T2 : 100%
- candidats SANS connectivite : 4873, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3504 systemes avec CONNECTED sur 27323 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3829 candidats sur 8119 portent les champs bruts (47%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 152 candidats
  - AVEC connectivite (66) : resistance **44.9%**
...
- `ab89a63b01ef` — 152 candidats
  - AVEC connectivite (66) : T0=13.12 T1=0.00 T2=3.14 — pondere **6.27**
  - SANS connectivite (86) : T0=15.99 T1=0.00 T2=2.91 — pondere **5.81**
  - test de permutation : **p = 0.3823** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 3527 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3504 avec CONNECTED, 23 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24822 systemes
  - sans CONNECTED : 0.0% sur 5546 systemes
