...
| connect | 4 | 3 | 17110 | 8556 | 1102 | 591 | 1700 | 1361 | 1863 | 1722 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 16762 | 3943 | 7104 | 11 | 2288 | 848 | 7 | 2561 | 15.3% |
...
- candidats AVEC connectivite : 1849, dont T2 : 100%
- candidats SANS connectivite : 2871, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2137 systemes avec CONNECTED sur 16480 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*430 candidats sur 4720 portent les champs bruts (9%).*
...
- `e3baecf8377b` — 166 candidats
  - AVEC connectivite (66) : resistance **42.3%**
  - SANS connectivite (100) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 166 candidats
  - AVEC connectivite (66) : T0=13.39 T1=0.00 T2=3.23 — pondere **6.45**
  - SANS connectivite (100) : T0=15.92 T1=0.00 T2=2.61 — pondere **5.22**
...
**2 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0270).
...
## cout
- temps total 12.5 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2154 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2137 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 13979 systemes
  - sans CONNECTED : 0.0% sur 3131 systemes
