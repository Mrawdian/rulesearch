...
genere 2026-08-26 06:36 UTC — 28857 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 19883 systemes
...
- candidats AVEC connectivite : 1418, dont T2 : 100%
- candidats SANS connectivite : 2150, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1568 systemes avec CONNECTED sur 11930 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2403 candidats
  - AVEC connectivite (939) : T0=13.20 T1=0.00 T2=2.88 — pondere **5.75**
...
- TROP-CHER : 1575 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1568 avec CONNECTED, 7 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
