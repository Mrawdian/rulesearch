...
genere 2026-08-30 01:58 UTC — 203437 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 120093 systemes
...
- moteur actif `0caa9267db60` (159695 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 99670 | 49456 | 6788 | 3342 | 10060 | 7965 | 10493 | 10268 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 97652 | 22769 | 41226 | 45 | 13507 | 5040 | 37 | 15021 | 15.4% |
...
- candidats SANS connectivite : 15331, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10767 systemes avec CONNECTED sur 83766 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*21436 candidats sur 25726 portent les champs bruts (83%).*

- `5c556c16ea8b` — 15471 candidats
  - AVEC connectivite (6267) : resistance **41.1%**
  - SANS connectivite (9204) : resistance **21.5%**
...
- `5c556c16ea8b` — 15471 candidats
  ...
  - SANS connectivite (9204) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 10814 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10767 avec CONNECTED, 47 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 81265 systemes
  - sans CONNECTED : 0.0% sur 18405 systemes
