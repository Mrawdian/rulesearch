...
genere 2026-08-26 12:36 UTC — 44301 systemes evalues
...
| connect | 4 | 3 | 19293 | 9617 | 1260 | 673 | 1930 | 1530 | 2081 | 1963 | 10.2% |
...
- candidats AVEC connectivite : 2090, dont T2 : 100%
- candidats SANS connectivite : 3198, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2355 systemes avec CONNECTED sur 18253 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*998 candidats sur 5288 portent les champs bruts (19%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `e40600351a72` — 77 candidats
  - AVEC connectivite (39) : resistance **37.2%**
...
- `e40600351a72` — 77 candidats
  - AVEC connectivite (39) : T0=13.08 T1=0.00 T2=2.82 — pondere **5.64**
  - SANS connectivite (38) : T0=17.05 T1=0.00 T2=2.53 — pondere **5.05**
  - test de permutation : **p = 0.3618** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 15752 systemes
  - sans CONNECTED : 0.0% sur 3541 systemes
