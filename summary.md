...
genere 2026-08-27 21:46 UTC — 115483 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 32139 systemes
...
- moteur actif `0caa9267db60` (71741 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 55247 | 27512 | 3825 | 1875 | 5463 | 4377 | 5841 | 5639 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 54121 | 12491 | 22977 | 26 | 7505 | 2807 | 25 | 8288 | 15.3% |
...
- candidats SANS connectivite : 8598, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6115 systemes avec CONNECTED sur 47634 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10074 candidats sur 14364 portent les champs bruts (70%).*

- `5c556c16ea8b` — 4109 candidats
  - AVEC connectivite (1638) : resistance **42.0%**
  - SANS connectivite (2471) : resistance **22.6%**
...
- `5c556c16ea8b` — 4109 candidats
  ...
  - SANS connectivite (2471) : T0=15.77 T1=0.00 T2=2.72 — pondere **5.43**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 45133 systemes
  - sans CONNECTED : 0.0% sur 10114 systemes
