...
| connect | 4 | 3 | 5920 | 2986 | 380 | 213 | 568 | 476 | 616 | 611 | 10.3% |
| ref | 4 | 3 | 5788 | 1408 | 2404 | 1 | 775 | 284 | 2 | 914 | 15.8% |
...
- candidats AVEC connectivite : 614, dont T2 : 100%
- candidats SANS connectivite : 918, dont T2 : 100%
...
- **616 systemes avec CONNECTED sur 4911 (12.5%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 367 candidats
  - AVEC connectivite (135) : T0=13.09 T1=0.00 T2=2.92 — pondere **5.84**
  - SANS connectivite (232) : T0=15.94 T1=0.00 T2=2.63 — pondere **5.27**
  - test de permutation : **p = 0.0930** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 618 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 616 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 4854 systemes
  - sans CONNECTED : 0.0% sur 1066 systemes
