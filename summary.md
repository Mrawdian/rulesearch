...
genere 2026-08-27 06:31 UTC — 85030 systemes evalues
...
- moteur actif `0caa9267db60` (41288 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 39869 | 19854 | 2730 | 1356 | 3970 | 3136 | 4216 | 4092 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 39046 | 8993 | 16617 | 22 | 5413 | 2038 | 21 | 5942 | 15.2% |
...
- candidats AVEC connectivite : 4219, dont T2 : 100%
- candidats SANS connectivite : 6252, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4490 systemes avec CONNECTED sur 35103 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6181 candidats sur 10471 portent les champs bruts (59%).*
...
- `23303c299f39` — 225 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 216 candidats
  - AVEC connectivite (91) : resistance **43.5%**
  - SANS connectivite (125) : resistance **22.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 216 candidats
  - AVEC connectivite (91) : T0=12.65 T1=0.00 T2=3.18 — pondere **6.35**
  - SANS connectivite (125) : T0=15.94 T1=0.00 T2=2.71 — pondere **5.42**
  - test de permutation : **p = 0.0330** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e40600351a72` — 194 candidats
...
**7 serie(s) reproductible(s) sur 14 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `ab89a63b01ef` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0060), `5c556c16ea8b` (p=0.0330), `b71bb0907fb5` (p=0.0110).
...
- TROP-CHER : 4521 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4490 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 32602 systemes
  - sans CONNECTED : 0.0% sur 7267 systemes
