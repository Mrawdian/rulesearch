...
genere 2026-08-26 02:28 UTC — 18311 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 9337 systemes
...
| connect | 4 | 3 | 9193 | 4625 | 600 | 307 | 881 | 729 | 1001 | 939 | 10.2% |
...
- candidats AVEC connectivite : 942, dont T2 : 100%
...
- **1001 systemes avec CONNECTED sur 7613 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1180 candidats
  - AVEC connectivite (463) : T0=13.37 T1=0.00 T2=2.89 — pondere **5.79**
  - SANS connectivite (717) : T0=15.85 T1=0.00 T2=2.66 — pondere **5.32**
  - test de permutation : **p = 0.0190** — ecart significatif au seuil 0.05
...
- TROP-CHER : 1005 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1001 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 7556 systemes
  - sans CONNECTED : 0.0% sur 1637 systemes
