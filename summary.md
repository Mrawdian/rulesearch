...
genere 2026-09-03 19:06 UTC — 345650 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 262306 systemes
...
- moteur actif `0caa9267db60` (301908 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 171474 | 85228 | 11630 | 5742 | 17456 | 13530 | 18179 | 17526 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 168061 | 39091 | 71024 | 67 | 23310 | 8695 | 66 | 25796 | 15.3% |
...
- candidats AVEC connectivite : 17653, dont T2 : 100%
- candidats SANS connectivite : 26106, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18453 systemes avec CONNECTED sur 142402 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39469 candidats sur 43759 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33504 candidats
  - AVEC connectivite (13525) : resistance **41.0%**
  - SANS connectivite (19979) : resistance **21.2%**
...
- `5c556c16ea8b` — 33504 candidats
  - AVEC connectivite (13525) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (19979) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
## cout
- temps total 107.3 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 18529 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18453 avec CONNECTED, 76 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 139901 systemes
  - sans CONNECTED : 0.0% sur 31573 systemes
