...
genere 2026-08-26 23:42 UTC — 70089 systemes evalues
...
- moteur actif `0caa9267db60` (26347 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 32340 | 16083 | 2215 | 1090 | 3223 | 2574 | 3444 | 3300 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 31634 | 7301 | 13430 | 18 | 4378 | 1652 | 14 | 4841 | 15.3% |
...
- candidats AVEC connectivite : 3427, dont T2 : 100%
- candidats SANS connectivite : 5151, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3718 systemes avec CONNECTED sur 28940 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4288 candidats sur 8578 portent les champs bruts (50%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 611 candidats
  - AVEC connectivite (247) : resistance **42.3%**
  - SANS connectivite (364) : resistance **21.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 611 candidats
  - AVEC connectivite (247) : T0=13.03 T1=0.00 T2=3.13 — pondere **6.27**
  - SANS connectivite (364) : T0=15.93 T1=0.00 T2=2.63 — pondere **5.26**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e3baecf8377b` — 657 candidats
...
- TROP-CHER : 3742 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3718 avec CONNECTED, 24 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 26439 systemes
  - sans CONNECTED : 0.0% sur 5901 systemes
