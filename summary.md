...
| connect | 4 | 3 | 6605 | 3320 | 430 | 236 | 634 | 534 | 687 | 687 | 10.4% |
| ref | 4 | 3 | 6460 | 1572 | 2672 | 1 | 868 | 319 | 2 | 1026 | 15.9% |
...
- candidats AVEC connectivite : 690, dont T2 : 100%
- candidats SANS connectivite : 1030, dont T2 : 100%
...
- **687 systemes avec CONNECTED sur 5469 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 555 candidats
  - AVEC connectivite (211) : T0=13.18 T1=0.00 T2=2.97 — pondere **5.93**
  - SANS connectivite (344) : T0=15.82 T1=0.00 T2=2.63 — pondere **5.26**
...
- TROP-CHER : 689 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 687 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 5412 systemes
  - sans CONNECTED : 0.0% sur 1193 systemes
