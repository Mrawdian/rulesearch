...
genere 2026-08-28 09:11 UTC — 136832 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 53488 systemes
...
- moteur actif `0caa9267db60` (93090 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 66038 | 32799 | 4535 | 2243 | 6605 | 5265 | 6952 | 6788 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 64679 | 14963 | 27364 | 30 | 9006 | 3337 | 28 | 9949 | 15.4% |
...
- candidats AVEC connectivite : 6915, dont T2 : 100%
- candidats SANS connectivite : 10259, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7226 systemes avec CONNECTED sur 56383 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12884 candidats sur 17174 portent les champs bruts (75%).*

- `5c556c16ea8b` — 6919 candidats
  - AVEC connectivite (2787) : resistance **41.5%**
  - SANS connectivite (4132) : resistance **21.8%**
...
- `5c556c16ea8b` — 6919 candidats
  - AVEC connectivite (2787) : T0=12.97 T1=0.00 T2=3.02 — pondere **6.04**
  - SANS connectivite (4132) : T0=15.86 T1=0.00 T2=2.67 — pondere **5.35**
...
- TROP-CHER : 7264 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7226 avec CONNECTED, 38 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 53882 systemes
  - sans CONNECTED : 0.0% sur 12156 systemes
