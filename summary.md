...
genere 2026-08-26 13:24 UTC — 46452 systemes evalues
...
- moteur actif `0caa9267db60` (2710 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20380 | 10166 | 1339 | 703 | 2040 | 1618 | 2181 | 2081 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 19957 | 4683 | 8429 | 13 | 2757 | 1031 | 7 | 3037 | 15.2% |
...
- candidats AVEC connectivite : 2208, dont T2 : 100%
- candidats SANS connectivite : 3347, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2455 systemes avec CONNECTED sur 19133 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1265 candidats sur 5555 portent les champs bruts (23%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 150 candidats
  - AVEC connectivite (70) : resistance **38.0%**
  - SANS connectivite (80) : resistance **22.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 150 candidats
  - AVEC connectivite (70) : T0=13.29 T1=0.00 T2=2.71 — pondere **5.43**
  - SANS connectivite (80) : T0=16.20 T1=0.00 T2=2.95 — pondere **5.90**
  - test de permutation : **p = 0.3573** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 2472 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2455 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16632 systemes
  - sans CONNECTED : 0.0% sur 3748 systemes
