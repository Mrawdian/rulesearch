...
| connect | 4 | 3 | 18262 | 9127 | 1188 | 636 | 1814 | 1447 | 1983 | 1838 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 17883 | 4208 | 7544 | 12 | 2449 | 919 | 7 | 2744 | 15.3% |
...
- candidats AVEC connectivite : 1965, dont T2 : 100%
- candidats SANS connectivite : 3054, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2257 systemes avec CONNECTED sur 17415 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*729 candidats sur 5019 portent les champs bruts (15%).*
...
- `e3baecf8377b` — 465 candidats
  - AVEC connectivite (182) : resistance **42.6%**
  - SANS connectivite (283) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 465 candidats
  - AVEC connectivite (182) : T0=12.99 T1=0.00 T2=3.12 — pondere **6.24**
  - SANS connectivite (283) : T0=16.09 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 2274 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2257 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14914 systemes
  - sans CONNECTED : 0.0% sur 3348 systemes
