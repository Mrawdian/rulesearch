...
genere 2026-09-04 12:57 UTC — 364987 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 281643 systemes
...
- moteur actif `0caa9267db60` (321245 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 181226 | 90057 | 12321 | 6054 | 18436 | 14280 | 19205 | 18555 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 177646 | 41266 | 75073 | 72 | 24678 | 9199 | 70 | 27274 | 15.4% |
...
- candidats AVEC connectivite : 18682, dont T2 : 100%
- candidats SANS connectivite : 27584, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19479 systemes avec CONNECTED sur 150340 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*41976 candidats sur 46266 portent les champs bruts (91%).*

- `5c556c16ea8b` — 36011 candidats
  - AVEC connectivite (14554) : resistance **41.0%**
  - SANS connectivite (21457) : resistance **21.2%**
...
- `5c556c16ea8b` — 36011 candidats
  - AVEC connectivite (14554) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (21457) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
## cout
- temps total 113.3 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 19559 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19479 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 147839 systemes
  - sans CONNECTED : 0.0% sur 33387 systemes
