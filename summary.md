...
genere 2026-08-30 09:26 UTC — 213958 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 130614 systemes
...
- moteur actif `0caa9267db60` (170216 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 104986 | 52118 | 7156 | 3501 | 10576 | 8356 | 11121 | 10791 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 102857 | 23988 | 43436 | 48 | 14205 | 5304 | 41 | 15827 | 15.4% |
...
- candidats AVEC connectivite : 10918, dont T2 : 100%
...
- **11395 systemes avec CONNECTED sur 88141 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*22765 candidats sur 27055 portent les champs bruts (84%).*

- `5c556c16ea8b` — 16800 candidats
  - AVEC connectivite (6790) : resistance **41.2%**
...
- `5c556c16ea8b` — 16800 candidats
  - AVEC connectivite (6790) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
...
- TROP-CHER : 11446 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11395 avec CONNECTED, 51 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 85640 systemes
  - sans CONNECTED : 0.0% sur 19346 systemes
