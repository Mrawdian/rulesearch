...
genere 2026-09-02 07:25 UTC — 305239 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 221895 systemes
...
- moteur actif `0caa9267db60` (261497 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 151067 | 75066 | 10270 | 5059 | 15335 | 11892 | 15998 | 15517 | 10.3% |
...
- candidats AVEC connectivite : 15644, dont T2 : 100%
...
- **16272 systemes avec CONNECTED sur 125821 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*34353 candidats sur 38643 portent les champs bruts (89%).*

- `5c556c16ea8b` — 28388 candidats
  - AVEC connectivite (11516) : resistance **41.1%**
...
- `5c556c16ea8b` — 28388 candidats
  - AVEC connectivite (11516) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 16345 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16272 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 123320 systemes
  - sans CONNECTED : 0.0% sur 27747 systemes
