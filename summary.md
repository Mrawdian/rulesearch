...
genere 2026-08-30 05:40 UTC — 208824 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 125480 systemes
...
- moteur actif `0caa9267db60` (165082 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 102393 | 50842 | 6970 | 3428 | 10339 | 8164 | 10797 | 10520 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 100316 | 23350 | 42394 | 45 | 13852 | 5180 | 39 | 15449 | 15.4% |
...
- candidats AVEC connectivite : 10647, dont T2 : 100%
...
- **11071 systemes avec CONNECTED sur 86011 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*22116 candidats sur 26406 portent les champs bruts (84%).*

- `5c556c16ea8b` — 16151 candidats
  - AVEC connectivite (6519) : resistance **41.1%**
...
- `5c556c16ea8b` — 16151 candidats
  - AVEC connectivite (6519) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
...
- TROP-CHER : 11120 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11071 avec CONNECTED, 49 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 83510 systemes
  - sans CONNECTED : 0.0% sur 18883 systemes
