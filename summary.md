...
genere 2026-08-27 18:29 UTC — 109303 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 25959 systemes
...
- moteur actif `0caa9267db60` (65561 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 52121 | 25956 | 3605 | 1791 | 5162 | 4126 | 5500 | 5305 | 10.2% |
...
- candidats AVEC connectivite : 5432, dont T2 : 100%
- candidats SANS connectivite : 8120, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5774 systemes avec CONNECTED sur 45075 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*9262 candidats sur 13552 portent les champs bruts (68%).*
...
- `5c556c16ea8b` — 3297 candidats
  - AVEC connectivite (1304) : resistance **42.0%**
...
- `5c556c16ea8b` — 3297 candidats
  - AVEC connectivite (1304) : T0=12.98 T1=0.00 T2=3.07 — pondere **6.13**
...
- TROP-CHER : 5808 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 5774 avec CONNECTED, 34 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 42574 systemes
