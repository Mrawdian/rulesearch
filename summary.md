...
genere 2026-09-06 17:10 UTC — 417480 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 334136 systemes
...
- moteur actif `0caa9267db60` (373738 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 207741 | 103139 | 14151 | 6910 | 21058 | 16361 | 22080 | 21403 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 203624 | 47357 | 85885 | 79 | 28405 | 10511 | 73 | 31297 | 15.4% |
...
- candidats AVEC connectivite : 21530, dont T2 : 100%
- candidats SANS connectivite : 31607, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **22354 systemes avec CONNECTED sur 172002 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*48847 candidats sur 53137 portent les champs bruts (92%).*

- `5c556c16ea8b` — 42882 candidats
  - AVEC connectivite (17402) : resistance **41.1%**
  - SANS connectivite (25480) : resistance **21.3%**
...
- `5c556c16ea8b` — 42882 candidats
  - AVEC connectivite (17402) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (25480) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
## cout
- temps total 129.9 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 22437 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 22354 avec CONNECTED, 83 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 169501 systemes
  - sans CONNECTED : 0.0% sur 38240 systemes
