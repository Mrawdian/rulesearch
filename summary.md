...
genere 2026-08-27 14:46 UTC — 101957 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 18613 systemes
...
- moteur actif `0caa9267db60` (58215 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 48410 | 24124 | 3334 | 1657 | 4805 | 3829 | 5114 | 4922 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 47432 | 10974 | 20134 | 25 | 6568 | 2480 | 22 | 7228 | 15.2% |
...
- candidats AVEC connectivite : 5049, dont T2 : 100%
- candidats SANS connectivite : 7538, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5388 systemes avec CONNECTED sur 42055 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*8297 candidats sur 12587 portent les champs bruts (66%).*
...
- `5c556c16ea8b` — 2332 candidats
  - AVEC connectivite (921) : resistance **41.6%**
  - SANS connectivite (1411) : resistance **22.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 2332 candidats
  - AVEC connectivite (921) : T0=13.02 T1=0.00 T2=3.03 — pondere **6.05**
  - SANS connectivite (1411) : T0=15.78 T1=0.00 T2=2.68 — pondere **5.36**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 2280 candidats
...
## cout
- temps total 31.5 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 5420 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 5388 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 39554 systemes
  - sans CONNECTED : 0.0% sur 8856 systemes
