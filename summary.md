...
genere 2026-08-26 10:45 UTC — 39559 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `615abe43d6bc` : 7172 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
- `e3baecf8377b` : 966 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
**8432 enregistrements (21%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| ref | 4 | 3 | 16543 | 3892 | 7013 | 11 | 2254 | 835 | 7 | 2531 | 15.3% |
...
- candidats SANS connectivite : 2841, dont T2 : 100%
...
*385 candidats sur 4675 portent les champs bruts (8%).*
...
- `e3baecf8377b` — 121 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (51) : resistance **40.5%**
  - SANS connectivite (70) : resistance **20.4%**
...
- `e3baecf8377b` — 121 candidats
  - AVEC connectivite (51) : T0=13.53 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (70) : T0=15.84 T1=0.00 T2=2.57 — pondere **5.14**
