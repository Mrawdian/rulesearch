...
| connect | 4 | 3 | 6130 | 3088 | 393 | 223 | 588 | 494 | 636 | 635 | 10.4% |
| ref | 4 | 3 | 5992 | 1457 | 2493 | 1 | 800 | 294 | 2 | 945 | 15.8% |
...
- candidats AVEC connectivite : 638, dont T2 : 100%
- candidats SANS connectivite : 949, dont T2 : 100%
...
- **636 systemes avec CONNECTED sur 5081 (12.5%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 422 candidats
  - AVEC connectivite (159) : T0=13.19 T1=0.00 T2=2.96 — pondere **5.91**
  - SANS connectivite (263) : T0=15.95 T1=0.00 T2=2.62 — pondere **5.23**
...
- TROP-CHER : 638 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 636 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 5024 systemes
  - sans CONNECTED : 0.0% sur 1106 systemes
