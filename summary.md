...
genere 2026-09-05 22:36 UTC — 399398 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 316054 systemes
...
- moteur actif `0caa9267db60` (355656 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 198606 | 98601 | 13528 | 6619 | 20168 | 15644 | 21087 | 20432 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 194677 | 45312 | 82130 | 78 | 27102 | 10054 | 72 | 29913 | 15.4% |
...
- candidats SANS connectivite : 30223, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21361 systemes avec CONNECTED sur 164531 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*46492 candidats sur 50782 portent les champs bruts (92%).*

- `5c556c16ea8b` — 40527 candidats
  - AVEC connectivite (16431) : resistance **41.1%**
  - SANS connectivite (24096) : resistance **21.3%**
...
- `5c556c16ea8b` — 40527 candidats
  ...
  - SANS connectivite (24096) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 162030 systemes
  - sans CONNECTED : 0.0% sur 36576 systemes
