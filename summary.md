...
genere 2026-08-31 17:31 UTC — 258453 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 175109 systemes
...
- moteur actif `0caa9267db60` (214711 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 127460 | 63387 | 8616 | 4272 | 12872 | 10075 | 13448 | 13120 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 124878 | 29092 | 52732 | 56 | 17304 | 6454 | 56 | 19174 | 15.4% |
...
- candidats AVEC connectivite : 13247, dont T2 : 100%
- candidats SANS connectivite : 19484, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13722 systemes avec CONNECTED sur 106508 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*28441 candidats sur 32731 portent les champs bruts (87%).*

- `5c556c16ea8b` — 22476 candidats
  - AVEC connectivite (9119) : resistance **41.0%**
  - SANS connectivite (13357) : resistance **21.4%**
...
- `5c556c16ea8b` — 22476 candidats
  - AVEC connectivite (9119) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.97**
  - SANS connectivite (13357) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 13788 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13722 avec CONNECTED, 66 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 104007 systemes
  - sans CONNECTED : 0.0% sur 23453 systemes
