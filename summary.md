...
genere 2026-09-05 13:49 UTC — 390687 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 307343 systemes
...
- moteur actif `0caa9267db60` (346945 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 194213 | 96452 | 13227 | 6466 | 19752 | 15288 | 20598 | 19956 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 190359 | 44311 | 80340 | 78 | 26490 | 9847 | 71 | 29208 | 15.3% |
...
- candidats AVEC connectivite : 20083, dont T2 : 100%
- candidats SANS connectivite : 29518, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20872 systemes avec CONNECTED sur 160915 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*45311 candidats sur 49601 portent les champs bruts (91%).*

- `5c556c16ea8b` — 39346 candidats
  - AVEC connectivite (15955) : resistance **41.0%**
  - SANS connectivite (23391) : resistance **21.3%**
...
- `5c556c16ea8b` — 39346 candidats
  - AVEC connectivite (15955) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.94**
  - SANS connectivite (23391) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
## cout
- temps total 121.3 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 20953 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 20872 avec CONNECTED, 81 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 158414 systemes
  - sans CONNECTED : 0.0% sur 35799 systemes
