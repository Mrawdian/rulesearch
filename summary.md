...
genere 2026-09-04 21:25 UTC — 373825 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 290481 systemes
...
- moteur actif `0caa9267db60` (330083 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 185688 | 92235 | 12617 | 6216 | 18876 | 14621 | 19692 | 19052 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 182022 | 42327 | 76912 | 75 | 25291 | 9416 | 70 | 27917 | 15.3% |
...
- candidats AVEC connectivite : 19179, dont T2 : 100%
- candidats SANS connectivite : 28227, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19966 systemes avec CONNECTED sur 153985 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*43116 candidats sur 47406 portent les champs bruts (91%).*

- `5c556c16ea8b` — 37151 candidats
  - AVEC connectivite (15051) : resistance **41.1%**
  - SANS connectivite (22100) : resistance **21.2%**
...
- `5c556c16ea8b` — 37151 candidats
  - AVEC connectivite (15051) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (22100) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 20046 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19966 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 151484 systemes
  - sans CONNECTED : 0.0% sur 34204 systemes
