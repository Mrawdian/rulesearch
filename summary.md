...
genere 2026-08-29 15:20 UTC — 187131 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 103787 systemes
...
- moteur actif `0caa9267db60` (143389 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 91431 | 45464 | 6215 | 3076 | 9201 | 7284 | 9624 | 9403 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 89585 | 20930 | 37796 | 43 | 12392 | 4598 | 36 | 13784 | 15.4% |
...
- candidats AVEC connectivite : 9530, dont T2 : 100%
- candidats SANS connectivite : 14094, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9898 systemes avec CONNECTED sur 77085 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*19334 candidats sur 23624 portent les champs bruts (82%).*

- `5c556c16ea8b` — 13369 candidats
  - AVEC connectivite (5402) : resistance **41.2%**
  - SANS connectivite (7967) : resistance **21.5%**
...
- `5c556c16ea8b` — 13369 candidats
  - AVEC connectivite (5402) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (7967) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 9944 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 9898 avec CONNECTED, 46 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 74584 systemes
  - sans CONNECTED : 0.0% sur 16847 systemes
