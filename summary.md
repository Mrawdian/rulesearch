...
genere 2026-09-04 18:56 UTC — 371321 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 287977 systemes
...
- moteur actif `0caa9267db60` (327579 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 184422 | 91624 | 12551 | 6174 | 18750 | 14522 | 19540 | 18892 | 10.2% |
...
- candidats AVEC connectivite : 19019, dont T2 : 100%
...
- **19814 systemes avec CONNECTED sur 152952 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*42776 candidats sur 47066 portent les champs bruts (91%).*

- `5c556c16ea8b` — 36811 candidats
  - AVEC connectivite (14891) : resistance **41.1%**
...
- `5c556c16ea8b` — 36811 candidats
  - AVEC connectivite (14891) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.95**
...
- TROP-CHER : 19894 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19814 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 150451 systemes
  - sans CONNECTED : 0.0% sur 33971 systemes
