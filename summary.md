...
genere 2026-08-31 11:41 UTC — 250658 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 167314 systemes
...
- moteur actif `0caa9267db60` (206916 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 123527 | 61433 | 8376 | 4140 | 12445 | 9747 | 13053 | 12720 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 121016 | 28244 | 51083 | 53 | 16730 | 6264 | 55 | 18577 | 15.4% |
...
- candidats AVEC connectivite : 12847, dont T2 : 100%
- candidats SANS connectivite : 18887, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13327 systemes avec CONNECTED sur 103324 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*27444 candidats sur 31734 portent les champs bruts (86%).*

- `5c556c16ea8b` — 21479 candidats
  - AVEC connectivite (8719) : resistance **40.9%**
  - SANS connectivite (12760) : resistance **21.3%**
...
- `5c556c16ea8b` — 21479 candidats
  - AVEC connectivite (8719) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (12760) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 100823 systemes
  - sans CONNECTED : 0.0% sur 22704 systemes
