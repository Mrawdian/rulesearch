...
genere 2026-08-28 01:14 UTC — 122470 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 39126 systemes
...
- moteur actif `0caa9267db60` (78728 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 58767 | 29266 | 4062 | 1983 | 5847 | 4652 | 6177 | 6024 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 57588 | 13299 | 24432 | 28 | 7997 | 2987 | 26 | 8817 | 15.3% |
...
- candidats SANS connectivite : 9127, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6451 systemes avec CONNECTED sur 50479 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10988 candidats sur 15278 portent les champs bruts (72%).*

- `5c556c16ea8b` — 5023 candidats
  - AVEC connectivite (2023) : resistance **42.0%**
  - SANS connectivite (3000) : resistance **22.3%**
...
- `5c556c16ea8b` — 5023 candidats
  ...
  - SANS connectivite (3000) : T0=15.85 T1=0.00 T2=2.71 — pondere **5.43**
...
- TROP-CHER : 6487 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6451 avec CONNECTED, 36 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 47978 systemes
  - sans CONNECTED : 0.0% sur 10789 systemes
