...
genere 2026-08-27 08:40 UTC — 89693 systemes evalues
...
- moteur actif `0caa9267db60` (45951 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 42227 | 21025 | 2904 | 1428 | 4215 | 3317 | 4448 | 4344 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 41351 | 9531 | 17580 | 23 | 5721 | 2154 | 22 | 6320 | 15.3% |
...
- candidats AVEC connectivite : 4471, dont T2 : 100%
- candidats SANS connectivite : 6630, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4722 systemes avec CONNECTED sur 37013 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6811 candidats sur 11101 portent les champs bruts (61%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 846 candidats
  - AVEC connectivite (343) : resistance **40.8%**
  - SANS connectivite (503) : resistance **21.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 846 candidats
  - AVEC connectivite (343) : T0=13.12 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (503) : T0=15.95 T1=0.00 T2=2.64 — pondere **5.28**
...
- TROP-CHER : 4754 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4722 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 34512 systemes
  - sans CONNECTED : 0.0% sur 7715 systemes
