...
| connect | 4 | 3 | 4348 | 2187 | 278 | 150 | 424 | 340 | 454 | 463 | 10.6% |
...
- **454 systemes avec CONNECTED sur 3625 (12.5%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- TROP-CHER : 456 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 454 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 3568 systemes
  - sans CONNECTED : 0.0% sur 780 systemes
