...
| connect | 4 | 3 | 7577 | 3820 | 497 | 263 | 723 | 607 | 799 | 784 | 10.3% |
...
- candidats AVEC connectivite : 787, dont T2 : 100%
...
- **799 systemes avec CONNECTED sur 6273 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 791 candidats
  - AVEC connectivite (308) : T0=13.33 T1=0.00 T2=2.91 — pondere **5.81**
  - SANS connectivite (483) : T0=15.78 T1=0.00 T2=2.66 — pondere **5.31**
  - test de permutation : **p = 0.0330** — ecart significatif au seuil 0.05
...
- TROP-CHER : 801 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 799 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 6216 systemes
  - sans CONNECTED : 0.0% sur 1361 systemes
