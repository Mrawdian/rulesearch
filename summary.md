...
genere 2026-08-29 11:03 UTC — 180506 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 97162 systemes
...
- moteur actif `0caa9267db60` (136764 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 88086 | 43782 | 5993 | 2983 | 8853 | 7019 | 9257 | 9077 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 86305 | 20161 | 36453 | 40 | 11917 | 4412 | 35 | 13281 | 15.4% |
...
- candidats AVEC connectivite : 9204, dont T2 : 100%
- candidats SANS connectivite : 13591, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9531 systemes avec CONNECTED sur 74369 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*18505 candidats sur 22795 portent les champs bruts (81%).*

- `5c556c16ea8b` — 12540 candidats
  - AVEC connectivite (5076) : resistance **41.2%**
  - SANS connectivite (7464) : resistance **21.5%**
...
- `5c556c16ea8b` — 12540 candidats
  - AVEC connectivite (5076) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (7464) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 71868 systemes
  - sans CONNECTED : 0.0% sur 16218 systemes
