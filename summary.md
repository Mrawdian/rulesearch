...
genere 2026-08-26 22:32 UTC — 67481 systemes evalues
...
- moteur actif `0caa9267db60` (23739 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 31009 | 15399 | 2122 | 1040 | 3088 | 2471 | 3308 | 3186 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 30357 | 6992 | 12891 | 18 | 4206 | 1578 | 14 | 4658 | 15.3% |
...
- candidats AVEC connectivite : 3313, dont T2 : 100%
- candidats SANS connectivite : 4968, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3582 systemes avec CONNECTED sur 27854 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3991 candidats sur 8281 portent les champs bruts (48%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 314 candidats
  - AVEC connectivite (133) : resistance **43.0%**
  - SANS connectivite (181) : resistance **22.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 314 candidats
  - AVEC connectivite (133) : T0=12.82 T1=0.00 T2=3.11 — pondere **6.23**
  - SANS connectivite (181) : T0=16.18 T1=0.00 T2=2.80 — pondere **5.59**
  - test de permutation : **p = 0.0830** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- TROP-CHER : 3606 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3582 avec CONNECTED, 24 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 25353 systemes
  - sans CONNECTED : 0.0% sur 5656 systemes
