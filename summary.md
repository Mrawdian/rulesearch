...
genere 2026-08-27 00:46 UTC — 72389 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 9167 systemes
- `ab89a63b01ef` : 7482 systemes
...
- moteur actif `0caa9267db60` (28647 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 32781 | 7555 | 13916 | 18 | 4555 | 1716 | 16 | 5005 | 15.3% |
...
- candidats SANS connectivite : 5315, dont T2 : 100%
...
*4572 candidats sur 8862 portent les champs bruts (52%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 895 candidats
  - AVEC connectivite (367) : resistance **41.0%**
  - SANS connectivite (528) : resistance **21.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 895 candidats
  ...
  - SANS connectivite (528) : T0=15.90 T1=0.00 T2=2.61 — pondere **5.23**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
