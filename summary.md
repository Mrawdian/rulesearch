...
genere 2026-08-26 03:41 UTC — 21518 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 12544 systemes
...
| connect | 4 | 3 | 10818 | 5439 | 713 | 372 | 1036 | 865 | 1167 | 1087 | 10.0% |
| ref | 4 | 3 | 10576 | 2539 | 4447 | 5 | 1422 | 538 | 4 | 1621 | 15.3% |
...
- candidats AVEC connectivite : 1090, dont T2 : 100%
- candidats SANS connectivite : 1625, dont T2 : 100%
...
- **1167 systemes avec CONNECTED sur 8925 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1550 candidats
  - AVEC connectivite (611) : T0=13.36 T1=0.00 T2=2.87 — pondere **5.73**
  - SANS connectivite (939) : T0=15.80 T1=0.00 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 1171 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 1167 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 8868 systemes
  - sans CONNECTED : 0.0% sur 1950 systemes
