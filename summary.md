...
genere 2026-08-29 17:09 UTC — 189936 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 106592 systemes
...
- moteur actif `0caa9267db60` (146194 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 92839 | 46142 | 6322 | 3117 | 9358 | 7377 | 9777 | 9556 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 90982 | 21246 | 38388 | 43 | 12575 | 4677 | 36 | 14011 | 15.4% |
...
- candidats SANS connectivite : 14321, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10051 systemes avec CONNECTED sur 78236 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*19714 candidats sur 24004 portent les champs bruts (82%).*

- `5c556c16ea8b` — 13749 candidats
  - AVEC connectivite (5555) : resistance **41.2%**
  - SANS connectivite (8194) : resistance **21.5%**
...
- `5c556c16ea8b` — 13749 candidats
  ...
  - SANS connectivite (8194) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.33**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 75735 systemes
  - sans CONNECTED : 0.0% sur 17104 systemes
