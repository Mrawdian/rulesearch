...
- moteur actif `0caa9267db60` (47263 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 42884 | 21357 | 2942 | 1451 | 4285 | 3371 | 4516 | 4404 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 42006 | 9685 | 17838 | 25 | 5815 | 2190 | 22 | 6430 | 15.3% |
...
- candidats SANS connectivite : 6740, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4790 systemes avec CONNECTED sur 37539 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6981 candidats sur 11271 portent les champs bruts (62%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 1016 candidats
  - AVEC connectivite (403) : resistance **41.3%**
  - SANS connectivite (613) : resistance **21.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 1016 candidats
  ...
  - SANS connectivite (613) : T0=15.83 T1=0.00 T2=2.65 — pondere **5.29**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 35038 systemes
  - sans CONNECTED : 0.0% sur 7846 systemes
