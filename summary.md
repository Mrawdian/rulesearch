...
genere 2026-08-30 14:18 UTC — 221174 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 137830 systemes
...
- moteur actif `0caa9267db60` (177432 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 108626 | 53983 | 7379 | 3627 | 10946 | 8617 | 11485 | 11169 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 106433 | 24819 | 44935 | 49 | 14715 | 5503 | 41 | 16362 | 15.4% |
...
- candidats AVEC connectivite : 11296, dont T2 : 100%
- candidats SANS connectivite : 16672, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11759 systemes avec CONNECTED sur 91123 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*23678 candidats sur 27968 portent les champs bruts (85%).*

- `5c556c16ea8b` — 17713 candidats
  - AVEC connectivite (7168) : resistance **41.1%**
  - SANS connectivite (10545) : resistance **21.5%**
...
- `5c556c16ea8b` — 17713 candidats
  - AVEC connectivite (7168) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (10545) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 11810 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11759 avec CONNECTED, 51 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 88622 systemes
  - sans CONNECTED : 0.0% sur 20004 systemes
