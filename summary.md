...
genere 2026-09-01 10:19 UTC — 279798 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 196454 systemes
...
- moteur actif `0caa9267db60` (236056 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 138229 | 68707 | 9352 | 4614 | 14027 | 10899 | 14607 | 14235 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 135454 | 31566 | 57245 | 58 | 18777 | 7014 | 60 | 20723 | 15.3% |
...
- candidats AVEC connectivite : 14362, dont T2 : 100%
- candidats SANS connectivite : 21033, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14881 systemes avec CONNECTED sur 115294 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*31105 candidats sur 35395 portent les champs bruts (88%).*

- `5c556c16ea8b` — 25140 candidats
  - AVEC connectivite (10234) : resistance **41.1%**
  - SANS connectivite (14906) : resistance **21.4%**
...
- `5c556c16ea8b` — 25140 candidats
  - AVEC connectivite (10234) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (14906) : T0=15.93 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 14951 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14881 avec CONNECTED, 70 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 112793 systemes
  - sans CONNECTED : 0.0% sur 25436 systemes
