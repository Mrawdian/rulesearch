...
genere 2026-08-26 18:39 UTC — 58876 systemes evalues
...
- moteur actif `0caa9267db60` (15134 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 26657 | 13289 | 1819 | 901 | 2644 | 2107 | 2840 | 2728 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 26104 | 6006 | 11062 | 15 | 3642 | 1342 | 10 | 4027 | 15.4% |
...
- candidats AVEC connectivite : 2855, dont T2 : 100%
- candidats SANS connectivite : 4337, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3114 systemes avec CONNECTED sur 24303 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2902 candidats sur 7192 portent les champs bruts (40%).*
...
- `b71bb0907fb5` — 53 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 33 candidats
  - AVEC connectivite (11) : resistance **41.1%**
  - SANS connectivite (22) : resistance **14.9%**
...
- `62448a55927e` — 33 candidats
  - AVEC connectivite (11) : T0=12.82 T1=0.00 T2=3.18 — pondere **6.36**
  - SANS connectivite (22) : T0=15.91 T1=0.00 T2=2.23 — pondere **4.45**
  - *groupes trop petits (< 20) — aucun test, aucune conclusion*
- `e8a1f930f7b9` — 28 candidats
...
- TROP-CHER : 3134 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3114 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 21802 systemes
  - sans CONNECTED : 0.0% sur 4855 systemes
