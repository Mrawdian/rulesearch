...
genere 2026-08-29 03:12 UTC — 167880 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 84536 systemes
...
- moteur actif `0caa9267db60` (124138 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 81705 | 40658 | 5557 | 2773 | 8201 | 6486 | 8579 | 8410 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 80060 | 18629 | 33877 | 36 | 11085 | 4069 | 34 | 12325 | 15.4% |
...
- candidats SANS connectivite : 12635, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8853 systemes avec CONNECTED sur 69162 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*16882 candidats sur 21172 portent les champs bruts (80%).*

- `5c556c16ea8b` — 10917 candidats
  - AVEC connectivite (4409) : resistance **41.2%**
  - SANS connectivite (6508) : resistance **21.7%**
...
- `5c556c16ea8b` — 10917 candidats
  ...
  - SANS connectivite (6508) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.34**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 66661 systemes
  - sans CONNECTED : 0.0% sur 15044 systemes
