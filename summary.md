...
| connect | 4 | 3 | 6560 | 3299 | 424 | 236 | 631 | 530 | 683 | 682 | 10.4% |
...
- candidats AVEC connectivite : 685, dont T2 : 100%
...
- **683 systemes avec CONNECTED sur 5430 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 539 candidats
  - AVEC connectivite (206) : T0=13.18 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 685 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 683 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 5373 systemes
