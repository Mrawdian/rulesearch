...
genere 2026-09-02 15:32 UTC — 314503 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 231159 systemes
...
- moteur actif `0caa9267db60` (270761 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 155737 | 77366 | 10595 | 5202 | 15836 | 12258 | 16506 | 15972 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 152651 | 35555 | 64579 | 64 | 21080 | 7900 | 63 | 23398 | 15.3% |
...
- candidats AVEC connectivite : 16099, dont T2 : 100%
- candidats SANS connectivite : 23708, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16780 systemes avec CONNECTED sur 129615 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*35517 candidats sur 39807 portent les champs bruts (89%).*

- `5c556c16ea8b` — 29552 candidats
  - AVEC connectivite (11971) : resistance **41.1%**
  - SANS connectivite (17581) : resistance **21.3%**
...
- `5c556c16ea8b` — 29552 candidats
  - AVEC connectivite (11971) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (17581) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 127114 systemes
  - sans CONNECTED : 0.0% sur 28623 systemes
