...
| connect | 4 | 3 | 4303 | 2165 | 277 | 149 | 416 | 336 | 448 | 462 | 10.7% |
| ref | 4 | 3 | 4209 | 1025 | 1772 | 1 | 561 | 198 | 2 | 650 | 15.4% |
...
- candidats AVEC connectivite : 465, dont T2 : 100%
- candidats SANS connectivite : 654, dont T2 : 100%
...
- **448 systemes avec CONNECTED sur 3592 (12.5%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- TROP-CHER : 450 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 448 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 3535 systemes
  - sans CONNECTED : 0.0% sur 768 systemes
