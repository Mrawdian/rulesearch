...
genere 2026-09-06 06:31 UTC — 407189 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 323845 systemes
...
- moteur actif `0caa9267db60` (363447 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 202545 | 100567 | 13820 | 6742 | 20538 | 15924 | 21514 | 20865 | 10.3% |
...
- candidats AVEC connectivite : 20992, dont T2 : 100%
...
- **21788 systemes avec CONNECTED sur 167773 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*47521 candidats sur 51811 portent les champs bruts (92%).*

- `5c556c16ea8b` — 41556 candidats
  - AVEC connectivite (16864) : resistance **41.1%**
...
- `5c556c16ea8b` — 41556 candidats
  - AVEC connectivite (16864) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
...
- TROP-CHER : 21871 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21788 avec CONNECTED, 83 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 165272 systemes
  - sans CONNECTED : 0.0% sur 37273 systemes
