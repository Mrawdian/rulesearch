...
genere 2026-09-06 10:58 UTC — 411580 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 328236 systemes
...
- moteur actif `0caa9267db60` (367838 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 204753 | 101665 | 13968 | 6815 | 20760 | 16104 | 21741 | 21096 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 200712 | 46648 | 84695 | 79 | 27980 | 10368 | 73 | 30852 | 15.4% |
...
- candidats AVEC connectivite : 21223, dont T2 : 100%
- candidats SANS connectivite : 31162, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **22015 systemes avec CONNECTED sur 169582 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*48095 candidats sur 52385 portent les champs bruts (92%).*

- `5c556c16ea8b` — 42130 candidats
  - AVEC connectivite (17095) : resistance **41.1%**
  - SANS connectivite (25035) : resistance **21.3%**
...
- `5c556c16ea8b` — 42130 candidats
  - AVEC connectivite (17095) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (25035) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 22098 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 22015 avec CONNECTED, 83 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 167081 systemes
  - sans CONNECTED : 0.0% sur 37672 systemes
