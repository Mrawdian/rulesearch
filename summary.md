...
genere 2026-09-04 08:04 UTC — 359823 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 276479 systemes
...
- moteur actif `0caa9267db60` (316081 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 178624 | 88776 | 12134 | 5973 | 18176 | 14074 | 18925 | 18292 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 175084 | 40680 | 73960 | 71 | 24308 | 9076 | 70 | 26905 | 15.4% |
...
- candidats AVEC connectivite : 18419, dont T2 : 100%
- candidats SANS connectivite : 27215, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19199 systemes avec CONNECTED sur 148243 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*41344 candidats sur 45634 portent les champs bruts (91%).*

- `5c556c16ea8b` — 35379 candidats
  - AVEC connectivite (14291) : resistance **41.1%**
  - SANS connectivite (21088) : resistance **21.3%**
...
- `5c556c16ea8b` — 35379 candidats
  - AVEC connectivite (14291) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (21088) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 19279 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19199 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 145742 systemes
  - sans CONNECTED : 0.0% sur 32882 systemes
