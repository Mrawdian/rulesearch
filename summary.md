...
| connect | 4 | 3 | 18770 | 9365 | 1220 | 652 | 1872 | 1496 | 2035 | 1897 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 18382 | 4321 | 7748 | 13 | 2525 | 948 | 7 | 2820 | 15.3% |
...
- candidats AVEC connectivite : 2024, dont T2 : 100%
- candidats SANS connectivite : 3130, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2309 systemes avec CONNECTED sur 17818 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*864 candidats sur 5154 portent les champs bruts (17%).*
...
- `e3baecf8377b` — 600 candidats
  - AVEC connectivite (241) : resistance **41.8%**
  - SANS connectivite (359) : resistance **21.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 600 candidats
  - AVEC connectivite (241) : T0=13.12 T1=0.00 T2=3.07 — pondere **6.15**
  - SANS connectivite (359) : T0=15.94 T1=0.00 T2=2.64 — pondere **5.29**
...
## cout
- temps total 13.5 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2326 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 2309 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 15317 systemes
  - sans CONNECTED : 0.0% sur 3453 systemes
