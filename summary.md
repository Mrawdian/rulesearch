...
| connect | 4 | 3 | 17095 | 8548 | 1101 | 590 | 1698 | 1360 | 1862 | 1721 | 10.1% |
...
- candidats AVEC connectivite : 1848, dont T2 : 100%
- candidats SANS connectivite : 2869, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2136 systemes avec CONNECTED sur 16469 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*427 candidats sur 4717 portent les champs bruts (9%).*
...
- `e3baecf8377b` — 163 candidats
  - AVEC connectivite (65) : resistance **41.8%**
...
- `e3baecf8377b` — 163 candidats
  - AVEC connectivite (65) : T0=13.40 T1=0.00 T2=3.17 — pondere **6.34**
...
- TROP-CHER : 2153 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2136 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 13968 systemes
  - sans CONNECTED : 0.0% sur 3127 systemes
