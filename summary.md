...
genere 2026-09-05 23:24 UTC — 400244 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 316900 systemes
...
- moteur actif `0caa9267db60` (356502 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 199039 | 98813 | 13556 | 6635 | 20213 | 15683 | 21126 | 20481 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 195090 | 45398 | 82308 | 78 | 27173 | 10071 | 72 | 29973 | 15.4% |
...
- candidats AVEC connectivite : 20608, dont T2 : 100%
- candidats SANS connectivite : 30283, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21400 systemes avec CONNECTED sur 164875 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*46601 candidats sur 50891 portent les champs bruts (92%).*

- `5c556c16ea8b` — 40636 candidats
  - AVEC connectivite (16480) : resistance **41.0%**
  - SANS connectivite (24156) : resistance **21.3%**
...
- `5c556c16ea8b` — 40636 candidats
  - AVEC connectivite (16480) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.94**
  - SANS connectivite (24156) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 21482 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21400 avec CONNECTED, 82 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 162374 systemes
  - sans CONNECTED : 0.0% sur 36665 systemes
