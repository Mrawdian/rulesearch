...
genere 2026-08-26 19:54 UTC — 61662 systemes evalues
...
- moteur actif `0caa9267db60` (17920 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 28078 | 13987 | 1919 | 947 | 2780 | 2221 | 2990 | 2882 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 27469 | 6346 | 11633 | 15 | 3818 | 1414 | 12 | 4231 | 15.4% |
...
- candidats AVEC connectivite : 3009, dont T2 : 100%
- candidats SANS connectivite : 4541, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3264 systemes avec CONNECTED sur 25483 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3260 candidats sur 7550 portent les champs bruts (43%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 391 candidats
  - AVEC connectivite (165) : resistance **39.5%**
  - SANS connectivite (226) : resistance **19.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 391 candidats
  - AVEC connectivite (165) : T0=12.99 T1=0.00 T2=2.87 — pondere **5.75**
  - SANS connectivite (226) : T0=16.06 T1=0.00 T2=2.59 — pondere **5.19**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22982 systemes
  - sans CONNECTED : 0.0% sur 5096 systemes
