...
genere 2026-08-26 18:22 UTC — 58146 systemes evalues
...
- `8f22f0d2d442` : 45 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (14404 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 26298 | 13105 | 1787 | 892 | 2610 | 2077 | 2805 | 2698 | 10.3% |
...
- candidats AVEC connectivite : 2825, dont T2 : 100%
- candidats SANS connectivite : 4274, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3079 systemes avec CONNECTED sur 24006 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2809 candidats sur 7099 portent les champs bruts (40%).*
...
- TROP-CHER : 3099 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3079 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 21505 systemes
  - sans CONNECTED : 0.0% sur 4793 systemes
