...
genere 2026-09-01 01:07 UTC — 268230 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 184886 systemes
...
- moteur actif `0caa9267db60` (224488 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 132398 | 65794 | 8955 | 4439 | 13422 | 10465 | 13980 | 13627 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 129717 | 30234 | 54809 | 56 | 17966 | 6717 | 57 | 19868 | 15.3% |
...
- candidats AVEC connectivite : 13754, dont T2 : 100%
- candidats SANS connectivite : 20178, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14254 systemes avec CONNECTED sur 110524 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*29642 candidats sur 33932 portent les champs bruts (87%).*

- `5c556c16ea8b` — 23677 candidats
  - AVEC connectivite (9626) : resistance **41.0%**
  - SANS connectivite (14051) : resistance **21.3%**
...
- `5c556c16ea8b` — 23677 candidats
  - AVEC connectivite (9626) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (14051) : T0=15.93 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 14321 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14254 avec CONNECTED, 67 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 108023 systemes
  - sans CONNECTED : 0.0% sur 24375 systemes
