...
genere 2026-08-27 06:27 UTC — 84929 systemes evalues
...
- moteur actif `0caa9267db60` (41187 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 39825 | 19839 | 2728 | 1355 | 3962 | 3131 | 4210 | 4087 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 38989 | 8980 | 16593 | 22 | 5404 | 2036 | 21 | 5933 | 15.2% |
...
- candidats AVEC connectivite : 4214, dont T2 : 100%
- candidats SANS connectivite : 6243, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4484 systemes avec CONNECTED sur 35071 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6167 candidats sur 10457 portent les champs bruts (59%).*
...
- `23303c299f39` — 225 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 202 candidats
  - AVEC connectivite (86) : resistance **42.8%**
  - SANS connectivite (116) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 202 candidats
  - AVEC connectivite (86) : T0=12.74 T1=0.00 T2=3.10 — pondere **6.21**
  - SANS connectivite (116) : T0=15.89 T1=0.00 T2=2.59 — pondere **5.19**
...
- TROP-CHER : 4515 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4484 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 32570 systemes
  - sans CONNECTED : 0.0% sur 7255 systemes
