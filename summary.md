...
genere 2026-08-26 23:30 UTC — 69634 systemes evalues
...
- moteur actif `0caa9267db60` (25892 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 32102 | 15956 | 2205 | 1080 | 3200 | 2557 | 3423 | 3275 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 31417 | 7245 | 13344 | 18 | 4343 | 1644 | 14 | 4809 | 15.3% |
...
- candidats AVEC connectivite : 3402, dont T2 : 100%
- candidats SANS connectivite : 5119, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3697 systemes avec CONNECTED sur 28741 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4231 candidats sur 8521 portent les champs bruts (50%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 554 candidats
  - AVEC connectivite (222) : resistance **42.4%**
  - SANS connectivite (332) : resistance **22.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 554 candidats
  - AVEC connectivite (222) : T0=13.02 T1=0.00 T2=3.12 — pondere **6.23**
  - SANS connectivite (332) : T0=16.05 T1=0.00 T2=2.67 — pondere **5.35**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 26240 systemes
  - sans CONNECTED : 0.0% sur 5862 systemes
