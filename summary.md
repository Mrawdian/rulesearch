...
genere 2026-08-26 01:44 UTC — 16727 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 7753 systemes
...
| connect | 4 | 3 | 8401 | 4231 | 547 | 285 | 797 | 675 | 894 | 871 | 10.4% |
| ref | 4 | 3 | 8202 | 1983 | 3439 | 2 | 1099 | 401 | 3 | 1275 | 15.5% |
...
- candidats AVEC connectivite : 874, dont T2 : 100%
- candidats SANS connectivite : 1279, dont T2 : 100%
...
- **894 systemes avec CONNECTED sur 6954 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 988 candidats
  - AVEC connectivite (395) : T0=13.38 T1=0.00 T2=2.85 — pondere **5.70**
  - SANS connectivite (593) : T0=15.93 T1=0.00 T2=2.66 — pondere **5.31**
  - test de permutation : **p = 0.0575** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 897 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 894 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 6897 systemes
  - sans CONNECTED : 0.0% sur 1504 systemes
