...
genere 2026-08-25 20:23 UTC — 2884 systemes evalues

## versions du DSL presentes
- `615abe43d6bc` : 1907 systemes
...
| connect | 4 | 3 | 1403 | 708 | 101 | 55 | 149 | 107 | 131 | 136 | 9.7% |
...
- candidats AVEC connectivite : 139, dont T2 : 100%
- candidats SANS connectivite : 214, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **131 systemes avec CONNECTED sur 1202 (10.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- TROP-CHER : 132 systemes abandonnes (4.6% des systemes), 95% du temps total
  dont 131 avec CONNECTED, 1 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 11.4% sur 1145 systemes
  - sans CONNECTED : 0.0% sur 258 systemes
