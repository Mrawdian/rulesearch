...
genere 2026-08-29 01:36 UTC — 165296 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 81952 systemes
...
- moteur actif `0caa9267db60` (121554 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 80401 | 39999 | 5471 | 2727 | 8047 | 6400 | 8437 | 8297 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 78780 | 18309 | 33357 | 36 | 10883 | 4008 | 33 | 12149 | 15.4% |
...
- candidats AVEC connectivite : 8424, dont T2 : 100%
- candidats SANS connectivite : 12459, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8711 systemes avec CONNECTED sur 68095 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*16593 candidats sur 20883 portent les champs bruts (79%).*

- `5c556c16ea8b` — 10628 candidats
  - AVEC connectivite (4296) : resistance **41.1%**
  - SANS connectivite (6332) : resistance **21.7%**
...
- `5c556c16ea8b` — 10628 candidats
  - AVEC connectivite (4296) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (6332) : T0=15.90 T1=0.00 T2=2.67 — pondere **5.35**
...
- TROP-CHER : 8754 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8711 avec CONNECTED, 43 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 65594 systemes
  - sans CONNECTED : 0.0% sur 14807 systemes
