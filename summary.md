...
genere 2026-08-27 20:41 UTC — 113314 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 29970 systemes
...
- moteur actif `0caa9267db60` (69572 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 54137 | 26956 | 3744 | 1838 | 5341 | 4284 | 5734 | 5533 | 10.2% |
...
- candidats AVEC connectivite : 5660, dont T2 : 100%
- candidats SANS connectivite : 8427, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6008 systemes avec CONNECTED sur 46744 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*9797 candidats sur 14087 portent les champs bruts (70%).*

- `5c556c16ea8b` — 3832 candidats
  - AVEC connectivite (1532) : resistance **41.9%**
...
- `5c556c16ea8b` — 3832 candidats
  - AVEC connectivite (1532) : T0=12.94 T1=0.00 T2=3.05 — pondere **6.10**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 44243 systemes
  - sans CONNECTED : 0.0% sur 9894 systemes
