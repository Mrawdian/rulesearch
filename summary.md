...
| connect | 4 | 3 | 6219 | 3139 | 398 | 226 | 599 | 499 | 641 | 644 | 10.4% |
...
- candidats AVEC connectivite : 647, dont T2 : 100%
...
- **641 systemes avec CONNECTED sur 5152 (12.4%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 445 candidats
  - AVEC connectivite (168) : T0=13.26 T1=0.00 T2=2.96 — pondere **5.93**
...
- TROP-CHER : 643 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 641 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.6% sur 5095 systemes
  - sans CONNECTED : 0.0% sur 1124 systemes
