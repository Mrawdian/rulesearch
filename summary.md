...
| connect | 4 | 3 | 17843 | 8931 | 1157 | 617 | 1767 | 1413 | 1941 | 1793 | 10.0% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 17457 | 4107 | 7370 | 12 | 2388 | 891 | 7 | 2682 | 15.4% |
...
- candidats AVEC connectivite : 1920, dont T2 : 100%
- candidats SANS connectivite : 2992, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2215 systemes avec CONNECTED sur 17080 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*622 candidats sur 4912 portent les champs bruts (13%).*
...
- `e3baecf8377b` — 358 candidats
  - AVEC connectivite (137) : resistance **43.9%**
  - SANS connectivite (221) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 358 candidats
  - AVEC connectivite (137) : T0=12.90 T1=0.00 T2=3.18 — pondere **6.35**
  - SANS connectivite (221) : T0=16.01 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 2232 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2215 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14579 systemes
  - sans CONNECTED : 0.0% sur 3264 systemes
