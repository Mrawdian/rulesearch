...
genere 2026-08-26 22:17 UTC — 66978 systemes evalues
...
- moteur actif `0caa9267db60` (23236 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 30108 | 6937 | 12788 | 18 | 4166 | 1557 | 14 | 4628 | 15.4% |
...
- candidats SANS connectivite : 4938, dont T2 : 100%
...
*3929 candidats sur 8219 portent les champs bruts (48%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 252 candidats
  - AVEC connectivite (101) : resistance **43.0%**
  - SANS connectivite (151) : resistance **22.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 252 candidats
  ...
  - SANS connectivite (151) : T0=16.13 T1=0.00 T2=2.80 — pondere **5.60**
  - test de permutation : **p = 0.2059** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
