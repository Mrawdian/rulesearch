...
genere 2026-08-26 13:18 UTC — 46231 systemes evalues
...
- moteur actif `0caa9267db60` (2489 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20276 | 10119 | 1334 | 699 | 2031 | 1610 | 2169 | 2065 | 10.2% |
...
- candidats AVEC connectivite : 2192, dont T2 : 100%
- candidats SANS connectivite : 3333, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2443 systemes avec CONNECTED sur 19047 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1235 candidats sur 5525 portent les champs bruts (22%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 120 candidats
  - AVEC connectivite (54) : resistance **38.9%**
...
- `06fe04a859f1` — 120 candidats
  - AVEC connectivite (54) : T0=13.07 T1=0.00 T2=2.80 — pondere **5.59**
  - SANS connectivite (66) : T0=16.64 T1=0.00 T2=2.94 — pondere **5.88**
  - test de permutation : **p = 0.6347** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 2460 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2443 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16546 systemes
  - sans CONNECTED : 0.0% sur 3730 systemes
