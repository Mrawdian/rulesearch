...
genere 2026-09-08 23:30 UTC — 467384 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 384040 systemes
...
- moteur actif `0caa9267db60` (423642 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 232946 | 115704 | 15864 | 7797 | 23573 | 18246 | 24817 | 23988 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 228323 | 53178 | 96198 | 92 | 31818 | 11792 | 82 | 35144 | 15.4% |
...
- candidats AVEC connectivite : 24115, dont T2 : 100%
- candidats SANS connectivite : 35454, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25091 systemes avec CONNECTED sur 192706 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55279 candidats sur 59569 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49314 candidats
  - AVEC connectivite (19987) : resistance **41.2%**
  - SANS connectivite (29327) : resistance **21.3%**
...
- `5c556c16ea8b` — 49314 candidats
  - AVEC connectivite (19987) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.97**
  - SANS connectivite (29327) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 25183 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25091 avec CONNECTED, 92 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 190205 systemes
  - sans CONNECTED : 0.0% sur 42741 systemes
