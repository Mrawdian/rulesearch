...
genere 2026-09-03 20:40 UTC — 347467 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 264123 systemes
...
- moteur actif `0caa9267db60` (303725 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 172381 | 85683 | 11708 | 5771 | 17555 | 13589 | 18260 | 17622 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 168971 | 39291 | 71427 | 67 | 23433 | 8742 | 66 | 25932 | 15.3% |
...
- candidats AVEC connectivite : 17749, dont T2 : 100%
- candidats SANS connectivite : 26242, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18534 systemes avec CONNECTED sur 143140 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39701 candidats sur 43991 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33736 candidats
  - AVEC connectivite (13621) : resistance **41.0%**
  - SANS connectivite (20115) : resistance **21.2%**
...
- `5c556c16ea8b` — 33736 candidats
  - AVEC connectivite (13621) : T0=13.03 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (20115) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.29**
...
- TROP-CHER : 18610 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18534 avec CONNECTED, 76 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 140639 systemes
  - sans CONNECTED : 0.0% sur 31742 systemes
