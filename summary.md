...
genere 2026-09-02 00:51 UTC — 297539 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 214195 systemes
...
- moteur actif `0caa9267db60` (253797 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 147187 | 73118 | 10020 | 4934 | 14932 | 11596 | 15565 | 15128 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 144237 | 33555 | 61012 | 61 | 19979 | 7447 | 63 | 22108 | 15.3% |
...
- candidats AVEC connectivite : 15255, dont T2 : 100%
- candidats SANS connectivite : 22418, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15839 systemes avec CONNECTED sur 122648 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*33383 candidats sur 37673 portent les champs bruts (89%).*

- `5c556c16ea8b` — 27418 candidats
  - AVEC connectivite (11127) : resistance **41.0%**
  - SANS connectivite (16291) : resistance **21.3%**
...
- `5c556c16ea8b` — 27418 candidats
  - AVEC connectivite (11127) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (16291) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 15912 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15839 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 120147 systemes
  - sans CONNECTED : 0.0% sur 27040 systemes
