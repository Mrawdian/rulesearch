...
genere 2026-09-10 03:51 UTC — 491874 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 408530 systemes
...
- moteur actif `0caa9267db60` (448132 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 245314 | 121801 | 16704 | 8227 | 24825 | 19247 | 26154 | 25242 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 240445 | 56046 | 101294 | 96 | 33484 | 12420 | 87 | 36997 | 15.4% |
...
- candidats SANS connectivite : 37307, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **26428 systemes avec CONNECTED sur 202793 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*58386 candidats sur 62676 portent les champs bruts (93%).*

- `5c556c16ea8b` — 52421 candidats
  - AVEC connectivite (21241) : resistance **41.2%**
  - SANS connectivite (31180) : resistance **21.3%**
...
- `5c556c16ea8b` — 52421 candidats
  ...
  - SANS connectivite (31180) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 26525 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 26428 avec CONNECTED, 97 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 200292 systemes
  - sans CONNECTED : 0.0% sur 45022 systemes
