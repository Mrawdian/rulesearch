...
genere 2026-09-01 10:27 UTC — 280005 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 196661 systemes
...
- moteur actif `0caa9267db60` (236263 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 138334 | 68768 | 9357 | 4617 | 14038 | 10908 | 14613 | 14245 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 135556 | 31591 | 57284 | 58 | 18793 | 7019 | 60 | 20740 | 15.3% |
...
- candidats AVEC connectivite : 14372, dont T2 : 100%
- candidats SANS connectivite : 21050, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14887 systemes avec CONNECTED sur 115380 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*31132 candidats sur 35422 portent les champs bruts (88%).*

- `5c556c16ea8b` — 25167 candidats
  - AVEC connectivite (10244) : resistance **41.1%**
  - SANS connectivite (14923) : resistance **21.4%**
...
- `5c556c16ea8b` — 25167 candidats
  - AVEC connectivite (10244) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (14923) : T0=15.93 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 14957 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14887 avec CONNECTED, 70 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 112879 systemes
  - sans CONNECTED : 0.0% sur 25455 systemes
