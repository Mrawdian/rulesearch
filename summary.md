...
genere 2026-09-05 01:34 UTC — 378170 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 294826 systemes
...
- moteur actif `0caa9267db60` (334428 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 187881 | 93308 | 12795 | 6279 | 19107 | 14800 | 19920 | 19266 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 184174 | 42845 | 77787 | 77 | 25586 | 9534 | 70 | 28261 | 15.3% |
...
- candidats AVEC connectivite : 19393, dont T2 : 100%
- candidats SANS connectivite : 28571, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20194 systemes avec CONNECTED sur 155769 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*43674 candidats sur 47964 portent les champs bruts (91%).*

- `5c556c16ea8b` — 37709 candidats
  - AVEC connectivite (15265) : resistance **41.1%**
  - SANS connectivite (22444) : resistance **21.2%**
...
- `5c556c16ea8b` — 37709 candidats
  - AVEC connectivite (15265) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (22444) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 20274 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 20194 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 153268 systemes
  - sans CONNECTED : 0.0% sur 34613 systemes
