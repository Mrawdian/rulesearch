...
genere 2026-09-05 10:37 UTC — 387434 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 304090 systemes
...
- moteur actif `0caa9267db60` (343692 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 192573 | 95630 | 13115 | 6409 | 19587 | 15156 | 20425 | 19788 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 188746 | 43936 | 79665 | 77 | 26266 | 9763 | 70 | 28955 | 15.3% |
...
- candidats AVEC connectivite : 19915, dont T2 : 100%
- candidats SANS connectivite : 29265, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20699 systemes avec CONNECTED sur 159597 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*44890 candidats sur 49180 portent les champs bruts (91%).*

- `5c556c16ea8b` — 38925 candidats
  - AVEC connectivite (15787) : resistance **41.1%**
  - SANS connectivite (23138) : resistance **21.3%**
...
- `5c556c16ea8b` — 38925 candidats
  - AVEC connectivite (15787) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (23138) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 157096 systemes
  - sans CONNECTED : 0.0% sur 35477 systemes
