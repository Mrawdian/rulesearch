...
genere 2026-09-06 14:46 UTC — 415193 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 331849 systemes
...
- moteur actif `0caa9267db60` (371451 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 206589 | 102576 | 14079 | 6878 | 20945 | 16248 | 21948 | 21288 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 202489 | 47059 | 85428 | 79 | 28240 | 10461 | 73 | 31132 | 15.4% |
...
- candidats AVEC connectivite : 21415, dont T2 : 100%
- candidats SANS connectivite : 31442, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **22222 systemes avec CONNECTED sur 171084 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*48567 candidats sur 52857 portent les champs bruts (92%).*

- `5c556c16ea8b` — 42602 candidats
  - AVEC connectivite (17287) : resistance **41.1%**
  - SANS connectivite (25315) : resistance **21.3%**
...
- `5c556c16ea8b` — 42602 candidats
  - AVEC connectivite (17287) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (25315) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 168583 systemes
  - sans CONNECTED : 0.0% sur 38006 systemes
