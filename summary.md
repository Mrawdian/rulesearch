...
genere 2026-08-29 14:28 UTC — 185842 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 102498 systemes
...
- moteur actif `0caa9267db60` (142100 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 90773 | 45147 | 6171 | 3057 | 9134 | 7228 | 9549 | 9336 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 88954 | 20783 | 37537 | 43 | 12290 | 4564 | 35 | 13696 | 15.4% |
...
- candidats AVEC connectivite : 9463, dont T2 : 100%
- candidats SANS connectivite : 14006, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9823 systemes avec CONNECTED sur 76558 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*19179 candidats sur 23469 portent les champs bruts (82%).*

- `5c556c16ea8b` — 13214 candidats
  - AVEC connectivite (5335) : resistance **41.2%**
  - SANS connectivite (7879) : resistance **21.5%**
...
- `5c556c16ea8b` — 13214 candidats
  - AVEC connectivite (5335) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (7879) : T0=15.90 T1=0.00 T2=2.67 — pondere **5.33**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 74057 systemes
  - sans CONNECTED : 0.0% sur 16716 systemes
