...
genere 2026-09-02 00:28 UTC — 297097 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 213753 systemes
...
- moteur actif `0caa9267db60` (253355 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 146963 | 73008 | 10005 | 4925 | 14917 | 11578 | 15538 | 15100 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 144019 | 33502 | 60922 | 61 | 19947 | 7435 | 63 | 22077 | 15.3% |
...
- candidats AVEC connectivite : 15227, dont T2 : 100%
- candidats SANS connectivite : 22387, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15812 systemes avec CONNECTED sur 122459 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*33324 candidats sur 37614 portent les champs bruts (89%).*

- `5c556c16ea8b` — 27359 candidats
  - AVEC connectivite (11099) : resistance **41.0%**
  - SANS connectivite (16260) : resistance **21.3%**
...
- `5c556c16ea8b` — 27359 candidats
  - AVEC connectivite (11099) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (16260) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 15885 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15812 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 119958 systemes
  - sans CONNECTED : 0.0% sur 27005 systemes
