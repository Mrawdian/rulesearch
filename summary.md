...
genere 2026-08-26 17:52 UTC — 56977 systemes evalues
...
- `0a74109317e5` : 90 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (13235 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `84fba70921e0`, `b71bb0907fb5`, `e40600351a72`, `e8a1f930f7b9`
...
**7556 enregistrements (13%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 25699 | 12814 | 1750 | 868 | 2549 | 2029 | 2745 | 2627 | 10.2% |
...
- candidats AVEC connectivite : 2754, dont T2 : 100%
- candidats SANS connectivite : 4202, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3019 systemes avec CONNECTED sur 23509 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2666 candidats sur 6956 portent les champs bruts (38%).*
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 21008 systemes
  - sans CONNECTED : 0.0% sur 4691 systemes
