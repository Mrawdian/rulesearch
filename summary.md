...
genere 2026-08-27 08:52 UTC — 90091 systemes evalues
...
- moteur actif `0caa9267db60` (46349 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 41555 | 9579 | 17658 | 24 | 5755 | 2163 | 22 | 6354 | 15.3% |
...
- candidats SANS connectivite : 6664, dont T2 : 100%
...
*6870 candidats sur 11160 portent les champs bruts (62%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 905 candidats
  - AVEC connectivite (368) : resistance **40.9%**
  - SANS connectivite (537) : resistance **21.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 905 candidats
  ...
  - SANS connectivite (537) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
  - test de permutation : **p = 0.0045** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 798 candidats
...
**7 serie(s) reproductible(s) sur 14 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `ab89a63b01ef` (p=0.0005), `06fe04a859f1` (p=0.0005), `5c556c16ea8b` (p=0.0045), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
