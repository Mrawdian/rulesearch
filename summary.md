...
genere 2026-09-05 07:05 UTC — 383908 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 300564 systemes
...
- moteur actif `0caa9267db60` (340166 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 190775 | 94744 | 13001 | 6357 | 19396 | 15033 | 20222 | 19584 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 187018 | 43519 | 78962 | 77 | 26010 | 9681 | 70 | 28685 | 15.3% |
...
- candidats AVEC connectivite : 19711, dont T2 : 100%
- candidats SANS connectivite : 28995, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20496 systemes avec CONNECTED sur 158130 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*44416 candidats sur 48706 portent les champs bruts (91%).*

- `5c556c16ea8b` — 38451 candidats
  - AVEC connectivite (15583) : resistance **41.1%**
  - SANS connectivite (22868) : resistance **21.3%**
...
- `5c556c16ea8b` — 38451 candidats
  - AVEC connectivite (15583) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (22868) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
## cout
- temps total 119.1 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 20576 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 20496 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 155629 systemes
  - sans CONNECTED : 0.0% sur 35146 systemes
