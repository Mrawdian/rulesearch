...
genere 2026-09-09 03:14 UTC — 470783 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 387439 systemes
...
- moteur actif `0caa9267db60` (427041 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 234664 | 116538 | 16001 | 7860 | 23758 | 18376 | 24981 | 24173 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 230004 | 53579 | 96908 | 92 | 32048 | 11883 | 82 | 35393 | 15.4% |
...
- candidats AVEC connectivite : 24300, dont T2 : 100%
- candidats SANS connectivite : 35703, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25255 systemes avec CONNECTED sur 194097 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55713 candidats sur 60003 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49748 candidats
  - AVEC connectivite (20172) : resistance **41.2%**
  - SANS connectivite (29576) : resistance **21.3%**
...
- `5c556c16ea8b` — 49748 candidats
  - AVEC connectivite (20172) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.97**
  - SANS connectivite (29576) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 25347 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25255 avec CONNECTED, 92 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 191596 systemes
  - sans CONNECTED : 0.0% sur 43068 systemes
