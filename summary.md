...
genere 2026-08-28 14:45 UTC — 146471 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 63127 systemes
...
- moteur actif `0caa9267db60` (102729 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 70890 | 35223 | 4848 | 2410 | 7107 | 5655 | 7480 | 7262 | 10.2% |
...
- candidats AVEC connectivite : 7389, dont T2 : 100%
...
- **7754 systemes avec CONNECTED sur 60326 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*14140 candidats sur 18430 portent les champs bruts (77%).*

- `5c556c16ea8b` — 8175 candidats
  - AVEC connectivite (3261) : resistance **41.2%**
...
- `5c556c16ea8b` — 8175 candidats
  - AVEC connectivite (3261) : T0=13.03 T1=0.00 T2=3.00 — pondere **6.00**
...
- TROP-CHER : 7794 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7754 avec CONNECTED, 40 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 57825 systemes
  - sans CONNECTED : 0.0% sur 13065 systemes
