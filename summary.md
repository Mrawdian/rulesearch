...
genere 2026-08-26 21:02 UTC — 64136 systemes evalues
...
- moteur actif `0caa9267db60` (20394 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 29321 | 14587 | 1997 | 978 | 2921 | 2324 | 3128 | 3012 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 28700 | 6622 | 12179 | 16 | 3984 | 1477 | 12 | 4410 | 15.4% |
...
- candidats AVEC connectivite : 3139, dont T2 : 100%
- candidats SANS connectivite : 4720, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3402 systemes avec CONNECTED sur 26484 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3569 candidats sur 7859 portent les champs bruts (45%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 700 candidats
  - AVEC connectivite (295) : resistance **40.0%**
  - SANS connectivite (405) : resistance **20.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 700 candidats
  - AVEC connectivite (295) : T0=12.86 T1=0.00 T2=2.85 — pondere **5.70**
  - SANS connectivite (405) : T0=16.13 T1=0.00 T2=2.67 — pondere **5.34**
...
- TROP-CHER : 3424 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3402 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23983 systemes
  - sans CONNECTED : 0.0% sur 5338 systemes
