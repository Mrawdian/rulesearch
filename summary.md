...
genere 2026-08-29 00:27 UTC — 163206 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 79862 systemes
...
- moteur actif `0caa9267db60` (119464 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 79352 | 39467 | 5407 | 2691 | 7929 | 6326 | 8348 | 8177 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 77739 | 18066 | 32896 | 36 | 10747 | 3960 | 31 | 11998 | 15.4% |
...
- candidats AVEC connectivite : 8304, dont T2 : 100%
- candidats SANS connectivite : 12308, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8622 systemes avec CONNECTED sur 67227 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*16322 candidats sur 20612 portent les champs bruts (79%).*

- `5c556c16ea8b` — 10357 candidats
  - AVEC connectivite (4176) : resistance **41.1%**
  - SANS connectivite (6181) : resistance **21.7%**
...
- `5c556c16ea8b` — 10357 candidats
  - AVEC connectivite (4176) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (6181) : T0=15.89 T1=0.00 T2=2.68 — pondere **5.35**
...
## cout
- temps total 50.2 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 8663 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8622 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 64726 systemes
  - sans CONNECTED : 0.0% sur 14626 systemes
