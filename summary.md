...
genere 2026-08-27 04:14 UTC — 80035 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 15128 systemes
...
- moteur actif `0caa9267db60` (36293 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 37366 | 18575 | 2575 | 1275 | 3709 | 2944 | 3963 | 3840 | 10.3% |
...
- candidats AVEC connectivite : 3967, dont T2 : 100%
- candidats SANS connectivite : 5881, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4237 systemes avec CONNECTED sur 33085 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5558 candidats sur 9848 portent les champs bruts (56%).*
...
- `ab89a63b01ef` — 1881 candidats
  - AVEC connectivite (787) : resistance **41.4%**
...
- `ab89a63b01ef` — 1881 candidats
  - AVEC connectivite (787) : T0=13.08 T1=0.00 T2=3.04 — pondere **6.08**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 30584 systemes
  - sans CONNECTED : 0.0% sur 6782 systemes
