...
genere 2026-08-29 14:04 UTC — 185244 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 101900 systemes
...
- moteur actif `0caa9267db60` (141502 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 90475 | 44999 | 6148 | 3049 | 9100 | 7209 | 9513 | 9310 | 10.3% |
...
- candidats AVEC connectivite : 9437, dont T2 : 100%
...
- **9787 systemes avec CONNECTED sur 76306 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*19111 candidats sur 23401 portent les champs bruts (82%).*

- `5c556c16ea8b` — 13146 candidats
  - AVEC connectivite (5309) : resistance **41.2%**
...
- `5c556c16ea8b` — 13146 candidats
  - AVEC connectivite (5309) : T0=12.99 T1=0.00 T2=3.00 — pondere **5.99**
...
- TROP-CHER : 9832 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 9787 avec CONNECTED, 45 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 73805 systemes
  - sans CONNECTED : 0.0% sur 16670 systemes
