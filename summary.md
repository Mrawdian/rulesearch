...
genere 2026-09-01 08:26 UTC — 277433 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 194089 systemes
...
- moteur actif `0caa9267db60` (233691 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 137036 | 68093 | 9275 | 4577 | 13906 | 10823 | 14482 | 14104 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 134282 | 31296 | 56737 | 58 | 18613 | 6957 | 60 | 20551 | 15.3% |
...
- candidats SANS connectivite : 20861, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14756 systemes avec CONNECTED sur 114312 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*30802 candidats sur 35092 portent les champs bruts (88%).*

- `5c556c16ea8b` — 24837 candidats
  - AVEC connectivite (10103) : resistance **41.0%**
  - SANS connectivite (14734) : resistance **21.3%**
...
- `5c556c16ea8b` — 24837 candidats
  ...
  - SANS connectivite (14734) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 14826 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14756 avec CONNECTED, 70 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 111811 systemes
  - sans CONNECTED : 0.0% sur 25225 systemes
