...
genere 2026-08-26 18:25 UTC — 58296 systemes evalues
...
- `8f22f0d2d442` : 195 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (14554 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
**7661 enregistrements (13%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 26373 | 13143 | 1794 | 892 | 2616 | 2083 | 2811 | 2708 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 25808 | 5934 | 10938 | 15 | 3602 | 1326 | 10 | 3983 | 15.4% |
...
- candidats AVEC connectivite : 2835, dont T2 : 100%
- candidats SANS connectivite : 4293, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3085 systemes avec CONNECTED sur 24071 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2838 candidats sur 7128 portent les champs bruts (40%).*
...
- `84fba70921e0` — 33 candidats
  ...
  - *groupes trop petits (< 20) — aucun test*
- `8f22f0d2d442` — 34 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (12) : resistance **39.4%**
  - SANS connectivite (22) : resistance **18.2%**
  - *groupes trop petits (< 20) — aucun test*
...
- `84fba70921e0` — 33 candidats
  ...
  - *groupes trop petits (< 20) — aucun test, aucune conclusion*
- `8f22f0d2d442` — 34 candidats
  - AVEC connectivite (12) : T0=13.75 T1=0.00 T2=2.83 — pondere **5.67**
  - SANS connectivite (22) : T0=15.95 T1=0.00 T2=2.64 — pondere **5.27**
  - *groupes trop petits (< 20) — aucun test, aucune conclusion*

### ce que les series reproductibles etablissent

**5 serie(s) reproductible(s) sur 10 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
...
## cout
- temps total 18.0 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 3105 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3085 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 21570 systemes
  - sans CONNECTED : 0.0% sur 4803 systemes
