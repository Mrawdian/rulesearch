...
genere 2026-09-08 20:10 UTC — 464288 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 380944 systemes
...
- moteur actif `0caa9267db60` (420546 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 231392 | 114941 | 15749 | 7741 | 23397 | 18122 | 24673 | 23830 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 226781 | 52821 | 95572 | 90 | 31591 | 11725 | 81 | 34883 | 15.4% |
...
- candidats AVEC connectivite : 23957, dont T2 : 100%
- candidats SANS connectivite : 35193, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **24947 systemes avec CONNECTED sur 191477 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*54860 candidats sur 59150 portent les champs bruts (93%).*

- `5c556c16ea8b` — 48895 candidats
  - AVEC connectivite (19829) : resistance **41.2%**
  - SANS connectivite (29066) : resistance **21.3%**
...
- `5c556c16ea8b` — 48895 candidats
  - AVEC connectivite (19829) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (29066) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 188976 systemes
  - sans CONNECTED : 0.0% sur 42416 systemes
