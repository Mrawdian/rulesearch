...
genere 2026-08-27 23:01 UTC — 117927 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 34583 systemes
...
- moteur actif `0caa9267db60` (74185 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 56471 | 28122 | 3904 | 1914 | 5601 | 4472 | 5967 | 5766 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 55341 | 12771 | 23494 | 26 | 7681 | 2858 | 25 | 8484 | 15.3% |
...
- candidats AVEC connectivite : 5893, dont T2 : 100%
- candidats SANS connectivite : 8794, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6241 systemes avec CONNECTED sur 48627 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10397 candidats sur 14687 portent les champs bruts (71%).*

- `5c556c16ea8b` — 4432 candidats
  - AVEC connectivite (1765) : resistance **42.0%**
  - SANS connectivite (2667) : resistance **22.5%**
...
- `5c556c16ea8b` — 4432 candidats
  - AVEC connectivite (1765) : T0=12.96 T1=0.00 T2=3.06 — pondere **6.11**
  - SANS connectivite (2667) : T0=15.79 T1=0.00 T2=2.71 — pondere **5.43**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 46126 systemes
  - sans CONNECTED : 0.0% sur 10345 systemes
