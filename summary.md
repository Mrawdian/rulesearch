...
genere 2026-08-29 17:14 UTC — 190071 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 106727 systemes
...
- moteur actif `0caa9267db60` (146329 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 92914 | 46173 | 6330 | 3120 | 9365 | 7389 | 9783 | 9563 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 91042 | 21264 | 38410 | 43 | 12586 | 4679 | 36 | 14018 | 15.4% |
...
- candidats AVEC connectivite : 9690, dont T2 : 100%
- candidats SANS connectivite : 14328, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10057 systemes avec CONNECTED sur 78295 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*19728 candidats sur 24018 portent les champs bruts (82%).*

- `5c556c16ea8b` — 13763 candidats
  - AVEC connectivite (5562) : resistance **41.2%**
  - SANS connectivite (8201) : resistance **21.6%**
...
- `5c556c16ea8b` — 13763 candidats
  - AVEC connectivite (5562) : T0=12.99 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (8201) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.34**
...
- TROP-CHER : 10103 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10057 avec CONNECTED, 46 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 75794 systemes
  - sans CONNECTED : 0.0% sur 17120 systemes
