...
genere 2026-08-26 16:29 UTC — 53742 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 8559 systemes
...
- moteur actif `0caa9267db60` (10000 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 24074 | 12009 | 1641 | 814 | 2385 | 1905 | 2572 | 2446 | 10.2% |
...
- candidats AVEC connectivite : 2573, dont T2 : 100%
- candidats SANS connectivite : 3937, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2846 systemes avec CONNECTED sur 22167 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2220 candidats sur 6510 portent les champs bruts (34%).*
...
- `06fe04a859f1` — 1105 candidats
  - AVEC connectivite (435) : resistance **40.8%**
...
- `06fe04a859f1` — 1105 candidats
  - AVEC connectivite (435) : T0=13.13 T1=0.00 T2=3.01 — pondere **6.01**
...
- TROP-CHER : 2866 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2846 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19666 systemes
  - sans CONNECTED : 0.0% sur 4408 systemes
