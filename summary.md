...
genere 2026-08-28 16:16 UTC — 149001 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 65657 systemes
...
- moteur actif `0caa9267db60` (105259 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 72161 | 35825 | 4931 | 2461 | 7250 | 5747 | 7626 | 7398 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 70725 | 16428 | 29893 | 32 | 9767 | 3648 | 31 | 10923 | 15.4% |
...
- candidats AVEC connectivite : 7525, dont T2 : 100%
...
- **7900 systemes avec CONNECTED sur 61363 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*14468 candidats sur 18758 portent les champs bruts (77%).*

- `5c556c16ea8b` — 8503 candidats
  - AVEC connectivite (3397) : resistance **41.2%**
...
- `5c556c16ea8b` — 8503 candidats
  - AVEC connectivite (3397) : T0=13.02 T1=0.00 T2=3.00 — pondere **6.00**
...
- TROP-CHER : 7941 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7900 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 58862 systemes
  - sans CONNECTED : 0.0% sur 13299 systemes
