...
genere 2026-08-26 20:25 UTC — 62878 systemes evalues
...
- moteur actif `0caa9267db60` (19136 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 28692 | 14290 | 1965 | 961 | 2845 | 2274 | 3050 | 2947 | 10.3% |
...
- candidats AVEC connectivite : 3074, dont T2 : 100%
- candidats SANS connectivite : 4628, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3324 systemes avec CONNECTED sur 25975 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3412 candidats sur 7702 portent les champs bruts (44%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 543 candidats
  - AVEC connectivite (230) : resistance **39.6%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 543 candidats
  - AVEC connectivite (230) : T0=12.84 T1=0.00 T2=2.83 — pondere **5.67**
...
- TROP-CHER : 3346 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3324 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23474 systemes
  - sans CONNECTED : 0.0% sur 5218 systemes
