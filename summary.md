...
genere 2026-09-07 23:37 UTC — 445797 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 362453 systemes
...
- moteur actif `0caa9267db60` (402055 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 222056 | 110278 | 15139 | 7416 | 22470 | 17388 | 23657 | 22878 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 217626 | 50696 | 91716 | 85 | 30344 | 11259 | 78 | 33430 | 15.4% |
...
- candidats AVEC connectivite : 23005, dont T2 : 100%
- candidats SANS connectivite : 33740, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23931 systemes avec CONNECTED sur 183840 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*52455 candidats sur 56745 portent les champs bruts (92%).*

- `5c556c16ea8b` — 46490 candidats
  - AVEC connectivite (18877) : resistance **41.2%**
  - SANS connectivite (27613) : resistance **21.3%**
...
- `5c556c16ea8b` — 46490 candidats
  - AVEC connectivite (18877) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (27613) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
## cout
- temps total 139.0 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 24019 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23931 avec CONNECTED, 88 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 181339 systemes
  - sans CONNECTED : 0.0% sur 40717 systemes
