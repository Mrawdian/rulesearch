...
genere 2026-09-03 06:39 UTC — 331829 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 248485 systemes
...
- moteur actif `0caa9267db60` (288087 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 164492 | 81748 | 11166 | 5502 | 16754 | 12968 | 17428 | 16823 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 161222 | 37579 | 68151 | 65 | 22355 | 8333 | 66 | 24661 | 15.3% |
...
- candidats AVEC connectivite : 16950, dont T2 : 100%
- candidats SANS connectivite : 24971, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **17702 systemes avec CONNECTED sur 136690 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*37631 candidats sur 41921 portent les champs bruts (90%).*

- `5c556c16ea8b` — 31666 candidats
  - AVEC connectivite (12822) : resistance **41.1%**
  - SANS connectivite (18844) : resistance **21.2%**
...
- `5c556c16ea8b` — 31666 candidats
  - AVEC connectivite (12822) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (18844) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 134189 systemes
  - sans CONNECTED : 0.0% sur 30303 systemes
