...
genere 2026-08-27 00:07 UTC — 70951 systemes evalues
...
- moteur actif `0caa9267db60` (27209 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 32775 | 16289 | 2251 | 1108 | 3261 | 2605 | 3495 | 3346 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 32061 | 7384 | 13611 | 18 | 4446 | 1680 | 15 | 4907 | 15.3% |
...
- candidats AVEC connectivite : 3473, dont T2 : 100%
- candidats SANS connectivite : 5217, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3769 systemes avec CONNECTED sur 29291 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4400 candidats sur 8690 portent les champs bruts (51%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 723 candidats
  - AVEC connectivite (293) : resistance **41.6%**
  - SANS connectivite (430) : resistance **21.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 723 candidats
  - AVEC connectivite (293) : T0=13.16 T1=0.00 T2=3.09 — pondere **6.17**
  - SANS connectivite (430) : T0=15.94 T1=0.00 T2=2.60 — pondere **5.20**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e3baecf8377b` — 657 candidats
...
- TROP-CHER : 3794 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3769 avec CONNECTED, 25 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 26790 systemes
  - sans CONNECTED : 0.0% sur 5985 systemes
