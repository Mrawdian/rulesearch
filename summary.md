...
genere 2026-09-03 03:12 UTC — 327957 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 244613 systemes
...
- moteur actif `0caa9267db60` (284215 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 162536 | 80761 | 11041 | 5438 | 16553 | 12812 | 17214 | 16638 | 10.2% |
...
- candidats AVEC connectivite : 16765, dont T2 : 100%
...
- **17488 systemes avec CONNECTED sur 135095 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*37196 candidats sur 41486 portent les champs bruts (90%).*

- `5c556c16ea8b` — 31231 candidats
  - AVEC connectivite (12637) : resistance **41.1%**
...
- `5c556c16ea8b` — 31231 candidats
  - AVEC connectivite (12637) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 17563 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 17488 avec CONNECTED, 75 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 132594 systemes
  - sans CONNECTED : 0.0% sur 29942 systemes
