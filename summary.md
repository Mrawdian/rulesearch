...
genere 2026-08-27 07:40 UTC — 87576 systemes evalues
...
- moteur actif `0caa9267db60` (43834 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 41150 | 20483 | 2823 | 1398 | 4109 | 3240 | 4340 | 4226 | 10.3% |
...
- candidats AVEC connectivite : 4353, dont T2 : 100%
- candidats SANS connectivite : 6459, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4614 systemes avec CONNECTED sur 36132 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6522 candidats sur 10812 portent les champs bruts (60%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 557 candidats
  - AVEC connectivite (225) : resistance **41.7%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 557 candidats
  - AVEC connectivite (225) : T0=13.06 T1=0.00 T2=3.05 — pondere **6.11**
...
- TROP-CHER : 4645 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4614 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 33631 systemes
  - sans CONNECTED : 0.0% sur 7519 systemes
