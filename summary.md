...
genere 2026-09-02 03:28 UTC — 300549 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 217205 systemes
...
- moteur actif `0caa9267db60` (256807 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 148705 | 73881 | 10123 | 4984 | 15087 | 11697 | 15747 | 15282 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 145729 | 33890 | 61667 | 62 | 20178 | 7535 | 63 | 22322 | 15.3% |
...
- candidats AVEC connectivite : 15409, dont T2 : 100%
- candidats SANS connectivite : 22632, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16021 systemes avec CONNECTED sur 123904 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*33751 candidats sur 38041 portent les champs bruts (89%).*

- `5c556c16ea8b` — 27786 candidats
  - AVEC connectivite (11281) : resistance **41.0%**
  - SANS connectivite (16505) : resistance **21.3%**
...
- `5c556c16ea8b` — 27786 candidats
  - AVEC connectivite (11281) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (16505) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 16094 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16021 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 121403 systemes
  - sans CONNECTED : 0.0% sur 27302 systemes
