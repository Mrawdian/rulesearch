...
genere 2026-08-29 04:05 UTC — 169376 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 86032 systemes
...
- moteur actif `0caa9267db60` (125634 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 82466 | 41045 | 5603 | 2788 | 8284 | 6544 | 8654 | 8496 | 10.3% |
...
- candidats AVEC connectivite : 8623, dont T2 : 100%
...
- **8928 systemes avec CONNECTED sur 69793 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*17080 candidats sur 21370 portent les champs bruts (80%).*

- `5c556c16ea8b` — 11115 candidats
  - AVEC connectivite (4495) : resistance **41.2%**
...
- `5c556c16ea8b` — 11115 candidats
  - AVEC connectivite (4495) : T0=13.01 T1=0.00 T2=3.00 — pondere **5.99**
...
- TROP-CHER : 8972 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8928 avec CONNECTED, 44 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 67292 systemes
  - sans CONNECTED : 0.0% sur 15174 systemes
