...
genere 2026-08-27 01:43 UTC — 74509 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 9602 systemes
...
- moteur actif `0caa9267db60` (30767 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 34569 | 17196 | 2377 | 1171 | 3432 | 2751 | 3678 | 3522 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 33825 | 7799 | 14384 | 20 | 4693 | 1757 | 18 | 5154 | 15.2% |
...
- candidats SANS connectivite : 5464, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3952 systemes avec CONNECTED sur 30777 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4823 candidats sur 9113 portent les champs bruts (53%).*
...
- `ab89a63b01ef` — 1146 candidats
  - AVEC connectivite (469) : resistance **41.2%**
  - SANS connectivite (677) : resistance **21.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1146 candidats
  ...
  - SANS connectivite (677) : T0=15.90 T1=0.00 T2=2.68 — pondere **5.36**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 28276 systemes
  - sans CONNECTED : 0.0% sur 6293 systemes
