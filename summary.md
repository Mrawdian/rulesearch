...
| connect | 4 | 3 | 5755 | 2896 | 368 | 207 | 555 | 470 | 599 | 593 | 10.3% |
| ref | 4 | 3 | 5611 | 1361 | 2339 | 1 | 747 | 275 | 2 | 886 | 15.8% |
...
- candidats AVEC connectivite : 596, dont T2 : 100%
- candidats SANS connectivite : 890, dont T2 : 100%
...
- **599 systemes avec CONNECTED sur 4766 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 321 candidats
  - AVEC connectivite (117) : T0=13.18 T1=0.00 T2=2.71 — pondere **5.42**
  - SANS connectivite (204) : T0=15.96 T1=0.00 T2=2.66 — pondere **5.32**
  - test de permutation : **p = 0.7761** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 4709 systemes
  - sans CONNECTED : 0.0% sur 1046 systemes
