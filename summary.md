...
| connect | 4 | 3 | 5725 | 2881 | 365 | 206 | 552 | 467 | 598 | 589 | 10.3% |
...
- **598 systemes avec CONNECTED sur 4743 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- TROP-CHER : 600 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 598 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 4686 systemes
  - sans CONNECTED : 0.0% sur 1039 systemes
