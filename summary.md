...
| connect | 4 | 3 | 5770 | 2903 | 370 | 208 | 556 | 470 | 599 | 596 | 10.3% |
| ref | 4 | 3 | 5626 | 1362 | 2346 | 1 | 748 | 275 | 2 | 892 | 15.9% |
...
- candidats AVEC connectivite : 599, dont T2 : 100%
- candidats SANS connectivite : 896, dont T2 : 100%
...
- **599 systemes avec CONNECTED sur 4780 (12.5%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 330 candidats
  - AVEC connectivite (120) : T0=13.18 T1=0.00 T2=2.74 — pondere **5.48**
  - SANS connectivite (210) : T0=16.00 T1=0.00 T2=2.65 — pondere **5.30**
  - test de permutation : **p = 0.5747** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 601 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 599 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 4723 systemes
  - sans CONNECTED : 0.0% sur 1047 systemes
