...
genere 2026-09-05 18:49 UTC — 395708 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 312364 systemes
...
- moteur actif `0caa9267db60` (351966 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 196740 | 97677 | 13398 | 6561 | 19998 | 15484 | 20872 | 20249 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 192853 | 44876 | 81373 | 78 | 26861 | 9970 | 71 | 29609 | 15.4% |
...
- candidats AVEC connectivite : 20376, dont T2 : 100%
- candidats SANS connectivite : 29919, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21146 systemes avec CONNECTED sur 163001 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*46005 candidats sur 50295 portent les champs bruts (91%).*

- `5c556c16ea8b` — 40040 candidats
  - AVEC connectivite (16248) : resistance **41.1%**
  - SANS connectivite (23792) : resistance **21.3%**
...
- `5c556c16ea8b` — 40040 candidats
  - AVEC connectivite (16248) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (23792) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 21227 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21146 avec CONNECTED, 81 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 160500 systemes
  - sans CONNECTED : 0.0% sur 36240 systemes
