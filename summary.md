...
genere 2026-08-26 20:14 UTC — 62505 systemes evalues
...
- moteur actif `0caa9267db60` (18763 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 28497 | 14191 | 1950 | 955 | 2828 | 2261 | 3027 | 2926 | 10.3% |
...
- candidats AVEC connectivite : 3053, dont T2 : 100%
- candidats SANS connectivite : 4607, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3301 systemes avec CONNECTED sur 25810 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3370 candidats sur 7660 portent les champs bruts (44%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 501 candidats
  - AVEC connectivite (209) : resistance **39.3%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 501 candidats
  - AVEC connectivite (209) : T0=12.88 T1=0.00 T2=2.84 — pondere **5.67**
  - SANS connectivite (292) : T0=16.13 T1=0.00 T2=2.66 — pondere **5.32**
  - test de permutation : **p = 0.2164** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- TROP-CHER : 3323 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3301 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23309 systemes
  - sans CONNECTED : 0.0% sur 5188 systemes
