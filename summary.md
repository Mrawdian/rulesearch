...
genere 2026-09-07 10:42 UTC — 434065 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 350721 systemes
...
- moteur actif `0caa9267db60` (390323 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 216122 | 107360 | 14712 | 7197 | 21893 | 16947 | 22981 | 22281 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 211828 | 49311 | 89315 | 83 | 29514 | 10951 | 76 | 32560 | 15.4% |
...
- candidats AVEC connectivite : 22408, dont T2 : 100%
...
- **23255 systemes avec CONNECTED sur 178943 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*50988 candidats sur 55278 portent les champs bruts (92%).*

- `5c556c16ea8b` — 45023 candidats
  - AVEC connectivite (18280) : resistance **41.1%**
...
- `5c556c16ea8b` — 45023 candidats
  - AVEC connectivite (18280) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 23341 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23255 avec CONNECTED, 86 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 176442 systemes
  - sans CONNECTED : 0.0% sur 39680 systemes
