...
genere 2026-08-27 21:14 UTC — 114392 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 31048 systemes
...
- moteur actif `0caa9267db60` (70650 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 54692 | 27243 | 3780 | 1853 | 5401 | 4329 | 5789 | 5584 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 53585 | 12364 | 22771 | 26 | 7421 | 2785 | 25 | 8191 | 15.3% |
...
- candidats AVEC connectivite : 5711, dont T2 : 100%
- candidats SANS connectivite : 8501, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6063 systemes avec CONNECTED sur 47193 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*9922 candidats sur 14212 portent les champs bruts (70%).*

- `5c556c16ea8b` — 3957 candidats
  - AVEC connectivite (1583) : resistance **42.0%**
  - SANS connectivite (2374) : resistance **22.5%**
...
- `5c556c16ea8b` — 3957 candidats
  - AVEC connectivite (1583) : T0=12.94 T1=0.00 T2=3.06 — pondere **6.12**
  - SANS connectivite (2374) : T0=15.77 T1=0.00 T2=2.71 — pondere **5.42**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 44692 systemes
  - sans CONNECTED : 0.0% sur 10000 systemes
