...
genere 2026-08-28 05:53 UTC — 130989 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 47645 systemes
...
- moteur actif `0caa9267db60` (87247 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 63080 | 31359 | 4329 | 2139 | 6307 | 5024 | 6628 | 6480 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 61794 | 14295 | 26177 | 29 | 8592 | 3193 | 28 | 9478 | 15.3% |
...
- candidats AVEC connectivite : 6607, dont T2 : 100%
- candidats SANS connectivite : 9788, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6902 systemes avec CONNECTED sur 53963 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12105 candidats sur 16395 portent les champs bruts (74%).*

- `5c556c16ea8b` — 6140 candidats
  - AVEC connectivite (2479) : resistance **41.5%**
  - SANS connectivite (3661) : resistance **22.0%**
...
- `5c556c16ea8b` — 6140 candidats
  - AVEC connectivite (2479) : T0=12.97 T1=0.00 T2=3.01 — pondere **6.03**
  - SANS connectivite (3661) : T0=15.86 T1=0.00 T2=2.69 — pondere **5.37**
...
- TROP-CHER : 6940 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6902 avec CONNECTED, 38 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 51462 systemes
  - sans CONNECTED : 0.0% sur 11618 systemes
