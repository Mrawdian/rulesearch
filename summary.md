...
genere 2026-08-27 08:11 UTC — 88671 systemes evalues
...
- moteur actif `0caa9267db60` (44929 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 40852 | 9406 | 17369 | 22 | 5666 | 2130 | 21 | 6238 | 15.3% |
...
- candidats SANS connectivite : 6548, dont T2 : 100%
...
*6662 candidats sur 10952 portent les champs bruts (61%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 697 candidats
  - AVEC connectivite (276) : resistance **40.9%**
  - SANS connectivite (421) : resistance **21.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 697 candidats
  ...
  - SANS connectivite (421) : T0=15.81 T1=0.00 T2=2.64 — pondere **5.29**
  - test de permutation : **p = 0.0075** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e3baecf8377b` — 657 candidats
...
**7 serie(s) reproductible(s) sur 14 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `ab89a63b01ef` (p=0.0005), `06fe04a859f1` (p=0.0005), `5c556c16ea8b` (p=0.0075), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
