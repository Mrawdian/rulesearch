...
genere 2026-09-04 16:38 UTC — 369018 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 285674 systemes
...
- moteur actif `0caa9267db60` (325276 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 183256 | 91087 | 12456 | 6122 | 18653 | 14427 | 19398 | 18761 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 179647 | 41760 | 75897 | 74 | 24958 | 9307 | 70 | 27567 | 15.3% |
...
- candidats AVEC connectivite : 18888, dont T2 : 100%
- candidats SANS connectivite : 27877, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19672 systemes avec CONNECTED sur 151996 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*42475 candidats sur 46765 portent les champs bruts (91%).*

- `5c556c16ea8b` — 36510 candidats
  - AVEC connectivite (14760) : resistance **41.0%**
  - SANS connectivite (21750) : resistance **21.2%**
...
- `5c556c16ea8b` — 36510 candidats
  - AVEC connectivite (14760) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.94**
  - SANS connectivite (21750) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 19752 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19672 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 149495 systemes
  - sans CONNECTED : 0.0% sur 33761 systemes
