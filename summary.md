...
| connect | 4 | 3 | 17260 | 8633 | 1115 | 596 | 1711 | 1375 | 1877 | 1737 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 16909 | 3984 | 7154 | 11 | 2310 | 855 | 7 | 2588 | 15.3% |
...
- candidats SANS connectivite : 2898, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2151 systemes avec CONNECTED sur 16599 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*472 candidats sur 4762 portent les champs bruts (10%).*
...
- `e3baecf8377b` — 208 candidats
  - AVEC connectivite (81) : resistance **42.7%**
  - SANS connectivite (127) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 208 candidats
  ...
  - SANS connectivite (127) : T0=16.06 T1=0.00 T2=2.65 — pondere **5.29**
...
**2 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0325).
...
- TROP-CHER : 2168 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2151 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14098 systemes
  - sans CONNECTED : 0.0% sur 3162 systemes
