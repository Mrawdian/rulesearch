...
genere 2026-09-09 14:30 UTC — 480540 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 397196 systemes
...
- moteur actif `0caa9267db60` (436798 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 239605 | 118934 | 16338 | 8026 | 24259 | 18794 | 25517 | 24694 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 234820 | 54709 | 98950 | 92 | 32710 | 12132 | 86 | 36122 | 15.4% |
...
- candidats AVEC connectivite : 24821, dont T2 : 100%
...
- **25791 systemes avec CONNECTED sur 198102 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*56963 candidats sur 61253 portent les champs bruts (93%).*

- `5c556c16ea8b` — 50998 candidats
  - AVEC connectivite (20693) : resistance **41.2%**
...
- `5c556c16ea8b` — 50998 candidats
  - AVEC connectivite (20693) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 25887 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25791 avec CONNECTED, 96 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 195601 systemes
  - sans CONNECTED : 0.0% sur 44004 systemes
