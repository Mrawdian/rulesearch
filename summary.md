...
genere 2026-08-29 16:38 UTC — 189193 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 105849 systemes
...
- moteur actif `0caa9267db60` (145451 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 92466 | 45966 | 6292 | 3107 | 9315 | 7353 | 9731 | 9518 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 90612 | 21165 | 38238 | 43 | 12535 | 4651 | 36 | 13938 | 15.4% |
...
- candidats AVEC connectivite : 9645, dont T2 : 100%
- candidats SANS connectivite : 14248, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10005 systemes avec CONNECTED sur 77931 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*19603 candidats sur 23893 portent les champs bruts (82%).*

- `5c556c16ea8b` — 13638 candidats
  - AVEC connectivite (5517) : resistance **41.2%**
  - SANS connectivite (8121) : resistance **21.5%**
...
- `5c556c16ea8b` — 13638 candidats
  - AVEC connectivite (5517) : T0=12.99 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (8121) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.33**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 75430 systemes
  - sans CONNECTED : 0.0% sur 17036 systemes
