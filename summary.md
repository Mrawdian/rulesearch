...
| connect | 4 | 3 | 17335 | 8676 | 1120 | 598 | 1717 | 1380 | 1884 | 1742 | 10.0% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 16968 | 3995 | 7177 | 12 | 2322 | 858 | 7 | 2597 | 15.3% |
...
- candidats SANS connectivite : 2907, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2158 systemes avec CONNECTED sur 16663 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*486 candidats sur 4776 portent les champs bruts (10%).*
...
- `e3baecf8377b` — 222 candidats
  - AVEC connectivite (86) : resistance **42.4%**
  - SANS connectivite (136) : resistance **21.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 222 candidats
  ...
  - SANS connectivite (136) : T0=16.07 T1=0.00 T2=2.65 — pondere **5.31**
...
**2 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0395).
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14162 systemes
  - sans CONNECTED : 0.0% sur 3173 systemes
