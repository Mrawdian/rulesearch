...
genere 2026-08-27 06:56 UTC — 86065 systemes evalues
...
- moteur actif `0caa9267db60` (42323 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 40390 | 20112 | 2764 | 1377 | 4035 | 3177 | 4259 | 4144 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 39560 | 9121 | 16818 | 22 | 5486 | 2067 | 21 | 6025 | 15.2% |
...
- candidats AVEC connectivite : 4271, dont T2 : 100%
- candidats SANS connectivite : 6335, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4533 systemes avec CONNECTED sur 35516 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6316 candidats sur 10606 portent les champs bruts (60%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 351 candidats
  - AVEC connectivite (143) : resistance **42.0%**
  - SANS connectivite (208) : resistance **21.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 351 candidats
  - AVEC connectivite (143) : T0=13.01 T1=0.00 T2=3.07 — pondere **6.14**
  - SANS connectivite (208) : T0=15.84 T1=0.00 T2=2.65 — pondere **5.31**
  - test de permutation : **p = 0.0140** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `23303c299f39` — 225 candidats
...
**7 serie(s) reproductible(s) sur 14 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `ab89a63b01ef` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `5c556c16ea8b` (p=0.0140), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
...
## cout
- temps total 26.5 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 4564 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4533 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 33015 systemes
  - sans CONNECTED : 0.0% sur 7375 systemes
