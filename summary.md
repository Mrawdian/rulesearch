...
genere 2026-09-06 20:11 UTC — 420428 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 337084 systemes
...
- moteur actif `0caa9267db60` (376686 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 209220 | 103894 | 14250 | 6959 | 21215 | 16450 | 22229 | 21559 | 10.3% |
...
- candidats AVEC connectivite : 21686, dont T2 : 100%
...
- **22503 systemes avec CONNECTED sur 173239 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*49238 candidats sur 53528 portent les champs bruts (92%).*

- `5c556c16ea8b` — 43273 candidats
  - AVEC connectivite (17558) : resistance **41.1%**
...
- `5c556c16ea8b` — 43273 candidats
  - AVEC connectivite (17558) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 22586 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 22503 avec CONNECTED, 83 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 170738 systemes
