...
genere 2026-08-26 13:25 UTC — 46511 systemes evalues
...
- moteur actif `0caa9267db60` (2769 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20410 | 10179 | 1343 | 704 | 2042 | 1622 | 2183 | 2085 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 19986 | 4686 | 8441 | 13 | 2763 | 1033 | 7 | 3043 | 15.2% |
...
- candidats AVEC connectivite : 2212, dont T2 : 100%
- candidats SANS connectivite : 3353, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2457 systemes avec CONNECTED sur 19156 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1275 candidats sur 5565 portent les champs bruts (23%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 160 candidats
  - AVEC connectivite (74) : resistance **37.5%**
  - SANS connectivite (86) : resistance **23.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 160 candidats
  - AVEC connectivite (74) : T0=13.41 T1=0.00 T2=2.70 — pondere **5.41**
  - SANS connectivite (86) : T0=16.12 T1=0.00 T2=2.99 — pondere **5.98**
...
- TROP-CHER : 2474 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2457 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16655 systemes
  - sans CONNECTED : 0.0% sur 3755 systemes
