...
genere 2026-09-04 17:13 UTC — 369611 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 286267 systemes
...
- moteur actif `0caa9267db60` (325869 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 183556 | 91233 | 12479 | 6132 | 18675 | 14450 | 19436 | 18794 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 179940 | 41832 | 76018 | 74 | 24999 | 9324 | 70 | 27609 | 15.3% |
...
- candidats AVEC connectivite : 18921, dont T2 : 100%
- candidats SANS connectivite : 27919, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19710 systemes avec CONNECTED sur 152247 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*42550 candidats sur 46840 portent les champs bruts (91%).*

- `5c556c16ea8b` — 36585 candidats
  - AVEC connectivite (14793) : resistance **41.0%**
  - SANS connectivite (21792) : resistance **21.3%**
...
- `5c556c16ea8b` — 36585 candidats
  - AVEC connectivite (14793) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.94**
  - SANS connectivite (21792) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 19790 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19710 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 149746 systemes
  - sans CONNECTED : 0.0% sur 33810 systemes
