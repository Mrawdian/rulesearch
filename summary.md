...
genere 2026-08-29 10:29 UTC — 179689 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 96345 systemes
...
- moteur actif `0caa9267db60` (135947 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 87667 | 43579 | 5967 | 2970 | 8808 | 6984 | 9206 | 9037 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 85907 | 20070 | 36292 | 40 | 11856 | 4382 | 35 | 13226 | 15.4% |
...
- candidats AVEC connectivite : 9164, dont T2 : 100%
- candidats SANS connectivite : 13536, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9480 systemes avec CONNECTED sur 74029 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*18410 candidats sur 22700 portent les champs bruts (81%).*

- `5c556c16ea8b` — 12445 candidats
  - AVEC connectivite (5036) : resistance **41.1%**
  - SANS connectivite (7409) : resistance **21.5%**
...
- `5c556c16ea8b` — 12445 candidats
  - AVEC connectivite (5036) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (7409) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.33**
...
## cout
- temps total 55.2 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 9525 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 9480 avec CONNECTED, 45 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 71528 systemes
  - sans CONNECTED : 0.0% sur 16139 systemes
