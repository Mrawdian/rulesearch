...
genere 2026-08-27 04:39 UTC — 81085 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 16178 systemes
...
- moteur actif `0caa9267db60` (37343 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 37886 | 18850 | 2613 | 1288 | 3766 | 2975 | 4007 | 3895 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 37084 | 8547 | 15774 | 21 | 5134 | 1933 | 20 | 5655 | 15.2% |
...
- candidats AVEC connectivite : 4022, dont T2 : 100%
- candidats SANS connectivite : 5965, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4281 systemes avec CONNECTED sur 33512 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5697 candidats sur 9987 portent les champs bruts (57%).*
...
- `ab89a63b01ef` — 2020 candidats
  - AVEC connectivite (842) : resistance **41.4%**
  - SANS connectivite (1178) : resistance **21.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 2020 candidats
  - AVEC connectivite (842) : T0=13.04 T1=0.00 T2=3.03 — pondere **6.06**
  - SANS connectivite (1178) : T0=15.92 T1=0.00 T2=2.69 — pondere **5.37**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- TROP-CHER : 4311 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4281 avec CONNECTED, 30 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 31011 systemes
  - sans CONNECTED : 0.0% sur 6875 systemes
