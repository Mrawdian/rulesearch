...
| connect | 4 | 3 | 17185 | 8595 | 1110 | 594 | 1704 | 1366 | 1869 | 1731 | 10.1% |
...
- candidats AVEC connectivite : 1858, dont T2 : 100%
- candidats SANS connectivite : 2876, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2143 systemes avec CONNECTED sur 16539 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*444 candidats sur 4734 portent les champs bruts (9%).*
...
- `e3baecf8377b` — 180 candidats
  - AVEC connectivite (75) : resistance **42.7%**
...
- `e3baecf8377b` — 180 candidats
  - AVEC connectivite (75) : T0=13.24 T1=0.00 T2=3.17 — pondere **6.35**
...
**2 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0290).
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14038 systemes
  - sans CONNECTED : 0.0% sur 3147 systemes
