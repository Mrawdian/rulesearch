...
- `89c65c03c4ad` — 514 candidats
  - AVEC connectivite (194) : T0=13.21 T1=0.00 T2=2.89 — pondere **5.78**
  - SANS connectivite (320) : T0=15.86 T1=0.00 T2=2.65 — pondere **5.31**
  - test de permutation : **p = 0.1084** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
