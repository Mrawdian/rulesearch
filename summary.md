...
genere 2026-08-26 14:45 UTC — 49634 systemes evalues
...
- moteur actif `0caa9267db60` (5892 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21996 | 10973 | 1473 | 753 | 2180 | 1741 | 2353 | 2245 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 21523 | 5006 | 9087 | 13 | 2990 | 1106 | 9 | 3312 | 15.4% |
...
- candidats SANS connectivite : 3622, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2627 systemes avec CONNECTED sur 20473 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1704 candidats sur 5994 portent les champs bruts (28%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 589 candidats
  - AVEC connectivite (234) : resistance **41.1%**
  - SANS connectivite (355) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 589 candidats
  ...
  - SANS connectivite (355) : T0=16.06 T1=0.00 T2=2.64 — pondere **5.28**
...
- TROP-CHER : 2646 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2627 avec CONNECTED, 19 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17972 systemes
  - sans CONNECTED : 0.0% sur 4024 systemes
