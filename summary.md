...
genere 2026-08-26 14:21 UTC — 48718 systemes evalues
...
- moteur actif `0caa9267db60` (4976 systemes) : `06fe04a859f1`, `e40600351a72`
...
| ref | 4 | 3 | 21072 | 4912 | 8888 | 13 | 2920 | 1089 | 7 | 3243 | 15.4% |
...
- candidats SANS connectivite : 3553, dont T2 : 100%
...
*1587 candidats sur 5877 portent les champs bruts (27%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 472 candidats
  - AVEC connectivite (186) : resistance **40.3%**
  - SANS connectivite (286) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 472 candidats
  ...
  - SANS connectivite (286) : T0=16.12 T1=0.00 T2=2.66 — pondere **5.32**
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0235).
...
- TROP-CHER : 2594 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2577 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
