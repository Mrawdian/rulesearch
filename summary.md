...
genere 2026-08-27 04:06 UTC — 79755 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 14848 systemes
...
- moteur actif `0caa9267db60` (36013 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 37216 | 18502 | 2567 | 1268 | 3692 | 2931 | 3949 | 3824 | 10.3% |
...
- candidats AVEC connectivite : 3951, dont T2 : 100%
- candidats SANS connectivite : 5860, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4223 systemes avec CONNECTED sur 32967 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5521 candidats sur 9811 portent les champs bruts (56%).*
...
- `ab89a63b01ef` — 1844 candidats
  - AVEC connectivite (771) : resistance **41.3%**
...
- `ab89a63b01ef` — 1844 candidats
  - AVEC connectivite (771) : T0=13.06 T1=0.00 T2=3.03 — pondere **6.06**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 30466 systemes
  - sans CONNECTED : 0.0% sur 6750 systemes
