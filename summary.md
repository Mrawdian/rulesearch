...
| connect | 4 | 3 | 7622 | 3837 | 501 | 265 | 728 | 610 | 804 | 791 | 10.4% |
...
- candidats AVEC connectivite : 794, dont T2 : 100%
...
- **804 systemes avec CONNECTED sur 6310 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 805 candidats
  - AVEC connectivite (315) : T0=13.38 T1=0.00 T2=2.88 — pondere **5.77**
  - SANS connectivite (490) : T0=15.79 T1=0.00 T2=2.65 — pondere **5.31**
  - test de permutation : **p = 0.0420** — ecart significatif au seuil 0.05
...
- TROP-CHER : 806 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 804 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 6253 systemes
  - sans CONNECTED : 0.0% sur 1369 systemes
