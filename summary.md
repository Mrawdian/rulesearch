...
genere 2026-08-27 22:05 UTC — 116178 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 32834 systemes
...
- moteur actif `0caa9267db60` (72436 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 55590 | 27697 | 3844 | 1889 | 5500 | 4402 | 5870 | 5670 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 54473 | 12564 | 23134 | 26 | 7556 | 2821 | 25 | 8345 | 15.3% |
...
- candidats AVEC connectivite : 5797, dont T2 : 100%
- candidats SANS connectivite : 8655, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6144 systemes avec CONNECTED sur 47914 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10162 candidats sur 14452 portent les champs bruts (70%).*

- `5c556c16ea8b` — 4197 candidats
  - AVEC connectivite (1669) : resistance **42.0%**
  - SANS connectivite (2528) : resistance **22.5%**
...
- `5c556c16ea8b` — 4197 candidats
  - AVEC connectivite (1669) : T0=12.93 T1=0.00 T2=3.05 — pondere **6.11**
  - SANS connectivite (2528) : T0=15.79 T1=0.00 T2=2.72 — pondere **5.44**
...
- TROP-CHER : 6179 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6144 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 45413 systemes
