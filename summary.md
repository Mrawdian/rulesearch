...
genere 2026-08-28 01:58 UTC — 123840 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 40496 systemes
...
- moteur actif `0caa9267db60` (80098 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 59469 | 29610 | 4108 | 2009 | 5915 | 4712 | 6245 | 6105 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 58256 | 13463 | 24692 | 28 | 8096 | 3018 | 26 | 8931 | 15.3% |
...
- candidats AVEC connectivite : 6232, dont T2 : 100%
- candidats SANS connectivite : 9241, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6519 systemes avec CONNECTED sur 51042 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11183 candidats sur 15473 portent les champs bruts (72%).*

- `5c556c16ea8b` — 5218 candidats
  - AVEC connectivite (2104) : resistance **41.9%**
  - SANS connectivite (3114) : resistance **22.2%**
...
- `5c556c16ea8b` — 5218 candidats
  - AVEC connectivite (2104) : T0=12.99 T1=0.00 T2=3.05 — pondere **6.09**
  - SANS connectivite (3114) : T0=15.84 T1=0.00 T2=2.71 — pondere **5.41**
...
- TROP-CHER : 6555 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6519 avec CONNECTED, 36 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 48541 systemes
  - sans CONNECTED : 0.0% sur 10928 systemes
