...
genere 2026-09-05 05:03 UTC — 381768 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 298424 systemes
...
- moteur actif `0caa9267db60` (338026 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 189703 | 94211 | 12915 | 6337 | 19295 | 14948 | 20116 | 19452 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 185950 | 43272 | 78537 | 77 | 25822 | 9627 | 70 | 28531 | 15.3% |
...
- candidats AVEC connectivite : 19579, dont T2 : 100%
- candidats SANS connectivite : 28841, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20390 systemes avec CONNECTED sur 157252 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*44130 candidats sur 48420 portent les champs bruts (91%).*

- `5c556c16ea8b` — 38165 candidats
  - AVEC connectivite (15451) : resistance **41.1%**
  - SANS connectivite (22714) : resistance **21.2%**
...
- `5c556c16ea8b` — 38165 candidats
  - AVEC connectivite (15451) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (22714) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 154751 systemes
  - sans CONNECTED : 0.0% sur 34952 systemes
