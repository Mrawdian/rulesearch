...
genere 2026-09-04 03:25 UTC — 354775 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 271431 systemes
...
- moteur actif `0caa9267db60` (311033 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 176068 | 87502 | 11974 | 5884 | 17933 | 13852 | 18661 | 18019 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 172592 | 40103 | 72879 | 70 | 23988 | 8942 | 68 | 26528 | 15.4% |
...
- candidats AVEC connectivite : 18146, dont T2 : 100%
- candidats SANS connectivite : 26838, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18935 systemes avec CONNECTED sur 146164 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*40694 candidats sur 44984 portent les champs bruts (90%).*

- `5c556c16ea8b` — 34729 candidats
  - AVEC connectivite (14018) : resistance **41.0%**
  - SANS connectivite (20711) : resistance **21.3%**
...
- `5c556c16ea8b` — 34729 candidats
  - AVEC connectivite (14018) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (20711) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 19013 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18935 avec CONNECTED, 78 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 143663 systemes
  - sans CONNECTED : 0.0% sur 32405 systemes
