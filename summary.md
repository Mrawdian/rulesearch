...
genere 2026-08-29 00:14 UTC — 162854 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 79510 systemes
...
- moteur actif `0caa9267db60` (119112 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 79174 | 39368 | 5390 | 2688 | 7913 | 6319 | 8330 | 8159 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 77565 | 18016 | 32828 | 36 | 10722 | 3954 | 31 | 11973 | 15.4% |
...
- candidats SANS connectivite : 12283, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8604 systemes avec CONNECTED sur 67078 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*16279 candidats sur 20569 portent les champs bruts (79%).*

- `5c556c16ea8b` — 10314 candidats
  - AVEC connectivite (4158) : resistance **41.1%**
  - SANS connectivite (6156) : resistance **21.7%**
...
- `5c556c16ea8b` — 10314 candidats
  ...
  - SANS connectivite (6156) : T0=15.89 T1=0.00 T2=2.68 — pondere **5.36**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 64577 systemes
  - sans CONNECTED : 0.0% sur 14597 systemes
