...
genere 2026-08-26 13:40 UTC — 47278 systemes evalues
...
- moteur actif `0caa9267db60` (3536 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20797 | 10379 | 1377 | 720 | 2068 | 1654 | 2212 | 2129 | 10.2% |
...
- candidats AVEC connectivite : 2256, dont T2 : 100%
- candidats SANS connectivite : 3417, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2486 systemes avec CONNECTED sur 19483 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1383 candidats sur 5673 portent les champs bruts (24%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 268 candidats
  - AVEC connectivite (118) : resistance **38.7%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 268 candidats
  - AVEC connectivite (118) : T0=13.36 T1=0.00 T2=2.80 — pondere **5.59**
  - SANS connectivite (150) : T0=16.25 T1=0.00 T2=2.76 — pondere **5.52**
  - test de permutation : **p = 0.8641** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
- TROP-CHER : 2503 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2486 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 16982 systemes
  - sans CONNECTED : 0.0% sur 3815 systemes
