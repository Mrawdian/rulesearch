...
genere 2026-08-26 22:03 UTC — 66431 systemes evalues
...
- moteur actif `0caa9267db60` (22689 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 30488 | 15146 | 2085 | 1024 | 3047 | 2421 | 3249 | 3131 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 29828 | 6877 | 12677 | 17 | 4119 | 1541 | 13 | 4584 | 15.4% |
...
- candidats AVEC connectivite : 3258, dont T2 : 100%
- candidats SANS connectivite : 4894, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3523 systemes avec CONNECTED sur 27423 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3862 candidats sur 8152 portent les champs bruts (47%).*
...
- `23303c299f39` — 225 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 185 candidats
  - AVEC connectivite (78) : resistance **42.9%**
  - SANS connectivite (107) : resistance **23.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 185 candidats
  - AVEC connectivite (78) : T0=13.24 T1=0.00 T2=3.01 — pondere **6.03**
  - SANS connectivite (107) : T0=15.91 T1=0.00 T2=2.84 — pondere **5.68**
  - test de permutation : **p = 0.4923** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
## cout
- temps total 20.6 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 3546 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3523 avec CONNECTED, 23 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24922 systemes
  - sans CONNECTED : 0.0% sur 5566 systemes
