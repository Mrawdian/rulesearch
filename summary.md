...
genere 2026-09-03 16:01 UTC — 342282 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 258938 systemes
...
- moteur actif `0caa9267db60` (298540 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 169771 | 84379 | 11520 | 5682 | 17265 | 13414 | 17994 | 17353 | 10.2% |
...
- candidats AVEC connectivite : 17480, dont T2 : 100%
...
- **18268 systemes avec CONNECTED sur 141011 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39029 candidats sur 43319 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33064 candidats
  - AVEC connectivite (13352) : resistance **41.0%**
...
- `5c556c16ea8b` — 33064 candidats
  - AVEC connectivite (13352) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 18344 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18268 avec CONNECTED, 76 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 138510 systemes
  - sans CONNECTED : 0.0% sur 31261 systemes
