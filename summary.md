...
genere 2026-08-26 18:00 UTC — 57304 systemes evalues
...
- moteur actif `0caa9267db60` (13562 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `84fba70921e0`, `b71bb0907fb5`, `e40600351a72`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 25864 | 12884 | 1763 | 876 | 2564 | 2044 | 2761 | 2652 | 10.3% |
...
- candidats AVEC connectivite : 2779, dont T2 : 100%
- candidats SANS connectivite : 4223, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3035 systemes avec CONNECTED sur 23645 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2712 candidats sur 7002 portent les champs bruts (39%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `0a74109317e5` — 63 candidats
  - AVEC connectivite (30) : resistance **38.8%**
...
- `0a74109317e5` — 63 candidats
  - AVEC connectivite (30) : T0=13.83 T1=0.00 T2=2.80 — pondere **5.60**
  - SANS connectivite (33) : T0=15.67 T1=0.00 T2=2.61 — pondere **5.21**
  - test de permutation : **p = 0.6497** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `b71bb0907fb5` — 53 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 21144 systemes
  - sans CONNECTED : 0.0% sur 4720 systemes
