...
genere 2026-09-10 01:41 UTC — 490042 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 406698 systemes
...
- moteur actif `0caa9267db60` (446300 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 244388 | 121341 | 16643 | 8187 | 24730 | 19164 | 26052 | 25170 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 239539 | 55833 | 100895 | 95 | 33366 | 12380 | 87 | 36862 | 15.4% |
...
- candidats AVEC connectivite : 25297, dont T2 : 100%
- candidats SANS connectivite : 37172, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **26326 systemes avec CONNECTED sur 202035 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*58179 candidats sur 62469 portent les champs bruts (93%).*

- `5c556c16ea8b` — 52214 candidats
  - AVEC connectivite (21169) : resistance **41.2%**
  - SANS connectivite (31045) : resistance **21.3%**
...
- `5c556c16ea8b` — 52214 candidats
  - AVEC connectivite (21169) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (31045) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 26423 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 26326 avec CONNECTED, 97 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 199534 systemes
  - sans CONNECTED : 0.0% sur 44854 systemes
