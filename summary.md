...
| connect | 4 | 3 | 18037 | 9017 | 1172 | 627 | 1787 | 1432 | 1962 | 1814 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 17647 | 4154 | 7447 | 12 | 2414 | 899 | 7 | 2714 | 15.4% |
...
- candidats AVEC connectivite : 1941, dont T2 : 100%
- candidats SANS connectivite : 3024, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2236 systemes avec CONNECTED sur 17233 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*675 candidats sur 4965 portent les champs bruts (14%).*
...
- `e3baecf8377b` — 411 candidats
  - AVEC connectivite (158) : resistance **44.3%**
  - SANS connectivite (253) : resistance **21.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 411 candidats
  - AVEC connectivite (158) : T0=12.96 T1=0.00 T2=3.22 — pondere **6.44**
  - SANS connectivite (253) : T0=16.03 T1=0.00 T2=2.68 — pondere **5.36**
...
- TROP-CHER : 2253 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2236 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14732 systemes
  - sans CONNECTED : 0.0% sur 3305 systemes
