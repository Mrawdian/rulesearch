...
genere 2026-08-26 19:27 UTC — 60733 systemes evalues
...
- moteur actif `0caa9267db60` (16991 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27600 | 13768 | 1879 | 932 | 2726 | 2188 | 2934 | 2827 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 27018 | 6250 | 11428 | 15 | 3764 | 1391 | 11 | 4159 | 15.4% |
...
- candidats AVEC connectivite : 2954, dont T2 : 100%
- candidats SANS connectivite : 4469, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3208 systemes avec CONNECTED sur 25088 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3133 candidats sur 7423 portent les champs bruts (42%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 264 candidats
  - AVEC connectivite (110) : resistance **39.2%**
  - SANS connectivite (154) : resistance **18.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 264 candidats
  - AVEC connectivite (110) : T0=13.04 T1=0.00 T2=2.90 — pondere **5.80**
  - SANS connectivite (154) : T0=16.04 T1=0.00 T2=2.58 — pondere **5.17**
...
- TROP-CHER : 3229 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3208 avec CONNECTED, 21 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22587 systemes
  - sans CONNECTED : 0.0% sur 5013 systemes
