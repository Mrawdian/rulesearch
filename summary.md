...
genere 2026-08-30 04:25 UTC — 207101 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 123757 systemes
...
- moteur actif `0caa9267db60` (163359 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 101526 | 50426 | 6910 | 3401 | 10244 | 8100 | 10688 | 10435 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 99460 | 23176 | 42012 | 45 | 13741 | 5137 | 38 | 15304 | 15.4% |
...
- candidats AVEC connectivite : 10562, dont T2 : 100%
- candidats SANS connectivite : 15614, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10962 systemes avec CONNECTED sur 85300 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*21886 candidats sur 26176 portent les champs bruts (84%).*

- `5c556c16ea8b` — 15921 candidats
  - AVEC connectivite (6434) : resistance **41.1%**
  - SANS connectivite (9487) : resistance **21.5%**
...
- `5c556c16ea8b` — 15921 candidats
  - AVEC connectivite (6434) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (9487) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.32**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 82799 systemes
  - sans CONNECTED : 0.0% sur 18727 systemes
