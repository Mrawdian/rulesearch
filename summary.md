...
genere 2026-08-29 20:01 UTC — 194174 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 110830 systemes
...
- moteur actif `0caa9267db60` (150432 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 94993 | 47180 | 6464 | 3199 | 9581 | 7569 | 10025 | 9765 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 93066 | 21702 | 39284 | 43 | 12883 | 4788 | 36 | 14324 | 15.4% |
...
- candidats SANS connectivite : 14634, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10299 systemes avec CONNECTED sur 79974 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*20236 candidats sur 24526 portent les champs bruts (83%).*

- `5c556c16ea8b` — 14271 candidats
  - AVEC connectivite (5764) : resistance **41.2%**
  - SANS connectivite (8507) : resistance **21.5%**
...
- `5c556c16ea8b` — 14271 candidats
  ...
  - SANS connectivite (8507) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 10345 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10299 avec CONNECTED, 46 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 77473 systemes
  - sans CONNECTED : 0.0% sur 17520 systemes
