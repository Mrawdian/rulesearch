...
genere 2026-09-09 21:48 UTC — 486756 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 403412 systemes
...
- moteur actif `0caa9267db60` (443014 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 242728 | 120526 | 16554 | 8128 | 24558 | 19029 | 25864 | 24990 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 237913 | 55459 | 100230 | 95 | 33132 | 12292 | 87 | 36597 | 15.4% |
...
- candidats SANS connectivite : 36907, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **26138 systemes avec CONNECTED sur 200678 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*57734 candidats sur 62024 portent les champs bruts (93%).*

- `5c556c16ea8b` — 51769 candidats
  - AVEC connectivite (20989) : resistance **41.2%**
  - SANS connectivite (30780) : resistance **21.3%**
...
- `5c556c16ea8b` — 51769 candidats
  ...
  - SANS connectivite (30780) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 198177 systemes
  - sans CONNECTED : 0.0% sur 44551 systemes
