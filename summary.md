...
genere 2026-08-31 19:07 UTC — 260650 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 177306 systemes
...
- moteur actif `0caa9267db60` (216908 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 128578 | 63920 | 8695 | 4312 | 13014 | 10165 | 13549 | 13244 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 125957 | 29351 | 53184 | 56 | 17450 | 6513 | 56 | 19337 | 15.4% |
...
- candidats AVEC connectivite : 13371, dont T2 : 100%
- candidats SANS connectivite : 19647, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13823 systemes avec CONNECTED sur 107405 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*28728 candidats sur 33018 portent les champs bruts (87%).*

- `5c556c16ea8b` — 22763 candidats
  - AVEC connectivite (9243) : resistance **41.0%**
  - SANS connectivite (13520) : resistance **21.4%**
...
- `5c556c16ea8b` — 22763 candidats
  - AVEC connectivite (9243) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.97**
  - SANS connectivite (13520) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 13889 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13823 avec CONNECTED, 66 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 104904 systemes
  - sans CONNECTED : 0.0% sur 23674 systemes
