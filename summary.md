...
genere 2026-08-29 20:44 UTC — 195224 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 111880 systemes
...
- moteur actif `0caa9267db60` (151482 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 95517 | 47427 | 6495 | 3219 | 9633 | 7612 | 10086 | 9826 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 93592 | 21822 | 39520 | 43 | 12960 | 4814 | 37 | 14390 | 15.4% |
...
- candidats AVEC connectivite : 9953, dont T2 : 100%
- candidats SANS connectivite : 14700, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10360 systemes avec CONNECTED sur 80403 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*20363 candidats sur 24653 portent les champs bruts (83%).*

- `5c556c16ea8b` — 14398 candidats
  - AVEC connectivite (5825) : resistance **41.2%**
  - SANS connectivite (8573) : resistance **21.5%**
...
- `5c556c16ea8b` — 14398 candidats
  - AVEC connectivite (5825) : T0=13.00 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (8573) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 10407 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10360 avec CONNECTED, 47 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 77902 systemes
  - sans CONNECTED : 0.0% sur 17615 systemes
