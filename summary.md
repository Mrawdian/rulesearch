...
| connect | 4 | 3 | 5740 | 2888 | 367 | 207 | 553 | 469 | 599 | 590 | 10.3% |
| ref | 4 | 3 | 5596 | 1359 | 2332 | 1 | 746 | 273 | 2 | 883 | 15.8% |
...
- candidats AVEC connectivite : 593, dont T2 : 100%
- candidats SANS connectivite : 887, dont T2 : 100%
...
- **599 systemes avec CONNECTED sur 4754 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 315 candidats
  - AVEC connectivite (114) : T0=13.15 T1=0.00 T2=2.72 — pondere **5.44**
  - SANS connectivite (201) : T0=15.97 T1=0.00 T2=2.67 — pondere **5.33**
  - test de permutation : **p = 0.8011** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 4697 systemes
  - sans CONNECTED : 0.0% sur 1043 systemes
