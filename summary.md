...
| connect | 4 | 3 | 5935 | 2995 | 381 | 214 | 570 | 476 | 617 | 612 | 10.3% |
| ref | 4 | 3 | 5801 | 1410 | 2410 | 1 | 777 | 285 | 2 | 916 | 15.8% |
...
- candidats AVEC connectivite : 615, dont T2 : 100%
- candidats SANS connectivite : 920, dont T2 : 100%
...
- **617 systemes avec CONNECTED sur 4924 (12.5%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 370 candidats
  - AVEC connectivite (136) : T0=13.08 T1=0.00 T2=2.91 — pondere **5.82**
  - SANS connectivite (234) : T0=15.96 T1=0.00 T2=2.63 — pondere **5.26**
...
- TROP-CHER : 619 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 617 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 4867 systemes
  - sans CONNECTED : 0.0% sur 1068 systemes
