...
genere 2026-09-08 21:41 UTC — 465711 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 382367 systemes
...
- moteur actif `0caa9267db60` (421969 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 232109 | 115301 | 15790 | 7769 | 23481 | 18179 | 24736 | 23906 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 227487 | 52990 | 95875 | 90 | 31690 | 11757 | 81 | 34986 | 15.4% |
...
- candidats AVEC connectivite : 24033, dont T2 : 100%
- candidats SANS connectivite : 35296, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25010 systemes avec CONNECTED sur 192046 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55039 candidats sur 59329 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49074 candidats
  - AVEC connectivite (19905) : resistance **41.2%**
  - SANS connectivite (29169) : resistance **21.3%**
...
- `5c556c16ea8b` — 49074 candidats
  - AVEC connectivite (19905) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (29169) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 25101 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25010 avec CONNECTED, 91 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 189545 systemes
  - sans CONNECTED : 0.0% sur 42564 systemes
