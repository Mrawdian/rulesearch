...
genere 2026-09-09 12:52 UTC — 479231 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 395887 systemes
...
- moteur actif `0caa9267db60` (435489 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 238935 | 118623 | 16290 | 8007 | 24189 | 18744 | 25430 | 24619 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 234181 | 54571 | 98665 | 92 | 32627 | 12100 | 84 | 36023 | 15.4% |
...
- candidats AVEC connectivite : 24746, dont T2 : 100%
- candidats SANS connectivite : 36333, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25704 systemes avec CONNECTED sur 197554 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*56789 candidats sur 61079 portent les champs bruts (93%).*

- `5c556c16ea8b` — 50824 candidats
  - AVEC connectivite (20618) : resistance **41.2%**
  - SANS connectivite (30206) : resistance **21.3%**
...
- `5c556c16ea8b` — 50824 candidats
  - AVEC connectivite (20618) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (30206) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 25798 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25704 avec CONNECTED, 94 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 195053 systemes
  - sans CONNECTED : 0.0% sur 43882 systemes
