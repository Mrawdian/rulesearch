...
genere 2026-08-28 18:51 UTC — 153634 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 70290 systemes
...
- moteur actif `0caa9267db60` (109892 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 74504 | 37039 | 5076 | 2541 | 7471 | 5931 | 7855 | 7646 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 73015 | 16984 | 30875 | 35 | 10066 | 3751 | 31 | 11270 | 15.4% |
...
- candidats AVEC connectivite : 7773, dont T2 : 100%
- candidats SANS connectivite : 11580, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8129 systemes avec CONNECTED sur 63285 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*15063 candidats sur 19353 portent les champs bruts (78%).*

- `5c556c16ea8b` — 9098 candidats
  - AVEC connectivite (3645) : resistance **41.1%**
  - SANS connectivite (5453) : resistance **21.7%**
...
- `5c556c16ea8b` — 9098 candidats
  - AVEC connectivite (3645) : T0=13.02 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (5453) : T0=15.89 T1=0.00 T2=2.68 — pondere **5.35**
...
- TROP-CHER : 8170 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8129 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 60784 systemes
  - sans CONNECTED : 0.0% sur 13720 systemes
