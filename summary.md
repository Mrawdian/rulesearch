...
genere 2026-08-26 21:06 UTC — 64225 systemes evalues
...
- moteur actif `0caa9267db60` (20483 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 29366 | 14602 | 2002 | 982 | 2926 | 2328 | 3138 | 3014 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 28744 | 6629 | 12199 | 16 | 3988 | 1481 | 12 | 4419 | 15.4% |
...
- candidats SANS connectivite : 4729, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3412 systemes avec CONNECTED sur 26522 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3580 candidats sur 7870 portent les champs bruts (45%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 711 candidats
  - AVEC connectivite (297) : resistance **39.9%**
  - SANS connectivite (414) : resistance **20.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 711 candidats
  ...
  - SANS connectivite (414) : T0=16.15 T1=0.00 T2=2.68 — pondere **5.36**
  - test de permutation : **p = 0.1629** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e3baecf8377b` — 657 candidats
...
## cout
- temps total 20.0 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 3434 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3412 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 24021 systemes
  - sans CONNECTED : 0.0% sur 5345 systemes
