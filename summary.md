...
genere 2026-08-29 16:51 UTC — 189547 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 106203 systemes
...
- moteur actif `0caa9267db60` (145805 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 92645 | 46057 | 6308 | 3113 | 9333 | 7366 | 9748 | 9534 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 90787 | 21199 | 38319 | 43 | 12556 | 4659 | 36 | 13969 | 15.4% |
...
- candidats SANS connectivite : 14279, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10022 systemes avec CONNECTED sur 78083 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*19650 candidats sur 23940 portent les champs bruts (82%).*

- `5c556c16ea8b` — 13685 candidats
  - AVEC connectivite (5533) : resistance **41.2%**
  - SANS connectivite (8152) : resistance **21.5%**
...
- `5c556c16ea8b` — 13685 candidats
  ...
  - SANS connectivite (8152) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.34**
...
- TROP-CHER : 10068 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10022 avec CONNECTED, 46 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 75582 systemes
