...
**7466 enregistrements (66%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 5665 | 2854 | 361 | 205 | 543 | 461 | 590 | 584 | 10.3% |
| ref | 4 | 3 | 5523 | 1342 | 2303 | 1 | 736 | 268 | 2 | 871 | 15.8% |
...
- candidats AVEC connectivite : 587, dont T2 : 100%
- candidats SANS connectivite : 875, dont T2 : 100%
...
- **590 systemes avec CONNECTED sur 4695 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 297 candidats
  - AVEC connectivite (108) : T0=13.13 T1=0.00 T2=2.78 — pondere **5.56**
  - SANS connectivite (189) : T0=15.98 T1=0.00 T2=2.63 — pondere **5.26**
  - test de permutation : **p = 0.4148** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
## cout
- temps total 3.4 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 592 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 590 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 4638 systemes
  - sans CONNECTED : 0.0% sur 1027 systemes
