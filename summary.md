...
| connect | 4 | 3 | 6278 | 3169 | 403 | 228 | 604 | 501 | 648 | 652 | 10.4% |
...
- candidats AVEC connectivite : 655, dont T2 : 100%
...
- **648 systemes avec CONNECTED sur 5204 (12.5%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 462 candidats
  - AVEC connectivite (176) : T0=13.23 T1=0.00 T2=2.93 — pondere **5.86**
  - SANS connectivite (286) : T0=15.81 T1=0.00 T2=2.62 — pondere **5.24**
  - test de permutation : **p = 0.0370** — ecart significatif au seuil 0.05
...
- TROP-CHER : 650 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 648 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.6% sur 5147 systemes
  - sans CONNECTED : 0.0% sur 1131 systemes
