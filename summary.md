...
genere 2026-08-28 15:35 UTC — 147827 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 64483 systemes
...
- moteur actif `0caa9267db60` (104085 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 71578 | 35543 | 4891 | 2440 | 7181 | 5698 | 7563 | 7346 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 70134 | 16287 | 29638 | 32 | 9704 | 3617 | 31 | 10822 | 15.4% |
...
- candidats AVEC connectivite : 7473, dont T2 : 100%
- candidats SANS connectivite : 11132, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7837 systemes avec CONNECTED sur 60894 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*14315 candidats sur 18605 portent les champs bruts (77%).*

- `5c556c16ea8b` — 8350 candidats
  - AVEC connectivite (3345) : resistance **41.2%**
  - SANS connectivite (5005) : resistance **21.8%**
...
- `5c556c16ea8b` — 8350 candidats
  - AVEC connectivite (3345) : T0=13.02 T1=0.00 T2=3.00 — pondere **6.01**
  - SANS connectivite (5005) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.37**
...
- TROP-CHER : 7878 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7837 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 58393 systemes
  - sans CONNECTED : 0.0% sur 13185 systemes
