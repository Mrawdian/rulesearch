...
genere 2026-08-29 12:12 UTC — 182387 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 99043 systemes
...
- moteur actif `0caa9267db60` (138645 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 89027 | 44259 | 6058 | 3011 | 8950 | 7108 | 9352 | 9154 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 87245 | 20406 | 36837 | 42 | 12038 | 4472 | 35 | 13409 | 15.4% |
...
- candidats AVEC connectivite : 9281, dont T2 : 100%
- candidats SANS connectivite : 13719, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9626 systemes avec CONNECTED sur 75124 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*18710 candidats sur 23000 portent les champs bruts (81%).*

- `5c556c16ea8b` — 12745 candidats
  - AVEC connectivite (5153) : resistance **41.2%**
  - SANS connectivite (7592) : resistance **21.5%**
...
- `5c556c16ea8b` — 12745 candidats
  - AVEC connectivite (5153) : T0=12.99 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (7592) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
## cout
- temps total 56.1 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 9671 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 9626 avec CONNECTED, 45 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 72623 systemes
  - sans CONNECTED : 0.0% sur 16404 systemes
