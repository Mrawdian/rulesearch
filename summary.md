...
genere 2026-08-26 18:45 UTC — 59142 systemes evalues
...
- moteur actif `0caa9267db60` (15400 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 26792 | 13369 | 1825 | 904 | 2657 | 2115 | 2849 | 2740 | 10.2% |
...
- candidats AVEC connectivite : 2867, dont T2 : 100%
- candidats SANS connectivite : 4359, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3123 systemes avec CONNECTED sur 24419 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2936 candidats sur 7226 portent les champs bruts (41%).*
...
- `0a74109317e5` — 80 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 67 candidats
  - AVEC connectivite (23) : resistance **48.2%**
...
- `62448a55927e` — 67 candidats
  - AVEC connectivite (23) : T0=13.13 T1=0.00 T2=3.39 — pondere **6.78**
...
**6 serie(s) reproductible(s) sur 12 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0060), `62448a55927e` (p=0.0295), `b71bb0907fb5` (p=0.0110).
...
- TROP-CHER : 3143 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3123 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 21918 systemes
  - sans CONNECTED : 0.0% sur 4874 systemes
