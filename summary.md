...
genere 2026-08-28 15:22 UTC — 147425 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 64081 systemes
...
- moteur actif `0caa9267db60` (103683 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 71368 | 35432 | 4876 | 2432 | 7162 | 5688 | 7545 | 7318 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 69942 | 16234 | 29551 | 32 | 9682 | 3609 | 31 | 10800 | 15.4% |
...
- candidats AVEC connectivite : 7445, dont T2 : 100%
- candidats SANS connectivite : 11110, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7819 systemes avec CONNECTED sur 60715 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*14265 candidats sur 18555 portent les champs bruts (77%).*

- `5c556c16ea8b` — 8300 candidats
  - AVEC connectivite (3317) : resistance **41.2%**
  - SANS connectivite (4983) : resistance **21.8%**
...
- `5c556c16ea8b` — 8300 candidats
  - AVEC connectivite (3317) : T0=13.01 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (4983) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.37**
...
## cout
- temps total 45.6 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 7860 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7819 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 58214 systemes
  - sans CONNECTED : 0.0% sur 13154 systemes
