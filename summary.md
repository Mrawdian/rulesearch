...
genere 2026-08-27 06:44 UTC — 85623 systemes evalues
...
- moteur actif `0caa9267db60` (41881 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 40166 | 20000 | 2750 | 1366 | 4008 | 3159 | 4236 | 4127 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 39342 | 9062 | 16738 | 22 | 5452 | 2053 | 21 | 5994 | 15.2% |
...
- candidats AVEC connectivite : 4254, dont T2 : 100%
- candidats SANS connectivite : 6304, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4510 systemes avec CONNECTED sur 35343 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6268 candidats sur 10558 portent les champs bruts (59%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 303 candidats
  - AVEC connectivite (126) : resistance **41.3%**
  - SANS connectivite (177) : resistance **21.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 303 candidats
  - AVEC connectivite (126) : T0=13.08 T1=0.00 T2=3.02 — pondere **6.05**
  - SANS connectivite (177) : T0=15.85 T1=0.00 T2=2.66 — pondere **5.32**
  - test de permutation : **p = 0.0445** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `23303c299f39` — 225 candidats
...
**7 serie(s) reproductible(s) sur 14 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `ab89a63b01ef` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `5c556c16ea8b` (p=0.0445), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
...
## cout
- temps total 26.4 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 4541 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4510 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 32842 systemes
  - sans CONNECTED : 0.0% sur 7324 systemes
