...
genere 2026-08-27 04:32 UTC — 80774 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 15867 systemes
...
- moteur actif `0caa9267db60` (37032 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 37737 | 18777 | 2601 | 1280 | 3751 | 2967 | 3994 | 3876 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 36922 | 8508 | 15713 | 21 | 5104 | 1927 | 20 | 5629 | 15.2% |
...
- candidats AVEC connectivite : 4003, dont T2 : 100%
- candidats SANS connectivite : 5939, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4268 systemes avec CONNECTED sur 33394 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5652 candidats sur 9942 portent les champs bruts (57%).*
...
- `ab89a63b01ef` — 1975 candidats
  - AVEC connectivite (823) : resistance **41.5%**
  - SANS connectivite (1152) : resistance **21.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1975 candidats
  - AVEC connectivite (823) : T0=13.04 T1=0.00 T2=3.05 — pondere **6.09**
  - SANS connectivite (1152) : T0=15.92 T1=0.00 T2=2.69 — pondere **5.39**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
## cout
- temps total 25.0 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 4298 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4268 avec CONNECTED, 30 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 30893 systemes
  - sans CONNECTED : 0.0% sur 6844 systemes
