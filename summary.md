...
| connect | 4 | 3 | 18382 | 9175 | 1195 | 639 | 1835 | 1460 | 1994 | 1855 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 18000 | 4245 | 7582 | 12 | 2463 | 928 | 7 | 2763 | 15.3% |
...
- candidats AVEC connectivite : 1982, dont T2 : 100%
- candidats SANS connectivite : 3073, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2268 systemes avec CONNECTED sur 17507 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*765 candidats sur 5055 portent les champs bruts (15%).*
...
- `e3baecf8377b` — 501 candidats
  - AVEC connectivite (199) : resistance **42.8%**
  - SANS connectivite (302) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 501 candidats
  - AVEC connectivite (199) : T0=12.98 T1=0.00 T2=3.12 — pondere **6.24**
  - SANS connectivite (302) : T0=16.05 T1=0.00 T2=2.67 — pondere **5.34**
...
- TROP-CHER : 2285 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2268 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 15006 systemes
  - sans CONNECTED : 0.0% sur 3376 systemes
