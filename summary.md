...
genere 2026-08-27 21:00 UTC — 113932 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 30588 systemes
...
- moteur actif `0caa9267db60` (70190 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 54452 | 27116 | 3766 | 1848 | 5375 | 4312 | 5766 | 5561 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 53365 | 12318 | 22687 | 26 | 7377 | 2772 | 25 | 8158 | 15.3% |
...
- candidats SANS connectivite : 8468, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6040 systemes avec CONNECTED sur 47000 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*9866 candidats sur 14156 portent les champs bruts (70%).*

- `5c556c16ea8b` — 3901 candidats
  - AVEC connectivite (1560) : resistance **42.0%**
  - SANS connectivite (2341) : resistance **22.5%**
...
- `5c556c16ea8b` — 3901 candidats
  ...
  - SANS connectivite (2341) : T0=15.77 T1=0.00 T2=2.71 — pondere **5.42**
...
- TROP-CHER : 6075 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6040 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 44499 systemes
  - sans CONNECTED : 0.0% sur 9953 systemes
