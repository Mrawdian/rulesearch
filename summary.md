...
genere 2026-08-27 00:26 UTC — 71680 systemes evalues
...
- moteur actif `0caa9267db60` (27938 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 33135 | 16461 | 2281 | 1122 | 3294 | 2634 | 3532 | 3387 | 10.2% |
...
- candidats AVEC connectivite : 3514, dont T2 : 100%
- candidats SANS connectivite : 5268, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3806 systemes avec CONNECTED sur 29596 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4492 candidats sur 8782 portent les champs bruts (51%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 815 candidats
  - AVEC connectivite (334) : resistance **41.4%**
...
- `ab89a63b01ef` — 815 candidats
  - AVEC connectivite (334) : T0=13.13 T1=0.00 T2=3.07 — pondere **6.14**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 27095 systemes
  - sans CONNECTED : 0.0% sur 6040 systemes
