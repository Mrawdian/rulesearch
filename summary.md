...
genere 2026-08-26 22:10 UTC — 66714 systemes evalues
...
- moteur actif `0caa9267db60` (22972 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 30623 | 15214 | 2096 | 1029 | 3059 | 2435 | 3262 | 3142 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 29976 | 6912 | 12735 | 18 | 4145 | 1545 | 13 | 4608 | 15.4% |
...
- candidats AVEC connectivite : 3269, dont T2 : 100%
- candidats SANS connectivite : 4918, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3536 systemes avec CONNECTED sur 27535 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3897 candidats sur 8187 portent les champs bruts (48%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 220 candidats
  - AVEC connectivite (89) : resistance **42.9%**
  - SANS connectivite (131) : resistance **22.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 220 candidats
  - AVEC connectivite (89) : T0=13.13 T1=0.00 T2=3.03 — pondere **6.07**
  - SANS connectivite (131) : T0=16.03 T1=0.00 T2=2.70 — pondere **5.40**
...
- TROP-CHER : 3559 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3536 avec CONNECTED, 23 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 25034 systemes
  - sans CONNECTED : 0.0% sur 5589 systemes
