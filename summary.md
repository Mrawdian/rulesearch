...
genere 2026-08-26 14:18 UTC — 48598 systemes evalues
...
- moteur actif `0caa9267db60` (4856 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21471 | 10712 | 1428 | 741 | 2123 | 1705 | 2297 | 2194 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 21012 | 4905 | 8859 | 13 | 2912 | 1085 | 7 | 3231 | 15.4% |
...
- candidats SANS connectivite : 3541, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2571 systemes avec CONNECTED sur 20050 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1572 candidats sur 5862 portent les champs bruts (27%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 457 candidats
  - AVEC connectivite (183) : resistance **40.1%**
  - SANS connectivite (274) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 457 candidats
  ...
  - SANS connectivite (274) : T0=16.12 T1=0.00 T2=2.66 — pondere **5.31**
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0280).
...
- TROP-CHER : 2588 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2571 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17549 systemes
