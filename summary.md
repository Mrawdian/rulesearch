...
genere 2026-09-02 09:37 UTC — 307835 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 224491 systemes
...
- moteur actif `0caa9267db60` (264093 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 152380 | 75699 | 10369 | 5103 | 15487 | 11995 | 16134 | 15646 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 149340 | 34795 | 63151 | 63 | 20655 | 7709 | 63 | 22892 | 15.3% |
...
- candidats SANS connectivite : 23202, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16408 systemes avec CONNECTED sur 126883 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*34685 candidats sur 38975 portent les champs bruts (89%).*

- `5c556c16ea8b` — 28720 candidats
  - AVEC connectivite (11645) : resistance **41.1%**
  - SANS connectivite (17075) : resistance **21.3%**
...
- `5c556c16ea8b` — 28720 candidats
  ...
  - SANS connectivite (17075) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.29**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 124382 systemes
  - sans CONNECTED : 0.0% sur 27998 systemes
