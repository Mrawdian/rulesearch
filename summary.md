...
genere 2026-08-27 00:36 UTC — 71975 systemes evalues
...
- moteur actif `0caa9267db60` (28233 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 33284 | 16538 | 2286 | 1128 | 3309 | 2644 | 3552 | 3402 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 32576 | 7510 | 13832 | 18 | 4522 | 1706 | 16 | 4972 | 15.3% |
...
- candidats AVEC connectivite : 3529, dont T2 : 100%
- candidats SANS connectivite : 5282, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3826 systemes avec CONNECTED sur 29722 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4521 candidats sur 8811 portent les champs bruts (51%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 844 candidats
  - AVEC connectivite (349) : resistance **41.2%**
  - SANS connectivite (495) : resistance **21.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 844 candidats
  - AVEC connectivite (349) : T0=13.09 T1=0.00 T2=3.06 — pondere **6.13**
  - SANS connectivite (495) : T0=15.95 T1=0.00 T2=2.59 — pondere **5.18**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 798 candidats
...
- TROP-CHER : 3852 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 3826 avec CONNECTED, 26 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 27221 systemes
  - sans CONNECTED : 0.0% sur 6063 systemes
