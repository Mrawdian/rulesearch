...
genere 2026-08-26 21:50 UTC — 66003 systemes evalues
...
- moteur actif `0caa9267db60` (22261 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 30263 | 15030 | 2067 | 1021 | 3031 | 2403 | 3222 | 3106 | 10.3% |
...
- **3496 systemes avec CONNECTED sur 27236 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3802 candidats sur 8092 portent les champs bruts (47%).*
...
- `ab89a63b01ef` — 125 candidats
  ...
  - test de permutation : **p = 0.3708** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 3518 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3496 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24735 systemes
  - sans CONNECTED : 0.0% sur 5528 systemes
