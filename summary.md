...
genere 2026-08-27 07:23 UTC — 86981 systemes evalues
...
- moteur actif `0caa9267db60` (43239 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 40851 | 20335 | 2796 | 1389 | 4094 | 3209 | 4310 | 4192 | 10.3% |
...
- candidats AVEC connectivite : 4319, dont T2 : 100%
- candidats SANS connectivite : 6412, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4584 systemes avec CONNECTED sur 35880 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6441 candidats sur 10731 portent les champs bruts (60%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 476 candidats
  - AVEC connectivite (191) : resistance **41.8%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 476 candidats
  - AVEC connectivite (191) : T0=12.95 T1=0.00 T2=3.05 — pondere **6.09**
...
- TROP-CHER : 4615 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4584 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 33379 systemes
  - sans CONNECTED : 0.0% sur 7472 systemes
