...
genere 2026-08-26 09:55 UTC — 37461 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 28487 systemes
...
- candidats SANS connectivite : 2704, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2006 systemes avec CONNECTED sur 15443 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*145 candidats sur 4435 portent les champs bruts (3%).*

- `89c65c03c4ad` — 145 candidats
  - AVEC connectivite (54) : resistance **46.3%**
  - SANS connectivite (91) : resistance **22.3%**
...
- `89c65c03c4ad` — 3270 candidats
  - AVEC connectivite (1252) : T0=13.05 T1=0.00 T2=2.95 — pondere **5.89**
  - SANS connectivite (2018) : T0=15.84 T1=0.02 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 2023 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2006 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
