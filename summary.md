...
| connect | 4 | 3 | 5890 | 2970 | 379 | 213 | 564 | 474 | 613 | 607 | 10.3% |
| ref | 4 | 3 | 5759 | 1401 | 2396 | 1 | 767 | 281 | 2 | 911 | 15.8% |
...
- candidats AVEC connectivite : 610, dont T2 : 100%
- candidats SANS connectivite : 915, dont T2 : 100%
...
- **613 systemes avec CONNECTED sur 4887 (12.5%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 360 candidats
  - AVEC connectivite (131) : T0=13.07 T1=0.00 T2=2.91 — pondere **5.82**
  - SANS connectivite (229) : T0=15.93 T1=0.00 T2=2.62 — pondere **5.24**
...
- TROP-CHER : 615 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 613 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 4830 systemes
  - sans CONNECTED : 0.0% sur 1060 systemes
