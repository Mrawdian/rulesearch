...
genere 2026-08-26 13:38 UTC — 47117 systemes evalues
...
- moteur actif `0caa9267db60` (3375 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20723 | 10335 | 1369 | 719 | 2064 | 1649 | 2208 | 2121 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20279 | 4741 | 8567 | 13 | 2811 | 1047 | 7 | 3093 | 15.3% |
...
- candidats AVEC connectivite : 2248, dont T2 : 100%
- candidats SANS connectivite : 3403, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2482 systemes avec CONNECTED sur 19420 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1361 candidats sur 5651 portent les champs bruts (24%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 246 candidats
  - AVEC connectivite (110) : resistance **38.9%**
  - SANS connectivite (136) : resistance **21.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 246 candidats
  - AVEC connectivite (110) : T0=13.55 T1=0.00 T2=2.80 — pondere **5.60**
  - SANS connectivite (136) : T0=16.22 T1=0.00 T2=2.78 — pondere **5.56**
  - test de permutation : **p = 0.9320** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
## cout
- temps total 14.5 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2499 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2482 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16919 systemes
  - sans CONNECTED : 0.0% sur 3804 systemes
