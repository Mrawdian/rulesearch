...
genere 2026-08-26 20:49 UTC — 63694 systemes evalues
...
- moteur actif `0caa9267db60` (19952 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 28483 | 6572 | 12081 | 16 | 3955 | 1467 | 12 | 4380 | 15.4% |
...
- candidats SANS connectivite : 4690, dont T2 : 100%
...
*3517 candidats sur 7807 portent les champs bruts (45%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 648 candidats
  - AVEC connectivite (273) : resistance **39.9%**
  - SANS connectivite (375) : resistance **20.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 648 candidats
  ...
  - SANS connectivite (375) : T0=16.11 T1=0.00 T2=2.69 — pondere **5.37**
  - test de permutation : **p = 0.2259** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
