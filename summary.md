...
genere 2026-08-27 05:35 UTC — 83225 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 18318 systemes
...
- moteur actif `0caa9267db60` (39483 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 38959 | 19402 | 2681 | 1334 | 3869 | 3068 | 4107 | 3994 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 38151 | 8805 | 16226 | 22 | 5283 | 1986 | 21 | 5808 | 15.2% |
...
- candidats AVEC connectivite : 4121, dont T2 : 100%
- candidats SANS connectivite : 6118, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4381 systemes avec CONNECTED sur 34368 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5949 candidats sur 10239 portent les champs bruts (58%).*
...
- `ab89a63b01ef` — 2272 candidats
  - AVEC connectivite (941) : resistance **41.1%**
  - SANS connectivite (1331) : resistance **21.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 2272 candidats
  - AVEC connectivite (941) : T0=13.04 T1=0.00 T2=3.01 — pondere **6.02**
  - SANS connectivite (1331) : T0=15.96 T1=0.00 T2=2.66 — pondere **5.32**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- TROP-CHER : 4412 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4381 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 31867 systemes
  - sans CONNECTED : 0.0% sur 7092 systemes
