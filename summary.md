...
genere 2026-08-25 21:48 UTC — 6725 systemes evalues

## versions du DSL presentes
- `615abe43d6bc` : 5748 systemes
...
| connect | 4 | 3 | 3343 | 1687 | 213 | 118 | 326 | 261 | 335 | 361 | 10.8% |
...
- candidats AVEC connectivite : 364, dont T2 : 100%
- candidats SANS connectivite : 518, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **335 systemes avec CONNECTED sur 2795 (12.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- TROP-CHER : 336 systemes abandonnes (5.0% des systemes), 96% du temps total
  dont 335 avec CONNECTED, 1 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.2% sur 2738 systemes
  - sans CONNECTED : 0.0% sur 605 systemes
