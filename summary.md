...
genere 2026-09-08 23:49 UTC — 467633 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 384289 systemes
...
- moteur actif `0caa9267db60` (423891 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 233081 | 115769 | 15870 | 7801 | 23591 | 18256 | 24835 | 24002 | 10.3% |
...
- candidats AVEC connectivite : 24129, dont T2 : 100%
...
- **25109 systemes avec CONNECTED sur 192811 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55315 candidats sur 59605 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49350 candidats
  - AVEC connectivite (20001) : resistance **41.2%**
...
- `5c556c16ea8b` — 49350 candidats
  - AVEC connectivite (20001) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 25201 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25109 avec CONNECTED, 92 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 190310 systemes
  - sans CONNECTED : 0.0% sur 42771 systemes
