...
genere 2026-08-30 10:38 UTC — 215669 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 132325 systemes
...
- moteur actif `0caa9267db60` (171927 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 105848 | 52541 | 7212 | 3530 | 10667 | 8421 | 11216 | 10879 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 103706 | 24192 | 43802 | 49 | 14319 | 5352 | 41 | 15943 | 15.4% |
...
- candidats AVEC connectivite : 11006, dont T2 : 100%
- candidats SANS connectivite : 16253, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11490 systemes avec CONNECTED sur 88847 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*22969 candidats sur 27259 portent les champs bruts (84%).*

- `5c556c16ea8b` — 17004 candidats
  - AVEC connectivite (6878) : resistance **41.1%**
  - SANS connectivite (10126) : resistance **21.5%**
...
- `5c556c16ea8b` — 17004 candidats
  - AVEC connectivite (6878) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (10126) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 86346 systemes
  - sans CONNECTED : 0.0% sur 19502 systemes
