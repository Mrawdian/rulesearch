...
genere 2026-08-28 20:30 UTC — 156412 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 73068 systemes
...
- moteur actif `0caa9267db60` (112670 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 75910 | 37726 | 5170 | 2579 | 7607 | 6059 | 8006 | 7800 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 74387 | 17288 | 31492 | 35 | 10257 | 3809 | 31 | 11472 | 15.4% |
...
- candidats AVEC connectivite : 7927, dont T2 : 100%
- candidats SANS connectivite : 11782, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8280 systemes avec CONNECTED sur 64427 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*15419 candidats sur 19709 portent les champs bruts (78%).*

- `5c556c16ea8b` — 9454 candidats
  - AVEC connectivite (3799) : resistance **41.1%**
  - SANS connectivite (5655) : resistance **21.7%**
...
- `5c556c16ea8b` — 9454 candidats
  - AVEC connectivite (3799) : T0=13.01 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (5655) : T0=15.89 T1=0.00 T2=2.68 — pondere **5.36**
...
- TROP-CHER : 8321 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8280 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 61926 systemes
  - sans CONNECTED : 0.0% sur 13984 systemes
