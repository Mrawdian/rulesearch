...
genere 2026-09-07 12:15 UTC — 435486 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 352142 systemes
...
- moteur actif `0caa9267db60` (391744 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 216841 | 107727 | 14765 | 7216 | 21959 | 17000 | 23064 | 22355 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 212530 | 49483 | 89600 | 83 | 29623 | 10978 | 76 | 32669 | 15.4% |
...
- candidats AVEC connectivite : 22482, dont T2 : 100%
- candidats SANS connectivite : 32979, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23338 systemes avec CONNECTED sur 179525 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*51171 candidats sur 55461 portent les champs bruts (92%).*

- `5c556c16ea8b` — 45206 candidats
  - AVEC connectivite (18354) : resistance **41.1%**
  - SANS connectivite (26852) : resistance **21.3%**
...
- `5c556c16ea8b` — 45206 candidats
  - AVEC connectivite (18354) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (26852) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 23424 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23338 avec CONNECTED, 86 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 177024 systemes
  - sans CONNECTED : 0.0% sur 39817 systemes
