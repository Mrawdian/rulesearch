...
genere 2026-08-26 18:52 UTC — 59424 systemes evalues
...
- moteur actif `0caa9267db60` (15682 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 26942 | 13445 | 1834 | 908 | 2673 | 2130 | 2865 | 2751 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 26367 | 6086 | 11164 | 15 | 3674 | 1359 | 10 | 4059 | 15.4% |
...
- candidats AVEC connectivite : 2878, dont T2 : 100%
- candidats SANS connectivite : 4369, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3139 systemes avec CONNECTED sur 24538 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2957 candidats sur 7247 portent les champs bruts (41%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 88 candidats
  - AVEC connectivite (34) : resistance **47.1%**
  - SANS connectivite (54) : resistance **16.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 88 candidats
  - AVEC connectivite (34) : T0=13.12 T1=0.00 T2=3.35 — pondere **6.71**
  - SANS connectivite (54) : T0=16.17 T1=0.00 T2=2.41 — pondere **4.81**
...
**6 serie(s) reproductible(s) sur 12 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0060), `62448a55927e` (p=0.0085), `b71bb0907fb5` (p=0.0110).
...
- TROP-CHER : 3159 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3139 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22037 systemes
  - sans CONNECTED : 0.0% sur 4905 systemes
