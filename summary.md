...
genere 2026-08-26 23:19 UTC — 69189 systemes evalues
...
- moteur actif `0caa9267db60` (25447 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 31877 | 15837 | 2190 | 1072 | 3170 | 2540 | 3402 | 3261 | 10.2% |
...
- candidats AVEC connectivite : 3388, dont T2 : 100%
- candidats SANS connectivite : 5092, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3676 systemes avec CONNECTED sur 28567 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4190 candidats sur 8480 portent les champs bruts (49%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 513 candidats
  - AVEC connectivite (208) : resistance **41.7%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 513 candidats
  - AVEC connectivite (208) : T0=12.91 T1=0.00 T2=3.07 — pondere **6.13**
...
- TROP-CHER : 3700 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3676 avec CONNECTED, 24 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 26066 systemes
  - sans CONNECTED : 0.0% sur 5811 systemes
