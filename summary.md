...
genere 2026-09-03 15:24 UTC — 341569 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 258225 systemes
...
- moteur actif `0caa9267db60` (297827 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 169412 | 84207 | 11487 | 5673 | 17238 | 13373 | 17958 | 17315 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 166042 | 38625 | 70190 | 66 | 23035 | 8586 | 66 | 25462 | 15.3% |
...
- candidats AVEC connectivite : 17442, dont T2 : 100%
- candidats SANS connectivite : 25772, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18232 systemes avec CONNECTED sur 140720 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*38924 candidats sur 43214 portent les champs bruts (90%).*

- `5c556c16ea8b` — 32959 candidats
  - AVEC connectivite (13314) : resistance **41.0%**
  - SANS connectivite (19645) : resistance **21.2%**
...
- `5c556c16ea8b` — 32959 candidats
  - AVEC connectivite (13314) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (19645) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.29**
...
- TROP-CHER : 18308 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18232 avec CONNECTED, 76 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 138219 systemes
  - sans CONNECTED : 0.0% sur 31193 systemes
