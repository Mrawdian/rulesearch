...
genere 2026-08-27 03:18 UTC — 78025 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 13118 systemes
...
- moteur actif `0caa9267db60` (34283 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 36349 | 18072 | 2505 | 1233 | 3611 | 2874 | 3858 | 3721 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 35561 | 8211 | 15125 | 20 | 4911 | 1851 | 19 | 5424 | 15.3% |
...
- candidats SANS connectivite : 5734, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4132 systemes avec CONNECTED sur 32249 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5292 candidats sur 9582 portent les champs bruts (55%).*
...
- `ab89a63b01ef` — 1615 candidats
  - AVEC connectivite (668) : resistance **41.2%**
  - SANS connectivite (947) : resistance **22.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1615 candidats
  ...
  - SANS connectivite (947) : T0=15.92 T1=0.00 T2=2.71 — pondere **5.43**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- TROP-CHER : 4161 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4132 avec CONNECTED, 29 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 29748 systemes
  - sans CONNECTED : 0.0% sur 6601 systemes
