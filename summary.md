...
genere 2026-08-26 22:35 UTC — 67601 systemes evalues
...
- moteur actif `0caa9267db60` (23859 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 31069 | 15426 | 2126 | 1042 | 3096 | 2478 | 3314 | 3192 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 30417 | 7006 | 12918 | 18 | 4219 | 1579 | 14 | 4663 | 15.3% |
...
- candidats AVEC connectivite : 3319, dont T2 : 100%
- candidats SANS connectivite : 4973, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3588 systemes avec CONNECTED sur 27896 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4002 candidats sur 8292 portent les champs bruts (48%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 325 candidats
  - AVEC connectivite (139) : resistance **42.6%**
  - SANS connectivite (186) : resistance **22.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 325 candidats
  - AVEC connectivite (139) : T0=12.79 T1=0.00 T2=3.06 — pondere **6.13**
  - SANS connectivite (186) : T0=16.17 T1=0.00 T2=2.80 — pondere **5.60**
  - test de permutation : **p = 0.1354** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
**5 serie(s) reproductible(s) sur 13 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
...
## cout
- temps total 21.0 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 3612 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3588 avec CONNECTED, 24 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 25395 systemes
  - sans CONNECTED : 0.0% sur 5674 systemes
