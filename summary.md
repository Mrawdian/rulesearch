...
genere 2026-08-28 13:33 UTC — 144324 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 60980 systemes
...
- moteur actif `0caa9267db60` (100582 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 69813 | 34686 | 4770 | 2366 | 7007 | 5579 | 7374 | 7137 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 68396 | 15875 | 28902 | 32 | 9471 | 3521 | 30 | 10562 | 15.4% |
...
- candidats AVEC connectivite : 7264, dont T2 : 100%
- candidats SANS connectivite : 10872, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7648 systemes avec CONNECTED sur 59432 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*13846 candidats sur 18136 portent les champs bruts (76%).*

- `5c556c16ea8b` — 7881 candidats
  - AVEC connectivite (3136) : resistance **41.3%**
  - SANS connectivite (4745) : resistance **21.8%**
...
- `5c556c16ea8b` — 7881 candidats
  - AVEC connectivite (3136) : T0=13.00 T1=0.00 T2=3.00 — pondere **6.01**
  - SANS connectivite (4745) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.36**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 56931 systemes
  - sans CONNECTED : 0.0% sur 12882 systemes
