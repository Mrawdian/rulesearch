...
genere 2026-08-27 02:29 UTC — 76136 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 11229 systemes
...
- moteur actif `0caa9267db60` (32394 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 35393 | 17609 | 2432 | 1201 | 3511 | 2804 | 3769 | 3612 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 34628 | 7980 | 14729 | 20 | 4795 | 1813 | 19 | 5272 | 15.2% |
...
- candidats SANS connectivite : 5582, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4043 systemes avec CONNECTED sur 31467 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5031 candidats sur 9321 portent les champs bruts (54%).*
...
- `ab89a63b01ef` — 1354 candidats
  - AVEC connectivite (559) : resistance **41.1%**
  - SANS connectivite (795) : resistance **22.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1354 candidats
  ...
  - SANS connectivite (795) : T0=15.94 T1=0.00 T2=2.70 — pondere **5.39**
...
- TROP-CHER : 4072 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4043 avec CONNECTED, 29 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 28966 systemes
  - sans CONNECTED : 0.0% sur 6427 systemes
