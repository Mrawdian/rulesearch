...
genere 2026-08-26 14:25 UTC — 48894 systemes evalues
...
- moteur actif `0caa9267db60` (5152 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21621 | 10786 | 1440 | 744 | 2140 | 1720 | 2311 | 2206 | 10.2% |
...
- candidats AVEC connectivite : 2333, dont T2 : 100%
- candidats SANS connectivite : 3566, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2585 systemes avec CONNECTED sur 20169 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1609 candidats sur 5899 portent les champs bruts (27%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 494 candidats
  - AVEC connectivite (195) : resistance **40.3%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 494 candidats
  - AVEC connectivite (195) : T0=13.38 T1=0.00 T2=2.98 — pondere **5.96**
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0305).
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17668 systemes
  - sans CONNECTED : 0.0% sur 3953 systemes
