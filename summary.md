...
genere 2026-08-31 12:04 UTC — 251162 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 167818 systemes
...
- moteur actif `0caa9267db60` (207420 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 123782 | 61557 | 8394 | 4149 | 12472 | 9765 | 13078 | 12747 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 121265 | 28291 | 51190 | 53 | 16777 | 6276 | 56 | 18612 | 15.3% |
...
- candidats AVEC connectivite : 12874, dont T2 : 100%
- candidats SANS connectivite : 18922, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13352 systemes avec CONNECTED sur 103530 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*27506 candidats sur 31796 portent les champs bruts (87%).*

- `5c556c16ea8b` — 21541 candidats
  - AVEC connectivite (8746) : resistance **40.9%**
  - SANS connectivite (12795) : resistance **21.3%**
...
- `5c556c16ea8b` — 21541 candidats
  - AVEC connectivite (8746) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (12795) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 101029 systemes
  - sans CONNECTED : 0.0% sur 22753 systemes
