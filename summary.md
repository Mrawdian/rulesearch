...
genere 2026-08-28 01:26 UTC — 122896 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 39552 systemes
...
- moteur actif `0caa9267db60` (79154 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 58991 | 29376 | 4077 | 1994 | 5868 | 4675 | 6195 | 6048 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 57790 | 13344 | 24526 | 28 | 8027 | 2993 | 26 | 8844 | 15.3% |
...
- candidats AVEC connectivite : 6175, dont T2 : 100%
- candidats SANS connectivite : 9154, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6469 systemes avec CONNECTED sur 50655 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11039 candidats sur 15329 portent les champs bruts (72%).*

- `5c556c16ea8b` — 5074 candidats
  - AVEC connectivite (2047) : resistance **42.0%**
  - SANS connectivite (3027) : resistance **22.3%**
...
- `5c556c16ea8b` — 5074 candidats
  - AVEC connectivite (2047) : T0=12.99 T1=0.00 T2=3.05 — pondere **6.10**
  - SANS connectivite (3027) : T0=15.84 T1=0.00 T2=2.71 — pondere **5.42**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 48154 systemes
  - sans CONNECTED : 0.0% sur 10837 systemes
