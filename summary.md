...
genere 2026-08-26 07:53 UTC — 32010 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 23036 systemes
...
- candidats AVEC connectivite : 1530, dont T2 : 100%
- candidats SANS connectivite : 2366, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1741 systemes avec CONNECTED sur 13234 (13.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2731 candidats
  - AVEC connectivite (1051) : T0=13.18 T1=0.00 T2=2.90 — pondere **5.79**
