...
genere 2026-09-07 04:42 UTC — 428467 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 345123 systemes
...
- moteur actif `0caa9267db60` (384725 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 213285 | 105907 | 14529 | 7101 | 21631 | 16759 | 22672 | 21973 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 209067 | 48669 | 88153 | 81 | 29138 | 10798 | 75 | 32135 | 15.4% |
...
- candidats AVEC connectivite : 22100, dont T2 : 100%
- candidats SANS connectivite : 32445, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **22946 systemes avec CONNECTED sur 176566 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*50255 candidats sur 54545 portent les champs bruts (92%).*

- `5c556c16ea8b` — 44290 candidats
  - AVEC connectivite (17972) : resistance **41.1%**
  - SANS connectivite (26318) : resistance **21.3%**
...
- `5c556c16ea8b` — 44290 candidats
  - AVEC connectivite (17972) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (26318) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
## cout
- temps total 133.3 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 23031 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 22946 avec CONNECTED, 85 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 174065 systemes
  - sans CONNECTED : 0.0% sur 39220 systemes
