...
genere 2026-08-26 09:35 UTC — 36540 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 27566 systemes
...
| connect | 4 | 3 | 15808 | 7882 | 1033 | 541 | 1566 | 1262 | 1727 | 1596 | 10.1% |
| d4 | 4 | 4 | 5122 | 2356 | 1304 | 26 | 367 | 337 | 246 | 360 | 7.0% |
| ref | 4 | 3 | 15486 | 3635 | 6535 | 11 | 2126 | 785 | 6 | 2388 | 15.4% |
...
- candidats AVEC connectivite : 1698, dont T2 : 100%
- candidats SANS connectivite : 2653, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1964 systemes avec CONNECTED sur 15075 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*61 candidats sur 4351 portent les champs bruts (1%).*

- `89c65c03c4ad` — 61 candidats
  - AVEC connectivite (21) : resistance **55.4%**
  - SANS connectivite (40) : resistance **21.7%**
...
- `89c65c03c4ad` — 3186 candidats
  - AVEC connectivite (1219) : T0=13.10 T1=0.00 T2=2.95 — pondere **5.90**
  - SANS connectivite (1967) : T0=15.85 T1=0.02 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 1979 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 1964 avec CONNECTED, 15 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.4% sur 12924 systemes
  - sans CONNECTED : 0.0% sur 2884 systemes
