...
genere 2026-08-26 14:42 UTC — 49560 systemes evalues
...
- moteur actif `0caa9267db60` (5818 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21951 | 10950 | 1470 | 753 | 2176 | 1737 | 2347 | 2241 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 21494 | 4999 | 9076 | 13 | 2985 | 1104 | 9 | 3308 | 15.4% |
...
- candidats AVEC connectivite : 2368, dont T2 : 100%
- candidats SANS connectivite : 3618, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2621 systemes avec CONNECTED sur 20436 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1696 candidats sur 5986 portent les champs bruts (28%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 581 candidats
  - AVEC connectivite (230) : resistance **40.7%**
  - SANS connectivite (351) : resistance **20.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 581 candidats
  - AVEC connectivite (230) : T0=13.41 T1=0.00 T2=3.03 — pondere **6.06**
  - SANS connectivite (351) : T0=16.08 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 2640 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2621 avec CONNECTED, 19 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17935 systemes
  - sans CONNECTED : 0.0% sur 4016 systemes
