...
genere 2026-08-26 19:14 UTC — 60248 systemes evalues
...
- moteur actif `0caa9267db60` (16506 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27360 | 13649 | 1865 | 923 | 2704 | 2168 | 2908 | 2800 | 10.2% |
...
- candidats AVEC connectivite : 2927, dont T2 : 100%
- candidats SANS connectivite : 4432, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3182 systemes avec CONNECTED sur 24887 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3069 candidats sur 7359 portent les champs bruts (42%).*
...
- `23303c299f39` — 225 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 200 candidats
  - AVEC connectivite (83) : resistance **39.2%**
...
- `62448a55927e` — 200 candidats
  - AVEC connectivite (83) : T0=13.14 T1=0.00 T2=2.90 — pondere **5.81**
  - SANS connectivite (117) : T0=16.07 T1=0.00 T2=2.55 — pondere **5.09**
  - test de permutation : **p = 0.1229** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
- TROP-CHER : 3202 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3182 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22386 systemes
  - sans CONNECTED : 0.0% sur 4974 systemes
