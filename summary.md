...
| connect | 4 | 3 | 5546 | 2787 | 356 | 203 | 532 | 456 | 576 | 573 | 10.3% |
| ref | 4 | 3 | 5410 | 1312 | 2256 | 1 | 716 | 265 | 2 | 858 | 15.9% |
...
- candidats AVEC connectivite : 576, dont T2 : 100%
...
- **576 systemes avec CONNECTED sur 4592 (12.5%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 273 candidats
  - AVEC connectivite (97) : T0=13.20 T1=0.00 T2=2.84 — pondere **5.67**
  - SANS connectivite (176) : T0=16.04 T1=0.00 T2=2.62 — pondere **5.25**
  - test de permutation : **p = 0.2709** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 578 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 576 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 4535 systemes
  - sans CONNECTED : 0.0% sur 1011 systemes
