...
genere 2026-09-04 17:39 UTC — 370009 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 286665 systemes
...
- moteur actif `0caa9267db60` (326267 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 183766 | 91318 | 12502 | 6147 | 18688 | 14467 | 19466 | 18818 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 180128 | 41873 | 76096 | 75 | 25029 | 9331 | 70 | 27640 | 15.3% |
...
- candidats AVEC connectivite : 18945, dont T2 : 100%
- candidats SANS connectivite : 27950, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19740 systemes avec CONNECTED sur 152419 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*42605 candidats sur 46895 portent les champs bruts (91%).*

- `5c556c16ea8b` — 36640 candidats
  - AVEC connectivite (14817) : resistance **41.0%**
  - SANS connectivite (21823) : resistance **21.3%**
...
- `5c556c16ea8b` — 36640 candidats
  - AVEC connectivite (14817) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.94**
  - SANS connectivite (21823) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 149918 systemes
  - sans CONNECTED : 0.0% sur 33848 systemes
