...
genere 2026-09-04 14:25 UTC — 366632 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 283288 systemes
...
- moteur actif `0caa9267db60` (322890 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 182059 | 90491 | 12379 | 6081 | 18532 | 14339 | 19279 | 18626 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 178458 | 41479 | 75389 | 73 | 24796 | 9243 | 70 | 27394 | 15.4% |
...
- candidats AVEC connectivite : 18753, dont T2 : 100%
- candidats SANS connectivite : 27704, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19553 systemes avec CONNECTED sur 151010 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*42167 candidats sur 46457 portent les champs bruts (91%).*

- `5c556c16ea8b` — 36202 candidats
  - AVEC connectivite (14625) : resistance **41.0%**
  - SANS connectivite (21577) : resistance **21.2%**
...
- `5c556c16ea8b` — 36202 candidats
  - AVEC connectivite (14625) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.94**
  - SANS connectivite (21577) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 148509 systemes
  - sans CONNECTED : 0.0% sur 33550 systemes
