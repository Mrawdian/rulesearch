...
genere 2026-09-04 05:40 UTC — 357165 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 273821 systemes
...
- moteur actif `0caa9267db60` (313423 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 177281 | 88113 | 12054 | 5936 | 18024 | 13955 | 18796 | 18148 | 10.2% |
...
- candidats AVEC connectivite : 18275, dont T2 : 100%
...
- **19070 systemes avec CONNECTED sur 147178 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*41007 candidats sur 45297 portent les champs bruts (91%).*

- `5c556c16ea8b` — 35042 candidats
  - AVEC connectivite (14147) : resistance **41.1%**
...
- `5c556c16ea8b` — 35042 candidats
  - AVEC connectivite (14147) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 19150 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19070 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 144677 systemes
  - sans CONNECTED : 0.0% sur 32604 systemes
