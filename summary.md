...
genere 2026-08-26 16:08 UTC — 52926 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 7743 systemes
...
- moteur actif `0caa9267db60` (9184 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23654 | 11795 | 1605 | 806 | 2354 | 1874 | 2527 | 2397 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 23157 | 5363 | 9778 | 14 | 3237 | 1179 | 10 | 3576 | 15.4% |
...
- candidats AVEC connectivite : 2524, dont T2 : 100%
- candidats SANS connectivite : 3886, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2801 systemes avec CONNECTED sur 21811 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2120 candidats sur 6410 portent les champs bruts (33%).*
...
- `06fe04a859f1` — 1005 candidats
  - AVEC connectivite (386) : resistance **41.2%**
  - SANS connectivite (619) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1005 candidats
  - AVEC connectivite (386) : T0=13.18 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (619) : T0=16.00 T1=0.00 T2=2.64 — pondere **5.27**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
...
- TROP-CHER : 2821 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2801 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19310 systemes
  - sans CONNECTED : 0.0% sur 4344 systemes
