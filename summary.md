...
genere 2026-09-07 03:02 UTC — 426913 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 343569 systemes
...
- moteur actif `0caa9267db60` (383171 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 212508 | 105508 | 14474 | 7073 | 21564 | 16708 | 22585 | 21896 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 208290 | 48468 | 87840 | 81 | 29033 | 10756 | 74 | 32020 | 15.4% |
...
- candidats SANS connectivite : 32330, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **22859 systemes avec CONNECTED sur 175913 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*50063 candidats sur 54353 portent les champs bruts (92%).*

- `5c556c16ea8b` — 44098 candidats
  - AVEC connectivite (17895) : resistance **41.1%**
  - SANS connectivite (26203) : resistance **21.3%**
...
- `5c556c16ea8b` — 44098 candidats
  ...
  - SANS connectivite (26203) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 22943 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 22859 avec CONNECTED, 84 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 173412 systemes
  - sans CONNECTED : 0.0% sur 39096 systemes
