...
genere 2026-09-03 16:34 UTC — 342892 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 259548 systemes
...
- moteur actif `0caa9267db60` (299150 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 170070 | 84535 | 11538 | 5693 | 17298 | 13431 | 18026 | 17383 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 166707 | 38769 | 70465 | 67 | 23133 | 8620 | 66 | 25575 | 15.3% |
...
- candidats SANS connectivite : 25885, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18300 systemes avec CONNECTED sur 141259 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39105 candidats sur 43395 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33140 candidats
  - AVEC connectivite (13382) : resistance **41.0%**
  - SANS connectivite (19758) : resistance **21.2%**
...
- `5c556c16ea8b` — 33140 candidats
  ...
  - SANS connectivite (19758) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 18376 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18300 avec CONNECTED, 76 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 138758 systemes
  - sans CONNECTED : 0.0% sur 31312 systemes
