...
genere 2026-08-28 04:00 UTC — 127638 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 44294 systemes
...
- moteur actif `0caa9267db60` (83896 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 61380 | 30520 | 4243 | 2077 | 6114 | 4881 | 6446 | 6310 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 60143 | 13917 | 25473 | 28 | 8371 | 3112 | 26 | 9214 | 15.3% |
...
- candidats AVEC connectivite : 6437, dont T2 : 100%
- candidats SANS connectivite : 9524, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6720 systemes avec CONNECTED sur 52588 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11671 candidats sur 15961 portent les champs bruts (73%).*

- `5c556c16ea8b` — 5706 candidats
  - AVEC connectivite (2309) : resistance **41.8%**
  - SANS connectivite (3397) : resistance **22.1%**
...
- `5c556c16ea8b` — 5706 candidats
  - AVEC connectivite (2309) : T0=12.98 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (3397) : T0=15.86 T1=0.00 T2=2.69 — pondere **5.39**
...
- TROP-CHER : 6756 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6720 avec CONNECTED, 36 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 50087 systemes
  - sans CONNECTED : 0.0% sur 11293 systemes
