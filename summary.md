...
genere 2026-08-31 03:52 UTC — 239955 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 156611 systemes
...
- moteur actif `0caa9267db60` (196213 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 118121 | 58759 | 8024 | 3959 | 11861 | 9307 | 12514 | 12154 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 115719 | 27002 | 48916 | 53 | 15969 | 5974 | 52 | 17743 | 15.3% |
...
- candidats AVEC connectivite : 12281, dont T2 : 100%
- candidats SANS connectivite : 18053, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12788 systemes avec CONNECTED sur 98969 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*26044 candidats sur 30334 portent les champs bruts (86%).*

- `5c556c16ea8b` — 20079 candidats
  - AVEC connectivite (8153) : resistance **41.0%**
  - SANS connectivite (11926) : resistance **21.4%**
...
- `5c556c16ea8b` — 20079 candidats
  - AVEC connectivite (8153) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.97**
  - SANS connectivite (11926) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
## cout
- temps total 74.5 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 12850 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 12788 avec CONNECTED, 62 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 96468 systemes
  - sans CONNECTED : 0.0% sur 21653 systemes
