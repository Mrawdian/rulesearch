...
genere 2026-08-26 06:06 UTC — 27424 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 18450 systemes
...
- candidats AVEC connectivite : 1374, dont T2 : 100%
- candidats SANS connectivite : 2062, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1502 systemes avec CONNECTED sur 11352 (13.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2271 candidats
  - AVEC connectivite (895) : T0=13.25 T1=0.00 T2=2.87 — pondere **5.73**
  - SANS connectivite (1376) : T0=15.90 T1=0.00 T2=2.64 — pondere **5.29**
...
- TROP-CHER : 1508 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1502 avec CONNECTED, 6 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
