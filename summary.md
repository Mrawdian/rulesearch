...
genere 2026-09-01 21:21 UTC — 293253 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 209909 systemes
...
- moteur actif `0caa9267db60` (249511 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 145025 | 72023 | 9864 | 4855 | 14728 | 11423 | 15342 | 14917 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 142113 | 33040 | 60108 | 60 | 19702 | 7347 | 63 | 21782 | 15.3% |
...
- candidats SANS connectivite : 22092, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15616 systemes avec CONNECTED sur 120860 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*32846 candidats sur 37136 portent les champs bruts (88%).*

- `5c556c16ea8b` — 26881 candidats
  - AVEC connectivite (10916) : resistance **41.0%**
  - SANS connectivite (15965) : resistance **21.3%**
...
- `5c556c16ea8b` — 26881 candidats
  ...
  - SANS connectivite (15965) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 15689 systemes abandonnes (5.3% des systemes), 96% du temps total
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 118359 systemes
  - sans CONNECTED : 0.0% sur 26666 systemes
