...
genere 2026-09-07 17:00 UTC — 439873 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 356529 systemes
...
- moteur actif `0caa9267db60` (396131 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 219063 | 108821 | 14942 | 7297 | 22177 | 17168 | 23305 | 22570 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 214695 | 49995 | 90503 | 84 | 29929 | 11089 | 77 | 33000 | 15.4% |
...
- candidats AVEC connectivite : 22697, dont T2 : 100%
- candidats SANS connectivite : 33310, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23579 systemes avec CONNECTED sur 181356 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*51717 candidats sur 56007 portent les champs bruts (92%).*

- `5c556c16ea8b` — 45752 candidats
  - AVEC connectivite (18569) : resistance **41.1%**
  - SANS connectivite (27183) : resistance **21.3%**
...
- `5c556c16ea8b` — 45752 candidats
  - AVEC connectivite (18569) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (27183) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 23666 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23579 avec CONNECTED, 87 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 178855 systemes
  - sans CONNECTED : 0.0% sur 40208 systemes
