...
genere 2026-09-05 18:31 UTC — 395412 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 312068 systemes
...
- moteur actif `0caa9267db60` (351670 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 196590 | 97601 | 13384 | 6553 | 19991 | 15472 | 20857 | 20233 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 192707 | 44846 | 81307 | 78 | 26835 | 9965 | 71 | 29591 | 15.4% |
...
- candidats AVEC connectivite : 20360, dont T2 : 100%
- candidats SANS connectivite : 29901, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21131 systemes avec CONNECTED sur 162874 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*45971 candidats sur 50261 portent les champs bruts (91%).*

- `5c556c16ea8b` — 40006 candidats
  - AVEC connectivite (16232) : resistance **41.1%**
  - SANS connectivite (23774) : resistance **21.3%**
...
- `5c556c16ea8b` — 40006 candidats
  - AVEC connectivite (16232) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (23774) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 21212 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21131 avec CONNECTED, 81 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 160373 systemes
  - sans CONNECTED : 0.0% sur 36217 systemes
