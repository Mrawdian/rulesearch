...
genere 2026-08-26 20:57 UTC — 64004 systemes evalues
...
- moteur actif `0caa9267db60` (20262 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 29261 | 14560 | 1994 | 976 | 2915 | 2319 | 3117 | 3006 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 28628 | 6604 | 12142 | 16 | 3978 | 1473 | 12 | 4403 | 15.4% |
...
- candidats AVEC connectivite : 3133, dont T2 : 100%
- candidats SANS connectivite : 4713, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3391 systemes avec CONNECTED sur 26434 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3556 candidats sur 7846 portent les champs bruts (45%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 687 candidats
  - AVEC connectivite (289) : resistance **40.0%**
  - SANS connectivite (398) : resistance **20.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 687 candidats
  - AVEC connectivite (289) : T0=12.83 T1=0.00 T2=2.84 — pondere **5.69**
  - SANS connectivite (398) : T0=16.12 T1=0.00 T2=2.68 — pondere **5.36**
...
## cout
- temps total 19.8 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 3413 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3391 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23933 systemes
  - sans CONNECTED : 0.0% sur 5328 systemes
