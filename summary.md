...
genere 2026-08-26 20:40 UTC — 63396 systemes evalues
...
- moteur actif `0caa9267db60` (19654 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 28946 | 14405 | 1977 | 968 | 2875 | 2294 | 3083 | 2976 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 28335 | 6541 | 12024 | 16 | 3931 | 1459 | 12 | 4352 | 15.4% |
...
- candidats AVEC connectivite : 3103, dont T2 : 100%
- candidats SANS connectivite : 4662, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3357 systemes avec CONNECTED sur 26181 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3475 candidats sur 7765 portent les champs bruts (45%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 606 candidats
  - AVEC connectivite (259) : resistance **40.1%**
  - SANS connectivite (347) : resistance **20.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 606 candidats
  - AVEC connectivite (259) : T0=12.75 T1=0.00 T2=2.85 — pondere **5.70**
  - SANS connectivite (347) : T0=16.17 T1=0.00 T2=2.67 — pondere **5.34**
  - test de permutation : **p = 0.1559** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- TROP-CHER : 3379 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3357 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23680 systemes
  - sans CONNECTED : 0.0% sur 5266 systemes
