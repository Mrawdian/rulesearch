...
genere 2026-09-03 06:57 UTC — 332196 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 248852 systemes
...
- moteur actif `0caa9267db60` (288454 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 164671 | 81827 | 11184 | 5509 | 16775 | 12988 | 17442 | 16842 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 161410 | 37622 | 68230 | 65 | 22383 | 8347 | 66 | 24685 | 15.3% |
...
- candidats AVEC connectivite : 16969, dont T2 : 100%
- candidats SANS connectivite : 24995, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **17716 systemes avec CONNECTED sur 136832 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*37674 candidats sur 41964 portent les champs bruts (90%).*

- `5c556c16ea8b` — 31709 candidats
  - AVEC connectivite (12841) : resistance **41.1%**
  - SANS connectivite (18868) : resistance **21.2%**
...
- `5c556c16ea8b` — 31709 candidats
  - AVEC connectivite (12841) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (18868) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 134331 systemes
  - sans CONNECTED : 0.0% sur 30340 systemes
