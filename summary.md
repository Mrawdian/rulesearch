...
genere 2026-08-26 16:30 UTC — 53771 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 8588 systemes
...
- moteur actif `0caa9267db60` (10029 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 24089 | 12014 | 1641 | 816 | 2387 | 1907 | 2573 | 2449 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 23567 | 5460 | 9958 | 14 | 3295 | 1200 | 10 | 3630 | 15.4% |
...
- candidats AVEC connectivite : 2576, dont T2 : 100%
- candidats SANS connectivite : 3940, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2847 systemes avec CONNECTED sur 22179 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2226 candidats sur 6516 portent les champs bruts (34%).*
...
- `06fe04a859f1` — 1111 candidats
  - AVEC connectivite (438) : resistance **40.8%**
  - SANS connectivite (673) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1111 candidats
  - AVEC connectivite (438) : T0=13.12 T1=0.00 T2=3.00 — pondere **6.01**
  - SANS connectivite (673) : T0=15.95 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 2867 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2847 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19678 systemes
  - sans CONNECTED : 0.0% sur 4411 systemes
