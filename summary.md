...
genere 2026-09-09 15:26 UTC — 481308 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 397964 systemes
...
- moteur actif `0caa9267db60` (437566 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 239995 | 119129 | 16363 | 8041 | 24294 | 18822 | 25566 | 24733 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 235198 | 54800 | 99118 | 92 | 32764 | 12150 | 86 | 36169 | 15.4% |
...
- candidats AVEC connectivite : 24860, dont T2 : 100%
- candidats SANS connectivite : 36479, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25840 systemes avec CONNECTED sur 198430 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*57049 candidats sur 61339 portent les champs bruts (93%).*

- `5c556c16ea8b` — 51084 candidats
  - AVEC connectivite (20732) : resistance **41.2%**
  - SANS connectivite (30352) : resistance **21.3%**
...
- `5c556c16ea8b` — 51084 candidats
  - AVEC connectivite (20732) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (30352) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 195929 systemes
  - sans CONNECTED : 0.0% sur 44066 systemes
