...
genere 2026-09-08 20:37 UTC — 464728 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 381384 systemes
...
- moteur actif `0caa9267db60` (420986 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 231614 | 115051 | 15764 | 7752 | 23423 | 18141 | 24691 | 23851 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 226999 | 52879 | 95665 | 90 | 31623 | 11736 | 81 | 34907 | 15.4% |
...
- candidats SANS connectivite : 35217, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **24965 systemes avec CONNECTED sur 191650 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*54905 candidats sur 59195 portent les champs bruts (93%).*

- `5c556c16ea8b` — 48940 candidats
  - AVEC connectivite (19850) : resistance **41.2%**
  - SANS connectivite (29090) : resistance **21.3%**
...
- `5c556c16ea8b` — 48940 candidats
  ...
  - SANS connectivite (29090) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 189149 systemes
  - sans CONNECTED : 0.0% sur 42465 systemes
