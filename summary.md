...
genere 2026-09-07 05:07 UTC — 428843 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 345499 systemes
...
- moteur actif `0caa9267db60` (385101 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 213478 | 105997 | 14540 | 7110 | 21649 | 16773 | 22697 | 21994 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 209250 | 48713 | 88219 | 81 | 29172 | 10807 | 75 | 32165 | 15.4% |
...
- candidats AVEC connectivite : 22121, dont T2 : 100%
- candidats SANS connectivite : 32475, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **22971 systemes avec CONNECTED sur 176726 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*50306 candidats sur 54596 portent les champs bruts (92%).*

- `5c556c16ea8b` — 44341 candidats
  - AVEC connectivite (17993) : resistance **41.1%**
  - SANS connectivite (26348) : resistance **21.3%**
...
- `5c556c16ea8b` — 44341 candidats
  - AVEC connectivite (17993) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (26348) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 23056 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 22971 avec CONNECTED, 85 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 174225 systemes
  - sans CONNECTED : 0.0% sur 39253 systemes
