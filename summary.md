...
genere 2026-08-27 03:30 UTC — 78485 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 13578 systemes
...
- moteur actif `0caa9267db60` (34743 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 36573 | 18167 | 2526 | 1242 | 3637 | 2896 | 3881 | 3747 | 10.2% |
...
- candidats AVEC connectivite : 3874, dont T2 : 100%
- candidats SANS connectivite : 5765, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4155 systemes avec CONNECTED sur 32424 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5349 candidats sur 9639 portent les champs bruts (55%).*
...
- `ab89a63b01ef` — 1672 candidats
  - AVEC connectivite (694) : resistance **41.2%**
...
- `ab89a63b01ef` — 1672 candidats
  - AVEC connectivite (694) : T0=13.04 T1=0.00 T2=3.03 — pondere **6.07**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 29923 systemes
  - sans CONNECTED : 0.0% sur 6650 systemes
