...
genere 2026-09-04 00:46 UTC — 351983 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 268639 systemes
...
- moteur actif `0caa9267db60` (308241 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 174666 | 86825 | 11876 | 5841 | 17789 | 13744 | 18496 | 17870 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 171202 | 39786 | 72328 | 70 | 23775 | 8857 | 67 | 26305 | 15.4% |
...
- candidats AVEC connectivite : 17997, dont T2 : 100%
- candidats SANS connectivite : 26615, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18770 systemes avec CONNECTED sur 145018 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*40322 candidats sur 44612 portent les champs bruts (90%).*

- `5c556c16ea8b` — 34357 candidats
  - AVEC connectivite (13869) : resistance **41.0%**
  - SANS connectivite (20488) : resistance **21.3%**
...
- `5c556c16ea8b` — 34357 candidats
  - AVEC connectivite (13869) : T0=13.03 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (20488) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
## cout
- temps total 109.1 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 18847 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18770 avec CONNECTED, 77 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 142517 systemes
  - sans CONNECTED : 0.0% sur 32149 systemes
