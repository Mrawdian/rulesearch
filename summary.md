...
genere 2026-08-26 22:53 UTC — 68224 systemes evalues
...
- moteur actif `0caa9267db60` (24482 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 31384 | 15582 | 2150 | 1055 | 3123 | 2502 | 3351 | 3222 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 30725 | 7073 | 13062 | 18 | 4258 | 1597 | 14 | 4703 | 15.3% |
...
- candidats AVEC connectivite : 3349, dont T2 : 100%
- candidats SANS connectivite : 5013, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3625 systemes avec CONNECTED sur 28156 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4072 candidats sur 8362 portent les champs bruts (49%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 395 candidats
  - AVEC connectivite (169) : resistance **42.8%**
  - SANS connectivite (226) : resistance **21.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 395 candidats
  - AVEC connectivite (169) : T0=12.88 T1=0.00 T2=3.09 — pondere **6.18**
  - SANS connectivite (226) : T0=16.14 T1=0.00 T2=2.71 — pondere **5.42**
...
**6 serie(s) reproductible(s) sur 13 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `ab89a63b01ef` (p=0.0185), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
...
- TROP-CHER : 3649 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3625 avec CONNECTED, 24 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 25655 systemes
  - sans CONNECTED : 0.0% sur 5729 systemes
