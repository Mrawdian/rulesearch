...
genere 2026-08-26 12:27 UTC — 43914 systemes evalues
...
- `e40600351a72` : 172 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
- `6680f7b47e6f` : 124 systemes

Les lignes de dsl_hash differents ne sont pas comparables entre elles.

**7638 enregistrements (17%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 19099 | 9530 | 1250 | 663 | 1904 | 1517 | 2065 | 1934 | 10.1% |
...
- candidats AVEC connectivite : 2061, dont T2 : 100%
- candidats SANS connectivite : 3176, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2339 systemes avec CONNECTED sur 18095 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*947 candidats sur 5237 portent les champs bruts (18%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `e40600351a72` — 26 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (10) : resistance **38.8%**
...
- `e40600351a72` — 26 candidats
  - AVEC connectivite (10) : T0=14.90 T1=0.00 T2=3.00 — pondere **6.00**
...
- TROP-CHER : 2356 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2339 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 15594 systemes
  - sans CONNECTED : 0.0% sur 3505 systemes
