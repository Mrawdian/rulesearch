...
genere 2026-09-09 03:17 UTC — 470813 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 387469 systemes
...
- moteur actif `0caa9267db60` (427071 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 234679 | 116543 | 16002 | 7861 | 23758 | 18378 | 24986 | 24173 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 230019 | 53581 | 96917 | 92 | 32050 | 11884 | 82 | 35394 | 15.4% |
...
- candidats SANS connectivite : 35704, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25260 systemes avec CONNECTED sur 194109 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55714 candidats sur 60004 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49749 candidats
  - AVEC connectivite (20172) : resistance **41.2%**
  - SANS connectivite (29577) : resistance **21.3%**
...
- `5c556c16ea8b` — 49749 candidats
  ...
  - SANS connectivite (29577) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 25352 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25260 avec CONNECTED, 92 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 191608 systemes
  - sans CONNECTED : 0.0% sur 43071 systemes
