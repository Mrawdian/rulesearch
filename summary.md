...
genere 2026-08-27 08:27 UTC — 89248 systemes evalues
...
- moteur actif `0caa9267db60` (45506 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 42003 | 20916 | 2889 | 1420 | 4190 | 3302 | 4424 | 4317 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 41130 | 9476 | 17487 | 23 | 5699 | 2142 | 22 | 6281 | 15.3% |
...
- candidats AVEC connectivite : 4444, dont T2 : 100%
- candidats SANS connectivite : 6591, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4698 systemes avec CONNECTED sur 36829 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6745 candidats sur 11035 portent les champs bruts (61%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 780 candidats
  - AVEC connectivite (316) : resistance **41.3%**
  - SANS connectivite (464) : resistance **21.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 780 candidats
  - AVEC connectivite (316) : T0=13.09 T1=0.00 T2=3.02 — pondere **6.04**
  - SANS connectivite (464) : T0=15.89 T1=0.00 T2=2.63 — pondere **5.27**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e3baecf8377b` — 657 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 34328 systemes
  - sans CONNECTED : 0.0% sur 7675 systemes
