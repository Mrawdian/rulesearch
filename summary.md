...
genere 2026-08-26 15:02 UTC — 50286 systemes evalues
...
- moteur actif `0caa9267db60` (6544 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22325 | 11129 | 1500 | 764 | 2221 | 1771 | 2389 | 2271 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 21846 | 5073 | 9211 | 13 | 3052 | 1120 | 10 | 3367 | 15.4% |
...
- candidats AVEC connectivite : 2398, dont T2 : 100%
- candidats SANS connectivite : 3677, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2663 systemes avec CONNECTED sur 20727 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1785 candidats sur 6075 portent les champs bruts (29%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 670 candidats
  - AVEC connectivite (260) : resistance **41.0%**
  - SANS connectivite (410) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 670 candidats
  - AVEC connectivite (260) : T0=13.32 T1=0.00 T2=3.02 — pondere **6.03**
  - SANS connectivite (410) : T0=16.01 T1=0.00 T2=2.65 — pondere **5.30**
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0025).
...
- TROP-CHER : 2683 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2663 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18226 systemes
  - sans CONNECTED : 0.0% sur 4099 systemes
