...
genere 2026-08-27 15:21 UTC — 103171 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 19827 systemes
...
- moteur actif `0caa9267db60` (59429 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 49023 | 24418 | 3382 | 1680 | 4870 | 3880 | 5173 | 4985 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 48033 | 11102 | 20401 | 25 | 6644 | 2512 | 23 | 7325 | 15.2% |
...
- candidats AVEC connectivite : 5112, dont T2 : 100%
- candidats SANS connectivite : 7635, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5447 systemes avec CONNECTED sur 42557 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*8457 candidats sur 12747 portent les champs bruts (66%).*
...
- `5c556c16ea8b` — 2492 candidats
  - AVEC connectivite (984) : resistance **41.8%**
...
- `5c556c16ea8b` — 2492 candidats
  - AVEC connectivite (984) : T0=13.02 T1=0.00 T2=3.04 — pondere **6.08**
...
- TROP-CHER : 5480 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 5447 avec CONNECTED, 33 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 40056 systemes
  - sans CONNECTED : 0.0% sur 8967 systemes
