...
genere 2026-08-26 15:55 UTC — 52424 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 7241 systemes
...
- moteur actif `0caa9267db60` (8682 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23401 | 11660 | 1584 | 800 | 2336 | 1854 | 2499 | 2372 | 10.1% |
...
- candidats AVEC connectivite : 2499, dont T2 : 100%
- candidats SANS connectivite : 3844, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2773 systemes avec CONNECTED sur 21600 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2053 candidats sur 6343 portent les champs bruts (32%).*
...
- `06fe04a859f1` — 938 candidats
  - AVEC connectivite (361) : resistance **41.4%**
...
- `06fe04a859f1` — 938 candidats
  - AVEC connectivite (361) : T0=13.22 T1=0.00 T2=3.04 — pondere **6.08**
...
- TROP-CHER : 2793 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2773 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19099 systemes
  - sans CONNECTED : 0.0% sur 4302 systemes
