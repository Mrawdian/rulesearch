...
genere 2026-08-26 18:53 UTC — 59496 systemes evalues
...
- moteur actif `0caa9267db60` (15754 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 26972 | 13460 | 1836 | 908 | 2675 | 2133 | 2866 | 2758 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 26409 | 6098 | 11181 | 15 | 3678 | 1363 | 10 | 4064 | 15.4% |
...
- candidats AVEC connectivite : 2885, dont T2 : 100%
- candidats SANS connectivite : 4374, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3140 systemes avec CONNECTED sur 24563 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2969 candidats sur 7259 portent les champs bruts (41%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 100 candidats
  - AVEC connectivite (41) : resistance **44.0%**
  - SANS connectivite (59) : resistance **16.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 100 candidats
  - AVEC connectivite (41) : T0=13.15 T1=0.00 T2=3.12 — pondere **6.24**
  - SANS connectivite (59) : T0=16.20 T1=0.00 T2=2.41 — pondere **4.81**
...
**6 serie(s) reproductible(s) sur 12 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0060), `62448a55927e` (p=0.0190), `b71bb0907fb5` (p=0.0110).
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22062 systemes
  - sans CONNECTED : 0.0% sur 4910 systemes
