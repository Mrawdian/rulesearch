...
genere 2026-09-09 00:12 UTC — 468002 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 384658 systemes
...
- moteur actif `0caa9267db60` (424260 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 233261 | 115850 | 15894 | 7808 | 23611 | 18268 | 24850 | 24022 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 228626 | 53244 | 96330 | 92 | 31857 | 11809 | 82 | 35193 | 15.4% |
...
- candidats AVEC connectivite : 24149, dont T2 : 100%
- candidats SANS connectivite : 35503, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25124 systemes avec CONNECTED sur 192961 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55362 candidats sur 59652 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49397 candidats
  - AVEC connectivite (20021) : resistance **41.2%**
  - SANS connectivite (29376) : resistance **21.3%**
...
- `5c556c16ea8b` — 49397 candidats
  - AVEC connectivite (20021) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (29376) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 25216 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25124 avec CONNECTED, 92 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 190460 systemes
  - sans CONNECTED : 0.0% sur 42801 systemes
