...
genere 2026-09-04 08:06 UTC — 359852 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 276508 systemes
...
- moteur actif `0caa9267db60` (316110 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 178639 | 88785 | 12136 | 5973 | 18176 | 14075 | 18927 | 18293 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 175098 | 40685 | 73965 | 71 | 24310 | 9077 | 70 | 26906 | 15.4% |
...
- candidats AVEC connectivite : 18420, dont T2 : 100%
- candidats SANS connectivite : 27216, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19201 systemes avec CONNECTED sur 148257 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*41346 candidats sur 45636 portent les champs bruts (91%).*

- `5c556c16ea8b` — 35381 candidats
  - AVEC connectivite (14292) : resistance **41.1%**
  - SANS connectivite (21089) : resistance **21.3%**
...
- `5c556c16ea8b` — 35381 candidats
  - AVEC connectivite (14292) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (21089) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 145756 systemes
  - sans CONNECTED : 0.0% sur 32883 systemes
