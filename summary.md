...
genere 2026-09-08 00:03 UTC — 446211 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 362867 systemes
...
- moteur actif `0caa9267db60` (402469 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 222265 | 110379 | 15149 | 7422 | 22505 | 17403 | 23676 | 22896 | 10.3% |
...
- candidats AVEC connectivite : 23023, dont T2 : 100%
...
- **23950 systemes avec CONNECTED sur 184001 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*52499 candidats sur 56789 portent les champs bruts (92%).*

- `5c556c16ea8b` — 46534 candidats
  - AVEC connectivite (18895) : resistance **41.2%**
...
- `5c556c16ea8b` — 46534 candidats
  - AVEC connectivite (18895) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 24038 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23950 avec CONNECTED, 88 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 181500 systemes
  - sans CONNECTED : 0.0% sur 40765 systemes
