...
genere 2026-08-27 11:05 UTC — 94761 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 18378 systemes
- `5c556c16ea8b` : 11417 systemes
...
- moteur actif `0caa9267db60` (51019 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 44782 | 22327 | 3074 | 1520 | 4459 | 3541 | 4708 | 4572 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 43864 | 10113 | 18620 | 25 | 6096 | 2277 | 22 | 6710 | 15.3% |
...
- candidats AVEC connectivite : 4699, dont T2 : 100%
- candidats SANS connectivite : 7020, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4982 systemes avec CONNECTED sur 39080 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*7429 candidats sur 11719 portent les champs bruts (63%).*
...
- `ab89a63b01ef` — 2280 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 1464 candidats
  - AVEC connectivite (571) : resistance **41.5%**
...
- `ab89a63b01ef` — 2280 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 1464 candidats
  - AVEC connectivite (571) : T0=13.06 T1=0.00 T2=3.02 — pondere **6.04**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 36579 systemes
  - sans CONNECTED : 0.0% sur 8203 systemes
