...
genere 2026-08-27 20:43 UTC — 113389 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 30045 systemes
...
- moteur actif `0caa9267db60` (69647 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 54182 | 26983 | 3746 | 1839 | 5346 | 4286 | 5737 | 5537 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 53092 | 12252 | 22566 | 26 | 7345 | 2759 | 25 | 8117 | 15.3% |
...
- candidats AVEC connectivite : 5664, dont T2 : 100%
- candidats SANS connectivite : 8427, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6011 systemes avec CONNECTED sur 46783 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*9801 candidats sur 14091 portent les champs bruts (70%).*

- `5c556c16ea8b` — 3836 candidats
  - AVEC connectivite (1536) : resistance **41.9%**
  - SANS connectivite (2300) : resistance **22.4%**
...
- `5c556c16ea8b` — 3836 candidats
  - AVEC connectivite (1536) : T0=12.94 T1=0.00 T2=3.05 — pondere **6.10**
  - SANS connectivite (2300) : T0=15.77 T1=0.00 T2=2.70 — pondere **5.40**
...
- TROP-CHER : 6046 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6011 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 44282 systemes
  - sans CONNECTED : 0.0% sur 9900 systemes
