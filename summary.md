...
genere 2026-09-01 11:07 UTC — 280875 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 197531 systemes
...
- moteur actif `0caa9267db60` (237133 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 138766 | 68979 | 9387 | 4641 | 14097 | 10939 | 14651 | 14273 | 10.3% |
...
- candidats AVEC connectivite : 14400, dont T2 : 100%
...
- **14925 systemes avec CONNECTED sur 115724 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*31232 candidats sur 35522 portent les champs bruts (88%).*

- `5c556c16ea8b` — 25267 candidats
  - AVEC connectivite (10272) : resistance **41.0%**
...
- `5c556c16ea8b` — 25267 candidats
  - AVEC connectivite (10272) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 113223 systemes
  - sans CONNECTED : 0.0% sur 25543 systemes
