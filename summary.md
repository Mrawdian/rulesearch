...
genere 2026-08-31 19:39 UTC — 261329 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 177985 systemes
...
- moteur actif `0caa9267db60` (217587 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 128921 | 64082 | 8717 | 4322 | 13060 | 10191 | 13587 | 13280 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 126293 | 29428 | 53324 | 56 | 17510 | 6528 | 56 | 19381 | 15.3% |
...
- candidats SANS connectivite : 19691, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13861 systemes avec CONNECTED sur 107677 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*28808 candidats sur 33098 portent les champs bruts (87%).*

- `5c556c16ea8b` — 22843 candidats
  - AVEC connectivite (9279) : resistance **41.1%**
  - SANS connectivite (13564) : resistance **21.4%**
...
- `5c556c16ea8b` — 22843 candidats
  ...
  - SANS connectivite (13564) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 105176 systemes
  - sans CONNECTED : 0.0% sur 23745 systemes
