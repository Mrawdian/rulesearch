...
genere 2026-08-26 18:25 UTC — 58236 systemes evalues
...
- `8f22f0d2d442` : 135 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (14494 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 25778 | 5926 | 10928 | 15 | 3597 | 1325 | 10 | 3977 | 15.4% |
...
- candidats SANS connectivite : 4287, dont T2 : 100%
...
*2827 candidats sur 7117 portent les champs bruts (40%).*
...
- `84fba70921e0` — 33 candidats
  ...
  - *groupes trop petits (< 20) — aucun test*
- `8f22f0d2d442` — 23 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (7) : resistance **32.0%**
  - SANS connectivite (16) : resistance **18.7%**
  - *groupes trop petits (< 20) — aucun test*
...
- `84fba70921e0` — 33 candidats
  ...
  - *groupes trop petits (< 20) — aucun test, aucune conclusion*
- `8f22f0d2d442` — 23 candidats
  - AVEC connectivite (7) : T0=14.71 T1=0.00 T2=2.43 — pondere **4.86**
  - SANS connectivite (16) : T0=15.94 T1=0.00 T2=2.69 — pondere **5.38**
  - *groupes trop petits (< 20) — aucun test, aucune conclusion*
