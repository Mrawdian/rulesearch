...
genere 2026-08-26 16:10 UTC — 53015 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 7832 systemes
...
- moteur actif `0caa9267db60` (9273 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23699 | 11816 | 1609 | 809 | 2358 | 1877 | 2532 | 2401 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 23201 | 5369 | 9799 | 14 | 3244 | 1181 | 10 | 3584 | 15.4% |
...
- candidats AVEC connectivite : 2528, dont T2 : 100%
- candidats SANS connectivite : 3894, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2806 systemes avec CONNECTED sur 21850 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2132 candidats sur 6422 portent les champs bruts (33%).*
...
- `06fe04a859f1` — 1017 candidats
  - AVEC connectivite (390) : resistance **41.2%**
  - SANS connectivite (627) : resistance **20.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1017 candidats
  - AVEC connectivite (390) : T0=13.18 T1=0.00 T2=3.04 — pondere **6.07**
  - SANS connectivite (627) : T0=15.98 T1=0.00 T2=2.63 — pondere **5.25**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
...
- TROP-CHER : 2826 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2806 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19349 systemes
  - sans CONNECTED : 0.0% sur 4350 systemes
