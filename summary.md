...
genere 2026-08-27 22:18 UTC — 116562 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 33218 systemes
...
- moteur actif `0caa9267db60` (72820 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 55784 | 27790 | 3855 | 1891 | 5524 | 4419 | 5893 | 5691 | 10.2% |
...
- candidats AVEC connectivite : 5818, dont T2 : 100%
- candidats SANS connectivite : 8685, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6167 systemes avec CONNECTED sur 48076 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10213 candidats sur 14503 portent les champs bruts (70%).*

- `5c556c16ea8b` — 4248 candidats
  - AVEC connectivite (1690) : resistance **41.9%**
...
- `5c556c16ea8b` — 4248 candidats
  - AVEC connectivite (1690) : T0=12.95 T1=0.00 T2=3.05 — pondere **6.10**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 45575 systemes
