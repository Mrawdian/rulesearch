...
genere 2026-09-03 23:19 UTC — 350359 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 267015 systemes
...
- moteur actif `0caa9267db60` (306617 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 173846 | 86428 | 11805 | 5817 | 17700 | 13688 | 18417 | 17777 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 170398 | 39613 | 71997 | 70 | 23660 | 8819 | 66 | 26159 | 15.4% |
...
- candidats SANS connectivite : 26469, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18691 systemes avec CONNECTED sur 144351 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*40083 candidats sur 44373 portent les champs bruts (90%).*

- `5c556c16ea8b` — 34118 candidats
  - AVEC connectivite (13776) : resistance **41.1%**
  - SANS connectivite (20342) : resistance **21.2%**
...
- `5c556c16ea8b` — 34118 candidats
  ...
  - SANS connectivite (20342) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 18767 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18691 avec CONNECTED, 76 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 141850 systemes
