...
| connect | 4 | 3 | 17080 | 8540 | 1099 | 589 | 1697 | 1359 | 1861 | 1720 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 16718 | 3936 | 7086 | 11 | 2275 | 844 | 7 | 2559 | 15.3% |
...
- candidats SANS connectivite : 2869, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2135 systemes avec CONNECTED sur 16457 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*426 candidats sur 4716 portent les champs bruts (9%).*
...
- `e3baecf8377b` — 162 candidats
  - AVEC connectivite (64) : resistance **42.0%**
  - SANS connectivite (98) : resistance **20.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 162 candidats
  ...
  - SANS connectivite (98) : T0=15.93 T1=0.00 T2=2.59 — pondere **5.18**
...
**2 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0390).
...
- TROP-CHER : 2152 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2135 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 13956 systemes
  - sans CONNECTED : 0.0% sur 3124 systemes
