...
genere 2026-08-26 22:24 UTC — 67156 systemes evalues
...
- moteur actif `0caa9267db60` (23414 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 30845 | 15316 | 2113 | 1037 | 3070 | 2458 | 3292 | 3167 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 30196 | 6955 | 12826 | 18 | 4179 | 1569 | 14 | 4635 | 15.3% |
...
- candidats SANS connectivite : 4945, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3566 systemes avec CONNECTED sur 27716 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3949 candidats sur 8239 portent les champs bruts (48%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 272 candidats
  - AVEC connectivite (114) : resistance **44.0%**
  - SANS connectivite (158) : resistance **22.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 272 candidats
  ...
  - SANS connectivite (158) : T0=15.99 T1=0.00 T2=2.77 — pondere **5.54**
...
- TROP-CHER : 3590 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3566 avec CONNECTED, 24 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 25215 systemes
  - sans CONNECTED : 0.0% sur 5630 systemes
