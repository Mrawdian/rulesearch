...
genere 2026-08-30 05:21 UTC — 208364 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 125020 systemes
...
- moteur actif `0caa9267db60` (164622 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 102169 | 50729 | 6953 | 3421 | 10316 | 8149 | 10771 | 10498 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 100080 | 23307 | 42290 | 45 | 13820 | 5169 | 38 | 15404 | 15.4% |
...
- candidats AVEC connectivite : 10625, dont T2 : 100%
- candidats SANS connectivite : 15714, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11045 systemes avec CONNECTED sur 85823 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*22049 candidats sur 26339 portent les champs bruts (84%).*

- `5c556c16ea8b` — 16084 candidats
  - AVEC connectivite (6497) : resistance **41.1%**
  - SANS connectivite (9587) : resistance **21.5%**
...
- `5c556c16ea8b` — 16084 candidats
  - AVEC connectivite (6497) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (9587) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.32**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 83322 systemes
  - sans CONNECTED : 0.0% sur 18847 systemes
