...
genere 2026-08-26 17:44 UTC — 56593 systemes evalues
...
- moteur actif `0caa9267db60` (12851 systemes) : `06fe04a859f1`, `23303c299f39`, `b71bb0907fb5`, `e40600351a72`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 25505 | 12726 | 1734 | 859 | 2526 | 2010 | 2729 | 2607 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 24973 | 5764 | 10575 | 15 | 3494 | 1266 | 10 | 3849 | 15.4% |
...
- candidats AVEC connectivite : 2734, dont T2 : 100%
- candidats SANS connectivite : 4159, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3003 systemes avec CONNECTED sur 23357 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2603 candidats sur 6893 portent les champs bruts (38%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `b71bb0907fb5` — 40 candidats
  - AVEC connectivite (18) : resistance **41.4%**
  - SANS connectivite (22) : resistance **15.6%**
...
- `b71bb0907fb5` — 40 candidats
  - AVEC connectivite (18) : T0=12.39 T1=0.00 T2=3.11 — pondere **6.22**
  - SANS connectivite (22) : T0=16.00 T1=0.00 T2=2.00 — pondere **4.00**
  - *groupes trop petits (< 20) — aucun test, aucune conclusion*
- `e8a1f930f7b9` — 28 candidats
...
- TROP-CHER : 3023 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3003 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 20856 systemes
  - sans CONNECTED : 0.0% sur 4649 systemes
