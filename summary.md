...
genere 2026-08-26 14:24 UTC — 48835 systemes evalues
...
- moteur actif `0caa9267db60` (5093 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21591 | 10775 | 1437 | 744 | 2137 | 1716 | 2308 | 2201 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 21129 | 4921 | 8923 | 13 | 2925 | 1091 | 8 | 3248 | 15.4% |
...
- candidats AVEC connectivite : 2328, dont T2 : 100%
- candidats SANS connectivite : 3558, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2582 systemes avec CONNECTED sur 20146 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1596 candidats sur 5886 portent les champs bruts (27%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 481 candidats
  - AVEC connectivite (190) : resistance **40.0%**
  - SANS connectivite (291) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 481 candidats
  - AVEC connectivite (190) : T0=13.36 T1=0.00 T2=2.96 — pondere **5.93**
  - SANS connectivite (291) : T0=16.09 T1=0.00 T2=2.67 — pondere **5.34**
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0440).
...
- TROP-CHER : 2600 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2582 avec CONNECTED, 18 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17645 systemes
  - sans CONNECTED : 0.0% sur 3946 systemes
