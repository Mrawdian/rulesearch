...
genere 2026-08-26 02:19 UTC — 18017 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 9043 systemes
...
| connect | 4 | 3 | 9044 | 4555 | 587 | 300 | 869 | 716 | 979 | 927 | 10.2% |
| ref | 4 | 3 | 8849 | 2132 | 3716 | 2 | 1180 | 439 | 3 | 1377 | 15.6% |
...
- candidats AVEC connectivite : 930, dont T2 : 100%
- candidats SANS connectivite : 1381, dont T2 : 100%
...
- **979 systemes avec CONNECTED sur 7492 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1146 candidats
  - AVEC connectivite (451) : T0=13.37 T1=0.00 T2=2.90 — pondere **5.79**
  - SANS connectivite (695) : T0=15.85 T1=0.00 T2=2.66 — pondere **5.32**
...
## cout
- temps total 5.7 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 982 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 979 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 7435 systemes
  - sans CONNECTED : 0.0% sur 1609 systemes
