...
genere 2026-08-26 18:25 UTC — 58281 systemes evalues
...
- `8f22f0d2d442` : 180 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (14539 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 26358 | 13136 | 1792 | 892 | 2615 | 2081 | 2811 | 2705 | 10.3% |
...
- candidats AVEC connectivite : 2832, dont T2 : 100%
- candidats SANS connectivite : 4293, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3085 systemes avec CONNECTED sur 24058 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2835 candidats sur 7125 portent les champs bruts (40%).*
...
- `84fba70921e0` — 33 candidats
  ...
  - *groupes trop petits (< 20) — aucun test*
- `8f22f0d2d442` — 31 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (9) : resistance **33.2%**
...
- `84fba70921e0` — 33 candidats
  ...
  - *groupes trop petits (< 20) — aucun test, aucune conclusion*
- `8f22f0d2d442` — 31 candidats
  - AVEC connectivite (9) : T0=14.11 T1=0.00 T2=2.44 — pondere **4.89**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 21557 systemes
  - sans CONNECTED : 0.0% sur 4801 systemes
