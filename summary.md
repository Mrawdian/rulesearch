...
genere 2026-08-26 21:12 UTC — 64446 systemes evalues
...
- moteur actif `0caa9267db60` (20704 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 29486 | 14660 | 2015 | 988 | 2940 | 2332 | 3151 | 3025 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 28845 | 6652 | 12241 | 16 | 4006 | 1487 | 12 | 4431 | 15.4% |
...
- candidats AVEC connectivite : 3152, dont T2 : 100%
- candidats SANS connectivite : 4741, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3425 systemes avec CONNECTED sur 26622 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3603 candidats sur 7893 portent les champs bruts (46%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 734 candidats
  - AVEC connectivite (308) : resistance **40.0%**
  - SANS connectivite (426) : resistance **20.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 734 candidats
  - AVEC connectivite (308) : T0=12.86 T1=0.00 T2=2.84 — pondere **5.69**
  - SANS connectivite (426) : T0=16.18 T1=0.00 T2=2.68 — pondere **5.36**
...
- TROP-CHER : 3447 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3425 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 24121 systemes
  - sans CONNECTED : 0.0% sur 5365 systemes
