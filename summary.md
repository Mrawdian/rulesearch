...
**7466 enregistrements (65%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 5785 | 2910 | 370 | 210 | 556 | 471 | 601 | 598 | 10.3% |
| ref | 4 | 3 | 5655 | 1371 | 2359 | 1 | 752 | 276 | 2 | 894 | 15.8% |
...
- candidats AVEC connectivite : 601, dont T2 : 100%
- candidats SANS connectivite : 898, dont T2 : 100%
...
- **601 systemes avec CONNECTED sur 4794 (12.5%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 334 candidats
  - AVEC connectivite (122) : T0=13.12 T1=0.00 T2=2.78 — pondere **5.56**
  - SANS connectivite (212) : T0=15.99 T1=0.00 T2=2.68 — pondere **5.36**
  - test de permutation : **p = 0.5777** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 603 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 601 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 4737 systemes
  - sans CONNECTED : 0.0% sur 1048 systemes
