...
genere 2026-08-31 02:14 UTC — 237662 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 154318 systemes
...
- moteur actif `0caa9267db60` (193920 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 116968 | 58169 | 7943 | 3932 | 11760 | 9218 | 12398 | 12022 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 114579 | 26741 | 48416 | 53 | 15811 | 5923 | 51 | 17574 | 15.3% |
...
- candidats AVEC connectivite : 12149, dont T2 : 100%
- candidats SANS connectivite : 17884, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12672 systemes avec CONNECTED sur 98019 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*25743 candidats sur 30033 portent les champs bruts (86%).*

- `5c556c16ea8b` — 19778 candidats
  - AVEC connectivite (8021) : resistance **41.0%**
  - SANS connectivite (11757) : resistance **21.4%**
...
- `5c556c16ea8b` — 19778 candidats
  - AVEC connectivite (8021) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.97**
  - SANS connectivite (11757) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 12733 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 12672 avec CONNECTED, 61 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 95518 systemes
  - sans CONNECTED : 0.0% sur 21450 systemes
