...
genere 2026-08-26 22:04 UTC — 66476 systemes evalues
...
- moteur actif `0caa9267db60` (22734 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 30503 | 15154 | 2086 | 1024 | 3048 | 2425 | 3250 | 3131 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 29858 | 6884 | 12692 | 17 | 4123 | 1541 | 13 | 4588 | 15.4% |
...
- candidats SANS connectivite : 4898, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3524 systemes avec CONNECTED sur 27435 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3866 candidats sur 8156 portent les champs bruts (47%).*
...
- `23303c299f39` — 225 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 189 candidats
  - AVEC connectivite (78) : resistance **42.9%**
  - SANS connectivite (111) : resistance **22.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 189 candidats
  ...
  - SANS connectivite (111) : T0=15.84 T1=0.00 T2=2.79 — pondere **5.59**
  - test de permutation : **p = 0.3533** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
- TROP-CHER : 3547 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3524 avec CONNECTED, 23 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24934 systemes
  - sans CONNECTED : 0.0% sur 5569 systemes
