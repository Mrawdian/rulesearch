...
genere 2026-08-28 06:55 UTC — 132919 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 49575 systemes
...
- moteur actif `0caa9267db60` (89177 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 64047 | 31828 | 4399 | 2172 | 6420 | 5096 | 6726 | 6585 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 62757 | 14509 | 26585 | 29 | 8734 | 3243 | 28 | 9627 | 15.3% |
...
- candidats AVEC connectivite : 6712, dont T2 : 100%
- candidats SANS connectivite : 9937, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7000 systemes avec CONNECTED sur 54740 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12359 candidats sur 16649 portent les champs bruts (74%).*

- `5c556c16ea8b` — 6394 candidats
  - AVEC connectivite (2584) : resistance **41.4%**
  - SANS connectivite (3810) : resistance **21.9%**
...
- `5c556c16ea8b` — 6394 candidats
  - AVEC connectivite (2584) : T0=12.98 T1=0.00 T2=3.02 — pondere **6.03**
  - SANS connectivite (3810) : T0=15.86 T1=0.00 T2=2.68 — pondere **5.37**
...
- TROP-CHER : 7038 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7000 avec CONNECTED, 38 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 52239 systemes
  - sans CONNECTED : 0.0% sur 11808 systemes
