...
genere 2026-08-26 19:19 UTC — 60424 systemes evalues
...
- moteur actif `0caa9267db60` (16682 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27450 | 13690 | 1873 | 926 | 2713 | 2174 | 2918 | 2812 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 26859 | 6207 | 11363 | 15 | 3743 | 1381 | 10 | 4140 | 15.4% |
...
- candidats AVEC connectivite : 2939, dont T2 : 100%
- candidats SANS connectivite : 4450, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3192 systemes avec CONNECTED sur 24964 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3099 candidats sur 7389 portent les champs bruts (42%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 230 candidats
  - AVEC connectivite (95) : resistance **39.0%**
  - SANS connectivite (135) : resistance **18.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 230 candidats
  - AVEC connectivite (95) : T0=13.14 T1=0.00 T2=2.88 — pondere **5.77**
  - SANS connectivite (135) : T0=16.17 T1=0.00 T2=2.61 — pondere **5.21**
...
- TROP-CHER : 3212 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3192 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22463 systemes
  - sans CONNECTED : 0.0% sur 4987 systemes
