...
genere 2026-08-29 11:46 UTC — 181629 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 98285 systemes
...
- moteur actif `0caa9267db60` (137887 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 88653 | 44058 | 6032 | 3000 | 8918 | 7075 | 9319 | 9122 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 86861 | 20293 | 36688 | 42 | 11993 | 4447 | 35 | 13357 | 15.4% |
...
- candidats AVEC connectivite : 9249, dont T2 : 100%
- candidats SANS connectivite : 13667, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9593 systemes avec CONNECTED sur 74814 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*18626 candidats sur 22916 portent les champs bruts (81%).*

- `5c556c16ea8b` — 12661 candidats
  - AVEC connectivite (5121) : resistance **41.2%**
  - SANS connectivite (7540) : resistance **21.5%**
...
- `5c556c16ea8b` — 12661 candidats
  - AVEC connectivite (5121) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (7540) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 9638 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 9593 avec CONNECTED, 45 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 72313 systemes
  - sans CONNECTED : 0.0% sur 16340 systemes
