...
genere 2026-09-05 02:41 UTC — 379353 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 296009 systemes
...
- moteur actif `0caa9267db60` (335611 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 188477 | 93596 | 12837 | 6296 | 19166 | 14854 | 19980 | 19330 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 184761 | 42982 | 78045 | 77 | 25657 | 9557 | 70 | 28359 | 15.3% |
...
- candidats AVEC connectivite : 19457, dont T2 : 100%
- candidats SANS connectivite : 28669, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20254 systemes avec CONNECTED sur 156252 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*43836 candidats sur 48126 portent les champs bruts (91%).*

- `5c556c16ea8b` — 37871 candidats
  - AVEC connectivite (15329) : resistance **41.1%**
  - SANS connectivite (22542) : resistance **21.2%**
...
- `5c556c16ea8b` — 37871 candidats
  - AVEC connectivite (15329) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (22542) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
## cout
- temps total 117.8 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 20334 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 20254 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 153751 systemes
  - sans CONNECTED : 0.0% sur 34726 systemes
