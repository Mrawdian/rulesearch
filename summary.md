...
- moteur actif `0caa9267db60` (8125 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23117 | 11521 | 1561 | 785 | 2302 | 1840 | 2470 | 2348 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 22635 | 5238 | 9552 | 14 | 3174 | 1155 | 10 | 3492 | 15.4% |
...
- candidats AVEC connectivite : 2475, dont T2 : 100%
- candidats SANS connectivite : 3802, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2744 systemes avec CONNECTED sur 21369 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1987 candidats sur 6277 portent les champs bruts (32%).*
...
- `06fe04a859f1` — 872 candidats
  - AVEC connectivite (337) : resistance **41.1%**
  - SANS connectivite (535) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 872 candidats
  - AVEC connectivite (337) : T0=13.24 T1=0.00 T2=3.02 — pondere **6.04**
  - SANS connectivite (535) : T0=16.03 T1=0.00 T2=2.64 — pondere **5.29**
...
- TROP-CHER : 2764 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2744 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18868 systemes
  - sans CONNECTED : 0.0% sur 4249 systemes
