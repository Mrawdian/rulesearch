...
genere 2026-08-26 18:02 UTC — 57349 systemes evalues
...
- moteur actif `0caa9267db60` (13607 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `84fba70921e0`, `b71bb0907fb5`, `e40600351a72`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 25894 | 12896 | 1766 | 876 | 2566 | 2047 | 2766 | 2657 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 25340 | 5840 | 10734 | 15 | 3536 | 1289 | 10 | 3916 | 15.5% |
...
- candidats AVEC connectivite : 2784, dont T2 : 100%
- candidats SANS connectivite : 4226, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3040 systemes avec CONNECTED sur 23672 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2720 candidats sur 7010 portent les champs bruts (39%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `0a74109317e5` — 71 candidats
  - AVEC connectivite (35) : resistance **37.1%**
  - SANS connectivite (36) : resistance **20.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `0a74109317e5` — 71 candidats
  - AVEC connectivite (35) : T0=14.23 T1=0.00 T2=2.71 — pondere **5.43**
  - SANS connectivite (36) : T0=15.78 T1=0.00 T2=2.53 — pondere **5.06**
  - test de permutation : **p = 0.6527** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `b71bb0907fb5` — 53 candidats
...
## cout
- temps total 17.8 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 3060 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3040 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 21171 systemes
  - sans CONNECTED : 0.0% sur 4723 systemes
