...
genere 2026-08-26 21:39 UTC — 65543 systemes evalues
...
- `ab89a63b01ef` : 636 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (21801 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
**8162 enregistrements (12%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 30039 | 14925 | 2051 | 1011 | 3010 | 2377 | 3202 | 3083 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 29389 | 6779 | 12481 | 16 | 4070 | 1517 | 12 | 4514 | 15.4% |
...
- candidats AVEC connectivite : 3210, dont T2 : 100%
- candidats SANS connectivite : 4824, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3476 systemes avec CONNECTED sur 27056 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3744 candidats sur 8034 portent les champs bruts (47%).*
...
- `e80bc1b2b437` — 75 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 67 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (30) : resistance **44.0%**
  - SANS connectivite (37) : resistance **21.1%**
...
- `ab89a63b01ef` — 67 candidats
  - AVEC connectivite (30) : T0=14.43 T1=0.00 T2=3.10 — pondere **6.20**
  - SANS connectivite (37) : T0=16.49 T1=0.00 T2=2.89 — pondere **5.78**
  - test de permutation : **p = 0.6467** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `0a74109317e5` — 80 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24555 systemes
  - sans CONNECTED : 0.0% sur 5484 systemes
