...
genere 2026-09-07 07:46 UTC — 431267 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 347923 systemes
...
- moteur actif `0caa9267db60` (387525 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 214703 | 106627 | 14620 | 7157 | 21755 | 16853 | 22838 | 22121 | 10.3% |
...
- candidats AVEC connectivite : 22248, dont T2 : 100%
...
- **23112 systemes avec CONNECTED sur 177759 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*50619 candidats sur 54909 portent les champs bruts (92%).*

- `5c556c16ea8b` — 44654 candidats
  - AVEC connectivite (18120) : resistance **41.1%**
...
- `5c556c16ea8b` — 44654 candidats
  - AVEC connectivite (18120) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 23198 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23112 avec CONNECTED, 86 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 175258 systemes
  - sans CONNECTED : 0.0% sur 39445 systemes
