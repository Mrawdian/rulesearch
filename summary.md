...
| connect | 4 | 3 | 5337 | 2678 | 340 | 191 | 520 | 437 | 559 | 553 | 10.4% |
| ref | 4 | 3 | 5205 | 1258 | 2180 | 1 | 685 | 251 | 2 | 828 | 15.9% |
...
- candidats AVEC connectivite : 556, dont T2 : 100%
- candidats SANS connectivite : 832, dont T2 : 100%
...
- **559 systemes avec CONNECTED sur 4416 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 223 candidats
  - AVEC connectivite (77) : T0=13.23 T1=0.00 T2=2.77 — pondere **5.53**
  - SANS connectivite (146) : T0=15.88 T1=0.00 T2=2.70 — pondere **5.40**
...
- TROP-CHER : 561 systemes abandonnes (5.3% des systemes), 96% du temps total
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 4359 systemes
  - sans CONNECTED : 0.0% sur 978 systemes
