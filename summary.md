...
genere 2026-08-26 19:16 UTC — 60337 systemes evalues
...
- moteur actif `0caa9267db60` (16595 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27405 | 13670 | 1868 | 925 | 2709 | 2172 | 2911 | 2807 | 10.2% |
...
- candidats AVEC connectivite : 2934, dont T2 : 100%
- candidats SANS connectivite : 4440, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3185 systemes avec CONNECTED sur 24924 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3084 candidats sur 7374 portent les champs bruts (42%).*
...
- `23303c299f39` — 225 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 215 candidats
  - AVEC connectivite (90) : resistance **39.8%**
...
- `62448a55927e` — 215 candidats
  - AVEC connectivite (90) : T0=13.10 T1=0.00 T2=2.94 — pondere **5.89**
...
- TROP-CHER : 3205 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3185 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22423 systemes
  - sans CONNECTED : 0.0% sur 4982 systemes
