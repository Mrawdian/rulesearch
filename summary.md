...
genere 2026-09-01 20:42 UTC — 292471 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 209127 systemes
...
- moteur actif `0caa9267db60` (248729 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 144620 | 71829 | 9830 | 4841 | 14687 | 11395 | 15298 | 14872 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 141736 | 32942 | 59957 | 59 | 19652 | 7325 | 63 | 21727 | 15.3% |
...
- candidats SANS connectivite : 22037, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15572 systemes avec CONNECTED sur 120522 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*32746 candidats sur 37036 portent les champs bruts (88%).*

- `5c556c16ea8b` — 26781 candidats
  - AVEC connectivite (10871) : resistance **41.0%**
  - SANS connectivite (15910) : resistance **21.3%**
...
- `5c556c16ea8b` — 26781 candidats
  ...
  - SANS connectivite (15910) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 15645 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15572 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 118021 systemes
