...
genere 2026-09-06 07:33 UTC — 408179 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 324835 systemes
...
- moteur actif `0caa9267db60` (364437 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 203038 | 100816 | 13857 | 6753 | 20588 | 15949 | 21572 | 20918 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 199026 | 46268 | 83994 | 78 | 27719 | 10289 | 73 | 30588 | 15.4% |
...
- candidats AVEC connectivite : 21045, dont T2 : 100%
- candidats SANS connectivite : 30898, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21846 systemes avec CONNECTED sur 168188 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*47653 candidats sur 51943 portent les champs bruts (92%).*

- `5c556c16ea8b` — 41688 candidats
  - AVEC connectivite (16917) : resistance **41.1%**
  - SANS connectivite (24771) : resistance **21.3%**
...
- `5c556c16ea8b` — 41688 candidats
  - AVEC connectivite (16917) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (24771) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 21929 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21846 avec CONNECTED, 83 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 165687 systemes
  - sans CONNECTED : 0.0% sur 37351 systemes
