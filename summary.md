...
genere 2026-08-26 16:38 UTC — 54127 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 8944 systemes
...
- moteur actif `0caa9267db60` (10385 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 24269 | 12104 | 1654 | 823 | 2407 | 1918 | 2589 | 2471 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 23743 | 5494 | 10029 | 14 | 3326 | 1204 | 10 | 3666 | 15.4% |
...
- candidats AVEC connectivite : 2598, dont T2 : 100%
- candidats SANS connectivite : 3976, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2863 systemes avec CONNECTED sur 22329 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2284 candidats sur 6574 portent les champs bruts (35%).*
...
- `06fe04a859f1` — 1169 candidats
  - AVEC connectivite (460) : resistance **41.0%**
  - SANS connectivite (709) : resistance **20.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1169 candidats
  - AVEC connectivite (460) : T0=13.11 T1=0.00 T2=3.03 — pondere **6.06**
  - SANS connectivite (709) : T0=15.96 T1=0.00 T2=2.62 — pondere **5.25**
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0010), `e3baecf8377b` (p=0.0005).
...
## cout
- temps total 16.8 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2883 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2863 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19828 systemes
  - sans CONNECTED : 0.0% sur 4441 systemes
