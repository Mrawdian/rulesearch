...
| ref | 4 | 3 | 16748 | 3941 | 7099 | 11 | 2283 | 847 | 7 | 2560 | 15.3% |
...
- candidats SANS connectivite : 2870, dont T2 : 100%
...
*428 candidats sur 4718 portent les champs bruts (9%).*
...
- `e3baecf8377b` — 164 candidats
  - AVEC connectivite (65) : resistance **41.8%**
  - SANS connectivite (99) : resistance **20.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 164 candidats
  ...
  - SANS connectivite (99) : T0=15.92 T1=0.00 T2=2.61 — pondere **5.21**
...
**2 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0385).
