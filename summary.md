...
genere 2026-08-29 16:21 UTC — 188709 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 105365 systemes
...
- moteur actif `0caa9267db60` (144967 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 92226 | 45850 | 6275 | 3102 | 9285 | 7333 | 9710 | 9495 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 90368 | 21109 | 38132 | 43 | 12508 | 4637 | 36 | 13897 | 15.4% |
...
- candidats AVEC connectivite : 9622, dont T2 : 100%
- candidats SANS connectivite : 14207, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9984 systemes avec CONNECTED sur 77740 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*19539 candidats sur 23829 portent les champs bruts (82%).*

- `5c556c16ea8b` — 13574 candidats
  - AVEC connectivite (5494) : resistance **41.2%**
  - SANS connectivite (8080) : resistance **21.5%**
...
- `5c556c16ea8b` — 13574 candidats
  - AVEC connectivite (5494) : T0=12.99 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (8080) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.34**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 75239 systemes
  - sans CONNECTED : 0.0% sur 16987 systemes
