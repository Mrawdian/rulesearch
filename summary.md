...
genere 2026-08-27 08:17 UTC — 88893 systemes evalues
...
- moteur actif `0caa9267db60` (45151 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 41824 | 20831 | 2877 | 1416 | 4173 | 3287 | 4407 | 4291 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 40954 | 9441 | 17401 | 22 | 5678 | 2134 | 21 | 6257 | 15.3% |
...
- candidats AVEC connectivite : 4418, dont T2 : 100%
- candidats SANS connectivite : 6567, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4681 systemes avec CONNECTED sur 36684 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6695 candidats sur 10985 portent les champs bruts (61%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 730 candidats
  - AVEC connectivite (290) : resistance **41.1%**
  - SANS connectivite (440) : resistance **21.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 730 candidats
  - AVEC connectivite (290) : T0=13.07 T1=0.00 T2=3.00 — pondere **6.01**
  - SANS connectivite (440) : T0=15.81 T1=0.00 T2=2.64 — pondere **5.27**
...
- TROP-CHER : 4712 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4681 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 34183 systemes
  - sans CONNECTED : 0.0% sur 7641 systemes
