...
genere 2026-08-28 23:00 UTC — 160754 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 77410 systemes
...
- moteur actif `0caa9267db60` (117012 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 78110 | 38803 | 5326 | 2659 | 7820 | 6247 | 8221 | 8039 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 76529 | 17784 | 32405 | 35 | 10555 | 3912 | 31 | 11803 | 15.4% |
...
- candidats AVEC connectivite : 8166, dont T2 : 100%
- candidats SANS connectivite : 12113, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8495 systemes avec CONNECTED sur 66197 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*15989 candidats sur 20279 portent les champs bruts (79%).*

- `5c556c16ea8b` — 10024 candidats
  - AVEC connectivite (4038) : resistance **41.1%**
  - SANS connectivite (5986) : resistance **21.8%**
...
- `5c556c16ea8b` — 10024 candidats
  - AVEC connectivite (4038) : T0=13.01 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (5986) : T0=15.89 T1=0.00 T2=2.68 — pondere **5.37**
...
- TROP-CHER : 8536 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8495 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 63696 systemes
  - sans CONNECTED : 0.0% sur 14414 systemes
