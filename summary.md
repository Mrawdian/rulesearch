...
genere 2026-08-28 00:53 UTC — 121705 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 38361 systemes
...
- moteur actif `0caa9267db60` (77963 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 58377 | 29082 | 4034 | 1972 | 5795 | 4615 | 6144 | 5984 | 10.3% |
...
- candidats AVEC connectivite : 6111, dont T2 : 100%
- candidats SANS connectivite : 9068, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6418 systemes avec CONNECTED sur 50177 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10889 candidats sur 15179 portent les champs bruts (72%).*

- `5c556c16ea8b` — 4924 candidats
  - AVEC connectivite (1983) : resistance **42.0%**
...
- `5c556c16ea8b` — 4924 candidats
  - AVEC connectivite (1983) : T0=12.99 T1=0.00 T2=3.05 — pondere **6.10**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 47676 systemes
  - sans CONNECTED : 0.0% sur 10701 systemes
