...
genere 2026-08-29 22:34 UTC — 198152 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 114808 systemes
...
- moteur actif `0caa9267db60` (154410 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 96996 | 48167 | 6593 | 3262 | 9783 | 7720 | 10227 | 9998 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 95041 | 22175 | 40137 | 44 | 13151 | 4887 | 37 | 14604 | 15.4% |
...
- candidats AVEC connectivite : 10125, dont T2 : 100%
- candidats SANS connectivite : 14914, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10501 systemes avec CONNECTED sur 81614 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*20749 candidats sur 25039 portent les champs bruts (83%).*

- `5c556c16ea8b` — 14784 candidats
  - AVEC connectivite (5997) : resistance **41.1%**
  - SANS connectivite (8787) : resistance **21.5%**
...
- `5c556c16ea8b` — 14784 candidats
  - AVEC connectivite (5997) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (8787) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 10548 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10501 avec CONNECTED, 47 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 79113 systemes
  - sans CONNECTED : 0.0% sur 17883 systemes
