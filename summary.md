...
genere 2026-08-26 17:09 UTC — 55310 systemes evalues
...
- moteur actif `0caa9267db60` (11568 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
| connect | 4 | 3 | 24863 | 12415 | 1690 | 843 | 2458 | 1958 | 2654 | 2534 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 24332 | 5628 | 10294 | 14 | 3402 | 1236 | 10 | 3748 | 15.4% |
...
- candidats AVEC connectivite : 2661, dont T2 : 100%
- candidats SANS connectivite : 4058, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2928 systemes avec CONNECTED sur 22829 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2429 candidats sur 6719 portent les champs bruts (36%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 119 candidats
  - AVEC connectivite (47) : resistance **41.1%**
  - SANS connectivite (72) : resistance **21.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `23303c299f39` — 119 candidats
  - AVEC connectivite (47) : T0=12.70 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (72) : T0=16.86 T1=0.00 T2=2.76 — pondere **5.53**
  - test de permutation : **p = 0.4818** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 2948 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2928 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 20328 systemes
  - sans CONNECTED : 0.0% sur 4535 systemes
