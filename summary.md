...
genere 2026-09-01 22:46 UTC — 295010 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 211666 systemes
...
- moteur actif `0caa9267db60` (251268 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 145905 | 72462 | 9920 | 4894 | 14820 | 11504 | 15430 | 14994 | 10.3% |
...
- candidats AVEC connectivite : 15121, dont T2 : 100%
...
- **15704 systemes avec CONNECTED sur 121574 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*33057 candidats sur 37347 portent les champs bruts (89%).*

- `5c556c16ea8b` — 27092 candidats
  - AVEC connectivite (10993) : resistance **41.0%**
...
- `5c556c16ea8b` — 27092 candidats
  - AVEC connectivite (10993) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 15777 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15704 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 119073 systemes
  - sans CONNECTED : 0.0% sur 26832 systemes
