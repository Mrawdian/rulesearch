...
genere 2026-08-26 21:53 UTC — 66181 systemes evalues
...
- moteur actif `0caa9267db60` (22439 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 30353 | 15080 | 2077 | 1021 | 3037 | 2411 | 3227 | 3116 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 29713 | 6852 | 12628 | 16 | 4109 | 1532 | 13 | 4563 | 15.4% |
...
- candidats AVEC connectivite : 3243, dont T2 : 100%
- candidats SANS connectivite : 4873, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3501 systemes avec CONNECTED sur 27309 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3826 candidats sur 8116 portent les champs bruts (47%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 149 candidats
  - AVEC connectivite (63) : resistance **44.7%**
  - SANS connectivite (86) : resistance **23.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 149 candidats
  - AVEC connectivite (63) : T0=13.21 T1=0.00 T2=3.13 — pondere **6.25**
  - SANS connectivite (86) : T0=15.99 T1=0.00 T2=2.91 — pondere **5.81**
  - test de permutation : **p = 0.4088** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 3524 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3501 avec CONNECTED, 23 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24808 systemes
  - sans CONNECTED : 0.0% sur 5545 systemes
