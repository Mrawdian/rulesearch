...
genere 2026-08-29 06:32 UTC — 173314 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 89970 systemes
...
- moteur actif `0caa9267db60` (129572 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 84453 | 42044 | 5747 | 2850 | 8470 | 6700 | 8869 | 8702 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 82746 | 19311 | 34989 | 39 | 11428 | 4207 | 34 | 12733 | 15.4% |
...
- candidats SANS connectivite : 13043, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9143 systemes avec CONNECTED sur 71437 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*17582 candidats sur 21872 portent les champs bruts (80%).*

- `5c556c16ea8b` — 11617 candidats
  - AVEC connectivite (4701) : resistance **41.2%**
  - SANS connectivite (6916) : resistance **21.6%**
...
- `5c556c16ea8b` — 11617 candidats
  ...
  - SANS connectivite (6916) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.33**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 68936 systemes
  - sans CONNECTED : 0.0% sur 15517 systemes
