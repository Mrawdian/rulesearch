...
genere 2026-09-09 22:06 UTC — 487004 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 403660 systemes
...
- moteur actif `0caa9267db60` (443262 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 242861 | 120585 | 16562 | 8130 | 24580 | 19040 | 25879 | 25005 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 238028 | 55479 | 100284 | 95 | 33148 | 12300 | 87 | 36614 | 15.4% |
...
- candidats SANS connectivite : 36924, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **26153 systemes avec CONNECTED sur 200781 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*57766 candidats sur 62056 portent les champs bruts (93%).*

- `5c556c16ea8b` — 51801 candidats
  - AVEC connectivite (21004) : resistance **41.2%**
  - SANS connectivite (30797) : resistance **21.3%**
...
- `5c556c16ea8b` — 51801 candidats
  ...
  - SANS connectivite (30797) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 198280 systemes
  - sans CONNECTED : 0.0% sur 44581 systemes
