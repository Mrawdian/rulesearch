...
genere 2026-08-30 04:07 UTC — 206629 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 123285 systemes
...
- moteur actif `0caa9267db60` (162887 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 101286 | 50304 | 6898 | 3389 | 10217 | 8083 | 10667 | 10410 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 99228 | 23119 | 41911 | 45 | 13713 | 5131 | 38 | 15264 | 15.4% |
...
- candidats AVEC connectivite : 10537, dont T2 : 100%
...
- **10941 systemes avec CONNECTED sur 85098 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*21821 candidats sur 26111 portent les champs bruts (84%).*

- `5c556c16ea8b` — 15856 candidats
  - AVEC connectivite (6409) : resistance **41.1%**
...
- `5c556c16ea8b` — 15856 candidats
  - AVEC connectivite (6409) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.99**
...
- TROP-CHER : 10989 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10941 avec CONNECTED, 48 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 82597 systemes
  - sans CONNECTED : 0.0% sur 18689 systemes
