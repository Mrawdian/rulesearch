...
genere 2026-08-26 22:06 UTC — 66566 systemes evalues
...
- moteur actif `0caa9267db60` (22824 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 30548 | 15176 | 2089 | 1028 | 3051 | 2429 | 3254 | 3136 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 29903 | 6895 | 12708 | 17 | 4128 | 1543 | 13 | 4599 | 15.4% |
...
- candidats AVEC connectivite : 3263, dont T2 : 100%
- candidats SANS connectivite : 4909, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3528 systemes avec CONNECTED sur 27473 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3882 candidats sur 8172 portent les champs bruts (48%).*
...
- `23303c299f39` — 225 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 205 candidats
  - AVEC connectivite (83) : resistance **43.6%**
  - SANS connectivite (122) : resistance **22.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 205 candidats
  - AVEC connectivite (83) : T0=13.31 T1=0.00 T2=3.08 — pondere **6.17**
  - SANS connectivite (122) : T0=15.92 T1=0.00 T2=2.75 — pondere **5.51**
  - test de permutation : **p = 0.1494** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
- TROP-CHER : 3551 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3528 avec CONNECTED, 23 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24972 systemes
  - sans CONNECTED : 0.0% sur 5576 systemes
