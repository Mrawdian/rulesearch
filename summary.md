...
genere 2026-08-26 02:51 UTC — 19292 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 10318 systemes
...
| connect | 4 | 3 | 9687 | 4869 | 633 | 333 | 922 | 765 | 1054 | 990 | 10.2% |
...
- candidats AVEC connectivite : 993, dont T2 : 100%
...
- **1054 systemes avec CONNECTED sur 8019 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1298 candidats
  - AVEC connectivite (514) : T0=13.34 T1=0.00 T2=2.89 — pondere **5.77**
...
- TROP-CHER : 1058 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1054 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 7962 systemes
  - sans CONNECTED : 0.0% sur 1725 systemes
