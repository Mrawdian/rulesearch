...
genere 2026-08-28 04:42 UTC — 128859 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 45515 systemes
...
- moteur actif `0caa9267db60` (85117 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 62006 | 30844 | 4277 | 2097 | 6184 | 4920 | 6513 | 6372 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 60738 | 14067 | 25709 | 28 | 8450 | 3143 | 27 | 9312 | 15.3% |
...
- candidats AVEC connectivite : 6499, dont T2 : 100%
- candidats SANS connectivite : 9622, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6787 systemes avec CONNECTED sur 53102 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11831 candidats sur 16121 portent les champs bruts (73%).*

- `5c556c16ea8b` — 5866 candidats
  - AVEC connectivite (2371) : resistance **41.7%**
  - SANS connectivite (3495) : resistance **22.1%**
...
- `5c556c16ea8b` — 5866 candidats
  - AVEC connectivite (2371) : T0=12.99 T1=0.00 T2=3.03 — pondere **6.07**
  - SANS connectivite (3495) : T0=15.85 T1=0.00 T2=2.70 — pondere **5.39**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 50601 systemes
  - sans CONNECTED : 0.0% sur 11405 systemes
