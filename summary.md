...
genere 2026-08-26 22:41 UTC — 67824 systemes evalues
...
- moteur actif `0caa9267db60` (24082 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 30520 | 7028 | 12966 | 18 | 4233 | 1584 | 14 | 4677 | 15.3% |
...
- candidats SANS connectivite : 4987, dont T2 : 100%
...
*4026 candidats sur 8316 portent les champs bruts (48%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 349 candidats
  - AVEC connectivite (149) : resistance **42.7%**
  - SANS connectivite (200) : resistance **22.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 349 candidats
  ...
  - SANS connectivite (200) : T0=16.13 T1=0.00 T2=2.75 — pondere **5.51**
  - test de permutation : **p = 0.0620** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
