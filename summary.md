...
genere 2026-08-29 19:06 UTC — 192793 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 109449 systemes
...
- moteur actif `0caa9267db60` (149051 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 94293 | 46856 | 6423 | 3167 | 9498 | 7507 | 9948 | 9693 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 92385 | 21554 | 38998 | 43 | 12779 | 4756 | 36 | 14213 | 15.4% |
...
- candidats AVEC connectivite : 9820, dont T2 : 100%
- candidats SANS connectivite : 14523, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10222 systemes avec CONNECTED sur 79427 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*20053 candidats sur 24343 portent les champs bruts (82%).*

- `5c556c16ea8b` — 14088 candidats
  - AVEC connectivite (5692) : resistance **41.2%**
  - SANS connectivite (8396) : resistance **21.5%**
...
- `5c556c16ea8b` — 14088 candidats
  - AVEC connectivite (5692) : T0=12.99 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (8396) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.33**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 76926 systemes
  - sans CONNECTED : 0.0% sur 17367 systemes
