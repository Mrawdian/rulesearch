...
genere 2026-09-07 00:39 UTC — 424646 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 341302 systemes
...
- moteur actif `0caa9267db60` (380904 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 211355 | 104939 | 14397 | 7042 | 21435 | 16615 | 22463 | 21783 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 207176 | 48170 | 87404 | 80 | 28875 | 10695 | 73 | 31861 | 15.4% |
...
- candidats AVEC connectivite : 21910, dont T2 : 100%
...
- **22737 systemes avec CONNECTED sur 174990 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*49791 candidats sur 54081 portent les champs bruts (92%).*

- `5c556c16ea8b` — 43826 candidats
  - AVEC connectivite (17782) : resistance **41.1%**
...
- `5c556c16ea8b` — 43826 candidats
  - AVEC connectivite (17782) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 22820 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 22737 avec CONNECTED, 83 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 172489 systemes
  - sans CONNECTED : 0.0% sur 38866 systemes
