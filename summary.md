...
| connect | 4 | 3 | 17634 | 8823 | 1137 | 609 | 1754 | 1403 | 1915 | 1772 | 10.0% |
...
- candidats AVEC connectivite : 1899, dont T2 : 100%
- candidats SANS connectivite : 2957, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2189 systemes avec CONNECTED sur 16901 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*566 candidats sur 4856 portent les champs bruts (12%).*
...
- `e3baecf8377b` — 302 candidats
  - AVEC connectivite (116) : resistance **44.0%**
...
- `e3baecf8377b` — 302 candidats
  - AVEC connectivite (116) : T0=12.92 T1=0.00 T2=3.16 — pondere **6.33**
...
**2 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0070).
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14400 systemes
  - sans CONNECTED : 0.0% sur 3234 systemes
