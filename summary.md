...
| ref | 4 | 3 | 16894 | 3981 | 7149 | 11 | 2307 | 854 | 7 | 2585 | 15.3% |
...
- candidats SANS connectivite : 2895, dont T2 : 100%
...
*469 candidats sur 4759 portent les champs bruts (10%).*
...
- `e3baecf8377b` — 205 candidats
  - AVEC connectivite (81) : resistance **42.7%**
  - SANS connectivite (124) : resistance **21.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 205 candidats
  ...
  - SANS connectivite (124) : T0=16.02 T1=0.00 T2=2.67 — pondere **5.34**
  - test de permutation : **p = 0.0505** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
**1 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005).
