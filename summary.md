...
genere 2026-09-03 21:00 UTC — 347839 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 264495 systemes
...
- moteur actif `0caa9267db60` (304097 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 172576 | 85794 | 11720 | 5774 | 17568 | 13598 | 18280 | 17648 | 10.2% |
...
- candidats AVEC connectivite : 17775, dont T2 : 100%
...
- **18554 systemes avec CONNECTED sur 143313 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39750 candidats sur 44040 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33785 candidats
  - AVEC connectivite (13647) : resistance **41.0%**
...
- `5c556c16ea8b` — 33785 candidats
  - AVEC connectivite (13647) : T0=13.03 T1=0.00 T2=2.97 — pondere **5.95**
...
- TROP-CHER : 18630 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18554 avec CONNECTED, 76 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 140812 systemes
  - sans CONNECTED : 0.0% sur 31764 systemes
