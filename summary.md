...
genere 2026-09-07 08:33 UTC — 432034 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 348690 systemes
...
- moteur actif `0caa9267db60` (388292 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 215091 | 106833 | 14643 | 7161 | 21796 | 16884 | 22874 | 22165 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 210828 | 49078 | 88897 | 82 | 29376 | 10889 | 76 | 32412 | 15.4% |
...
- candidats AVEC connectivite : 22292, dont T2 : 100%
...
- **23148 systemes avec CONNECTED sur 178078 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*50724 candidats sur 55014 portent les champs bruts (92%).*

- `5c556c16ea8b` — 44759 candidats
  - AVEC connectivite (18164) : resistance **41.1%**
...
- `5c556c16ea8b` — 44759 candidats
  - AVEC connectivite (18164) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 23234 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23148 avec CONNECTED, 86 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 175577 systemes
  - sans CONNECTED : 0.0% sur 39514 systemes
