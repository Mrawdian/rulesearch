...
genere 2026-08-26 12:45 UTC — 44741 systemes evalues
...
| connect | 4 | 3 | 19517 | 9733 | 1274 | 680 | 1950 | 1551 | 2099 | 1986 | 10.2% |
...
- candidats AVEC connectivite : 2113, dont T2 : 100%
- candidats SANS connectivite : 3233, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2373 systemes avec CONNECTED sur 18436 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1056 candidats sur 5346 portent les champs bruts (20%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `e40600351a72` — 135 candidats
  - AVEC connectivite (62) : resistance **39.8%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e40600351a72` — 135 candidats
  - AVEC connectivite (62) : T0=12.97 T1=0.00 T2=2.94 — pondere **5.87**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 15935 systemes
  - sans CONNECTED : 0.0% sur 3582 systemes
