...
genere 2026-08-28 01:48 UTC — 123528 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 40184 systemes
...
- moteur actif `0caa9267db60` (79786 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 59305 | 29531 | 4097 | 2005 | 5895 | 4699 | 6233 | 6084 | 10.3% |
...
- candidats AVEC connectivite : 6211, dont T2 : 100%
- candidats SANS connectivite : 9213, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6507 systemes avec CONNECTED sur 50916 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11134 candidats sur 15424 portent les champs bruts (72%).*

- `5c556c16ea8b` — 5169 candidats
  - AVEC connectivite (2083) : resistance **41.9%**
...
- `5c556c16ea8b` — 5169 candidats
  - AVEC connectivite (2083) : T0=12.99 T1=0.00 T2=3.05 — pondere **6.10**
...
- TROP-CHER : 6543 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6507 avec CONNECTED, 36 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 48415 systemes
  - sans CONNECTED : 0.0% sur 10890 systemes
