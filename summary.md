...
genere 2026-08-26 20:10 UTC — 62330 systemes evalues
...
- moteur actif `0caa9267db60` (18588 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 28408 | 14142 | 1946 | 953 | 2818 | 2252 | 3020 | 2920 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 27807 | 6423 | 11786 | 15 | 3862 | 1428 | 12 | 4281 | 15.4% |
...
- candidats AVEC connectivite : 3047, dont T2 : 100%
- candidats SANS connectivite : 4591, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3294 systemes avec CONNECTED sur 25740 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3348 candidats sur 7638 portent les champs bruts (44%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 479 candidats
  - AVEC connectivite (203) : resistance **39.4%**
  - SANS connectivite (276) : resistance **19.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 479 candidats
  - AVEC connectivite (203) : T0=12.86 T1=0.00 T2=2.83 — pondere **5.67**
  - SANS connectivite (276) : T0=16.12 T1=0.00 T2=2.59 — pondere **5.18**
  - test de permutation : **p = 0.0965** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- TROP-CHER : 3316 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3294 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23239 systemes
  - sans CONNECTED : 0.0% sur 5169 systemes
