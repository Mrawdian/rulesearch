...
genere 2026-08-28 06:08 UTC — 131443 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 48099 systemes
...
- moteur actif `0caa9267db60` (87701 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 63301 | 31467 | 4342 | 2147 | 6328 | 5046 | 6653 | 6502 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 62027 | 14343 | 26286 | 29 | 8623 | 3202 | 28 | 9514 | 15.3% |
...
- candidats AVEC connectivite : 6629, dont T2 : 100%
- candidats SANS connectivite : 9824, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6927 systemes avec CONNECTED sur 54143 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12163 candidats sur 16453 portent les champs bruts (74%).*

- `5c556c16ea8b` — 6198 candidats
  - AVEC connectivite (2501) : resistance **41.5%**
  - SANS connectivite (3697) : resistance **22.0%**
...
- `5c556c16ea8b` — 6198 candidats
  - AVEC connectivite (2501) : T0=12.97 T1=0.00 T2=3.02 — pondere **6.04**
  - SANS connectivite (3697) : T0=15.86 T1=0.00 T2=2.69 — pondere **5.37**
...
- TROP-CHER : 6965 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6927 avec CONNECTED, 38 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 51642 systemes
  - sans CONNECTED : 0.0% sur 11659 systemes
