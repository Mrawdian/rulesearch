...
| connect | 4 | 3 | 7007 | 3519 | 461 | 245 | 664 | 568 | 731 | 740 | 10.6% |
| ref | 4 | 3 | 6835 | 1645 | 2843 | 1 | 918 | 342 | 2 | 1084 | 15.9% |
...
- candidats AVEC connectivite : 743, dont T2 : 100%
- candidats SANS connectivite : 1088, dont T2 : 100%
...
- **731 systemes avec CONNECTED sur 5801 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 666 candidats
  - AVEC connectivite (264) : T0=13.24 T1=0.00 T2=2.94 — pondere **5.88**
  - SANS connectivite (402) : T0=15.81 T1=0.00 T2=2.63 — pondere **5.27**
...
- TROP-CHER : 733 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 731 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 5744 systemes
  - sans CONNECTED : 0.0% sur 1263 systemes
