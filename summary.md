...
genere 2026-08-26 20:30 UTC — 63085 systemes evalues
...
- moteur actif `0caa9267db60` (19343 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 28174 | 6513 | 11946 | 15 | 3909 | 1450 | 12 | 4329 | 15.4% |
...
- candidats SANS connectivite : 4639, dont T2 : 100%
...
*3438 candidats sur 7728 portent les champs bruts (44%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 569 candidats
  - AVEC connectivite (245) : resistance **40.0%**
  - SANS connectivite (324) : resistance **20.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 569 candidats
  ...
  - SANS connectivite (324) : T0=16.19 T1=0.00 T2=2.67 — pondere **5.33**
  - test de permutation : **p = 0.1814** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
