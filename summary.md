...
genere 2026-09-01 06:54 UTC — 275521 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 192177 systemes
...
- moteur actif `0caa9267db60` (231779 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 136067 | 67611 | 9205 | 4552 | 13809 | 10759 | 14378 | 13989 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 133339 | 31072 | 56350 | 58 | 18492 | 6893 | 60 | 20404 | 15.3% |
...
- candidats AVEC connectivite : 14116, dont T2 : 100%
- candidats SANS connectivite : 20714, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14652 systemes avec CONNECTED sur 113522 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*30540 candidats sur 34830 portent les champs bruts (88%).*

- `5c556c16ea8b` — 24575 candidats
  - AVEC connectivite (9988) : resistance **41.0%**
  - SANS connectivite (14587) : resistance **21.3%**
...
- `5c556c16ea8b` — 24575 candidats
  - AVEC connectivite (9988) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (14587) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 111021 systemes
  - sans CONNECTED : 0.0% sur 25046 systemes
