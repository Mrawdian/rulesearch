...
genere 2026-09-07 04:35 UTC — 428379 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 345035 systemes
...
- moteur actif `0caa9267db60` (384637 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 213240 | 105888 | 14523 | 7097 | 21626 | 16758 | 22665 | 21971 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 209024 | 48656 | 88138 | 81 | 29130 | 10796 | 75 | 32130 | 15.4% |
...
- candidats AVEC connectivite : 22098, dont T2 : 100%
- candidats SANS connectivite : 32440, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **22939 systemes avec CONNECTED sur 176528 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*50248 candidats sur 54538 portent les champs bruts (92%).*

- `5c556c16ea8b` — 44283 candidats
  - AVEC connectivite (17970) : resistance **41.1%**
  - SANS connectivite (26313) : resistance **21.3%**
...
- `5c556c16ea8b` — 44283 candidats
  - AVEC connectivite (17970) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (26313) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 23024 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 22939 avec CONNECTED, 85 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 174027 systemes
  - sans CONNECTED : 0.0% sur 39213 systemes
