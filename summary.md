...
genere 2026-08-26 16:20 UTC — 53355 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 8172 systemes
...
- moteur actif `0caa9267db60` (9613 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23879 | 11912 | 1626 | 813 | 2371 | 1883 | 2552 | 2423 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 23361 | 5410 | 9865 | 14 | 3268 | 1193 | 10 | 3601 | 15.4% |
...
- candidats AVEC connectivite : 2550, dont T2 : 100%
- candidats SANS connectivite : 3911, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2826 systemes avec CONNECTED sur 22007 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2171 candidats sur 6461 portent les champs bruts (34%).*
...
- `06fe04a859f1` — 1056 candidats
  - AVEC connectivite (412) : resistance **40.9%**
  - SANS connectivite (644) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1056 candidats
  - AVEC connectivite (412) : T0=13.17 T1=0.00 T2=3.03 — pondere **6.06**
  - SANS connectivite (644) : T0=16.01 T1=0.00 T2=2.64 — pondere **5.29**
...
- TROP-CHER : 2846 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2826 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19506 systemes
  - sans CONNECTED : 0.0% sur 4373 systemes
