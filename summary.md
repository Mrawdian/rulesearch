...
genere 2026-08-26 10:39 UTC — 39246 systemes evalues
...
- `e3baecf8377b` : 653 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
**8119 enregistrements (21%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
*346 candidats sur 4636 portent les champs bruts (7%).*
...
- `e3baecf8377b` — 82 candidats (**NON REPRODUCTIBLE**)
...
- `e3baecf8377b` — 82 candidats
  - AVEC connectivite (31) : T0=13.68 T1=0.00 T2=2.77 — pondere **5.55**
  - SANS connectivite (51) : T0=15.90 T1=0.00 T2=2.41 — pondere **4.82**
  - test de permutation : **p = 0.3513** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
