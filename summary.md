...
genere 2026-09-02 08:59 UTC — 307065 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 223721 systemes
...
- moteur actif `0caa9267db60` (263323 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 151991 | 75510 | 10338 | 5092 | 15448 | 11958 | 16096 | 15606 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 148959 | 34687 | 62997 | 63 | 20614 | 7688 | 63 | 22835 | 15.3% |
...
- candidats AVEC connectivite : 15733, dont T2 : 100%
- candidats SANS connectivite : 23145, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16370 systemes avec CONNECTED sur 126570 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*34588 candidats sur 38878 portent les champs bruts (89%).*

- `5c556c16ea8b` — 28623 candidats
  - AVEC connectivite (11605) : resistance **41.1%**
  - SANS connectivite (17018) : resistance **21.3%**
...
- `5c556c16ea8b` — 28623 candidats
  - AVEC connectivite (11605) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (17018) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.29**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 124069 systemes
  - sans CONNECTED : 0.0% sur 27922 systemes
