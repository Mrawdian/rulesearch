...
genere 2026-08-26 15:55 UTC — 52439 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 7256 systemes
...
- moteur actif `0caa9267db60` (8697 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23416 | 11670 | 1585 | 800 | 2338 | 1854 | 2500 | 2373 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 22908 | 5300 | 9681 | 14 | 3204 | 1165 | 10 | 3534 | 15.4% |
...
- candidats AVEC connectivite : 2500, dont T2 : 100%
- candidats SANS connectivite : 3844, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2774 systemes avec CONNECTED sur 21612 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2054 candidats sur 6344 portent les champs bruts (32%).*
...
- `06fe04a859f1` — 939 candidats
  - AVEC connectivite (362) : resistance **41.4%**
  - SANS connectivite (577) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 939 candidats
  - AVEC connectivite (362) : T0=13.22 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (577) : T0=16.03 T1=0.00 T2=2.65 — pondere **5.29**
...
- TROP-CHER : 2794 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2774 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19111 systemes
  - sans CONNECTED : 0.0% sur 4305 systemes
