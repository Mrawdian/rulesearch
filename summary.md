...
genere 2026-08-26 21:10 UTC — 64387 systemes evalues
...
- moteur actif `0caa9267db60` (20645 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 29456 | 14646 | 2013 | 986 | 2937 | 2331 | 3147 | 3021 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 28816 | 6647 | 12227 | 16 | 4000 | 1486 | 12 | 4428 | 15.4% |
...
- **3421 systemes avec CONNECTED sur 26597 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3596 candidats sur 7886 portent les champs bruts (46%).*
...
- `62448a55927e` — 727 candidats
  ...
  - test de permutation : **p = 0.1429** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e3baecf8377b` — 657 candidats
...
- TROP-CHER : 3443 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3421 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 24096 systemes
  - sans CONNECTED : 0.0% sur 5360 systemes
