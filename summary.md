...
genere 2026-08-28 13:43 UTC — 144633 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 61289 systemes
...
- moteur actif `0caa9267db60` (100891 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 69963 | 34760 | 4780 | 2370 | 7025 | 5591 | 7387 | 7154 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 68555 | 15905 | 28970 | 32 | 9495 | 3531 | 30 | 10589 | 15.4% |
...
- candidats AVEC connectivite : 7281, dont T2 : 100%
- candidats SANS connectivite : 10899, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7661 systemes avec CONNECTED sur 59550 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*13890 candidats sur 18180 portent les champs bruts (76%).*

- `5c556c16ea8b` — 7925 candidats
  - AVEC connectivite (3153) : resistance **41.2%**
  - SANS connectivite (4772) : resistance **21.7%**
...
- `5c556c16ea8b` — 7925 candidats
  - AVEC connectivite (3153) : T0=13.00 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (4772) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.35**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 57049 systemes
  - sans CONNECTED : 0.0% sur 12914 systemes
