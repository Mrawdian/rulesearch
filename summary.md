...
genere 2026-08-30 03:44 UTC — 206078 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 122734 systemes
...
- moteur actif `0caa9267db60` (162336 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
**7585 enregistrements (4%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 101016 | 50159 | 6881 | 3386 | 10187 | 8065 | 10633 | 10389 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 98947 | 23054 | 41799 | 45 | 13674 | 5114 | 38 | 15216 | 15.4% |
...
- candidats AVEC connectivite : 10516, dont T2 : 100%
- candidats SANS connectivite : 15526, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10907 systemes avec CONNECTED sur 84873 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*21752 candidats sur 26042 portent les champs bruts (84%).*

- `5c556c16ea8b` — 15787 candidats
  - AVEC connectivite (6388) : resistance **41.1%**
  - SANS connectivite (9399) : resistance **21.5%**
...
- `5c556c16ea8b` — 15787 candidats
  - AVEC connectivite (6388) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (9399) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.32**
...
- `T2` indices=0.06 — PAIRDIFF(>=1)@knight + PAIRSTEP(1)@knight + CONNECTED(v2) + COUNT(v2,1-5)@grid
...
## cout
- temps total 63.5 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 10955 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10907 avec CONNECTED, 48 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 82372 systemes
  - sans CONNECTED : 0.0% sur 18644 systemes
