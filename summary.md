...
| connect | 4 | 3 | 5456 | 2740 | 352 | 200 | 526 | 450 | 568 | 560 | 10.3% |
...
- candidats AVEC connectivite : 563, dont T2 : 100%
...
- **568 systemes avec CONNECTED sur 4515 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 248 candidats
  - AVEC connectivite (84) : T0=13.31 T1=0.00 T2=2.70 — pondere **5.40**
  - SANS connectivite (164) : T0=15.96 T1=0.00 T2=2.66 — pondere **5.32**
  - test de permutation : **p = 0.8561** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 570 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 568 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 4458 systemes
  - sans CONNECTED : 0.0% sur 998 systemes
