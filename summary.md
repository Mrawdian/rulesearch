...
genere 2026-08-26 16:04 UTC — 52808 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 7625 systemes
...
- moteur actif `0caa9267db60` (9066 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23594 | 11767 | 1599 | 805 | 2348 | 1870 | 2519 | 2390 | 10.1% |
...
- candidats AVEC connectivite : 2517, dont T2 : 100%
- candidats SANS connectivite : 3874, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2793 systemes avec CONNECTED sur 21765 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2101 candidats sur 6391 portent les champs bruts (33%).*
...
- `06fe04a859f1` — 986 candidats
  - AVEC connectivite (379) : resistance **41.4%**
...
- `06fe04a859f1` — 986 candidats
  - AVEC connectivite (379) : T0=13.21 T1=0.00 T2=3.04 — pondere **6.07**
...
- TROP-CHER : 2813 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2793 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19264 systemes
  - sans CONNECTED : 0.0% sur 4330 systemes
