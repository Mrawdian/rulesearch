...
| connect | 4 | 3 | 8087 | 4075 | 526 | 275 | 772 | 646 | 855 | 845 | 10.4% |
...
- candidats AVEC connectivite : 848, dont T2 : 100%
...
- **855 systemes avec CONNECTED sur 6696 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 917 candidats
  - AVEC connectivite (369) : T0=13.44 T1=0.00 T2=2.83 — pondere **5.67**
  - SANS connectivite (548) : T0=15.85 T1=0.00 T2=2.65 — pondere **5.30**
  - test de permutation : **p = 0.0840** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 858 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 855 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 6639 systemes
  - sans CONNECTED : 0.0% sur 1448 systemes
