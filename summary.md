...
- moteur actif `0caa9267db60` (8536 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23327 | 11621 | 1579 | 795 | 2329 | 1851 | 2492 | 2365 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 22836 | 5283 | 9646 | 14 | 3200 | 1162 | 10 | 3521 | 15.4% |
...
- candidats AVEC connectivite : 2492, dont T2 : 100%
- candidats SANS connectivite : 3831, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2766 systemes avec CONNECTED sur 21539 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2033 candidats sur 6323 portent les champs bruts (32%).*
...
- `06fe04a859f1` — 918 candidats
  - AVEC connectivite (354) : resistance **41.4%**
  - SANS connectivite (564) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 918 candidats
  - AVEC connectivite (354) : T0=13.24 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (564) : T0=16.03 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 2786 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2766 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19038 systemes
  - sans CONNECTED : 0.0% sur 4289 systemes
