...
genere 2026-09-03 22:39 UTC — 349618 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 266274 systemes
...
- moteur actif `0caa9267db60` (305876 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 173472 | 86248 | 11780 | 5800 | 17658 | 13666 | 18378 | 17734 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 170031 | 39547 | 71843 | 69 | 23601 | 8794 | 66 | 26097 | 15.3% |
...
- candidats AVEC connectivite : 17861, dont T2 : 100%
- candidats SANS connectivite : 26407, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18652 systemes avec CONNECTED sur 144039 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39978 candidats sur 44268 portent les champs bruts (90%).*

- `5c556c16ea8b` — 34013 candidats
  - AVEC connectivite (13733) : resistance **41.0%**
  - SANS connectivite (20280) : resistance **21.2%**
...
- `5c556c16ea8b` — 34013 candidats
  - AVEC connectivite (13733) : T0=13.03 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (20280) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.29**
...
- TROP-CHER : 18728 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18652 avec CONNECTED, 76 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 141538 systemes
  - sans CONNECTED : 0.0% sur 31934 systemes
