...
genere 2026-09-04 08:00 UTC — 359736 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 276392 systemes
...
- moteur actif `0caa9267db60` (315994 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 178582 | 88759 | 12132 | 5972 | 18166 | 14070 | 18922 | 18288 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 175039 | 40669 | 73942 | 71 | 24301 | 9074 | 70 | 26898 | 15.4% |
...
- candidats SANS connectivite : 27208, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19196 systemes avec CONNECTED sur 148215 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*41333 candidats sur 45623 portent les champs bruts (91%).*

- `5c556c16ea8b` — 35368 candidats
  - AVEC connectivite (14287) : resistance **41.1%**
  - SANS connectivite (21081) : resistance **21.3%**
...
- `5c556c16ea8b` — 35368 candidats
  ...
  - SANS connectivite (21081) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 145714 systemes
  - sans CONNECTED : 0.0% sur 32868 systemes
