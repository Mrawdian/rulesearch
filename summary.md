...
| connect | 4 | 3 | 18636 | 9296 | 1211 | 645 | 1865 | 1487 | 2018 | 1884 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 18250 | 4289 | 7690 | 13 | 2505 | 942 | 7 | 2804 | 15.4% |
...
- candidats AVEC connectivite : 2011, dont T2 : 100%
- candidats SANS connectivite : 3114, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2292 systemes avec CONNECTED sur 17703 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*835 candidats sur 5125 portent les champs bruts (16%).*
...
- `e3baecf8377b` — 571 candidats
  - AVEC connectivite (228) : resistance **42.0%**
...
- `e3baecf8377b` — 571 candidats
  - AVEC connectivite (228) : T0=13.14 T1=0.00 T2=3.08 — pondere **6.17**
...
- TROP-CHER : 2309 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 2292 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 15202 systemes
  - sans CONNECTED : 0.0% sur 3434 systemes
