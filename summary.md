...
| connect | 4 | 3 | 18576 | 9273 | 1202 | 643 | 1856 | 1481 | 2013 | 1878 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 18176 | 4277 | 7659 | 13 | 2488 | 942 | 7 | 2790 | 15.3% |
...
- candidats AVEC connectivite : 2005, dont T2 : 100%
- candidats SANS connectivite : 3100, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2287 systemes avec CONNECTED sur 17661 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*815 candidats sur 5105 portent les champs bruts (16%).*
...
- `e3baecf8377b` — 551 candidats
  - AVEC connectivite (222) : resistance **41.9%**
  - SANS connectivite (329) : resistance **21.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 551 candidats
  - AVEC connectivite (222) : T0=13.14 T1=0.00 T2=3.07 — pondere **6.14**
  - SANS connectivite (329) : T0=16.04 T1=0.00 T2=2.67 — pondere **5.34**
...
- TROP-CHER : 2304 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 2287 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 15160 systemes
  - sans CONNECTED : 0.0% sur 3416 systemes
