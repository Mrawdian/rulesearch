...
- `89c65c03c4ad` — 318 candidats
  - AVEC connectivite (114) : T0=13.15 T1=0.00 T2=2.72 — pondere **5.44**
  - SANS connectivite (204) : T0=15.96 T1=0.00 T2=2.66 — pondere **5.32**
  - test de permutation : **p = 0.7451** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
