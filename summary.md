...
genere 2026-09-08 04:29 UTC — 450225 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 366881 systemes
...
- moteur actif `0caa9267db60` (406483 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 224278 | 111374 | 15273 | 7486 | 22698 | 17580 | 23902 | 23107 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 219832 | 51211 | 92655 | 87 | 30647 | 11351 | 79 | 33784 | 15.4% |
...
- candidats SANS connectivite : 34094, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **24176 systemes avec CONNECTED sur 185634 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*53038 candidats sur 57328 portent les champs bruts (93%).*

- `5c556c16ea8b` — 47073 candidats
  - AVEC connectivite (19106) : resistance **41.2%**
  - SANS connectivite (27967) : resistance **21.3%**
...
- `5c556c16ea8b` — 47073 candidats
  ...
  - SANS connectivite (27967) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 24265 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 24176 avec CONNECTED, 89 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 183133 systemes
  - sans CONNECTED : 0.0% sur 41145 systemes
