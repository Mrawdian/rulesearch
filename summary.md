...
genere 2026-08-26 21:19 UTC — 64817 systemes evalues
...
- moteur actif `0caa9267db60` (21075 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 29665 | 14743 | 2028 | 993 | 2966 | 2347 | 3162 | 3049 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 29037 | 6698 | 12320 | 16 | 4028 | 1496 | 12 | 4467 | 15.4% |
...
- candidats AVEC connectivite : 3176, dont T2 : 100%
- candidats SANS connectivite : 4777, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3436 systemes avec CONNECTED sur 26762 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3663 candidats sur 7953 portent les champs bruts (46%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 794 candidats
  - AVEC connectivite (332) : resistance **40.2%**
  - SANS connectivite (462) : resistance **20.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 794 candidats
  - AVEC connectivite (332) : T0=12.91 T1=0.00 T2=2.86 — pondere **5.72**
  - SANS connectivite (462) : T0=16.19 T1=0.00 T2=2.67 — pondere **5.33**
...
- TROP-CHER : 3458 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3436 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24261 systemes
  - sans CONNECTED : 0.0% sur 5404 systemes
