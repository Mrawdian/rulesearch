...
genere 2026-08-29 20:19 UTC — 194602 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 111258 systemes
...
- moteur actif `0caa9267db60` (150860 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 95203 | 47284 | 6480 | 3210 | 9598 | 7583 | 10051 | 9784 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 93284 | 21746 | 39385 | 43 | 12915 | 4797 | 37 | 14355 | 15.4% |
...
- candidats SANS connectivite : 14665, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10325 systemes avec CONNECTED sur 80151 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*20286 candidats sur 24576 portent les champs bruts (83%).*

- `5c556c16ea8b` — 14321 candidats
  - AVEC connectivite (5783) : resistance **41.2%**
  - SANS connectivite (8538) : resistance **21.5%**
...
- `5c556c16ea8b` — 14321 candidats
  ...
  - SANS connectivite (8538) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.33**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 77650 systemes
  - sans CONNECTED : 0.0% sur 17553 systemes
