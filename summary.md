...
genere 2026-09-07 14:07 UTC — 437244 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 353900 systemes
...
- moteur actif `0caa9267db60` (393502 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 217736 | 108177 | 14843 | 7244 | 22041 | 17079 | 23155 | 22435 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 213393 | 49711 | 89938 | 83 | 29739 | 11020 | 77 | 32807 | 15.4% |
...
- candidats AVEC connectivite : 22562, dont T2 : 100%
- candidats SANS connectivite : 33117, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23429 systemes avec CONNECTED sur 180258 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*51389 candidats sur 55679 portent les champs bruts (92%).*

- `5c556c16ea8b` — 45424 candidats
  - AVEC connectivite (18434) : resistance **41.1%**
  - SANS connectivite (26990) : resistance **21.3%**
...
- `5c556c16ea8b` — 45424 candidats
  - AVEC connectivite (18434) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (26990) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 23516 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23429 avec CONNECTED, 87 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 177757 systemes
  - sans CONNECTED : 0.0% sur 39979 systemes
