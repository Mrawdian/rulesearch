...
genere 2026-08-26 07:41 UTC — 31562 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 22588 systemes
...
**7466 enregistrements (24%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 14551 | 7274 | 953 | 503 | 1426 | 1156 | 1588 | 1464 | 10.1% |
| d4 | 4 | 4 | 2633 | 1205 | 677 | 14 | 188 | 175 | 130 | 175 | 6.6% |
| ref | 4 | 3 | 14254 | 3373 | 5982 | 9 | 1966 | 726 | 6 | 2192 | 15.4% |
...
- candidats AVEC connectivite : 1509, dont T2 : 100%
- candidats SANS connectivite : 2329, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1714 systemes avec CONNECTED sur 13046 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2673 candidats
  - AVEC connectivite (1030) : T0=13.18 T1=0.00 T2=2.89 — pondere **5.78**
  - SANS connectivite (1643) : T0=15.91 T1=0.01 T2=2.64 — pondere **5.29**
...
## cout
- temps total 10.0 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 1724 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1714 avec CONNECTED, 10 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 11910 systemes
  - sans CONNECTED : 0.0% sur 2641 systemes
