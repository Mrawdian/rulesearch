...
genere 2026-08-26 14:23 UTC — 48820 systemes evalues
...
- moteur actif `0caa9267db60` (5078 systemes) : `06fe04a859f1`, `e40600351a72`
...
*1595 candidats sur 5885 portent les champs bruts (27%).*
...
- `06fe04a859f1` — 480 candidats
  ...
  - test de permutation : **p = 0.0415** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e40600351a72` — 194 candidats
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0415).
