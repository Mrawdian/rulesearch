...
genere 2026-09-03 08:25 UTC — 333755 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 250411 systemes
...
- moteur actif `0caa9267db60` (290013 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 165466 | 82211 | 11241 | 5532 | 16848 | 13048 | 17540 | 16925 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 162174 | 37776 | 68560 | 66 | 22491 | 8382 | 66 | 24821 | 15.3% |
...
- candidats AVEC connectivite : 17052, dont T2 : 100%
...
- **17814 systemes avec CONNECTED sur 137495 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*37893 candidats sur 42183 portent les champs bruts (90%).*

- `5c556c16ea8b` — 31928 candidats
  - AVEC connectivite (12924) : resistance **41.1%**
...
- `5c556c16ea8b` — 31928 candidats
  - AVEC connectivite (12924) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 17890 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 17814 avec CONNECTED, 76 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 134994 systemes
  - sans CONNECTED : 0.0% sur 30472 systemes
