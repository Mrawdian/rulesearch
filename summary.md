...
genere 2026-08-27 07:16 UTC — 86761 systemes evalues
...
- moteur actif `0caa9267db60` (43019 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 40746 | 20283 | 2789 | 1388 | 4082 | 3202 | 4297 | 4179 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 39900 | 9192 | 16958 | 22 | 5536 | 2084 | 21 | 6087 | 15.3% |
...
- candidats AVEC connectivite : 4306, dont T2 : 100%
- candidats SANS connectivite : 6397, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4571 systemes avec CONNECTED sur 35796 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6413 candidats sur 10703 portent les champs bruts (60%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 448 candidats
  - AVEC connectivite (178) : resistance **42.0%**
  - SANS connectivite (270) : resistance **20.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 448 candidats
  - AVEC connectivite (178) : T0=13.05 T1=0.00 T2=3.08 — pondere **6.16**
  - SANS connectivite (270) : T0=15.76 T1=0.00 T2=2.61 — pondere **5.21**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 33295 systemes
  - sans CONNECTED : 0.0% sur 7451 systemes
