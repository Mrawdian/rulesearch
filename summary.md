...
genere 2026-08-26 18:27 UTC — 58429 systemes evalues
...
- moteur actif `0caa9267db60` (14687 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 26433 | 13176 | 1801 | 895 | 2620 | 2089 | 2814 | 2712 | 10.3% |
...
- candidats AVEC connectivite : 2839, dont T2 : 100%
- candidats SANS connectivite : 4299, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3088 systemes avec CONNECTED sur 24120 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2848 candidats sur 7138 portent les champs bruts (40%).*
...
- `b71bb0907fb5` — 53 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `8f22f0d2d442` — 44 candidats
  - AVEC connectivite (16) : resistance **38.4%**
...
- `8f22f0d2d442` — 44 candidats
  - AVEC connectivite (16) : T0=13.62 T1=0.00 T2=2.69 — pondere **5.38**
...
- TROP-CHER : 3108 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3088 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 21619 systemes
  - sans CONNECTED : 0.0% sur 4814 systemes
