...
| ref | 4 | 3 | 16982 | 3999 | 7182 | 12 | 2325 | 859 | 7 | 2598 | 15.3% |
...
- candidats SANS connectivite : 2908, dont T2 : 100%
...
*489 candidats sur 4779 portent les champs bruts (10%).*
...
- `e3baecf8377b` — 225 candidats
  - AVEC connectivite (88) : resistance **43.2%**
  - SANS connectivite (137) : resistance **21.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 225 candidats
  ...
  - SANS connectivite (137) : T0=16.09 T1=0.00 T2=2.65 — pondere **5.30**
...
**2 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0265).
