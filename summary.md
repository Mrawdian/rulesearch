...
genere 2026-08-28 09:28 UTC — 137293 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 53949 systemes
...
- moteur actif `0caa9267db60` (93551 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 66263 | 32916 | 4543 | 2251 | 6625 | 5282 | 6979 | 6812 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 64915 | 15018 | 27458 | 30 | 9044 | 3350 | 28 | 9985 | 15.4% |
...
- candidats SANS connectivite : 10295, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7253 systemes avec CONNECTED sur 56573 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12944 candidats sur 17234 portent les champs bruts (75%).*

- `5c556c16ea8b` — 6979 candidats
  - AVEC connectivite (2811) : resistance **41.5%**
  - SANS connectivite (4168) : resistance **21.8%**
...
- `5c556c16ea8b` — 6979 candidats
  ...
  - SANS connectivite (4168) : T0=15.87 T1=0.00 T2=2.68 — pondere **5.35**
...
- TROP-CHER : 7291 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7253 avec CONNECTED, 38 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 54072 systemes
  - sans CONNECTED : 0.0% sur 12191 systemes
