...
genere 2026-08-26 17:07 UTC — 55265 systemes evalues
...
- moteur actif `0caa9267db60` (11523 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
| connect | 4 | 3 | 24833 | 12401 | 1687 | 842 | 2457 | 1955 | 2649 | 2531 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 24317 | 5626 | 10285 | 14 | 3401 | 1235 | 10 | 3746 | 15.4% |
...
- candidats AVEC connectivite : 2658, dont T2 : 100%
- candidats SANS connectivite : 4056, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2923 systemes avec CONNECTED sur 22806 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2424 candidats sur 6714 portent les champs bruts (36%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 114 candidats
  - AVEC connectivite (44) : resistance **40.5%**
  - SANS connectivite (70) : resistance **21.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `23303c299f39` — 114 candidats
  - AVEC connectivite (44) : T0=12.73 T1=0.00 T2=2.93 — pondere **5.86**
  - SANS connectivite (70) : T0=16.77 T1=0.00 T2=2.71 — pondere **5.43**
  - test de permutation : **p = 0.5572** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 2943 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2923 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 20305 systemes
  - sans CONNECTED : 0.0% sur 4528 systemes
