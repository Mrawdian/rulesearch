...
genere 2026-08-28 06:00 UTC — 131219 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 47875 systemes
...
- moteur actif `0caa9267db60` (87477 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 63196 | 31415 | 4337 | 2144 | 6315 | 5036 | 6641 | 6493 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 61908 | 14322 | 26232 | 29 | 8604 | 3196 | 28 | 9495 | 15.3% |
...
- candidats SANS connectivite : 9805, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6915 systemes avec CONNECTED sur 54059 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12135 candidats sur 16425 portent les champs bruts (74%).*

- `5c556c16ea8b` — 6170 candidats
  - AVEC connectivite (2492) : resistance **41.5%**
  - SANS connectivite (3678) : resistance **22.0%**
...
- `5c556c16ea8b` — 6170 candidats
  ...
  - SANS connectivite (3678) : T0=15.86 T1=0.00 T2=2.69 — pondere **5.37**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 51558 systemes
  - sans CONNECTED : 0.0% sur 11638 systemes
