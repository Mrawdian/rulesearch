...
genere 2026-08-26 13:59 UTC — 47931 systemes evalues
...
- moteur actif `0caa9267db60` (4189 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21126 | 10545 | 1401 | 729 | 2093 | 1681 | 2255 | 2158 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20690 | 4830 | 8732 | 13 | 2871 | 1071 | 7 | 3166 | 15.3% |
...
- candidats AVEC connectivite : 2285, dont T2 : 100%
- candidats SANS connectivite : 3476, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2529 systemes avec CONNECTED sur 19756 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1471 candidats sur 5761 portent les champs bruts (26%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 356 candidats
  - AVEC connectivite (147) : resistance **39.7%**
  - SANS connectivite (209) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 356 candidats
  - AVEC connectivite (147) : T0=13.39 T1=0.00 T2=2.93 — pondere **5.85**
  - SANS connectivite (209) : T0=16.10 T1=0.00 T2=2.69 — pondere **5.38**
...
- TROP-CHER : 2546 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2529 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17255 systemes
  - sans CONNECTED : 0.0% sur 3871 systemes
