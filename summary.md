...
genere 2026-08-27 07:19 UTC — 86861 systemes evalues
...
- moteur actif `0caa9267db60` (43119 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 40791 | 20308 | 2791 | 1388 | 4087 | 3206 | 4301 | 4184 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 39955 | 9208 | 16981 | 22 | 5545 | 2085 | 21 | 6093 | 15.2% |
...
- candidats AVEC connectivite : 4311, dont T2 : 100%
- candidats SANS connectivite : 6403, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4575 systemes avec CONNECTED sur 35831 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6424 candidats sur 10714 portent les champs bruts (60%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 459 candidats
  - AVEC connectivite (183) : resistance **41.5%**
  - SANS connectivite (276) : resistance **20.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 459 candidats
  - AVEC connectivite (183) : T0=13.03 T1=0.00 T2=3.05 — pondere **6.10**
  - SANS connectivite (276) : T0=15.79 T1=0.00 T2=2.61 — pondere **5.22**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 33330 systemes
  - sans CONNECTED : 0.0% sur 7461 systemes
