...
genere 2026-08-28 17:17 UTC — 150747 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 67403 systemes
...
- moteur actif `0caa9267db60` (107005 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 73041 | 36265 | 4985 | 2496 | 7331 | 5818 | 7719 | 7493 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 71591 | 16643 | 30256 | 33 | 9885 | 3691 | 31 | 11049 | 15.4% |
...
- candidats SANS connectivite : 11359, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7993 systemes avec CONNECTED sur 62085 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*14689 candidats sur 18979 portent les champs bruts (77%).*

- `5c556c16ea8b` — 8724 candidats
  - AVEC connectivite (3492) : resistance **41.1%**
  - SANS connectivite (5232) : resistance **21.7%**
...
- `5c556c16ea8b` — 8724 candidats
  ...
  - SANS connectivite (5232) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.36**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 59584 systemes
  - sans CONNECTED : 0.0% sur 13457 systemes
