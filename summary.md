...
genere 2026-08-26 13:39 UTC — 47205 systemes evalues
...
- moteur actif `0caa9267db60` (3463 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20767 | 10365 | 1372 | 719 | 2066 | 1650 | 2211 | 2126 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20323 | 4752 | 8590 | 13 | 2816 | 1048 | 7 | 3097 | 15.2% |
...
- candidats AVEC connectivite : 2253, dont T2 : 100%
- candidats SANS connectivite : 3407, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2485 systemes avec CONNECTED sur 19460 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1370 candidats sur 5660 portent les champs bruts (24%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 255 candidats
  - AVEC connectivite (115) : resistance **38.5%**
  - SANS connectivite (140) : resistance **21.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 255 candidats
  - AVEC connectivite (115) : T0=13.41 T1=0.00 T2=2.77 — pondere **5.55**
  - SANS connectivite (140) : T0=16.25 T1=0.00 T2=2.78 — pondere **5.56**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 16959 systemes
  - sans CONNECTED : 0.0% sur 3808 systemes
