...
genere 2026-08-26 03:33 UTC — 21151 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 12177 systemes
...
| connect | 4 | 3 | 10626 | 5348 | 696 | 367 | 1018 | 844 | 1150 | 1067 | 10.0% |
| ref | 4 | 3 | 10401 | 2489 | 4384 | 5 | 1396 | 526 | 4 | 1597 | 15.4% |
...
- candidats AVEC connectivite : 1070, dont T2 : 100%
- candidats SANS connectivite : 1601, dont T2 : 100%
...
- **1150 systemes avec CONNECTED sur 8776 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1506 candidats
  - AVEC connectivite (591) : T0=13.37 T1=0.00 T2=2.86 — pondere **5.72**
  - SANS connectivite (915) : T0=15.80 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 1154 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1150 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 8719 systemes
  - sans CONNECTED : 0.0% sur 1907 systemes
