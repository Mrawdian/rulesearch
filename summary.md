...
genere 2026-08-28 10:04 UTC — 138417 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 55073 systemes
...
- moteur actif `0caa9267db60` (94675 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 66830 | 33204 | 4582 | 2273 | 6691 | 5332 | 7036 | 6856 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 65472 | 15142 | 27676 | 30 | 9125 | 3382 | 28 | 10086 | 15.4% |
...
- candidats SANS connectivite : 10396, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7310 systemes avec CONNECTED sur 57019 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*13089 candidats sur 17379 portent les champs bruts (75%).*

- `5c556c16ea8b` — 7124 candidats
  - AVEC connectivite (2855) : resistance **41.4%**
  - SANS connectivite (4269) : resistance **21.8%**
...
- `5c556c16ea8b` — 7124 candidats
  ...
  - SANS connectivite (4269) : T0=15.87 T1=0.00 T2=2.68 — pondere **5.35**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 54518 systemes
  - sans CONNECTED : 0.0% sur 12312 systemes
