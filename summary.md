...
genere 2026-08-26 18:49 UTC — 59335 systemes evalues
...
- moteur actif `0caa9267db60` (15593 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 26897 | 13418 | 1832 | 908 | 2671 | 2125 | 2858 | 2750 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 26323 | 6071 | 11145 | 15 | 3671 | 1356 | 10 | 4055 | 15.4% |
...
- candidats AVEC connectivite : 2877, dont T2 : 100%
- candidats SANS connectivite : 4365, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3132 systemes avec CONNECTED sur 24501 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2952 candidats sur 7242 portent les champs bruts (41%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 83 candidats
  - AVEC connectivite (33) : resistance **46.8%**
  - SANS connectivite (50) : resistance **16.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 83 candidats
  - AVEC connectivite (33) : T0=13.15 T1=0.00 T2=3.30 — pondere **6.61**
  - SANS connectivite (50) : T0=16.38 T1=0.00 T2=2.46 — pondere **4.92**
...
**6 serie(s) reproductible(s) sur 12 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0060), `62448a55927e` (p=0.0200), `b71bb0907fb5` (p=0.0110).
...
- TROP-CHER : 3152 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3132 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22000 systemes
  - sans CONNECTED : 0.0% sur 4897 systemes
