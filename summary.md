...
genere 2026-09-01 06:40 UTC — 275226 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 191882 systemes
...
- moteur actif `0caa9267db60` (231484 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 135918 | 67529 | 9194 | 4550 | 13795 | 10748 | 14361 | 13978 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 133193 | 31033 | 56287 | 58 | 18477 | 6887 | 60 | 20381 | 15.3% |
...
- candidats SANS connectivite : 20691, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14635 systemes avec CONNECTED sur 113397 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*30506 candidats sur 34796 portent les champs bruts (88%).*

- `5c556c16ea8b` — 24541 candidats
  - AVEC connectivite (9977) : resistance **41.0%**
  - SANS connectivite (14564) : resistance **21.3%**
...
- `5c556c16ea8b` — 24541 candidats
  ...
  - SANS connectivite (14564) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 14705 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14635 avec CONNECTED, 70 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 110896 systemes
  - sans CONNECTED : 0.0% sur 25022 systemes
