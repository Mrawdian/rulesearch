...
genere 2026-08-25 20:21 UTC — 2781 systemes evalues

## versions du DSL presentes
- `615abe43d6bc` : 1804 systemes
...
| connect | 4 | 3 | 1358 | 692 | 96 | 54 | 143 | 103 | 125 | 129 | 9.5% |
| ref | 4 | 3 | 1299 | 306 | 562 | 0 | 171 | 56 | 1 | 203 | 15.6% |
...
- candidats AVEC connectivite : 132, dont T2 : 100%
- candidats SANS connectivite : 207, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **125 systemes avec CONNECTED sur 1166 (10.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- TROP-CHER : 126 systemes abandonnes (4.5% des systemes), 95% du temps total
  dont 125 avec CONNECTED, 1 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 11.3% sur 1109 systemes
  - sans CONNECTED : 0.0% sur 249 systemes
