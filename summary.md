...
genere 2026-08-27 02:51 UTC — 77052 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 12145 systemes
...
- moteur actif `0caa9267db60` (33310 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 35857 | 17852 | 2466 | 1214 | 3552 | 2835 | 3808 | 3667 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 35080 | 8090 | 14918 | 20 | 4850 | 1836 | 19 | 5347 | 15.2% |
...
- candidats AVEC connectivite : 3794, dont T2 : 100%
- candidats SANS connectivite : 5657, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4082 systemes avec CONNECTED sur 31857 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5161 candidats sur 9451 portent les champs bruts (55%).*
...
- `ab89a63b01ef` — 1484 candidats
  - AVEC connectivite (614) : resistance **41.2%**
  - SANS connectivite (870) : resistance **22.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1484 candidats
  - AVEC connectivite (614) : T0=13.01 T1=0.00 T2=3.05 — pondere **6.09**
  - SANS connectivite (870) : T0=15.96 T1=0.00 T2=2.71 — pondere **5.41**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- TROP-CHER : 4111 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4082 avec CONNECTED, 29 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 29356 systemes
  - sans CONNECTED : 0.0% sur 6501 systemes
