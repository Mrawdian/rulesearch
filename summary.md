...
genere 2026-09-03 04:14 UTC — 329068 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 245724 systemes
...
- moteur actif `0caa9267db60` (285326 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 163089 | 81026 | 11082 | 5458 | 16601 | 12857 | 17286 | 16694 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 159864 | 37243 | 67573 | 65 | 22156 | 8262 | 65 | 24488 | 15.3% |
...
- candidats SANS connectivite : 24798, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **17560 systemes avec CONNECTED sur 135552 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*37329 candidats sur 41619 portent les champs bruts (90%).*

- `5c556c16ea8b` — 31364 candidats
  - AVEC connectivite (12693) : resistance **41.1%**
  - SANS connectivite (18671) : resistance **21.2%**
...
- `5c556c16ea8b` — 31364 candidats
  ...
  - SANS connectivite (18671) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 133051 systemes
  - sans CONNECTED : 0.0% sur 30038 systemes
