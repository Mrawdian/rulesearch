...
genere 2026-08-26 22:34 UTC — 67541 systemes evalues
...
- moteur actif `0caa9267db60` (23799 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 31039 | 15413 | 2125 | 1041 | 3091 | 2473 | 3311 | 3190 | 10.3% |
...
- candidats AVEC connectivite : 3317, dont T2 : 100%
- candidats SANS connectivite : 4970, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3585 systemes avec CONNECTED sur 27877 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3997 candidats sur 8287 portent les champs bruts (48%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 320 candidats
  - AVEC connectivite (137) : resistance **42.5%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 320 candidats
  - AVEC connectivite (137) : T0=12.82 T1=0.00 T2=3.07 — pondere **6.13**
  - SANS connectivite (183) : T0=16.19 T1=0.00 T2=2.81 — pondere **5.62**
  - test de permutation : **p = 0.1439** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 25376 systemes
  - sans CONNECTED : 0.0% sur 5663 systemes
