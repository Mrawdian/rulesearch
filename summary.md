...
genere 2026-09-03 20:14 UTC — 346962 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 263618 systemes
...
- moteur actif `0caa9267db60` (303220 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 172127 | 85564 | 11685 | 5761 | 17530 | 13570 | 18238 | 17587 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 168720 | 39228 | 71335 | 67 | 23395 | 8729 | 66 | 25887 | 15.3% |
...
- candidats AVEC connectivite : 17714, dont T2 : 100%
- candidats SANS connectivite : 26197, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18512 systemes avec CONNECTED sur 142935 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39621 candidats sur 43911 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33656 candidats
  - AVEC connectivite (13586) : resistance **41.0%**
  - SANS connectivite (20070) : resistance **21.2%**
...
- `5c556c16ea8b` — 33656 candidats
  - AVEC connectivite (13586) : T0=13.03 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (20070) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.29**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 140434 systemes
  - sans CONNECTED : 0.0% sur 31693 systemes
