...
genere 2026-08-26 14:01 UTC — 47991 systemes evalues
...
- moteur actif `0caa9267db60` (4249 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21156 | 10559 | 1405 | 729 | 2097 | 1683 | 2260 | 2159 | 10.2% |
...
- candidats AVEC connectivite : 2286, dont T2 : 100%
- candidats SANS connectivite : 3482, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2534 systemes avec CONNECTED sur 19780 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1478 candidats sur 5768 portent les champs bruts (26%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 363 candidats
  - AVEC connectivite (148) : resistance **39.5%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 363 candidats
  - AVEC connectivite (148) : T0=13.38 T1=0.00 T2=2.91 — pondere **5.82**
...
- TROP-CHER : 2551 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2534 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17279 systemes
  - sans CONNECTED : 0.0% sur 3877 systemes
