...
genere 2026-08-25 21:03 UTC — 4650 systemes evalues

## versions du DSL presentes
- `615abe43d6bc` : 3673 systemes
...
| connect | 4 | 3 | 2299 | 1159 | 160 | 76 | 233 | 174 | 228 | 243 | 10.6% |
...
- candidats AVEC connectivite : 246, dont T2 : 100%
- candidats SANS connectivite : 356, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **228 systemes avec CONNECTED sur 1936 (11.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- TROP-CHER : 229 systemes abandonnes (4.9% des systemes), 95% du temps total
  dont 228 avec CONNECTED, 1 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.1% sur 1879 systemes
  - sans CONNECTED : 0.0% sur 420 systemes
