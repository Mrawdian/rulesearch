...
genere 2026-08-27 02:31 UTC — 76211 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 11304 systemes
...
- moteur actif `0caa9267db60` (32469 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 35423 | 17626 | 2435 | 1201 | 3513 | 2807 | 3771 | 3614 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 34673 | 7987 | 14747 | 20 | 4803 | 1814 | 19 | 5283 | 15.2% |
...
- candidats AVEC connectivite : 3741, dont T2 : 100%
- candidats SANS connectivite : 5593, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4045 systemes avec CONNECTED sur 31490 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5044 candidats sur 9334 portent les champs bruts (54%).*
...
- `ab89a63b01ef` — 1367 candidats
  - AVEC connectivite (561) : resistance **41.0%**
  - SANS connectivite (806) : resistance **22.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1367 candidats
  - AVEC connectivite (561) : T0=13.03 T1=0.00 T2=3.03 — pondere **6.06**
  - SANS connectivite (806) : T0=15.91 T1=0.00 T2=2.69 — pondere **5.38**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 28989 systemes
  - sans CONNECTED : 0.0% sur 6434 systemes
