...
| connect | 4 | 3 | 5019 | 2516 | 316 | 177 | 489 | 410 | 523 | 530 | 10.6% |
| ref | 4 | 3 | 4911 | 1191 | 2062 | 1 | 647 | 236 | 2 | 772 | 15.7% |
...
- candidats AVEC connectivite : 533, dont T2 : 100%
- candidats SANS connectivite : 776, dont T2 : 100%
...
- **523 systemes avec CONNECTED sur 4160 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 144 candidats
  - AVEC connectivite (54) : T0=12.91 T1=0.00 T2=2.91 — pondere **5.81**
  - SANS connectivite (90) : T0=16.26 T1=0.00 T2=2.82 — pondere **5.64**
...
- TROP-CHER : 525 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 523 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 4103 systemes
  - sans CONNECTED : 0.0% sur 916 systemes
