...
genere 2026-08-27 06:34 UTC — 85222 systemes evalues
...
- moteur actif `0caa9267db60` (41480 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 39973 | 19918 | 2736 | 1359 | 3978 | 3145 | 4221 | 4100 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 39134 | 9012 | 16651 | 22 | 5421 | 2042 | 21 | 5965 | 15.2% |
...
- candidats AVEC connectivite : 4227, dont T2 : 100%
- candidats SANS connectivite : 6275, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4495 systemes avec CONNECTED sur 35192 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6212 candidats sur 10502 portent les champs bruts (59%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 247 candidats
  - AVEC connectivite (99) : resistance **42.5%**
  - SANS connectivite (148) : resistance **21.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 247 candidats
  - AVEC connectivite (99) : T0=12.83 T1=0.00 T2=3.10 — pondere **6.20**
  - SANS connectivite (148) : T0=15.82 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 32691 systemes
  - sans CONNECTED : 0.0% sur 7282 systemes
