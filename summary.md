...
genere 2026-09-03 20:35 UTC — 347363 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 264019 systemes
...
- moteur actif `0caa9267db60` (303621 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 172336 | 85662 | 11702 | 5768 | 17551 | 13587 | 18256 | 17617 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 168912 | 39283 | 71402 | 67 | 23420 | 8738 | 66 | 25923 | 15.3% |
...
- candidats AVEC connectivite : 17744, dont T2 : 100%
- candidats SANS connectivite : 26233, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18530 systemes avec CONNECTED sur 143102 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39687 candidats sur 43977 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33722 candidats
  - AVEC connectivite (13616) : resistance **41.0%**
  - SANS connectivite (20106) : resistance **21.2%**
...
- `5c556c16ea8b` — 33722 candidats
  - AVEC connectivite (13616) : T0=13.03 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (20106) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.29**
...
## cout
- temps total 107.8 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 18606 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18530 avec CONNECTED, 76 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 140601 systemes
  - sans CONNECTED : 0.0% sur 31735 systemes
