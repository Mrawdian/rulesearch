...
genere 2026-09-01 07:00 UTC — 275610 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 192266 systemes
...
- moteur actif `0caa9267db60` (231868 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 136112 | 67631 | 9207 | 4552 | 13811 | 10762 | 14387 | 13997 | 10.3% |
...
- candidats AVEC connectivite : 14124, dont T2 : 100%
...
- **14661 systemes avec CONNECTED sur 113561 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*30554 candidats sur 34844 portent les champs bruts (88%).*

- `5c556c16ea8b` — 24589 candidats
  - AVEC connectivite (9996) : resistance **41.0%**
...
- `5c556c16ea8b` — 24589 candidats
  - AVEC connectivite (9996) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 14731 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14661 avec CONNECTED, 70 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 111060 systemes
