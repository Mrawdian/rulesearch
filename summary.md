...
genere 2026-08-31 04:17 UTC — 240578 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 157234 systemes
...
- moteur actif `0caa9267db60` (196836 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 118436 | 58922 | 8048 | 3976 | 11887 | 9330 | 12541 | 12187 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 116027 | 27089 | 49029 | 53 | 16022 | 5986 | 52 | 17786 | 15.3% |
...
- candidats SANS connectivite : 18096, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12815 systemes avec CONNECTED sur 99234 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*26120 candidats sur 30410 portent les champs bruts (86%).*

- `5c556c16ea8b` — 20155 candidats
  - AVEC connectivite (8186) : resistance **41.0%**
  - SANS connectivite (11969) : resistance **21.4%**
...
- `5c556c16ea8b` — 20155 candidats
  ...
  - SANS connectivite (11969) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 96733 systemes
  - sans CONNECTED : 0.0% sur 21703 systemes
