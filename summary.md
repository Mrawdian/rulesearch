...
genere 2026-08-26 19:01 UTC — 59836 systemes evalues
...
- moteur actif `0caa9267db60` (16094 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27150 | 13550 | 1845 | 913 | 2693 | 2149 | 2880 | 2781 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 26571 | 6138 | 11252 | 15 | 3699 | 1369 | 10 | 4088 | 15.4% |
...
- candidats AVEC connectivite : 2908, dont T2 : 100%
- candidats SANS connectivite : 4398, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3154 systemes avec CONNECTED sur 24706 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3016 candidats sur 7306 portent les champs bruts (41%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 147 candidats
  - AVEC connectivite (64) : resistance **40.2%**
  - SANS connectivite (83) : resistance **18.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 147 candidats
  - AVEC connectivite (64) : T0=13.12 T1=0.00 T2=2.94 — pondere **5.88**
  - SANS connectivite (83) : T0=15.98 T1=0.00 T2=2.55 — pondere **5.11**
  - test de permutation : **p = 0.1664** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 3174 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3154 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22205 systemes
  - sans CONNECTED : 0.0% sur 4945 systemes
