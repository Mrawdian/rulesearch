...
genere 2026-08-28 05:27 UTC — 130322 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 46978 systemes
...
- moteur actif `0caa9267db60` (86580 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 62736 | 31201 | 4310 | 2128 | 6263 | 4994 | 6583 | 6446 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 61471 | 14219 | 26036 | 29 | 8550 | 3179 | 27 | 9429 | 15.3% |
...
- candidats AVEC connectivite : 6573, dont T2 : 100%
- candidats SANS connectivite : 9739, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6857 systemes avec CONNECTED sur 53691 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12022 candidats sur 16312 portent les champs bruts (74%).*

- `5c556c16ea8b` — 6057 candidats
  - AVEC connectivite (2445) : resistance **41.6%**
...
- `5c556c16ea8b` — 6057 candidats
  - AVEC connectivite (2445) : T0=12.98 T1=0.00 T2=3.03 — pondere **6.05**
...
- TROP-CHER : 6894 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6857 avec CONNECTED, 37 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 51190 systemes
  - sans CONNECTED : 0.0% sur 11546 systemes
