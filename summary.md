...
genere 2026-08-31 20:54 UTC — 262912 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 179568 systemes
...
- moteur actif `0caa9267db60` (219170 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 129709 | 64483 | 8764 | 4351 | 13133 | 10254 | 13675 | 13360 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 127088 | 29625 | 53664 | 56 | 17625 | 6565 | 57 | 19486 | 15.3% |
...
- candidats AVEC connectivite : 13487, dont T2 : 100%
- candidats SANS connectivite : 19796, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13949 systemes avec CONNECTED sur 108339 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*28993 candidats sur 33283 portent les champs bruts (87%).*

- `5c556c16ea8b` — 23028 candidats
  - AVEC connectivite (9359) : resistance **41.0%**
  - SANS connectivite (13669) : resistance **21.3%**
...
- `5c556c16ea8b` — 23028 candidats
  - AVEC connectivite (9359) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.97**
  - SANS connectivite (13669) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 14016 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13949 avec CONNECTED, 67 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 105838 systemes
  - sans CONNECTED : 0.0% sur 23871 systemes
