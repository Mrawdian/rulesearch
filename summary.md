...
genere 2026-08-26 01:42 UTC — 16622 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 7648 systemes
...
| connect | 4 | 3 | 8341 | 4198 | 544 | 284 | 793 | 668 | 889 | 864 | 10.4% |
...
- candidats AVEC connectivite : 867, dont T2 : 100%
...
- **889 systemes avec CONNECTED sur 6906 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 973 candidats
  - AVEC connectivite (388) : T0=13.37 T1=0.00 T2=2.85 — pondere **5.70**
...
- TROP-CHER : 892 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 889 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 6849 systemes
  - sans CONNECTED : 0.0% sur 1492 systemes
