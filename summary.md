...
genere 2026-08-26 22:16 UTC — 66935 systemes evalues
...
- moteur actif `0caa9267db60` (23193 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 30079 | 6933 | 12778 | 18 | 4161 | 1554 | 14 | 4621 | 15.4% |
...
- candidats SANS connectivite : 4931, dont T2 : 100%
...
*3921 candidats sur 8211 portent les champs bruts (48%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 244 candidats
  - AVEC connectivite (100) : resistance **42.9%**
  - SANS connectivite (144) : resistance **22.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 244 candidats
  ...
  - SANS connectivite (144) : T0=16.15 T1=0.00 T2=2.76 — pondere **5.53**
  - test de permutation : **p = 0.1739** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
