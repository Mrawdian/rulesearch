...
| connect | 4 | 3 | 17664 | 8834 | 1140 | 612 | 1756 | 1405 | 1918 | 1778 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 17281 | 4064 | 7308 | 12 | 2364 | 878 | 7 | 2648 | 15.3% |
...
- candidats AVEC connectivite : 1905, dont T2 : 100%
- candidats SANS connectivite : 2958, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2192 systemes avec CONNECTED sur 16925 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*573 candidats sur 4863 portent les champs bruts (12%).*
...
- `e3baecf8377b` — 309 candidats
  - AVEC connectivite (122) : resistance **43.8%**
...
- `e3baecf8377b` — 309 candidats
  - AVEC connectivite (122) : T0=12.98 T1=0.00 T2=3.15 — pondere **6.30**
  - SANS connectivite (187) : T0=16.09 T1=0.00 T2=2.68 — pondere **5.36**
...
- TROP-CHER : 2209 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2192 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14424 systemes
  - sans CONNECTED : 0.0% sur 3240 systemes
