...
genere 2026-08-27 20:23 UTC — 112796 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 29452 systemes
...
- moteur actif `0caa9267db60` (69054 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 53883 | 26829 | 3729 | 1834 | 5320 | 4269 | 5700 | 5499 | 10.2% |
...
- candidats AVEC connectivite : 5626, dont T2 : 100%
- candidats SANS connectivite : 8384, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5974 systemes avec CONNECTED sur 46529 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*9720 candidats sur 14010 portent les champs bruts (69%).*
...
- `5c556c16ea8b` — 3755 candidats
  - AVEC connectivite (1498) : resistance **42.0%**
...
- `5c556c16ea8b` — 3755 candidats
  - AVEC connectivite (1498) : T0=12.93 T1=0.00 T2=3.05 — pondere **6.11**
...
- TROP-CHER : 6009 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 5974 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 44028 systemes
  - sans CONNECTED : 0.0% sur 9855 systemes
