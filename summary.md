...
genere 2026-09-01 18:12 UTC — 289547 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 206203 systemes
...
- moteur actif `0caa9267db60` (245805 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 143155 | 71131 | 9713 | 4787 | 14543 | 11295 | 15121 | 14716 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 140277 | 32619 | 59341 | 59 | 19445 | 7253 | 63 | 21486 | 15.3% |
...
- candidats AVEC connectivite : 14843, dont T2 : 100%
- candidats SANS connectivite : 21796, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15395 systemes avec CONNECTED sur 119308 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*32349 candidats sur 36639 portent les champs bruts (88%).*

- `5c556c16ea8b` — 26384 candidats
  - AVEC connectivite (10715) : resistance **41.0%**
  - SANS connectivite (15669) : resistance **21.3%**
...
- `5c556c16ea8b` — 26384 candidats
  - AVEC connectivite (10715) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (15669) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 15468 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15395 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 116807 systemes
  - sans CONNECTED : 0.0% sur 26348 systemes
