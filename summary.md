...
genere 2026-09-05 14:17 UTC — 391161 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 307817 systemes
...
- moteur actif `0caa9267db60` (347419 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 194453 | 96579 | 13238 | 6477 | 19772 | 15304 | 20625 | 19983 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 190593 | 44366 | 80440 | 78 | 26522 | 9855 | 71 | 29247 | 15.3% |
...
- candidats AVEC connectivite : 20110, dont T2 : 100%
- candidats SANS connectivite : 29557, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20899 systemes avec CONNECTED sur 161117 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*45377 candidats sur 49667 portent les champs bruts (91%).*

- `5c556c16ea8b` — 39412 candidats
  - AVEC connectivite (15982) : resistance **41.0%**
  - SANS connectivite (23430) : resistance **21.3%**
...
- `5c556c16ea8b` — 39412 candidats
  - AVEC connectivite (15982) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.94**
  - SANS connectivite (23430) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 158616 systemes
  - sans CONNECTED : 0.0% sur 35837 systemes
