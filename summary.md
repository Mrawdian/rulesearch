...
genere 2026-09-05 13:41 UTC — 390570 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 307226 systemes
...
- moteur actif `0caa9267db60` (346828 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 194153 | 96429 | 13220 | 6465 | 19742 | 15283 | 20589 | 19951 | 10.3% |
...
- candidats AVEC connectivite : 20078, dont T2 : 100%
...
- **20863 systemes avec CONNECTED sur 160869 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*45294 candidats sur 49584 portent les champs bruts (91%).*

- `5c556c16ea8b` — 39329 candidats
  - AVEC connectivite (15950) : resistance **41.0%**
...
- `5c556c16ea8b` — 39329 candidats
  - AVEC connectivite (15950) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.94**
...
- TROP-CHER : 20944 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 20863 avec CONNECTED, 81 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 158368 systemes
  - sans CONNECTED : 0.0% sur 35785 systemes
