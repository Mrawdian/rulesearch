...
genere 2026-08-26 19:06 UTC — 60027 systemes evalues
...
- moteur actif `0caa9267db60` (16285 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27240 | 13597 | 1851 | 919 | 2700 | 2155 | 2890 | 2787 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 26672 | 6158 | 11291 | 15 | 3718 | 1374 | 10 | 4106 | 15.4% |
...
- candidats AVEC connectivite : 2914, dont T2 : 100%
- candidats SANS connectivite : 4416, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3164 systemes avec CONNECTED sur 24785 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3040 candidats sur 7330 portent les champs bruts (41%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 171 candidats
  - AVEC connectivite (70) : resistance **40.4%**
  - SANS connectivite (101) : resistance **18.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 171 candidats
  - AVEC connectivite (70) : T0=13.13 T1=0.00 T2=2.94 — pondere **5.89**
  - SANS connectivite (101) : T0=16.05 T1=0.00 T2=2.61 — pondere **5.23**
...
- TROP-CHER : 3184 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3164 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22284 systemes
  - sans CONNECTED : 0.0% sur 4956 systemes
