...
genere 2026-09-02 06:08 UTC — 303675 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 220331 systemes
...
- moteur actif `0caa9267db60` (259933 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 150278 | 74648 | 10216 | 5037 | 15250 | 11828 | 15921 | 15453 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 147282 | 34274 | 62315 | 62 | 20385 | 7605 | 63 | 22566 | 15.3% |
...
- candidats AVEC connectivite : 15580, dont T2 : 100%
- candidats SANS connectivite : 22876, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16195 systemes avec CONNECTED sur 125183 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*34166 candidats sur 38456 portent les champs bruts (89%).*

- `5c556c16ea8b` — 28201 candidats
  - AVEC connectivite (11452) : resistance **41.1%**
  - SANS connectivite (16749) : resistance **21.3%**
...
- `5c556c16ea8b` — 28201 candidats
  - AVEC connectivite (11452) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (16749) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.30**
...
## cout
- temps total 94.2 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 16268 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16195 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 122682 systemes
  - sans CONNECTED : 0.0% sur 27596 systemes
