...
| connect | 4 | 3 | 16990 | 8483 | 1095 | 588 | 1690 | 1352 | 1854 | 1714 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 16646 | 3921 | 7052 | 11 | 2267 | 841 | 7 | 2547 | 15.3% |
...
- candidats AVEC connectivite : 1841, dont T2 : 100%
- candidats SANS connectivite : 2857, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2128 systemes avec CONNECTED sur 16387 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*408 candidats sur 4698 portent les champs bruts (9%).*
...
- `e3baecf8377b` — 144 candidats
  - AVEC connectivite (58) : resistance **41.1%**
  - SANS connectivite (86) : resistance **20.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 144 candidats
  - AVEC connectivite (58) : T0=13.36 T1=0.00 T2=3.07 — pondere **6.14**
  - SANS connectivite (86) : T0=15.69 T1=0.00 T2=2.55 — pondere **5.09**
...
- TROP-CHER : 2145 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2128 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.4% sur 13886 systemes
  - sans CONNECTED : 0.0% sur 3104 systemes
