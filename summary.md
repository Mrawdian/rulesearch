...
genere 2026-08-27 14:04 UTC — 100511 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 18378 systemes
- `5c556c16ea8b` : 17167 systemes
...
- moteur actif `0caa9267db60` (56769 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 47678 | 23764 | 3270 | 1632 | 4730 | 3769 | 5040 | 4857 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 46718 | 10813 | 19828 | 25 | 6466 | 2440 | 22 | 7123 | 15.2% |
...
- candidats AVEC connectivite : 4984, dont T2 : 100%
- candidats SANS connectivite : 7433, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5314 systemes avec CONNECTED sur 41467 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*8127 candidats sur 12417 portent les champs bruts (65%).*
...
- `ab89a63b01ef` — 2280 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 2162 candidats
  - AVEC connectivite (856) : resistance **41.9%**
  - SANS connectivite (1306) : resistance **22.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 2280 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 2162 candidats
  - AVEC connectivite (856) : T0=13.01 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (1306) : T0=15.76 T1=0.00 T2=2.68 — pondere **5.35**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 38966 systemes
  - sans CONNECTED : 0.0% sur 8712 systemes
