...
genere 2026-08-27 02:10 UTC — 75440 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 10533 systemes
...
- moteur actif `0caa9267db60` (31698 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 35033 | 17424 | 2408 | 1186 | 3477 | 2781 | 3734 | 3575 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 34292 | 7898 | 14590 | 20 | 4758 | 1785 | 18 | 5223 | 15.2% |
...
- candidats AVEC connectivite : 3702, dont T2 : 100%
- candidats SANS connectivite : 5533, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4008 systemes avec CONNECTED sur 31164 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4945 candidats sur 9235 portent les champs bruts (54%).*
...
- `ab89a63b01ef` — 1268 candidats
  - AVEC connectivite (522) : resistance **41.2%**
  - SANS connectivite (746) : resistance **22.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1268 candidats
  - AVEC connectivite (522) : T0=13.02 T1=0.00 T2=3.05 — pondere **6.11**
  - SANS connectivite (746) : T0=15.91 T1=0.00 T2=2.70 — pondere **5.40**
...
- TROP-CHER : 4036 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4008 avec CONNECTED, 28 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 28663 systemes
  - sans CONNECTED : 0.0% sur 6370 systemes
