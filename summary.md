...
genere 2026-08-29 06:27 UTC — 173165 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 89821 systemes
...
- moteur actif `0caa9267db60` (129423 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 84378 | 42007 | 5737 | 2848 | 8465 | 6693 | 8864 | 8694 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 82672 | 19285 | 34959 | 39 | 11423 | 4205 | 34 | 12722 | 15.4% |
...
- candidats AVEC connectivite : 8821, dont T2 : 100%
- candidats SANS connectivite : 13032, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9138 systemes avec CONNECTED sur 71376 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*17563 candidats sur 21853 portent les champs bruts (80%).*

- `5c556c16ea8b` — 11598 candidats
  - AVEC connectivite (4693) : resistance **41.2%**
  - SANS connectivite (6905) : resistance **21.6%**
...
- `5c556c16ea8b` — 11598 candidats
  - AVEC connectivite (4693) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (6905) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.33**
...
- TROP-CHER : 9182 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 9138 avec CONNECTED, 44 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 68875 systemes
  - sans CONNECTED : 0.0% sur 15503 systemes
