...
genere 2026-08-27 17:18 UTC — 106991 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 23647 systemes
...
- moteur actif `0caa9267db60` (63249 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 49930 | 11546 | 21192 | 26 | 6895 | 2605 | 23 | 7641 | 15.3% |
...
- candidats SANS connectivite : 7951, dont T2 : 100%
...
*8969 candidats sur 13259 portent les champs bruts (68%).*
...
- `5c556c16ea8b` — 3004 candidats
  - AVEC connectivite (1180) : resistance **42.0%**
  - SANS connectivite (1824) : resistance **22.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 3004 candidats
  ...
  - SANS connectivite (1824) : T0=15.79 T1=0.00 T2=2.69 — pondere **5.38**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 2280 candidats
