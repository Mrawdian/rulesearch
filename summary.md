...
genere 2026-08-30 16:47 UTC — 224723 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 141379 systemes
...
- moteur actif `0caa9267db60` (180981 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 110434 | 54893 | 7503 | 3688 | 11125 | 8743 | 11672 | 11369 | 10.3% |
...
- candidats AVEC connectivite : 11496, dont T2 : 100%
...
- **11946 systemes avec CONNECTED sur 92625 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*24165 candidats sur 28455 portent les champs bruts (85%).*

- `5c556c16ea8b` — 18200 candidats
  - AVEC connectivite (7368) : resistance **41.1%**
...
- `5c556c16ea8b` — 18200 candidats
  - AVEC connectivite (7368) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.97**
...
- TROP-CHER : 12000 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11946 avec CONNECTED, 54 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 90124 systemes
  - sans CONNECTED : 0.0% sur 20310 systemes
