...
genere 2026-08-27 00:06 UTC — 70921 systemes evalues
...
- moteur actif `0caa9267db60` (27179 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 32760 | 16280 | 2250 | 1107 | 3260 | 2605 | 3494 | 3345 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 32046 | 7382 | 13602 | 18 | 4445 | 1679 | 15 | 4905 | 15.3% |
...
- candidats AVEC connectivite : 3472, dont T2 : 100%
- candidats SANS connectivite : 5215, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3768 systemes avec CONNECTED sur 29278 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4397 candidats sur 8687 portent les champs bruts (51%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 720 candidats
  - AVEC connectivite (292) : resistance **41.6%**
  - SANS connectivite (428) : resistance **21.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 720 candidats
  - AVEC connectivite (292) : T0=13.15 T1=0.00 T2=3.09 — pondere **6.17**
  - SANS connectivite (428) : T0=15.93 T1=0.00 T2=2.61 — pondere **5.21**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e3baecf8377b` — 657 candidats
...
- TROP-CHER : 3793 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3768 avec CONNECTED, 25 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 26777 systemes
  - sans CONNECTED : 0.0% sur 5983 systemes
