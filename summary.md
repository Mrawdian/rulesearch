...
genere 2026-08-27 01:02 UTC — 72997 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 9167 systemes
- `ab89a63b01ef` : 8090 systemes
...
- moteur actif `0caa9267db60` (29255 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 33807 | 16807 | 2327 | 1149 | 3354 | 2684 | 3602 | 3452 | 10.2% |
...
- candidats AVEC connectivite : 3579, dont T2 : 100%
- candidats SANS connectivite : 5352, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3876 systemes avec CONNECTED sur 30156 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4641 candidats sur 8931 portent les champs bruts (52%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 964 candidats
  - AVEC connectivite (399) : resistance **40.8%**
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 964 candidats
  - AVEC connectivite (399) : T0=13.08 T1=0.00 T2=3.04 — pondere **6.07**
...
- TROP-CHER : 3902 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3876 avec CONNECTED, 26 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 27655 systemes
  - sans CONNECTED : 0.0% sur 6152 systemes
