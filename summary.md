...
- moteur actif `0caa9267db60` (8418 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23267 | 11594 | 1579 | 790 | 2322 | 1845 | 2487 | 2359 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 22778 | 5268 | 9618 | 14 | 3196 | 1160 | 10 | 3512 | 15.4% |
...
- candidats AVEC connectivite : 2486, dont T2 : 100%
- candidats SANS connectivite : 3822, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2761 systemes avec CONNECTED sur 21492 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2018 candidats sur 6308 portent les champs bruts (32%).*
...
- `06fe04a859f1` — 903 candidats
  - AVEC connectivite (348) : resistance **41.3%**
  - SANS connectivite (555) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 903 candidats
  - AVEC connectivite (348) : T0=13.22 T1=0.00 T2=3.03 — pondere **6.06**
  - SANS connectivite (555) : T0=16.04 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 2781 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2761 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18991 systemes
  - sans CONNECTED : 0.0% sur 4276 systemes
