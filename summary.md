...
genere 2026-08-28 07:35 UTC — 134101 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 50757 systemes
...
- moteur actif `0caa9267db60` (90359 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 64646 | 32111 | 4437 | 2196 | 6484 | 5154 | 6791 | 6638 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 63340 | 14651 | 26810 | 29 | 8815 | 3275 | 28 | 9730 | 15.4% |
...
- candidats AVEC connectivite : 6765, dont T2 : 100%
- candidats SANS connectivite : 10040, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7065 systemes avec CONNECTED sur 55230 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12515 candidats sur 16805 portent les champs bruts (74%).*

- `5c556c16ea8b` — 6550 candidats
  - AVEC connectivite (2637) : resistance **41.4%**
  - SANS connectivite (3913) : resistance **21.9%**
...
- `5c556c16ea8b` — 6550 candidats
  - AVEC connectivite (2637) : T0=12.98 T1=0.00 T2=3.01 — pondere **6.03**
  - SANS connectivite (3913) : T0=15.85 T1=0.00 T2=2.68 — pondere **5.36**
...
- TROP-CHER : 7103 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7065 avec CONNECTED, 38 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 52729 systemes
  - sans CONNECTED : 0.0% sur 11917 systemes
