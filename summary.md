...
genere 2026-08-31 08:46 UTC — 246733 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 163389 systemes
...
- moteur actif `0caa9267db60` (202991 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 121543 | 60443 | 8246 | 4074 | 12228 | 9601 | 12851 | 12523 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 119075 | 27799 | 50273 | 53 | 16456 | 6157 | 54 | 18273 | 15.3% |
...
- candidats AVEC connectivite : 12650, dont T2 : 100%
- candidats SANS connectivite : 18583, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13125 systemes avec CONNECTED sur 101718 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*26943 candidats sur 31233 portent les champs bruts (86%).*

- `5c556c16ea8b` — 20978 candidats
  - AVEC connectivite (8522) : resistance **40.9%**
  - SANS connectivite (12456) : resistance **21.3%**
...
- `5c556c16ea8b` — 20978 candidats
  - AVEC connectivite (8522) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (12456) : T0=15.90 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 13189 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13125 avec CONNECTED, 64 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 99217 systemes
  - sans CONNECTED : 0.0% sur 22326 systemes
