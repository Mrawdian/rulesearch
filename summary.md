...
genere 2026-08-26 13:36 UTC — 47072 systemes evalues
...
- moteur actif `0caa9267db60` (3330 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20693 | 10321 | 1367 | 718 | 2063 | 1645 | 2205 | 2118 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20264 | 4740 | 8560 | 13 | 2809 | 1046 | 7 | 3089 | 15.2% |
...
- candidats AVEC connectivite : 2245, dont T2 : 100%
- candidats SANS connectivite : 3399, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2479 systemes avec CONNECTED sur 19393 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1354 candidats sur 5644 portent les champs bruts (24%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 239 candidats
  - AVEC connectivite (107) : resistance **38.4%**
  - SANS connectivite (132) : resistance **21.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 239 candidats
  - AVEC connectivite (107) : T0=13.55 T1=0.00 T2=2.76 — pondere **5.51**
  - SANS connectivite (132) : T0=16.21 T1=0.00 T2=2.78 — pondere **5.56**
  - test de permutation : **p = 0.9205** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
- TROP-CHER : 2496 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2479 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16892 systemes
  - sans CONNECTED : 0.0% sur 3801 systemes
