...
genere 2026-08-31 18:55 UTC — 260387 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 177043 systemes
...
- moteur actif `0caa9267db60` (216645 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 128445 | 63852 | 8687 | 4309 | 12993 | 10155 | 13537 | 13233 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 125827 | 29320 | 53123 | 56 | 17432 | 6507 | 56 | 19323 | 15.4% |
...
- candidats AVEC connectivite : 13360, dont T2 : 100%
- candidats SANS connectivite : 19633, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13811 systemes avec CONNECTED sur 107300 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*28703 candidats sur 32993 portent les champs bruts (87%).*

- `5c556c16ea8b` — 22738 candidats
  - AVEC connectivite (9232) : resistance **41.0%**
  - SANS connectivite (13506) : resistance **21.4%**
...
- `5c556c16ea8b` — 22738 candidats
  - AVEC connectivite (9232) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (13506) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 13877 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13811 avec CONNECTED, 66 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 104799 systemes
  - sans CONNECTED : 0.0% sur 23646 systemes
