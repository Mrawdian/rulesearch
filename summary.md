...
genere 2026-08-27 08:38 UTC — 89633 systemes evalues
...
- moteur actif `0caa9267db60` (45891 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 42197 | 21013 | 2902 | 1428 | 4210 | 3314 | 4444 | 4340 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 41321 | 9525 | 17568 | 23 | 5717 | 2151 | 22 | 6315 | 15.3% |
...
- candidats AVEC connectivite : 4467, dont T2 : 100%
- candidats SANS connectivite : 6625, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4718 systemes avec CONNECTED sur 36991 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6802 candidats sur 11092 portent les champs bruts (61%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 837 candidats
  - AVEC connectivite (339) : resistance **40.9%**
  - SANS connectivite (498) : resistance **21.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 837 candidats
  - AVEC connectivite (339) : T0=13.09 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (498) : T0=15.94 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 4750 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4718 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 34490 systemes
  - sans CONNECTED : 0.0% sur 7707 systemes
