...
genere 2026-08-26 17:10 UTC — 55385 systemes evalues
...
- moteur actif `0caa9267db60` (11643 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
| connect | 4 | 3 | 24893 | 12428 | 1695 | 843 | 2461 | 1963 | 2656 | 2536 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 24377 | 5638 | 10312 | 14 | 3406 | 1238 | 10 | 3759 | 15.4% |
...
- candidats AVEC connectivite : 2663, dont T2 : 100%
- candidats SANS connectivite : 4069, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2930 systemes avec CONNECTED sur 22849 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2442 candidats sur 6732 portent les champs bruts (36%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 132 candidats
  - AVEC connectivite (49) : resistance **40.8%**
  - SANS connectivite (83) : resistance **21.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `23303c299f39` — 132 candidats
  - AVEC connectivite (49) : T0=12.59 T1=0.00 T2=2.96 — pondere **5.92**
  - SANS connectivite (83) : T0=16.55 T1=0.00 T2=2.70 — pondere **5.40**
  - test de permutation : **p = 0.4003** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 20348 systemes
  - sans CONNECTED : 0.0% sur 4545 systemes
