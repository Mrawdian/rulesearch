...
genere 2026-09-04 01:40 UTC — 352888 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 269544 systemes
...
- moteur actif `0caa9267db60` (309146 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 175126 | 87043 | 11909 | 5856 | 17833 | 13777 | 18558 | 17920 | 10.2% |
...
- candidats AVEC connectivite : 18047, dont T2 : 100%
...
- **18832 systemes avec CONNECTED sur 145404 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*40431 candidats sur 44721 portent les champs bruts (90%).*

- `5c556c16ea8b` — 34466 candidats
  - AVEC connectivite (13919) : resistance **41.0%**
...
- `5c556c16ea8b` — 34466 candidats
  - AVEC connectivite (13919) : T0=13.03 T1=0.00 T2=2.97 — pondere **5.95**
...
- TROP-CHER : 18909 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18832 avec CONNECTED, 77 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 142903 systemes
  - sans CONNECTED : 0.0% sur 32223 systemes
