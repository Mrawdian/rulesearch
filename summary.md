...
genere 2026-09-06 14:21 UTC — 414793 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 331449 systemes
...
- moteur actif `0caa9267db60` (371051 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 206381 | 102481 | 14059 | 6869 | 20923 | 16234 | 21927 | 21264 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 202297 | 47006 | 85355 | 79 | 28209 | 10452 | 73 | 31106 | 15.4% |
...
- candidats AVEC connectivite : 21391, dont T2 : 100%
- candidats SANS connectivite : 31416, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **22201 systemes avec CONNECTED sur 170915 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*48517 candidats sur 52807 portent les champs bruts (92%).*

- `5c556c16ea8b` — 42552 candidats
  - AVEC connectivite (17263) : resistance **41.1%**
  - SANS connectivite (25289) : resistance **21.3%**
...
- `5c556c16ea8b` — 42552 candidats
  - AVEC connectivite (17263) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (25289) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 22284 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 22201 avec CONNECTED, 83 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 168414 systemes
  - sans CONNECTED : 0.0% sur 37967 systemes
