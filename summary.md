...
genere 2026-08-27 06:29 UTC — 84971 systemes evalues
...
- moteur actif `0caa9267db60` (41229 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 39017 | 8988 | 16602 | 22 | 5409 | 2036 | 21 | 5939 | 15.2% |
...
- candidats SANS connectivite : 6249, dont T2 : 100%
...
*6175 candidats sur 10465 portent les champs bruts (59%).*
...
- `23303c299f39` — 225 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 210 candidats
  - AVEC connectivite (88) : resistance **43.1%**
  - SANS connectivite (122) : resistance **21.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 210 candidats
  ...
  - SANS connectivite (122) : T0=15.94 T1=0.00 T2=2.66 — pondere **5.33**
  - test de permutation : **p = 0.0345** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e40600351a72` — 194 candidats
...
**7 serie(s) reproductible(s) sur 14 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `ab89a63b01ef` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0060), `5c556c16ea8b` (p=0.0345), `b71bb0907fb5` (p=0.0110).
