...
genere 2026-08-28 02:41 UTC — 125421 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 42077 systemes
...
- moteur actif `0caa9267db60` (81679 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 60258 | 30005 | 4160 | 2038 | 5999 | 4782 | 6308 | 6191 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 59048 | 13655 | 25015 | 28 | 8213 | 3059 | 26 | 9050 | 15.3% |
...
- candidats AVEC connectivite : 6318, dont T2 : 100%
- candidats SANS connectivite : 9360, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6582 systemes avec CONNECTED sur 51680 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11388 candidats sur 15678 portent les champs bruts (73%).*

- `5c556c16ea8b` — 5423 candidats
  - AVEC connectivite (2190) : resistance **41.8%**
  - SANS connectivite (3233) : resistance **22.3%**
...
- `5c556c16ea8b` — 5423 candidats
  - AVEC connectivite (2190) : T0=12.99 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (3233) : T0=15.84 T1=0.00 T2=2.71 — pondere **5.41**
...
- TROP-CHER : 6618 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6582 avec CONNECTED, 36 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 49179 systemes
  - sans CONNECTED : 0.0% sur 11079 systemes
