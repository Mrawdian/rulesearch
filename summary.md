...
genere 2026-08-26 18:26 UTC — 58325 systemes evalues
...
- `8f22f0d2d442` : 224 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (14583 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
**7690 enregistrements (13%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 26388 | 13151 | 1794 | 894 | 2616 | 2086 | 2812 | 2709 | 10.3% |
...
- candidats AVEC connectivite : 2836, dont T2 : 100%
- candidats SANS connectivite : 4294, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3086 systemes avec CONNECTED sur 24084 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2840 candidats sur 7130 portent les champs bruts (40%).*
...
- `b71bb0907fb5` — 53 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `8f22f0d2d442` — 36 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (13) : resistance **42.1%**
...
- `8f22f0d2d442` — 36 candidats
  - AVEC connectivite (13) : T0=13.31 T1=0.00 T2=2.92 — pondere **5.85**
...
## cout
- temps total 18.1 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 3106 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3086 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 21583 systemes
  - sans CONNECTED : 0.0% sur 4805 systemes
