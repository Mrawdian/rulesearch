...
genere 2026-08-28 13:45 UTC — 144678 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 61334 systemes
...
- moteur actif `0caa9267db60` (100936 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 69993 | 34776 | 4782 | 2371 | 7026 | 5592 | 7392 | 7158 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 68570 | 15909 | 28974 | 32 | 9498 | 3531 | 30 | 10593 | 15.4% |
...
- candidats AVEC connectivite : 7285, dont T2 : 100%
- candidats SANS connectivite : 10903, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7666 systemes avec CONNECTED sur 59578 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*13898 candidats sur 18188 portent les champs bruts (76%).*

- `5c556c16ea8b` — 7933 candidats
  - AVEC connectivite (3157) : resistance **41.2%**
  - SANS connectivite (4776) : resistance **21.7%**
...
- `5c556c16ea8b` — 7933 candidats
  - AVEC connectivite (3157) : T0=13.01 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (4776) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.35**
...
- TROP-CHER : 7706 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7666 avec CONNECTED, 40 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 57077 systemes
  - sans CONNECTED : 0.0% sur 12916 systemes
