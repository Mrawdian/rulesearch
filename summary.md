...
genere 2026-08-30 17:00 UTC — 224989 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 141645 systemes
...
- moteur actif `0caa9267db60` (181247 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 110569 | 54961 | 7510 | 3691 | 11139 | 8756 | 11691 | 11378 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 108305 | 25234 | 45739 | 50 | 14955 | 5598 | 44 | 16675 | 15.4% |
...
- candidats AVEC connectivite : 11505, dont T2 : 100%
...
- **11965 systemes avec CONNECTED sur 92730 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*24200 candidats sur 28490 portent les champs bruts (85%).*

- `5c556c16ea8b` — 18235 candidats
  - AVEC connectivite (7377) : resistance **41.1%**
...
- `5c556c16ea8b` — 18235 candidats
  - AVEC connectivite (7377) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.97**
...
- TROP-CHER : 12019 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11965 avec CONNECTED, 54 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 90229 systemes
  - sans CONNECTED : 0.0% sur 20340 systemes
