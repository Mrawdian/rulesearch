...
- moteur actif `0caa9267db60` (48303 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 42522 | 9809 | 18040 | 25 | 5902 | 2221 | 22 | 6502 | 15.3% |
...
- candidats SANS connectivite : 6812, dont T2 : 100%
...
*7092 candidats sur 11382 portent les champs bruts (62%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 1127 candidats
  - AVEC connectivite (442) : resistance **41.5%**
  - SANS connectivite (685) : resistance **21.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 1127 candidats
  ...
  - SANS connectivite (685) : T0=15.77 T1=0.00 T2=2.64 — pondere **5.28**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
