...
genere 2026-08-26 02:07 UTC — 17511 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 8537 systemes
...
| connect | 4 | 3 | 8789 | 4420 | 575 | 295 | 836 | 702 | 951 | 903 | 10.3% |
| ref | 4 | 3 | 8598 | 2074 | 3613 | 2 | 1149 | 425 | 3 | 1332 | 15.5% |
...
- candidats AVEC connectivite : 906, dont T2 : 100%
- candidats SANS connectivite : 1336, dont T2 : 100%
...
- **951 systemes avec CONNECTED sur 7281 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1077 candidats
  - AVEC connectivite (427) : T0=13.34 T1=0.00 T2=2.86 — pondere **5.71**
  - SANS connectivite (650) : T0=15.90 T1=0.00 T2=2.68 — pondere **5.35**
  - test de permutation : **p = 0.0690** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 954 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 951 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 7224 systemes
  - sans CONNECTED : 0.0% sur 1565 systemes
