...
genere 2026-09-02 05:24 UTC — 302931 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 219587 systemes
...
- moteur actif `0caa9267db60` (259189 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 149904 | 74470 | 10196 | 5027 | 15200 | 11807 | 15867 | 15418 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 146912 | 34190 | 62167 | 62 | 20326 | 7584 | 63 | 22508 | 15.3% |
...
- candidats AVEC connectivite : 15545, dont T2 : 100%
...
- **16141 systemes avec CONNECTED sur 124876 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*34073 candidats sur 38363 portent les champs bruts (89%).*

- `5c556c16ea8b` — 28108 candidats
  - AVEC connectivite (11417) : resistance **41.1%**
...
- `5c556c16ea8b` — 28108 candidats
  - AVEC connectivite (11417) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 16214 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16141 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 122375 systemes
  - sans CONNECTED : 0.0% sur 27529 systemes
