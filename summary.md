...
genere 2026-09-08 16:45 UTC — 461222 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 377878 systemes
...
- moteur actif `0caa9267db60` (417480 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 229838 | 114171 | 15639 | 7693 | 23243 | 17991 | 24508 | 23669 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 225269 | 52476 | 94937 | 89 | 31398 | 11650 | 81 | 34620 | 15.4% |
...
- candidats AVEC connectivite : 23796, dont T2 : 100%
- candidats SANS connectivite : 34930, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **24782 systemes avec CONNECTED sur 190200 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*54436 candidats sur 58726 portent les champs bruts (93%).*

- `5c556c16ea8b` — 48471 candidats
  - AVEC connectivite (19668) : resistance **41.2%**
  - SANS connectivite (28803) : resistance **21.3%**
...
- `5c556c16ea8b` — 48471 candidats
  - AVEC connectivite (19668) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (28803) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 24873 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 24782 avec CONNECTED, 91 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 187699 systemes
  - sans CONNECTED : 0.0% sur 42139 systemes
