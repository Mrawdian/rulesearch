...
genere 2026-08-28 09:16 UTC — 136982 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 53638 systemes
...
- moteur actif `0caa9267db60` (93240 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 66113 | 32841 | 4536 | 2247 | 6609 | 5274 | 6960 | 6794 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 64754 | 14981 | 27398 | 30 | 9014 | 3339 | 28 | 9962 | 15.4% |
...
- candidats AVEC connectivite : 6921, dont T2 : 100%
- candidats SANS connectivite : 10272, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7234 systemes avec CONNECTED sur 56447 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12903 candidats sur 17193 portent les champs bruts (75%).*

- `5c556c16ea8b` — 6938 candidats
  - AVEC connectivite (2793) : resistance **41.5%**
  - SANS connectivite (4145) : resistance **21.8%**
...
- `5c556c16ea8b` — 6938 candidats
  - AVEC connectivite (2793) : T0=12.97 T1=0.00 T2=3.02 — pondere **6.04**
  - SANS connectivite (4145) : T0=15.86 T1=0.00 T2=2.67 — pondere **5.35**
...
## cout
- temps total 42.2 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 7272 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7234 avec CONNECTED, 38 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 53946 systemes
  - sans CONNECTED : 0.0% sur 12167 systemes
