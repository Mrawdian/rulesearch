...
genere 2026-08-26 10:31 UTC — 38977 systemes evalues
...
- `e3baecf8377b` : 384 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
**7850 enregistrements (20%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
*317 candidats sur 4607 portent les champs bruts (7%).*
...
- `e3baecf8377b` — 53 candidats (**NON REPRODUCTIBLE**)
...
- `e3baecf8377b` — 53 candidats
  - AVEC connectivite (23) : T0=13.91 T1=0.00 T2=2.87 — pondere **5.74**
  - SANS connectivite (30) : T0=15.90 T1=0.00 T2=2.17 — pondere **4.33**
  - test de permutation : **p = 0.1369** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
