...
genere 2026-08-26 14:08 UTC — 48214 systemes evalues
...
- moteur actif `0caa9267db60` (4472 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21276 | 10619 | 1411 | 732 | 2107 | 1690 | 2274 | 2173 | 10.2% |
...
- candidats AVEC connectivite : 2300, dont T2 : 100%
- candidats SANS connectivite : 3501, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2548 systemes avec CONNECTED sur 19883 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1511 candidats sur 5801 portent les champs bruts (26%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 396 candidats
  - AVEC connectivite (162) : resistance **39.7%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 396 candidats
  - AVEC connectivite (162) : T0=13.40 T1=0.00 T2=2.94 — pondere **5.88**
...
- TROP-CHER : 2565 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2548 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17382 systemes
  - sans CONNECTED : 0.0% sur 3894 systemes
