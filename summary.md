...
genere 2026-09-01 01:30 UTC — 268764 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 185420 systemes
...
- moteur actif `0caa9267db60` (225022 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 132667 | 65926 | 8974 | 4451 | 13447 | 10491 | 14004 | 13655 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 129982 | 30288 | 54923 | 57 | 18004 | 6728 | 57 | 19915 | 15.3% |
...
- candidats AVEC connectivite : 13782, dont T2 : 100%
- candidats SANS connectivite : 20225, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14278 systemes avec CONNECTED sur 110745 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*29717 candidats sur 34007 portent les champs bruts (87%).*

- `5c556c16ea8b` — 23752 candidats
  - AVEC connectivite (9654) : resistance **41.0%**
  - SANS connectivite (14098) : resistance **21.3%**
...
- `5c556c16ea8b` — 23752 candidats
  - AVEC connectivite (9654) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (14098) : T0=15.93 T1=0.00 T2=2.66 — pondere **5.31**
...
## cout
- temps total 83.1 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 14345 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14278 avec CONNECTED, 67 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 108244 systemes
  - sans CONNECTED : 0.0% sur 24423 systemes
