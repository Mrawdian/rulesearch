...
genere 2026-08-29 07:02 UTC — 174112 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 90768 systemes
...
- moteur actif `0caa9267db60` (130370 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 84857 | 42239 | 5768 | 2866 | 8514 | 6726 | 8914 | 8756 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 83140 | 19406 | 35154 | 39 | 11475 | 4236 | 34 | 12791 | 15.4% |
...
- candidats AVEC connectivite : 8883, dont T2 : 100%
- candidats SANS connectivite : 13101, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9188 systemes avec CONNECTED sur 71774 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*17694 candidats sur 21984 portent les champs bruts (80%).*

- `5c556c16ea8b` — 11729 candidats
  - AVEC connectivite (4755) : resistance **41.2%**
  - SANS connectivite (6974) : resistance **21.6%**
...
- `5c556c16ea8b` — 11729 candidats
  - AVEC connectivite (4755) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (6974) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.33**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 69273 systemes
  - sans CONNECTED : 0.0% sur 15584 systemes
