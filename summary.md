...
genere 2026-08-26 04:51 UTC — 24387 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 15413 systemes
...
| connect | 4 | 3 | 12269 | 6148 | 805 | 424 | 1180 | 982 | 1333 | 1245 | 10.1% |
...
- candidats AVEC connectivite : 1248, dont T2 : 100%
...
- **1333 systemes avec CONNECTED sur 10113 (13.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1932 candidats
  - AVEC connectivite (769) : T0=13.31 T1=0.00 T2=2.83 — pondere **5.65**
...
- TROP-CHER : 1337 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1333 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 10056 systemes
  - sans CONNECTED : 0.0% sur 2213 systemes
