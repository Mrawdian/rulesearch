...
genere 2026-08-29 11:30 UTC — 181245 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 97901 systemes
...
- moteur actif `0caa9267db60` (137503 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 88459 | 43968 | 6015 | 2995 | 8893 | 7062 | 9296 | 9105 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 86671 | 20241 | 36618 | 42 | 11964 | 4432 | 35 | 13333 | 15.4% |
...
- candidats AVEC connectivite : 9232, dont T2 : 100%
- candidats SANS connectivite : 13643, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9570 systemes avec CONNECTED sur 74660 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*18585 candidats sur 22875 portent les champs bruts (81%).*

- `5c556c16ea8b` — 12620 candidats
  - AVEC connectivite (5104) : resistance **41.2%**
  - SANS connectivite (7516) : resistance **21.5%**
...
- `5c556c16ea8b` — 12620 candidats
  - AVEC connectivite (5104) : T0=12.99 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (7516) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 9615 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 9570 avec CONNECTED, 45 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 72159 systemes
  - sans CONNECTED : 0.0% sur 16300 systemes
