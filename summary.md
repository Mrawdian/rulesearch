...
genere 2026-08-27 00:11 UTC — 71175 systemes evalues
...
- moteur actif `0caa9267db60` (27433 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 32180 | 7409 | 13662 | 18 | 4463 | 1687 | 15 | 4926 | 15.3% |
...
- candidats SANS connectivite : 5236, dont T2 : 100%
...
*4431 candidats sur 8721 portent les champs bruts (51%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 754 candidats
  - AVEC connectivite (305) : resistance **41.6%**
  - SANS connectivite (449) : resistance **21.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 754 candidats
  ...
  - SANS connectivite (449) : T0=15.94 T1=0.00 T2=2.61 — pondere **5.21**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 798 candidats
