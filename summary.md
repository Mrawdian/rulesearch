...
- moteur actif `0caa9267db60` (7241 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22669 | 11299 | 1526 | 770 | 2263 | 1798 | 2426 | 2305 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 22199 | 5144 | 9370 | 13 | 3102 | 1138 | 10 | 3422 | 15.4% |
...
- candidats AVEC connectivite : 2432, dont T2 : 100%
- candidats SANS connectivite : 3732, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2700 systemes avec CONNECTED sur 21003 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1874 candidats sur 6164 portent les champs bruts (30%).*
...
- `06fe04a859f1` — 759 candidats
  - AVEC connectivite (294) : resistance **41.3%**
  - SANS connectivite (465) : resistance **20.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 759 candidats
  - AVEC connectivite (294) : T0=13.34 T1=0.00 T2=3.04 — pondere **6.07**
  - SANS connectivite (465) : T0=16.02 T1=0.00 T2=2.62 — pondere **5.23**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e3baecf8377b` — 657 candidats
...
- TROP-CHER : 2720 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2700 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18502 systemes
  - sans CONNECTED : 0.0% sur 4167 systemes
