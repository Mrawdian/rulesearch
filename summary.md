...
genere 2026-08-26 19:22 UTC — 60555 systemes evalues
...
- moteur actif `0caa9267db60` (16813 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27510 | 13718 | 1876 | 929 | 2717 | 2179 | 2925 | 2820 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 26930 | 6225 | 11391 | 15 | 3752 | 1385 | 10 | 4152 | 15.4% |
...
- candidats AVEC connectivite : 2947, dont T2 : 100%
- candidats SANS connectivite : 4462, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3199 systemes avec CONNECTED sur 25015 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3119 candidats sur 7409 portent les champs bruts (42%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 250 candidats
  - AVEC connectivite (103) : resistance **38.9%**
  - SANS connectivite (147) : resistance **18.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 250 candidats
  - AVEC connectivite (103) : T0=13.16 T1=0.00 T2=2.88 — pondere **5.77**
  - SANS connectivite (147) : T0=16.05 T1=0.00 T2=2.59 — pondere **5.18**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22514 systemes
  - sans CONNECTED : 0.0% sur 4996 systemes
