...
genere 2026-08-26 16:56 UTC — 54839 systemes evalues
...
- moteur actif `0caa9267db60` (11097 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
| connect | 4 | 3 | 24626 | 12298 | 1673 | 834 | 2439 | 1941 | 2628 | 2506 | 10.2% |
...
- candidats AVEC connectivite : 2633, dont T2 : 100%
- candidats SANS connectivite : 4023, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2902 systemes avec CONNECTED sur 22628 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2366 candidats sur 6656 portent les champs bruts (36%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 56 candidats
  - AVEC connectivite (19) : resistance **35.9%**
...
- `23303c299f39` — 56 candidats
  - AVEC connectivite (19) : T0=13.16 T1=0.00 T2=2.79 — pondere **5.58**
...
- TROP-CHER : 2922 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2902 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 20127 systemes
  - sans CONNECTED : 0.0% sur 4499 systemes
