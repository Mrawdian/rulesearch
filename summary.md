...
genere 2026-08-26 05:21 UTC — 25656 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 16682 systemes
...
| connect | 4 | 3 | 12906 | 6458 | 846 | 446 | 1253 | 1029 | 1401 | 1306 | 10.1% |
| ref | 4 | 3 | 12626 | 3016 | 5306 | 9 | 1719 | 635 | 4 | 1937 | 15.3% |
...
- candidats AVEC connectivite : 1309, dont T2 : 100%
...
- **1401 systemes avec CONNECTED sur 10631 (13.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2085 candidats
  - AVEC connectivite (830) : T0=13.25 T1=0.00 T2=2.86 — pondere **5.71**
...
- TROP-CHER : 1405 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1401 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 10574 systemes
  - sans CONNECTED : 0.0% sur 2332 systemes
