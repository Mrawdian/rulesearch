...
genere 2026-08-26 09:17 UTC — 35781 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 26807 systemes
...
| d4 | 4 | 4 | 4747 | 2174 | 1218 | 26 | 337 | 317 | 229 | 329 | 6.9% |
...
- candidats SANS connectivite : 2604, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1926 systemes avec CONNECTED sur 14768 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 3109 candidats
  - AVEC connectivite (1191) : T0=13.13 T1=0.00 T2=2.93 — pondere **5.87**
  - SANS connectivite (1918) : T0=15.89 T1=0.01 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 1939 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 1926 avec CONNECTED, 13 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
