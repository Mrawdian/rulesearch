...
| connect | 4 | 3 | 5830 | 2931 | 374 | 211 | 560 | 473 | 607 | 604 | 10.4% |
| ref | 4 | 3 | 5685 | 1381 | 2370 | 1 | 755 | 277 | 2 | 899 | 15.8% |
...
- candidats AVEC connectivite : 607, dont T2 : 100%
- candidats SANS connectivite : 903, dont T2 : 100%
...
- **607 systemes avec CONNECTED sur 4834 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 345 candidats
  - AVEC connectivite (128) : T0=13.08 T1=0.00 T2=2.87 — pondere **5.73**
  - SANS connectivite (217) : T0=16.01 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 609 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 607 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 4777 systemes
  - sans CONNECTED : 0.0% sur 1053 systemes
