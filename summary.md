...
genere 2026-08-26 13:04 UTC — 45582 systemes evalues
...
- moteur actif `0caa9267db60` (1840 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 19949 | 9968 | 1302 | 687 | 2005 | 1571 | 2141 | 2029 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 19518 | 4579 | 8247 | 13 | 2686 | 1007 | 7 | 2979 | 15.3% |
...
- candidats AVEC connectivite : 2156, dont T2 : 100%
- candidats SANS connectivite : 3289, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2415 systemes avec CONNECTED sur 18786 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1155 candidats sur 5445 portent les champs bruts (21%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 40 candidats
  - AVEC connectivite (18) : resistance **38.2%**
...
- `06fe04a859f1` — 40 candidats
  - AVEC connectivite (18) : T0=13.89 T1=0.00 T2=2.50 — pondere **5.00**
...
- TROP-CHER : 2432 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2415 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16285 systemes
  - sans CONNECTED : 0.0% sur 3664 systemes
