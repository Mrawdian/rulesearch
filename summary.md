...
genere 2026-08-26 22:17 UTC — 66963 systemes evalues
...
- moteur actif `0caa9267db60` (23221 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 30755 | 15278 | 2107 | 1035 | 3066 | 2448 | 3277 | 3154 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 30093 | 6934 | 12783 | 18 | 4165 | 1557 | 14 | 4622 | 15.4% |
...
- candidats AVEC connectivite : 3281, dont T2 : 100%
- candidats SANS connectivite : 4932, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3551 systemes avec CONNECTED sur 27646 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3923 candidats sur 8213 portent les champs bruts (48%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 246 candidats
  - AVEC connectivite (101) : resistance **43.0%**
  - SANS connectivite (145) : resistance **22.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 246 candidats
  - AVEC connectivite (101) : T0=12.92 T1=0.00 T2=3.06 — pondere **6.12**
  - SANS connectivite (145) : T0=16.12 T1=0.00 T2=2.77 — pondere **5.54**
...
## cout
- temps total 20.8 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 3575 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3551 avec CONNECTED, 24 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 25145 systemes
  - sans CONNECTED : 0.0% sur 5610 systemes
