...
genere 2026-08-26 23:50 UTC — 70356 systemes evalues
...
- moteur actif `0caa9267db60` (26614 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 31766 | 7329 | 13494 | 18 | 4396 | 1658 | 14 | 4857 | 15.3% |
...
- candidats SANS connectivite : 5167, dont T2 : 100%
...
*4314 candidats sur 8604 portent les champs bruts (50%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 637 candidats
  - AVEC connectivite (257) : resistance **42.1%**
  - SANS connectivite (380) : resistance **21.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 637 candidats
  ...
  - SANS connectivite (380) : T0=15.90 T1=0.00 T2=2.64 — pondere **5.28**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e3baecf8377b` — 657 candidats
...
- TROP-CHER : 3761 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3737 avec CONNECTED, 24 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
