...
genere 2026-09-01 07:42 UTC — 276499 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 193155 systemes
...
- moteur actif `0caa9267db60` (232757 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 136560 | 67841 | 9243 | 4566 | 13859 | 10789 | 14433 | 14055 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 133824 | 31190 | 56545 | 58 | 18556 | 6926 | 60 | 20479 | 15.3% |
...
- candidats AVEC connectivite : 14182, dont T2 : 100%
- candidats SANS connectivite : 20789, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14707 systemes avec CONNECTED sur 113916 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*30681 candidats sur 34971 portent les champs bruts (88%).*

- `5c556c16ea8b` — 24716 candidats
  - AVEC connectivite (10054) : resistance **41.0%**
  - SANS connectivite (14662) : resistance **21.3%**
...
- `5c556c16ea8b` — 24716 candidats
  - AVEC connectivite (10054) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (14662) : T0=15.93 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 14777 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14707 avec CONNECTED, 70 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 111415 systemes
  - sans CONNECTED : 0.0% sur 25145 systemes
