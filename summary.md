...
genere 2026-08-26 21:37 UTC — 65468 systemes evalues
...
- `ab89a63b01ef` : 561 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (21726 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
**8087 enregistrements (12%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 29994 | 14906 | 2047 | 1008 | 3006 | 2373 | 3197 | 3077 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 29359 | 6774 | 12464 | 16 | 4066 | 1516 | 12 | 4511 | 15.4% |
...
- candidats AVEC connectivite : 3204, dont T2 : 100%
- candidats SANS connectivite : 4821, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3471 systemes avec CONNECTED sur 27022 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3735 candidats sur 8025 portent les champs bruts (47%).*
...
- `e80bc1b2b437` — 75 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 58 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (24) : resistance **42.9%**
  - SANS connectivite (34) : resistance **21.5%**
...
- `ab89a63b01ef` — 58 candidats
  - AVEC connectivite (24) : T0=14.38 T1=0.00 T2=2.96 — pondere **5.92**
  - SANS connectivite (34) : T0=16.47 T1=0.00 T2=2.88 — pondere **5.76**
  - test de permutation : **p = 0.8656** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `0a74109317e5` — 80 candidats
...
- TROP-CHER : 3493 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3471 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24521 systemes
  - sans CONNECTED : 0.0% sur 5473 systemes
