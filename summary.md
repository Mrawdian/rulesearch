...
| connect | 4 | 3 | 7982 | 4025 | 519 | 272 | 762 | 634 | 841 | 836 | 10.5% |
| ref | 4 | 3 | 7801 | 1882 | 3270 | 1 | 1045 | 381 | 3 | 1219 | 15.6% |
...
- candidats AVEC connectivite : 839, dont T2 : 100%
- candidats SANS connectivite : 1223, dont T2 : 100%
...
- **841 systemes avec CONNECTED sur 6612 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 897 candidats
  - AVEC connectivite (360) : T0=13.40 T1=0.00 T2=2.84 — pondere **5.69**
  - SANS connectivite (537) : T0=15.85 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 844 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 841 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 6555 systemes
  - sans CONNECTED : 0.0% sur 1427 systemes
