...
genere 2026-08-29 07:55 UTC — 175620 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 92276 systemes
...
- moteur actif `0caa9267db60` (131878 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 85620 | 42622 | 5822 | 2893 | 8584 | 6795 | 8983 | 8833 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 83885 | 19584 | 35464 | 39 | 11566 | 4275 | 35 | 12916 | 15.4% |
...
- candidats AVEC connectivite : 8960, dont T2 : 100%
- candidats SANS connectivite : 13226, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9257 systemes avec CONNECTED sur 72398 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*17896 candidats sur 22186 portent les champs bruts (81%).*

- `5c556c16ea8b` — 11931 candidats
  - AVEC connectivite (4832) : resistance **41.1%**
  - SANS connectivite (7099) : resistance **21.6%**
...
- `5c556c16ea8b` — 11931 candidats
  - AVEC connectivite (4832) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (7099) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.33**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 69897 systemes
  - sans CONNECTED : 0.0% sur 15723 systemes
