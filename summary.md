...
genere 2026-09-09 01:33 UTC — 469273 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 385929 systemes
...
- moteur actif `0caa9267db60` (425531 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 233905 | 116167 | 15940 | 7826 | 23673 | 18330 | 24905 | 24099 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 229253 | 53388 | 96594 | 92 | 31950 | 11845 | 82 | 35283 | 15.4% |
...
- candidats AVEC connectivite : 24226, dont T2 : 100%
- candidats SANS connectivite : 35593, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25179 systemes avec CONNECTED sur 193474 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55529 candidats sur 59819 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49564 candidats
  - AVEC connectivite (20098) : resistance **41.2%**
  - SANS connectivite (29466) : resistance **21.3%**
...
- `5c556c16ea8b` — 49564 candidats
  - AVEC connectivite (20098) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (29466) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 190973 systemes
  - sans CONNECTED : 0.0% sur 42932 systemes
