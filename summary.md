...
genere 2026-08-26 17:20 UTC — 55739 systemes evalues
...
- moteur actif `0caa9267db60` (11997 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
| connect | 4 | 3 | 25073 | 12513 | 1706 | 844 | 2480 | 1982 | 2677 | 2560 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 24551 | 5677 | 10383 | 14 | 3430 | 1249 | 10 | 3788 | 15.4% |
...
- candidats AVEC connectivite : 2687, dont T2 : 100%
- candidats SANS connectivite : 4098, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2951 systemes avec CONNECTED sur 22997 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2495 candidats sur 6785 portent les champs bruts (37%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 185 candidats
  - AVEC connectivite (73) : resistance **43.3%**
  - SANS connectivite (112) : resistance **20.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `23303c299f39` — 185 candidats
  - AVEC connectivite (73) : T0=12.85 T1=0.00 T2=3.16 — pondere **6.33**
  - SANS connectivite (112) : T0=16.29 T1=0.00 T2=2.61 — pondere **5.21**
...
**4 serie(s) reproductible(s) sur 7 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0215).
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 20496 systemes
  - sans CONNECTED : 0.0% sur 4577 systemes
