...
| connect | 4 | 3 | 7532 | 3796 | 496 | 263 | 717 | 604 | 793 | 780 | 10.4% |
...
- candidats AVEC connectivite : 783, dont T2 : 100%
...
- **793 systemes avec CONNECTED sur 6237 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 779 candidats
  - AVEC connectivite (304) : T0=13.30 T1=0.00 T2=2.92 — pondere **5.84**
  - SANS connectivite (475) : T0=15.80 T1=0.00 T2=2.65 — pondere **5.31**
  - test de permutation : **p = 0.0215** — ecart significatif au seuil 0.05
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 6180 systemes
  - sans CONNECTED : 0.0% sur 1352 systemes
