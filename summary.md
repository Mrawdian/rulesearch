...
genere 2026-08-30 06:01 UTC — 209352 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 126008 systemes
...
- moteur actif `0caa9267db60` (165610 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 102662 | 50968 | 6988 | 3435 | 10373 | 8185 | 10824 | 10550 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 100575 | 23434 | 42488 | 45 | 13890 | 5189 | 39 | 15482 | 15.4% |
...
- candidats AVEC connectivite : 10677, dont T2 : 100%
- candidats SANS connectivite : 15792, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11098 systemes avec CONNECTED sur 86223 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*22179 candidats sur 26469 portent les champs bruts (84%).*

- `5c556c16ea8b` — 16214 candidats
  - AVEC connectivite (6549) : resistance **41.1%**
  - SANS connectivite (9665) : resistance **21.5%**
...
- `5c556c16ea8b` — 16214 candidats
  - AVEC connectivite (6549) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (9665) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 11147 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11098 avec CONNECTED, 49 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 83722 systemes
  - sans CONNECTED : 0.0% sur 18940 systemes
