...
genere 2026-08-26 13:55 UTC — 47752 systemes evalues
...
- moteur actif `0caa9267db60` (4010 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21036 | 10499 | 1393 | 723 | 2087 | 1673 | 2248 | 2150 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20601 | 4812 | 8698 | 13 | 2856 | 1065 | 7 | 3150 | 15.3% |
...
- candidats AVEC connectivite : 2277, dont T2 : 100%
- candidats SANS connectivite : 3460, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2522 systemes avec CONNECTED sur 19683 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1447 candidats sur 5737 portent les champs bruts (25%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 332 candidats
  - AVEC connectivite (139) : resistance **39.8%**
  - SANS connectivite (193) : resistance **21.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 332 candidats
  - AVEC connectivite (139) : T0=13.45 T1=0.00 T2=2.91 — pondere **5.83**
  - SANS connectivite (193) : T0=16.13 T1=0.00 T2=2.74 — pondere **5.48**
  - test de permutation : **p = 0.3273** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
## cout
- temps total 14.8 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2539 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2522 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17182 systemes
  - sans CONNECTED : 0.0% sur 3854 systemes
