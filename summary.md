...
genere 2026-08-28 10:09 UTC — 138550 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 55206 systemes
...
- moteur actif `0caa9267db60` (94808 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 66904 | 33243 | 4588 | 2275 | 6701 | 5337 | 7045 | 6859 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 65531 | 15149 | 27703 | 30 | 9136 | 3384 | 28 | 10098 | 15.4% |
...
- candidats AVEC connectivite : 6986, dont T2 : 100%
- candidats SANS connectivite : 10408, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7319 systemes avec CONNECTED sur 57074 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*13104 candidats sur 17394 portent les champs bruts (75%).*

- `5c556c16ea8b` — 7139 candidats
  - AVEC connectivite (2858) : resistance **41.4%**
  - SANS connectivite (4281) : resistance **21.7%**
...
- `5c556c16ea8b` — 7139 candidats
  - AVEC connectivite (2858) : T0=13.00 T1=0.00 T2=3.01 — pondere **6.03**
  - SANS connectivite (4281) : T0=15.86 T1=0.00 T2=2.67 — pondere **5.35**
...
- TROP-CHER : 7357 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7319 avec CONNECTED, 38 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 54573 systemes
  - sans CONNECTED : 0.0% sur 12331 systemes
