...
genere 2026-09-05 14:01 UTC — 390939 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 307595 systemes
...
- moteur actif `0caa9267db60` (347197 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 194333 | 96518 | 13234 | 6470 | 19764 | 15298 | 20605 | 19969 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 190491 | 44342 | 80395 | 78 | 26505 | 9851 | 71 | 29235 | 15.3% |
...
- candidats AVEC connectivite : 20096, dont T2 : 100%
- candidats SANS connectivite : 29545, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20879 systemes avec CONNECTED sur 161013 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*45351 candidats sur 49641 portent les champs bruts (91%).*

- `5c556c16ea8b` — 39386 candidats
  - AVEC connectivite (15968) : resistance **41.0%**
  - SANS connectivite (23418) : resistance **21.3%**
...
- `5c556c16ea8b` — 39386 candidats
  - AVEC connectivite (15968) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.94**
  - SANS connectivite (23418) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 20960 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 20879 avec CONNECTED, 81 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 158512 systemes
  - sans CONNECTED : 0.0% sur 35821 systemes
