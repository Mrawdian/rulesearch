...
genere 2026-08-26 09:45 UTC — 37030 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 28056 systemes
...
| connect | 4 | 3 | 15928 | 7943 | 1039 | 549 | 1584 | 1269 | 1739 | 1604 | 10.1% |
| d4 | 4 | 4 | 5377 | 2473 | 1366 | 28 | 385 | 358 | 255 | 377 | 7.0% |
| ref | 4 | 3 | 15601 | 3666 | 6579 | 11 | 2144 | 792 | 7 | 2402 | 15.4% |
...
- candidats SANS connectivite : 2675, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1984 systemes avec CONNECTED sur 15271 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*100 candidats sur 4390 portent les champs bruts (2%).*

- `89c65c03c4ad` — 100 candidats
  - AVEC connectivite (38) : resistance **48.2%**
  - SANS connectivite (62) : resistance **21.5%**
...
- `89c65c03c4ad` — 3225 candidats
  - AVEC connectivite (1236) : T0=13.08 T1=0.00 T2=2.95 — pondere **5.90**
  - SANS connectivite (1989) : T0=15.84 T1=0.02 T2=2.65 — pondere **5.32**
...
## cout
- temps total 11.6 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2001 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 1984 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.4% sur 13016 systemes
  - sans CONNECTED : 0.0% sur 2912 systemes
