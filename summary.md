...
genere 2026-08-28 21:36 UTC — 158331 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 74987 systemes
...
- moteur actif `0caa9267db60` (114589 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 76883 | 38205 | 5236 | 2613 | 7707 | 6130 | 8099 | 7911 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 75333 | 17509 | 31898 | 35 | 10377 | 3859 | 31 | 11620 | 15.4% |
...
- candidats AVEC connectivite : 8038, dont T2 : 100%
- candidats SANS connectivite : 11930, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8373 systemes avec CONNECTED sur 65223 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*15678 candidats sur 19968 portent les champs bruts (79%).*

- `5c556c16ea8b` — 9713 candidats
  - AVEC connectivite (3910) : resistance **41.2%**
  - SANS connectivite (5803) : resistance **21.8%**
...
- `5c556c16ea8b` — 9713 candidats
  - AVEC connectivite (3910) : T0=13.02 T1=0.00 T2=3.00 — pondere **6.01**
  - SANS connectivite (5803) : T0=15.89 T1=0.00 T2=2.68 — pondere **5.36**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 62722 systemes
  - sans CONNECTED : 0.0% sur 14161 systemes
