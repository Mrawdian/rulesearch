...
genere 2026-08-27 05:48 UTC — 83641 systemes evalues
...
- moteur actif `0caa9267db60` (39899 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 39166 | 19498 | 2694 | 1337 | 3893 | 3088 | 4132 | 4015 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 38360 | 8849 | 16318 | 22 | 5311 | 1998 | 21 | 5841 | 15.2% |
...
- candidats AVEC connectivite : 4142, dont T2 : 100%
- candidats SANS connectivite : 6151, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4406 systemes avec CONNECTED sur 34531 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6003 candidats sur 10293 portent les champs bruts (58%).*
...
- `b71bb0907fb5` — 53 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 38 candidats
  - AVEC connectivite (14) : resistance **42.5%**
  - SANS connectivite (24) : resistance **23.1%**
...
- `5c556c16ea8b` — 38 candidats
  - AVEC connectivite (14) : T0=12.50 T1=0.00 T2=3.21 — pondere **6.43**
  - SANS connectivite (24) : T0=16.75 T1=0.00 T2=2.54 — pondere **5.08**
...
## cout
- temps total 25.8 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 4437 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4406 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 32030 systemes
  - sans CONNECTED : 0.0% sur 7136 systemes
