...
genere 2026-08-27 15:22 UTC — 103201 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 19857 systemes
...
- moteur actif `0caa9267db60` (59459 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 49038 | 24425 | 3383 | 1680 | 4871 | 3883 | 5174 | 4987 | 10.2% |
...
- candidats AVEC connectivite : 5114, dont T2 : 100%
- candidats SANS connectivite : 7635, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5448 systemes avec CONNECTED sur 42568 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*8459 candidats sur 12749 portent les champs bruts (66%).*
...
- `5c556c16ea8b` — 2494 candidats
  - AVEC connectivite (986) : resistance **41.7%**
...
- `5c556c16ea8b` — 2494 candidats
  - AVEC connectivite (986) : T0=13.02 T1=0.00 T2=3.04 — pondere **6.07**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 40067 systemes
  - sans CONNECTED : 0.0% sur 8971 systemes
