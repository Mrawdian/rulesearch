...
genere 2026-08-26 20:48 UTC — 63651 systemes evalues
...
- moteur actif `0caa9267db60` (19909 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 29081 | 14468 | 1985 | 972 | 2894 | 2302 | 3100 | 2989 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 28455 | 6564 | 12072 | 16 | 3950 | 1466 | 12 | 4375 | 15.4% |
...
- candidats AVEC connectivite : 3116, dont T2 : 100%
- candidats SANS connectivite : 4685, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3374 systemes avec CONNECTED sur 26292 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3511 candidats sur 7801 portent les champs bruts (45%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 642 candidats
  - AVEC connectivite (272) : resistance **40.0%**
  - SANS connectivite (370) : resistance **20.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 642 candidats
  - AVEC connectivite (272) : T0=12.82 T1=0.00 T2=2.85 — pondere **5.71**
  - SANS connectivite (370) : T0=16.11 T1=0.00 T2=2.67 — pondere **5.35**
...
- TROP-CHER : 3396 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3374 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23791 systemes
  - sans CONNECTED : 0.0% sur 5290 systemes
