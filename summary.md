...
genere 2026-09-02 01:21 UTC — 298087 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 214743 systemes
...
- moteur actif `0caa9267db60` (254345 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 147455 | 73246 | 10037 | 4944 | 14965 | 11611 | 15603 | 15153 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 144517 | 33623 | 61139 | 61 | 20010 | 7465 | 63 | 22144 | 15.3% |
...
- candidats AVEC connectivite : 15280, dont T2 : 100%
...
- **15877 systemes avec CONNECTED sur 122868 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*33444 candidats sur 37734 portent les champs bruts (89%).*

- `5c556c16ea8b` — 27479 candidats
  - AVEC connectivite (11152) : resistance **41.0%**
...
- `5c556c16ea8b` — 27479 candidats
  - AVEC connectivite (11152) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 15950 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 15877 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 120367 systemes
  - sans CONNECTED : 0.0% sur 27088 systemes
