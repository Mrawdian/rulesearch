...
genere 2026-08-28 07:33 UTC — 134041 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 50697 systemes
...
- moteur actif `0caa9267db60` (90299 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 64616 | 32096 | 4436 | 2195 | 6483 | 5150 | 6788 | 6633 | 10.3% |
...
- candidats AVEC connectivite : 6760, dont T2 : 100%
...
- **7062 systemes avec CONNECTED sur 55203 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12498 candidats sur 16788 portent les champs bruts (74%).*

- `5c556c16ea8b` — 6533 candidats
  - AVEC connectivite (2632) : resistance **41.4%**
...
- `5c556c16ea8b` — 6533 candidats
  - AVEC connectivite (2632) : T0=12.98 T1=0.00 T2=3.01 — pondere **6.02**
...
- TROP-CHER : 7100 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7062 avec CONNECTED, 38 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 52702 systemes
  - sans CONNECTED : 0.0% sur 11914 systemes
