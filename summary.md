...
genere 2026-08-26 21:01 UTC — 64093 systemes evalues
...
- moteur actif `0caa9267db60` (20351 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 29306 | 14579 | 1996 | 977 | 2920 | 2323 | 3126 | 3011 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 28672 | 6616 | 12164 | 16 | 3982 | 1477 | 12 | 4405 | 15.4% |
...
- candidats AVEC connectivite : 3138, dont T2 : 100%
- candidats SANS connectivite : 4715, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3400 systemes avec CONNECTED sur 26470 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3563 candidats sur 7853 portent les champs bruts (45%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 694 candidats
  - AVEC connectivite (294) : resistance **40.0%**
  - SANS connectivite (400) : resistance **20.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 694 candidats
  - AVEC connectivite (294) : T0=12.84 T1=0.00 T2=2.85 — pondere **5.70**
  - SANS connectivite (400) : T0=16.11 T1=0.00 T2=2.68 — pondere **5.36**
...
- TROP-CHER : 3422 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3400 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23969 systemes
  - sans CONNECTED : 0.0% sur 5337 systemes
