...
genere 2026-08-26 19:15 UTC — 60322 systemes evalues
...
- moteur actif `0caa9267db60` (16580 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27390 | 13662 | 1868 | 924 | 2708 | 2171 | 2910 | 2804 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 26817 | 6197 | 11350 | 15 | 3737 | 1378 | 10 | 4130 | 15.4% |
...
- candidats AVEC connectivite : 2931, dont T2 : 100%
- candidats SANS connectivite : 4440, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3184 systemes avec CONNECTED sur 24911 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3081 candidats sur 7371 portent les champs bruts (42%).*
...
- `23303c299f39` — 225 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 212 candidats
  - AVEC connectivite (87) : resistance **39.1%**
  - SANS connectivite (125) : resistance **18.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 212 candidats
  - AVEC connectivite (87) : T0=13.14 T1=0.00 T2=2.90 — pondere **5.79**
  - SANS connectivite (125) : T0=16.12 T1=0.00 T2=2.58 — pondere **5.15**
...
- TROP-CHER : 3204 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3184 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22410 systemes
  - sans CONNECTED : 0.0% sur 4980 systemes
