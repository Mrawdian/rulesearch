...
genere 2026-08-31 02:50 UTC — 238508 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 155164 systemes
...
- moteur actif `0caa9267db60` (194766 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 117387 | 58384 | 7970 | 3939 | 11802 | 9251 | 12438 | 12068 | 10.3% |
...
- candidats AVEC connectivite : 12195, dont T2 : 100%
...
- **12712 systemes avec CONNECTED sur 98361 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*25852 candidats sur 30142 portent les champs bruts (86%).*

- `5c556c16ea8b` — 19887 candidats
  - AVEC connectivite (8067) : resistance **41.0%**
...
- `5c556c16ea8b` — 19887 candidats
  - AVEC connectivite (8067) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.97**
...
- TROP-CHER : 12774 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 12712 avec CONNECTED, 62 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 95860 systemes
  - sans CONNECTED : 0.0% sur 21527 systemes
