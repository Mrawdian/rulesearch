...
genere 2026-08-26 13:31 UTC — 46807 systemes evalues
...
- moteur actif `0caa9267db60` (3065 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20558 | 10251 | 1355 | 713 | 2053 | 1634 | 2196 | 2102 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20134 | 4709 | 8504 | 13 | 2792 | 1041 | 7 | 3068 | 15.2% |
...
- candidats AVEC connectivite : 2229, dont T2 : 100%
- candidats SANS connectivite : 3378, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2470 systemes avec CONNECTED sur 19280 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1317 candidats sur 5607 portent les champs bruts (23%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 202 candidats
  - AVEC connectivite (91) : resistance **38.4%**
  - SANS connectivite (111) : resistance **22.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 202 candidats
  - AVEC connectivite (91) : T0=13.53 T1=0.00 T2=2.77 — pondere **5.54**
  - SANS connectivite (111) : T0=16.19 T1=0.00 T2=2.89 — pondere **5.78**
  - test de permutation : **p = 0.5782** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
- TROP-CHER : 2487 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2470 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16779 systemes
  - sans CONNECTED : 0.0% sur 3779 systemes
