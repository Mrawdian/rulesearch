...
genere 2026-08-27 00:40 UTC — 72122 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 9167 systemes
- `ab89a63b01ef` : 7215 systemes
...
- moteur actif `0caa9267db60` (28380 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 33359 | 16582 | 2292 | 1130 | 3311 | 2649 | 3559 | 3410 | 10.2% |
...
- candidats AVEC connectivite : 3537, dont T2 : 100%
- candidats SANS connectivite : 5299, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3833 systemes avec CONNECTED sur 29787 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4546 candidats sur 8836 portent les champs bruts (51%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 869 candidats
  - AVEC connectivite (357) : resistance **41.1%**
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 869 candidats
  - AVEC connectivite (357) : T0=13.08 T1=0.00 T2=3.05 — pondere **6.10**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 27286 systemes
  - sans CONNECTED : 0.0% sur 6073 systemes
