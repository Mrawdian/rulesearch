...
genere 2026-09-03 09:08 UTC — 334593 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 251249 systemes
...
- moteur actif `0caa9267db60` (290851 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 165882 | 82420 | 11269 | 5550 | 16890 | 13086 | 17579 | 16963 | 10.2% |
...
- candidats AVEC connectivite : 17090, dont T2 : 100%
...
- **17853 systemes avec CONNECTED sur 137832 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*38013 candidats sur 42303 portent les champs bruts (90%).*

- `5c556c16ea8b` — 32048 candidats
  - AVEC connectivite (12962) : resistance **41.1%**
...
- `5c556c16ea8b` — 32048 candidats
  - AVEC connectivite (12962) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 17929 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 17853 avec CONNECTED, 76 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 135331 systemes
  - sans CONNECTED : 0.0% sur 30551 systemes
