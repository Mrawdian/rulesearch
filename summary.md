...
genere 2026-08-26 05:52 UTC — 26889 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 17915 systemes
...
| d4 | 4 | 4 | 270 | 127 | 66 | 0 | 18 | 16 | 14 | 19 | 7.0% |
...
- candidats AVEC connectivite : 1356, dont T2 : 100%
- candidats SANS connectivite : 2030, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1469 systemes avec CONNECTED sur 11132 (13.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2221 candidats
  - AVEC connectivite (877) : T0=13.24 T1=0.00 T2=2.87 — pondere **5.74**
...
- TROP-CHER : 1475 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1469 avec CONNECTED, 6 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
