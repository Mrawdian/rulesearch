...
genere 2026-08-28 21:06 UTC — 157432 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 74088 systemes
...
- moteur actif `0caa9267db60` (113690 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 76420 | 37977 | 5207 | 2595 | 7654 | 6097 | 8059 | 7858 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 74897 | 17409 | 31722 | 35 | 10318 | 3837 | 31 | 11542 | 15.4% |
...
- candidats AVEC connectivite : 7985, dont T2 : 100%
- candidats SANS connectivite : 11852, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8333 systemes avec CONNECTED sur 64852 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*15547 candidats sur 19837 portent les champs bruts (78%).*

- `5c556c16ea8b` — 9582 candidats
  - AVEC connectivite (3857) : resistance **41.1%**
  - SANS connectivite (5725) : resistance **21.7%**
...
- `5c556c16ea8b` — 9582 candidats
  - AVEC connectivite (3857) : T0=13.01 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (5725) : T0=15.89 T1=0.00 T2=2.68 — pondere **5.36**
...
- TROP-CHER : 8374 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8333 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 62351 systemes
  - sans CONNECTED : 0.0% sur 14069 systemes
