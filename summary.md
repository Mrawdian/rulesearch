...
genere 2026-08-28 11:00 UTC — 139981 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 56637 systemes
...
- moteur actif `0caa9267db60` (96239 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 67622 | 33590 | 4647 | 2302 | 6776 | 5387 | 7127 | 6926 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 66244 | 15321 | 28003 | 30 | 9222 | 3423 | 29 | 10213 | 15.4% |
...
- candidats AVEC connectivite : 7053, dont T2 : 100%
- candidats SANS connectivite : 10523, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7401 systemes avec CONNECTED sur 57658 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*13286 candidats sur 17576 portent les champs bruts (76%).*

- `5c556c16ea8b` — 7321 candidats
  - AVEC connectivite (2925) : resistance **41.4%**
  - SANS connectivite (4396) : resistance **21.7%**
...
- `5c556c16ea8b` — 7321 candidats
  - AVEC connectivite (2925) : T0=12.99 T1=0.00 T2=3.01 — pondere **6.02**
  - SANS connectivite (4396) : T0=15.88 T1=0.00 T2=2.67 — pondere **5.35**
...
- TROP-CHER : 7440 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7401 avec CONNECTED, 39 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 55157 systemes
  - sans CONNECTED : 0.0% sur 12465 systemes
