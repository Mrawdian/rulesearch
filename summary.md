...
genere 2026-08-27 05:57 UTC — 83865 systemes evalues
...
- moteur actif `0caa9267db60` (40123 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 39286 | 19555 | 2701 | 1341 | 3906 | 3096 | 4151 | 4027 | 10.3% |
...
- candidats AVEC connectivite : 4154, dont T2 : 100%
- candidats SANS connectivite : 6168, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4425 systemes avec CONNECTED sur 34634 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6032 candidats sur 10322 portent les champs bruts (58%).*
...
- `0a74109317e5` — 80 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 67 candidats
  - AVEC connectivite (26) : resistance **43.1%**
...
- `5c556c16ea8b` — 67 candidats
  - AVEC connectivite (26) : T0=12.92 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (41) : T0=16.05 T1=0.00 T2=2.61 — pondere **5.22**
  - test de permutation : **p = 0.2659** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `8f22f0d2d442` — 65 candidats
...
- TROP-CHER : 4456 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4425 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 32133 systemes
  - sans CONNECTED : 0.0% sur 7153 systemes
