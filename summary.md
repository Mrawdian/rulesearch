...
genere 2026-09-04 16:21 UTC — 368737 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 285393 systemes
...
- moteur actif `0caa9267db60` (324995 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 183121 | 91022 | 12450 | 6118 | 18641 | 14417 | 19382 | 18740 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 179501 | 41722 | 75835 | 74 | 24939 | 9301 | 70 | 27546 | 15.3% |
...
- candidats AVEC connectivite : 18867, dont T2 : 100%
- candidats SANS connectivite : 27856, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19656 systemes avec CONNECTED sur 151883 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*42433 candidats sur 46723 portent les champs bruts (91%).*

- `5c556c16ea8b` — 36468 candidats
  - AVEC connectivite (14739) : resistance **41.0%**
  - SANS connectivite (21729) : resistance **21.2%**
...
- `5c556c16ea8b` — 36468 candidats
  - AVEC connectivite (14739) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (21729) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 19736 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19656 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 149382 systemes
  - sans CONNECTED : 0.0% sur 33739 systemes
