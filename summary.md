...
genere 2026-09-06 06:15 UTC — 406907 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 323563 systemes
...
- moteur actif `0caa9267db60` (363165 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 202397 | 100490 | 13811 | 6739 | 20520 | 15912 | 21502 | 20850 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 198395 | 46121 | 83728 | 78 | 27640 | 10255 | 73 | 30483 | 15.4% |
...
- candidats AVEC connectivite : 20977, dont T2 : 100%
- candidats SANS connectivite : 30793, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21776 systemes avec CONNECTED sur 167654 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*47480 candidats sur 51770 portent les champs bruts (92%).*

- `5c556c16ea8b` — 41515 candidats
  - AVEC connectivite (16849) : resistance **41.1%**
  - SANS connectivite (24666) : resistance **21.3%**
...
- `5c556c16ea8b` — 41515 candidats
  - AVEC connectivite (16849) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (24666) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 165153 systemes
  - sans CONNECTED : 0.0% sur 37244 systemes
