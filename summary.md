...
genere 2026-08-27 16:34 UTC — 105600 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 22256 systemes
...
- moteur actif `0caa9267db60` (61858 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 50244 | 25013 | 3472 | 1721 | 4988 | 3981 | 5299 | 5120 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 49241 | 11384 | 20900 | 25 | 6803 | 2571 | 23 | 7533 | 15.3% |
...
- candidats AVEC connectivite : 5247, dont T2 : 100%
- candidats SANS connectivite : 7843, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5573 systemes avec CONNECTED sur 43537 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*8800 candidats sur 13090 portent les champs bruts (67%).*
...
- `5c556c16ea8b` — 2835 candidats
  - AVEC connectivite (1119) : resistance **42.0%**
...
- `5c556c16ea8b` — 2835 candidats
  - AVEC connectivite (1119) : T0=13.00 T1=0.00 T2=3.07 — pondere **6.13**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 41036 systemes
  - sans CONNECTED : 0.0% sur 9208 systemes
