...
| connect | 4 | 3 | 17230 | 8616 | 1114 | 595 | 1706 | 1373 | 1874 | 1736 | 10.1% |
...
- candidats AVEC connectivite : 1863, dont T2 : 100%
- candidats SANS connectivite : 2887, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2148 systemes avec CONNECTED sur 16576 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*460 candidats sur 4750 portent les champs bruts (10%).*
...
- `e3baecf8377b` — 196 candidats
  - AVEC connectivite (80) : resistance **42.8%**
...
- `e3baecf8377b` — 196 candidats
  - AVEC connectivite (80) : T0=13.21 T1=0.00 T2=3.16 — pondere **6.33**
...
**2 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0185).
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14075 systemes
  - sans CONNECTED : 0.0% sur 3155 systemes
