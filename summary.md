...
genere 2026-08-28 09:34 UTC — 137485 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 54141 systemes
...
- moteur actif `0caa9267db60` (93743 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 66368 | 32980 | 4545 | 2254 | 6639 | 5288 | 6988 | 6818 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 65002 | 15039 | 27493 | 30 | 9052 | 3354 | 28 | 10004 | 15.4% |
...
- candidats AVEC connectivite : 6945, dont T2 : 100%
- candidats SANS connectivite : 10314, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7262 systemes avec CONNECTED sur 56658 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12969 candidats sur 17259 portent les champs bruts (75%).*

- `5c556c16ea8b` — 7004 candidats
  - AVEC connectivite (2817) : resistance **41.5%**
  - SANS connectivite (4187) : resistance **21.8%**
...
- `5c556c16ea8b` — 7004 candidats
  - AVEC connectivite (2817) : T0=12.97 T1=0.00 T2=3.02 — pondere **6.04**
  - SANS connectivite (4187) : T0=15.86 T1=0.00 T2=2.68 — pondere **5.35**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 54157 systemes
  - sans CONNECTED : 0.0% sur 12211 systemes
