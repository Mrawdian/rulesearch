...
genere 2026-08-26 14:32 UTC — 49204 systemes evalues
...
- moteur actif `0caa9267db60` (5462 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21771 | 10866 | 1455 | 748 | 2156 | 1725 | 2325 | 2221 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 21318 | 4955 | 9002 | 13 | 2952 | 1099 | 8 | 3289 | 15.4% |
...
- candidats AVEC connectivite : 2348, dont T2 : 100%
- candidats SANS connectivite : 3599, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2599 systemes avec CONNECTED sur 20297 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1657 candidats sur 5947 portent les champs bruts (28%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 542 candidats
  - AVEC connectivite (210) : resistance **40.0%**
  - SANS connectivite (332) : resistance **20.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 542 candidats
  - AVEC connectivite (210) : T0=13.47 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (332) : T0=16.09 T1=0.00 T2=2.64 — pondere **5.28**
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0100).
...
- TROP-CHER : 2617 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2599 avec CONNECTED, 18 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17796 systemes
  - sans CONNECTED : 0.0% sur 3975 systemes
