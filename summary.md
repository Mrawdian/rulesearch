...
genere 2026-09-06 00:15 UTC — 401126 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 317782 systemes
...
- moteur actif `0caa9267db60` (357384 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 199483 | 99032 | 13590 | 6645 | 20260 | 15707 | 21165 | 20543 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 195528 | 45489 | 82498 | 78 | 27240 | 10097 | 72 | 30037 | 15.4% |
...
- candidats SANS connectivite : 30347, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21439 systemes avec CONNECTED sur 165249 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*46727 candidats sur 51017 portent les champs bruts (92%).*

- `5c556c16ea8b` — 40762 candidats
  - AVEC connectivite (16542) : resistance **41.0%**
  - SANS connectivite (24220) : resistance **21.3%**
...
- `5c556c16ea8b` — 40762 candidats
  ...
  - SANS connectivite (24220) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 162748 systemes
  - sans CONNECTED : 0.0% sur 36735 systemes
