...
genere 2026-08-26 03:27 UTC — 20859 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 11885 systemes
...
| connect | 4 | 3 | 10478 | 5275 | 688 | 363 | 1000 | 833 | 1137 | 1049 | 10.0% |
...
- candidats AVEC connectivite : 1052, dont T2 : 100%
...
- **1137 systemes avec CONNECTED sur 8658 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1468 candidats
  - AVEC connectivite (573) : T0=13.35 T1=0.00 T2=2.86 — pondere **5.71**
...
- TROP-CHER : 1141 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1137 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 8601 systemes
  - sans CONNECTED : 0.0% sur 1877 systemes
