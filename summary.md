...
genere 2026-08-26 17:03 UTC — 55117 systemes evalues
...
- moteur actif `0caa9267db60` (11375 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
| connect | 4 | 3 | 24759 | 12366 | 1681 | 840 | 2453 | 1949 | 2642 | 2519 | 10.2% |
...
- candidats AVEC connectivite : 2646, dont T2 : 100%
- candidats SANS connectivite : 4043, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2916 systemes avec CONNECTED sur 22743 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2399 candidats sur 6689 portent les champs bruts (36%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 89 candidats
  - AVEC connectivite (32) : resistance **40.0%**
...
- `23303c299f39` — 89 candidats
  - AVEC connectivite (32) : T0=12.88 T1=0.00 T2=2.97 — pondere **5.94**
  - SANS connectivite (57) : T0=16.96 T1=0.00 T2=2.88 — pondere **5.75**
  - test de permutation : **p = 0.8521** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 2936 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2916 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 20242 systemes
  - sans CONNECTED : 0.0% sur 4517 systemes
