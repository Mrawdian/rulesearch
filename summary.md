...
genere 2026-08-26 16:42 UTC — 54320 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 9137 systemes
...
- moteur actif `0caa9267db60` (10578 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 24359 | 12153 | 1658 | 823 | 2412 | 1926 | 2597 | 2486 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 23846 | 5522 | 10074 | 14 | 3343 | 1210 | 10 | 3673 | 15.4% |
...
- candidats AVEC connectivite : 2613, dont T2 : 100%
- candidats SANS connectivite : 3983, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2871 systemes avec CONNECTED sur 22405 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2306 candidats sur 6596 portent les champs bruts (35%).*
...
- `06fe04a859f1` — 1191 candidats
  - AVEC connectivite (475) : resistance **41.0%**
  - SANS connectivite (716) : resistance **20.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1191 candidats
  - AVEC connectivite (475) : T0=13.10 T1=0.00 T2=3.02 — pondere **6.04**
  - SANS connectivite (716) : T0=15.94 T1=0.00 T2=2.61 — pondere **5.23**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 19904 systemes
  - sans CONNECTED : 0.0% sur 4455 systemes
