...
genere 2026-08-26 09:47 UTC — 37089 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 28115 systemes
...
| connect | 4 | 3 | 15943 | 7951 | 1039 | 550 | 1586 | 1270 | 1741 | 1604 | 10.1% |
| d4 | 4 | 4 | 5407 | 2485 | 1372 | 28 | 386 | 363 | 257 | 380 | 7.0% |
...
- candidats AVEC connectivite : 1716, dont T2 : 100%
- candidats SANS connectivite : 2680, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1988 systemes avec CONNECTED sur 15296 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*106 candidats sur 4396 portent les champs bruts (2%).*

- `89c65c03c4ad` — 106 candidats
  - AVEC connectivite (39) : resistance **49.3%**
  - SANS connectivite (67) : resistance **21.2%**
...
- `89c65c03c4ad` — 3231 candidats
  - AVEC connectivite (1237) : T0=13.08 T1=0.00 T2=2.95 — pondere **5.90**
  - SANS connectivite (1994) : T0=15.85 T1=0.02 T2=2.65 — pondere **5.32**
...
- TROP-CHER : 2005 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 1988 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.4% sur 13028 systemes
