...
genere 2026-08-28 18:57 UTC — 153812 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 70468 systemes
...
- moteur actif `0caa9267db60` (110070 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 74594 | 37083 | 5083 | 2548 | 7482 | 5935 | 7862 | 7656 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 73103 | 17004 | 30910 | 35 | 10081 | 3755 | 31 | 11284 | 15.4% |
...
- candidats AVEC connectivite : 7783, dont T2 : 100%
- candidats SANS connectivite : 11594, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8136 systemes avec CONNECTED sur 63357 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*15087 candidats sur 19377 portent les champs bruts (78%).*

- `5c556c16ea8b` — 9122 candidats
  - AVEC connectivite (3655) : resistance **41.1%**
  - SANS connectivite (5467) : resistance **21.7%**
...
- `5c556c16ea8b` — 9122 candidats
  - AVEC connectivite (3655) : T0=13.02 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (5467) : T0=15.89 T1=0.00 T2=2.68 — pondere **5.35**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 60856 systemes
  - sans CONNECTED : 0.0% sur 13738 systemes
