...
genere 2026-08-27 01:02 UTC — 73012 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 9167 systemes
- `ab89a63b01ef` : 8105 systemes
...
- moteur actif `0caa9267db60` (29270 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 33090 | 7627 | 14057 | 19 | 4597 | 1728 | 16 | 5046 | 15.2% |
...
- candidats SANS connectivite : 5356, dont T2 : 100%
...
*4645 candidats sur 8935 portent les champs bruts (52%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 968 candidats
  - AVEC connectivite (399) : resistance **40.8%**
  - SANS connectivite (569) : resistance **21.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 968 candidats
  ...
  - SANS connectivite (569) : T0=15.92 T1=0.00 T2=2.64 — pondere **5.28**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
