...
genere 2026-08-26 22:14 UTC — 66862 systemes evalues
...
- moteur actif `0caa9267db60` (23120 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 30697 | 15253 | 2102 | 1032 | 3061 | 2442 | 3269 | 3150 | 10.3% |
...
- candidats AVEC connectivite : 3277, dont T2 : 100%
- candidats SANS connectivite : 4928, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3543 systemes avec CONNECTED sur 27599 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3915 candidats sur 8205 portent les champs bruts (48%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 238 candidats
  - AVEC connectivite (97) : resistance **42.6%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 238 candidats
  - AVEC connectivite (97) : T0=12.99 T1=0.00 T2=3.03 — pondere **6.06**
  - SANS connectivite (141) : T0=16.16 T1=0.00 T2=2.77 — pondere **5.53**
  - test de permutation : **p = 0.1984** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 25098 systemes
  - sans CONNECTED : 0.0% sur 5599 systemes
