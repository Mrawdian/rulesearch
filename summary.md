...
genere 2026-09-04 06:54 UTC — 358496 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 275152 systemes
...
- moteur actif `0caa9267db60` (314754 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 177954 | 88456 | 12093 | 5957 | 18097 | 14011 | 18865 | 18211 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 174427 | 40534 | 73676 | 70 | 24210 | 9044 | 70 | 26809 | 15.4% |
...
- candidats AVEC connectivite : 18338, dont T2 : 100%
- candidats SANS connectivite : 27119, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19139 systemes avec CONNECTED sur 147716 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*41167 candidats sur 45457 portent les champs bruts (91%).*

- `5c556c16ea8b` — 35202 candidats
  - AVEC connectivite (14210) : resistance **41.1%**
  - SANS connectivite (20992) : resistance **21.2%**
...
- `5c556c16ea8b` — 35202 candidats
  - AVEC connectivite (14210) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (20992) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 145215 systemes
  - sans CONNECTED : 0.0% sur 32739 systemes
