...
genere 2026-08-25 22:55 UTC — 9478 systemes evalues
...
| connect | 4 | 3 | 4737 | 2391 | 293 | 166 | 459 | 383 | 497 | 494 | 10.4% |
| ref | 4 | 3 | 4617 | 1128 | 1940 | 1 | 605 | 220 | 2 | 721 | 15.6% |
...
- candidats AVEC connectivite : 497, dont T2 : 100%
- candidats SANS connectivite : 725, dont T2 : 100%
...
- **497 systemes avec CONNECTED sur 3943 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 57 candidats
  - AVEC connectivite (18) : T0=12.61 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (39) : T0=16.10 T1=0.00 T2=2.97 — pondere **5.95**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 3886 systemes
  - sans CONNECTED : 0.0% sur 851 systemes
