...
genere 2026-09-02 04:27 UTC — 301814 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 218470 systemes
...
- moteur actif `0caa9267db60` (258072 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 149335 | 74205 | 10158 | 5009 | 15134 | 11755 | 15801 | 15360 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 146364 | 34034 | 61949 | 62 | 20257 | 7559 | 63 | 22428 | 15.3% |
...
- candidats AVEC connectivite : 15487, dont T2 : 100%
- candidats SANS connectivite : 22738, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16075 systemes avec CONNECTED sur 124424 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*33935 candidats sur 38225 portent les champs bruts (89%).*

- `5c556c16ea8b` — 27970 candidats
  - AVEC connectivite (11359) : resistance **41.0%**
  - SANS connectivite (16611) : resistance **21.3%**
...
- `5c556c16ea8b` — 27970 candidats
  - AVEC connectivite (11359) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (16611) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 16148 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16075 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 121923 systemes
  - sans CONNECTED : 0.0% sur 27412 systemes
