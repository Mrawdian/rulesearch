...
genere 2026-08-31 12:52 UTC — 252258 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 168914 systemes
...
- moteur actif `0caa9267db60` (208516 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 124335 | 61828 | 8433 | 4165 | 12535 | 9810 | 13133 | 12802 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 121808 | 28419 | 51420 | 54 | 16854 | 6302 | 56 | 18693 | 15.3% |
...
- candidats AVEC connectivite : 12929, dont T2 : 100%
- candidats SANS connectivite : 19003, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13407 systemes avec CONNECTED sur 103986 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*27642 candidats sur 31932 portent les champs bruts (87%).*

- `5c556c16ea8b` — 21677 candidats
  - AVEC connectivite (8801) : resistance **41.0%**
  - SANS connectivite (12876) : resistance **21.4%**
...
- `5c556c16ea8b` — 21677 candidats
  - AVEC connectivite (8801) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (12876) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 101485 systemes
  - sans CONNECTED : 0.0% sur 22850 systemes
