...
genere 2026-08-26 22:13 UTC — 66832 systemes evalues
...
- moteur actif `0caa9267db60` (23090 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 30035 | 6924 | 12759 | 18 | 4152 | 1552 | 14 | 4616 | 15.4% |
...
- candidats SANS connectivite : 4926, dont T2 : 100%
...
*3909 candidats sur 8199 portent les champs bruts (48%).*
...
- `ab89a63b01ef` — 232 candidats
  ...
  - SANS connectivite (139) : T0=16.15 T1=0.00 T2=2.76 — pondere **5.51**
  - test de permutation : **p = 0.2499** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- TROP-CHER : 3567 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3543 avec CONNECTED, 24 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
