...
genere 2026-09-01 02:03 UTC — 269469 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 186125 systemes
...
- moteur actif `0caa9267db60` (225727 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 133022 | 66093 | 8996 | 4465 | 13493 | 10526 | 14039 | 13684 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 130332 | 30374 | 55073 | 57 | 18049 | 6745 | 57 | 19967 | 15.3% |
...
- candidats AVEC connectivite : 13811, dont T2 : 100%
...
- **14313 systemes avec CONNECTED sur 111025 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*29798 candidats sur 34088 portent les champs bruts (87%).*

- `5c556c16ea8b` — 23833 candidats
  - AVEC connectivite (9683) : resistance **41.0%**
...
- `5c556c16ea8b` — 23833 candidats
  - AVEC connectivite (9683) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 14380 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14313 avec CONNECTED, 67 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 108524 systemes
  - sans CONNECTED : 0.0% sur 24498 systemes
