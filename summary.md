...
genere 2026-08-26 17:58 UTC — 57185 systemes evalues
...
- moteur actif `0caa9267db60` (13443 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `84fba70921e0`, `b71bb0907fb5`, `e40600351a72`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 25804 | 12855 | 1760 | 871 | 2560 | 2036 | 2758 | 2645 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 25266 | 5822 | 10703 | 15 | 3526 | 1283 | 10 | 3907 | 15.5% |
...
- candidats AVEC connectivite : 2772, dont T2 : 100%
- candidats SANS connectivite : 4217, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3032 systemes avec CONNECTED sur 23595 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2699 candidats sur 6989 portent les champs bruts (39%).*
...
- `b71bb0907fb5` — 53 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `0a74109317e5` — 50 candidats
  - AVEC connectivite (23) : resistance **41.6%**
  - SANS connectivite (27) : resistance **21.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `0a74109317e5` — 50 candidats
  - AVEC connectivite (23) : T0=13.61 T1=0.00 T2=3.09 — pondere **6.17**
  - SANS connectivite (27) : T0=15.89 T1=0.00 T2=2.59 — pondere **5.19**
  - test de permutation : **p = 0.3398** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 3052 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3032 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 21094 systemes
  - sans CONNECTED : 0.0% sur 4710 systemes
