...
- moteur actif `0caa9267db60` (6603 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22354 | 11143 | 1501 | 764 | 2225 | 1773 | 2392 | 2275 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 21876 | 5078 | 9225 | 13 | 3057 | 1122 | 10 | 3371 | 15.4% |
...
- candidats AVEC connectivite : 2402, dont T2 : 100%
- candidats SANS connectivite : 3681, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2666 systemes avec CONNECTED sur 20749 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1793 candidats sur 6083 portent les champs bruts (29%).*
...
- `06fe04a859f1` — 678 candidats
  - AVEC connectivite (264) : resistance **41.0%**
  - SANS connectivite (414) : resistance **20.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 678 candidats
  - AVEC connectivite (264) : T0=13.31 T1=0.00 T2=3.01 — pondere **6.02**
  - SANS connectivite (414) : T0=16.01 T1=0.00 T2=2.64 — pondere **5.29**
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0030), `e3baecf8377b` (p=0.0005).
...
- TROP-CHER : 2686 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2666 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18248 systemes
  - sans CONNECTED : 0.0% sur 4106 systemes
