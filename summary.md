...
genere 2026-09-08 10:48 UTC — 455929 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 372585 systemes
...
- moteur actif `0caa9267db60` (412187 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 227164 | 112828 | 15451 | 7594 | 22979 | 17806 | 24213 | 23400 | 10.3% |
...
- candidats AVEC connectivite : 23527, dont T2 : 100%
...
- **24487 systemes avec CONNECTED sur 188002 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*53786 candidats sur 58076 portent les champs bruts (93%).*

- `5c556c16ea8b` — 47821 candidats
  - AVEC connectivite (19399) : resistance **41.2%**
...
- `5c556c16ea8b` — 47821 candidats
  - AVEC connectivite (19399) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 24578 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 24487 avec CONNECTED, 91 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 185501 systemes
  - sans CONNECTED : 0.0% sur 41663 systemes
