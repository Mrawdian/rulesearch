...
genere 2026-08-25 22:29 UTC — 8399 systemes evalues

## versions du DSL presentes
- `615abe43d6bc` : 7172 systemes
- `0327bdc4c76a` : 853 systemes
- `12a0c0c5e34b` : 250 systemes
...
| connect | 4 | 3 | 4183 | 2111 | 267 | 146 | 402 | 326 | 435 | 447 | 10.7% |
| ref | 4 | 3 | 4092 | 998 | 1721 | 1 | 546 | 192 | 2 | 632 | 15.4% |
...
- candidats AVEC connectivite : 450, dont T2 : 100%
...
- **435 systemes avec CONNECTED sur 3495 (12.4%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 3438 systemes
  - sans CONNECTED : 0.0% sur 745 systemes
