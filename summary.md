...
genere 2026-08-26 18:53 UTC — 59453 systemes evalues
...
- moteur actif `0caa9267db60` (15711 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 26957 | 13453 | 1835 | 908 | 2673 | 2132 | 2865 | 2755 | 10.2% |
...
- candidats AVEC connectivite : 2882, dont T2 : 100%
- candidats SANS connectivite : 4373, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3139 systemes avec CONNECTED sur 24550 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2965 candidats sur 7255 portent les champs bruts (41%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 96 candidats
  - AVEC connectivite (38) : resistance **45.5%**
...
- `62448a55927e` — 96 candidats
  - AVEC connectivite (38) : T0=13.21 T1=0.00 T2=3.26 — pondere **6.53**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22049 systemes
  - sans CONNECTED : 0.0% sur 4908 systemes
