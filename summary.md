...
genere 2026-09-01 22:22 UTC — 294479 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 211135 systemes
...
- moteur actif `0caa9267db60` (250737 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 145636 | 72319 | 9905 | 4885 | 14798 | 11481 | 15407 | 14963 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 142728 | 33198 | 60373 | 61 | 19779 | 7368 | 63 | 21875 | 15.3% |
...
- candidats AVEC connectivite : 15090, dont T2 : 100%
- candidats SANS connectivite : 22185, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15681 systemes avec CONNECTED sur 121350 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*32985 candidats sur 37275 portent les champs bruts (88%).*

- `5c556c16ea8b` — 27020 candidats
  - AVEC connectivite (10962) : resistance **41.0%**
  - SANS connectivite (16058) : resistance **21.3%**
...
- `5c556c16ea8b` — 27020 candidats
  - AVEC connectivite (10962) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (16058) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 15754 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15681 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 118849 systemes
  - sans CONNECTED : 0.0% sur 26787 systemes
