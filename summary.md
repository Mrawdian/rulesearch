...
genere 2026-08-29 07:32 UTC — 174998 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 91654 systemes
...
- moteur actif `0caa9267db60` (131256 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 85307 | 42451 | 5803 | 2881 | 8557 | 6777 | 8953 | 8802 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 83576 | 19505 | 35344 | 39 | 11525 | 4257 | 34 | 12866 | 15.4% |
...
- candidats SANS connectivite : 13176, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9227 systemes avec CONNECTED sur 72132 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*17815 candidats sur 22105 portent les champs bruts (81%).*

- `5c556c16ea8b` — 11850 candidats
  - AVEC connectivite (4801) : resistance **41.1%**
  - SANS connectivite (7049) : resistance **21.6%**
...
- `5c556c16ea8b` — 11850 candidats
  ...
  - SANS connectivite (7049) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.33**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 69631 systemes
  - sans CONNECTED : 0.0% sur 15676 systemes
