...
genere 2026-08-26 13:57 UTC — 47827 systemes evalues
...
- moteur actif `0caa9267db60` (4085 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21081 | 10522 | 1395 | 728 | 2090 | 1676 | 2250 | 2156 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20631 | 4816 | 8712 | 13 | 2861 | 1065 | 7 | 3157 | 15.3% |
...
- candidats AVEC connectivite : 2283, dont T2 : 100%
- candidats SANS connectivite : 3467, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2524 systemes avec CONNECTED sur 19721 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1460 candidats sur 5750 portent les champs bruts (25%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 345 candidats
  - AVEC connectivite (145) : resistance **39.7%**
  - SANS connectivite (200) : resistance **20.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 345 candidats
  - AVEC connectivite (145) : T0=13.35 T1=0.00 T2=2.92 — pondere **5.83**
  - SANS connectivite (200) : T0=16.12 T1=0.00 T2=2.69 — pondere **5.39**
...
- TROP-CHER : 2541 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2524 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17220 systemes
  - sans CONNECTED : 0.0% sur 3861 systemes
