...
genere 2026-08-29 12:45 UTC — 183347 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 100003 systemes
...
- moteur actif `0caa9267db60` (139605 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 89519 | 44520 | 6084 | 3028 | 9002 | 7144 | 9393 | 9209 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 87713 | 20514 | 37018 | 43 | 12099 | 4500 | 35 | 13498 | 15.4% |
...
- candidats AVEC connectivite : 9336, dont T2 : 100%
- candidats SANS connectivite : 13808, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9667 systemes avec CONNECTED sur 75524 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*18854 candidats sur 23144 portent les champs bruts (81%).*

- `5c556c16ea8b` — 12889 candidats
  - AVEC connectivite (5208) : resistance **41.2%**
  - SANS connectivite (7681) : resistance **21.5%**
...
- `5c556c16ea8b` — 12889 candidats
  - AVEC connectivite (5208) : T0=12.99 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (7681) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.33**
...
## cout
- temps total 56.3 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 9712 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 9667 avec CONNECTED, 45 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 73023 systemes
  - sans CONNECTED : 0.0% sur 16496 systemes
