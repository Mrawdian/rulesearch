...
genere 2026-08-31 06:15 UTC — 243209 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 159865 systemes
...
- moteur actif `0caa9267db60` (199467 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 119768 | 59573 | 8133 | 4016 | 12027 | 9447 | 12683 | 12333 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 117326 | 27387 | 49572 | 53 | 16223 | 6056 | 52 | 17973 | 15.3% |
...
- candidats AVEC connectivite : 12460, dont T2 : 100%
- candidats SANS connectivite : 18283, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12957 systemes avec CONNECTED sur 100307 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*26453 candidats sur 30743 portent les champs bruts (86%).*

- `5c556c16ea8b` — 20488 candidats
  - AVEC connectivite (8332) : resistance **40.9%**
  - SANS connectivite (12156) : resistance **21.4%**
...
- `5c556c16ea8b` — 20488 candidats
  - AVEC connectivite (8332) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (12156) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 13019 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 12957 avec CONNECTED, 62 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 97806 systemes
  - sans CONNECTED : 0.0% sur 21962 systemes
