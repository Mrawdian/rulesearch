...
**7466 enregistrements (53%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 7082 | 3558 | 466 | 247 | 674 | 574 | 737 | 746 | 10.5% |
| ref | 4 | 3 | 6907 | 1666 | 2875 | 1 | 927 | 345 | 2 | 1091 | 15.8% |
...
- candidats AVEC connectivite : 749, dont T2 : 100%
- candidats SANS connectivite : 1095, dont T2 : 100%
...
- **737 systemes avec CONNECTED sur 5859 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 679 candidats
  - AVEC connectivite (270) : T0=13.22 T1=0.00 T2=2.92 — pondere **5.84**
  - SANS connectivite (409) : T0=15.83 T1=0.00 T2=2.64 — pondere **5.27**
...
## cout
- temps total 4.3 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 739 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 737 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 5802 systemes
  - sans CONNECTED : 0.0% sur 1280 systemes
