...
genere 2026-09-09 18:24 UTC — 483880 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 400536 systemes
...
- moteur actif `0caa9267db60` (440138 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 241279 | 119784 | 16452 | 8082 | 24421 | 18927 | 25699 | 24855 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 236486 | 55117 | 99644 | 94 | 32939 | 12210 | 86 | 36375 | 15.4% |
...
- candidats AVEC connectivite : 24982, dont T2 : 100%
- candidats SANS connectivite : 36685, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25973 systemes avec CONNECTED sur 199478 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*57377 candidats sur 61667 portent les champs bruts (93%).*

- `5c556c16ea8b` — 51412 candidats
  - AVEC connectivite (20854) : resistance **41.2%**
  - SANS connectivite (30558) : resistance **21.3%**
...
- `5c556c16ea8b` — 51412 candidats
  - AVEC connectivite (20854) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (30558) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 196977 systemes
  - sans CONNECTED : 0.0% sur 44302 systemes
