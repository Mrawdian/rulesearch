...
genere 2026-08-28 15:00 UTC — 146874 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 63530 systemes
...
- moteur actif `0caa9267db60` (103132 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 69661 | 16172 | 29426 | 32 | 9641 | 3592 | 30 | 10765 | 15.5% |
...
- candidats SANS connectivite : 11075, dont T2 : 100%
...
*14198 candidats sur 18488 portent les champs bruts (77%).*

- `5c556c16ea8b` — 8233 candidats
  - AVEC connectivite (3285) : resistance **41.2%**
  - SANS connectivite (4948) : resistance **21.8%**
...
- `5c556c16ea8b` — 8233 candidats
  ...
  - SANS connectivite (4948) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.36**
...
- TROP-CHER : 7822 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7782 avec CONNECTED, 40 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
