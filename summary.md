...
genere 2026-09-01 00:55 UTC — 267932 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 184588 systemes
...
- moteur actif `0caa9267db60` (224190 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 132248 | 65716 | 8941 | 4436 | 13410 | 10453 | 13969 | 13609 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 129569 | 30198 | 54747 | 56 | 17945 | 6706 | 57 | 19850 | 15.3% |
...
- candidats AVEC connectivite : 13736, dont T2 : 100%
- candidats SANS connectivite : 20160, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14243 systemes avec CONNECTED sur 110399 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*29606 candidats sur 33896 portent les champs bruts (87%).*

- `5c556c16ea8b` — 23641 candidats
  - AVEC connectivite (9608) : resistance **41.0%**
  - SANS connectivite (14033) : resistance **21.3%**
...
- `5c556c16ea8b` — 23641 candidats
  - AVEC connectivite (9608) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (14033) : T0=15.93 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 107898 systemes
