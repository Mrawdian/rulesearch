...
| connect | 4 | 3 | 18457 | 9214 | 1196 | 640 | 1840 | 1470 | 2005 | 1862 | 10.1% |
...
- candidats AVEC connectivite : 1989, dont T2 : 100%
- candidats SANS connectivite : 3084, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2279 systemes avec CONNECTED sur 17568 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*783 candidats sur 5073 portent les champs bruts (15%).*
...
- `e3baecf8377b` — 519 candidats
  - AVEC connectivite (206) : resistance **42.5%**
...
- `e3baecf8377b` — 519 candidats
  - AVEC connectivite (206) : T0=13.03 T1=0.00 T2=3.10 — pondere **6.20**
...
- TROP-CHER : 2296 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 2279 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 15067 systemes
  - sans CONNECTED : 0.0% sur 3390 systemes
