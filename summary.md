...
genere 2026-09-04 10:29 UTC — 362422 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 279078 systemes
...
- moteur actif `0caa9267db60` (318680 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 179938 | 89423 | 12226 | 6018 | 18309 | 14187 | 19060 | 18418 | 10.2% |
...
- candidats AVEC connectivite : 18545, dont T2 : 100%
...
- **19334 systemes avec CONNECTED sur 149292 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*41655 candidats sur 45945 portent les champs bruts (91%).*

- `5c556c16ea8b` — 35690 candidats
  - AVEC connectivite (14417) : resistance **41.0%**
...
- `5c556c16ea8b` — 35690 candidats
  - AVEC connectivite (14417) : T0=13.03 T1=0.00 T2=2.97 — pondere **5.95**
...
- TROP-CHER : 19414 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19334 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 146791 systemes
  - sans CONNECTED : 0.0% sur 33147 systemes
