...
genere 2026-08-30 05:37 UTC — 208719 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 125375 systemes
...
- moteur actif `0caa9267db60` (164977 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 102348 | 50818 | 6966 | 3427 | 10334 | 8162 | 10794 | 10515 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 100256 | 23337 | 42368 | 45 | 13847 | 5178 | 39 | 15435 | 15.4% |
...
- candidats AVEC connectivite : 10642, dont T2 : 100%
- candidats SANS connectivite : 15745, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11068 systemes avec CONNECTED sur 85970 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*22097 candidats sur 26387 portent les champs bruts (84%).*

- `5c556c16ea8b` — 16132 candidats
  - AVEC connectivite (6514) : resistance **41.1%**
  - SANS connectivite (9618) : resistance **21.5%**
...
- `5c556c16ea8b` — 16132 candidats
  - AVEC connectivite (6514) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (9618) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 11117 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11068 avec CONNECTED, 49 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 83469 systemes
  - sans CONNECTED : 0.0% sur 18879 systemes
