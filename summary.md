...
genere 2026-08-26 14:41 UTC — 49515 systemes evalues
...
- moteur actif `0caa9267db60` (5773 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21936 | 10940 | 1470 | 753 | 2174 | 1737 | 2344 | 2241 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 21464 | 4988 | 9065 | 13 | 2981 | 1104 | 9 | 3304 | 15.4% |
...
- candidats SANS connectivite : 3614, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2618 systemes avec CONNECTED sur 20424 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1692 candidats sur 5982 portent les champs bruts (28%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 577 candidats
  - AVEC connectivite (230) : resistance **40.7%**
  - SANS connectivite (347) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 577 candidats
  ...
  - SANS connectivite (347) : T0=16.08 T1=0.00 T2=2.65 — pondere **5.30**
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0085).
...
- TROP-CHER : 2637 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2618 avec CONNECTED, 19 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17923 systemes
  - sans CONNECTED : 0.0% sur 4013 systemes
