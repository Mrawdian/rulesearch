...
genere 2026-09-05 17:32 UTC — 394421 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 311077 systemes
...
- moteur actif `0caa9267db60` (350679 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 196097 | 97381 | 13349 | 6539 | 19936 | 15424 | 20802 | 20172 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 192209 | 44738 | 81097 | 78 | 26762 | 9935 | 71 | 29514 | 15.4% |
...
- candidats AVEC connectivite : 20299, dont T2 : 100%
- candidats SANS connectivite : 29824, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21076 systemes avec CONNECTED sur 162488 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*45833 candidats sur 50123 portent les champs bruts (91%).*

- `5c556c16ea8b` — 39868 candidats
  - AVEC connectivite (16171) : resistance **41.1%**
  - SANS connectivite (23697) : resistance **21.3%**
...
- `5c556c16ea8b` — 39868 candidats
  - AVEC connectivite (16171) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (23697) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 159987 systemes
  - sans CONNECTED : 0.0% sur 36110 systemes
