...
| connect | 4 | 3 | 7637 | 3842 | 504 | 265 | 729 | 611 | 807 | 793 | 10.4% |
...
- candidats AVEC connectivite : 796, dont T2 : 100%
...
- **807 systemes avec CONNECTED sur 6323 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 807 candidats
  - AVEC connectivite (317) : T0=13.37 T1=0.00 T2=2.89 — pondere **5.79**
  - SANS connectivite (490) : T0=15.79 T1=0.00 T2=2.65 — pondere **5.31**
  - test de permutation : **p = 0.0395** — ecart significatif au seuil 0.05
...
- TROP-CHER : 809 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 807 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 6266 systemes
  - sans CONNECTED : 0.0% sur 1371 systemes
