...
| connect | 4 | 3 | 7442 | 3742 | 494 | 258 | 710 | 601 | 782 | 774 | 10.4% |
...
- candidats AVEC connectivite : 777, dont T2 : 100%
...
- **782 systemes avec CONNECTED sur 6156 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 758 candidats
  - AVEC connectivite (298) : T0=13.26 T1=0.00 T2=2.92 — pondere **5.83**
...
- TROP-CHER : 784 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 782 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 6099 systemes
