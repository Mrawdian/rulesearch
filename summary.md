...
genere 2026-08-27 08:37 UTC — 89604 systemes evalues
...
- moteur actif `0caa9267db60` (45862 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 42183 | 21004 | 2902 | 1428 | 4208 | 3314 | 4444 | 4337 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 41306 | 9522 | 17562 | 23 | 5716 | 2150 | 22 | 6311 | 15.3% |
...
- candidats AVEC connectivite : 4464, dont T2 : 100%
- candidats SANS connectivite : 6621, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4718 systemes avec CONNECTED sur 36978 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6795 candidats sur 11085 portent les champs bruts (61%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 830 candidats
  - AVEC connectivite (336) : resistance **41.0%**
  - SANS connectivite (494) : resistance **21.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 830 candidats
  - AVEC connectivite (336) : T0=13.10 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (494) : T0=15.94 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 34477 systemes
