...
genere 2026-08-26 18:01 UTC — 57319 systemes evalues
...
- moteur actif `0caa9267db60` (13577 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `84fba70921e0`, `b71bb0907fb5`, `e40600351a72`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 25879 | 12889 | 1766 | 876 | 2566 | 2044 | 2763 | 2655 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 25325 | 5838 | 10729 | 15 | 3534 | 1286 | 10 | 3913 | 15.5% |
...
- candidats AVEC connectivite : 2782, dont T2 : 100%
- candidats SANS connectivite : 4223, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3037 systemes avec CONNECTED sur 23659 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2715 candidats sur 7005 portent les champs bruts (39%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `0a74109317e5` — 66 candidats
  - AVEC connectivite (33) : resistance **38.0%**
  - SANS connectivite (33) : resistance **21.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `0a74109317e5` — 66 candidats
  - AVEC connectivite (33) : T0=14.06 T1=0.00 T2=2.79 — pondere **5.58**
  - SANS connectivite (33) : T0=15.67 T1=0.00 T2=2.61 — pondere **5.21**
  - test de permutation : **p = 0.7176** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `b71bb0907fb5` — 53 candidats
...
- TROP-CHER : 3057 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3037 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 21158 systemes
  - sans CONNECTED : 0.0% sur 4721 systemes
