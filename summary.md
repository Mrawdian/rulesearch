...
genere 2026-08-26 16:33 UTC — 53993 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 8810 systemes
...
- moteur actif `0caa9267db60` (10251 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 24194 | 12068 | 1648 | 821 | 2401 | 1913 | 2579 | 2462 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 23684 | 5484 | 10001 | 14 | 3317 | 1203 | 10 | 3655 | 15.4% |
...
- candidats AVEC connectivite : 2589, dont T2 : 100%
- candidats SANS connectivite : 3965, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2853 systemes avec CONNECTED sur 22265 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2264 candidats sur 6554 portent les champs bruts (35%).*
...
- `06fe04a859f1` — 1149 candidats
  - AVEC connectivite (451) : resistance **40.9%**
  - SANS connectivite (698) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1149 candidats
  - AVEC connectivite (451) : T0=13.12 T1=0.00 T2=3.02 — pondere **6.04**
  - SANS connectivite (698) : T0=15.98 T1=0.00 T2=2.63 — pondere **5.27**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
...
- TROP-CHER : 2873 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2853 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 19764 systemes
  - sans CONNECTED : 0.0% sur 4430 systemes
