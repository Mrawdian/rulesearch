...
genere 2026-08-26 14:31 UTC — 49116 systemes evalues
...
- moteur actif `0caa9267db60` (5374 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21726 | 10843 | 1450 | 747 | 2149 | 1724 | 2323 | 2215 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 21275 | 4945 | 8983 | 13 | 2948 | 1099 | 8 | 3279 | 15.4% |
...
- candidats AVEC connectivite : 2342, dont T2 : 100%
- candidats SANS connectivite : 3589, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2597 systemes avec CONNECTED sur 20260 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1641 candidats sur 5931 portent les champs bruts (28%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 526 candidats
  - AVEC connectivite (204) : resistance **40.0%**
  - SANS connectivite (322) : resistance **20.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 526 candidats
  - AVEC connectivite (204) : T0=13.45 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (322) : T0=16.06 T1=0.00 T2=2.62 — pondere **5.24**
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0115).
...
- TROP-CHER : 2615 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2597 avec CONNECTED, 18 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17759 systemes
  - sans CONNECTED : 0.0% sur 3967 systemes
