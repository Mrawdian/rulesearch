...
genere 2026-08-28 13:37 UTC — 144443 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 61099 systemes
...
- moteur actif `0caa9267db60` (100701 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 69873 | 34713 | 4774 | 2369 | 7017 | 5584 | 7379 | 7142 | 10.2% |
...
- candidats AVEC connectivite : 7269, dont T2 : 100%
...
- **7653 systemes avec CONNECTED sur 59477 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*13864 candidats sur 18154 portent les champs bruts (76%).*

- `5c556c16ea8b` — 7899 candidats
  - AVEC connectivite (3141) : resistance **41.3%**
...
- `5c556c16ea8b` — 7899 candidats
  - AVEC connectivite (3141) : T0=13.00 T1=0.00 T2=3.00 — pondere **6.01**
...
- TROP-CHER : 7693 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7653 avec CONNECTED, 40 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 56976 systemes
  - sans CONNECTED : 0.0% sur 12897 systemes
