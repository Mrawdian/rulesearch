...
genere 2026-08-26 23:15 UTC — 68970 systemes evalues
...
- moteur actif `0caa9267db60` (25228 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 31772 | 15776 | 2180 | 1068 | 3162 | 2534 | 3396 | 3251 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 31083 | 7161 | 13212 | 18 | 4302 | 1615 | 14 | 4761 | 15.3% |
...
- candidats AVEC connectivite : 3378, dont T2 : 100%
- candidats SANS connectivite : 5071, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3670 systemes avec CONNECTED sur 28476 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4159 candidats sur 8449 portent les champs bruts (49%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 482 candidats
  - AVEC connectivite (198) : resistance **41.8%**
  - SANS connectivite (284) : resistance **21.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 482 candidats
  - AVEC connectivite (198) : T0=12.98 T1=0.00 T2=3.05 — pondere **6.10**
  - SANS connectivite (284) : T0=16.06 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 25975 systemes
  - sans CONNECTED : 0.0% sur 5797 systemes
