...
genere 2026-08-26 19:01 UTC — 59881 systemes evalues
...
- moteur actif `0caa9267db60` (16139 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27165 | 13560 | 1846 | 914 | 2694 | 2150 | 2880 | 2782 | 10.2% |
...
- candidats AVEC connectivite : 2909, dont T2 : 100%
- candidats SANS connectivite : 4402, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3154 systemes avec CONNECTED sur 24719 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3021 candidats sur 7311 portent les champs bruts (41%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 152 candidats
  - AVEC connectivite (65) : resistance **39.9%**
...
- `62448a55927e` — 152 candidats
  - AVEC connectivite (65) : T0=13.09 T1=0.00 T2=2.91 — pondere **5.82**
  - SANS connectivite (87) : T0=16.06 T1=0.00 T2=2.57 — pondere **5.15**
  - test de permutation : **p = 0.2004** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22218 systemes
  - sans CONNECTED : 0.0% sur 4947 systemes
