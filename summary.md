...
genere 2026-09-01 03:45 UTC — 271538 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 188194 systemes
...
- moteur actif `0caa9267db60` (227796 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 134066 | 66607 | 9064 | 4499 | 13602 | 10611 | 14165 | 13779 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 131357 | 30612 | 55509 | 57 | 18212 | 6781 | 57 | 20119 | 15.3% |
...
- candidats AVEC connectivite : 13906, dont T2 : 100%
- candidats SANS connectivite : 20429, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14439 systemes avec CONNECTED sur 111873 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*30045 candidats sur 34335 portent les champs bruts (88%).*

- `5c556c16ea8b` — 24080 candidats
  - AVEC connectivite (9778) : resistance **41.0%**
  - SANS connectivite (14302) : resistance **21.3%**
...
- `5c556c16ea8b` — 24080 candidats
  - AVEC connectivite (9778) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (14302) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 14506 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14439 avec CONNECTED, 67 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 109372 systemes
  - sans CONNECTED : 0.0% sur 24694 systemes
