...
genere 2026-09-02 23:21 UTC — 323492 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 240148 systemes
...
- moteur actif `0caa9267db60` (279750 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 160280 | 79618 | 10890 | 5361 | 16326 | 12633 | 16984 | 16416 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 157097 | 36620 | 66401 | 64 | 21729 | 8110 | 65 | 24096 | 15.3% |
...
- candidats AVEC connectivite : 16543, dont T2 : 100%
- candidats SANS connectivite : 24406, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **17258 systemes avec CONNECTED sur 133266 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*36659 candidats sur 40949 portent les champs bruts (90%).*

- `5c556c16ea8b` — 30694 candidats
  - AVEC connectivite (12415) : resistance **41.1%**
  - SANS connectivite (18279) : resistance **21.2%**
...
- `5c556c16ea8b` — 30694 candidats
  - AVEC connectivite (12415) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (18279) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 130765 systemes
  - sans CONNECTED : 0.0% sur 29515 systemes
