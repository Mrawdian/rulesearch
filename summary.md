...
genere 2026-08-27 01:18 UTC — 73574 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 9167 systemes
- `ab89a63b01ef` : 8667 systemes
...
- moteur actif `0caa9267db60` (29832 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 34092 | 16957 | 2337 | 1157 | 3388 | 2711 | 3632 | 3474 | 10.2% |
...
- **3906 systemes avec CONNECTED sur 30387 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
## cout
- temps total 22.8 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 3933 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3906 avec CONNECTED, 27 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 27886 systemes
  - sans CONNECTED : 0.0% sur 6206 systemes
