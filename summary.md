...
genere 2026-09-04 03:34 UTC — 354893 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 271549 systemes
...
- moteur actif `0caa9267db60` (311151 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 176128 | 87530 | 11978 | 5886 | 17935 | 13859 | 18674 | 18023 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 172650 | 40124 | 72898 | 70 | 23995 | 8945 | 68 | 26536 | 15.4% |
...
- candidats SANS connectivite : 26846, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18948 systemes avec CONNECTED sur 146215 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*40706 candidats sur 44996 portent les champs bruts (90%).*

- `5c556c16ea8b` — 34741 candidats
  - AVEC connectivite (14022) : resistance **41.0%**
  - SANS connectivite (20719) : resistance **21.3%**
...
- `5c556c16ea8b` — 34741 candidats
  ...
  - SANS connectivite (20719) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 19026 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18948 avec CONNECTED, 78 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 143714 systemes
  - sans CONNECTED : 0.0% sur 32414 systemes
