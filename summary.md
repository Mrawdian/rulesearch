...
genere 2026-08-31 02:29 UTC — 238060 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 154716 systemes
...
- moteur actif `0caa9267db60` (194318 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 117163 | 58267 | 7955 | 3935 | 11784 | 9236 | 12412 | 12045 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 114782 | 26783 | 48512 | 53 | 15833 | 5930 | 51 | 17610 | 15.3% |
...
- candidats AVEC connectivite : 12172, dont T2 : 100%
- candidats SANS connectivite : 17920, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12686 systemes avec CONNECTED sur 98170 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*25802 candidats sur 30092 portent les champs bruts (86%).*

- `5c556c16ea8b` — 19837 candidats
  - AVEC connectivite (8044) : resistance **41.0%**
  - SANS connectivite (11793) : resistance **21.4%**
...
- `5c556c16ea8b` — 19837 candidats
  - AVEC connectivite (8044) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (11793) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 95669 systemes
  - sans CONNECTED : 0.0% sur 21494 systemes
