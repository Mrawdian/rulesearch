...
genere 2026-08-29 18:53 UTC — 192451 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 109107 systemes
...
- moteur actif `0caa9267db60` (148709 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 94113 | 46762 | 6409 | 3158 | 9482 | 7493 | 9933 | 9676 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 92223 | 21515 | 38928 | 43 | 12755 | 4748 | 36 | 14192 | 15.4% |
...
- candidats AVEC connectivite : 9803, dont T2 : 100%
- candidats SANS connectivite : 14502, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10207 systemes avec CONNECTED sur 79280 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*20015 candidats sur 24305 portent les champs bruts (82%).*

- `5c556c16ea8b` — 14050 candidats
  - AVEC connectivite (5675) : resistance **41.2%**
  - SANS connectivite (8375) : resistance **21.5%**
...
- `5c556c16ea8b` — 14050 candidats
  - AVEC connectivite (5675) : T0=12.99 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (8375) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 10253 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10207 avec CONNECTED, 46 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 76779 systemes
  - sans CONNECTED : 0.0% sur 17334 systemes
