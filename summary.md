...
genere 2026-08-26 19:15 UTC — 60292 systemes evalues
...
- moteur actif `0caa9267db60` (16550 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27375 | 13655 | 1867 | 924 | 2706 | 2169 | 2909 | 2802 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 26802 | 6195 | 11344 | 15 | 3733 | 1377 | 10 | 4128 | 15.4% |
...
- candidats AVEC connectivite : 2929, dont T2 : 100%
- candidats SANS connectivite : 4438, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3183 systemes avec CONNECTED sur 24900 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3077 candidats sur 7367 portent les champs bruts (42%).*
...
- `23303c299f39` — 225 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 208 candidats
  - AVEC connectivite (85) : resistance **38.7%**
  - SANS connectivite (123) : resistance **18.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 208 candidats
  - AVEC connectivite (85) : T0=13.21 T1=0.00 T2=2.88 — pondere **5.76**
  - SANS connectivite (123) : T0=16.11 T1=0.00 T2=2.58 — pondere **5.15**
  - test de permutation : **p = 0.1784** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
- TROP-CHER : 3203 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3183 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22399 systemes
  - sans CONNECTED : 0.0% sur 4976 systemes
