...
genere 2026-08-30 12:33 UTC — 218519 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 135175 systemes
...
- moteur actif `0caa9267db60` (174777 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
**7585 enregistrements (3%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 107295 | 53296 | 7303 | 3582 | 10808 | 8534 | 11359 | 11017 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 105109 | 24512 | 44385 | 49 | 14511 | 5439 | 41 | 16163 | 15.4% |
...
- candidats AVEC connectivite : 11144, dont T2 : 100%
- candidats SANS connectivite : 16473, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11633 systemes avec CONNECTED sur 90027 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*23327 candidats sur 27617 portent les champs bruts (84%).*

- `5c556c16ea8b` — 17362 candidats
  - AVEC connectivite (7016) : resistance **41.1%**
  - SANS connectivite (10346) : resistance **21.5%**
...
- `5c556c16ea8b` — 17362 candidats
  - AVEC connectivite (7016) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (10346) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
## cout
- temps total 67.7 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 11684 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11633 avec CONNECTED, 51 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 87526 systemes
  - sans CONNECTED : 0.0% sur 19769 systemes
