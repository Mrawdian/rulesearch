...
genere 2026-08-27 11:41 UTC — 95926 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 18378 systemes
- `5c556c16ea8b` : 12582 systemes
...
- moteur actif `0caa9267db60` (52184 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 45379 | 22633 | 3109 | 1540 | 4523 | 3580 | 4776 | 4632 | 10.2% |
...
- candidats AVEC connectivite : 4759, dont T2 : 100%
- candidats SANS connectivite : 7107, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5050 systemes avec CONNECTED sur 39579 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*7576 candidats sur 11866 portent les champs bruts (64%).*
...
- `ab89a63b01ef` — 2280 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 1611 candidats
  - AVEC connectivite (631) : resistance **41.6%**
...
- `ab89a63b01ef` — 2280 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 1611 candidats
  - AVEC connectivite (631) : T0=13.04 T1=0.00 T2=3.03 — pondere **6.06**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 37078 systemes
  - sans CONNECTED : 0.0% sur 8301 systemes
