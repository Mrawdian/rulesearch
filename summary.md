...
genere 2026-08-27 14:46 UTC — 101942 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 18598 systemes
...
- moteur actif `0caa9267db60` (58200 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 47417 | 10972 | 20129 | 25 | 6564 | 2479 | 22 | 7225 | 15.2% |
...
- candidats SANS connectivite : 7535, dont T2 : 100%
...
*8294 candidats sur 12584 portent les champs bruts (66%).*
...
- `5c556c16ea8b` — 2329 candidats
  - AVEC connectivite (921) : resistance **41.6%**
  - SANS connectivite (1408) : resistance **22.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 2329 candidats
  ...
  - SANS connectivite (1408) : T0=15.78 T1=0.00 T2=2.68 — pondere **5.37**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 2280 candidats
