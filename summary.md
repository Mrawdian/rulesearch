...
genere 2026-09-02 04:10 UTC — 301458 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 218114 systemes
...
- moteur actif `0caa9267db60` (257716 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 149155 | 74119 | 10146 | 5000 | 15120 | 11738 | 15784 | 15337 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 146188 | 33990 | 61867 | 62 | 20240 | 7555 | 63 | 22399 | 15.3% |
...
- candidats AVEC connectivite : 15464, dont T2 : 100%
- candidats SANS connectivite : 22709, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16058 systemes avec CONNECTED sur 124281 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*33883 candidats sur 38173 portent les champs bruts (89%).*

- `5c556c16ea8b` — 27918 candidats
  - AVEC connectivite (11336) : resistance **41.0%**
  - SANS connectivite (16582) : resistance **21.3%**
...
- `5c556c16ea8b` — 27918 candidats
  - AVEC connectivite (11336) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (16582) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 121780 systemes
  - sans CONNECTED : 0.0% sur 27375 systemes
