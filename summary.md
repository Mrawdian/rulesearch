...
genere 2026-09-04 09:12 UTC — 361035 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 277691 systemes
...
- moteur actif `0caa9267db60` (317293 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 179239 | 89084 | 12178 | 5991 | 18244 | 14118 | 18989 | 18349 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 175681 | 40811 | 74224 | 72 | 24396 | 9105 | 70 | 26989 | 15.4% |
...
- candidats SANS connectivite : 27299, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19263 systemes avec CONNECTED sur 148735 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*41485 candidats sur 45775 portent les champs bruts (91%).*

- `5c556c16ea8b` — 35520 candidats
  - AVEC connectivite (14348) : resistance **41.1%**
  - SANS connectivite (21172) : resistance **21.3%**
...
- `5c556c16ea8b` — 35520 candidats
  ...
  - SANS connectivite (21172) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 146234 systemes
  - sans CONNECTED : 0.0% sur 33005 systemes
