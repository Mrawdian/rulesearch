...
genere 2026-08-28 07:13 UTC — 133404 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 50060 systemes
...
- moteur actif `0caa9267db60` (89662 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 64302 | 31952 | 4414 | 2182 | 6446 | 5117 | 6758 | 6605 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 62987 | 14574 | 26661 | 29 | 8771 | 3255 | 28 | 9667 | 15.3% |
...
- candidats AVEC connectivite : 6732, dont T2 : 100%
- candidats SANS connectivite : 9977, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7032 systemes avec CONNECTED sur 54949 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12419 candidats sur 16709 portent les champs bruts (74%).*

- `5c556c16ea8b` — 6454 candidats
  - AVEC connectivite (2604) : resistance **41.4%**
  - SANS connectivite (3850) : resistance **21.9%**
...
- `5c556c16ea8b` — 6454 candidats
  - AVEC connectivite (2604) : T0=12.98 T1=0.00 T2=3.02 — pondere **6.04**
  - SANS connectivite (3850) : T0=15.86 T1=0.00 T2=2.68 — pondere **5.36**
...
- TROP-CHER : 7070 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7032 avec CONNECTED, 38 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 52448 systemes
  - sans CONNECTED : 0.0% sur 11854 systemes
