...
genere 2026-09-06 16:38 UTC — 416944 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 333600 systemes
...
- moteur actif `0caa9267db60` (373202 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 207471 | 103006 | 14134 | 6902 | 21028 | 16330 | 22052 | 21381 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 203358 | 47283 | 85794 | 79 | 28358 | 10501 | 73 | 31253 | 15.4% |
...
- candidats AVEC connectivite : 21508, dont T2 : 100%
- candidats SANS connectivite : 31563, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **22326 systemes avec CONNECTED sur 171796 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*48781 candidats sur 53071 portent les champs bruts (92%).*

- `5c556c16ea8b` — 42816 candidats
  - AVEC connectivite (17380) : resistance **41.1%**
  - SANS connectivite (25436) : resistance **21.3%**
...
- `5c556c16ea8b` — 42816 candidats
  - AVEC connectivite (17380) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (25436) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 169295 systemes
  - sans CONNECTED : 0.0% sur 38176 systemes
