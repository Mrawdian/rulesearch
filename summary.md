...
| connect | 4 | 3 | 7247 | 3646 | 476 | 251 | 684 | 591 | 758 | 760 | 10.5% |
| ref | 4 | 3 | 7084 | 1709 | 2954 | 1 | 950 | 353 | 2 | 1115 | 15.7% |
...
- candidats AVEC connectivite : 763, dont T2 : 100%
- candidats SANS connectivite : 1119, dont T2 : 100%
...
- **758 systemes avec CONNECTED sur 6002 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 717 candidats
  - AVEC connectivite (284) : T0=13.25 T1=0.00 T2=2.94 — pondere **5.87**
  - SANS connectivite (433) : T0=15.78 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 760 systemes abandonnes (5.3% des systemes), 96% du temps total
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 5945 systemes
  - sans CONNECTED : 0.0% sur 1302 systemes
