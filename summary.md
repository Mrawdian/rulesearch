...
genere 2026-08-29 05:24 UTC — 171578 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 88234 systemes
...
- moteur actif `0caa9267db60` (127836 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 83573 | 41607 | 5679 | 2824 | 8383 | 6638 | 8766 | 8614 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 81890 | 19074 | 34652 | 39 | 11326 | 4162 | 34 | 12598 | 15.4% |
...
- candidats AVEC connectivite : 8741, dont T2 : 100%
- candidats SANS connectivite : 12908, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9040 systemes avec CONNECTED sur 70708 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*17359 candidats sur 21649 portent les champs bruts (80%).*

- `5c556c16ea8b` — 11394 candidats
  - AVEC connectivite (4613) : resistance **41.2%**
  - SANS connectivite (6781) : resistance **21.7%**
...
- `5c556c16ea8b` — 11394 candidats
  - AVEC connectivite (4613) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (6781) : T0=15.90 T1=0.00 T2=2.67 — pondere **5.33**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 68207 systemes
  - sans CONNECTED : 0.0% sur 15366 systemes
