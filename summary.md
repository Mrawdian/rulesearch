...
genere 2026-08-26 14:09 UTC — 48316 systemes evalues
...
- moteur actif `0caa9267db60` (4574 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21321 | 10642 | 1416 | 733 | 2109 | 1695 | 2276 | 2180 | 10.2% |
...
- candidats AVEC connectivite : 2307, dont T2 : 100%
- candidats SANS connectivite : 3518, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2550 systemes avec CONNECTED sur 19922 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1535 candidats sur 5825 portent les champs bruts (26%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 420 candidats
  - AVEC connectivite (169) : resistance **39.8%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 420 candidats
  - AVEC connectivite (169) : T0=13.42 T1=0.00 T2=2.96 — pondere **5.92**
  - SANS connectivite (251) : T0=16.07 T1=0.00 T2=2.65 — pondere **5.29**
  - test de permutation : **p = 0.0410** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e40600351a72` — 194 candidats
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0410).
...
## cout
- temps total 14.9 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2567 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2550 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17421 systemes
  - sans CONNECTED : 0.0% sur 3900 systemes
