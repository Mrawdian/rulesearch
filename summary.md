...
genere 2026-08-27 04:30 UTC — 80699 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 15792 systemes
...
- moteur actif `0caa9267db60` (36957 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 37692 | 18750 | 2598 | 1280 | 3748 | 2965 | 3990 | 3873 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 36892 | 8501 | 15703 | 21 | 5100 | 1924 | 20 | 5623 | 15.2% |
...
- candidats AVEC connectivite : 4000, dont T2 : 100%
- candidats SANS connectivite : 5933, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4264 systemes avec CONNECTED sur 33353 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5643 candidats sur 9933 portent les champs bruts (57%).*
...
- `ab89a63b01ef` — 1966 candidats
  - AVEC connectivite (820) : resistance **41.4%**
  - SANS connectivite (1146) : resistance **21.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1966 candidats
  - AVEC connectivite (820) : T0=13.05 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (1146) : T0=15.92 T1=0.00 T2=2.70 — pondere **5.39**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- TROP-CHER : 4294 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4264 avec CONNECTED, 30 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 30852 systemes
  - sans CONNECTED : 0.0% sur 6840 systemes
