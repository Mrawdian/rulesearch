...
genere 2026-08-25 22:07 UTC — 7568 systemes evalues

## versions du DSL presentes
- `615abe43d6bc` : 6591 systemes
...
| connect | 4 | 3 | 3763 | 1896 | 241 | 129 | 368 | 303 | 381 | 400 | 10.6% |
...
- candidats AVEC connectivite : 403, dont T2 : 100%
- candidats SANS connectivite : 577, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **381 systemes avec CONNECTED sur 3130 (12.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- TROP-CHER : 383 systemes abandonnes (5.1% des systemes), 96% du temps total
  dont 381 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.4% sur 3073 systemes
  - sans CONNECTED : 0.0% sur 690 systemes
