...
genere 2026-08-26 18:26 UTC — 58369 systemes evalues
...
- moteur actif `0caa9267db60` (14627 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 26403 | 13159 | 1796 | 895 | 2617 | 2087 | 2812 | 2711 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 25851 | 5944 | 10961 | 15 | 3607 | 1327 | 10 | 3987 | 15.4% |
...
- candidats AVEC connectivite : 2838, dont T2 : 100%
- candidats SANS connectivite : 4297, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3086 systemes avec CONNECTED sur 24097 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2845 candidats sur 7135 portent les champs bruts (40%).*
...
- `b71bb0907fb5` — 53 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `8f22f0d2d442` — 41 candidats
  - AVEC connectivite (15) : resistance **40.4%**
  - SANS connectivite (26) : resistance **18.2%**
...
- `8f22f0d2d442` — 41 candidats
  - AVEC connectivite (15) : T0=13.40 T1=0.00 T2=2.80 — pondere **5.60**
  - SANS connectivite (26) : T0=15.96 T1=0.00 T2=2.58 — pondere **5.15**
  - *groupes trop petits (< 20) — aucun test, aucune conclusion*
- `e8a1f930f7b9` — 28 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 21596 systemes
  - sans CONNECTED : 0.0% sur 4807 systemes
