...
genere 2026-09-04 09:28 UTC — 361314 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 277970 systemes
...
- moteur actif `0caa9267db60` (317572 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 179374 | 89152 | 12192 | 5997 | 18255 | 14127 | 19003 | 18359 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 175825 | 40844 | 74287 | 72 | 24420 | 9117 | 70 | 27001 | 15.4% |
...
- candidats SANS connectivite : 27311, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19277 systemes avec CONNECTED sur 148846 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*41507 candidats sur 45797 portent les champs bruts (91%).*

- `5c556c16ea8b` — 35542 candidats
  - AVEC connectivite (14358) : resistance **41.0%**
  - SANS connectivite (21184) : resistance **21.3%**
...
- `5c556c16ea8b` — 35542 candidats
  ...
  - SANS connectivite (21184) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 146345 systemes
  - sans CONNECTED : 0.0% sur 33029 systemes
