...
genere 2026-08-31 03:41 UTC — 239700 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 156356 systemes
...
- moteur actif `0caa9267db60` (195958 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 117986 | 58691 | 8017 | 3956 | 11854 | 9296 | 12501 | 12129 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 115599 | 26968 | 48871 | 53 | 15952 | 5969 | 52 | 17724 | 15.3% |
...
- candidats AVEC connectivite : 12256, dont T2 : 100%
- candidats SANS connectivite : 18034, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12775 systemes avec CONNECTED sur 98853 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*26000 candidats sur 30290 portent les champs bruts (86%).*

- `5c556c16ea8b` — 20035 candidats
  - AVEC connectivite (8128) : resistance **41.0%**
  - SANS connectivite (11907) : resistance **21.4%**
...
- `5c556c16ea8b` — 20035 candidats
  - AVEC connectivite (8128) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.97**
  - SANS connectivite (11907) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 96352 systemes
  - sans CONNECTED : 0.0% sur 21634 systemes
