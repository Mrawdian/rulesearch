...
genere 2026-08-26 04:56 UTC — 24670 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 15696 systemes
...
| connect | 4 | 3 | 12403 | 6218 | 813 | 428 | 1196 | 991 | 1343 | 1258 | 10.1% |
...
- candidats AVEC connectivite : 1261, dont T2 : 100%
...
- **1343 systemes avec CONNECTED sur 10223 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1971 candidats
  - AVEC connectivite (782) : T0=13.27 T1=0.00 T2=2.84 — pondere **5.68**
  - SANS connectivite (1189) : T0=15.89 T1=0.00 T2=2.64 — pondere **5.29**
  - test de permutation : **p = 0.0070** — ecart significatif au seuil 0.05
...
- TROP-CHER : 1347 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1343 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 10166 systemes
  - sans CONNECTED : 0.0% sur 2237 systemes
