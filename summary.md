...
| connect | 4 | 3 | 6947 | 3487 | 455 | 244 | 659 | 566 | 727 | 730 | 10.5% |
...
- candidats AVEC connectivite : 733, dont T2 : 100%
...
- **727 systemes avec CONNECTED sur 5749 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 650 candidats
  - AVEC connectivite (254) : T0=13.24 T1=0.00 T2=2.92 — pondere **5.84**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 5692 systemes
