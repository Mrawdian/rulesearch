...
genere 2026-08-30 00:57 UTC — 201820 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 118476 systemes
...
- moteur actif `0caa9267db60` (158078 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 98850 | 49060 | 6730 | 3318 | 9971 | 7876 | 10416 | 10196 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 96855 | 22602 | 40866 | 45 | 13395 | 4999 | 37 | 14904 | 15.4% |
...
- candidats SANS connectivite : 15214, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10690 systemes avec CONNECTED sur 83111 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*21247 candidats sur 25537 portent les champs bruts (83%).*

- `5c556c16ea8b` — 15282 candidats
  - AVEC connectivite (6195) : resistance **41.2%**
  - SANS connectivite (9087) : resistance **21.5%**
...
- `5c556c16ea8b` — 15282 candidats
  ...
  - SANS connectivite (9087) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.33**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 80610 systemes
  - sans CONNECTED : 0.0% sur 18240 systemes
