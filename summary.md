...
genere 2026-08-28 09:30 UTC — 137351 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 54007 systemes
...
- moteur actif `0caa9267db60` (93609 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 66293 | 32933 | 4543 | 2253 | 6631 | 5283 | 6983 | 6812 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 64943 | 15025 | 27472 | 30 | 9045 | 3351 | 28 | 9990 | 15.4% |
...
- candidats AVEC connectivite : 6939, dont T2 : 100%
- candidats SANS connectivite : 10300, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7257 systemes avec CONNECTED sur 56596 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12949 candidats sur 17239 portent les champs bruts (75%).*

- `5c556c16ea8b` — 6984 candidats
  - AVEC connectivite (2811) : resistance **41.5%**
  - SANS connectivite (4173) : resistance **21.8%**
...
- `5c556c16ea8b` — 6984 candidats
  - AVEC connectivite (2811) : T0=12.97 T1=0.00 T2=3.02 — pondere **6.04**
  - SANS connectivite (4173) : T0=15.87 T1=0.00 T2=2.68 — pondere **5.35**
...
- TROP-CHER : 7295 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7257 avec CONNECTED, 38 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 54095 systemes
  - sans CONNECTED : 0.0% sur 12198 systemes
