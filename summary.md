...
genere 2026-08-28 04:08 UTC — 127829 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 44485 systemes
...
- moteur actif `0caa9267db60` (84087 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 61485 | 30577 | 4249 | 2080 | 6126 | 4887 | 6459 | 6317 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 60229 | 13938 | 25505 | 28 | 8378 | 3118 | 26 | 9234 | 15.3% |
...
- candidats SANS connectivite : 9544, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6733 systemes avec CONNECTED sur 52674 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11698 candidats sur 15988 portent les champs bruts (73%).*

- `5c556c16ea8b` — 5733 candidats
  - AVEC connectivite (2316) : resistance **41.7%**
  - SANS connectivite (3417) : resistance **22.1%**
...
- `5c556c16ea8b` — 5733 candidats
  ...
  - SANS connectivite (3417) : T0=15.86 T1=0.00 T2=2.70 — pondere **5.39**
...
- TROP-CHER : 6769 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6733 avec CONNECTED, 36 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 50173 systemes
  - sans CONNECTED : 0.0% sur 11312 systemes
