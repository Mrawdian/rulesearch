...
genere 2026-08-28 14:20 UTC — 145672 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 62328 systemes
...
- moteur actif `0caa9267db60` (101930 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 70486 | 35016 | 4815 | 2392 | 7072 | 5621 | 7448 | 7220 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 69071 | 16034 | 29179 | 32 | 9568 | 3558 | 30 | 10667 | 15.4% |
...
- candidats AVEC connectivite : 7347, dont T2 : 100%
- candidats SANS connectivite : 10977, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7722 systemes avec CONNECTED sur 59994 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*14034 candidats sur 18324 portent les champs bruts (77%).*

- `5c556c16ea8b` — 8069 candidats
  - AVEC connectivite (3219) : resistance **41.2%**
  - SANS connectivite (4850) : resistance **21.8%**
...
- `5c556c16ea8b` — 8069 candidats
  - AVEC connectivite (3219) : T0=13.02 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (4850) : T0=15.89 T1=0.00 T2=2.68 — pondere **5.36**
...
- TROP-CHER : 7762 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7722 avec CONNECTED, 40 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 57493 systemes
  - sans CONNECTED : 0.0% sur 12993 systemes
