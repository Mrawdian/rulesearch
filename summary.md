...
genere 2026-09-02 00:39 UTC — 297303 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 213959 systemes
...
- moteur actif `0caa9267db60` (253561 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 147067 | 73060 | 10010 | 4930 | 14922 | 11583 | 15551 | 15119 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 144121 | 33524 | 60968 | 61 | 19961 | 7442 | 63 | 22090 | 15.3% |
...
- candidats AVEC connectivite : 15246, dont T2 : 100%
- candidats SANS connectivite : 22400, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15825 systemes avec CONNECTED sur 122552 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*33356 candidats sur 37646 portent les champs bruts (89%).*

- `5c556c16ea8b` — 27391 candidats
  - AVEC connectivite (11118) : resistance **41.0%**
  - SANS connectivite (16273) : resistance **21.3%**
...
- `5c556c16ea8b` — 27391 candidats
  - AVEC connectivite (11118) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (16273) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 15898 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15825 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 120051 systemes
  - sans CONNECTED : 0.0% sur 27016 systemes
