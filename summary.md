...
genere 2026-09-10 05:29 UTC — 493302 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 409958 systemes
...
- moteur actif `0caa9267db60` (449560 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 246040 | 122162 | 16765 | 8256 | 24894 | 19310 | 26222 | 25308 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 241147 | 56234 | 101586 | 96 | 33566 | 12452 | 87 | 37105 | 15.4% |
...
- candidats SANS connectivite : 37415, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **26496 systemes avec CONNECTED sur 203374 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*58560 candidats sur 62850 portent les champs bruts (93%).*

- `5c556c16ea8b` — 52595 candidats
  - AVEC connectivite (21307) : resistance **41.2%**
  - SANS connectivite (31288) : resistance **21.3%**
...
- `5c556c16ea8b` — 52595 candidats
  ...
  - SANS connectivite (31288) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 26593 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 26496 avec CONNECTED, 97 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 200873 systemes
  - sans CONNECTED : 0.0% sur 45167 systemes
