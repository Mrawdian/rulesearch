...
genere 2026-08-26 14:23 UTC — 48790 systemes evalues
...
- moteur actif `0caa9267db60` (5048 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21561 | 10761 | 1434 | 743 | 2132 | 1713 | 2307 | 2199 | 10.2% |
...
- candidats AVEC connectivite : 2326, dont T2 : 100%
- candidats SANS connectivite : 3556, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2581 systemes avec CONNECTED sur 20123 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1592 candidats sur 5882 portent les champs bruts (27%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 477 candidats
  - AVEC connectivite (188) : resistance **40.0%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 477 candidats
  - AVEC connectivite (188) : T0=13.39 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (289) : T0=16.10 T1=0.00 T2=2.67 — pondere **5.34**
  - test de permutation : **p = 0.0395** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e40600351a72` — 194 candidats
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0395).
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17622 systemes
  - sans CONNECTED : 0.0% sur 3939 systemes
