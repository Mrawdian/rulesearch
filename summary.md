...
genere 2026-09-07 07:13 UTC — 430774 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 347430 systemes
...
- moteur actif `0caa9267db60` (387032 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 214464 | 106506 | 14607 | 7150 | 21727 | 16842 | 22807 | 22094 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 210195 | 48935 | 88626 | 81 | 29298 | 10848 | 75 | 32314 | 15.4% |
...
- candidats AVEC connectivite : 22221, dont T2 : 100%
- candidats SANS connectivite : 32624, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23081 systemes avec CONNECTED sur 177561 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*50555 candidats sur 54845 portent les champs bruts (92%).*

- `5c556c16ea8b` — 44590 candidats
  - AVEC connectivite (18093) : resistance **41.1%**
  - SANS connectivite (26497) : resistance **21.3%**
...
- `5c556c16ea8b` — 44590 candidats
  - AVEC connectivite (18093) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (26497) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 23166 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23081 avec CONNECTED, 85 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 175060 systemes
  - sans CONNECTED : 0.0% sur 39404 systemes
