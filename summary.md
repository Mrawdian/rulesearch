...
genere 2026-08-31 23:30 UTC — 266251 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 182907 systemes
...
- moteur actif `0caa9267db60` (222509 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 131399 | 65320 | 8872 | 4418 | 13311 | 10387 | 13861 | 13521 | 10.3% |
...
- candidats AVEC connectivite : 13648, dont T2 : 100%
...
- **14135 systemes avec CONNECTED sur 109722 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*29400 candidats sur 33690 portent les champs bruts (87%).*

- `5c556c16ea8b` — 23435 candidats
  - AVEC connectivite (9520) : resistance **41.0%**
...
- `5c556c16ea8b` — 23435 candidats
  - AVEC connectivite (9520) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 14202 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14135 avec CONNECTED, 67 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 107221 systemes
  - sans CONNECTED : 0.0% sur 24178 systemes
