...
genere 2026-08-27 02:59 UTC — 77320 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 12413 systemes
...
- moteur actif `0caa9267db60` (33578 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 35991 | 17906 | 2473 | 1219 | 3568 | 2846 | 3821 | 3688 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 35214 | 8131 | 14965 | 20 | 4870 | 1841 | 19 | 5368 | 15.2% |
...
- candidats AVEC connectivite : 3815, dont T2 : 100%
- candidats SANS connectivite : 5678, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4095 systemes avec CONNECTED sur 31964 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5203 candidats sur 9493 portent les champs bruts (55%).*
...
- `ab89a63b01ef` — 1526 candidats
  - AVEC connectivite (635) : resistance **41.4%**
  - SANS connectivite (891) : resistance **21.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1526 candidats
  - AVEC connectivite (635) : T0=13.01 T1=0.00 T2=3.06 — pondere **6.12**
  - SANS connectivite (891) : T0=15.96 T1=0.00 T2=2.70 — pondere **5.39**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- TROP-CHER : 4124 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4095 avec CONNECTED, 29 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 29463 systemes
  - sans CONNECTED : 0.0% sur 6528 systemes
