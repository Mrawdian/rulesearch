...
| connect | 4 | 3 | 6695 | 3363 | 433 | 240 | 639 | 544 | 702 | 696 | 10.4% |
...
- candidats AVEC connectivite : 699, dont T2 : 100%
...
- **702 systemes avec CONNECTED sur 5544 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 575 candidats
  - AVEC connectivite (220) : T0=13.19 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 704 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 702 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 5487 systemes
  - sans CONNECTED : 0.0% sur 1208 systemes
