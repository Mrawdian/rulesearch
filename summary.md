...
genere 2026-08-27 02:05 UTC — 75292 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 10385 systemes
...
- moteur actif `0caa9267db60` (31550 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 34958 | 17393 | 2405 | 1183 | 3468 | 2777 | 3722 | 3564 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 34219 | 7884 | 14557 | 20 | 4746 | 1782 | 18 | 5212 | 15.2% |
...
- candidats SANS connectivite : 5522, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3996 systemes avec CONNECTED sur 31102 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4923 candidats sur 9213 portent les champs bruts (53%).*
...
- `ab89a63b01ef` — 1246 candidats
  - AVEC connectivite (511) : resistance **41.3%**
  - SANS connectivite (735) : resistance **22.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1246 candidats
  ...
  - SANS connectivite (735) : T0=15.91 T1=0.00 T2=2.71 — pondere **5.43**
...
- TROP-CHER : 4024 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3996 avec CONNECTED, 28 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 28601 systemes
  - sans CONNECTED : 0.0% sur 6357 systemes
