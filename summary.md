...
genere 2026-09-09 01:06 UTC — 468856 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 385512 systemes
...
- moteur actif `0caa9267db60` (425114 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 233695 | 116061 | 15925 | 7822 | 23656 | 18308 | 24886 | 24075 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 229046 | 53341 | 96511 | 92 | 31924 | 11831 | 82 | 35246 | 15.4% |
...
- candidats AVEC connectivite : 24202, dont T2 : 100%
...
- **25160 systemes avec CONNECTED sur 193308 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55468 candidats sur 59758 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49503 candidats
  - AVEC connectivite (20074) : resistance **41.2%**
...
- `5c556c16ea8b` — 49503 candidats
  - AVEC connectivite (20074) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.97**
...
- TROP-CHER : 25252 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25160 avec CONNECTED, 92 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 190807 systemes
  - sans CONNECTED : 0.0% sur 42888 systemes
