...
genere 2026-09-02 06:45 UTC — 304448 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 221104 systemes
...
- moteur actif `0caa9267db60` (260706 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 150665 | 74856 | 10246 | 5048 | 15289 | 11861 | 15955 | 15485 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 147668 | 34382 | 62470 | 62 | 20437 | 7613 | 63 | 22629 | 15.3% |
...
- candidats AVEC connectivite : 15612, dont T2 : 100%
- candidats SANS connectivite : 22939, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16229 systemes avec CONNECTED sur 125494 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*34261 candidats sur 38551 portent les champs bruts (89%).*

- `5c556c16ea8b` — 28296 candidats
  - AVEC connectivite (11484) : resistance **41.1%**
  - SANS connectivite (16812) : resistance **21.3%**
...
- `5c556c16ea8b` — 28296 candidats
  - AVEC connectivite (11484) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (16812) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 16302 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16229 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 122993 systemes
  - sans CONNECTED : 0.0% sur 27672 systemes
