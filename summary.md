...
genere 2026-08-26 16:53 UTC — 54736 systemes evalues
...
- moteur actif `0caa9267db60` (10994 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
| connect | 4 | 3 | 24568 | 12267 | 1668 | 831 | 2435 | 1938 | 2620 | 2502 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 24053 | 5563 | 10169 | 14 | 3369 | 1221 | 10 | 3707 | 15.4% |
...
- candidats AVEC connectivite : 2629, dont T2 : 100%
- candidats SANS connectivite : 4017, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2894 systemes avec CONNECTED sur 22579 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2356 candidats sur 6646 portent les champs bruts (35%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 46 candidats
  - AVEC connectivite (15) : resistance **33.9%**
  - SANS connectivite (31) : resistance **23.7%**
...
- `23303c299f39` — 46 candidats
  - AVEC connectivite (15) : T0=13.47 T1=0.00 T2=2.73 — pondere **5.47**
  - SANS connectivite (31) : T0=17.10 T1=0.00 T2=2.97 — pondere **5.94**
...
- TROP-CHER : 2914 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2894 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 20078 systemes
  - sans CONNECTED : 0.0% sur 4490 systemes
