...
genere 2026-08-26 16:53 UTC — 54751 systemes evalues
...
- moteur actif `0caa9267db60` (11009 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
| connect | 4 | 3 | 24583 | 12278 | 1670 | 832 | 2435 | 1938 | 2620 | 2503 | 10.2% |
...
- candidats AVEC connectivite : 2630, dont T2 : 100%
- candidats SANS connectivite : 4017, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2894 systemes avec CONNECTED sur 22592 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2357 candidats sur 6647 portent les champs bruts (35%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 47 candidats
  - AVEC connectivite (16) : resistance **34.4%**
...
- `23303c299f39` — 47 candidats
  - AVEC connectivite (16) : T0=13.38 T1=0.00 T2=2.75 — pondere **5.50**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 20091 systemes
  - sans CONNECTED : 0.0% sur 4492 systemes
