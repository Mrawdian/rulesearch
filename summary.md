...
genere 2026-08-31 13:15 UTC — 252805 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 169461 systemes
...
- moteur actif `0caa9267db60` (209063 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 124604 | 61961 | 8441 | 4172 | 12581 | 9835 | 13156 | 12825 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 122086 | 28488 | 51531 | 54 | 16898 | 6314 | 56 | 18735 | 15.3% |
...
- candidats AVEC connectivite : 12952, dont T2 : 100%
- candidats SANS connectivite : 19045, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13430 systemes avec CONNECTED sur 104181 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*27707 candidats sur 31997 portent les champs bruts (87%).*

- `5c556c16ea8b` — 21742 candidats
  - AVEC connectivite (8824) : resistance **41.0%**
  - SANS connectivite (12918) : resistance **21.4%**
...
- `5c556c16ea8b` — 21742 candidats
  - AVEC connectivite (8824) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (12918) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
## cout
- temps total 78.2 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 13496 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13430 avec CONNECTED, 66 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 101680 systemes
  - sans CONNECTED : 0.0% sur 22924 systemes
