...
genere 2026-08-30 22:48 UTC — 233088 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 149744 systemes
...
- moteur actif `0caa9267db60` (189346 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 114654 | 57000 | 7791 | 3846 | 11519 | 9064 | 12130 | 11801 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 112319 | 26213 | 47461 | 53 | 15494 | 5802 | 49 | 17237 | 15.3% |
...
- candidats SANS connectivite : 17547, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12404 systemes avec CONNECTED sur 96116 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*25185 candidats sur 29475 portent les champs bruts (85%).*

- `5c556c16ea8b` — 19220 candidats
  - AVEC connectivite (7800) : resistance **41.0%**
  - SANS connectivite (11420) : resistance **21.4%**
...
- `5c556c16ea8b` — 19220 candidats
  ...
  - SANS connectivite (11420) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 12463 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 12404 avec CONNECTED, 59 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 93615 systemes
  - sans CONNECTED : 0.0% sur 21039 systemes
