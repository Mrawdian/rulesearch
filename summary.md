...
genere 2026-08-26 06:02 UTC — 27274 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 18300 systemes
...
| d4 | 4 | 4 | 477 | 215 | 122 | 1 | 35 | 35 | 23 | 33 | 6.9% |
...
- candidats SANS connectivite : 2055, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1491 systemes avec CONNECTED sur 11291 (13.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2260 candidats
  - AVEC connectivite (891) : T0=13.24 T1=0.00 T2=2.86 — pondere **5.73**
  - SANS connectivite (1369) : T0=15.89 T1=0.00 T2=2.65 — pondere **5.29**
...
**1 serie(s) reproductible(s) sur 3 etablissent l'ecart** : `89c65c03c4ad` (p=0.0030).
...
- TROP-CHER : 1497 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1491 avec CONNECTED, 6 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
