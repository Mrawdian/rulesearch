...
genere 2026-08-27 02:46 UTC — 76831 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 11924 systemes
...
- moteur actif `0caa9267db60` (33089 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 35737 | 17791 | 2453 | 1210 | 3544 | 2831 | 3799 | 3646 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 34979 | 8070 | 14876 | 20 | 4836 | 1827 | 19 | 5331 | 15.2% |
...
- candidats AVEC connectivite : 3773, dont T2 : 100%
- candidats SANS connectivite : 5641, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4073 systemes avec CONNECTED sur 31751 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5124 candidats sur 9414 portent les champs bruts (54%).*
...
- `ab89a63b01ef` — 1447 candidats
  - AVEC connectivite (593) : resistance **41.2%**
...
- `ab89a63b01ef` — 1447 candidats
  - AVEC connectivite (593) : T0=12.97 T1=0.00 T2=3.05 — pondere **6.09**
...
- TROP-CHER : 4102 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4073 avec CONNECTED, 29 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 29250 systemes
  - sans CONNECTED : 0.0% sur 6487 systemes
