...
genere 2026-08-26 14:30 UTC — 49071 systemes evalues
...
- moteur actif `0caa9267db60` (5329 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21711 | 10836 | 1447 | 745 | 2149 | 1723 | 2321 | 2215 | 10.2% |
...
- **2595 systemes avec CONNECTED sur 20248 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1636 candidats sur 5926 portent les champs bruts (28%).*
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0190).
...
- TROP-CHER : 2613 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2595 avec CONNECTED, 18 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17747 systemes
  - sans CONNECTED : 0.0% sur 3964 systemes
