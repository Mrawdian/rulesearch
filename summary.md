...
genere 2026-08-27 07:16 UTC — 86731 systemes evalues
...
- moteur actif `0caa9267db60` (42989 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 40731 | 20273 | 2787 | 1388 | 4081 | 3201 | 4297 | 4178 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 39885 | 9187 | 16954 | 22 | 5534 | 2084 | 21 | 6083 | 15.3% |
...
- candidats AVEC connectivite : 4305, dont T2 : 100%
- candidats SANS connectivite : 6393, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4571 systemes avec CONNECTED sur 35784 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6408 candidats sur 10698 portent les champs bruts (60%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 443 candidats
  - AVEC connectivite (177) : resistance **42.0%**
  - SANS connectivite (266) : resistance **20.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 443 candidats
  - AVEC connectivite (177) : T0=13.06 T1=0.00 T2=3.08 — pondere **6.16**
  - SANS connectivite (266) : T0=15.77 T1=0.00 T2=2.62 — pondere **5.24**
...
- TROP-CHER : 4602 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4571 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 33283 systemes
  - sans CONNECTED : 0.0% sur 7448 systemes
