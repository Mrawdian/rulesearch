...
genere 2026-09-02 17:46 UTC — 317084 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 233740 systemes
...
- moteur actif `0caa9267db60` (273342 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 157051 | 78046 | 10689 | 5250 | 15969 | 12353 | 16642 | 16089 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 153918 | 35851 | 65125 | 64 | 21257 | 7960 | 63 | 23586 | 15.3% |
...
- candidats SANS connectivite : 23896, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16916 systemes avec CONNECTED sur 130699 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*35822 candidats sur 40112 portent les champs bruts (89%).*

- `5c556c16ea8b` — 29857 candidats
  - AVEC connectivite (12088) : resistance **41.0%**
  - SANS connectivite (17769) : resistance **21.2%**
...
- `5c556c16ea8b` — 29857 candidats
  ...
  - SANS connectivite (17769) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.29**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 128198 systemes
  - sans CONNECTED : 0.0% sur 28853 systemes
