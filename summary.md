...
genere 2026-09-06 23:53 UTC — 423920 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 340576 systemes
...
- moteur actif `0caa9267db60` (380178 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 210995 | 104760 | 14376 | 7026 | 21401 | 16582 | 22424 | 21748 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 206810 | 48078 | 87262 | 80 | 28823 | 10679 | 73 | 31797 | 15.4% |
...
- candidats AVEC connectivite : 21875, dont T2 : 100%
- candidats SANS connectivite : 32107, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **22698 systemes avec CONNECTED sur 174698 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*49692 candidats sur 53982 portent les champs bruts (92%).*

- `5c556c16ea8b` — 43727 candidats
  - AVEC connectivite (17747) : resistance **41.1%**
  - SANS connectivite (25980) : resistance **21.3%**
...
- `5c556c16ea8b` — 43727 candidats
  - AVEC connectivite (17747) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (25980) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
## cout
- temps total 131.9 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 22781 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 22698 avec CONNECTED, 83 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 172197 systemes
  - sans CONNECTED : 0.0% sur 38798 systemes
