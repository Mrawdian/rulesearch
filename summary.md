...
genere 2026-09-02 13:22 UTC — 312177 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 228833 systemes
...
- moteur actif `0caa9267db60` (268435 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 154573 | 76794 | 10514 | 5173 | 15712 | 12168 | 16366 | 15868 | 10.3% |
...
- candidats AVEC connectivite : 15995, dont T2 : 100%
...
- **16640 systemes avec CONNECTED sur 128677 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*35242 candidats sur 39532 portent les champs bruts (89%).*

- `5c556c16ea8b` — 29277 candidats
  - AVEC connectivite (11867) : resistance **41.1%**
...
- `5c556c16ea8b` — 29277 candidats
  - AVEC connectivite (11867) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 16713 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16640 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 126176 systemes
  - sans CONNECTED : 0.0% sur 28397 systemes
