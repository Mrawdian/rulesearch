...
genere 2026-08-30 10:29 UTC — 215449 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 132105 systemes
...
- moteur actif `0caa9267db60` (171707 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 105743 | 52490 | 7201 | 3528 | 10655 | 8414 | 11205 | 10869 | 10.3% |
...
- candidats AVEC connectivite : 10996, dont T2 : 100%
...
- **11479 systemes avec CONNECTED sur 88762 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*22944 candidats sur 27234 portent les champs bruts (84%).*

- `5c556c16ea8b` — 16979 candidats
  - AVEC connectivite (6868) : resistance **41.1%**
...
- `5c556c16ea8b` — 16979 candidats
  - AVEC connectivite (6868) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
...
- TROP-CHER : 11530 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 11479 avec CONNECTED, 51 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 86261 systemes
  - sans CONNECTED : 0.0% sur 19482 systemes
