...
genere 2026-08-31 11:57 UTC — 251001 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 167657 systemes
...
- moteur actif `0caa9267db60` (207259 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 123692 | 61518 | 8387 | 4145 | 12462 | 9756 | 13072 | 12736 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 121194 | 28281 | 51158 | 53 | 16763 | 6272 | 56 | 18601 | 15.3% |
...
- candidats SANS connectivite : 18911, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13346 systemes avec CONNECTED sur 103461 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*27484 candidats sur 31774 portent les champs bruts (86%).*

- `5c556c16ea8b` — 21519 candidats
  - AVEC connectivite (8735) : resistance **40.9%**
  - SANS connectivite (12784) : resistance **21.3%**
...
- `5c556c16ea8b` — 21519 candidats
  ...
  - SANS connectivite (12784) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 13412 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13346 avec CONNECTED, 66 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 100960 systemes
  - sans CONNECTED : 0.0% sur 22732 systemes
