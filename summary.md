...
genere 2026-08-28 07:12 UTC — 133376 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 50032 systemes
...
- moteur actif `0caa9267db60` (89634 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 64287 | 31945 | 4414 | 2181 | 6445 | 5116 | 6755 | 6604 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 62974 | 14571 | 26657 | 29 | 8767 | 3254 | 28 | 9666 | 15.3% |
...
- candidats AVEC connectivite : 6731, dont T2 : 100%
- candidats SANS connectivite : 9976, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7029 systemes avec CONNECTED sur 54936 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12417 candidats sur 16707 portent les champs bruts (74%).*

- `5c556c16ea8b` — 6452 candidats
  - AVEC connectivite (2603) : resistance **41.4%**
  - SANS connectivite (3849) : resistance **21.9%**
...
- `5c556c16ea8b` — 6452 candidats
  - AVEC connectivite (2603) : T0=12.98 T1=0.00 T2=3.02 — pondere **6.03**
  - SANS connectivite (3849) : T0=15.86 T1=0.00 T2=2.68 — pondere **5.36**
...
- TROP-CHER : 7067 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7029 avec CONNECTED, 38 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 52435 systemes
  - sans CONNECTED : 0.0% sur 11852 systemes
