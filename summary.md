...
genere 2026-08-26 21:45 UTC — 65839 systemes evalues
...
- moteur actif `0caa9267db60` (22097 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 30188 | 14997 | 2063 | 1016 | 3022 | 2396 | 3212 | 3101 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 29536 | 6809 | 12553 | 16 | 4090 | 1525 | 12 | 4531 | 15.3% |
...
- candidats AVEC connectivite : 3228, dont T2 : 100%
- candidats SANS connectivite : 4841, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3486 systemes avec CONNECTED sur 27177 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3779 candidats sur 8069 portent les champs bruts (47%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 102 candidats
  - AVEC connectivite (48) : resistance **45.2%**
  - SANS connectivite (54) : resistance **22.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 102 candidats
  - AVEC connectivite (48) : T0=13.83 T1=0.00 T2=3.23 — pondere **6.46**
  - SANS connectivite (54) : T0=15.98 T1=0.00 T2=3.00 — pondere **6.00**
  - test de permutation : **p = 0.5067** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 3508 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3486 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24676 systemes
  - sans CONNECTED : 0.0% sur 5512 systemes
