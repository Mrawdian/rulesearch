...
genere 2026-08-26 01:47 UTC — 16816 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 7842 systemes
...
| connect | 4 | 3 | 8446 | 4251 | 550 | 286 | 801 | 680 | 901 | 874 | 10.3% |
...
- candidats AVEC connectivite : 877, dont T2 : 100%
...
- **901 systemes avec CONNECTED sur 6992 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 998 candidats
  - AVEC connectivite (398) : T0=13.39 T1=0.00 T2=2.85 — pondere **5.69**
  - SANS connectivite (600) : T0=15.93 T1=0.00 T2=2.67 — pondere **5.34**
  - test de permutation : **p = 0.0975** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 904 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 901 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 6935 systemes
  - sans CONNECTED : 0.0% sur 1511 systemes
