...
genere 2026-09-03 11:06 UTC — 336848 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 253504 systemes
...
- moteur actif `0caa9267db60` (293106 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 167020 | 83002 | 11342 | 5594 | 17007 | 13184 | 17693 | 17058 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 163713 | 38129 | 69183 | 66 | 22709 | 8463 | 66 | 25085 | 15.3% |
...
- candidats AVEC connectivite : 17185, dont T2 : 100%
- candidats SANS connectivite : 25395, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **17967 systemes avec CONNECTED sur 138755 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*38290 candidats sur 42580 portent les champs bruts (90%).*

- `5c556c16ea8b` — 32325 candidats
  - AVEC connectivite (13057) : resistance **41.1%**
  - SANS connectivite (19268) : resistance **21.2%**
...
- `5c556c16ea8b` — 32325 candidats
  - AVEC connectivite (13057) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (19268) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.29**
...
- TROP-CHER : 18043 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 17967 avec CONNECTED, 76 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 136254 systemes
  - sans CONNECTED : 0.0% sur 30766 systemes
