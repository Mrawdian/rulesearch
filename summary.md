...
genere 2026-09-06 05:20 UTC — 406049 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 322705 systemes
...
- moteur actif `0caa9267db60` (362307 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 201965 | 100267 | 13781 | 6722 | 20497 | 15882 | 21450 | 20797 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 197969 | 46041 | 83534 | 78 | 27579 | 10227 | 73 | 30420 | 15.4% |
...
- candidats SANS connectivite : 30730, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21724 systemes avec CONNECTED sur 167285 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*47364 candidats sur 51654 portent les champs bruts (92%).*

- `5c556c16ea8b` — 41399 candidats
  - AVEC connectivite (16796) : resistance **41.1%**
  - SANS connectivite (24603) : resistance **21.3%**
...
- `5c556c16ea8b` — 41399 candidats
  ...
  - SANS connectivite (24603) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 21807 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21724 avec CONNECTED, 83 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 164784 systemes
