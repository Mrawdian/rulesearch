...
genere 2026-09-05 12:47 UTC — 389563 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 306219 systemes
...
- moteur actif `0caa9267db60` (345821 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 193645 | 96168 | 13185 | 6453 | 19687 | 15241 | 20551 | 19891 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 189803 | 44181 | 80108 | 77 | 26416 | 9820 | 71 | 29116 | 15.3% |
...
- candidats AVEC connectivite : 20018, dont T2 : 100%
- candidats SANS connectivite : 29426, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20825 systemes avec CONNECTED sur 160462 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*45154 candidats sur 49444 portent les champs bruts (91%).*

- `5c556c16ea8b` — 39189 candidats
  - AVEC connectivite (15890) : resistance **41.0%**
  - SANS connectivite (23299) : resistance **21.3%**
...
- `5c556c16ea8b` — 39189 candidats
  - AVEC connectivite (15890) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.94**
  - SANS connectivite (23299) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 157961 systemes
  - sans CONNECTED : 0.0% sur 35684 systemes
