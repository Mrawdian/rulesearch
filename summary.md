...
genere 2026-09-01 11:49 UTC — 281737 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 198393 systemes
...
- moteur actif `0caa9267db60` (237995 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 139198 | 69190 | 9425 | 4652 | 14145 | 10969 | 14700 | 14317 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 136424 | 31751 | 57677 | 59 | 18920 | 7060 | 61 | 20885 | 15.3% |
...
- candidats SANS connectivite : 21195, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14974 systemes avec CONNECTED sur 116083 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*31349 candidats sur 35639 portent les champs bruts (88%).*

- `5c556c16ea8b` — 25384 candidats
  - AVEC connectivite (10316) : resistance **41.0%**
  - SANS connectivite (15068) : resistance **21.3%**
...
- `5c556c16ea8b` — 25384 candidats
  ...
  - SANS connectivite (15068) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 113582 systemes
  - sans CONNECTED : 0.0% sur 25616 systemes
