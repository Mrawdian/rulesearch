...
genere 2026-08-27 04:32 UTC — 80819 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 15912 systemes
...
- moteur actif `0caa9267db60` (37077 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 37752 | 18787 | 2601 | 1280 | 3751 | 2969 | 3995 | 3878 | 10.3% |
...
- candidats AVEC connectivite : 4005, dont T2 : 100%
- candidats SANS connectivite : 5944, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4269 systemes avec CONNECTED sur 33408 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5659 candidats sur 9949 portent les champs bruts (57%).*
...
- `ab89a63b01ef` — 1982 candidats
  - AVEC connectivite (825) : resistance **41.5%**
...
- `ab89a63b01ef` — 1982 candidats
  - AVEC connectivite (825) : T0=13.03 T1=0.00 T2=3.05 — pondere **6.09**
...
- TROP-CHER : 4299 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4269 avec CONNECTED, 30 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 30907 systemes
  - sans CONNECTED : 0.0% sur 6845 systemes
