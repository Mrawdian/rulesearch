...
genere 2026-08-27 06:02 UTC — 84059 systemes evalues
...
- moteur actif `0caa9267db60` (40317 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 39376 | 19599 | 2706 | 1343 | 3919 | 3102 | 4161 | 4035 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 38568 | 8895 | 16414 | 22 | 5338 | 2006 | 21 | 5872 | 15.2% |
...
- candidats AVEC connectivite : 4162, dont T2 : 100%
- candidats SANS connectivite : 6182, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4435 systemes avec CONNECTED sur 34702 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6054 candidats sur 10344 portent les champs bruts (59%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 89 candidats
  - AVEC connectivite (34) : resistance **42.3%**
  - SANS connectivite (55) : resistance **22.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 89 candidats
  - AVEC connectivite (34) : T0=13.06 T1=0.00 T2=3.06 — pondere **6.12**
  - SANS connectivite (55) : T0=15.45 T1=0.00 T2=2.60 — pondere **5.20**
  - test de permutation : **p = 0.1549** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e80bc1b2b437` — 75 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 32201 systemes
  - sans CONNECTED : 0.0% sur 7175 systemes
