...
genere 2026-08-28 03:33 UTC — 126956 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 43612 systemes
...
- moteur actif `0caa9267db60` (83214 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 61036 | 30355 | 4223 | 2062 | 6080 | 4857 | 6395 | 6277 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 59805 | 13840 | 25331 | 28 | 8326 | 3091 | 26 | 9161 | 15.3% |
...
- candidats AVEC connectivite : 6404, dont T2 : 100%
- candidats SANS connectivite : 9471, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6669 systemes avec CONNECTED sur 52302 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11585 candidats sur 15875 portent les champs bruts (73%).*

- `5c556c16ea8b` — 5620 candidats
  - AVEC connectivite (2276) : resistance **41.9%**
  - SANS connectivite (3344) : resistance **22.1%**
...
- `5c556c16ea8b` — 5620 candidats
  - AVEC connectivite (2276) : T0=12.97 T1=0.00 T2=3.05 — pondere **6.09**
  - SANS connectivite (3344) : T0=15.86 T1=0.00 T2=2.70 — pondere **5.39**
...
## cout
- temps total 38.9 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 6705 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6669 avec CONNECTED, 36 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 49801 systemes
  - sans CONNECTED : 0.0% sur 11235 systemes
