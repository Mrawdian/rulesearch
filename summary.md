...
genere 2026-08-26 20:22 UTC — 62833 systemes evalues
...
- moteur actif `0caa9267db60` (19091 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 28662 | 14280 | 1961 | 960 | 2843 | 2273 | 3042 | 2944 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 28056 | 6488 | 11885 | 15 | 3897 | 1443 | 12 | 4316 | 15.4% |
...
- candidats AVEC connectivite : 3071, dont T2 : 100%
- candidats SANS connectivite : 4626, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3316 systemes avec CONNECTED sur 25948 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3407 candidats sur 7697 portent les champs bruts (44%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 538 candidats
  - AVEC connectivite (227) : resistance **39.5%**
  - SANS connectivite (311) : resistance **20.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 538 candidats
  - AVEC connectivite (227) : T0=12.85 T1=0.00 T2=2.84 — pondere **5.68**
  - SANS connectivite (311) : T0=16.19 T1=0.00 T2=2.66 — pondere **5.32**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23447 systemes
  - sans CONNECTED : 0.0% sur 5215 systemes
