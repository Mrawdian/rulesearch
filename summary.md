...
| connect | 4 | 3 | 19010 | 9490 | 1242 | 660 | 1893 | 1512 | 2054 | 1924 | 10.1% |
...
- candidats AVEC connectivite : 2051, dont T2 : 100%
- candidats SANS connectivite : 3158, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2328 systemes avec CONNECTED sur 18019 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*919 candidats sur 5209 portent les champs bruts (18%).*
...
- TROP-CHER : 2345 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2328 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 15518 systemes
  - sans CONNECTED : 0.0% sur 3492 systemes
