...
genere 2026-09-07 05:47 UTC — 429472 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 346128 systemes
...
- moteur actif `0caa9267db60` (385730 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 213804 | 106161 | 14559 | 7127 | 21671 | 16799 | 22730 | 22033 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 209553 | 48785 | 88348 | 81 | 29211 | 10822 | 75 | 32213 | 15.4% |
...
- candidats AVEC connectivite : 22160, dont T2 : 100%
- candidats SANS connectivite : 32523, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23004 systemes avec CONNECTED sur 176999 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*50393 candidats sur 54683 portent les champs bruts (92%).*

- `5c556c16ea8b` — 44428 candidats
  - AVEC connectivite (18032) : resistance **41.1%**
  - SANS connectivite (26396) : resistance **21.3%**
...
- `5c556c16ea8b` — 44428 candidats
  - AVEC connectivite (18032) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (26396) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 23089 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23004 avec CONNECTED, 85 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 174498 systemes
