...
genere 2026-08-27 01:58 UTC — 75100 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 10193 systemes
...
- moteur actif `0caa9267db60` (31358 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 34868 | 17350 | 2400 | 1179 | 3459 | 2771 | 3706 | 3559 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 34117 | 7862 | 14508 | 20 | 4733 | 1775 | 18 | 5201 | 15.2% |
...
- candidats SANS connectivite : 5511, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3980 systemes avec CONNECTED sur 31027 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4907 candidats sur 9197 portent les champs bruts (53%).*
...
- `ab89a63b01ef` — 1230 candidats
  - AVEC connectivite (506) : resistance **41.3%**
  - SANS connectivite (724) : resistance **22.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1230 candidats
  ...
  - SANS connectivite (724) : T0=15.91 T1=0.00 T2=2.71 — pondere **5.42**
...
- TROP-CHER : 4008 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3980 avec CONNECTED, 28 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 28526 systemes
  - sans CONNECTED : 0.0% sur 6342 systemes
