...
genere 2026-09-05 06:24 UTC — 383181 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 299837 systemes
...
- moteur actif `0caa9267db60` (339439 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 190417 | 94578 | 12966 | 6351 | 19363 | 15004 | 20187 | 19534 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 186649 | 43438 | 78808 | 77 | 25945 | 9665 | 70 | 28632 | 15.3% |
...
- candidats AVEC connectivite : 19661, dont T2 : 100%
- candidats SANS connectivite : 28942, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20461 systemes avec CONNECTED sur 157836 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*44313 candidats sur 48603 portent les champs bruts (91%).*

- `5c556c16ea8b` — 38348 candidats
  - AVEC connectivite (15533) : resistance **41.1%**
  - SANS connectivite (22815) : resistance **21.3%**
...
- `5c556c16ea8b` — 38348 candidats
  - AVEC connectivite (15533) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (22815) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 155335 systemes
  - sans CONNECTED : 0.0% sur 35082 systemes
