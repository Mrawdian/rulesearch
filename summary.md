...
- moteur actif `0caa9267db60` (48735 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 43633 | 21749 | 2992 | 1474 | 4353 | 3435 | 4594 | 4470 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 42729 | 9849 | 18136 | 25 | 5935 | 2231 | 22 | 6530 | 15.3% |
...
- candidats AVEC connectivite : 4597, dont T2 : 100%
- candidats SANS connectivite : 6840, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4868 systemes avec CONNECTED sur 38160 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*7147 candidats sur 11437 portent les champs bruts (62%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 1182 candidats
  - AVEC connectivite (469) : resistance **41.4%**
  - SANS connectivite (713) : resistance **21.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 1182 candidats
  - AVEC connectivite (469) : T0=13.00 T1=0.00 T2=3.01 — pondere **6.02**
  - SANS connectivite (713) : T0=15.81 T1=0.00 T2=2.64 — pondere **5.28**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 35659 systemes
  - sans CONNECTED : 0.0% sur 7974 systemes
