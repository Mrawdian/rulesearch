...
| connect | 4 | 3 | 6872 | 3459 | 449 | 241 | 654 | 560 | 719 | 712 | 10.4% |
| ref | 4 | 3 | 6708 | 1619 | 2785 | 1 | 904 | 333 | 2 | 1064 | 15.9% |
...
- candidats AVEC connectivite : 715, dont T2 : 100%
- candidats SANS connectivite : 1068, dont T2 : 100%
...
- **719 systemes avec CONNECTED sur 5689 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 618 candidats
  - AVEC connectivite (236) : T0=13.23 T1=0.00 T2=2.94 — pondere **5.87**
  - SANS connectivite (382) : T0=15.76 T1=0.00 T2=2.65 — pondere **5.29**
...
- TROP-CHER : 721 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 719 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 5632 systemes
  - sans CONNECTED : 0.0% sur 1240 systemes
