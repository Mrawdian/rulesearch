...
genere 2026-08-31 05:28 UTC — 242175 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 158831 systemes
...
- moteur actif `0caa9267db60` (198433 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 119244 | 59329 | 8101 | 3996 | 11963 | 9400 | 12625 | 12279 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 116816 | 27273 | 49365 | 53 | 16131 | 6029 | 52 | 17903 | 15.3% |
...
- candidats AVEC connectivite : 12406, dont T2 : 100%
- candidats SANS connectivite : 18213, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12899 systemes avec CONNECTED sur 99893 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*26329 candidats sur 30619 portent les champs bruts (86%).*

- `5c556c16ea8b` — 20364 candidats
  - AVEC connectivite (8278) : resistance **40.9%**
  - SANS connectivite (12086) : resistance **21.4%**
...
- `5c556c16ea8b` — 20364 candidats
  - AVEC connectivite (8278) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (12086) : T0=15.90 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 12961 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 12899 avec CONNECTED, 62 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 97392 systemes
  - sans CONNECTED : 0.0% sur 21852 systemes
