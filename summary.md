...
genere 2026-09-03 22:16 UTC — 349176 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 265832 systemes
...
- moteur actif `0caa9267db60` (305434 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 173248 | 86134 | 11761 | 5792 | 17634 | 13653 | 18359 | 17709 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 169813 | 39499 | 71754 | 69 | 23561 | 8784 | 66 | 26067 | 15.4% |
...
- candidats AVEC connectivite : 17836, dont T2 : 100%
- candidats SANS connectivite : 26377, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18633 systemes avec CONNECTED sur 143857 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39923 candidats sur 44213 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33958 candidats
  - AVEC connectivite (13708) : resistance **41.0%**
  - SANS connectivite (20250) : resistance **21.2%**
...
- `5c556c16ea8b` — 33958 candidats
  - AVEC connectivite (13708) : T0=13.03 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (20250) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
## cout
- temps total 108.3 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 18709 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18633 avec CONNECTED, 76 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 141356 systemes
  - sans CONNECTED : 0.0% sur 31892 systemes
