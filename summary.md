...
- moteur actif `0caa9267db60` (7846 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22982 | 11453 | 1554 | 779 | 2290 | 1825 | 2458 | 2335 | 10.2% |
...
- candidats AVEC connectivite : 2462, dont T2 : 100%
- candidats SANS connectivite : 3785, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2732 systemes avec CONNECTED sur 21261 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1957 candidats sur 6247 portent les champs bruts (31%).*
...
- `06fe04a859f1` — 842 candidats
  - AVEC connectivite (324) : resistance **41.0%**
...
- `06fe04a859f1` — 842 candidats
  - AVEC connectivite (324) : T0=13.28 T1=0.00 T2=3.02 — pondere **6.04**
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0035), `e3baecf8377b` (p=0.0005).
...
- TROP-CHER : 2752 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2732 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18760 systemes
  - sans CONNECTED : 0.0% sur 4222 systemes
