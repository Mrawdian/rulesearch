...
genere 2026-08-27 08:43 UTC — 89797 systemes evalues
...
- moteur actif `0caa9267db60` (46055 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 42272 | 21053 | 2904 | 1430 | 4218 | 3318 | 4454 | 4349 | 10.3% |
...
- candidats AVEC connectivite : 4476, dont T2 : 100%
- candidats SANS connectivite : 6639, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4728 systemes avec CONNECTED sur 37054 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6825 candidats sur 11115 portent les champs bruts (61%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 860 candidats
  - AVEC connectivite (348) : resistance **40.9%**
...
- `5c556c16ea8b` — 860 candidats
  - AVEC connectivite (348) : T0=13.11 T1=0.00 T2=2.99 — pondere **5.97**
...
- TROP-CHER : 4760 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4728 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 34553 systemes
  - sans CONNECTED : 0.0% sur 7719 systemes
