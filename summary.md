...
genere 2026-08-26 19:04 UTC — 59956 systemes evalues
...
- moteur actif `0caa9267db60` (16214 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27210 | 13582 | 1850 | 916 | 2698 | 2153 | 2885 | 2786 | 10.2% |
...
- candidats AVEC connectivite : 2913, dont T2 : 100%
- candidats SANS connectivite : 4411, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3159 systemes avec CONNECTED sur 24759 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3034 candidats sur 7324 portent les champs bruts (41%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 165 candidats
  - AVEC connectivite (69) : resistance **40.5%**
...
- `62448a55927e` — 165 candidats
  - AVEC connectivite (69) : T0=13.10 T1=0.00 T2=2.96 — pondere **5.91**
  - SANS connectivite (96) : T0=16.02 T1=0.00 T2=2.62 — pondere **5.25**
  - test de permutation : **p = 0.1874** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 3179 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3159 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22258 systemes
  - sans CONNECTED : 0.0% sur 4952 systemes
