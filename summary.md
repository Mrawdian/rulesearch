...
genere 2026-08-26 02:41 UTC — 18832 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 9858 systemes
...
| connect | 4 | 3 | 9462 | 4754 | 619 | 321 | 902 | 752 | 1031 | 969 | 10.2% |
...
- candidats AVEC connectivite : 972, dont T2 : 100%
...
- **1031 systemes avec CONNECTED sur 7837 (13.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1246 candidats
  - AVEC connectivite (493) : T0=13.32 T1=0.00 T2=2.91 — pondere **5.82**
...
- TROP-CHER : 1035 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1031 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 7780 systemes
  - sans CONNECTED : 0.0% sur 1682 systemes
