...
genere 2026-09-05 04:23 UTC — 381106 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 297762 systemes
...
- moteur actif `0caa9267db60` (337364 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 189359 | 94047 | 12895 | 6323 | 19258 | 14916 | 20076 | 19420 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 185632 | 43184 | 78402 | 77 | 25790 | 9605 | 70 | 28490 | 15.3% |
...
- candidats SANS connectivite : 28800, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20350 systemes avec CONNECTED sur 156975 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*44057 candidats sur 48347 portent les champs bruts (91%).*

- `5c556c16ea8b` — 38092 candidats
  - AVEC connectivite (15419) : resistance **41.1%**
  - SANS connectivite (22673) : resistance **21.2%**
...
- `5c556c16ea8b` — 38092 candidats
  ...
  - SANS connectivite (22673) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 154474 systemes
  - sans CONNECTED : 0.0% sur 34885 systemes
