...
genere 2026-08-28 22:55 UTC — 160620 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 77276 systemes
...
- moteur actif `0caa9267db60` (116878 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
**7585 enregistrements (5%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 78035 | 38762 | 5321 | 2657 | 7815 | 6242 | 8214 | 8031 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 76470 | 17773 | 32377 | 35 | 10550 | 3909 | 31 | 11791 | 15.4% |
...
- candidats AVEC connectivite : 8158, dont T2 : 100%
- candidats SANS connectivite : 12101, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8488 systemes avec CONNECTED sur 66133 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*15969 candidats sur 20259 portent les champs bruts (79%).*

- `5c556c16ea8b` — 10004 candidats
  - AVEC connectivite (4030) : resistance **41.2%**
  - SANS connectivite (5974) : resistance **21.8%**
...
- `5c556c16ea8b` — 10004 candidats
  - AVEC connectivite (4030) : T0=13.01 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (5974) : T0=15.89 T1=0.00 T2=2.68 — pondere **5.37**
...
- `T2` indices=0.06 — PAIRDIFF(>=1)@knight + PAIRSTEP(1)@knight + CONNECTED(v2) + NOSQUARE(v2) + COUNT(v2,1-3)@grid
- `T2` indices=0.06 — PAIRDIFF(>=1)@knight + CONNECTED(v0) + COUNT(v0,1-2)@grid + PAIRSTEP(1)@knight
- `T2` indices=0.06 — PAIRSTEP(1)@knight + PAIRDIFF(>=1)@knight + CONNECTED(v0) + NOSQUARE(v0) + COUNT(v0,1-2)@grid
...
- `T2` indices=0.12 — MONO@cols + COUNT(v0,0-0)@blocks + SUM(4+-1)@rows
- `T2` indices=0.12 — SUM(1+-1)@rows + MONO@cols
- `T2` indices=0.12 — MONO@rows + SUM(1+-1)@cols

## cout
- temps total 49.5 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 8529 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8488 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 63632 systemes
  - sans CONNECTED : 0.0% sur 14403 systemes
