...
| connect | 4 | 3 | 17425 | 8720 | 1126 | 601 | 1727 | 1386 | 1893 | 1752 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 17063 | 4015 | 7217 | 12 | 2336 | 862 | 7 | 2614 | 15.3% |
...
- candidats AVEC connectivite : 1879, dont T2 : 100%
- candidats SANS connectivite : 2924, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2167 systemes avec CONNECTED sur 16736 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*513 candidats sur 4803 portent les champs bruts (11%).*
...
- `e3baecf8377b` — 249 candidats
  - AVEC connectivite (96) : resistance **43.1%**
  - SANS connectivite (153) : resistance **20.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 249 candidats
  - AVEC connectivite (96) : T0=13.02 T1=0.00 T2=3.14 — pondere **6.27**
  - SANS connectivite (153) : T0=16.13 T1=0.00 T2=2.64 — pondere **5.28**
...
**2 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0190).
...
- TROP-CHER : 2184 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2167 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14235 systemes
  - sans CONNECTED : 0.0% sur 3190 systemes
