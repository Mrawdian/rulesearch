...
genere 2026-08-27 02:04 UTC — 75262 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 10355 systemes
...
- moteur actif `0caa9267db60` (31520 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 34943 | 17386 | 2404 | 1183 | 3467 | 2774 | 3719 | 3564 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 34204 | 7883 | 14551 | 20 | 4742 | 1781 | 18 | 5209 | 15.2% |
...
- candidats AVEC connectivite : 3691, dont T2 : 100%
- candidats SANS connectivite : 5519, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3993 systemes avec CONNECTED sur 31089 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4920 candidats sur 9210 portent les champs bruts (53%).*
...
- `ab89a63b01ef` — 1243 candidats
  - AVEC connectivite (511) : resistance **41.3%**
  - SANS connectivite (732) : resistance **22.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1243 candidats
  - AVEC connectivite (511) : T0=13.02 T1=0.00 T2=3.05 — pondere **6.10**
  - SANS connectivite (732) : T0=15.92 T1=0.00 T2=2.71 — pondere **5.42**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- TROP-CHER : 4021 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3993 avec CONNECTED, 28 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 28588 systemes
  - sans CONNECTED : 0.0% sur 6355 systemes
