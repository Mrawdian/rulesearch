...
genere 2026-08-27 04:17 UTC — 80198 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 15291 systemes
...
- moteur actif `0caa9267db60` (36456 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 37440 | 18609 | 2585 | 1277 | 3721 | 2947 | 3968 | 3848 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 36643 | 8440 | 15603 | 21 | 5061 | 1911 | 20 | 5587 | 15.2% |
...
- candidats SANS connectivite : 5897, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4242 systemes avec CONNECTED sur 33144 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5582 candidats sur 9872 portent les champs bruts (57%).*
...
- `ab89a63b01ef` — 1905 candidats
  - AVEC connectivite (795) : resistance **41.4%**
  - SANS connectivite (1110) : resistance **21.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1905 candidats
  ...
  - SANS connectivite (1110) : T0=15.92 T1=0.00 T2=2.68 — pondere **5.36**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- TROP-CHER : 4272 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4242 avec CONNECTED, 30 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 30643 systemes
  - sans CONNECTED : 0.0% sur 6797 systemes
