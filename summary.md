...
genere 2026-08-26 16:58 UTC — 54898 systemes evalues
...
- moteur actif `0caa9267db60` (11156 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
| connect | 4 | 3 | 24655 | 12316 | 1675 | 835 | 2442 | 1941 | 2630 | 2508 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 24128 | 5582 | 10199 | 14 | 3383 | 1225 | 10 | 3715 | 15.4% |
...
- candidats AVEC connectivite : 2635, dont T2 : 100%
- candidats SANS connectivite : 4025, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2904 systemes avec CONNECTED sur 22653 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2370 candidats sur 6660 portent les champs bruts (36%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 60 candidats
  - AVEC connectivite (21) : resistance **37.8%**
  - SANS connectivite (39) : resistance **22.2%**
  - test de permutation : **p = 0.0050** — significatif.
...
- `23303c299f39` — 60 candidats
  - AVEC connectivite (21) : T0=13.00 T1=0.00 T2=2.86 — pondere **5.71**
  - SANS connectivite (39) : T0=16.72 T1=0.00 T2=2.90 — pondere **5.79**
  - test de permutation : **p = 0.9430** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
**3 serie(s) reproductible(s) sur 7 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005).
...
## cout
- temps total 17.0 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2924 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2904 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 20152 systemes
  - sans CONNECTED : 0.0% sur 4503 systemes
