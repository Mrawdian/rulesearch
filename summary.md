...
| connect | 4 | 3 | 17050 | 8519 | 1098 | 589 | 1694 | 1357 | 1858 | 1720 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 16689 | 3932 | 7074 | 11 | 2269 | 843 | 7 | 2553 | 15.3% |
...
- candidats AVEC connectivite : 1847, dont T2 : 100%
- candidats SANS connectivite : 2863, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2132 systemes avec CONNECTED sur 16433 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*420 candidats sur 4710 portent les champs bruts (9%).*
...
- `e3baecf8377b` — 156 candidats
  - AVEC connectivite (64) : resistance **42.0%**
  - SANS connectivite (92) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 156 candidats
  - AVEC connectivite (64) : T0=13.38 T1=0.00 T2=3.16 — pondere **6.31**
  - SANS connectivite (92) : T0=15.79 T1=0.00 T2=2.61 — pondere **5.22**
...
**2 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0475).
...
- TROP-CHER : 2149 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2132 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 13932 systemes
  - sans CONNECTED : 0.0% sur 3118 systemes
