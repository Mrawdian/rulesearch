...
genere 2026-09-03 15:50 UTC — 342103 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 258759 systemes
...
- moteur actif `0caa9267db60` (298361 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 169681 | 84343 | 11508 | 5681 | 17258 | 13403 | 17979 | 17346 | 10.2% |
...
- candidats AVEC connectivite : 17473, dont T2 : 100%
...
- **18253 systemes avec CONNECTED sur 140938 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39002 candidats sur 43292 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33037 candidats
  - AVEC connectivite (13345) : resistance **41.0%**
...
- `5c556c16ea8b` — 33037 candidats
  - AVEC connectivite (13345) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 18329 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18253 avec CONNECTED, 76 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 138437 systemes
  - sans CONNECTED : 0.0% sur 31244 systemes
