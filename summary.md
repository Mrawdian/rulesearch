...
genere 2026-08-26 21:30 UTC — 65174 systemes evalues
...
- `ab89a63b01ef` : 267 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (21432 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
**7793 enregistrements (12%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 29845 | 14827 | 2036 | 1000 | 2990 | 2367 | 3184 | 3063 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 29214 | 6735 | 12403 | 16 | 4048 | 1507 | 12 | 4493 | 15.4% |
...
- candidats SANS connectivite : 4803, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3458 systemes avec CONNECTED sur 26901 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3703 candidats sur 7993 portent les champs bruts (46%).*
...
- `b71bb0907fb5` — 53 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 26 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (10) : resistance **54.4%**
  - SANS connectivite (16) : resistance **22.0%**
...
- `ab89a63b01ef` — 26 candidats
  - AVEC connectivite (10) : T0=14.10 T1=0.00 T2=3.70 — pondere **7.40**
  - SANS connectivite (16) : T0=15.81 T1=0.00 T2=3.06 — pondere **6.12**
  - *groupes trop petits (< 20) — aucun test, aucune conclusion*
- `e8a1f930f7b9` — 28 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24400 systemes
  - sans CONNECTED : 0.0% sur 5445 systemes
