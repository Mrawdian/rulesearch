...
- candidats AVEC connectivite : 1463, dont T2 : 100%
- candidats SANS connectivite : 2229, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1639 systemes avec CONNECTED sur 12417 (13.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2527 candidats
  - AVEC connectivite (984) : T0=13.20 T1=0.00 T2=2.88 — pondere **5.77**
...
- TROP-CHER : 1648 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1639 avec CONNECTED, 9 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
