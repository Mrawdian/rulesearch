...
genere 2026-09-10 09:19 UTC — 496381 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 413037 systemes
...
- moteur actif `0caa9267db60` (452639 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 247596 | 122916 | 16871 | 8326 | 25047 | 19423 | 26402 | 25473 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 242670 | 56591 | 102228 | 97 | 33770 | 12512 | 87 | 37364 | 15.4% |
...
- candidats AVEC connectivite : 25600, dont T2 : 100%
...
- **26676 systemes avec CONNECTED sur 204667 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*58984 candidats sur 63274 portent les champs bruts (93%).*

- `5c556c16ea8b` — 53019 candidats
  - AVEC connectivite (21472) : resistance **41.2%**
...
- `5c556c16ea8b` — 53019 candidats
  - AVEC connectivite (21472) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 26773 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 26676 avec CONNECTED, 97 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 202166 systemes
  - sans CONNECTED : 0.0% sur 45430 systemes
