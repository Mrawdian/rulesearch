...
| connect | 4 | 3 | 18800 | 9384 | 1222 | 652 | 1873 | 1496 | 2038 | 1902 | 10.1% |
...
- candidats AVEC connectivite : 2029, dont T2 : 100%
- candidats SANS connectivite : 3132, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2312 systemes avec CONNECTED sur 17847 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*871 candidats sur 5161 portent les champs bruts (17%).*
...
- `e3baecf8377b` — 607 candidats
  - AVEC connectivite (246) : resistance **41.9%**
...
- `e3baecf8377b` — 607 candidats
  - AVEC connectivite (246) : T0=13.13 T1=0.00 T2=3.09 — pondere **6.17**
...
- TROP-CHER : 2329 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2312 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 15346 systemes
