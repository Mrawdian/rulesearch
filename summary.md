...
genere 2026-09-06 01:44 UTC — 402545 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 319201 systemes
...
- moteur actif `0caa9267db60` (358803 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 200200 | 99391 | 13639 | 6668 | 20326 | 15760 | 21252 | 20617 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 196230 | 45633 | 82798 | 78 | 27349 | 10129 | 73 | 30153 | 15.4% |
...
- candidats AVEC connectivite : 20744, dont T2 : 100%
...
- **21526 systemes avec CONNECTED sur 165843 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*46917 candidats sur 51207 portent les champs bruts (92%).*

- `5c556c16ea8b` — 40952 candidats
  - AVEC connectivite (16616) : resistance **41.0%**
...
- `5c556c16ea8b` — 40952 candidats
  - AVEC connectivite (16616) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.94**
...
- TROP-CHER : 21609 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21526 avec CONNECTED, 83 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 163342 systemes
  - sans CONNECTED : 0.0% sur 36858 systemes
