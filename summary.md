...
genere 2026-08-27 11:00 UTC — 94521 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 18378 systemes
- `5c556c16ea8b` : 11177 systemes
...
- moteur actif `0caa9267db60` (50779 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 44662 | 22259 | 3066 | 1514 | 4446 | 3531 | 4703 | 4563 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 43744 | 10095 | 18565 | 25 | 6075 | 2271 | 22 | 6690 | 15.3% |
...
- candidats AVEC connectivite : 4690, dont T2 : 100%
- candidats SANS connectivite : 7000, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4977 systemes avec CONNECTED sur 38986 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*7400 candidats sur 11690 portent les champs bruts (63%).*
...
- `ab89a63b01ef` — 2280 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 1435 candidats
  - AVEC connectivite (562) : resistance **41.6%**
  - SANS connectivite (873) : resistance **22.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 2280 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 1435 candidats
  - AVEC connectivite (562) : T0=13.05 T1=0.00 T2=3.03 — pondere **6.07**
  - SANS connectivite (873) : T0=15.78 T1=0.00 T2=2.67 — pondere **5.33**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 36485 systemes
  - sans CONNECTED : 0.0% sur 8177 systemes
