...
| connect | 4 | 3 | 16976 | 8479 | 1094 | 587 | 1688 | 1352 | 1850 | 1712 | 10.1% |
...
- candidats AVEC connectivite : 1839, dont T2 : 100%
- candidats SANS connectivite : 2854, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2124 systemes avec CONNECTED sur 16375 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*403 candidats sur 4693 portent les champs bruts (9%).*
...
- `e3baecf8377b` — 139 candidats
  - AVEC connectivite (56) : resistance **40.3%**
...
- `e3baecf8377b` — 139 candidats
  - AVEC connectivite (56) : T0=13.50 T1=0.00 T2=3.02 — pondere **6.04**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 13874 systemes
  - sans CONNECTED : 0.0% sur 3102 systemes
