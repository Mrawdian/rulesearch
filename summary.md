...
genere 2026-09-06 11:19 UTC — 411917 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 328573 systemes
...
- moteur actif `0caa9267db60` (368175 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 204933 | 101745 | 13976 | 6824 | 20781 | 16121 | 21761 | 21120 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 200869 | 46681 | 84758 | 79 | 28001 | 10383 | 73 | 30877 | 15.4% |
...
- candidats AVEC connectivite : 21247, dont T2 : 100%
- candidats SANS connectivite : 31187, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **22035 systemes avec CONNECTED sur 169722 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*48144 candidats sur 52434 portent les champs bruts (92%).*

- `5c556c16ea8b` — 42179 candidats
  - AVEC connectivite (17119) : resistance **41.1%**
  - SANS connectivite (25060) : resistance **21.3%**
...
- `5c556c16ea8b` — 42179 candidats
  - AVEC connectivite (17119) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (25060) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 167221 systemes
  - sans CONNECTED : 0.0% sur 37712 systemes
