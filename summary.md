...
genere 2026-08-26 14:07 UTC — 48199 systemes evalues
...
- moteur actif `0caa9267db60` (4457 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21261 | 10612 | 1410 | 731 | 2106 | 1689 | 2272 | 2172 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20823 | 4858 | 8788 | 13 | 2890 | 1076 | 7 | 3191 | 15.3% |
...
- candidats AVEC connectivite : 2299, dont T2 : 100%
- candidats SANS connectivite : 3501, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2546 systemes avec CONNECTED sur 19870 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1510 candidats sur 5800 portent les champs bruts (26%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 395 candidats
  - AVEC connectivite (161) : resistance **39.8%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 395 candidats
  - AVEC connectivite (161) : T0=13.39 T1=0.00 T2=2.94 — pondere **5.89**
  - SANS connectivite (234) : T0=16.07 T1=0.00 T2=2.71 — pondere **5.41**
...
- TROP-CHER : 2563 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2546 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17369 systemes
  - sans CONNECTED : 0.0% sur 3892 systemes
