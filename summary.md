...
genere 2026-08-26 17:00 UTC — 54958 systemes evalues
...
- moteur actif `0caa9267db60` (11216 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
| connect | 4 | 3 | 24685 | 12329 | 1677 | 838 | 2443 | 1943 | 2635 | 2512 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 24158 | 5589 | 10211 | 14 | 3386 | 1227 | 10 | 3721 | 15.4% |
...
- candidats AVEC connectivite : 2639, dont T2 : 100%
- candidats SANS connectivite : 4031, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2909 systemes avec CONNECTED sur 22681 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2380 candidats sur 6670 portent les champs bruts (36%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 70 candidats
  - AVEC connectivite (25) : resistance **38.1%**
  - SANS connectivite (45) : resistance **21.6%**
  - test de permutation : **p = 0.0015** — significatif.
...
- `23303c299f39` — 70 candidats
  - AVEC connectivite (25) : T0=13.28 T1=0.00 T2=2.84 — pondere **5.68**
  - SANS connectivite (45) : T0=16.87 T1=0.00 T2=2.80 — pondere **5.60**
  - test de permutation : **p = 0.9415** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 2929 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2909 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 20180 systemes
  - sans CONNECTED : 0.0% sur 4505 systemes
