...
genere 2026-08-29 03:02 UTC — 167583 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 84239 systemes
...
- moteur actif `0caa9267db60` (123841 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 81555 | 40586 | 5547 | 2769 | 8182 | 6475 | 8566 | 8394 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 79913 | 18590 | 33826 | 36 | 11060 | 4064 | 34 | 12298 | 15.4% |
...
- candidats AVEC connectivite : 8521, dont T2 : 100%
- candidats SANS connectivite : 12608, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8840 systemes avec CONNECTED sur 69042 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*16839 candidats sur 21129 portent les champs bruts (80%).*

- `5c556c16ea8b` — 10874 candidats
  - AVEC connectivite (4393) : resistance **41.2%**
  - SANS connectivite (6481) : resistance **21.7%**
...
- `5c556c16ea8b` — 10874 candidats
  - AVEC connectivite (4393) : T0=13.01 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (6481) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.34**
...
## cout
- temps total 51.5 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 8884 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8840 avec CONNECTED, 44 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 66541 systemes
  - sans CONNECTED : 0.0% sur 15014 systemes
