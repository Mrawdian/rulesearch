...
genere 2026-09-03 21:41 UTC — 348574 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 265230 systemes
...
- moteur actif `0caa9267db60` (304832 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 172950 | 85983 | 11745 | 5782 | 17609 | 13629 | 18321 | 17680 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 169509 | 39428 | 71629 | 67 | 23508 | 8772 | 66 | 26026 | 15.4% |
...
- candidats AVEC connectivite : 17807, dont T2 : 100%
- candidats SANS connectivite : 26336, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18595 systemes avec CONNECTED sur 143612 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39853 candidats sur 44143 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33888 candidats
  - AVEC connectivite (13679) : resistance **41.0%**
  - SANS connectivite (20209) : resistance **21.2%**
...
- `5c556c16ea8b` — 33888 candidats
  - AVEC connectivite (13679) : T0=13.03 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (20209) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.29**
...
- TROP-CHER : 18671 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18595 avec CONNECTED, 76 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 141111 systemes
  - sans CONNECTED : 0.0% sur 31839 systemes
