...
genere 2026-08-26 08:26 UTC — 33536 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 24562 systemes
...
- candidats SANS connectivite : 2454, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1814 systemes avec CONNECTED sur 13851 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2879 candidats
  - AVEC connectivite (1111) : T0=13.17 T1=0.00 T2=2.91 — pondere **5.83**
  - SANS connectivite (1768) : T0=15.89 T1=0.01 T2=2.65 — pondere **5.32**
