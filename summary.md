...
genere 2026-09-02 16:26 UTC — 315520 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 232176 systemes
...
- moteur actif `0caa9267db60` (271778 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 156260 | 77638 | 10634 | 5225 | 15888 | 12288 | 16563 | 16018 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 153145 | 35672 | 64796 | 64 | 21148 | 7923 | 63 | 23467 | 15.3% |
...
- candidats AVEC connectivite : 16145, dont T2 : 100%
- candidats SANS connectivite : 23777, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16837 systemes avec CONNECTED sur 130054 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*35632 candidats sur 39922 portent les champs bruts (89%).*

- `5c556c16ea8b` — 29667 candidats
  - AVEC connectivite (12017) : resistance **41.0%**
  - SANS connectivite (17650) : resistance **21.3%**
...
- `5c556c16ea8b` — 29667 candidats
  - AVEC connectivite (12017) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (17650) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.29**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 127553 systemes
  - sans CONNECTED : 0.0% sur 28707 systemes
