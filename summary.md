...
genere 2026-09-01 17:49 UTC — 289057 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 205713 systemes
...
- moteur actif `0caa9267db60` (245315 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 142900 | 70995 | 9691 | 4776 | 14522 | 11277 | 15099 | 14692 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 140042 | 32557 | 59245 | 59 | 19413 | 7246 | 63 | 21448 | 15.3% |
...
- candidats SANS connectivite : 21758, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15373 systemes avec CONNECTED sur 119098 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*32287 candidats sur 36577 portent les champs bruts (88%).*

- `5c556c16ea8b` — 26322 candidats
  - AVEC connectivite (10691) : resistance **41.0%**
  - SANS connectivite (15631) : resistance **21.3%**
...
- `5c556c16ea8b` — 26322 candidats
  ...
  - SANS connectivite (15631) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 116597 systemes
  - sans CONNECTED : 0.0% sur 26303 systemes
