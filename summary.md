...
genere 2026-09-05 14:50 UTC — 391694 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 308350 systemes
...
- moteur actif `0caa9267db60` (347952 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 194721 | 96705 | 13252 | 6486 | 19804 | 15321 | 20658 | 20018 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 190858 | 44428 | 80547 | 78 | 26570 | 9868 | 71 | 29282 | 15.3% |
...
- candidats SANS connectivite : 29592, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20932 systemes avec CONNECTED sur 161344 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*45447 candidats sur 49737 portent les champs bruts (91%).*

- `5c556c16ea8b` — 39482 candidats
  - AVEC connectivite (16017) : resistance **41.0%**
  - SANS connectivite (23465) : resistance **21.3%**
...
- `5c556c16ea8b` — 39482 candidats
  ...
  - SANS connectivite (23465) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 158843 systemes
  - sans CONNECTED : 0.0% sur 35878 systemes
