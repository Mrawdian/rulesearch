...
genere 2026-09-03 16:30 UTC — 342802 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 259458 systemes
...
- moteur actif `0caa9267db60` (299060 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 170025 | 84513 | 11532 | 5692 | 17294 | 13427 | 18023 | 17380 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 166662 | 38763 | 70439 | 67 | 23130 | 8620 | 66 | 25565 | 15.3% |
...
- candidats AVEC connectivite : 17507, dont T2 : 100%
- candidats SANS connectivite : 25875, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18297 systemes avec CONNECTED sur 141224 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39092 candidats sur 43382 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33127 candidats
  - AVEC connectivite (13379) : resistance **41.0%**
  - SANS connectivite (19748) : resistance **21.2%**
...
- `5c556c16ea8b` — 33127 candidats
  - AVEC connectivite (13379) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (19748) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 138723 systemes
  - sans CONNECTED : 0.0% sur 31302 systemes
