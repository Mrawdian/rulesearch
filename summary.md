...
genere 2026-08-26 14:16 UTC — 48508 systemes evalues
...
- moteur actif `0caa9267db60` (4766 systemes) : `06fe04a859f1`, `e40600351a72`
...
| ref | 4 | 3 | 20967 | 4893 | 8842 | 13 | 2908 | 1083 | 7 | 3221 | 15.4% |
...
- candidats SANS connectivite : 3531, dont T2 : 100%
...
*1558 candidats sur 5848 portent les champs bruts (27%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 443 candidats
  - AVEC connectivite (179) : resistance **39.9%**
  - SANS connectivite (264) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 443 candidats
  ...
  - SANS connectivite (264) : T0=16.10 T1=0.00 T2=2.64 — pondere **5.28**
  - test de permutation : **p = 0.0275** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e40600351a72` — 194 candidats
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0275).
