...
genere 2026-08-26 17:14 UTC — 55520 systemes evalues
...
- moteur actif `0caa9267db60` (11778 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
| connect | 4 | 3 | 24968 | 12466 | 1698 | 844 | 2471 | 1971 | 2665 | 2542 | 10.2% |
...
- candidats AVEC connectivite : 2669, dont T2 : 100%
- candidats SANS connectivite : 4078, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2939 systemes avec CONNECTED sur 22911 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2457 candidats sur 6747 portent les champs bruts (36%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 147 candidats
  - AVEC connectivite (55) : resistance **41.1%**
...
- `23303c299f39` — 147 candidats
  - AVEC connectivite (55) : T0=12.73 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (92) : T0=16.33 T1=0.00 T2=2.72 — pondere **5.43**
  - test de permutation : **p = 0.3653** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 2959 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2939 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 20410 systemes
  - sans CONNECTED : 0.0% sur 4558 systemes
