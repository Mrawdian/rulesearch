...
genere 2026-08-31 07:21 UTC — 244809 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 161465 systemes
...
- moteur actif `0caa9267db60` (201067 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 120574 | 59977 | 8188 | 4046 | 12116 | 9511 | 12752 | 12419 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 118120 | 27574 | 49900 | 53 | 16326 | 6095 | 52 | 18110 | 15.3% |
...
- candidats AVEC connectivite : 12546, dont T2 : 100%
- candidats SANS connectivite : 18420, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13026 systemes avec CONNECTED sur 100954 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*26676 candidats sur 30966 portent les champs bruts (86%).*

- `5c556c16ea8b` — 20711 candidats
  - AVEC connectivite (8418) : resistance **40.9%**
  - SANS connectivite (12293) : resistance **21.4%**
...
- `5c556c16ea8b` — 20711 candidats
  - AVEC connectivite (8418) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (12293) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 13088 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13026 avec CONNECTED, 62 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 98453 systemes
  - sans CONNECTED : 0.0% sur 22121 systemes
