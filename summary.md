...
genere 2026-09-02 09:11 UTC — 307330 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 223986 systemes
...
- moteur actif `0caa9267db60` (263588 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 152126 | 75585 | 10350 | 5096 | 15458 | 11967 | 16105 | 15621 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 149089 | 34729 | 63044 | 63 | 20631 | 7693 | 63 | 22854 | 15.3% |
...
- candidats AVEC connectivite : 15748, dont T2 : 100%
- candidats SANS connectivite : 23164, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16379 systemes avec CONNECTED sur 126686 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*34622 candidats sur 38912 portent les champs bruts (89%).*

- `5c556c16ea8b` — 28657 candidats
  - AVEC connectivite (11620) : resistance **41.1%**
  - SANS connectivite (17037) : resistance **21.3%**
...
- `5c556c16ea8b` — 28657 candidats
  - AVEC connectivite (11620) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (17037) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.29**
...
- TROP-CHER : 16452 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16379 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 124185 systemes
  - sans CONNECTED : 0.0% sur 27941 systemes
