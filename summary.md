...
genere 2026-08-30 01:39 UTC — 202965 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 119621 systemes
...
- moteur actif `0caa9267db60` (159223 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 99430 | 49341 | 6770 | 3335 | 10037 | 7938 | 10466 | 10247 | 10.3% |
...
- candidats AVEC connectivite : 10374, dont T2 : 100%
...
- **10740 systemes avec CONNECTED sur 83571 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*21371 candidats sur 25661 portent les champs bruts (83%).*

- `5c556c16ea8b` — 15406 candidats
  - AVEC connectivite (6246) : resistance **41.1%**
...
- `5c556c16ea8b` — 15406 candidats
  - AVEC connectivite (6246) : T0=13.01 T1=0.00 T2=3.00 — pondere **6.00**
...
- TROP-CHER : 10787 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10740 avec CONNECTED, 47 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 81070 systemes
  - sans CONNECTED : 0.0% sur 18360 systemes
