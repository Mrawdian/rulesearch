...
genere 2026-08-26 13:09 UTC — 45729 systemes evalues
...
- moteur actif `0caa9267db60` (1987 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20023 | 10003 | 1306 | 687 | 2007 | 1584 | 2151 | 2038 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 19591 | 4593 | 8277 | 13 | 2696 | 1014 | 7 | 2991 | 15.3% |
...
- candidats SANS connectivite : 3301, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2425 systemes avec CONNECTED sur 18843 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1176 candidats sur 5466 portent les champs bruts (22%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 61 candidats
  - AVEC connectivite (27) : resistance **36.7%**
  - SANS connectivite (34) : resistance **21.0%**
...
- `06fe04a859f1` — 61 candidats
  ...
  - SANS connectivite (34) : T0=16.53 T1=0.00 T2=2.74 — pondere **5.47**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 16342 systemes
  - sans CONNECTED : 0.0% sur 3681 systemes
