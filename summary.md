...
| ref | 4 | 3 | 17310 | 4067 | 7322 | 12 | 2368 | 881 | 7 | 2653 | 15.3% |
...
- candidats SANS connectivite : 2963, dont T2 : 100%
...
*578 candidats sur 4868 portent les champs bruts (12%).*
...
- `e3baecf8377b` — 314 candidats
  - AVEC connectivite (122) : resistance **43.8%**
  - SANS connectivite (192) : resistance **21.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 314 candidats
  ...
  - SANS connectivite (192) : T0=16.03 T1=0.00 T2=2.70 — pondere **5.41**
...
**2 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0195).
