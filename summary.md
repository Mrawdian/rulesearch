...
genere 2026-09-08 23:28 UTC — 467340 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 383996 systemes
...
- moteur actif `0caa9267db60` (423598 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 232931 | 115696 | 15862 | 7797 | 23572 | 18245 | 24817 | 23986 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 228294 | 53170 | 96187 | 92 | 31811 | 11790 | 82 | 35143 | 15.4% |
...
- candidats SANS connectivite : 35453, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25091 systemes avec CONNECTED sur 192693 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55276 candidats sur 59566 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49311 candidats
  - AVEC connectivite (19985) : resistance **41.2%**
  - SANS connectivite (29326) : resistance **21.3%**
...
- `5c556c16ea8b` — 49311 candidats
  ...
  - SANS connectivite (29326) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 190192 systemes
  - sans CONNECTED : 0.0% sur 42739 systemes
