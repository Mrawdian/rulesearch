...
genere 2026-09-04 07:48 UTC — 359547 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 276203 systemes
...
- moteur actif `0caa9267db60` (315805 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 178478 | 88705 | 12127 | 5968 | 18155 | 14064 | 18909 | 18278 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 174954 | 40656 | 73899 | 71 | 24291 | 9072 | 70 | 26881 | 15.4% |
...
- candidats AVEC connectivite : 18405, dont T2 : 100%
- candidats SANS connectivite : 27191, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19183 systemes avec CONNECTED sur 148128 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*41306 candidats sur 45596 portent les champs bruts (91%).*

- `5c556c16ea8b` — 35341 candidats
  - AVEC connectivite (14277) : resistance **41.1%**
  - SANS connectivite (21064) : resistance **21.2%**
...
- `5c556c16ea8b` — 35341 candidats
  - AVEC connectivite (14277) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (21064) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
## cout
- temps total 111.5 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 19263 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19183 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 145627 systemes
  - sans CONNECTED : 0.0% sur 32851 systemes
