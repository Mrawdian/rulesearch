...
genere 2026-09-01 00:45 UTC — 267754 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 184410 systemes
...
- moteur actif `0caa9267db60` (224012 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 132158 | 65667 | 8937 | 4433 | 13403 | 10445 | 13956 | 13604 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 129481 | 30175 | 54702 | 56 | 17932 | 6704 | 57 | 19845 | 15.3% |
...
- candidats AVEC connectivite : 13731, dont T2 : 100%
- candidats SANS connectivite : 20155, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14230 systemes avec CONNECTED sur 110324 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*29596 candidats sur 33886 portent les champs bruts (87%).*

- `5c556c16ea8b` — 23631 candidats
  - AVEC connectivite (9603) : resistance **41.0%**
  - SANS connectivite (14028) : resistance **21.3%**
...
- `5c556c16ea8b` — 23631 candidats
  - AVEC connectivite (9603) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (14028) : T0=15.93 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 107823 systemes
  - sans CONNECTED : 0.0% sur 24335 systemes
