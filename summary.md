...
genere 2026-08-26 23:46 UTC — 70221 systemes evalues
...
- moteur actif `0caa9267db60` (26479 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 32400 | 16117 | 2217 | 1091 | 3227 | 2579 | 3453 | 3302 | 10.2% |
...
- candidats AVEC connectivite : 3429, dont T2 : 100%
- candidats SANS connectivite : 5162, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3727 systemes avec CONNECTED sur 28991 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4301 candidats sur 8591 portent les champs bruts (50%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 624 candidats
  - AVEC connectivite (249) : resistance **42.2%**
...
- `ab89a63b01ef` — 624 candidats
  - AVEC connectivite (249) : T0=13.05 T1=0.00 T2=3.13 — pondere **6.27**
...
- TROP-CHER : 3751 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3727 avec CONNECTED, 24 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 26490 systemes
  - sans CONNECTED : 0.0% sur 5910 systemes
