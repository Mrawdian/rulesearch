...
genere 2026-08-26 08:30 UTC — 33685 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 24711 systemes
...
- candidats AVEC connectivite : 1597, dont T2 : 100%
- candidats SANS connectivite : 2463, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1822 systemes avec CONNECTED sur 13910 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2895 candidats
  - AVEC connectivite (1118) : T0=13.16 T1=0.00 T2=2.91 — pondere **5.83**
...
- TROP-CHER : 1833 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 1822 avec CONNECTED, 11 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
