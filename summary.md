...
- moteur actif `0caa9267db60` (8006 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23057 | 11496 | 1557 | 781 | 2298 | 1834 | 2462 | 2340 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 22576 | 5222 | 9530 | 14 | 3161 | 1153 | 10 | 3486 | 15.4% |
...
- candidats AVEC connectivite : 2467, dont T2 : 100%
- candidats SANS connectivite : 3796, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2736 systemes avec CONNECTED sur 21318 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1973 candidats sur 6263 portent les champs bruts (32%).*
...
- `06fe04a859f1` — 858 candidats
  - AVEC connectivite (329) : resistance **41.1%**
  - SANS connectivite (529) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 858 candidats
  - AVEC connectivite (329) : T0=13.26 T1=0.00 T2=3.02 — pondere **6.04**
  - SANS connectivite (529) : T0=16.03 T1=0.00 T2=2.64 — pondere **5.27**
...
- TROP-CHER : 2756 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2736 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18817 systemes
  - sans CONNECTED : 0.0% sur 4240 systemes
