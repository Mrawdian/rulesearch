...
genere 2026-08-27 17:24 UTC — 107214 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 23870 systemes
...
- moteur actif `0caa9267db60` (63472 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 51066 | 25437 | 3533 | 1747 | 5058 | 4049 | 5386 | 5196 | 10.2% |
...
- candidats AVEC connectivite : 5323, dont T2 : 100%
- candidats SANS connectivite : 7965, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5660 systemes avec CONNECTED sur 44210 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*8998 candidats sur 13288 portent les champs bruts (68%).*
...
- `5c556c16ea8b` — 3033 candidats
  - AVEC connectivite (1195) : resistance **42.0%**
...
- `5c556c16ea8b` — 3033 candidats
  - AVEC connectivite (1195) : T0=12.99 T1=0.00 T2=3.06 — pondere **6.13**
...
- TROP-CHER : 5693 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 5660 avec CONNECTED, 33 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 41709 systemes
