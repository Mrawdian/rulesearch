...
genere 2026-08-30 21:38 UTC — 231430 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 148086 systemes
...
- moteur actif `0caa9267db60` (187688 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 113819 | 56602 | 7733 | 3811 | 11430 | 9002 | 12045 | 11702 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 111496 | 26001 | 47120 | 52 | 15378 | 5765 | 47 | 17123 | 15.4% |
...
- candidats AVEC connectivite : 11829, dont T2 : 100%
- candidats SANS connectivite : 17433, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12319 systemes avec CONNECTED sur 95427 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*24972 candidats sur 29262 portent les champs bruts (85%).*

- `5c556c16ea8b` — 19007 candidats
  - AVEC connectivite (7701) : resistance **41.1%**
  - SANS connectivite (11306) : resistance **21.4%**
...
- `5c556c16ea8b` — 19007 candidats
  - AVEC connectivite (7701) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (11306) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 92926 systemes
  - sans CONNECTED : 0.0% sur 20893 systemes
