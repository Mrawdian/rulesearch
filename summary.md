...
genere 2026-08-26 14:34 UTC — 49264 systemes evalues
...
- moteur actif `0caa9267db60` (5522 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21801 | 10879 | 1457 | 748 | 2159 | 1726 | 2328 | 2227 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 21348 | 4961 | 9016 | 13 | 2959 | 1100 | 8 | 3291 | 15.4% |
...
- candidats AVEC connectivite : 2354, dont T2 : 100%
- candidats SANS connectivite : 3601, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2602 systemes avec CONNECTED sur 20322 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1665 candidats sur 5955 portent les champs bruts (28%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 550 candidats
  - AVEC connectivite (216) : resistance **40.2%**
  - SANS connectivite (334) : resistance **20.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 550 candidats
  - AVEC connectivite (216) : T0=13.46 T1=0.00 T2=3.01 — pondere **6.02**
  - SANS connectivite (334) : T0=16.06 T1=0.00 T2=2.64 — pondere **5.28**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17821 systemes
  - sans CONNECTED : 0.0% sur 3980 systemes
