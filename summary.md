...
genere 2026-09-02 14:55 UTC — 313795 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 230451 systemes
...
- moteur actif `0caa9267db60` (270053 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 155379 | 77198 | 10568 | 5194 | 15792 | 12236 | 16466 | 15933 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 152301 | 35476 | 64415 | 64 | 21040 | 7881 | 63 | 23350 | 15.3% |
...
- candidats SANS connectivite : 23660, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **16740 systemes avec CONNECTED sur 129328 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*35430 candidats sur 39720 portent les champs bruts (89%).*

- `5c556c16ea8b` — 29465 candidats
  - AVEC connectivite (11932) : resistance **41.1%**
  - SANS connectivite (17533) : resistance **21.3%**
...
- `5c556c16ea8b` — 29465 candidats
  ...
  - SANS connectivite (17533) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 126827 systemes
  - sans CONNECTED : 0.0% sur 28552 systemes
