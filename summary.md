...
genere 2026-08-26 15:58 UTC — 52540 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 7357 systemes
...
- moteur actif `0caa9267db60` (8798 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23461 | 11691 | 1588 | 802 | 2341 | 1859 | 2505 | 2379 | 10.1% |
...
- candidats AVEC connectivite : 2506, dont T2 : 100%
- candidats SANS connectivite : 3853, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2779 systemes avec CONNECTED sur 21649 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2069 candidats sur 6359 portent les champs bruts (33%).*
...
- `06fe04a859f1` — 954 candidats
  - AVEC connectivite (368) : resistance **41.5%**
...
- `06fe04a859f1` — 954 candidats
  - AVEC connectivite (368) : T0=13.22 T1=0.00 T2=3.05 — pondere **6.09**
...
- TROP-CHER : 2799 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2779 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19148 systemes
