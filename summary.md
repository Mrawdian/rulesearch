...
genere 2026-09-04 02:46 UTC — 354049 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 270705 systemes
...
- moteur actif `0caa9267db60` (310307 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 175711 | 87334 | 11950 | 5871 | 17885 | 13821 | 18626 | 17984 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 172223 | 40026 | 72728 | 70 | 23939 | 8921 | 68 | 26457 | 15.4% |
...
- candidats AVEC connectivite : 18111, dont T2 : 100%
- candidats SANS connectivite : 26767, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18900 systemes avec CONNECTED sur 145888 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*40588 candidats sur 44878 portent les champs bruts (90%).*

- `5c556c16ea8b` — 34623 candidats
  - AVEC connectivite (13983) : resistance **41.0%**
  - SANS connectivite (20640) : resistance **21.3%**
...
- `5c556c16ea8b` — 34623 candidats
  - AVEC connectivite (13983) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (20640) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 18978 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18900 avec CONNECTED, 78 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 143387 systemes
  - sans CONNECTED : 0.0% sur 32324 systemes
