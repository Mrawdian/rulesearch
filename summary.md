...
genere 2026-08-28 01:21 UTC — 122663 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 39319 systemes
...
- moteur actif `0caa9267db60` (78921 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 58872 | 29315 | 4069 | 1991 | 5854 | 4665 | 6189 | 6032 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 57676 | 13321 | 24470 | 28 | 8013 | 2991 | 26 | 8825 | 15.3% |
...
- candidats AVEC connectivite : 6159, dont T2 : 100%
- candidats SANS connectivite : 9135, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6463 systemes avec CONNECTED sur 50560 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11004 candidats sur 15294 portent les champs bruts (72%).*

- `5c556c16ea8b` — 5039 candidats
  - AVEC connectivite (2031) : resistance **42.0%**
  - SANS connectivite (3008) : resistance **22.3%**
...
- `5c556c16ea8b` — 5039 candidats
  - AVEC connectivite (2031) : T0=12.99 T1=0.00 T2=3.05 — pondere **6.10**
  - SANS connectivite (3008) : T0=15.84 T1=0.00 T2=2.71 — pondere **5.42**
...
- TROP-CHER : 6499 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6463 avec CONNECTED, 36 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 48059 systemes
  - sans CONNECTED : 0.0% sur 10813 systemes
