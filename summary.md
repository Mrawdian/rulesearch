...
genere 2026-08-26 14:31 UTC — 49131 systemes evalues
...
- moteur actif `0caa9267db60` (5389 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21741 | 10850 | 1453 | 747 | 2151 | 1725 | 2323 | 2217 | 10.2% |
...
- candidats AVEC connectivite : 2344, dont T2 : 100%
- candidats SANS connectivite : 3589, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2597 systemes avec CONNECTED sur 20271 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1643 candidats sur 5933 portent les champs bruts (28%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 528 candidats
  - AVEC connectivite (206) : resistance **39.8%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 528 candidats
  - AVEC connectivite (206) : T0=13.45 T1=0.00 T2=2.96 — pondere **5.92**
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0120).
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17770 systemes
  - sans CONNECTED : 0.0% sur 3971 systemes
