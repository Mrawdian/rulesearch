...
genere 2026-09-06 01:40 UTC — 402472 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 319128 systemes
...
- moteur actif `0caa9267db60` (358730 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 200155 | 99367 | 13635 | 6667 | 20319 | 15757 | 21249 | 20614 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 196202 | 45627 | 82781 | 78 | 27345 | 10128 | 73 | 30153 | 15.4% |
...
- candidats AVEC connectivite : 20741, dont T2 : 100%
...
- **21523 systemes avec CONNECTED sur 165806 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*46914 candidats sur 51204 portent les champs bruts (92%).*

- `5c556c16ea8b` — 40949 candidats
  - AVEC connectivite (16613) : resistance **41.0%**
...
- `5c556c16ea8b` — 40949 candidats
  - AVEC connectivite (16613) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.94**
...
- TROP-CHER : 21606 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21523 avec CONNECTED, 83 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 163305 systemes
  - sans CONNECTED : 0.0% sur 36850 systemes
