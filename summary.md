...
genere 2026-09-09 11:13 UTC — 477801 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 394457 systemes
...
- moteur actif `0caa9267db60` (434059 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 238220 | 118274 | 16243 | 7982 | 24117 | 18671 | 25357 | 24549 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 233466 | 54412 | 98366 | 92 | 32517 | 12058 | 84 | 35918 | 15.4% |
...
- candidats SANS connectivite : 36228, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25631 systemes avec CONNECTED sur 196990 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*56614 candidats sur 60904 portent les champs bruts (93%).*

- `5c556c16ea8b` — 50649 candidats
  - AVEC connectivite (20548) : resistance **41.2%**
  - SANS connectivite (30101) : resistance **21.3%**
...
- `5c556c16ea8b` — 50649 candidats
  ...
  - SANS connectivite (30101) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 25725 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25631 avec CONNECTED, 94 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 194489 systemes
  - sans CONNECTED : 0.0% sur 43731 systemes
