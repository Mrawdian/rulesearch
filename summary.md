...
**7466 enregistrements (55%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 6857 | 3449 | 448 | 241 | 653 | 558 | 719 | 711 | 10.4% |
...
- candidats AVEC connectivite : 714, dont T2 : 100%
...
- **719 systemes avec CONNECTED sur 5678 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 617 candidats
  - AVEC connectivite (235) : T0=13.23 T1=0.00 T2=2.94 — pondere **5.87**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 5621 systemes
  - sans CONNECTED : 0.0% sur 1236 systemes
