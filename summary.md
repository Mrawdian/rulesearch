...
genere 2026-08-26 04:23 UTC — 23206 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 14232 systemes
...
| connect | 4 | 3 | 11671 | 5846 | 766 | 404 | 1122 | 936 | 1266 | 1183 | 10.1% |
| ref | 4 | 3 | 11411 | 2717 | 4801 | 6 | 1547 | 580 | 4 | 1756 | 15.4% |
...
- candidats AVEC connectivite : 1186, dont T2 : 100%
- candidats SANS connectivite : 1760, dont T2 : 100%
...
- **1266 systemes avec CONNECTED sur 9618 (13.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1781 candidats
  - AVEC connectivite (707) : T0=13.33 T1=0.00 T2=2.84 — pondere **5.69**
  - SANS connectivite (1074) : T0=15.83 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 1270 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1266 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 9561 systemes
  - sans CONNECTED : 0.0% sur 2110 systemes
