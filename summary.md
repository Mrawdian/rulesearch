...
- moteur actif `0caa9267db60` (7122 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22609 | 11268 | 1521 | 770 | 2256 | 1792 | 2420 | 2301 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 22140 | 5131 | 9342 | 13 | 3093 | 1136 | 10 | 3415 | 15.4% |
...
- candidats AVEC connectivite : 2428, dont T2 : 100%
- candidats SANS connectivite : 3725, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2694 systemes avec CONNECTED sur 20956 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1863 candidats sur 6153 portent les champs bruts (30%).*
...
- `06fe04a859f1` — 748 candidats
  - AVEC connectivite (290) : resistance **41.4%**
  - SANS connectivite (458) : resistance **20.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 748 candidats
  - AVEC connectivite (290) : T0=13.33 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (458) : T0=16.03 T1=0.00 T2=2.61 — pondere **5.23**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e3baecf8377b` — 657 candidats
...
- TROP-CHER : 2714 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2694 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18455 systemes
  - sans CONNECTED : 0.0% sur 4154 systemes
