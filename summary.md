...
genere 2026-08-28 05:32 UTC — 130471 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 47127 systemes
...
- moteur actif `0caa9267db60` (86729 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 62811 | 31236 | 4314 | 2130 | 6276 | 5001 | 6591 | 6452 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 61545 | 14231 | 26069 | 29 | 8562 | 3181 | 27 | 9444 | 15.3% |
...
- candidats AVEC connectivite : 6579, dont T2 : 100%
- candidats SANS connectivite : 9754, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6865 systemes avec CONNECTED sur 53747 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12043 candidats sur 16333 portent les champs bruts (74%).*

- `5c556c16ea8b` — 6078 candidats
  - AVEC connectivite (2451) : resistance **41.6%**
  - SANS connectivite (3627) : resistance **22.0%**
...
- `5c556c16ea8b` — 6078 candidats
  - AVEC connectivite (2451) : T0=12.98 T1=0.00 T2=3.03 — pondere **6.06**
  - SANS connectivite (3627) : T0=15.86 T1=0.00 T2=2.69 — pondere **5.38**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 51246 systemes
  - sans CONNECTED : 0.0% sur 11565 systemes
