...
genere 2026-08-30 06:40 UTC — 210266 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 126922 systemes
...
- moteur actif `0caa9267db60` (166524 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 103120 | 51191 | 7025 | 3448 | 10421 | 8214 | 10879 | 10599 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 101031 | 23544 | 42679 | 47 | 13946 | 5219 | 40 | 15548 | 15.4% |
...
- candidats AVEC connectivite : 10726, dont T2 : 100%
- candidats SANS connectivite : 15858, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11153 systemes avec CONNECTED sur 86597 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*22294 candidats sur 26584 portent les champs bruts (84%).*

- `5c556c16ea8b` — 16329 candidats
  - AVEC connectivite (6598) : resistance **41.1%**
  - SANS connectivite (9731) : resistance **21.5%**
...
- `5c556c16ea8b` — 16329 candidats
  - AVEC connectivite (6598) : T0=13.00 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (9731) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.32**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 84096 systemes
  - sans CONNECTED : 0.0% sur 19024 systemes
