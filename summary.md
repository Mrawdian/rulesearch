...
| connect | 4 | 3 | 18785 | 9374 | 1221 | 652 | 1873 | 1496 | 2037 | 1899 | 10.1% |
...
- candidats AVEC connectivite : 2026, dont T2 : 100%
- candidats SANS connectivite : 3130, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2311 systemes avec CONNECTED sur 17832 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*866 candidats sur 5156 portent les champs bruts (17%).*
...
- `e3baecf8377b` — 602 candidats
  - AVEC connectivite (243) : resistance **42.0%**
...
- `e3baecf8377b` — 602 candidats
  - AVEC connectivite (243) : T0=13.10 T1=0.00 T2=3.09 — pondere **6.19**
...
**2 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0010).
...
- TROP-CHER : 2328 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 2311 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 15331 systemes
  - sans CONNECTED : 0.0% sur 3454 systemes
