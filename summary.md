...
genere 2026-08-26 18:43 UTC — 59010 systemes evalues
...
- moteur actif `0caa9267db60` (15268 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 26732 | 13336 | 1823 | 903 | 2649 | 2111 | 2846 | 2732 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 26163 | 6017 | 11091 | 15 | 3647 | 1346 | 10 | 4037 | 15.4% |
...
- candidats AVEC connectivite : 2859, dont T2 : 100%
- candidats SANS connectivite : 4347, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3120 systemes avec CONNECTED sur 24369 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2916 candidats sur 7206 portent les champs bruts (40%).*
...
- `8f22f0d2d442` — 65 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 47 candidats
  - AVEC connectivite (15) : resistance **44.0%**
  - SANS connectivite (32) : resistance **15.9%**
...
- `62448a55927e` — 47 candidats
  - AVEC connectivite (15) : T0=13.47 T1=0.00 T2=3.33 — pondere **6.67**
  - SANS connectivite (32) : T0=16.41 T1=0.00 T2=2.47 — pondere **4.94**
...
- TROP-CHER : 3140 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3120 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 21868 systemes
  - sans CONNECTED : 0.0% sur 4864 systemes
