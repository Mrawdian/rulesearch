...
genere 2026-09-07 16:16 UTC — 439179 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 355835 systemes
...
- moteur actif `0caa9267db60` (395437 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 218704 | 108640 | 14913 | 7282 | 22138 | 17145 | 23271 | 22535 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 214360 | 49940 | 90344 | 83 | 29873 | 11069 | 77 | 32956 | 15.4% |
...
- candidats AVEC connectivite : 22662, dont T2 : 100%
- candidats SANS connectivite : 33266, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23545 systemes avec CONNECTED sur 181060 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*51638 candidats sur 55928 portent les champs bruts (92%).*

- `5c556c16ea8b` — 45673 candidats
  - AVEC connectivite (18534) : resistance **41.1%**
  - SANS connectivite (27139) : resistance **21.3%**
...
- `5c556c16ea8b` — 45673 candidats
  - AVEC connectivite (18534) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (27139) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 178559 systemes
  - sans CONNECTED : 0.0% sur 40145 systemes
