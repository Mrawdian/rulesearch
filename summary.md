...
genere 2026-09-09 04:04 UTC — 471497 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 388153 systemes
...
- moteur actif `0caa9267db60` (427755 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 235023 | 116724 | 16027 | 7866 | 23785 | 18398 | 25026 | 24213 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 230359 | 53671 | 97055 | 92 | 32093 | 11903 | 82 | 35444 | 15.4% |
...
- candidats AVEC connectivite : 24340, dont T2 : 100%
- candidats SANS connectivite : 35754, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25300 systemes avec CONNECTED sur 194396 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55804 candidats sur 60094 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49839 candidats
  - AVEC connectivite (20212) : resistance **41.2%**
  - SANS connectivite (29627) : resistance **21.3%**
...
- `5c556c16ea8b` — 49839 candidats
  - AVEC connectivite (20212) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.97**
  - SANS connectivite (29627) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
## cout
- temps total 147.0 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 25392 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25300 avec CONNECTED, 92 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 191895 systemes
  - sans CONNECTED : 0.0% sur 43128 systemes
