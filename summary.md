...
genere 2026-08-27 21:41 UTC — 115321 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 31977 systemes
...
- moteur actif `0caa9267db60` (71579 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 55157 | 27463 | 3820 | 1874 | 5456 | 4367 | 5834 | 5629 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 54049 | 12472 | 22947 | 26 | 7498 | 2805 | 25 | 8274 | 15.3% |
...
- candidats SANS connectivite : 8584, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6108 systemes avec CONNECTED sur 47560 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10050 candidats sur 14340 portent les champs bruts (70%).*

- `5c556c16ea8b` — 4085 candidats
  - AVEC connectivite (1628) : resistance **42.1%**
  - SANS connectivite (2457) : resistance **22.5%**
...
- `5c556c16ea8b` — 4085 candidats
  ...
  - SANS connectivite (2457) : T0=15.78 T1=0.00 T2=2.71 — pondere **5.42**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 45059 systemes
  - sans CONNECTED : 0.0% sur 10098 systemes
