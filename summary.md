...
genere 2026-08-26 09:22 UTC — 35988 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 27014 systemes
...
- **1935 systemes avec CONNECTED sur 14849 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*7 candidats sur 4297 portent les champs bruts (0%).*
...
- TROP-CHER : 1950 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 1935 avec CONNECTED, 15 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
