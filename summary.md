...
genere 2026-09-01 20:35 UTC — 292337 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 208993 systemes
...
- moteur actif `0caa9267db60` (248595 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 144560 | 71800 | 9825 | 4839 | 14680 | 11391 | 15291 | 14866 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 141662 | 32928 | 59923 | 59 | 19638 | 7323 | 63 | 21717 | 15.3% |
...
- candidats AVEC connectivite : 14993, dont T2 : 100%
- candidats SANS connectivite : 22027, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15565 systemes avec CONNECTED sur 120470 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*32730 candidats sur 37020 portent les champs bruts (88%).*

- `5c556c16ea8b` — 26765 candidats
  - AVEC connectivite (10865) : resistance **41.0%**
  - SANS connectivite (15900) : resistance **21.4%**
...
- `5c556c16ea8b` — 26765 candidats
  - AVEC connectivite (10865) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (15900) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 15638 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15565 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 117969 systemes
  - sans CONNECTED : 0.0% sur 26591 systemes
