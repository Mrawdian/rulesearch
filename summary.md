...
genere 2026-09-06 12:13 UTC — 412767 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 329423 systemes
...
- moteur actif `0caa9267db60` (369025 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 205366 | 101964 | 14004 | 6836 | 20823 | 16158 | 21809 | 21163 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 201286 | 46781 | 84935 | 79 | 28068 | 10400 | 73 | 30933 | 15.4% |
...
- candidats AVEC connectivite : 21290, dont T2 : 100%
- candidats SANS connectivite : 31243, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **22083 systemes avec CONNECTED sur 170081 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*48243 candidats sur 52533 portent les champs bruts (92%).*

- `5c556c16ea8b` — 42278 candidats
  - AVEC connectivite (17162) : resistance **41.1%**
  - SANS connectivite (25116) : resistance **21.3%**
...
- `5c556c16ea8b` — 42278 candidats
  - AVEC connectivite (17162) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (25116) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 167580 systemes
  - sans CONNECTED : 0.0% sur 37786 systemes
