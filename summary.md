...
genere 2026-08-25 20:09 UTC — 2249 systemes evalues

## versions du DSL presentes
- `615abe43d6bc` : 1272 systemes
...
| connect | 4 | 3 | 1088 | 558 | 81 | 46 | 121 | 75 | 95 | 98 | 9.0% |
| ref | 4 | 3 | 1037 | 239 | 458 | 0 | 139 | 39 | 1 | 161 | 15.5% |
...
- candidats AVEC connectivite : 101, dont T2 : 100%
- candidats SANS connectivite : 165, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **95 systemes avec CONNECTED sur 943 (10.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- TROP-CHER : 96 systemes abandonnes (4.3% des systemes), 94% du temps total
  dont 95 avec CONNECTED, 1 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 10.7% sur 886 systemes
  - sans CONNECTED : 0.0% sur 202 systemes
