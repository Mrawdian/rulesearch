...
- moteur actif `0caa9267db60` (8317 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23222 | 11567 | 1574 | 790 | 2316 | 1845 | 2485 | 2354 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 22722 | 5255 | 9595 | 14 | 3187 | 1157 | 10 | 3504 | 15.4% |
...
- candidats AVEC connectivite : 2481, dont T2 : 100%
- candidats SANS connectivite : 3814, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2759 systemes avec CONNECTED sur 21455 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2005 candidats sur 6295 portent les champs bruts (32%).*
...
- `06fe04a859f1` — 890 candidats
  - AVEC connectivite (343) : resistance **41.3%**
  - SANS connectivite (547) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 890 candidats
  - AVEC connectivite (343) : T0=13.23 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (547) : T0=16.01 T1=0.00 T2=2.65 — pondere **5.29**
...
## cout
- temps total 16.2 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2779 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2759 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18954 systemes
  - sans CONNECTED : 0.0% sur 4268 systemes
