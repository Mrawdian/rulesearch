...
genere 2026-08-25 19:47 UTC — 949 systemes evalues

## versions du DSL presentes
- `0327bdc4c76a` : 825 systemes
...
| connect | 4 | 3 | 430 | 218 | 38 | 16 | 44 | 28 | 46 | 35 | 8.1% |
| ref | 4 | 3 | 395 | 89 | 171 | 0 | 55 | 13 | 0 | 67 | 17.0% |
...
- candidats AVEC connectivite : 38, dont T2 : 100%
- candidats SANS connectivite : 71, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **46 systemes avec CONNECTED sur 409 (11.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- TROP-CHER : 46 systemes abandonnes (4.8% des systemes), 95% du temps total
  dont 46 avec CONNECTED, 0 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 352 systemes
  - sans CONNECTED : 0.0% sur 78 systemes
