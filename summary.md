...
genere 2026-08-28 14:52 UTC — 146681 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 63337 systemes
...
- moteur actif `0caa9267db60` (102939 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 70995 | 35270 | 4853 | 2414 | 7123 | 5662 | 7493 | 7273 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 69571 | 16150 | 29394 | 32 | 9631 | 3585 | 30 | 10746 | 15.4% |
...
- candidats AVEC connectivite : 7400, dont T2 : 100%
- candidats SANS connectivite : 11056, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7767 systemes avec CONNECTED sur 60410 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*14166 candidats sur 18456 portent les champs bruts (77%).*

- `5c556c16ea8b` — 8201 candidats
  - AVEC connectivite (3272) : resistance **41.2%**
  - SANS connectivite (4929) : resistance **21.8%**
...
- `5c556c16ea8b` — 8201 candidats
  - AVEC connectivite (3272) : T0=13.02 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (4929) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.36**
...
## cout
- temps total 45.3 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 7807 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7767 avec CONNECTED, 40 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 57909 systemes
  - sans CONNECTED : 0.0% sur 13086 systemes
