...
genere 2026-09-02 00:34 UTC — 297199 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 213855 systemes
...
- moteur actif `0caa9267db60` (253457 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 147008 | 73030 | 10006 | 4927 | 14919 | 11581 | 15545 | 15108 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 144076 | 33516 | 60944 | 61 | 19955 | 7440 | 63 | 22085 | 15.3% |
...
- candidats AVEC connectivite : 15235, dont T2 : 100%
- candidats SANS connectivite : 22395, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15819 systemes avec CONNECTED sur 122499 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*33340 candidats sur 37630 portent les champs bruts (89%).*

- `5c556c16ea8b` — 27375 candidats
  - AVEC connectivite (11107) : resistance **41.0%**
  - SANS connectivite (16268) : resistance **21.3%**
...
- `5c556c16ea8b` — 27375 candidats
  - AVEC connectivite (11107) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (16268) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 119998 systemes
  - sans CONNECTED : 0.0% sur 27010 systemes
