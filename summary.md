...
genere 2026-08-31 01:29 UTC — 236647 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 153303 systemes
...
- moteur actif `0caa9267db60` (192905 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 116445 | 57891 | 7911 | 3913 | 11702 | 9185 | 12340 | 11981 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 114087 | 26607 | 48225 | 53 | 15735 | 5903 | 51 | 17503 | 15.3% |
...
- candidats AVEC connectivite : 12108, dont T2 : 100%
- candidats SANS connectivite : 17813, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12614 systemes avec CONNECTED sur 97594 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*25631 candidats sur 29921 portent les champs bruts (86%).*

- `5c556c16ea8b` — 19666 candidats
  - AVEC connectivite (7980) : resistance **41.0%**
  - SANS connectivite (11686) : resistance **21.4%**
...
- `5c556c16ea8b` — 19666 candidats
  - AVEC connectivite (7980) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.97**
  - SANS connectivite (11686) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 95093 systemes
  - sans CONNECTED : 0.0% sur 21352 systemes
