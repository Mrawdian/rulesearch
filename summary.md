...
genere 2026-08-30 20:18 UTC — 229611 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 146267 systemes
...
- moteur actif `0caa9267db60` (185869 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 112905 | 56145 | 7670 | 3777 | 11338 | 8933 | 11944 | 11625 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 110591 | 25790 | 46731 | 51 | 15252 | 5717 | 46 | 16994 | 15.4% |
...
- candidats AVEC connectivite : 11752, dont T2 : 100%
...
- **12218 systemes avec CONNECTED sur 94666 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*24766 candidats sur 29056 portent les champs bruts (85%).*

- `5c556c16ea8b` — 18801 candidats
  - AVEC connectivite (7624) : resistance **41.1%**
...
- `5c556c16ea8b` — 18801 candidats
  - AVEC connectivite (7624) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.98**
...
- TROP-CHER : 12274 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 12218 avec CONNECTED, 56 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 92165 systemes
  - sans CONNECTED : 0.0% sur 20740 systemes
