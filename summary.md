...
genere 2026-09-09 00:10 UTC — 467972 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 384628 systemes
...
- moteur actif `0caa9267db60` (424230 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 233246 | 115841 | 15891 | 7808 | 23610 | 18267 | 24849 | 24022 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 228611 | 53242 | 96321 | 92 | 31856 | 11808 | 82 | 35191 | 15.4% |
...
- candidats SANS connectivite : 35501, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25123 systemes avec CONNECTED sur 192948 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55360 candidats sur 59650 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49395 candidats
  - AVEC connectivite (20021) : resistance **41.2%**
  - SANS connectivite (29374) : resistance **21.3%**
...
- `5c556c16ea8b` — 49395 candidats
  ...
  - SANS connectivite (29374) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 25215 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25123 avec CONNECTED, 92 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 190447 systemes
  - sans CONNECTED : 0.0% sur 42799 systemes
