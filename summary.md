...
genere 2026-09-01 09:13 UTC — 278471 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 195127 systemes
...
- moteur actif `0caa9267db60` (234729 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 137559 | 68380 | 9311 | 4595 | 13949 | 10860 | 14531 | 14153 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 134797 | 31416 | 56949 | 58 | 18703 | 6981 | 60 | 20619 | 15.3% |
...
- candidats AVEC connectivite : 14280, dont T2 : 100%
- candidats SANS connectivite : 20929, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14805 systemes avec CONNECTED sur 114746 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*30919 candidats sur 35209 portent les champs bruts (88%).*

- `5c556c16ea8b` — 24954 candidats
  - AVEC connectivite (10152) : resistance **41.0%**
  - SANS connectivite (14802) : resistance **21.3%**
...
- `5c556c16ea8b` — 24954 candidats
  - AVEC connectivite (10152) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (14802) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 14875 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14805 avec CONNECTED, 70 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 112245 systemes
  - sans CONNECTED : 0.0% sur 25314 systemes
