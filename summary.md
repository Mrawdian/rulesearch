...
genere 2026-09-08 19:01 UTC — 463246 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 379902 systemes
...
- moteur actif `0caa9267db60` (419504 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 230871 | 114681 | 15720 | 7722 | 23336 | 18084 | 24621 | 23771 | 10.3% |
...
- candidats AVEC connectivite : 23898, dont T2 : 100%
...
- **24895 systemes avec CONNECTED sur 191048 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*54712 candidats sur 59002 portent les champs bruts (93%).*

- `5c556c16ea8b` — 48747 candidats
  - AVEC connectivite (19770) : resistance **41.2%**
...
- `5c556c16ea8b` — 48747 candidats
  - AVEC connectivite (19770) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 24986 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 24895 avec CONNECTED, 91 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 188547 systemes
  - sans CONNECTED : 0.0% sur 42324 systemes
