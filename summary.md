...
| connect | 4 | 3 | 17395 | 8705 | 1123 | 601 | 1724 | 1385 | 1891 | 1748 | 10.0% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 17036 | 4010 | 7202 | 12 | 2334 | 861 | 7 | 2610 | 15.3% |
...
- candidats AVEC connectivite : 1875, dont T2 : 100%
- candidats SANS connectivite : 2920, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2165 systemes avec CONNECTED sur 16711 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*505 candidats sur 4795 portent les champs bruts (11%).*
...
- `e3baecf8377b` — 241 candidats
  - AVEC connectivite (92) : resistance **43.1%**
  - SANS connectivite (149) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 241 candidats
  - AVEC connectivite (92) : T0=13.09 T1=0.00 T2=3.15 — pondere **6.30**
  - SANS connectivite (149) : T0=16.13 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 2182 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2165 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14210 systemes
  - sans CONNECTED : 0.0% sur 3185 systemes
