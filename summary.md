...
genere 2026-08-27 04:51 UTC — 81606 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 16699 systemes
...
- moteur actif `0caa9267db60` (37864 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 38154 | 18991 | 2630 | 1302 | 3794 | 2994 | 4026 | 3922 | 10.3% |
...
- candidats AVEC connectivite : 4049, dont T2 : 100%
- candidats SANS connectivite : 6000, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4300 systemes avec CONNECTED sur 33723 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5759 candidats sur 10049 portent les champs bruts (57%).*
...
- `ab89a63b01ef` — 2082 candidats
  - AVEC connectivite (869) : resistance **41.5%**
...
- `ab89a63b01ef` — 2082 candidats
  - AVEC connectivite (869) : T0=13.04 T1=0.00 T2=3.04 — pondere **6.08**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 31222 systemes
  - sans CONNECTED : 0.0% sur 6932 systemes
