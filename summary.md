...
genere 2026-09-01 16:06 UTC — 286946 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 203602 systemes
...
- moteur actif `0caa9267db60` (243204 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 141839 | 70470 | 9615 | 4742 | 14405 | 11194 | 14987 | 14590 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 138992 | 32319 | 58774 | 59 | 19275 | 7198 | 62 | 21294 | 15.3% |
...
- candidats AVEC connectivite : 14717, dont T2 : 100%
...
- **15261 systemes avec CONNECTED sur 118230 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*32031 candidats sur 36321 portent les champs bruts (88%).*

- `5c556c16ea8b` — 26066 candidats
  - AVEC connectivite (10589) : resistance **41.0%**
...
- `5c556c16ea8b` — 26066 candidats
  - AVEC connectivite (10589) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 15333 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15261 avec CONNECTED, 72 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 115729 systemes
  - sans CONNECTED : 0.0% sur 26110 systemes
