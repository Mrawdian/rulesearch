...
genere 2026-08-26 20:53 UTC — 63827 systemes evalues
...
- moteur actif `0caa9267db60` (20085 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 29171 | 14516 | 1990 | 975 | 2901 | 2308 | 3109 | 2998 | 10.3% |
...
- candidats AVEC connectivite : 3125, dont T2 : 100%
- candidats SANS connectivite : 4697, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3383 systemes avec CONNECTED sur 26369 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3532 candidats sur 7822 portent les champs bruts (45%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 663 candidats
  - AVEC connectivite (281) : resistance **40.1%**
...
- `62448a55927e` — 663 candidats
  - AVEC connectivite (281) : T0=12.81 T1=0.00 T2=2.86 — pondere **5.72**
  - SANS connectivite (382) : T0=16.13 T1=0.00 T2=2.69 — pondere **5.37**
  - test de permutation : **p = 0.1649** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e3baecf8377b` — 657 candidats
...
- TROP-CHER : 3405 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3383 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23868 systemes
