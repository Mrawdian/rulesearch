...
genere 2026-08-26 18:13 UTC — 57806 systemes evalues
...
- moteur actif `0caa9267db60` (14064 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `84fba70921e0`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 26118 | 13011 | 1779 | 882 | 2589 | 2064 | 2788 | 2682 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 25573 | 5889 | 10842 | 15 | 3569 | 1309 | 10 | 3939 | 15.4% |
...
- candidats AVEC connectivite : 2809, dont T2 : 100%
- candidats SANS connectivite : 4249, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3062 systemes avec CONNECTED sur 23854 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2768 candidats sur 7058 portent les champs bruts (39%).*
...
- `0a74109317e5` — 80 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `e80bc1b2b437` — 39 candidats
  - AVEC connectivite (24) : resistance **40.7%**
  - SANS connectivite (15) : resistance **22.1%**
...
- `e80bc1b2b437` — 39 candidats
  - AVEC connectivite (24) : T0=13.00 T1=0.00 T2=2.67 — pondere **5.33**
  - SANS connectivite (15) : T0=15.27 T1=0.00 T2=2.93 — pondere **5.87**
...
- TROP-CHER : 3082 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3062 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 21353 systemes
  - sans CONNECTED : 0.0% sur 4765 systemes
