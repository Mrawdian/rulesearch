...
genere 2026-08-26 21:14 UTC — 64581 systemes evalues
...
- moteur actif `0caa9267db60` (20839 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 29546 | 14690 | 2020 | 991 | 2950 | 2336 | 3153 | 3031 | 10.3% |
...
- candidats AVEC connectivite : 3158, dont T2 : 100%
- candidats SANS connectivite : 4758, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3427 systemes avec CONNECTED sur 26666 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3626 candidats sur 7916 portent les champs bruts (46%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 757 candidats
  - AVEC connectivite (314) : resistance **40.1%**
...
- `62448a55927e` — 757 candidats
  - AVEC connectivite (314) : T0=12.88 T1=0.00 T2=2.86 — pondere **5.71**
  - SANS connectivite (443) : T0=16.18 T1=0.00 T2=2.66 — pondere **5.32**
  - test de permutation : **p = 0.0845** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e3baecf8377b` — 657 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24165 systemes
  - sans CONNECTED : 0.0% sur 5381 systemes
