...
genere 2026-08-31 06:11 UTC — 243122 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 159778 systemes
...
- moteur actif `0caa9267db60` (199380 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 119723 | 59552 | 8130 | 4015 | 12024 | 9441 | 12678 | 12327 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 117284 | 27373 | 49559 | 53 | 16216 | 6054 | 52 | 17967 | 15.3% |
...
- candidats AVEC connectivite : 12454, dont T2 : 100%
- candidats SANS connectivite : 18277, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12952 systemes avec CONNECTED sur 100272 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*26441 candidats sur 30731 portent les champs bruts (86%).*

- `5c556c16ea8b` — 20476 candidats
  - AVEC connectivite (8326) : resistance **40.9%**
  - SANS connectivite (12150) : resistance **21.4%**
...
- `5c556c16ea8b` — 20476 candidats
  - AVEC connectivite (8326) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (12150) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 97771 systemes
  - sans CONNECTED : 0.0% sur 21952 systemes
