...
genere 2026-08-26 19:56 UTC — 61751 systemes evalues
...
- moteur actif `0caa9267db60` (18009 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 28123 | 14007 | 1923 | 947 | 2787 | 2224 | 2994 | 2888 | 10.3% |
...
- candidats AVEC connectivite : 3015, dont T2 : 100%
- candidats SANS connectivite : 4544, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3268 systemes avec CONNECTED sur 25517 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3269 candidats sur 7559 portent les champs bruts (43%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 400 candidats
  - AVEC connectivite (171) : resistance **39.3%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 400 candidats
  - AVEC connectivite (171) : T0=12.91 T1=0.00 T2=2.84 — pondere **5.67**
  - SANS connectivite (229) : T0=16.07 T1=0.00 T2=2.59 — pondere **5.17**
  - test de permutation : **p = 0.1119** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- TROP-CHER : 3290 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3268 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23016 systemes
  - sans CONNECTED : 0.0% sur 5107 systemes
