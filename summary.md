...
| connect | 4 | 3 | 17783 | 8900 | 1149 | 614 | 1763 | 1411 | 1934 | 1788 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 17398 | 4093 | 7352 | 12 | 2380 | 884 | 7 | 2670 | 15.3% |
...
- candidats AVEC connectivite : 1915, dont T2 : 100%
- candidats SANS connectivite : 2980, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2208 systemes avec CONNECTED sur 17029 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*605 candidats sur 4895 portent les champs bruts (12%).*
...
- `e3baecf8377b` — 341 candidats
  - AVEC connectivite (132) : resistance **43.3%**
  - SANS connectivite (209) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 341 candidats
  - AVEC connectivite (132) : T0=12.95 T1=0.00 T2=3.14 — pondere **6.27**
  - SANS connectivite (209) : T0=16.08 T1=0.00 T2=2.67 — pondere **5.33**
...
**2 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0085).
...
- TROP-CHER : 2225 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2208 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14528 systemes
  - sans CONNECTED : 0.0% sur 3255 systemes
