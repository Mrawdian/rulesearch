...
genere 2026-08-27 16:31 UTC — 105495 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 22151 systemes
...
- moteur actif `0caa9267db60` (61753 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 50199 | 24993 | 3469 | 1721 | 4981 | 3979 | 5295 | 5111 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 49181 | 11374 | 20869 | 25 | 6800 | 2568 | 23 | 7520 | 15.3% |
...
- candidats AVEC connectivite : 5238, dont T2 : 100%
- candidats SANS connectivite : 7830, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5569 systemes avec CONNECTED sur 43501 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*8778 candidats sur 13068 portent les champs bruts (67%).*
...
- `5c556c16ea8b` — 2813 candidats
  - AVEC connectivite (1110) : resistance **41.9%**
  - SANS connectivite (1703) : resistance **22.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 2813 candidats
  - AVEC connectivite (1110) : T0=13.02 T1=0.00 T2=3.06 — pondere **6.12**
  - SANS connectivite (1703) : T0=15.78 T1=0.00 T2=2.68 — pondere **5.37**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 2280 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 41000 systemes
  - sans CONNECTED : 0.0% sur 9199 systemes
