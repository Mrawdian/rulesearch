...
genere 2026-09-05 01:31 UTC — 378111 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 294767 systemes
...
- moteur actif `0caa9267db60` (334369 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 187851 | 93289 | 12793 | 6279 | 19102 | 14797 | 19919 | 19266 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 184145 | 42836 | 77778 | 77 | 25582 | 9533 | 70 | 28255 | 15.3% |
...
- candidats SANS connectivite : 28565, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20193 systemes avec CONNECTED sur 155748 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*43668 candidats sur 47958 portent les champs bruts (91%).*

- `5c556c16ea8b` — 37703 candidats
  - AVEC connectivite (15265) : resistance **41.1%**
  - SANS connectivite (22438) : resistance **21.2%**
...
- `5c556c16ea8b` — 37703 candidats
  ...
  - SANS connectivite (22438) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 153247 systemes
  - sans CONNECTED : 0.0% sur 34604 systemes
