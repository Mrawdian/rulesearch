...
genere 2026-08-30 23:53 UTC — 234558 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 151214 systemes
...
- moteur actif `0caa9267db60` (190816 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 115403 | 57377 | 7833 | 3878 | 11590 | 9122 | 12213 | 11876 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 113040 | 26368 | 47770 | 53 | 15595 | 5840 | 50 | 17354 | 15.4% |
...
- candidats SANS connectivite : 17664, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12487 systemes avec CONNECTED sur 96746 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*25377 candidats sur 29667 portent les champs bruts (86%).*

- `5c556c16ea8b` — 19412 candidats
  - AVEC connectivite (7875) : resistance **41.1%**
  - SANS connectivite (11537) : resistance **21.4%**
...
- `5c556c16ea8b` — 19412 candidats
  ...
  - SANS connectivite (11537) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 12547 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 12487 avec CONNECTED, 60 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 94245 systemes
  - sans CONNECTED : 0.0% sur 21158 systemes
