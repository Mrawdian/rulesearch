...
genere 2026-08-26 04:11 UTC — 22825 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 13851 systemes
...
| connect | 4 | 3 | 11476 | 5751 | 758 | 398 | 1105 | 919 | 1239 | 1160 | 10.1% |
| ref | 4 | 3 | 11225 | 2672 | 4722 | 6 | 1520 | 572 | 4 | 1729 | 15.4% |
...
- candidats AVEC connectivite : 1163, dont T2 : 100%
- candidats SANS connectivite : 1733, dont T2 : 100%
...
- **1239 systemes avec CONNECTED sur 9459 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1731 candidats
  - AVEC connectivite (684) : T0=13.35 T1=0.00 T2=2.83 — pondere **5.66**
  - SANS connectivite (1047) : T0=15.83 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 1243 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 1239 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 9402 systemes
  - sans CONNECTED : 0.0% sur 2074 systemes
