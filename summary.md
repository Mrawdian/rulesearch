...
genere 2026-08-28 04:17 UTC — 128108 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 44764 systemes
...
- moteur actif `0caa9267db60` (84366 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 61620 | 30653 | 4254 | 2081 | 6140 | 4897 | 6473 | 6330 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 60373 | 13972 | 25572 | 28 | 8391 | 3126 | 26 | 9256 | 15.3% |
...
- candidats SANS connectivite : 9566, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6747 systemes avec CONNECTED sur 52789 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11733 candidats sur 16023 portent les champs bruts (73%).*

- `5c556c16ea8b` — 5768 candidats
  - AVEC connectivite (2329) : resistance **41.7%**
  - SANS connectivite (3439) : resistance **22.1%**
...
- `5c556c16ea8b` — 5768 candidats
  ...
  - SANS connectivite (3439) : T0=15.86 T1=0.00 T2=2.70 — pondere **5.40**
...
- TROP-CHER : 6783 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6747 avec CONNECTED, 36 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 50288 systemes
  - sans CONNECTED : 0.0% sur 11332 systemes
