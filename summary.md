...
genere 2026-08-30 18:40 UTC — 227282 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 143938 systemes
...
- moteur actif `0caa9267db60` (183540 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 111723 | 55545 | 7586 | 3731 | 11241 | 8842 | 11822 | 11504 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 109444 | 25508 | 46230 | 50 | 15113 | 5653 | 45 | 16835 | 15.4% |
...
- candidats AVEC connectivite : 11631, dont T2 : 100%
...
- **12096 systemes avec CONNECTED sur 93690 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*24486 candidats sur 28776 portent les champs bruts (85%).*

- `5c556c16ea8b` — 18521 candidats
  - AVEC connectivite (7503) : resistance **41.0%**
...
- `5c556c16ea8b` — 18521 candidats
  - AVEC connectivite (7503) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.97**
...
- TROP-CHER : 12151 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 12096 avec CONNECTED, 55 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 91189 systemes
  - sans CONNECTED : 0.0% sur 20534 systemes
