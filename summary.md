...
genere 2026-08-31 09:44 UTC — 248083 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 164739 systemes
...
- moteur actif `0caa9267db60` (204341 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 122216 | 60786 | 8288 | 4092 | 12293 | 9654 | 12916 | 12599 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 119752 | 27961 | 50549 | 53 | 16553 | 6193 | 54 | 18379 | 15.3% |
...
- candidats SANS connectivite : 18689, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13190 systemes avec CONNECTED sur 102274 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*27125 candidats sur 31415 portent les champs bruts (86%).*

- `5c556c16ea8b` — 21160 candidats
  - AVEC connectivite (8598) : resistance **41.0%**
  - SANS connectivite (12562) : resistance **21.3%**
...
- `5c556c16ea8b` — 21160 candidats
  ...
  - SANS connectivite (12562) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 13254 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13190 avec CONNECTED, 64 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 99773 systemes
  - sans CONNECTED : 0.0% sur 22443 systemes
