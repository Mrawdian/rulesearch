...
genere 2026-08-28 06:22 UTC — 131884 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 48540 systemes
...
- moteur actif `0caa9267db60` (88142 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 63524 | 31568 | 4360 | 2156 | 6358 | 5059 | 6675 | 6528 | 10.3% |
...
- candidats AVEC connectivite : 6655, dont T2 : 100%
- candidats SANS connectivite : 9856, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6949 systemes avec CONNECTED sur 54320 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12221 candidats sur 16511 portent les champs bruts (74%).*

- `5c556c16ea8b` — 6256 candidats
  - AVEC connectivite (2527) : resistance **41.5%**
...
- `5c556c16ea8b` — 6256 candidats
  - AVEC connectivite (2527) : T0=12.97 T1=0.00 T2=3.02 — pondere **6.04**
...
- TROP-CHER : 6987 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6949 avec CONNECTED, 38 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 51819 systemes
  - sans CONNECTED : 0.0% sur 11705 systemes
