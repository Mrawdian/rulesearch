...
genere 2026-08-26 04:05 UTC — 22630 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 13656 systemes
...
| connect | 4 | 3 | 11371 | 5711 | 748 | 390 | 1095 | 912 | 1224 | 1148 | 10.1% |
...
- candidats AVEC connectivite : 1151, dont T2 : 100%
...
- **1224 systemes avec CONNECTED sur 9372 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1699 candidats
  - AVEC connectivite (672) : T0=13.34 T1=0.00 T2=2.84 — pondere **5.69**
...
- TROP-CHER : 1228 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 1224 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 9315 systemes
  - sans CONNECTED : 0.0% sur 2056 systemes
