...
genere 2026-08-31 19:58 UTC — 261776 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 178432 systemes
...
- moteur actif `0caa9267db60` (218034 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 129145 | 64209 | 8731 | 4328 | 13080 | 10207 | 13607 | 13298 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 126516 | 29485 | 53424 | 56 | 17542 | 6536 | 56 | 19407 | 15.3% |
...
- candidats SANS connectivite : 19717, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13881 systemes avec CONNECTED sur 107866 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*28852 candidats sur 33142 portent les champs bruts (87%).*

- `5c556c16ea8b` — 22887 candidats
  - AVEC connectivite (9297) : resistance **41.1%**
  - SANS connectivite (13590) : resistance **21.4%**
...
- `5c556c16ea8b` — 22887 candidats
  ...
  - SANS connectivite (13590) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.32**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 105365 systemes
  - sans CONNECTED : 0.0% sur 23780 systemes
