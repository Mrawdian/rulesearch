...
genere 2026-09-08 08:57 UTC — 454293 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 370949 systemes
...
- moteur actif `0caa9267db60` (410551 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 226340 | 112399 | 15405 | 7561 | 22905 | 17734 | 24118 | 23333 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 221838 | 51661 | 93508 | 88 | 30895 | 11472 | 81 | 34115 | 15.4% |
...
- candidats AVEC connectivite : 23460, dont T2 : 100%
- candidats SANS connectivite : 34425, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **24392 systemes avec CONNECTED sur 187328 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*53595 candidats sur 57885 portent les champs bruts (93%).*

- `5c556c16ea8b` — 47630 candidats
  - AVEC connectivite (19332) : resistance **41.1%**
  - SANS connectivite (28298) : resistance **21.3%**
...
- `5c556c16ea8b` — 47630 candidats
  - AVEC connectivite (19332) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (28298) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 184827 systemes
  - sans CONNECTED : 0.0% sur 41513 systemes
