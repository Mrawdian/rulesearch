...
genere 2026-08-27 08:49 UTC — 89988 systemes evalues
...
- moteur actif `0caa9267db60` (46246 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 42376 | 21102 | 2913 | 1431 | 4230 | 3323 | 4467 | 4364 | 10.3% |
...
- candidats AVEC connectivite : 4491, dont T2 : 100%
- candidats SANS connectivite : 6654, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4741 systemes avec CONNECTED sur 37139 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6855 candidats sur 11145 portent les champs bruts (62%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 890 candidats
  - AVEC connectivite (363) : resistance **40.9%**
...
- `5c556c16ea8b` — 890 candidats
  - AVEC connectivite (363) : T0=13.08 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 4773 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4741 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 34638 systemes
  - sans CONNECTED : 0.0% sur 7738 systemes
