...
genere 2026-08-28 02:36 UTC — 125228 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 41884 systemes
...
- moteur actif `0caa9267db60` (81486 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 60168 | 29968 | 4156 | 2034 | 5987 | 4775 | 6300 | 6175 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 58945 | 13637 | 24971 | 28 | 8200 | 3054 | 26 | 9027 | 15.3% |
...
- candidats SANS connectivite : 9337, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6574 systemes avec CONNECTED sur 51607 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11349 candidats sur 15639 portent les champs bruts (73%).*

- `5c556c16ea8b` — 5384 candidats
  - AVEC connectivite (2174) : resistance **41.8%**
  - SANS connectivite (3210) : resistance **22.3%**
...
- `5c556c16ea8b` — 5384 candidats
  ...
  - SANS connectivite (3210) : T0=15.84 T1=0.00 T2=2.71 — pondere **5.41**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 49106 systemes
