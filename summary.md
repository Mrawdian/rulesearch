...
genere 2026-08-26 18:05 UTC — 57483 systemes evalues
...
- `e80bc1b2b437` : 59 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (13741 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `84fba70921e0`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 25954 | 12928 | 1770 | 878 | 2573 | 2052 | 2771 | 2661 | 10.3% |
...
- candidats AVEC connectivite : 2788, dont T2 : 100%
- candidats SANS connectivite : 4234, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3045 systemes avec CONNECTED sur 23717 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2732 candidats sur 7022 portent les champs bruts (39%).*
...
- TROP-CHER : 3065 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3045 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 21216 systemes
  - sans CONNECTED : 0.0% sur 4738 systemes
