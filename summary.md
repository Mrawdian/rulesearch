...
genere 2026-08-26 19:00 UTC — 59806 systemes evalues
...
- moteur actif `0caa9267db60` (16064 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27135 | 13542 | 1845 | 912 | 2692 | 2148 | 2878 | 2779 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 26556 | 6133 | 11244 | 15 | 3699 | 1369 | 10 | 4086 | 15.4% |
...
- candidats AVEC connectivite : 2906, dont T2 : 100%
- candidats SANS connectivite : 4396, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3152 systemes avec CONNECTED sur 24693 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3012 candidats sur 7302 portent les champs bruts (41%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 143 candidats
  - AVEC connectivite (62) : resistance **40.8%**
  - SANS connectivite (81) : resistance **18.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 143 candidats
  - AVEC connectivite (62) : T0=13.10 T1=0.00 T2=2.95 — pondere **5.90**
  - SANS connectivite (81) : T0=16.00 T1=0.00 T2=2.53 — pondere **5.06**
...
- TROP-CHER : 3172 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3152 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22192 systemes
  - sans CONNECTED : 0.0% sur 4943 systemes
