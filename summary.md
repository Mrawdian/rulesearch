...
genere 2026-09-07 16:41 UTC — 439578 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 356234 systemes
...
- moteur actif `0caa9267db60` (395836 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 218913 | 108750 | 14932 | 7291 | 22159 | 17156 | 23290 | 22552 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 214550 | 49974 | 90431 | 83 | 29911 | 11082 | 77 | 32974 | 15.4% |
...
- candidats AVEC connectivite : 22679, dont T2 : 100%
- candidats SANS connectivite : 33284, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23564 systemes avec CONNECTED sur 181236 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*51673 candidats sur 55963 portent les champs bruts (92%).*

- `5c556c16ea8b` — 45708 candidats
  - AVEC connectivite (18551) : resistance **41.1%**
  - SANS connectivite (27157) : resistance **21.3%**
...
- `5c556c16ea8b` — 45708 candidats
  - AVEC connectivite (18551) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (27157) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 23651 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23564 avec CONNECTED, 87 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 178735 systemes
  - sans CONNECTED : 0.0% sur 40178 systemes
