...
| connect | 4 | 3 | 6782 | 3410 | 445 | 240 | 648 | 548 | 710 | 703 | 10.4% |
| ref | 4 | 3 | 6634 | 1604 | 2751 | 1 | 891 | 331 | 2 | 1054 | 15.9% |
...
- candidats AVEC connectivite : 706, dont T2 : 100%
- candidats SANS connectivite : 1058, dont T2 : 100%
...
- **710 systemes avec CONNECTED sur 5619 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 599 candidats
  - AVEC connectivite (227) : T0=13.21 T1=0.00 T2=2.95 — pondere **5.89**
  - SANS connectivite (372) : T0=15.74 T1=0.00 T2=2.63 — pondere **5.26**
...
- TROP-CHER : 712 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 710 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 5562 systemes
  - sans CONNECTED : 0.0% sur 1220 systemes
