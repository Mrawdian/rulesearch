...
genere 2026-09-05 03:41 UTC — 380322 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 296978 systemes
...
- moteur actif `0caa9267db60` (336580 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 188970 | 93847 | 12863 | 6307 | 19218 | 14890 | 20045 | 19379 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 185237 | 43089 | 78249 | 77 | 25729 | 9584 | 70 | 28425 | 15.3% |
...
- candidats AVEC connectivite : 19506, dont T2 : 100%
- candidats SANS connectivite : 28735, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **20319 systemes avec CONNECTED sur 156656 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*43951 candidats sur 48241 portent les champs bruts (91%).*

- `5c556c16ea8b` — 37986 candidats
  - AVEC connectivite (15378) : resistance **41.1%**
  - SANS connectivite (22608) : resistance **21.2%**
...
- `5c556c16ea8b` — 37986 candidats
  - AVEC connectivite (15378) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (22608) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 20399 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 20319 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 154155 systemes
  - sans CONNECTED : 0.0% sur 34815 systemes
