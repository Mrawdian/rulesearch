...
genere 2026-08-27 15:24 UTC — 103287 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 19943 systemes
...
- moteur actif `0caa9267db60` (59545 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 49082 | 24448 | 3388 | 1682 | 4874 | 3888 | 5176 | 4991 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 48090 | 11113 | 20431 | 25 | 6651 | 2512 | 23 | 7334 | 15.3% |
...
- candidats AVEC connectivite : 5118, dont T2 : 100%
- candidats SANS connectivite : 7644, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5450 systemes avec CONNECTED sur 42603 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*8472 candidats sur 12762 portent les champs bruts (66%).*
...
- `5c556c16ea8b` — 2507 candidats
  - AVEC connectivite (990) : resistance **41.7%**
  - SANS connectivite (1517) : resistance **22.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 2507 candidats
  - AVEC connectivite (990) : T0=13.02 T1=0.00 T2=3.03 — pondere **6.06**
  - SANS connectivite (1517) : T0=15.80 T1=0.00 T2=2.67 — pondere **5.34**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 2280 candidats
...
- TROP-CHER : 5483 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 5450 avec CONNECTED, 33 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 40102 systemes
  - sans CONNECTED : 0.0% sur 8980 systemes
