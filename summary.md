...
genere 2026-08-28 08:00 UTC — 134824 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 51480 systemes
...
- moteur actif `0caa9267db60` (91082 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 65020 | 32290 | 4468 | 2204 | 6520 | 5184 | 6834 | 6682 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 63689 | 14738 | 26965 | 29 | 8852 | 3290 | 28 | 9785 | 15.4% |
...
- candidats AVEC connectivite : 6809, dont T2 : 100%
...
- **7108 systemes avec CONNECTED sur 55539 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12614 candidats sur 16904 portent les champs bruts (75%).*

- `5c556c16ea8b` — 6649 candidats
  - AVEC connectivite (2681) : resistance **41.4%**
...
- `5c556c16ea8b` — 6649 candidats
  - AVEC connectivite (2681) : T0=12.98 T1=0.00 T2=3.02 — pondere **6.04**
...
- TROP-CHER : 7146 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7108 avec CONNECTED, 38 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 53038 systemes
  - sans CONNECTED : 0.0% sur 11982 systemes
