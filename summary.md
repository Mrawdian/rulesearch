...
**7466 enregistrements (67%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 5620 | 2834 | 359 | 204 | 538 | 459 | 583 | 576 | 10.2% |
| ref | 4 | 3 | 5481 | 1327 | 2295 | 1 | 727 | 267 | 2 | 862 | 15.7% |
...
- candidats AVEC connectivite : 579, dont T2 : 100%
- candidats SANS connectivite : 866, dont T2 : 100%
...
- **583 systemes avec CONNECTED sur 4655 (12.5%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 280 candidats
  - AVEC connectivite (100) : T0=13.16 T1=0.00 T2=2.80 — pondere **5.60**
  - SANS connectivite (180) : T0=15.99 T1=0.00 T2=2.63 — pondere **5.26**
  - test de permutation : **p = 0.3553** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 585 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 583 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.7% sur 4598 systemes
