...
genere 2026-08-29 08:54 UTC — 177201 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 93857 systemes
...
- moteur actif `0caa9267db60` (133459 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 86410 | 42990 | 5881 | 2928 | 8676 | 6863 | 9068 | 8904 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 84676 | 19776 | 35794 | 39 | 11677 | 4317 | 35 | 13032 | 15.4% |
...
- candidats AVEC connectivite : 9031, dont T2 : 100%
- candidats SANS connectivite : 13342, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9342 systemes avec CONNECTED sur 73024 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*18083 candidats sur 22373 portent les champs bruts (81%).*

- `5c556c16ea8b` — 12118 candidats
  - AVEC connectivite (4903) : resistance **41.1%**
  - SANS connectivite (7215) : resistance **21.6%**
...
- `5c556c16ea8b` — 12118 candidats
  - AVEC connectivite (4903) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.97**
  - SANS connectivite (7215) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.32**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 70523 systemes
  - sans CONNECTED : 0.0% sur 15887 systemes
