...
genere 2026-08-29 19:44 UTC — 193730 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 110386 systemes
...
- moteur actif `0caa9267db60` (149988 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 94768 | 47071 | 6450 | 3189 | 9560 | 7550 | 10004 | 9736 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 92847 | 21650 | 39189 | 43 | 12848 | 4782 | 36 | 14293 | 15.4% |
...
- candidats AVEC connectivite : 9863, dont T2 : 100%
- candidats SANS connectivite : 14603, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **10278 systemes avec CONNECTED sur 79791 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*20176 candidats sur 24466 portent les champs bruts (82%).*

- `5c556c16ea8b` — 14211 candidats
  - AVEC connectivite (5735) : resistance **41.2%**
  - SANS connectivite (8476) : resistance **21.5%**
...
- `5c556c16ea8b` — 14211 candidats
  - AVEC connectivite (5735) : T0=13.00 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (8476) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.33**
...
## cout
- temps total 59.8 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 10324 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10278 avec CONNECTED, 46 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 77290 systemes
  - sans CONNECTED : 0.0% sur 17478 systemes
