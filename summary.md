...
genere 2026-08-31 21:30 UTC — 263638 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 180294 systemes
...
- moteur actif `0caa9267db60` (219896 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 130084 | 64669 | 8788 | 4361 | 13179 | 10277 | 13722 | 13392 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 127439 | 29711 | 53826 | 56 | 17670 | 6585 | 57 | 19524 | 15.3% |
...
- candidats SANS connectivite : 19834, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13996 systemes avec CONNECTED sur 108644 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*29063 candidats sur 33353 portent les champs bruts (87%).*

- `5c556c16ea8b` — 23098 candidats
  - AVEC connectivite (9391) : resistance **41.1%**
  - SANS connectivite (13707) : resistance **21.4%**
...
- `5c556c16ea8b` — 23098 candidats
  ...
  - SANS connectivite (13707) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 14063 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13996 avec CONNECTED, 67 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 106143 systemes
  - sans CONNECTED : 0.0% sur 23941 systemes
