...
genere 2026-09-02 17:16 UTC — 316548 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 233204 systemes
...
- moteur actif `0caa9267db60` (272806 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 156782 | 77911 | 10671 | 5243 | 15935 | 12332 | 16607 | 16072 | 10.3% |
...
- candidats AVEC connectivite : 16199, dont T2 : 100%
...
- **16881 systemes avec CONNECTED sur 130483 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*35763 candidats sur 40053 portent les champs bruts (89%).*

- `5c556c16ea8b` — 29798 candidats
  - AVEC connectivite (12071) : resistance **41.0%**
...
- `5c556c16ea8b` — 29798 candidats
  - AVEC connectivite (12071) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 16954 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16881 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 127982 systemes
  - sans CONNECTED : 0.0% sur 28800 systemes
