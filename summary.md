...
genere 2026-08-26 20:10 UTC — 62358 systemes evalues
...
- moteur actif `0caa9267db60` (18616 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 28423 | 14148 | 1946 | 953 | 2822 | 2254 | 3020 | 2922 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 27820 | 6427 | 11787 | 15 | 3867 | 1429 | 12 | 4283 | 15.4% |
...
- candidats AVEC connectivite : 3049, dont T2 : 100%
- candidats SANS connectivite : 4593, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3294 systemes avec CONNECTED sur 25749 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3352 candidats sur 7642 portent les champs bruts (44%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 483 candidats
  - AVEC connectivite (205) : resistance **39.2%**
  - SANS connectivite (278) : resistance **19.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 483 candidats
  - AVEC connectivite (205) : T0=12.89 T1=0.00 T2=2.82 — pondere **5.64**
  - SANS connectivite (278) : T0=16.09 T1=0.00 T2=2.59 — pondere **5.19**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23248 systemes
  - sans CONNECTED : 0.0% sur 5175 systemes
