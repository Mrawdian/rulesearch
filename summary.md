...
genere 2026-08-26 16:18 UTC — 53267 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 8084 systemes
...
- moteur actif `0caa9267db60` (9525 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23834 | 11894 | 1618 | 812 | 2367 | 1881 | 2548 | 2416 | 10.1% |
...
- candidats AVEC connectivite : 2543, dont T2 : 100%
- candidats SANS connectivite : 3902, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2822 systemes avec CONNECTED sur 21969 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2155 candidats sur 6445 portent les champs bruts (33%).*
...
- `06fe04a859f1` — 1040 candidats
  - AVEC connectivite (405) : resistance **41.1%**
...
- `06fe04a859f1` — 1040 candidats
  - AVEC connectivite (405) : T0=13.17 T1=0.00 T2=3.04 — pondere **6.07**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19468 systemes
  - sans CONNECTED : 0.0% sur 4366 systemes
