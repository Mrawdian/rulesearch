...
genere 2026-08-27 06:19 UTC — 84633 systemes evalues
...
- moteur actif `0caa9267db60` (40891 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 39675 | 19757 | 2721 | 1352 | 3951 | 3120 | 4195 | 4066 | 10.2% |
...
- candidats AVEC connectivite : 4193, dont T2 : 100%
- candidats SANS connectivite : 6218, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4469 systemes avec CONNECTED sur 34946 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6121 candidats sur 10411 portent les champs bruts (59%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 156 candidats
  - AVEC connectivite (65) : resistance **43.4%**
...
- `5c556c16ea8b` — 156 candidats
  - AVEC connectivite (65) : T0=12.88 T1=0.00 T2=3.09 — pondere **6.18**
...
**7 serie(s) reproductible(s) sur 14 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `ab89a63b01ef` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0060), `5c556c16ea8b` (p=0.0235), `b71bb0907fb5` (p=0.0110).
...
- TROP-CHER : 4500 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4469 avec CONNECTED, 31 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 32445 systemes
  - sans CONNECTED : 0.0% sur 7230 systemes
