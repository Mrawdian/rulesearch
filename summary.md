...
- moteur actif `0caa9267db60` (7535 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 22818 | 11373 | 1539 | 775 | 2276 | 1813 | 2444 | 2312 | 10.1% |
...
- candidats AVEC connectivite : 2439, dont T2 : 100%
- candidats SANS connectivite : 3760, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2718 systemes avec CONNECTED sur 21122 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1909 candidats sur 6199 portent les champs bruts (31%).*
...
- `06fe04a859f1` — 794 candidats
  - AVEC connectivite (301) : resistance **41.0%**
...
- `06fe04a859f1` — 794 candidats
  - AVEC connectivite (301) : T0=13.37 T1=0.00 T2=3.02 — pondere **6.04**
...
- TROP-CHER : 2738 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2718 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 18621 systemes
  - sans CONNECTED : 0.0% sur 4197 systemes
