...
genere 2026-08-30 14:40 UTC — 221662 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 138318 systemes
...
- moteur actif `0caa9267db60` (177920 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 108880 | 54106 | 7400 | 3637 | 10967 | 8641 | 11514 | 11190 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 106667 | 24874 | 45033 | 49 | 14740 | 5515 | 43 | 16404 | 15.4% |
...
- candidats AVEC connectivite : 11317, dont T2 : 100%
- candidats SANS connectivite : 16714, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11788 systemes avec CONNECTED sur 91335 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*23741 candidats sur 28031 portent les champs bruts (85%).*

- `5c556c16ea8b` — 17776 candidats
  - AVEC connectivite (7189) : resistance **41.1%**
  - SANS connectivite (10587) : resistance **21.5%**
...
- `5c556c16ea8b` — 17776 candidats
  - AVEC connectivite (7189) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (10587) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 88834 systemes
  - sans CONNECTED : 0.0% sur 20046 systemes
