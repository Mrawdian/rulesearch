...
genere 2026-08-27 20:57 UTC — 113842 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 30498 systemes
...
- moteur actif `0caa9267db60` (70100 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 54407 | 27094 | 3761 | 1844 | 5371 | 4307 | 5762 | 5560 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 53320 | 12304 | 22673 | 26 | 7367 | 2769 | 25 | 8154 | 15.3% |
...
- candidats AVEC connectivite : 5687, dont T2 : 100%
- candidats SANS connectivite : 8464, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6036 systemes avec CONNECTED sur 46964 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*9861 candidats sur 14151 portent les champs bruts (70%).*

- `5c556c16ea8b` — 3896 candidats
  - AVEC connectivite (1559) : resistance **42.0%**
  - SANS connectivite (2337) : resistance **22.5%**
...
- `5c556c16ea8b` — 3896 candidats
  - AVEC connectivite (1559) : T0=12.93 T1=0.00 T2=3.06 — pondere **6.11**
  - SANS connectivite (2337) : T0=15.77 T1=0.00 T2=2.71 — pondere **5.42**
...
- TROP-CHER : 6071 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6036 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 44463 systemes
  - sans CONNECTED : 0.0% sur 9944 systemes
