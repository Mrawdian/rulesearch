...
genere 2026-08-26 17:03 UTC — 55088 systemes evalues
...
- moteur actif `0caa9267db60` (11346 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
| connect | 4 | 3 | 24744 | 12358 | 1681 | 838 | 2451 | 1948 | 2641 | 2518 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 24229 | 5606 | 10244 | 14 | 3392 | 1230 | 10 | 3733 | 15.4% |
...
- candidats AVEC connectivite : 2645, dont T2 : 100%
- candidats SANS connectivite : 4043, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2915 systemes avec CONNECTED sur 22730 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2398 candidats sur 6688 portent les champs bruts (36%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 88 candidats
  - AVEC connectivite (31) : resistance **40.3%**
...
- `23303c299f39` — 88 candidats
  - AVEC connectivite (31) : T0=12.90 T1=0.00 T2=2.94 — pondere **5.87**
  - SANS connectivite (57) : T0=16.96 T1=0.00 T2=2.88 — pondere **5.75**
  - test de permutation : **p = 0.8986** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 2935 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2915 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 20229 systemes
  - sans CONNECTED : 0.0% sur 4515 systemes
