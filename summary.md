...
genere 2026-08-26 15:59 UTC — 52584 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 7401 systemes
...
- moteur actif `0caa9267db60` (8842 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23490 | 11704 | 1589 | 804 | 2343 | 1864 | 2509 | 2381 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 22979 | 5317 | 9708 | 14 | 3214 | 1171 | 10 | 3545 | 15.4% |
...
- candidats SANS connectivite : 3855, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2783 systemes avec CONNECTED sur 21671 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2073 candidats sur 6363 portent les champs bruts (33%).*
...
- `06fe04a859f1` — 958 candidats
  - AVEC connectivite (370) : resistance **41.5%**
  - SANS connectivite (588) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 958 candidats
  ...
  - SANS connectivite (588) : T0=16.04 T1=0.00 T2=2.64 — pondere **5.27**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19170 systemes
  - sans CONNECTED : 0.0% sur 4320 systemes
