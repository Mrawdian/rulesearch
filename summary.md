...
genere 2026-08-26 21:16 UTC — 64684 systemes evalues
...
- moteur actif `0caa9267db60` (20942 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 29605 | 14716 | 2024 | 992 | 2958 | 2345 | 3157 | 3038 | 10.3% |
...
- candidats AVEC connectivite : 3165, dont T2 : 100%
- candidats SANS connectivite : 4764, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3431 systemes avec CONNECTED sur 26711 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3639 candidats sur 7929 portent les champs bruts (46%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 770 candidats
  - AVEC connectivite (321) : resistance **40.4%**
...
- `62448a55927e` — 770 candidats
  - AVEC connectivite (321) : T0=12.88 T1=0.00 T2=2.88 — pondere **5.75**
  - SANS connectivite (449) : T0=16.18 T1=0.00 T2=2.67 — pondere **5.33**
  - test de permutation : **p = 0.0615** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e3baecf8377b` — 657 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24210 systemes
  - sans CONNECTED : 0.0% sur 5395 systemes
