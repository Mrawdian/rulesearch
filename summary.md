...
genere 2026-08-29 17:30 UTC — 190442 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 107098 systemes
...
- moteur actif `0caa9267db60` (146700 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 93094 | 46260 | 6341 | 3128 | 9378 | 7408 | 9810 | 9578 | 10.3% |
...
- candidats AVEC connectivite : 9705, dont T2 : 100%
...
- **10084 systemes avec CONNECTED sur 78445 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*19780 candidats sur 24070 portent les champs bruts (82%).*

- `5c556c16ea8b` — 13815 candidats
  - AVEC connectivite (5577) : resistance **41.1%**
...
- `5c556c16ea8b` — 13815 candidats
  - AVEC connectivite (5577) : T0=12.99 T1=0.00 T2=2.99 — pondere **5.99**
...
- TROP-CHER : 10130 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 10084 avec CONNECTED, 46 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 75944 systemes
  - sans CONNECTED : 0.0% sur 17150 systemes
