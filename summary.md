...
genere 2026-08-26 16:55 UTC — 54824 systemes evalues
...
- moteur actif `0caa9267db60` (11082 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
| connect | 4 | 3 | 24611 | 12291 | 1672 | 833 | 2437 | 1941 | 2625 | 2505 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 24098 | 5574 | 10185 | 14 | 3377 | 1225 | 10 | 3713 | 15.4% |
...
- candidats AVEC connectivite : 2632, dont T2 : 100%
- candidats SANS connectivite : 4023, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2899 systemes avec CONNECTED sur 22615 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2365 candidats sur 6655 portent les champs bruts (36%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 55 candidats
  - AVEC connectivite (18) : resistance **37.1%**
  - SANS connectivite (37) : resistance **21.6%**
...
- `23303c299f39` — 55 candidats
  - AVEC connectivite (18) : T0=13.06 T1=0.00 T2=2.89 — pondere **5.78**
  - SANS connectivite (37) : T0=16.81 T1=0.00 T2=2.84 — pondere **5.68**
...
- TROP-CHER : 2919 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2899 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 20114 systemes
  - sans CONNECTED : 0.0% sur 4497 systemes
