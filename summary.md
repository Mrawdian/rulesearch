...
genere 2026-08-26 23:01 UTC — 68500 systemes evalues
...
- moteur actif `0caa9267db60` (24758 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 31533 | 15660 | 2158 | 1056 | 3143 | 2517 | 3367 | 3232 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 30852 | 7107 | 13110 | 18 | 4272 | 1604 | 14 | 4727 | 15.3% |
...
- candidats AVEC connectivite : 3359, dont T2 : 100%
- candidats SANS connectivite : 5037, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3641 systemes avec CONNECTED sur 28273 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4106 candidats sur 8396 portent les champs bruts (49%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 429 candidats
  - AVEC connectivite (179) : resistance **42.4%**
  - SANS connectivite (250) : resistance **21.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 429 candidats
  - AVEC connectivite (179) : T0=13.00 T1=0.00 T2=3.08 — pondere **6.16**
  - SANS connectivite (250) : T0=16.00 T1=0.00 T2=2.67 — pondere **5.34**
...
- TROP-CHER : 3665 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 3641 avec CONNECTED, 24 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 25772 systemes
  - sans CONNECTED : 0.0% sur 5761 systemes
