...
genere 2026-08-31 06:42 UTC — 243861 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 160517 systemes
...
- moteur actif `0caa9267db60` (200119 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 120095 | 59727 | 8153 | 4033 | 12064 | 9478 | 12713 | 12370 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 117651 | 27456 | 49712 | 53 | 16271 | 6069 | 52 | 18028 | 15.3% |
...
- candidats AVEC connectivite : 12497, dont T2 : 100%
- candidats SANS connectivite : 18338, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12987 systemes avec CONNECTED sur 100564 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*26545 candidats sur 30835 portent les champs bruts (86%).*

- `5c556c16ea8b` — 20580 candidats
  - AVEC connectivite (8369) : resistance **40.9%**
  - SANS connectivite (12211) : resistance **21.4%**
...
- `5c556c16ea8b` — 20580 candidats
  - AVEC connectivite (8369) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (12211) : T0=15.90 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 13049 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 12987 avec CONNECTED, 62 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 98063 systemes
  - sans CONNECTED : 0.0% sur 22032 systemes
