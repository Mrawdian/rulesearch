...
genere 2026-08-27 02:53 UTC — 77082 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 12175 systemes
...
- moteur actif `0caa9267db60` (33340 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 35872 | 17857 | 2466 | 1214 | 3552 | 2837 | 3811 | 3672 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 35095 | 8090 | 14926 | 20 | 4855 | 1836 | 19 | 5349 | 15.2% |
...
- candidats AVEC connectivite : 3799, dont T2 : 100%
- candidats SANS connectivite : 5659, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4085 systemes avec CONNECTED sur 31870 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5168 candidats sur 9458 portent les champs bruts (55%).*
...
- `ab89a63b01ef` — 1491 candidats
  - AVEC connectivite (619) : resistance **41.2%**
  - SANS connectivite (872) : resistance **22.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1491 candidats
  - AVEC connectivite (619) : T0=13.00 T1=0.00 T2=3.05 — pondere **6.09**
  - SANS connectivite (872) : T0=15.95 T1=0.00 T2=2.71 — pondere **5.41**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 29369 systemes
  - sans CONNECTED : 0.0% sur 6503 systemes
