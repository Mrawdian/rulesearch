...
genere 2026-08-26 07:30 UTC — 31085 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 22111 systemes
...
| connect | 4 | 3 | 14431 | 7214 | 945 | 500 | 1412 | 1144 | 1576 | 1454 | 10.1% |
| d4 | 4 | 4 | 2394 | 1098 | 610 | 13 | 174 | 159 | 116 | 160 | 6.7% |
| ref | 4 | 3 | 14136 | 3347 | 5939 | 9 | 1946 | 719 | 6 | 2170 | 15.4% |
...
- candidats AVEC connectivite : 1492, dont T2 : 100%
- candidats SANS connectivite : 2299, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1689 systemes avec CONNECTED sur 12858 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2626 candidats
  - AVEC connectivite (1013) : T0=13.19 T1=0.00 T2=2.89 — pondere **5.77**
  - SANS connectivite (1613) : T0=15.89 T1=0.01 T2=2.63 — pondere **5.27**
...
- TROP-CHER : 1698 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1689 avec CONNECTED, 9 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 11817 systemes
  - sans CONNECTED : 0.0% sur 2614 systemes
