...
genere 2026-08-26 08:39 UTC — 34011 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 25037 systemes
...
| connect | 4 | 3 | 15165 | 7564 | 991 | 521 | 1486 | 1216 | 1658 | 1536 | 10.1% |
| d4 | 4 | 4 | 3863 | 1765 | 995 | 21 | 280 | 253 | 191 | 266 | 6.9% |
| ref | 4 | 3 | 14859 | 3516 | 6236 | 9 | 2044 | 759 | 6 | 2289 | 15.4% |
...
- candidats AVEC connectivite : 1610, dont T2 : 100%
- candidats SANS connectivite : 2488, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1844 systemes avec CONNECTED sur 14036 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2933 candidats
  - AVEC connectivite (1131) : T0=13.16 T1=0.00 T2=2.91 — pondere **5.83**
  - SANS connectivite (1802) : T0=15.90 T1=0.01 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 1855 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1844 avec CONNECTED, 11 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.4% sur 12403 systemes
  - sans CONNECTED : 0.0% sur 2762 systemes
