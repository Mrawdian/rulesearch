...
genere 2026-08-26 19:37 UTC — 61101 systemes evalues
...
- moteur actif `0caa9267db60` (17359 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27795 | 13850 | 1900 | 935 | 2750 | 2206 | 2954 | 2851 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 27191 | 6294 | 11500 | 15 | 3783 | 1401 | 11 | 4187 | 15.4% |
...
- candidats AVEC connectivite : 2978, dont T2 : 100%
- candidats SANS connectivite : 4497, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3228 systemes avec CONNECTED sur 25241 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3185 candidats sur 7475 portent les champs bruts (43%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 316 candidats
  - AVEC connectivite (134) : resistance **39.6%**
  - SANS connectivite (182) : resistance **19.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 316 candidats
  - AVEC connectivite (134) : T0=13.04 T1=0.00 T2=2.90 — pondere **5.79**
  - SANS connectivite (182) : T0=16.05 T1=0.00 T2=2.62 — pondere **5.23**
...
- TROP-CHER : 3249 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3228 avec CONNECTED, 21 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22740 systemes
  - sans CONNECTED : 0.0% sur 5055 systemes
