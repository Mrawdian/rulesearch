...
genere 2026-08-27 07:38 UTC — 87458 systemes evalues
...
- moteur actif `0caa9267db60` (43716 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 41090 | 20454 | 2816 | 1395 | 4104 | 3232 | 4339 | 4219 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 40253 | 9268 | 17112 | 22 | 5591 | 2096 | 21 | 6143 | 15.3% |
...
- candidats AVEC connectivite : 4346, dont T2 : 100%
- candidats SANS connectivite : 6453, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4613 systemes avec CONNECTED sur 36087 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6509 candidats sur 10799 portent les champs bruts (60%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 544 candidats
  - AVEC connectivite (218) : resistance **41.8%**
  - SANS connectivite (326) : resistance **20.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 544 candidats
  - AVEC connectivite (218) : T0=12.99 T1=0.00 T2=3.06 — pondere **6.11**
  - SANS connectivite (326) : T0=15.84 T1=0.00 T2=2.60 — pondere **5.21**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 33586 systemes
  - sans CONNECTED : 0.0% sur 7504 systemes
