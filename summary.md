...
genere 2026-08-28 13:00 UTC — 143363 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 60019 systemes
...
- moteur actif `0caa9267db60` (99621 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 69321 | 34439 | 4744 | 2352 | 6950 | 5537 | 7321 | 7089 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 67927 | 15765 | 28703 | 32 | 9403 | 3505 | 30 | 10486 | 15.4% |
...
- candidats AVEC connectivite : 7216, dont T2 : 100%
- candidats SANS connectivite : 10796, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **7595 systemes avec CONNECTED sur 59029 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*13722 candidats sur 18012 portent les champs bruts (76%).*

- `5c556c16ea8b` — 7757 candidats
  - AVEC connectivite (3088) : resistance **41.3%**
  - SANS connectivite (4669) : resistance **21.8%**
...
- `5c556c16ea8b` — 7757 candidats
  - AVEC connectivite (3088) : T0=13.01 T1=0.00 T2=3.01 — pondere **6.02**
  - SANS connectivite (4669) : T0=15.88 T1=0.00 T2=2.68 — pondere **5.37**
...
- TROP-CHER : 7635 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 7595 avec CONNECTED, 40 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 56528 systemes
  - sans CONNECTED : 0.0% sur 12793 systemes
