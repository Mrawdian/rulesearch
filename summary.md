...
genere 2026-09-01 18:05 UTC — 289398 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 206054 systemes
...
- moteur actif `0caa9267db60` (245656 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 143080 | 71093 | 9705 | 4786 | 14536 | 11289 | 15114 | 14709 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 140203 | 32604 | 59313 | 59 | 19432 | 7250 | 63 | 21471 | 15.3% |
...
- candidats AVEC connectivite : 14836, dont T2 : 100%
- candidats SANS connectivite : 21781, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15388 systemes avec CONNECTED sur 119249 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*32327 candidats sur 36617 portent les champs bruts (88%).*

- `5c556c16ea8b` — 26362 candidats
  - AVEC connectivite (10708) : resistance **41.0%**
  - SANS connectivite (15654) : resistance **21.3%**
...
- `5c556c16ea8b` — 26362 candidats
  - AVEC connectivite (10708) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (15654) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 15461 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15388 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 116748 systemes
  - sans CONNECTED : 0.0% sur 26332 systemes
