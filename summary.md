...
genere 2026-08-28 22:06 UTC — 159222 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 75878 systemes
...
- moteur actif `0caa9267db60` (115480 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 77332 | 38421 | 5268 | 2634 | 7746 | 6177 | 8140 | 7957 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 75775 | 17621 | 32084 | 35 | 10440 | 3874 | 31 | 11686 | 15.4% |
...
- candidats SANS connectivite : 11996, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8414 systemes avec CONNECTED sur 65579 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*15790 candidats sur 20080 portent les champs bruts (79%).*

- `5c556c16ea8b` — 9825 candidats
  - AVEC connectivite (3956) : resistance **41.2%**
  - SANS connectivite (5869) : resistance **21.8%**
...
- `5c556c16ea8b` — 9825 candidats
  ...
  - SANS connectivite (5869) : T0=15.89 T1=0.00 T2=2.68 — pondere **5.36**
...
- TROP-CHER : 8455 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8414 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 63078 systemes
  - sans CONNECTED : 0.0% sur 14254 systemes
