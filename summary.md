...
genere 2026-08-28 05:39 UTC — 130691 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 47347 systemes
...
- moteur actif `0caa9267db60` (86949 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 62930 | 31291 | 4322 | 2135 | 6290 | 5010 | 6603 | 6467 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 61646 | 14256 | 26113 | 29 | 8576 | 3186 | 27 | 9457 | 15.3% |
...
- candidats AVEC connectivite : 6594, dont T2 : 100%
- candidats SANS connectivite : 9767, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6877 systemes avec CONNECTED sur 53843 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*12071 candidats sur 16361 portent les champs bruts (74%).*

- `5c556c16ea8b` — 6106 candidats
  - AVEC connectivite (2466) : resistance **41.5%**
...
- `5c556c16ea8b` — 6106 candidats
  - AVEC connectivite (2466) : T0=12.99 T1=0.00 T2=3.02 — pondere **6.04**
...
- TROP-CHER : 6914 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6877 avec CONNECTED, 37 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 51342 systemes
  - sans CONNECTED : 0.0% sur 11588 systemes
