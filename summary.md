...
genere 2026-09-01 21:04 UTC — 292886 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 209542 systemes
...
- moteur actif `0caa9267db60` (249144 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 144830 | 71929 | 9849 | 4849 | 14703 | 11413 | 15324 | 14894 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 141941 | 32998 | 60040 | 59 | 19682 | 7337 | 63 | 21751 | 15.3% |
...
- candidats AVEC connectivite : 15021, dont T2 : 100%
- candidats SANS connectivite : 22061, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15598 systemes avec CONNECTED sur 120697 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*32792 candidats sur 37082 portent les champs bruts (88%).*

- `5c556c16ea8b` — 26827 candidats
  - AVEC connectivite (10893) : resistance **41.0%**
  - SANS connectivite (15934) : resistance **21.3%**
...
- `5c556c16ea8b` — 26827 candidats
  - AVEC connectivite (10893) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (15934) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 15671 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 15598 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 118196 systemes
  - sans CONNECTED : 0.0% sur 26634 systemes
