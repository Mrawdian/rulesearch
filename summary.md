...
genere 2026-08-26 13:48 UTC — 47573 systemes evalues
...
- moteur actif `0caa9267db60` (3831 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20946 | 10460 | 1389 | 721 | 2078 | 1668 | 2230 | 2140 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20512 | 4794 | 8663 | 13 | 2842 | 1061 | 7 | 3132 | 15.3% |
...
- candidats AVEC connectivite : 2267, dont T2 : 100%
- candidats SANS connectivite : 3442, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2504 systemes avec CONNECTED sur 19607 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1419 candidats sur 5709 portent les champs bruts (25%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 304 candidats
  - AVEC connectivite (129) : resistance **39.6%**
  - SANS connectivite (175) : resistance **20.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 304 candidats
  - AVEC connectivite (129) : T0=13.35 T1=0.00 T2=2.88 — pondere **5.77**
  - SANS connectivite (175) : T0=16.19 T1=0.00 T2=2.70 — pondere **5.41**
  - test de permutation : **p = 0.3218** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
- TROP-CHER : 2521 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2504 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 17106 systemes
  - sans CONNECTED : 0.0% sur 3840 systemes
