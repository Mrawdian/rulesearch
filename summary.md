...
genere 2026-08-26 14:22 UTC — 48747 systemes evalues
...
- moteur actif `0caa9267db60` (5005 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21546 | 10754 | 1433 | 742 | 2131 | 1712 | 2304 | 2198 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 21086 | 4914 | 8898 | 13 | 2920 | 1089 | 8 | 3244 | 15.4% |
...
- candidats AVEC connectivite : 2325, dont T2 : 100%
- candidats SANS connectivite : 3554, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2578 systemes avec CONNECTED sur 20110 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1589 candidats sur 5879 portent les champs bruts (27%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 474 candidats
  - AVEC connectivite (187) : resistance **40.2%**
  - SANS connectivite (287) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 474 candidats
  - AVEC connectivite (187) : T0=13.39 T1=0.00 T2=2.98 — pondere **5.97**
  - SANS connectivite (287) : T0=16.11 T1=0.00 T2=2.67 — pondere **5.33**
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0295).
...
## cout
- temps total 15.1 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2596 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2578 avec CONNECTED, 18 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17609 systemes
  - sans CONNECTED : 0.0% sur 3937 systemes
