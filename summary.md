...
genere 2026-08-27 01:39 UTC — 74316 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 9409 systemes
...
- moteur actif `0caa9267db60` (30574 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 34465 | 17141 | 2360 | 1168 | 3422 | 2745 | 3673 | 3514 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 33736 | 7784 | 14337 | 20 | 4682 | 1754 | 18 | 5141 | 15.2% |
...
- candidats AVEC connectivite : 3641, dont T2 : 100%
- candidats SANS connectivite : 5451, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3947 systemes avec CONNECTED sur 30694 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4802 candidats sur 9092 portent les champs bruts (53%).*
...
- `ab89a63b01ef` — 1125 candidats
  - AVEC connectivite (461) : resistance **41.3%**
  - SANS connectivite (664) : resistance **21.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1125 candidats
  - AVEC connectivite (461) : T0=13.04 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (664) : T0=15.89 T1=0.00 T2=2.68 — pondere **5.36**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 1195 candidats
...
## cout
- temps total 23.1 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 3975 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3947 avec CONNECTED, 28 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 28193 systemes
  - sans CONNECTED : 0.0% sur 6272 systemes
