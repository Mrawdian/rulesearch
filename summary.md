...
genere 2026-09-03 05:00 UTC — 329938 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 246594 systemes
...
- moteur actif `0caa9267db60` (286196 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 163536 | 81245 | 11111 | 5475 | 16659 | 12891 | 17330 | 16733 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 160287 | 37348 | 67753 | 65 | 22211 | 8284 | 65 | 24549 | 15.3% |
...
- candidats AVEC connectivite : 16860, dont T2 : 100%
- candidats SANS connectivite : 24859, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **17604 systemes avec CONNECTED sur 135900 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*37429 candidats sur 41719 portent les champs bruts (90%).*

- `5c556c16ea8b` — 31464 candidats
  - AVEC connectivite (12732) : resistance **41.1%**
  - SANS connectivite (18732) : resistance **21.2%**
...
- `5c556c16ea8b` — 31464 candidats
  - AVEC connectivite (12732) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (18732) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
## cout
- temps total 102.4 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 17679 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 17604 avec CONNECTED, 75 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 133399 systemes
  - sans CONNECTED : 0.0% sur 30137 systemes
