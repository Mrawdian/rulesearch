...
genere 2026-08-26 10:03 UTC — 37820 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 28846 systemes
...
| connect | 4 | 3 | 16122 | 8044 | 1049 | 553 | 1604 | 1285 | 1761 | 1623 | 10.1% |
| d4 | 4 | 4 | 5781 | 2658 | 1472 | 30 | 404 | 387 | 272 | 411 | 7.1% |
| ref | 4 | 3 | 15793 | 3712 | 6673 | 11 | 2166 | 800 | 7 | 2424 | 15.3% |
...
- candidats AVEC connectivite : 1742, dont T2 : 100%
- candidats SANS connectivite : 2723, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2023 systemes avec CONNECTED sur 15588 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*175 candidats sur 4465 portent les champs bruts (4%).*

- `89c65c03c4ad` — 175 candidats
  - AVEC connectivite (65) : resistance **47.5%**
  - SANS connectivite (110) : resistance **21.5%**
...
- `89c65c03c4ad` — 3300 candidats
  - AVEC connectivite (1263) : T0=13.05 T1=0.00 T2=2.96 — pondere **5.92**
  - SANS connectivite (2037) : T0=15.85 T1=0.02 T2=2.66 — pondere **5.34**
...
## cout
- temps total 11.9 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2040 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2023 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.4% sur 13173 systemes
  - sans CONNECTED : 0.0% sur 2949 systemes
