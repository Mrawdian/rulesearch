...
genere 2026-08-27 22:48 UTC — 117525 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 34181 systemes
...
- moteur actif `0caa9267db60` (73783 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 56278 | 28024 | 3893 | 1906 | 5582 | 4460 | 5946 | 5744 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 55132 | 12723 | 23406 | 26 | 7654 | 2848 | 25 | 8448 | 15.3% |
...
- candidats AVEC connectivite : 5871, dont T2 : 100%
- candidats SANS connectivite : 8758, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6220 systemes avec CONNECTED sur 48466 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10339 candidats sur 14629 portent les champs bruts (71%).*

- `5c556c16ea8b` — 4374 candidats
  - AVEC connectivite (1743) : resistance **42.1%**
  - SANS connectivite (2631) : resistance **22.5%**
...
- `5c556c16ea8b` — 4374 candidats
  - AVEC connectivite (1743) : T0=12.95 T1=0.00 T2=3.06 — pondere **6.12**
  - SANS connectivite (2631) : T0=15.79 T1=0.00 T2=2.71 — pondere **5.43**
...
- TROP-CHER : 6255 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6220 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 45965 systemes
  - sans CONNECTED : 0.0% sur 10313 systemes
