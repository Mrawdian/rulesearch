...
genere 2026-08-26 06:55 UTC — 29482 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 20508 systemes
...
| d4 | 4 | 4 | 1586 | 726 | 396 | 11 | 119 | 107 | 82 | 107 | 6.7% |
| ref | 4 | 3 | 13744 | 3262 | 5780 | 9 | 1885 | 695 | 6 | 2107 | 15.3% |
...
- candidats SANS connectivite : 2192, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1612 systemes avec CONNECTED sur 12196 (13.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2470 candidats
  - AVEC connectivite (964) : T0=13.20 T1=0.00 T2=2.87 — pondere **5.75**
  - SANS connectivite (1506) : T0=15.90 T1=0.01 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 1621 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1612 avec CONNECTED, 9 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
