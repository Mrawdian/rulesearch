...
genere 2026-08-31 19:31 UTC — 261169 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 177825 systemes
...
- moteur actif `0caa9267db60` (217427 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 128831 | 64045 | 8713 | 4317 | 13046 | 10185 | 13577 | 13268 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 126223 | 29409 | 53293 | 56 | 17500 | 6526 | 56 | 19373 | 15.3% |
...
- candidats AVEC connectivite : 13395, dont T2 : 100%
- candidats SANS connectivite : 19683, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13851 systemes avec CONNECTED sur 107604 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*28788 candidats sur 33078 portent les champs bruts (87%).*

- `5c556c16ea8b` — 22823 candidats
  - AVEC connectivite (9267) : resistance **41.0%**
  - SANS connectivite (13556) : resistance **21.4%**
...
- `5c556c16ea8b` — 22823 candidats
  - AVEC connectivite (9267) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.97**
  - SANS connectivite (13556) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 13917 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13851 avec CONNECTED, 66 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 105103 systemes
  - sans CONNECTED : 0.0% sur 23728 systemes
