...
genere 2026-09-07 19:44 UTC — 442415 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 359071 systemes
...
- moteur actif `0caa9267db60` (398673 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 220349 | 109440 | 15031 | 7340 | 22316 | 17269 | 23442 | 22706 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 215951 | 50296 | 91009 | 85 | 30095 | 11165 | 77 | 33206 | 15.4% |
...
- candidats SANS connectivite : 33516, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23716 systemes avec CONNECTED sur 182399 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*52059 candidats sur 56349 portent les champs bruts (92%).*

- `5c556c16ea8b` — 46094 candidats
  - AVEC connectivite (18705) : resistance **41.1%**
  - SANS connectivite (27389) : resistance **21.3%**
...
- `5c556c16ea8b` — 46094 candidats
  ...
  - SANS connectivite (27389) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 23803 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23716 avec CONNECTED, 87 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 179898 systemes
  - sans CONNECTED : 0.0% sur 40451 systemes
