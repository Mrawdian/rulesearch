...
genere 2026-09-03 08:00 UTC — 333309 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 249965 systemes
...
- moteur actif `0caa9267db60` (289567 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 165241 | 82109 | 11225 | 5527 | 16823 | 13035 | 17514 | 16894 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 161953 | 37729 | 68472 | 66 | 22456 | 8372 | 66 | 24780 | 15.3% |
...
- candidats AVEC connectivite : 17021, dont T2 : 100%
- candidats SANS connectivite : 25090, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **17788 systemes avec CONNECTED sur 137304 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*37821 candidats sur 42111 portent les champs bruts (90%).*

- `5c556c16ea8b` — 31856 candidats
  - AVEC connectivite (12893) : resistance **41.1%**
  - SANS connectivite (18963) : resistance **21.2%**
...
- `5c556c16ea8b` — 31856 candidats
  - AVEC connectivite (12893) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (18963) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 17864 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 17788 avec CONNECTED, 76 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 134803 systemes
  - sans CONNECTED : 0.0% sur 30438 systemes
