...
genere 2026-09-05 17:27 UTC — 394334 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 310990 systemes
...
- moteur actif `0caa9267db60` (350592 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 196052 | 97356 | 13345 | 6538 | 19933 | 15420 | 20800 | 20166 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 192167 | 44728 | 81082 | 78 | 26757 | 9932 | 71 | 29505 | 15.4% |
...
- candidats AVEC connectivite : 20293, dont T2 : 100%
- candidats SANS connectivite : 29815, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21074 systemes avec CONNECTED sur 162448 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*45818 candidats sur 50108 portent les champs bruts (91%).*

- `5c556c16ea8b` — 39853 candidats
  - AVEC connectivite (16165) : resistance **41.1%**
  - SANS connectivite (23688) : resistance **21.3%**
...
- `5c556c16ea8b` — 39853 candidats
  - AVEC connectivite (16165) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (23688) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 159947 systemes
  - sans CONNECTED : 0.0% sur 36105 systemes
