...
genere 2026-08-26 13:23 UTC — 46408 systemes evalues
...
- moteur actif `0caa9267db60` (2666 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20366 | 10162 | 1336 | 703 | 2039 | 1616 | 2178 | 2080 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 19927 | 4677 | 8414 | 13 | 2753 | 1030 | 7 | 3033 | 15.2% |
...
- candidats AVEC connectivite : 2207, dont T2 : 100%
- candidats SANS connectivite : 3343, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2452 systemes avec CONNECTED sur 19122 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1260 candidats sur 5550 portent les champs bruts (23%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 145 candidats
  - AVEC connectivite (69) : resistance **37.7%**
  - SANS connectivite (76) : resistance **22.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 145 candidats
  - AVEC connectivite (69) : T0=13.26 T1=0.00 T2=2.68 — pondere **5.36**
  - SANS connectivite (76) : T0=16.38 T1=0.00 T2=2.97 — pondere **5.95**
  - test de permutation : **p = 0.2454** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 2469 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2452 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16621 systemes
  - sans CONNECTED : 0.0% sur 3745 systemes
