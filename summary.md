...
genere 2026-08-27 01:18 UTC — 73559 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 9167 systemes
- `ab89a63b01ef` : 8652 systemes
...
- moteur actif `0caa9267db60` (29817 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 33352 | 7690 | 14168 | 20 | 4631 | 1742 | 17 | 5084 | 15.2% |
...
- candidats SANS connectivite : 5394, dont T2 : 100%
...
*4705 candidats sur 8995 portent les champs bruts (52%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 1028 candidats
  - AVEC connectivite (421) : resistance **41.0%**
  - SANS connectivite (607) : resistance **21.7%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1028 candidats
  ...
  - SANS connectivite (607) : T0=15.90 T1=0.00 T2=2.64 — pondere **5.28**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
