...
genere 2026-08-27 00:43 UTC — 72257 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 9167 systemes
- `ab89a63b01ef` : 7350 systemes
...
- moteur actif `0caa9267db60` (28515 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 33434 | 16618 | 2301 | 1132 | 3319 | 2656 | 3566 | 3415 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 32708 | 7541 | 13885 | 18 | 4539 | 1712 | 16 | 4997 | 15.3% |
...
- candidats AVEC connectivite : 3542, dont T2 : 100%
- candidats SANS connectivite : 5307, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3840 systemes avec CONNECTED sur 29847 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4559 candidats sur 8849 portent les champs bruts (52%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 882 candidats
  - AVEC connectivite (362) : resistance **41.1%**
  - SANS connectivite (520) : resistance **21.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 882 candidats
  - AVEC connectivite (362) : T0=13.07 T1=0.00 T2=3.05 — pondere **6.09**
  - SANS connectivite (520) : T0=15.91 T1=0.00 T2=2.59 — pondere **5.19**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
...
## cout
- temps total 22.5 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 3866 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 3840 avec CONNECTED, 26 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 27346 systemes
  - sans CONNECTED : 0.0% sur 6088 systemes
