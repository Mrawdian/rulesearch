...
genere 2026-08-26 13:36 UTC — 47015 systemes evalues
...
- moteur actif `0caa9267db60` (3273 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20663 | 10303 | 1364 | 718 | 2059 | 1644 | 2204 | 2116 | 10.2% |
...
- candidats AVEC connectivite : 2243, dont T2 : 100%
- candidats SANS connectivite : 3396, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2478 systemes avec CONNECTED sur 19369 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1349 candidats sur 5639 portent les champs bruts (24%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 234 candidats
  - AVEC connectivite (105) : resistance **38.1%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 234 candidats
  - AVEC connectivite (105) : T0=13.61 T1=0.00 T2=2.74 — pondere **5.49**
  - SANS connectivite (129) : T0=16.16 T1=0.00 T2=2.79 — pondere **5.58**
  - test de permutation : **p = 0.8196** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16868 systemes
  - sans CONNECTED : 0.0% sur 3795 systemes
