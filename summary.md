...
genere 2026-08-30 19:40 UTC — 228737 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 145393 systemes
...
- moteur actif `0caa9267db60` (184995 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 112456 | 55919 | 7634 | 3763 | 11301 | 8894 | 11896 | 11586 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 110166 | 25694 | 46536 | 51 | 15197 | 5697 | 45 | 16936 | 15.4% |
...
- candidats AVEC connectivite : 11713, dont T2 : 100%
- candidats SANS connectivite : 17246, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **12170 systemes avec CONNECTED sur 94295 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*24669 candidats sur 28959 portent les champs bruts (85%).*

- `5c556c16ea8b` — 18704 candidats
  - AVEC connectivite (7585) : resistance **41.1%**
  - SANS connectivite (11119) : resistance **21.5%**
...
- `5c556c16ea8b` — 18704 candidats
  - AVEC connectivite (7585) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (11119) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 12225 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 12170 avec CONNECTED, 55 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 91794 systemes
  - sans CONNECTED : 0.0% sur 20662 systemes
