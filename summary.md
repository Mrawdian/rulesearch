...
genere 2026-08-27 00:31 UTC — 71813 systemes evalues
...
- moteur actif `0caa9267db60` (28071 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 33210 | 16499 | 2283 | 1124 | 3302 | 2641 | 3541 | 3395 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 32488 | 7489 | 13792 | 18 | 4505 | 1702 | 16 | 4966 | 15.3% |
...
- candidats AVEC connectivite : 3522, dont T2 : 100%
- candidats SANS connectivite : 5276, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3815 systemes avec CONNECTED sur 29659 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4508 candidats sur 8798 portent les champs bruts (51%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 831 candidats
  - AVEC connectivite (342) : resistance **41.3%**
...
- `ab89a63b01ef` — 831 candidats
  - AVEC connectivite (342) : T0=13.12 T1=0.00 T2=3.06 — pondere **6.13**
...
- TROP-CHER : 3841 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3815 avec CONNECTED, 26 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 27158 systemes
  - sans CONNECTED : 0.0% sur 6052 systemes
