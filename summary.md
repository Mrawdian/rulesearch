...
genere 2026-08-27 18:04 UTC — 108512 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 25168 systemes
...
- moteur actif `0caa9267db60` (64770 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 51723 | 25767 | 3581 | 1776 | 5117 | 4094 | 5457 | 5259 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 50674 | 11742 | 21493 | 26 | 7000 | 2643 | 23 | 7745 | 15.3% |
...
- candidats AVEC connectivite : 5386, dont T2 : 100%
- candidats SANS connectivite : 8055, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5731 systemes avec CONNECTED sur 44760 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*9151 candidats sur 13441 portent les champs bruts (68%).*
...
- `5c556c16ea8b` — 3186 candidats
  - AVEC connectivite (1258) : resistance **42.0%**
  - SANS connectivite (1928) : resistance **22.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 3186 candidats
  - AVEC connectivite (1258) : T0=13.00 T1=0.00 T2=3.07 — pondere **6.14**
  - SANS connectivite (1928) : T0=15.77 T1=0.00 T2=2.70 — pondere **5.39**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 2280 candidats
...
- TROP-CHER : 5764 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 5731 avec CONNECTED, 33 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 42259 systemes
  - sans CONNECTED : 0.0% sur 9464 systemes
