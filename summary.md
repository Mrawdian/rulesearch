...
genere 2026-08-26 05:45 UTC — 26606 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 17632 systemes
...
**7466 enregistrements (28%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 13311 | 6658 | 872 | 464 | 1304 | 1060 | 1445 | 1340 | 10.1% |
| d4 | 4 | 4 | 135 | 68 | 29 | 0 | 7 | 10 | 7 | 10 | 7.4% |
| ref | 4 | 3 | 13036 | 3115 | 5477 | 9 | 1776 | 653 | 5 | 2001 | 15.3% |
...
- candidats AVEC connectivite : 1345, dont T2 : 100%
- candidats SANS connectivite : 2013, dont T2 : 100%
...
- **1452 systemes avec CONNECTED sur 11016 (13.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2193 candidats
  - AVEC connectivite (866) : T0=13.26 T1=0.00 T2=2.87 — pondere **5.74**
  - SANS connectivite (1327) : T0=15.89 T1=0.00 T2=2.64 — pondere **5.29**
...
**1 serie(s) reproductible(s) sur 3 etablissent l'ecart** : `89c65c03c4ad` (p=0.0020).
...
- `T2` indices=0.12 — CONNECTED(v0) + COUNT(v0,1-5)@grid + PAIRDIFF(>=1)@adj + PAIRDIFF(>=1)@knight
...
## cout
- temps total 8.4 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 1457 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1452 avec CONNECTED, 5 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 10901 systemes
  - sans CONNECTED : 0.0% sur 2410 systemes
