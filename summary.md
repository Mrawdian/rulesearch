...
genere 2026-09-03 04:26 UTC — 329303 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 245959 systemes
...
- moteur actif `0caa9267db60` (285561 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 163209 | 81088 | 11086 | 5462 | 16614 | 12868 | 17296 | 16708 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 159979 | 37275 | 67620 | 65 | 22174 | 8265 | 65 | 24503 | 15.3% |
...
- candidats AVEC connectivite : 16835, dont T2 : 100%
- candidats SANS connectivite : 24813, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **17570 systemes avec CONNECTED sur 135647 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*37358 candidats sur 41648 portent les champs bruts (90%).*

- `5c556c16ea8b` — 31393 candidats
  - AVEC connectivite (12707) : resistance **41.1%**
  - SANS connectivite (18686) : resistance **21.2%**
...
- `5c556c16ea8b` — 31393 candidats
  - AVEC connectivite (12707) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (18686) : T0=15.93 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 133146 systemes
  - sans CONNECTED : 0.0% sur 30063 systemes
