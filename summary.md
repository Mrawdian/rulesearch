...
genere 2026-08-26 21:08 UTC — 64327 systemes evalues
...
- moteur actif `0caa9267db60` (20585 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 29426 | 14632 | 2010 | 985 | 2934 | 2330 | 3142 | 3018 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 28786 | 6637 | 12215 | 16 | 3997 | 1484 | 12 | 4425 | 15.4% |
...
- candidats AVEC connectivite : 3145, dont T2 : 100%
- candidats SANS connectivite : 4735, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3416 systemes avec CONNECTED sur 26573 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3590 candidats sur 7880 portent les champs bruts (46%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 721 candidats
  - AVEC connectivite (301) : resistance **40.0%**
  - SANS connectivite (420) : resistance **20.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 721 candidats
  - AVEC connectivite (301) : T0=12.87 T1=0.00 T2=2.85 — pondere **5.69**
  - SANS connectivite (420) : T0=16.17 T1=0.00 T2=2.68 — pondere **5.37**
  - test de permutation : **p = 0.1654** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e3baecf8377b` — 657 candidats
...
- TROP-CHER : 3438 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3416 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 24072 systemes
  - sans CONNECTED : 0.0% sur 5354 systemes
