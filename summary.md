...
- moteur actif `0caa9267db60` (47515 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 43019 | 21428 | 2950 | 1455 | 4300 | 3384 | 4530 | 4411 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 42123 | 9708 | 17890 | 25 | 5837 | 2197 | 22 | 6443 | 15.3% |
...
- candidats AVEC connectivite : 4538, dont T2 : 100%
- candidats SANS connectivite : 6753, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4804 systemes avec CONNECTED sur 37646 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*7001 candidats sur 11291 portent les champs bruts (62%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 1036 candidats
  - AVEC connectivite (410) : resistance **41.4%**
  - SANS connectivite (626) : resistance **21.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `5c556c16ea8b` — 1036 candidats
  - AVEC connectivite (410) : T0=13.00 T1=0.00 T2=3.01 — pondere **6.03**
  - SANS connectivite (626) : T0=15.83 T1=0.00 T2=2.65 — pondere **5.29**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 35145 systemes
  - sans CONNECTED : 0.0% sur 7874 systemes
