...
genere 2026-09-08 06:29 UTC — 452032 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 368688 systemes
...
- moteur actif `0caa9267db60` (408290 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 225193 | 111814 | 15333 | 7512 | 22799 | 17649 | 24002 | 23214 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 220724 | 51412 | 93034 | 87 | 30751 | 11409 | 80 | 33933 | 15.4% |
...
- candidats AVEC connectivite : 23341, dont T2 : 100%
- candidats SANS connectivite : 34243, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **24276 systemes avec CONNECTED sur 186386 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*53294 candidats sur 57584 portent les champs bruts (93%).*

- `5c556c16ea8b` — 47329 candidats
  - AVEC connectivite (19213) : resistance **41.2%**
  - SANS connectivite (28116) : resistance **21.3%**
...
- `5c556c16ea8b` — 47329 candidats
  - AVEC connectivite (19213) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (28116) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 183885 systemes
  - sans CONNECTED : 0.0% sur 41308 systemes
