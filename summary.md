...
genere 2026-09-08 00:46 UTC — 446834 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 363490 systemes
...
- moteur actif `0caa9267db60` (403092 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 222580 | 110534 | 15164 | 7428 | 22533 | 17427 | 23719 | 22935 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 218139 | 50821 | 91931 | 86 | 30420 | 11280 | 78 | 33505 | 15.4% |
...
- candidats SANS connectivite : 33815, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23993 systemes avec CONNECTED sur 184260 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*52587 candidats sur 56877 portent les champs bruts (92%).*

- `5c556c16ea8b` — 46622 candidats
  - AVEC connectivite (18934) : resistance **41.2%**
  - SANS connectivite (27688) : resistance **21.3%**
...
- `5c556c16ea8b` — 46622 candidats
  ...
  - SANS connectivite (27688) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 181759 systemes
  - sans CONNECTED : 0.0% sur 40821 systemes
