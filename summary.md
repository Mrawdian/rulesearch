...
genere 2026-08-31 13:19 UTC — 252909 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 169565 systemes
...
- moteur actif `0caa9267db60` (209167 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 124664 | 61996 | 8445 | 4175 | 12585 | 9841 | 13161 | 12828 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 122130 | 28501 | 51551 | 54 | 16903 | 6314 | 56 | 18741 | 15.3% |
...
- candidats AVEC connectivite : 12955, dont T2 : 100%
- candidats SANS connectivite : 19051, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13435 systemes avec CONNECTED sur 104229 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*27716 candidats sur 32006 portent les champs bruts (87%).*

- `5c556c16ea8b` — 21751 candidats
  - AVEC connectivite (8827) : resistance **41.0%**
  - SANS connectivite (12924) : resistance **21.4%**
...
- `5c556c16ea8b` — 21751 candidats
  - AVEC connectivite (8827) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (12924) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 13501 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13435 avec CONNECTED, 66 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 101728 systemes
  - sans CONNECTED : 0.0% sur 22936 systemes
