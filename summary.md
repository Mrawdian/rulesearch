...
genere 2026-08-26 14:43 UTC — 49590 systemes evalues
...
- moteur actif `0caa9267db60` (5848 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21966 | 10959 | 1471 | 753 | 2176 | 1738 | 2349 | 2243 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 21509 | 5003 | 9081 | 13 | 2988 | 1106 | 9 | 3309 | 15.4% |
...
- candidats AVEC connectivite : 2370, dont T2 : 100%
- candidats SANS connectivite : 3619, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2623 systemes avec CONNECTED sur 20450 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1699 candidats sur 5989 portent les champs bruts (28%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 584 candidats
  - AVEC connectivite (232) : resistance **41.0%**
  - SANS connectivite (352) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 584 candidats
  - AVEC connectivite (232) : T0=13.38 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (352) : T0=16.07 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 2642 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2623 avec CONNECTED, 19 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17949 systemes
  - sans CONNECTED : 0.0% sur 4017 systemes
