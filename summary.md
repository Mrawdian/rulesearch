...
genere 2026-08-26 07:44 UTC — 31622 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 22648 systemes
...
| ref | 4 | 3 | 14269 | 3375 | 5986 | 9 | 1967 | 727 | 6 | 2199 | 15.4% |
...
- candidats AVEC connectivite : 1512, dont T2 : 100%
- candidats SANS connectivite : 2338, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1722 systemes avec CONNECTED sur 13071 (13.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2685 candidats
  - AVEC connectivite (1033) : T0=13.18 T1=0.00 T2=2.89 — pondere **5.78**
  - SANS connectivite (1652) : T0=15.92 T1=0.01 T2=2.64 — pondere **5.30**
...
- TROP-CHER : 1732 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1722 avec CONNECTED, 10 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
