...
genere 2026-09-04 05:34 UTC — 357062 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 273718 systemes
...
- moteur actif `0caa9267db60` (313320 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 177222 | 88086 | 12052 | 5933 | 18017 | 13951 | 18788 | 18140 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 173725 | 40371 | 73368 | 70 | 24121 | 9007 | 70 | 26704 | 15.4% |
...
- candidats AVEC connectivite : 18267, dont T2 : 100%
- candidats SANS connectivite : 27014, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19062 systemes avec CONNECTED sur 147130 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*40991 candidats sur 45281 portent les champs bruts (91%).*

- `5c556c16ea8b` — 35026 candidats
  - AVEC connectivite (14139) : resistance **41.1%**
  - SANS connectivite (20887) : resistance **21.2%**
...
- `5c556c16ea8b` — 35026 candidats
  - AVEC connectivite (14139) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
  - SANS connectivite (20887) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
## cout
- temps total 110.8 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 19142 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19062 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 144629 systemes
  - sans CONNECTED : 0.0% sur 32593 systemes
