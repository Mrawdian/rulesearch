...
genere 2026-08-26 21:00 UTC — 64078 systemes evalues
...
- moteur actif `0caa9267db60` (20336 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 29291 | 14572 | 1995 | 977 | 2919 | 2321 | 3124 | 3009 | 10.3% |
...
- candidats AVEC connectivite : 3136, dont T2 : 100%
- candidats SANS connectivite : 4715, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3398 systemes avec CONNECTED sur 26458 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3561 candidats sur 7851 portent les champs bruts (45%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 692 candidats
  - AVEC connectivite (292) : resistance **40.1%**
...
- `62448a55927e` — 692 candidats
  - AVEC connectivite (292) : T0=12.83 T1=0.00 T2=2.85 — pondere **5.71**
  - SANS connectivite (400) : T0=16.11 T1=0.00 T2=2.68 — pondere **5.36**
  - test de permutation : **p = 0.1394** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e3baecf8377b` — 657 candidats
...
- TROP-CHER : 3420 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3398 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 23957 systemes
  - sans CONNECTED : 0.0% sur 5334 systemes
