...
genere 2026-09-04 19:05 UTC — 371497 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 288153 systemes
...
- moteur actif `0caa9267db60` (327755 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 184511 | 91675 | 12558 | 6179 | 18756 | 14525 | 19549 | 18900 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 180871 | 42045 | 76419 | 75 | 25144 | 9357 | 70 | 27747 | 15.3% |
...
- candidats AVEC connectivite : 19027, dont T2 : 100%
- candidats SANS connectivite : 28057, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **19823 systemes avec CONNECTED sur 153027 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*42794 candidats sur 47084 portent les champs bruts (91%).*

- `5c556c16ea8b` — 36829 candidats
  - AVEC connectivite (14899) : resistance **41.1%**
  - SANS connectivite (21930) : resistance **21.3%**
...
- `5c556c16ea8b` — 36829 candidats
  - AVEC connectivite (14899) : T0=13.02 T1=0.00 T2=2.97 — pondere **5.95**
  - SANS connectivite (21930) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 19903 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 19823 avec CONNECTED, 80 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 150526 systemes
  - sans CONNECTED : 0.0% sur 33985 systemes
