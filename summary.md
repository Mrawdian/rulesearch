...
genere 2026-08-26 14:17 UTC — 48568 systemes evalues
...
- moteur actif `0caa9267db60` (4826 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21456 | 10703 | 1426 | 740 | 2122 | 1704 | 2296 | 2194 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20997 | 4900 | 8851 | 13 | 2911 | 1085 | 7 | 3230 | 15.4% |
...
- candidats AVEC connectivite : 2321, dont T2 : 100%
- candidats SANS connectivite : 3540, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2570 systemes avec CONNECTED sur 20037 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1571 candidats sur 5861 portent les champs bruts (27%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 456 candidats
  - AVEC connectivite (183) : resistance **40.1%**
  - SANS connectivite (273) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 456 candidats
  - AVEC connectivite (183) : T0=13.42 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (273) : T0=16.13 T1=0.00 T2=2.66 — pondere **5.32**
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0340).
...
- TROP-CHER : 2587 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2570 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17536 systemes
  - sans CONNECTED : 0.0% sur 3920 systemes
