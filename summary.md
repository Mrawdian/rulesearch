...
genere 2026-08-26 04:15 UTC — 22973 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 13999 systemes
...
**7466 enregistrements (32%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 11551 | 5785 | 762 | 398 | 1114 | 927 | 1248 | 1169 | 10.1% |
| ref | 4 | 3 | 11298 | 2689 | 4758 | 6 | 1533 | 573 | 4 | 1735 | 15.4% |
...
- candidats AVEC connectivite : 1172, dont T2 : 100%
- candidats SANS connectivite : 1739, dont T2 : 100%
...
- **1248 systemes avec CONNECTED sur 9517 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1746 candidats
  - AVEC connectivite (693) : T0=13.35 T1=0.00 T2=2.84 — pondere **5.67**
  - SANS connectivite (1053) : T0=15.83 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 1252 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 1248 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 9460 systemes
  - sans CONNECTED : 0.0% sur 2091 systemes
