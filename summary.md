...
| connect | 4 | 3 | 17320 | 8668 | 1117 | 598 | 1715 | 1378 | 1884 | 1742 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 16953 | 3993 | 7172 | 12 | 2318 | 857 | 7 | 2594 | 15.3% |
...
- candidats AVEC connectivite : 1869, dont T2 : 100%
- candidats SANS connectivite : 2904, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2158 systemes avec CONNECTED sur 16651 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*483 candidats sur 4773 portent les champs bruts (10%).*
...
- `e3baecf8377b` — 219 candidats
  - AVEC connectivite (86) : resistance **42.4%**
  - SANS connectivite (133) : resistance **20.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 219 candidats
  - AVEC connectivite (86) : T0=13.23 T1=0.00 T2=3.13 — pondere **6.26**
  - SANS connectivite (133) : T0=16.14 T1=0.00 T2=2.65 — pondere **5.29**
...
**2 serie(s) reproductible(s) sur 4 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0335).
...
- TROP-CHER : 2175 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2158 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 14150 systemes
  - sans CONNECTED : 0.0% sur 3170 systemes
