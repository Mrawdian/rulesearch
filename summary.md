...
**7466 enregistrements (73%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 5124 | 2565 | 324 | 185 | 500 | 419 | 537 | 536 | 10.5% |
| ref | 4 | 3 | 5016 | 1222 | 2101 | 1 | 658 | 240 | 2 | 792 | 15.8% |
...
- candidats AVEC connectivite : 539, dont T2 : 100%
- candidats SANS connectivite : 796, dont T2 : 100%
...
- **537 systemes avec CONNECTED sur 4241 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 170 candidats
  - AVEC connectivite (60) : T0=13.17 T1=0.00 T2=2.88 — pondere **5.77**
  - SANS connectivite (110) : T0=16.16 T1=0.00 T2=2.70 — pondere **5.40**
...
## cout
- temps total 3.1 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 539 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 537 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 4184 systemes
  - sans CONNECTED : 0.0% sur 940 systemes
