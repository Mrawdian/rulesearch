...
genere 2026-08-27 07:04 UTC — 86373 systemes evalues
...
- moteur actif `0caa9267db60` (42631 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 40552 | 20194 | 2773 | 1380 | 4056 | 3193 | 4271 | 4159 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 39706 | 9151 | 16881 | 22 | 5509 | 2073 | 21 | 6049 | 15.2% |
...
- candidats SANS connectivite : 6359, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4545 systemes avec CONNECTED sur 35637 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6355 candidats sur 10645 portent les champs bruts (60%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 390 candidats
  - AVEC connectivite (158) : resistance **42.2%**
  - SANS connectivite (232) : resistance **21.2%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 390 candidats
  ...
  - SANS connectivite (232) : T0=15.86 T1=0.00 T2=2.69 — pondere **5.39**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 33136 systemes
  - sans CONNECTED : 0.0% sur 7416 systemes
