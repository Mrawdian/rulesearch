...
genere 2026-09-01 16:59 UTC — 287982 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 204638 systemes
...
- moteur actif `0caa9267db60` (244240 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 142362 | 70724 | 9659 | 4761 | 14452 | 11231 | 15051 | 14643 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 139505 | 32442 | 59002 | 59 | 19345 | 7221 | 63 | 21362 | 15.3% |
...
- candidats AVEC connectivite : 14770, dont T2 : 100%
- candidats SANS connectivite : 21672, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15325 systemes avec CONNECTED sur 118671 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*32152 candidats sur 36442 portent les champs bruts (88%).*

- `5c556c16ea8b` — 26187 candidats
  - AVEC connectivite (10642) : resistance **41.0%**
  - SANS connectivite (15545) : resistance **21.3%**
...
- `5c556c16ea8b` — 26187 candidats
  - AVEC connectivite (10642) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (15545) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 15398 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 15325 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 116170 systemes
  - sans CONNECTED : 0.0% sur 26192 systemes
