...
genere 2026-08-29 00:36 UTC — 163503 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 80159 systemes
...
- moteur actif `0caa9267db60` (119761 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 79502 | 39545 | 5418 | 2698 | 7947 | 6334 | 8359 | 8192 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 77886 | 18105 | 32961 | 36 | 10762 | 3969 | 31 | 12017 | 15.4% |
...
- candidats AVEC connectivite : 8319, dont T2 : 100%
- candidats SANS connectivite : 12327, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8633 systemes avec CONNECTED sur 67350 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*16356 candidats sur 20646 portent les champs bruts (79%).*

- `5c556c16ea8b` — 10391 candidats
  - AVEC connectivite (4191) : resistance **41.1%**
  - SANS connectivite (6200) : resistance **21.7%**
...
- `5c556c16ea8b` — 10391 candidats
  - AVEC connectivite (4191) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.98**
  - SANS connectivite (6200) : T0=15.89 T1=0.00 T2=2.68 — pondere **5.35**
...
- TROP-CHER : 8674 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8633 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 64849 systemes
  - sans CONNECTED : 0.0% sur 14653 systemes
