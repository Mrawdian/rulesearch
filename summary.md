...
genere 2026-08-26 14:13 UTC — 48464 systemes evalues
...
- moteur actif `0caa9267db60` (4722 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21396 | 10679 | 1424 | 737 | 2114 | 1699 | 2286 | 2186 | 10.2% |
...
- **2560 systemes avec CONNECTED sur 19989 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1551 candidats sur 5841 portent les champs bruts (27%).*
...
**3 serie(s) reproductible(s) sur 6 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `e3baecf8377b` (p=0.0005), `06fe04a859f1` (p=0.0225).
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17488 systemes
