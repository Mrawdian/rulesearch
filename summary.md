...
genere 2026-08-28 22:09 UTC — 159267 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 75923 systemes
...
- moteur actif `0caa9267db60` (115525 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 77362 | 38432 | 5269 | 2634 | 7748 | 6182 | 8147 | 7961 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 75790 | 17626 | 32091 | 35 | 10443 | 3874 | 31 | 11686 | 15.4% |
...
- candidats AVEC connectivite : 8088, dont T2 : 100%
...
- **8421 systemes avec CONNECTED sur 65601 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*15794 candidats sur 20084 portent les champs bruts (79%).*

- `5c556c16ea8b` — 9829 candidats
  - AVEC connectivite (3960) : resistance **41.2%**
...
- `5c556c16ea8b` — 9829 candidats
  - AVEC connectivite (3960) : T0=13.01 T1=0.00 T2=3.00 — pondere **6.01**
...
- TROP-CHER : 8462 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8421 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 63100 systemes
  - sans CONNECTED : 0.0% sur 14262 systemes
