...
**7466 enregistrements (61%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 6159 | 3106 | 395 | 223 | 592 | 494 | 638 | 638 | 10.4% |
| ref | 4 | 3 | 6007 | 1458 | 2503 | 1 | 800 | 296 | 2 | 947 | 15.8% |
...
- candidats AVEC connectivite : 641, dont T2 : 100%
- candidats SANS connectivite : 951, dont T2 : 100%
...
- **638 systemes avec CONNECTED sur 5106 (12.5%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 427 candidats
  - AVEC connectivite (162) : T0=13.22 T1=0.00 T2=2.95 — pondere **5.90**
  - SANS connectivite (265) : T0=15.95 T1=0.00 T2=2.62 — pondere **5.25**
...
- TROP-CHER : 640 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 638 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.6% sur 5049 systemes
  - sans CONNECTED : 0.0% sur 1110 systemes
