...
genere 2026-08-25 22:54 UTC — 9389 systemes evalues
...
**7466 enregistrements (80%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 4692 | 2365 | 289 | 166 | 453 | 379 | 494 | 492 | 10.5% |
| ref | 4 | 3 | 4573 | 1116 | 1920 | 1 | 601 | 217 | 2 | 716 | 15.7% |
...
- candidats AVEC connectivite : 495, dont T2 : 100%
- candidats SANS connectivite : 720, dont T2 : 100%
...
- **494 systemes avec CONNECTED sur 3908 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 50 candidats
  - AVEC connectivite (16) : T0=12.31 T1=0.00 T2=3.12 — pondere **6.25**
  - SANS connectivite (34) : T0=15.91 T1=0.00 T2=3.00 — pondere **6.00**
...
## cout
- temps total 2.9 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 496 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 494 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 3851 systemes
  - sans CONNECTED : 0.0% sur 841 systemes
