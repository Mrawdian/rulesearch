...
genere 2026-09-02 16:48 UTC — 315960 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 232616 systemes
...
- moteur actif `0caa9267db60` (272218 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 156484 | 77758 | 10650 | 5236 | 15908 | 12302 | 16583 | 16040 | 10.3% |
...
- candidats AVEC connectivite : 16167, dont T2 : 100%
...
- **16857 systemes avec CONNECTED sur 130235 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*35684 candidats sur 39974 portent les champs bruts (89%).*

- `5c556c16ea8b` — 29719 candidats
  - AVEC connectivite (12039) : resistance **41.0%**
...
- `5c556c16ea8b` — 29719 candidats
  - AVEC connectivite (12039) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.95**
...
- TROP-CHER : 16930 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 16857 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 127734 systemes
  - sans CONNECTED : 0.0% sur 28750 systemes
