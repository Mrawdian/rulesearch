...
genere 2026-08-30 07:12 UTC — 210924 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 127580 systemes
...
- moteur actif `0caa9267db60` (167182 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 103464 | 51371 | 7042 | 3455 | 10451 | 8242 | 10927 | 10630 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 101345 | 23630 | 42799 | 47 | 13988 | 5240 | 40 | 15593 | 15.4% |
...
- candidats SANS connectivite : 15903, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11201 systemes avec CONNECTED sur 86879 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*22370 candidats sur 26660 portent les champs bruts (84%).*

- `5c556c16ea8b` — 16405 candidats
  - AVEC connectivite (6629) : resistance **41.1%**
  - SANS connectivite (9776) : resistance **21.5%**
...
- `5c556c16ea8b` — 16405 candidats
  ...
  - SANS connectivite (9776) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 11251 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 11201 avec CONNECTED, 50 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 84378 systemes
  - sans CONNECTED : 0.0% sur 19086 systemes
