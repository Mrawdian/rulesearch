...
genere 2026-08-31 12:19 UTC — 251562 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 168218 systemes
...
- moteur actif `0caa9267db60` (207820 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 123977 | 61656 | 8410 | 4152 | 12494 | 9785 | 13091 | 12767 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 121470 | 28334 | 51278 | 54 | 16812 | 6289 | 56 | 18637 | 15.3% |
...
- candidats SANS connectivite : 18947, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13365 systemes avec CONNECTED sur 103685 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*27551 candidats sur 31841 portent les champs bruts (87%).*

- `5c556c16ea8b` — 21586 candidats
  - AVEC connectivite (8766) : resistance **40.9%**
  - SANS connectivite (12820) : resistance **21.4%**
...
- `5c556c16ea8b` — 21586 candidats
  ...
  - SANS connectivite (12820) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 101184 systemes
