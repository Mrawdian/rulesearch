...
genere 2026-08-26 21:58 UTC — 66286 systemes evalues
...
- moteur actif `0caa9267db60` (22544 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 30413 | 15112 | 2080 | 1023 | 3038 | 2416 | 3237 | 3123 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 29758 | 6858 | 12649 | 16 | 4112 | 1537 | 13 | 4573 | 15.4% |
...
- candidats AVEC connectivite : 3250, dont T2 : 100%
- candidats SANS connectivite : 4883, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3511 systemes avec CONNECTED sur 27364 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3843 candidats sur 8133 portent les champs bruts (47%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 166 candidats
  - AVEC connectivite (70) : resistance **44.9%**
  - SANS connectivite (96) : resistance **23.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 166 candidats
  - AVEC connectivite (70) : T0=13.10 T1=0.00 T2=3.13 — pondere **6.26**
  - SANS connectivite (96) : T0=15.93 T1=0.00 T2=2.89 — pondere **5.77**
  - test de permutation : **p = 0.3383** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 3534 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3511 avec CONNECTED, 23 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24863 systemes
  - sans CONNECTED : 0.0% sur 5550 systemes
