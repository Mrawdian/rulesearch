...
genere 2026-08-26 21:29 UTC — 65129 systemes evalues
...
- `ab89a63b01ef` : 222 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (21387 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
**7748 enregistrements (12%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| ref | 4 | 3 | 29184 | 6730 | 12386 | 16 | 4043 | 1506 | 12 | 4491 | 15.4% |
...
- candidats SANS connectivite : 4801, dont T2 : 100%
...
*3701 candidats sur 7991 portent les champs bruts (46%).*
...
- `b71bb0907fb5` — 53 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 24 candidats (**NON REPRODUCTIBLE**)
...
- `ab89a63b01ef` — 24 candidats
  - AVEC connectivite (10) : T0=14.10 T1=0.00 T2=3.70 — pondere **7.40**
  - SANS connectivite (14) : T0=15.71 T1=0.00 T2=3.07 — pondere **6.14**
  - *groupes trop petits (< 20) — aucun test, aucune conclusion*
- `e8a1f930f7b9` — 28 candidats
