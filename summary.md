...
genere 2026-08-26 14:38 UTC — 49428 systemes evalues
...
- moteur actif `0caa9267db60` (5686 systemes) : `06fe04a859f1`, `e40600351a72`
...
| ref | 4 | 3 | 21422 | 4978 | 9047 | 13 | 2972 | 1104 | 8 | 3300 | 15.4% |
...
- candidats SANS connectivite : 3610, dont T2 : 100%
...
*1684 candidats sur 5974 portent les champs bruts (28%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 569 candidats
  - AVEC connectivite (226) : resistance **40.7%**
  - SANS connectivite (343) : resistance **20.8%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 569 candidats
  ...
  - SANS connectivite (343) : T0=16.06 T1=0.00 T2=2.64 — pondere **5.28**
...
- TROP-CHER : 2629 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2611 avec CONNECTED, 18 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
