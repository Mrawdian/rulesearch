...
genere 2026-08-30 05:45 UTC — 208941 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 125597 systemes
...
- moteur actif `0caa9267db60` (165199 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 102453 | 50871 | 6975 | 3430 | 10345 | 8171 | 10803 | 10523 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 100373 | 23365 | 42415 | 45 | 13862 | 5184 | 39 | 15456 | 15.4% |
...
- candidats SANS connectivite : 15766, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **11077 systemes avec CONNECTED sur 86057 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*22126 candidats sur 26416 portent les champs bruts (84%).*

- `5c556c16ea8b` — 16161 candidats
  - AVEC connectivite (6522) : resistance **41.1%**
  - SANS connectivite (9639) : resistance **21.5%**
...
- `5c556c16ea8b` — 16161 candidats
  ...
  - SANS connectivite (9639) : T0=15.88 T1=0.00 T2=2.66 — pondere **5.32**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 83556 systemes
  - sans CONNECTED : 0.0% sur 18897 systemes
