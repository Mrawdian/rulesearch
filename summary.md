...
genere 2026-08-26 17:54 UTC — 57037 systemes evalues
...
- `0a74109317e5` : 150 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (13295 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `84fba70921e0`, `b71bb0907fb5`, `e40600351a72`, `e8a1f930f7b9`
...
**7616 enregistrements (13%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 25729 | 12820 | 1756 | 869 | 2551 | 2033 | 2749 | 2633 | 10.2% |
...
- candidats AVEC connectivite : 2760, dont T2 : 100%
- candidats SANS connectivite : 4207, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3023 systemes avec CONNECTED sur 23533 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2677 candidats sur 6967 portent les champs bruts (38%).*
...
- `84fba70921e0` — 33 candidats
  ...
  - *groupes trop petits (< 20) — aucun test*
- `0a74109317e5` — 28 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (11) : resistance **37.6%**
...
- `84fba70921e0` — 33 candidats
  ...
  - *groupes trop petits (< 20) — aucun test, aucune conclusion*
- `0a74109317e5` — 28 candidats
  - AVEC connectivite (11) : T0=14.18 T1=0.00 T2=3.00 — pondere **6.00**
...
- TROP-CHER : 3043 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3023 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 21032 systemes
  - sans CONNECTED : 0.0% sur 4697 systemes
