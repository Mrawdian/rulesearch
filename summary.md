...
genere 2026-08-26 20:46 UTC — 63591 systemes evalues
...
- moteur actif `0caa9267db60` (19849 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 28425 | 6559 | 12061 | 16 | 3945 | 1466 | 12 | 4366 | 15.4% |
...
- candidats SANS connectivite : 4676, dont T2 : 100%
...
*3500 candidats sur 7790 portent les champs bruts (45%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 631 candidats
  - AVEC connectivite (270) : resistance **40.0%**
  - SANS connectivite (361) : resistance **20.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 631 candidats
  ...
  - SANS connectivite (361) : T0=16.11 T1=0.00 T2=2.66 — pondere **5.32**
  - test de permutation : **p = 0.1419** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
