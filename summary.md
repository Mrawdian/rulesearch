...
| connect | 4 | 3 | 6308 | 3179 | 408 | 228 | 606 | 504 | 652 | 658 | 10.4% |
...
- candidats AVEC connectivite : 661, dont T2 : 100%
...
- **652 systemes avec CONNECTED sur 5229 (12.5%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 470 candidats
  - AVEC connectivite (182) : T0=13.24 T1=0.00 T2=2.90 — pondere **5.79**
...
- TROP-CHER : 654 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 652 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.6% sur 5172 systemes
  - sans CONNECTED : 0.0% sur 1136 systemes
