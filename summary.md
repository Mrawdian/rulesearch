...
genere 2026-09-02 19:42 UTC — 319276 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 235932 systemes
...
- moteur actif `0caa9267db60` (275534 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 158157 | 78584 | 10771 | 5282 | 16085 | 12435 | 16764 | 16212 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 155004 | 36127 | 65558 | 64 | 21411 | 8003 | 63 | 23766 | 15.3% |
...
- candidats SANS connectivite : 24076, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **17038 systemes avec CONNECTED sur 131604 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*36125 candidats sur 40415 portent les champs bruts (89%).*

- `5c556c16ea8b` — 30160 candidats
  - AVEC connectivite (12211) : resistance **41.0%**
  - SANS connectivite (17949) : resistance **21.2%**
...
- `5c556c16ea8b` — 30160 candidats
  ...
  - SANS connectivite (17949) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.29**
...
- TROP-CHER : 17111 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 17038 avec CONNECTED, 73 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 129103 systemes
  - sans CONNECTED : 0.0% sur 29054 systemes
