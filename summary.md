...
genere 2026-08-26 19:53 UTC — 61632 systemes evalues
...
- moteur actif `0caa9267db60` (17890 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 28063 | 13979 | 1919 | 947 | 2779 | 2219 | 2988 | 2881 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 27454 | 6342 | 11625 | 15 | 3817 | 1414 | 12 | 4229 | 15.4% |
...
- candidats AVEC connectivite : 3008, dont T2 : 100%
- candidats SANS connectivite : 4539, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3262 systemes avec CONNECTED sur 25470 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3257 candidats sur 7547 portent les champs bruts (43%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 388 candidats
  - AVEC connectivite (164) : resistance **39.4%**
  - SANS connectivite (224) : resistance **19.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 388 candidats
  - AVEC connectivite (164) : T0=13.01 T1=0.00 T2=2.87 — pondere **5.74**
  - SANS connectivite (224) : T0=16.05 T1=0.00 T2=2.58 — pondere **5.15**
...
- TROP-CHER : 3284 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3262 avec CONNECTED, 22 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22969 systemes
  - sans CONNECTED : 0.0% sur 5094 systemes
