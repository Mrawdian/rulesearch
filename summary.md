...
genere 2026-08-28 04:37 UTC — 128739 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 45395 systemes
...
- moteur actif `0caa9267db60` (84997 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 61946 | 30816 | 4273 | 2095 | 6181 | 4916 | 6504 | 6363 | 10.3% |
...
- candidats AVEC connectivite : 6490, dont T2 : 100%
- candidats SANS connectivite : 9617, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6778 systemes avec CONNECTED sur 53048 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*11817 candidats sur 16107 portent les champs bruts (73%).*

- `5c556c16ea8b` — 5852 candidats
  - AVEC connectivite (2362) : resistance **41.7%**
...
- `5c556c16ea8b` — 5852 candidats
  - AVEC connectivite (2362) : T0=12.98 T1=0.00 T2=3.04 — pondere **6.07**
...
- TROP-CHER : 6815 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6778 avec CONNECTED, 37 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 50547 systemes
  - sans CONNECTED : 0.0% sur 11399 systemes
