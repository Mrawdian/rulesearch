...
genere 2026-09-01 11:43 UTC — 281573 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 198229 systemes
...
- moteur actif `0caa9267db60` (237831 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 139124 | 69147 | 9419 | 4651 | 14136 | 10961 | 14697 | 14313 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 136334 | 31737 | 57634 | 59 | 18907 | 7057 | 61 | 20868 | 15.3% |
...
- candidats SANS connectivite : 21178, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14971 systemes avec CONNECTED sur 116027 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*31328 candidats sur 35618 portent les champs bruts (88%).*

- `5c556c16ea8b` — 25363 candidats
  - AVEC connectivite (10312) : resistance **41.0%**
  - SANS connectivite (15051) : resistance **21.4%**
...
- `5c556c16ea8b` — 25363 candidats
  ...
  - SANS connectivite (15051) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 113526 systemes
  - sans CONNECTED : 0.0% sur 25598 systemes
