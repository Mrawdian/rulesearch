...
genere 2026-08-27 00:50 UTC — 72507 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 9167 systemes
- `ab89a63b01ef` : 7600 systemes
...
- moteur actif `0caa9267db60` (28765 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 32839 | 7567 | 13942 | 18 | 4565 | 1717 | 16 | 5014 | 15.3% |
...
- candidats SANS connectivite : 5324, dont T2 : 100%
...
*4587 candidats sur 8877 portent les champs bruts (52%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 910 candidats
  - AVEC connectivite (373) : resistance **41.1%**
  - SANS connectivite (537) : resistance **21.6%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 910 candidats
  ...
  - SANS connectivite (537) : T0=15.91 T1=0.00 T2=2.62 — pondere **5.24**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
