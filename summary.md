...
genere 2026-08-26 17:14 UTC — 55505 systemes evalues
...
- moteur actif `0caa9267db60` (11763 systemes) : `06fe04a859f1`, `23303c299f39`, `e40600351a72`
...
| connect | 4 | 3 | 24953 | 12460 | 1698 | 843 | 2469 | 1969 | 2664 | 2539 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 24437 | 5650 | 10337 | 14 | 3416 | 1242 | 10 | 3768 | 15.4% |
...
- candidats SANS connectivite : 4078, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2938 systemes avec CONNECTED sur 22899 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2454 candidats sur 6744 portent les champs bruts (36%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `23303c299f39` — 144 candidats
  - AVEC connectivite (52) : resistance **41.5%**
  - SANS connectivite (92) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `23303c299f39` — 144 candidats
  ...
  - SANS connectivite (92) : T0=16.33 T1=0.00 T2=2.72 — pondere **5.43**
  - test de permutation : **p = 0.3728** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 20398 systemes
  - sans CONNECTED : 0.0% sur 4555 systemes
