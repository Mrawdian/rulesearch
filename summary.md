...
genere 2026-08-26 05:46 UTC — 26681 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 17707 systemes
...
| connect | 4 | 3 | 13326 | 6665 | 876 | 465 | 1304 | 1060 | 1448 | 1340 | 10.1% |
...
- candidats AVEC connectivite : 1346, dont T2 : 100%
- candidats SANS connectivite : 2019, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **1455 systemes avec CONNECTED sur 11041 (13.2%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 2200 candidats
  - AVEC connectivite (867) : T0=13.25 T1=0.00 T2=2.87 — pondere **5.74**
...
- TROP-CHER : 1460 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1455 avec CONNECTED, 5 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.3% sur 10914 systemes
  - sans CONNECTED : 0.0% sur 2412 systemes
