...
genere 2026-09-08 23:58 UTC — 467765 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 384421 systemes
...
- moteur actif `0caa9267db60` (424023 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 233141 | 115797 | 15878 | 7804 | 23598 | 18261 | 24842 | 24004 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 228509 | 53222 | 96281 | 92 | 31842 | 11798 | 82 | 35173 | 15.4% |
...
- candidats AVEC connectivite : 24131, dont T2 : 100%
- candidats SANS connectivite : 35483, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25116 systemes avec CONNECTED sur 192861 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*55324 candidats sur 59614 portent les champs bruts (93%).*

- `5c556c16ea8b` — 49359 candidats
  - AVEC connectivite (20003) : resistance **41.2%**
  - SANS connectivite (29356) : resistance **21.3%**
...
- `5c556c16ea8b` — 49359 candidats
  - AVEC connectivite (20003) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (29356) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 25208 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 25116 avec CONNECTED, 92 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 190360 systemes
  - sans CONNECTED : 0.0% sur 42781 systemes
