...
genere 2026-09-09 05:51 UTC — 473104 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 389760 systemes
...
- moteur actif `0caa9267db60` (429362 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 235845 | 117130 | 16076 | 7902 | 23855 | 18473 | 25106 | 24305 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 231144 | 53841 | 97386 | 92 | 32193 | 11944 | 83 | 35586 | 15.4% |
...
- candidats SANS connectivite : 35896, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **25380 systemes avec CONNECTED sur 195078 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*56038 candidats sur 60328 portent les champs bruts (93%).*

- `5c556c16ea8b` — 50073 candidats
  - AVEC connectivite (20304) : resistance **41.2%**
  - SANS connectivite (29769) : resistance **21.3%**
...
- `5c556c16ea8b` — 50073 candidats
  ...
  - SANS connectivite (29769) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 192577 systemes
  - sans CONNECTED : 0.0% sur 43268 systemes
