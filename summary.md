...
genere 2026-08-25 20:54 UTC — 4293 systemes evalues

## versions du DSL presentes
- `615abe43d6bc` : 3316 systemes
...
| connect | 4 | 3 | 2120 | 1068 | 146 | 70 | 217 | 165 | 204 | 226 | 10.7% |
...
- **204 systemes avec CONNECTED sur 1787 (11.4%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- TROP-CHER : 205 systemes abandonnes (4.8% des systemes), 95% du temps total
  dont 204 avec CONNECTED, 1 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 11.8% sur 1730 systemes
  - sans CONNECTED : 0.0% sur 390 systemes
