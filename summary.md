...
| connect | 4 | 3 | 5004 | 2507 | 315 | 177 | 487 | 408 | 523 | 529 | 10.6% |
...
- candidats AVEC connectivite : 532, dont T2 : 100%
...
- **523 systemes avec CONNECTED sur 4149 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 138 candidats
  - AVEC connectivite (53) : T0=12.81 T1=0.00 T2=2.92 — pondere **5.85**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 4092 systemes
  - sans CONNECTED : 0.0% sur 912 systemes
