...
genere 2026-08-26 04:00 UTC — 22378 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 13404 systemes
...
| connect | 4 | 3 | 11251 | 5645 | 741 | 387 | 1085 | 904 | 1213 | 1134 | 10.1% |
| ref | 4 | 3 | 11003 | 2619 | 4642 | 6 | 1479 | 563 | 4 | 1690 | 15.4% |
...
- candidats AVEC connectivite : 1137, dont T2 : 100%
- candidats SANS connectivite : 1694, dont T2 : 100%
...
- **1213 systemes avec CONNECTED sur 9273 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1666 candidats
  - AVEC connectivite (658) : T0=13.33 T1=0.00 T2=2.85 — pondere **5.69**
  - SANS connectivite (1008) : T0=15.83 T1=0.00 T2=2.66 — pondere **5.31**
...
## cout
- temps total 7.0 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 1217 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 1213 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 9216 systemes
  - sans CONNECTED : 0.0% sur 2035 systemes
