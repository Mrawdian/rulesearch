...
genere 2026-08-26 19:33 UTC — 61012 systemes evalues
...
- moteur actif `0caa9267db60` (17270 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27750 | 13837 | 1895 | 933 | 2742 | 2202 | 2946 | 2846 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 27147 | 6288 | 11475 | 15 | 3779 | 1400 | 11 | 4179 | 15.4% |
...
- candidats AVEC connectivite : 2973, dont T2 : 100%
- candidats SANS connectivite : 4489, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3220 systemes avec CONNECTED sur 25207 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3172 candidats sur 7462 portent les champs bruts (43%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 303 candidats
  - AVEC connectivite (129) : resistance **39.7%**
  - SANS connectivite (174) : resistance **18.4%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 303 candidats
  - AVEC connectivite (129) : T0=13.09 T1=0.00 T2=2.92 — pondere **5.84**
  - SANS connectivite (174) : T0=16.14 T1=0.00 T2=2.56 — pondere **5.13**
  - test de permutation : **p = 0.0490** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `23303c299f39` — 225 candidats
...
**6 serie(s) reproductible(s) sur 12 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `62448a55927e` (p=0.0490), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22706 systemes
  - sans CONNECTED : 0.0% sur 5044 systemes
