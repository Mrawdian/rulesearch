...
genere 2026-08-27 22:07 UTC — 116223 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 32879 systemes
...
- moteur actif `0caa9267db60` (72481 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 55620 | 27708 | 3845 | 1890 | 5501 | 4405 | 5876 | 5677 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 54488 | 12569 | 23138 | 26 | 7558 | 2822 | 25 | 8348 | 15.3% |
...
- candidats AVEC connectivite : 5804, dont T2 : 100%
- candidats SANS connectivite : 8658, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **6150 systemes avec CONNECTED sur 47940 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*10172 candidats sur 14462 portent les champs bruts (70%).*

- `5c556c16ea8b` — 4207 candidats
  - AVEC connectivite (1676) : resistance **42.0%**
  - SANS connectivite (2531) : resistance **22.5%**
...
- `5c556c16ea8b` — 4207 candidats
  - AVEC connectivite (1676) : T0=12.93 T1=0.00 T2=3.05 — pondere **6.10**
  - SANS connectivite (2531) : T0=15.80 T1=0.00 T2=2.72 — pondere **5.44**
...
## cout
- temps total 35.9 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 6185 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 6150 avec CONNECTED, 35 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 45439 systemes
  - sans CONNECTED : 0.0% sur 10181 systemes
