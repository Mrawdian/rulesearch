...
genere 2026-08-29 06:12 UTC — 172796 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 89452 systemes
...
- moteur actif `0caa9267db60` (129054 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 84185 | 41918 | 5715 | 2839 | 8449 | 6680 | 8841 | 8677 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 82496 | 19227 | 34888 | 39 | 11402 | 4198 | 34 | 12703 | 15.4% |
...
- candidats AVEC connectivite : 8804, dont T2 : 100%
- candidats SANS connectivite : 13013, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9115 systemes avec CONNECTED sur 71215 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*17527 candidats sur 21817 portent les champs bruts (80%).*

- `5c556c16ea8b` — 11562 candidats
  - AVEC connectivite (4676) : resistance **41.2%**
  - SANS connectivite (6886) : resistance **21.6%**
...
- `5c556c16ea8b` — 11562 candidats
  - AVEC connectivite (4676) : T0=13.01 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (6886) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.33**
...
## cout
- temps total 53.1 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 9159 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 9115 avec CONNECTED, 44 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 68714 systemes
  - sans CONNECTED : 0.0% sur 15471 systemes
