...
genere 2026-08-31 18:46 UTC — 260197 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 176853 systemes
...
- moteur actif `0caa9267db60` (216455 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 128341 | 63801 | 8681 | 4305 | 12980 | 10152 | 13526 | 13217 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 125741 | 29299 | 53089 | 56 | 17418 | 6503 | 56 | 19310 | 15.4% |
...
- candidats AVEC connectivite : 13344, dont T2 : 100%
...
- **13800 systemes avec CONNECTED sur 107212 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*28674 candidats sur 32964 portent les champs bruts (87%).*

- `5c556c16ea8b` — 22709 candidats
  - AVEC connectivite (9216) : resistance **41.0%**
...
- `5c556c16ea8b` — 22709 candidats
  - AVEC connectivite (9216) : T0=13.02 T1=0.00 T2=2.99 — pondere **5.98**
...
- TROP-CHER : 13866 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 13800 avec CONNECTED, 66 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 104711 systemes
  - sans CONNECTED : 0.0% sur 23630 systemes
