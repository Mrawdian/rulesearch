...
genere 2026-08-26 16:14 UTC — 53163 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 7980 systemes
...
- moteur actif `0caa9267db60` (9421 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23774 | 11863 | 1614 | 810 | 2363 | 1877 | 2541 | 2408 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 23274 | 5391 | 9828 | 14 | 3254 | 1188 | 10 | 3589 | 15.4% |
...
- candidats AVEC connectivite : 2535, dont T2 : 100%
- candidats SANS connectivite : 3899, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2815 systemes avec CONNECTED sur 21917 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2144 candidats sur 6434 portent les champs bruts (33%).*
...
- `06fe04a859f1` — 1029 candidats
  - AVEC connectivite (397) : resistance **41.1%**
  - SANS connectivite (632) : resistance **21.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1029 candidats
  - AVEC connectivite (397) : T0=13.20 T1=0.00 T2=3.04 — pondere **6.08**
  - SANS connectivite (632) : T0=15.98 T1=0.00 T2=2.63 — pondere **5.27**
...
## cout
- temps total 16.5 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 2835 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2815 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19416 systemes
  - sans CONNECTED : 0.0% sur 4358 systemes
