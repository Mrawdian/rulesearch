...
genere 2026-08-29 03:24 UTC — 168159 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 84815 systemes
...
- moteur actif `0caa9267db60` (124417 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 81852 | 40745 | 5560 | 2775 | 8219 | 6496 | 8599 | 8415 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 80192 | 18658 | 33940 | 36 | 11106 | 4074 | 34 | 12339 | 15.4% |
...
- candidats AVEC connectivite : 8542, dont T2 : 100%
- candidats SANS connectivite : 12649, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8873 systemes avec CONNECTED sur 69281 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*16901 candidats sur 21191 portent les champs bruts (80%).*

- `5c556c16ea8b` — 10936 candidats
  - AVEC connectivite (4414) : resistance **41.2%**
  - SANS connectivite (6522) : resistance **21.7%**
...
- `5c556c16ea8b` — 10936 candidats
  - AVEC connectivite (4414) : T0=13.02 T1=0.00 T2=3.00 — pondere **6.00**
  - SANS connectivite (6522) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.34**
...
- TROP-CHER : 8917 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8873 avec CONNECTED, 44 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 66780 systemes
  - sans CONNECTED : 0.0% sur 15072 systemes
