...
genere 2026-08-26 02:11 UTC — 17630 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 8656 systemes
...
**7466 enregistrements (42%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 8849 | 4452 | 577 | 296 | 843 | 703 | 959 | 911 | 10.3% |
| ref | 4 | 3 | 8657 | 2086 | 3639 | 2 | 1157 | 425 | 3 | 1345 | 15.5% |
...
- candidats AVEC connectivite : 914, dont T2 : 100%
- candidats SANS connectivite : 1349, dont T2 : 100%
...
- **959 systemes avec CONNECTED sur 7335 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1098 candidats
  - AVEC connectivite (435) : T0=13.32 T1=0.00 T2=2.88 — pondere **5.76**
  - SANS connectivite (663) : T0=15.90 T1=0.00 T2=2.67 — pondere **5.35**
  - test de permutation : **p = 0.0355** — ecart significatif au seuil 0.05
...
## cout
- temps total 5.6 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 962 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 959 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 7278 systemes
  - sans CONNECTED : 0.0% sur 1571 systemes
