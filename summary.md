...
genere 2026-08-27 17:03 UTC — 106501 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 23157 systemes
...
- moteur actif `0caa9267db60` (62759 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 50707 | 25251 | 3505 | 1737 | 5027 | 4017 | 5352 | 5162 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 49679 | 11487 | 21076 | 25 | 6862 | 2598 | 23 | 7606 | 15.3% |
...
- candidats SANS connectivite : 7916, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5626 systemes avec CONNECTED sur 43918 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*8915 candidats sur 13205 portent les champs bruts (68%).*
...
- `5c556c16ea8b` — 2950 candidats
  - AVEC connectivite (1161) : resistance **41.9%**
  - SANS connectivite (1789) : resistance **22.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 2950 candidats
  ...
  - SANS connectivite (1789) : T0=15.78 T1=0.00 T2=2.69 — pondere **5.39**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 2280 candidats
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 41417 systemes
  - sans CONNECTED : 0.0% sur 9290 systemes
