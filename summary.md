...
genere 2026-09-03 01:07 UTC — 325540 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 242196 systemes
...
- moteur actif `0caa9267db60` (281798 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 161310 | 80136 | 10958 | 5386 | 16433 | 12717 | 17089 | 16527 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 158115 | 36853 | 66817 | 64 | 21876 | 8170 | 65 | 24258 | 15.3% |
...
- candidats AVEC connectivite : 16654, dont T2 : 100%
...
- **17363 systemes avec CONNECTED sur 134101 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*36932 candidats sur 41222 portent les champs bruts (90%).*

- `5c556c16ea8b` — 30967 candidats
  - AVEC connectivite (12526) : resistance **41.1%**
...
- `5c556c16ea8b` — 30967 candidats
  - AVEC connectivite (12526) : T0=13.03 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 17438 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 17363 avec CONNECTED, 75 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 131600 systemes
  - sans CONNECTED : 0.0% sur 29710 systemes
