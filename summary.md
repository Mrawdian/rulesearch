...
genere 2026-08-26 03:40 UTC — 21474 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 12500 systemes
...
| connect | 4 | 3 | 10789 | 5424 | 711 | 372 | 1034 | 860 | 1165 | 1085 | 10.1% |
| ref | 4 | 3 | 10561 | 2533 | 4442 | 5 | 1421 | 538 | 4 | 1618 | 15.3% |
...
- candidats AVEC connectivite : 1088, dont T2 : 100%
- candidats SANS connectivite : 1622, dont T2 : 100%
...
- **1165 systemes avec CONNECTED sur 8904 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1545 candidats
  - AVEC connectivite (609) : T0=13.36 T1=0.00 T2=2.86 — pondere **5.72**
  - SANS connectivite (936) : T0=15.80 T1=0.00 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 1169 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 1165 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 8847 systemes
  - sans CONNECTED : 0.0% sur 1942 systemes
