...
genere 2026-08-27 00:34 UTC — 71946 systemes evalues
...
- moteur actif `0caa9267db60` (28204 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 32562 | 7508 | 13822 | 18 | 4521 | 1706 | 16 | 4971 | 15.3% |
...
- candidats SANS connectivite : 5281, dont T2 : 100%
...
*4519 candidats sur 8809 portent les champs bruts (51%).*
...
- `06fe04a859f1` — 1195 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 842 candidats
  - AVEC connectivite (348) : resistance **41.3%**
  - SANS connectivite (494) : resistance **21.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 842 candidats
  ...
  - SANS connectivite (494) : T0=15.94 T1=0.00 T2=2.60 — pondere **5.19**
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 798 candidats
...
- TROP-CHER : 3849 systemes abandonnes (5.3% des systemes), 96% du temps total
