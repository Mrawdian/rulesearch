...
genere 2026-08-26 12:52 UTC — 45054 systemes evalues
...
| connect | 4 | 3 | 19681 | 9821 | 1282 | 683 | 1970 | 1559 | 2116 | 2006 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 19258 | 4520 | 8126 | 13 | 2648 | 993 | 7 | 2951 | 15.3% |
...
- candidats AVEC connectivite : 2133, dont T2 : 100%
- candidats SANS connectivite : 3261, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2390 systemes avec CONNECTED sur 18573 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1104 candidats sur 5394 portent les champs bruts (20%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `e40600351a72` — 183 candidats
  - AVEC connectivite (82) : resistance **39.9%**
  - SANS connectivite (101) : resistance **20.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e40600351a72` — 183 candidats
  - AVEC connectivite (82) : T0=12.88 T1=0.00 T2=2.90 — pondere **5.80**
  - SANS connectivite (101) : T0=16.60 T1=0.00 T2=2.60 — pondere **5.21**
...
- TROP-CHER : 2407 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2390 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 16072 systemes
  - sans CONNECTED : 0.0% sur 3609 systemes
