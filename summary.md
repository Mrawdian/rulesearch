...
genere 2026-08-26 21:29 UTC — 65159 systemes evalues
...
- `ab89a63b01ef` : 252 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
- moteur actif `0caa9267db60` (21417 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
**7778 enregistrements (12%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| ref | 4 | 3 | 29199 | 6733 | 12396 | 16 | 4044 | 1506 | 12 | 4492 | 15.4% |
...
- candidats SANS connectivite : 4802, dont T2 : 100%
...
*3702 candidats sur 7992 portent les champs bruts (46%).*
...
- `b71bb0907fb5` — 53 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 25 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (10) : resistance **54.4%**
  - SANS connectivite (15) : resistance **22.4%**
...
- `ab89a63b01ef` — 25 candidats
  - AVEC connectivite (10) : T0=14.10 T1=0.00 T2=3.70 — pondere **7.40**
  - SANS connectivite (15) : T0=15.87 T1=0.00 T2=3.07 — pondere **6.13**
  - *groupes trop petits (< 20) — aucun test, aucune conclusion*
- `e8a1f930f7b9` — 28 candidats
