...
genere 2026-08-26 01:44 UTC — 16697 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 7723 systemes
...
| connect | 4 | 3 | 8386 | 4223 | 547 | 284 | 796 | 674 | 893 | 868 | 10.4% |
| ref | 4 | 3 | 8187 | 1977 | 3436 | 2 | 1094 | 401 | 3 | 1274 | 15.6% |
...
- candidats AVEC connectivite : 871, dont T2 : 100%
- candidats SANS connectivite : 1278, dont T2 : 100%
...
- **893 systemes avec CONNECTED sur 6941 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 984 candidats
  - AVEC connectivite (392) : T0=13.38 T1=0.00 T2=2.85 — pondere **5.71**
  - SANS connectivite (592) : T0=15.93 T1=0.00 T2=2.66 — pondere **5.32**
  - test de permutation : **p = 0.0550** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 896 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 893 avec CONNECTED, 3 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 6884 systemes
  - sans CONNECTED : 0.0% sur 1502 systemes
