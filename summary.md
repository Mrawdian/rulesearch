...
genere 2026-09-09 21:42 UTC — 486652 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 403308 systemes
...
- moteur actif `0caa9267db60` (442910 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 242684 | 120509 | 16550 | 8126 | 24553 | 19022 | 25862 | 24985 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 237853 | 55447 | 100206 | 95 | 33121 | 12290 | 87 | 36586 | 15.4% |
...
- candidats AVEC connectivite : 25112, dont T2 : 100%
- candidats SANS connectivite : 36896, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **26136 systemes avec CONNECTED sur 200647 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*57718 candidats sur 62008 portent les champs bruts (93%).*

- `5c556c16ea8b` — 51753 candidats
  - AVEC connectivite (20984) : resistance **41.2%**
  - SANS connectivite (30769) : resistance **21.3%**
...
- `5c556c16ea8b` — 51753 candidats
  - AVEC connectivite (20984) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (30769) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 26233 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 26136 avec CONNECTED, 97 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 198146 systemes
  - sans CONNECTED : 0.0% sur 44538 systemes
