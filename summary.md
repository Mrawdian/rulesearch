...
genere 2026-08-29 12:46 UTC — 183377 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 100033 systemes
...
- moteur actif `0caa9267db60` (139635 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 89534 | 44531 | 6085 | 3028 | 9002 | 7145 | 9393 | 9211 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 87728 | 20516 | 37024 | 43 | 12100 | 4502 | 35 | 13502 | 15.4% |
...
- candidats AVEC connectivite : 9338, dont T2 : 100%
- candidats SANS connectivite : 13812, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9667 systemes avec CONNECTED sur 75538 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*18860 candidats sur 23150 portent les champs bruts (81%).*

- `5c556c16ea8b` — 12895 candidats
  - AVEC connectivite (5210) : resistance **41.2%**
  - SANS connectivite (7685) : resistance **21.5%**
...
- `5c556c16ea8b` — 12895 candidats
  - AVEC connectivite (5210) : T0=13.00 T1=0.00 T2=2.99 — pondere **5.99**
  - SANS connectivite (7685) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.33**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 73037 systemes
  - sans CONNECTED : 0.0% sur 16497 systemes
