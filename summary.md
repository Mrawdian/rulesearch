...
genere 2026-08-26 03:28 UTC — 20874 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 11900 systemes
...
| connect | 4 | 3 | 10493 | 5282 | 688 | 364 | 1002 | 833 | 1140 | 1050 | 10.0% |
| ref | 4 | 3 | 10257 | 2457 | 4331 | 5 | 1368 | 515 | 4 | 1577 | 15.4% |
...
- candidats AVEC connectivite : 1053, dont T2 : 100%
- candidats SANS connectivite : 1581, dont T2 : 100%
...
- **1140 systemes avec CONNECTED sur 8670 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1469 candidats
  - AVEC connectivite (574) : T0=13.35 T1=0.00 T2=2.86 — pondere **5.73**
  - SANS connectivite (895) : T0=15.82 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 1144 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1140 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 8613 systemes
  - sans CONNECTED : 0.0% sur 1880 systemes
