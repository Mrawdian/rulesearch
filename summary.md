...
genere 2026-08-27 02:35 UTC — 76373 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 11466 systemes
...
- moteur actif `0caa9267db60` (32631 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 35513 | 17666 | 2442 | 1205 | 3521 | 2815 | 3780 | 3626 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 34745 | 8004 | 14782 | 20 | 4809 | 1815 | 19 | 5296 | 15.2% |
...
- candidats AVEC connectivite : 3753, dont T2 : 100%
- candidats SANS connectivite : 5606, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4054 systemes avec CONNECTED sur 31563 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*5069 candidats sur 9359 portent les champs bruts (54%).*
...
- `ab89a63b01ef` — 1392 candidats
  - AVEC connectivite (573) : resistance **41.1%**
  - SANS connectivite (819) : resistance **22.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `ab89a63b01ef` — 1392 candidats
  - AVEC connectivite (573) : T0=12.99 T1=0.00 T2=3.03 — pondere **6.07**
  - SANS connectivite (819) : T0=15.91 T1=0.00 T2=2.69 — pondere **5.37**
...
**6 serie(s) reproductible(s) sur 13 etablissent l'ecart** : `89c65c03c4ad` (p=0.0005), `ab89a63b01ef` (p=0.0010), `06fe04a859f1` (p=0.0005), `e3baecf8377b` (p=0.0005), `23303c299f39` (p=0.0060), `b71bb0907fb5` (p=0.0110).
...
## cout
- temps total 23.7 h, dont 2% brule sur des systemes MORT
- TROP-CHER : 4083 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 4054 avec CONNECTED, 29 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 29062 systemes
  - sans CONNECTED : 0.0% sur 6451 systemes
