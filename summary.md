...
genere 2026-09-07 11:13 UTC — 434538 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 351194 systemes
...
- moteur actif `0caa9267db60` (390796 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 216362 | 107487 | 14729 | 7202 | 21912 | 16965 | 23007 | 22308 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 212061 | 49374 | 89411 | 83 | 29544 | 10957 | 76 | 32598 | 15.4% |
...
- candidats AVEC connectivite : 22435, dont T2 : 100%
- candidats SANS connectivite : 32908, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **23281 systemes avec CONNECTED sur 179143 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*51053 candidats sur 55343 portent les champs bruts (92%).*

- `5c556c16ea8b` — 45088 candidats
  - AVEC connectivite (18307) : resistance **41.1%**
  - SANS connectivite (26781) : resistance **21.3%**
...
- `5c556c16ea8b` — 45088 candidats
  - AVEC connectivite (18307) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (26781) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 176642 systemes
  - sans CONNECTED : 0.0% sur 39720 systemes
