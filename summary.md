...
genere 2026-08-31 18:22 UTC — 259605 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 176261 systemes
...
- moteur actif `0caa9267db60` (215863 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 128043 | 63667 | 8653 | 4295 | 12939 | 10127 | 13503 | 13182 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 125447 | 29218 | 52984 | 56 | 17376 | 6487 | 56 | 19260 | 15.4% |
...
- candidats SANS connectivite : 19570, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **13777 systemes avec CONNECTED sur 106976 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*28589 candidats sur 32879 portent les champs bruts (87%).*

- `5c556c16ea8b` — 22624 candidats
  - AVEC connectivite (9181) : resistance **41.0%**
  - SANS connectivite (13443) : resistance **21.4%**
...
- `5c556c16ea8b` — 22624 candidats
  ...
  - SANS connectivite (13443) : T0=15.91 T1=0.00 T2=2.66 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 104475 systemes
  - sans CONNECTED : 0.0% sur 23568 systemes
