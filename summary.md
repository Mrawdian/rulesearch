...
genere 2026-09-07 04:15 UTC — 428010 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 344666 systemes
...
- moteur actif `0caa9267db60` (384268 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 213060 | 105785 | 14512 | 7089 | 21611 | 16748 | 22653 | 21951 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 208835 | 48621 | 88049 | 81 | 29106 | 10783 | 75 | 32102 | 15.4% |
...
- candidats AVEC connectivite : 22078, dont T2 : 100%
- candidats SANS connectivite : 32412, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **22927 systemes avec CONNECTED sur 176375 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*50200 candidats sur 54490 portent les champs bruts (92%).*

- `5c556c16ea8b` — 44235 candidats
  - AVEC connectivite (17950) : resistance **41.1%**
  - SANS connectivite (26285) : resistance **21.3%**
...
- `5c556c16ea8b` — 44235 candidats
  - AVEC connectivite (17950) : T0=13.01 T1=0.00 T2=2.98 — pondere **5.96**
  - SANS connectivite (26285) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 173874 systemes
  - sans CONNECTED : 0.0% sur 39186 systemes
