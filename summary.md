...
genere 2026-08-26 03:10 UTC — 20283 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 11309 systemes
...
| connect | 4 | 3 | 10193 | 5137 | 664 | 349 | 974 | 812 | 1095 | 1034 | 10.1% |
| ref | 4 | 3 | 9966 | 2386 | 4203 | 3 | 1326 | 505 | 4 | 1539 | 15.4% |
...
- candidats SANS connectivite : 1543, dont T2 : 100%
...
- **1095 systemes avec CONNECTED sur 8425 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1415 candidats
  - AVEC connectivite (558) : T0=13.35 T1=0.00 T2=2.87 — pondere **5.73**
  - SANS connectivite (857) : T0=15.81 T1=0.00 T2=2.66 — pondere **5.33**
...
- TROP-CHER : 1099 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 1095 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 8368 systemes
  - sans CONNECTED : 0.0% sur 1825 systemes
