...
genere 2026-09-03 22:37 UTC — 349576 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 266232 systemes
...
- moteur actif `0caa9267db60` (305834 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 173457 | 86240 | 11778 | 5800 | 17656 | 13665 | 18376 | 17734 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 170004 | 39540 | 71833 | 69 | 23595 | 8792 | 66 | 26095 | 15.3% |
...
- candidats SANS connectivite : 26405, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **18650 systemes avec CONNECTED sur 144028 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39976 candidats sur 44266 portent les champs bruts (90%).*

- `5c556c16ea8b` — 34011 candidats
  - AVEC connectivite (13733) : resistance **41.0%**
  - SANS connectivite (20278) : resistance **21.2%**
...
- `5c556c16ea8b` — 34011 candidats
  ...
  - SANS connectivite (20278) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.30**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 141527 systemes
  - sans CONNECTED : 0.0% sur 31930 systemes
