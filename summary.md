...
genere 2026-08-26 16:19 UTC — 53325 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `06fe04a859f1` : 8142 systemes
...
- moteur actif `0caa9267db60` (9583 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 23864 | 11907 | 1623 | 813 | 2370 | 1882 | 2551 | 2419 | 10.1% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 23346 | 5408 | 9858 | 14 | 3267 | 1193 | 10 | 3596 | 15.4% |
...
- candidats AVEC connectivite : 2546, dont T2 : 100%
- candidats SANS connectivite : 3906, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2825 systemes avec CONNECTED sur 21994 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2162 candidats sur 6452 portent les champs bruts (34%).*
...
- `06fe04a859f1` — 1047 candidats
  - AVEC connectivite (408) : resistance **41.0%**
  - SANS connectivite (639) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `06fe04a859f1` — 1047 candidats
  - AVEC connectivite (408) : T0=13.15 T1=0.00 T2=3.03 — pondere **6.06**
  - SANS connectivite (639) : T0=15.97 T1=0.00 T2=2.65 — pondere **5.30**
...
- TROP-CHER : 2845 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 2825 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 19493 systemes
  - sans CONNECTED : 0.0% sur 4371 systemes
