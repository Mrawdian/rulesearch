...
genere 2026-09-05 23:04 UTC — 399888 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 316544 systemes
...
- moteur actif `0caa9267db60` (356146 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 198860 | 98730 | 13547 | 6627 | 20192 | 15667 | 21109 | 20457 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 194913 | 45361 | 82229 | 78 | 27143 | 10063 | 72 | 29950 | 15.4% |
...
- candidats AVEC connectivite : 20584, dont T2 : 100%
- candidats SANS connectivite : 30260, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21383 systemes avec CONNECTED sur 164735 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*46554 candidats sur 50844 portent les champs bruts (92%).*

- `5c556c16ea8b` — 40589 candidats
  - AVEC connectivite (16456) : resistance **41.0%**
  - SANS connectivite (24133) : resistance **21.3%**
...
- `5c556c16ea8b` — 40589 candidats
  - AVEC connectivite (16456) : T0=13.01 T1=0.00 T2=2.97 — pondere **5.94**
  - SANS connectivite (24133) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 162234 systemes
  - sans CONNECTED : 0.0% sur 36626 systemes
