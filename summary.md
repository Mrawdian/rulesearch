...
genere 2026-08-25 21:55 UTC — 7049 systemes evalues

## versions du DSL presentes
- `615abe43d6bc` : 6072 systemes
...
| connect | 4 | 3 | 3508 | 1775 | 226 | 121 | 337 | 275 | 354 | 377 | 10.7% |
| ref | 4 | 3 | 3417 | 811 | 1433 | 1 | 470 | 165 | 1 | 536 | 15.7% |
...
- candidats AVEC connectivite : 380, dont T2 : 100%
- candidats SANS connectivite : 540, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **354 systemes avec CONNECTED sur 2934 (12.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- TROP-CHER : 355 systemes abandonnes (5.0% des systemes), 96% du temps total
  dont 354 avec CONNECTED, 1 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.3% sur 2877 systemes
  - sans CONNECTED : 0.0% sur 631 systemes
