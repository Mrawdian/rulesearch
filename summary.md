...
genere 2026-09-03 21:36 UTC — 348472 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 265128 systemes
...
- moteur actif `0caa9267db60` (304730 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 172891 | 85951 | 11740 | 5780 | 17602 | 13624 | 18318 | 17676 | 10.2% |
...
- candidats AVEC connectivite : 17803, dont T2 : 100%
...
- **18592 systemes avec CONNECTED sur 143565 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*39842 candidats sur 44132 portent les champs bruts (90%).*

- `5c556c16ea8b` — 33877 candidats
  - AVEC connectivite (13675) : resistance **41.0%**
...
- `5c556c16ea8b` — 33877 candidats
  - AVEC connectivite (13675) : T0=13.03 T1=0.00 T2=2.97 — pondere **5.95**
...
- TROP-CHER : 18668 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 18592 avec CONNECTED, 76 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 141064 systemes
  - sans CONNECTED : 0.0% sur 31827 systemes
