...
genere 2026-09-01 22:10 UTC — 294227 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 210883 systemes
...
- moteur actif `0caa9267db60` (250485 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 145516 | 72262 | 9891 | 4880 | 14784 | 11472 | 15395 | 14957 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 142596 | 33171 | 60305 | 61 | 19761 | 7366 | 63 | 21858 | 15.3% |
...
- candidats SANS connectivite : 22168, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **15669 systemes avec CONNECTED sur 121254 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*32962 candidats sur 37252 portent les champs bruts (88%).*

- `5c556c16ea8b` — 26997 candidats
  - AVEC connectivite (10956) : resistance **41.0%**
  - SANS connectivite (16041) : resistance **21.3%**
...
- `5c556c16ea8b` — 26997 candidats
  ...
  - SANS connectivite (16041) : T0=15.91 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 15742 systemes abandonnes (5.4% des systemes), 96% du temps total
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 118753 systemes
  - sans CONNECTED : 0.0% sur 26763 systemes
