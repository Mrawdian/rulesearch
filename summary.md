...
genere 2026-08-26 14:17 UTC — 48553 systemes evalues
...
- moteur actif `0caa9267db60` (4811 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 21441 | 10693 | 1426 | 740 | 2121 | 1702 | 2296 | 2192 | 10.2% |
...
- candidats AVEC connectivite : 2319, dont T2 : 100%
- candidats SANS connectivite : 3540, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2570 systemes avec CONNECTED sur 20025 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1569 candidats sur 5859 portent les champs bruts (27%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 454 candidats
  - AVEC connectivite (181) : resistance **39.9%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 454 candidats
  - AVEC connectivite (181) : T0=13.46 T1=0.00 T2=2.98 — pondere **5.96**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 17524 systemes
  - sans CONNECTED : 0.0% sur 3917 systemes
