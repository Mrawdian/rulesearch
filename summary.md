...
genere 2026-08-26 19:29 UTC — 60823 systemes evalues
...
- moteur actif `0caa9267db60` (17081 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27645 | 13789 | 1885 | 932 | 2732 | 2191 | 2939 | 2831 | 10.2% |
...
- **3213 systemes avec CONNECTED sur 25126 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3143 candidats sur 7433 portent les champs bruts (42%).*
...
- `62448a55927e` — 274 candidats
  ...
  - test de permutation : **p = 0.0555** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- TROP-CHER : 3234 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3213 avec CONNECTED, 21 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22625 systemes
  - sans CONNECTED : 0.0% sur 5020 systemes
