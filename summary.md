...
| connect | 4 | 3 | 4767 | 2404 | 294 | 166 | 464 | 387 | 500 | 498 | 10.4% |
| ref | 4 | 3 | 4661 | 1137 | 1958 | 1 | 610 | 224 | 2 | 729 | 15.6% |
...
- candidats AVEC connectivite : 501, dont T2 : 100%
- candidats SANS connectivite : 733, dont T2 : 100%
...
- **500 systemes avec CONNECTED sur 3965 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 69 candidats
  - AVEC connectivite (22) : T0=12.86 T1=0.00 T2=3.14 — pondere **6.27**
  - SANS connectivite (47) : T0=16.04 T1=0.00 T2=2.87 — pondere **5.74**
...
- TROP-CHER : 502 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 500 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 3908 systemes
  - sans CONNECTED : 0.0% sur 859 systemes
