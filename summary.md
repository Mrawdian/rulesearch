...
**7466 enregistrements (72%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 5153 | 2584 | 326 | 185 | 503 | 420 | 539 | 538 | 10.4% |
| ref | 4 | 3 | 5030 | 1222 | 2108 | 1 | 659 | 241 | 2 | 797 | 15.8% |
...
- candidats AVEC connectivite : 541, dont T2 : 100%
- candidats SANS connectivite : 801, dont T2 : 100%
...
- **539 systemes avec CONNECTED sur 4264 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 177 candidats
  - AVEC connectivite (62) : T0=13.19 T1=0.00 T2=2.87 — pondere **5.74**
  - SANS connectivite (115) : T0=16.19 T1=0.00 T2=2.72 — pondere **5.44**
...
- TROP-CHER : 541 systemes abandonnes (5.2% des systemes), 96% du temps total
  dont 539 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 4207 systemes
  - sans CONNECTED : 0.0% sur 946 systemes
