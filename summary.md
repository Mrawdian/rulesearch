...
genere 2026-08-26 22:58 UTC — 68411 systemes evalues
...
- moteur actif `0caa9267db60` (24669 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 31488 | 15634 | 2156 | 1056 | 3140 | 2514 | 3360 | 3228 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 30808 | 7099 | 13094 | 18 | 4264 | 1599 | 14 | 4720 | 15.3% |
...
- candidats AVEC connectivite : 3355, dont T2 : 100%
- candidats SANS connectivite : 5030, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3634 systemes avec CONNECTED sur 28233 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*4095 candidats sur 8385 portent les champs bruts (49%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 418 candidats
  - AVEC connectivite (175) : resistance **42.5%**
  - SANS connectivite (243) : resistance **21.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `ab89a63b01ef` — 418 candidats
  - AVEC connectivite (175) : T0=12.95 T1=0.00 T2=3.09 — pondere **6.17**
  - SANS connectivite (243) : T0=16.07 T1=0.00 T2=2.70 — pondere **5.39**
...
- TROP-CHER : 3658 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3634 avec CONNECTED, 24 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 25732 systemes
  - sans CONNECTED : 0.0% sur 5756 systemes
