...
genere 2026-08-26 12:46 UTC — 44785 systemes evalues
...
| connect | 4 | 3 | 19546 | 9747 | 1275 | 682 | 1952 | 1553 | 2101 | 1992 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 19124 | 4485 | 8069 | 13 | 2637 | 989 | 7 | 2924 | 15.3% |
...
- candidats AVEC connectivite : 2119, dont T2 : 100%
- candidats SANS connectivite : 3234, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2375 systemes avec CONNECTED sur 18460 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1063 candidats sur 5353 portent les champs bruts (20%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `e40600351a72` — 142 candidats
  - AVEC connectivite (68) : resistance **40.4%**
  - SANS connectivite (74) : resistance **18.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e40600351a72` — 142 candidats
  - AVEC connectivite (68) : T0=12.96 T1=0.00 T2=3.01 — pondere **6.03**
  - SANS connectivite (74) : T0=16.82 T1=0.00 T2=2.61 — pondere **5.22**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 15959 systemes
  - sans CONNECTED : 0.0% sur 3587 systemes
