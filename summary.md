...
genere 2026-08-26 13:29 UTC — 46688 systemes evalues
...
- moteur actif `0caa9267db60` (2946 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20499 | 10224 | 1350 | 708 | 2048 | 1631 | 2192 | 2092 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 20074 | 4703 | 8475 | 13 | 2780 | 1039 | 7 | 3057 | 15.2% |
...
- candidats AVEC connectivite : 2219, dont T2 : 100%
- candidats SANS connectivite : 3367, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2466 systemes avec CONNECTED sur 19230 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1296 candidats sur 5586 portent les champs bruts (23%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 181 candidats
  - AVEC connectivite (81) : resistance **38.4%**
  - SANS connectivite (100) : resistance **23.0%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 181 candidats
  - AVEC connectivite (81) : T0=13.51 T1=0.00 T2=2.77 — pondere **5.53**
  - SANS connectivite (100) : T0=16.26 T1=0.00 T2=2.96 — pondere **5.92**
  - test de permutation : **p = 0.4093** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
## cout
- temps total 14.4 h, dont 2% brule sur des systemes MORT
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16729 systemes
  - sans CONNECTED : 0.0% sur 3770 systemes
