...
genere 2026-09-01 03:26 UTC — 271169 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 187825 systemes
...
- moteur actif `0caa9267db60` (227427 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 133871 | 66513 | 9054 | 4492 | 13579 | 10599 | 14142 | 13755 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 131183 | 30573 | 55433 | 57 | 18184 | 6774 | 57 | 20095 | 15.3% |
...
- candidats SANS connectivite : 20405, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **14416 systemes avec CONNECTED sur 111713 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*29997 candidats sur 34287 portent les champs bruts (87%).*

- `5c556c16ea8b` — 24032 candidats
  - AVEC connectivite (9754) : resistance **41.0%**
  - SANS connectivite (14278) : resistance **21.3%**
...
- `5c556c16ea8b` — 24032 candidats
  ...
  - SANS connectivite (14278) : T0=15.92 T1=0.00 T2=2.66 — pondere **5.31**
...
- TROP-CHER : 14483 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 14416 avec CONNECTED, 67 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 109212 systemes
  - sans CONNECTED : 0.0% sur 24659 systemes
