...
genere 2026-08-26 10:42 UTC — 39409 systemes evalues
...
- `e3baecf8377b` : 816 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)
...
**8282 enregistrements (21%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 16826 | 8400 | 1082 | 582 | 1674 | 1339 | 1837 | 1700 | 10.1% |
...
- candidats AVEC connectivite : 1827, dont T2 : 100%
- candidats SANS connectivite : 2829, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2111 systemes avec CONNECTED sur 16252 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*366 candidats sur 4656 portent les champs bruts (8%).*
...
- `e3baecf8377b` — 102 candidats (**NON REPRODUCTIBLE**)
  - AVEC connectivite (44) : resistance **39.9%**
...
- `e3baecf8377b` — 102 candidats
  - AVEC connectivite (44) : T0=13.55 T1=0.00 T2=2.95 — pondere **5.91**
  - SANS connectivite (58) : T0=15.76 T1=0.00 T2=2.43 — pondere **4.86**
  - test de permutation : **p = 0.1189** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- TROP-CHER : 2128 systemes abandonnes (5.4% des systemes), 95% du temps total
  dont 2111 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.4% sur 13751 systemes
  - sans CONNECTED : 0.0% sur 3075 systemes
