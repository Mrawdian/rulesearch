...
genere 2026-08-26 18:14 UTC — 57835 systemes evalues
...
- moteur actif `0caa9267db60` (14093 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `84fba70921e0`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 26133 | 13018 | 1780 | 883 | 2591 | 2064 | 2790 | 2684 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 25587 | 5890 | 10848 | 15 | 3571 | 1310 | 10 | 3943 | 15.4% |
...
- candidats AVEC connectivite : 2811, dont T2 : 100%
- candidats SANS connectivite : 4253, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3064 systemes avec CONNECTED sur 23867 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*2774 candidats sur 7064 portent les champs bruts (39%).*
...
- `0a74109317e5` — 80 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `e80bc1b2b437` — 45 candidats
  - AVEC connectivite (26) : resistance **39.9%**
  - SANS connectivite (19) : resistance **18.9%**
...
- `e80bc1b2b437` — 45 candidats
  - AVEC connectivite (26) : T0=12.85 T1=0.00 T2=2.65 — pondere **5.31**
  - SANS connectivite (19) : T0=15.53 T1=0.00 T2=2.58 — pondere **5.16**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 21366 systemes
  - sans CONNECTED : 0.0% sur 4767 systemes
