...
genere 2026-08-25 22:47 UTC — 9076 systemes evalues
...
- `89c65c03c4ad` : 102 systemes — **NON REPRODUCTIBLE** (aucun commit ne porte ce moteur)

Les lignes de dsl_hash differents ne sont pas comparables entre elles.

**7568 enregistrements (83%) proviennent d'un moteur dont la source n'existe plus** — ni dans git, ni sur le disque. Donnee valide mais non rejouable : ne pas la citer comme reproductible.
...
| connect | 4 | 3 | 4527 | 2283 | 282 | 155 | 440 | 356 | 478 | 480 | 10.6% |
| ref | 4 | 3 | 4425 | 1073 | 1863 | 1 | 585 | 210 | 2 | 691 | 15.6% |
...
- candidats SANS connectivite : 695, dont T2 : 100%
...
- **478 systemes avec CONNECTED sur 3778 (12.7%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- TROP-CHER : 480 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 478 avec CONNECTED, 2 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 3721 systemes
  - sans CONNECTED : 0.0% sur 806 systemes
