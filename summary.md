...
| connect | 4 | 3 | 5516 | 2769 | 353 | 203 | 531 | 453 | 575 | 571 | 10.4% |
| ref | 4 | 3 | 5381 | 1304 | 2244 | 1 | 712 | 264 | 2 | 854 | 15.9% |
...
- candidats AVEC connectivite : 574, dont T2 : 100%
- candidats SANS connectivite : 858, dont T2 : 100%
...
- **575 systemes avec CONNECTED sur 4566 (12.6%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 267 candidats
  - AVEC connectivite (95) : T0=13.18 T1=0.00 T2=2.84 — pondere **5.68**
  - SANS connectivite (172) : T0=15.95 T1=0.00 T2=2.65 — pondere **5.29**
  - test de permutation : **p = 0.3253** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.8% sur 4509 systemes
  - sans CONNECTED : 0.0% sur 1007 systemes
