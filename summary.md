...
genere 2026-08-29 02:41 UTC — 167095 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 83751 systemes
...
- moteur actif `0caa9267db60` (123353 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| ref | 4 | 3 | 79664 | 18531 | 33722 | 36 | 11020 | 4052 | 33 | 12265 | 15.4% |
...
- candidats SANS connectivite : 12575, dont T2 : 100%
...
*16789 candidats sur 21079 portent les champs bruts (80%).*

- `5c556c16ea8b` — 10824 candidats
  - AVEC connectivite (4376) : resistance **41.2%**
  - SANS connectivite (6448) : resistance **21.6%**
...
- `5c556c16ea8b` — 10824 candidats
  ...
  - SANS connectivite (6448) : T0=15.89 T1=0.00 T2=2.67 — pondere **5.34**
...
- TROP-CHER : 8849 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8806 avec CONNECTED, 43 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
