...
genere 2026-08-26 13:36 UTC — 47042 systemes evalues
...
- moteur actif `0caa9267db60` (3300 systemes) : `06fe04a859f1`, `e40600351a72`
...
| connect | 4 | 3 | 20678 | 10312 | 1367 | 718 | 2061 | 1644 | 2204 | 2117 | 10.2% |
...
- candidats AVEC connectivite : 2244, dont T2 : 100%
- candidats SANS connectivite : 3397, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2478 systemes avec CONNECTED sur 19380 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1351 candidats sur 5641 portent les champs bruts (24%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `06fe04a859f1` — 236 candidats
  - AVEC connectivite (106) : resistance **38.3%**
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `06fe04a859f1` — 236 candidats
  - AVEC connectivite (106) : T0=13.58 T1=0.00 T2=2.75 — pondere **5.51**
  - SANS connectivite (130) : T0=16.17 T1=0.00 T2=2.78 — pondere **5.55**
  - test de permutation : **p = 0.9180** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `e40600351a72` — 194 candidats
...
- TROP-CHER : 2495 systemes abandonnes (5.3% des systemes), 95% du temps total
  dont 2478 avec CONNECTED, 17 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 16879 systemes
  - sans CONNECTED : 0.0% sur 3799 systemes
