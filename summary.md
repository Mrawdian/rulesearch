...
genere 2026-08-26 19:07 UTC — 60057 systemes evalues
...
- moteur actif `0caa9267db60` (16315 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27255 | 13602 | 1854 | 919 | 2700 | 2158 | 2893 | 2788 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 26687 | 6164 | 11296 | 15 | 3719 | 1374 | 10 | 4109 | 15.4% |
...
- candidats AVEC connectivite : 2915, dont T2 : 100%
- candidats SANS connectivite : 4419, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3167 systemes avec CONNECTED sur 24796 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3044 candidats sur 7334 portent les champs bruts (42%).*
...
- `23303c299f39` — 225 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 175 candidats
  - AVEC connectivite (71) : resistance **40.4%**
  - SANS connectivite (104) : resistance **18.5%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `62448a55927e` — 175 candidats
  - AVEC connectivite (71) : T0=13.14 T1=0.00 T2=2.94 — pondere **5.89**
  - SANS connectivite (104) : T0=16.05 T1=0.00 T2=2.59 — pondere **5.17**
...
- TROP-CHER : 3187 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3167 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22295 systemes
  - sans CONNECTED : 0.0% sur 4960 systemes
