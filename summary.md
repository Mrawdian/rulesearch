...
genere 2026-08-26 12:45 UTC — 44755 systemes evalues
...
| connect | 4 | 3 | 19531 | 9740 | 1274 | 680 | 1951 | 1552 | 2101 | 1989 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 19109 | 4479 | 8061 | 13 | 2637 | 989 | 7 | 2923 | 15.3% |
...
- candidats AVEC connectivite : 2116, dont T2 : 100%
- candidats SANS connectivite : 3233, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **2375 systemes avec CONNECTED sur 18448 (12.9%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*1059 candidats sur 5349 portent les champs bruts (20%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `e40600351a72` — 138 candidats
  - AVEC connectivite (65) : resistance **40.4%**
  - SANS connectivite (73) : resistance **18.9%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `e40600351a72` — 138 candidats
  - AVEC connectivite (65) : T0=12.88 T1=0.00 T2=3.03 — pondere **6.06**
  - SANS connectivite (73) : T0=16.73 T1=0.00 T2=2.62 — pondere **5.23**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 15947 systemes
  - sans CONNECTED : 0.0% sur 3584 systemes
