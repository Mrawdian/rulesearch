...
genere 2026-08-27 15:19 UTC — 103068 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `5c556c16ea8b` : 19724 systemes
...
- moteur actif `0caa9267db60` (59326 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 48978 | 24395 | 3381 | 1680 | 4864 | 3875 | 5170 | 4978 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 47975 | 11091 | 20368 | 25 | 6639 | 2509 | 23 | 7319 | 15.3% |
...
- candidats AVEC connectivite : 5105, dont T2 : 100%
- candidats SANS connectivite : 7629, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **5444 systemes avec CONNECTED sur 42522 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*8444 candidats sur 12734 portent les champs bruts (66%).*
...
- `5c556c16ea8b` — 2479 candidats
  - AVEC connectivite (977) : resistance **41.7%**
...
- `5c556c16ea8b` — 2479 candidats
  - AVEC connectivite (977) : T0=13.02 T1=0.00 T2=3.03 — pondere **6.06**
...
- TROP-CHER : 5477 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 5444 avec CONNECTED, 33 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 40021 systemes
  - sans CONNECTED : 0.0% sur 8957 systemes
