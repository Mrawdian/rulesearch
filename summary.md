...
genere 2026-08-26 19:21 UTC — 60525 systemes evalues
...
- moteur actif `0caa9267db60` (16783 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `b71bb0907fb5`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 27495 | 13712 | 1875 | 926 | 2715 | 2179 | 2923 | 2819 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 26915 | 6222 | 11387 | 15 | 3748 | 1384 | 10 | 4149 | 15.4% |
...
- candidats AVEC connectivite : 2946, dont T2 : 100%
- candidats SANS connectivite : 4459, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3197 systemes avec CONNECTED sur 25003 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3115 candidats sur 7405 portent les champs bruts (42%).*
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `62448a55927e` — 246 candidats
  - AVEC connectivite (102) : resistance **38.9%**
  - SANS connectivite (144) : resistance **18.3%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `e3baecf8377b` — 657 candidats
  ...
  - test de permutation : **p = 0.0005** — ecart significatif au seuil 0.05, sur une serie reproductible.
- `62448a55927e` — 246 candidats
  - AVEC connectivite (102) : T0=13.14 T1=0.00 T2=2.89 — pondere **5.78**
  - SANS connectivite (144) : T0=16.09 T1=0.00 T2=2.58 — pondere **5.17**
  - test de permutation : **p = 0.1339** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
- `23303c299f39` — 225 candidats
...
- TROP-CHER : 3217 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 3197 avec CONNECTED, 20 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 22502 systemes
  - sans CONNECTED : 0.0% sur 4993 systemes
