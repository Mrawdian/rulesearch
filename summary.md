...
genere 2026-08-26 03:01 UTC — 19884 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 10910 systemes
...
| connect | 4 | 3 | 9985 | 5023 | 655 | 345 | 951 | 798 | 1073 | 1013 | 10.1% |
| ref | 4 | 3 | 9775 | 2337 | 4125 | 3 | 1294 | 497 | 4 | 1515 | 15.5% |
...
- candidats AVEC connectivite : 1016, dont T2 : 100%
- candidats SANS connectivite : 1519, dont T2 : 100%
...
- **1073 systemes avec CONNECTED sur 8254 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1370 candidats
  - AVEC connectivite (537) : T0=13.35 T1=0.00 T2=2.88 — pondere **5.75**
  - SANS connectivite (833) : T0=15.82 T1=0.00 T2=2.66 — pondere **5.32**
...
- TROP-CHER : 1077 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 1073 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.1% sur 8197 systemes
  - sans CONNECTED : 0.0% sur 1788 systemes
