...
genere 2026-08-27 14:10 UTC — 100746 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 29619 systemes
- `ab89a63b01ef` : 18378 systemes
- `5c556c16ea8b` : 17402 systemes
...
- moteur actif `0caa9267db60` (57004 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 47798 | 23829 | 3281 | 1637 | 4736 | 3779 | 5050 | 4869 | 10.2% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 46833 | 10845 | 19872 | 25 | 6487 | 2441 | 22 | 7140 | 15.2% |
...
- **5324 systemes avec CONNECTED sur 41571 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*8156 candidats sur 12446 portent les champs bruts (66%).*
...
- TROP-CHER : 5356 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 5324 avec CONNECTED, 32 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 39070 systemes
  - sans CONNECTED : 0.0% sur 8728 systemes
