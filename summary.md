...
genere 2026-09-08 00:00 UTC — 446166 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 362822 systemes
...
- moteur actif `0caa9267db60` (402424 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 222235 | 110364 | 15148 | 7421 | 22501 | 17402 | 23674 | 22892 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 217816 | 50752 | 91786 | 85 | 30370 | 11273 | 78 | 33454 | 15.4% |
...
- candidats AVEC connectivite : 23019, dont T2 : 100%
...
- **23948 systemes avec CONNECTED sur 183976 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*52493 candidats sur 56783 portent les champs bruts (92%).*

- `5c556c16ea8b` — 46528 candidats
  - AVEC connectivite (18891) : resistance **41.2%**
...
- `5c556c16ea8b` — 46528 candidats
  - AVEC connectivite (18891) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 24036 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23948 avec CONNECTED, 88 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 181475 systemes
  - sans CONNECTED : 0.0% sur 40760 systemes
