...
genere 2026-08-28 23:42 UTC — 161968 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 78624 systemes
...
- moteur actif `0caa9267db60` (118226 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 78725 | 39127 | 5366 | 2677 | 7866 | 6296 | 8282 | 8110 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 77128 | 17923 | 32649 | 35 | 10650 | 3938 | 31 | 11898 | 15.4% |
...
- candidats AVEC connectivite : 8237, dont T2 : 100%
- candidats SANS connectivite : 12208, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **8556 systemes avec CONNECTED sur 66704 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*16155 candidats sur 20445 portent les champs bruts (79%).*

- `5c556c16ea8b` — 10190 candidats
  - AVEC connectivite (4109) : resistance **41.2%**
  - SANS connectivite (6081) : resistance **21.8%**
...
- `5c556c16ea8b` — 10190 candidats
  - AVEC connectivite (4109) : T0=13.01 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (6081) : T0=15.89 T1=0.00 T2=2.68 — pondere **5.36**
...
- TROP-CHER : 8597 systemes abandonnes (5.3% des systemes), 96% du temps total
  dont 8556 avec CONNECTED, 41 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 64203 systemes
  - sans CONNECTED : 0.0% sur 14522 systemes
