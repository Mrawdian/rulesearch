...
genere 2026-09-08 00:25 UTC — 446526 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 363182 systemes
...
- moteur actif `0caa9267db60` (402784 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 222415 | 110454 | 15153 | 7425 | 22517 | 17417 | 23698 | 22913 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 217996 | 50788 | 91867 | 85 | 30403 | 11278 | 78 | 33479 | 15.4% |
...
- candidats AVEC connectivite : 23040, dont T2 : 100%
...
- **23972 systemes avec CONNECTED sur 184120 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*52539 candidats sur 56829 portent les champs bruts (92%).*

- `5c556c16ea8b` — 46574 candidats
  - AVEC connectivite (18912) : resistance **41.2%**
...
- `5c556c16ea8b` — 46574 candidats
  - AVEC connectivite (18912) : T0=13.02 T1=0.00 T2=2.98 — pondere **5.96**
...
- TROP-CHER : 24060 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 23972 avec CONNECTED, 88 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 181619 systemes
  - sans CONNECTED : 0.0% sur 40796 systemes
