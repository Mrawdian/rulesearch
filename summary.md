...
genere 2026-09-05 22:51 UTC — 399680 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 316336 systemes
...
- moteur actif `0caa9267db60` (355938 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 198755 | 98684 | 13541 | 6624 | 20182 | 15654 | 21096 | 20447 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 194810 | 45342 | 82188 | 78 | 27122 | 10058 | 72 | 29933 | 15.4% |
...
- candidats SANS connectivite : 30243, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **21370 systemes avec CONNECTED sur 164657 (13.0%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*46527 candidats sur 50817 portent les champs bruts (92%).*

- `5c556c16ea8b` — 40562 candidats
  - AVEC connectivite (16446) : resistance **41.1%**
  - SANS connectivite (24116) : resistance **21.3%**
...
- `5c556c16ea8b` — 40562 candidats
  ...
  - SANS connectivite (24116) : T0=15.92 T1=0.00 T2=2.65 — pondere **5.31**
...
- TROP-CHER : 21452 systemes abandonnes (5.4% des systemes), 96% du temps total
  dont 21370 avec CONNECTED, 82 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 162156 systemes
