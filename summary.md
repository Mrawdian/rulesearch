...
genere 2026-08-27 08:22 UTC — 89070 systemes evalues
...
- moteur actif `0caa9267db60` (45328 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 41913 | 20873 | 2881 | 1418 | 4180 | 3294 | 4417 | 4305 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 41042 | 9464 | 17444 | 22 | 5685 | 2137 | 21 | 6269 | 15.3% |
...
- candidats AVEC connectivite : 4432, dont T2 : 100%
- candidats SANS connectivite : 6579, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **4691 systemes avec CONNECTED sur 36758 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*6721 candidats sur 11011 portent les champs bruts (61%).*
...
- `62448a55927e` — 798 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `5c556c16ea8b` — 756 candidats
  - AVEC connectivite (304) : resistance **41.0%**
  - SANS connectivite (452) : resistance **21.1%**
  - test de permutation : **p = 0.0005** — significatif.
...
- `5c556c16ea8b` — 756 candidats
  - AVEC connectivite (304) : T0=13.09 T1=0.00 T2=3.00 — pondere **5.99**
  - SANS connectivite (452) : T0=15.87 T1=0.00 T2=2.62 — pondere **5.23**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 34257 systemes
  - sans CONNECTED : 0.0% sur 7656 systemes
