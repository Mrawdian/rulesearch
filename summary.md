...
genere 2026-08-26 04:41 UTC — 24047 systemes evalues

## versions du DSL presentes
- `89c65c03c4ad` : 15073 systemes
...
| connect | 4 | 3 | 12090 | 6063 | 792 | 421 | 1163 | 971 | 1309 | 1221 | 10.1% |
...
- candidats AVEC connectivite : 1224, dont T2 : 100%
...
- **1309 systemes avec CONNECTED sur 9966 (13.1%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
- `89c65c03c4ad` — 1885 candidats
  - AVEC connectivite (745) : T0=13.32 T1=0.00 T2=2.84 — pondere **5.68**
...
- TROP-CHER : 1313 systemes abandonnes (5.5% des systemes), 96% du temps total
  dont 1309 avec CONNECTED, 4 sans -- **chiffre CONFONDU** : seul le tag connect peut produire des systemes avec CONNECTED, ce ratio melange l'effet de la connectivite et celui de la configuration. Voir la ventilation ci-dessous.
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.2% sur 9909 systemes
