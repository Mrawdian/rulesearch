...
genere 2026-08-26 21:49 UTC — 65943 systemes evalues
...
- moteur actif `0caa9267db60` (22201 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 30233 | 15013 | 2066 | 1019 | 3027 | 2401 | 3221 | 3105 | 10.3% |
...
- candidats AVEC connectivite : 3232, dont T2 : 100%
- candidats SANS connectivite : 4854, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **3495 systemes avec CONNECTED sur 27212 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*3796 candidats sur 8086 portent les champs bruts (47%).*
...
- `e40600351a72` — 194 candidats
  ...
  - test de permutation : **p = 0.0005** — significatif.
- `ab89a63b01ef` — 119 candidats
  - AVEC connectivite (52) : resistance **44.8%**
...
- `ab89a63b01ef` — 119 candidats
  - AVEC connectivite (52) : T0=13.65 T1=0.00 T2=3.17 — pondere **6.35**
  - SANS connectivite (67) : T0=15.78 T1=0.00 T2=2.94 — pondere **5.88**
  - test de permutation : **p = 0.4613** — **NON SIGNIFICATIF**, l'ecart est compatible avec le bruit. Ne pas conclure.
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 13.0% sur 24711 systemes
  - sans CONNECTED : 0.0% sur 5522 systemes
