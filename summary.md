...
genere 2026-08-29 10:54 UTC — 180298 systemes evalues

## versions du DSL presentes
- `5c556c16ea8b` : 96954 systemes
...
- moteur actif `0caa9267db60` (136556 systemes) : `06fe04a859f1`, `0a74109317e5`, `23303c299f39`, `5c556c16ea8b`, `62448a55927e`, `84fba70921e0`, `8f22f0d2d442`, `9e54e42681ed`, `ab89a63b01ef`, `b71bb0907fb5`, `cf6a4d3246d8`, `e40600351a72`, `e80bc1b2b437`, `e8a1f930f7b9`
...
| connect | 4 | 3 | 87981 | 43723 | 5989 | 2978 | 8843 | 7013 | 9245 | 9070 | 10.3% |
| d4 | 4 | 4 | 5991 | 2749 | 1523 | 30 | 421 | 404 | 284 | 430 | 7.2% |
| ref | 4 | 3 | 86202 | 20137 | 36413 | 40 | 11906 | 4402 | 35 | 13263 | 15.4% |
...
- candidats SANS connectivite : 13573, dont T2 : 100%
- **l'hypothese ne tient pas — le v2 n'est qu'un v1 elargi**

### censure de l'echantillon

- **9519 systemes avec CONNECTED sur 74278 (12.8%) sont abandonnes en TROP-CHER** et ne figurent donc pas dans la mesure ci-dessus.
...
*18480 candidats sur 22770 portent les champs bruts (81%).*

- `5c556c16ea8b` — 12515 candidats
  - AVEC connectivite (5069) : resistance **41.2%**
  - SANS connectivite (7446) : resistance **21.5%**
...
- `5c556c16ea8b` — 12515 candidats
  ...
  - SANS connectivite (7446) : T0=15.89 T1=0.00 T2=2.66 — pondere **5.33**
...
- taux de TROP-CHER **dans le seul tag connect** (a configuration egale, non confondu) :
  - avec CONNECTED : 12.9% sur 71777 systemes
  - sans CONNECTED : 0.0% sur 16204 systemes
