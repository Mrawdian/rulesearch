...
Ce canari verifie que **toute technique effectivement activee se declenche au
moins une fois** sur des cas de reference. Le seuil d'activation est
...
for niveau in range(DEFAULT_MAX_LEVEL + 1, SONDE_MAX + 1):
    note = "inerte (non activee, n'echoue pas)" if not total[niveau] else "operante"
...
print("OK : toute technique activee se declenche au moins une fois.")
